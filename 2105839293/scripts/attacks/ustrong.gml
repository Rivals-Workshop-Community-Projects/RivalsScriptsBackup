...
set_window_value(AT_USTRONG, 1, AG_WINDOW_SFX, sound_get("sfx_yuuto_strong"));
...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, sound_get("sfx_yuuto_star"));
...
set_hitbox_value(AT_USTRONG, 3, HG_ANGLE, 88);
