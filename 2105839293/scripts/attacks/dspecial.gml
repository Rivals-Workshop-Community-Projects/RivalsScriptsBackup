...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.9);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_WIDTH, 280);
set_hitbox_value(AT_DSPECIAL, 1, HG_HEIGHT, 280);
