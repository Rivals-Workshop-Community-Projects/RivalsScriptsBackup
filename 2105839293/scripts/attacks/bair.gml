...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("sfx_yuuto_wave"));
...
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 0);
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 0);
...
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_Y, -53);
...
set_hitbox_value(AT_BAIR, 2, HG_PROJECTILE_MASK, sprite_get("bair_proj_mask"));
set_hitbox_value(AT_BAIR, 2, HG_PROJECTILE_ANIM_SPEED, 0.9);
