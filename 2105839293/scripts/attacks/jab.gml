...
set_window_value(AT_JAB, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1);
...
set_window_value(AT_JAB, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1);
...
set_hitbox_value(AT_JAB, 3, HG_BASE_HITPAUSE, 0.6);
