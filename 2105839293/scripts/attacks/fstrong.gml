...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, sound_get("sfx_yuuto_warp"));
...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_SFX, asset_get("sfx_kragg_rock_shatter"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_WINDOW_CREATION_FRAME, 11);
set_hitbox_value(AT_FSTRONG, 1, HG_LIFETIME, 3);
set_hitbox_value(AT_FSTRONG, 1, HG_SHAPE, 0);
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_X, 10);
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_Y, -100);
...
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, 192);
...
set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT, 192);
...
set_hitbox_value(AT_FSTRONG, 3, HG_WINDOW_CREATION_FRAME, 16);
...
set_hitbox_value(AT_FSTRONG, 3, HG_VISUAL_EFFECT, 192);
...
set_hitbox_value(AT_FSTRONG, 4, HG_LIFETIME, 6);
set_hitbox_value(AT_FSTRONG, 4, HG_WINDOW_CREATION_FRAME, 17);
...
set_hitbox_value(AT_FSTRONG, 4, HG_ANGLE, 33);
...
set_hitbox_value(AT_FSTRONG, 4, HG_VISUAL_EFFECT, 192);
