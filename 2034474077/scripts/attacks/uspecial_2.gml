...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_swipe_medium1"));
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX_FRAME, 2);
...
set_window_value(AT_USPECIAL, 5, AG_WINDOW_SFX, asset_get("sfx_swipe_medium1"));
...
set_window_value(AT_USPECIAL, 7, AG_WINDOW_SFX_FRAME, 2);
set_window_value(AT_USPECIAL, 7, AG_WINDOW_CUSTOM_GRAVITY, -0.1);
...
set_window_value(AT_USPECIAL, 9, AG_WINDOW_CUSTOM_GRAVITY, 0.4);
...
set_hitbox_value(AT_USPECIAL, 1, HG_WIDTH, 53);
set_hitbox_value(AT_USPECIAL, 1, HG_HEIGHT, 70);
set_hitbox_value(AT_USPECIAL, 1, HG_SHAPE, 0);
set_hitbox_value(AT_USPECIAL, 1, HG_PRIORITY, 1);
set_hitbox_value(AT_USPECIAL, 1, HG_DAMAGE, 1);
set_hitbox_value(AT_USPECIAL, 1, HG_ANGLE, 43);
set_hitbox_value(AT_USPECIAL, 1, HG_ANGLE_FLIPPER, 4); //0
...
set_hitbox_value(AT_USPECIAL, 2, HG_HITBOX_X, 41);
...
set_hitbox_value(AT_USPECIAL, 4, HG_HITBOX_X, 37);
set_hitbox_value(AT_USPECIAL, 4, HG_HITBOX_Y, -46);
set_hitbox_value(AT_USPECIAL, 4, HG_WIDTH, 63);
...
set_hitbox_value(AT_USPECIAL, 4, HG_ANGLE, 35);
set_hitbox_value(AT_USPECIAL, 4, HG_BASE_KNOCKBACK, 5.5); //6
