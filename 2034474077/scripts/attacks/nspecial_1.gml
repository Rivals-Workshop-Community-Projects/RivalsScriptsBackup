...
if(ballin){
    set_attack_value(AT_NSPECIAL, AG_SPRITE, sprite_get("nspecial_ballin"));
    set_attack_value(AT_NSPECIAL, AG_AIR_SPRITE, sprite_get("nspecial_ballin"));
}
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("aaashotput"));
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("aaashotput"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_GRAVITY, 0.9);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_EFFECT, 69);