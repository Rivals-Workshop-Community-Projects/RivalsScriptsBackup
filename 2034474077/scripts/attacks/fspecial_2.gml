...
set_window_value(AT_FSPECIAL_2, 2, AG_WINDOW_LENGTH, 6); //8
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_ANGLE, 60); //was 361 //was 50
set_hitbox_value(AT_FSPECIAL_2, 1, HG_BASE_KNOCKBACK, 7.5); //8
