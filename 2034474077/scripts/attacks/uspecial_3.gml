...
set_hitbox_value(AT_USPECIAL_3, 1, HG_DRIFT_MULTIPLIER, 0);
...
set_hitbox_value(AT_USPECIAL_3, 2, HG_BASE_KNOCKBACK, 5.5);
set_hitbox_value(AT_USPECIAL_3, 2, HG_KNOCKBACK_SCALING, 0.75);
...
set_hitbox_value(AT_USPECIAL_3, 3, HG_DRIFT_MULTIPLIER, 0);