...
set_window_value(AT_FSPECIAL, 5, AG_WINDOW_VSPEED, -16);
...
set_window_value(AT_FSPECIAL, 7, AG_WINDOW_VSPEED, 20);
...
set_window_value(AT_FSPECIAL, 9, AG_WINDOW_CUSTOM_GRAVITY, 0.65);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_ANGLE, 100); //115
