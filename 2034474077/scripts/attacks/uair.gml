...
set_attack_value(AT_UAIR, AG_LANDING_LAG, 5); //fear
...
set_hitbox_value(AT_UAIR, 1, HG_HITBOX_Y, -41);
set_hitbox_value(AT_UAIR, 1, HG_WIDTH, 39);
...
set_hitbox_value(AT_UAIR, 1, HG_KNOCKBACK_SCALING, .70);
...
set_hitbox_value(AT_UAIR, 2, HG_KNOCKBACK_SCALING, .70);
...
set_hitbox_value(AT_UAIR, 3, HG_HITBOX_Y, -47);
...
set_hitbox_value(AT_UAIR, 3, HG_KNOCKBACK_SCALING, .70);
