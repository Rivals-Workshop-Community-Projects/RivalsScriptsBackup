...
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_X, -20); //-40
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_Y, -34); //-39
set_hitbox_value(AT_BAIR, 2, HG_WIDTH, 50); //80
set_hitbox_value(AT_BAIR, 2, HG_HEIGHT, 30); //39
