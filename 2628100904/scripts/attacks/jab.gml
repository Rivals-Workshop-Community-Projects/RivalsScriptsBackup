...
set_window_value(AT_JAB, 7, AG_WINDOW_SFX, sound_get("pistol_clipin"));
...
// set_window_value(AT_JAB, 8, AG_WINDOW_SFX, sound_get("pistol_shoot"));
...
set_hitbox_value(AT_JAB, 1, HG_SHAPE, 2); //rounded rectangle is 2, circle is 0, square is 1
...
set_hitbox_value(AT_JAB, 2, HG_SHAPE, 2); //rounded rectangle is 2, circle is 0, square is 1
...
set_hitbox_value(AT_JAB, 3, HG_VISUAL_EFFECT, explode_fx);

if(has_rune("L")){
    set_hitbox_value(AT_JAB, 3, HG_BASE_KNOCKBACK, 30);
}