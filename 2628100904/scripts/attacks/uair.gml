//basic 1-hit aerial attack, based on darmanna's UAIR
...
set_window_value(AT_UAIR, 2, AG_WINDOW_SFX, sound_get("batswing"));
...
set_hitbox_value(AT_UAIR, 1, HG_HEIGHT, 63);
...
set_hitbox_value(AT_UAIR, 3, HG_HITBOX_X, 57);
...
set_hitbox_value(AT_UAIR, 3, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_UAIR, 3, HG_HIT_SFX, asset_get("sfx_blow_medium3"));
set_hitbox_value(AT_UAIR, 3, HG_EXTRA_CAMERA_SHAKE, 0);