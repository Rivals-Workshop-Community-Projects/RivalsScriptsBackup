...
set_hitbox_value(AT_USTRONG, 3, HG_WIDTH, 130);
...
set_hitbox_value(AT_USTRONG, 3, HG_HITSTUN_MULTIPLIER, .8);
...
set_hitbox_value(AT_USTRONG, 4, HG_PROJECTILE_ANIM_SPEED, 0.3);
...
set_hitbox_value(AT_USTRONG, 4, HG_HITSTUN_MULTIPLIER, .8);
set_hitbox_value(AT_USTRONG, 4, HG_HIT_LOCKOUT, 15);
set_hitbox_value(AT_USTRONG, 4, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_USTRONG, 4, HG_HITPAUSE_SCALING, 0.7);
...
set_hitbox_value(AT_USTRONG, 4, HG_PROJECTILE_PLASMA_SAFE, 1);
