...
set_hitbox_value(AT_DSPECIAL, 6, HG_KNOCKBACK_SCALING, 1.35);
...
set_hitbox_value(AT_DSPECIAL, 7, HG_WIDTH, 125);
set_hitbox_value(AT_DSPECIAL, 7, HG_HEIGHT, 125);
...
set_hitbox_value(AT_DSPECIAL, 7, HG_KNOCKBACK_SCALING, 1.3);
...
set_hitbox_value(AT_DSPECIAL, 7, HG_DRIFT_MULTIPLIER, 0.25);
