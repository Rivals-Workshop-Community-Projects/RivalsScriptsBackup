...
set_window_value(AT_FAIR, 4, AG_WINDOW_GOTO, 3);
...
set_hitbox_value(AT_FAIR, 2, HG_ANGLE, 105);
...
set_hitbox_value(AT_FAIR, 3, HG_VISUAL_EFFECT_Y_OFFSET, 15);
set_hitbox_value(AT_FAIR, 3, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_FAIR, 3, HG_VISUAL_EFFECT, HFX_ELL_FSPEC_HIT);