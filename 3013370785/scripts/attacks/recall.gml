...
set_attack_value(AT_DSPECIAL_2, AG_SPRITE, sprite_get("recall"));
set_attack_value(AT_DSPECIAL_2, AG_HURTBOX_SPRITE, sprite_get("recall_hurt"));
...
set_window_value(AT_DSPECIAL_2, 1, AG_WINDOW_SFX, sound_get("rune_search_start"));
set_window_value(AT_DSPECIAL_2, 1, AG_WINDOW_SFX_FRAME, 0);

set_window_value(AT_DSPECIAL_2, 2, AG_WINDOW_LENGTH, 21);
...
set_window_value(AT_DSPECIAL_2, 2, AG_WINDOW_SFX, asset_get("sfx_swipe_weak1"));
