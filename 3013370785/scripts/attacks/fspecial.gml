...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_VSPEED, -5);
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_SFX, sound_get("shield_surf"));
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_SFX, jump_sound);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_LIFETIME, 600);
...
set_hitbox_value(AT_FSPECIAL, 4, HG_PROJECTILE_LIFESPAN, 0);
