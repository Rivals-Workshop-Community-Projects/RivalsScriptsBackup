...
sprite_change_offset("idle_air", 100, 140);
...
sprite_change_offset("nspecial_2", 100, 140);
...
sprite_change_offset("lightning_fstrong", 100, 140);
sprite_change_offset("lightning_ustrong", 100, 140);
sprite_change_offset("lightning_dstrong", 100, 140);
sprite_change_offset("lightning_dspecial", 100, 140);

sprite_change_offset("hud_strong_cooldown", 5, 6);
sprite_change_offset("fstrong_proj", 100, 140);
sprite_change_offset("ustrong_proj", 100, 140);
sprite_change_offset("dstrong_proj", 100, 140);
sprite_change_offset("dstrong_proj_mask", 100, 140);
sprite_change_offset("dspecial_proj", 100, 140);
sprite_change_offset("dspecial_proj_final", 100, 140);
sprite_change_offset("bolt_main", 128, 0);
sprite_change_offset("bolt_bottom", 128, 0);

sprite_change_offset("cloud_mask", 100, 140);
sprite_change_offset("cloud_idle", 100, 140);
sprite_change_offset("cloud_spawn", 100, 140);
sprite_change_offset("cloud_die", 100, 140);
sprite_change_offset("cloud_explode", 100, 140);
sprite_change_offset("cloud_uspecial", 100, 140);
...
sprite_change_offset("snail_land", 100, 140);

sprite_change_offset("alto_spawn", 100, 140);
sprite_change_offset("alto_idle", 100, 140);

sprite_change_offset("vfx_woag", 276, 175);
sprite_change_offset("vfx_rain_splash", 100, 140);
sprite_change_offset("vfx_rain_drop", 4, 16);