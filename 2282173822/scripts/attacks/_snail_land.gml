...
set_hitbox_value(AT_EXTRA_1, 2, HG_HEIGHT, 72);
...
set_hitbox_value(AT_EXTRA_1, 2, HG_BASE_HITPAUSE, 14);
set_hitbox_value(AT_EXTRA_1, 2, HG_HITPAUSE_SCALING, 0.7);
set_hitbox_value(AT_EXTRA_1, 2, HG_HIT_SFX, sfx_ssbu_shock);
...
set_hitbox_value(AT_EXTRA_1, 2, HG_MUNO_HITBOX_NAME, "Cloud Explosion");