set_attack_value(AT_DSTRONG_2, AG_SPRITE, sprite_get("lightning_dstrong"));
...
set_attack_value(AT_DSTRONG_2, AG_HURTBOX_SPRITE, sprite_get("lightning_dstrong_hurt"));
set_attack_value(AT_DSTRONG_2, AG_USES_CUSTOM_GRAVITY, 1);
set_attack_value(AT_DSTRONG_2, AG_OFF_LEDGE, 1);
set_attack_value(AT_DSTRONG_2, AG_MUNO_ATTACK_NAME, "Lightning DStrong");
set_attack_value(AT_DSTRONG_2, AG_MUNO_ATTACK_MISC_ADD, "Can only be charged for 30f");
...
set_window_value(AT_DSTRONG_2, 4, AG_WINDOW_TYPE, 7);
set_window_value(AT_DSTRONG_2, 4, AG_WINDOW_LENGTH, 25);
...
for (var i = 1; i < 5; i++){
	// set_window_value(AT_DSTRONG_2, i, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
}
...
set_hitbox_value(AT_DSTRONG_2, 1, HG_HITBOX_Y, 40);
