...
set_window_value(AT_DSTRONG, 5, AG_WINDOW_SFX_FRAME, 3);
set_window_value(AT_DSTRONG, 5, AG_WINDOW_SFX, sound_get("dstrong_keg"));

set_window_value(AT_DSTRONG, 6, AG_WINDOW_LENGTH, 30);
set_window_value(AT_DSTRONG, 6, AG_WINDOW_ANIM_FRAMES, 8);
