...
set_attack_value(AT_BAIR, AG_LANDING_LAG, 6); // 4
...
set_window_value(AT_BAIR, 3, AG_WINDOW_LENGTH, 15); // 7
...
set_hitbox_value(AT_BAIR, 1, HG_DAMAGE, 9); // 5
...
set_hitbox_value(AT_BAIR, 2, HG_DAMAGE, 6); // 5
