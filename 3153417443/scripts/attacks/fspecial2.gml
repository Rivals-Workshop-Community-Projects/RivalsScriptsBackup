...
//DOWN
set_window_value(AT_FSPECIAL_2, 3, AG_WINDOW_LENGTH, 33);
...
set_hitbox_value(AT_FSPECIAL_2, 2, HG_ANGLE, 130);
...
set_hitbox_value(AT_FSPECIAL_2, 3, HG_WINDOW_CREATION_FRAME, 12);
...
set_hitbox_value(AT_FSPECIAL_2, 4, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_HITPAUSE_SCALING, .5);
