...
set_window_value(AT_UTILT, 3, AG_WINDOW_HAS_WHIFFLAG, 7);
...
set_hitbox_value(AT_UTILT, 1, HG_WIDTH, 85); // 20
...
set_hitbox_value(AT_UTILT, 2, HG_WIDTH, 85); // 20
set_hitbox_value(AT_UTILT, 2, HG_HEIGHT, 50);
set_hitbox_value(AT_UTILT, 2, HG_PRIORITY, 2);
set_hitbox_value(AT_UTILT, 2, HG_DAMAGE, 6); // 3
