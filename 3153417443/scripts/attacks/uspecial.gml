...
set_hitbox_value(AT_USPECIAL, 3, HG_BASE_KNOCKBACK, 7); //7
set_hitbox_value(AT_USPECIAL, 3, HG_KNOCKBACK_SCALING, 0.9); //0.6//0.7
...
set_hitbox_value(AT_USPECIAL, 4, HG_BASE_KNOCKBACK, 7); //7
set_hitbox_value(AT_USPECIAL, 4, HG_KNOCKBACK_SCALING, 0.9); //0.6//0.7
...
set_hitbox_value(AT_USPECIAL, 5, HG_ANGLE, 255); //292 
