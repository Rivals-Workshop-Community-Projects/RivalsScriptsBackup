...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_LENGTH, 23);
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_frog_fspecial_cancel"));
...
set_window_value(AT_FSPECIAL, 6, AG_WINDOW_SFX, asset_get("sfx_dizzy"));
