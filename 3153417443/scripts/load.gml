...
sprite_change_offset("walljump", 120, 180);
...
sprite_change_offset("ftilt", 100, 190);
...
sprite_change_offset("fstrong", 98, 190);
sprite_change_offset("ustrong", 128, 190);
sprite_change_offset("dstrong", 128, 190);
sprite_change_offset("nspecial", 124, 190);
sprite_change_offset("fspecial", 124, 190);
sprite_change_offset("throws", 124, 190);
sprite_change_offset("uspecial", 124, 180);
sprite_change_offset("dspecial", 128, 190);
sprite_change_offset("dspecialair", 114, 204);
sprite_change_offset("taunt", 128, 190);

sprite_change_offset("plat", 120, 158);
sprite_change_offset("plat_behind", 120, 158);

sprite_change_offset("nspecial_proj", 128, 128);

sprite_change_offset("bubcreate", 128, 128);
sprite_change_offset("bubblefloat", 136, 194);
sprite_change_offset("bubactive", 128, 128);
sprite_change_offset("bubdestroy", 128, 128);
sprite_change_offset("bubdestroyex", 128, 128);
sprite_change_offset("bubmask", 128, 128);
sprite_change_offset("buboutline", 128, 128);
//sprite_change_offset("player_outline", 86, 1);
sprite_change_offset("bubgrow", 128, 128);
sprite_change_offset("bub_vfx_m", 128, 128);
sprite_change_offset("grab_vfx", 128, 128);
sprite_change_offset("fstrong_startup_vfx", 136, 190);
sprite_change_offset("fstrong_catch_vfx", 118, 138);
