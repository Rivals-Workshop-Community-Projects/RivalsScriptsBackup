...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sound_get("dagger_swoosh1"));
...
set_hitbox_value(AT_DAIR, 1, HG_WIDTH, 9);
set_hitbox_value(AT_DAIR, 1, HG_HEIGHT, 9);
...
set_hitbox_value(AT_DAIR, 3, HG_HIT_LOCKOUT, 20);