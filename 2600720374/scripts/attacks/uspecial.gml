...
set_attack_value(AT_USPECIAL, AG_SPRITE, sprite_get("dragon_punch"));
set_attack_value(AT_USPECIAL, AG_NUM_WINDOWS, 4);
set_attack_value(AT_USPECIAL, AG_HAS_LANDING_LAG, 4);
set_attack_value(AT_USPECIAL, AG_OFF_LEDGE, 1);
set_attack_value(AT_USPECIAL, AG_AIR_SPRITE, sprite_get("dragon_punch"));
...
// DP back part that doesn't hit enemies and just hits the orb
// this is silly
...
set_hitbox_value(AT_USPECIAL, 3, HG_ANGLE, 87);
