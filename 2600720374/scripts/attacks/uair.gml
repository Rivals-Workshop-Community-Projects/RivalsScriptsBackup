...
set_hitbox_value(AT_UAIR, 1, HG_ANGLE, 91);
set_hitbox_value(AT_UAIR, 1, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_UAIR, 1, HG_KNOCKBACK_SCALING, .60);
...
set_hitbox_value(AT_UAIR, 2, HG_ANGLE, 112);
set_hitbox_value(AT_UAIR, 2, HG_BASE_KNOCKBACK, 6.2);
