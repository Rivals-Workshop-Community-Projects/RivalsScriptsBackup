...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_absa_orb_missrelease"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_KNOCKBACK_SCALING, 0.45);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("orb"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_absa_singlezap2"));
...
set_hitbox_value(AT_DSPECIAL, 2, HG_ANGLE, 64);
