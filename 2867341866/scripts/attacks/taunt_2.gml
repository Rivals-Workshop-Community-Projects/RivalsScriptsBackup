// GRAFFITI TAUNT
set_attack_value(AT_TAUNT_2, AG_SPRITE, sprite_get("grafitti_taunt"));
...
//set_window_value(AT_TAUNT_2, 2, AG_WINDOW_SFX, asset_get("sfx_sand_yell"));
...
set_hitbox_value(AT_TAUNT_2, 1, HG_PROJECTILE_SPRITE, sprite_get("graffiti_can"));
