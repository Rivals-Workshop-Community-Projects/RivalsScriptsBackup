...
set_window_value(AT_NAIR, 2, AG_WINDOW_SFX, asset_get("sfx_buzzsaw_throw"));
...
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT, vfx_l);
...
set_hitbox_value(AT_NAIR, 3, HG_VISUAL_EFFECT, vfx_m);
set_hitbox_value(AT_NAIR, 3, HG_HITPAUSE_SCALING, .5);
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, asset_get("sfx_buzzsaw_hit"));
