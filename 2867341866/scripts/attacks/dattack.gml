...
set_window_value(AT_DATTACK, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.3);
...
set_window_value(AT_DATTACK, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.3);
...
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT, vfx_m);
