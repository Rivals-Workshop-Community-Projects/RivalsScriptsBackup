...
set_attack_value(AT_FTILT2, AG_NUM_WINDOWS, 5);
...
set_window_value(AT_FTILT2, 4, AG_WINDOW_LENGTH, 15);
set_window_value(AT_FTILT2, 4, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_FTILT2, 4, AG_WINDOW_ANIM_FRAME_START, 4);

set_window_value(AT_FTILT2, 5, AG_WINDOW_TYPE, 1);
set_window_value(AT_FTILT2, 5, AG_WINDOW_LENGTH, 8);
set_window_value(AT_FTILT2, 5, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_FTILT2, 5, AG_WINDOW_ANIM_FRAME_START, 7);
