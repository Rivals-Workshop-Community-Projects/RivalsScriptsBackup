...
set_window_value(AT_BAIR2, 3, AG_WINDOW_LENGTH, 9);
...
set_hitbox_value(AT_BAIR2, 2, HG_ANGLE, 135);
set_hitbox_value(AT_BAIR2, 2, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_BAIR2, 2, HG_KNOCKBACK_SCALING, .6);
...
set_hitbox_value(AT_BAIR2, 3, HG_ANGLE, 140);
...
set_hitbox_value(AT_BAIR2, 3, HG_VISUAL_EFFECT, shock_big);
