...
set_hitbox_value(AT_NSPECIAL_2_AIR, 1, HG_DAMAGE, 8);
...
set_hitbox_value(AT_NSPECIAL_2_AIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_NSPECIAL_2_AIR, 1, HG_VISUAL_EFFECT, shock_big);
set_hitbox_value(AT_NSPECIAL_2_AIR, 1, HG_HIT_SFX, sound_get("slash"));
