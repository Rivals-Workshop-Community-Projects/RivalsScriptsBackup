...
set_window_value(AT_DTILT2, 1, AG_WINDOW_LENGTH, 7);
...
set_window_value(AT_DTILT2, 1, AG_WINDOW_SFX_FRAME, 6);
...
set_hitbox_value(AT_DTILT2, 2, HG_VISUAL_EFFECT, shock_big);
