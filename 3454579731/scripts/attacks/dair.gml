...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sound_get("sfx_twirl"));
...
set_hitbox_value(AT_DAIR, 1, HG_HEIGHT, 23);
...
set_hitbox_value(AT_DAIR, 2, HG_DRIFT_MULTIPLIER, 1.2);
...
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, sound_get("sfx_sharp_hit_weak"));
