...
sprite_index = sprite_get("lava_spawn");           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
...
sprite[0] = sprite_get("lava_spawn");
sprite[1] = sprite_get("lava_idle"); 
sprite[2] = sprite_get("lava_death"); 
