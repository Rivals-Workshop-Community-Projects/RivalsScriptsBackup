...
set_window_value(AT_NAIR, 2, AG_WINDOW_TYPE, 1); //active 1
...
set_window_value(AT_NAIR, 4, AG_WINDOW_TYPE, 1); //active 2
...
set_hitbox_value(AT_NAIR, 1, HG_HITBOX_X, 50);
...
set_hitbox_value(AT_NAIR, 1, HG_BASE_KNOCKBACK, 6.2);
...
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, -11);
