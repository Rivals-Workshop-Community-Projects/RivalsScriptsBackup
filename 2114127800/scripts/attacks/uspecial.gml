...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, sound_get("sfx_transform"));
...
set_window_value(AT_USPECIAL, 7, AG_WINDOW_LENGTH, 21);
set_window_value(AT_USPECIAL, 7, AG_WINDOW_ANIM_FRAMES, 9);
...
set_window_value(AT_USPECIAL, 7, AG_WINDOW_SFX, asset_get("sfx_absa_concentrate"));
...
set_window_value(AT_USPECIAL, 8, AG_WINDOW_ANIM_FRAME_START, 24);
...
set_hitbox_value(AT_USPECIAL, 5, HG_KNOCKBACK_SCALING, 0.9);
...
set_hitbox_value(AT_USPECIAL, 5, HG_HIT_SFX, asset_get("sfx_burnconsume"));
...
set_hitbox_value(AT_USPECIAL, 6, HG_WINDOW_CREATION_FRAME, 19);
set_hitbox_value(AT_USPECIAL, 6, HG_HITBOX_X, 0);
set_hitbox_value(AT_USPECIAL, 6, HG_HITBOX_Y, -22);
set_hitbox_value(AT_USPECIAL, 6, HG_WIDTH, 150);
set_hitbox_value(AT_USPECIAL, 6, HG_HEIGHT, 150);
