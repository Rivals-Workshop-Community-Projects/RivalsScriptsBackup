...
set_window_value(AT_DATTACK, 4, AG_WINDOW_SFX, sound_get("sfx_spin"));
set_window_value(AT_DATTACK, 4, AG_WINDOW_TYPE, 1);
set_window_value(AT_DATTACK, 4, AG_WINDOW_LENGTH, 25);
set_window_value(AT_DATTACK, 4, AG_WINDOW_ANIM_FRAMES, 15);
...
set_window_value(AT_DATTACK, 5, AG_WINDOW_ANIM_FRAME_START, 25);
...
set_hitbox_value(AT_DATTACK, 3, HG_LIFETIME, 19);
set_hitbox_value(AT_DATTACK, 3, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_DATTACK, 3, HG_HITBOX_Y, -43);
...
set_hitbox_value(AT_DATTACK, 3, HG_HIT_SFX, sound_get("sfx_spin_hit"));