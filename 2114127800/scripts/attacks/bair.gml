...
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_Y, -90);
...
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, -11);
...
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_Y, -98);
...
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, -15);
...
set_hitbox_value(AT_BAIR, 3, HG_HITBOX_Y, -67);
...
set_hitbox_value(AT_BAIR, 3, HG_BASE_KNOCKBACK, 4.5);
...
set_hitbox_value(AT_BAIR, 3, HG_VISUAL_EFFECT_Y_OFFSET, -11);
...
set_hitbox_value(AT_BAIR, 4, HG_HITBOX_X, -47);
set_hitbox_value(AT_BAIR, 4, HG_HITBOX_Y, -47);
set_hitbox_value(AT_BAIR, 4, HG_WIDTH, 25);
set_hitbox_value(AT_BAIR, 4, HG_HEIGHT, 20);
set_hitbox_value(AT_BAIR, 4, HG_PRIORITY, 2);
set_hitbox_value(AT_BAIR, 4, HG_DAMAGE, 10);
set_hitbox_value(AT_BAIR, 4, HG_ANGLE, -95);
...
set_hitbox_value(AT_BAIR, 4, HG_VISUAL_EFFECT_Y_OFFSET, -15);
...
set_hitbox_value(AT_BAIR, 5, HG_BASE_KNOCKBACK, 4.5);
set_hitbox_value(AT_BAIR, 5, HG_KNOCKBACK_SCALING, .4);
set_hitbox_value(AT_BAIR, 5, HG_BASE_HITPAUSE, 4);
set_hitbox_value(AT_BAIR, 5, HG_HITPAUSE_SCALING, .3);
set_hitbox_value(AT_BAIR, 5, HG_VISUAL_EFFECT_X_OFFSET, 10);
set_hitbox_value(AT_BAIR, 5, HG_VISUAL_EFFECT_Y_OFFSET, -11);
...
set_hitbox_value(AT_BAIR, 6, HG_HITBOX_X, -9);
set_hitbox_value(AT_BAIR, 6, HG_HITBOX_Y, -16);
set_hitbox_value(AT_BAIR, 6, HG_WIDTH, 20);
set_hitbox_value(AT_BAIR, 6, HG_HEIGHT, 25);
set_hitbox_value(AT_BAIR, 6, HG_PRIORITY, 2);
set_hitbox_value(AT_BAIR, 6, HG_DAMAGE, 10);
set_hitbox_value(AT_BAIR, 6, HG_ANGLE, -95);
set_hitbox_value(AT_BAIR, 6, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_BAIR, 6, HG_KNOCKBACK_SCALING, .8);
set_hitbox_value(AT_BAIR, 6, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_BAIR, 6, HG_HITPAUSE_SCALING, .5);
set_hitbox_value(AT_BAIR, 6, HG_VISUAL_EFFECT_X_OFFSET, 10);
set_hitbox_value(AT_BAIR, 6, HG_VISUAL_EFFECT_Y_OFFSET, -15);
set_hitbox_value(AT_BAIR, 6, HG_HIT_SFX, asset_get("sfx_blow_heavy1"));
