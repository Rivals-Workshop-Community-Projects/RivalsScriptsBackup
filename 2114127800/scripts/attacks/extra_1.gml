...
set_hitbox_value(AT_EXTRA_1, 2, HG_VISUAL_EFFECT_X_OFFSET, 30);
set_hitbox_value(AT_EXTRA_1, 2, HG_VISUAL_EFFECT_Y_OFFSET, 10);
set_hitbox_value(AT_EXTRA_1, 2, HG_HIT_SFX, asset_get("sfx_burnapplied"));
...
set_hitbox_value(AT_NSPECIAL, 3, HG_PARENT_HITBOX, 4);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_VISUAL_EFFECT, 137);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("puddle_proj"));
set_hitbox_value(AT_NSPECIAL, 3, HG_PROJECTILE_MASK, sprite_get("puddle_proj"));
...
set_hitbox_value(AT_EXTRA_1, 4, HG_HITBOX_Y, 80);
set_hitbox_value(AT_EXTRA_1, 4, HG_WIDTH, 80);
set_hitbox_value(AT_EXTRA_1, 4, HG_HEIGHT, 20);
...
set_hitbox_value(AT_EXTRA_1, 4, HG_VISUAL_EFFECT, 3);
set_hitbox_value(AT_EXTRA_1, 4, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_EXTRA_1, 4, HG_HITPAUSE_SCALING, .6);
set_hitbox_value(AT_EXTRA_1, 4, HG_VISUAL_EFFECT_X_OFFSET, 30);
set_hitbox_value(AT_EXTRA_1, 4, HG_VISUAL_EFFECT_Y_OFFSET, 10);
set_hitbox_value(AT_EXTRA_1, 4, HG_HIT_SFX, asset_get("sfx_burnapplied"));
...
set_hitbox_value(AT_EXTRA_1, 4, HG_TECHABLE, 3);