...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, sound_get("motor1"));
...
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX,  sound_get("bloodlight1"));
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT, BloodFX1);
...
set_hitbox_value(AT_DTILT, 2, HG_HIT_SFX,  sound_get("Med Slash"));
set_hitbox_value(AT_DTILT, 2, HG_VISUAL_EFFECT, BloodFX1);
