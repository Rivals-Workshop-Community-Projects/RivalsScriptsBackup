...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_orca_bite"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HITBOX_X, 39);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HIT_SFX, sound_get("bloodmed2"));
set_hitbox_value(AT_DSPECIAL, 1, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_DSPECIAL, 1, HG_TECHABLE, 1);
set_hitbox_value(AT_DSPECIAL, 1, HG_VISUAL_EFFECT, BloodFX2);
