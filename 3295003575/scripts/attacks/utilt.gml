...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("motor1"));
...
set_hitbox_value(AT_UTILT, 1, HG_WIDTH, 97);
...
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sound_get("Med Slash"));
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, BloodFX1);
...
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, sound_get("Med Slash"));
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, BloodFX1);