...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("bloodlight2"));
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, sound_get("motor1"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 206);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("bloodmed2"));
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, BloodFX2);