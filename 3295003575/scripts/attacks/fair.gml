...
set_hitbox_value(AT_FAIR, 1, HG_HITBOX_X, -3);
...
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, sound_get("bloodlight1"));
set_hitbox_value(AT_FAIR, 1, HG_VISUAL_EFFECT, BloodFX1);
...
set_hitbox_value(AT_FAIR, 2, HG_HIT_SFX, sound_get("Med Slash"));
set_hitbox_value(AT_FAIR, 2, HG_VISUAL_EFFECT, BloodFX1);
set_hitbox_value(AT_FAIR, 2, HG_ANGLE_FLIPPER, 6);

set_hitbox_value(AT_FAIR, 3, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_FAIR, 3, HG_WINDOW, 2);
set_hitbox_value(AT_FAIR, 3, HG_LIFETIME, 4);
set_hitbox_value(AT_FAIR, 3, HG_HITBOX_X, 23);
...
set_hitbox_value(AT_FAIR, 3, HG_BASE_HITPAUSE, 28);
...
set_hitbox_value(AT_FAIR, 3, HG_HIT_SFX, sound_get("bloodmed2"));
set_hitbox_value(AT_FAIR, 3, HG_VISUAL_EFFECT, BloodFX2);