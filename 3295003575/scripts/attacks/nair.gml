...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, sound_get("motor1"));
...
set_hitbox_value(AT_NAIR, 1, HG_WIDTH, 107);
set_hitbox_value(AT_NAIR, 1, HG_HEIGHT, 109);
...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sound_get("bloodlight1"));
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT, BloodFX1);
...
set_hitbox_value(AT_NAIR, 3, HG_WIDTH, 107);
set_hitbox_value(AT_NAIR, 3, HG_HEIGHT, 109);
...
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, sound_get("bloodlight1"));
set_hitbox_value(AT_NAIR, 3, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_NAIR, 4, HG_VISUAL_EFFECT, BloodFX1);
...
set_hitbox_value(AT_NAIR, 4, HG_HITBOX_Y, -7);
set_hitbox_value(AT_NAIR, 4, HG_WIDTH, 107);
set_hitbox_value(AT_NAIR, 4, HG_HEIGHT, 109);
...
set_hitbox_value(AT_NAIR, 4, HG_HIT_SFX, sound_get("bloodlight1"));
set_hitbox_value(AT_NAIR, 4, HG_VISUAL_EFFECT, BloodFX1);
...
set_hitbox_value(AT_NAIR, 5, HG_HITBOX_Y, -8);
set_hitbox_value(AT_NAIR, 5, HG_WIDTH, 107);
set_hitbox_value(AT_NAIR, 5, HG_HEIGHT, 109);
...
set_hitbox_value(AT_NAIR, 5, HG_HIT_SFX, sound_get("bloodlight1"));
set_hitbox_value(AT_NAIR, 5, HG_VISUAL_EFFECT, BloodFX1);
