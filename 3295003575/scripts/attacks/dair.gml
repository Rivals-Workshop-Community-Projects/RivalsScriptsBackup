...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sound_get("motor1"));
...
set_hitbox_value(AT_DAIR, 1, HG_HITBOX_X, 17);
...
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, sound_get("bloodlight1"));
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, BloodFX1);
...
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT, BloodFX1);
...
set_hitbox_value(AT_DAIR, 3, HG_HIT_SFX, sound_get("bloodlight1"));
set_hitbox_value(AT_DAIR, 3, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_DAIR, 3, HG_VISUAL_EFFECT, BloodFX1);
...
set_hitbox_value(AT_DAIR, 4, HG_HITBOX_Y, 33);
set_hitbox_value(AT_DAIR, 4, HG_WIDTH, 45);
set_hitbox_value(AT_DAIR, 4, HG_HEIGHT, 61);
...
set_hitbox_value(AT_DAIR, 4, HG_HIT_SFX, sound_get("bloodlight1"));
set_hitbox_value(AT_DAIR, 4, HG_HITBOX_GROUP, 3);
set_hitbox_value(AT_DAIR, 4, HG_VISUAL_EFFECT, BloodFX1);
