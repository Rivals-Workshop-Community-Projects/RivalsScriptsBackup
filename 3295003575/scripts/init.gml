...
BloodFX1 = hit_fx_create(sprite_get("bloodfx1"), 28);
BloodFX2 = hit_fx_create(sprite_get("bloodfx2"), 28);
BloodFX3 = hit_fx_create(sprite_get("bloodfx3"), 28);
Bloodstab = hit_fx_create(sprite_get("bloodstab"), 28);
Bloodstab2 = hit_fx_create(sprite_get("bloodstab2"), 28);
