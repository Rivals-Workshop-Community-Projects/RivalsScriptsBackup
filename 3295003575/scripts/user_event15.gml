...
initTip("NSpecial: Revving");
initWords("Denji will revv his engine and will damage himself a bit, but it will give himself numerous buffs");
initWords("his damage and speed will be increased and he will gain a third jump ");
initWords("The revving buff will last for 10 seconds and then it will be on a cooldown");
...
initTip("FSpecial: Chainsaw Dash");
initWords("Denji will dash forward, damaging anything in his path");
initWords("it has a first frame sweetspot that will deal way more damage and have more knockback");
initWords("\Additionally, if Revved, the fspecial will be empowered into a Chainsaw Kick");
initImage_ext(sprite_get("fspecial"), -4, fa_center, 1, 1, true, c_white, 1, false, noone, noone, noone, noone);

initTip("USpecial: Chain grab");
initWords("This move have two versions, air and grounded.");
initWords("the air version will make denji use his chain to grapple himself upwards");
initWords("the ground version will make him able to grab his opponent using his chain and propel both of them to each other");
initImage_ext(sprite_get("uspecial_ground"), -4, fa_center, 1, 1, true, c_white, 1, false, noone, noone, noone, noone);

initTip("DSpecial: Blood Bite");
initWords("Denji will charge up a bite, after the button is released, he will bite forwards, the bite will heal him");
initWords("charging it longer will make the bite deal more damage, however the heal wont increase");
