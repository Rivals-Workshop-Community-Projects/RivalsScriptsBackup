...
easy_window("active_front",
    AG_WINDOW_LENGTH, 7,
    AG_WINDOW_SFX, asset_get("sfx_swipe_heavy1"),
)

easy_hitbox(1,
    HG_WINDOW, get_window_index("active_front"),
    HG_LIFETIME, 7,
    HG_HITBOX_X, 30,
    HG_HITBOX_Y, -10,
    HG_HEIGHT, 50,
...
easy_window("active_back",
    AG_WINDOW_LENGTH, 5,
    AG_WINDOW_SFX, asset_get("sfx_swipe_heavy1"),
)

easy_hitbox(2,
    HG_WINDOW, get_window_index("active_back"),
    HG_LIFETIME, 5,
    HG_HITBOX_X, -10, //-35,
    HG_HITBOX_Y, -10,
    HG_HEIGHT, 50,
...
#macro ACTIVE_FRONT_FRAMES 1
#define _get_active_front_frames()
    return ACTIVE_FRONT_FRAMES
#macro ACTIVE_FRONT_FRAME_START 1
#define _get_active_front_frame_start()
    return ACTIVE_FRONT_FRAME_START

#macro ACTIVE_BACK_FRAMES 1
#define _get_active_back_frames()
    return ACTIVE_BACK_FRAMES
#macro ACTIVE_BACK_FRAME_START 2
#define _get_active_back_frame_start()
    return ACTIVE_BACK_FRAME_START
