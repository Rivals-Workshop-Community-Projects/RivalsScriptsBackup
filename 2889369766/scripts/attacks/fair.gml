...
set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, sound_get("sora_slash2"));
...
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, sound_get("sora_swordhit1"));
...
set_hitbox_value(AT_FAIR, 2, HG_HIT_SFX, sound_get("sora_swordhit1"));