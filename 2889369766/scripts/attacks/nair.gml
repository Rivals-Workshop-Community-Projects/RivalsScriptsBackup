...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sound_get("sora_swordhit2"));
...
set_hitbox_value(AT_NAIR, 3, HG_HEIGHT, 108);
...
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, sound_get("sora_swordhit1"));
