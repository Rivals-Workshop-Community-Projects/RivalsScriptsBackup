...
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, sound_get("sora_slash1"));
...
set_window_value(AT_JAB, 4, AG_WINDOW_SFX, asset_get("sfx_oly_nspecial_shoot"));
...
set_hitbox_value(AT_JAB, 1, HG_WIDTH, 73);
...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("sora_swordhit2"));
...
set_hitbox_value(AT_JAB, 2, HG_VISUAL_EFFECT, 310);
...
set_hitbox_value(AT_JAB, 3, HG_VISUAL_EFFECT, 310);
