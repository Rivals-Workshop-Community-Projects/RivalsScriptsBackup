...
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, sound_get("sora_swordhit2"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HEIGHT, 72);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HIT_SFX, sound_get("sora_swordhit1"));