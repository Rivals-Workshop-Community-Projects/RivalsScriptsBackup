...
set_window_value(AT_FTILT, 4, AG_WINDOW_SFX, sound_get("sora_slash2"));
...
set_hitbox_value(AT_FTILT, 2, HG_HEIGHT, 73);
...
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, sound_get("sora_swordhit1"));