...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, asset_get("sfx_oly_nspecial_shoot"));
...
set_hitbox_value(AT_DAIR, 1, HG_WIDTH, 108);
...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, 311);
...
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT, 311);
