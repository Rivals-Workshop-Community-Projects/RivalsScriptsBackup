...
set_hitbox_value(AT_EXTRA_1, 1, HG_ANGLE, 130);
...
//set_hitbox_value(AT_EXTRA_1, 1, HG_HIT_SFX, sound_get("explode1"));
...
set_hitbox_value(AT_EXTRA_1, 1, HG_PROJECTILE_SPRITE, asset_get("empty_sprite")); // hope this works lol
set_hitbox_value(AT_EXTRA_1, 1, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_EXTRA_1, 1, HG_PROJECTILE_ANIM_SPEED, .25);
...
set_hitbox_value(AT_EXTRA_1, 1, HG_PROJECTILE_DESTROY_EFFECT, 13);
set_hitbox_value(AT_EXTRA_1, 1, HG_PROJECTILE_PARRY_STUN, 1); // suffer
set_hitbox_value(AT_EXTRA_1, 1, HG_EXTENDED_PARRY_STUN, 1);
//set_hitbox_value(AT_EXTRA_1, 1, HG_PROJECTILE_COLLISION_SPRITE, sprite_get("fspecial_proj_collision"));