...
// startup 
set_window_value(AT_NAIR, 1, AG_WINDOW_LENGTH, 4); // 6 if this proves too little
...
// endlag 
set_window_value(AT_NAIR, 3, AG_WINDOW_LENGTH, 14); // do 16 if this proves too little
...
//set_hitbox_value(AT_NAIR, 1, HG_ANGLE_FLIPPER, 10); // eh
