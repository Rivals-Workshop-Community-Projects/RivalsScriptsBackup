...
// this move will be needing some balancing Lol!

// startup
set_window_value(AT_UAIR, 1, AG_WINDOW_TYPE, 1);
set_window_value(AT_UAIR, 1, AG_WINDOW_LENGTH, 10); // set to 12 if too op
...
set_window_value(AT_UAIR, 3, AG_WINDOW_LENGTH, 15); // set to 20 if too op
...
set_hitbox_value(AT_UAIR, 1, HG_ANGLE, 90); // be grateful this isn't 86 or 93 or something dum like that
...
set_hitbox_value(AT_UAIR, 2, HG_HEIGHT, 88);
