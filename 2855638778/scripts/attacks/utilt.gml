...
// startup
set_window_value(AT_UTILT, 1, AG_WINDOW_LENGTH, 7); // set to 9 if this is "too op"
...
// endlag
set_window_value(AT_UTILT, 3, AG_WINDOW_LENGTH, 12); // set to 16 if this is "too op"
...
set_hitbox_value(AT_UTILT, 2, HG_HITPAUSE_SCALING, .30);
