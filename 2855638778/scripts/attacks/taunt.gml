...
set_attack_value(AT_TAUNT, AG_HURTBOX_SPRITE, sprite_get("soldier_hurtbox"));
...
set_window_value(AT_TAUNT, 4, AG_WINDOW_SFX, sound_get("soldier_taunt"));
set_window_value(AT_TAUNT, 4, AG_WINDOW_SFX_FRAME, 5);
