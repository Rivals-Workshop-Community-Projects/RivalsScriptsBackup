...
set_window_value(AT_BAIR, 3, AG_WINDOW_LENGTH, 12); // 7
...
set_hitbox_value(AT_BAIR, 1, HG_DAMAGE, 8); // 5
...
set_hitbox_value(AT_BAIR, 2, HG_HEIGHT, 43);
set_hitbox_value(AT_BAIR, 2, HG_PRIORITY, 2);
set_hitbox_value(AT_BAIR, 2, HG_SHAPE, 0);
set_hitbox_value(AT_BAIR, 2, HG_DAMAGE, 8); // 5
