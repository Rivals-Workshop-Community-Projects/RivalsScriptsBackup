...
set_window_value(AT_NAIR, 1, AG_WINDOW_LENGTH, 7); // 4
...
set_hitbox_value(AT_NAIR, 1, HG_ANGLE_FLIPPER, 6); // 290
...
set_hitbox_value(AT_NAIR, 1, HG_HITPAUSE_SCALING, .85);
