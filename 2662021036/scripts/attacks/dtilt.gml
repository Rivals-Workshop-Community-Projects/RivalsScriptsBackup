...
set_window_value(AT_DTILT, 2, AG_WINDOW_SFX, sound_get("vileplume_dtilt"));

set_window_value(AT_DTILT, 3, AG_WINDOW_LENGTH, 4);
set_window_value(AT_DTILT, 3, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_DTILT, 3, AG_WINDOW_ANIM_FRAME_START, 2);

set_window_value(AT_DTILT, 4, AG_WINDOW_LENGTH, 14); // 10
...
set_hitbox_value(AT_DTILT, 1, HG_WIDTH, 132);
...
set_hitbox_value(AT_DTILT, 1, HG_HITPAUSE_SCALING, .75);
