...
spr_nspecial_front = sprite_get("nspecial_front");
spr_nspecial_up = sprite_get("nspecial_up");
spr_nspecial_back = sprite_get("nspecial_back");
spr_nspecial_down = sprite_get("nspecial_down");
spr_nspecial_clear = sprite_get("nspecial_spin");
...
// with other print(phone.settings)
	...
	initSetting("FPS Warning", "setting_fps_warn", [0, 1], ["Off", "On"], "Display a warning onscreen when the FPS drops below 60.");
