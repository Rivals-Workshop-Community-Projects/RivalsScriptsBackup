...
//set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, sound_get("monarch_smallblink1"));

// Intangible
set_window_value(AT_NAIR, 2, AG_WINDOW_TYPE, 1);
set_window_value(AT_NAIR, 2, AG_WINDOW_LENGTH, 0);
...
//set_window_value(AT_NAIR, 2, AG_WINDOW_SFX, sound_get("monarch_smallblink2"));
...
set_window_value(AT_NAIR, 3, AG_WINDOW_SFX, sound_get("monarch_woosh3"));
...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sound_get("monarch_knifehit3"));
