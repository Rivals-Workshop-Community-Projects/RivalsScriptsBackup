...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, sound_get("monarch_gunshot1"));
...
set_hitbox_value(AT_DTILT, 1, HG_WIDTH, 50); // 30
...
set_hitbox_value(AT_DTILT, 1, HG_BASE_KNOCKBACK, 6.2);
...
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT, hitfx10);
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_Y_OFFSET, 10);
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, sound_get("monarch_gunhit1"));