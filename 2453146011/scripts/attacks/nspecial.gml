...
set_attack_value(AT_NSPECIAL, AG_HURTBOX_AIR_SPRITE, sprite_get("nspecial_hurt_front_air"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HITBOX_Y, -7);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("beam"));
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, empty_fx);
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, empty_fx);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_VISUAL_EFFECT, empty_fx);
