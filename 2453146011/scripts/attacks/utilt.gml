...
set_hitbox_value(AT_UTILT, 7, HG_KNOCKBACK_SCALING, .2);
...
set_hitbox_value(AT_UTILT, 8, HG_KNOCKBACK_SCALING, .2);
...
set_hitbox_value(AT_UTILT, 9, HG_KNOCKBACK_SCALING, .2);
