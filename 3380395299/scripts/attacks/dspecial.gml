...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, .15);
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX_FRAME, 6);
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, sound_get("beep4"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HIT_SFX, sound_get("beep5"));
