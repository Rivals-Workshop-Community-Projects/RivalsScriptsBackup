...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, sound_get("beep10"));
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, sound_get("beep11"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_HITPAUSE_SCALING, .55);
