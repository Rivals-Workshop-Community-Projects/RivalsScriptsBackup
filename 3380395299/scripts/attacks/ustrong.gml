...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, sound_get("beep16"));
...
set_window_value(AT_USTRONG, 4, AG_WINDOW_SFX, sound_get("beep16"));
...
set_hitbox_value(AT_USTRONG, 1, HG_SDI_MULTIPLIER, .001);
set_hitbox_value(AT_USTRONG, 1, HG_DRIFT_MULTIPLIER, .001);
