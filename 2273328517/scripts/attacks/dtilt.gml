...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, sound_get("static1"));
...
set_hitbox_value(AT_DTILT, 1, HG_HITBOX_Y, -64);
set_hitbox_value(AT_DTILT, 1, HG_WIDTH, 66);
set_hitbox_value(AT_DTILT, 1, HG_HEIGHT, 163);
...
set_hitbox_value(AT_DTILT, 3, HG_VISUAL_EFFECT, 306);
