...
set_hitbox_value(AT_FTHROW, 1, HG_HITBOX_X, 2);
set_hitbox_value(AT_FTHROW, 1, HG_HITBOX_Y, 3);
set_hitbox_value(AT_FTHROW, 1, HG_WIDTH, 46);
...
set_hitbox_value(AT_FTHROW, 1, HG_EFFECT, 12);
