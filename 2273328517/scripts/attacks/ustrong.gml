...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, sound_get("weird_swing1"));
...
set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX, sound_get("tv_hit"));
...
set_hitbox_value(AT_USTRONG, 3, HG_HEIGHT, 104);
...
set_hitbox_value(AT_USTRONG, 4, HG_WIDTH, 64);
set_hitbox_value(AT_USTRONG, 4, HG_HEIGHT, 114);
...
set_hitbox_value(AT_USTRONG, 4, HG_HIT_SFX, asset_get("sfx_blow_heavy1"));//asset_get("sfx_blow_heavy1"));
...
//set_hitbox_value(AT_USTRONG, 4, HG_ANGLE, 30);
...
set_hitbox_value(AT_USTRONG, 4, HG_HIT_SFX, sound_get("weird_hit1"));
...
//set_hitbox_value(AT_USTRONG, 4, HG_PROJECTILE_DESTROY_EFFECT, asset_get("empty_sprite"));*/