...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, sound_get("jab_boom"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("spam_empty"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_LIFETIME, 25);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_EXTENDED_PARRY_STUN, false);
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("spamhead"));
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_MASK, sprite_get("spamhead"));
...
set_hitbox_value(AT_NSPECIAL, 3, HG_ANGLE, 125);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_EXTENDED_PARRY_STUN, false);
set_hitbox_value(AT_NSPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("spamhead"));
set_hitbox_value(AT_NSPECIAL, 3, HG_PROJECTILE_MASK, sprite_get("spamhead"));
...
set_hitbox_value(AT_NSPECIAL, 4, HG_EXTENDED_PARRY_STUN, false);
set_hitbox_value(AT_NSPECIAL, 4, HG_PROJECTILE_SPRITE, sprite_get("spamheadgreen"));
set_hitbox_value(AT_NSPECIAL, 4, HG_PROJECTILE_MASK, sprite_get("spamheadgreen"));
