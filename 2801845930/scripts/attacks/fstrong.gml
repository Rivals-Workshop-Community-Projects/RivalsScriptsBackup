...
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_Y, -57);
...
set_hitbox_value(AT_FSTRONG, 2, HG_ANGLE, 250);
...
set_hitbox_value(AT_FSTRONG, 2, HG_EFFECT, 15);
set_hitbox_value(AT_FSTRONG, 2, HG_HITSTUN_MULTIPLIER, 0.7);
