...
set_window_value(AT_USTRONG, 1, AG_WINDOW_SFX, sound_get("jab_start"));
...
set_window_value(AT_USTRONG, 4, AG_WINDOW_SFX, sound_get("jab_blast"));
...
set_hitbox_value(AT_USTRONG, 2, HG_HITPAUSE_SCALING, 0.95);
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, stringhfx);
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("jab_boom"));
