...
sprite_change_offset("ftilt", 62, 68);
sprite_change_offset("dtilt", 30, 60);
sprite_change_offset("utilt", 48, 102);
sprite_change_offset("nair", 23, 62);
sprite_change_offset("fair", 51, 70);
sprite_change_offset("bair", 70, 94);
sprite_change_offset("uair", 58,136);
sprite_change_offset("dair", 56, 98);
...
sprite_change_offset("handsTarget", 8, 9);