...
set_hitbox_value(AT_FSTRONG, 8, HG_BASE_HITPAUSE, 15);
set_hitbox_value(AT_FSTRONG, 8, HG_HITPAUSE_SCALING, 0.9);      
...
set_hitbox_value(AT_FSTRONG, 9, HG_KNOCKBACK_SCALING, 0.25);
