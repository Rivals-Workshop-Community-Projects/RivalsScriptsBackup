...
set_hitbox_value(AT_FAIR, 1, HG_HEIGHT, 72);
...
set_hitbox_value(AT_FAIR, 2, HG_HITBOX_X, 3);
...
set_hitbox_value(AT_FAIR, 3, HG_HITBOX_X, 3);
...
set_hitbox_value(AT_FAIR, 3, HG_HITPAUSE_SCALING, .85);
