...
set_hitbox_value(AT_BAIR, 3, HG_HEIGHT, 53);
...
set_hitbox_value(AT_BAIR, 3, HG_BASE_HITPAUSE, 14);
...
set_hitbox_value(AT_BAIR, 3, HG_ANGLE_FLIPPER, 0);set_hitbox_value(AT_BAIR, 1, HG_HITBOX_GROUP, 1);