...
set_attack_value(AT_NSPECIAL_2, AG_HURTBOX_SPRITE, sprite_get("fstrong_hurt"));
...
set_window_value(AT_NSPECIAL_2, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, .2);
...
set_hitbox_value(AT_NSPECIAL_2, 1, HG_WIDTH, 84);
...
set_hitbox_value(AT_NSPECIAL_2, 1, HG_BASE_HITPAUSE, 18);
...
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HIT_SFX, asset_get("sfx_burnconsume"));
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HIT_LOCKOUT, 10);