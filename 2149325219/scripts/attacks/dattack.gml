...
set_window_value(AT_DATTACK, 3, AG_WINDOW_LENGTH, 32);
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .048);
...
set_hitbox_value(AT_DATTACK, 1, HG_LIFETIME, 40);
