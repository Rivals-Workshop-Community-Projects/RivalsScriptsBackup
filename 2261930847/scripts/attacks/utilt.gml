...
set_hitbox_value(AT_UTILT, 2, HG_HITBOX_Y, -8);
...
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, asset_get("sfx_waterhit_weak"));
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, 6);
...
set_hitbox_value(AT_UTILT, 3, HG_VISUAL_EFFECT, 150);
