...
set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX, sound_get("sfx_usmash"));
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, 138);
...
set_hitbox_value(AT_USTRONG, 3, HG_HEIGHT, 190);
...
set_hitbox_value(AT_USTRONG, 3, HG_VISUAL_EFFECT, 195);
...
set_hitbox_value(AT_USTRONG, 4, HG_HITBOX_Y, -200);
...
set_hitbox_value(AT_USTRONG, 4, HG_BASE_KNOCKBACK, 6.5);
...
set_hitbox_value(AT_USTRONG, 4, HG_VISUAL_EFFECT, 195);
