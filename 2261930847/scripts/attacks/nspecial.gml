...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("sfx_nspecial"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_ANIM_SPEED, .45);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_WINDOW, 87);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HITBOX_Y, 200);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_ANIM_SPEED, .45);
