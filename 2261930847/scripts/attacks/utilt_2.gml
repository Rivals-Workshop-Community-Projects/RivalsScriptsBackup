...
set_attack_value(AT_UTILT_2, AG_NUM_WINDOWS, 5);
set_attack_value(AT_UTILT_2, AG_HURTBOX_SPRITE, sprite_get("utilt_mud_hurt"));

//Startup
set_window_value(AT_UTILT_2, 1, AG_WINDOW_TYPE, 1);
set_window_value(AT_UTILT_2, 1, AG_WINDOW_LENGTH, 8);
set_window_value(AT_UTILT_2, 1, AG_WINDOW_ANIM_FRAMES, 1);
...
set_window_value(AT_UTILT_2, 2, AG_WINDOW_LENGTH, 3);
set_window_value(AT_UTILT_2, 2, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_UTILT_2, 2, AG_WINDOW_ANIM_FRAME_START, 1);

set_window_value(AT_UTILT_2, 3, AG_WINDOW_TYPE, 1);
set_window_value(AT_UTILT_2, 3, AG_WINDOW_LENGTH, 9);
set_window_value(AT_UTILT_2, 3, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_UTILT_2, 3, AG_WINDOW_ANIM_FRAME_START, 2);

set_window_value(AT_UTILT_2, 4, AG_WINDOW_TYPE, 1);
set_window_value(AT_UTILT_2, 4, AG_WINDOW_LENGTH, 3);
set_window_value(AT_UTILT_2, 4, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_UTILT_2, 4, AG_WINDOW_ANIM_FRAME_START, 5);

//Endlag
set_window_value(AT_UTILT_2, 5, AG_WINDOW_TYPE, 1);
set_window_value(AT_UTILT_2, 5, AG_WINDOW_LENGTH, 8);
set_window_value(AT_UTILT_2, 5, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_UTILT_2, 5, AG_WINDOW_ANIM_FRAME_START, 6);
set_window_value(AT_UTILT_2, 5, AG_WINDOW_HAS_WHIFFLAG, 1);
...
set_hitbox_value(AT_UTILT_2, 1, HG_WINDOW, 3);
set_hitbox_value(AT_UTILT_2, 1, HG_LIFETIME, 3);
...
set_hitbox_value(AT_UTILT_2, 1, HG_BASE_KNOCKBACK, 6);
...
set_hitbox_value(AT_UTILT_2, 1, HG_HIT_SFX, asset_get("sfx_blow_medium1"));
...
set_hitbox_value(AT_UTILT_2, 6, HG_WINDOW, 2);
set_hitbox_value(AT_UTILT_2, 6, HG_LIFETIME, 3);
...
set_hitbox_value(AT_UTILT_2, 2, HG_WINDOW, 3);
set_hitbox_value(AT_UTILT_2, 2, HG_LIFETIME, 3);
...
set_hitbox_value(AT_UTILT_2, 2, HG_DAMAGE, 6);
...
set_hitbox_value(AT_UTILT_2, 3, HG_WINDOW, 3);
set_hitbox_value(AT_UTILT_2, 3, HG_WINDOW_CREATION_FRAME, 3);
...
set_hitbox_value(AT_UTILT_2, 4, HG_WINDOW, 3);
set_hitbox_value(AT_UTILT_2, 4, HG_WINDOW_CREATION_FRAME, 6);
...
set_hitbox_value(AT_UTILT_2, 4, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_UTILT_2, 4, HG_HITPAUSE_SCALING, .3);
...
set_hitbox_value(AT_UTILT_2, 5, HG_WINDOW, 4);
...
set_hitbox_value(AT_UTILT_2, 5, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_UTILT_2, 5, HG_HITPAUSE_SCALING, .3);
