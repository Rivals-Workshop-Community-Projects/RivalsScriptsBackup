...
set_hitbox_value(AT_NAIR, 1, HG_BASE_KNOCKBACK, 2.25);
...
set_hitbox_value(AT_NAIR, 2, HG_BASE_KNOCKBACK, 2.25);
set_hitbox_value(AT_NAIR, 2, HG_KNOCKBACK_SCALING, 0);
set_hitbox_value(AT_NAIR, 2, HG_BASE_HITPAUSE, 2.5);
...
set_hitbox_value(AT_NAIR, 3, HG_SDI_MULTIPLIER, 0.5);
set_hitbox_value(AT_NAIR, 3, HG_ANGLE, 45);
set_hitbox_value(AT_NAIR, 3, HG_ANGLE_FLIPPER, 9);
set_hitbox_value(AT_NAIR, 3, HG_BASE_KNOCKBACK, 2.25);
set_hitbox_value(AT_NAIR, 3, HG_KNOCKBACK_SCALING, 0);
set_hitbox_value(AT_NAIR, 3, HG_BASE_HITPAUSE, 2.5);
...
set_hitbox_value(AT_NAIR, 4, HG_BASE_KNOCKBACK, 2.25);
set_hitbox_value(AT_NAIR, 4, HG_KNOCKBACK_SCALING, 0);
set_hitbox_value(AT_NAIR, 4, HG_BASE_HITPAUSE, 2.5);
...
set_hitbox_value(AT_NAIR, 5, HG_BASE_KNOCKBACK, 7.25);
