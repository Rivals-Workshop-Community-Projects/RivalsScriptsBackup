...
set_window_value(AT_FSTRONG_2, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .1);
...
set_window_value(AT_FSTRONG_2, 5, AG_WINDOW_LENGTH, 8);
...
set_window_value(AT_FSTRONG_2, 6, AG_WINDOW_LENGTH, 9);
...
set_hitbox_value(AT_FSTRONG_2, 2, HG_KNOCKBACK_SCALING, 1.15);
