...
set_window_value(AT_DSTRONG_2, 2, AG_WINDOW_LENGTH, 2);
...
set_window_value(AT_DSTRONG_2, 4, AG_WINDOW_SFX_FRAME, 1);

set_window_value(AT_DSTRONG_2, 5, AG_WINDOW_TYPE, 1);
set_window_value(AT_DSTRONG_2, 5, AG_WINDOW_LENGTH, 4);
set_window_value(AT_DSTRONG_2, 5, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_DSTRONG_2, 5, AG_WINDOW_ANIM_FRAME_START, 6);

//Endlag
set_window_value(AT_DSTRONG_2, 6, AG_WINDOW_TYPE, 1);
set_window_value(AT_DSTRONG_2, 6, AG_WINDOW_LENGTH, 20);
...
set_hitbox_value(AT_DSTRONG_2, 3, HG_DAMAGE, 9);
set_hitbox_value(AT_DSTRONG_2, 3, HG_ANGLE, 90);
set_hitbox_value(AT_DSTRONG_2, 3, HG_BASE_KNOCKBACK, 10);
set_hitbox_value(AT_DSTRONG_2, 3, HG_KNOCKBACK_SCALING, 1.1);
...
set_hitbox_value(AT_DSTRONG_2, 4, HG_WINDOW, 5);
...
set_hitbox_value(AT_DSTRONG_2, 4, HG_DAMAGE, 9);
set_hitbox_value(AT_DSTRONG_2, 4, HG_ANGLE, 90);
set_hitbox_value(AT_DSTRONG_2, 4, HG_BASE_KNOCKBACK, 10);
set_hitbox_value(AT_DSTRONG_2, 4, HG_KNOCKBACK_SCALING, 1.1);
