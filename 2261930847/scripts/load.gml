...
sprite_change_offset("bighurt", 68, 89);
sprite_change_offset("downhurt", 68, 89);
...
sprite_change_offset("dashstop", 40,62);
sprite_change_offset("dashturn", 40, 62);

sprite_change_offset("jumpstart", 40, 62);
sprite_change_offset("jump", 40, 62);
sprite_change_offset("doublejump", 40, 62);
...
sprite_change_offset("waveland", 38, 62);
...
sprite_change_offset("utilt", 44, 90);
sprite_change_offset("utilt_mud", 54, 110);
...
sprite_change_offset("fstrong_mud", 40, 61);
...
sprite_change_offset("fspecial2", 56, 86);
...
sprite_change_offset("plat", 96, 10);

sprite_change_offset("nspecial_proj", 36, 60);
sprite_change_offset("muddd", 88, 22);
sprite_change_offset("mudland", 88, 58);
sprite_change_offset("muddry", 88, 60);
sprite_change_offset("mudsplosion", 84, 84);
sprite_change_offset("mud_hit", 30, 75);
sprite_change_offset("mud_hit2", 50, 115);
sprite_change_offset("bonk_hit", 50, 115)
sprite_change_offset("bonk_reverse_hit", 50, 115)

sprite_change_offset("fspecial2_proj", 124, 106);
sprite_change_offset("fspecial2_air_proj", 83, 105);
sprite_change_offset("fspecial2_proj_mask", 118, 107);
sprite_change_offset("fspecial2_air_proj_mask", 83, 105);

sprite_change_offset("last_resort_portrait", 27, 39);
