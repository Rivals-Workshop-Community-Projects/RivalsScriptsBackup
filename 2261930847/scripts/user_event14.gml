...
spr_muddash = sprite_get("muddash")
spr_muddtilt = sprite_get("dtilt_mud")
spr_dspecialroll = sprite_get("dspecial_roll")
spr_downtaunt = sprite_get("down_taunt")
spr_fspecial2 = sprite_get("fspecial2")
spr_fspecial2proj = sprite_get("fspecial2_proj")
...
with phone{
	...
	initApp(1, 1, "Quagsire Tips", $875825, tips);
	...
	initApp(7, 7, "The Useless App", $264b87, []);
...
with phone{
	...
	[Community] discord.gg/yhchvBB"); // if you remove the credits i will come to your house and kick down your door
