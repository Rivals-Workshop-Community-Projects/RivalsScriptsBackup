...
set_hitbox_value(AT_EXTRA_1, 1, HG_VISUAL_EFFECT, hit_small)
...
set_hitbox_value(AT_EXTRA_1, 2, HG_HITBOX_X, -2);
set_hitbox_value(AT_EXTRA_1, 2, HG_HITBOX_Y, -38);
set_hitbox_value(AT_EXTRA_1, 2, HG_WIDTH, 94);
set_hitbox_value(AT_EXTRA_1, 2, HG_HEIGHT, 94);
...
set_hitbox_value(AT_EXTRA_1, 2, HG_HITSTUN_MULTIPLIER, 1.5);
set_hitbox_value(AT_EXTRA_1, 2, HG_HIT_LOCKOUT, 6);
set_hitbox_value(AT_EXTRA_1, 2, HG_VISUAL_EFFECT, hit_small)
