...
set_window_value(AT_FTILT, 4, AG_WINDOW_HSPEED, 6);

set_window_value(AT_FTILT, 5, AG_WINDOW_LENGTH, 20);
...
set_window_value(AT_FTILT, 6, AG_WINDOW_SFX, sound_get("claw2"));
set_window_value(AT_FTILT, 6, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_FTILT, 6, AG_WINDOW_HSPEED, 8);

set_window_value(AT_FTILT, 7, AG_WINDOW_LENGTH, 20);
...
set_window_value(AT_FTILT, 7, AG_WINDOW_HSPEED, 0);
...
set_hitbox_value(AT_FTILT, 3, HG_VISUAL_EFFECT, hit_small);
