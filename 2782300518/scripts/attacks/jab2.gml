...
set_window_value(48, 1, AG_WINDOW_HSPEED, hsp);
set_window_value(48, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(48, 1, AG_WINDOW_SFX, sound_get("claw3"));
set_window_value(48, 1, AG_WINDOW_SFX_FRAME, 3);

set_window_value(48, 2, AG_WINDOW_LENGTH, 3);
set_window_value(48, 2, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(48, 2, AG_WINDOW_ANIM_FRAME_START, 1);
set_window_value(48, 2, AG_WINDOW_HSPEED, hsp);

set_window_value(48, 3, AG_WINDOW_LENGTH, 20);
set_window_value(48, 3, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(48, 3, AG_WINDOW_ANIM_FRAME_START, 2);
set_window_value(48, 3, AG_WINDOW_HSPEED, hsp);

set_window_value(48, 4, AG_WINDOW_LENGTH, 3);
set_window_value(48, 4, AG_WINDOW_ANIM_FRAMES, 1);
...
set_window_value(48, 4, AG_WINDOW_HSPEED, hsp);

set_window_value(48, 5, AG_WINDOW_LENGTH, 20);
set_window_value(48, 5, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(48, 5, AG_WINDOW_ANIM_FRAME_START, 6);
set_window_value(48, 5, AG_WINDOW_HSPEED, hsp);

set_window_value(48, 6, AG_WINDOW_LENGTH, 3);
set_window_value(48, 6, AG_WINDOW_ANIM_FRAMES, 1);
...
set_window_value(48, 6, AG_WINDOW_HSPEED, hsp);

set_window_value(48, 7, AG_WINDOW_LENGTH, 20);
set_window_value(48, 7, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(48, 7, AG_WINDOW_ANIM_FRAME_START, 10);
set_window_value(48, 7, AG_WINDOW_HSPEED, hsp);
...
set_hitbox_value(48, 1, HG_LIFETIME, 3);
set_hitbox_value(48, 1, HG_HITBOX_X, 24);
set_hitbox_value(48, 1, HG_HITBOX_Y, -49);
set_hitbox_value(48, 1, HG_WIDTH, 60);
set_hitbox_value(48, 1, HG_HEIGHT, 82);
set_hitbox_value(48, 1, HG_PRIORITY, 2);
set_hitbox_value(48, 1, HG_DAMAGE, 2);
...
set_hitbox_value(48, 1, HG_VISUAL_EFFECT, hit_small);
...
set_hitbox_value(48, 2, HG_LIFETIME, 3);
set_hitbox_value(48, 2, HG_HITBOX_X, 22);
set_hitbox_value(48, 2, HG_HITBOX_Y, -52);
set_hitbox_value(48, 2, HG_WIDTH, 70);
set_hitbox_value(48, 2, HG_HEIGHT, 82);
set_hitbox_value(48, 2, HG_PRIORITY, 2);
set_hitbox_value(48, 2, HG_DAMAGE, 2);
...
set_hitbox_value(48, 2, HG_VISUAL_EFFECT, hit_small);
...
set_hitbox_value(48, 3, HG_HITPAUSE_SCALING, .7);
set_hitbox_value(48, 3, HG_VISUAL_EFFECT, hit_small);
