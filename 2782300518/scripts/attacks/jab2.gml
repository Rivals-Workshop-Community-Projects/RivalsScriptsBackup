...
set_window_value(48, 3, AG_WINDOW_CANCEL_TYPE, 1);
set_window_value(48, 3, AG_WINDOW_CANCEL_FRAME, 3);
...
set_window_value(48, 5, AG_WINDOW_CANCEL_TYPE, 1);
set_window_value(48, 5, AG_WINDOW_CANCEL_FRAME, 3);
...
set_hitbox_value(48, 1, HG_HITBOX_X, 30);
set_hitbox_value(48, 1, HG_HITBOX_Y, -25);
set_hitbox_value(48, 1, HG_WIDTH, 40);
set_hitbox_value(48, 1, HG_HEIGHT, 48);
set_hitbox_value(48, 1, HG_PRIORITY, 2);
set_hitbox_value(48, 1, HG_DAMAGE, 4);
set_hitbox_value(48, 1, HG_ANGLE, 280);
set_hitbox_value(48, 1, HG_BASE_KNOCKBACK, 4);
set_hitbox_value(48, 1, HG_BASE_HITPAUSE, 4);
set_hitbox_value(48, 1, HG_HITSTUN_MULTIPLIER, 1);
...
set_hitbox_value(48, 2, HG_HITBOX_X, 30);
set_hitbox_value(48, 2, HG_HITBOX_Y, -35);
set_hitbox_value(48, 2, HG_WIDTH, 40);
set_hitbox_value(48, 2, HG_HEIGHT, 48);
set_hitbox_value(48, 2, HG_PRIORITY, 2);
set_hitbox_value(48, 2, HG_DAMAGE, 4);
set_hitbox_value(48, 2, HG_ANGLE, 361);
set_hitbox_value(48, 2, HG_BASE_KNOCKBACK, 4);
set_hitbox_value(48, 2, HG_BASE_HITPAUSE, 5);
set_hitbox_value(48, 2, HG_HITSTUN_MULTIPLIER, 1);
...
set_hitbox_value(48, 3, HG_HITBOX_X, 30);
set_hitbox_value(48, 3, HG_HITBOX_Y, -25);
set_hitbox_value(48, 3, HG_WIDTH, 40);
set_hitbox_value(48, 3, HG_HEIGHT, 48);
set_hitbox_value(48, 3, HG_PRIORITY, 2);
set_hitbox_value(48, 3, HG_DAMAGE, 5);
set_hitbox_value(48, 3, HG_ANGLE, 280);
