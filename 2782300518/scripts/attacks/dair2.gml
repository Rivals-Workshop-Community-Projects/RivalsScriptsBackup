...
set_attack_value(40, AG_NUM_WINDOWS, 2);
...
set_window_value(40, 1, AG_WINDOW_LENGTH, 6);
...
set_window_value(40, 2, AG_WINDOW_LENGTH, 7);
...
set_hitbox_value(40, 1, HG_DAMAGE, fuel_remaining / 3);
