...
set_window_value(AT_DTILT, 6, AG_WINDOW_SFX, sound_get("claw4"));

set_window_value(AT_DTILT, 7, AG_WINDOW_LENGTH, 20);
...
set_hitbox_value(AT_DTILT, 3, HG_HITBOX_X, 21);
set_hitbox_value(AT_DTILT, 3, HG_HITBOX_Y, -26);
...
set_hitbox_value(AT_DTILT, 3, HG_VISUAL_EFFECT, hit_small);
