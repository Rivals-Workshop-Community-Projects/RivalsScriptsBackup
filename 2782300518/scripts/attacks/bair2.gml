...
set_attack_value(39, AG_LANDING_LAG, 6);
...
set_window_value(39, 1, AG_WINDOW_SFX, sound_get("motorbike_uppercut"));
set_window_value(39, 1, AG_WINDOW_SFX_FRAME, 5);
...
set_hitbox_value(39, 1, HG_DAMAGE, 7);
set_hitbox_value(39, 1, HG_ANGLE, 130);
...
set_hitbox_value(39, 1, HG_HIT_SFX, asset_get("sfx_blow_medium1"));
