...
set_hitbox_value(AT_EXTRA_2, 1, HG_HEIGHT, 48);
...
set_hitbox_value(AT_EXTRA_2, 1, HG_HITSTUN_MULTIPLIER, 1.5);
set_hitbox_value(AT_EXTRA_2, 1, HG_VISUAL_EFFECT, hit_small);
