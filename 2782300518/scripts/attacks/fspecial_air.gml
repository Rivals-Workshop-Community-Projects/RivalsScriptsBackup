...
set_window_value(AT_FSPECIAL_AIR, 1, AG_WINDOW_SFX_FRAME, 17);
...
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_LIFETIME, 38);
...
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_HITSTUN_MULTIPLIER, 0.5);
