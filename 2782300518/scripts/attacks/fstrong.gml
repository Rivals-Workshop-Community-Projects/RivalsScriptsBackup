...
set_attack_value(AT_FSTRONG, AG_MUNO_ATTACK_NAME, "FStrong (Strong Kick)");
...
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, hit_large);
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sound_get("hit_heavy"));
