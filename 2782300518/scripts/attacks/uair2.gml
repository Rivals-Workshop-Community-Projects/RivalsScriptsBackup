...
set_window_value(42, 1, AG_WINDOW_SFX, sound_get("wild_claw"));
set_window_value(42, 1, AG_WINDOW_SFX_FRAME, 5);

set_window_value(42, 2, AG_WINDOW_LENGTH, 3);
set_window_value(42, 2, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(42, 2, AG_WINDOW_ANIM_FRAME_START, 2);

set_window_value(42, 3, AG_WINDOW_LENGTH, 9);
...
set_hitbox_value(42, 1, HG_DAMAGE, 10);
