...
set_window_value(AT_UTILT, 3, AG_WINDOW_CANCEL_FRAME, 3);
...
set_window_value(AT_UTILT, 5, AG_WINDOW_CANCEL_TYPE, 1);
set_window_value(AT_UTILT, 5, AG_WINDOW_CANCEL_FRAME, 3);
...
set_window_value(AT_UTILT, 6, AG_WINDOW_SFX, sound_get("claw2"));
