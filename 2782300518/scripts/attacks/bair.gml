...
av(atk, AG_SPRITE, sprite_get("bair"));
av(atk, AG_NUM_WINDOWS, 3);
av(atk, AG_HAS_LANDING_LAG, 1);
av(atk, AG_LANDING_LAG, 6);
av(atk, AG_HURTBOX_SPRITE, sprite_get("bair_hurt"));
av(atk, AG_MUNO_ATTACK_NAME, "BAir (Back Kick)");
...
hv(atk, 1, HG_HITPAUSE_SCALING, .55)
