...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("jab2"));
...
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, hit_medium);
...
set_hitbox_value(AT_BAIR, 2, HG_KNOCKBACK_SCALING, .25)
set_hitbox_value(AT_BAIR, 2, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_BAIR, 2, HG_HITPAUSE_SCALING, .8);
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT, hit_small);
