...
set_hitbox_value(AT_USTRONG_2, 1, HG_HITBOX_X, 16);
set_hitbox_value(AT_USTRONG_2, 1, HG_HITBOX_Y, -80);
set_hitbox_value(AT_USTRONG_2, 1, HG_WIDTH, 86);
...
set_hitbox_value(AT_USTRONG_2, 1, HG_BASE_KNOCKBACK, 14);
...
set_hitbox_value(AT_USTRONG_2, 1, HG_VISUAL_EFFECT, 11);
