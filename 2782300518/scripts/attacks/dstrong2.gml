...
set_window_value(AT_DSTRONG_2, 1, AG_WINDOW_LENGTH, 18);
...
set_window_value(AT_DSTRONG_2, 3, AG_WINDOW_LENGTH, 17);
...
set_hitbox_value(AT_DSTRONG_2, 1, HG_VISUAL_EFFECT, hit_large);
