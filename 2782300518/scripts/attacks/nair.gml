...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, sound_get("wild_claw_spin"));
...
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT, hit_medium);
...
set_hitbox_value(AT_NAIR, 3, HG_VISUAL_EFFECT, hit_medium);
...
set_hitbox_value(AT_NAIR, 4, HG_HEIGHT, 84);
