...
set_window_value(46, 1, AG_WINDOW_SFX_FRAME, 5);
...
set_window_value(46, 3, AG_WINDOW_LENGTH, 20);
...
set_window_value(46, 4, AG_WINDOW_ANIM_FRAME_START, 6);
set_window_value(46, 4, AG_WINDOW_HAS_SFX, 1);
set_window_value(46, 4, AG_WINDOW_SFX, sound_get("jab1"));

set_window_value(46, 5, AG_WINDOW_LENGTH, 20);
set_window_value(46, 5, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(46, 5, AG_WINDOW_ANIM_FRAME_START, 7);

set_window_value(46, 6, AG_WINDOW_LENGTH, 3);
set_window_value(46, 6, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(46, 6, AG_WINDOW_ANIM_FRAME_START, 10);
set_window_value(46, 6, AG_WINDOW_HAS_SFX, 1);
set_window_value(46, 6, AG_WINDOW_SFX, sound_get("claw1"));

set_window_value(46, 7, AG_WINDOW_LENGTH, 20);
set_window_value(46, 7, AG_WINDOW_ANIM_FRAMES, 3);
...
set_hitbox_value(46, 1, HG_DAMAGE, 2);
...
set_hitbox_value(46, 2, HG_LIFETIME, 3);
...
set_hitbox_value(46, 2, HG_DAMAGE, 2);
...
set_hitbox_value(46, 3, HG_LIFETIME, 3);
...
set_hitbox_value(46, 3, HG_DAMAGE, 4);
