...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("claw3"));
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_SFX, sound_get("claw3"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HITSTUN_MULTIPLIER, 1.5);
