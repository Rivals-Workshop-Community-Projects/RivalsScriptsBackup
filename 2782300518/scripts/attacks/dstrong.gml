...
set_attack_value(AT_DSTRONG, AG_MUNO_ATTACK_NAME, "DStrong (Splits Kick)");
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, hit_large);
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("hit_heavy"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, hit_large);
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("hit_heavy"));
