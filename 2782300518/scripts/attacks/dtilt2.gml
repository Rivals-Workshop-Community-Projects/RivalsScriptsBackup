...
set_window_value(45, 1, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(45, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(45, 1, AG_WINDOW_SFX, sound_get("claw4"));
set_window_value(45, 1, AG_WINDOW_SFX_FRAME, 5);

set_window_value(45, 2, AG_WINDOW_LENGTH, 3);
set_window_value(45, 2, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(45, 2, AG_WINDOW_ANIM_FRAME_START, 2);
...
set_window_value(45, 4, AG_WINDOW_LENGTH, 3);
set_window_value(45, 4, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(45, 4, AG_WINDOW_ANIM_FRAME_START, 6);
set_window_value(45, 4, AG_WINDOW_HAS_SFX, 1);
set_window_value(45, 4, AG_WINDOW_SFX, sound_get("claw4"));

set_window_value(45, 5, AG_WINDOW_LENGTH, 20);
set_window_value(45, 5, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(45, 5, AG_WINDOW_ANIM_FRAME_START, 7);

set_window_value(45, 6, AG_WINDOW_LENGTH, 6);
set_window_value(45, 6, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(45, 6, AG_WINDOW_ANIM_FRAME_START, 10);
...
set_window_value(45, 7, AG_WINDOW_LENGTH, 20);
set_window_value(45, 7, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(45, 7, AG_WINDOW_ANIM_FRAME_START, 11);
...
set_hitbox_value(45, 1, HG_DAMAGE, 2);
set_hitbox_value(45, 1, HG_ANGLE, 75);
set_hitbox_value(45, 1, HG_BASE_KNOCKBACK, 4);
set_hitbox_value(45, 1, HG_BASE_HITPAUSE, 4);
set_hitbox_value(45, 1, HG_HITSTUN_MULTIPLIER, 1.5);
set_hitbox_value(45, 1, HG_VISUAL_EFFECT, hit_small);
...
set_hitbox_value(45, 2, HG_DAMAGE, 2);
set_hitbox_value(45, 2, HG_ANGLE, 75);
set_hitbox_value(45, 2, HG_BASE_KNOCKBACK, 4);
set_hitbox_value(45, 2, HG_BASE_HITPAUSE, 5);
set_hitbox_value(45, 2, HG_HITSTUN_MULTIPLIER, 1.5);
set_hitbox_value(45, 2, HG_VISUAL_EFFECT, hit_small);
...
set_hitbox_value(45, 3, HG_DAMAGE, 4);
set_hitbox_value(45, 3, HG_ANGLE, 45);
set_hitbox_value(45, 3, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(45, 3, HG_KNOCKBACK_SCALING, .3);
set_hitbox_value(45, 3, HG_BASE_HITPAUSE, 12);
set_hitbox_value(45, 3, HG_HITPAUSE_SCALING, .7);
set_hitbox_value(45, 3, HG_VISUAL_EFFECT, hit_small);
