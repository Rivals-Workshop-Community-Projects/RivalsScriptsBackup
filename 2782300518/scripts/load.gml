...
sprite_change_offset("airdodge_back", 40, 78);
sprite_change_offset("airdodge_downback", 40, 78);
sprite_change_offset("airdodge_upback", 40, 78);
...
sprite_change_offset("fair2", 40, 78);
