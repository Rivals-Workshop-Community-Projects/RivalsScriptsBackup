//This file is much longer than load files on other characters due to every animation having a bike version
...
sprite_change_offset("hurt_crystalised", 20, 39);
sprite_change_offset("hurt_bike_crystalised", 20, 41);
...
sprite_change_offset("downhurt_bike", 40, 82);
sprite_change_offset("bouncehurt", 40, 78);
sprite_change_offset("bouncehurt_bike", 40, 82);
...
sprite_change_offset("jump", 44, 78);
sprite_change_offset("jump2", 40, 82);
sprite_change_offset("doublejump", 50, 78);
sprite_change_offset("doublejump2", 50, 78);
sprite_change_offset("walljump", 44, 78);
sprite_change_offset("walljump2", 38, 78);
sprite_change_offset("pratfall", 44, 78);
sprite_change_offset("pratfall2", 40, 82);
...
sprite_change_offset("bike_idle_air", 40, 82);

sprite_change_offset("parry", 40, 78);
sprite_change_offset("parry2", 40, 82);
...
sprite_change_offset("airdodge", 44, 78);
sprite_change_offset("airdodge2", 40, 96);
sprite_change_offset("waveland", 40, 78);
sprite_change_offset("waveland2", 40, 82);
sprite_change_offset("tech", 40, 78);
sprite_change_offset("tech2", 40, 82);
...
sprite_change_offset("dtilt2", 40, 82);
sprite_change_offset("utilt", 38, 90);
sprite_change_offset("utilt2", 38, 98);
sprite_change_offset("nair", 42, 98);
sprite_change_offset("nair2", 68, 116);
sprite_change_offset("fair", 38, 78);
sprite_change_offset("fair2", 52, 130);
sprite_change_offset("bair", 68, 78);
sprite_change_offset("bair2", 68, 78);
sprite_change_offset("uair", 38, 108);
sprite_change_offset("uair2", 40, 126);
sprite_change_offset("dair", 86, 102);
sprite_change_offset("dair2", 54, 88);
sprite_change_offset("fstrong", 46, 78);
sprite_change_offset("fstrong2", 56, 116);
sprite_change_offset("ustrong", 40, 110);
sprite_change_offset("ustrong2", 52, 140);
sprite_change_offset("dstrong", 42, 98);
sprite_change_offset("dstrong2", 40, 78);
sprite_change_offset("nspecial", 34, 78);
sprite_change_offset("nspecial_air", 32, 78);
sprite_change_offset("nspecial2", 42, 92);
...
sprite_change_offset("dspecial2", 42, 78);
sprite_change_offset("dspecial_air", 60, 84);
sprite_change_offset("dspecial_air_proj", 42, 82);
...
sprite_change_offset("bench_sit", 40, 78);
...
sprite_change_offset("disc_arrow", 58, 58);
sprite_change_offset("disc_hit", 140, 160);

sprite_change_offset("multikick_meter", 33,0);
sprite_change_offset("multikick_meter_full", 33,0);
sprite_change_offset("walljump_counter", 14,1);
sprite_change_offset("walljump_counter2", 14,0);

sprite_change_offset("nitro_boost", 50, 50)

sprite_change_offset("plat", 50, 0);

sprite_change_offset("sparkle", 30, 30);

sprite_change_offset("power_back", 34, 86);
sprite_change_offset("carol_sign", 18, 41);
sprite_change_offset("guilty_carol", 31, 0);
...
sprite_change_offset("hit_big", 74, 74);
sprite_change_offset("hit_proj", 50, 50);
sprite_change_offset("bubble_pop", 86, 102);
sprite_change_offset("explosion", 110, 86);
sprite_change_offset("bike_charge", 38, 78);
sprite_change_offset("bike_mask", 38, 78);
