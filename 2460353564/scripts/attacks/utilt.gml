...
set_attack_value(AT_UTILT, AG_HURTBOX_SPRITE, -1);

set_window_value(AT_UTILT, 1, AG_WINDOW_TYPE, 1);
set_window_value(AT_UTILT, 1, AG_WINDOW_LENGTH, 20);
set_window_value(AT_UTILT, 1, AG_WINDOW_ANIM_FRAMES, 10);
set_window_value(AT_UTILT, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("s800_kengeki00"));
...
set_hitbox_value(AT_UTILT, 1, HG_LIFETIME, 30);
...
set_hitbox_value(AT_UTILT, 1, HG_DAMAGE, 0.5); // knives do fractional damage, which i had to custom code. see hit_player.gml
...
set_hitbox_value(AT_UTILT, 1, HG_PROJECTILE_SPRITE, sprite_get("knife_up"));
set_hitbox_value(AT_UTILT, 1, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_UTILT, 1, HG_PROJECTILE_VSPEED, -18);
