...
set_hitbox_value(AT_DAIR, 1, HG_DAMAGE, 0.5);
...
set_hitbox_value(AT_DAIR, 1, HG_PROJECTILE_SPRITE, sprite_get("knife"));
set_hitbox_value(AT_DAIR, 1, HG_PROJECTILE_MASK, sprite_get("knife_hitbox"));
set_hitbox_value(AT_DAIR, 1, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_DAIR, 1, HG_PROJECTILE_HSPEED, 12.7);
set_hitbox_value(AT_DAIR, 1, HG_PROJECTILE_VSPEED, 12.7);
...
set_hitbox_value(AT_DAIR, 2, HG_DAMAGE, 0.5);
...
set_hitbox_value(AT_DAIR, 3, HG_DAMAGE, 0.5);
set_hitbox_value(AT_DAIR, 3, HG_LIFETIME, 48);
