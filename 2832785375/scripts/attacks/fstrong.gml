...
set_attack_value(AT_FSTRONG, AG_VINE_SPRITE, sprite_get("fstrong_vine"));
...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_syl_fspecial_bite"));
...
set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT, vfx_wood_large);
...
set_hitbox_value(AT_FSTRONG, 2, HG_PROJECTILE_COLLISION_SPRITE, 0);
