...
set_hitbox_value(AT_DTILT, 1, HG_HITBOX_X, 100);
...
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT, vfx_flower_large);
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, asset_get("sfx_leafy_hit1"));
