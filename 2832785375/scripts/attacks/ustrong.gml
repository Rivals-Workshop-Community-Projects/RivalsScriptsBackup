...
set_attack_value(AT_USTRONG, AG_VINE_SPRITE, sprite_get("ustrong_vine"));
...
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_Y, -170);
...
set_hitbox_value(AT_USTRONG, 4, HG_HEIGHT, 180);
...
set_hitbox_value(AT_USTRONG, 4, HG_HITPAUSE_SCALING, 0.4);
