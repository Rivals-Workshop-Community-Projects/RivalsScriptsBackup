...
set_window_value(AT_USPECIAL, 5, AG_WINDOW_SFX, asset_get("sfx_bite"));
...
set_window_value(AT_USPECIAL, 6, AG_WINDOW_HSPEED, 2);
...
set_hitbox_value(AT_USPECIAL, 6, HG_HITBOX_Y, -30);
