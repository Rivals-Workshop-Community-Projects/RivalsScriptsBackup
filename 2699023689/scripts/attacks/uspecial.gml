...
set_attack_value(AT_USPECIAL, AG_SPRITE, asset_get("goat_uspecial"));
set_attack_value(AT_USPECIAL, AG_NUM_WINDOWS, 6);
set_attack_value(AT_USPECIAL, AG_HAS_LANDING_LAG, 4);
set_attack_value(AT_USPECIAL, AG_OFF_LEDGE, 1);
set_attack_value(AT_USPECIAL, AG_AIR_SPRITE, asset_get("goat_uspecial"));
set_attack_value(AT_USPECIAL, AG_HURTBOX_SPRITE, asset_get("goat_uspecial_hurt"));
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_absa_dashdown"));
...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_TYPE, 3);
...
set_window_value(AT_USPECIAL, 5, AG_WINDOW_SFX, asset_get("sfx_absa_dashup"));
...
set_window_value(AT_USPECIAL, 7, AG_WINDOW_HAS_CUSTOM_FRICTION, 0);
set_window_value(AT_USPECIAL, 7, AG_WINDOW_CUSTOM_AIR_FRICTION, 0);
set_window_value(AT_USPECIAL, 7, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0);
...
set_hitbox_value(temp_attack, temp_num, HG_KNOCKBACK_SCALING, .15);
