...
set_hitbox_value(AT_JAB, 3, HG_LIFETIME, 20);
...
set_hitbox_value(AT_JAB, 3, HG_EXTRA_HITPAUSE, 24);
...
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, asset_get("sfx_watergun_fire"));
...
set_hitbox_value(AT_JAB, 4, HG_HIT_SFX, asset_get("sfx_waterhit_medium"));
