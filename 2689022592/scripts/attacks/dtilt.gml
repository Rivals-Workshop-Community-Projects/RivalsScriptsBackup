...
set_hitbox_value(AT_DTILT, 2, HG_LIFETIME, 61);
set_hitbox_value(AT_DTILT, 2, HG_HITBOX_X, 666);
set_hitbox_value(AT_DTILT, 2, HG_HITBOX_Y, 666);
set_hitbox_value(AT_DTILT, 2, HG_WIDTH, 1);
set_hitbox_value(AT_DTILT, 2, HG_HEIGHT, 1);
set_hitbox_value(AT_DTILT, 2, HG_SHAPE, 0);
set_hitbox_value(AT_DTILT, 2, HG_PRIORITY, 6);
set_hitbox_value(AT_DTILT, 2, HG_HITBOX_GROUP, 6);
set_hitbox_value(AT_DTILT, 2, HG_DAMAGE, 666);
set_hitbox_value(AT_DTILT, 2, HG_ANGLE, 666);
set_hitbox_value(AT_DTILT, 2, HG_BASE_KNOCKBACK, 666);
set_hitbox_value(AT_DTILT, 2, HG_KNOCKBACK_SCALING, 666);
set_hitbox_value(AT_DTILT, 2, HG_BASE_HITPAUSE, 666);
set_hitbox_value(AT_DTILT, 2, HG_HITPAUSE_SCALING, 666);
set_hitbox_value(AT_DTILT, 2, HG_VISUAL_EFFECT_X_OFFSET, 666);
set_hitbox_value(AT_DTILT, 2, HG_HIT_SFX, asset_get("sfx_blow_weak2"));
set_hitbox_value(AT_DTILT, 2, HG_VISUAL_EFFECT, 301);
set_hitbox_value(AT_DTILT, 2, HG_HITSTUN_MULTIPLIER, 666);