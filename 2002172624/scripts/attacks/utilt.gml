...
set_hitbox_value(AT_UTILT, 5, HG_HITBOX_Y, -10);
set_hitbox_value(AT_UTILT, 5, HG_WIDTH, 35);
set_hitbox_value(AT_UTILT, 5, HG_HEIGHT, 16);
...
set_hitbox_value(AT_UTILT, 5, HG_KNOCKBACK_SCALING, .30);
set_hitbox_value(AT_UTILT, 5, HG_BASE_HITPAUSE, 4);
set_hitbox_value(AT_UTILT, 5, HG_HITPAUSE_SCALING, .30);
set_hitbox_value(AT_UTILT, 5, HG_HIT_SFX, asset_get("sfx_shovel_hit_light1"));
