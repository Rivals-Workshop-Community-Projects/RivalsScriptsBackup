...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_LENGTH, 14); //was 12
set_window_value(AT_FSTRONG, 1, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_FSTRONG, 1, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_FSTRONG, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, .28);
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX, sound_get("Briggs_PyroSplash"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_BASE_KNOCKBACK, 7.2);
...
set_hitbox_value(AT_FSTRONG, 2, HG_BASE_KNOCKBACK, 7.5); //7.5
set_hitbox_value(AT_FSTRONG, 2, HG_KNOCKBACK_SCALING, 0.8); //0.9
