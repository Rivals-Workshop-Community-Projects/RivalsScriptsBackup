set_attack_value(AT_EXTRA_1, AG_SPRITE, sprite_get("dtilt"));
set_attack_value(AT_EXTRA_1, AG_NUM_WINDOWS, 1);
set_attack_value(AT_EXTRA_1, AG_HURTBOX_SPRITE, sprite_get("dtilt_hurt"));

set_window_value(AT_EXTRA_1, 1, AG_WINDOW_TYPE, 1);
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_LENGTH, 32); //24
...
set_hitbox_value(AT_EXTRA_1, 1, HG_WIDTH, 122);
...
set_hitbox_value(AT_EXTRA_1, 1, HG_ANGLE, 104);
...
set_hitbox_value(AT_EXTRA_1, 1, HG_PROJECTILE_MASK, sprite_get("catrun_hurt"));
