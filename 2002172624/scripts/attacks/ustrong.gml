...
set_hitbox_value(AT_USTRONG, 1, HG_KNOCKBACK_SCALING, 0); //0.2
...
set_hitbox_value(AT_USTRONG, 3, HG_BASE_KNOCKBACK, 9); //8
set_hitbox_value(AT_USTRONG, 3, HG_KNOCKBACK_SCALING, 1.5); //1.2
