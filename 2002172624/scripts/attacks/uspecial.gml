...
set_attack_value(AT_USPECIAL, AG_SPRITE, sprite_get("uspecialground"));
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_shovel_swing_med2"));
...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_LENGTH, 30); //30
...
set_hitbox_value(AT_USPECIAL, 1, HG_HIT_SFX, asset_get("sfx_metal_hit_strong"));
