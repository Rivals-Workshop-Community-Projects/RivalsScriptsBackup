...
set_attack_value(AT_NSPECIAL_AIR, AG_HURTBOX_AIR_SPRITE, sprite_get("nspecial_hurt_air"));
...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("nsmb_fireball"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("nspecial_fireball"));
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("nspecial_fireball_mask"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_AIR_FRICTION, -.01);
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_GRAVITY, .65);
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_ENEMY_BEHAVIOR, 0);
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, fireball_hit_fx);
