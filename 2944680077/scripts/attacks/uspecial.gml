...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, sound_get("melee_superjumppunch"));
...
set_hitbox_value(AT_USPECIAL, 5, HG_HEIGHT, 16);
...
set_hitbox_value(AT_USPECIAL, 5, HG_VISUAL_EFFECT, bounce_fx);