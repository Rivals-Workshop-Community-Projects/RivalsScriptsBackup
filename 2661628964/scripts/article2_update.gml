...
switch(state){
    case 0:
        new_sprite = sprite_get("osha_spawn");
        animation_type = 0;
        break;
    case 1:
        new_sprite = sprite_get("osha_idle");
        animation_type = 1;
        break;
    case 2:
        new_sprite = sprite_get("osha_launch");
        animation_type = 2;
        break;
    case 3:
    	new_sprite = sprite_get("osha_spawn");
...
player_id.oshawott_hp -= hbox.damage
