...
set_window_value(AT_JAB, 9, AG_WINDOW_ANIM_FRAME_START, 6);
set_window_value(AT_JAB, 9, AG_WINDOW_HAS_WHIFFLAG, 1);
set_window_value(AT_JAB, 9, AG_WINDOW_CANCEL_TYPE, 1);
set_window_value(AT_JAB, 9, AG_WINDOW_CANCEL_FRAME, 2);
...
set_window_value(AT_JAB, 10, AG_WINDOW_ANIM_FRAME_START, 9);

set_window_value(AT_JAB, 11, AG_WINDOW_TYPE, 1);
set_window_value(AT_JAB, 11, AG_WINDOW_LENGTH, 3);
...
set_window_value(AT_JAB, 12, AG_WINDOW_LENGTH, 15);
...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("fury1"));
...
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, sound_get("fury1"));
...
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, sound_get("fury1"));
...
set_hitbox_value(AT_JAB, 4, HG_HIT_SFX, sound_get("fury1"));
...
set_hitbox_value(AT_JAB, 5, HG_HIT_SFX, sound_get("fury2"));
