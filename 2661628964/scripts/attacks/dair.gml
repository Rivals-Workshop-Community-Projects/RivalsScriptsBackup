...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sound_get("uturn1"));
...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, 17);
//set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, sound_get("uturn3"));
