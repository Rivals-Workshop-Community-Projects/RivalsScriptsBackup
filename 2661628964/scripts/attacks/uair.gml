...
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, sound_get("hyper"));
...
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, sound_get("shadow2"));
...
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, sound_get("shadow2"));