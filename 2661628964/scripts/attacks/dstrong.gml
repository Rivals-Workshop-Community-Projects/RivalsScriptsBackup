...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_abyss_spawn"));
...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("sucker1"));
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_SFX, sound_get("sucker1"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, payback_vfx);
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, -32);
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("sucker2"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, payback_vfx);
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT_Y_OFFSET, -32);
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("sucker2"));