...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, sound_get("play1"));
...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_SFX, sound_get("play2"));
...
set_window_value(AT_USPECIAL, 6, AG_WINDOW_CUSTOM_GRAVITY, 1.8);
set_window_value(AT_USPECIAL, 6, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USPECIAL, 6, AG_WINDOW_SFX, sound_get("play3"));
...
set_hitbox_value(AT_USPECIAL, 2, HG_VISUAL_EFFECT, 138);
...
set_hitbox_value(AT_USPECIAL, 3, HG_VISUAL_EFFECT, 138);
...
set_hitbox_value(AT_USPECIAL, 4, HG_VISUAL_EFFECT, 138);
