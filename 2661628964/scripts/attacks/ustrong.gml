...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("slash_weak"));
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("slash_strong"));
...
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, sound_get("slash_weak"));