...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, asset_get("sfx_charge_blade_ready"));
...
set_window_value(AT_NAIR, 5, AG_WINDOW_LENGTH, 20);
...
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT, 151);
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sound_get("fury1"));
...
set_hitbox_value(AT_NAIR, 2, HG_WIDTH, 30);
...
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, sound_get("shadow2"));
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_GROUP, 1);

set_hitbox_value(AT_NAIR, 3, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_NAIR, 3, HG_WINDOW, 4);
set_hitbox_value(AT_NAIR, 3, HG_LIFETIME, 3);
set_hitbox_value(AT_NAIR, 3, HG_HITBOX_X, 16);
...
set_hitbox_value(AT_NAIR, 3, HG_VISUAL_EFFECT, 151);
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, sound_get("fury1"));
...
set_hitbox_value(AT_NAIR, 4, HG_ANGLE, 120);
...
set_hitbox_value(AT_NAIR, 4, HG_HIT_SFX, sound_get("shadow2"));
