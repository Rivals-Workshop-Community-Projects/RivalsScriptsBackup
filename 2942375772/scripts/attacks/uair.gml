...
set_hitbox_value(AT_UAIR, 1, HG_WIDTH, 125); // 135 -> 125
...
set_hitbox_value(AT_UAIR, 1, HG_MUNO_HITBOX_MISC_ADD, "Adds shake note");
...
set_hitbox_value(AT_UAIR, 3, HG_HITBOX_Y, -32);
...
set_hitbox_value(AT_UAIR, 2, HG_MUNO_HITBOX_MISC_ADD, "Adds rimshot note");