...
set_hitbox_value(AT_NSPECIAL, 4, HG_VISUAL_EFFECT, green_nspec_vfx);
...
set_hitbox_value(AT_NSPECIAL, 5, HG_VISUAL_EFFECT, red_nspec_vfx);
...
set_hitbox_value(AT_NSPECIAL, 5, HG_PROJECTILE_DESTROY_EFFECT, red_nspec_destroy);
...
set_hitbox_value(AT_NSPECIAL, 6, HG_LIFETIME, 11);
...
set_hitbox_value(AT_NSPECIAL, 6, HG_BASE_HITPAUSE, 0);
...
set_hitbox_value(AT_NSPECIAL, 6, HG_HITSTUN_MULTIPLIER, 0);
set_hitbox_value(AT_NSPECIAL, 6, HG_VISUAL_EFFECT, 1);
set_hitbox_value(AT_NSPECIAL, 6, HG_PROJECTILE_DESTROY_EFFECT, green_nspec_destroy);
set_hitbox_value(AT_NSPECIAL, 6, HG_MUNO_HITBOX_EXCLUDE, 1);