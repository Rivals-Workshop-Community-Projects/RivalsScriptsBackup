...
set_hitbox_value(AT_FSTRONG, 2, HG_WIDTH, 71);
...
set_hitbox_value(AT_FSTRONG, 3, HG_HITBOX_X, 74);
set_hitbox_value(AT_FSTRONG, 3, HG_HITBOX_Y, -57);
...
set_hitbox_value(AT_FSTRONG, 3, HG_HIT_SFX, asset_get("sfx_bird_downspecial"));