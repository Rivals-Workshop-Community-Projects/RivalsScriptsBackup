...
set_hitbox_value(AT_FSPECIAL, 5, HG_KNOCKBACK_SCALING, .6);
...
set_hitbox_value(AT_FSPECIAL, 6, HG_HITPAUSE_SCALING, .6);
...
set_hitbox_value(AT_FSPECIAL, 6, HG_PROJECTILE_SPRITE, sprite_get("fspecial_projectile"));
