...
set_hitbox_value(AT_DSPECIAL, 1, HG_LIFETIME, 350);
...
set_hitbox_value(AT_DSPECIAL, 4, HG_HITSTUN_MULTIPLIER, 0.75);
...
set_hitbox_value(AT_DSPECIAL, 8, HG_ANGLE, 140);
set_hitbox_value(AT_DSPECIAL, 8, HG_BASE_KNOCKBACK, 9);
set_hitbox_value(AT_DSPECIAL, 8, HG_HITSTUN_MULTIPLIER, 0.75);
