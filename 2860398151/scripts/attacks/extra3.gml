...
set_attack_value(AT_EXTRA_3, AG_SPRITE, sprite_get("nometercringe"));
set_attack_value(AT_EXTRA_3, AG_AIR_SPRITE, sprite_get("nometercringe_air"));
...
set_window_value(AT_EXTRA_3, 1, AG_WINDOW_SFX, asset_get("sfx_absa_singlezap1"));
