...
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_Y, -11);
set_hitbox_value(AT_FSTRONG, 1, HG_WIDTH, 41);
set_hitbox_value(AT_FSTRONG, 1, HG_HEIGHT, 27);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HEIGHT, 97);
