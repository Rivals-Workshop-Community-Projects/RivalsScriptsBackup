...
set_hitbox_value(AT_USTRONG, 1, HG_KNOCKBACK_SCALING, 0.80);
set_hitbox_value(AT_USTRONG, 1, HG_BASE_HITPAUSE, 11);
set_hitbox_value(AT_USTRONG, 1, HG_HITPAUSE_SCALING, 0.80);
...
set_hitbox_value(AT_USTRONG, 2, HG_KNOCKBACK_SCALING, 1.00);
set_hitbox_value(AT_USTRONG, 2, HG_BASE_HITPAUSE, 14);
set_hitbox_value(AT_USTRONG, 2, HG_HITPAUSE_SCALING, 0.90);
