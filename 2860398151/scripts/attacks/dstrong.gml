...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX_FRAME, 9);
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_HSPEED, 1);
...
set_hitbox_value(AT_DSTRONG, 1, HG_KNOCKBACK_SCALING, 0.90);
set_hitbox_value(AT_DSTRONG, 1, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_DSTRONG, 1, HG_HITPAUSE_SCALING, 0.90);
