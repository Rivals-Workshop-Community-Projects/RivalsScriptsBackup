...
set_window_value(AT_JAB, 8, AG_WINDOW_HSPEED, 5.5);
...
set_window_value(AT_JAB, 9, AG_WINDOW_ANIM_FRAME_START, 24);
...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sfx_kodiak_jab1);
...
set_hitbox_value(AT_JAB, 2, HG_ANGLE, 79);
set_hitbox_value(AT_JAB, 2, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_JAB, 2, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, sfx_kodiak_jab2);
...
set_hitbox_value(AT_JAB, 3, HG_HITPAUSE_SCALING, 0.55);
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, sfx_kodiak_jab3);
