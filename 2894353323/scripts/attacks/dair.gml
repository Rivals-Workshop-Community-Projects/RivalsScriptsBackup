...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sound_get("sfx_sword_swing_heavy1"));
...
set_hitbox_value(AT_DAIR, 1, HG_MUNO_HITBOX_NAME, "Clean");
...
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, sound_get("sfx_sword_blow_heavy1"));


set_hitbox_value(AT_DAIR, 2, HG_MUNO_HITBOX_NAME, "Late");
...
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, sound_get("sfx_sword_blow_medium1"));