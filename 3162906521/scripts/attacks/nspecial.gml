...
set_hitbox_value(AT_NSPECIAL, 1, HG_WIDTH, 93);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HITBOX_X, -200);
...
// set_hitbox_value(AT_NSPECIAL, 2, HG_HIT_SFX, asset_get("sfx_shovel_hit_light2"));
set_hitbox_value(AT_NSPECIAL, 2, HG_VISUAL_EFFECT, 1);
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("ammo_s_fall"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_GRAVITY, 1);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("hud_costs"));
