...
// set_window_value(AT_DATTACK, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, 20);
set_window_value(AT_DATTACK, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sound_get("gunslinger_start"));
...
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX, sound_get("jackhammer_loop"));
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_SFX, sound_get("jackhammer_end"));
...
set_hitbox_value(AT_DATTACK, 1, HG_EFFECT, 15);
