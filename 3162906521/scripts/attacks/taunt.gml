...
set_attack_value(AT_TAUNT, AG_NUM_WINDOWS, 10);
...
set_window_value(AT_TAUNT, 1, AG_CATEGORY, 2);
...
set_window_value(AT_TAUNT, 7, AG_WINDOW_TYPE, 3);
set_window_value(AT_TAUNT, 7, AG_WINDOW_LENGTH, 4);
set_window_value(AT_TAUNT, 7, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_TAUNT, 7, AG_WINDOW_ANIM_FRAME_START, 6);

set_window_value(AT_TAUNT, 8, AG_WINDOW_TYPE, 3);
set_window_value(AT_TAUNT, 8, AG_WINDOW_LENGTH, 4);
set_window_value(AT_TAUNT, 8, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_TAUNT, 8, AG_WINDOW_ANIM_FRAME_START, 7);

set_window_value(AT_TAUNT, 9, AG_WINDOW_TYPE, 3);
set_window_value(AT_TAUNT, 9, AG_WINDOW_LENGTH, 4);
set_window_value(AT_TAUNT, 9, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_TAUNT, 9, AG_WINDOW_ANIM_FRAME_START, 8);

set_window_value(AT_TAUNT, 10, AG_WINDOW_TYPE, 3);
set_window_value(AT_TAUNT, 10, AG_WINDOW_LENGTH, 4);
set_window_value(AT_TAUNT, 10, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_TAUNT, 10, AG_WINDOW_ANIM_FRAME_START, 9);