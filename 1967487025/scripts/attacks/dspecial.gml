...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, sound_get("chaos_fly"));
...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_HSPEED, 30);
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_SFX, sound_get("chaos_halt"));