...
set_window_value(AT_FTILT, 3, AG_WINDOW_SFX, sound_get("chaos_magic"));

set_window_value(AT_FTILT, 4, AG_WINDOW_TYPE, 1);
set_window_value(AT_FTILT, 4, AG_WINDOW_LENGTH, 22);
...
set_hitbox_value(AT_FTILT, 1, HG_WINDOW_CREATION_FRAME, 8);
set_hitbox_value(AT_FTILT, 1, HG_LIFETIME, 14);
...
set_hitbox_value(AT_FTILT, 1, HG_HITSTUN_MULTIPLIER, .85);
...
set_hitbox_value(AT_FTILT, 1, HG_PROJECTILE_ANIM_SPEED, 10/14);
