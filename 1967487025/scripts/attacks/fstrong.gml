...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("chaos_fsmash"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_KNOCKBACK_SCALING, 1.03);
set_hitbox_value(AT_FSTRONG, 1, HG_BASE_HITPAUSE, 12);
set_hitbox_value(AT_FSTRONG, 1, HG_HITPAUSE_SCALING, 1.1);
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sound_get("chaos_heavy_hit"));
...
set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT, 129);
