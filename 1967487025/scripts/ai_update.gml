...
if get_training_cpu_action() == CPU_FIGHT {
	if temp_level == 9 && state == PS_SPAWN && introTimer == 2 && introTimer2 == 0 {
		sound_play(sound_get("true power"))
		runeA = true; //Uspecial lagless
		runeB = true; //Nair
		runeC = true; //Stun
		runeD = true; //Dspecial
		runeE = true; //Fspecial
		runeF = true; //Dstrong
		runeG = true; //06 Boost
		runeH = true; //Meter regen
		runeI = true; //Half costs
		runeJ = true; //Airdodge to opp
		runeK = true; //SPEED
		runeL = true; //Chaos Control
		runeM = true; //Chaos Blast
		runeN = true; //Chaos Rift
		runeO = true; //Teleport
		is_level_9 = true;
}
...
//copied from Kirby, I did not write this
