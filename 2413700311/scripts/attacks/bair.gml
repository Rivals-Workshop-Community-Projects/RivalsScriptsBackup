...
set_window_value(AT_BAIR, 3, AG_WINDOW_SFX, asset_get("sfx_ell_uspecial_explode"));
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, asset_get("sfx_ell_strong_attack_explosion"));
...
set_hitbox_value(AT_BAIR, 2, HG_PROJECTILE_HSPEED, -4);
