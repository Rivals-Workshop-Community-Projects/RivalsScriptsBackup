...
set_window_value(AT_NSPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_shovel_swing_med1"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, 119);
//set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT_Y_OFFSET, -16);
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_ice_nspecial_hit_ground"));
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("nspe_proj"));
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("nspe_proj_hurt"));
