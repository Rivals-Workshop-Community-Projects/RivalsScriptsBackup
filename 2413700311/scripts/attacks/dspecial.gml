...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX, sound_get("fstr2"));
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_INVINCIBILITY	, 1);//無敵
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_spin"));
...
set_window_value(AT_DSPECIAL, 5, AG_WINDOW_HAS_CUSTOM_FRICTION, 5);
...
set_window_value(AT_DSPECIAL, 6, AG_WINDOW_HSPEED, 1);
set_window_value(AT_DSPECIAL, 6, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(AT_DSPECIAL, 6, AG_WINDOW_HAS_WHIFFLAG, 5);
