...
set_attack_value(AT_DSPECIAL_2, AG_SPRITE, sprite_get("headless_dspecial"));
set_attack_value(AT_DSPECIAL_2, AG_NUM_WINDOWS, 5);
set_attack_value(AT_DSPECIAL_2, AG_HURTBOX_SPRITE, sprite_get("headless_dspecial_hurt"));
...
set_window_value(AT_DSPECIAL_2, 2, AG_WINDOW_SFX, asset_get("sfx_zetter_shine"));
...
set_window_value(AT_DSPECIAL_2, 5, AG_WINDOW_HAS_WHIFFLAG, 2);
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_WIDTH, 38);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HEIGHT, 38);
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_FINAL_BASE_KNOCKBACK, 1);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_BASE_HITPAUSE, 4);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_VISUAL_EFFECT_X_OFFSET, 20);
