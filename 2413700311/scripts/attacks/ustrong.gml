...
set_window_value(AT_USTRONG, 1, AG_WINDOW_SFX, sound_get("fstr2"));
...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, sound_get("ustr1"));
...
set_window_value(AT_USTRONG, 4, AG_WINDOW_SFX, sound_get("ustr2"));
