...
set_attack_value(AT_USPECIAL, AG_AIR_SPRITE, sprite_get("uspecial_air"));//空中攻撃に使用するスプライト
set_attack_value(AT_USPECIAL, AG_HURTBOX_SPRITE, sprite_get("uspecial_hurt"));//攻撃の当たり判定に使用するスプライト
set_attack_value(AT_USPECIAL, AG_HURTBOX_AIR_SPRITE, sprite_get("uspecial_air_hurt"));//空中攻撃の当たり判定に使用するスプライト

//-----------------------------------------
//構え
set_window_value(AT_USPECIAL, 1, AG_WINDOW_LENGTH, 14);//フレーム単位のウィンドウの継続時間
