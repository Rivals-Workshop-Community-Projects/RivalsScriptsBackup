...
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, sfx_swipe4);
...
set_window_value(AT_JAB, 4, AG_WINDOW_SFX, sfx_swipe6);
...
set_window_value(AT_JAB, 7, AG_WINDOW_SFX, sfx_swipe3);
...
set_hitbox_value(AT_JAB, 3, HG_HITBOX_X, 47);
set_hitbox_value(AT_JAB, 3, HG_HITBOX_Y, -46);
set_hitbox_value(AT_JAB, 3, HG_WIDTH, 49);
...
set_hitbox_value(AT_JAB, 4, HG_HITBOX_Y, -26);
set_hitbox_value(AT_JAB, 4, HG_WIDTH, 69);
set_hitbox_value(AT_JAB, 4, HG_HEIGHT, 32);
