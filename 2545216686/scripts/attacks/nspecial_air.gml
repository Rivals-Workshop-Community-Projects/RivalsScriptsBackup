...
set_attack_value(AT_NSPECIAL_AIR, AG_MUNO_ATTACK_NAME, "NSpecial: Energy Shot");
set_attack_value(AT_NSPECIAL_AIR, AG_MUNO_ATTACK_MISC_ADD, "Projectile that stuns.
...
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_MUNO_HITBOX_NAME, "Projectile Hitbox");
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_WINDOW, 99999);
...
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_DAMAGE, 9 - (nspecMultihitRune * 4));
...
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_HITSTUN_MULTIPLIER, 0.8);
...
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_HSPEED, 4 + (nspecMultihitRune * 3));
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_VSPEED, 4 + (nspecMultihitRune * 3));
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_GROUND_BEHAVIOR, 2);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_VISUAL_EFFECT, 157 - (nspecMultihitRune * 136));
