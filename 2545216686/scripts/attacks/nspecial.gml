...
set_hitbox_value(AT_NSPECIAL, 1, HG_DAMAGE, 9 - (nspecMultihitRune * 4));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_HSPEED, 4 + (nspecMultihitRune * 3));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_EXTRA_HITPAUSE, 32);
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("empty_sprite"));
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_ANIM_SPEED, .16);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_DESTROY_EFFECT, 157);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_PROJECTILE_ANIM_SPEED, .16);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_PROJECTILE_DESTROY_EFFECT, 157);
