...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sfx_energyshot);
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX_FRAME, 25);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("energy_shot"));
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_ANIM_SPEED, .16);
