...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sound_get("throw"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("knife_g"));
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_VSPEED, -7.2);
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_HSPEED, 4.8);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, sound_get("knife_hit1"));
...
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("knife_g"));
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_VSPEED, -4.8);
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_HSPEED, 7.2);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, sound_get("knife_hit1"));
...
set_hitbox_value(AT_FSPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("knife_g"));
...
set_hitbox_value(AT_FSPECIAL, 3, HG_HIT_SFX, sound_get("knife_hit1"));
