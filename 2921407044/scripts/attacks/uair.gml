...
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -114);
...
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -116);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 43);
