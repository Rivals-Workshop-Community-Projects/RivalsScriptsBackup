...
set_attack_value(attack, AG_SPRITE, sprite_get("fspecial")); //sprite_get("")
set_attack_value(attack, AG_AIR_SPRITE, 0);
set_attack_value(attack, AG_HURTBOX_SPRITE, sprite_get("fspecial_hurt")); //sprite_get("_hurt")
...
set_attack_value(attack, AG_LANDING_LAG, 1);
...
// Window #1 / Frame(s) # 0-1 / Start Up Charging Loop
...
// Window #3 / Frame(s) # 3 / Before Speed Apply
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #6 / Frame(s) # 11-12 / Normal Endlag no hitbox
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HITBOX_TYPE, 2); // Sets to a projectile
set_hitbox_value(AT_FSPECIAL, 2, 80, 1); // Exclude from Woodcock
set_hitbox_value(AT_FSPECIAL, 2, HG_WINDOW, 1); // Window the attack Spawns from
set_hitbox_value(AT_FSPECIAL, 2, HG_WINDOW_CREATION_FRAME, get_window_value(AT_FSPECIAL,1,AG_WINDOW_LENGTH) - 1); // Window the attack Spawns from
set_hitbox_value(AT_FSPECIAL, 2, HG_LIFETIME, 120); // Hitbox Lifetime in Frames
set_hitbox_value(AT_FSPECIAL, 2, HG_HITBOX_X, -15); // The x position of the center of the hitbox, relative to the center of the player
set_hitbox_value(AT_FSPECIAL, 2, HG_HITBOX_Y, -60); // The y position of the center of the hitbox, relative to the center of the player
set_hitbox_value(AT_FSPECIAL, 2, HG_WIDTH, 14); //The width of the hitbox, in pixels.
set_hitbox_value(AT_FSPECIAL, 2, HG_HEIGHT, 8); //The width of the hitbox, in pixels.
set_hitbox_value(AT_FSPECIAL, 2, HG_PRIORITY, 0); // Priority score for hitbox.
set_hitbox_value(AT_FSPECIAL, 2, HG_DAMAGE, 0); // Damage dealt by hitbox 
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("shell")); // Call the sprite without "_strip"
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_MASK, sprite_get("shell")); // This will overlay hit box to make precise.
//set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_ANIM_SPEED, .5); // How fast it loops through the animation.
...
//Shell 2
set_hitbox_value(AT_FSPECIAL, 3, HG_HITBOX_TYPE, 2); // Sets to a projectile
set_hitbox_value(AT_FSPECIAL, 3, 80, 1); // Exclude from Woodcock
set_hitbox_value(AT_FSPECIAL, 3, HG_WINDOW, 1); // Window the attack Spawns from
set_hitbox_value(AT_FSPECIAL, 3, HG_WINDOW_CREATION_FRAME, get_window_value(AT_FSPECIAL,1,AG_WINDOW_LENGTH) - 1); // Window the attack Spawns from
set_hitbox_value(AT_FSPECIAL, 3, HG_LIFETIME, 120); // Hitbox Lifetime in Frames
set_hitbox_value(AT_FSPECIAL, 3, HG_HITBOX_X, -25); // The x position of the center of the hitbox, relative to the center of the player
set_hitbox_value(AT_FSPECIAL, 3, HG_HITBOX_Y, -60); // The y position of the center of the hitbox, relative to the center of the player
set_hitbox_value(AT_FSPECIAL, 3, HG_WIDTH, 14); //The width of the hitbox, in pixels.
set_hitbox_value(AT_FSPECIAL, 3, HG_HEIGHT, 8); //The width of the hitbox, in pixels.
set_hitbox_value(AT_FSPECIAL, 3, HG_PRIORITY, 0); // Priority score for hitbox.
set_hitbox_value(AT_FSPECIAL, 3, HG_DAMAGE, 0); // Damage dealt by hitbox 0 to 10.
set_hitbox_value(AT_FSPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("shell")); // Call the sprite without "_strip"
set_hitbox_value(AT_FSPECIAL, 3, HG_PROJECTILE_MASK, sprite_get("shell")); // This will overlay hit box to make precise.
//set_hitbox_value(At_FSPECIAL, 3, HG_PROJECTILE_ANIM_SPEED, .5); // How fast it loops through the animation.
...
set_hitbox_value(AT_FSPECIAL, 3, HG_PROJECTILE_GRAVITY, 1);
set_hitbox_value(AT_FSPECIAL, 3, HG_PROJECTILE_HSPEED, -1); // How much the hit box moves, should be Slow or zero for this attack.
