...
switch(draw_menu){
	case DRAW_NO_MENU:
		...
		textDraw(x + 10, y + 140, "fName", c_white, 18, 200, 1, true, 1,"#" + string(get_player_color(player)) + mode_indicator_suffix +":" + string(slot_property_array[ get_player_color(player) + (color_shift * 32),0]))
	...
	//textDraw(x + 50, y + 70, "fName", c_white, 18, 200, 1, false, 1, mode_string); reenable for added color alts
	...
	*/
	...
	draw_menu_button(BOX_CLOSE_INTERAL_MENU);
	// Draw Text
	textDraw(x + 20, y + 80, "fName", c_white, 18, 210, 1, false, 1,
	"Extra Alts 
	to be added 
	later!")
	break;
	...
	// Draw partial rectangle Underlay
		...
		"Developer: Opengunner
		DE Release Date: 1/21/23
		Original Release: 2/15/21"
		);
