...
set_hitbox_value(AT_USPECIAL_2, 1, HG_HITPAUSE_SCALING, 0.6);
set_hitbox_value(AT_USPECIAL_2, 1, HG_VISUAL_EFFECT, 303);
set_hitbox_value(AT_USPECIAL_2, 1, HG_SDI_MULTIPLIER, 1.1);
set_hitbox_value(AT_USPECIAL_2, 1, HG_DRIFT_MULTIPLIER, 1.5);
...
set_hitbox_value(AT_USPECIAL_2, 3, HG_HITPAUSE_SCALING, 0.6);
set_hitbox_value(AT_USPECIAL_2, 3, HG_SDI_MULTIPLIER, 1.1);
set_hitbox_value(AT_USPECIAL_2, 3, HG_DRIFT_MULTIPLIER, 1.5);
