...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_zetter_downb"));
...
set_hitbox_value(AT_FSTRONG, 2, HG_ANGLE_FLIPPER, 10);
...
set_hitbox_value(AT_FSTRONG, 4, HG_HITBOX_X, 57);
set_hitbox_value(AT_FSTRONG, 4, HG_HITBOX_Y, -37);
set_hitbox_value(AT_FSTRONG, 4, HG_WIDTH, 85);
set_hitbox_value(AT_FSTRONG, 4, HG_HEIGHT, 57);
...
set_hitbox_value(AT_FSTRONG, 4, HG_HIT_SFX, sound_get("sfx_krdl_fire_hit"));
...
set_hitbox_value(AT_FSTRONG, 5, HG_WIDTH, 39);
set_hitbox_value(AT_FSTRONG, 5, HG_TECHABLE, 3);
set_hitbox_value(AT_FSTRONG, 5, HG_HEIGHT, 38);
...
set_hitbox_value(AT_FSTRONG, 5, HG_HIT_SFX, sound_get("sfx_krdl_fire_hit"));
