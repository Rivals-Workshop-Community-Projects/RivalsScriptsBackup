...
char_height         = 52;
norm_height = 52;
suit_height = 102;//                  not zetterburn's. this is just cosmetic anyway
...
//Sprites
nspecial_proj = sprite_get("nspecial_proj");
ustrong_proj = sprite_get("ustrong_proj");
nspecial_proj_big = sprite_get("nspecial_proj_big");
spr_example = sprite_get("example"); // sprites/example_stripX.png

// SFX
sfx_charge = sound_get("sfx_charge_1");
sfx_charge_start = sound_get("sfx_charge_start");
sfx_charge_loop = sound_get("sfx_charge_loop");
sfx_drill_land = sound_get("sfx_drill_land");
sfx_dbfz_hit_broken = sound_get("ARC_BTL_CMN_Hit_XLarge");
sfx_dbfz_hit_jab3 = sound_get("ARC_BTL_GKN_Atk5A_3rd_Hit");

// VFX
flare = hit_fx_create(sprite_get("flare"), 20); // actually for nspecial, not ftilt
drill_trail = hit_fx_create(sprite_get("drillbit_trail"), 8);

disappear = hit_fx_create(sprite_get("disappear"), 15);
...
voice_chance = 0;
sfx_susie_yell = noone;
sfx_susie_yell1 = sound_get("sfx_susie_yell1");
sfx_susie_yell2 = sound_get("sfx_susie_yell2");

temp_blockdetection = noone;
...
spin          = sound_get("sfx_spin_loop");
// Victory
set_victory_bg(sprite_get("victory_bg")); // victory_background.png
set_victory_theme(sound_get("mus_susie_wins")); // victory_theme.ogg
...
window_time = noone;
next_window_time = noone;

/*artificial_hitstop = false;
artificial_hitstop_time = 0;
pre_hitstop_hsp = noone;
pre_hitstop_vsp = noone;*/

// Compatibility
Hikaru_Title = "Wicked Company";
arena_title = "Rutheless Buisness Executive";
battle_text = "Susie analyzes your skills."
