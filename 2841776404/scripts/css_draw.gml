...
if (!variable_instance_exists(id,"ae") || ye == true){
    ...
    ce[0,0] = make_color_rgb(248, 74, 174) // "color preview square" color. can be any color!
    ce[0,1] = "Default Setting" // the name of the alternate color.
    
    ce[1,0] = make_color_rgb(255, 217, 0)
    ce[1,1] = "Honey Lemon"
    
    ce[2,0] = make_color_rgb(77, 201, 255)
    ce[2,1] = "Blue Raspberry"
    
    ce[3,0] = make_color_rgb(144, 255, 46)
    ce[3,1] = "Keylime Pie"
    
    ce[4,0] = make_color_rgb(158, 78, 230)
    ce[4,1] = "Forgotten Father"
    
    ce[5,0] = make_color_rgb(217, 48, 90)
    ce[5,1] = "Parallel Doppelganger"
    
    ce[6,0] = make_color_rgb(78, 23, 141)
    ce[6,1] = "Abyss"
	
    ce[7,0] = make_color_rgb(83, 122, 62)
    ce[7,1] = "Early Access"
	
    ce[8,0] = make_color_rgb(59, 60, 56)
    ce[8,1] = "Mind in a Program"
	
    ce[9,0] = make_color_rgb(125, 42, 2)
    ce[9,1] = "Soul Zero System"
	
    ce[10,0] = make_color_rgb(7, 129, 237)
    ce[10,1] = "Frozen General"
	
    ce[11,0] = make_color_rgb(204, 40, 34)
    ce[11,1] = "Blazing General"

    ce[12,0] = make_color_rgb(232, 204, 21)
    ce[12,1] = "Lightning General"
	
    ce[13,0] = make_color_rgb(41, 99, 255)
    ce[13,1] = "Visitor from Afar"
	
    ce[14,0] = make_color_rgb(255, 38, 53)
    ce[14,1] = "War Machine EX"
	
    ce[15,0] = make_color_rgb(144, 181, 41)
    ce[15,1] = "Gigabyte Guardian"

    ce[16,0] = make_color_rgb(184, 31, 30)
    ce[16,1] = "Mecha Knightmare"

    ce[17,0] = make_color_rgb(216, 27, 27)
    ce[17,1] = "Tri-Dimensional Cannon"

    ce[18,0] = make_color_rgb(227, 184, 0)
    ce[18,1] = "Golden"
	
    ce[19,0] = make_color_rgb(255, 0, 136)
    ce[19,1] = "Pink Ball Revolution"
	
    ce[20,0] = make_color_rgb(255, 241, 179)
    ce[20,1] = "Motherly Love"

    ce[21,0] = make_color_rgb(157, 212, 84)
    ce[21,1] = "Full Steam Vengeance"

    ce[22,0] = make_color_rgb(87, 132, 255)
    ce[22,1] = "Cyber Queen"
