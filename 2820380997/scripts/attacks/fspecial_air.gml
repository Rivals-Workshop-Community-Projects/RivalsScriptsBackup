...
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_bird_downspecial")); // asset_get("") or sound_get("")
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, 10); //get_window_value(attack,window_num,AG_WINDOW_LENGTH)-1);
