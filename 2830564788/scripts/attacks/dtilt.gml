...
set_hitbox_value(AT_DTILT, 1, HG_DAMAGE, 6); // 1
set_hitbox_value(AT_DTILT, 1, HG_ANGLE, 75); // 2
set_hitbox_value(AT_DTILT, 1, HG_BASE_KNOCKBACK, 6); // 3
set_hitbox_value(AT_DTILT, 1, HG_KNOCKBACK_SCALING, .3); // 4
set_hitbox_value(AT_DTILT, 1, HG_PRIORITY, 1); // 5
set_hitbox_value(AT_DTILT, 1, HG_BASE_HITPAUSE, 5); // 6
set_hitbox_value(AT_DTILT, 1, HG_HITPAUSE_SCALING, .35); // 7
set_hitbox_value(AT_DTILT, 1, HG_ANGLE_FLIPPER, 0); // 8
