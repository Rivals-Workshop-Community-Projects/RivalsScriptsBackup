...
set_hitbox_value(AT_UAIR, 1, HG_DAMAGE, 6); // 1
set_hitbox_value(AT_UAIR, 1, HG_ANGLE, 70); // 2
set_hitbox_value(AT_UAIR, 1, HG_BASE_KNOCKBACK, 6); // 3
set_hitbox_value(AT_UAIR, 1, HG_KNOCKBACK_SCALING, .8); // 4
set_hitbox_value(AT_UAIR, 1, HG_PRIORITY, 4); // 5
set_hitbox_value(AT_UAIR, 1, HG_BASE_HITPAUSE, 7); // 6
set_hitbox_value(AT_UAIR, 1, HG_HITPAUSE_SCALING, .8); // 7
set_hitbox_value(AT_UAIR, 1, HG_ANGLE_FLIPPER, 6); // 8
