...
set_window_value(AT_USTRONG, 1, AG_WINDOW_ANIM_FRAMES, 0);
...
set_window_value(AT_USTRONG, 3, AG_WINDOW_ANIM_FRAMES, 0);
...
set_hitbox_value(AT_USTRONG, 1, HG_DAMAGE, 12); // 1
set_hitbox_value(AT_USTRONG, 1, HG_ANGLE, 90); // 2
set_hitbox_value(AT_USTRONG, 1, HG_BASE_KNOCKBACK, 7); // 3
set_hitbox_value(AT_USTRONG, 1, HG_KNOCKBACK_SCALING, 1); // 4
set_hitbox_value(AT_USTRONG, 1, HG_PRIORITY, 3); // 5
set_hitbox_value(AT_USTRONG, 1, HG_BASE_HITPAUSE, 10); // 6
set_hitbox_value(AT_USTRONG, 1, HG_HITPAUSE_SCALING, 1); // 7
set_hitbox_value(AT_USTRONG, 1, HG_ANGLE_FLIPPER, 0); // 8
