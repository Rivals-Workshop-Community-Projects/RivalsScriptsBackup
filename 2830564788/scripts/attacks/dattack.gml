...
set_window_value(AT_DATTACK, 2, AG_WINDOW_ANIM_FRAMES, 0);
...
set_hitbox_value(AT_DATTACK, 1, HG_DAMAGE, 4); // 1
set_hitbox_value(AT_DATTACK, 1, HG_ANGLE, 40); // 2
set_hitbox_value(AT_DATTACK, 1, HG_BASE_KNOCKBACK, 5); // 3
set_hitbox_value(AT_DATTACK, 1, HG_KNOCKBACK_SCALING, 0); // 4
set_hitbox_value(AT_DATTACK, 1, HG_PRIORITY, 2); // 5
set_hitbox_value(AT_DATTACK, 1, HG_BASE_HITPAUSE, 6); // 6
set_hitbox_value(AT_DATTACK, 1, HG_HITPAUSE_SCALING, 0); // 7
set_hitbox_value(AT_DATTACK, 1, HG_ANGLE_FLIPPER, 0); // 8
