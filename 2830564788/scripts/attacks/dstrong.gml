...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_ANIM_FRAMES, 0);
...
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 51);
set_hitbox_value(AT_DSTRONG, 1, HG_HEIGHT, 36);
set_hitbox_value(AT_DSTRONG, 1, HG_SHAPE, 2);
set_hitbox_value(AT_DSTRONG, 1, HG_DAMAGE, 10); // 1
set_hitbox_value(AT_DSTRONG, 1, HG_ANGLE, 60); // 2
set_hitbox_value(AT_DSTRONG, 1, HG_BASE_KNOCKBACK, 9); // 3
set_hitbox_value(AT_DSTRONG, 1, HG_KNOCKBACK_SCALING, 1); // 4
set_hitbox_value(AT_DSTRONG, 1, HG_PRIORITY, 4); // 5
set_hitbox_value(AT_DSTRONG, 1, HG_BASE_HITPAUSE, 7); // 6
set_hitbox_value(AT_DSTRONG, 1, HG_HITPAUSE_SCALING, 1); // 7
set_hitbox_value(AT_DSTRONG, 1, HG_ANGLE_FLIPPER, 6); // 8
