...
set_hitbox_value(AT_FSTRONG, 1, HG_DAMAGE, 12); // 1
set_hitbox_value(AT_FSTRONG, 1, HG_ANGLE, 45); // 2
set_hitbox_value(AT_FSTRONG, 1, HG_BASE_KNOCKBACK, 5); // 3
set_hitbox_value(AT_FSTRONG, 1, HG_KNOCKBACK_SCALING, 1); // 4
set_hitbox_value(AT_FSTRONG, 1, HG_PRIORITY, 3); // 5
set_hitbox_value(AT_FSTRONG, 1, HG_BASE_HITPAUSE, 10); // 6
set_hitbox_value(AT_FSTRONG, 1, HG_HITPAUSE_SCALING, .25); // 7
set_hitbox_value(AT_FSTRONG, 1, HG_ANGLE_FLIPPER, 0); // 8
