...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("BladesAttackSideAir"));
...
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_X, -54);
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("BladesAttackRapidHit"));
...
set_hitbox_value(AT_BAIR, 3, HG_HITBOX_X, -54);
...
set_hitbox_value(AT_BAIR, 3, HG_HIT_SFX, sound_get("BladesAttackRapidHit"));
