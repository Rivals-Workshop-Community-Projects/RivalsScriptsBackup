...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("blast2"));
...
set_hitbox_value(AT_UTILT, 2, HG_HITBOX_Y, -4);
...
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, asset_get("sfx_absa_harderhit"));