set_attack_value(AT_TAUNT, AG_SPRITE, sprite_get("tauntb"));
...
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX, sound_get("spin"));
...
set_window_value(AT_TAUNT, 5, AG_WINDOW_TYPE, 2);
...
set_hitbox_value(AT_TAUNT, 1, HG_WIDTH, 5);
set_hitbox_value(AT_TAUNT, 1, HG_HEIGHT, 5);
...
set_hitbox_value(AT_TAUNT, 1, HG_KNOCKBACK_SCALING, 1.6);
...
set_hitbox_value(AT_TAUNT, 1, HG_HIT_SFX, sound_get("bat"));
