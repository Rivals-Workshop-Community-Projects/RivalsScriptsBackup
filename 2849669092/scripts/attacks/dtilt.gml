...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, sound_get("blast"));
...
set_hitbox_value(AT_DTILT, 1, HG_WIDTH, 89);
...
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_Y_OFFSET, 5);
...
set_hitbox_value(AT_DTILT, 2, HG_WIDTH, 39);
...
set_hitbox_value(AT_DTILT, 2, HG_VISUAL_EFFECT_Y_OFFSET, 5);
set_hitbox_value(AT_DTILT, 2, HG_HIT_SFX, asset_get("sfx_absa_singlezap1"));