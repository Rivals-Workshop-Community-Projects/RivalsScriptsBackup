...
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 69);
...
set_hitbox_value(AT_BAIR, 3, HG_HEIGHT, 69);
...
set_hitbox_value(AT_BAIR, 4, HG_HEIGHT, 69);
...
set_hitbox_value(AT_BAIR, 4, HG_VISUAL_EFFECT_X_OFFSET, 20);
set_hitbox_value(AT_BAIR, 4, HG_VISUAL_EFFECT_Y_OFFSET, -20);
