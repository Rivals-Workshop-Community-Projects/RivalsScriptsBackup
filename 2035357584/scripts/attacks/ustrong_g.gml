...
//charge
set_window_value(AT_USTRONG_G, 1, AG_WINDOW_LENGTH, 17);
...
//active
set_window_value(AT_USTRONG_G, 3, AG_WINDOW_LENGTH, 9);
...
set_hitbox_value(AT_USTRONG_G, 3, HG_LIFETIME, 6);
...
set_hitbox_value(AT_USTRONG_G, 3, HG_BASE_KNOCKBACK, 10);
set_hitbox_value(AT_USTRONG_G, 3, HG_KNOCKBACK_SCALING, 1.15);
set_hitbox_value(AT_USTRONG_G, 3, HG_BASE_HITPAUSE, 11);
set_hitbox_value(AT_USTRONG_G, 3, HG_HITPAUSE_SCALING, .8);
set_hitbox_value(AT_USTRONG_G, 3, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_USTRONG_G, 3, HG_HIT_SFX, asset_get("sfx_blow_heavy2"));
...
set_hitbox_value(AT_USTRONG_G, 4, HG_LIFETIME, 6);
...
set_hitbox_value(AT_USTRONG_G, 4, HG_HEIGHT, 108);
...
set_hitbox_value(AT_USTRONG_G, 4, HG_KNOCKBACK_SCALING, 1.0);
