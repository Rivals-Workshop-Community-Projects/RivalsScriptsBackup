...
set_hitbox_value(AT_FAIR_G, 2, HG_HITBOX_X, 58);
set_hitbox_value(AT_FAIR_G, 2, HG_HITBOX_Y, -45);
set_hitbox_value(AT_FAIR_G, 2, HG_WIDTH, 110);
set_hitbox_value(AT_FAIR_G, 2, HG_HEIGHT, 85);
