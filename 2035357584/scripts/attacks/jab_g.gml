...
set_window_value(AT_JAB_G, 3, AG_WINDOW_HAS_WHIFFLAG, 1);
...
set_window_value(AT_JAB_G, 6, AG_WINDOW_HAS_WHIFFLAG, 1);
...
set_window_value(AT_JAB_G, 9, AG_WINDOW_HAS_WHIFFLAG, 1);
