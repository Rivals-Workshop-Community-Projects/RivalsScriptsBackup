...
//ftiltg active
set_window_value(AT_FTILT_G, 2, AG_WINDOW_LENGTH, 5);
set_window_value(AT_FTILT_G, 2, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_FTILT_G, 2, AG_WINDOW_ANIM_FRAME_START, 4);

//ftiltg end
set_window_value(AT_FTILT_G, 3, AG_WINDOW_LENGTH, 18);
set_window_value(AT_FTILT_G, 3, AG_WINDOW_ANIM_FRAMES, 5);
set_window_value(AT_FTILT_G, 3, AG_WINDOW_ANIM_FRAME_START, 5);
...
set_hitbox_value(AT_FTILT_G, 1, HG_LIFETIME, 5);
...
set_hitbox_value(AT_FTILT_G, 1, HG_ANGLE, 40);
set_hitbox_value(AT_FTILT_G, 1, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_FTILT_G, 1, HG_KNOCKBACK_SCALING, .4);
set_hitbox_value(AT_FTILT_G, 1, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_FTILT_G, 1, HG_HITPAUSE_SCALING, .6);
