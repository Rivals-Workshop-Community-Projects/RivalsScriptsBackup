...
//dattackg end
set_window_value(AT_DATTACK_G, 3, AG_WINDOW_LENGTH, 15);
set_window_value(AT_DATTACK_G, 3, AG_WINDOW_ANIM_FRAMES, 2);
...
set_hitbox_value(AT_DATTACK_G, 1, HG_KNOCKBACK_SCALING, .9);
set_hitbox_value(AT_DATTACK_G, 1, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_DATTACK_G, 1, HG_HITPAUSE_SCALING, .9);
...
set_hitbox_value(AT_DATTACK_G, 2, HG_LIFETIME, 4);
...
set_hitbox_value(AT_DATTACK_G, 2, HG_KNOCKBACK_SCALING, .9);
set_hitbox_value(AT_DATTACK_G, 2, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_DATTACK_G, 2, HG_HITPAUSE_SCALING, .9);
