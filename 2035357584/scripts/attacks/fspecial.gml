...
set_hitbox_value(AT_FSPECIAL, 11, HG_WIDTH, 80);
set_hitbox_value(AT_FSPECIAL, 11, HG_HEIGHT, 45);
...
set_hitbox_value(AT_FSPECIAL, 11, HG_HITSTUN_MULTIPLIER, 0.7);
...
set_hitbox_value(AT_FSPECIAL, 12, HG_WIDTH, 80);
set_hitbox_value(AT_FSPECIAL, 12, HG_HEIGHT, 45);
...
set_hitbox_value(AT_FSPECIAL, 12, HG_HITSTUN_MULTIPLIER, 0.7);
...
set_hitbox_value(AT_FSPECIAL, 13, HG_WIDTH, 90);
...
set_hitbox_value(AT_FSPECIAL, 13, HG_HITPAUSE_SCALING, .7);
set_hitbox_value(AT_FSPECIAL, 13, HG_VISUAL_EFFECT, 13);
set_hitbox_value(AT_FSPECIAL, 13, HG_HITSTUN_MULTIPLIER, 0.7);
