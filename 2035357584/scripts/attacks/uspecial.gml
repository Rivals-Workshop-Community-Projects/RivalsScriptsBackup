...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, sound_get("zipballoon"));
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_HSPEED, BALLOON_H_SPEED);
set_window_value(AT_USPECIAL, 2, AG_WINDOW_VSPEED, BALLOON_V_SPEED);
set_window_value(AT_USPECIAL, 2, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_USPECIAL, 2, AG_WINDOW_VSPEED_TYPE, 1);
set_window_value(AT_USPECIAL, 2, AG_WINDOW_CUSTOM_GRAVITY, gravity_speed);

//separate and open cute
...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX, sound_get("chute"));
