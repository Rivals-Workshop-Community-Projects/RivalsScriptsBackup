...
set_attack_value(AT_NAIR_G, AG_LANDING_LAG, 8);
...
//nairg active1
set_window_value(AT_NAIR_G, 2, AG_WINDOW_LENGTH, 2);
...
set_hitbox_value(AT_NAIR_G, 2, HG_DAMAGE, 10);
set_hitbox_value(AT_NAIR_G, 2, HG_ANGLE, 145);
set_hitbox_value(AT_NAIR_G, 2, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_NAIR_G, 2, HG_KNOCKBACK_SCALING, .45);
set_hitbox_value(AT_NAIR_G, 2, HG_BASE_HITPAUSE, 9);
set_hitbox_value(AT_NAIR_G, 2, HG_HITPAUSE_SCALING, .8);
set_hitbox_value(AT_NAIR_G, 2, HG_VISUAL_EFFECT, 301);
set_hitbox_value(AT_NAIR_G, 2, HG_HIT_SFX, asset_get("sfx_blow_heavy2"));
...
set_hitbox_value(AT_NAIR_G, 3, HG_ANGLE, 140);
