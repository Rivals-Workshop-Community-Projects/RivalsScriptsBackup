...
set_hitbox_value(AT_FSPECIAL, 1, HG_ANGLE, 90);//45
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, 1);//45

set_hitbox_value(AT_FSPECIAL, 1, HG_BASE_KNOCKBACK, 0);//8
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT, -1);
set_hitbox_value(AT_FSPECIAL, 1, HG_IGNORES_PROJECTILES, 1);//.2
set_hitbox_value(AT_FSPECIAL, 1, HG_GROUNDEDNESS, 2);//8
