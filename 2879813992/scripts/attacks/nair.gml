...
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_Y, -75);
...
set_hitbox_value(AT_NAIR, 2, HG_HITPAUSE_SCALING, .55);
...
set_hitbox_value(AT_NAIR, 3, HG_KNOCKBACK_SCALING, .55);
set_hitbox_value(AT_NAIR, 3, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_NAIR, 3, HG_HITPAUSE_SCALING, .55);
...
set_hitbox_value(AT_NAIR, 4, HG_HITBOX_X, 37);
...
set_hitbox_value(AT_NAIR, 4, HG_KNOCKBACK_SCALING, .55);
set_hitbox_value(AT_NAIR, 4, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_NAIR, 4, HG_HITPAUSE_SCALING, .55);
