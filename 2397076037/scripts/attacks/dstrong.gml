...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_LENGTH, 60);
...
set_hitbox_value(AT_DSTRONG, 1, HG_LIFETIME, 40);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_LOCKOUT, 30)
...
set_hitbox_value(AT_DSTRONG, 2, HG_DAMAGE, 30);
