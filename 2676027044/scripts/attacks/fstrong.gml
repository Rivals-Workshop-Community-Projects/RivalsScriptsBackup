...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_shovel_swing_heavy1"));
...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, .5);
...
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, hfx_wood_big);
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sound_get("woodhammer"));
