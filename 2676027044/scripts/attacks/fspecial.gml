...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sound_get("dashrough"));
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, .7);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_EXTRA_HITPAUSE, 31);
set_hitbox_value(AT_FSPECIAL, 1, HG_EFFECT, 6);
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, asset_get("playroughtest"));
