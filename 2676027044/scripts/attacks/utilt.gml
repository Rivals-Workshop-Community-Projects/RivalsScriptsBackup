...
set_hitbox_value(AT_UTILT, 1, HG_WIDTH, 63);
...
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sound_get("cut"));
...
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, sound_get("cut"));
...
set_hitbox_value(AT_UTILT, 3, HG_HIT_SFX, sound_get("cut"));
