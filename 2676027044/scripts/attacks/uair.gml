...
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT, hfx_wood_small);
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, -40);
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, sound_get("cut2"));
