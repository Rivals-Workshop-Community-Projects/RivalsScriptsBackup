...
set_hitbox_value(AT_DAIR, 1, HG_HITBOX_Y, 105);
...
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, asset_get("sfx_ori_spirit_flame_1"));
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, hfx_shadow_big);
...
set_hitbox_value(AT_DAIR, 2, HG_HEIGHT, 136);
...
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, sound_get("cut2"));
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT, hfx_shadow_mid);
