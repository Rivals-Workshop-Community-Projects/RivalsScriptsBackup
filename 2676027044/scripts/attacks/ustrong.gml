...
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_Y, -175);
...
set_hitbox_value(AT_USTRONG, 2, HG_HEIGHT, 180);
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("sharp3"));

set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, hfx_mimibig);
