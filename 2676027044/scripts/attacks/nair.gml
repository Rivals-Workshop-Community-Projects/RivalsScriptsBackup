...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sound_get("nair1"));
set_hitbox_value(AT_NAIR, 1, HG_HITBOX_GROUP, -11);
...
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_GROUP, -11);
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, sound_get("nair2"));
...
set_hitbox_value(AT_NAIR, 3, HG_VISUAL_EFFECT_Y_OFFSET, -15);
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, asset_get("sfx_blow_medium2"));
set_hitbox_value(AT_NAIR, 3, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, sound_get("nair3"));
