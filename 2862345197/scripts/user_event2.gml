...
//=================OTHER=================
//  hurt sprites
add_sprites("hurt","bouncehurt","bighurt","spinhurt","uphurt","downhurt");
...
if (get_player_color(player) == 2) set_skin("ice");
if (get_player_color(player) == 3) set_skin("man");
if (get_player_color(player) == 4 || get_player_color(player) == 27) set_skin("top");
if (get_player_color(player) == 5) set_skin("uni");
