set_attack_value(AT_JAB, AG_SPRITE, sprite_get("idle"));
set_attack_value(AT_JAB, AG_NUM_WINDOWS, 4);
set_attack_value(AT_JAB, AG_HURTBOX_SPRITE, sprite_get("shelly_hurtbox"));
set_attack_value(AT_JAB, AG_OFF_LEDGE, 1);
set_attack_value(AT_JAB, AG_MUNO_ATTACK_MISC_ADD, "Can be cancelled into FTilt and NAir by moving and jumping respectively.");
...
set_window_value(AT_JAB, 4, AG_WINDOW_HAS_WHIFFLAG, 1); //NOTE: if you make it a multi-hit jab, remove whifflag, since Rivals multi-step jabs do not have whifflag. single-hits like sandbert, elli, etc DO have whifflag
...
set_hitbox_value(AT_JAB, 1, HG_MUNO_HITBOX_NAME, "Laser (Normal)");
...
set_hitbox_value(AT_JAB, 1, HG_VISUAL_EFFECT, pshooter_hfx);
set_hitbox_value(AT_JAB, 1, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_JAB, 1, HG_VISUAL_EFFECT_Y_OFFSET, 0);
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("pshooter_hit_1"));
...
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_SPRITE, sprite_get("pshooter_proj_h"));
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_MASK, sprite_get("pshooter_mask"));
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_COLLISION_SPRITE, sprite_get("pshooter_mask"));
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_ANIM_SPEED, 0.7);
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_HSPEED, 10);
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_VSPEED, 0);
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_DESTROY_EFFECT, pshooter_destroy);
...
set_hitbox_value(AT_JAB, 2, HG_MUNO_HITBOX_NAME, "Laser
(Third Hit)");
set_hitbox_value(AT_JAB, 2, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_JAB, 2, HG_WINDOW, 2);
set_hitbox_value(AT_JAB, 2, HG_LIFETIME, 15);
