...
set_attack_value(AT_DATTACK, AG_MUNO_ATTACK_MISC_ADD, "Pressing the opposite direction reverses all momentum instantly. Has a cooldown of 30.");

set_window_value(AT_DATTACK, 1, AG_WINDOW_LENGTH, 4);
set_window_value(AT_DATTACK, 1, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_DATTACK, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sound_get("dash_boost"));
...
set_hitbox_value(AT_DATTACK, 1, HG_MUNO_HITBOX_NAME, "Sweetspot");
...
set_hitbox_value(AT_DATTACK, 2, HG_MUNO_HITBOX_NAME, "Sourspot");
