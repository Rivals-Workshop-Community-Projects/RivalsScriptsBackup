...
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT, square_hfx2);
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, 30);
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_Y_OFFSET, 10);
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, asset_get("sfx_absa_dattack"));
set_hitbox_value(AT_DTILT, 1, HG_HIT_PARTICLE_NUM, 1);
set_hitbox_value(AT_DTILT, 1, HG_ZAP, 1);