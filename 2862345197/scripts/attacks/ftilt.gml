...
set_attack_value(AT_FTILT, AG_MUNO_ATTACK_MISC_ADD, "Can be cancelled into Jump and NAir by stopping and jumping respectively.");
...
set_window_value(AT_FTILT, 4, AG_WINDOW_HAS_WHIFFLAG, 1); //NOTE: if you make it a multi-hit FTILT, remove whifflag, since Rivals multi-step FTILTs do not have whifflag. single-hits like sandbert, elli, etc DO have whifflag
...
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT, pshooter_hfx);
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT_Y_OFFSET, 0);
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, sound_get("pshooter_hit_1"));
set_hitbox_value(AT_FTILT, 1, HG_ANGLE_FLIPPER, 0);
set_hitbox_value(AT_FTILT, 1, HG_IGNORES_PROJECTILES, 1);
set_hitbox_value(AT_FTILT, 1, HG_SDI_MULTIPLIER, 2.0);
set_hitbox_value(AT_FTILT, 1, HG_FORCE_FLINCH, 1);
set_hitbox_value(AT_FTILT, 1, HG_HIT_PARTICLE_NUM, 2);

set_hitbox_value(AT_FTILT, 1, HG_PROJECTILE_SPRITE, sprite_get("pshooter_proj_h"));
set_hitbox_value(AT_FTILT, 1, HG_PROJECTILE_MASK, sprite_get("pshooter_mask"));
set_hitbox_value(AT_FTILT, 1, HG_PROJECTILE_COLLISION_SPRITE, sprite_get("pshooter_mask"));
...
set_hitbox_value(AT_FTILT, 1, HG_PROJECTILE_DESTROY_EFFECT, pshooter_destroy);
...
set_hitbox_value(AT_FTILT, 2, HG_MUNO_HITBOX_NAME, "Laser
(Third Hit)");
...
set_hitbox_value(AT_FTILT, 2, HG_SDI_MULTIPLIER, 2.0);
