...
set_window_value(AT_UAIR, 3, AG_WINDOW_LENGTH, 10); //2 frames more endlag
...
set_hitbox_value(AT_UAIR, 1, HG_WIDTH, 97);
...
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, asset_get("sfx_may_whip2"));
...
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, asset_get("sfx_may_whip2"));
