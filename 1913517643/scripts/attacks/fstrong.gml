...
set_hitbox_value(AT_FSTRONG, 2, HG_BASE_KNOCKBACK, 8); //was 7.5
...
set_hitbox_value(AT_FSTRONG, 3, HG_BASE_KNOCKBACK, 6); //was 5.5
set_hitbox_value(AT_FSTRONG, 3, HG_KNOCKBACK_SCALING, .85); //was .85
