...
set_hitbox_value(AT_DAIR, 5, HG_HITBOX_Y, -9);
...
set_hitbox_value(AT_DAIR, 7, HG_WIDTH, 50);
...
//set_hitbox_value(AT_DAIR, 7, HG_FINAL_BASE_KNOCKBACK, 6);
...
set_hitbox_value(AT_DAIR, 8, HG_WINDOW, 8);
set_hitbox_value(AT_DAIR, 8, HG_LIFETIME, 2);
set_hitbox_value(AT_DAIR, 8, HG_HITBOX_X, 8);
set_hitbox_value(AT_DAIR, 8, HG_HITBOX_Y, 8);
set_hitbox_value(AT_DAIR, 8, HG_WIDTH, 50);
...
set_hitbox_value(AT_DAIR, 8, HG_ANGLE, 80);
set_hitbox_value(AT_DAIR, 8, HG_BASE_KNOCKBACK, 4);
set_hitbox_value(AT_DAIR, 8, HG_KNOCKBACK_SCALING, .6);
//set_hitbox_value(AT_DAIR, 8, HG_FINAL_BASE_KNOCKBACK, 6);
