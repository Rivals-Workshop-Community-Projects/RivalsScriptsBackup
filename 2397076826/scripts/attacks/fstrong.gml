...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_ice_on_player"));
...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_bird_sidespecial_start"));
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_HSPEED, 12);
...
set_window_value(AT_FSTRONG, 6, AG_WINDOW_TYPE, 7);
...
set_window_value(AT_FSTRONG, 6, AG_WINDOW_SFX, sound_get("Fstrong"));


set_window_value(AT_FSTRONG, 7, AG_WINDOW_LENGTH, 10);
set_window_value(AT_FSTRONG, 7, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_FSTRONG, 7, AG_WINDOW_ANIM_FRAME_START, 23);


set_window_value(AT_FSTRONG, 8, AG_WINDOW_LENGTH, 24);
...
set_window_value(AT_FSTRONG, 8, AG_WINDOW_SFX, sound_get("Fstrong"));
...
set_hitbox_value(AT_FSTRONG, 4, HG_HITBOX_X, -8);
set_hitbox_value(AT_FSTRONG, 4, HG_HITBOX_Y, -101);
...
set_hitbox_value(AT_FSTRONG, 4, HG_ANGLE, 140);
set_hitbox_value(AT_FSTRONG, 4, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_FSTRONG, 4, HG_BASE_HITPAUSE, 14);
...
set_hitbox_value(AT_FSTRONG, 2, HG_WIDTH, 92);
...
set_hitbox_value(AT_FSTRONG, 5, HG_HITBOX_X, -63);
set_hitbox_value(AT_FSTRONG, 5, HG_HITBOX_Y, -51);
set_hitbox_value(AT_FSTRONG, 5, HG_WIDTH, 90);
set_hitbox_value(AT_FSTRONG, 5, HG_HEIGHT, 94);
...
set_hitbox_value(AT_FSTRONG, 5, HG_ANGLE, 140);
set_hitbox_value(AT_FSTRONG, 5, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_FSTRONG, 5, HG_BASE_HITPAUSE, 14);
set_hitbox_value(AT_FSTRONG, 5, HG_HITPAUSE_SCALING, .7);
set_hitbox_value(AT_FSTRONG, 5, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_FSTRONG, 5, HG_VISUAL_EFFECT_Y_OFFSET, 1);
set_hitbox_value(AT_FSTRONG, 5, HG_HIT_SFX, sound_get("slice"));
set_hitbox_value(AT_FSTRONG, 5, HG_HITSTUN_MULTIPLIER, 1);
set_hitbox_value(AT_FSTRONG, 5, HG_VISUAL_EFFECT, 303);
set_hitbox_value(AT_FSTRONG, 5, HG_TECHABLE, 3);
set_hitbox_value(AT_FSTRONG, 5, HG_SDI_MULTIPLIER, 0.1);
...
set_hitbox_value(AT_FSTRONG, 6, HG_HITBOX_X, -8);
set_hitbox_value(AT_FSTRONG, 6, HG_HITBOX_Y, -101);
set_hitbox_value(AT_FSTRONG, 6, HG_WIDTH, 100);
set_hitbox_value(AT_FSTRONG, 6, HG_HEIGHT, 54);
...
set_hitbox_value(AT_FSTRONG, 6, HG_BASE_HITPAUSE, 14);
set_hitbox_value(AT_FSTRONG, 6, HG_HITPAUSE_SCALING, .7);
set_hitbox_value(AT_FSTRONG, 6, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_FSTRONG, 6, HG_VISUAL_EFFECT_Y_OFFSET, 1);
set_hitbox_value(AT_FSTRONG, 6, HG_HIT_SFX, sound_get("slice"));
set_hitbox_value(AT_FSTRONG, 6, HG_HITSTUN_MULTIPLIER, 1);
set_hitbox_value(AT_FSTRONG, 6, HG_VISUAL_EFFECT, 303);
set_hitbox_value(AT_FSTRONG, 6, HG_TECHABLE, 3);
set_hitbox_value(AT_FSTRONG, 6, HG_SDI_MULTIPLIER, 0.1);
set_hitbox_value(AT_FSTRONG, 6, HG_HITBOX_GROUP, 2);

set_hitbox_value(AT_FSTRONG, 7, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_FSTRONG, 7, HG_WINDOW, 8);
set_hitbox_value(AT_FSTRONG, 7, HG_WINDOW_CREATION_FRAME, 4);
set_hitbox_value(AT_FSTRONG, 7, HG_LIFETIME, 5);
set_hitbox_value(AT_FSTRONG, 7, HG_HITBOX_X, 78);
set_hitbox_value(AT_FSTRONG, 7, HG_HITBOX_Y, -72);
set_hitbox_value(AT_FSTRONG, 7, HG_WIDTH, 92);
set_hitbox_value(AT_FSTRONG, 7, HG_HEIGHT, 110);
...
set_hitbox_value(AT_FSTRONG, 7, HG_BASE_HITPAUSE, 14);
set_hitbox_value(AT_FSTRONG, 7, HG_HITPAUSE_SCALING, .7);
set_hitbox_value(AT_FSTRONG, 7, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_FSTRONG, 7, HG_VISUAL_EFFECT_Y_OFFSET, 1);
set_hitbox_value(AT_FSTRONG, 7, HG_HIT_SFX, sound_get("slice"));
set_hitbox_value(AT_FSTRONG, 7, HG_HITSTUN_MULTIPLIER, 1.0);
set_hitbox_value(AT_FSTRONG, 7, HG_VISUAL_EFFECT, 303);


set_hitbox_value(AT_FSTRONG, 8, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_FSTRONG, 8, HG_WINDOW, 8);
set_hitbox_value(AT_FSTRONG, 8, HG_WINDOW_CREATION_FRAME, 4);
set_hitbox_value(AT_FSTRONG, 8, HG_LIFETIME, 5 );
set_hitbox_value(AT_FSTRONG, 8, HG_HITBOX_X, 42);
set_hitbox_value(AT_FSTRONG, 8, HG_HITBOX_Y, -24);
set_hitbox_value(AT_FSTRONG, 8, HG_WIDTH, 90);
set_hitbox_value(AT_FSTRONG, 8, HG_HEIGHT, 34);
...
set_hitbox_value(AT_FSTRONG, 8, HG_ANGLE, 40);
set_hitbox_value(AT_FSTRONG, 8, HG_ANGLE_FLIPPER, 0);
set_hitbox_value(AT_FSTRONG, 8, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_FSTRONG, 8, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_FSTRONG, 8, HG_KNOCKBACK_SCALING, 1);
set_hitbox_value(AT_FSTRONG, 8, HG_BASE_HITPAUSE, 14);
set_hitbox_value(AT_FSTRONG, 8, HG_HITPAUSE_SCALING, .7);
set_hitbox_value(AT_FSTRONG, 8, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_FSTRONG, 8, HG_VISUAL_EFFECT_Y_OFFSET, 1);
set_hitbox_value(AT_FSTRONG, 8, HG_HIT_SFX, sound_get("slice"));
set_hitbox_value(AT_FSTRONG, 8, HG_HITSTUN_MULTIPLIER, 1.0);
set_hitbox_value(AT_FSTRONG, 8, HG_VISUAL_EFFECT, 303);