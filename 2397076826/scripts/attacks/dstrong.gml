...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, asset_get("SpaceCut2"));
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_SFX, sound_get("Fstrong"));
...
set_window_value(AT_DSTRONG, 6, AG_WINDOW_HSPEED, 6);
...
set_window_value(AT_DSTRONG, 7, AG_WINDOW_SFX, asset_get("sfx_ice_shieldup"));
set_window_value(AT_DSTRONG, 7, AG_WINDOW_SFX_FRAME, 10);
...
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 172);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("counterhit"));
set_hitbox_value(AT_DSTRONG, 1, HG_HITSTUN_MULTIPLIER, 1);
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, SC);
...
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT, SC);
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_DSTRONG, 3, HG_HIT_SFX, sound_get("counterhit"));
