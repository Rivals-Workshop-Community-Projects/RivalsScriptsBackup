...
set_attack_value(AT_USTRONG, AG_SPRITE, sprite_get("strong"));
set_attack_value(AT_USTRONG, AG_NUM_WINDOWS, 1);
set_attack_value(AT_USTRONG, AG_HURTBOX_SPRITE, sprite_get("strong_hurt"));
...
set_window_value(AT_USTRONG, 5, AG_WINDOW_SFX, sound_get("RI"));
...
set_hitbox_value(AT_USTRONG, 3, HG_DAMAGE, 0.1);
...
set_hitbox_value(AT_USTRONG, 4, HG_LIFETIME, 11);
...
set_hitbox_value(AT_USTRONG, 4, HG_DAMAGE, 0.1);
...
set_hitbox_value(AT_USTRONG, 2, HG_WINDOW, 11);
set_hitbox_value(AT_USTRONG, 2, HG_LIFETIME, 4);
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_X,  100);
...
set_hitbox_value(AT_USTRONG, 2, HG_BASE_HITPAUSE, 30);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, SC);
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("counterhit"));
...
set_hitbox_value(AT_USTRONG, 6, HG_ANGLE, 30);
...
set_hitbox_value(AT_USTRONG, 6, HG_HITPAUSE_SCALING, .7);
set_hitbox_value(AT_USTRONG, 6, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_USTRONG, 6, HG_HITSTUN_MULTIPLIER, 0.3);
...
set_hitbox_value(AT_USTRONG, 7, HG_WINDOW_CREATION_FRAME, 5);
...
set_hitbox_value(AT_USTRONG, 7, HG_WIDTH, 140);
...
set_hitbox_value(AT_USTRONG, 7, HG_HITSTUN_MULTIPLIER, 0.6);
set_hitbox_value(AT_USTRONG, 7, HG_VISUAL_EFFECT, 303);
set_hitbox_value(AT_USTRONG, 7, HG_HIT_SFX, sound_get("slice"));
