...
set_hitbox_value(AT_NSPECIAL, 1, HG_TECHABLE, 00);
...
set_hitbox_value(AT_NSPECIAL, 4, HG_TECHABLE, 00);
...
set_hitbox_value(AT_NSPECIAL, 5, HG_TECHABLE, 00);
...
set_hitbox_value(AT_NSPECIAL, 6, HG_TECHABLE, 00);
