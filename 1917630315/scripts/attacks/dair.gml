...
set_window_value(AT_DAIR, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.75);
...
set_window_value(AT_DAIR, 4, AG_WINDOW_SFX, asset_get("sfx_ori_stomp_hit"));
set_window_value(AT_DAIR, 4, AG_WINDOW_SFX_FRAME, 2);
...
var startup = get_window_value(AT_DAIR, 1, AG_WINDOW_LENGTH) + get_window_value(AT_DAIR, 2, AG_WINDOW_LENGTH);
var anim_l = startup + get_window_value(AT_DAIR, 3, AG_WINDOW_LENGTH);

set_attack_value(AT_DAIR, AG_MUNO_ATTACK_MISC_ADD, "Indefintely loops on frame " + string(anim_l) + " onward.");


set_num_hitboxes(AT_DAIR, 3);

set_hitbox_value(AT_DAIR, 1, HG_MUNO_HITBOX_NAME, "Spike 1");
...
set_hitbox_value(AT_DAIR, 3, HG_MUNO_HITBOX_NAME, "Landing");
...
set_hitbox_value(AT_DAIR, 3, HG_WIDTH, 192);
