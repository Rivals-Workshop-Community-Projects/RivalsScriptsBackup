...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, .8);
...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_orca_bite"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_HEIGHT, 133);
