...
set_window_value(AT_DATTACK, 3, AG_WINDOW_HAS_WHIFFLAG, 6);
...
set_hitbox_value(AT_DATTACK, 1, HG_HITBOX_Y, -87);
set_hitbox_value(AT_DATTACK, 1, HG_WIDTH, 106);
set_hitbox_value(AT_DATTACK, 1, HG_HEIGHT, 148);
...
set_hitbox_value(AT_DATTACK, 2, HG_HITBOX_Y, -87);
set_hitbox_value(AT_DATTACK, 2, HG_WIDTH, 94);
set_hitbox_value(AT_DATTACK, 2, HG_HEIGHT, 148);
