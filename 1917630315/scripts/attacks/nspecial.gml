...
set_num_hitboxes(AT_NSPECIAL, 0); //no hitboxes will be created automatically. They must be created through create_hitbox(AT_DSPECIAL, 1, x, y)
...
set_hitbox_value(AT_NSPECIAL, 1, HG_KNOCKBACK_SCALING, 0.12);
set_hitbox_value(AT_NSPECIAL, 1, HG_HITPAUSE_SCALING, 0.12);
