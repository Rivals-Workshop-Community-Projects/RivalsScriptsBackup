...
set_window_value(AT_USTRONG, 7, AG_WINDOW_ANIM_FRAME_START, 22);

set_window_value(AT_USTRONG, 8, AG_WINDOW_LENGTH, 40);
set_window_value(AT_USTRONG, 8, AG_WINDOW_ANIM_FRAMES, 5);
set_window_value(AT_USTRONG, 8, AG_WINDOW_ANIM_FRAME_START, 25);
...
set_hitbox_value(AT_USTRONG, 1, HG_HITSTUN_MULTIPLIER, 1.0);
...
set_hitbox_value(AT_USTRONG, 2, HG_HITSTUN_MULTIPLIER, 1.0);
...
set_hitbox_value(AT_USTRONG, 3, HG_HEIGHT, 124);
...
set_hitbox_value(AT_USTRONG, 3, HG_HITPAUSE_SCALING, .85);
...
set_hitbox_value(AT_USTRONG, 4, HG_PROJECTILE_SPRITE, sprite_get("empty"));
...
set_hitbox_value(AT_USTRONG, 4, HG_HITSTUN_MULTIPLIER, 1.1);
...
set_hitbox_value(AT_USTRONG, 4, HG_VISUAL_EFFECT_Y_OFFSET, 30);
