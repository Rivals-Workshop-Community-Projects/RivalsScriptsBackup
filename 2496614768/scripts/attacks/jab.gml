...
set_hitbox_value(AT_JAB, 5, HG_WIDTH, 62);
set_hitbox_value(AT_JAB, 5, HG_HEIGHT, 96);
...
set_hitbox_value(AT_JAB, 6, HG_HITBOX_X, 22);
set_hitbox_value(AT_JAB, 6, HG_HITBOX_Y, -32);
set_hitbox_value(AT_JAB, 6, HG_WIDTH, 86);
