...
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_ori_energyhit_weak"));
...
set_hitbox_value(AT_FSPECIAL, 3, HG_HITPAUSE_SCALING, 0.2);
...
set_hitbox_value(AT_FSPECIAL, 4, HG_HITBOX_X, 26);
