...
sprite_change_offset("jab", 30, 68);
sprite_change_offset("dattack", 54, 66);
sprite_change_offset("ftilt", 40, 90);
sprite_change_offset("dtilt", 33, 70);
sprite_change_offset("utilt", 73, 114);
...
sprite_change_offset("dugato", 36, 86);

sprite_change_offset("classe", 56, 92);
