...
set_window_value(AT_UTILT, 2, AG_WINDOW_SFX, sound_get("swing_medium2"));
...
set_window_value(AT_UTILT, 3, AG_WINDOW_SFX, sound_get("swing_medium"));
...
set_hitbox_value(AT_UTILT, 2, HG_BASE_KNOCKBACK, 8.2);//8.2
set_hitbox_value(AT_UTILT, 2, HG_KNOCKBACK_SCALING, 0.34);//0.35
