...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX, sound_get("swing_strong2"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_KNOCKBACK_SCALING, 0.82);
...
set_hitbox_value(AT_FSTRONG, 2, HG_KNOCKBACK_SCALING, 0.82);
