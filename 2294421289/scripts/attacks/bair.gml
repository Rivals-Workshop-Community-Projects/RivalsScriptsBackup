...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("swing_strong"));
...
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_X, -25); //-16
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_Y, -40); //-35
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 65);
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 40); //34
...
set_hitbox_value(AT_BAIR, 1, HG_KNOCKBACK_SCALING, 0.6); //76
...
set_hitbox_value(AT_BAIR, 1, HG_ANGLE_FLIPPER, 0); //6
...
set_hitbox_value(AT_BAIR, 2, HG_BASE_KNOCKBACK, 7);//6.5
