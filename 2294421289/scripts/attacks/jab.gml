...
set_window_value(AT_JAB, 11, AG_WINDOW_SFX, asset_get("sfx_swipe_medium1"));
set_window_value(AT_JAB, 11, AG_WINDOW_SFX_FRAME, 1);
...
set_hitbox_value(AT_JAB, 4, HG_BASE_HITPAUSE, 13);
