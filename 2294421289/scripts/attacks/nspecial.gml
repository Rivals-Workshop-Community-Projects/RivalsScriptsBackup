...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_LENGTH, 3); //4
...
set_hitbox_value(AT_NSPECIAL, 1, HG_DAMAGE, 1); //6
set_hitbox_value(AT_NSPECIAL, 1, HG_ANGLE, 50);
set_hitbox_value(AT_NSPECIAL, 1, HG_BASE_KNOCKBACK, 1); //9
set_hitbox_value(AT_NSPECIAL, 1, HG_KNOCKBACK_SCALING, 0.5); //0.4
set_hitbox_value(AT_NSPECIAL, 1, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_NSPECIAL, 1, HG_HITPAUSE_SCALING, 0.4); //0.35
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HITPAUSE_SCALING, 0.5); //.2
