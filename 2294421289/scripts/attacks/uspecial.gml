...
set_hitbox_value(AT_USPECIAL, 1, HG_SDI_MULTIPLIER, 0.5);
...
set_hitbox_value(AT_USPECIAL, 2, HG_SDI_MULTIPLIER, 0.5);
...
set_hitbox_value(AT_USPECIAL, 3, HG_SDI_MULTIPLIER, 0.5);
...
set_hitbox_value(AT_USPECIAL, 4, HG_SDI_MULTIPLIER, 0.5);
...
set_hitbox_value(AT_USPECIAL, 5, HG_HITBOX_Y, -15);
...
set_hitbox_value(AT_USPECIAL, 5, HG_VISUAL_EFFECT, 156);
