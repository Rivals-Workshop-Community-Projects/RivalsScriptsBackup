set_attack_value(AT_TAUNT_2, AG_SPRITE, sprite_get("classe"));
...
set_attack_value(AT_TAUNT_2, AG_HURTBOX_SPRITE, asset_get("utilt_hurt"));

set_window_value(AT_TAUNT_2, 1, AG_WINDOW_TYPE, 1);
set_window_value(AT_TAUNT_2, 1, AG_WINDOW_LENGTH, 70);
set_window_value(AT_TAUNT_2, 1, AG_WINDOW_ANIM_FRAMES, 23);
set_window_value(AT_TAUNT_2, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_TAUNT_2, 1, AG_WINDOW_SFX, sound_get("laclasse"));
