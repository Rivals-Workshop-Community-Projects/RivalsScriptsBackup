...
// Eyes/Dress
set_color_profile_slot( 0, 0, 27, 18, 193 );
set_color_profile_slot_range( 0, 16, 45, 58 );

// Bow
set_color_profile_slot( 0, 1, 0, 139, 115 );
set_color_profile_slot_range( 1, 16, 18, 23 );

// Shoes
set_color_profile_slot( 0, 2, 67, 87, 126 );
set_color_profile_slot_range( 2, 2, 7, 24 );

// Skin
set_color_profile_slot( 0, 3, 240, 226, 205 );
set_color_profile_slot_range( 3, 23, 56, 28 );

// Hair
set_color_profile_slot( 0, 4, 191, 199, 219 );
set_color_profile_slot_range( 4, 1, 1, 1 );

// Hair2
set_color_profile_slot( 0, 5, 138, 142, 167 );
set_color_profile_slot_range( 5, 1, 1, 1 );

// Sleves
set_color_profile_slot( 0, 6, 219, 223, 234 );
set_color_profile_slot_range( 6, 1, 1, 1 );

// Clothes2
set_color_profile_slot( 0, 7, 178, 181, 212 );
...
set_color_profile_slot( 1, 1, 188, 199, 38 ); //Bow
set_color_profile_slot( 1, 2, 67, 87, 126 ); //Shoes
set_color_profile_slot( 1, 3, 240, 226, 205 ); //Skin
set_color_profile_slot( 1, 4, 191, 199, 219 ); //Hair
set_color_profile_slot( 1, 5, 138, 142, 167 ); //Hair2
set_color_profile_slot( 1, 6, 219, 223, 234 ); //Sleves
set_color_profile_slot( 1, 7, 178, 181, 212 ); //Clothes2

// Remilia
set_color_profile_slot( 2, 0, 255, 0, 0 ); //Eyes/Dress
set_color_profile_slot( 2, 1, 189, 217, 217 ); //Bow
set_color_profile_slot( 2, 2, 240, 240, 240 ); //Shoes
set_color_profile_slot( 2, 3, 255, 250, 240 ); //Skin
set_color_profile_slot( 2, 4, 166, 250, 255 ); //Hair
set_color_profile_slot( 2, 5, 0, 114, 145 ); //Hair2
set_color_profile_slot( 2, 6, 230, 255, 250 ); //Sleves
set_color_profile_slot( 2, 7, 255, 186, 186 ); //Clothes2
...
set_color_profile_slot( 3, 5, 255, 153, 0 ); //Hair2
set_color_profile_slot( 3, 6, 255, 255, 255 ); //Sleves
set_color_profile_slot( 3, 7, 255, 196, 196 ); //Clothes2

// Patchouli
set_color_profile_slot( 4, 0, 228, 156, 255 ); //Eyes/Dress
set_color_profile_slot( 4, 1, 166, 42, 0 ); //Bow
set_color_profile_slot( 4, 2, 107, 37, 18 ); //Shoes
set_color_profile_slot( 4, 3, 240, 222, 197 ); //Skin
set_color_profile_slot( 4, 4, 200, 135, 255 ); //Hair
set_color_profile_slot( 4, 5, 74, 41, 163 ); //Hair2
set_color_profile_slot( 4, 6, 255, 255, 255 ); //Sleves
set_color_profile_slot( 4, 7, 255, 214, 245 ); //Clothes2

// Meiling
set_color_profile_slot( 5, 0, 186, 113, 49 ); //Eyes/Dress
set_color_profile_slot( 5, 1, 0, 0, 0 ); //Bow
set_color_profile_slot( 5, 2, 56, 56, 56 ); //Shoes
set_color_profile_slot( 5, 3, 240, 226, 205 ); //Skin
set_color_profile_slot( 5, 4, 255, 82, 96 ); //Hair
set_color_profile_slot( 5, 5, 138, 0, 87 ); //Hair2
set_color_profile_slot( 5, 6, 85, 156, 61 ); //Sleves
set_color_profile_slot( 5, 7, 21, 97, 0 ); //Clothes2
...
set_color_profile_slot( 6, 7, 255, 196, 196 ); //Clothes2

// Reisen
set_color_profile_slot( 7, 0, 38, 0, 10 ); //Eyes/Dress
set_color_profile_slot( 7, 1, 166, 36, 0 ); //Bow
set_color_profile_slot( 7, 2, 110, 48, 48 ); //Shoes
set_color_profile_slot( 7, 3, 240, 226, 205 ); //Skin
set_color_profile_slot( 7, 4, 231, 212, 255 ); //Hair
