...
set_window_value(AT_FTILT, 3, AG_WINDOW_LENGTH, 22);
...
set_hitbox_value(AT_FTILT, 1, HG_FINAL_BASE_KNOCKBACK, 6)
set_hitbox_value(AT_FTILT, 1, HG_KNOCKBACK_SCALING, 1.2);
