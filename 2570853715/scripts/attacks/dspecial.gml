...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, sound_get("dspecial_throw"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_MUNO_HITBOX_NAME, "Dspecial Knife Projectile");
set_hitbox_value(AT_DSPECIAL, 1, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_DSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("dspecial_knife"));
