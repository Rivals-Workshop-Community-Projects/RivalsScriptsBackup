set_attack_value(AT_TAUNT, AG_MUNO_ATTACK_NAME, "roomba (taunt)");
...
set_window_value(AT_TAUNT, 1, AG_WINDOW_HSPEED, 2.5);
...
set_hitbox_value(AT_TAUNT, 1, HG_HITBOX_X, 5);
...
set_hitbox_value(AT_TAUNT, 1, HG_ANGLE_FLIPPER, 9);
...
set_hitbox_value(AT_TAUNT, 2, HG_WINDOW_CREATION_FRAME, 6);
set_hitbox_value(AT_TAUNT, 2, HG_LIFETIME, 2);
set_hitbox_value(AT_TAUNT, 2, HG_HITBOX_Y, -10);
set_hitbox_value(AT_TAUNT, 2, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_TAUNT, 2, HG_HITBOX_X, 5);

set_hitbox_value(AT_TAUNT, 3, HG_PARENT_HITBOX, 1);
set_hitbox_value(AT_TAUNT, 3, HG_WINDOW, 1);
set_hitbox_value(AT_TAUNT, 3, HG_WINDOW_CREATION_FRAME, 12);
set_hitbox_value(AT_TAUNT, 3, HG_LIFETIME, 2);
set_hitbox_value(AT_TAUNT, 3, HG_HITBOX_Y, -10);
set_hitbox_value(AT_TAUNT, 3, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_TAUNT, 3, HG_HITBOX_X, 5);

set_hitbox_value(AT_TAUNT, 4, HG_PARENT_HITBOX, 1);
set_hitbox_value(AT_TAUNT, 4, HG_WINDOW, 1);
set_hitbox_value(AT_TAUNT, 4, HG_WINDOW_CREATION_FRAME, 18);
set_hitbox_value(AT_TAUNT, 4, HG_LIFETIME, 2);
set_hitbox_value(AT_TAUNT, 4, HG_HITBOX_Y, -10);
set_hitbox_value(AT_TAUNT, 4, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_TAUNT, 4, HG_HITBOX_X, 5);

set_attack_value(AT_TAUNT, AG_MUNO_ATTACK_MISC, "roomba go brrr");