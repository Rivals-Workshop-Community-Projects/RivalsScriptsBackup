...
set_window_value(AT_DATTACK, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, .02);
...
set_hitbox_value(AT_DATTACK, 1, HG_MUNO_HITBOX_NAME, "Hit");
...
set_attack_value(AT_DATTACK, AG_MUNO_ATTACK_MISC_ADD, "Jump cancel starting at frame " + "16" + " on hit. Does 1% self damage.");