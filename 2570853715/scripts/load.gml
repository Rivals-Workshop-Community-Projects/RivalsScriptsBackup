...
sprite_change_offset("ustrong_overlay", 62, 79);
...
sprite_change_offset("shine_ustrong", 32, 32);
sprite_change_offset("shine_fstrong", 32, 32);
...
sprite_change_offset("dspecial_dev_knife", 38, 6);
sprite_change_offset("dspecial2_dev_knife", 38, 6);
sprite_change_offset("blue_trail", 1, 5);
sprite_change_offset("chainsaw", 32, 12);
sprite_change_offset("fstrong_dev", 102, 115);
sprite_change_offset("dstrong_dev", 98, 115);
sprite_change_offset("lightning", 60, 400);
sprite_change_offset("hfx_bat_large", 128, 128);
sprite_change_offset("hfx_pumpkin", 64, 64);
sprite_change_offset("intro", 102, 115);