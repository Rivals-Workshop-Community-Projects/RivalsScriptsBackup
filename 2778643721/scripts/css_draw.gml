...
if (!variable_instance_exists(id,"ae") || ye == true){
    ...
    ce[1,0] = make_color_rgb(253, 168, 44)
    ce[1,1] = "Tangerine"
    
    ce[2,0] = make_color_rgb(66, 209, 224)
    ce[2,1] = "Sea Salt"
    
    ce[3,0] = make_color_rgb(97, 169, 51)
    ce[3,1] = "Lime"
    
    ce[4,0] = make_color_rgb(74, 68, 241)
    ce[4,1] = "Under My Control"
    
    ce[5,0] = make_color_rgb(230, 48, 61)
    ce[5,1] = "Under My Control EX"
    
    ce[6,0] = make_color_rgb(86, 84, 146)
    ce[6,1] = "Abyss"
	
    ce[7,0] = make_color_rgb(83, 122, 62)
    ce[7,1] = "Gameboy"
	
    ce[8,0] = make_color_rgb(86, 84, 112)
    ce[8,1] = "C-R-O-W-N-E-D"
	
    ce[9,0] = make_color_rgb(255, 251, 250)
    ce[9,1] = "Apple Vendor"
	
    ce[10,0] = make_color_rgb(42, 53, 166)
    ce[10,1] = "The Jester of Stars"
	
    ce[11,0] = make_color_rgb(204, 209, 212)
    ce[11,1] = "Floral Heartstrings"

    ce[12,0] = make_color_rgb(237, 31, 127)
    ce[12,1] = "Executive Executor"
	
    ce[13,0] = make_color_rgb(201, 0, 94)
    ce[13,1] = "Twinkle Star Hero"
	
    ce[14,0] = make_color_rgb(255, 0, 0)
    ce[14,1] = "His Royal Nemesis"
	
    ce[15,0] = make_color_rgb(21, 0, 176)
    ce[15,1] = "Scourge of Darkness"

    ce[16,0] = make_color_rgb(255, 60, 0)
    ce[16,1] = "Legend of Dee"

    ce[17,0] = make_color_rgb(150, 171, 184)
    ce[17,1] = "Invasive Species"

    ce[18,0] = make_color_rgb(255, 208, 0)
    ce[18,1] = "Golden"
	
    ce[19,0] = make_color_rgb(47, 86, 204)
    ce[19,1] = "Metallic Warmachine"
	
    ce[20,0] = make_color_rgb(47, 86, 204)
    ce[20,1] = "Officiant of Doom"

    ce[21,0] = make_color_rgb(237, 0, 0)
    ce[21,1] = "laugh."

    ce[22,0] = make_color_rgb(0, 176, 109)
    ce[22,1] = "Prince from the Darkness"

    ce[23,0] = make_color_rgb(207, 18, 0)
    ce[23,1] = "Magical Wizard"

    ce[24,0] = make_color_rgb(255, 0, 0)
    ce[24,1] = "Lor Sleighcutter"

    ce[25,0] = make_color_rgb(108, 105, 188)
    ce[25,1] = "CHAOS CHAOS CHAOS"

    ce[26,0] = make_color_rgb(252, 255, 232)
    ce[26,1] = "Last Line of Defense"

    ce[27,0] = make_color_rgb(56, 48, 87)
    ce[27,1] = "The Rights of The World"

    ce[28,0] = make_color_rgb(255, 255, 255)
    ce[28,1] = "Transcendant"

    ce[29,0] = make_color_rgb(176, 0, 191)
