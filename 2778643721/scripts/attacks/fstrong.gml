set_attack_value(AT_FSTRONG, AG_SPRITE, sprite_get("fstrong_smol"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_Y, -172);
set_hitbox_value(AT_FSTRONG, 1, HG_SHAPE, 2);
set_hitbox_value(AT_FSTRONG, 1, HG_WIDTH, 272);
set_hitbox_value(AT_FSTRONG, 1, HG_HEIGHT, 130);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_Y, -74);
set_hitbox_value(AT_FSTRONG, 2, HG_WIDTH, 150);
set_hitbox_value(AT_FSTRONG, 2, HG_HEIGHT, 180);
