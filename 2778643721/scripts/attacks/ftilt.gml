...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, sound_get("sfx_open_small2"));

set_window_value(AT_FTILT, 2, AG_WINDOW_LENGTH, 9);
set_window_value(AT_FTILT, 2, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_FTILT, 2, AG_WINDOW_ANIM_FRAME_START, 2);
set_window_value(AT_FTILT, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FTILT, 2, AG_WINDOW_SFX, sound_get("sfx_spike_thrust"));
...
set_hitbox_value(AT_FTILT, 1, HG_HITBOX_X, 68);
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, asset_get("sfx_syl_nspecial_flowerhit"));
...
set_hitbox_value(AT_FTILT, 2, HG_KNOCKBACK_SCALING, .75);
...
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, sound_get("sfx_hit_sharp"));
