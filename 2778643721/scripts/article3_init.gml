...
sprite_index = sprite_get("gem_apple");           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
mask_index = sprite_get("apple_mask1");
