...
set_window_value(AT_DSTRONG, 5, AG_WINDOW_HAS_WHIFFLAG, 20);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HITPAUSE_SCALING, 1.6);
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("sf_hit4"));
