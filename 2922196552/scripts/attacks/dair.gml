...
set_window_value(AT_DAIR, 1, AG_WINDOW_CUSTOM_GRAVITY, 0.7);
...
set_window_value(AT_DAIR, 3, AG_WINDOW_LENGTH, 50);
...
set_window_value(AT_DAIR, 4, AG_WINDOW_SFX, sound_get("SMASH"));
...
set_hitbox_value(AT_DAIR, 2, HG_HITPAUSE_SCALING, 0.45);
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, 10);
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, sound_get("sf_hit3"));
