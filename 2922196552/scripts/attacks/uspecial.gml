...
set_hitbox_value(AT_USPECIAL, 1, HG_HIT_SFX, sound_get("sf_hit1"));
...
set_hitbox_value(AT_USPECIAL, 2, HG_KNOCKBACK_SCALING, 0.56);
set_hitbox_value(AT_USPECIAL, 2, HG_VISUAL_EFFECT, 305);
set_hitbox_value(AT_USPECIAL, 2, HG_BASE_HITPAUSE, 13);
set_hitbox_value(AT_USPECIAL, 2, HG_HIT_SFX, sound_get("sf_hit3"));
