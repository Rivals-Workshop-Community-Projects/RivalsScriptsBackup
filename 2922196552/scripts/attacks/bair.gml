...
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 87);
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("sf_hit4"));
...
set_hitbox_value(AT_BAIR, 2, HG_ANGLE, 290);
...
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, sound_get("sf_hit4"));
...
set_hitbox_value(AT_BAIR, 3, HG_HITBOX_X, -19);
set_hitbox_value(AT_BAIR, 3, HG_HITBOX_Y, -71);
...
set_hitbox_value(AT_BAIR, 3, HG_KNOCKBACK_SCALING, .55);
set_hitbox_value(AT_BAIR, 3, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_BAIR, 3, HG_HITPAUSE_SCALING, .5);
set_hitbox_value(AT_BAIR, 3, HG_HIT_SFX, sound_get("sf_hit3"));