...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sound_get("oliviafolding"));
...
set_window_value(AT_DAIR, 5, AG_WINDOW_VSPEED, -7.3);
...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, bootssuccessful);
