...
set_window_value(AT_BAIR, 1, AG_WINDOW_CUSTOM_GRAVITY, 1.1);
...
set_window_value(AT_BAIR, 2, AG_WINDOW_CUSTOM_GRAVITY, .7);
...
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT, puffyhit);
