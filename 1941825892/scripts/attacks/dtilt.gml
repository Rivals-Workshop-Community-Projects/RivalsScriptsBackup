...
set_hitbox_value(AT_DTILT, 2, HG_HITBOX_X, 53);
...
set_hitbox_value(AT_DTILT, 3, HG_HITBOX_X, 41);
set_hitbox_value(AT_DTILT, 3, HG_HITBOX_Y, -3);
set_hitbox_value(AT_DTILT, 3, HG_WIDTH, 56);
set_hitbox_value(AT_DTILT, 3, HG_HEIGHT, 12);
...
set_hitbox_value(AT_DTILT, 3, HG_HITPAUSE_SCALING, 0.25);
...
set_hitbox_value(AT_DTILT, 4, HG_HITBOX_Y, -1);
set_hitbox_value(AT_DTILT, 4, HG_WIDTH, 55);
...
set_hitbox_value(AT_DTILT, 4, HG_HITPAUSE_SCALING, 0.25);
set_hitbox_value(AT_DTILT, 4, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_DTILT, 4, HG_HIT_SFX, asset_get("sfx_blow_medium1"));