...
set_attack_value(AT_FAIR, AG_SPRITE, sprite_get("fair_balanced"));
...
set_window_value(AT_FAIR, 3, AG_WINDOW_CUSTOM_GRAVITY, 1.2);
...
set_hitbox_value(AT_FAIR, 4, HG_WINDOW_CREATION_FRAME, 26);
set_hitbox_value(AT_FAIR, 4, HG_HITBOX_X, 30);
set_hitbox_value(AT_FAIR, 4, HG_HITBOX_Y, -28);
...
set_hitbox_value(AT_FAIR, 4, HG_KNOCKBACK_SCALING, 0.1);
...
set_hitbox_value(AT_FAIR, 5, HG_WINDOW_CREATION_FRAME, 35);
set_hitbox_value(AT_FAIR, 5, HG_HITBOX_X, 25);
set_hitbox_value(AT_FAIR, 5, HG_HITBOX_Y, -30);
set_hitbox_value(AT_FAIR, 5, HG_WIDTH, 78);
...
set_hitbox_value(AT_FAIR, 5, HG_KNOCKBACK_SCALING, 0.55/4);
set_hitbox_value(AT_FAIR, 5, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_FAIR, 5, HG_HITPAUSE_SCALING, 0.55/4);
