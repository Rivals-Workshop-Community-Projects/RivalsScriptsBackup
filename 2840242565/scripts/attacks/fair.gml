...
set_hitbox_value(AT_FAIR, 3, HG_HEIGHT, 57);
...
set_hitbox_value(AT_FAIR, 5, HG_HITBOX_X, 28);
set_hitbox_value(AT_FAIR, 5, HG_HITBOX_Y, 8);
set_hitbox_value(AT_FAIR, 5, HG_WIDTH, 44);
set_hitbox_value(AT_FAIR, 5, HG_HEIGHT, 30);
