...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sfx_star_allies_gooey_burning);
...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_VSPEED, 0.25);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_LIFETIME, 22);
