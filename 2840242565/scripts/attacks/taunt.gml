...
set_attack_value(AT_TAUNT, AG_HURTBOX_SPRITE, asset_get("gooey_hurtbox"));

set_window_value(AT_TAUNT, 1, AG_WINDOW_TYPE, 1);
set_window_value(AT_TAUNT, 1, AG_WINDOW_LENGTH, 16);
set_window_value(AT_TAUNT, 1, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_TAUNT, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX, sound_get("gooeytaunt"));
...
set_attack_value(AT_TAUNT, AG_SPRITE, sprite_get("dmtaunt"));
set_attack_value(AT_TAUNT, AG_HURTBOX_SPRITE, asset_get("gooey_hurtbox"));;
set_attack_value(AT_TAUNT, AG_NUM_WINDOWS, 3);
...
set_window_value(AT_TAUNT, 1, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_TAUNT, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX, sound_get("sfx_dmcalling"));
