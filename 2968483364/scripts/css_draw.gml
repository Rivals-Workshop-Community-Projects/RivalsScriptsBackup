...
if (!variable_instance_exists(id,"ae") || ye == true){
    ...
    ce[0,1] = "The Fiery Immortal" // the name of the alternate color.
    ...
    ce[1,0] = make_color_rgb(38, 191, 148)
    ce[1,1] = "Wildfire"
    ce[1,2] = "Standard recolor."
    ce[2,0] = make_color_rgb(85, 164, 189)
    ce[2,1] = "Deep Blaze"
    ce[2,2] = "Standard recolor."
    ce[3,0] = make_color_rgb(44, 44, 69)
    ce[3,1] = "Monochrome Night"
    ce[3,2] = "Flashier recolor."
    ce[4,0] = make_color_rgb(166, 50, 67)
    ce[4,1] = "Charred"
    ce[4,2] = "Flashier recolor."
    ce[5,0] = make_color_rgb(103, 182, 252)
    ce[5,1] = "Scald and Sear"
    ce[5,2] = "Flashier recolor."
    ce[6,0] = make_color_rgb(222, 255, 252)
    ce[6,1] = "Pure Heat"
    ce[6,2] = "Flashier recolor."
    ce[7,0] = make_color_rgb(44, 44, 59)
    ce[7,1] = "Blood-Red Run"
    ce[7,2] = "I gotta find out who killed my dad."
    ce[8,0] = make_color_rgb(255, 153, 250)
    ce[8,1] = "Lunatic Eyes"
    ce[8,2] = "Reisen Udongein Inaba"
    ce[9,0] = make_color_rgb(200, 213, 245)
    ce[9,1] = "Historic Half-Beast"
    ce[9,2] = "Keine Kamishirasawa"
    ce[10,0] = make_color_rgb(255, 176, 180)
    ce[10,1] = "The Bamboo Cutter"
    ce[10,2] = "Kaguya Houraisan"
...
if (color_desc_activate){
    ...
    draw_set_alpha(1);
    textDraw(x+14, (y+100)-round(dial_ease/30), "fName", c_white, 18, 200, 1, false, dial_ease/100, "- Color "+string(ue)+": "+ (color_name_activate? ce[ue,1] : " "));
