...
spr_unlit = sprite_get("nspec_offbomb");
spr_lit = sprite_get("nspec_bomb");
spr_blast = sprite_get("vfx_bombblast");

sprite_index = spr_unlit;                           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
mask_index = sprite_get("nspec_bomb_mask");
...
idle_anim_rate = 4;                                 //Example animation speed value 1. The animation in question will increment every 8 frames in this case
...
new_sprite = sprite_get("nspec_bomb");             //This is another part of the animation handling. It tells the game "this is the sprite this article should be using; if it's not already, switch it over please"
