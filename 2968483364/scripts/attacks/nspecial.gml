...
//contact hitbox when the fuse is lit
...
set_hitbox_value(AT_NSPECIAL, 2, HG_LIFETIME, 5); //actually 4
...
set_hitbox_value(AT_NSPECIAL, 3, HG_HITBOX_X, 24);
set_hitbox_value(AT_NSPECIAL, 3, HG_HITBOX_Y, -68);
