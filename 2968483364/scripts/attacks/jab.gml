...
set_window_value(AT_JAB, 7, AG_WINDOW_SFX, asset_get("sfx_ell_strong_attack_explosion"));
...
set_hitbox_value(AT_JAB, 1, HG_HITSTUN_MULTIPLIER, 0.95);
...
set_hitbox_value(AT_JAB, 2, HG_BASE_KNOCKBACK, 4.25);
...
set_hitbox_value(AT_JAB, 3, HG_HEIGHT, 73);
...
set_hitbox_value(AT_JAB, 3, HG_KNOCKBACK_SCALING, .60);
