...
if (!variable_instance_exists(id,"ae") || ye == true){
    ...
    ce[0,0] = make_color_rgb(67, 190, 250) // "color preview square" color. can be any color!
    ce[0,1] = "Magikoopa" // the name of the alternate color.
    ...
    ce[1,0] = make_color_rgb(0, 200, 64)
    ce[1,1] = "Green"
    ce[1,2] = ""
    ce[2,0] = make_color_rgb(232, 0, 8)
    ce[2,1] = "Red"
    ce[2,2] = ""
    ce[3,0] = make_color_rgb(249, 249, 250)
    ce[3,1] = "White"
    ce[3,2] = ""
    ce[4,0] = make_color_rgb(255, 233, 34) 
    ce[4,1] = "Yellow"
    ce[4,2] = ""
    ce[5,0] = make_color_rgb(171, 68, 0)
    ce[5,1] = "Orange"
    ce[5,2] = ""
    ce[6,0] = make_color_rgb(0, 103, 102)
    ce[6,1] = "Teal"
    ce[6,2] = ""
    ce[7,0] = make_color_rgb(255, 171, 234)
    ce[7,1] = "Pink"
    ce[7,2] = ""
    ce[8,0] = make_color_rgb(252, 253, 255)
    ce[8,1] = "Inverted"
    ce[8,2] = ""
    ce[9,0] = make_color_rgb(128, 64, 193)
    ce[9,1] = "Kammy Koopa"
    ce[9,2] = ""
    ce[10,0] = make_color_rgb(102, 40, 158)
    ce[10,1] = "Kamella"
    ce[10,2] = ""
    ce[11,0] = make_color_rgb(250, 160, 199)
    ce[11,1] = "Disguise"
    ce[11,2] = ""
    ce[12,0] = make_color_rgb(25, 171, 175)
    ce[12,1] = "Evoker"
    ce[12,2] = ""
    ce[13,0] = make_color_rgb(126, 126, 248 )
    ce[13,1] = "Super Mario World"
    ce[13,2] = ""
    ce[14,0] = make_color_rgb(136, 51, 0)
    ce[14,1] = "Super Mario Maker"
    ce[14,2] = ""
    ce[15,0] = make_color_rgb( 8, 122, 247 )
    ce[15,1] = "Black Magic"
    ce[15,2] = ""
    ce[16,0] = make_color_rgb( 252, 253, 255)
    ce[16,1] = "White Magic"
    ce[16,2] = ""
