...
sprite_change_offset("idle_hurtbox", 22, 61);
...
sprite_change_offset("dspecial_retro1", 13, 49, true);
sprite_change_offset("dspecial_retro2", 13, 49, true);
...
sprite_change_offset("strong_hurt1", 22, 36);
sprite_change_offset("strong_hurt2", 16, 38);
sprite_change_offset("strong_hurt3", 28, 40);

sprite_change_offset("sniper_scope", 15, 7);
sprite_change_offset("sniper_scope_retro1", 15, 7);
sprite_change_offset("sniper_scope_retro2", 15, 7);
...
sprite_change_offset("smoke_tiny", 19, 70);
