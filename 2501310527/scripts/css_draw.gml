...
if (!variable_instance_exists(id,"ae") || ye == true){
    ...
    ce[0,0] = make_color_rgb(49, 53, 61) // "color preview square" color. can be any color!
    ce[0,1] = "Classic" // the name of the alternate color.
    ce[0,2] = "Classic black! The most common Bill color!" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    ce[1,0] = make_color_rgb(237, 33, 33)
    ce[1,1] = "Bull's-Eye Bill"
    ce[1,2] = "As it appeared in Mario Kart DS!"
    ce[2,0] = make_color_rgb(231, 123, 156)
    ce[2,1] = "Yoshi's Island Bill"
    ce[2,2] = "As it appeared in Mario Kart DS!"
    ce[3,0] = make_color_rgb(255, 207, 64)
    ce[3,1] = "Gold Bullet Bill"
    ce[3,2] = "As it appeared in Yoshi's Story!"
    ce[4,0] = make_color_rgb(0, 0, 0)
    ce[4,1] = "Retro"
    ce[4,2] = "As it first appeared in Yoshi's Story!"
    ce[5,0] = make_color_rgb(83, 122, 62)
    ce[5,1] = "Bullet Biff"
    ce[5,2] = "As it appeared in Yoshi's Story!"
    ce[6,0] = make_color_rgb(117, 158, 255)
    ce[6,1] = "Guided Bullet Bill"
    ce[6,2] = "The iconic miniboss from Paper Mario!"
    ce[7,0] = make_color_rgb(130, 0, 181)
    ce[7,1] = "Waluigi"
    ce[7,2] = "Appears in Game & Watch Gallery 2!"
    ce[8,0] = make_color_rgb(27, 52, 166)
    ce[8,1] = "Thwomp"
    ce[8,2] = "The helpful friend from Yoshi's Story!"
    ce[9,0] = make_color_rgb(204, 204, 204)
    ce[9,1] = "Boo"
    ce[9,2] = "As it appeared in Mario Kart DS!"
    ce[10,0] = make_color_rgb(229, 125, 34)
    ce[10,1] = "Orange"
    ce[10,2] = "As it appeared in Mario Kart 8!"
    ce[11,0] = make_color_rgb(147, 61, 226)
    ce[11,1] = "Waluigi"
    ce[11,2] = "A fellow Technique-style player in Mario Tennis!"
    ce[12,0] = make_color_rgb(216, 40, 0)
    ce[12,1] = "Retro"
    ce[12,2] = "Original color from Super Mario Bros. 2!"
    ce[13,0] = make_color_rgb(252, 116, 180)
    ce[13,1] = "Retro Pink"
    ce[13,2] = "Alternate color from Super Mario Bros. 2!"
    ce[14,0] = make_color_rgb(188, 188, 188)
    ce[14,1] = "Retro Gray"
    ce[14,2] = "Unused color from Super Mario Bros. 2!"
    ce[15,0] = make_color_rgb(76, 220, 72)
    ce[15,1] = "Retro Green"
    ce[15,2] = "Beezo color from Super Mario Bros. 2!"
