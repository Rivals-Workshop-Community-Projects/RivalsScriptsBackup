...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sound_get("bounce_face"));
...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, 124);
...
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT, 124);
