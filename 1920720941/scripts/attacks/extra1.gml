...
set_attack_value(AT_EXTRA_1, AG_AIR_SPRITE, sprite_get("idle"));
...
set_window_value(AT_EXTRA_1, 5, AG_WINDOW_LENGTH, 1);
...
set_hitbox_value(AT_EXTRA_1, 1, HG_EFFECT, 9);
set_hitbox_value(AT_EXTRA_1, 1, HG_BASE_HITPAUSE, 0);
set_hitbox_value(AT_EXTRA_1, 1, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_EXTRA_1, 1, HG_HIT_SFX, asset_get("sfx_absa_singlezap2"));
...
set_hitbox_value(AT_EXTRA_1, 2, HG_LIFETIME, 8);
set_hitbox_value(AT_EXTRA_1, 2, HG_HITBOX_X, 0);
set_hitbox_value(AT_EXTRA_1, 2, HG_HITBOX_Y, -34);
...
set_hitbox_value(AT_EXTRA_1, 2, HG_HIT_SFX, asset_get("sfx_absa_singlezap2"));
...
set_hitbox_value(AT_EXTRA_1, 3, HG_HITBOX_Y, -24);
...
set_hitbox_value(AT_EXTRA_1, 3, HG_DAMAGE, 12);
set_hitbox_value(AT_EXTRA_1, 3, HG_ANGLE, 90);
set_hitbox_value(AT_EXTRA_1, 3, HG_BASE_KNOCKBACK, 10);
set_hitbox_value(AT_EXTRA_1, 3, HG_KNOCKBACK_SCALING, .6);
set_hitbox_value(AT_EXTRA_1, 3, HG_BASE_HITPAUSE, 12);
set_hitbox_value(AT_EXTRA_1, 3, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_EXTRA_1, 3, HG_HIT_SFX, asset_get("sfx_absa_singlezap2"));
