...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("crystal_break"));
...
set_window_value(AT_NSPECIAL, 4, AG_WINDOW_ANIM_FRAMES, 15);
set_window_value(AT_NSPECIAL, 4, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_NSPECIAL, 4, AG_WINDOW_SFX, sound_get("crystal"));
