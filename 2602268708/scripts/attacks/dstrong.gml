...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_CUSTOM_GRAVITY, .55);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_LOCKOUT, 7);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_Y, -9000);
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, thwomp_hit2);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_LOCKOUT, 7);
