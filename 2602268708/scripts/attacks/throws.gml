...
set_window_value(AT_UTHROW, 1, AG_WINDOW_SFX_FRAME, 9);
...
set_hitbox_value(AT_UTHROW, 1, HG_HIT_PARTICLE_NUM, 2);
set_hitbox_value(AT_UTHROW, 1, HG_HIT_SFX, asset_get("sfx_blow_medium3"));
set_hitbox_value(AT_UTHROW, 1, HG_VISUAL_EFFECT, 303);

//BTHROW

set_attack_value(AT_EXTRA_1, AG_MUNO_ATTACK_NAME, "BThrow");
...
set_hitbox_value(AT_EXTRA_1, 1, HG_ANGLE, 145);
