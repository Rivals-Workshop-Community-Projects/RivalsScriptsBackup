...
set_attack_value(AT_DTILT, AG_MUNO_ATTACK_MISC_ADD, "Jump cancellable on hit.");
...
set_window_value(AT_DTILT, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.3);
...
set_hitbox_value(AT_DTILT, 2, HG_WIDTH, 13);
