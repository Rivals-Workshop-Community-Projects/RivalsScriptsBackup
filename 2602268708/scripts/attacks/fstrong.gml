...
set_hitbox_value(AT_FSTRONG, 1, HG_LIFETIME, 46);
...
set_hitbox_value(AT_FSTRONG, 3, HG_HITBOX_Y, -9000); //Don't worry about this.
...
set_hitbox_value(AT_FSTRONG, 5, HG_VISUAL_EFFECT, whomp_hit2);
