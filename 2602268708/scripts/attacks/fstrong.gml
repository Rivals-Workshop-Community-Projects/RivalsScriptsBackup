...
set_hitbox_value(AT_FSTRONG, 1, HG_LIFETIME, 260);
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_X, 20);
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_Y, -81);
set_hitbox_value(AT_FSTRONG, 1, HG_WIDTH, 0);
set_hitbox_value(AT_FSTRONG, 1, HG_HEIGHT, 0);
set_hitbox_value(AT_FSTRONG, 1, HG_SHAPE, 2);
set_hitbox_value(AT_FSTRONG, 1, HG_PRIORITY, 1);
set_hitbox_value(AT_FSTRONG, 1, HG_DAMAGE, 10);
set_hitbox_value(AT_FSTRONG, 1, HG_ANGLE, 45);
set_hitbox_value(AT_FSTRONG, 1, HG_BASE_KNOCKBACK, 0);
...
set_hitbox_value(AT_FSTRONG, 1, HG_PROJECTILE_SPRITE, sprite_get("fstrong_whomp"));
set_hitbox_value(AT_FSTRONG, 1, HG_PROJECTILE_MASK, asset_get("empty_sprite"));
set_hitbox_value(AT_FSTRONG, 1, HG_PROJECTILE_COLLISION_SPRITE, sprite_get("fstrong_whomp_mask"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_PROJECTILE_DESTROY_EFFECT, whomp_explode);

//LAUNCH HITBOX
set_hitbox_value(AT_FSTRONG, 2, HG_MUNO_HITBOX_NAME, "Launcher");
set_hitbox_value(AT_FSTRONG, 2, HG_MUNO_HITBOX_MISC_ADD, "Active frames only accurate if Whomp is not airborne on frame 45");
set_hitbox_value(AT_FSTRONG, 2, HG_MUNO_HITBOX_ACTIVE, "45-49");
...
//FALLING HITBOX
set_hitbox_value(AT_FSTRONG, 3, HG_MUNO_HITBOX_NAME, "Falling Hit");
set_hitbox_value(AT_FSTRONG, 3, HG_MUNO_HITBOX_ACTIVE, "45-");
set_hitbox_value(AT_FSTRONG, 3, HG_MUNO_HITBOX_MISC_ADD, "Starts if Whomp is airborne on frame 45");
...
set_hitbox_value(AT_FSTRONG, 3, HG_ANGLE, 69); //nice
...
//SLAM CONNECTING HIT
set_hitbox_value(AT_FSTRONG, 4, HG_MUNO_HITBOX_NAME, "Initial Slam");
set_hitbox_value(AT_FSTRONG, 4, HG_MUNO_HITBOX_ACTIVE, "39-44");
...
set_hitbox_value(AT_FSTRONG, 4, HG_ANGLE, 270); //nice
...
set_hitbox_value(AT_FSTRONG, 4, HG_VISUAL_EFFECT, whomp_hit2);
