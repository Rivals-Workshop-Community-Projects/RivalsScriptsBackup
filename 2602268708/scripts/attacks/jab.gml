...
set_window_value(AT_JAB, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.6);
...
set_window_value(AT_JAB, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.6);
...
set_window_value(AT_JAB, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.6);
...
set_window_value(AT_JAB, 6, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.6);
...
set_window_value(AT_JAB, 7, AG_WINDOW_SFX, asset_get("sfx_shovel_swing_heavy1"));
set_window_value(AT_JAB, 7, AG_WINDOW_SFX_FRAME, 5);
set_window_value(AT_JAB, 7, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.8);

set_window_value(AT_JAB, 8, AG_WINDOW_HSPEED, 7);
set_window_value(AT_JAB, 8, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(AT_JAB, 8, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.8);
