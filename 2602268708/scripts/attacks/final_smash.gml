set_attack_value(49, AG_MUNO_ATTACK_NAME, "YOU WANT FUN?");
...
set_hitbox_value(49, 1, HG_HITBOX_X, -450);
...
set_hitbox_value(49, 1, HG_PROJECTILE_SPRITE, sprite_get("fs_wario_apparition"));
...
//i dont fucking know how to do stuff with draw_sprite and alpha so heres my bootleg solution
set_hitbox_value(49, 2, HG_HITBOX_TYPE, 2);
set_hitbox_value(49, 2, HG_WINDOW, 1);
set_hitbox_value(49, 2, HG_WINDOW_CREATION_FRAME, 20);
set_hitbox_value(49, 2, HG_LIFETIME, 5);
set_hitbox_value(49, 2, HG_HITBOX_X, -450);
set_hitbox_value(49, 2, HG_HITBOX_Y, 80);
set_hitbox_value(49, 2, HG_WIDTH, 150);
set_hitbox_value(49, 2, HG_HEIGHT, 200);
...
set_hitbox_value(49, 2, HG_VISUAL_EFFECT, 157);
set_hitbox_value(49, 2, HG_EFFECT, fs_hit);
set_hitbox_value(49, 2, HG_HIT_SFX, asset_get("sfx_blow_heavy2"));
set_hitbox_value(49, 2, HG_PROJECTILE_SPRITE, sprite_get("fs_wario_apparition_tran"));
set_hitbox_value(49, 2, HG_PROJECTILE_MASK, sprite_get("fs_wario_apparition"));
set_hitbox_value(49, 2, HG_PROJECTILE_ANIM_SPEED, .4);
set_hitbox_value(49, 2, HG_PROJECTILE_IS_TRANSCENDENT, 1);
set_hitbox_value(49, 2, HG_PROJECTILE_PLASMA_SAFE, true);
set_hitbox_value(49, 2, HG_PROJECTILE_PARRY_STUN, false);
