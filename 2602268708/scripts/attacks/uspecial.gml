...
set_hitbox_value(AT_USPECIAL, temp_num, HG_LIFETIME, 4);
set_hitbox_value(AT_USPECIAL, temp_num, HG_HITBOX_Y, -80);
set_hitbox_value(AT_USPECIAL, temp_num, HG_WIDTH, 60);
set_hitbox_value(AT_USPECIAL, temp_num, HG_HEIGHT, 50);
set_hitbox_value(AT_USPECIAL, temp_num, HG_PRIORITY, 1);
set_hitbox_value(AT_USPECIAL, temp_num, HG_DAMAGE, 2);
set_hitbox_value(AT_USPECIAL, temp_num, HG_ANGLE, 90);
set_hitbox_value(AT_USPECIAL, temp_num, HG_BASE_KNOCKBACK, 10);
set_hitbox_value(AT_USPECIAL, temp_num, HG_BASE_HITPAUSE, 4);
set_hitbox_value(AT_USPECIAL, temp_num, HG_VISUAL_EFFECT, 3);
set_hitbox_value(AT_USPECIAL, temp_num, HG_HIT_SFX, asset_get("sfx_forsburn_reappear_hit"));
set_hitbox_value(AT_USPECIAL, temp_num, HG_ANGLE_FLIPPER, 10);
...
set_hitbox_value(AT_USPECIAL, temp_num, HG_HEIGHT, 86);
set_hitbox_value(AT_USPECIAL, temp_num, HG_PRIORITY, 1);
set_hitbox_value(AT_USPECIAL, temp_num, HG_DAMAGE, 6);
set_hitbox_value(AT_USPECIAL, temp_num, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_USPECIAL, temp_num, HG_KNOCKBACK_SCALING, .8);
set_hitbox_value(AT_USPECIAL, temp_num, HG_BASE_HITPAUSE, 4);
...
set_hitbox_value(AT_USPECIAL, temp_num, HG_HIT_SFX, asset_get("sfx_shovel_hit_heavy1"));
...
set_hitbox_value(AT_USPECIAL, temp_num, HG_SHAPE, 1);
