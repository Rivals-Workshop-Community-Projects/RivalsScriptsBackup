...
set_hitbox_value(AT_FTHROW, 1, HG_HIT_PARTICLE_NUM, 1);
...
set_hitbox_value(AT_DTHROW, 1, HG_HIT_PARTICLE_NUM, 1);
...
set_hitbox_value(AT_UTHROW, 1, HG_HIT_PARTICLE_NUM, 1);
