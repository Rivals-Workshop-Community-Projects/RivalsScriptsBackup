...
// set_hitbox_value(AT_UAIR, 1, HG_HITBOX_Y, -76);
...
// set_hitbox_value(AT_UAIR, 2, HG_HEIGHT, 19);
...
// set_hitbox_value(AT_UAIR, 4, HG_WIDTH, 79);
// set_hitbox_value(AT_UAIR, 4, HG_HEIGHT, 29);
