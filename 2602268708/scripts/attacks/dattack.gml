...
set_attack_value(AT_DATTACK, AG_MUNO_ATTACK_MISC_ADD, "Tilt cancellable on hit starting from Window 3. ()");
...
set_window_value(AT_DATTACK, 2, AG_WINDOW_TYPE, 9);
...
set_hitbox_value(AT_DATTACK, 1, HG_MUNO_HITBOX_NAME, "Multihits");
set_hitbox_value(AT_DATTACK, 1, HG_MUNO_HITBOX_MISC_ADD, "Hits 5 times");
...
set_hitbox_value(AT_DATTACK, 1, HG_KNOCKBACK_SCALING, 0.05);
