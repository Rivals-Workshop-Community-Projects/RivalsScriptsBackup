...
with phone{
	...
	initApp(0, 0, "HOME Menu", $139B7A, 0); // uses BGR instead of RGB for... some reason????? wtf gamemaker
	initApp(1, 1, "Fighter Tips", $139B7A, tips);
	initApp(2, 2, "Patch Notes", $139B7A, patches);
	initApp(3, 3, "Phone Settings", $139B7A, settings);
	initApp(4, 4, "Frame Data", $139B7A, moves); // old color: $236b89
	initApp(5, 5, "Cheat Codes", $139B7A, cheats);
	initApp(6, 6, "Training Town", $139B7A, stage_settings);
	initApp(7, 7, "Codecs", $139B7A, []);
	initApp(8, 8, "About", $139B7A, abouts);
	initApp(9, 9, "Power Off", $139B7A, 0);
