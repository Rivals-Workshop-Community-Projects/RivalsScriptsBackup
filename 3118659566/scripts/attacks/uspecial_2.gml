...
set_window_value(AT_USPECIAL_2, 1, AG_WINDOW_SFX_FRAME, 14);
set_window_value(AT_USPECIAL_2, 1, AG_WINDOW_VSPEED, 0);
set_window_value(AT_USPECIAL_2, 1, AG_WINDOW_VSPEED_TYPE, 1);
set_window_value(AT_USPECIAL_2, 1, AG_WINDOW_HSPEED, 0.2);
...
set_window_value(AT_USPECIAL_2, 2, AG_WINDOW_HSPEED, 0.2);
...
set_window_value(AT_USPECIAL_2, 3, AG_WINDOW_VSPEED, -11.5);
set_window_value(AT_USPECIAL_2, 3, AG_WINDOW_VSPEED_TYPE, 2);
set_window_value(AT_USPECIAL_2, 3, AG_WINDOW_HSPEED, 4);
...
set_window_value(AT_USPECIAL_2, 5, AG_WINDOW_LENGTH, 1);
...
set_hitbox_value(AT_USPECIAL_2, 1, HG_HITBOX_Y, -25);
set_hitbox_value(AT_USPECIAL_2, 1, HG_WIDTH, 76);
...
set_hitbox_value(AT_USPECIAL_2, 1, HG_ANGLE, 95); //292 
set_hitbox_value(AT_USPECIAL_2, 1, HG_PRIORITY, 2);
set_hitbox_value(AT_USPECIAL_2, 1, HG_HITSTUN_MULTIPLIER, 1.5);
set_hitbox_value(AT_USPECIAL_2, 1, HG_TECHABLE, 1);
set_hitbox_value(AT_USPECIAL_2, 1, HG_BASE_KNOCKBACK, 9); //7
...
set_hitbox_value(AT_USPECIAL_2, 2, HG_HITBOX_Y, -75);
set_hitbox_value(AT_USPECIAL_2, 2, HG_WIDTH, 76);
set_hitbox_value(AT_USPECIAL_2, 2, HG_HEIGHT, 54);
set_hitbox_value(AT_USPECIAL_2, 2, HG_SHAPE, 0);
set_hitbox_value(AT_USPECIAL_2, 2, HG_DAMAGE, 6);
set_hitbox_value(AT_USPECIAL_2, 2, HG_ANGLE, 85); //292 
set_hitbox_value(AT_USPECIAL_2, 2, HG_ANGLE_FLIPPER, 4); //292 
...
set_hitbox_value(AT_USPECIAL_2, 2, HG_BASE_KNOCKBACK, 4); //7
...
set_hitbox_value(AT_USPECIAL_2, 2, HG_DRIFT_MULTIPLIER, 0);
...
set_hitbox_value(AT_USPECIAL_2, 3, HG_HITBOX_X, 18);
set_hitbox_value(AT_USPECIAL_2, 3, HG_HITBOX_Y, -90);
set_hitbox_value(AT_USPECIAL_2, 3, HG_WIDTH, 60);
set_hitbox_value(AT_USPECIAL_2, 3, HG_HEIGHT, 60);
set_hitbox_value(AT_USPECIAL_2, 3, HG_SHAPE, 0);
set_hitbox_value(AT_USPECIAL_2, 3, HG_DAMAGE, 5);
set_hitbox_value(AT_USPECIAL_2, 3, HG_ANGLE, 90); //292 
//set_hitbox_value(AT_USPECIAL_2, 3, HG_ANGLE_FLIPPER, 9); //292 
set_hitbox_value(AT_USPECIAL_2, 3, HG_PRIORITY, 1);
set_hitbox_value(AT_USPECIAL_2, 3, HG_BASE_KNOCKBACK, 7); //7
set_hitbox_value(AT_USPECIAL_2, 3, HG_KNOCKBACK_SCALING, .7); //7
set_hitbox_value(AT_USPECIAL_2, 3, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_USPECIAL_2, 3, HG_HITPAUSE_SCALING, .6);
...
set_hitbox_value(AT_USPECIAL_2, 4, HG_HEIGHT, 60);
set_hitbox_value(AT_USPECIAL_2, 4, HG_SHAPE, 0);
set_hitbox_value(AT_USPECIAL_2, 4, HG_DAMAGE, 5);
set_hitbox_value(AT_USPECIAL_2, 4, HG_ANGLE, 90); //292 
//set_hitbox_value(AT_USPECIAL_2, 4, HG_ANGLE_FLIPPER, 9); //292 
set_hitbox_value(AT_USPECIAL_2, 4, HG_PRIORITY, 1);
set_hitbox_value(AT_USPECIAL_2, 4, HG_BASE_KNOCKBACK, 7); //7
set_hitbox_value(AT_USPECIAL_2, 4, HG_KNOCKBACK_SCALING, .7); //7
set_hitbox_value(AT_USPECIAL_2, 4, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_USPECIAL_2, 4, HG_HITPAUSE_SCALING, .6);
set_hitbox_value(AT_USPECIAL_2, 4, HG_VISUAL_EFFECT, 1);
set_hitbox_value(AT_USPECIAL_2, 4, HG_HIT_SFX, asset_get("sfx_blow_heavy2"));
set_hitbox_value(AT_USPECIAL_2, 4, HG_DRIFT_MULTIPLIER, 1);
