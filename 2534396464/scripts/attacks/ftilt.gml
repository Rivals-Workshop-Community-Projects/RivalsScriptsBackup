...
set_window_value(AT_FTILT, 2, AG_WINDOW_SFX, sound_get("katana_06"));
...
set_hitbox_value(AT_FTILT, 1, HG_HITBOX_X, 8);
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, sound_get("katana_impact_object_01"));
