...
set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, sound_get("gardener"));
...
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, sound_get("gardener_hit"));
...
set_hitbox_value(AT_FAIR, 3, HG_HIT_SFX, sound_get("gardener_hit"));
