...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, sound_get("rocket_stock_shoot"));
...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_HAS_WHIFFLAG, 6);
...
set_hitbox_value(AT_USPECIAL, 1, HG_HIT_SFX, sound_get("rocket_directhit_explode"));
