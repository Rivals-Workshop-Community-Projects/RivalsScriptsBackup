...
set_hitbox_value(AT_JAB, 1, HG_VISUAL_EFFECT_X_OFFSET, 13);
set_hitbox_value(AT_JAB, 1, HG_VISUAL_EFFECT_Y_OFFSET, -22);
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("panhit"));
