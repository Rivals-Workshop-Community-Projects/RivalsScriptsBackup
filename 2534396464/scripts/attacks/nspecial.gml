...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("rocket_stock_shoot"));
...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_HAS_WHIFFLAG, 14);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_KNOCKBACK_SCALING, 1.05);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("rocket_proj"));
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("rocket_proj"));
