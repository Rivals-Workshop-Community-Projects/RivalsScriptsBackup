...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, sound_get("rocket_stock_shoot"));
...
set_window_value(AT_DTILT, 3, AG_WINDOW_HAS_WHIFFLAG, 13);
...
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, 29);
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_Y_OFFSET, -20);
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, sound_get("rocket_directhit_explode"));
