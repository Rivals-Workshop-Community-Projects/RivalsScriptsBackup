set_attack_value(AT_TAUNT_2, AG_SPRITE, sprite_get("jump"));
...
set_window_value(AT_TAUNT_2, 1, AG_WINDOW_LENGTH, 300);
set_window_value(AT_TAUNT_2, 1, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_TAUNT_2, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_TAUNT_2, 1, AG_WINDOW_SFX, sound_get("Tankman Ascends"));

set_window_value(AT_TAUNT_2, 2, AG_WINDOW_TYPE, 2);
set_window_value(AT_TAUNT_2, 2, AG_WINDOW_LENGTH, 150);
set_window_value(AT_TAUNT_2, 2, AG_WINDOW_ANIM_FRAMES, 1);

set_window_value(AT_TAUNT_2, 3, AG_WINDOW_TYPE, 7);
set_window_value(AT_TAUNT_2, 3, AG_WINDOW_LENGTH, 150);
