...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_charge_blade_ready"));
...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_LENGTH, 17);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("uncharged_note"));
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("uncharged_note"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("tier1_note"));
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_MASK, sprite_get("tier1_note"));
...
set_hitbox_value(AT_NSPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("tier2_note"));
set_hitbox_value(AT_NSPECIAL, 3, HG_PROJECTILE_MASK, sprite_get("tier2_note"));
