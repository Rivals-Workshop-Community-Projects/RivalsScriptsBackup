...
set_window_value(AT_BAIR, 2, AG_WINDOW_LENGTH, 24);
set_window_value(AT_BAIR, 2, AG_WINDOW_ANIM_FRAMES, 12);
...
set_window_value(AT_BAIR, 3, AG_WINDOW_ANIM_FRAME_START, 14);
...
set_hitbox_value(AT_BAIR, 3, HG_VISUAL_EFFECT_X_OFFSET, 8);
...
set_hitbox_value(AT_BAIR, 4, HG_VISUAL_EFFECT_X_OFFSET, 8);
