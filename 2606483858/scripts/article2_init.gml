...
sprite_index = sprite_get("arrow_idle");           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
...
mask_index = sprite_get("uspecial_arrow_hurtbox");
