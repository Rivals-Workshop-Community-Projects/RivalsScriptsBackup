...
set_window_value(AT_DTILT, 3, AG_WINDOW_HAS_CUSTOM_FRICTION, true);
set_window_value(AT_DTILT, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.8);
...
set_hitbox_value(AT_DTILT, 2, HG_WIDTH, 51);
