...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_VSPEED, -20); //-14
...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_CUSTOM_GRAVITY, 0.65);
...
set_hitbox_value(AT_USPECIAL, 1, HG_WIDTH, 47);
...
set_hitbox_value(AT_USPECIAL, 1, HG_KNOCKBACK_SCALING, 0.9); //1.0
set_hitbox_value(AT_USPECIAL, 1, HG_BASE_HITPAUSE, 12);
set_hitbox_value(AT_USPECIAL, 1, HG_HITPAUSE_SCALING, 1.0);
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT, hfx_elecbig);
...
set_hitbox_value(AT_USPECIAL, 2, HG_HEIGHT, 132);
