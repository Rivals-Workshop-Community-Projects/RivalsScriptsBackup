...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sound_get("sfx_slash_m"));
...
set_window_value(AT_DATTACK, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .85);
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .65);
