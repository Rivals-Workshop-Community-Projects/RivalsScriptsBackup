...
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_X, 105);
...
set_hitbox_value(AT_FSTRONG, 2, HG_KNOCKBACK_SCALING, 0.4);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, asset_get("sfx_dust_knuckle"));
...
set_hitbox_value(AT_FSTRONG, 3, HG_WIDTH, 25);
...
set_hitbox_value(AT_FSTRONG, 3, HG_HIT_SFX, sound_get("ris_bounce"));