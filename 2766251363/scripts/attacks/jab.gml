...
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, sound_get("ris_lilgrab"));
...
set_hitbox_value(AT_JAB, 1, HG_VISUAL_EFFECT, 19);
...
set_hitbox_value(AT_JAB, 1, HG_DRIFT_MULTIPLIER, 0);
...
set_hitbox_value(AT_JAB, 2, HG_DRIFT_MULTIPLIER, 0);
...
set_hitbox_value(AT_JAB, 3, HG_WIDTH, 2);
...
set_hitbox_value(AT_JAB, 3, HG_EFFECT, 9);
set_hitbox_value(AT_JAB, 3, HG_VISUAL_EFFECT, 1);
set_hitbox_value(AT_JAB, 3, HG_ANGLE_FLIPPER, 0);
set_hitbox_value(AT_JAB, 3, HG_DRIFT_MULTIPLIER, 0);
set_hitbox_value(AT_JAB, 3, HG_SDI_MULTIPLIER, 0);
...
set_hitbox_value(AT_JAB, 4, HG_HIT_SFX, asset_get("sfx_kragg_throw"));