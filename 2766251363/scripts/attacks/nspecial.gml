...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("ris_grab"));
...
set_window_value(AT_NSPECIAL, 4, AG_WINDOW_HSPEED, 9);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_EXTRA_HITPAUSE, 90);
set_hitbox_value(AT_NSPECIAL, 1, HG_HITSTUN_MULTIPLIER, 1);
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("nspecial_ghost"));
...
set_hitbox_value(AT_NSPECIAL, 3, HG_HEIGHT, 65);
