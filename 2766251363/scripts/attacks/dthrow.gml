...
set_window_value(AT_DTHROW, 1, AG_WINDOW_ANIM_FRAMES, 8);
set_window_value(AT_DTHROW, 1, AG_WINDOW_ANIM_FRAME_START, 0);

set_window_value(AT_DTHROW, 2, AG_WINDOW_TYPE, 1);
set_window_value(AT_DTHROW, 2, AG_WINDOW_LENGTH, 25);
set_window_value(AT_DTHROW, 2, AG_WINDOW_ANIM_FRAMES, 8);
set_window_value(AT_DTHROW, 2, AG_WINDOW_ANIM_FRAME_START, 8);
...
set_window_value(AT_DTHROW, 3, AG_WINDOW_ANIM_FRAME_START, 17);
set_window_value(AT_DTHROW, 3, AG_WINDOW_HSPEED, 0);
set_window_value(AT_DTHROW, 3, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_DTHROW, 3, AG_WINDOW_VSPEED, 9);
...
set_hitbox_value(AT_DTHROW, 1, HG_LIFETIME, 18);
...
set_hitbox_value(AT_DTHROW, 1, HG_BASE_KNOCKBACK, 1);
set_hitbox_value(AT_DTHROW, 1, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_DTHROW, 1, HG_EXTRA_HITPAUSE, 90);
set_hitbox_value(AT_DTHROW, 1, HG_VISUAL_EFFECT_Y_OFFSET, -16);
set_hitbox_value(AT_DTHROW, 1, HG_HITSTUN_MULTIPLIER, 1);
set_hitbox_value(AT_DTHROW, 1, HG_PROJECTILE_SPRITE, sprite_get("nspecial_ghost"));
set_hitbox_value(AT_DTHROW, 1, HG_PROJECTILE_MASK, sprite_get("nspecial_proj"));
set_hitbox_value(AT_DTHROW, 1, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_DTHROW, 1, HG_PROJECTILE_HSPEED, 0);
set_hitbox_value(AT_DTHROW, 1, HG_VISUAL_EFFECT, 19);
...
set_hitbox_value(AT_DTHROW, 1, HG_PROJECTILE_PLASMA_SAFE, 1);
...
set_hitbox_value(AT_DTHROW, 3, HG_HEIGHT, 45);
...
set_hitbox_value(AT_DTHROW, 3, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_DTHROW, 3, HG_KNOCKBACK_SCALING, 0.3);
set_hitbox_value(AT_DTHROW, 3, HG_EFFECT, 9);
set_hitbox_value(AT_DTHROW, 3, HG_VISUAL_EFFECT_Y_OFFSET, -16);
set_hitbox_value(AT_DTHROW, 3, HG_HITSTUN_MULTIPLIER, 1);
set_hitbox_value(AT_DTHROW, 3, HG_VISUAL_EFFECT, 303);