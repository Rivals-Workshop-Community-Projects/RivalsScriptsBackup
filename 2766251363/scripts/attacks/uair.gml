...
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, sound_get("ris_lilgrab"));
...
set_window_value(AT_UAIR, 6, AG_WINDOW_LENGTH, 18);
set_window_value(AT_UAIR, 6, AG_WINDOW_ANIM_FRAMES, 6);
set_window_value(AT_UAIR, 6, AG_WINDOW_ANIM_FRAME_START, 5);
set_window_value(AT_UAIR, 6, AG_WINDOW_VSPEED, -9);
set_window_value(AT_UAIR, 6, AG_WINDOW_VSPEED_TYPE, 2);

set_window_value(AT_UAIR, 7, AG_WINDOW_TYPE, 1);
set_window_value(AT_UAIR, 7, AG_WINDOW_LENGTH, 7);
...
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT, 19);
...
set_hitbox_value(AT_UAIR, 1, HG_DRIFT_MULTIPLIER, 0);
...
set_hitbox_value(AT_UAIR, 2, HG_HITSTUN_MULTIPLIER, 1.5);
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT, 1);
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, sound_get("ris_bwoung"));
set_hitbox_value(AT_UAIR, 2, HG_ANGLE_FLIPPER, 0);
set_hitbox_value(AT_UAIR, 2, HG_DRIFT_MULTIPLIER, 0);
set_hitbox_value(AT_UAIR, 2, HG_SDI_MULTIPLIER, 0);
...
set_hitbox_value(AT_UAIR, 3, HG_DAMAGE, 0);
...
set_hitbox_value(AT_UAIR, 3, HG_BASE_HITPAUSE, 0);
set_hitbox_value(AT_UAIR, 3, HG_HITPAUSE_SCALING, 0);
set_hitbox_value(AT_UAIR, 3, HG_HITSTUN_MULTIPLIER, 1.3);
