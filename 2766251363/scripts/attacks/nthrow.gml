...
set_window_value(AT_NTHROW, 1, AG_WINDOW_ANIM_FRAMES, 8);
...
set_window_value(AT_NTHROW, 2, AG_WINDOW_ANIM_FRAME_START, 8);
...
set_window_value(AT_NTHROW, 3, AG_WINDOW_ANIM_FRAME_START, 17);
set_window_value(AT_NTHROW, 3, AG_WINDOW_HSPEED, 9);
set_window_value(AT_NTHROW, 3, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_NTHROW, 3, AG_WINDOW_VSPEED, 9);
...
set_hitbox_value(AT_NTHROW, 1, HG_LIFETIME, 18);
set_hitbox_value(AT_NTHROW, 1, HG_HITBOX_X, 0);
set_hitbox_value(AT_NTHROW, 1, HG_HITBOX_Y, -0);
...
set_hitbox_value(AT_NTHROW, 1, HG_EXTRA_HITPAUSE, 90);
set_hitbox_value(AT_NTHROW, 1, HG_VISUAL_EFFECT_Y_OFFSET, -16);
set_hitbox_value(AT_NTHROW, 1, HG_HITSTUN_MULTIPLIER, 1);
set_hitbox_value(AT_NTHROW, 1, HG_PROJECTILE_SPRITE, sprite_get("nspecial_ghost"));
set_hitbox_value(AT_NTHROW, 1, HG_PROJECTILE_MASK, sprite_get("nspecial_proj"));
set_hitbox_value(AT_NTHROW, 1, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_NTHROW, 1, HG_PROJECTILE_HSPEED, 0);
set_hitbox_value(AT_NTHROW, 1, HG_VISUAL_EFFECT, 19);
set_hitbox_value(AT_NTHROW, 1, HG_PROJECTILE_UNBASHABLE, 1);
set_hitbox_value(AT_NTHROW, 1, HG_PROJECTILE_PARRY_STUN, 1);
set_hitbox_value(AT_NTHROW, 1, HG_PROJECTILE_DOES_NOT_REFLECT, 1);
set_hitbox_value(AT_NTHROW, 1, HG_PROJECTILE_DESTROY_EFFECT, 1);
set_hitbox_value(AT_NTHROW, 1, HG_PROJECTILE_PLASMA_SAFE, 1);
...
set_hitbox_value(AT_NTHROW, 2, HG_LIFETIME, 10);
set_hitbox_value(AT_NTHROW, 2, HG_HITBOX_X, -10);
set_hitbox_value(AT_NTHROW, 2, HG_HITBOX_Y, -54);
set_hitbox_value(AT_NTHROW, 2, HG_WIDTH, 55);
...
set_hitbox_value(AT_NTHROW, 2, HG_KNOCKBACK_SCALING, 0.3);
set_hitbox_value(AT_NTHROW, 2, HG_VISUAL_EFFECT_Y_OFFSET, -16);
...
set_hitbox_value(AT_NTHROW, 3, HG_WINDOW, 3);
set_hitbox_value(AT_NTHROW, 3, HG_WINDOW_CREATION_FRAME, 1);
set_hitbox_value(AT_NTHROW, 3, HG_LIFETIME, 10);
set_hitbox_value(AT_NTHROW, 3, HG_HITBOX_X, -13);
set_hitbox_value(AT_NTHROW, 3, HG_HITBOX_Y, -52);
set_hitbox_value(AT_NTHROW, 3, HG_WIDTH, 75);
set_hitbox_value(AT_NTHROW, 3, HG_HEIGHT, 75);
...
set_hitbox_value(AT_NTHROW, 3, HG_KNOCKBACK_SCALING, 0.3);
set_hitbox_value(AT_NTHROW, 3, HG_EFFECT, 9);
set_hitbox_value(AT_NTHROW, 3, HG_VISUAL_EFFECT_Y_OFFSET, -16);
set_hitbox_value(AT_NTHROW, 3, HG_HITSTUN_MULTIPLIER, 1);
set_hitbox_value(AT_NTHROW, 3, HG_VISUAL_EFFECT, 303);