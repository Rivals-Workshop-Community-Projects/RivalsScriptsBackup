...
if !_init || !in_render exit; //Only draw stuff after initializing
if in_render {
    if debug_info {
    ...
    if (!is_boss && (show_healthbar && (obj_stage_main.enemy_health_hud_mode == 1 || obj_stage_main.enemy_health_hud_mode == 2))) {
