...
rel_pos = 0;
obj_type = "";
article_frame_limit = 5; //Chunk loading if it lags EXPERIMENTAL
art = noone;
//follow_objects  = [];
/*with oPlayer {
...
array_terrain_data = array_create(0);
array_background_data = array_create(0);
combined_terrain = 0;
terrain_grid_data = ds_grid_create(1, 1);
grid_room_data = ds_grid_create(1, 1);
