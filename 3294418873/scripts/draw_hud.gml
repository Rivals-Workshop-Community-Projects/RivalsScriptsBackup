...
//music name title
music_titles = ["Cleric Beast", "The Hunter", "Laurence, the First Vicar", "Lady Maria of the Astral Clocktower"]
 
 
//confirmation sound to play when music has been changed
//sound_get and asset_get both works here.
var confirm_sound = sound_get("bloodvial");
...
var music_line_color = make_color_rgb(0,0,0);
...
var music_txt_color = make_color_rgb(206,97,98);
