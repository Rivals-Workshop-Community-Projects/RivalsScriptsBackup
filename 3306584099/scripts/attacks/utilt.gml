...
set_hitbox_value(AT_UTILT, 5, HG_WIDTH, 112);
set_hitbox_value(AT_UTILT, 5, HG_HEIGHT, 62);
...
set_hitbox_value(AT_UTILT, 6, HG_HITBOX_X, -16);
set_hitbox_value(AT_UTILT, 6, HG_HITBOX_Y, -50);
set_hitbox_value(AT_UTILT, 6, HG_WIDTH, 62);
