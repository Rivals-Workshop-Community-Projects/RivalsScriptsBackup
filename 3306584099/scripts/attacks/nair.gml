...
set_hitbox_value(AT_NAIR, 7, HG_HITBOX_Y, -50);
set_hitbox_value(AT_NAIR, 7, HG_WIDTH, 110);
...
set_hitbox_value(AT_NAIR, 8, HG_HITBOX_Y, -50);
set_hitbox_value(AT_NAIR, 8, HG_WIDTH, 120);
