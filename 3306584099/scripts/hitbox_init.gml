...
// NEW SOUP CODE HERE
if player_id.alt_invert_ice {
    switch (attack) {
        case AT_NSPECIAL:
            if hbox_num == 1 {
                sprite_index = sprite_get("nspecial_proj1_inverted")
            } 
            else if hbox_num == 2 {
                sprite_index = sprite_get("nspecial_proj1a_inverted")
            }
            else if hbox_num == 3 {
                sprite_index = sprite_get("nspecial_proj1b_inverted")
            }else if hbox_num == 4 {
                sprite_index = sprite_get("nspecial_proj2_inverted")
            }
            break;
    }
}
