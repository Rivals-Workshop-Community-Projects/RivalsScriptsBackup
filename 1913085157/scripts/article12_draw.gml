...
draw_sprite_ext( sprite_get("gradient_fade"), 0, temp_x, temp_y, 3000, thingy*2.6, 0, c_black, thingy/1.4 );

draw_sprite_ext( sprite_get("gradient_fade"), 0, temp_x, temp_y+1400, 3000, -5, 0, -1, thingy/5 );