...
set_window_value(AT_DATTACK, 2, AG_WINDOW_LENGTH, 6);//9
set_window_value(AT_DATTACK, 2, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_DATTACK, 2, AG_WINDOW_ANIM_FRAME_START, 1);
set_window_value(AT_DATTACK, 2, AG_WINDOW_HSPEED, 8);//10
...
set_window_value(AT_DATTACK, 4, AG_WINDOW_HSPEED, 8);//10
