...
set_hitbox_value(AT_DAIR, 1, HG_HITSTUN_MULTIPLIER, 0.58);
...
set_hitbox_value(AT_DAIR, 2, HG_HITSTUN_MULTIPLIER, 0.58);
...
set_hitbox_value(AT_DAIR, 11, HG_HITSTUN_MULTIPLIER, 0.9);
