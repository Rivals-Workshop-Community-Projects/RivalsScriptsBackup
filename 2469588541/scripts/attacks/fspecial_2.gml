...
set_window_value(AT_FSPECIAL_2, 1, AG_WINDOW_LENGTH, 8);//9
...
set_window_value(AT_FSPECIAL_2, 2, AG_WINDOW_LENGTH, 6);//12
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_BASE_KNOCKBACK, 12);//12
//set_hitbox_value(AT_FSPECIAL_2, 1, HG_EXTRA_HITPAUSE, 25);
//set_hitbox_value(AT_FSPECIAL_2, 1, HG_KNOCKBACK_SCALING, .1);
set_hitbox_value(AT_FSPECIAL_2, 1, HG_BASE_HITPAUSE, 6);//12
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HITSTUN_MULTIPLIER, 1.2);//0.9
//set_hitbox_value(AT_FSPECIAL_2, 1, HG_DRIFT_MULTIPLIER, 0.045);
set_hitbox_value(AT_FSPECIAL_2, 1, HG_DRIFT_MULTIPLIER, has_rune("B")?0.01:0.20);
