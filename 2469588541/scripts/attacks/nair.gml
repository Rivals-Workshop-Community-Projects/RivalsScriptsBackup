...
set_window_value(AT_NAIR, 3, AG_WINDOW_LENGTH, 25);
...
set_hitbox_value(AT_NAIR, 1, HG_LIFETIME, 28);
...
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT, smallstar_effect);
...
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT, bigstar_effect);

set_hitbox_value(AT_NAIR, 3, HG_PARENT_HITBOX, 3);
set_hitbox_value(AT_NAIR, 3, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_NAIR, 3, HG_WINDOW, 2);
set_hitbox_value(AT_NAIR, 3, HG_LIFETIME, 26);
...
set_hitbox_value(AT_NAIR, 3, HG_VISUAL_EFFECT, smallstar_effect);