...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_HSPEED, 15);//25
...
set_hitbox_value(AT_FSPECIAL, 2, HG_ANGLE, 45);//361
set_hitbox_value(AT_FSPECIAL, 2, HG_BASE_KNOCKBACK, 6);//5
set_hitbox_value(AT_FSPECIAL, 2, HG_KNOCKBACK_SCALING, 0.5);//.9
