...
sfx_pho_open = sound_get("_pho_bw_battleopen");
sfx_pho_close = sound_get("_pho_bw_close");
sfx_pho_move = sound_get("_pho_bw_move");
sfx_pho_move_home = sound_get("_pho_bw_move");
sfx_pho_page = sound_get("_pho_bw_select");
sfx_pho_open_app = sound_get("_pho_bw_menuselect");
sfx_pho_close_app = sound_get("_pho_bw_back");
sfx_pho_power_off = sound_get("_pho_bw_menuclose");
sfx_pho_power_on = sound_get("_pho_bw_menuopen");
...
with phone{
	...
	APP_HOME		= pho_initApp("Home Screen",	$FFFFFF, $FFFFFF, apps);
	APP_TIPS		= pho_initApp("Tips",			$94FFFF, $084A73, tips);
	APP_PATCHES		= pho_initApp("Patches",		$CEADFF, $310073, patches);
	APP_DATA		= pho_initApp("Data",			$F75A8C, $6B0821, data);
	APP_CHEATS		= pho_initApp("Cheats",			$FFAD21, $734200, cheats);
	APP_UTILS		= pho_initApp("Utilities",		$FF107B, $5A0000, utils);
	APP_POWER		= pho_initApp("Power",			$4ACE84, $005229, []);
}
