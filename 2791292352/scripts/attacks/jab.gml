...
set_window_value(AT_JAB, 9, AG_WINDOW_CANCEL_FRAME, 6);
...
set_window_value(AT_JAB, 11, AG_WINDOW_LENGTH, 2);
...
set_window_value(AT_JAB, 12, AG_WINDOW_CANCEL_FRAME, 6);


set_num_hitboxes(AT_JAB, 1);

set_hitbox_value(AT_JAB, 1, HG_MUNO_HITBOX_NAME, "Jabs");
set_hitbox_value(AT_JAB, 1, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_JAB, 1, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_JAB, 1, HG_WINDOW, 13);
...
set_hitbox_value(AT_JAB, 1, HG_SDI_MULTIPLIER, 1.5);
set_hitbox_value(AT_JAB, 1, HG_FORCE_FLINCH, 0);

set_attack_value(AT_JAB, AG_MUNO_ATTACK_MISC_ADD, "Keep pressing attack to loop infinitely.");