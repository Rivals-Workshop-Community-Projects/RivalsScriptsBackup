...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("shadowclaw"));
...
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, bair_cross1);
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("ssbu_slice_s"));
set_hitbox_value(AT_BAIR, 1, HG_HIT_LOCKOUT, 1);
set_hitbox_value(AT_BAIR, 1, HG_HIT_PARTICLE_NUM, 3);
...
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT, bair_cross1);
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, sound_get("ssbu_slice_s"));
set_hitbox_value(AT_BAIR, 2, HG_HIT_LOCKOUT, 1);
set_hitbox_value(AT_BAIR, 2, HG_HIT_PARTICLE_NUM, 3);

set_hitbox_value(AT_BAIR, 3, HG_MUNO_HITBOX_NAME, "Launcher");
...
set_hitbox_value(AT_BAIR, 3, HG_HITBOX_Y, -45);
set_hitbox_value(AT_BAIR, 3, HG_WIDTH, 75);
set_hitbox_value(AT_BAIR, 3, HG_HEIGHT, 110);
...
set_hitbox_value(AT_BAIR, 3, HG_VISUAL_EFFECT, bair_cross2);
set_hitbox_value(AT_BAIR, 3, HG_HIT_SFX, sound_get("ssbu_slice_m"));
