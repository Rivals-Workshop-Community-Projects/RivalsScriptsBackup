...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_LENGTH, 26);
set_window_value(AT_DSTRONG, 1, AG_WINDOW_ANIM_FRAMES, 6);
set_window_value(AT_DSTRONG, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, sound_get("phantom_sink"));
set_window_value(AT_DSTRONG, 1, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_DSTRONG, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, 100);
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, sound_get("phantom_attack"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_MUNO_HITBOX_NAME, "Coffin Hitbox");
...
set_hitbox_value(AT_DSTRONG, 1, HG_HEIGHT, 115);
...
set_hitbox_value(AT_DSTRONG, 2, HG_MUNO_HITBOX_NAME, "Outer Hitbox");
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, wwisp_hit);
...
set_attack_value(AT_DSTRONG, AG_MUNO_ATTACK_MISC_ADD, "Intangible while charging. Inner hitbox inflicts Mummy.");