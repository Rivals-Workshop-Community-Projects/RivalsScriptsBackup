...
// GHOST MID
set_color_profile_slot( 0, 0, 119, 73, 187 );
set_color_profile_slot_range( 0, 1, 1, 1 );

// GOLD
set_color_profile_slot( 0, 1, 251, 205, 113 );
set_color_profile_slot_range( 1, 2, 40, 48 );

// CREST 1
set_color_profile_slot( 0, 2, 32, 149, 188 );
set_color_profile_slot_range( 2, 1, 46, 27 );

// CREST 2
set_color_profile_slot( 0, 3, 27, 85, 150 );
set_color_profile_slot_range( 3, 1, 1, 1 );

// HANDS
set_color_profile_slot( 0, 4, 42, 42, 42 );
set_color_profile_slot_range( 4, 1, 4, 12 );

// EYES
set_color_profile_slot( 0, 5, 255, 116, 92 );
set_color_profile_slot_range( 5, 2, 37, 1 );

// GHOST LIGHT
set_color_profile_slot( 0, 6, 180, 121, 221 );
...
// SHINY
set_color_profile_slot( 1, 0, 0, 163, 204 ); //GHOST MID
set_color_profile_slot( 1, 1, 197, 206, 214 ); //GOLD
set_color_profile_slot( 1, 2, 222, 123, 214 ); //CREST 1
...
set_color_profile_slot( 2, 1, 221, 214, 219 ); //GOLD
set_color_profile_slot( 2, 2, 184, 44, 50 ); //CREST 1
...
set_color_profile_slot( 3, 1, 61, 90, 110 ); //GOLD
set_color_profile_slot( 3, 2, 255, 102, 0 ); //CREST 1
...
set_color_profile_slot( 4, 1, 110, 104, 103 ); //GOLD
set_color_profile_slot( 4, 2, 220, 99, 144 ); //CREST 1
...
// AEGISLASH
set_color_profile_slot( 5, 0, 78, 76, 77 ); //GHOST MID
set_color_profile_slot( 5, 1, 205, 191, 104 ); //GOLD
set_color_profile_slot( 5, 2, 243, 240, 226 ); //CREST 1
...
set_color_profile_slot( 6, 1, 86, 84, 146 ); //GOLD
set_color_profile_slot( 6, 2, 168, 175, 215 ); //CREST 1
...
set_color_profile_slot( 7, 1, 167, 186, 74 ); //GOLD
set_color_profile_slot( 7, 2, 83, 122, 62 ); //CREST 1
set_color_profile_slot( 7, 3, 83, 122, 62 ); //CREST 2
set_color_profile_slot( 7, 4, 35, 67, 49 ); //HANDS
set_color_profile_slot( 7, 5, 211, 226, 154 ); //EYES
set_color_profile_slot( 7, 6, 211, 226, 154 ); //GHOST LIGHT
set_color_profile_slot( 7, 7, 83, 122, 62 ); //GHOST DARK

// INFAMOUS
set_color_profile_slot( 8, 0, 70, 217, 174 ); //GHOST MID
set_color_profile_slot( 8, 1, 77, 69, 151 ); //GOLD
set_color_profile_slot( 8, 2, 40, 185, 252 ); //CREST 1
...
set_color_profile_slot( 9, 1, 107, 169, 190 ); //GOLD
set_color_profile_slot( 9, 2, 203, 207, 210 ); //CREST 1
...
set_color_profile_slot( 10, 1, 187, 201, 213 ); //GOLD
set_color_profile_slot( 10, 2, 237, 207, 109 ); //CREST 1
...
set_color_profile_slot( 11, 1, 255, 224, 124 ); //GOLD
set_color_profile_slot( 11, 2, 182, 135, 185 ); //CREST 1
...
set_color_profile_slot( 12, 1, 230, 82, 62 ); //GOLD
set_color_profile_slot( 12, 2, 94, 74, 74 ); //CREST 1
...
// GOLURK
set_color_profile_slot( 13, 0, 232, 193, 63 ); //GHOST MID
set_color_profile_slot( 13, 1, 131, 197, 205 ); //GOLD
set_color_profile_slot( 13, 2, 197, 156, 82 ); //CREST 1
...
set_color_profile_slot( 14, 1, 117, 117, 117 ); //GOLD
set_color_profile_slot( 14, 2, 115, 82, 230 ); //CREST 1
...
set_color_profile_slot( 15, 1, 135, 117, 86 ); //GOLD
set_color_profile_slot( 15, 2, 246, 189, 57 ); //CREST 1
...
set_color_profile_slot( 16, 1, 90, 131, 205 ); //GOLD
set_color_profile_slot( 16, 2, 189, 82, 123 ); //CREST 1
...
set_color_profile_slot( 17, 1, 133, 212, 247 ); //GOLD
set_color_profile_slot( 17, 2, 169, 118, 184 ); //CREST 1
...
set_color_profile_slot( 18, 1, 225, 226, 227 ); //GOLD
set_color_profile_slot( 18, 2, 247, 222, 41 ); //CREST 1
...
set_color_profile_slot( 19, 1, 202, 238, 178 ); //GOLD
set_color_profile_slot( 19, 2, 222, 98, 98 ); //CREST 1
...
set_color_profile_slot( 20, 1, 219, 211, 178 ); //GOLD
set_color_profile_slot( 20, 2, 153, 116, 86 ); //CREST 1
...
set_color_profile_slot( 21, 1, 197, 82, 122 ); //GOLD
set_color_profile_slot( 21, 2, 80, 80, 102 ); //CREST 1
...
set_color_profile_slot( 22, 1, 165, 143, 119 ); //GOLD
set_color_profile_slot( 22, 2, 71, 175, 114 ); //CREST 1
...
set_color_profile_slot( 23, 1, 57, 134, 142 ); //GOLD
set_color_profile_slot( 23, 2, 134, 90, 51 ); //CREST 1
...
set_color_profile_slot( 24, 1, 96, 137, 72 ); //GOLD
set_color_profile_slot( 24, 2, 227, 214, 190 ); //CREST 1
...
// PLANT GANG
set_color_profile_slot( 25, 0, 2, 94, 47 ); //GHOST MID
set_color_profile_slot( 25, 1, 209, 73, 73 ); //GOLD
set_color_profile_slot( 25, 2, 215, 232, 216 ); //CREST 1
...
// MARTH
set_color_profile_slot( 26, 0, 46, 61, 179 ); //GHOST MID
set_color_profile_slot( 26, 1, 58, 93, 171 ); //GOLD
set_color_profile_slot( 26, 2, 243, 225, 83 ); //CREST 1
...
set_color_profile_slot( 27, 1, 235, 244, 255 ); //GOLD
set_color_profile_slot( 27, 2, 32, 149, 188 ); //CREST 1
...
// TRANS RIGHTS
set_color_profile_slot( 28, 0, 201, 48, 171 ); //GHOST MID
set_color_profile_slot( 28, 1, 125, 203, 255 ); //GOLD
set_color_profile_slot( 28, 2, 242, 148, 235 ); //CREST 1
set_color_profile_slot( 28, 3, 184, 84, 176 ); //CREST 2
...
set_color_profile_slot( 29, 1, 187, 84, 199 ); //GOLD
set_color_profile_slot( 29, 2, 255, 221, 0 ); //CREST 1
...
set_color_profile_slot( 30, 1, 255, 255, 255 ); //GOLD
set_color_profile_slot( 30, 2, 61, 61, 61 ); //CREST 1
set_color_profile_slot( 30, 3, 87, 87, 87 ); //CREST 2
...
set_color_profile_slot( 31, 1, 255, 252, 252 ); //GOLD
set_color_profile_slot( 31, 2, 0, 0, 0 ); //CREST 1
...
=== BEGIN JSON PALETTE ===
{"formatversion":1,"data":[{"name":"GHOST MID","colors":[{"r":119,"g":73,"b":187,"main":true}]},{"name":"GOLD","colors":[{"r":249,"g":236,"b":209},{"r":251,"g":205,"b":113,"main":true},{"r":204,"g":154,"b":54},{"r":130,"g":95,"b":32}]},{"name":"CREST 1","colors":[{"r":158,"g":230,"b":255},{"r":32,"g":149,"b":188,"main":true}]},{"name":"CREST 2","colors":[{"r":27,"g":85,"b":150,"main":true}]},{"name":"HANDS","colors":[{"r":68,"g":66,"b":66},{"r":42,"g":42,"b":42,"main":true}]},{"name":"EYES","colors":[{"r":255,"g":116,"b":92,"main":true},{"r":255,"g":42,"b":0}]},{"name":"GHOST LIGHT","colors":[{"r":180,"g":121,"b":221,"main":true}]},{"name":"GHOST DARK","colors":[{"r":85,"g":33,"b":162,"main":true}]}]}
=== END JSON PALETTE ===
*/
