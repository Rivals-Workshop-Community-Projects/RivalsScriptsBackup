...
if (get_player_color(player) == 11){
    set_character_color_shading( 0, 0.6 ); //body
    set_character_color_shading( 1, 1.2 ); //electricity
}

if (get_player_color(player) == 12){
    set_character_color_shading( 0, 0.45 ); //body
    set_character_color_shading( 1, 0 ); //electricity
}
