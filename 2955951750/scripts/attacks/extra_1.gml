...
set_attack_value(AT_EXTRA_1, AG_SPRITE, sprite_get("walkturn"));
set_attack_value(AT_EXTRA_1, AG_NUM_WINDOWS, 3);
set_attack_value(AT_EXTRA_1, AG_AIR_SPRITE, sprite_get("walkturn"));
set_attack_value(AT_EXTRA_1, AG_HURTBOX_SPRITE, sprite_get("oxob_hurtbox"));

set_window_value(AT_EXTRA_1, 1, AG_WINDOW_TYPE, 1);
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_LENGTH, 4);
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_HSPEED, 9);
...
set_hitbox_value(AT_EXTRA_1, 1, HG_LIFETIME, 16);
set_hitbox_value(AT_EXTRA_1, 1, HG_HITBOX_X, 8);
