...
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, weakhit);
...
set_hitbox_value(AT_BAIR, 3, HG_ANGLE, 80);
...
set_hitbox_value(AT_BAIR, 3, HG_VISUAL_EFFECT, weakhit2);
