...
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, sfx_hit_light);
...
set_window_value(AT_JAB, 4, AG_WINDOW_SFX, sfx_hit_medium);
...
set_window_value(AT_JAB, 7, AG_WINDOW_SFX, sfx_hit_heavy);
...
set_hitbox_value(AT_JAB, 3, HG_KNOCKBACK_SCALING, .70);
