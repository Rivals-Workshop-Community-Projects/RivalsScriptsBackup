...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, sfx_lasso_heavy);
...
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_X, 114);
...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sfx_grab);
...
//set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_X, 160);
...
set_hitbox_value(AT_USTRONG, 3, HG_WIDTH, 56);
...
set_hitbox_value(AT_USTRONG, 4, HG_ANGLE, 135);
...
set_hitbox_value(AT_USTRONG, 4, HG_HIT_SFX, asset_get("sfx_may_whip1"));
...
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_X, -60);
...
set_hitbox_value(AT_USTRONG, 5, HG_ANGLE, 225);
...
set_hitbox_value(AT_USTRONG, 6, HG_HITBOX_X, -60);
