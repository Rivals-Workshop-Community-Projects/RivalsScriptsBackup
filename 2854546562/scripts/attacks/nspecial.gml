...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sfx_hit_light);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_forsburn_cape_hit"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HIT_SFX, sfx_hit_medium);
