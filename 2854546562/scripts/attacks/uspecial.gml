...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_forsburn_cape_swipe"));
...
set_hitbox_value(AT_USPECIAL, 2, HG_ANGLE, 15);
...
set_hitbox_value(AT_USPECIAL, 4, HG_ANGLE, -15);
