...
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, asset_get("sfx_birdclap"));
set_hitbox_value(AT_UAIR, 2, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT, smallheartFX);
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, -24);