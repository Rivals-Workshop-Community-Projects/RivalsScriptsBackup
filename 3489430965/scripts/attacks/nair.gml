...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, sound_get("diamond_armor"));
...
set_window_value(AT_NAIR, 3, AG_WINDOW_LENGTH, 22);
...
set_hitbox_value(AT_NAIR, 1, HG_HEIGHT, 144);
