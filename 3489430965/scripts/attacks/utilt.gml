...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("the_nether"));
...
set_hitbox_value(AT_UTILT, 1, HG_WIDTH, 128);
set_hitbox_value(AT_UTILT, 1, HG_HEIGHT, 168);
...
set_hitbox_value(AT_UTILT, 1, HG_HITPAUSE_SCALING, 1.0);
