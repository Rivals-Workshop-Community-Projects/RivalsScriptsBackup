...
set_window_value(AT_FSPECIAL_2, 2, AG_WINDOW_CUSTOM_GRAVITY, 0.5);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HITBOX_Y, -18 - (has_rune("N") * 30));
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HITBOX_X, 10);
set_hitbox_value(AT_FSPECIAL_2, 1, HG_WIDTH, 46 + (has_rune("N") * 40));
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HEIGHT, 40 + (has_rune("N") * 50));
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_VISUAL_EFFECT, HFX_GEN_OMNI);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_PROJECTILE_COLLISION_SPRITE, asset_get("empty_sprite"));
