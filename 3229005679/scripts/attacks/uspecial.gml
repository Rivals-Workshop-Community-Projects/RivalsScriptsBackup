...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, sound_get("cannonballshoot3"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_LIFETIME, 65);
set_hitbox_value(AT_USPECIAL, 1, HG_HITBOX_X, 58);
...
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("rocketProjectile"));
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_COLLISION_SPRITE, sprite_get("rocketProjectile"));
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, 1);
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_ANIM_SPEED, 0.5);
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_HSPEED, 7.5);
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_VSPEED, 7.5);
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_GRAVITY, 0);
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_WALL_BEHAVIOR, 0);
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_GROUND_BEHAVIOR, 0); //-1
...
set_hitbox_value(AT_USPECIAL, 2, HG_PROJECTILE_COLLISION_SPRITE, asset_get("empty_sprite"));
...
set_hitbox_value(AT_USPECIAL, 2, HG_VISUAL_EFFECT, fakeEmpty);
...
set_hitbox_value(AT_USPECIAL, 3, HG_PROJECTILE_COLLISION_SPRITE, asset_get("empty_sprite"));
...
set_hitbox_value(AT_USPECIAL, 3, HG_VISUAL_EFFECT, fakeEmpty);
