...
set_window_value(AT_DATTACK, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, air_friction);
...
set_window_value(AT_DATTACK, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, air_friction);
...
set_hitbox_value(AT_DATTACK, 1, HG_HITSTUN_MULTIPLIER, 0.5);
...
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT, HFX_GEN_SWEET);
...
set_hitbox_value(AT_DATTACK, 2, HG_HITPAUSE_SCALING, 0.75);
