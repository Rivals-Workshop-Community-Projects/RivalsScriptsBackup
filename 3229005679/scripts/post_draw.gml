...
if (get_match_setting(SET_HITBOX_VIS)){
    ...
    if (instance_exists(vigiWeenie) && vigiWeenie.state != 6) then draw_sprite_ext(vigiWeenie.mask_index, 0, vigiWeenie.x, vigiWeenie.y, 2*vigiWeenie.spr_dir, 2, 0, -1, 0.5);
}
