...
if (attack == AT_FSPECIAL) {
    proj_timer = 0;
    initial_hsp = hsp;
    pause_to_animate_max = 10;
    pause_to_animate = pause_to_animate_max;
    start_clamp = false;
    end_clamp = false;
    proj_can_grab = true;
    chosen_image_index = 0;
    // Percent of time to spend active, then closes and returns in the remaining time, must be >0, <1
    //clamp_percent = 0.6;
    initial_x = x;
