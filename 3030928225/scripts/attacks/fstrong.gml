...
set_window_value(atk, window_num, AG_WINDOW_ANIM_FRAMES, 15);
set_window_value(atk, window_num, AG_WINDOW_ANIM_FRAME_START, 3);
...
// Uncharged
    ...
    set_hitbox_value(atk, hitbox_num, HG_FINAL_BASE_KNOCKBACK, 3);
    set_hitbox_value(atk, hitbox_num, HG_KNOCKBACK_SCALING, 0);
    set_hitbox_value(atk, hitbox_num, HG_BASE_HITPAUSE, 3);
    set_hitbox_value(atk, hitbox_num, HG_EXTRA_HITPAUSE, 4);
