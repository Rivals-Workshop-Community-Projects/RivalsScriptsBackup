...
sprite_index = sprite_get("fspecial_hopslop_enter");           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
...
attack_anim_rate = 10;                                 //Example animation speed value 1. The animation in question will increment every 8 frames in this case
...
new_sprite = sprite_get("fspecial_hopslop_enter");             //This is another part of the animation handling. It tells the game "this is the sprite this article should be using; if it's not already, switch it over please"
...
//choose creature
var creature_type = random_func(7, 4, true);
switch (creature_type)
{
    case 0: //WATER
        hitbox_number = 2;
        spr_enter =  sprite_get("fspecial_hopslop_enter");
        spr_idle =   sprite_get("fspecial_hopslop_idle");
        spr_attack = sprite_get("fspecial_hopslop_attack");
        spr_fx =     sprite_get("fspecial_hopslop_fx");
        spr_die =    sprite_get("fspecial_hopslop_die");
        hit_sfx = asset_get("sfx_orcane_dsmash");
    break;
    case 1: //AIR
        hitbox_number = 3;
        spr_enter =  sprite_get("fspecial_gorillanado_enter");
        spr_idle =   sprite_get("fspecial_gorillanado_idle");
        spr_attack = sprite_get("fspecial_gorillanado_attack");
        spr_fx =     sprite_get("fspecial_gorillanado_fx");
        spr_die =    sprite_get("fspecial_gorillanado_die");
        hit_sfx = asset_get("sfx_bird_nspecial");
    break;
    case 2: //EARTH
        hitbox_number = 4;
        spr_enter =  sprite_get("fspecial_folet_enter");
        spr_idle =   sprite_get("fspecial_folet_idle");
        spr_attack = sprite_get("fspecial_folet_attack");
        spr_fx =     sprite_get("fspecial_folet_fx");
        spr_die =    sprite_get("fspecial_folet_die");
        hit_sfx = asset_get("sfx_syl_dspecial_growth");
    break;
    case 3: //FIRE
    default: //ERROR
        creature_type = 3;
        hitbox_number = 5;
        spr_enter =  sprite_get("fspecial_firefang_enter");
        spr_idle =   sprite_get("fspecial_firefang_idle");
        spr_attack = sprite_get("fspecial_firefang_attack");
        spr_fx =     sprite_get("fspecial_firefang_fx");
        spr_die =    sprite_get("fspecial_firefang_die");
        hit_sfx = asset_get("sfx_ori_sein_fstrong");
        
    break;
}

//Notify Adam of current Creature chosen
player_id.vfx_fspecial_icon_active = true;
player_id.vfx_fspecial_icon_index = creature_type;
