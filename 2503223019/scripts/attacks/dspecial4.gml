...
set_attack_value(AT_DTHROW, AG_AIR_SPRITE, sprite_get("dspecial_air"));
set_attack_value(AT_DTHROW, AG_HURTBOX_SPRITE, sprite_get("dspecial_hurt"));
set_attack_value(AT_DTHROW, AG_HURTBOX_AIR_SPRITE, sprite_get("dspecial_air_hurt"));
...
set_window_value(AT_DTHROW, 1, AG_WINDOW_SFX, asset_get("sfx_holy_textbox"));
