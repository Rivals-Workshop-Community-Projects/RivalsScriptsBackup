...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, asset_get("sfx_holy_textbox"));
...
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT, 22);
...
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT, 22);
