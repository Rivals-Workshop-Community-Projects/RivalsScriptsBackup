...
set_hitbox_value(AT_USTRONG, 1, HG_PROJECTILE_SPRITE, sprite_get("milebar_together"));
...
set_hitbox_value(AT_USTRONG, 1, HG_LIFETIME, 290);
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_X, 0);
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_Y, -1);
set_hitbox_value(AT_USTRONG, 1, HG_WIDTH, 0);
set_hitbox_value(AT_USTRONG, 1, HG_HEIGHT, 0);
...
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_TYPE, 2); //Green
set_hitbox_value(AT_USTRONG, 2, HG_PROJECTILE_SPRITE, sprite_get("milebar_g_moving"));
...
set_hitbox_value(AT_USTRONG, 2, HG_PROJECTILE_PLASMA_SAFE, true); //Clarien can't touch this.
set_hitbox_value(AT_USTRONG, 2, HG_WINDOW, 3);
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_USTRONG, 2, HG_LIFETIME, 290);
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_X, 36);
...
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_TYPE, 2); //Orange
set_hitbox_value(AT_USTRONG, 3, HG_PROJECTILE_SPRITE, sprite_get("milebar_r_moving"));
...
set_hitbox_value(AT_USTRONG, 3, HG_PROJECTILE_PLASMA_SAFE, true); //Clarien can't touch this.
set_hitbox_value(AT_USTRONG, 3, HG_WINDOW, 3);
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_USTRONG, 3, HG_LIFETIME, 290);
...
set_hitbox_value(AT_USTRONG, 4, HG_HITBOX_TYPE, 2); //The actual hitbox of the middle
...
set_hitbox_value(AT_USTRONG, 4, HG_PROJECTILE_PLASMA_SAFE, true); //Clarien can't touch this.
...
set_hitbox_value(AT_USTRONG, 4, HG_HITBOX_Y, 5);
...
set_hitbox_value(AT_USTRONG, 4, HG_VISUAL_EFFECT_X_OFFSET, -1);
set_hitbox_value(AT_USTRONG, 4, HG_VISUAL_EFFECT_Y_OFFSET, -5);
...
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_TYPE, 2); //The actual hitbox of the sides
...
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_PLASMA_SAFE, true); //Clarien can't touch this.
set_hitbox_value(AT_USTRONG, 5, HG_WINDOW, 3);
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_USTRONG, 5, HG_LIFETIME, 90);
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_X, 0);
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_Y, -4);
set_hitbox_value(AT_USTRONG, 5, HG_HEIGHT, 0);
...
set_hitbox_value(AT_USTRONG, 5, HG_VISUAL_EFFECT_X_OFFSET, -1);
set_hitbox_value(AT_USTRONG, 5, HG_VISUAL_EFFECT_Y_OFFSET, -5);
