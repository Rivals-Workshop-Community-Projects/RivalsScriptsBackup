...
set_window_value(AT_JAB, 3, AG_WINDOW_HAS_WHIFFLAG, 10); //NOTE: if you make it a multi-hit jab, remove whifflag, since Rivals multi-step jabs do not have whifflag. single-hits like sandbert, elli, etc DO have whifflag
...
set_hitbox_value(AT_JAB, 1, HG_ANGLE, 210);
...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("melee_fan"));
