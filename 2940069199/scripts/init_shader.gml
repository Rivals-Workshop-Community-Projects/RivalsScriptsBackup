...
if (get_player_color(player) == 0)
{
    switch(color_shift)
    {
        ...
        case 2:
            set_character_color_slot( 0, 12, 127, 169 ); //Hair
            set_character_color_slot( 1, 45, 45, 151 ); //Eyes
            set_character_color_slot( 2, 135, 27, 46 ); //Bows
            set_character_color_slot( 3, 49, 47, 61 ); //Shirt
            set_character_color_slot( 4, 229, 176, 145 ); //Skin
            set_character_color_slot( 5, 16, 19, 41 ); //Axe Blade
            set_character_color_slot( 6, 84, 87, 99 ); //Legging 1
            set_character_color_slot( 7, 84, 87, 99 ); //Legging 2
            set_article_color_slot( 0, 12, 127, 169 ); //Hair
            set_article_color_slot( 1, 45, 45, 151 ); //Eyes
            set_article_color_slot( 2, 135, 27, 46 ); //Bows
            set_article_color_slot( 3, 49, 47, 61 ); //Shirt
            set_article_color_slot( 4, 229, 176, 145 ); //Skin
            set_article_color_slot( 5, 16, 19, 41 ); //Axe Blade
            set_article_color_slot( 6, 84, 87, 99 ); //Legging 1
            set_article_color_slot( 7, 84, 87, 99 ); //Legging 2
            break;
    }
}
...
// Rose Maiden
set_color_profile_slot( 28, 0, 255, 150, 189 ); //Hair
set_color_profile_slot( 28, 1, 143, 21, 82 ); //Eyes
set_color_profile_slot( 28, 2, 89, 0, 21 ); //Bows
set_color_profile_slot( 28, 3, 94, 14, 38 ); //Shirt
set_color_profile_slot( 28, 4, 229, 176, 145 ); //Skin
set_color_profile_slot( 28, 5, 245, 81, 81 ); //Axe Blade
set_color_profile_slot( 28, 6, 74, 19, 19 ); //Legging 1
set_color_profile_slot( 28, 7, 109, 148, 109 ); //Legging 2

// What the Feesh
set_color_profile_slot( 29, 0, 83, 169, 158 ); //Hair
set_color_profile_slot( 29, 1, 174, 94, 166 ); //Eyes
set_color_profile_slot( 29, 2, 120, 183, 205 ); //Bows
set_color_profile_slot( 29, 3, 18, 12, 64 ); //Shirt
set_color_profile_slot( 29, 4, 229, 176, 145 ); //Skin
set_color_profile_slot( 29, 5, 101, 71, 158 ); //Axe Blade
set_color_profile_slot( 29, 6, 18, 12, 64 ); //Legging 1
set_color_profile_slot( 29, 7, 18, 12, 64 ); //Legging 2
