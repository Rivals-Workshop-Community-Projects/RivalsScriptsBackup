...
sprite_change_offset("uspecial_ground", 128, 158);
sprite_change_offset("uspecial_groundhurt", 128, 158);
sprite_change_offset("dspecial", 64, 110);
sprite_change_offset("taunt", 64, 110);
sprite_change_offset("taunt_train", 64, 94);

sprite_change_offset("plat", 64, 94);
sprite_change_offset("plat_despawn", 64, 94);

sprite_change_offset("mic", 14, 9);
sprite_change_offset("nspecial_proj", 64, 94);
sprite_change_offset("tetrinos_small_all", 30, 30);
sprite_change_offset("tetrinos_all", 60, 60);
sprite_change_offset("tetrinos1", 60, 60);
sprite_change_offset("tetrinos2", 60, 60);
sprite_change_offset("tetrinos3", 60, 60);
sprite_change_offset("tetrinos4", 60, 60);
sprite_change_offset("tetrinos5", 60, 60);
sprite_change_offset("tetrinos6", 60, 60);
sprite_change_offset("tetrinos7", 60, 60);
sprite_change_offset("tetrinos_line_up", 30, 30);


sprite_change_offset("comet_spawn", 60, 60);
sprite_change_offset("comet_idle_hurt", 60, 60);
sprite_change_offset("comet_hurt", 60, 60);
sprite_change_offset("comet_idle", 60, 60);
sprite_change_offset("comet_startup", 60, 60);
sprite_change_offset("comet_launch", 60, 60);

sprite_change_offset("axe_hit_small", 45, 60);
sprite_change_offset("axe_hit_large", 129, 131);
