...
// Hair
set_color_profile_slot( 0, 0, 12, 127, 169 );
set_color_profile_slot_range( 0, 8, 17, 25 );

// Eyes
set_color_profile_slot( 0, 1, 7, 117, 21 );
set_color_profile_slot_range( 1, 1, 1, 1 );

// Bows
set_color_profile_slot( 0, 2, 13, 13, 69 );
set_color_profile_slot_range( 2, 1, 12, 33 );

// Shirt
set_color_profile_slot( 0, 3, 54, 52, 73 );
set_color_profile_slot_range( 3, 2, 13, 43 );

// Skin
set_color_profile_slot( 0, 4, 229, 176, 145 );
set_color_profile_slot_range( 4, 12, 17, 11 );

// Axe Blade
set_color_profile_slot( 0, 5, 4, 163, 172 );
set_color_profile_slot_range( 5, 1, 5, 29 );

// Legging 1
set_color_profile_slot( 0, 6, 69, 13, 13 );
set_color_profile_slot_range( 6, 1, 12, 33 );

// Legging 2
set_color_profile_slot( 0, 7, 44, 32, 52 );
set_color_profile_slot_range( 7, 2, 10, 10 );
...
=== BEGIN JSON PALETTE ===
{"formatversion":1,"data":[{"name":"Hair","colors":[{"r":52,"g":201,"b":229},{"r":12,"g":127,"b":169,"main":true}]},{"name":"Eyes","colors":[{"r":7,"g":117,"b":21,"main":true}]},{"name":"Bows","colors":[{"r":45,"g":45,"b":151},{"r":13,"g":13,"b":69,"main":true}]},{"name":"Shirt","colors":[{"r":154,"g":151,"b":181},{"r":96,"g":93,"b":118},{"r":54,"g":52,"b":73,"main":true},{"r":34,"g":32,"b":52}]},{"name":"Skin","colors":[{"r":255,"g":231,"b":201},{"r":229,"g":176,"b":145,"main":true}]},{"name":"Axe Blade","colors":[{"r":14,"g":230,"b":242},{"r":4,"g":163,"b":172,"main":true}]},{"name":"Legging 1","colors":[{"r":69,"g":13,"b":13,"main":true},{"r":151,"g":45,"b":45}]},{"name":"Legging 2","colors":[{"r":44,"g":32,"b":52,"main":true},{"r":65,"g":52,"b":73}]}]}
=== END JSON PALETTE ===
*/
