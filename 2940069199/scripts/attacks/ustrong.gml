...
set_hitbox_value(AT_USTRONG, 4, HG_WIDTH, 59);
...
set_hitbox_value(AT_USTRONG, 4, HG_VISUAL_EFFECT, axesmall);
...
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_X, -22);
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_Y, -37);
set_hitbox_value(AT_USTRONG, 5, HG_WIDTH, 33);
