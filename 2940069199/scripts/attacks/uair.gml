...
set_hitbox_value(AT_UAIR, 3, HG_WIDTH, 105);
...
set_hitbox_value(AT_UAIR, 3, HG_VISUAL_EFFECT, musicsmall);
...
set_hitbox_value(AT_UAIR, 4, HG_HITBOX_Y, -53);
set_hitbox_value(AT_UAIR, 4, HG_HITBOX_X, 7);
set_hitbox_value(AT_UAIR, 4, HG_WIDTH, 33);
...
set_hitbox_value(AT_UAIR, 5, HG_PARENT_HITBOX, 4);
...
set_hitbox_value(AT_UAIR, 5, HG_HITBOX_Y, -53);
set_hitbox_value(AT_UAIR, 5, HG_HITBOX_X, 7);
...
set_hitbox_value(AT_UAIR, 6, HG_HITBOX_Y, -53);
set_hitbox_value(AT_UAIR, 6, HG_HITBOX_X, 7);
set_hitbox_value(AT_UAIR, 6, HG_WIDTH, 33);
set_hitbox_value(AT_UAIR, 6, HG_HEIGHT, 65);
...
set_hitbox_value(AT_UAIR, 6, HG_VISUAL_EFFECT, musicsmall);
set_hitbox_value(AT_UAIR, 6, HG_HIT_PARTICLE_NUM, 1);
set_hitbox_value(AT_UAIR, 6, HG_VISUAL_EFFECT_Y_OFFSET, -20);