...
set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, sound_get("swipe_Er02"));
...
set_window_value(AT_FAIR, 3, AG_WINDOW_LENGTH, 11); //9
...
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, sound_get("sfx_knifehit_m"));