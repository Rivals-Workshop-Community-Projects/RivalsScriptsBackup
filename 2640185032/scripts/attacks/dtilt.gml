...
set_window_value(AT_DTILT, 2, AG_WINDOW_SFX, sound_get("swipe_Er02"));
...
set_window_value(AT_DTILT, 4, AG_WINDOW_LENGTH, 16);
...
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, sound_get("sfx_knifehit_l"));