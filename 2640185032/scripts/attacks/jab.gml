...
set_window_value(AT_JAB, 7, AG_WINDOW_SFX, sound_get("swipe_Sw02"));
...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("sfx_knifehit_s"));

set_hitbox_value(AT_JAB, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_JAB, 2, HG_WINDOW, 5);
set_hitbox_value(AT_JAB, 2, HG_LIFETIME, 3);
set_hitbox_value(AT_JAB, 2, HG_HITBOX_X, 30);
set_hitbox_value(AT_JAB, 2, HG_HITBOX_Y, -19);
set_hitbox_value(AT_JAB, 2, HG_WIDTH, 74);
set_hitbox_value(AT_JAB, 2, HG_HEIGHT, 41);
set_hitbox_value(AT_JAB, 2, HG_PRIORITY, 2);
set_hitbox_value(AT_JAB, 2, HG_DAMAGE, 3);
set_hitbox_value(AT_JAB, 2, HG_ANGLE, 80);
set_hitbox_value(AT_JAB, 2, HG_BASE_KNOCKBACK, 0.5);
...
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, sound_get("sfx_knifehit_s"));
...
set_hitbox_value(AT_JAB, 2, HG_VISUAL_EFFECT, 301);
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, sound_get("sfx_knifehit_m"));
