...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("swipe_Bl03"));
...
set_window_value(AT_DSTRONG, 5, AG_WINDOW_LENGTH, 17);
...
set_hitbox_value(AT_DSTRONG, 1, HG_KNOCKBACK_SCALING, 1.05); //was 1.1
set_hitbox_value(AT_DSTRONG, 1, HG_BASE_HITPAUSE, 9);
set_hitbox_value(AT_DSTRONG, 1, HG_HITPAUSE_SCALING, .85);
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("sfx_knifehit_l"));