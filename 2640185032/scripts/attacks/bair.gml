...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("swipe_Sw02"));
...
//set_window_value(AT_BAIR, 2, AG_WINDOW_SFX, asset_get("sfx_ice_back_air"));
set_window_value(AT_BAIR, 2, AG_WINDOW_SFX, sound_get("swipe_Bl03"));
...
set_window_value(AT_BAIR, 5, AG_WINDOW_LENGTH, 20);
set_window_value(AT_BAIR, 5, AG_WINDOW_ANIM_FRAMES, 6);
...
set_hitbox_value(AT_BAIR, 1, HG_KNOCKBACK_SCALING, .8); //was 0.85
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("sfx_knifehit_l"));

//back hit
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_BAIR, 2, HG_WINDOW, 4);
set_hitbox_value(AT_BAIR, 2, HG_LIFETIME, 3);
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_X, -22); //-21
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_Y, -9);
set_hitbox_value(AT_BAIR, 2, HG_WIDTH, 77);
...
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, sound_get("sfx_knifehit_l"));
...
set_hitbox_value(AT_BAIR, 3, HG_HITBOX_X, -73);
set_hitbox_value(AT_BAIR, 3, HG_HITBOX_Y, -12);
set_hitbox_value(AT_BAIR, 3, HG_WIDTH, 34);
set_hitbox_value(AT_BAIR, 3, HG_HEIGHT, 17);
...
set_hitbox_value(AT_BAIR, 3, HG_KNOCKBACK_SCALING, 1.1);
...
set_hitbox_value(AT_BAIR, 3, HG_HIT_SFX, sound_get("crashinghit2"));