...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sound_get("swipe_Sw02"));
...
set_hitbox_value(AT_DAIR, 1, HG_WIDTH, 92);
...
set_hitbox_value(AT_DAIR, 1, HG_HITSTUN_MULTIPLIER, 1.1);
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, 301);
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, sound_get("sfx_knifehit_m"));