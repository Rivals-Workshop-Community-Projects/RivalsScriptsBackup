...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_GOTO, 10);
set_window_value(AT_USPECIAL, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, sound_get("spark_fire"));
...
set_window_value(AT_USPECIAL, 10, AG_WINDOW_SFX, sound_get("spark_end"));
