...
set_hitbox_value(AT_FSTRONG, 4, HG_DAMAGE, 14);
...
set_hitbox_value(AT_FSTRONG, 4, HG_VISUAL_EFFECT_X_OFFSET, -0.69);
set_hitbox_value(AT_FSTRONG, 4, HG_HIT_SFX, asset_get("sfx_ori_energyhit_heavy"));
...
set_hitbox_value(AT_FSTRONG, 4, HG_HIT_LOCKOUT, 4);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_Y, -80);
