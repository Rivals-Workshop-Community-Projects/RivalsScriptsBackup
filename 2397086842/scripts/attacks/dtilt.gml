...
set_window_value(AT_DTILT, 2, AG_WINDOW_SFX, asset_get("sfx_shovel_swing_light2"));
...
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, sound_get("bonk"));
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, 0.69);
...
set_hitbox_value(AT_DTILT, 2, HG_FINAL_BASE_KNOCKBACK, 7);
...
set_hitbox_value(AT_DTILT, 2, HG_VISUAL_EFFECT_X_OFFSET, 0.69);