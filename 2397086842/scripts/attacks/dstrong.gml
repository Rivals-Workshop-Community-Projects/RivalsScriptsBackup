...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_shovel_swing_heavy2"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT_X_OFFSET, -0.69);
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_LOCKOUT, 12);
...
set_hitbox_value(AT_DSTRONG, 2, HG_WIDTH, 162);
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT_X_OFFSET, -0.69);
...
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT_X_OFFSET, -0.69);
set_hitbox_value(AT_DSTRONG, 3, HG_HIT_LOCKOUT, 12);

set_hitbox_value(AT_DSTRONG, 4, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_DSTRONG, 4, HG_WINDOW, 2);
set_hitbox_value(AT_DSTRONG, 4, HG_WINDOW_CREATION_FRAME, 16);
...
set_hitbox_value(AT_DSTRONG, 4, HG_WIDTH, 145);
...
set_hitbox_value(AT_DSTRONG, 4, HG_ANGLE, 100);
set_hitbox_value(AT_DSTRONG, 4, HG_ANGLE_FLIPPER, 7);
set_hitbox_value(AT_DSTRONG, 4, HG_BASE_KNOCKBACK, 9);
set_hitbox_value(AT_DSTRONG, 4, HG_KNOCKBACK_SCALING, 1.15);
...
set_hitbox_value(AT_DSTRONG, 4, HG_HIT_SFX, asset_get("sfx_ori_energyhit_heavy"));
...
set_hitbox_value(AT_DSTRONG, 4, HG_VISUAL_EFFECT_X_OFFSET, -0.69);
set_hitbox_value(AT_DSTRONG, 4, HG_HIT_LOCKOUT, 12);