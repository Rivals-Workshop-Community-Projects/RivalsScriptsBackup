...
set_hitbox_value(AT_NSPECIAL, 6, HG_PRIORITY, 3);
set_hitbox_value(AT_NSPECIAL, 6, HG_DAMAGE, 16);
...
set_hitbox_value(AT_NSPECIAL, 7, HG_LIFETIME, 20);
...
set_hitbox_value(AT_NSPECIAL, 8, HG_PROJECTILE_VSPEED, 4);
...
set_hitbox_value(AT_NSPECIAL, 11, HG_WIDTH, 80);
