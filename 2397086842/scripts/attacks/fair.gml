...
set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, asset_get("sfx_shovel_swing_heavy1"));
...
set_window_value(AT_FAIR, 2, AG_WINDOW_SFX, asset_get("sfx_shovel_swing_med2"));
...
set_hitbox_value(AT_FAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, 0.69);
...
set_hitbox_value(AT_FAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, 0.69);