...
set_hitbox_value(AT_NSPECIAL, 4, HG_WIDTH, 170);
set_hitbox_value(AT_NSPECIAL, 4, HG_HEIGHT, 170);
...
set_hitbox_value(AT_NSPECIAL, 7, HG_ANGLE, 32);
set_hitbox_value(AT_NSPECIAL, 7, HG_BASE_KNOCKBACK, 14);
