...
set_hitbox_value(AT_DATTACK, 1, HG_HEIGHT, 39);
...
set_hitbox_value(AT_DATTACK, 1, HG_HITSTUN_MULTIPLIER, .6);
...
set_hitbox_value(AT_DATTACK, 2, HG_HITSTUN_MULTIPLIER, 0.6);