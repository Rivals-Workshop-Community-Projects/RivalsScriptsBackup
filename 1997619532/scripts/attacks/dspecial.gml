...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, sound_get("SpaceCutB"));
...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX, sound_get("slice"));
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_SFX, sound_get("SpaceCut"));
