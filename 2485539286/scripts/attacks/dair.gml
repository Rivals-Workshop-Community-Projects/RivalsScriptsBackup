...
set_hitbox_value(AT_DAIR, 2, HG_HEIGHT, 102);
...
set_hitbox_value(AT_DAIR, 2, HG_HITSTUN_MULTIPLIER, .9);
...
set_hitbox_value(AT_DAIR, 3, HG_HITSTUN_MULTIPLIER, .9);
...
set_hitbox_value(AT_DAIR, 4, HG_HEIGHT, 72);
...
set_hitbox_value(AT_DAIR, 4, HG_HITSTUN_MULTIPLIER, .9);