...
set_hitbox_value(AT_USPECIAL, 1, HG_WIDTH, 124);
set_hitbox_value(AT_USPECIAL, 1, HG_HEIGHT, 124);
...
set_hitbox_value(AT_USPECIAL, 2, HG_WIDTH, 124);
set_hitbox_value(AT_USPECIAL, 2, HG_HEIGHT, 124);
