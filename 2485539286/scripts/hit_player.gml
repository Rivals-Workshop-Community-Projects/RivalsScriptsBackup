...
sound_play(sound_get("cheese"),false,noone,1,1)	
 sound_play(asset_get("sfx_blow_heavy1"),false,noone,2,0.6)
  sound_play(asset_get("sfx_ori_sein_fstrong_finalhit"),false,noone,1)
 shake_camera(6,16)
...
if hhh == 3 {    
 sound_play(sound_get("mhit1"),false,noone, 0.3 + my_hitboxID.damage/30)
} 

if hhh == 2{
  sound_play(sound_get("mhit2"),false,noone, (0.3 + my_hitboxID.damage/30))  
}
...
switch my_hitboxID.attack {
    ...
    case AT_JAB:
     if my_hitboxID.damage == 2 {
         sound_play(asset_get("sfx_shovel_hit_light1"),false,noone,0.8, 0.95 + (random_func(10,4,true)/15));
     } else {
          sound_play(asset_get("sfx_shovel_hit_med2"),false,noone,1);
     }
    ...
    case AT_DTILT:
     if my_hitboxID.hbox_num == 1 {
         sound_play(asset_get("sfx_shovel_hit_med2"),false,noone,0.8);
     }
