...
sprite_index = sprite_get("miniontrail");		//The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
...
hit_wall = false;                                   //If the article moves into a wall on its own, this variable will be true.
    ...
    if (id != other.id && player_id == other.player_id) {
        if (minion_poisoned) {
            other.sprite_index = sprite_get("markedminiontrail");
        }
    }
}