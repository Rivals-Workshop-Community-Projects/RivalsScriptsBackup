...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_syl_dstrong"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_ANGLE, 115);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_X, 95);
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_Y, -45);
set_hitbox_value(AT_DSTRONG, 2, HG_WIDTH, 35);
