...
set_window_value(AT_USPECIAL_GROUND, 1, AG_WINDOW_LENGTH, 19);
...
set_window_value(AT_USPECIAL_GROUND, 1, AG_WINDOW_VSPEED, -8);
set_window_value(AT_USPECIAL_GROUND, 1, AG_WINDOW_SFX, asset_get("sfx_syl_nspecial"));
set_window_value(AT_USPECIAL_GROUND, 1, AG_WINDOW_SFX_FRAME, 18);
...
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_HITBOX_Y, 6);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_HITBOX_X, 0);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_WIDTH, 25);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_HEIGHT, 25);
...
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_HITPAUSE_SCALING, 1.0);
...
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_DAMAGE, 8);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_ANGLE, 67);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_BASE_KNOCKBACK, 5.5);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_KNOCKBACK_SCALING, 0.3);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_HITPAUSE_SCALING, .4);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_HIT_SFX, asset_get("sfx_abyss_seed_explode"));
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_VISUAL_EFFECT, 117);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_PROJECTILE_SPRITE, sprite_get("projdair"));
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_PROJECTILE_MASK, sprite_get("projdair"));
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_PROJECTILE_GRAVITY, 0.5);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_PROJECTILE_VSPEED, 5);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_PROJECTILE_PARRY_STUN, false);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_PROJECTILE_DESTROY_EFFECT, 14);