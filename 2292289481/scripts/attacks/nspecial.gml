...
set_hitbox_value(AT_NSPECIAL, 2, HG_HIT_SFX, asset_get("sfx_crunch"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("weborb"));
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("weborb"));
