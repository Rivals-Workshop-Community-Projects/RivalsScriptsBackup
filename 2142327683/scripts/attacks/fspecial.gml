...
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_X, 140);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_ANGLE_FLIPPER, 5);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, asset_get("sfx_may_whip2"));
...
set_hitbox_value(AT_FSPECIAL, 3, HG_VISUAL_EFFECT, 17);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_HIT_SFX, asset_get("sfx_may_whip1"));
...
set_hitbox_value(AT_FSPECIAL, 4, HG_VISUAL_EFFECT, 17);
...
set_hitbox_value(AT_FSPECIAL, 4, HG_HIT_SFX, asset_get("sfx_may_whip1"));