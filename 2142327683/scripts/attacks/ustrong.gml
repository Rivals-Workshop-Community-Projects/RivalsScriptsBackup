...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, sound_get("CloverShotMid"));
...
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_Y, -84);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, gun_strong);
