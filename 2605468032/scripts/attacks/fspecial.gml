...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.99);
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.99);
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_VSPEED, 0.5);
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.99);
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.99);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_shovel_hit_med1"));
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HITBOX_Y, -69);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_KNOCKBACK_SCALING, .95);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_KNOCKBACK_SCALING, 0.95);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_HIT_SFX, asset_get("sfx_shovel_hit_heavy2"));
