...
set_window_value(AT_FSPECIAL_AIR, 4, AG_WINDOW_ANIM_FRAMES, 6);
...
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_HITBOX_X, 38);
...
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_KNOCKBACK_SCALING, 0.8);
...
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_HIT_SFX, asset_get("sfx_shovel_hit_med2"));
...
set_hitbox_value(AT_FSPECIAL_AIR, 2, HG_WIDTH, 55);
...
set_hitbox_value(AT_FSPECIAL_AIR, 2, HG_KNOCKBACK_SCALING, .9);
...
set_hitbox_value(AT_FSPECIAL_AIR, 3, HG_WINDOW_CREATION_FRAME, 3);
set_hitbox_value(AT_FSPECIAL_AIR, 3, HG_HITBOX_X, 71);
set_hitbox_value(AT_FSPECIAL_AIR, 3, HG_HITBOX_Y, -43);
set_hitbox_value(AT_FSPECIAL_AIR, 3, HG_WIDTH, 44);
...
set_hitbox_value(AT_FSPECIAL_AIR, 3, HG_DAMAGE, 10);
...
set_hitbox_value(AT_FSPECIAL_AIR, 4, HG_WINDOW_CREATION_FRAME, 3);
...
set_hitbox_value(AT_FSPECIAL_AIR, 4, HG_DAMAGE, 10);
