...
set_hitbox_value(AT_DSPECIAL_2, 3, HG_HITBOX_Y, -2);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_WIDTH, 46);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_HEIGHT, 76);
...
set_hitbox_value(AT_DSPECIAL_2, 4, HG_LIFETIME, 20);
