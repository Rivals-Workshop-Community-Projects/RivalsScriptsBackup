...
set_window_value(AT_UTILT, 3, AG_WINDOW_LENGTH, 6);//5
...
set_hitbox_value(AT_UTILT, 1, HG_HITBOX_Y, -61);//-53
set_hitbox_value(AT_UTILT, 1, HG_WIDTH, 50);
set_hitbox_value(AT_UTILT, 1, HG_HEIGHT, 97);//81
...
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sound_get("hit5"));//sfx_blow_weak2