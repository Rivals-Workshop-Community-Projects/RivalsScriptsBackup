...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sound_get("swing"));
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.15);//0.2
...
set_hitbox_value(AT_DATTACK, 1, HG_ANGLE, 60); //361
