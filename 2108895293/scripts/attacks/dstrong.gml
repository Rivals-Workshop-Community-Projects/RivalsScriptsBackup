...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_LENGTH, 3); //Active
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_SFX, sound_get("dstrong2"));
set_window_value(AT_DSTRONG, 4, AG_WINDOW_SFX_FRAME, 7);

set_window_value(AT_DSTRONG, 5, AG_WINDOW_LENGTH, 3); //Active 2
...
set_hitbox_value(AT_DSTRONG, 1, HG_KNOCKBACK_SCALING, 0.88);
...
set_hitbox_value(AT_DSTRONG, 2, HG_ANGLE_FLIPPER, 5); //Sends in reverse
set_hitbox_value(AT_DSTRONG, 2, HG_PRIORITY, 1);
set_hitbox_value(AT_DSTRONG, 2, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_DSTRONG, 2, HG_KNOCKBACK_SCALING, 0.88);
