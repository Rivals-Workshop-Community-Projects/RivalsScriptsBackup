...
set_hitbox_value(AT_NSPECIAL, 3, HG_HEIGHT, 22);
...
set_hitbox_value(AT_NSPECIAL, 4, HG_LIFETIME, 36);
...
set_hitbox_value(AT_NSPECIAL, 4, HG_KNOCKBACK_SCALING, .35);
...
set_hitbox_value(AT_NSPECIAL, 4, HG_HIT_SFX, asset_get("sfx_flareo_rod"));
set_hitbox_value(AT_NSPECIAL, 4, HG_ANGLE, 60);
set_hitbox_value(AT_NSPECIAL, 4, HG_HIT_PARTICLE_NUM, 1);
set_hitbox_value(AT_NSPECIAL, 4, HG_VISUAL_EFFECT, hfx_rin_small);
set_hitbox_value(AT_NSPECIAL, 4, HG_PROJECTILE_DESTROY_EFFECT, hfx_rin_small);
set_hitbox_value(AT_NSPECIAL, 4, HG_VISUAL_EFFECT_Y_OFFSET, -16);
set_hitbox_value(AT_NSPECIAL, 4, HG_PROJECTILE_SPRITE, sprite_get("dspecial_proj"));
set_hitbox_value(AT_NSPECIAL, 4, HG_PROJECTILE_MASK, sprite_get("dspecial_proj"));
