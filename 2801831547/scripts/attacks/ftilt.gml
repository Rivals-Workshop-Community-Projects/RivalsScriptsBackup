...
set_hitbox_value(AT_FTILT, 2, HG_WIDTH, 38);
...
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, asset_get("sfx_zetter_upb_hit"));
...
set_hitbox_value(AT_FTILT, 3, HG_DRIFT_MULTIPLIER, 1);
set_hitbox_value(AT_FTILT, 3, HG_HITPAUSE_SCALING, .4);
set_hitbox_value(AT_FTILT, 3, HG_VISUAL_EFFECT, hfx_rin_small);
