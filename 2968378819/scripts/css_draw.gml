...
if (!variable_instance_exists(id,"ae") || ye == true){
    ...
    ce[4,1] = "White"
    ce[4,2] = "woke up feeling just white"
    ...
    ce[8,1] = "Just My Style"
    ce[8,2] = "Adell (Disgaea 2)"
