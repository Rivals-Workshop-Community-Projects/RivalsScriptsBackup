...
set_attack_value(AT_NSPECIAL, AG_NUM_WINDOWS, 14);
...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_HSPEED, 15);
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_VSPEED, -15);
...
set_window_value(AT_NSPECIAL, 4, AG_WINDOW_HSPEED, 18);
...
set_window_value(AT_NSPECIAL, 4, AG_WINDOW_GOTO, 8);
...
set_window_value(AT_NSPECIAL, 5, AG_WINDOW_HSPEED, 15);
...
set_window_value(AT_NSPECIAL, 5, AG_WINDOW_GOTO, 8);
...
set_window_value(AT_NSPECIAL, 6, AG_WINDOW_VSPEED, 18);
...
set_window_value(AT_NSPECIAL, 8, AG_WINDOW_ANIM_FRAME_START, 0);
set_window_value(AT_NSPECIAL, 8, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_NSPECIAL, 8, AG_WINDOW_SFX, asset_get("sfx_clairen_fspecial_dash"));
set_window_value(AT_NSPECIAL, 8, AG_WINDOW_SFX_FRAME, 9);
...
set_window_value(AT_NSPECIAL, 8, AG_WINDOW_GOTO, 14);
...
set_window_value(AT_NSPECIAL, 10, AG_WINDOW_HSPEED, 15);
set_window_value(AT_NSPECIAL, 10, AG_WINDOW_VSPEED, -15);
set_window_value(AT_NSPECIAL, 10, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_NSPECIAL, 10, AG_WINDOW_VSPEED_TYPE, 1);
set_window_value(AT_NSPECIAL, 10, AG_WINDOW_GOTO, 14);

//Dash Horizontally
set_window_value(AT_NSPECIAL, 11, AG_WINDOW_LENGTH, 9);
set_window_value(AT_NSPECIAL, 11, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_NSPECIAL, 11, AG_WINDOW_ANIM_FRAME_START, 9);
set_window_value(AT_NSPECIAL, 11, AG_WINDOW_HSPEED, 18);
...
set_window_value(AT_NSPECIAL, 11, AG_WINDOW_GOTO, 14);

//Dash Diagonally Downward
set_window_value(AT_NSPECIAL, 12, AG_WINDOW_LENGTH, 9);
set_window_value(AT_NSPECIAL, 12, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_NSPECIAL, 12, AG_WINDOW_ANIM_FRAME_START, 12);
set_window_value(AT_NSPECIAL, 12, AG_WINDOW_HSPEED, 15);
set_window_value(AT_NSPECIAL, 12, AG_WINDOW_VSPEED, 15);
set_window_value(AT_NSPECIAL, 12, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_NSPECIAL, 12, AG_WINDOW_VSPEED_TYPE, 1);
set_window_value(AT_NSPECIAL, 12, AG_WINDOW_GOTO, 14);

//Dash Downward
set_window_value(AT_NSPECIAL, 13, AG_WINDOW_LENGTH, 9);
set_window_value(AT_NSPECIAL, 13, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_NSPECIAL, 13, AG_WINDOW_ANIM_FRAME_START, 15);
set_window_value(AT_NSPECIAL, 13, AG_WINDOW_HSPEED, 0);
set_window_value(AT_NSPECIAL, 13, AG_WINDOW_VSPEED, 18);
set_window_value(AT_NSPECIAL, 13, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_NSPECIAL, 13, AG_WINDOW_VSPEED_TYPE, 1);
set_window_value(AT_NSPECIAL, 13, AG_WINDOW_GOTO, 14);

//Endlag
set_window_value(AT_NSPECIAL, 14, AG_WINDOW_LENGTH, 6);
set_window_value(AT_NSPECIAL, 14, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_NSPECIAL, 14, AG_WINDOW_ANIM_FRAME_START, 0);
set_window_value(AT_NSPECIAL, 14, AG_WINDOW_HSPEED, 0);
set_window_value(AT_NSPECIAL, 14, AG_WINDOW_VSPEED, 0);
set_window_value(AT_NSPECIAL, 14, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_NSPECIAL, 14, AG_WINDOW_VSPEED_TYPE, 1);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, sound_get("HitLight2"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HIT_SFX, sound_get("HitLight"));
...
set_hitbox_value(AT_NSPECIAL, 3, HG_HITBOX_X, 6);
set_hitbox_value(AT_NSPECIAL, 3, HG_HITBOX_Y, -27);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_HIT_SFX, sound_get("HitLight2"));
...
set_hitbox_value(AT_NSPECIAL, 4, HG_HITBOX_X, 5);
set_hitbox_value(AT_NSPECIAL, 4, HG_HITBOX_Y, -14);
...
set_hitbox_value(AT_NSPECIAL, 4, HG_HIT_SFX, sound_get("HitLight"));
...
set_hitbox_value(AT_NSPECIAL, 5, HG_ANGLE, 270);
set_hitbox_value(AT_NSPECIAL, 5, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_NSPECIAL, 5, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_NSPECIAL, 5, HG_HIT_SFX, sound_get("HitLight2"));
...
set_hitbox_value(AT_NSPECIAL, 6, HG_WIDTH, 45);
set_hitbox_value(AT_NSPECIAL, 6, HG_HEIGHT, 70);
...
set_hitbox_value(AT_NSPECIAL, 6, HG_HIT_SFX, sound_get("HitLight"));
...
set_hitbox_value(AT_NSPECIAL, 7, HG_HITBOX_Y, -26);
set_hitbox_value(AT_NSPECIAL, 7, HG_WIDTH, 60);
set_hitbox_value(AT_NSPECIAL, 7, HG_HEIGHT, 45);
...
set_hitbox_value(AT_NSPECIAL, 7, HG_HIT_SFX, sound_get("HitLight2"));
set_hitbox_value(AT_NSPECIAL, 7, HG_HITBOX_GROUP, 2);

set_hitbox_value(AT_NSPECIAL, 8, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_NSPECIAL, 8, HG_WINDOW, 11);
set_hitbox_value(AT_NSPECIAL, 8, HG_LIFETIME, 6);
set_hitbox_value(AT_NSPECIAL, 8, HG_HITBOX_X, 6);
set_hitbox_value(AT_NSPECIAL, 8, HG_HITBOX_Y, -27);
set_hitbox_value(AT_NSPECIAL, 8, HG_WIDTH, 70);
set_hitbox_value(AT_NSPECIAL, 8, HG_HEIGHT, 45);
...
set_hitbox_value(AT_NSPECIAL, 8, HG_HIT_SFX, sound_get("HitLight"));
set_hitbox_value(AT_NSPECIAL, 8, HG_HITBOX_GROUP, 2);

set_hitbox_value(AT_NSPECIAL, 9, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_NSPECIAL, 9, HG_WINDOW, 12);
set_hitbox_value(AT_NSPECIAL, 9, HG_LIFETIME, 6);
set_hitbox_value(AT_NSPECIAL, 9, HG_HITBOX_X, 5);
set_hitbox_value(AT_NSPECIAL, 9, HG_HITBOX_Y, -14);
set_hitbox_value(AT_NSPECIAL, 9, HG_WIDTH, 60);
set_hitbox_value(AT_NSPECIAL, 9, HG_HEIGHT, 35);
set_hitbox_value(AT_NSPECIAL, 9, HG_PRIORITY, 5);
set_hitbox_value(AT_NSPECIAL, 9, HG_DAMAGE, 3);
set_hitbox_value(AT_NSPECIAL, 9, HG_ANGLE, 30);
set_hitbox_value(AT_NSPECIAL, 9, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_NSPECIAL, 9, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_NSPECIAL, 9, HG_HIT_SFX, sound_get("HitLight2"));
set_hitbox_value(AT_NSPECIAL, 9, HG_HITBOX_GROUP, 2);

set_hitbox_value(AT_NSPECIAL, 10, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_NSPECIAL, 10, HG_WINDOW, 13);
set_hitbox_value(AT_NSPECIAL, 10, HG_LIFETIME, 6);
set_hitbox_value(AT_NSPECIAL, 10, HG_HITBOX_X, -2);
set_hitbox_value(AT_NSPECIAL, 10, HG_HITBOX_Y, -25);
set_hitbox_value(AT_NSPECIAL, 10, HG_WIDTH, 40);
set_hitbox_value(AT_NSPECIAL, 10, HG_HEIGHT, 70);
set_hitbox_value(AT_NSPECIAL, 10, HG_PRIORITY, 5);
set_hitbox_value(AT_NSPECIAL, 10, HG_DAMAGE, 3);
...
set_hitbox_value(AT_NSPECIAL, 10, HG_HIT_SFX, sound_get("HitLight"));
set_hitbox_value(AT_NSPECIAL, 10, HG_HITBOX_GROUP, 2);