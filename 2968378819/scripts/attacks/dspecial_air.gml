...
set_window_value(AT_DSPECIAL_AIR, 2, AG_WINDOW_HSPEED, has_rune("H")? 5:3);
set_window_value(AT_DSPECIAL_AIR, 2, AG_WINDOW_VSPEED, has_rune("H")? 13:9);
...
set_window_value(AT_DSPECIAL_AIR, 3, AG_WINDOW_HSPEED, has_rune("H")? 5:3);
set_window_value(AT_DSPECIAL_AIR, 3, AG_WINDOW_VSPEED, has_rune("H")? 13:9);
...
set_window_value(AT_DSPECIAL_AIR, 4, AG_WINDOW_HSPEED, has_rune("H")? 2:1);
set_window_value(AT_DSPECIAL_AIR, 4, AG_WINDOW_VSPEED, has_rune("H")? 7:5);
