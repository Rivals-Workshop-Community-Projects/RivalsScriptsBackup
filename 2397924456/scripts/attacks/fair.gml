...
set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, sfx_astral_chain_swipe_big_1);
...
set_hitbox_value(AT_FAIR, 1, HG_HEIGHT, 116);
...
set_hitbox_value(AT_FAIR, 1, HG_VISUAL_EFFECT, vfx_hit_big);
