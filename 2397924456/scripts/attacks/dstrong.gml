...
set_hitbox_value(AT_DSTRONG, 2, HG_MUNO_HITBOX_EXCLUDE, 1);
...
set_hitbox_value(AT_DSTRONG, 3, HG_WIDTH, 128);
...
set_hitbox_value(AT_DSTRONG, 3, HG_MUNO_HITBOX_NAME, "Shockwave");
set_hitbox_value(AT_DSTRONG, 3, HG_MUNO_HITBOX_MISC_ADD, "Takes priority over the Fist hitbox against grounded opponents.
Does not appear for the desynced version.");