...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sfx_astral_chain_normal_swipe_1);
...
set_window_value(AT_UTILT, 3, AG_WINDOW_SFX_FRAME, 6);
...
set_hitbox_value(AT_UTILT, 2, HG_HITBOX_Y, -56); // -48
