...
set_attack_value(AT_NSPECIAL, AG_HURTBOX_AIR_SPRITE, sprite_get("idle_hurt"));
...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, sound_get("sfx_bark"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, sound_get("sfx_hit2"));