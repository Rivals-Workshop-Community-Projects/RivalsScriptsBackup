...
set_window_value(AT_DATTACK, 1, AG_WINDOW_CUSTOM_GRAVITY, .6);
...
set_window_value(AT_DATTACK, 2, AG_WINDOW_CUSTOM_GRAVITY, .6);
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_GRAVITY, .6);
set_window_value(AT_DATTACK, 3, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, .1);
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .25);
...
set_hitbox_value(AT_DATTACK, 2, HG_ANGLE, 28);
...
set_hitbox_value(AT_DATTACK, 3, HG_ANGLE, 330);
