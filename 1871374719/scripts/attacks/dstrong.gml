...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, sound_get("sfx_spearappear"));
...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("sfx_spearrise"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, 21);
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT_X_OFFSET, 10);
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("sfx_hit1"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_WIDTH, 28);
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, 21);
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT_X_OFFSET, 10);
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("sfx_hit1"));
