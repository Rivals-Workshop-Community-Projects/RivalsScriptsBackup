...
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_LENGTH, 120);
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_VSPEED_TYPE, 1);
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_ANIM_FRAMES, 19);
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_SFX_FRAME, 40);
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_SFX, asset_get("sfx_forsburn_split"))
