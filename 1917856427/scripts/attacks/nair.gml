...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, asset_get("sfx_infinidagger"));
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX_FRAME, 9);
set_window_value(AT_NAIR, 1, AG_WINDOW_CUSTOM_GRAVITY, 1.2);
...
set_window_value(AT_NAIR, 2, AG_WINDOW_VSPEED, -5);
...
set_hitbox_value(AT_NAIR, 2, HG_DAMAGE, 9); //OLD 7
