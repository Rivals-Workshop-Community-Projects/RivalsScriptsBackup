...
set_hitbox_value(AT_FSTRONG, 1, HG_KNOCKBACK_SCALING, 0.8); //old 0.6
...
set_hitbox_value(AT_FSTRONG, 2, HG_KNOCKBACK_SCALING, 0.8); //old 0.6
...
set_hitbox_value(AT_FSTRONG, 3, HG_KNOCKBACK_SCALING, 0.8);  //old 0.9
