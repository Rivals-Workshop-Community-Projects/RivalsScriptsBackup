...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_LENGTH, 14);//old 19
...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_LENGTH,11);//old 15
...
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT_Y_OFFSET, -26);
