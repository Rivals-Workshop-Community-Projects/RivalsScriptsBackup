set_attack_value(AT_USTRONG, AG_SPRITE, sprite_get("ustrong_yield"));
set_attack_value(AT_USTRONG, AG_NUM_WINDOWS, 5);
set_attack_value(AT_USTRONG, AG_STRONG_CHARGE_WINDOW, 1);
set_attack_value(AT_USTRONG, AG_HURTBOX_SPRITE, sprite_get("ustrong_hurt"));
set_attack_value(AT_USTRONG, AG_MUNO_ATTACK_NAME, "UStrong (Yield Sign)");
...
//set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_tow_anchor_land"));
...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("shovel_hit"));
...
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_X, 56);
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("shovel_hit"));
...
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, sound_get("shovel_hit"));
...
set_hitbox_value(AT_USTRONG, 4, HG_HITBOX_Y, -98);
set_hitbox_value(AT_USTRONG, 4, HG_WIDTH, 98);
set_hitbox_value(AT_USTRONG, 4, HG_HEIGHT, 46);
...
set_hitbox_value(AT_USTRONG, 4, HG_HIT_SFX, sound_get("shovel_hit"));
...
set_hitbox_value(AT_USTRONG, 5, HG_HIT_SFX, sound_get("shovel_hit"));
