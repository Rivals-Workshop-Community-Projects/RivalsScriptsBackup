...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HITBOX_X, 94);
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HITBOX_Y, -60);
set_hitbox_value(AT_FSPECIAL_2, 1, HG_WIDTH, 49);
...
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HITBOX_X, 77);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HITBOX_Y, -40);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_WIDTH, 86);
...
set_hitbox_value(AT_FSPECIAL_2, 4, HG_HITBOX_X, 78);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_HITBOX_Y, -34);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_WIDTH, 88);
