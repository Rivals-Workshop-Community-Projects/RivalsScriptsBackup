...
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, asset_get("sfx_pom_slap1"));
...
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, asset_get("sfx_pom_slap1"));
...
set_hitbox_value(AT_UTILT, 3, HG_HIT_SFX, asset_get("sfx_pom_slap2"));
