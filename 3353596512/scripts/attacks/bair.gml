...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("bair_safetyoff"));
...
//endlag
set_window_value(AT_BAIR, 5, AG_WINDOW_LENGTH, 15); //add more anim frames and increase
...
set_hitbox_value(AT_BAIR, 2, HG_HEIGHT, 67);
