set_attack_value(AT_FSTRONG, AG_SPRITE, sprite_get("fstrong_yield"));
set_attack_value(AT_FSTRONG, AG_NUM_WINDOWS, 5);
set_attack_value(AT_FSTRONG, AG_STRONG_CHARGE_WINDOW, 1);
set_attack_value(AT_FSTRONG, AG_HURTBOX_SPRITE, sprite_get("fstrong_hurt"));
set_attack_value(AT_FSTRONG, AG_MUNO_ATTACK_NAME, "FStrong (Yield Sign)");
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_tow_anchor_land"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_HEIGHT, 116);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sound_get("shovel_hit"));
...
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, sound_get("shovel_hit"));
