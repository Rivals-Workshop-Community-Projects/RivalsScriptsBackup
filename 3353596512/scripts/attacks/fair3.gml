...
set_hitbox_value(AT_FAIR_3, 1, HG_KNOCKBACK_SCALING, 0.75);
...
set_hitbox_value(AT_FAIR_3, 2, HG_KNOCKBACK_SCALING, 0.75);
...
set_hitbox_value(AT_FAIR_3, 3, HG_HITBOX_X, 54);
set_hitbox_value(AT_FAIR_3, 3, HG_HITBOX_Y, -30);
set_hitbox_value(AT_FAIR_3, 3, HG_WIDTH, 92);
...
set_hitbox_value(AT_FAIR_3, 3, HG_KNOCKBACK_SCALING, 0.75);
