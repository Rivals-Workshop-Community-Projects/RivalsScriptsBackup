...
initTip("NSpecial: Job");
initWords("Job Bot gets ready to job!");
initWords("Job bot pulls a paper out of him and it tells what job you currently have");
initWords("The job you get buffs any move that refrences the move you got.");
initImage_ext(sprite_get("nspecial"), -4, fa_center, -1, 1, true, c_white, 1, true, noone, noone, noone, noone);

initTip("FSpecial: idk lol");
initWords("something alright");
initWords("sure of it");
initImage_ext(sprite_get("fspecial"), -4, fa_center, 1, 1, true, c_white, 1, false, noone, noone, noone, noone);

initTip("USpecial: Maximum Energy");
initWords("Job Bot Shakes a can of 'Maximum Energy' and flies to the skies!");
initWords("This is a refrence to one of the funniest moments in job simulator.");
initImage_ext(sprite_get("uspecial"), -4, fa_center, 1, 1, true, c_white, 1, false, noone, noone, noone, noone);

initTip("DSpecial: Photo Copier?");
initWords("It seems Job bot brought a photo copier? i wonder for...");
initWords("This move is a counter, the same amount of damage will be sent out to ");
initImage_ext(sprite_get("dspecial"), -4, fa_center, 1, 1, true, c_white, 1, false, noone, noone, noone, noone);

initTip("FStrong: Paper Airplane");
initWords("Job bot gets ready and flies a paper airplane!");
initImage_ext(sprite_get("fstrong"), -4, fa_center, 1, 1, true, c_white, 1, false, noone, noone, noone, noone);
	
initTip("JobBot's Lore");
initWords_ext("", fa_center, c_gray, 0, false);
initWords("Job Bot owns the Job museum. a place where you can look at Job related stuff from the past");
initWords("Job Bot likes to Job. That is all we really know about job bot, but maybe someday we will...");
...
initPatch("About Job Bot", "");
initWords("Job Bot is your guide from the Vitural Realty game 'Job simulator: the 2050 archives' which has received many game rewards.");
initWords("Job Bot has made it to rivals, with him comes a bunch of tools he'll use to [JOB].");
initHeader("Originally developed by");
initSection("Owlchemy Labs");
initHeader("Animation, coding, and balancing by");
initSection("Jonah Iwankow & Epicshaner DX");
initHeader("Additional SFX from");
initSection("Job Simulator: the 2050 archives");
initHeader("Compatible with");
initSection("Trummel & Alto, Otto, Steve, and Link");
...
SPK_JOOB = initSpeaker(1, "Job Bot", sprite_get("_pho_example_speaker"));
SPK_TWIN = initSpeaker(2, "Sandbert's evil twin", sprite_get("_pho_example_speaker"));

initCodec(0); // this should just always be 0, because there are no codec gimmicks
initCodecPage(SPK_TRUM, 6, 0, "WOAG!");
initCodecPage(SPK_TRUM, 0, 0, "Is that Job Bot from Job Simulator?");
initCodecPage(SPK_ALTO, 5, 0, "what? do you not like vr games?"); 
initCodecPage(SPK_TRUM, 0, 0, "First off I can't even play them,");
initCodecPage(SPK_TRUM, 0, 0, "Second off, I just think That's such a obscure choice");
initCodecPage(SPK_ALTO, 6, 0, "Geez, you're right...");
initCodecPage(SPK_ALTO, 6, 0, "Imma try to throw something at him and see what happens");
initCodecPage(SPK_JOOB, 0, 0, "Thank you human! may i have another?"); // this page uses the custom speaker
initCodecPage(SPK_ALTO, 1, 0, "heeh");
...
// Steve death message.
steve_death_message = "Steve couldn't pay his taxes";
...
initCodecPit();
initCodecPagePit(SPK_PIT,	8,	2,	"Oh i thought i already fought all these robots!");
initCodecPagePit(SPK_PIT,	6,	7,	"kinda makes you wonder who made them...");
initCodecPagePit(SPK_PALU,	0,	3,	"Job bot is nothing like the bot's we've fought before");
initCodecPagePit(SPK_PALU,	0,	2,	"He pays his taxes...");
