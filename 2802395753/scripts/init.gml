...
arena_title = "CEO of the simulation";
arena_short_name = "Job Bot";
tcoart = sprite_get("tco_art");
miiverse_post = sprite_get("miiverse");
battle_text = "*You suddenly have the urge to job...";
battle_text2 = "*Job bot's lust to work frightens you"
...
cheat = false;
job = "none";
sdi_mult = 0.01; //office jab sdi multiplier
grabbed_id = noone;
previous_job = 1;
job_timer = 0;