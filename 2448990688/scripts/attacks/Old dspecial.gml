...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_waveland_zet"));
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_spin_longer"));

set_window_value(AT_DSPECIAL, 4, AG_WINDOW_LENGTH, 15);
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_ANIM_FRAME_START, 24);
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy1"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HEIGHT, 43);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HEIGHT, 43);
set_hitbox_value(AT_DSPECIAL, 2, HG_PRIORITY, 10);
set_hitbox_value(AT_DSPECIAL, 2, HG_DAMAGE, 50);
