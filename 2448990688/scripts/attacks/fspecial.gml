...
set_hitbox_value(AT_FSPECIAL, 1, HG_WIDTH, 152);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_WIDTH, 152);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_WIDTH, 152);
...
set_hitbox_value(AT_FSPECIAL, 4, HG_WIDTH, 152);
...
set_hitbox_value(AT_FSPECIAL, 5, HG_WIDTH, 152);
set_hitbox_value(AT_FSPECIAL, 5, HG_ANGLE, 90);
set_hitbox_value(AT_FSPECIAL, 5, HG_HEIGHT, 54);
...
set_hitbox_value(AT_FSPECIAL, 6, HG_HEIGHT, 65);
