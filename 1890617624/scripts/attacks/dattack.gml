...
set_window_value(AT_DATTACK, 1, AG_WINDOW_HAS_CUSTOM_FRICTION, 0.6);
set_window_value(AT_DATTACK, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sound_get("voicedattack"));
...
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX, sound_get("whiffmedium"));
...
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT, hitsparksuper);
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT_X_OFFSET, 30);
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT_Y_OFFSET, 16);
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, sound_get("bighit"));
