...
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, sound_get("voicedtilt"));
...
set_window_value(AT_UAIR, 2, AG_WINDOW_SFX, sound_get("whiffmedium"));
...
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT, hitsparksuper);
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, -16);
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, sound_get("kickhit"));
