...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("voicefstrong"));
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX, sound_get("chainsaw"));
...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_SFX, sound_get("bang"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, hitsparkheavy);
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT_X_OFFSET, 10);
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sound_get("bighit2"));
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_LOCKOUT, 10);
set_hitbox_value(AT_FSTRONG, 1, HG_HITSTUN_MULTIPLIER, 0.4);