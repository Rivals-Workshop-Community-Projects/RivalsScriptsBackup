...
set_window_value(AT_UTILT, 2, AG_WINDOW_SFX, sound_get("whiffheavy"));
...
set_window_value(AT_UTILT, 3, AG_WINDOW_SFX, sound_get("voiceustrong"));
...
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, hitsparksuper);
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, 8);
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT_Y_OFFSET, -20);
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sound_get("bighit"));
set_hitbox_value(AT_UTILT, 1, HG_HITSTUN_MULTIPLIER, 0.4);