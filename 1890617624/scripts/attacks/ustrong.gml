set_attack_value(AT_USTRONG, AG_SPRITE, sprite_get("fspecial"));
set_attack_value(AT_USTRONG, AG_NUM_WINDOWS, 5);
set_attack_value(AT_USTRONG, AG_HAS_LANDING_LAG, 3);
set_attack_value(AT_USTRONG, AG_STRONG_CHARGE_WINDOW, 1);
set_attack_value(AT_USTRONG, AG_HURTBOX_SPRITE, sprite_get("fspecial_hurt"));
...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, sound_get("whiffheavy"));
...
set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX, sound_get("voiceustrong"));
...
set_window_value(AT_USTRONG, 6, AG_WINDOW_LENGTH, 9999);
...
set_hitbox_value(AT_USTRONG, 1, HG_BASE_KNOCKBACK, 19);
set_hitbox_value(AT_USTRONG, 1, HG_KNOCKBACK_SCALING, 0.4);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, hitsparkheavy);
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT_X_OFFSET, 8);
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, -20);
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("bighit"));