...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("voiceustrong"));
...
set_window_value(AT_BAIR, 2, AG_WINDOW_SFX, sound_get("whiffmedium"));
...
set_hitbox_value(AT_BAIR, 1, HG_ANGLE, -170);
...
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, hitsparkheavy);
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, -32);
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("punchheavy"));
