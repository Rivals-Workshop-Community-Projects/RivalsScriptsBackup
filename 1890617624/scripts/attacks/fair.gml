...
set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, sound_get("voicedattack"));
...
set_window_value(AT_FAIR, 2, AG_WINDOW_SFX, sound_get("swoosh"));
...
set_hitbox_value(AT_FAIR, 1, HG_HEIGHT, 120);
...
set_hitbox_value(AT_FAIR, 1, HG_VISUAL_EFFECT, hitsparkheavy);
set_hitbox_value(AT_FAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, 32);
set_hitbox_value(AT_FAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, sound_get("bighit"));
set_hitbox_value(AT_FAIR, 1, HG_HITSTUN_MULTIPLIER, 0.2);