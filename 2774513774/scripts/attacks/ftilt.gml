...
set_window_value(AT_FTILT, 4, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy1"));
...
set_hitbox_value(AT_FTILT, 2, HG_WINDOW_CREATION_FRAME, 19);
...
set_hitbox_value(AT_FTILT, 3, HG_HITBOX_Y, -80);
...
set_hitbox_value(AT_FTILT, 3, HG_HITPAUSE_SCALING, .25);
