...
set_window_value(AT_DTILT, 2, AG_WINDOW_SFX, asset_get("sfx_kragg_spike"));
...
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT, 192);
...
set_hitbox_value(AT_DTILT, 2, HG_VISUAL_EFFECT, 193);
set_hitbox_value(AT_DTILT, 2, HG_HIT_SFX, asset_get("sfx_blow_medium2"));
set_hitbox_value(AT_DTILT, 2, HG_PROJECTILE_SPRITE, sprite_get("Dtilt_projectile"));
set_hitbox_value(AT_DTILT, 2, HG_PROJECTILE_MASK, sprite_get("Dtilt_projectile"));
...
set_hitbox_value(AT_DTILT, 2, HG_PROJECTILE_ANIM_SPEED, .2);