with obj_article1 if player_id == other{
	...
	if idx != noone{
		...
		draw_sprite_ext(sprite_get("article_offscreen"), 8 + (get_player_color(player) == 13), clamp(x - view_get_xview(), margin, view_get_wview() - margin), clamp(z - view_get_yview(), margin, view_get_hview() - margin), 1, 1, 0, c_white, 1);
