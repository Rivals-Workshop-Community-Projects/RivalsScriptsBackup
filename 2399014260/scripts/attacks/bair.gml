...
set_window_value(AT_BAIR, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sfx_mario_swoosh_2);
...
set_window_value(AT_BAIR, 3, AG_WINDOW_SFX, sfx_mario_swoosh_2);
...
set_window_value(AT_BAIR, 5, AG_WINDOW_SFX, sfx_mario_swoosh_3);
set_window_value(AT_BAIR, 5, AG_WINDOW_SFX_FRAME, 3);
set_window_value(AT_BAIR, 5, AG_WINDOW_VSPEED, -1);
...
set_window_value(AT_BAIR, 7, AG_WINDOW_ANIM_FRAME_START, 10);
...
set_hitbox_value(AT_BAIR, 2, HG_MUNO_HITBOX_NAME, "Hit 2");
...
set_hitbox_value(AT_BAIR, 3, HG_HIT_SFX, asset_get("sfx_shovel_hit_med1"));
set_hitbox_value(AT_BAIR, 3, HG_HITBOX_GROUP, 3);
set_hitbox_value(AT_BAIR, 3, HG_MUNO_HITBOX_NAME, "Hit 3");