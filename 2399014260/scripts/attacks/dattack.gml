...
set_window_value(AT_DATTACK, 4, AG_MUNO_WINDOW_EXCLUDE, 2);
...
set_attack_value(AT_DATTACK, AG_MUNO_ATTACK_ENDLAG, "0 (" + string(ceil(get_window_value(AT_DATTACK, 4, AG_WINDOW_LENGTH) * 1.5)) + ")");