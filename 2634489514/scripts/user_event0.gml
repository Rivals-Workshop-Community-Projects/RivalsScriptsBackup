...
[[1,-1],[7, 4, 70, 0, 0, [0, 1544-4*8, 400, 0, 0, 0, 0, 0], [0,13]]], //cell, [room_format]
[11]); //Actions to start on exit
...
//Despawn the dialog if you trigger rykenburn early
action_add(17, 0, 21, ACT.DESPAWN,  
[18], //article_group
[22]); //Actions to start on exit

action_add(17, 0, 22, ACT.KILL,  
[5,6,7,11,12],
[]); //Actions to start on exit
...
dialog_add(7,_i++,["Cleanliness here has gotten down to unacceptable levels."]); //Ryken
...
dialog_add(11,_i++,["But be careful, people disappear during the night..."]); //Mage
...
dialog_add(14,_i++,["This is what you were sent to snuff out? Our chance of reclaiming freedom? Our chance for redemption?"]); //Ryken
...
//3: Supplier Gather
quest_add(3,1,"Food for Thought","Find the missing shipment in the Meadows to the right",asset_get("empty_sprite"));
...
quest_add(5,1,"Inquiry","Find this helper in her home on the right side of town.",asset_get("empty_sprite"));
quest_add(5,2,"The Lacuna Question","Visit Dr Lacuna, who lives next to the shrine on the left side of town.",asset_get("empty_sprite"));
...
//6: Find Laboratory
quest_add(6,1,"Descend into Darkness","Search in the Underground Aqueduct.",asset_get("empty_sprite"));
quest_add(6,2,"Descend into Darkness","Defeat Rykenburn.",asset_get("empty_sprite"));
