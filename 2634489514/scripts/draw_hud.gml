...
if in_speedrun {
	var _speedrun_text = "TIMER: "+string(floor(follow_player.speedrun_timer/60/60))+":"+string(floor(follow_player.speedrun_timer/60) % 60)+":"+string(floor(follow_player.speedrun_timer) % 60);
	
	draw_set_font(asset_get("fName"));
	draw_debug_text(430-floor(string_length(_speedrun_text)/2),12,_speedrun_text); 
}
