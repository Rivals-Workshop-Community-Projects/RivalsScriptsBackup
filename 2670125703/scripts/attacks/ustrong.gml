...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, sound_get("sfx_frenzy_usmash"));
...
set_hitbox_value(AT_USTRONG, 1, HG_MUNO_HITBOX_NAME, "Frenzy Base");
...
set_hitbox_value(AT_USTRONG, 1, HG_KNOCKBACK_SCALING, 0.90);
...
set_hitbox_value(AT_USTRONG, 2, HG_MUNO_HITBOX_NAME, "Frenzy Bite");
