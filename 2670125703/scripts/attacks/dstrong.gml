...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("sfx_cube_dsmash"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_MUNO_HITBOX_NAME, "Normal Pain");
...
set_hitbox_value(AT_DSTRONG, 1, HG_KNOCKBACK_SCALING, 0.80);
set_hitbox_value(AT_DSTRONG, 1, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_DSTRONG, 1, HG_HITPAUSE_SCALING, 0.70);
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, 303);
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sfx_dbfz_hit_medium);
set_hitbox_value(AT_DSTRONG, 1, HG_ANGLE_FLIPPER, 6);

set_hitbox_value(AT_DSTRONG, 2, HG_MUNO_HITBOX_NAME, "Sweet Pain");
...
set_hitbox_value(AT_DSTRONG, 2, HG_KNOCKBACK_SCALING, 0.90);
