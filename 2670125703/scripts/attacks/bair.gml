...
set_hitbox_value(AT_BAIR, 1, HG_HITPAUSE_SCALING, 0.80);
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sfx_dbfz_hit_strong);
...
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, sfx_dbfz_hit_medium);
