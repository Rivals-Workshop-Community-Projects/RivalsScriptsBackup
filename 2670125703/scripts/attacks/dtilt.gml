...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, sfx_dbfz_swipe_weak1);
...
set_hitbox_value(AT_DTILT, 1, HG_ANGLE, 77);
...
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, sfx_dbfz_hit_weak);
