...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_ori_bash_use"));
...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_VSPEED, -5.5);
...
set_window_value(AT_FSPECIAL, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, .7);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_VISUAL_EFFECT, fspecial_hfx)
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_DESTROY_EFFECT, fspecial_hfx)
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, sound_get("glucky_waterhit"));
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("fspecial_proj"))
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_GRAVITY, 0.35);
