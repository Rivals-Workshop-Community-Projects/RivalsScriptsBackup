...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, asset_get("sfx_ori_bash_launch"));
...
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, bubbles_hfx);
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, asset_get("sfx_ori_energyhit_medium"));