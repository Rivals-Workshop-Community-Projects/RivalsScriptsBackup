...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("grenade_pin"));
...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, sound_get("mollo_gunload"));
...
// Holster (Exit Gun Stance)
set_attack_value(AT_EXTRA_1, AG_SPRITE, sprite_get("holster"));
...
set_attack_value(AT_EXTRA_1, AG_AIR_SPRITE, sprite_get("holster_air"));
set_attack_value(AT_EXTRA_1, AG_HURTBOX_SPRITE, sprite_get("holster_hurt"));
set_attack_value(AT_EXTRA_1, AG_HURTBOX_AIR_SPRITE, sprite_get("holster_air_hurt"));
...
set_window_value(AT_EXTRA_1, 3, AG_WINDOW_SFX, sound_get("glucky_gun4"));
