...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_ori_bash_launch"));
...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX, sound_get("mollo_gunload"));
...
set_window_value(AT_USPECIAL, 5, AG_WINDOW_SFX, sound_get("glucky_gun2"));
set_window_value(AT_USPECIAL, 5, AG_WINDOW_SFX_FRAME, 17);
...
set_hitbox_value(AT_USPECIAL, 2, HG_EXTRA_HITPAUSE, 6);
