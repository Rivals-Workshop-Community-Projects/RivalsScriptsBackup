...
set_window_value(AT_DTILT, 4, AG_WINDOW_SFX, sound_get("glucky_gun1"));
...
set_hitbox_value(AT_DTILT, 2, HG_HITBOX_X, 81);
...
set_hitbox_value(AT_DTILT, 2, HG_VISUAL_EFFECT, sweet_hfx);
