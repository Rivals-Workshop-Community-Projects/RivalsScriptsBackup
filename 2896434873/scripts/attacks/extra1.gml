...
set_attack_value(AT_EXTRA_3, AG_SPRITE, sprite_get("flub"));
...
set_attack_value(AT_EXTRA_3, AG_AIR_SPRITE, sprite_get("flub"));
set_attack_value(AT_EXTRA_3, AG_HURTBOX_SPRITE, sprite_get("flub_hurt"));
...
set_window_value(AT_EXTRA_3, 2, AG_WINDOW_SFX, sound_get("glucky_gun1"));