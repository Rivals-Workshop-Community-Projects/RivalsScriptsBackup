...
set_window_value(AT_USTRONG, 1, AG_WINDOW_SFX, sound_get("mollo_gunload"));
...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_ori_bash_use"));
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, bubbles_hfx);
