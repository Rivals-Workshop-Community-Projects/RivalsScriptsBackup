...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sound_get("mollo_gunload"));
...
set_window_value(AT_DAIR, 3, AG_WINDOW_SFX, sound_get("glucky_gun2"));
set_window_value(AT_DAIR, 3, AG_WINDOW_SFX_FRAME, 11);
