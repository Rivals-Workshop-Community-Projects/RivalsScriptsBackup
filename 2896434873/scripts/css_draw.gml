...
else if (alt_new != currAlt)
{
	...
	currAlt = alt_new;
	sound_play(sound_get("grenade_pin"))
}

alt_name[0]  = "Lax Sharpshooter";
alt_name[1]  = "Bitter Cold";
alt_name[2]  = "Blistering Heat";
alt_name[3]  = "Raging Radiant";
alt_name[4]  = "Combo Vortex";
alt_name[5]  = "Dual Spirit";
alt_name[6]  = "Balanced Divide";
alt_name[7]  = "Infinite Spiral";
alt_name[8]  = "Reckless Armament";
alt_name[9]  = "Hidden Horror";
alt_name[10] = "Carpet Bomber";
alt_name[11] = "Full Steam Vengance";
alt_name[12] = "Kindling Wrath";
alt_name[13] = "Squared-Up Shooter";
alt_name[14] = "Phantom Sniper";
alt_name[15] = "Mesmerizing Phantom";
alt_name[16] = "Specular Swindler";
alt_name[17] = "Fowl Play";
alt_name[18] = "False Prestige";
alt_name[19] = "Spawn of Agony";
alt_name[20] = "Ominous Maw";
alt_name[21] = "Transition Period";
alt_name[22] = "Hopeful Night";
alt_name[23] = "Cosmic Sky";
alt_name[24] = "Aquatic Squad";
alt_name[25] = "Rude Buster";
alt_name[26] = "[BIG SHOT]";
alt_name[27] = "Silent Scream";
alt_name[28] = "Fool or Clown";
alt_name[29] = "Marionette";
alt_name[30] = "Drift";
alt_name[31] = "The Infinite One";
...
textDraw(temp_x + 196, temp_y + 30, "fName", c_aqua, 0, 1000, 1, false, 0.6, "v" + patch_ver);
textDraw(temp_x + 200, temp_y + 34, "fName", c_fuchsia, 0, 1000, 1, false, 0.6, "v" + patch_ver);
textDraw(temp_x + 198, temp_y + 32, "fName", c_white, 0, 1000, 1, false, 1, "v" + patch_ver);
