...
set_hitbox_value(AT_FAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, 36);
set_hitbox_value(AT_FAIR, 2, HG_HITSTUN_MULTIPLIER, 1.0);
...
set_hitbox_value(AT_FAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, 36);
set_hitbox_value(AT_FAIR, 1, HG_HITSTUN_MULTIPLIER, 1.0);
