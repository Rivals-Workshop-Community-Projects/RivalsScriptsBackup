...
set_window_value(AT_JAB, 10, AG_WINDOW_LENGTH, 15);
...
set_window_value(AT_JAB, 11, AG_WINDOW_ANIM_FRAME_START, 20);

set_window_value(AT_JAB, 12, AG_WINDOW_LENGTH, 12);
set_window_value(AT_JAB, 12, AG_WINDOW_ANIM_FRAMES, 4);
set_window_value(AT_JAB, 12, AG_WINDOW_ANIM_FRAME_START, 22);
...
set_hitbox_value(AT_JAB, 4, HG_WIDTH, 110);
set_hitbox_value(AT_JAB, 4, HG_HEIGHT, 110);
set_hitbox_value(AT_JAB, 4, HG_PRIORITY, 2);
set_hitbox_value(AT_JAB, 4, HG_DAMAGE, 12);
set_hitbox_value(AT_JAB, 4, HG_ANGLE, 40);
set_hitbox_value(AT_JAB, 4, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_JAB, 4, HG_KNOCKBACK_SCALING, 1.2);
