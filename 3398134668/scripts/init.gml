...
elec_vfx = hit_fx_create(sprite_get("electrichit"),15);
zigzap_vfx = hit_fx_create(sprite_get("zigzap"),15);
proj_trail_vfx = hit_fx_create(sprite_get("proj_trail"),15);
ion_explosion_vfx = hit_fx_create(sprite_get("ion_explosion"),15);
...
// Victory
var victory_theme = sound_get("VictoryThemeAzula");
set_victory_bg(sprite_get("victory_background")); // victory_background.png
set_victory_theme(victory_theme); // victory_theme.ogg
//sound_volume(victory_theme,3,1);
// Movement SFX
