...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("Electric"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_X, 74);
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_Y, -32);
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 89);
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, elec_vfx);
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("ElectricHit"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_KNOCKBACK_SCALING, .5);
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, elec_vfx);
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("ElectricHit"));
...
set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_X, 150);
set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_Y, -32);
set_hitbox_value(AT_DSTRONG, 3, HG_WIDTH, 200);
set_hitbox_value(AT_DSTRONG, 3, HG_HEIGHT, 59);
...
set_hitbox_value(AT_DSTRONG, 3, HG_KNOCKBACK_SCALING, .5);
set_hitbox_value(AT_DSTRONG, 3, HG_BASE_HITPAUSE, 18);
...
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT, elec_vfx);
set_hitbox_value(AT_DSTRONG, 3, HG_HIT_SFX, sound_get("ElectricHit"));
...
set_hitbox_value(AT_DSTRONG, 4, HG_HITBOX_X, -150);
set_hitbox_value(AT_DSTRONG, 4, HG_HITBOX_Y, -32);
set_hitbox_value(AT_DSTRONG, 4, HG_WIDTH, 200);
set_hitbox_value(AT_DSTRONG, 4, HG_HEIGHT, 59);
...
set_hitbox_value(AT_DSTRONG, 4, HG_KNOCKBACK_SCALING, .5);
...
set_hitbox_value(AT_DSTRONG, 4, HG_VISUAL_EFFECT, elec_vfx);
set_hitbox_value(AT_DSTRONG, 4, HG_HIT_SFX, sound_get("ElectricHit"));
