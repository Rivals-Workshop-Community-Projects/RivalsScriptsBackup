...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("Electric"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_KNOCKBACK_SCALING, 0.65);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sound_get("ElectricHit"));
...
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_X, 280);
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_Y, -35);
set_hitbox_value(AT_FSTRONG, 2, HG_WIDTH, 420);
...
set_hitbox_value(AT_FSTRONG, 2, HG_KNOCKBACK_SCALING, 0.65);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, sound_get("ElectricHit"));
