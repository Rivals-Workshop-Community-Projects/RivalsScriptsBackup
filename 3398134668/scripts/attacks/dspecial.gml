...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, sound_get("Spark"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_VISUAL_EFFECT, elec_vfx);
set_hitbox_value(AT_DSPECIAL, 1, HG_HIT_SFX, sound_get("ElectricHit"));
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HITBOX_Y, -05);
set_hitbox_value(AT_DSPECIAL, 2, HG_WIDTH, 56);
set_hitbox_value(AT_DSPECIAL, 2, HG_HEIGHT, 22);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_VISUAL_EFFECT, elec_vfx);
set_hitbox_value(AT_DSPECIAL, 2, HG_HIT_SFX, sound_get("ElectricHit"));
