...
set_hitbox_value(AT_BAIR, 3, HG_HIT_SFX, sound_get("ElectricHit"));
...
set_hitbox_value(AT_BAIR, 4, HG_BASE_KNOCKBACK, 11);
...
set_hitbox_value(AT_BAIR, 4, HG_HIT_SFX, sound_get("ElectricHit"));
