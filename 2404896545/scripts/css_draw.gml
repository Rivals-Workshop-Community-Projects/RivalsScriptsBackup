...
if (!variable_instance_exists(id,"ae") || ye == true){
    ...
    //--- ---
    altsel = sound_get("one4"); // change the alt select sound here. if you don't want to change the sound, put 0 here.
    color_desc_activate = false; // optional "alt color description button". set to "true" to turn it on.
    
    col_max = 7; // number of alternate color palettes. 0 is the default color, count it accordingly.
    
    //first array index is for alternate color. second array index is for distinguishing the information in it.
    ce[0,0] = make_color_rgb(239, 239, 239) // "color preview square" color. can be any color!
    ce[0,1] = "ComProject 0377b" // the name of the alternate color.
    ce[0,2] = "Beleive it or not, it's difficult to come up with creative color names when there's no references." // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    ce[1,0] = make_color_rgb(186, 209, 255)
    ce[1,1] = "Blue"
    ce[1,2] = ""
    ce[2,0] = make_color_rgb(255, 216, 209)
    ce[2,1] = "Pink"
    ce[2,2] = ""
    ce[3,0] = make_color_rgb(157, 201, 155)
    ce[3,1] = "Green"
    ce[3,2] = ""
    ce[4,0] = make_color_rgb(163, 163, 163)
    ce[4,1] = "Black"
    ce[4,2] = ""
    ce[5,0] = make_color_rgb(255, 223, 179)
    ce[5,1] = "Yellow"
    ce[5,2] = ""
    ce[6,0] = make_color_rgb(226, 176, 255)
    ce[6,1] = "Purple"
    ce[6,2] = ""
    ...
    ce[7,2] = ""
    /*
    ce[8,0] = make_color_rgb(229, 229, 229)
    ce[8,1] = "White"
    ce[8,2] = "The helpful friend from Yoshi's Story!"
    ce[9,0] = make_color_rgb(53, 71, 191)
    ce[9,1] = "Dark Blue"
