...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, sound_get("two3"));
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, asset_get("sfx_absa_new_whip1"));
...
set_hitbox_value(AT_FTILT, 2, HG_HITPAUSE_SCALING, .75);
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, asset_get("sfx_absa_new_whip1"));