...
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, sound_get("two2"));
...
set_window_value(AT_JAB, 3, AG_WINDOW_HAS_WHIFFLAG, 7);
...
set_window_value(AT_JAB, 4, AG_WINDOW_SFX, sound_get("two1"));
...
set_window_value(AT_JAB, 6, AG_WINDOW_HAS_WHIFFLAG, 2);
...
set_hitbox_value(AT_JAB, 1, HG_HITPAUSE_SCALING, .01);
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, asset_get("sfx_orca_bite"));
...
set_hitbox_value(AT_JAB, 2, HG_BASE_KNOCKBACK, 8.2)
set_hitbox_value(AT_JAB, 2, HG_KNOCKBACK_SCALING, 0.55)
...
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, asset_get("sfx_orca_bite"));
...
set_hitbox_value(AT_JAB, 3, HG_HITPAUSE_SCALING, .01);
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, asset_get("sfx_orca_bite"));
...
set_hitbox_value(AT_JAB, 4, HG_KNOCKBACK_SCALING, 0.45)
...
set_hitbox_value(AT_JAB, 4, HG_VISUAL_EFFECT_Y_OFFSET, -16);
set_hitbox_value(AT_JAB, 4, HG_HIT_SFX, asset_get("sfx_orca_bite"));
