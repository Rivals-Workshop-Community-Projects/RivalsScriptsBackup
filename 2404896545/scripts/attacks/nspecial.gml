...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("one1"));
...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, sound_get("two2"));
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_HAS_WHIFFLAG, 5);
