...
set_hitbox_value(AT_BAIR, 4, HG_KNOCKBACK_SCALING, 0.9);
...
set_hitbox_value(AT_BAIR, 5, HG_HITBOX_X, -70);
set_hitbox_value(AT_BAIR, 5, HG_HITBOX_Y, -50);
set_hitbox_value(AT_BAIR, 5, HG_WIDTH, 65);
...
set_hitbox_value(AT_BAIR, 6, HG_HITBOX_X, -80);
set_hitbox_value(AT_BAIR, 6, HG_HITBOX_Y, -50);
set_hitbox_value(AT_BAIR, 6, HG_WIDTH, 100);
...
set_hitbox_value(AT_BAIR, 7, HG_ANGLE, 45);
set_hitbox_value(AT_BAIR, 7, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_BAIR, 7, HG_KNOCKBACK_SCALING, 0.8);
set_hitbox_value(AT_BAIR, 7, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_BAIR, 7, HG_HITPAUSE_SCALING, .8);
