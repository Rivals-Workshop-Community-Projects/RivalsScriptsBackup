...
set_attack_value(AT_NAIR, AG_LANDING_LAG, 14);
...
set_hitbox_value(AT_NAIR, 1, HG_WINDOW, 20);
set_hitbox_value(AT_NAIR, 1, HG_LIFETIME, 3);
set_hitbox_value(AT_NAIR, 1, HG_HITBOX_X, 2);
set_hitbox_value(AT_NAIR, 1, HG_HITBOX_Y, -50);
set_hitbox_value(AT_NAIR, 1, HG_WIDTH, 155);
set_hitbox_value(AT_NAIR, 1, HG_HEIGHT, 155);
...
set_hitbox_value(AT_NAIR, 2, HG_HITSTUN_MULTIPLIER, .75);
