...
set_window_value(AT_DTILT, 2, AG_WINDOW_HSPEED, 9.5);
...
set_window_value(AT_DTILT, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .25);
...
set_window_value(AT_DTILT, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .7);
...
set_window_value(AT_DTILT, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, .5);
...
set_hitbox_value(AT_DTILT, 2, HG_WIDTH, 65);
