...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, asset_get("sfx_ori_stomp_spin"));
...
set_window_value(AT_DTILT, 2, AG_WINDOW_HAS_SFX, 0);
...
set_window_value(AT_DTILT, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .05);
