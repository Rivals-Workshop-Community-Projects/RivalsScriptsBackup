...
set_attack_value(AT_DSPECIAL, AG_HURTBOX_SPRITE, sprite_get("beegguy_hurt"));
...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX, sound_get("smw_yoshi_tongue"));
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_SFX, sound_get("smw_yoshi_swallow_no_coin"));
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_SFX, sound_get("smrpg_battle_vigorup"));
