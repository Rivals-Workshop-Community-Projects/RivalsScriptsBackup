...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, sound_get("smw_yoshi_tongue"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, sound_get("eat"));
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("tonguetip"));
