set_attack_value(AT_TAUNT_2, AG_SPRITE, sprite_get("taunt_sakk"));
...
set_window_value(AT_TAUNT_2, 1, AG_WINDOW_SFX, sound_get("smrpg_item"));
...
set_window_value(AT_TAUNT_2, 2, AG_WINDOW_SFX, asset_get("sfx_land_heavy"));
set_window_value(AT_TAUNT_2, 2, AG_WINDOW_SFX_FRAME, 7);
...
set_window_value(AT_TAUNT_2, 4, AG_WINDOW_LENGTH, 28);
...
set_window_value(AT_TAUNT_2, 5, AG_WINDOW_LENGTH, 3);
