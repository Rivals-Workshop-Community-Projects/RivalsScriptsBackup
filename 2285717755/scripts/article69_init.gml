...
bg_chars[0].x = get_marker_x(1);
bg_chars[0].y = get_marker_y(1);

bg_chars[1].x = get_marker_x(2);
bg_chars[1].y = get_marker_y(2);

bg_chars[2].x = get_marker_x(3);
bg_chars[2].y = get_marker_y(3);

bg_chars[3].x = get_marker_x(4);
bg_chars[3].y = get_marker_y(4);
