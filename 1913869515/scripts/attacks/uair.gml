...
set_hitbox_value(AT_UAIR, 4, HG_LIFETIME, 180);
set_hitbox_value(AT_UAIR, 4, HG_HITBOX_X, 10);
set_hitbox_value(AT_UAIR, 4, HG_HITBOX_Y, -36);
...
set_hitbox_value(AT_UAIR, 4, HG_PROJECTILE_SPRITE, sprite_get("eblade"));
set_hitbox_value(AT_UAIR, 4, HG_PROJECTILE_AIR_FRICTION, 0);
set_hitbox_value(AT_UAIR, 4, HG_PROJECTILE_HSPEED, 0);
set_hitbox_value(AT_UAIR, 4, HG_PROJECTILE_VSPEED, 0);
...
set_hitbox_value(AT_UAIR, 4, HG_WIDTH, 0);
set_hitbox_value(AT_UAIR, 4, HG_HEIGHT, 0);
