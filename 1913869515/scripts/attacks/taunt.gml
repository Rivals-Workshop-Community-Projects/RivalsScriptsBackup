...
set_hitbox_value(AT_TAUNT, 12, HG_VISUAL_EFFECT, 14);
...
set_hitbox_value(AT_TAUNT, 12, HG_ANGLE, 270);
set_hitbox_value(AT_TAUNT, 12, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_TAUNT, 12, HG_KNOCKBACK_SCALING, .8);
set_hitbox_value(AT_TAUNT, 12, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_TAUNT, 12, HG_HITPAUSE_SCALING, 0.8);
set_hitbox_value(AT_TAUNT, 12, HG_HIT_SFX, asset_get("sfx_blow_medium2"));
