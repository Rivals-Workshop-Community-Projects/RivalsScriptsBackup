...
set_hitbox_value(AT_DATTACK, 4, HG_HITBOX_X, 62);
set_hitbox_value(AT_DATTACK, 4, HG_HITBOX_Y, -32);
set_hitbox_value(AT_DATTACK, 4, HG_WIDTH, 96);
set_hitbox_value(AT_DATTACK, 4, HG_HEIGHT, 19);
...
set_hitbox_value(AT_DATTACK, 4, HG_HIT_SFX, sound_get("slicel"));
