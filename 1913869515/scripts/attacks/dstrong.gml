...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_HSPEED, -16);
...
set_hitbox_value(AT_DSTRONG, 4, HG_BASE_HITPAUSE, 25);
set_hitbox_value(AT_DSTRONG, 4, HG_HITPAUSE_SCALING, 1.9);
