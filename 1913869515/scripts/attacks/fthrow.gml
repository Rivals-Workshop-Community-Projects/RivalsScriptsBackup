...
set_hitbox_value(AT_FTHROW, 1, HG_WIDTH, 116);
set_hitbox_value(AT_FTHROW, 1, HG_HEIGHT, 116);
...
set_hitbox_value(AT_FTHROW, 1, HG_HITPAUSE_SCALING, 0.25);
...
set_hitbox_value(AT_FTHROW, 3, HG_HITPAUSE_SCALING, 0.25);
...
set_hitbox_value(AT_FTHROW, 3, HG_HITSTUN_MULTIPLIER, 0.8);
...
set_hitbox_value(AT_FTHROW, 2, HG_HITSTUN_MULTIPLIER, 0.8);
