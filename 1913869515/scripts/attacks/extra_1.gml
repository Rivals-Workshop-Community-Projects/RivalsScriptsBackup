...
set_hitbox_value(AT_EXTRA_1, 3, HG_WINDOW_CREATION_FRAME, 13);
set_hitbox_value(AT_EXTRA_1, 3, HG_LIFETIME, 5);
set_hitbox_value(AT_EXTRA_1, 3, HG_HITBOX_X, 133);
set_hitbox_value(AT_EXTRA_1, 3, HG_HITBOX_Y, -41);
set_hitbox_value(AT_EXTRA_1, 3, HG_WIDTH, 246);
set_hitbox_value(AT_EXTRA_1, 3, HG_HEIGHT, 124);
...
set_hitbox_value(AT_EXTRA_1, 3, HG_KNOCKBACK_SCALING, 0.3);
set_hitbox_value(AT_EXTRA_1, 3, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_EXTRA_1, 3, HG_EXTRA_HITPAUSE, 8);
set_hitbox_value(AT_EXTRA_1, 3, HG_HITPAUSE_SCALING, 0.2);
set_hitbox_value(AT_EXTRA_1, 3, HG_VISUAL_EFFECT_X_OFFSET, 16);
...
set_hitbox_value(AT_EXTRA_1, 3, HG_HIT_LOCKOUT, 10);
...
set_hitbox_value(AT_EXTRA_1, 2, HG_HEIGHT, 85);
