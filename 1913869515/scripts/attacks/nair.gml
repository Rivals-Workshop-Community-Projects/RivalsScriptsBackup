...
set_window_value(AT_NAIR, 7, AG_WINDOW_ANIM_FRAME_START, 5);
...
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, sound_get("slicel"));
...
set_hitbox_value(AT_NAIR, 4, HG_HIT_SFX, sound_get("slicel"));
...
set_hitbox_value(AT_NAIR, 5, HG_HIT_SFX, sound_get("slice"));
