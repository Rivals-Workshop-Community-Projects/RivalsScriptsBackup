...
set_window_value(AT_UTHROW, 2, AG_WINDOW_SFX, sound_get("RCE"));
...
set_hitbox_value(AT_UTHROW, 1, HG_WIDTH, 420);
set_hitbox_value(AT_UTHROW, 1, HG_HEIGHT, 420);
...
set_hitbox_value(AT_UTHROW, 3, HG_WIDTH, 420);
set_hitbox_value(AT_UTHROW, 3, HG_HEIGHT, 420);
set_hitbox_value(AT_UTHROW, 3, HG_SHAPE, 0);
set_hitbox_value(AT_UTHROW, 3, HG_PRIORITY, 3);
set_hitbox_value(AT_UTHROW, 3, HG_DAMAGE, 20);
...
set_hitbox_value(AT_UTHROW, 3, HG_KNOCKBACK_SCALING, 0.9);
set_hitbox_value(AT_UTHROW, 3, HG_BASE_HITPAUSE, 1);
set_hitbox_value(AT_UTHROW, 3, HG_EXTRA_HITPAUSE, 15);
...
set_hitbox_value(AT_UTHROW, 2, HG_HITBOX_Y, -20);
set_hitbox_value(AT_UTHROW, 2, HG_WIDTH, 408);
set_hitbox_value(AT_UTHROW, 2, HG_HEIGHT, 408);
set_hitbox_value(AT_UTHROW, 2, HG_SHAPE, 0);
set_hitbox_value(AT_UTHROW, 2, HG_PRIORITY, 3);
set_hitbox_value(AT_UTHROW, 2, HG_DAMAGE, 10);
...
set_hitbox_value(AT_UTHROW, 2, HG_KNOCKBACK_SCALING, 0.1);
set_hitbox_value(AT_UTHROW, 2, HG_BASE_HITPAUSE, 1);
set_hitbox_value(AT_UTHROW, 2, HG_EXTRA_HITPAUSE, 12);
set_hitbox_value(AT_UTHROW, 2, HG_HIT_LOCKOUT, 20);
set_hitbox_value(AT_UTHROW, 2, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_UTHROW, 2, HG_HITSTUN_MULTIPLIER, .6);
set_hitbox_value(AT_UTHROW, 2, HG_VISUAL_EFFECT, 1 );
set_hitbox_value(AT_UTHROW, 2, HG_HIT_SFX, sound_get("slice"));
