...
set_window_value(AT_DAIR, 2, AG_WINDOW_SFX, sound_get("dair"));
...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, 21);
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, asset_get("sfx_abyss_hazard_hit"));
