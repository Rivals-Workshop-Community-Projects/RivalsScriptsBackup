...
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT, 254);
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, -14);
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, -14);
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, asset_get("sfx_buzzsaw_hit"));
set_hitbox_value(AT_NAIR, 1, HG_IGNORES_PROJECTILES, 0);
set_hitbox_value(AT_NAIR, 1, HG_THROWS_ROCK, 0);
