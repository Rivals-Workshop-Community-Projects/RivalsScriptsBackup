set_attack_value(AT_FSTRONG, AG_SPRITE, sprite_get("fstrong1"));
...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, sound_get("treble"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_WINDOW_CREATION_FRAME, 15);
...
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, 67);
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, asset_get("sfx_ell_fist_explode"));
