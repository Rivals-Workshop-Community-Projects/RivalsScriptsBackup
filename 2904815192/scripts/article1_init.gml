...
incWidthDetection = (player_id.propertyWidthRune * 18);
if (!player_id.propertyWidthRune){ // no rune
	spr_idle = sprite_get("property_idle");
	spr_attack = sprite_get("property_attack");
	spr_hudRecolor = sprite_get("property_hud_color_draw");
} else if (player_id.propertyWidthRune){ // rune
	spr_idle = sprite_get("property_idle_rune");
	spr_attack = sprite_get("property_attack_rune");
	spr_hudRecolor = sprite_get("property_hud_color_draw_rune");
}
