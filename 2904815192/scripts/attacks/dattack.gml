...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sfx_monopoly_pc_taxi_move);
...
set_window_value(AT_DATTACK, 4, AG_WINDOW_SFX, asset_get("sfx_propeller_dagger_release"));
...
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT, money_hit_fx_lrg);
...
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT, money_hit_fx_sml);
