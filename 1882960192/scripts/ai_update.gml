...
if (get_training_cpu_action() == CPU_FIGHT && temp_level > 5) {
...
if attack = AT_DSPECIAL and window = 6 and window_timer > 7 {
...
if xdist > 250 and can_special and !ai_recovering and 55 > wblastcharge {
	joy_pad_idle = true;
    left_down = false;
    right_down = false;
	down_down = false;
