...
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .95);
...
set_hitbox_value(AT_DATTACK, 2, HG_ANGLE, 48);
...
set_hitbox_value(AT_DATTACK, 2, HG_HITPAUSE_SCALING, .05);
