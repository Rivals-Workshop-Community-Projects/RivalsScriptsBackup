...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_LIFETIME, 130);
...
set_hitbox_value(AT_FSPECIAL_2, 3, HG_KNOCKBACK_SCALING, .55);
...
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HITSTUN_MULTIPLIER, .7);
