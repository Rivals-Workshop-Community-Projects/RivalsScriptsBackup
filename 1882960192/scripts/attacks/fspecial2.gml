...
set_window_value(AT_FSPECIAL_2, 3, AG_WINDOW_SFX, sound_get("hammer-swing"));
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HEIGHT, 86);
...
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HITBOX_X, 33);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HITBOX_Y, -88);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_WIDTH, 30);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HEIGHT, 20);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_PRIORITY, 9);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_DAMAGE, 15);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_ANGLE, 90);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_BASE_KNOCKBACK, 9);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_KNOCKBACK_SCALING, 1.15);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_EXTRA_HITPAUSE, 20);
...
set_hitbox_value(AT_FSPECIAL_2, 3, HG_VISUAL_EFFECT, 112);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_IGNORES_PROJECTILES, 1);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_THROWS_ROCK, 0);
...
set_hitbox_value(AT_FSPECIAL_2, 2, HG_HITBOX_Y, -48);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_WIDTH, 70);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_SHAPE, 1);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_HEIGHT, 96);
