...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_ell_dspecial_explosion_1"));
...
set_window_value(AT_DSPECIAL, 5, AG_WINDOW_SFX, asset_get("sfx_jumpground"));
...
set_window_value(AT_DSPECIAL, 6, AG_WINDOW_CUSTOM_AIR_FRICTION, .005);
...
set_window_value(AT_DSPECIAL, 7, AG_WINDOW_CUSTOM_AIR_FRICTION, .15);
set_window_value(AT_DSPECIAL, 7, AG_WINDOW_CUSTOM_GROUND_FRICTION, .4);
