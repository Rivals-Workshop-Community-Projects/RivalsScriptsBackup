...
set_attack_value(AT_DSPECIAL, AG_OFF_LEDGE, true);
...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, sound_get("ballappear"));
...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX, sound_get("ghook-shoot"));
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_SFX, sound_get("ghook-fly"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HEIGHT, 26);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("dspecial_hook"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_PROJECTILE_GRAVITY, .015);
set_hitbox_value(AT_DSPECIAL, 1, HG_PROJECTILE_AIR_FRICTION, .35);
