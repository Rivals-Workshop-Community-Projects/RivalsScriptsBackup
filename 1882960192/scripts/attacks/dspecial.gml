...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_HSPEED, 26);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HITBOX_X, 86);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_FINAL_BASE_KNOCKBACK, 4);
