...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_HSPEED, 18);
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_VSPEED_TYPE, 1);
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .55);
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, .55);
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, .85);
...
set_window_value(AT_DSPECIAL, 5, AG_WINDOW_CUSTOM_AIR_FRICTION, .95);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HIT_SFX, sound_get("sword-hit1"));
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HIT_SFX, sound_get("sword-hit2"));
...
set_hitbox_value(AT_DSPECIAL, 3, HG_HIT_SFX, sound_get("sword-hit3"));