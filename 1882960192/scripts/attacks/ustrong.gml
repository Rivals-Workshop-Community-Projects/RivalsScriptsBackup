...
set_window_value(AT_USTRONG, 4, AG_WINDOW_SFX, asset_get("sfx_absa_new_whip1"));
...
set_window_value(AT_USTRONG, 5, AG_WINDOW_SFX, asset_get("sfx_absa_new_whip1"));
...
set_window_value(AT_USTRONG, 6, AG_WINDOW_SFX, asset_get("sfx_absa_new_whip1"));
...
set_hitbox_value(AT_USTRONG, 4, HG_KNOCKBACK_SCALING, 1.12);
...
set_hitbox_value(AT_USTRONG, 4, HG_HIT_SFX, asset_get("sfx_clairen_tip_med"));
