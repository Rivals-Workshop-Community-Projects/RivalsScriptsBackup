...
set_attack_value(AT_DSPECIAL_2, AG_OFF_LEDGE, true);
...
set_window_value(AT_DSPECIAL_2, 1, AG_WINDOW_SFX, sound_get("ballappear"));
...
set_window_value(AT_DSPECIAL_2, 2, AG_WINDOW_SFX, sound_get("ghook-shoot"));
...
set_window_value(AT_DSPECIAL_2, 3, AG_WINDOW_SFX, sound_get("ghook-fly"));
set_window_value(AT_DSPECIAL_2, 3, AG_WINDOW_SFX_FRAME, 1);

//loop while hook is out
...
//endlag (failed to catch anything)
...
set_window_value(AT_DSPECIAL_2, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, 2);
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_VISUAL_EFFECT, 112);
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HIT_SFX, asset_get("sfx_ori_sein_fstrong_hit"));
set_hitbox_value(AT_DSPECIAL_2, 1, HG_PROJECTILE_SPRITE, sprite_get("dspecial_hook"));
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_PROJECTILE_HSPEED, 22);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_PROJECTILE_AIR_FRICTION, .5);
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_IGNORES_PROJECTILES, true);