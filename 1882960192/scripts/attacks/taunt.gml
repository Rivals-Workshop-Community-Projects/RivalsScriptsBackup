...
set_window_value(AT_TAUNT_2, 2, AG_WINDOW_SFX,asset_get("sfx_forsburn_cape_swipe"));
...
set_window_value(AT_TAUNT_2, 5, AG_WINDOW_SFX, asset_get("sfx_shop_close"));
...
set_window_value(AT_TAUNT_2, 7, AG_WINDOW_LENGTH, 7);
