...
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX, asset_get("sfx_shovel_swing_med1"));
...
set_window_value(AT_TAUNT, 2, AG_WINDOW_SFX,asset_get("sfx_shop_invalid"));
...
set_hitbox_value(AT_TAUNT, 1, HG_WINDOW_CREATION_FRAME, 8);
set_hitbox_value(AT_TAUNT, 1, HG_LIFETIME, 1);
set_hitbox_value(AT_TAUNT, 1, HG_HITBOX_X, -36);
...
set_hitbox_value(AT_TAUNT, 1, HG_PRIORITY, 5);
...
set_hitbox_value(AT_TAUNT, 1, HG_HITPAUSE_SCALING, .15);
