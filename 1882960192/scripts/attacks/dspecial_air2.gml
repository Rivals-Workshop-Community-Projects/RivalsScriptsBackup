...
set_window_value(AT_DTHROW, 2, AG_WINDOW_SFX, sound_get("magicshoot4"));
...
set_window_value(AT_DTHROW, 3, AG_WINDOW_VSPEED, 29);
...
set_hitbox_value(AT_DTHROW, 3, HG_ANGLE, 50);
...
set_hitbox_value(AT_DTHROW, 4, HG_ANGLE, 50);
...
set_hitbox_value(AT_DTHROW, 9, HG_ANGLE, 90);
