...
set_window_value(AT_UAIR, 3, AG_WINDOW_SFX, asset_get("sfx_ori_glide_featherout"));
...
set_window_value(AT_UAIR, 6, AG_WINDOW_ANIM_FRAME_START, 17);
set_window_value(AT_UAIR, 6, AG_WINDOW_HAS_WHIFFLAG, 1);

set_window_value(AT_UAIR, 7, AG_WINDOW_TYPE, 1);
set_window_value(AT_UAIR, 7, AG_WINDOW_LENGTH, 54);
set_window_value(AT_UAIR, 7, AG_WINDOW_ANIM_FRAMES, 9);
set_window_value(AT_UAIR, 7, AG_WINDOW_ANIM_FRAME_START, 8);
set_window_value(AT_UAIR, 7, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_UAIR, 7, AG_WINDOW_CUSTOM_AIR_FRICTION, 0);
...
set_hitbox_value(AT_UAIR, 1, HG_HITPAUSE_SCALING, .15);
...
set_hitbox_value(AT_UAIR, 2, HG_HITBOX_Y, -106);
...
set_hitbox_value(AT_UAIR, 2, HG_HIT_LOCKOUT, 12);
...
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, asset_get("sfx_ori_glide_hit"));
...
set_hitbox_value(AT_UAIR, 3, HG_HITBOX_Y, -106);
set_hitbox_value(AT_UAIR, 3, HG_SHAPE, 0);
set_hitbox_value(AT_UAIR, 3, HG_WIDTH, 76);
set_hitbox_value(AT_UAIR, 3, HG_HEIGHT, 38);
...
set_hitbox_value(AT_UAIR, 4, HG_HITBOX_Y, -102);
