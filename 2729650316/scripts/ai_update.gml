...
usmashpercent = (2 - ai_target.knockback_adj) * 50
fsmashpercent = (2 - ai_target.knockback_adj) * 95
dsmashpercent = (2 - ai_target.knockback_adj) * 80
uspecialpercent = (2 - ai_target.knockback_adj) * 75
bairpercent = (2 - ai_target.knockback_adj) * 40
...
if !free and can_attack and 0 > AIwait{
    ...
    if 80 > ydist and 10 > xdist{ // Utilt
        clear_button_buffer( PC_ATTACK_PRESSED );
        joy_pad_idle = true;
        left_down = false;
        right_down = false;
	...
	if 40 > ydist and 50 > xdist and facing{ // Dtilt
        clear_button_buffer( PC_ATTACK_PRESSED );
        joy_pad_idle = true;
        left_down = false;
        right_down = false;
