...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_LENGTH, 12);//5
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_LENGTH, 14);//12
...
set_hitbox_value(AT_FSTRONG, 2, HG_BASE_KNOCKBACK, 8);//9
