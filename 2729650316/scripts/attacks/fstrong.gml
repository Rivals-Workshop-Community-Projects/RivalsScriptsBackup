...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_LENGTH, 8);//5
set_window_value(AT_FSTRONG, 1, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_FSTRONG, 1, AG_WINDOW_ANIM_FRAME_START, 5);
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_LENGTH, 16);//12
...
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_X, 29);
...
set_hitbox_value(AT_FSTRONG, 2, HG_BASE_KNOCKBACK, 6);//9
