...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_LENGTH, 10);//4
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_LENGTH, 15);//10
...
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 69);
...
set_hitbox_value(AT_DSTRONG, 2, HG_BASE_KNOCKBACK, 8.5);//9
set_hitbox_value(AT_DSTRONG, 2, HG_KNOCKBACK_SCALING, .8);
set_hitbox_value(AT_DSTRONG, 2, HG_EXTRA_HITPAUSE, 6);
