...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_burnapplied"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_EFFECT, 1917713379);
set_hitbox_value(AT_FSPECIAL, 1, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_FSPECIAL, 1, HG_KNOCKBACK_SCALING, 0);
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT, seal_hit_weak_hurt);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("fspecial_proj_hurt"));
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, fspecial_dead);
