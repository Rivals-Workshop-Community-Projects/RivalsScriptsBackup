...
set_hitbox_value(AT_USTRONG, 1, HG_EFFECT, 1917713380);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT,  seal_hit_large_heal);
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, -45);
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, asset_get("sfx_blow_heavy1"))

set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_TYPE, 1); //Fuck you presentation team
...
set_hitbox_value(AT_USTRONG, 2, HG_EFFECT, 1917713380);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT,  seal_hit_large_heal);
