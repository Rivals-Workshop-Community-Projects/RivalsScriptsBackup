...
set_hitbox_value(AT_UTILT, 1, HG_KNOCKBACK_SCALING, .40);
...
set_hitbox_value(AT_UTILT, 2, HG_KNOCKBACK_SCALING, .40);
...
set_hitbox_value(AT_UTILT, 3, HG_KNOCKBACK_SCALING, .40);
