...
yi_codec_data = [
    ...
    msg("yi", 0, 2, "Yes, in the Limitless Realm. Apparently, she somehow attuned to the Primordial Roots."),
    ...
    msg("yi", 0, 37, "To turn stubbornness into power... it beggars belief."),
