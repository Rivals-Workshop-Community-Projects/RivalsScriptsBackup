...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("tee_swing2"));
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, sound_get("tee_swing1"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("tee_punch_med"));
set_hitbox_value(AT_DSTRONG, 1, HG_ANGLE_FLIPPER, 0);
set_hitbox_value(AT_DSTRONG, 1, HG_HITSTUN_MULTIPLIER, 1.0);
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, fx_angle);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("tee_punch_med"));
set_hitbox_value(AT_DSTRONG, 2, HG_ANGLE_FLIPPER, 0);
set_hitbox_value(AT_DSTRONG, 2, HG_HITSTUN_MULTIPLIER, 1.0);
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, fx_angle);