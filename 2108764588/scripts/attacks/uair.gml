...
set_window_value(AT_UAIR, 1, AG_WINDOW_HSPEED, 1);
set_window_value(AT_UAIR, 1, AG_WINDOW_VSPEED, -1);
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, asset_get("sfx_swipe_weak2"));
//set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, asset_get("sfx_ice_shatter_big"));
...
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, asset_get("sfx_icehit_weak2"));
