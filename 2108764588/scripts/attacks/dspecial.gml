...
set_attack_value(AT_DSPECIAL, AG_HURTBOX_SPRITE, asset_get("ex_guy_hurt_box"));//sprite_get("uair_hurt"));
...
set_attack_value(AT_DSPECIAL, AG_CATEGORY, 2);
set_attack_value(AT_DSPECIAL, AG_SPRITE, sprite_get("dspecial_test"));
...
set_attack_value(AT_DSPECIAL, AG_HURTBOX_SPRITE, sprite_get("dspecial_test_hurt"));
//set_attack_value(AT_DSPECIAL, AG_USES_CUSTOM_GRAVITY, 1);

set_window_value(AT_DSPECIAL, 1, AG_WINDOW_LENGTH, 50);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HITBOX_Y, -6);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HITBOX_Y, -6);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HIT_SFX, asset_get("sfx_icehit_medium1"));
...
set_hitbox_value(AT_DSPECIAL, 3, HG_HITBOX_X, 22);
set_hitbox_value(AT_DSPECIAL, 3, HG_HITBOX_Y, -14);
set_hitbox_value(AT_DSPECIAL, 3, HG_WIDTH, 25);
set_hitbox_value(AT_DSPECIAL, 3, HG_HEIGHT, 25);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_HIT_SFX, asset_get("sfx_icehit_heavy1"));
...
set_hitbox_value(AT_DSPECIAL, 4, HG_LIFETIME, 17);
set_hitbox_value(AT_DSPECIAL, 4, HG_SHAPE, 0);
set_hitbox_value(AT_DSPECIAL, 4, HG_HITBOX_X, 22);
set_hitbox_value(AT_DSPECIAL, 4, HG_HITBOX_Y, -14);
set_hitbox_value(AT_DSPECIAL, 4, HG_WIDTH, 25);
set_hitbox_value(AT_DSPECIAL, 4, HG_HEIGHT, 25);
...
set_hitbox_value(AT_DSPECIAL, 4, HG_HIT_SFX, asset_get("sfx_icehit_medium2"));
