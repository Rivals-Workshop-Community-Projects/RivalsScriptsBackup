...
set_window_value(AT_NAIR, 1, AG_WINDOW_LENGTH, 6);//5
...
set_hitbox_value(AT_NAIR, 1, HG_WIDTH, 78);//95
set_hitbox_value(AT_NAIR, 1, HG_HEIGHT, 78);//95
...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sound_get("hit_med_5"));
...
set_hitbox_value(AT_NAIR, 2, HG_WIDTH, 70);//78
set_hitbox_value(AT_NAIR, 2, HG_HEIGHT, 70);//78
...
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, sound_get("hit_med_5"));
