...
set_hitbox_value(AT_FSTRONG, 1, HG_DAMAGE, 13);//12
...
set_hitbox_value(AT_FSTRONG, 1, HG_KNOCKBACK_SCALING, 1.0);//0.8//0.85
...
set_hitbox_value(AT_FSTRONG, 5, HG_HITPAUSE_SCALING, 0.5);//0.25
