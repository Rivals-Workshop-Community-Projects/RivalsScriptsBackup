...
set_hitbox_value(AT_DAIR, 2, HG_BASE_HITPAUSE, 7);//6
...
set_hitbox_value(AT_DAIR, 3, HG_BASE_HITPAUSE, 6);//5
...
set_hitbox_value(AT_DAIR, 4, HG_BASE_HITPAUSE, 6);//5
