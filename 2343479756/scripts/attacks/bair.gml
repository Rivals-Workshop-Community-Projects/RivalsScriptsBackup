...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("swing_med_3"));
...
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 39);
set_hitbox_value(AT_BAIR, 1, HG_DAMAGE, 8);
set_hitbox_value(AT_BAIR, 1, HG_ANGLE, 135);//55//50
//set_hitbox_value(AT_BAIR, 1, HG_ANGLE_FLIPPER, 5);
set_hitbox_value(AT_BAIR, 1, HG_PRIORITY, 2);
set_hitbox_value(AT_BAIR, 1, HG_BASE_KNOCKBACK, 8);//7
set_hitbox_value(AT_BAIR, 1, HG_FINAL_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_BAIR, 1, HG_KNOCKBACK_SCALING, 0.75);//0.7
set_hitbox_value(AT_BAIR, 1, HG_BASE_HITPAUSE, 9);//9
set_hitbox_value(AT_BAIR, 1, HG_HITPAUSE_SCALING, 0.7);//4//6
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("hit_med_1"));

//sour
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_BAIR, 2, HG_WINDOW, 2);
set_hitbox_value(AT_BAIR, 2, HG_LIFETIME, 7);
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_X, -3);
...
set_hitbox_value(AT_BAIR, 2, HG_HITPAUSE_SCALING, 0.5);//4
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT, 302);
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, sound_get("hit_gen_2"));
