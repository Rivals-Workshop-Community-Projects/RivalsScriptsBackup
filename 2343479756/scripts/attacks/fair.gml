...
set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, sound_get("swing_weak_4"));
...
set_window_value(AT_FAIR, 3, AG_WINDOW_SFX, sound_get("swing_med_4"));
...
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, sound_get("hit_weak_6"));
...
set_hitbox_value(AT_FAIR, 2, HG_WIDTH, 57);
...
set_hitbox_value(AT_FAIR, 2, HG_HIT_SFX, sound_get("hit_med_4"));
