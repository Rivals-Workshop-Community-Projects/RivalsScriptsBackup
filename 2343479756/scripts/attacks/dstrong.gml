...
set_hitbox_value(AT_DSTRONG, 1, HG_ANGLE, 55);//65//80
set_hitbox_value(AT_DSTRONG, 1, HG_PRIORITY, 1);
set_hitbox_value(AT_DSTRONG, 1, HG_BASE_KNOCKBACK, 6);//6
set_hitbox_value(AT_DSTRONG, 1, HG_KNOCKBACK_SCALING, 1.0);//0.7
set_hitbox_value(AT_DSTRONG, 1, HG_BASE_HITPAUSE, 8);//7
set_hitbox_value(AT_DSTRONG, 1, HG_HITPAUSE_SCALING, 0.7);//0.6
...
set_hitbox_value(AT_DSTRONG, 2, HG_ANGLE, 55);//55//75
set_hitbox_value(AT_DSTRONG, 2, HG_PRIORITY, 2);//3
set_hitbox_value(AT_DSTRONG, 2, HG_BASE_KNOCKBACK, 8);//7
set_hitbox_value(AT_DSTRONG, 2, HG_KNOCKBACK_SCALING, 1.0);//0.9//1.0
set_hitbox_value(AT_DSTRONG, 2, HG_BASE_HITPAUSE, 9);//8
...
set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_Y, -26);//-24
set_hitbox_value(AT_DSTRONG, 3, HG_WIDTH, 45);//65
set_hitbox_value(AT_DSTRONG, 3, HG_HEIGHT, 55);//57
set_hitbox_value(AT_DSTRONG, 3, HG_DAMAGE, 8);
set_hitbox_value(AT_DSTRONG, 3, HG_ANGLE, 361);//50
set_hitbox_value(AT_DSTRONG, 3, HG_ANGLE_FLIPPER, 5);
set_hitbox_value(AT_DSTRONG, 3, HG_PRIORITY, 3);//2
set_hitbox_value(AT_DSTRONG, 3, HG_BASE_KNOCKBACK, 9);//7
set_hitbox_value(AT_DSTRONG, 3, HG_KNOCKBACK_SCALING, 0.9);//0.9
set_hitbox_value(AT_DSTRONG, 3, HG_BASE_HITPAUSE, 9);//8
