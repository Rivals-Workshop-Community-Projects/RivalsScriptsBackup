...
set_window_value(AT_FSPECIAL_2, ig, AG_WINDOW_HSPEED, 2);
set_window_value(AT_FSPECIAL_2, ig, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_FSPECIAL_2, ig, AG_WINDOW_ANIM_FRAME_START, 26);
...
set_window_value(AT_FSPECIAL_2, ig, AG_WINDOW_ANIM_FRAME_START, 27);
...
set_window_value(AT_FSPECIAL_2, ig, AG_WINDOW_ANIM_FRAMES, 8);  
set_window_value(AT_FSPECIAL_2, ig, AG_WINDOW_ANIM_FRAME_START, 32);
