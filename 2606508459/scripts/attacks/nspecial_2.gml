...
set_window_value(AT_NSPECIAL_2, ig, AG_WINDOW_LENGTH, 1); //1
...
if (dip_swapSpecial)
{
    ...
    set_hitbox_value(AT_NSPECIAL_2, ig, HG_BASE_KNOCKBACK, 8.5);
    set_hitbox_value(AT_NSPECIAL_2, ig, HG_KNOCKBACK_SCALING, 0.14);
    ...
    set_hitbox_value(AT_NSPECIAL_2, ig, HG_WIDTH, 81);
    set_hitbox_value(AT_NSPECIAL_2, ig, HG_HEIGHT, 81);
