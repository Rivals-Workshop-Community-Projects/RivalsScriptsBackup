...
//Forward Air Hit
set_window_value(AT_FAIR, ig, AG_WINDOW_TYPE, 1);
set_window_value(AT_FAIR, ig, AG_WINDOW_LENGTH, 8);
set_window_value(AT_FAIR, ig, AG_WINDOW_ANIM_FRAMES, 2);
...
//Forward Air End
set_window_value(AT_FAIR, ig, AG_WINDOW_TYPE, 1);
set_window_value(AT_FAIR, ig, AG_WINDOW_LENGTH, 9);
set_window_value(AT_FAIR, ig, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_FAIR, ig, AG_WINDOW_ANIM_FRAME_START, 6);
...
set_hitbox_value(AT_FAIR, ig, HG_LIFETIME, 3);
set_hitbox_value(AT_FAIR, ig, HG_HITBOX_X, 40);
...
set_hitbox_value(AT_FAIR, ig, HG_ANGLE, 40);
...
set_hitbox_value(AT_FAIR, ig, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_FAIR, ig, HG_KNOCKBACK_SCALING, .6);
set_hitbox_value(AT_FAIR, ig, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_FAIR, ig, HG_HITPAUSE_SCALING, .2);

set_hitbox_value(AT_FAIR, ig, HG_VISUAL_EFFECT_X_OFFSET, 32);
set_hitbox_value(AT_FAIR, ig, HG_VISUAL_EFFECT_Y_OFFSET, -10);
