...
//Charge (2)
set_window_value(AT_FSPECIAL, ig, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL, ig, AG_WINDOW_LENGTH, 20);
...
set_window_value(AT_FSPECIAL, ig, AG_WINDOW_HSPEED, 30);
set_window_value(AT_FSPECIAL, ig, AG_WINDOW_VSPEED_TYPE, 1);
...
set_window_value(AT_FSPECIAL, ig, AG_WINDOW_HSPEED_TYPE, 2);
set_window_value(AT_FSPECIAL, ig, AG_WINDOW_HSPEED, 6);
set_window_value(AT_FSPECIAL, ig, AG_WINDOW_VSPEED_TYPE, 1);
set_window_value(AT_FSPECIAL, ig, AG_WINDOW_VSPEED, 0);
...
set_hitbox_value(AT_FSPECIAL, ig, HG_WINDOW_CREATION_FRAME, 2);
set_hitbox_value(AT_FSPECIAL, ig, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_FSPECIAL, ig, HG_LIFETIME, 11);
set_hitbox_value(AT_FSPECIAL, ig, HG_HITBOX_X, 21);
set_hitbox_value(AT_FSPECIAL, ig, HG_HITBOX_Y, -38);
...
set_hitbox_value(AT_FSPECIAL, ig, HG_ANGLE, 70); //85
