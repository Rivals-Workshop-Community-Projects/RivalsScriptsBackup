...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sound_get("sfx_swinglight"));
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX_FRAME, 7);
set_window_value(AT_DATTACK, 1, AG_WINDOW_HSPEED, 2);
set_window_value(AT_DATTACK, 1, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_DATTACK, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.01);
...
set_hitbox_value(AT_DATTACK, 1, HG_HEIGHT, 67);
...
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, sound_get("sfx_swordmedium"));