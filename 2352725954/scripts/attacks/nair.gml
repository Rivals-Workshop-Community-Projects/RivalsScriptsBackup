...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sound_get("sfx_swordmedium"));
...
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_X, 37);
...
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, sound_get("sfx_swordmedium"));
...
set_hitbox_value(AT_NAIR, 3, HG_HITBOX_Y, 9);
set_hitbox_value(AT_NAIR, 3, HG_WIDTH, 81);
set_hitbox_value(AT_NAIR, 3, HG_HEIGHT, 62);
...
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, sound_get("sfx_swordmedium"));
...
set_hitbox_value(AT_NAIR, 4, HG_KNOCKBACK_SCALING, .65);
...
set_hitbox_value(AT_NAIR, 4, HG_HIT_SFX, sound_get("sfx_swordmedium"));
