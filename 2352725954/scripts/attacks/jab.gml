...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("sfx_swordlight"));
...
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, sound_get("sfx_swordlight"));
...
set_hitbox_value(AT_JAB, 3, HG_HEIGHT, 63);
...
set_hitbox_value(AT_JAB, 2, HG_VISUAL_EFFECT, 301);
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, sound_get("sfx_swordmedium"));
