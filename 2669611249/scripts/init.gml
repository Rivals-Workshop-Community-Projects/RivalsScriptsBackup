...
air_hurtbox_spr = -1//asset_get("ex_guy_hurt_box");
...
razor_leaf_fx = hit_fx_create( sprite_get("razor_fx"), 15 )
poison_leaf_fx = hit_fx_create( sprite_get("poison_fx"), 15 )
poison_strike = hit_fx_create( sprite_get("poison_strike_hfx"), 30 )
leaf_strike = hit_fx_create( sprite_get("leaf_strike_hfx"), 30 )
poison_splash = hit_fx_create( sprite_get("poison_splash_hfx"), 30 )
exploding = hit_fx_create( sprite_get("sludge_explosion"), 60 )
smack = hit_fx_create( sprite_get("smack_hfx"), 60 )
