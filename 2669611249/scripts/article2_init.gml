...
sprite_index = sprite_get("sludgebomb");           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
...
spr_angle = 0
detonation_timer = 300;                             //sec = 60 frames so 1 sec = 60, 3 sec = 180, 5 sec = 300, etc
...
new_sprite = sprite_get("sludgebomb");             //This is another part of the animation handling. It tells the game "this is the sprite this article should be using; if it's not already, switch it over please"
