...
// set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, sound_get("bells"));
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, sound_get("pchsound_#313"));
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_HAS_WHIFFLAG, 12);
