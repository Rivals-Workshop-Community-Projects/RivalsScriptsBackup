...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_leaves"));
...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, sound_get("pchsound_#313"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("razor_leaf"));
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("razor_leaf"));
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_HSPEED, 7.5);
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, leaf_strike);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("poison_leaf"));
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_MASK, sprite_get("poison_leaf"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_VISUAL_EFFECT, poison_strike);
set_hitbox_value(AT_NSPECIAL, 2, HG_VISUAL_EFFECT_Y_OFFSET, 32);
set_hitbox_value(AT_NSPECIAL, 2, HG_HIT_SFX, asset_get("sfx_frog_dstrong"));