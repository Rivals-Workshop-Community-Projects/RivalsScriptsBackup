...
set_window_value(AT_USTRONG, 1, AG_WINDOW_SFX, sound_get("bells"));
...
set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX, sound_get("prout"));
...
set_window_value(AT_USTRONG, 4, AG_WINDOW_SFX, asset_get("sfx_birdclap"));
...
set_window_value(AT_USTRONG, 5, AG_WINDOW_HAS_WHIFFLAG, 9);
