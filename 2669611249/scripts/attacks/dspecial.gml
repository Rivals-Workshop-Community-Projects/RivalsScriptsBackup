...
set_hitbox_value(AT_DSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("acid"));
set_hitbox_value(AT_DSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("acid"));
...
//set_hitbox_value(AT_DSPECIAL, 1, HG_VISUAL_EFFECT, poison_splash);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HIT_LOCKOUT, 360);
//set_hitbox_value(AT_DSPECIAL, 2, HG_BASE_KNOCKBACK, 2);
//set_hitbox_value(AT_DSPECIAL, 2, HG_BASE_HITPAUSE, 5);
//set_hitbox_value(AT_DSPECIAL, 2, HG_HITSTUN_MULTIPLIER, 0.1);
set_hitbox_value(AT_DSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("poison_bubble"));
