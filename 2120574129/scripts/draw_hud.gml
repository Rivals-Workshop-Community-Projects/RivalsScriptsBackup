...
//music name title
music_titles = ["Totaka's Bop", "Training (Luigi's Mansion)", "Targets! (Super Smash Bros. Melee)", "Battle Stage (Mario Kart: Double Dash!!)"]
 
 
//confirmation sound to play when music has been changed
//sound_get and asset_get both works here.
var confirm_sound = sound_get("hal_menu");
...
var music_line_color = make_color_rgb(109,74,209);
