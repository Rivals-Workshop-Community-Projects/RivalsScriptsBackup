...
sprite_change_offset("airdodge", 48, 47);
...
sprite_change_offset("fspecial_jump", 32, 47, true);
sprite_change_offset("fspecial_attack", 48, 47, true);
sprite_change_offset("fspecial_special", 32, 47, true);
sprite_change_offset("fspecial_strong", 32, 63, true);
...
sprite_change_offset("fx_powerup", 32, 32);
sprite_change_offset("fx_powerdown", 32, 32);
sprite_change_offset("fx_tools", 32, 32);
sprite_change_offset("fx_uspec_expl", 64, 64);
sprite_change_offset("fx_uspec_proj", 48, 16);
sprite_change_offset("fx_shock1", 96, 126);
sprite_change_offset("fx_shock2", 96, 126);
