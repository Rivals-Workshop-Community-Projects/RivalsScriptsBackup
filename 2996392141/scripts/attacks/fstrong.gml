...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_TENSION_WHIFF_PENALTY, 12);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sound_get("sfx_bat_whack_heavy"));
...
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, sound_get("sfx_bat_whack"));