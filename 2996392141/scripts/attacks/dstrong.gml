...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_TENSION_WHIFF_PENALTY, 12);

set_num_hitboxes(AT_DSTRONG, 3);

set_hitbox_value(AT_DSTRONG, 1, HG_MUNO_HITBOX_NAME, "Early");
...
set_hitbox_value(AT_DSTRONG, 2, HG_MUNO_HITBOX_NAME, "Clean");
...
set_hitbox_value(AT_DSTRONG, 3, HG_MUNO_HITBOX_NAME, "Late");
...
set_hitbox_value(AT_DSTRONG, 3, HG_WIDTH, 78);
