...
//Loop
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_LOOP_TIMES, FSPECIAL_LOOP_TIMES);
...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_bird_nspecial2"));
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_LENGTH, 21);
...
var startup1 = get_window_value(AT_FSPECIAL, 1, AG_WINDOW_LENGTH);
var active1 = get_window_value(AT_FSPECIAL, 2, AG_WINDOW_LENGTH) * FSPECIAL_LOOP_TIMES;
var recovery1 = get_window_value(AT_FSPECIAL, 3, AG_WINDOW_LENGTH) + get_window_value(AT_FSPECIAL, 4, AG_WINDOW_LENGTH);
var recovery2 = get_window_value(AT_FSPECIAL, 3, AG_WINDOW_LENGTH) + get_window_value(AT_FSPECIAL, 4, AG_WINDOW_LENGTH);
var faf1 = startup1 + active1 + recovery1;
var faf2 = startup1 + active1 + recovery2;

set_attack_value(AT_FSPECIAL, AG_MUNO_ATTACK_ENDLAG, string(recovery1) + ` (${recovery2} air)`);
set_attack_value(AT_FSPECIAL, AG_MUNO_ATTACK_FAF, string(faf1) + ` (${faf2} air)`);
set_attack_value(AT_FSPECIAL, AG_MUNO_ATTACK_MISC_ADD, "Can be transitioned after frame" + string(startup1) + "on hit. Assumes the move is fully used.");


set_num_hitboxes(AT_FSPECIAL, 3);

set_hitbox_value(AT_FSPECIAL, 1, HG_MUNO_HITBOX_NAME, "Multihits");
...
set_hitbox_value(AT_FSPECIAL, 2, HG_MUNO_HITBOX_NAME, "Final Hit (Ground)");
...
set_hitbox_value(AT_FSPECIAL, 3, HG_MUNO_HITBOX_NAME, "Final Hit (Air)");
