...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, asset_get("sfx_waveland_ori"));
/*set_window_value(AT_DAIR, 1, AG_WINDOW_HAS_SFX, 1);
...
//set_window_value(AT_DAIR, 2, AG_WINDOW_SFX, asset_get("sfx_buzzsaw_hit"));
...
set_window_value(AT_DAIR, 3, AG_WINDOW_VSPEED, 30);
