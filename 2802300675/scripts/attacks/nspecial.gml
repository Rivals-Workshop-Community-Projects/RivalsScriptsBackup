...
//check article1update if you ever want to change these values
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, t1projsprite);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_SPRITE, t2projsprite);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_PROJECTILE_SPRITE, t3projsprite);
