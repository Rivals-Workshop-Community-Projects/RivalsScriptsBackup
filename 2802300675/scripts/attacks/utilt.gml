...
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, hitsmoke);
...
set_hitbox_value(AT_UTILT, 2, HG_HITBOX_Y, -61);
...
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, hitsmoke);
...
set_hitbox_value(AT_UTILT, 3, HG_HEIGHT, 125);
...
set_hitbox_value(AT_UTILT, 3, HG_VISUAL_EFFECT, hitsmoke);
set_hitbox_value(AT_UTILT, 3, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_UTILT, 3, HG_VISUAL_EFFECT_Y_OFFSET, -24);
...
set_hitbox_value(AT_UTILT, 4, HG_HITBOX_Y, -61);
set_hitbox_value(AT_UTILT, 4, HG_WIDTH, 80);
set_hitbox_value(AT_UTILT, 4, HG_HEIGHT, 122);
...
set_hitbox_value(AT_UTILT, 4, HG_VISUAL_EFFECT, bigsmoke);
...
set_hitbox_value(AT_UTILT, 4, HG_IGNORES_PROJECTILES, 0);
