...
set_window_value(AT_DSPECIAL_2, 6, AG_WINDOW_LENGTH, 21);
...
set_hitbox_value(AT_DSPECIAL_2, 3, HG_WIDTH, 110);
...
set_hitbox_value(AT_DSPECIAL_2, 4, HG_HITBOX_Y, -15);
set_hitbox_value(AT_DSPECIAL_2, 4, HG_WIDTH, 150);
set_hitbox_value(AT_DSPECIAL_2, 4, HG_HEIGHT, 40);
set_hitbox_value(AT_DSPECIAL_2, 4, HG_PRIORITY, 2);
...
set_hitbox_value(AT_DSPECIAL_2, 4, HG_KNOCKBACK_SCALING, 1);
