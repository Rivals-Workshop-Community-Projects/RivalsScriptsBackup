...
set_window_value(AT_USTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_forsburn_consume_fail"));
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, hitaffectstrong);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, hitaffectstrong);
...
set_hitbox_value(AT_USTRONG, 3, HG_VISUAL_EFFECT, hitsmoke);
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, asset_get("sfx_absa_cloud_send"));
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_USTRONG, 3, HG_PROJECTILE_SPRITE, sprite_get("smogball"));
set_hitbox_value(AT_USTRONG, 3, HG_PROJECTILE_MASK, sprite_get("smogball"));
...
set_hitbox_value(AT_USTRONG, 3, HG_PROJECTILE_DESTROY_EFFECT, hitsmoke);
