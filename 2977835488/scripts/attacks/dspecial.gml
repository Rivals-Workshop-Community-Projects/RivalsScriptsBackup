...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_hod_fspecial"));
...
set_hitbox_value(AT_DSPECIAL, 1, HGWIDTH, 55);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_WINDOW, 2);
set_hitbox_value(AT_DSPECIAL, 1, HG_LIFETIME, 31);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_EXTRA_HITPAUSE, 20);
set_hitbox_value(AT_DSPECIAL, 1, HG_EFFECT, 9);
set_hitbox_value(AT_DSPECIAL, 1, HG_VISUAL_EFFECT, dspecial_vfx2);
set_hitbox_value(AT_DSPECIAL, 1, HG_VISUAL_EFFECT_Y_OFFSET, 16);
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, dspecial_vfx2);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_PROJECTILE_HSPEED, 7.5);
