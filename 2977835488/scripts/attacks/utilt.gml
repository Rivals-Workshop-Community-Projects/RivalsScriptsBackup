...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, asset_get("sfx_syl_fspecial_bite"));
...
set_hitbox_value(AT_UTILT, 3, HG_HITBOX_Y, -114);
...
set_hitbox_value(AT_UTILT, 3, HG_HIT_SFX, asset_get("sfx_bigplant_eat"));
