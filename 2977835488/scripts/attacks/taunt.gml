...
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX, asset_get("sfx_boss_shine"));
...
//set_window_value(AT_TAUNT, 3, AG_WINDOW_SFX, sound_get("qoedil_test"));
...
set_window_value(AT_TAUNT, 5, AG_WINDOW_SFX_FRAME, 10);
