...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_hod_fspecial"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, nspecial_proj_hit);
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, nspecial_proj_hit);
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT_Y_OFFSET, 10);
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_hod_steamhit3"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_VISUAL_EFFECT, curse_vfx);
set_hitbox_value(AT_NSPECIAL, 2, HG_HIT_SFX, sound_get("qoedil_hit_bite"));
