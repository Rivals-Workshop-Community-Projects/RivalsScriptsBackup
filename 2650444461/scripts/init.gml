...
amMudkip = true;
is_KOB = true;
upb = false;upbtimer = 0;upb_hitbox = noone;
upb_hit_sprite1 = sprite_get("uspecial_hit1");upb_hit_sprite2 = sprite_get("uspecial_hit2");
upb_hit_sprite3 = sprite_get("uspecial_hit3");upb_hit_sprite4 = sprite_get("uspecial_hit4");
nspecialcharge = 0;nspec_multiplier = 1;nspecialcharge2 = 0;nspec_timer = 0;
fspecialcooldown = false;
dspecialtime = 0;
dspec_mud = noone;mud_puddles = ds_grid_create(3, 1);
slippery_timer = 0;on_puddle_id = noone;
ground_friction_or = 0;wave_friction_or = 0;wave_land_adj_or = 0;leave_ground_max_or = 0;mudkip_handled_stats = false;
dtiltmud = false;
crit = false;
outline_timer = 0;outline_rev = false;
pokeball_sprite = sprite_get("pokeball");
intro = (state == PS_SPAWN);introspeed = 0.2;
windowtiming = 0;
lookuptime = 0;
size_mult = 1;
big = false;mega = false;mini = false;normalsize = true;
sizechangemoves = true;passivesoftarmor = 0;knockback_adj_or = knockback_adj;
loaded = false;
trainingmode = false;
