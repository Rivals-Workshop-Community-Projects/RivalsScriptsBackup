...
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX, sound_get("voice_hi"));
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX_FRAME, 22);
...
set_window_value(AT_TAUNT, 4, AG_WINDOW_SFX, sound_get("voice_hi"));
set_window_value(AT_TAUNT, 4, AG_WINDOW_SFX_FRAME, 22);
