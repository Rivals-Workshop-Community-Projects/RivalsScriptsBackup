...
set_hitbox_value(AT_DSTRONG, 1, HG_LIFETIME, 6); // 5
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_X, -55); // 5
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_Y, -23); // -15
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 76); // 160
set_hitbox_value(AT_DSTRONG, 1, HG_HEIGHT, 32); // 30
set_hitbox_value(AT_DSTRONG, 1, HG_SHAPE, 0);
set_hitbox_value(AT_DSTRONG, 1, HG_PRIORITY, 6);
set_hitbox_value(AT_DSTRONG, 1, HG_DAMAGE, 10); // 11
set_hitbox_value(AT_DSTRONG, 1, HG_ANGLE, 125); // 290
...
set_hitbox_value(AT_DSTRONG, 2, HG_LIFETIME, 6); // 5
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_X, 55); // 5
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_Y, -23); // -15
set_hitbox_value(AT_DSTRONG, 2, HG_WIDTH, 76); // 160
set_hitbox_value(AT_DSTRONG, 2, HG_HEIGHT, 32); // 30
