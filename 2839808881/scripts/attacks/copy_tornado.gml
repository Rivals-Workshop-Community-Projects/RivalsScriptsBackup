...
set_hitbox_value(AT_COPY_TORNADO, 10, HG_DAMAGE, 5);
set_hitbox_value(AT_COPY_TORNADO, 10, HG_ANGLE, 90);
set_hitbox_value(AT_COPY_TORNADO, 10, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_COPY_TORNADO, 10, HG_KNOCKBACK_SCALING, .5);
