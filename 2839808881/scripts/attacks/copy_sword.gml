...
for (var i = 1; i < 5; i++){
	...
	set_hitbox_value(AT_COPY_SWORD, hboxRealNum, HG_LIFETIME, 3);
	...
	set_hitbox_value(AT_COPY_SWORD, hboxRealNum + 1, HG_LIFETIME, 3);
	...
	set_hitbox_value(AT_COPY_SWORD, hboxRealNum + 2, HG_LIFETIME, 3);
