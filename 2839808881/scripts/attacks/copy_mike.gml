...
set_hitbox_value(AT_COPY_MIKE, 2, HG_DAMAGE, 13);
...
set_hitbox_value(AT_COPY_MIKE, 2, HG_BASE_HITPAUSE, 12);
...
set_hitbox_value(AT_COPY_MIKE, 3, HG_DAMAGE, 16);
...
set_hitbox_value(AT_COPY_MIKE, 3, HG_BASE_HITPAUSE, 15);
