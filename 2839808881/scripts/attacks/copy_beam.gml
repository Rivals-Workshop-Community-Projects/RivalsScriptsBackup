...
set_window_value(AT_COPY_BEAM, 3, AG_WINDOW_LENGTH, 8);
...
set_hitbox_value(AT_COPY_BEAM, 1, HG_LIFETIME, 2);
...
set_hitbox_value(AT_COPY_BEAM, 2, HG_WINDOW_CREATION_FRAME, 2);
set_hitbox_value(AT_COPY_BEAM, 2, HG_LIFETIME, 2);
...
set_hitbox_value(AT_COPY_BEAM, 3, HG_WINDOW_CREATION_FRAME, 4);
set_hitbox_value(AT_COPY_BEAM, 3, HG_LIFETIME, 2);
...
set_hitbox_value(AT_COPY_BEAM, 4, HG_WINDOW_CREATION_FRAME, 6);
set_hitbox_value(AT_COPY_BEAM, 4, HG_LIFETIME, 2);
...
set_hitbox_value(AT_COPY_BEAM, 4, HG_DAMAGE, 3);
...
set_hitbox_value(AT_COPY_BEAM, 5, HG_WINDOW_CREATION_FRAME, 6);
set_hitbox_value(AT_COPY_BEAM, 5, HG_LIFETIME, 2);
...
set_hitbox_value(AT_COPY_BEAM, 5, HG_DAMAGE, 3);
...
set_hitbox_value(AT_COPY_BEAM, 6, HG_DAMAGE, 10);
...
set_hitbox_value(AT_COPY_BEAM, 6, HG_HITSTUN_MULTIPLIER, 0.6);
...
set_hitbox_value(AT_COPY_BEAM, 6, HG_PROJECTILE_IS_TRANSCENDENT, 0);
