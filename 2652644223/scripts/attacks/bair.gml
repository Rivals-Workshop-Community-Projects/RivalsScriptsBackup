...
set_window_value(AT_BAIR, 3, AG_WINDOW_GOTO, 6);
...
set_window_value(AT_BAIR, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.8);
...
set_hitbox_value(AT_BAIR, 3, HG_HIT_SFX, asset_get("sfx_clairen_tip_strong"));
