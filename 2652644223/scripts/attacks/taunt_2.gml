...
set_attack_value(AT_TAUNT_2, AG_HURTBOX_SPRITE, sprite_get("stand_hurt"));
...
set_window_value(AT_TAUNT_2, 1, AG_WINDOW_SFX, sound_get("revolver_deploy"));
...
set_window_value(AT_TAUNT_2, 2, AG_WINDOW_SFX, sound_get("revolver_load"));
...
set_window_value(AT_TAUNT_2, 3, AG_WINDOW_SFX, sound_get("revolver_wheel2"));
