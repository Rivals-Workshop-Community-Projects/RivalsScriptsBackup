...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("revolver_deploy"));
...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_SFX, sound_get("revolver_cock"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_WIDTH, 18);
set_hitbox_value(AT_NSPECIAL, 1, HG_HEIGHT, 18);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, 22);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_WIDTH, 18);
set_hitbox_value(AT_NSPECIAL, 2, HG_HEIGHT, 18);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_VISUAL_EFFECT, 22);
