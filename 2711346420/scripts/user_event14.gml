...
/*
sfx_pho_open = sound_get("sfx_monkey_ball_2_menu_pause");
sfx_pho_close = sound_get("sfx_monkey_ball_2_ball_bounce");
sfx_pho_move = sound_get("_pho_acnh_move1");
sfx_pho_move_home = sound_get("_pho_acnh_move1");
sfx_pho_page = sound_get("sfx_monkey_ball_2_menu_select");
sfx_pho_open_app = sound_get("sfx_monkey_ball_2_menu_select");
sfx_pho_close_app = sound_get("sfx_monkey_ball_2_ball_bounce");
sfx_pho_power_off = sound_get("sfx_monkey_ball_2_menu_select");
sfx_pho_power_on = sound_get("sfx_monkey_ball_2_menu_pause");
*/
initIndexes();
