...
//set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, sfx_monkey_ball_banana_mania_fight_charge);
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX, sfx_monkey_ball_2_fight_swipe);
