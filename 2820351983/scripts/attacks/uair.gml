...
easy_window("active_late",
    AG_WINDOW_LENGTH, 2,
)

easy_hitbox(2,
    HG_WINDOW, get_window_index("active_late"),
    HG_LIFETIME, 2,
    HG_DAMAGE, 5,
    HG_BASE_KNOCKBACK, 5,
...
#macro ACTIVE_EARLY_FRAMES 1
#define _get_active_early_frames()
    return ACTIVE_EARLY_FRAMES
#macro ACTIVE_EARLY_FRAME_START 1
#define _get_active_early_frame_start()
    return ACTIVE_EARLY_FRAME_START

#macro ACTIVE_LATE_FRAMES 1
#define _get_active_late_frames()
    return ACTIVE_LATE_FRAMES
#macro ACTIVE_LATE_FRAME_START 2
#define _get_active_late_frame_start()
    return ACTIVE_LATE_FRAME_START
