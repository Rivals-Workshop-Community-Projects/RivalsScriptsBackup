...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, sfx_kirby_swipe3);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, pillow_hit_fx_lrg);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, pillow_hit_fx_sml);
