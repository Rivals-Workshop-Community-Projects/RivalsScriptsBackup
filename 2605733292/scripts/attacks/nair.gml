...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, sfx_hammer_swipe_spin);
...
set_window_value(AT_NAIR, 8, AG_WINDOW_LENGTH, 1);
...
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT, pillow_hit_fx_med);
...
set_hitbox_value(AT_NAIR, 2, HG_HEIGHT, 59);
...
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT, pillow_hit_fx_med);
...
set_hitbox_value(AT_NAIR, 3, HG_VISUAL_EFFECT, pillow_hit_fx_med);
...
set_hitbox_value(AT_NAIR, 4, HG_HITBOX_Y, -3);
...
set_hitbox_value(AT_NAIR, 4, HG_VISUAL_EFFECT, pillow_hit_fx_med);
...
set_hitbox_value(AT_NAIR, 5, HG_ANGLE, 25);
...
set_hitbox_value(AT_NAIR, 5, HG_VISUAL_EFFECT, pillow_hit_fx_med);
...
set_hitbox_value(AT_NAIR, 5, HG_HITBOX_GROUP, 0);
...
set_hitbox_value(AT_NAIR, 6, HG_HITBOX_X, -32);
set_hitbox_value(AT_NAIR, 6, HG_HITBOX_Y, -27);
set_hitbox_value(AT_NAIR, 6, HG_WIDTH, 58);
set_hitbox_value(AT_NAIR, 6, HG_HEIGHT, 83);
...
set_hitbox_value(AT_NAIR, 6, HG_VISUAL_EFFECT, pillow_hit_fx_med);
...
set_hitbox_value(AT_NAIR, 6, HG_HITBOX_GROUP, 0);