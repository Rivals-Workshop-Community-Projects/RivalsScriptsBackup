...
//set_window_value(AT_TAUNT, 3, AG_WINDOW_SFX, asset_get("sfx_land"));
set_window_value(AT_TAUNT, 3, AG_WINDOW_SFX, sfx_land);
...
set_hitbox_value(AT_TAUNT, 1, HG_LIFETIME, 9999999999999999999999);
set_hitbox_value(AT_TAUNT, 1, HG_HITBOX_X, 0);
set_hitbox_value(AT_TAUNT, 1, HG_HITBOX_Y, 4);
...
set_hitbox_value(AT_TAUNT, 1, HG_BASE_KNOCKBACK, 11);
...
set_hitbox_value(AT_TAUNT, 1, HG_HIT_SFX, sfx_canvas_curse_balloon_pop);
set_hitbox_value(AT_TAUNT, 1, HG_PROJECTILE_SPRITE, sprite_get("intro_noddy_left"));
set_hitbox_value(AT_TAUNT, 1, HG_PROJECTILE_MASK, sprite_get("noddy_left"));