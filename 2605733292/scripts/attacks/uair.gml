...
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, sfx_hammer_swipe1);
...
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT, pillow_hit_fx_sml);
...
set_hitbox_value(AT_UAIR, 2, HG_WIDTH, 59);
...
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT, pillow_hit_fx_sml);
