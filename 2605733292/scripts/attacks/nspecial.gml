...
set_hitbox_value(AT_NSPECIAL, 1, HG_WINDOW, 12);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HITBOX_Y, -4);
set_hitbox_value(AT_NSPECIAL, 1, HG_WIDTH, 47);
set_hitbox_value(AT_NSPECIAL, 1, HG_HEIGHT, 47);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HEIGHT, 47);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_HITBOX_Y, -4);
set_hitbox_value(AT_NSPECIAL, 3, HG_WIDTH, 47);
set_hitbox_value(AT_NSPECIAL, 3, HG_HEIGHT, 47);
...
set_hitbox_value(AT_NSPECIAL, 6, HG_HITBOX_X, 1);
set_hitbox_value(AT_NSPECIAL, 6, HG_HITBOX_Y, -4);
set_hitbox_value(AT_NSPECIAL, 6, HG_WIDTH, 47);
set_hitbox_value(AT_NSPECIAL, 6, HG_HEIGHT, 47);
...
set_hitbox_value(AT_NSPECIAL, 7, HG_HITBOX_X, 1);
set_hitbox_value(AT_NSPECIAL, 7, HG_HITBOX_Y, -4);
set_hitbox_value(AT_NSPECIAL, 7, HG_WIDTH, 47);
set_hitbox_value(AT_NSPECIAL, 7, HG_HEIGHT, 47);
...
set_hitbox_value(AT_USPECIAL, 6, HG_EXTENDED_PARRY_STUN, true);
set_hitbox_value(AT_USPECIAL, 7, HG_EXTENDED_PARRY_STUN, true);
