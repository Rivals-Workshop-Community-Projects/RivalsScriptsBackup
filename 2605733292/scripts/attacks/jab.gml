...
set_hitbox_value(AT_JAB, 1, HG_KNOCKBACK_SCALING, 0.05);
...
set_hitbox_value(AT_JAB, 4, HG_HITBOX_X, 43);
set_hitbox_value(AT_JAB, 4, HG_HITBOX_Y, -34);
set_hitbox_value(AT_JAB, 4, HG_WIDTH, 62);
set_hitbox_value(AT_JAB, 4, HG_HEIGHT, 74);
