...
//set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, sfx_kirby_swipe3);
...
set_hitbox_value(AT_FAIR, 1, HG_VISUAL_EFFECT, pillow_hit_fx_lrg);
...
set_hitbox_value(AT_FAIR, 2, HG_VISUAL_EFFECT, pillow_hit_fx_lrg);
