...
if phone.hint_opac > 0{
	...
	textDraw(temp_x + 72 + phone.taunt_hint_x, height + phone.taunt_hint_y, "fName", c_white, 100, 100, fa_right, 1, true, 1, "Taunt!", false);
	draw_sprite_ext(phone.spr_pho_compatibility_badges, 0, temp_x + 72 + phone.taunt_hint_x, height + phone.taunt_hint_y - 7, 1, 1, 0, c_white, 1);
}
