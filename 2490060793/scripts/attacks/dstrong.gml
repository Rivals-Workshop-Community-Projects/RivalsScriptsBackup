...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("bar_swing_med3"));
...
set_hitbox_value(AT_DSTRONG, 3, HG_EFFECT, 99);
...
set_hitbox_value(AT_DSTRONG, 4, HG_EXTRA_HITPAUSE, 4);
set_hitbox_value(AT_DSTRONG, 4, HG_EFFECT, 99);
