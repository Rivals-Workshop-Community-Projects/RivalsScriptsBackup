...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("bar_swing_med1"));
...
set_hitbox_value(AT_UTILT, 4, HG_EFFECT, 99);
set_hitbox_value(AT_UTILT, 4, HG_HIT_SFX, asset_get("sfx_blow_medium3"));
set_hitbox_value(AT_UTILT, 4, HG_VISUAL_EFFECT, 21);
...
set_hitbox_value(AT_UTILT, 5, HG_DAMAGE, 11);
set_hitbox_value(AT_UTILT, 5, HG_ANGLE, 90);
set_hitbox_value(AT_UTILT, 5, HG_ANGLE_FLIPPER, 0);
...
set_hitbox_value(AT_UTILT, 5, HG_EXTRA_HITPAUSE, 4);
set_hitbox_value(AT_UTILT, 5, HG_EFFECT, 99);
set_hitbox_value(AT_UTILT, 5, HG_HIT_SFX, asset_get("sfx_blow_medium3"));
set_hitbox_value(AT_UTILT, 5, HG_VISUAL_EFFECT, 21);
...
set_hitbox_value(AT_UTILT, 6, HG_DAMAGE, 11);
...
set_hitbox_value(AT_UTILT, 6, HG_EXTRA_HITPAUSE, 4);
set_hitbox_value(AT_UTILT, 6, HG_EFFECT, 99);
set_hitbox_value(AT_UTILT, 6, HG_HIT_SFX, asset_get("sfx_blow_medium3"));
set_hitbox_value(AT_UTILT, 6, HG_VISUAL_EFFECT, 21);
