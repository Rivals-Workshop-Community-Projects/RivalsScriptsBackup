...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_clairen_fspecial_dash"));
...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_frog_uspecial_cast"));
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX_FRAME, 10);
...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_HSPEED, 20);
...
set_window_value(AT_USPECIAL, 5, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.3);
set_window_value(AT_USPECIAL, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.3);
...
set_hitbox_value(AT_USPECIAL, 2, HG_EFFECT, 99);
