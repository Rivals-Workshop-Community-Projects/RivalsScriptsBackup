...
set_hitbox_value(AT_USPECIAL, 6, HG_SDI_MULTIPLIER, 0.1);
set_hitbox_value(AT_USPECIAL, 6, HG_DRIFT_MULTIPLIER, 0.1);
...
set_hitbox_value(AT_USPECIAL, 7, HG_SDI_MULTIPLIER, 0.1);
