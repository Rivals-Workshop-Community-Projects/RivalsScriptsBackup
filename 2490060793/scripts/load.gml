...
sprite_change_offset("xslash", 80, 178);
...
sprite_change_offset("hud_meter_blank", 0, 0);
sprite_change_offset("hud_meter_flash", 0, 0);
sprite_change_offset("hud_meter_break", 0, 0);
...
sprite_change_offset("killzoom", 230, 125);
sprite_change_offset("killzoom_bg", 230, 125);
