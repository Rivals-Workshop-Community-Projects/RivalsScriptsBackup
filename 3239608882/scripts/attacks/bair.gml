...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("sf_hit1"));
...
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, sound_get("sf_hit1"));
...
set_hitbox_value(AT_BAIR, 3, HG_HITPAUSE_SCALING, 0.34);
set_hitbox_value(AT_BAIR, 3, HG_VISUAL_EFFECT, 302);
set_hitbox_value(AT_BAIR, 3, HG_HIT_SFX, sound_get("sf_hit2"));
