...
set_window_value(AT_USTRONG, 5, AG_WINDOW_HAS_WHIFFLAG, 7);
...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("slash2"));
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("slash2"));
...
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, sound_get("slash2"));
...
set_hitbox_value(AT_USTRONG, 4, HG_HITPAUSE_SCALING, .25);
...
set_hitbox_value(AT_USTRONG, 4, HG_HIT_SFX, sound_get("slash1"));
