...
set_window_value(AT_DAIR, 2, AG_WINDOW_HITPAUSE_FRAME, 0);
...
set_window_value(AT_DAIR, 3, AG_WINDOW_HITPAUSE_FRAME, 0);
...
set_window_value(AT_DAIR, 4, AG_WINDOW_HITPAUSE_FRAME, 0);
set_window_value(AT_DAIR, 4, AG_WINDOW_CUSTOM_GRAVITY, 0);

set_window_value(AT_DAIR, 5, AG_WINDOW_TYPE, 5);
...
set_window_value(AT_DAIR, 6, AG_WINDOW_TYPE, 5);
...
set_window_value(AT_DAIR, 6, AG_WINDOW_HAS_CUSTOM_FRICTION, 0);
set_window_value(AT_DAIR, 6, AG_WINDOW_CUSTOM_AIR_FRICTION, 0);
set_window_value(AT_DAIR, 6, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0);
//set_window_value(AT_DAIR, 5, AG_WINDOW_HAS_WHIFFLAG, 7);
set_window_value(AT_DAIR, 6, AG_WINDOW_CUSTOM_GRAVITY, 0);
...
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, sound_get("sf_hit1"));
...
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, sound_get("sf_hit1"));
...
set_hitbox_value(AT_DAIR, 3, HG_HIT_SFX, sound_get("sf_hit2"));
