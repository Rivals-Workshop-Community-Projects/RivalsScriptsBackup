...
set_window_value(AT_UAIR, 1, AG_WINDOW_LENGTH, 8);//old 6
...
set_hitbox_value(AT_UAIR, 1, 81, "Early Hit");
...
set_hitbox_value(AT_UAIR, 1, HG_DAMAGE, 6); //old 10
set_hitbox_value(AT_UAIR, 1, HG_ANGLE, 90);
set_hitbox_value(AT_UAIR, 1, HG_BASE_KNOCKBACK, 10);// 9 old
set_hitbox_value(AT_UAIR, 1, HG_KNOCKBACK_SCALING, 0.6);// 0.3 old
...
set_hitbox_value(AT_UAIR, 2, 81, "Late Hit");
...
set_hitbox_value(AT_UAIR, 2, HG_DAMAGE, 4); //old 10
set_hitbox_value(AT_UAIR, 2, HG_ANGLE, 90);
set_hitbox_value(AT_UAIR, 2, HG_BASE_KNOCKBACK, 4);
set_hitbox_value(AT_UAIR, 2, HG_KNOCKBACK_SCALING, 0.25);
