...
set_hitbox_value(AT_BAIR, 1, 81, "Early Hit"); // Woodcock Name
...
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 86); //86 > 96
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 30);
set_hitbox_value(AT_BAIR, 1, HG_PRIORITY, 2);
set_hitbox_value(AT_BAIR, 1, HG_DAMAGE, 8); // 8 > 10
set_hitbox_value(AT_BAIR, 1, HG_ANGLE, 135);
set_hitbox_value(AT_BAIR, 1, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_BAIR, 1, HG_KNOCKBACK_SCALING, 0.4); //0.5 > 0.6
...
set_hitbox_value(AT_BAIR, 3, 81, "Early Hit"); // Woodcock Name
