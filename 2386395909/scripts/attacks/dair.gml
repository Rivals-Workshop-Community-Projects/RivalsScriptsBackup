...
set_hitbox_value(AT_DAIR, 1, 81, "Outer Hitbox");
...
set_hitbox_value(AT_DAIR, 2, 81, "Center Hitbox");
...
set_hitbox_value(AT_DAIR, 3, 81, "Late Hitbox");
...
set_hitbox_value(AT_DAIR, 3, HG_DAMAGE, 7); //old 12
set_hitbox_value(AT_DAIR, 3, HG_ANGLE, 270);
set_hitbox_value(AT_DAIR, 3, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_DAIR, 3, HG_KNOCKBACK_SCALING, 0.3); // Made more the same as aother hitboxes
