...
set_attack_value(AT_DSTRONG, AG_HURTBOX_SPRITE, sprite_get("ihurt"));
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_kragg_rock_land"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 54);
...
set_hitbox_value(AT_DSTRONG, 2, HG_WIDTH, 54);
