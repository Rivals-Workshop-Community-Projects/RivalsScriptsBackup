...
set_attack_value(AT_FTILT, AG_HURTBOX_SPRITE, sprite_get("ihurt"));
...
set_window_value(AT_FTILT, 2, AG_WINDOW_SFX, sound_get("THROW4"));
...
set_window_value(AT_FTILT, 3, AG_WINDOW_HAS_WHIFFLAG, 2);
...
set_hitbox_value(AT_FTILT, 1, HG_LIFETIME, 26);
...
set_hitbox_value(AT_FTILT, 1, HG_PROJECTILE_SPRITE, sprite_get("magicproj2"));
set_hitbox_value(AT_FTILT, 1, HG_PROJECTILE_MASK, sprite_get("magicproj2"));
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, sound_get("MAGICHIT2"));
