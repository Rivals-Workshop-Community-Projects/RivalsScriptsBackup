...
set_window_value(AT_JAB, 5, AG_WINDOW_TYPE, 2);
...
set_window_value(AT_JAB, 6, AG_WINDOW_TYPE, 3);
...
set_window_value(AT_JAB, 8, AG_WINDOW_TYPE, 2);
...
set_window_value(AT_JAB, 9, AG_WINDOW_TYPE, 5);
...
set_hitbox_value(AT_JAB, 3, HG_ANGLE, 48);
set_hitbox_value(AT_JAB, 3, HG_BASE_KNOCKBACK, 6.7);
