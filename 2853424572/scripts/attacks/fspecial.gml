...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, .17);
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .17);
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_CUSTOM_GRAVITY, .0625);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT, 311);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_oly_dspecial_armorhit"));
