...
set_attack_value(AT_NSPECIAL, AG_NO_PARRY_STUN, 1);

set_window_value(AT_NSPECIAL, 1, AG_WINDOW_LENGTH, 15);
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX_FRAME, 13);
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_ori_dtilt_perform"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HITSTUN_MULTIPLIER, 1.33);
set_hitbox_value(AT_NSPECIAL, 1, HG_BASE_HITPAUSE, 4);
set_hitbox_value(AT_NSPECIAL, 1, HG_EXTRA_HITPAUSE, 9);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, sound_get("se_common_cliff_catch"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HIT_SFX, sound_get("se_common_cliff_catch"));