...
set_window_value(AT_DAIR, 2, AG_WINDOW_CUSTOM_GRAVITY, .75);
...
set_window_value(AT_DAIR, 3, AG_WINDOW_CUSTOM_GRAVITY, .75);
...
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, sound_get("se_common_blowaway_meteor"));
...
set_hitbox_value(AT_DAIR, 2, HG_BASE_KNOCKBACK, 1.5);
...
set_hitbox_value(AT_DAIR, 2, HG_HITSTUN_MULTIPLIER, 1.33);
