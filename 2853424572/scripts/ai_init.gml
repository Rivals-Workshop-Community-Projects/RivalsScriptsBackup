...
close_side_attacks[5] = AT_USPECIAL;
close_side_attacks[6] = AT_FSTRONG;
close_side_attacks[7] = AT_UTILT;
close_side_attacks[8] = AT_FAIR;
close_side_attacks[9] = AT_BAIR;
close_side_attacks[10] = AT_BAIR;
close_side_attacks[11] = AT_BAIR;
...
neutral_attacks[7] = AT_JAB;
neutral_attacks[8] = AT_JAB;