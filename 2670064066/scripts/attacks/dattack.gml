...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sound_get("AR"));
...
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX, sound_get("AR"));
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_SFX, sound_get("AR"));
...
set_hitbox_value(AT_DATTACK, 1, HG_HITSTUN_MULTIPLIER, 2.5);
...
set_hitbox_value(AT_DATTACK, 2, HG_HITSTUN_MULTIPLIER, 2.5);
...
set_hitbox_value(AT_DATTACK, 3, HG_HITSTUN_MULTIPLIER, 2.5);
...
set_hitbox_value(AT_DATTACK, 4, HG_WINDOW_CREATION_FRAME, 7);
