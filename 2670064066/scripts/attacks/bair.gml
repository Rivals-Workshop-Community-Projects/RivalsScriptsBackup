...
set_window_value(AT_BAIR, 5, AG_WINDOW_SFX, asset_get("sfx_swipe_medium2"));
...
set_window_value(AT_BAIR, 7, AG_WINDOW_LENGTH, 2);
set_window_value(AT_BAIR, 7, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_BAIR, 7, AG_WINDOW_ANIM_FRAME_START, 14);

set_window_value(AT_BAIR, 8, AG_WINDOW_TYPE, 1);
set_window_value(AT_BAIR, 8, AG_WINDOW_LENGTH, 4);
set_window_value(AT_BAIR, 8, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_BAIR, 8, AG_WINDOW_ANIM_FRAME_START, 16);

set_window_value(AT_BAIR, 9, AG_WINDOW_TYPE, 1);
set_window_value(AT_BAIR, 9, AG_WINDOW_LENGTH, 4);
set_window_value(AT_BAIR, 9, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_BAIR, 9, AG_WINDOW_ANIM_FRAME_START, 19);
set_window_value(AT_BAIR, 9, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_BAIR, 9, AG_WINDOW_SFX, asset_get("sfx_swipe_medium2"));
set_window_value(AT_BAIR, 9, AG_WINDOW_SFX_FRAME, 3);

set_window_value(AT_BAIR, 10, AG_WINDOW_TYPE, 1);
set_window_value(AT_BAIR, 10, AG_WINDOW_LENGTH, 2);
set_window_value(AT_BAIR, 10, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_BAIR, 10, AG_WINDOW_ANIM_FRAME_START, 21);

set_window_value(AT_BAIR, 11, AG_WINDOW_TYPE, 1);
set_window_value(AT_BAIR, 11, AG_WINDOW_LENGTH, 2);
set_window_value(AT_BAIR, 11, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_BAIR, 11, AG_WINDOW_ANIM_FRAME_START, 22);

set_window_value(AT_BAIR, 12, AG_WINDOW_TYPE, 1);
set_window_value(AT_BAIR, 12, AG_WINDOW_LENGTH, 4);
set_window_value(AT_BAIR, 12, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_BAIR, 12, AG_WINDOW_ANIM_FRAME_START, 24);
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("slash1"));
...
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, sound_get("slash1"));
...
set_hitbox_value(AT_BAIR, 3, HG_HITBOX_X, -37);
...
set_hitbox_value(AT_BAIR, 3, HG_HIT_SFX, sound_get("slash2"));
