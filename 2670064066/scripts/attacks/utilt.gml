...
set_hitbox_value(AT_UTILT, 1, HG_ANGLE, 92);
set_hitbox_value(AT_UTILT, 1, HG_HITSTUN_MULTIPLIER, 1.8);
...
//set_hitbox_value(AT_UTILT, 1, HG_EXTRA_CAMERA_SHAKE, 2);
...
set_hitbox_value(AT_UTILT, 2, HG_HITSTUN_MULTIPLIER, 1.8);
