...
set_attack_value(AT_NSPECIAL_2, AG_SPRITE, sprite_get("PR"));
...
set_attack_value(AT_NSPECIAL_2, AG_AIR_SPRITE, sprite_get("PR"));
set_attack_value(AT_NSPECIAL_2, AG_HURTBOX_SPRITE, sprite_get("PR_hurt"));
...
set_window_value(AT_NSPECIAL_2, 1, AG_WINDOW_SFX, sound_get("PLASMA"));
...
set_window_value(AT_NSPECIAL_2, 3, AG_WINDOW_SFX, sound_get("PLASMA"));
...
set_window_value(AT_NSPECIAL_2, 5, AG_WINDOW_LENGTH, 1);
...
set_hitbox_value(AT_NSPECIAL_2, 1, HG_PROJECTILE_SPRITE, sprite_get("PR proj"));
set_hitbox_value(AT_NSPECIAL_2, 1, HG_PROJECTILE_MASK, sprite_get("PR coll"));
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HIT_SFX, asset_get("sfx_clairen_hit_weak"));
set_hitbox_value(AT_NSPECIAL_2, 1, HG_PROJECTILE_ANIM_SPEED, 1);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_PROJECTILE_HSPEED, 30);
...
set_hitbox_value(AT_NSPECIAL_2, 2, HG_BASE_KNOCKBACK, 1);
set_hitbox_value(AT_NSPECIAL_2, 2, HG_KNOCKBACK_SCALING, 0);
set_hitbox_value(AT_NSPECIAL_2, 2, HG_ANGLE, 70);
set_hitbox_value(AT_NSPECIAL_2, 2, HG_VISUAL_EFFECT, 111);
//set_hitbox_value(AT_NSPECIAL_2, 2, HG_VISUAL_EFFECT_Y_OFFSET, -16);
set_hitbox_value(AT_NSPECIAL_2, 2, HG_HITSTUN_MULTIPLIER, 0.6);
set_hitbox_value(AT_NSPECIAL_2, 2, HG_PROJECTILE_SPRITE, sprite_get("PR proj"));
set_hitbox_value(AT_NSPECIAL_2, 2, HG_PROJECTILE_MASK, sprite_get("PR coll"));
set_hitbox_value(AT_NSPECIAL_2, 2, HG_HIT_SFX, asset_get("sfx_clairen_hit_weak"));
set_hitbox_value(AT_NSPECIAL_2, 2, HG_PROJECTILE_ANIM_SPEED, 1);
set_hitbox_value(AT_NSPECIAL_2, 2, HG_PROJECTILE_HSPEED, 30);