...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, sound_get("activate"));
...
set_window_value(AT_USTRONG, 4, AG_WINDOW_SFX, sound_get("SWING"));
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, 124);
//set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("ENSW"));
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, 124);
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("ENSW"));
//set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, -10);