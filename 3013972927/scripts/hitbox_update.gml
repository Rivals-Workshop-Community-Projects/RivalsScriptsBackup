...
switch (attack)
{
    case AT_NSPECIAL: //multihit
        if (hbox_num == 2)
        {
            //if the hitbox sees blocks it should collide with, the nspec_found_target variable is set to true
           // if (place_meeting(x, y, asset_get("par_block")) || place_meeting(x, y, asset_get("par_jumpthrough"))) player_id.nspec_found_target = true;
        }
