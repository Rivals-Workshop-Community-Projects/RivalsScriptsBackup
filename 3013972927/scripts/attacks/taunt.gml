...
set_window_value(atk, window_num, AG_WINDOW_SFX, asset_get("sfx_clairen_nspecial_grab_success"));
...
set_window_value(atk, window_num, AG_WINDOW_HAS_SFX, 1);
set_window_value(atk, window_num, AG_WINDOW_SFX, asset_get("sfx_troupple_swipe"));
