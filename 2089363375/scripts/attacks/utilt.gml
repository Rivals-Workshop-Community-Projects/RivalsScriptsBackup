...
cat_attack_spr[AT_UTILT] = sprite_get("cat_utilt");
cat_attack_hurtbox_spr[AT_UTILT] = sprite_get("cat_utilt_hurt");
cat_window_amount[AT_UTILT] = 3;
cat_window_min[AT_UTILT] = 4;
cat_window_max[AT_UTILT] = 6;
cat_hitbox_amount[AT_UTILT] = 2;
cat_window_hitbox_min[AT_UTILT] = 3;
cat_window_hitbox_max[AT_UTILT] = 4;
...
set_hitbox_value(AT_UTILT, 4, HG_WINDOW, 6);
...
set_hitbox_value(AT_UTILT, 4, HG_KNOCKBACK_SCALING, .25);
set_hitbox_value(AT_UTILT, 4, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_UTILT, 4, HG_HITPAUSE_SCALING, .25);
set_hitbox_value(AT_UTILT, 4, HG_VISUAL_EFFECT_Y_OFFSET, -8);
