...
//NOTE: Cat does not have any animations, windows, or hitboxes.
//He just returns to Mitama here...
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_CUSTOM_GRAVITY, 0.35);
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX_FRAME, 17);
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_zetter_fireball_fire"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_ANIM_SPEED, 0.35);
...
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, uspecial_fx);
...
set_hitbox_value(AT_USPECIAL, 2, HG_PROJECTILE_VSPEED, 15);
...
set_hitbox_value(AT_USPECIAL, 2, HG_PROJECTILE_DESTROY_EFFECT, uspecial_fx);
set_hitbox_value(AT_USPECIAL, 2, HG_VISUAL_EFFECT, 3);
set_hitbox_value(AT_USPECIAL, 2, HG_HIT_SFX, asset_get("sfx_ori_grenade_hit"));