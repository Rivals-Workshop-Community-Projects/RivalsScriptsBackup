...
sprite_index = sprite_get("flowey");           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
image_index = 0;  
image_alpha = 0;
mask_index = sprite_get("floweymask");//The frame in the animation the article should start at. 0 = beginning of animation
...
new_sprite = sprite_get("flowertheflowey");             //This is another part of the animation handling. It tells the game "this is the sprite this article should be using; if it's not already, switch it over please"
