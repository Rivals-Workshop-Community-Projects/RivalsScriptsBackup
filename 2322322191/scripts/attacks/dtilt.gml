...
set_window_value(AT_DTILT, 2, AG_WINDOW_HSPEED, 13); // old 9 
set_window_value(AT_DTILT, 2, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_DTILT, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.8);
set_window_value(AT_DTILT, 2, AG_WINDOW_HSPEED_TYPE, 2);


set_window_value(AT_DTILT, 3, AG_WINDOW_TYPE, 0);
set_window_value(AT_DTILT, 3, AG_WINDOW_LENGTH, 12);//OLD 7
...
set_hitbox_value(AT_DTILT, 1, HG_BASE_HITPAUSE, 13);
