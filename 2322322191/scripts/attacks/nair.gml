...
set_hitbox_value(AT_NAIR, 1, HG_DAMAGE, 3); //old 6
set_hitbox_value(AT_NAIR, 1, HG_ANGLE, 80); // old 65
...
set_hitbox_value(AT_NAIR, 2, HG_DAMAGE, 3); //old 6
...
set_hitbox_value(AT_NAIR, 3, HG_HITBOX_X, 55);
...
set_hitbox_value(AT_NAIR, 3, HG_DAMAGE, 3); //old 6 
set_hitbox_value(AT_NAIR, 3, HG_ANGLE, 60); // old 361
...
set_hitbox_value(AT_NAIR, 4, HG_DAMAGE, 3); //old 6
set_hitbox_value(AT_NAIR, 4, HG_ANGLE, 60); //old 361
