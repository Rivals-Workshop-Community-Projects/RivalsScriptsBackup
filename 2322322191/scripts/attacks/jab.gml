...
set_window_value(AT_JAB, 9, AG_WINDOW_ANIM_FRAME_START, 3);
...
set_window_value(AT_JAB, 11, AG_WINDOW_ANIM_FRAME_START, 8);
set_window_value(AT_JAB, 11, AG_WINDOW_HSPEED_TYPE, 2);
set_window_value(AT_JAB, 11, AG_WINDOW_HSPEED, 3);
...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("snd_punchweak"));
...
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, sound_get("snd_punchweak"));
...
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, sound_get("snd_punchweak"));
...
set_hitbox_value(AT_JAB, 4, HG_WIDTH, 52);
...
set_hitbox_value(AT_JAB, 4, HG_VISUAL_EFFECT, tough_glove);
set_hitbox_value(AT_JAB, 4, HG_HIT_SFX, sound_get("snd_punchstrong"));