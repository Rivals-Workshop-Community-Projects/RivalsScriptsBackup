...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, .7);
...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("snd_laz"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_X, 11);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sound_get("snd_damage"));
...
set_hitbox_value(AT_FSTRONG, 2, HG_WIDTH, 24);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, sound_get("snd_damage"));
