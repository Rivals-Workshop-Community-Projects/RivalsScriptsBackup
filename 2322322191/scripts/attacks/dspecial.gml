...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, sound_get("snd_squeak"));
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_CUSTOM_GRAVITY, 1.0);
...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.0);
