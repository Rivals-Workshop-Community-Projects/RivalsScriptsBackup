...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, asset_get("sfx_clairen_swing_med"));
...
set_hitbox_value(AT_BAIR, 2, HG_HITPAUSE_SCALING, 1.0);
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT, 256);
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, -32);
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, asset_get("sfx_clairen_hit_strong"));
