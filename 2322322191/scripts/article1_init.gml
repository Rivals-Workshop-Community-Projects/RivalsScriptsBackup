...
sprite_index = noone;           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
image_index = 0;                
image_alpha = 1;
mask_index = noone;
times_parried = 0;
object_type=1; // type 0 = soul, type 1= friendliness pellet.
...
gothit = false; 
dir=noone;
iframes = 60;//The vertical speed of the article.
timerpg = 0;
timerpg2 = 0;
createbox = true;
mode = 0;
...
new_sprite = sprite_get("soul");             //This is another part of the animation handling. It tells the game "this is the sprite this article should be using; if it's not already, switch it over please"
