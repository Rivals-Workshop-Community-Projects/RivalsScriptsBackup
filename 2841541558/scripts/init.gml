...
wave_land_adj       = 1.0;		// 1.2  -  1.5      idk what zetterburn's is
...
// VFX
nspecial_puff_fx = hit_fx_create(sprite_get("nspecial_puff_fx"), 24);
wood_small = hit_fx_create(sprite_get("hfx_wood_small"), 18);
wood_large = hit_fx_create(sprite_get("hfx_wood_large"), 21);
wood_largest = hit_fx_create(sprite_get("hfx_wood_largest"), 28);
flower_small = hit_fx_create(sprite_get("hfx_flower_small"), 18);
flower_large = hit_fx_create(sprite_get("hfx_flower_large"), 20);

// Variables
whispyRoot = noone;
root_grounded_type = 0;
gotHitOutOfFSpecial = false;
rootYPlaceOffset = 0;
rootYPlaceOffsetReal = 0;
rootCannotBePlaced = false;
aused = 0
nspec_charge = 0;
apples = 0;
is_spam_whispy_woods = true;
...
// Hurtbox sprites
hurtbox_spr         = sprite_get("tree_hurtbox");
crouchbox_spr       = sprite_get("tree_crouch_hurtbox");
air_hurtbox_spr     = -1; // -1 = use hurtbox_spr
hitstun_hurtbox_spr = -1; // -1 = use hurtbox_spr

// Victory
set_victory_bg(sprite_get("victory_background")); // victory_background.png
set_victory_theme(sound_get("whispyvictory")); // victory_theme.ogg
...
puff_fx1 = hit_fx_create( sprite_get( "puff_fx1" ),  8);

root_spawn_while_airborne = false;

//Compatibility
Hikaru_Title = "Forest Guardian";
arena_title = "Stubborn Forest Guardian";
battle_text = "Whispy Woods stands in your path!"
kf_custom_icon = sprite_get("ability_wsp");
kf_hud_name = "Whispy Woods";

// MunoPhone Touch code - don't touch
// should be at BOTTOM of file, but above any #define lines
apple = hit_fx_create( sprite_get("applepop"), 30 )
