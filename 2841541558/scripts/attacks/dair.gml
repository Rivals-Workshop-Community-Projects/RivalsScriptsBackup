...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, asset_get("sfx_syl_ustrong"));
...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, wood_largest);
...
set_hitbox_value(AT_DAIR, 2, HG_WINDOW_CREATION_FRAME, 7);
...
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT, wood_large);
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, 40);
