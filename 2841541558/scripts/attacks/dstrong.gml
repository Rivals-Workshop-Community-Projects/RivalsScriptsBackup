...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_leaves"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, flower_large);
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, flower_large);
