...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, asset_get("sfx_syl_fstrong"));
...
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT, wood_small);
...
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT, wood_small);
