...
set_window_value(AT_BAIR, 2, AG_WINDOW_SFX, asset_get("sfx_may_root"));
...
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, wood_small);
...
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT, wood_small);
...
set_hitbox_value(AT_BAIR, 3, HG_WIDTH, 78);
...
set_hitbox_value(AT_BAIR, 3, HG_VISUAL_EFFECT, wood_small);
