...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_syl_dstrong"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_VISUAL_EFFECT, flower_small);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_PROJECTILE_COLLISION_SPRITE, sprite_get("dspecial_proj_hit_mask"));
