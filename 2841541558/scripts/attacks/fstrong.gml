...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_kragg_spike"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, wood_large);
...
set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT, wood_largest);
set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, asset_get("hfx_wood_largest"));
