...
set_window_value(AT_USTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_pillar_crumble"));

set_window_value(AT_USTRONG, 2, AG_WINDOW_LENGTH, 11);
set_window_value(AT_USTRONG, 2, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_USTRONG, 2, AG_WINDOW_ANIM_FRAME_START, 3);
set_window_value(AT_USTRONG, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_syl_ustrong"));
...
set_hitbox_value(AT_USTRONG, 1, HG_WIDTH, 146);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, wood_large);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, wood_large);
...
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_Y, -125);
...
set_hitbox_value(AT_USTRONG, 3, HG_VISUAL_EFFECT, wood_largest);
...
set_hitbox_value(AT_USTRONG, 4, HG_HITBOX_Y, -125);
...
set_hitbox_value(AT_USTRONG, 4, HG_DAMAGE, 16);
...
set_hitbox_value(AT_USTRONG, 4, HG_VISUAL_EFFECT, wood_largest);
