...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_HITPAUSE_FRAME, 13);
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, HFX_ETA_ICE_HUGE);
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, HFX_ETA_ICE_HUGE);
...
set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_Y, -140);
...
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT, HFX_ABS_ZAP_HUGE);
...
set_hitbox_value(AT_DSTRONG, 4, HG_VISUAL_EFFECT, HFX_ABS_ZAP_DIR);
...
set_hitbox_value(AT_DSTRONG, 4, HG_PROJECTILE_LIFESPAN, 0);
