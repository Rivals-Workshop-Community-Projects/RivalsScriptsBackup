...
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, -10);
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, asset_get("sfx_blow_medium2"));

// main hitbox again but relocated
...
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT_X_OFFSET, 26);
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT_X_OFFSET, -10);
