...
set_attack_value(AT_DSTRONG, AG_CATEGORY, 0 + (strongsUseableInAirRune * 2)); // rune
...
// endlag 2 (so the pose can be held more)
...
set_num_hitboxes(AT_DSTRONG, 1 + (strongsUseableInAirRune * 1));

// main hitbox (grounded only)
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, -2);
