...
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("fspecial_rock"));
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("fspecial_rock"));
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_GRAVITY, .5);
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_VSPEED, chuckVsp*.8);
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_HSPEED, chuckHsp*.8);
