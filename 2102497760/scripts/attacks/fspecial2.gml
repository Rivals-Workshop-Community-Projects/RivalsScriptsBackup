...
set_attack_value(AT_FSPECIAL_2, AG_SPRITE, sprite_get("ou_fair"));
...
set_attack_value(AT_FSPECIAL_2, AG_HURTBOX_SPRITE, sprite_get("nair_hurt"));

set_window_value(AT_FSPECIAL_2, 1, AG_WINDOW_LENGTH, 8);
set_window_value(AT_FSPECIAL_2, 1, AG_WINDOW_HSPEED_TYPE, 2);
set_window_value(AT_FSPECIAL_2, 1, AG_WINDOW_HSPEED, 10);
set_window_value(AT_FSPECIAL_2, 1, AG_WINDOW_VSPEED_TYPE, 2);
set_window_value(AT_FSPECIAL_2, 1, AG_WINDOW_VSPEED, -2);
...
set_window_value(AT_FSPECIAL_2, 2, AG_WINDOW_SFX, asset_get("sfx_absa_jab1"));
...
set_window_value(AT_FSPECIAL_2, 4, AG_WINDOW_SFX, asset_get("sfx_absa_jab1"));
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HITBOX_X, 27);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HIT_LOCKOUT, 0);
...
set_hitbox_value(AT_FSPECIAL_2, 2, HG_HITBOX_X, 27);
