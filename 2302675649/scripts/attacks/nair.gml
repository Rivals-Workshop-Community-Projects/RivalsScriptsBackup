...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, sound_get("slash6"));
...
set_window_value(AT_NAIR, 2, AG_WINDOW_SFX, sound_get("slash2"));
...
set_window_value(AT_NAIR, 3, AG_WINDOW_SFX, sound_get("slash1"));
...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sound_get("hit3"));
...
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_X, 57);
...
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, sound_get("hit3"));
...
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, sound_get("hit3"));
...
set_hitbox_value(AT_NAIR, 4, HG_HITBOX_X, 35);
