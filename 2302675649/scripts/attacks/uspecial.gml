...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_TYPE, 1); // slash
...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_SFX, sound_get("slash4"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_HIT_SFX, sound_get("hit3"));
...
set_hitbox_value(AT_USPECIAL, 2, HG_HEIGHT, 42);
...
set_hitbox_value(AT_USPECIAL, 2, HG_KNOCKBACK_SCALING, 1.05);
set_hitbox_value(AT_USPECIAL, 2, HG_BASE_HITPAUSE, 20);
set_hitbox_value(AT_USPECIAL, 2, HG_EXTRA_HITPAUSE, 14);
set_hitbox_value(AT_USPECIAL, 2, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_USPECIAL, 2, HG_HIT_SFX, sound_get("hit1"));
...
set_hitbox_value(AT_USPECIAL, 3, HG_KNOCKBACK_SCALING, 1.05);
set_hitbox_value(AT_USPECIAL, 3, HG_BASE_HITPAUSE, 20);
set_hitbox_value(AT_USPECIAL, 3, HG_EXTRA_HITPAUSE, 14);
