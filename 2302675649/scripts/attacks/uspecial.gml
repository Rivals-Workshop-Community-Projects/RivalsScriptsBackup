...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_TYPE, 1); // fly
...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_TYPE, 1); // slash
...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX, sound_get("slash4"));
