...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_LENGTH, has_rune("O")?10:18);
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_ANIM_FRAMES, 6);
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sound_get("gunload"));
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX_FRAME, 1);

set_window_value(AT_FSPECIAL, 2, AG_WINDOW_TYPE, 1); // loop
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_LENGTH, has_rune("O")?8:16);
...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_SFX_FRAME, has_rune("O")?6:14);

set_window_value(AT_FSPECIAL, 3, AG_WINDOW_TYPE, 1); // shoot
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_TYPE, 9); // loop 2
...
set_window_value(AT_FSPECIAL, 6, AG_WINDOW_TYPE, has_rune("E")?1:7); // nyoom
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_Y, -47);
