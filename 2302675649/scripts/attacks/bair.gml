...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("slash2"));
...
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, sound_get("hit2"));
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT, 306);