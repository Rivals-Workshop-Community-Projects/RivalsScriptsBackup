...
if _init == 0 {
    /*if spawn_variables[0] < 1000 {
        ...
        spr_ = spawn_variables[0];
        spr_name = sprite_get_name(spawn_variables[0]);
    ...
    //sprite_change_collision_mask(spr_name,true, 0, 0, 0, 0, 0, 0 );
    //sprite_change_collision_mask(spr_name,true, 2, 0, 0, sprite_get_width(spr_), sprite_get_height(spr_), 0 );
    mask_index = sprite_index;
    anim_speed = spawn_variables[1]*.01;
    group = spawn_variables[2];
    static = spawn_variables[3];
