...
set_hitbox_value(AT_NSPECIAL, 1, HG_WIDTH, 36); //32
set_hitbox_value(AT_NSPECIAL, 1, HG_HEIGHT, 36); //32
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("nspecial_active"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_HSPEED, 7); //6
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_VSPEED, 7); //3
