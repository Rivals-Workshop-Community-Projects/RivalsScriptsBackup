...
set_window_value(AT_NTHROW, 1, AG_WINDOW_SFX, asset_get("sfx_kragg_throw"));
...
set_hitbox_value(AT_NTHROW, 1, HG_WINDOW_CREATION_FRAME, 6);
...
set_hitbox_value(AT_NTHROW, 1, HG_HITBOX_Y, -70);
set_hitbox_value(AT_NTHROW, 1, HG_HITBOX_X, -50);
...
set_hitbox_value(AT_NTHROW, 1, HG_KNOCKBACK_SCALING, 1.2);
set_hitbox_value(AT_NTHROW, 1, HG_BASE_HITPAUSE, 13);
set_hitbox_value(AT_NTHROW, 1, HG_HIT_SFX, asset_get("sfx_blow_heavy1"));
set_hitbox_value(AT_NTHROW, 1, HG_HITPAUSE_SCALING, .65);
