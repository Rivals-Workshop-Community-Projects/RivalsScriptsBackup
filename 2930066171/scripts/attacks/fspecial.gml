...
set_hitbox_value(AT_FSPECIAL, 1, HG_WIDTH, 30); //40
set_hitbox_value(AT_FSPECIAL, 1, HG_HEIGHT, 30); //40
...
set_hitbox_value(AT_FSPECIAL, 2, HG_WIDTH, 80); //40
set_hitbox_value(AT_FSPECIAL, 2, HG_HEIGHT, 66); //40
...
set_hitbox_value(AT_FSPECIAL, 2, HG_VISUAL_EFFECT,  HFX_GEN_BIG);
set_hitbox_value(AT_FSPECIAL, 2, HG_VISUAL_EFFECT_Y_OFFSET,  2000);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, -4);
set_hitbox_value(AT_FSPECIAL, 2, HG_IGNORES_PROJECTILES, 1);
set_hitbox_value(AT_FSPECIAL, 2, HG_EFFECT, 9); //Polite Grab
