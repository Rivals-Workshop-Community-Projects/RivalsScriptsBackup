...
set_window_value(AT_UTILT, 1, AG_WINDOW_LENGTH, 21);
set_window_value(AT_UTILT, 1, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_UTILT, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy1"));
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX_FRAME, 18);
...
set_window_value(AT_UTILT, 4, AG_WINDOW_VSPEED, 20);
...
set_hitbox_value(AT_UTILT, 1, HG_LIFETIME, 12);
...
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX,  asset_get("sfx_clairen_nspecial_grab_success"));
