...
set_window_value(AT_FTHROW, 1, AG_WINDOW_SFX, asset_get("sfx_kragg_throw"));
...
set_hitbox_value(AT_FTHROW, 1, HG_WINDOW_CREATION_FRAME, 6);
...
set_hitbox_value(AT_FTHROW, 1, HG_HITBOX_X, 55);
...
set_hitbox_value(AT_FTHROW, 1, HG_ANGLE,  35);
...
set_hitbox_value(AT_FTHROW, 1, HG_HITSTUN_MULTIPLIER, .5);
set_hitbox_value(AT_FTHROW, 1, HG_HIT_SFX, asset_get("sfx_blow_medium1"));
set_hitbox_value(AT_FTHROW, 1, HG_HIT_LOCKOUT,  0);
