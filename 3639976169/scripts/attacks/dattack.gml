...
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX, asset_get("sfx_ori_dsmash_skitter_alone"));
...
set_window_value(AT_DATTACK, 2, AG_WINDOW_HSPEED, 11.2);
...
set_hitbox_value(AT_DATTACK, 1, HG_EFFECT, 6);
set_hitbox_value(AT_DATTACK, 1, HG_BASE_HITPAUSE, 12);
set_hitbox_value(AT_DATTACK, 1, HG_EXTRA_HITPAUSE, -7);
