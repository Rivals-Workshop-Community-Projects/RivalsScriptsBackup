...
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT, HFX_KRA_ROCK_BIG);
set_hitbox_value(AT_USPECIAL, 1, HG_HIT_SFX, asset_get("sfx_blow_heavy2"));
set_hitbox_value(AT_USPECIAL, 1, HG_BASE_KNOCKBACK, 5.85);
...
set_hitbox_value(AT_USPECIAL, 2, HG_PROJECTILE_DESTROY_EFFECT, HFX_KRA_ROCK_SMALL);