...
set_hitbox_value(AT_FAIR, 1, HG_BASE_KNOCKBACK, 4.15);
...
set_hitbox_value(AT_FAIR, 1, HG_HITSTUN_MULTIPLIER, .9);
...
set_hitbox_value(AT_FAIR, 2, HG_ANGLE, 350);
set_hitbox_value(AT_FAIR, 2, HG_BASE_KNOCKBACK, 5.075);
set_hitbox_value(AT_FAIR, 2, HG_KNOCKBACK_SCALING, .675);
set_hitbox_value(AT_FAIR, 2, HG_BASE_HITPAUSE, 16);
set_hitbox_value(AT_FAIR, 1, HG_EXTRA_HITPAUSE, -4);
set_hitbox_value(AT_FAIR, 2, HG_HITPAUSE_SCALING, .9);
set_hitbox_value(AT_FAIR, 2, HG_HITSTUN_MULTIPLIER, .875);
set_hitbox_value(AT_FAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, 18);
