...
set_window_value(AT_DTILT, 2, AG_WINDOW_SFX, sound_get("beam2"));
...
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, asset_get("sfx_zetter_downb"));
...
set_hitbox_value(AT_DTILT, 2, HG_HITSTUN_MULTIPLIER, 0.5);
...
set_hitbox_value(AT_DTILT, 2, HG_HIT_SFX, asset_get("sfx_zetter_upb_hit"));
