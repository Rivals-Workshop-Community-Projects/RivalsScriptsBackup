...
set_hitbox_value(AT_NAIR, 1, HG_KNOCKBACK_SCALING, .75);
...
set_hitbox_value(AT_NAIR, 2, HG_BASE_KNOCKBACK, 3.4);
...
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, 18);
...
//set_window_value(AT_NAIR, 2, AG_WINDOW_HITPAUSE_FRAME, 4);
...
set_hitbox_value(AT_NAIR, 1, HG_ANGLE, 361);
set_hitbox_value(AT_NAIR, 1, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_NAIR, 1, HG_BASE_KNOCKBACK, 5.2);
set_hitbox_value(AT_NAIR, 1, HG_KNOCKBACK_SCALING, .75);
set_hitbox_value(AT_NAIR, 1, HG_BASE_HITPAUSE, 12);
set_hitbox_value(AT_NAIR, 1, HG_EXTRA_HITPAUSE, -4);
set_hitbox_value(AT_NAIR, 1, HG_HITPAUSE_SCALING, .2);
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT, HFX_ETA_ICE_BIG);
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, asset_get("sfx_ice_nspecial_hit_ground"));
...
set_hitbox_value(AT_NAIR, 2, HG_ANGLE, 361);
set_hitbox_value(AT_NAIR, 2, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_NAIR, 2, HG_BASE_KNOCKBACK, 4.4);
set_hitbox_value(AT_NAIR, 2, HG_KNOCKBACK_SCALING, .7);
set_hitbox_value(AT_NAIR, 2, HG_BASE_HITPAUSE, 9);
set_hitbox_value(AT_NAIR, 1, HG_EXTRA_HITPAUSE, -4);
set_hitbox_value(AT_NAIR, 2, HG_HITPAUSE_SCALING, .2);
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, 18);
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT, HFX_ETA_ICEPOP_BIG);
