...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, .7);
set_window_value(AT_FSTRONG, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, .7);
...
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT, slapstick_dust);
