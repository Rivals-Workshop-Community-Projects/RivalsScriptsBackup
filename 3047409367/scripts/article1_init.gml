...
timer = 600; //time until it disappears automatically
...
sprite_index = sprite_get("daruma_initial");           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
mask_index = sprite_get("daruma_initial");
