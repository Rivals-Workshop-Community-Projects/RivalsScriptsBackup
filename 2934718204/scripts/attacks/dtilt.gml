...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, sound_get("hornet_sword"));
...
set_window_value(AT_DTILT, 2, AG_WINDOW_SFX, sound_get("hornet_sword"));
...
set_hitbox_value(AT_DTILT, 2, HG_HITBOX_GROUP, 3);