...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("claw_swipe1"));
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX_FRAME, 5);
set_window_value(AT_UTILT, 1, AG_WINDOW_CUSTOM_GRAVITY, 0.6);
...
set_hitbox_value(AT_UTILT, 2, HG_WIDTH, 25);
