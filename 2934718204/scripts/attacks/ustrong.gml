...
set_window_value(AT_USTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_clairen_fspecial_dash"));
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, vfx_shockwave);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, vfx_shockwave);
