...
// Trans outline
if (get_player_color(player) == 9 && !(attack == AT_DSPECIAL && window < 4 && (state == PS_ATTACK_AIR || state == PS_ATTACK_GROUND)) && !(attack == AT_USPECIAL && window > 1 && window < 5 && (state == PS_ATTACK_AIR || state == PS_ATTACK_GROUND))){
