...
//	draw_debug_text(x-10,y+10,string(fsp_angle_str));
//	draw_debug_text(x-10,y+10,"effecttrack:"+string(in_effect_tracker));
//	draw_debug_text(x-10,y+10,"effecttrack:"+string(fspecial_timer));
	draw_debug_text(x-10,y+10,"jumpstore:"+string(fsp_jump_storage));
	draw_debug_text(x-10,y+30,"jumps:"+string(djumps));
