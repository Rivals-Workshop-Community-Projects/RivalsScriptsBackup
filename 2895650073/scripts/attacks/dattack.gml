...
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX, asset_get("sfx_ori_stomp_hit"));
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX_FRAME, 15);
...
set_hitbox_value(AT_DATTACK, 1, HG_DRIFT_MULTIPLIER, -1.1)
...
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, asset_get("sfx_icehit_heavy2"));
