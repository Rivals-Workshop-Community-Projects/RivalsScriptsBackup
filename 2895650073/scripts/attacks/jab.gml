...
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, asset_get("sfx_oly_fspecial_start"));
...
set_window_value(AT_JAB, 5, AG_IASA, 1);
...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, asset_get("sfx_waveland_mol"));