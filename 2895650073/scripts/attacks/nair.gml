...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, asset_get("sfx_waveland_gus"));
...
set_window_value(AT_NAIR, 4, AG_IASA, 1);
...
set_window_value(AT_NAIR, 6, AG_WINDOW_ANIM_FRAME_START, 13);
set_window_value(AT_NAIR, 6, AG_WINDOW_ANIM_FRAMES, 3);

set_window_value(AT_NAIR, 7, AG_WINDOW_LENGTH, 5);
set_window_value(AT_NAIR, 7, AG_WINDOW_ANIM_FRAME_START, 19);
...
set_hitbox_value(AT_NAIR, 1, HG_WIDTH, 51);
...
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, asset_get("sfx_shovel_hit_light1"));
...
set_hitbox_value(AT_NAIR, 3, HG_HITBOX_Y, -13);
set_hitbox_value(AT_NAIR, 3, HG_WIDTH, 51);
set_hitbox_value(AT_NAIR, 3, HG_HEIGHT, 23);
...
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, asset_get("sfx_shovel_hit_light1"));
