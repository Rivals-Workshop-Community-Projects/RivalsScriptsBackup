...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_SFX, sound_get("claw_swipe2"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("blade_hit_heavy"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("blade_hit_heavy"));
