...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, sound_get("uspec_swing"));
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_CUSTOM_GRAVITY, 1.1);
...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_CUSTOM_GRAVITY, 1.1);
...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_CUSTOM_GRAVITY, 1.3);
...
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT, fstrong_vfx);
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT_Y_OFFSET, -30);
