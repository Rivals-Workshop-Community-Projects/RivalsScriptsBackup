...
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, sound_get("blade_hit_medium"));
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT, 303);
set_hitbox_value(AT_NAIR, 2, HG_HITSTUN_MULTIPLIER, 0.85);
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_GROUP, 8);
