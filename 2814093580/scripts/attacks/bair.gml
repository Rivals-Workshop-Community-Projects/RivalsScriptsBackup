...
set_hitbox_value(AT_BAIR, 1, HG_DAMAGE, has_rune("J")? 13:9);
set_hitbox_value(AT_BAIR, 1, HG_ANGLE, 135);
set_hitbox_value(AT_BAIR, 1, HG_BASE_KNOCKBACK, has_rune("J")? 8:6);
set_hitbox_value(AT_BAIR, 1, HG_KNOCKBACK_SCALING, has_rune("J")? 0.8:0.7);
set_hitbox_value(AT_BAIR, 1, HG_BASE_HITPAUSE, has_rune("J")? 25:20);
set_hitbox_value(AT_BAIR, 1, HG_HITPAUSE_SCALING, has_rune("J")? 1.3:1.0);
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, 301);
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, has_rune("J")? sound_get("spearcutsweet"):sound_get("spearcut"));
