...
set_window_value(AT_NSPECIAL_AIR, 2, AG_WINDOW_SFX, asset_get("sfx_shovel_swing_med1"));
set_window_value(AT_NSPECIAL_AIR, 2, AG_WINDOW_SFX_FRAME, 1);

set_window_value(AT_NSPECIAL_AIR, 3, AG_WINDOW_TYPE, 1);
set_window_value(AT_NSPECIAL_AIR, 3, AG_WINDOW_LENGTH, 17);
...
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_WINDOW, 9);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_LIFETIME, 999);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_HITBOX_Y, -38);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_HITBOX_X, 31);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_WIDTH, 43);
...
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_HITPAUSE_SCALING, 0.3);
...
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_COLLISION_SPRITE, sprite_get("jarhurt"));
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_MASK, sprite_get("jarhurt"));
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_HSPEED, 7);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_SPRITE, asset_get("empty_sprite"));
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_GRAVITY, 0.7);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_GROUND_FRICTION, 0.1);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_AIR_FRICTION, 0.11);
