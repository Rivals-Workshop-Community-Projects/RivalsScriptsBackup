...
alt_prev = 0;
portrait = 0;
portrait_flash = 0;did_flash = false;
...
if(player == 0){
    voice_button_pos = [
        42,
        148,
        42 + sprite_get_width(sprite_get("css_button"))+10,
        148 + sprite_get_height(sprite_get("css_button"))+10
    ];      
}
...
if(get_player_hud_color(player) == 8421504){
    voice_button_pos = [
        74-12,
        178,
        74-12 + sprite_get_width(sprite_get("css_button"))+10,
        178 + sprite_get_height(sprite_get("css_button"))+10
    ];     
}
