...
set_hitbox_value(AT_FSTRONG, 1, HG_LIFETIME, 29);
...
set_hitbox_value(AT_FSTRONG, 1, HG_BASE_KNOCKBACK, 10.5);
set_hitbox_value(AT_FSTRONG, 1, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, asset_get("sfx_blow_heavy1"));
set_hitbox_value(AT_FSTRONG, 1, HG_PROJECTILE_SPRITE, sprite_get("useless creature"));
