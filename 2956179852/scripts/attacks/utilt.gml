...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, asset_get("sfx_birdclap"));
...
set_hitbox_value(AT_UTILT, 1, HG_KNOCKBACK_SCALING, 0.95);
...
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sound_get("slap"));
