...
set_hitbox_value(AT_USTRONG, 1, HG_WINDOW, 20);
set_hitbox_value(AT_USTRONG, 1, HG_LIFETIME, 9999);
...
set_hitbox_value(AT_USTRONG, 1, HG_PROJECTILE_SPRITE, sprite_get("toast"));
