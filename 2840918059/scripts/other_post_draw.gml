...
//Custom Sprite Pulling

//Default
if (custom && state == PS_HITSTUN && last_attack == AT_FSPECIAL_2 && get_player_color( last_player ) == 0) {
	gpu_set_fog(1, c_blue, 0, 1);
	draw_sprite_ext(sprite_index, image_index, round(x) + draw_x, round(y) + draw_y, image_xscale, image_yscale, spr_angle, c_white, 0.4)
	gpu_set_fog(0, c_blue, 0, 1);
}

if (custom && state == PS_HITSTUN && last_attack == AT_FSPECIAL_2 && get_player_color( last_player ) == 0) {
	gpu_set_fog(1, c_green, 0, 1);
	draw_sprite_ext(sprite_index, image_index, round(x) + draw_x, round(y) + draw_y, image_xscale, image_yscale, spr_angle, c_white, 0.2)
	gpu_set_fog(0, c_green, 0, 1);
}
...
if (custom && state == PS_HITSTUN && last_attack == AT_FSPECIAL_2 && get_player_color( last_player ) == 1) {
	gpu_set_fog(1, c_white, 0, 1);
	draw_sprite_ext(sprite_index, image_index, round(x) + draw_x, round(y) + draw_y, image_xscale, image_yscale, spr_angle, c_white, 0.3)
	gpu_set_fog(0, c_white, 0, 1);
}
...
if (custom && state == PS_HITSTUN && last_attack == AT_FSPECIAL_2 && get_player_color( last_player ) == 3) {
	gpu_set_fog(1, c_green, 0, 1);
	draw_sprite_ext(sprite_index, image_index, round(x) + draw_x, round(y) + draw_y, image_xscale, image_yscale, spr_angle, c_white, 0.5)
	gpu_set_fog(0, c_green, 0, 1);
}
...
if (custom && state == PS_HITSTUN && last_attack == AT_FSPECIAL_2 && get_player_color( last_player ) == 5) {
	gpu_set_fog(1, c_blue, 0, 1);
	draw_sprite_ext(sprite_index, image_index, round(x) + draw_x, round(y) + draw_y, image_xscale, image_yscale, spr_angle, c_white, 0.45)
	gpu_set_fog(0, c_blue, 0, 1);
}
...
if (custom && state == PS_HITSTUN && last_attack == AT_FSPECIAL_2 && get_player_color( last_player ) == 5) {
	gpu_set_fog(1, c_black, 0, 1);
	draw_sprite_ext(sprite_index, image_index, round(x) + draw_x, round(y) + draw_y, image_xscale, image_yscale, spr_angle, c_white, 0.15)
	gpu_set_fog(0, c_black, 0, 1);
}
...
if (custom && state == PS_HITSTUN && last_attack == AT_FSPECIAL_2 && get_player_color( last_player ) == 7) {
	gpu_set_fog(1, c_white, 0, 1);
	draw_sprite_ext(sprite_index, image_index, round(x) + draw_x, round(y) + draw_y, image_xscale, image_yscale, spr_angle, c_white, 0.1)
	gpu_set_fog(0, c_white, 0, 1);
}
