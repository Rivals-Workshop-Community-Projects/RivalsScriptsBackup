...
set_window_value(AT_JAB, 2, AG_WINDOW_SFX, asset_get("sfx_ice_shieldup"));
...
set_window_value(AT_JAB, 5, AG_WINDOW_SFX, asset_get("sfx_ice_back_air"));
...
set_hitbox_value(AT_JAB, 1, HG_VISUAL_EFFECT, 28);
...
set_hitbox_value(AT_JAB, 2, HG_EXTRA_HITPAUSE, 12);
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, asset_get("sfx_ice_shatter"));
set_hitbox_value(AT_JAB, 2, HG_VISUAL_EFFECT, 28);
...
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, asset_get("sfx_ice_nspecial_hit_ground"));
set_hitbox_value(AT_JAB, 3, HG_VISUAL_EFFECT, 28);
