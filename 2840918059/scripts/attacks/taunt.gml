...
set_window_value(AT_TAUNT, 3, AG_WINDOW_SFX, asset_get("sfx_ice_uspecial_start"));
...
set_window_value(AT_TAUNT, 4, AG_WINDOW_SFX, asset_get("sfx_ice_nspecial_hit_ground"));
