...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, asset_get("sfx_ice_ftilt"));
...
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT, 199);
set_hitbox_value(AT_DATTACK, 1, HG_HIT_PARTICLE_NUM, 3);
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, asset_get("sfx_icehit_heavy1"));
