...
set_hitbox_value(AT_UAIR, 2, HG_ANGLE, 105);
...
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, asset_get("sfx_icehit_medium1"));
...
set_hitbox_value(AT_UAIR, 5, HG_KNOCKBACK_SCALING, .35);
set_hitbox_value(AT_UAIR, 5, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_UAIR, 5, HG_HITPAUSE_SCALING, .3);
set_hitbox_value(AT_UAIR, 5, HG_HIT_SFX, asset_get("sfx_ice_nspecial_hit_ground"));
set_hitbox_value(AT_UAIR, 5, HG_VISUAL_EFFECT, 28);
