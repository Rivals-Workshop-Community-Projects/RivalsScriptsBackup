...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, asset_get("sfx_jumpair"));
...
set_window_value(AT_DAIR, 3, AG_WINDOW_LENGTH, 99999);
...
set_window_value(AT_DAIR, 3, AG_WINDOW_VSPEED, 15);
...
set_window_value(AT_DAIR, 4, AG_WINDOW_SFX, asset_get("sfx_icehit_heavy1"));
...
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, asset_get("sfx_icehit_medium1"));
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, 28);
set_hitbox_value(AT_DAIR, 1, HG_HITBOX_GROUP, 1);

set_hitbox_value(AT_DAIR, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_DAIR, 2, HG_WINDOW, 2);
set_hitbox_value(AT_DAIR, 2, HG_LIFETIME, 99999);
set_hitbox_value(AT_DAIR, 2, HG_HITBOX_X, 0);
set_hitbox_value(AT_DAIR, 2, HG_HITBOX_Y, 20);
set_hitbox_value(AT_DAIR, 2, HG_WIDTH, 5);
set_hitbox_value(AT_DAIR, 2, HG_HEIGHT, 5);
...
set_hitbox_value(AT_DAIR, 2, HG_HIT_PARTICLE_NUM, 3);
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, asset_get("sfx_ice_nspecial_hit_ground"));
...
set_hitbox_value(AT_DAIR, 3, HG_HIT_SFX, asset_get("sfx_icehit_medium1"));
set_hitbox_value(AT_DAIR, 3, HG_VISUAL_EFFECT, 28);
