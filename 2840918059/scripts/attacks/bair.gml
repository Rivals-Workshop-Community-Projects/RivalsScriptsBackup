...
set_window_value(AT_BAIR, 2, AG_WINDOW_SFX, asset_get("sfx_ice_shieldup"));
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, asset_get("sfx_ice_fspecial_hit_ground"));
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, 28);
