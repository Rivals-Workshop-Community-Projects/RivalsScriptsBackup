...
set_window_value(AT_FAIR, 3, AG_WINDOW_SFX, asset_get("sfx_ice_back_air"));
...
set_hitbox_value(AT_FAIR, 1, HG_VISUAL_EFFECT, 28);
...
set_hitbox_value(AT_FAIR, 2, HG_HIT_PARTICLE_NUM, 3);
set_hitbox_value(AT_FAIR, 2, HG_HIT_SFX, asset_get("sfx_ice_shatter_big"));
