...
if (!variable_instance_exists(id,"ae") || ye == true){
	...
	ce[0,2] = "The default color for Cosmonaut." // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
	ce[1,0] = make_color_rgb(192, 197, 207)
	ce[1,1] = "Silver Surfer"
	ce[1,2] = "An alt based on the aptly named Silver Surfer."
	ce[2,0] = make_color_rgb(130, 182, 255)
	ce[2,1] = "Blue Star"
	ce[2,2] = "A simple Blue alt."
	ce[3,0] = make_color_rgb(255, 143, 143)
	ce[3,1] = "Red Dwarf"
	ce[3,2] = "A simple Red alt."
	ce[4,0] = make_color_rgb(31, 19, 59)
	ce[4,1] = "Void"
	ce[4,2] = "A dark take on the original color scheme."
	ce[5,0] = make_color_rgb(255, 213, 213)
	ce[5,1] = "Blank"
	ce[5,2] = "Retro-Style shadeless alt."
	ce[6,0] = make_color_rgb(242, 242, 242)
	ce[6,1] = "Monochrome"
	ce[6,2] = "A black and white alt."
	ce[7,0] = make_color_rgb(125, 255, 151)
	ce[7,1] = "Earth"
	ce[7,2] = "An alt based on the Planet Earth."
	ce[8,0] = make_color_rgb(255, 169, 145)
	ce[8,1] = "Mars"
	ce[8,2] = "An alt based on the Planet Mars."
	ce[9,0] = make_color_rgb(133, 107, 62)
	ce[9,1] = "Outer Wilds"
	ce[9,2] = "An alt based on the game Outer Wilds."
	ce[10,0] = make_color_rgb(192, 0, 209)
	ce[10,1] = "Farout"
	ce[10,2] = "A pink alt whos name is inspired from 2018 VG18."
	ce[11,0] = make_color_rgb(180, 32, 42)
	ce[11,1] = "Skeld"
	ce[11,2] = "An alt based on a familiar ship."
	ce[12,0] = make_color_rgb(196, 160, 227)
	ce[12,1] = "Developer"
	ce[12,2] = "Developer style colored alt."
	ce[13,0] = make_color_rgb(255, 229, 0)
	ce[13,1] = "The Moon?"
	ce[13,2] = "Please don't eat it."
	ce[14,0] = make_color_rgb(161, 255, 235)
	ce[14,1] = "Atmosphere"
	ce[14,2] = "A light alt based on the sky."
	ce[15,0] = make_color_rgb(179, 185, 209)
	ce[15,1] = "Inverted"
	ce[15,2] = ".tuanomsoC rof roloc tluafed ehT"
	ce[16,0] = make_color_rgb(119, 82, 156)
	ce[16,1] = "Veil Nebula"
	ce[16,2] = "A simple purple color scheme based on the Veil Nebula."
	ce[17,0] = make_color_rgb(97, 174, 254)
	ce[17,1] = "Cosmos"
	ce[17,2] = "An alt representing the Cosmos."
	ce[18,0] = make_color_rgb(44, 51, 84)
	ce[18,1] = "Gold"
	ce[18,2] = "A shiny golden alt."
	ce[19,0] = make_color_rgb(44, 51, 84)
	ce[19,1] = "Synne"
	ce[19,2] = "An alt based on Synne by Giik."
	ce[20,0] = make_color_rgb(44, 51, 84)
	ce[20,1] = "Arcade"
	ce[20,2] = "A stylish alt that changes colors each stock."
	ce[21,0] = make_color_rgb(131, 172, 135)
	ce[21,1] = "Dagobah"
