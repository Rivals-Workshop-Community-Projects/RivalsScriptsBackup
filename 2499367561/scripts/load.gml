...
sprite_change_offset("cr_hurtbox", 122, 150);
...
sprite_change_offset("dspecial_spin", 100, 140);
sprite_change_offset("dspecial_throw", 100, 140);
sprite_change_offset("taunt", 100, 140);
sprite_change_offset("taunt_2", 100, 140);
sprite_change_offset("shieldbreak", 100, 140);

sprite_change_offset("plat", 95, 0);
sprite_change_offset("space_fx", 35, 35);
sprite_change_offset("space_extra_small", 30, 30);
sprite_change_offset("star", 20, 20);
sprite_change_offset("star_fx", 10, 10);
sprite_change_offset("cosmic_whale", 200, 200);

sprite_change_offset("jetpack", 40, 40);

sprite_change_offset("airdodge_fx", 20, 50);

sprite_change_offset("hurtbox", 122, 158);
sprite_change_offset("kirb", 32, 54);
sprite_change_offset("shield", 100, 100);
sprite_change_offset("shieldsynne", 100, 100);
sprite_change_offset("shieldarcade", 100, 100);
sprite_change_offset("shieldvoid", 100, 100);
sprite_change_offset("shieldearth", 100, 100);
sprite_change_offset("blackhole_active", 160, 170);
sprite_change_offset("blackhole_inactive", 160, 170);
