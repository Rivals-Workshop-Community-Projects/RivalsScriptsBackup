...
set_hitbox_value(AT_DAIR, 1, HG_HITPAUSE_SCALING, 0.11);
...
set_hitbox_value(AT_DAIR, 2, HG_KNOCKBACK_SCALING, 0.05);
set_hitbox_value(AT_DAIR, 2, HG_BASE_HITPAUSE, 3);
set_hitbox_value(AT_DAIR, 2, HG_HITPAUSE_SCALING, 0.11);
...
set_hitbox_value(AT_DAIR, 3, HG_KNOCKBACK_SCALING, 0.05);
set_hitbox_value(AT_DAIR, 3, HG_BASE_HITPAUSE, 3);
set_hitbox_value(AT_DAIR, 3, HG_HITPAUSE_SCALING, 0.11);
