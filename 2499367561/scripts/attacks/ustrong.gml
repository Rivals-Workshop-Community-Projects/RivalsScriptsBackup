...
set_window_value(AT_USTRONG, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.8);
...
set_hitbox_value(AT_USTRONG, 1, HG_BASE_HITPAUSE, 9.2);
set_hitbox_value(AT_USTRONG, 1, HG_HITPAUSE_SCALING, 1.05);
...
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_Y, 5);
