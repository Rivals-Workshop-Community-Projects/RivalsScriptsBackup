...
set_window_value(AT_USTRONG, 1, AG_WINDOW_SFX, sound_get("rev3"));
...
set_window_value(AT_USTRONG, 2, AG_WINDOW_HAS_CUSTOM_FRICTION, 0.75);
set_window_value(AT_USTRONG, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, sound_get("squack6"));

set_window_value(AT_USTRONG, 3, AG_WINDOW_TYPE, 1);
set_window_value(AT_USTRONG, 3, AG_WINDOW_LENGTH, 15);
set_window_value(AT_USTRONG, 3, AG_WINDOW_ANIM_FRAMES, 4);
set_window_value(AT_USTRONG, 3, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX, sound_get("rev1"));
...
set_hitbox_value(AT_USTRONG, 1, HG_BASE_KNOCKBACK, 9.3);
...
set_hitbox_value(AT_USTRONG, 3, HG_BASE_KNOCKBACK, 9.3);
