...
set_window_value(AT_TAUNT, 1, AG_WINDOW_ANIM_FRAMES, 24);
...
set_window_value(AT_TAUNT, 2, AG_WINDOW_ANIM_FRAMES, 17);
set_window_value(AT_TAUNT, 2, AG_WINDOW_ANIM_FRAME_START, 24);
set_window_value(AT_TAUNT, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_TAUNT, 2, AG_WINDOW_SFX, sound_get( "rev1" ));
