...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sound_get("rev1"));

set_window_value(AT_DATTACK, 2, AG_WINDOW_TYPE, 1);
set_window_value(AT_DATTACK, 2, AG_WINDOW_LENGTH, 14);
set_window_value(AT_DATTACK, 2, AG_WINDOW_ANIM_FRAMES, 4);
set_window_value(AT_DATTACK, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX, asset_get("sfx_kragg_roll_start"));
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .80);
...
set_hitbox_value(AT_DATTACK, 1, HG_ANGLE, 52);
set_hitbox_value(AT_DATTACK, 1, HG_BASE_KNOCKBACK, 8.25);
set_hitbox_value(AT_DATTACK, 1, HG_KNOCKBACK_SCALING, .27);
