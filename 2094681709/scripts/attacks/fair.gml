...
set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, asset_get("sfx_go"));
...
set_hitbox_value(AT_FAIR, 1, HG_HITBOX_X, 115);
...
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, asset_get("sfx_absa_new_whip1"));
