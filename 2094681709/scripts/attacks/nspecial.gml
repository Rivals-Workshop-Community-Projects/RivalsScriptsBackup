...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_TYPE, 69); //article spawns frame 1 of this window
...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, sound_get("ancientpowerfast"));

//Dismissing
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_TYPE, 420);
