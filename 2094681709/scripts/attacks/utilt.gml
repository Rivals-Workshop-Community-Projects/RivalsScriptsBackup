...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("rev1"));
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX_FRAME, 2);

set_window_value(AT_UTILT, 2, AG_WINDOW_TYPE, 1);
set_window_value(AT_UTILT, 2, AG_WINDOW_LENGTH, 15);
set_window_value(AT_UTILT, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_UTILT, 2, AG_WINDOW_SFX, sound_get("rev1"));
...
set_hitbox_value(AT_UTILT, 1, HG_ANGLE, 104);
...
set_hitbox_value(AT_UTILT, 1, HG_KNOCKBACK_SCALING, .01);
...
set_hitbox_value(AT_UTILT, 2, HG_KNOCKBACK_SCALING, .09);
