...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, sound_get("hoo4"));
...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("hoo3"));
set_window_value(AT_DSTRONG, 2, AG_WINDOW_ANIM_FRAME_START, 6);


set_window_value(AT_DSTRONG, 3, AG_WINDOW_TYPE, 1);
set_window_value(AT_DSTRONG, 3, AG_WINDOW_LENGTH, 28);
set_window_value(AT_DSTRONG, 3, AG_WINDOW_ANIM_FRAMES, 11);
set_window_value(AT_DSTRONG, 3, AG_WINDOW_ANIM_FRAME_START, 12);
set_window_value(AT_DSTRONG, 3, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_shovel_hit_heavy2"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_BASE_KNOCKBACK, 8.25);
...
set_hitbox_value(AT_DSTRONG, 3, HG_BASE_KNOCKBACK, 8.25);
