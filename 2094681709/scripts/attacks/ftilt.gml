...
set_window_value(AT_FTILT, 2, AG_WINDOW_SFX, sound_get("horn2"));
...
set_hitbox_value(AT_FTILT, 1, HG_ANGLE, 52);
set_hitbox_value(AT_FTILT, 1, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_FTILT, 1, HG_KNOCKBACK_SCALING, .2);
set_hitbox_value(AT_FTILT, 1, HG_EXTRA_HITPAUSE, 17);
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, asset_get("sfx_ori_grenade_hit"));
...
set_hitbox_value(AT_FTILT, 2, HG_HITBOX_X, 120);
...
set_hitbox_value(AT_FTILT, 2, HG_ANGLE, 69);
...
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, asset_get("sfx_ori_grenade_hit"));
