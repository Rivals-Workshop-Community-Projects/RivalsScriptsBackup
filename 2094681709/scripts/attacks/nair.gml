...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, asset_get("sfx_metal_hit_strong"));
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX_FRAME, 2);

set_window_value(AT_NAIR, 2, AG_WINDOW_TYPE, 1);
set_window_value(AT_NAIR, 2, AG_WINDOW_LENGTH, 7);
set_window_value(AT_NAIR, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_NAIR, 2, AG_WINDOW_SFX, sound_get("rev2"));
...
set_hitbox_value(AT_NAIR, 1, HG_HITBOX_Y, 0);
set_hitbox_value(AT_NAIR, 1, HG_HITBOX_X, 0);
set_hitbox_value(AT_NAIR, 1, HG_WIDTH, 125);
set_hitbox_value(AT_NAIR, 1, HG_HEIGHT, 125);
...
set_hitbox_value(AT_NAIR, 1, HG_KNOCKBACK_SCALING, .33);
