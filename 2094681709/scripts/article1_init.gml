...
sprite_index = sprite_get("birdboydrive");           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
...
new_sprite = sprite_get("birdboydrive");             //This is another part of the animation handling. It tells the game "this is the sprite this article should be using; if it's not already, switch it over please"
