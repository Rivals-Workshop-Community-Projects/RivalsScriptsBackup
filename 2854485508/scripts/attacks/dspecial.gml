...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.04);
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.04);
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.04);
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_VSPEED_TYPE, 1);
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_SFX, sound_get("sfx_smb3_explosion"));
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_SFX_FRAME, 9);
...
set_window_value(AT_DSPECIAL, 5, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.1);
...
set_window_value(AT_DSPECIAL, 7, AG_WINDOW_SFX, sound_get("sfx_smb3_explosion"));
set_window_value(AT_DSPECIAL, 7, AG_WINDOW_SFX_FRAME, 1);
set_window_value(AT_DSPECIAL, 7, AG_MUNO_WINDOW_ROLE, 1);
...
set_window_value(AT_DSPECIAL, 8, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.1);
set_window_value(AT_DSPECIAL, 8, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.1);
...
set_window_value(AT_DSPECIAL, 8, AG_WINDOW_SFX, sound_get("sfx_smb3_explosion"));
...
set_window_value(AT_DSPECIAL, 9, AG_WINDOW_ANIM_FRAME_START, 15);
set_window_value(AT_DSPECIAL, 9, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_DSPECIAL, 9, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.4);
set_window_value(AT_DSPECIAL, 9, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.4);
...
set_attack_value(AT_DSPECIAL, AG_MUNO_ATTACK_MISC_ADD, "If hit during frames " + string(counter_frame) + "-" + string(counter_frame + counter_active) + " with >10 KB, goes into an Interrupted animation.");

set_num_hitboxes(AT_DSPECIAL, 2);

set_hitbox_value(AT_DSPECIAL, 1, HG_MUNO_HITBOX_NAME, "Successful Hit");
set_hitbox_value(AT_DSPECIAL, 1, HG_MUNO_HITBOX_MISC_ADD, "Adds Transformation status to marked opponent");
...
set_hitbox_value(AT_DSPECIAL, 2, HG_MUNO_HITBOX_NAME, "Interrupted");
set_hitbox_value(AT_DSPECIAL, 2, HG_MUNO_HITBOX_MISC_ADD, "Adds Transformation status to marked opponent");
