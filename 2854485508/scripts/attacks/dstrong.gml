...
set_hitbox_value(AT_DSTRONG, 1, HG_MUNO_HITBOX_NAME, "Sweetspot");
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, hfx_leaf);
...
set_hitbox_value(AT_DSTRONG, 2, HG_MUNO_HITBOX_NAME, "Sourspot");
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, hfx_leaf_heavy);
