...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_absa_new_whip2"));
...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_CUSTOM_GRAVITY, gravity_speed * .5);
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_CUSTOM_GRAVITY, gravity_speed * .5);
