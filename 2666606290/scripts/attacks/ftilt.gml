...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, asset_get("sfx_absa_jab1"));
...
set_window_value(AT_FTILT, 3, AG_WINDOW_LENGTH, 10); // 9
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, asset_get("sfx_clairen_tip_med"));
