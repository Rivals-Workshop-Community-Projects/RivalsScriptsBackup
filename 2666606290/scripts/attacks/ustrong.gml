...
set_window_value(AT_USTRONG, 1, AG_WINDOW_LENGTH, 8); // 4
...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_absa_whip"));
...
set_hitbox_value(AT_USTRONG, 3, HG_HEIGHT, 116);
...
set_hitbox_value(AT_USTRONG, 3, HG_KNOCKBACK_SCALING, 1.1); // 1.2
set_hitbox_value(AT_USTRONG, 3, HG_BASE_HITPAUSE, 12); // 8
