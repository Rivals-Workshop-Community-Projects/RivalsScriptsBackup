...
set_window_value(AT_DAIR, 1, AG_WINDOW_LENGTH, 14); // 9
set_window_value(AT_DAIR, 1, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_DAIR, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, asset_get("sfx_absa_whip2"));
...
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, asset_get("sfx_absa_kickhit"));
