...
set_window_value(AT_DATTACK, 2, AG_WINDOW_ANIM_FRAMES, 2); // 6
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_ANIM_FRAMES, 5); // 2
set_window_value(AT_DATTACK, 3, AG_WINDOW_ANIM_FRAME_START, 5); // 7
...
set_hitbox_value(AT_DATTACK, 1, HG_WIDTH, 80); // 64
set_hitbox_value(AT_DATTACK, 1, HG_HEIGHT, 40); // 64
set_hitbox_value(AT_DATTACK, 1, HG_PRIORITY, 2);
set_hitbox_value(AT_DATTACK, 1, HG_DAMAGE, 10); // 6
