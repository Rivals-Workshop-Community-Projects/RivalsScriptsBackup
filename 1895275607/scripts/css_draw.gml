...
alt_name[6]  = "Koopa";
alt_name[7]  = "Squirtle";
alt_name[8]  = "Ultra Fishbunjin 3000";
alt_name[9]  = "ExpLode";
alt_name[10] = "Uh Oh";
alt_name[11] = "Transcend";
alt_name[12] = "Targma";
alt_name[13] = "Turd and Birtle";
alt_name[14] = "Pink DK";
alt_name[15] = "Purple Drankula";

draw_set_halign(fa_right);
textDraw(temp_x + 198, temp_y + 36, "fName", c_aqua, 0, 1000, 1, false, 0.3, "v" + patch_ver);
textDraw(temp_x + 200, temp_y + 38, "fName", c_fuchsia, 0, 1000, 1, false, 0.3, "v" + patch_ver);
