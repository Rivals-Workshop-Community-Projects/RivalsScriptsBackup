...
set_attack_value(AT_NAIR, AG_HURTBOX_AIR_SPRITE, sprite_get("nair_hurt")); //TODO: add aerial hurtbox sprite
...
set_window_value(AT_NAIR, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, .02);
...
set_window_value(AT_NAIR, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .04);
...
set_hitbox_value(AT_NAIR, 2, HG_WINDOW_CREATION_FRAME, 999);
set_hitbox_value(AT_NAIR, 2, HG_LIFETIME, 60);
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_X, 0);
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_Y, -18);
set_hitbox_value(AT_NAIR, 2, HG_WIDTH, 56);
