...
set_num_hitboxes(AT_FTILT,1); // todo: sourspot(s)
...
set_hitbox_value(AT_FTILT, 1, HG_WIDTH, 112);
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, asset_get("sfx_ell_strong_attack_explosion")); //change?
