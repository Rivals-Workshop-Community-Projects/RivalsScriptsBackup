...
// set_hitbox_value(AT_FAIR, 1, HG_WINDOW_CREATION_FRAME, 1); // uh
set_hitbox_value(AT_FAIR, 1, HG_LIFETIME, 3);
set_hitbox_value(AT_FAIR, 1, HG_HITBOX_X, 64); // move to "tipper"
set_hitbox_value(AT_FAIR, 1, HG_HITBOX_Y, -2); // move to "tipper"
...
set_hitbox_value(AT_FAIR, 1, HG_BASE_KNOCKBACK, 6); // check maypul values for ref
set_hitbox_value(AT_FAIR, 1, HG_KNOCKBACK_SCALING, 0.5);
set_hitbox_value(AT_FAIR, 1, HG_BASE_HITPAUSE, 8); // maybe tweak a lil
set_hitbox_value(AT_FAIR, 1, HG_HITPAUSE_SCALING, .6); // maybe tweak
