...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_LENGTH, 5); //3
...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_LENGTH, 14); // 18
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_kragg_spike")); // sfx_kragg_spike
