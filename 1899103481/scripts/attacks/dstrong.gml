...
// set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_clairen_spin")); // todo: replace sfx with something cool
...
set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_X, 16);
...
// set_hitbox_value(AT_DSTRONG, 3, HG_KNOCKBACK_SCALING, 0.3);
set_hitbox_value(AT_DSTRONG, 3, HG_BASE_HITPAUSE, 4);
set_hitbox_value(AT_DSTRONG, 3, HG_HITPAUSE_SCALING, .5);
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT, 140);
...
set_hitbox_value(AT_DSTRONG, 4, HG_HIT_SFX, asset_get("sfx_abyss_explosion"));
