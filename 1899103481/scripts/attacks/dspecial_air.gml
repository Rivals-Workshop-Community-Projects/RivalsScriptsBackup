...
set_num_hitboxes(AT_DSPECIAL_AIR, 2); //no hitboxes will be created automatically. They must be created through create_hitbox(AT_DSPECIAL_AIR, 1, x, y)
...
set_hitbox_value(AT_DSPECIAL_AIR, 1, HG_WIDTH, 16);
...
set_hitbox_value(AT_DSPECIAL_AIR, 2, HG_HITBOX_X, 52);
set_hitbox_value(AT_DSPECIAL_AIR, 2, HG_HITBOX_Y, -48);
set_hitbox_value(AT_DSPECIAL_AIR, 2, HG_WIDTH, 54);
