...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_LENGTH, 24); // 20
...
set_hitbox_value(AT_FSTRONG, 1, HG_KNOCKBACK_SCALING, .8); // .9
set_hitbox_value(AT_FSTRONG, 1, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_FSTRONG, 1, HG_HITPAUSE_SCALING, .7);
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sfx_botw_hit_1);
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_LOCKOUT, 10);

set_hitbox_value(AT_FSTRONG, 2, HG_MUNO_HITBOX_NAME, "Tipper");
...
set_hitbox_value(AT_FSTRONG, 2, HG_KNOCKBACK_SCALING, .9); // 1
...
set_hitbox_value(AT_FSTRONG, 3, HG_MUNO_HITBOX_NAME, "Breaking Hit");
set_hitbox_value(AT_FSTRONG, 3, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_FSTRONG, 3, HG_WINDOW, 3);
set_hitbox_value(AT_FSTRONG, 3, HG_LIFETIME, 3);
set_hitbox_value(AT_FSTRONG, 3, HG_HITBOX_X, 96);
set_hitbox_value(AT_FSTRONG, 3, HG_HITBOX_Y, -32);
set_hitbox_value(AT_FSTRONG, 3, HG_WIDTH, 128);
set_hitbox_value(AT_FSTRONG, 3, HG_HEIGHT, 32);
...
set_hitbox_value(AT_FSTRONG, 3, HG_BASE_HITPAUSE, 12); // 16
set_hitbox_value(AT_FSTRONG, 3, HG_HITPAUSE_SCALING, .6); // .8
set_hitbox_value(AT_FSTRONG, 3, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_FSTRONG, 3, HG_HIT_SFX, sfx_botw_hit_1);
set_hitbox_value(AT_FSTRONG, 3, HG_HIT_LOCKOUT, 10);

set_hitbox_value(AT_FSTRONG, 4, HG_MUNO_HITBOX_NAME, "Spearless");
...
set_hitbox_value(AT_FSTRONG, 4, HG_KNOCKBACK_SCALING, 0.2);
