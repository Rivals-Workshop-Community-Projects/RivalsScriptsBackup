...
// falling
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_LENGTH, 600);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_MUNO_HITBOX_NAME, "Axe Kick");
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_FSPECIAL, 1, HG_WINDOW, 2);
set_hitbox_value(AT_FSPECIAL, 1, HG_LIFETIME, 3);
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_X, 0);
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_Y, 0); // -16
set_hitbox_value(AT_FSPECIAL, 1, HG_WIDTH, 64); // 96
set_hitbox_value(AT_FSPECIAL, 1, HG_HEIGHT, 56); // 64
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, sfx_botw_hit_1);

set_hitbox_value(AT_FSPECIAL, 2, HG_MUNO_HITBOX_NAME, "Falling Hit");
set_hitbox_value(AT_FSPECIAL, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_FSPECIAL, 2, HG_WINDOW, 3);
set_hitbox_value(AT_FSPECIAL, 2, HG_LIFETIME, 608);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, sfx_botw_hit_1);