...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, sfx_botw_spin_charge);

set_window_value(AT_DSTRONG, 2, AG_WINDOW_LENGTH, 4);
set_window_value(AT_DSTRONG, 2, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_DSTRONG, 2, AG_WINDOW_ANIM_FRAME_START, 2);
set_window_value(AT_DSTRONG, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_shovel_swing_light1"));
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_SFX, asset_get("sfx_shovel_swing_med1"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sfx_botw_hit_1);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sfx_botw_hit_1);
...
set_hitbox_value(AT_DSTRONG, 3, HG_HIT_SFX, sfx_botw_hit_1);
