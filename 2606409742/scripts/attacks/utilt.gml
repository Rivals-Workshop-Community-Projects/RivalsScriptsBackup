...
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sfx_botw_hit_1);
set_hitbox_value(AT_UTILT, 1, HG_HIT_LOCKOUT, 10);

set_hitbox_value(AT_UTILT, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_UTILT, 2, HG_WINDOW, 2);
set_hitbox_value(AT_UTILT, 2, HG_LIFETIME, 3);
set_hitbox_value(AT_UTILT, 2, HG_HITBOX_X, 56);
...
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, asset_get("sfx_shovel_hit_heavy1"));
