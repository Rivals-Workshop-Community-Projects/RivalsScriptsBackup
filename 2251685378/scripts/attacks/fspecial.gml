...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sound_get("bow_shot"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT, fspecial_effect);
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT_X_OFFSET, -30);
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT_Y_OFFSET, -30);
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, sound_get("arrow_hit"));
