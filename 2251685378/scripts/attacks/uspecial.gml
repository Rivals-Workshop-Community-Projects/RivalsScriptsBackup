...
set_hitbox_value(AT_USPECIAL, 1, HG_EXTRA_HITPAUSE, 35);
set_hitbox_value(AT_USPECIAL, 1, HG_FORCE_FLINCH, 1);
set_hitbox_value(AT_USPECIAL, 1, HG_HIT_SFX, asset_get("sfx_clairen_nspecial_grab_success"));