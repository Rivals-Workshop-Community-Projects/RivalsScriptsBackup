...
set_hitbox_value(AT_FAIR, 1, HG_ANGLE, 47);
...
set_hitbox_value(AT_FAIR, 2, HG_ANGLE, 47);
...
set_hitbox_value(AT_FAIR, 3, HG_ANGLE, 47);
set_hitbox_value(AT_FAIR, 3, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_FAIR, 3, HG_KNOCKBACK_SCALING, 1.1);
...
set_hitbox_value(AT_FAIR, 4, HG_ANGLE, 47);
set_hitbox_value(AT_FAIR, 4, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_FAIR, 4, HG_KNOCKBACK_SCALING, 1.1);
