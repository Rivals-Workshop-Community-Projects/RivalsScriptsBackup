...
set_hitbox_value(AT_USTRONG, 2, HG_LIFETIME, 24);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, fx_cardhit);
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("sfx_lucy_cardhit1"));
set_hitbox_value(AT_USTRONG, 2, HG_HIT_LOCKOUT, 7);
set_hitbox_value(AT_USTRONG, 2, HG_ANGLE_FLIPPER, 3);
set_hitbox_value(AT_USTRONG, 2, HG_EXTENDED_PARRY_STUN, 1);
set_hitbox_value(AT_USTRONG, 2, HG_PROJECTILE_SPRITE, sprite_get("card_proj1"));
set_hitbox_value(AT_USTRONG, 2, HG_PROJECTILE_MASK, sprite_get("card_proj1"));
...
set_hitbox_value(AT_USTRONG, 2, HG_PROJECTILE_DESTROY_EFFECT, 13);
