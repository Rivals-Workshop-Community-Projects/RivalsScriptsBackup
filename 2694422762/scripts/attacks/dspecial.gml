...
set_hitbox_value(AT_DSPECIAL, 15, HG_ANGLE, 45);
set_hitbox_value(AT_DSPECIAL, 15, HG_BASE_KNOCKBACK, 12);
set_hitbox_value(AT_DSPECIAL, 15, HG_KNOCKBACK_SCALING, 1.15);
set_hitbox_value(AT_DSPECIAL, 15, HG_BASE_HITPAUSE, 12);
set_hitbox_value(AT_DSPECIAL, 15, HG_HITPAUSE_SCALING, 1.15);
