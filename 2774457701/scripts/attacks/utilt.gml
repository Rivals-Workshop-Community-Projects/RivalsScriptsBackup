...
set_window_value(AT_UTILT, 2, AG_WINDOW_ANIM_FRAMES, 10);
set_window_value(AT_UTILT, 2, AG_WINDOW_ANIM_FRAME_START, 3);

set_window_value(AT_UTILT, 3, AG_WINDOW_LENGTH, 7);
set_window_value(AT_UTILT, 3, AG_WINDOW_ANIM_FRAMES, 7);
set_window_value(AT_UTILT, 3, AG_WINDOW_ANIM_FRAME_START, 14);
...
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, 6);
