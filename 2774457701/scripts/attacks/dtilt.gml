...
set_window_value(AT_DTILT, 2, AG_WINDOW_LENGTH, 23);
set_window_value(AT_DTILT, 2, AG_WINDOW_HSPEED, 20);
set_window_value(AT_DTILT, 2, AG_WINDOW_INVINCIBILITY, 2);
set_window_value(AT_DTILT, 2, AG_WINDOW_ANIM_FRAMES, 23);
...
set_hitbox_value(AT_DTILT, 1, HG_WIDTH, 99);
...
set_hitbox_value(AT_DTILT, 2, HG_WIDTH, 99);
set_hitbox_value(AT_DTILT, 2, HG_HEIGHT, 78);
...
set_hitbox_value(AT_DTILT, 2, HG_ANGLE, 25);
...
set_hitbox_value(AT_DTILT, 3, HG_LIFETIME, 18);
set_hitbox_value(AT_DTILT, 3, HG_HITBOX_X, 5);
set_hitbox_value(AT_DTILT, 3, HG_HITBOX_Y, -7);
set_hitbox_value(AT_DTILT, 3, HG_WIDTH, 99);
set_hitbox_value(AT_DTILT, 3, HG_HEIGHT, 78);
set_hitbox_value(AT_DTILT, 3, HG_PRIORITY, 10);
