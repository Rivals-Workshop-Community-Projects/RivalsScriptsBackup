...
set_attack_value(AT_DSPECIAL, AG_SPRITE, sprite_get("ftilt"));
set_attack_value(AT_DSPECIAL, AG_NUM_WINDOWS, 2);
set_attack_value(AT_DSPECIAL, AG_HAS_LANDING_LAG, 4);
set_attack_value(AT_DSPECIAL, AG_OFF_LEDGE, 1);
set_attack_value(AT_DSPECIAL, AG_AIR_SPRITE, sprite_get("ftilt"));
set_attack_value(AT_DSPECIAL, AG_HURTBOX_SPRITE, sprite_get("ftilt"));
