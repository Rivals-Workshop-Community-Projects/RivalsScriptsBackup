...
set_attack_value(AT_USTRONG, AG_HURTBOX_SPRITE, sprite_get("idle"));
set_attack_value(AT_USTRONG, AG_STRONG_CHARGE_WINDOW, 1);

set_window_value(AT_USTRONG, 1, AG_WINDOW_LENGTH, 3);
set_window_value(AT_USTRONG, 1, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_USTRONG, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_swipe_weak2"));

set_window_value(AT_USTRONG, 2, AG_WINDOW_LENGTH, 21);
set_window_value(AT_USTRONG, 2, AG_WINDOW_ANIM_FRAMES, 21);
...
set_window_value(AT_USTRONG, 3, AG_WINDOW_ANIM_FRAME_START, 26);
