...
set_hitbox_value(AT_FSPECIAL, 1, HG_HEIGHT, 5);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("water"));
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("water"));
