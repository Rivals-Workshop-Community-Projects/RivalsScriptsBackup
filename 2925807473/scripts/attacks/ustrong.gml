...
set_window_value(AT_USTRONG, 4, AG_WINDOW_LENGTH, 33);
...
set_hitbox_value(AT_USTRONG, 1, HG_KNOCKBACK_SCALING, 1.0); // 0.9
...
set_hitbox_value(AT_USTRONG, 2, HG_KNOCKBACK_SCALING, 0.9); // 0.9
set_hitbox_value(AT_USTRONG, 2, HG_BASE_HITPAUSE, 100);
set_hitbox_value(AT_USTRONG, 2, HG_HITPAUSE_SCALING, 1);
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, 305);
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("sweetspot2"));
