...
initTip("NSpecial: Ouroboros");
initWords("Shoots out a chain at various angles depending on the input.");
initWords("During the move, you can press SPECIAL to launch yourself towards it.");
initWords("Follow-ups require chain stocks. They recharge after 3 seconds, but the timer pauses when you are midair. Hitting an opponent with a chain will replenish your stocks.");
initImage_ext(sprite_get("chaintip"), 4, fa_center, 2, 2, true, c_white, 1, true, noone, noone, noone, noone);


initTip("FSpecial: Serpent's Benediction");
initWords("Dashes forward quickly, with brief projectile invincibility.");
initImage_ext(sprite_get("fspecial"), 3, fa_center, 2, 2, true, c_white, 1, false, noone, noone, noone, noone);
initWords("Press ATTACK during the move to perform Falling Fang, an advancing attack with a sweetspot at the bottom.");
initImage_ext(sprite_get("fspecial"), 11, fa_center, 2, 2, true, c_white, 1, false, noone, noone, noone, noone);
initWords("Press SPECIAL during the move to perform Rising Fang, an anti-air kick with higher vertical coverage and invincible startup.");
initImage_ext(sprite_get("fspecial"), 19, fa_center, 2, 2, true, c_white, 1, false, noone, noone, noone, noone);

initTip("USpecial: Hungry Coils");
initWords("An anti-air chain that catches opponents at an angle and flings them backwards. Does not grant height.");
initImage_ext(sprite_get("uspecial"), 3, fa_center, 2, 2, true, c_white, 1, false, noone, noone, noone, noone);

initTip("DSpecial: Bloody Fangs");
initWords("A grab that will send the opponent upwards. The throw has extremely low knockback growth.");
initImage_ext(sprite_get("dspecial"), 4, fa_center, 2, 2, true, c_white, 1, false, noone, noone, noone, noone);
	
initTip("Character Profile");
initWords_ext("Personal Data", fa_center, c_gray, 0, false);
initWords("Name: Hazama");
initWords("Height: 183 cm");
initWords("Weight: 61 kg");
initWords("Blood: AB");
initWords("Birthday: 29 Apr");
initWords("Origin: ???");
initWords("Likes: Boiled eggs");
initWords("Dislikes: Cats");
initWords("Hobbies: Collecting silver accessories");
initWords("Affiliation: Novus Orbis Librarium");
initWords("Weapon: Snake Pair: Ouroboros");
initWords_ext("Personality", fa_center, c_gray, 0, false);
initWords("His constant gentle expression makes it difficult to grasp his true intentions. He avoids confrontation, always bowing and speaking in a friendly, polite manner, with a smile always lighting up his face. However, beneath that mask lies a person who delights in the misery and suffering of others. Not a single soul has been able to see through that charming smile of his.");
initWords("It would not be an understatement to say his schemes have schemes of their own, and seldom will his plans fail.");
initWords_ext("Outline", fa_center, c_gray, 0, false);
initWords("Hazama is a captain of the NOL's Intelligence Department, and one of the first antagonists of BlazBlue. His true identity is in fact one of the Six Heroes who defeated the Black Beast, Yuuki Terumi. Terumi is a violent, inhumane character, who finds pleasure in watching others suffer. He is also the creator of the Azure Grimoire, and by extension the Black Beast.");
initWords("Under Terumi's influence, he attempted to use the Godslaying Sword 'Kusanagi' to destroy the Master Unit, but Ragna stopped him. However, using that timing, he was able to succeed in seizing the Takamagahara that once controlled him. Following a certain event, he separated from Terumi and gained his own will.");
initWords("Once again, he plots to bring the Master Unit down to earth, and destroy it, so he heads for Ikaruga. Together with Relius, he operates in the shadows, under the Imperator's watchful eye and guidance.");
...
#define CORE_patches
initPatch("1.3", "Mar 9 2023"); // (replace the date lol)
initHeader("Gameplay");
initSection("+ Sped up startup for following moves: FStrong, USpecial.");
initSection("~ USpecial voicelines.");

initPatch("1.2", "Feb 17 2023"); // (replace the date lol)
initHeader("General");
initSection("Sprite changes.");
initSection("Voice options are now a select screen button. You can keep it mute, or choose between English and Japanese.");
initHeader("Gameplay");
initSection("+ Dash speed: 7.5 (was 7)");
initSection("+ Max air speed: 6 (was 4)");
initSection("- Rising Fang: Knockback scaling .6 (was .9)");

initPatch("1.1", "Feb 5 2023"); // (replace the date lol)
initHeader("General");
initSection("Fixed an issue with the colors.");

initPatch("1.0", "Feb 3 2023"); // (replace the date lol)
initHeader("General");
initSection("The character was released.");

initPatch("About Hazama", "");
initHeader("Character by");
initSection("scauroboros");
initHeader("Character / sounds / assets from");
initSection("Arc System Works' BlazBlue");
...
CHEAT_STOCKS		= initCheat("Infinite Stocks", [0, 1], ["Off", "On"], "Forces chain stocks to always be 2.");
