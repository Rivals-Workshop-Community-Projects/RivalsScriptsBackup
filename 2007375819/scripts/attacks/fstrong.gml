...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .35);
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_ori_glide_featherout"));
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 2);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_Y, -43);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HITPAUSE_SCALING, 1.05);
