...
set_attack_value(AT_DSPECIAL_2, AG_HURTBOX_SPRITE, sprite_get("hurtb"));
...
set_window_value(AT_DSPECIAL_2, 2, AG_WINDOW_LENGTH, 9);
...
set_window_value(AT_DSPECIAL_2, 2, AG_WINDOW_SFX, sound_get("sfx_whistle2"));
