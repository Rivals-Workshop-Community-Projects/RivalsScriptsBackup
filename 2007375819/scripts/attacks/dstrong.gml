...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, .5);
...
set_window_value(AT_DSTRONG, 5, AG_WINDOW_HSPEED, 4);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_X, 12);
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_Y, -26);
set_hitbox_value(AT_DSTRONG, 2, HG_WIDTH, 95);
set_hitbox_value(AT_DSTRONG, 2, HG_HEIGHT, 49);
