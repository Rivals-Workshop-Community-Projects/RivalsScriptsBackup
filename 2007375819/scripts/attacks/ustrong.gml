...
set_window_value(AT_USTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_shop_move"));
...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_abyss_portal_spawn"));
...
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_X, 66);
...
set_hitbox_value(AT_USTRONG, 3, HG_WINDOW_CREATION_FRAME, 15);
