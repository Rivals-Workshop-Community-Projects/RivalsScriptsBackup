...
set_hitbox_value(AT_UAIR, 2, HG_HITBOX_Y, -92);
set_hitbox_value(AT_UAIR, 2, HG_WIDTH, 8);
set_hitbox_value(AT_UAIR, 2, HG_HEIGHT, 8);
...
set_hitbox_value(AT_UAIR, 2, HG_KNOCKBACK_SCALING, .95);
...
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, asset_get("sfx_ori_sein_fstrong_hit"));
