...
set_window_value(AT_FTILT, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, 5);
...
set_hitbox_value(AT_FTILT, 2, HG_WIDTH, 82);
...
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, sound_get("ilikeyacutgslap"));