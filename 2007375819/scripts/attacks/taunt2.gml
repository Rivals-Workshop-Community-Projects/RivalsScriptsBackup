...
set_window_value(AT_TAUNT_2, 4, AG_WINDOW_SFX, asset_get("sfx_ori_glide_featherout"));
...
set_window_value(AT_TAUNT_2, 6, AG_WINDOW_LENGTH, 4);
...
set_hitbox_value(AT_TAUNT_2, 1, HG_HITBOX_X, 56);
...
set_hitbox_value(AT_TAUNT_2, 1, HG_BASE_KNOCKBACK, .001);
set_hitbox_value(AT_TAUNT_2, 1, HG_KNOCKBACK_SCALING, 1);
set_hitbox_value(AT_TAUNT_2, 1, HG_BASE_HITPAUSE, 2);
set_hitbox_value(AT_TAUNT_2, 1, HG_HITPAUSE_SCALING, 1.5);
