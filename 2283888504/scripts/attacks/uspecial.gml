...
set_attack_value(AT_USPECIAL, AG_MUNO_ATTACK_MISC_ADD, "To view KB angles for different travel directions, perform that USpecial and then refresh frame data (press JUMP)");
