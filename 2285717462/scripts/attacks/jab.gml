...
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, sfx_sonic_swipe_2);
...
set_hitbox_value(AT_JAB, 1, HG_MUNO_OBJECT_LAUNCH_ANGLE, 45);
...
set_hitbox_value(AT_JAB, 2, HG_DAMAGE, 5); // 7
...
set_hitbox_value(AT_JAB, 2, HG_MUNO_OBJECT_LAUNCH_ANGLE, 45);