...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, sfx_sonic_spin);
...
set_hitbox_value(AT_NAIR, 1, HG_WIDTH, 82); // 96
set_hitbox_value(AT_NAIR, 1, HG_HEIGHT, 56); // 64
...
set_hitbox_value(AT_NAIR, 3, HG_WIDTH, 90); // 112
set_hitbox_value(AT_NAIR, 3, HG_HEIGHT, 62); // 75
...
for (var i = 1; i < 4; i++) set_hitbox_value(AT_NAIR, i, HG_MUNO_OBJECT_LAUNCH_ANGLE, -1);