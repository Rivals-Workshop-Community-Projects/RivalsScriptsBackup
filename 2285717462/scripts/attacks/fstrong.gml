...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, sfx_sonic_shield_fire_equip);
...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.5);
...
set_hitbox_value(AT_FSTRONG, 1, HG_MUNO_OBJECT_LAUNCH_ANGLE, 360);