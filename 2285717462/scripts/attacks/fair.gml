...
set_window_value(AT_FAIR, 1, AG_WINDOW_LENGTH, 8); // 6
...
set_hitbox_value(AT_FAIR, 1, HG_HEIGHT, 40); // 48
set_hitbox_value(AT_FAIR, 1, HG_SHAPE, 2); // 0
set_hitbox_value(AT_FAIR, 1, HG_PRIORITY, 2);
set_hitbox_value(AT_FAIR, 1, HG_DAMAGE, 6); // 7
...
set_hitbox_value(AT_FAIR, 1, HG_MUNO_OBJECT_LAUNCH_ANGLE, 360);