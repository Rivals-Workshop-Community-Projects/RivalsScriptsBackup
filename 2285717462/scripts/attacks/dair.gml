...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sfx_sonic_spin);
...
set_hitbox_value(AT_DAIR, 1, HG_DAMAGE, 10); // 12
set_hitbox_value(AT_DAIR, 1, HG_ANGLE, 316);
...
set_hitbox_value(AT_DAIR, 1, HG_MUNO_HITBOX_NAME, "Sweet");
set_hitbox_value(AT_DAIR, 1, HG_MUNO_OBJECT_LAUNCH_ANGLE, 315);
...
set_hitbox_value(AT_DAIR, 2, HG_DAMAGE, 6); // 8
...
set_hitbox_value(AT_DAIR, 2, HG_MUNO_OBJECT_LAUNCH_ANGLE, 315);