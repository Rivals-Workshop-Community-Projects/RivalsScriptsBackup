...
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.35);
...
set_hitbox_value(AT_DATTACK, 1, HG_EFFECT, has_rune("M"));
...
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, asset_get("sfx_swish_weak"));
...
set_hitbox_value(AT_DATTACK, 2, HG_EFFECT, has_rune("M"));
