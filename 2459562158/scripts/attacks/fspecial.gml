...
set_hitbox_value(AT_FSPECIAL, 2, HG_ANGLE, 130);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_VISUAL_EFFECT, grab_fx );
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, sound_get("grab"));
