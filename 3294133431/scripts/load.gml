...
sprite_change_offset("boxWalkStart", 96, 126);
sprite_change_offset("boxWalkStop", 96, 126);
...
sprite_change_offset("ftiltWeak", 64, 94);
...
sprite_change_offset("fairWeak", 64, 94);
...
sprite_change_offset("orbTrail", 4, 3);//orb_trail_spr

sprite_change_offset("sapper", 64, 65);
sprite_change_offset("sapperMask", 64, 65);

sprite_change_offset("money", 128, 64);
sprite_change_offset("cigarette", 128, 144);
