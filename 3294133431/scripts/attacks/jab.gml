...
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, asset_get("sfx_swipe_weak1"));//sound_get("knife_swing"));
//jab 1
...
set_window_value(AT_JAB, 4, AG_WINDOW_SFX, asset_get("sfx_swipe_weak2"));//sound_get("knife_swing"));
...
set_hitbox_value(AT_JAB, 2, HG_HITBOX_Y, -64);
