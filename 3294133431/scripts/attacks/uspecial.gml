...
set_hitbox_value(AT_USPECIAL, 2+loopHitboxes, HG_WIDTH, 64);
set_hitbox_value(AT_USPECIAL, 2+loopHitboxes, HG_HEIGHT, 42);
...
set_hitbox_value(AT_USPECIAL, 2+loopHitboxes, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_USPECIAL, 2+loopHitboxes, HG_KNOCKBACK_SCALING, .5);
...
set_hitbox_value(AT_USPECIAL, 2+loopHitboxes, HG_HITBOX_COLOR, $FFFF00);