...
set_hitbox_value(AT_BAIR, 1, HG_ANGLE, 90+45);
...
// set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, asset_get("sfx_blow_medium1"));//overriden in hit_player
...
set_hitbox_value(AT_BAIR, 2, HG_ANGLE, 90+30);
...
// set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, asset_get("sfx_blow_heavy2"));//overriden in hit_player
set_hitbox_value(AT_BAIR, 2, HG_ANGLE_FLIPPER, 0);
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_COLOR, $FFFF00);