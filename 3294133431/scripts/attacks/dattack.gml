...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sound_get("cardboard-box-down"));
// set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX_FRAME, 2);
//set_window_value(AT_DATTACK, 1, AG_WINDOW_CUSTOM_GRAVITY, 4);
...
//set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_GRAVITY, 4);
...
set_window_value(AT_DATTACK, 7, AG_WINDOW_ANIM_FRAMES, 4);
...
set_hitbox_value(AT_DATTACK, 3, HG_HEIGHT, 100);
