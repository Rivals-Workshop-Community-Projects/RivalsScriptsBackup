...
set_window_value(AT_UAIR, 2, AG_WINDOW_SFX, sound_get("rocket_hit_high"));
...
set_hitbox_value(AT_UAIR, 1, HG_WIDTH, 32);
set_hitbox_value(AT_UAIR, 1, HG_HEIGHT, 33);
...
set_hitbox_value(AT_UAIR, 3, HG_HITBOX_Y, -22);
...
set_hitbox_value(AT_UAIR, 3, HG_ANGLE, 361);
...
set_hitbox_value(AT_UAIR, 3, HG_HITBOX_Y, -33);
