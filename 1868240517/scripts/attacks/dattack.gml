...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sound_get("rocket_hit_high")); //asset_get("sfx_swipe_heavy1")
...
//set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX, sound_get("rocket_hit_high")); //asset_get("sfx_swipe_medium1")
...
set_hitbox_value(AT_DATTACK, 1, HG_HITBOX_X, -46);
set_hitbox_value(AT_DATTACK, 1, HG_HITBOX_Y, -23);
set_hitbox_value(AT_DATTACK, 1, HG_WIDTH, 43);
