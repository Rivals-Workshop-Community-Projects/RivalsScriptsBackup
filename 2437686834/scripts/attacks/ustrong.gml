...
//set_window_value(AT_USTRONG, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .4);
...
set_window_value(AT_USTRONG, 3, AG_WINDOW_HITPAUSE_FRAME, 5);
//set_window_value(AT_USTRONG, 3, AG_WINDOW_HSPEED, 2);
//set_window_value(AT_USTRONG, 3, AG_WINDOW_HSPEED_TYPE, 2);
set_window_value(AT_USTRONG, 3, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX, sound_get("smashhigh"));
...
set_hitbox_value(AT_USTRONG, 2, HG_DAMAGE, 17);
set_hitbox_value(AT_USTRONG, 2, HG_ANGLE, 96);
