...
//set_window_value(AT_UTILT, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, .4);
...
set_window_value(AT_UTILT, 3, AG_WINDOW_HITPAUSE_FRAME, 4);
...
set_window_value(AT_UTILT, 3, AG_WINDOW_SFX, sound_get("hydrantpull"));
...
set_hitbox_value(AT_UTILT, 1, HG_PRIORITY, 8);
...
//set_hitbox_value(AT_UTILT, 1, HG_EXTRA_HITPAUSE, 25);
