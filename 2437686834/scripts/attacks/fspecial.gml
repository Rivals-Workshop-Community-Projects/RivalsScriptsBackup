...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_SFX, sound_get("wa"));
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_SFX, sound_get("ka"));
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_SFX, sound_get("s_wa"));
...
set_window_value(AT_FSPECIAL, 5, AG_WINDOW_SFX, sound_get("s_ka"));
...
set_window_value(AT_FSPECIAL, 6, AG_WINDOW_SFX, sound_get("a_wa"))
set_window_value(AT_FSPECIAL, 6, AG_WINDOW_SFX_FRAME, 4);
...
set_window_value(AT_FSPECIAL, 7, AG_WINDOW_SFX, sound_get("a_ka"));
set_window_value(AT_FSPECIAL, 7, AG_WINDOW_SFX_FRAME, 4);
set_window_value(AT_FSPECIAL, 7, AG_USES_CUSTOM_GRAVITY, 1);
...
set_window_value(AT_FSPECIAL, 8, AG_USES_CUSTOM_GRAVITY, 1);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_ANGLE, 38);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_ANGLE, 38);
