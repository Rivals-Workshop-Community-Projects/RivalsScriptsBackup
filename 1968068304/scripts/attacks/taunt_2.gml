...
set_window_value(AT_TAUNT_2, 2, AG_WINDOW_SFX, sound_get("sharpen_edited_freesounds_nicktermer"));
...
set_window_value(AT_TAUNT_2, 3, AG_WINDOW_SFX, sound_get("sharpen_edited_freesounds_nicktermer"));

set_window_value(AT_TAUNT_2, 4, AG_WINDOW_TYPE, 3);
set_window_value(AT_TAUNT_2, 4, AG_WINDOW_LENGTH, 20);
