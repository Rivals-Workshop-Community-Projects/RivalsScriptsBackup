...
set_window_value(AT_UAIR, 4, AG_WINDOW_LENGTH, 14); //big cooldown
...
set_hitbox_value(AT_UAIR, 1, HG_ANGLE, 93);
...
set_hitbox_value(AT_UAIR, 1, HG_HITSTUN_MULTIPLIER, 0.95);
...
set_hitbox_value(AT_UAIR, 2, HG_ANGLE, 93);
...
set_hitbox_value(AT_UAIR, 2, HG_HITSTUN_MULTIPLIER,  0.95);
...
set_hitbox_value(AT_UAIR, 2, HG_DRIFT_MULTIPLIER, 0.5);
...
set_hitbox_value(AT_UAIR, 3, HG_ANGLE, 93);
...
set_hitbox_value(AT_UAIR, 3, HG_PRIORITY, 1);
set_hitbox_value(AT_UAIR, 3, HG_DRIFT_MULTIPLIER, 0.5);
