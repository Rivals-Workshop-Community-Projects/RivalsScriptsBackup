sprite_change_offset("big_band_hurtbox", 42, 146);
sprite_change_offset("big_band_crouchbox", 42, 146);
sprite_change_offset("idle", 80, 158);
sprite_change_offset("hurt", 80, 158);
sprite_change_offset("spinhurt", 80, 158);
sprite_change_offset("downhurt", 80, 158);
sprite_change_offset("bighurt", 80, 158);
sprite_change_offset("bouncehurt", 80, 158);
sprite_change_offset("uphurt", 80, 158);
...
sprite_change_offset("jump", 80, 158);
sprite_change_offset("doublejump", 80, 158);
sprite_change_offset("walljump", 80, 158);
...
sprite_change_offset("stand_nc", 80, 158);
sprite_change_offset("stand_nc_flash", 80, 158);
sprite_change_offset("air_nc", 80, 158);
sprite_change_offset("air_nc_flash", 80, 158);
sprite_change_offset("roll_forward", 80, 158);
sprite_change_offset("roll_backward", 80, 158);
sprite_change_offset("airdodge", 80, 158);
...
sprite_change_offset("ftilt", 66, 158);
sprite_change_offset("dtilt", 80, 158);
sprite_change_offset("utilt", 80, 158);
sprite_change_offset("nair", 80, 158);
sprite_change_offset("fair", 112, 158);
sprite_change_offset("bair", 80, 158);
sprite_change_offset("uair", 112, 190);
sprite_change_offset("dair", 80, 158);
sprite_change_offset("fstrong", 80, 158);
sprite_change_offset("ustrong", 70, 190);
sprite_change_offset("dstrong", 112, 158);
sprite_change_offset("nspecial", 112, 158);
sprite_change_offset("nspecial_air", 128, 158);
sprite_change_offset("nspecial_strong", 112, 158);
sprite_change_offset("fspecial", 112, 158);
sprite_change_offset("fspecial_air", 80, 158);
sprite_change_offset("uspecial", 80, 158);
sprite_change_offset("uspecial_air", 80, 158);
...
sprite_change_offset("dash_notes", 32, 64);

set_victory_bg(sprite_get("victory"));
set_victory_theme(sound_get("bb_victory"));