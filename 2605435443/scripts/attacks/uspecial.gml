...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX, sound_get("tuba"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_HITBOX_X, 78);
...
set_hitbox_value(AT_USPECIAL, 1, HG_EXTRA_HITPAUSE, 36);