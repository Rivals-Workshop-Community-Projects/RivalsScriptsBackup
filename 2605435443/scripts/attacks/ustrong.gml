...
set_hitbox_value(AT_USTRONG, 2, HG_WIDTH, 6);
set_hitbox_value(AT_USTRONG, 2, HG_HEIGHT, 6);
...
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_Y, -135);
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_X, 23);
set_hitbox_value(AT_USTRONG, 3, HG_WIDTH, 6);
set_hitbox_value(AT_USTRONG, 3, HG_HEIGHT, 6);
...
set_hitbox_value(AT_USTRONG, 4, HG_HITBOX_X, 23);
set_hitbox_value(AT_USTRONG, 4, HG_WIDTH, 6);
set_hitbox_value(AT_USTRONG, 4, HG_HEIGHT, 6);
...
set_hitbox_value(AT_USTRONG, 4, HG_HITPAUSE_SCALING, .68);
