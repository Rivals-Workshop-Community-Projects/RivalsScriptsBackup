...
set_window_value(AT_DAIR, 1, AG_WINDOW_CUSTOM_GRAVITY, .02);
...
set_window_value(AT_DAIR, 3, AG_WINDOW_CANCEL_FRAME, 0);
...
set_window_value(AT_DAIR, 4, AG_WINDOW_CUSTOM_GRAVITY, .02);
set_window_value(AT_DAIR, 4, AG_WINDOW_VSPEED_TYPE, 0);
set_window_value(AT_DAIR, 4, AG_WINDOW_VSPEED, -4);

set_window_value(AT_DAIR, 5, AG_WINDOW_TYPE, 9);
...
set_window_value(AT_DAIR, 5, AG_WINDOW_CUSTOM_GRAVITY, 1.02);
set_window_value(AT_DAIR, 5, AG_WINDOW_CUSTOM_AIR_FRICTION, 2.0);
...
set_hitbox_value(AT_DAIR, 2, HG_WIDTH, 128);
...
set_hitbox_value(AT_DAIR, 3, HG_WIDTH, 128);
...
set_hitbox_value(AT_DAIR, 4, HG_WIDTH, 128);
