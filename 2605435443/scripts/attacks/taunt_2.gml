...
set_attack_value(AT_TAUNT_2, AG_HURTBOX_SPRITE, sprite_get("big_band_hurtbox"));
...
set_window_value(AT_TAUNT_2, 2, AG_WINDOW_ANIM_FRAMES, 0);
...
set_window_value(AT_TAUNT_2, 3, AG_WINDOW_ANIM_FRAME_START, 21);