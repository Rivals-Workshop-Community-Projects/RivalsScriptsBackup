...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, sound_get("nspecial_close"));
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_SFX, sound_get("dspecial_thump_weak"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HITBOX_X, 126);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_ANGLE, 160);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HITBOX_X, 126);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_WIDTH, 98);
set_hitbox_value(AT_DSPECIAL, 2, HG_HEIGHT, 4);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_KNOCKBACK_SCALING, .50);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_HITBOX_X, 126);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_KNOCKBACK_SCALING, .40);
