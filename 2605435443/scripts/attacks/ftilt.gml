...
set_window_value(AT_FTILT, 4, AG_WINDOW_CANCEL_FRAME, 0);
...
set_window_value(AT_FTILT, 7, AG_WINDOW_HAS_WHIFFLAG, 2);
...
set_hitbox_value(AT_FTILT, 1, HG_HITBOX_X, 62);
...
set_hitbox_value(AT_FTILT, 1, HG_EXTRA_HITPAUSE, 6);
...
set_hitbox_value(AT_FTILT, 2, HG_HITPAUSE_SCALING, .20);
