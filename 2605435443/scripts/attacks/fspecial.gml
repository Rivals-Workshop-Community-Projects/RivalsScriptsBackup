...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sound_get("brass_knuckle_thrust"));
...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_HAS_CUSTOM_FRICTION, 2.02);
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_HAS_CUSTOM_FRICTION, .10);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_WIDTH, 150);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_KNOCKBACK_SCALING, .84);
set_hitbox_value(AT_FSPECIAL, 1, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_FSPECIAL, 1, HG_HITPAUSE_SCALING, 1.4);
