...
sprite_change_offset("ustrong", 93, 114);
...
sprite_change_offset("crouch_hurt", 93, 114);
sprite_change_offset("idle_hurt", 93, 114);

sprite_change_offset("sparkle", 17, 17);
sprite_change_offset("explosion", 71, 100);

sprite_change_offset("alarm_idle", 93, 114);
sprite_change_offset("alarm_land", 93, 114);
sprite_change_offset("alarm_break", 93, 114);
sprite_change_offset("alarm_col", 93, 114);

sprite_change_offset("pillow", 93, 114);