...
set_hitbox_value(AT_DATTACK, 1, HG_HITSTUN_MULTIPLIER, 0.75);
...
set_hitbox_value(AT_DATTACK, 2, HG_WIDTH, 82);
...
set_hitbox_value(AT_DATTACK, 3, HG_WIDTH, 82);
...
set_hitbox_value(AT_DATTACK, 4, HG_WIDTH, 82);
set_hitbox_value(AT_DATTACK, 4, HG_HEIGHT, 31);
