...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("lava1"));
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX_FRAME, 4);

//active 1
set_window_value(AT_DSTRONG, 3, AG_WINDOW_TYPE, 1);
set_window_value(AT_DSTRONG, 3, AG_WINDOW_LENGTH, dstrong_active_frames);
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_SFX, sound_get("lava2"));
set_window_value(AT_DSTRONG, 4, AG_WINDOW_SFX_FRAME, 2);

//active 2
set_window_value(AT_DSTRONG, 5, AG_WINDOW_TYPE, 1);
set_window_value(AT_DSTRONG, 5, AG_WINDOW_LENGTH, dstrong_active_frames);
...
set_hitbox_value(AT_DSTRONG, 1, HG_LIFETIME, dstrong_active_frames);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, asset_get("sfx_ell_uspecial_explode"));

set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_DSTRONG, 2, HG_WINDOW, 5);
set_hitbox_value(AT_DSTRONG, 2, HG_LIFETIME, dstrong_active_frames);
