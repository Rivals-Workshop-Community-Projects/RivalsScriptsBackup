...
set_window_value(AT_UTILT, 2, AG_WINDOW_SFX_FRAME, 11);
...
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, HFX_ZET_FIRE);
...
set_hitbox_value(AT_UTILT, 3, HG_VISUAL_EFFECT, HFX_ZET_FIRE_DIR);
