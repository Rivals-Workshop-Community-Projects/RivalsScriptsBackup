...
//set_window_value(AT_FSTRONG, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, 4.6);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_X, 118);
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_Y, -26);
set_hitbox_value(AT_FSTRONG, 2, HG_WIDTH, 18);
