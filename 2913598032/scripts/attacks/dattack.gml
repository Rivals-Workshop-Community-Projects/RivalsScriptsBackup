...
set_window_value(AT_DATTACK, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, .9);
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .9);
...
set_window_value(AT_DATTACK, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, .9);
...
set_window_value(AT_DATTACK, 7, AG_WINDOW_HAS_WHIFFLAG, 10);
...
set_hitbox_value(AT_DATTACK, 4, HG_HITBOX_X, 68);
