...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_HAS_WHIFFLAG, 5);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sfx_hit2);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, sfx_hit2);
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_LOCKOUT, 10);

set_hitbox_value(AT_FSTRONG, 3, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_FSTRONG, 3, HG_LIFETIME, 240);
...
set_hitbox_value(AT_FSTRONG, 3, HG_ANGLE_FLIPPER, 8);
...
set_hitbox_value(AT_FSTRONG, 3, HG_PROJECTILE_SPRITE, spr_throw_sword);
...
set_hitbox_value(AT_FSTRONG, 3, HG_PROJECTILE_GROUND_BEHAVIOR, 0);
set_hitbox_value(AT_FSTRONG, 3, HG_PROJECTILE_HSPEED, 8);
set_hitbox_value(AT_FSTRONG, 3, HG_PROJECTILE_VSPEED, -6);
set_hitbox_value(AT_FSTRONG, 3, HG_PROJECTILE_GRAVITY, 0.5);
...
set_hitbox_value(AT_FSTRONG, 3, HG_PROJECTILE_DESTROY_EFFECT, 301);
set_hitbox_value(AT_FSTRONG, 3, HG_IGNORES_PROJECTILES, 0);