...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, asset_get("sfx_kragg_spike"));
...
set_hitbox_value(AT_DTILT, 2, HG_HIT_SFX, sfx_bonk);
...
set_hitbox_value(AT_DTILT, 3, HG_HIT_SFX, asset_get("sfx_springgo"));
set_hitbox_value(AT_DTILT, 3, HG_HIT_LOCKOUT, 10);
set_hitbox_value(AT_DTILT, 3, HG_PROJECTILE_SPRITE, sprite_get("empty"));
