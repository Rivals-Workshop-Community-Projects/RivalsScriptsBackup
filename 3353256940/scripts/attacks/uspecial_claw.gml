...
set_attack_value(AT_EXTRA_3, AG_HURTBOX_SPRITE, sprite_get("uspecial_claw_hurt"));
...
set_hitbox_value(AT_EXTRA_3, 4, HG_BASE_KNOCKBACK, 8.1); 
set_hitbox_value(AT_EXTRA_3, 4, HG_KNOCKBACK_SCALING, 0.95); 
