...
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT, thunder_small);
...
set_hitbox_value(AT_DTILT, 2, HG_HIT_SFX, asset_get("sfx_absa_harderhit"));
set_hitbox_value(AT_DTILT, 2, HG_VISUAL_EFFECT, thunder_small);
set_hitbox_value(AT_DTILT, 2, HG_TWENNY_ELECTRIC, 1);
