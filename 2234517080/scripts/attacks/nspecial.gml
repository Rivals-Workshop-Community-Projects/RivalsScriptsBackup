...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_abyss_explosion_start"));
...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_abyss_hex_hit"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_EXTRA_HITPAUSE, 16);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, blaboa_big);