...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_kragg_roll_end"));
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_VSPEED, 19);
...
set_window_value(AT_DSPECIAL, 5, AG_WINDOW_SFX, asset_get("sfx_blow_heavy1"));
...
set_window_value(AT_DSPECIAL, 7, AG_WINDOW_SFX, asset_get("sfx_kragg_rock_pull"));
set_window_value(AT_DSPECIAL, 7, AG_WINDOW_SFX_FRAME, 3);
...
set_window_value(AT_DSPECIAL, 8, AG_WINDOW_VSPEED, -9);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HEIGHT, 19);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HEIGHT, 37);
