...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_gem_collect"));
...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_CUSTOM_GRAVITY, 0.25);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_WIDTH, 136);
set_hitbox_value(AT_NSPECIAL, 2, HG_HEIGHT, 136);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HIT_SFX, asset_get("mfx_hp_spawn"));
...
set_hitbox_value(AT_NSPECIAL, 3, HG_HIT_LOCKOUT, 2);
