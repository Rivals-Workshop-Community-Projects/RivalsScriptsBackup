...
state_timer = 0;
bomb_timer = 0;                                      //The point in time during that state the article should start in. (0 = beginning)
remoteCtrl = false;
...
switch(cardValue)
{   //SDCH
    case 0: sprite_index = sprite_get("nspecial-spade"); break;
    case 1: sprite_index = sprite_get("nspecial-diamond"); break;
    case 2: sprite_index = sprite_get("nspecial-club"); break;
    case 3: sprite_index = sprite_get("nspecial-heart"); break;
}

hitstop = 0;                                        //The frames remaining in hitpause. Hitpause automatically prevents movement
hit_timer = 0;
hbox_owner = player_id.player;
oldvsp = 0;
