...
if get_player_color(player) == 17 {
    ...
    set_color_profile_slot(17, 0,color_get_red(color_hsv2),color_get_green(color_hsv2),color_get_blue(color_hsv2));
    set_color_profile_slot(17, 2,color_get_red(color_hsv),color_get_green(color_hsv),color_get_blue(color_hsv));
    set_color_profile_slot(17, 5,455-color_get_red(color_hsv),455-color_get_green(color_hsv),455-color_get_blue(color_hsv));
...
alt_name[0]  = "Chaotic Gambit";
alt_name[1]  = "Blue Ocean";
alt_name[2]  = "Serena Hat";
alt_name[3]  = "Mint Chompo";
alt_name[4]  = "Great White";
alt_name[5]  = "Banana's Foster";
alt_name[6]  = "Season's Beatings";
alt_name[7]  = "Gamesharc";
alt_name[8]  = "Joker of Infamy";
alt_name[9]  = "Card Champion";
alt_name[10]  = "Nostalgia Gimmick";
alt_name[11] = "Wild Card West";
alt_name[12] = "Cyberpoker";
alt_name[13] = "Dark Shark";
alt_name[14] = "Trans Bites";
alt_name[15] = "BLM, nuff said";
alt_name[16] = "Bitesexual";
alt_name[17] = "Deal the Rainbow";
alt_name[18]  = "Loan Shark";
alt_name[19]  = "Devilspade";
alt_name[20]  = "Chaos King";
alt_name[21] = "DS Ballyhoo";
alt_name[22] = "Rat Hivemind";
alt_name[23] = "Tumblr Sexy Man";
alt_name[24] = "We live in a society.";
alt_name[25] = "Fungus Amogus";
...
draw_sprite_ext(sprite_get("charselect"), (get_player_color( player ) == 10), temp_x+102, temp_y, clamp((-1+(timerSelect)/8*2),-1, 1), 1, 0, c_white, 1);
// //Alt
