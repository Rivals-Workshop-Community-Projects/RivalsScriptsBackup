...
set_window_value(AT_FTILT, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, 4);
set_window_value(AT_FTILT, 1, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_FTILT, 1, AG_WINDOW_INVINCIBILITY, 0);
set_window_value(AT_FTILT, 1, AG_WINDOW_HITPAUSE_FRAME, 0);
...
set_window_value(AT_FTILT, 2, AG_WINDOW_SFX, sound_get("demo_sword_swing3"));
...
set_window_value(AT_FTILT, 3, AG_WINDOW_HITPAUSE_FRAME, 0);
...
set_hitbox_value(AT_FTILT, 1, HG_HITBOX_Y, -70);
set_hitbox_value(AT_FTILT, 1, HG_WIDTH, 48);
set_hitbox_value(AT_FTILT, 1, HG_HEIGHT, 77);
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, sound_get("panhit"));
