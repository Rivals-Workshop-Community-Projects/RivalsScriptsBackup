...
set_hitbox_value(atk, num, HG_KNOCKBACK_SCALING, 1 + .1*has_rune("F"));
...
set_hitbox_value(atk, num, HG_DAMAGE, 7);
set_hitbox_value(atk, num, HG_ANGLE, 45);
set_hitbox_value(atk, num, HG_BASE_KNOCKBACK, 8 + has_rune("F"));
set_hitbox_value(atk, num, HG_KNOCKBACK_SCALING, .95 + .1*has_rune("F"));
