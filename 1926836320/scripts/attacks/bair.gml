...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("quickattack1"));
...
set_window_value(AT_BAIR, 2, AG_WINDOW_CUSTOM_GRAVITY, .63);
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("quickattack2"));
