...
with (UNOWN_ATK) //shortcut
{
    ...
    UNOWN_SPECIALS  = [T, T, T, 
                       W, O, L, 
                       A, A, A];
}
//===============================================================
//Input parsing
if (is_special_pressed(DIR_ANY)) && lev_is_grounded
{
...
//?? unsure why "is_strong_pressed(DIR_ANY)" doesnt work for the strong-attack controller setting
    ...
    || left_strong_pressed || right_strong_pressed) && lev_is_grounded || (strong_down) && lev_is_grounded
{
...
else if (is_attack_pressed(DIR_ANY)) && lev_is_grounded
{
