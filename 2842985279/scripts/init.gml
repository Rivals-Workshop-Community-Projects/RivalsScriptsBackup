...
sfx_unown_buff_up = sound_get("rise");
sfx_unown_buff_down = sound_get("fall");
...
unown_turning_time_per_frame = 2;
...
ssl_hud_font = font_get("ssl_hud_font")
ssl_hud_font_ol = font_get("ssl_hud_font_ol")
