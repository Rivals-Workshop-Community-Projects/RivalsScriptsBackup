...
set_attack_value(AT_DSPECIAL_2, AG_SPRITE, sprite_get("Bfspecial"));
set_attack_value(AT_DSPECIAL_2, AG_HURTBOX_SPRITE, sprite_get("Bfspecial_hurt"));
...
set_window_value(AT_DSPECIAL_2, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.01);
set_window_value(AT_DSPECIAL_2, 1, AG_WINDOW_CUSTOM_GRAVITY, 0.1);
...
set_window_value(AT_DSPECIAL_2, 2, AG_WINDOW_SFX, asset_get("sfx_ell_big_missile_fire"));
set_window_value(AT_DSPECIAL_2, 2, AG_WINDOW_SFX_FRAME, 9);

set_window_value(AT_DSPECIAL_2, 3, AG_WINDOW_LENGTH, 10000);
set_window_value(AT_DSPECIAL_2, 3, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_DSPECIAL_2, 3, AG_WINDOW_ANIM_FRAME_START, 6);

set_window_value(AT_DSPECIAL_2, 4, AG_WINDOW_TYPE, 7);
...
set_window_value(AT_DSPECIAL_2, 4, AG_WINDOW_CUSTOM_GRAVITY, 0.5);
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_LIFETIME, 10000);
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_BASE_HITPAUSE, 18);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HITPAUSE_SCALING, 1.0);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HIT_SFX, asset_get("sfx_ell_fist_explode"));
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_BASE_HITPAUSE, 18);
set_hitbox_value(AT_DSPECIAL_2, 2, HG_HITPAUSE_SCALING, 1.0);
set_hitbox_value(AT_DSPECIAL_2, 2, HG_HIT_SFX, asset_get("sfx_ell_fist_explode"));
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_PROJECTILE_DOES_NOT_REFLECT, 0);
