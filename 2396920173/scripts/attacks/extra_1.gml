...
set_attack_value(AT_EXTRA_1, AG_SPRITE, sprite_get("Kidle"));
...
set_attack_value(AT_EXTRA_1, AG_HURTBOX_SPRITE, sprite_get("Khurtbox"));

set_window_value(AT_EXTRA_1, 1, AG_WINDOW_TYPE, 1);
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_LENGTH, 9999);
