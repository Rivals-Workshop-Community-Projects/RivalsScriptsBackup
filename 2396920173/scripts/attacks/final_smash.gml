...
set_attack_value(49, AG_SPRITE, sprite_get("finalsmash_chessatron"));
set_attack_value(49, AG_HURTBOX_SPRITE, sprite_get("finalsmash_chessatron_hurt"));
...
//fly down
set_window_value(49, 3, AG_WINDOW_LENGTH, 300);
...
//land
set_window_value(49, 4, AG_WINDOW_LENGTH, 49);
...
set_window_value(49, 6, AG_WINDOW_SFX, asset_get("sfx_abyss_hazard_start"));
set_window_value(49, 6, AG_WINDOW_SFX_FRAME, 0);

set_window_value(49, 7, AG_WINDOW_LENGTH, 9);
set_window_value(49, 7, AG_WINDOW_ANIM_FRAMES, 3);
