...
set_hitbox_value(AT_DTHROW, 1, HG_HITBOX_Y, 500);
set_hitbox_value(AT_DTHROW, 1, HG_WIDTH, 100);
set_hitbox_value(AT_DTHROW, 1, HG_HEIGHT, 1000);
set_hitbox_value(AT_DTHROW, 1, HG_PRIORITY, 4);
...
set_hitbox_value(AT_DTHROW, 1, HG_HIT_SFX, asset_get("sfx_absa_singlezap1"));
...
set_hitbox_value(AT_DTHROW, 1, HG_PROJECTILE_IS_TRANSCENDENT, 0);
