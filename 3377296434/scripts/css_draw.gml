...
if (!variable_instance_exists(id,"ae") || ye == true){
    ...
    ce[0,0] = make_color_rgb(158, 67, 18) // "color preview square" color. can be any color!
    ce[0,1] = "The Gustavo & Brick Hour" // the name of the alternate color.
    
    ce[1,0] = make_color_rgb(245, 247, 252)
    ce[1,1] = "Back to That Guy"
    
    ce[2,0] = make_color_rgb(255, 219, 61)
    ce[2,1] = "Introducing the Noise"
    
    ce[3,0] = make_color_rgb(161, 89, 45)
    ce[3,1] = "Outlaws Beware"
    
    ce[4,0] = make_color_rgb(255, 219, 112)
    ce[4,1] = "Technical Difficulties"
    
    ce[5,0] = make_color_rgb(242, 23, 23)
    ce[5,1] = "Let's-a Go!"
    
    ce[6,0] = make_color_rgb(242, 23, 23)
    ce[6,1] = "Abyss"
    
    ce[7,0] = make_color_rgb(242, 23, 23)
    ce[7,1] = "Early Access"
    
    ce[6+2,0] = make_color_rgb(74, 242, 23)
    ce[6+2,1] = "Okie Dokie!"
	
    ce[7+2,0] = make_color_rgb(255, 148, 199)
    ce[7+2,1] = "Dream Team"
	
    ce[8+2,0] = make_color_rgb(144, 58, 184)
    ce[8+2,1] = "Audaciously Herbacious!" // VIVA LA ARVENCORD
	
    ce[9+2,0] = make_color_rgb(228, 231, 237)
    ce[9+2,1] = "Don't Mine at Night"
    ...
    ce[14,1] = "Transcendance"
	
    ce[15,0] = make_color_rgb(255, 145, 218)
    ce[15,1] = "Bacon Lettuce Meatball"

    ce[16,0] = make_color_rgb(184, 81, 120 )
    ce[16,1] = "River to the Sea"
