...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sound_get("groundpoundstart"));
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_SFX, asset_get("sfx_blow_medium1"));
...
set_hitbox_value(AT_DATTACK, 1, HG_FINAL_BASE_KNOCKBACK, 7);
