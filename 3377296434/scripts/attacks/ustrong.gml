...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_ell_dspecial_explosion_1"));
...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_LOCKOUT, 24);
...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("sfx_explosion"));
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("ground_hit"));
