...
set_attack_value(AT_FSPECIAL, AG_SPRITE, sprite_get("jab"));
set_attack_value(AT_FSPECIAL, AG_NUM_WINDOWS, 2);
set_attack_value(AT_FSPECIAL, AG_HAS_LANDING_LAG, 4);
set_attack_value(AT_FSPECIAL, AG_OFF_LEDGE, 1);
set_attack_value(AT_FSPECIAL, AG_AIR_SPRITE, sprite_get("nair"));
set_attack_value(AT_FSPECIAL, AG_HURTBOX_SPRITE, -1);

set_window_value(AT_FSPECIAL, 1, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_LENGTH, 12);
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_ANIM_FRAMES, 6);
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sound_get("s18_thunder"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_Y, 4);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_EFFECT, 11); // electric stun
...
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("stun_knife"));
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("stun_knife"));
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_HSPEED, 12);
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_VSPEED, 0.2);
