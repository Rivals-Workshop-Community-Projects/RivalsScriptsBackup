...
set_window_value(AT_DSPECIAL_AIR, 1, AG_WINDOW_HSPEED, 3);
...
set_window_value(AT_DSPECIAL_AIR, 2, AG_WINDOW_SFX, sound_get("counter"));
...
//set_window_value(AT_DSPECIAL_AIR, 3, AG_WINDOW_SFX, sound_get("peach_vore"));