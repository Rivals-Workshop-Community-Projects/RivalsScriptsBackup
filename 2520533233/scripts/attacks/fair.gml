...
set_hitbox_value(AT_FAIR, 3, HG_VISUAL_EFFECT, 4 );
...
set_hitbox_value(AT_FAIR, 4, HG_VISUAL_EFFECT, 4 );
...
set_hitbox_value(AT_FAIR, 5, HG_WINDOW_CREATION_FRAME, 1);
...
set_hitbox_value(AT_FAIR, 7, HG_VISUAL_EFFECT, 148 );
...
set_hitbox_value(AT_FAIR, 8, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_FAIR, 8, HG_HITPAUSE_SCALING, 0.5);
set_hitbox_value(AT_FAIR, 8, HG_VISUAL_EFFECT, 148 );
