...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX, sound_get("counter"));
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_LENGTH, 11);
...
//set_window_value(AT_DSPECIAL, 3, AG_WINDOW_SFX, sound_get("peach_vore"));
