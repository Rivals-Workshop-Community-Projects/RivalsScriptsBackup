...
set_attack_value(AT_NSPECIAL_2, AG_MUNO_ATTACK_NAME, "Install Activation");
...
set_window_value(AT_EXTRA_1, 2, AG_WINDOW_SFX, sound_get("peach_vore"));
...
//set_window_value(AT_EXTRA_1, 3, AG_WINDOW_SFX, sound_get("peach_vore"));
...
set_window_value(AT_EXTRA_1, 5, AG_WINDOW_LENGTH, 36);
set_window_value(AT_EXTRA_1, 5, AG_WINDOW_ANIM_FRAMES, 6);
set_window_value(AT_EXTRA_1, 5, AG_WINDOW_ANIM_FRAME_START, 1);