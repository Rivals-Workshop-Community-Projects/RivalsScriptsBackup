set_attack_value(AT_PHONE, AG_SPRITE, sprite_get("taunt"));
...
set_attack_value(AT_PHONE, AG_HURTBOX_SPRITE, sprite_get("hurtbox"));
...
set_window_value(AT_PHONE, 1, AG_WINDOW_LENGTH, 1);
set_window_value(AT_PHONE, 1, AG_WINDOW_ANIM_FRAMES, 1);

//Looping window

set_window_value(AT_PHONE, 2, AG_WINDOW_TYPE, 9);
set_window_value(AT_PHONE, 2, AG_WINDOW_LENGTH, 45);
set_window_value(AT_PHONE, 2, AG_WINDOW_ANIM_FRAMES, 15);
set_window_value(AT_PHONE, 2, AG_WINDOW_ANIM_FRAME_START, 0);
