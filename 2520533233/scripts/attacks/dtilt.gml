...
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT, 4 );
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, sound_get("hisou_hit_light"));
...
set_hitbox_value(AT_DTILT, 2, HG_KNOCKBACK_SCALING, 0.85);
...
set_hitbox_value(AT_DTILT, 3, HG_HITBOX_Y, -8);
...
set_hitbox_value(AT_DTILT, 3, HG_VISUAL_EFFECT, 4 );
...
set_hitbox_value(AT_DTILT, 5, HG_HITBOX_Y, -8);
set_hitbox_value(AT_DTILT, 5, HG_SHAPE, 0);
set_hitbox_value(AT_DTILT, 5, HG_WIDTH, 66);
set_hitbox_value(AT_DTILT, 5, HG_HEIGHT, 22);
...
set_hitbox_value(AT_DTILT, 5, HG_VISUAL_EFFECT, 148 );
...
set_hitbox_value(AT_DTILT, 6, HG_VISUAL_EFFECT, 148 );
