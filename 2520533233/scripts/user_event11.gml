...
for (i = 0; i < array_length_1d(arr[cursor].objs); i++){
	...
	if (cur.type == 1){ // Images
		...
		draw_sprite_part_ext(cur.sprite, draw_frame, draw_l, draw_t, draw_w, draw_h, draw_x + offset_x, draw_y + offset_y, cur.xscale, 2, cur.color, 1);
		switch(cur.gimmick){
			case 2:
			case 3:
				draw_sprite_part_ext(cur.sprite, draw_frame, draw_l, draw_t, draw_w, draw_h, draw_x + offset_x + side_bar.screen_w, draw_y + offset_y, cur.xscale, 2, cur.color, 1);
				draw_sprite_part_ext(cur.sprite, draw_frame, draw_l, draw_t, draw_w, draw_h, draw_x + offset_x - side_bar.screen_w, draw_y + offset_y, cur.xscale, 2, cur.color, 1);
				break;
			case 4:
				break;
