...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_coin_capture"));
...
set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_ori_bash_launch"));
...
set_hitbox_value(AT_USTRONG, 1, HG_LIFETIME, 14);
...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, asset_get("mfx_star"));

set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_USTRONG, 2, HG_WINDOW, 3);
set_hitbox_value(AT_USTRONG, 2, HG_WINDOW_CREATION_FRAME, 2);
set_hitbox_value(AT_USTRONG, 2, HG_LIFETIME, 14);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT_Y_OFFSET, -30);
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, asset_get("mfx_star"));

set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_GROUP,1);
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_GROUP,1);

set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, FairyWind);
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, FairyWind);