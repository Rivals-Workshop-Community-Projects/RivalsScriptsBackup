...
set_attack_value(AT_USPECIAL_2, AG_AIR_SPRITE, sprite_get("dair"));
...
set_window_value(AT_USPECIAL_2, 1, AG_WINDOW_CUSTOM_GRAVITY, 0.2);
...
set_window_value(AT_USPECIAL_2, 3, AG_WINDOW_TYPE, 8);
...
set_hitbox_value(AT_USPECIAL_2, 1, HG_WINDOW_CREATION_FRAME, 6);
...
set_hitbox_value(AT_USPECIAL_2, 3, HG_HITPAUSE_SCALING, 0.2);
...
set_hitbox_value(AT_USPECIAL_2, 4, HG_DAMAGE, 6);
set_hitbox_value(AT_USPECIAL_2, 4, HG_ANGLE, 86);
set_hitbox_value(AT_USPECIAL_2, 4, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_USPECIAL_2, 4, HG_KNOCKBACK_SCALING, 1);
set_hitbox_value(AT_USPECIAL_2, 4, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_USPECIAL_2, 4, HG_HITPAUSE_SCALING, 0.9);
...
set_hitbox_value(AT_USPECIAL_2, 2, HG_HIT_SFX, asset_get("sfx_blow_medium2"));
