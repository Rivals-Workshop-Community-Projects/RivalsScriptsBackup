...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, asset_get("sfx_ice_shieldup"));
...
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, asset_get("sfx_icehit_weak1"));
set_hitbox_value(AT_UTILT, 2, HG_ANGLE_FLIPPER, 6);

set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, 27);
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT_Y_OFFSET, -3);
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, 27);
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT_Y_OFFSET, -3);
