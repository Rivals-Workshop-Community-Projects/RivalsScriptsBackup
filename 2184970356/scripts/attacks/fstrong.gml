...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_ice_dspecial_form"));
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_icehit_medium1"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_ANGLE, 59);
...
set_hitbox_value(AT_FSTRONG, 2, HG_LIFETIME, 150);
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_Y, 0);
set_hitbox_value(AT_FSTRONG, 2, HG_HEIGHT, 15);
set_hitbox_value(AT_FSTRONG, 2, HG_WIDTH, 11);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, asset_get("sfx_icehit_weak1"));
set_hitbox_value(AT_FSTRONG, 2, HG_PROJECTILE_SPRITE, sprite_get("dair_proj"));
set_hitbox_value(AT_FSTRONG, 2, HG_PROJECTILE_MASK, -1);	
set_hitbox_value(AT_FSTRONG, 2, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_FSTRONG, 2, HG_PROJECTILE_HSPEED, 3);
set_hitbox_value(AT_FSTRONG, 2, HG_PROJECTILE_VSPEED, 10);
...
set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT, 29);
set_hitbox_value(AT_FSTRONG, 2, HG_PROJECTILE_DESTROY_EFFECT, 27);
...
set_hitbox_value(AT_FSTRONG, 3, HG_HIT_SFX, asset_get("sfx_icehit_weak1"));
