...
set_hitbox_value(AT_UAIR, 1, HG_KNOCKBACK_SCALING, .95);
...
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, asset_get("sfx_icehit_weak1"));
set_hitbox_value(AT_UAIR, 2, HG_ANGLE_FLIPPER, 6);

set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT, 27);
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT, 27);
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, -3);
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, -3);
