...
set_hitbox_value(AT_FTILT, 1, HG_HITBOX_Y, -13);
...
set_hitbox_value(AT_FTILT, 1, HG_ANGLE, 43);
...
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT_Y_OFFSET, -12);
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, 4);
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, asset_get("sfx_abyss_hazard_hit"));
set_hitbox_value(AT_FTILT, 1, HG_EXTRA_CAMERA_SHAKE, 7);

set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT, BugBuzz);