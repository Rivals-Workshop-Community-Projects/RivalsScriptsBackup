...
set_window_value(AT_TAUNT, 4, AG_WINDOW_SFX, asset_get("mfx_logo_shing"));

set_window_value(AT_TAUNT, 5, AG_WINDOW_TYPE, 1);
set_window_value(AT_TAUNT, 5, AG_WINDOW_LENGTH, 13);
...
set_window_value(AT_TAUNT, 6, AG_WINDOW_LENGTH, 21);
