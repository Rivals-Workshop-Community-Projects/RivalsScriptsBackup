...
set_hitbox_value(AT_NAIR, 2, HG_PRIORITY, 0.5);
set_hitbox_value(AT_NAIR, 2, HG_DAMAGE, 6);
set_hitbox_value(AT_NAIR, 2, HG_ANGLE, 45);
set_hitbox_value(AT_NAIR, 2, HG_ANGLE_FLIPPER, 5); //knockback reversed, since this is the back of the move
...
set_hitbox_value(AT_NAIR, 3, HG_WIDTH, 36);
...
set_hitbox_value(AT_NAIR, 4, HG_WIDTH, 32);
set_hitbox_value(AT_NAIR, 4, HG_HEIGHT, 20);
set_hitbox_value(AT_NAIR, 4, HG_SHAPE, 2);
set_hitbox_value(AT_NAIR, 4, HG_PRIORITY, 0.5);
set_hitbox_value(AT_NAIR, 4, HG_DAMAGE, 4);
set_hitbox_value(AT_NAIR, 4, HG_ANGLE, 45);
set_hitbox_value(AT_NAIR, 4, HG_ANGLE_FLIPPER, 5); //knockback reversed, since this is the back of the move
