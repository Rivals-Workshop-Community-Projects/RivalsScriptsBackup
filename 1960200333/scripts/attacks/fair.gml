...
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, asset_get("sfx_shovel_hit_heavy2"));
...
set_hitbox_value(AT_FAIR, 2, HG_PRIORITY, 0.5);
...
set_hitbox_value(AT_FAIR, 3, HG_ANGLE, 300);
...
set_hitbox_value(AT_FAIR, 3, HG_EXTRA_HITPAUSE, 15);
...
set_hitbox_value(AT_FAIR, 3, HG_HIT_SFX, sound_get("sfx_tf2pan"));
...
set_hitbox_value(AT_FAIR, 4, HG_HITSTUN_MULTIPLIER, 0.7);
set_hitbox_value(AT_FAIR, 4, HG_HIT_SFX, asset_get("sfx_shovel_hit_med2"));