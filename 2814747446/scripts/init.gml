...
knockback_adj       = 0.8;		// 0.9  -  1.2

// Ground movement
walk_speed          = 1.2;		// 3    -  4.5
walk_accel          = 0.125;		// 0.2  -  0.5
walk_turn_time      = 6;	    // 6
initial_dash_time   = 13;		// 8    -  16
initial_dash_speed  = 6;		// 4    -  9
dash_speed          = 5;		// 5    -  9
dash_turn_time      = 12;		// 8    -  20
dash_turn_accel     = 3;		// 0.1  -  2
...
wallcling_spr = sprite_get("wallstick");
