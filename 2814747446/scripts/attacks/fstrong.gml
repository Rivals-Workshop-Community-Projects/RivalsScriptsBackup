...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_LENGTH, 17);
...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX_FRAME, 16);
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_HSPEED, 17);
