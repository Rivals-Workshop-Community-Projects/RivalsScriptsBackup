...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_waveland_cla"));
set_window_value(AT_USPECIAL, 2, AG_WINDOW_HSPEED_TYPE, 2);
set_window_value(AT_USPECIAL, 2, AG_WINDOW_VSPEED_TYPE, 2);
set_window_value(AT_USPECIAL, 2, AG_WINDOW_HSPEED, 13);
set_window_value(AT_USPECIAL, 2, AG_WINDOW_VSPEED, -13);
// set_window_value(AT_USPECIAL, 2, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
// set_window_value(AT_USPECIAL, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, 5);
...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_forsburn_consume_fail"));
...
set_window_value(AT_USPECIAL, 6, AG_WINDOW_LENGTH, 0);
...
set_window_value(AT_USPECIAL, 6, AG_WINDOW_CUSTOM_AIR_FRICTION, 1);
...
set_window_value(AT_USPECIAL, 6, AG_WINDOW_SFX, asset_get("sfx_forsburn_consume_fail"));
...
// set_hitbox_value(AT_USPECIA2, 1, HG_HITBOX_X, 30);
...
set_hitbox_value(AT_USPECIAL, 2, HG_HIT_SFX, asset_get("sfx_kragg_rock_pillar"));
...
set_hitbox_value(AT_USPECIAL, 3, HG_WIDTH, 125);
set_hitbox_value(AT_USPECIAL, 3, HG_HEIGHT, 125);
