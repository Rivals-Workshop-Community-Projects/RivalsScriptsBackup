...
set_window_value(AT_JAB, 2, AG_WINDOW_SFX, asset_get("sfx_pillar_crumble"));
...
set_window_value(AT_JAB, 5, AG_WINDOW_CANCEL_FRAME, 7);
set_window_value(AT_JAB, 5, AG_WINDOW_CANCEL_TYPE, 1);
set_window_value(AT_JAB, 5, AG_WINDOW_SFX, asset_get("sfx_pillar_crumble"));
...
set_window_value(AT_JAB, 7, AG_WINDOW_CANCEL_FRAME, 5);
...
set_hitbox_value(AT_JAB, 1, HG_HEIGHT, 95);
