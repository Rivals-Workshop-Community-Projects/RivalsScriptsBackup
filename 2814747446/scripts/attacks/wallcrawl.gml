set_attack_value(AT_EXTRA_1, AG_SPRITE, sprite_get("wallstick"));
...
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_GOTO, 2);
...
set_hitbox_value(AT_EXTRA_1, 2, HG_LIFETIME, get_window_value(AT_UTHROW, 3, AG_WINDOW_LENGTH));
