...
set_window_value(AT_NSPECIAL_AIR, 1, AG_WINDOW_LENGTH, 17);
...
set_window_value(AT_NSPECIAL_AIR, 2, AG_WINDOW_HSPEED, 12);
...
set_window_value(AT_NSPECIAL_AIR, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, .2);
...
set_window_value(AT_NSPECIAL_AIR, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.18);
...
set_window_value(AT_NSPECIAL_AIR, 5, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_NSPECIAL_AIR, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.2);
...
set_hitbox_value(AT_NSPECIAL_AIR, 4, HG_LIFETIME, 30);
