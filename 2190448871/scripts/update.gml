...
if state == PS_LANDING_LAG && state_timer == 1 && attack == AT_FSPECIAL && (special_down && (left_down or right_down) or is_special_pressed(DIR_SIDE)){
...
if oldspeed < 100 && ceil(mariospeed) >= 100 && annouced == 0{
    sound_play(sound_get("here_we_go"));
    annouced = 1;
}