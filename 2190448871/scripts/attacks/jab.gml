...
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, sound_get("yah"));
...
set_window_value(AT_JAB, 4, AG_WINDOW_SFX, sound_get("wah"));
...
set_window_value(AT_JAB, 7, AG_WINDOW_SFX, sound_get("hoo"));
