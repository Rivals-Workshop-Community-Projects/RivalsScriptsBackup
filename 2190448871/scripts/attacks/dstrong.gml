...
set_hitbox_value(AT_DSTRONG, 5, HG_PROJECTILE_AIR_FRICTION, 0.3);
set_hitbox_value(AT_DSTRONG, 5, HG_PROJECTILE_HSPEED, 8);
set_hitbox_value(AT_DSTRONG, 5, HG_PROJECTILE_VSPEED, 0);
set_hitbox_value(AT_DSTRONG, 5, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_DSTRONG, 5, HG_PROJECTILE_ANIM_SPEED, 0.4);
...
set_hitbox_value(AT_DSTRONG, 5, HG_HITPAUSE_SCALING, 0.3);
set_hitbox_value(AT_DSTRONG, 5, HG_HIT_SFX, asset_get("sfx_ori_seinhit_heavy"));
set_hitbox_value(AT_DSTRONG, 5, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_DSTRONG, 5, HG_PROJECTILE_PARRY_STUN, 1);
set_hitbox_value(AT_DSTRONG, 5, HG_VISUAL_EFFECT, 305);

set_hitbox_value(AT_DSTRONG, 6, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_DSTRONG, 6, HG_WINDOW, 2);
set_hitbox_value(AT_DSTRONG, 6, HG_WINDOW_CREATION_FRAME, 1);
set_hitbox_value(AT_DSTRONG, 6, HG_LIFETIME, 30);
set_hitbox_value(AT_DSTRONG, 6, HG_HITBOX_X, 40);
set_hitbox_value(AT_DSTRONG, 6, HG_HITBOX_Y, -36);
...
set_hitbox_value(AT_DSTRONG, 6, HG_PROJECTILE_AIR_FRICTION, 0.3);
set_hitbox_value(AT_DSTRONG, 6, HG_PROJECTILE_HSPEED, -8);
set_hitbox_value(AT_DSTRONG, 6, HG_PROJECTILE_VSPEED, 0);
set_hitbox_value(AT_DSTRONG, 6, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_DSTRONG, 6, HG_PROJECTILE_ANIM_SPEED, 0.4);
set_hitbox_value(AT_DSTRONG, 6, HG_PROJECTILE_DESTROY_EFFECT, 302);
...
set_hitbox_value(AT_DSTRONG, 6, HG_ANGLE, 130);
...
set_hitbox_value(AT_DSTRONG, 6, HG_HITPAUSE_SCALING, 0.3);
set_hitbox_value(AT_DSTRONG, 6, HG_HIT_SFX, asset_get("sfx_ori_seinhit_heavy"));
set_hitbox_value(AT_DSTRONG, 6, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_DSTRONG, 6, HG_PROJECTILE_PARRY_STUN, 1);
set_hitbox_value(AT_DSTRONG, 6, HG_VISUAL_EFFECT, 305);