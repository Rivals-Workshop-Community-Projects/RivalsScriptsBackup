...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_HSPEED, -0.5);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_WIDTH, 68);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_LIFETIME, 600);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("sbug"));
...
set_hitbox_value(AT_DSPECIAL, 3, HG_PROJECTILE_GRAVITY, 0.0);
...
set_hitbox_value(AT_DSPECIAL, 4, HG_HITBOX_Y, -60);
...
set_hitbox_value(AT_DSPECIAL, 4, HG_PROJECTILE_SPRITE, sprite_get("spacebreak"));
set_hitbox_value(AT_DSPECIAL, 4, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_DSPECIAL, 4, HG_PROJECTILE_ANIM_SPEED, .3);
set_hitbox_value(AT_DSPECIAL, 4, HG_PROJECTILE_HSPEED, 0);
set_hitbox_value(AT_DSPECIAL, 4, HG_PROJECTILE_VSPEED, 0);
set_hitbox_value(AT_DSPECIAL, 4, HG_PROJECTILE_GRAVITY, 0.0);
