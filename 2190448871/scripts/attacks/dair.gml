...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sound_get("pound1"));
...
set_window_value(AT_DAIR, 3, AG_WINDOW_LENGTH, 500);
...
set_window_value(AT_DAIR, 4, AG_WINDOW_SFX, sound_get("pound2"));
...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, stomp_fx);
...
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT, stomp_fx);