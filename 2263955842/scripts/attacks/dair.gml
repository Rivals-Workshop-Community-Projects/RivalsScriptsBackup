...
set_hitbox_value(AT_DAIR, 1, HG_WIDTH, 71);
...
set_hitbox_value(AT_DAIR, 2, HG_HEIGHT, 33);
...
set_hitbox_value(AT_DAIR, 3, HG_WIDTH, 71);
set_hitbox_value(AT_DAIR, 3, HG_HEIGHT, 33);
