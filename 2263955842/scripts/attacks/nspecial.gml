...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, sound_get("yinyang"))//sound_get("field_expend"));
...
// REIMU B HITBOX // NOT USED
set_hitbox_value(AT_NSPECIAL, 1, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_NSPECIAL, 1, HG_WINDOW,666)
set_hitbox_value(AT_NSPECIAL, 1, HG_WINDOW_CREATION_FRAME, 666);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_GROUNDEDNESS, 0);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_WINDOW,666)
set_hitbox_value(AT_NSPECIAL, 2, HG_WINDOW_CREATION_FRAME, 666);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_GROUNDEDNESS, 0);
