...
if drawtime < 120 {
draw_sprite_ext(sprite_get("idle"),drawtime/6,temp_x-36,temp_y - floor(drawtime/2),2,2,0,-1,2 - drawtime/60);
draw_debug_text(floor(x)+18,floor(y)+145 - floor(drawtime/2),string(palette_names[alt]));
