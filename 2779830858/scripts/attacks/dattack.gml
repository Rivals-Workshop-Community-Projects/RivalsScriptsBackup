...
set_hitbox_value(AT_DATTACK, 1, HG_BALL_SPEED, 10);
set_hitbox_value(AT_DATTACK, 1, HG_BALL_ANGLE, 10);
...
set_hitbox_value(AT_DATTACK, 2, HG_BALL_SPEED, 12);
set_hitbox_value(AT_DATTACK, 2, HG_BALL_ANGLE, 10);