...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sound_get("blink_dash"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_WIDTH, 114);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, sound_get("blink_hit"));
set_hitbox_value(AT_FSPECIAL, 1, HG_IGNORES_PROJECTILES, 1);
set_hitbox_value(AT_FSPECIAL, 1, HG_BALL_SPEED, 30);
set_hitbox_value(AT_FSPECIAL, 1, HG_BALL_ANGLE, 0);