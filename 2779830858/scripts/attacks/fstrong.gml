...
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sound_get("bat_hit_heavy2"));
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_LOCKOUT, 10);
set_hitbox_value(AT_FSTRONG, 1, HG_BALL_SPEED, 12);
set_hitbox_value(AT_FSTRONG, 1, HG_BALL_ANGLE, -45);
...
set_hitbox_value(AT_FSTRONG, 3, HG_WIDTH, 10);
set_hitbox_value(AT_FSTRONG, 3, HG_HEIGHT, 10);
...
set_hitbox_value(AT_FSTRONG, 3, HG_HIT_SFX, sound_get("bat_hit_heavy2"));
set_hitbox_value(AT_FSTRONG, 3, HG_HIT_LOCKOUT, 10);
set_hitbox_value(AT_FSTRONG, 3, HG_BALL_SPEED, 12);
set_hitbox_value(AT_FSTRONG, 3, HG_BALL_ANGLE, -45);
