...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("bat_hit_heavy2"));
set_hitbox_value(AT_DSTRONG, 1, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_DSTRONG, 1, HG_HITSTUN_MULTIPLIER, 1.0);
set_hitbox_value(AT_DSTRONG, 1, HG_BALL_SPEED, 12);
set_hitbox_value(AT_DSTRONG, 1, HG_BALL_ANGLE, 0);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("bat_hit_heavy1"));
set_hitbox_value(AT_DSTRONG, 2, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_DSTRONG, 2, HG_HITSTUN_MULTIPLIER, 1.0);
set_hitbox_value(AT_DSTRONG, 2, HG_BALL_SPEED, 12);
set_hitbox_value(AT_DSTRONG, 2, HG_BALL_ANGLE, 180);