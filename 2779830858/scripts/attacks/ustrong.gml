...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("bat_hit_heavy2"));
set_hitbox_value(AT_USTRONG, 1, HG_BALL_SPEED, 12);
set_hitbox_value(AT_USTRONG, 1, HG_BALL_ANGLE, 90);
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("bat_hit_heavy2"));
set_hitbox_value(AT_USTRONG, 2, HG_BALL_SPEED, 12);
set_hitbox_value(AT_USTRONG, 2, HG_BALL_ANGLE, 90);
