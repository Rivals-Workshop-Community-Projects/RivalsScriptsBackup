...
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, sound_get("bat_hit1"));
set_hitbox_value(AT_UAIR, 1, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_UAIR, 1, HG_BALL_SPEED, 10);
set_hitbox_value(AT_UAIR, 1, HG_BALL_ANGLE, 90);
...
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, sound_get("bat_hit2"));
set_hitbox_value(AT_UAIR, 2, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_UAIR, 2, HG_BALL_SPEED, 5);
set_hitbox_value(AT_UAIR, 2, HG_BALL_ANGLE, 90);