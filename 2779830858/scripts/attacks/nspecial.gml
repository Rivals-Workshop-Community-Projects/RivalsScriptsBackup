...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("nade_closed"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("nade_active"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HIT_SFX, sound_get("time_trigger1"));
