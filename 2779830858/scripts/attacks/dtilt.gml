...
set_hitbox_value(AT_DTILT, 1, HG_BALL_SPEED, 7);
set_hitbox_value(AT_DTILT, 1, HG_BALL_ANGLE, 90);
...
set_hitbox_value(AT_DTILT, 2, HG_BALL_SPEED, 12);
set_hitbox_value(AT_DTILT, 2, HG_BALL_ANGLE, 75);
