...
set_hitbox_value(AT_UTILT, 1, HG_KNOCKBACK_SCALING, .30);
set_hitbox_value(AT_UTILT, 1, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_UTILT, 1, HG_HITPAUSE_SCALING, .35);
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sound_get("bat_hit1"));
set_hitbox_value(AT_UTILT, 1, HG_BALL_SPEED, 10);
set_hitbox_value(AT_UTILT, 1, HG_BALL_ANGLE, 45);
...
set_hitbox_value(AT_UTILT, 2, HG_WIDTH, 120);
...
set_hitbox_value(AT_UTILT, 2, HG_KNOCKBACK_SCALING, .30);
...
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, sound_get("bat_hit1"));
set_hitbox_value(AT_UTILT, 2, HG_ANGLE_FLIPPER, 4);
set_hitbox_value(AT_UTILT, 2, HG_BALL_SPEED, 10);
set_hitbox_value(AT_UTILT, 2, HG_BALL_ANGLE, 120);
