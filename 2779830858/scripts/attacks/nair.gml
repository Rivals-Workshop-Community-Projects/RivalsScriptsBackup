...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sound_get("bat_hit1"));
set_hitbox_value(AT_NAIR, 1, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_NAIR, 1, HG_BALL_SPEED, 10);
set_hitbox_value(AT_NAIR, 1, HG_BALL_ANGLE, 0);
...
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, sound_get("bat_hit1"));
set_hitbox_value(AT_NAIR, 2, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_NAIR, 2, HG_BALL_SPEED, 10);
set_hitbox_value(AT_NAIR, 2, HG_BALL_ANGLE, 0);
...
set_hitbox_value(AT_NAIR, 3, HG_ANGLE, 145);
...
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, sound_get("bat_hit1"));
set_hitbox_value(AT_NAIR, 3, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_NAIR, 3, HG_BALL_SPEED, 10);
set_hitbox_value(AT_NAIR, 3, HG_BALL_ANGLE, 200);
