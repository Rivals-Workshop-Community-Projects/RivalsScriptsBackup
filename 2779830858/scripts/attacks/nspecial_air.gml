...
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_LIFETIME, 999);
...
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_SPRITE, sprite_get("nade_closed"));
...
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_ANIM_SPEED, .3);
...
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_ENEMY_BEHAVIOR, 2);
...
set_hitbox_value(AT_NSPECIAL_AIR, 2, HG_LIFETIME, 999);
set_hitbox_value(AT_NSPECIAL_AIR, 2, HG_HITBOX_X, 20);
set_hitbox_value(AT_NSPECIAL_AIR, 2, HG_HITBOX_Y, -32);
...
set_hitbox_value(AT_NSPECIAL_AIR, 2, HG_KNOCKBACK_SCALING, .2);
set_hitbox_value(AT_NSPECIAL_AIR, 2, HG_BASE_HITPAUSE, 4);
set_hitbox_value(AT_NSPECIAL_AIR, 2, HG_PROJECTILE_SPRITE, sprite_get("nade_active"));
set_hitbox_value(AT_NSPECIAL_AIR, 2, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_NSPECIAL_AIR, 2, HG_PROJECTILE_ANIM_SPEED, .15);
...
set_hitbox_value(AT_NSPECIAL_AIR, 2, HG_ANGLE_FLIPPER, 8);
