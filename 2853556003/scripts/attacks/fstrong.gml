...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_blow_heavy1"));
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_waterhit_heavy2"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_BASE_HITPAUSE, 1.5);
set_hitbox_value(AT_FSTRONG, 1, HG_EXTRA_HITPAUSE, 8);
set_hitbox_value(AT_FSTRONG, 1, HG_HITPAUSE_SCALING, 0.12);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_X, 68);
...
set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT, vfx_waterhit_huge);
