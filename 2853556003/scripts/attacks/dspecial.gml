...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, sound_get("sfx_watershield_activate"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_WIDTH, 40 * shield_size_multiplier);
set_hitbox_value(AT_DSPECIAL, 1, HG_HEIGHT, 80 * shield_size_multiplier);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_WIDTH, 50 * shield_size_multiplier);
set_hitbox_value(AT_DSPECIAL, 2, HG_HEIGHT, 90 * shield_size_multiplier);
