...
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT, vfx_waterhit_small);
...
set_hitbox_value(AT_FTILT, 3, HG_HITBOX_X, 68);
set_hitbox_value(AT_FTILT, 3, HG_HITBOX_Y, -26);
set_hitbox_value(AT_FTILT, 3, HG_WIDTH, 46);
set_hitbox_value(AT_FTILT, 3, HG_HEIGHT, 90);
...
set_hitbox_value(AT_FTILT, 3, HG_VISUAL_EFFECT, vfx_waterhit_huge);
