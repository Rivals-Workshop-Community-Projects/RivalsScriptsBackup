...
sprite_change_offset("bubbleBomb_cheese_outline", 40, 40);
...
sprite_change_offset("waterBombExplode_cheese", 128, 128);
sprite_change_offset("waterBombExplodeMulti_cheese", 128, 128);
...
sprite_change_offset("bubbleBombIdle_cheese", 40, 40);
sprite_change_offset("bubbleBombStrong_cheese", 40, 40);
...
sprite_change_offset("hurricane_bomb_cheese", 50, 50);
sprite_change_offset("hurricane_strong_bomb_cheese", 50, 50);
...
sprite_change_offset("sawblade_small", 47, 47);
sprite_change_offset("sawblade_big_air", 47, 47);
sprite_change_offset("sawblade_big_ground", 47, 72);
sprite_change_offset("sawblade_strong_air", 47, 47);
sprite_change_offset("sawblade_strong_ground", 47, 72);
sprite_change_offset("sawblade_small_outline", 51, 52);
sprite_change_offset("sawblade_big_air_outline", 51, 52);
sprite_change_offset("sawblade_big_ground_outline", 51, 77);
sprite_change_offset("sawblade_strong_air_outline", 51, 52);
sprite_change_offset("sawblade_strong_ground_outline", 51, 77);
sprite_change_offset("sawblade_mask", 47, 47);
...
sprite_change_offset("vfx_waterhit_small_cheese", 64, 64);
sprite_change_offset("vfx_waterhit_medium_cheese", 70, 70);
...
sprite_change_offset("cheese_destroy", 40, 40);
sprite_change_offset("cheesed_fx", 122, 150);
