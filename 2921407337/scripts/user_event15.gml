...
// Iroh's Extras
add_sprites(
            "intro", // Neutral Unique "plat_idle", "idle_2"
            //"ground_dash","airdash","idle_but_better", // Neutral Unqiue
            "dspecial_2", "sl_dspecial_2_pity_flip", // Dspecial
            "nspecial_air") // nspecial
...
//=================OTHER=================
//  hurt sprites
add_sprites("hurt","bouncehurt","hurtground","spinhurt","uphurt","downhurt","bighurt"); //,
...
//if (get_player_color(player) == 1) set_skin("9t");
//if (SL_mode_active == true) set_skin("sl");
