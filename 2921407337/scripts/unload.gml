if(flag_win_quote_enabled || SL_mode_active){
    ...
    results_smuggler.results_data = { opponent_name:temp_opponent, num_of_players:countPlayers, SL_mode_active:SL_mode_active };//attach payload
}