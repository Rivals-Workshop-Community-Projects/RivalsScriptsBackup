...
set_attack_value(attack, 87, "References Zetter UAIR");//AG_MUNO_ATTACK_MISC_ADD = i; i++;
...
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y,-63);
...
// Hitbox #2 / Window # - / Sweetspot
window_for_hitbox = 2; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, 81, "Sweetspot");//HG_MUNO_HITBOX_NAME = i; i++;
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 0);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 5);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y,-107);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 8);
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 8);
...
set_hitbox_value(attack, hitbox_num, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(attack, hitbox_num, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(attack, hitbox_num, HG_KNOCKBACK_SCALING, .82);
set_hitbox_value(attack, hitbox_num, HG_BASE_HITPAUSE, 10);
set_hitbox_value(attack, hitbox_num, HG_HITPAUSE_SCALING, 1);
set_hitbox_value(attack, hitbox_num, HG_VISUAL_EFFECT, hfx_uairsweet); // 305 - basic sweetspot
set_hitbox_value(attack, hitbox_num, HG_HIT_SFX, asset_get("sfx_rag_axe_swing"));
set_hitbox_value(attack, hitbox_num, HG_HIT_PARTICLE_NUM, 1);
