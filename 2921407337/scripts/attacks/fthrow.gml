var attack = AT_FTHROW; // SL Version of the move
...
set_attack_value(attack, AG_NUM_WINDOWS, 2);
...
// Window #1 / Frame(s) # 14-15 / Forward Shock Window
...
// Window #2 / Frame(s) # 16-20 / Foward Pull In
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #3 / Frame(s) # 26-27 / Upward Shock Window
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 20);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 2);
...
// Window #4 / Frame(s) # 28-32 / Upward Pull In
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 15);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 5);
...
// Window #5 / Frame(s) # 33-34 / Downward Shock Angle
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 20);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAME_START, 33);
set_window_value(attack, window_num, AG_WINDOW_HSPEED, 0);
set_window_value(attack, window_num, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_VSPEED, 0);
set_window_value(attack, window_num, AG_WINDOW_VSPEED_TYPE, 1);
...
// Window #6 / Frame(s) # 35-39 / Downward Pull In
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 15);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 5);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAME_START, 35);
set_window_value(attack, window_num, AG_WINDOW_HSPEED, 0);
set_window_value(attack, window_num, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_VSPEED, 0);
set_window_value(attack, window_num, AG_WINDOW_VSPEED_TYPE, 1);
...
window_for_hitbox = 1; 
    ...
    set_hitbox_value(attack, hitbox_num, HG_WINDOW_CREATION_FRAME, 10 + (hitbox_num - 1) * 2);
    set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 180);
    ...
    set_hitbox_value(attack, hitbox_num, HG_VISUAL_EFFECT, 302); // 20  - lightning small
...
// Hitbox #5 / Window #2 - / Inward Sending Hitbox
...
set_hitbox_value(attack, hitbox_num, HG_HIT_SFX, asset_get("sfx_absa_harderhit"));
