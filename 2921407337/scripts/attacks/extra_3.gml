var attack = AT_EXTRA_3; // SL Airdash 

//Attack Values-----------------------------------------------------------------------------
set_attack_value(attack, AG_CATEGORY, 1);
set_attack_value(attack, AG_SPRITE, sprite_get("sl_airdash")); //sprite_get("")
...
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_jumpair")); // asset_get("sfx_absa_dattack") or sound_get("")
...
//set_window_value(attack, window_num, AG_WINDOW_CUSTOM_GRAVITY, gravity_speed * .9);
...
// Window #2 / Frame(s) # 1-4 / Apply Speed
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 6);
