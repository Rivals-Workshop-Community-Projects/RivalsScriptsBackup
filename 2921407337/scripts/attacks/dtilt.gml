...
set_attack_value(attack, 87, "References Mollo Dtilt");//AG_MUNO_ATTACK_MISC_ADD = i; i++;
...
// Window #2 / Frame(s) # 4- / Apply Speed
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #3 / Frame(s) # 5-6 / Active Frames
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 4);
...
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 41);
