var attack = AT_FINAL_STRONG; // Swap Taunt for attack that this is

//Attack Values-----------------------------------------------------------------------------
set_attack_value(attack, AG_CATEGORY, 2);
set_attack_value(attack, AG_SPRITE, sprite_get("final_strong")); //sprite_get("")
set_attack_value(attack, AG_AIR_SPRITE, 0);
set_attack_value(attack, AG_HURTBOX_SPRITE, sprite_get("final_strong_hurt")); //sprite_get("_hurt")
...
// Window #1 / Frame(s) # 0-4 / Start Transform
...
// Window #2 / Frame(s) # 5-10 / Start Up Wolf
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_window_value(attack, window_num, AG_WINDOW_VSPEED_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_HAS_SFX, 1); 
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_absa_kickhit")); // asset_get("") or sound_get("")
...
// Window #4 / Frame(s) # 12-15 / In Between
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #6 / Frame(s) # 21-25 / Untransform
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 20);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 5);
...
// Hitbox 1# / Window # 3- / 1st Hit Body
...
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 76);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -102);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 230);
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 205);
set_hitbox_value(attack, hitbox_num, HG_PRIORITY, 10);
set_hitbox_value(attack, hitbox_num, HG_DAMAGE, 20);
...
set_hitbox_value(attack, hitbox_num, HG_EXTRA_HITPAUSE, 60);
set_hitbox_value(attack, hitbox_num, HG_HITPAUSE_SCALING, 0);
set_hitbox_value(attack, hitbox_num, HG_VISUAL_EFFECT, hfx_big_lightning4);
set_hitbox_value(attack, hitbox_num, HG_HIT_SFX, asset_get("sfx_blow_heavy1"));
set_hitbox_value(attack, hitbox_num, HG_HIT_PARTICLE_NUM, 4); // SL Electric

hitbox_num++;

// Hitbox 2# / Window # 3- / 1st Hit Shockwave
window_for_hitbox = 3; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_GROUP, 1);
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 1);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 411);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -25);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 434);
...
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 162);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -105);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 323);
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 207);
set_hitbox_value(attack, hitbox_num, HG_PRIORITY, 9);
set_hitbox_value(attack, hitbox_num, HG_DAMAGE, 20);
...
set_hitbox_value(attack, hitbox_num, HG_BASE_HITPAUSE, 20);
set_hitbox_value(attack, hitbox_num, HG_HITPAUSE_SCALING, 0);
set_hitbox_value(attack, hitbox_num, HG_VISUAL_EFFECT, hfx_mark_disperse);
