...
//set_attack_value(attack, 87, "");//AG_MUNO_ATTACK_MISC_ADD = i; i++;
...
// Window #3 / Frame(s) # 3- / Before Active Hitbox
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 3);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 1);
...
// Window #4 / Frame(s) # 4-8 / Active Hitbox Leading
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #5 / Frame(s) # 9- / Active Hitbox Final
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 3);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 1);
...
set_hitbox_value(attack, hitbox_num, HG_ANGLE_FLIPPER, 4); //4 = Horizontal knockback sends toward the center of the hitbox
set_hitbox_value(attack, hitbox_num, HG_SDI_MULTIPLIER, .5);
set_hitbox_value(attack, hitbox_num, HG_BASE_KNOCKBACK, 2);
...
// Hitbox #2 / Window #4 - / Carry 2
window_for_hitbox = 4; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, 81, "Carry 2");//HG_MUNO_HITBOX_NAME = i; i++;
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
...
set_hitbox_value(attack, hitbox_num, HG_BASE_HITPAUSE, 3);
set_hitbox_value(attack, hitbox_num, HG_HITPAUSE_SCALING, 0);
set_hitbox_value(attack, hitbox_num, HG_VISUAL_EFFECT, hfx_claw_slash); //302 - basic small with spin effect in center
set_hitbox_value(attack, hitbox_num, HG_HIT_SFX, asset_get("sfx_blow_medium1"));
set_hitbox_value(attack, hitbox_num, HG_HIT_PARTICLE_NUM, 1);

hitbox_num++;

// Hitbox #3 / Window #4 - / Carry 3
window_for_hitbox = 4; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, 81, "Carry 3");//HG_MUNO_HITBOX_NAME = i; i++;
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
...
// Hitbox 4# / Window # 4- / Carry 4
window_for_hitbox = 4; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, 81, "Carry 4");//HG_MUNO_HITBOX_NAME = i; i++;
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
...
// Hitbox #5 / Window # 4- / Carry 5
window_for_hitbox = 4; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, 81, "Carry 5");//HG_MUNO_HITBOX_NAME = i; i++;
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
...
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 126);
