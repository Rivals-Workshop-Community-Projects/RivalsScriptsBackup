...
set_attack_value(attack, 87, "References Zetter Ftilt");//AG_MUNO_ATTACK_MISC_ADD = i; i++;
...
// Window #2 / Frame(s) # 3- / Apply Speed
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #3 / Frame(s) # 4- / Active Frames
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 49);
...
set_hitbox_value(attack, hitbox_num, HG_KNOCKBACK_SCALING, .65);
...
set_hitbox_value(attack, hitbox_num, HG_HIT_SFX, sound_get("ftilt_slash"));
