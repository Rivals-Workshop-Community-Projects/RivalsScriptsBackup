...
set_attack_value(attack, AG_SPRITE, sprite_get("dattack")); //sprite_get("")
set_attack_value(attack, AG_AIR_SPRITE, 0);
set_attack_value(attack, AG_HURTBOX_SPRITE, sprite_get("dattack_hurt")); //sprite_get("_hurt")
...
set_attack_value(attack, 87, "References a mix of Forsburn Dattack and Sylv Dattack");//AG_MUNO_ATTACK_MISC_ADD = i; i++;
...
set_window_value(attack, window_num, AG_WINDOW_CUSTOM_GROUND_FRICTION, .4);

window_num++;

// Window #2 / Frame(s) # 1-3 / Fefore Active
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_window_value(attack, window_num, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(attack, window_num, AG_WINDOW_CUSTOM_GROUND_FRICTION, .9);
...
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 86);
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 77);
