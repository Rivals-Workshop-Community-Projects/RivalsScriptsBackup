...
set_attack_value(attack, 87, "References Zetter Fair");//AG_MUNO_ATTACK_MISC_ADD = i; i++;

//Window Values-----------------------------------------------------------------------------
var window_num = 1;

// Window #1 / Frame(s) # 0-3 / Startup
...
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 14);
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 12);
