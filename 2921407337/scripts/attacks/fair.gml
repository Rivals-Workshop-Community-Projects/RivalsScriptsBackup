...
set_attack_value(attack, 87, "References Kragg Fair");//AG_MUNO_ATTACK_MISC_ADD = i; i++;
...
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 73);
...
set_hitbox_value(attack, hitbox_num, HG_KNOCKBACK_SCALING, .85);
