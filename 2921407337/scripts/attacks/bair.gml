...
"- Hit 1 References Mollo Bair
- Hit 2 / 3 Referennces Zetter DAIR");//AG_MUNO_ATTACK_MISC_ADD = i; i++;
...
set_window_value(attack, window_num, AG_WINDOW_SFX, sound_get("B_Air")); // asset_get("") or sound_get("")
...
// Window #2 / Frame(s) # 6- / Backward Hit
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_window_value(attack, window_num, AG_WINDOW_HAS_WHIFFLAG, 8);
...
// Hitbox #1 / Window #2 - / Forward Hitbox Sending Back
window_for_hitbox = 2; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, 81, "Top Hitbox Sending Back");//HG_MUNO_HITBOX_NAME = i; i++;
...
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 51);
...
// Hitbox #2 / Window #2 - / Rear Hitbox Send Down
window_for_hitbox = 2; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, 81, "Rear Hitbox Spike");//HG_MUNO_HITBOX_NAME = i; i++;
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 0);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
...
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 73);
...
// Hitbox #3 / Window #3 - / Under Hitbox
window_for_hitbox = 3; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, 81, "Under Hitbox Spike");//HG_MUNO_HITBOX_NAME = i; i++;
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 0);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, -12);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, 9);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 105);
