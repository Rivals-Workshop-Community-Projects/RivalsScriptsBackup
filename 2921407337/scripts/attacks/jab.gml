...
set_attack_value(attack, 87, "References Zetter Jab");//AG_MUNO_ATTACK_MISC_ADD = i; i++;

//Window Values-----------------------------------------------------------------------------
var window_num = 1;

// Window #1 / Frame(s) # 0-3 / Jab 1 Start Up
...
// Window #2 / Frame(s) # 4- / Jab 1 Active hitbox
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #3 / Frame(s) # 5-7 / Jab 1 Endlag
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #4 / Frame(s) # 8-11 / Jab 2 Start Up
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #5 / Frame(s) # 12- / Jab 2 Active Hitbox
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 2);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 1);
...
// Window #6 / Frame(s) # 13-14 / Jab 2 Endlag
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 13);
...
// Window #7 / Frame(s) # 15-18 / Jab 3 Start Up
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_window_value(attack, window_num, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(attack, window_num, AG_WINDOW_HAS_SFX, 1); 
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_bite")); // asset_get("sfx_swipe_weak1") or sound_get("")
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, get_window_value(attack,window_num,AG_WINDOW_LENGTH) -1);

window_num++;

// Window #8 / Frame(s) # 19-20 / Jab 3 Active Hitbox
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 2);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 2);
...
// Window #9 / Frame(s) # 21-24 / Jab 3 Endlag
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_hitbox_value(attack, hitbox_num, 81, "Jab 1");//HG_MUNO_HITBOX_NAME = i; i++;
...
set_hitbox_value(attack, hitbox_num, 81, "Jab 2");//HG_MUNO_HITBOX_NAME = i; i++;
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 2);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
...
set_hitbox_value(attack, hitbox_num, 81, "Jab 3");//HG_MUNO_HITBOX_NAME = i; i++;
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
