var attack = AT_EXTRA_1; //SL Dspecial Pity Flip

//Attack Values-----------------------------------------------------------------------------
set_attack_value(attack, AG_CATEGORY, 1);
set_attack_value(attack, AG_SPRITE, sprite_get("sl_dspecial_2_pity_flip")); //sprite_get("")
set_attack_value(attack, AG_AIR_SPRITE, 0);
set_attack_value(attack, AG_HURTBOX_SPRITE, sprite_get("sl_dspecial_2_pity_flip_hurt")); //sprite_get("_hurt")
set_attack_value(attack, AG_HURTBOX_AIR_SPRITE, 0);
set_attack_value(attack, AG_NUM_WINDOWS, 1);
set_attack_value(attack, AG_HAS_LANDING_LAG, 1);
set_attack_value(attack, AG_OFF_LEDGE, 0);
set_attack_value(attack, AG_LANDING_LAG, prat_land_time);
...
// Window #1 / Frame(s) # 0-4 / Cancel Window
...
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_frog_fspecial_cancel")); // asset_get("") or sound_get("")
