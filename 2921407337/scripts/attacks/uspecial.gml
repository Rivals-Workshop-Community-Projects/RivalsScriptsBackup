...
set_attack_value(attack, 87, "References Wrastor Uspecial");//AG_MUNO_ATTACK_MISC_ADD = i; i++;
...
set_window_value(attack, window_num, AG_WINDOW_SFX, sound_get("U_Special")); // asset_get("") or sound_get("")
...
// Window #2 / Frame(s) # 2- / Strong Start Up Hitbox
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #3 / Frame(s) # 3- / Traveling Medium Hitbox
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 3);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAME_START, 3);
set_window_value(attack, window_num, AG_WINDOW_VSPEED, -11);
set_window_value(attack, window_num, AG_WINDOW_VSPEED_TYPE, 1); // Stall
set_window_value(attack, window_num, AG_WINDOW_HAS_SFX, 1); 
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_clairen_fspecial_dash")); // asset_get("") or sound_get("")
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, get_window_value(attack,window_num,AG_WINDOW_LENGTH)-1); //get_window_value(attack,window_num,AG_WINDOW_LENGTH)-1);

window_num++;

// Window #4 / Frame(s) # 4- / Travel Weak Hitbox
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 6);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAME_START, 4);
set_window_value(attack, window_num, AG_WINDOW_VSPEED, -10.5);
set_window_value(attack, window_num, AG_WINDOW_VSPEED_TYPE, 1); // Stall

window_num++;

// Window #5 / Frame(s) # 5-7 / Endlag
...
// Hitbox #1 / Window # 2- / Start Up Hitbox
...
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 46);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -30);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 59);
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 46);
...
set_hitbox_value(attack, hitbox_num, 81, "Strong Start-up");//HG_MUNO_HITBOX_NAME

hitbox_num++;

// Hitbox #2 / Window # 2- / Medium Traveling hitbox
...
set_hitbox_value(attack, hitbox_num, HG_VISUAL_EFFECT, hfx_big_normal);
set_hitbox_value(attack, hitbox_num, HG_HIT_PARTICLE_NUM, 2);
set_hitbox_value(attack, hitbox_num, HG_HIT_SFX, asset_get("sfx_blow_heavy1"));
set_hitbox_value(attack, hitbox_num, 81, "Medium Traveling");//HG_MUNO_HITBOX_NAME

hitbox_num++;

// Hitbox #2 / Window # 4- / Top Late
...
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -79);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 70);
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 59);
...
set_hitbox_value(attack, hitbox_num, HG_HIT_PARTICLE_NUM, 2);
set_hitbox_value(attack, hitbox_num, HG_VISUAL_EFFECT, hfx_small_normal);
set_hitbox_value(attack, hitbox_num, HG_HIT_SFX, asset_get("sfx_blow_medium1"));
set_hitbox_value(attack, hitbox_num, 81, "Late Top");//HG_MUNO_HITBOX_NAME

hitbox_num++;

// Hitbox #3 / Window # 4- / Front Late
window_for_hitbox = 4; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 0);
...
set_hitbox_value(attack, hitbox_num, HG_HIT_SFX, asset_get("sfx_blow_medium1"));
set_hitbox_value(attack, hitbox_num, 81, "Late Front");//HG_MUNO_HITBOX_NAME
hitbox_num++;
