...
// Window #3 / Frame(s) # 1-2 / Before Active
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 4);
...
set_window_value(attack, window_num, AG_WINDOW_CUSTOM_AIR_FRICTION, air_friction * 10);
set_window_value(attack, window_num, AG_WINDOW_CUSTOM_GROUND_FRICTION, ground_friction);

window_num++;

// Window #4 / Frame(s) # 3-4 / Active
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 2);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAME_START, 3);
set_window_value(attack, window_num, AG_WINDOW_HAS_SFX, 1); 
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_absa_new_whip1")); // asset_get("") or sound_get("")
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, 0); //get_window_value(attack,window_num,AG_WINDOW_LENGTH)-1);
set_window_value(attack, window_num, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(attack, window_num, AG_WINDOW_CUSTOM_AIR_FRICTION, air_friction * 10);
set_window_value(attack, window_num, AG_WINDOW_CUSTOM_GROUND_FRICTION, ground_friction);
...
// Window #5 / Frame(s) # 5-11 / Endlag
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 23);
...
set_window_value(attack, window_num, AG_WINDOW_HAS_SFX, 1); 
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_charge_blade_ready")); //  or sound_get("")
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, 6); //get_window_value(attack,window_num,AG_WINDOW_LENGTH)-1);
set_window_value(attack, window_num, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(attack, window_num, AG_WINDOW_CUSTOM_AIR_FRICTION, air_friction * 10);
set_window_value(attack, window_num, AG_WINDOW_CUSTOM_GROUND_FRICTION, ground_friction);
...
// Hitbox #1 / Window # 4- / Main Top Portion
window_for_hitbox = 4; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, 81, "Main Top Hitbox");//HG_MUNO_HITBOX_NAME = i; i++;
...
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -131);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 34);
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 109);
...
set_hitbox_value(attack, hitbox_num, HG_HIT_SFX, asset_get("sfx_may_whip2"));
set_hitbox_value(attack, hitbox_num, HG_HIT_PARTICLE_NUM, 3);

hitbox_num++;

// Hitbox #2 / Window # 4- / Sour Spot Front
window_for_hitbox = 4; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, 81, "Sour Spot Hitbox");//HG_MUNO_HITBOX_NAME = i; i++;
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 0);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
...
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 158);
...
set_hitbox_value(attack, hitbox_num, HG_HIT_SFX, asset_get("sfx_absa_cloud_pop"));
set_hitbox_value(attack, hitbox_num, HG_HIT_PARTICLE_NUM, 3);
