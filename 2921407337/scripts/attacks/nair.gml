...
"- Can cancel into a 3 hit combo on hit ONLY. 
- Nair 2/3 cannot be hitfalled. 
- Input up or down for different Nair 3 finshers");//AG_MUNO_ATTACK_MISC_ADD = i; i++;

//Window Values-----------------------------------------------------------------------------
var window_num = 1;

// Window 1 / Frame(s) # 0-1 / Nair 1 Startup
...
// Window 2 / Frame(s) # 2- / Nair 1 Active
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window 3 / Frame(s) # 3-6 / Nair 1 Endlag
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_CANCEL_TYPE, 0); // Gets set in attack update if this move hits
set_window_value(attack, window_num, AG_WINDOW_CANCEL_FRAME, 2);
...
// Window #4 / Frame(s) # 7-8 / Nair 2 Startup
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #5 / Frame(s) # 9- / Nair 2 Active
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 2);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 1);
...
// Window #6 / Frame(s) # 10-13 / Nair 2 Endlag
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
//set_window_value(attack, window_num, AG_WINDOW_CANCEL_TYPE, 1); // Reneabled
set_window_value(attack, window_num, AG_WINDOW_CANCEL_FRAME, 2); // Added
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 12);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 4);
...
// NAIR 3 NEUTRAL FINSIHER VERSION

// Window #7 / Frame(s) # 14-15 / Nair 3 Neutral Startup
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 6);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 2);
...
window_num++;
// Window #8 / Frame(s) # 16- / Nair 3 Neutral Active
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
window_num++;
// Window #9 / Frame(s) # 17-20 / Nair 3 Neutral Endlag
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// NAIR 3 DOWNWARD FINSIHER VERSION

// Window #10 / Frame(s) # 21-22 / Nair 3 Down Startup
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 6);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAME_START, 21);
set_window_value(attack, window_num, AG_WINDOW_HAS_SFX, 1);
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, 3);
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_swipe_medium2"));
window_num++;

// Window #11 / Frame(s) # 23- / Nair 3 Down Active
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 4);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 1);
...
// Window #12 / Frame(s) # 24-27 / Nair 3 Down Endlag
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 14);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 4);
...
// NAIR 3 UPWARD FINISHER VERSION

// Window #13 / Frame(s) # 28-29 / Nair 3 Up Startup
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 6);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 2);
...
// Window #14 / Frame(s) # 30- / Nair 3 Up Active
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 4);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAME_START, 30);
window_num++;

// Window #15 / Frame(s) # 31-34 / Nair 3 Up Endlag
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 14);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 4);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAME_START, 31);
window_num++;
...
//Nair 1
window_for_hitbox = 2;
set_hitbox_value(attack, hitbox_num, 81, "Nair 1");//HG_MUNO_HITBOX_NAME = i; i++;	
...
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 34);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -18);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 66);
...
set_hitbox_value(attack, hitbox_num, HG_VISUAL_EFFECT, hfx_claw_slash);
set_hitbox_value(attack, hitbox_num, HG_HIT_SFX, asset_get("sfx_blow_medium2"));
set_hitbox_value(attack, hitbox_num, HG_HIT_PARTICLE_NUM, 1);
hitbox_num++;

//Nair 2
window_for_hitbox = 5;
set_hitbox_value(attack, hitbox_num, 81, "Nair 2");//HG_MUNO_HITBOX_NAME = i; i++;	
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 0);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
...
//Nair 3 Neutral
window_for_hitbox = 8;
set_hitbox_value(attack, hitbox_num, 81, "Nair 3 Neutral");//HG_MUNO_HITBOX_NAME = i; i++;	
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 0);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
...
set_hitbox_value(attack, hitbox_num, 81, "Nair 3 Downwards");//HG_MUNO_HITBOX_NAME = i; i++;	
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 0);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
...
set_hitbox_value(attack, hitbox_num, HG_HIT_SFX, asset_get("sfx_blow_heavy1"));
set_hitbox_value(attack, hitbox_num, HG_HIT_PARTICLE_NUM, 1);
set_hitbox_value(attack, hitbox_num, HG_HITSTUN_MULTIPLIER, .8);
hitbox_num++;

//Nair 3 Upwards
window_for_hitbox = 14;
set_hitbox_value(attack, hitbox_num, 81, "Nair 3 Upwards");//HG_MUNO_HITBOX_NAME = i; i++;	
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 0);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
...
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 62);
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 65);
set_hitbox_value(attack, hitbox_num, HG_PRIORITY, 5);
set_hitbox_value(attack, hitbox_num, HG_DAMAGE, 5);
