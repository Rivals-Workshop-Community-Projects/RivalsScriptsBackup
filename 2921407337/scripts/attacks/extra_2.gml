var attack = AT_EXTRA_2; // SL Ground dash 

//Attack Values-----------------------------------------------------------------------------
set_attack_value(attack, AG_CATEGORY, 0);
set_attack_value(attack, AG_SPRITE, sprite_get("sl_ground_dash")); //sprite_get("")
...
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_jumpground")); // asset_get("sfx_absa_dattack") or sound_get("")
...
// Window #3 / Frame(s) # 5- / Endlag - last frame is unused cause it looks bad on the ground
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 3);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 1);
