...
set_attack_value(attack, AG_NUM_WINDOWS, 3); // Will not play success windows normally
...
// Absa's Nspecial Start Data
// Active starting Frame 28
// 8 Active Frames
// 28 Frames of endlag
/*
12 DMG
...
// Window #1 / Frame(s) # 0-6 / Start up
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 27);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 7);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAME_START, 0);
set_window_value(attack, window_num, AG_WINDOW_HAS_SFX, 1); 
set_window_value(attack, window_num, AG_WINDOW_SFX, sound_get("howl")); // asset_get("") or sound_get("")
...
// Window #2 / Frame(s) # 12-21 / Electric Missed Howl (Default)
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #3 / Frame(s) # 22-24 / Missed Endlag
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #4 / Frame(s) # 7-9 / Electric Hit
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_window_value(attack, window_num, AG_WINDOW_HSPEED_TYPE, 1); // Stall
set_window_value(attack, window_num, AG_WINDOW_VSPEED, 0);
set_window_value(attack, window_num, AG_WINDOW_VSPEED_TYPE, 1); // Stall
set_window_value(attack, window_num, AG_WINDOW_HAS_SFX, 1); 
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_absa_harderhit")); //  or sound_get("") sfx_absa_singlezap1
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, 2); //get_window_value(attack,window_num,AG_WINDOW_LENGTH)-1);

window_num++;

// Window #5/ Frame(s) # 10-11 / Electric Hit Endlag
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_window_value(attack, window_num, AG_WINDOW_HSPEED, 0);
set_window_value(attack, window_num, AG_WINDOW_HSPEED_TYPE, 1); // Stall then allow drift
set_window_value(attack, window_num, AG_WINDOW_VSPEED, 0);
set_window_value(attack, window_num, AG_WINDOW_VSPEED_TYPE, 1); // Stall

window_num++;

// Custom WIndow values for this move on woodcock
set_attack_value(attack, 87, 
"References Absa Nspecial Cloud Pop
Endlag Not Hit by Lightning: " + string(get_window_value(attack,3,AG_WINDOW_LENGTH) + get_window_value(attack,2,AG_WINDOW_LENGTH)));//AG_MUNO_ATTACK_MISC_ADD = i; i++;
set_attack_value(attack, 84, string(get_window_value(attack,5,AG_WINDOW_LENGTH)));//AG_MUNO_ATTACK_ENDLAG = i;			// Enter a string to override endlag
...
var window_1_length = get_window_value(attack,1,AG_WINDOW_LENGTH);
var window_4_length = get_window_value(attack,4,AG_WINDOW_LENGTH);

// Hitbox #1 / Window # 4- / Electric Hit Melee Hitbox
window_for_hitbox = 4; // Set this to change the window that the hitbox comes out at and its length quickly

set_hitbox_value(attack, hitbox_num, 81, "Body Hit Melee Hitbox");//HG_MUNO_HITBOX_NAME = i; i++;
set_hitbox_value(attack, hitbox_num, 82, string(window_1_length) + "-" + string(window_4_length + window_1_length));//HG_MUNO_HITBOX_ACTIVE = i;// Enter a string to override active frames
...
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 110);
...
set_hitbox_value(attack, hitbox_num, HG_HIT_PARTICLE_NUM, 2);
set_hitbox_value(attack, hitbox_num, HG_EXTRA_CAMERA_SHAKE, 1);
hitbox_num++;

// Hitbox #2 / Window # - / Cloud Projectile Hitbox Spike
window_for_hitbox = 0; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, 81, "Cloud Spike");//HG_MUNO_HITBOX_NAME = i; i++;
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
...
set_hitbox_value(attack, hitbox_num, 82, string(window_1_length) + "-" + string(get_hitbox_value(attack,hitbox_num,HG_LIFETIME) + window_1_length));//HG_MUNO_HITBOX_ACTIVE = i;// Enter a string to override active frames
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 0);
...
set_hitbox_value(attack, hitbox_num, HG_HIT_SFX, asset_get("sfx_absa_orb_hit"));
set_hitbox_value(attack, hitbox_num, HG_HIT_LOCKOUT, 10);
set_hitbox_value(attack, hitbox_num, HG_HIT_PARTICLE_NUM, 2);
//Projectile
...
set_hitbox_value(attack, hitbox_num, HG_PROJECTILE_DESTROY_EFFECT, 1); //1   - no visual effect
set_hitbox_value(attack, hitbox_num, HG_HITSTUN_MULTIPLIER, .7);
hitbox_num++;

// Hitbox #3 / Window # - / Lightning Stike Ground Hitbox
window_for_hitbox = 0; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, 81, "Ground Strike");//HG_MUNO_HITBOX_NAME = i; i++;
set_hitbox_value(attack, hitbox_num, 91, 
"Same properties as above");//HG_MUNO_HITBOX_MISC = i; i++;	
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 2);
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 2);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, 3); // Swap 1 for what ever window this attack is
...
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 85);
...
// Hitbox #4 / Window # - / Lightning Segment Hitbox
window_for_hitbox = 0; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, 81, "Lightning Segment");//HG_MUNO_HITBOX_NAME = i; i++;\
set_hitbox_value(attack, hitbox_num, 91, 
"Same properties as above");//HG_MUNO_HITBOX_MISC = i; i++;	
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 2);
...
set_hitbox_value(attack, hitbox_num, HG_VISUAL_EFFECT, 21); //21  - lightning medium
set_hitbox_value(attack, hitbox_num, HG_HIT_SFX, asset_get("sfx_zap"));
set_hitbox_value(attack, hitbox_num, HG_HIT_LOCKOUT, 10);
set_hitbox_value(attack, hitbox_num, HG_HIT_PARTICLE_NUM, 2);
//Projectile
set_hitbox_value(attack, hitbox_num, HG_PROJECTILE_SPRITE, asset_get("empty_sprite"));
