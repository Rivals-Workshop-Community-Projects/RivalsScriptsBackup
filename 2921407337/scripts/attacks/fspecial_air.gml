var attack = AT_FSPECIAL_AIR; // Version started in the air, should bounce

//Attack Values-----------------------------------------------------------------------------
set_attack_value(attack, AG_CATEGORY, 2);
set_attack_value(attack, AG_SPRITE, sprite_get("fspecial")); //sprite_get("")
set_attack_value(attack, AG_AIR_SPRITE, 0);
set_attack_value(attack, AG_HURTBOX_SPRITE, -1); //Use default hurtbox due to sprite rotation
...
"- References Ranno Fspecial Frame Data for Ground Bounce
- Does not refresh double jump or air dodge on ground bounce");//AG_MUNO_ATTACK_MISC_ADD = i; i++;
...
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_absa_boltcloud")); // asset_get("") or sound_get("")
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, 1); //get_window_value(attack,window_num,AG_WINDOW_LENGTH)-1);


window_num++;

// Window #2 / Frame(s) # 1-8 / Charging
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_window_value(attack, window_num, AG_WINDOW_HAS_SFX, 1); 
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_absa_whip_charge")); // asset_get("") or sound_get("")
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, 1); //get_window_value(attack,window_num,AG_WINDOW_LENGTH)-1);


window_num++;

// Window #3 / Frame(s) # 9- / before Active Hitbox
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 3);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 1);
...
// Window #4 / Frame(s) # 10-21 / Active Hitbox
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 11);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 11);
...
// Window #5 / Frame(s) # 30- / End start (got to window 7 on hit)
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 3);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 1);
...
// Window #7 / Frame(s) # 31-34 / Endlag Landing on ground Not used on air version
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #8 / Frame(s) # 23- / Follow Up Attack Start Up Unused
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #9 / Frame(s) # 23-24 / Follow up Acttack Active Unused
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 0);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 0);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAME_START, 0);
...
// Window #10 / Frame(s) # 26-30 / Follow up Attack Endlag Unused
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 12);
...
// Window #11 / Frame(s) # 31-34 / Bounce
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_hitbox_value(attack, hitbox_num, HG_VISUAL_EFFECT, hfx_big_lightning3);
set_hitbox_value(attack, hitbox_num, HG_HIT_SFX, asset_get("sfx_absa_new_whip1"));
