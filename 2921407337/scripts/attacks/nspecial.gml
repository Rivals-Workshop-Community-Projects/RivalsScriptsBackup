...
set_attack_value(attack, AG_AIR_SPRITE, sprite_get("nspecial_air"));
set_attack_value(attack, AG_HURTBOX_SPRITE, sprite_get("nspecial_hurt")); //sprite_get("_hurt")
set_attack_value(attack, AG_HURTBOX_AIR_SPRITE, sprite_get("nspecial_air_hurt"));
...
"- References Sylvanos Bair
- Can input up / down to angle this move
- Chain move can consume mark to grab and get SL mode.");//AG_MUNO_ATTACK_MISC_ADD = i; i++;

//Window Values-----------------------------------------------------------------------------
var window_num = 1;

// Window #1 / Frame(s) # 1-3 / Start Up Skip 0 it is idle frame
...
set_window_value(attack, window_num, AG_WINDOW_SFX, sound_get("WHIP")); // asset_get("") or sound_get("")
...
// Window #2 / Frame(s) # 4-5 / Active Normal Sideways Frames
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #4 / Frame(s) # 6-7 / Active Frames Upwards - OPTIONAL
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 4);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAME_START, 6);
set_window_value(attack, window_num, AG_WINDOW_GOTO, 3);

window_num++;

// Window #5 / Frame(s) # 8-9 / Active Frames - OPTIONAL
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 4);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 2);
...
// Hitbox #1 / Window #2 - / Sweetspot Tip
window_for_hitbox = 2; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, 81, "Sweetspot Tip");//HG_MUNO_HITBOX_NAME = i; i++;	
...
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 178);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -32);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 37);
...
set_hitbox_value(attack, hitbox_num, HG_VISUAL_EFFECT, hfx_chain_sweetspot);
set_hitbox_value(attack, hitbox_num, HG_HIT_SFX, asset_get("sfx_may_whip1"));
set_hitbox_value(attack, hitbox_num, HG_HIT_PARTICLE_NUM, 3);
hitbox_num++;

// Hitbox #2 / Window #2 - / Sourspot Chain
window_for_hitbox = 2; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, 81, "Sourspot");//HG_MUNO_HITBOX_NAME = i; i++;
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 2);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 105);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -32);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 103);
...
set_hitbox_value(attack, hitbox_num, HG_VISUAL_EFFECT, hfx_metal);
set_hitbox_value(attack, hitbox_num, HG_HIT_SFX, asset_get("sfx_blow_medium1"));
set_hitbox_value(attack, hitbox_num, HG_HIT_PARTICLE_NUM, 3);
hitbox_num++;

// Hitbox #3 / Window #4 - / Sweetspot Tip Upper
window_for_hitbox = 4; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, 80, 1);//HG_MUNO_HITBOX_EXCLUDE = i; i++;
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 2);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 144);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -126);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 37);
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 34);
set_hitbox_value(attack, hitbox_num, HG_PRIORITY, 4);
set_hitbox_value(attack, hitbox_num, HG_DAMAGE, 12);
...
// Hitbox #4 / Window #4 - / Sour Spot Upper Chain Outer
window_for_hitbox = 4; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, 80, 1);//HG_MUNO_HITBOX_EXCLUDE = i; i++;
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 2);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 110);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -92);
...
// Hitbox #5 / Window #4 - / Sour Spot Upper Chain Inner
window_for_hitbox = 4; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, 80, 1);//HG_MUNO_HITBOX_EXCLUDE = i; i++;
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 2);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 73);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -56);
...
// Hitbox #6 / Window #5 - / Sweetspot Downward Chain
...
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 2);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 138);
...
// Hitbox #7 / Window #5 - / Sour Spot Downward Chain Outer
window_for_hitbox = 5; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, 80, 1);//HG_MUNO_HITBOX_EXCLUDE = i; i++;
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 2);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 107);
...
// Hitbox #8 / Window #5 - / Sour Spot Downward Chain Inner
window_for_hitbox = 5; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, 80, 1);//HG_MUNO_HITBOX_EXCLUDE = i; i++;
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 2);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 79);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -15);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 45);
