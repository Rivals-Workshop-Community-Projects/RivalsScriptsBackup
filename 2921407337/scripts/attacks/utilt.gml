...
set_attack_value(attack, 87, "References Zetter Utilt");//AG_MUNO_ATTACK_MISC_ADD = i; i++;
...
// Hitbox #1 / Window #2 - / Front Scoop Hitbox
window_for_hitbox = 2; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, 81, "Front Scoop Hitbox");//HG_MUNO_HITBOX_NAME = i; i++;	
...
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 69);
...
set_hitbox_value(attack, hitbox_num, HG_VISUAL_EFFECT, hfx_claw_slash); //303 - basic small directional
...
// Hitbox #2 / Window #2 - / Top Hitbox
window_for_hitbox = 2; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, 81, "Top Hitbox");//HG_MUNO_HITBOX_NAME = i; i++;
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 0);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, -18);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -75);
