var attack = AT_DSPECIAL_2; // SL Dspecial Powerdunk
...
"- Can only be used in SL Mode
- Consumes SL Mode on landing
- Take remaining damage from SL mode");//AG_MUNO_ATTACK_MISC_ADD = i; i++;
...
set_window_value(attack, window_num, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_VSPEED, -6);
set_window_value(attack, window_num, AG_WINDOW_VSPEED_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_HAS_SFX, 1); 
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_dspecial_2_start")); // asset_get("") or sound_get("")
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, 0); //get_window_value(attack,window_num,AG_WINDOW_LENGTH)-1);

window_num++;

// Window #3 / Frame(s) # 4-5 / Swing Start Up
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 8);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 2);
...
// Window #4 / Frame(s) # 6- / Active Air Hitbox
...
set_window_value(attack, window_num, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_VSPEED, 16);
set_window_value(attack, window_num, AG_WINDOW_VSPEED_TYPE, 1);

window_num++;

// Window #5 / Frame(s) # 7 / Active Geyser Hitboxes
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 6);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAME_START, 7);
set_window_value(attack, window_num, AG_WINDOW_HAS_SFX, 1); 
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_abyss_explosion_big")); // asset_get("") or sound_get("")
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, 0); //get_window_value(attack,window_num,AG_WINDOW_LENGTH)-1);

window_num++;

// Window #6 / Frame(s) # 8-14 / Endlag
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Hitbox #1 / Window # 4- / Falling Hitbox
...
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 74);
...
set_hitbox_value(attack, hitbox_num, HG_HIT_PARTICLE_NUM, 4);
set_hitbox_value(attack, hitbox_num, 81, "Falling Grab Box");//HG_MUNO_HITBOX_NAME = i; i++;	
hitbox_num++;

// Hitbox #2 / Window # 5- / 1st Explosion Frame Hitbox
...
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 56);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -34);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 94);
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 71);
...
// Hitbox #3 / Window # 5- / 2nd Explosion Frame Hitbox Main
window_for_hitbox = 5; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_GROUP, 1);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
...
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 57);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -40);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 118);
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 87);
set_hitbox_value(attack, hitbox_num, HG_PRIORITY, 5);
set_hitbox_value(attack, hitbox_num, HG_DAMAGE, 15);
set_hitbox_value(attack, hitbox_num, HG_ANGLE, 90);
set_hitbox_value(attack, hitbox_num, HG_BASE_KNOCKBACK, 8);
...
// Hitbox #4 / Window # 5- / 2nd Explosion Hitbox Middle
window_for_hitbox = 5; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_GROUP, 1);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
...
set_hitbox_value(attack, hitbox_num, HG_WINDOW_CREATION_FRAME, 3);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, 3);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 92);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -104);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 42);
...
// Hitbox #5 / Window # 5- / 2nd Explosion Hitbox Tip
window_for_hitbox = 5; // Set this to change the window that the hitbox comes out at and its length quickly
set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_GROUP, 1);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
...
set_hitbox_value(attack, hitbox_num, HG_WINDOW_CREATION_FRAME, 3);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, 3);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 112);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -148);
