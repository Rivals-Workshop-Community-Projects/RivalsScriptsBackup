...
set_attack_value(attack, AG_SPRITE, sprite_get("fstrong")); //sprite_get("")
set_attack_value(attack, AG_AIR_SPRITE, 0);
set_attack_value(attack, AG_HURTBOX_SPRITE, sprite_get("fstrong_hurt")); //sprite_get("_hurt")
...
set_attack_value(attack, 87, "References Zetter Fstrong");//AG_MUNO_ATTACK_MISC_ADD = i; i++;
...
// Window #3 / Frame(s) # 3-6 / Leaping Before Hitbox
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_window_value(attack, window_num, AG_WINDOW_HSPEED, 10);
set_window_value(attack, window_num, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(attack, window_num, AG_WINDOW_HAS_SFX, 1); 
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_jumpground")); // asset_get("") or sound_get("")
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, 1); //get_window_value(attack,window_num,AG_WINDOW_LENGTH)-1);

window_num++;

// Window #4 / Frame(s) # 7-8 / Active Hitbox
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 4);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 2);
...
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 57);
