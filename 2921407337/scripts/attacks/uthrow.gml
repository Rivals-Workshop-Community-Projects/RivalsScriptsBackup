var attack = AT_UTHROW; // Swap Taunt for attack that this is

//Attack Values-----------------------------------------------------------------------------
set_attack_value(attack, AG_CATEGORY, 0);
set_attack_value(attack, AG_SPRITE, sprite_get("sl_ustrong")); //sprite_get("")
...
//Its coded like this so I don't need to have a different strip

// Window #1 / Frame(s) # 5- / Start Up 1 Shock Window
...
window_for_hitbox = 1; 
    ...
    set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -120);
