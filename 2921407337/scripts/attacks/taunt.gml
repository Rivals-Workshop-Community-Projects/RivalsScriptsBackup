...
set_window_value(attack, window_num, AG_WINDOW_SFX, sound_get("crowd_taunt")); // asset_get("") or sound_get("")
...
// Window #2 / Frame(s) # 2-17 / Default Window
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 60);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 15);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAME_START, 2);

window_num++;

// Window #3 / Frame(s) # 32-33 / Ending
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 6);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAME_START, 32);
