...
set_color_profile_slot_range( 0, 1, 24, 30 );

// Alt Fur
set_color_profile_slot( 0, 1, 253, 253, 253 );
set_color_profile_slot_range( 1, 1, 1, 1 );

// gold2
set_color_profile_slot( 0, 2, 112, 47, 7 );
set_color_profile_slot_range( 2, 15, 6, 38 );

// Fabric
set_color_profile_slot( 0, 3, 123, 37, 201 );
set_color_profile_slot_range( 3, 5, 4, 27 );

// Pants
set_color_profile_slot( 0, 4, 67, 68, 87 );
set_color_profile_slot_range( 4, 3, 5, 11 );

// Gold
set_color_profile_slot( 0, 5, 238, 220, 0 );
set_color_profile_slot_range( 5, 47, 69, 8 );

// SL
set_color_profile_slot( 0, 6, 167, 46, 82 );
set_color_profile_slot_range( 6, 10, 47, 27 );

// Lightning
set_color_profile_slot( 0, 7, 205, 247, 247 );
set_color_profile_slot_range( 7, 7, 29, 33 );
...
=== BEGIN JSON PALETTE ===
{"formatversion":1,"data":[{"name":"Fur","colors":[{"r":200,"g":200,"b":240,"main":true},{"r":99,"g":99,"b":166}]},{"name":"Alt Fur","colors":[{"r":"253","g":"253","b":"253","main":true}]},{"name":"gold2","colors":[{"r":112,"g":47,"b":7,"main":true},{"r":206,"g":135,"b":23}]},{"name":"Fabric","colors":[{"r":"123","g":"37","b":"201","main":true},{"r":73,"g":21,"b":136}]},{"name":"Pants","colors":[{"r":"67","g":"68","b":"87","main":true},{"r":50,"g":51,"b":62}]},{"name":"Gold","colors":[{"r":242,"g":250,"b":171},{"r":238,"g":220,"b":0,"main":true},{"r":219,"g":119,"b":101}]},{"name":"SL","colors":[{"r":219,"g":162,"b":182},{"r":167,"g":46,"b":82,"main":true},{"r":100,"g":21,"b":56}]},{"name":"Lightning","colors":[{"r":245,"g":254,"b":255},{"r":205,"g":247,"b":247,"main":true},{"r":139,"g":208,"b":216},{"r":91,"g":159,"b":166}]}]}
=== END JSON PALETTE ===
*/
