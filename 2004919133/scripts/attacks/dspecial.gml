...
set_attack_value(AT_DSPECIAL, AG_OFF_LEDGE, 2);
...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, sound_get("shopopen"));
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_SFX, sound_get("shopclose"));
