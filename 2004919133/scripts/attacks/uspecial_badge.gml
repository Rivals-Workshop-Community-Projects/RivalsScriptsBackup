...
set_window_value(AT_USPECIAL_2, 4, AG_WINDOW_LENGTH, 14);
set_window_value(AT_USPECIAL_2, 4, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_USPECIAL_2, 4, AG_WINDOW_ANIM_FRAME_START, 4);
set_window_value(AT_USPECIAL_2, 4, AG_WINDOW_SFX_FRAME, 1);
set_window_value(AT_USPECIAL_2, 4, AG_WINDOW_VSPEED_TYPE, 1);
set_window_value(AT_USPECIAL_2, 4, AG_WINDOW_VSPEED, uspec_descend*2.5);

//hover
set_window_value(AT_USPECIAL_2, 5, AG_WINDOW_TYPE, 8);
set_window_value(AT_USPECIAL_2, 5, AG_WINDOW_LENGTH, 240);
...
set_window_value(AT_USPECIAL_2, 5, AG_WINDOW_VSPEED, uspec_descend*2.5);

set_window_value(AT_USPECIAL_2, 6, AG_WINDOW_TYPE, 7);
set_window_value(AT_USPECIAL_2, 6, AG_WINDOW_LENGTH, 2);
...
set_window_value(AT_USPECIAL_2, 6, AG_WINDOW_SFX, asset_get("sfx_jumpground"));
set_window_value(AT_USPECIAL_2, 6, AG_WINDOW_SFX_FRAME, 1);
...
set_hitbox_value(AT_USPECIAL_2, 1, HG_HITBOX_Y, -65);
set_hitbox_value(AT_USPECIAL_2, 1, HG_WIDTH, 28);
set_hitbox_value(AT_USPECIAL_2, 1, HG_HEIGHT, 104);
...
set_hitbox_value(AT_USPECIAL_2, 2, HG_HITBOX_X, 12);
set_hitbox_value(AT_USPECIAL_2, 2, HG_HITBOX_Y, -70);
set_hitbox_value(AT_USPECIAL_2, 2, HG_WIDTH, 26);
...
set_hitbox_value(AT_USPECIAL_2, 3, HG_HITBOX_X, 12);
set_hitbox_value(AT_USPECIAL_2, 3, HG_HITBOX_Y, -70);
set_hitbox_value(AT_USPECIAL_2, 3, HG_WIDTH, 26);
...
set_hitbox_value(AT_USPECIAL_2, 3, HG_BASE_KNOCKBACK, 6);
...
set_hitbox_value(AT_USPECIAL_2, 4, HG_HITBOX_X, 12);
set_hitbox_value(AT_USPECIAL_2, 4, HG_HITBOX_Y, -70);
set_hitbox_value(AT_USPECIAL_2, 4, HG_WIDTH, 26);
...
set_hitbox_value(AT_USPECIAL_2, 4, HG_DAMAGE, 2);
...
set_hitbox_value(AT_USPECIAL_2, 5, HG_HITBOX_X, 16);
set_hitbox_value(AT_USPECIAL_2, 5, HG_HITBOX_Y, -74);
set_hitbox_value(AT_USPECIAL_2, 5, HG_WIDTH, 103);
set_hitbox_value(AT_USPECIAL_2, 5, HG_HEIGHT, 43);
...
set_hitbox_value(AT_USPECIAL_2, 5, HG_KNOCKBACK_SCALING, .75);
set_hitbox_value(AT_USPECIAL_2, 5, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_USPECIAL_2, 5, HG_HITPAUSE_SCALING, .65);
set_hitbox_value(AT_USPECIAL_2, 5, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_USPECIAL_2, 5, HG_HIT_SFX, asset_get("sfx_blow_heavy1"));
