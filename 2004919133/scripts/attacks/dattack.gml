...
set_window_value(AT_DATTACK, 1, AG_WINDOW_VSPEED, -2);
...
set_hitbox_value(AT_DATTACK, 1, HG_HEIGHT, 21);
...
set_hitbox_value(AT_DATTACK, 2, HG_WIDTH, 18);
set_hitbox_value(AT_DATTACK, 2, HG_HEIGHT, 79);
