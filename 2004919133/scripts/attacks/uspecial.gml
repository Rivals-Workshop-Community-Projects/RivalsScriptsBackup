...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_VSPEED, -11.5);
...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_VSPEED, uspec_descend);

//hover
set_window_value(AT_USPECIAL, 5, AG_WINDOW_TYPE, 8);
set_window_value(AT_USPECIAL, 5, AG_WINDOW_LENGTH, 240);
...
set_window_value(AT_USPECIAL, 5, AG_WINDOW_VSPEED, uspec_descend);
...
set_window_value(AT_USPECIAL, 6, AG_WINDOW_SFX, asset_get("sfx_jumpground"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_WIDTH, 28);
...
set_hitbox_value(AT_USPECIAL, 2, HG_WIDTH, 26);
...
set_hitbox_value(AT_USPECIAL, 4, HG_HITBOX_X, 12);
...
set_hitbox_value(AT_USPECIAL, 5, HG_HEIGHT, 43);
