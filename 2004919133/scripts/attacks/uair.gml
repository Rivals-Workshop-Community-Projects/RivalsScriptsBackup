...
set_window_value(AT_UAIR, 7, AG_WINDOW_ANIM_FRAME_START, 7);

set_window_value(AT_UAIR, 8, AG_WINDOW_TYPE, 1);
set_window_value(AT_UAIR, 8, AG_WINDOW_LENGTH, 2);
...
set_hitbox_value(AT_UAIR, 1, HG_HITBOX_X, 23);
...
set_hitbox_value(AT_UAIR, 2, HG_HEIGHT, 53);
