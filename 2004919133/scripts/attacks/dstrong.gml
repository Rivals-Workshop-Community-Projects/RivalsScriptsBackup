...
set_window_value(AT_DSTRONG, 5, AG_WINDOW_SFX, asset_get("mfx_star"));
...
set_window_value(AT_DSTRONG, 6, AG_WINDOW_ANIM_FRAME_START, 3);
...
set_window_value(AT_DSTRONG, 7, AG_WINDOW_HSPEED_TYPE, 1);
...
set_window_value(AT_DSTRONG, 9, AG_WINDOW_ANIM_FRAME_START, 6);
set_window_value(AT_DSTRONG, 9, AG_WINDOW_VSPEED_TYPE, 1);
set_window_value(AT_DSTRONG, 9, AG_WINDOW_HSPEED_TYPE, 1);
...
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 117);
...
set_hitbox_value(AT_DSTRONG, 3, HG_LIFETIME, 95);
