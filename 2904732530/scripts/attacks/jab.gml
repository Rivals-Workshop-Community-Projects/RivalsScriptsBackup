...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, asset_get("sfx_ice_shieldup"));
...
set_hitbox_value(AT_JAB, 2, HG_VISUAL_EFFECT, 27);
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, asset_get("sfx_ice_back_air"));
