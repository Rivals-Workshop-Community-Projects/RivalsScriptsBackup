...
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT, 27);
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, asset_get("sfx_ice_shieldup"));
...
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_Y, -85);
...
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT, 27);
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, asset_get("sfx_ice_shieldup"));
...
set_hitbox_value(AT_NAIR, 3, HG_HITBOX_X, 45);
