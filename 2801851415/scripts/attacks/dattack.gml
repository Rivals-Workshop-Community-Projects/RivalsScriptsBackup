...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, asset_get("sfx_ice_fspecial_hit_ground"));
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX_FRAME, 5);

set_window_value(AT_DATTACK, 2, AG_WINDOW_TYPE, 1);
set_window_value(AT_DATTACK, 2, AG_WINDOW_LENGTH, 8); //11
set_window_value(AT_DATTACK, 2, AG_WINDOW_HSPEED, 8); //7
...
set_hitbox_value(AT_DATTACK, 1, HG_HITBOX_Y, -9);
set_hitbox_value(AT_DATTACK, 1, HG_WIDTH, 103);
...
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, asset_get("sfx_icehit_medium1"));