...
set_window_value(AT_BAIR, 1, AG_WINDOW_LENGTH, 10);//10
...
set_window_value(AT_BAIR, 3, AG_WINDOW_LENGTH, 15);//6
...
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_X, -34);//-25
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_Y, -24);
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 67);//50
...
set_hitbox_value(AT_BAIR, 1, HG_KNOCKBACK_SCALING, .85);//.7
