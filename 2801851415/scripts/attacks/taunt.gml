...
set_window_value(AT_TAUNT, 1, AG_WINDOW_HAS_SFX, 5);
set_window_value(AT_TAUNT, 1, AG_WINDOW_ANIM_FRAME_START, 13);
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX, asset_get("sfx_ice_ftilt"));
...
set_window_value(AT_TAUNT, 2, AG_WINDOW_SFX, asset_get("sfx_shop_buy"));
