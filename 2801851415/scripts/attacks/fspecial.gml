...
set_attack_value(AT_FSPECIAL, AG_SPRITE, sprite_get("fspecial"));//fspecialground
set_attack_value(AT_FSPECIAL, AG_AIR_SPRITE, sprite_get("fspecial"));
set_attack_value(AT_FSPECIAL, AG_NUM_WINDOWS, 3);
set_attack_value(AT_FSPECIAL, AG_HAS_LANDING_LAG, 1);
set_attack_value(AT_FSPECIAL, AG_LANDING_LAG, 6); //this is normal landing lag for most aerials
...
//set_hitbox_value(AT_FSPECIAL, 2, HG_PARENT_HITBOX, 1); //use this line to make follow up hitboxes share values with this one, remove it if it should be different
