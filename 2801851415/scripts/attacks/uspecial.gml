...
set_hitbox_value(AT_USPECIAL, 3, HG_BASE_KNOCKBACK, 8); //this is absurd base knockback, do not give values this high to characters, sandbert has it because sandbert reasons
...
set_hitbox_value(AT_USPECIAL, 3, HG_HIT_SFX, asset_get("sfx_icehit_heavy2"));
