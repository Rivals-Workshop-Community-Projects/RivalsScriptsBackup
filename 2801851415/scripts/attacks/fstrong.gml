...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_LENGTH, 18);//10
set_window_value(AT_FSTRONG, 3, AG_WINDOW_ANIM_FRAMES, 4);
set_window_value(AT_FSTRONG, 3, AG_WINDOW_ANIM_FRAME_START, 5);
set_window_value(AT_FSTRONG, 3, AG_WINDOW_HAS_WHIFFLAG, 1);//this should be here, not window 2
...
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, asset_get("sfx_ice_nspecial_hit_ground"));
