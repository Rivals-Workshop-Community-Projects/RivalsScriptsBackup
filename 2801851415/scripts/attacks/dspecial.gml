...
set_attack_value(AT_DSPECIAL, AG_SPRITE, sprite_get("taunt"));
...
set_hitbox_value(AT_DSPECIAL, 3, HG_HITBOX_X, 0);//30
set_hitbox_value(AT_DSPECIAL, 3, HG_HITBOX_Y, -40);
set_hitbox_value(AT_DSPECIAL, 3, HG_WIDTH, 60);//50
set_hitbox_value(AT_DSPECIAL, 3, HG_HEIGHT, 60);
set_hitbox_value(AT_DSPECIAL, 3, HG_PRIORITY, 1);
set_hitbox_value(AT_DSPECIAL, 3, HG_DAMAGE, 8);//8
set_hitbox_value(AT_DSPECIAL, 3, HG_ANGLE, 45);
//set_hitbox_value(AT_DSPECIAL, 3, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_DSPECIAL, 3, HG_BASE_KNOCKBACK, 5);//6
set_hitbox_value(AT_DSPECIAL, 3, HG_KNOCKBACK_SCALING, .5);//.6
set_hitbox_value(AT_DSPECIAL, 3, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_DSPECIAL, 3, HG_HITPAUSE_SCALING, .6);//.25
//set_hitbox_value(AT_DSPECIAL, 3, HG_VISUAL_EFFECT, lanternfx);
