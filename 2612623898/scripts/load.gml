...
sprite_change_offset("hurt", 64, 128);
sprite_change_offset("crouch", 64, 128);
...
sprite_change_offset("walljump", 64, 128);
sprite_change_offset("pratfall", 64, 128);
sprite_change_offset("land", 64, 128);
sprite_change_offset("landinglag", 64, 128);
...
sprite_change_offset("dtilt", 64, 128);
sprite_change_offset("utilt", 64, 128);
sprite_change_offset("nair", 64, 128);
sprite_change_offset("fair", 64, 128);
sprite_change_offset("bair", 128, 128);
sprite_change_offset("uair", 64, 96);
sprite_change_offset("dair", 64, 128);
...
sprite_change_offset("proj_smoke", 32, 32);
