...
if (winner == player) //win quote textbox drawing, should only run from the perspective of this player if they are the ones drawing the win screen
{
    ...
    if (quote_current_pos_x > hide_pos_x)
    {
        ...
        //emote
        draw_sprite_ext(sprite_get("wsc_win_emote"), victory_emote, quote_current_pos_x+14, quote_pos_y+6, 2, 2, 0, c_white, 1);
        //text
        draw_win_quote(
            quote_current_pos_x+100, quote_pos_y+1,
...
#define use_generic_quote()
{
    var quotes = [];
    var i = 0;
    quotes[i++] = {quote: "I'm neutral.", emote: 0};
    quotes[i++] = {quote: "I'm happy!", emote: 1};
    quotes[i++] = {quote: "I'm sad...", emote: 2};
    quotes[i++] = {quote: "I'm angry.", emote: 3};
    quotes[i++] = {quote: "I'm confused?", emote: 4};
