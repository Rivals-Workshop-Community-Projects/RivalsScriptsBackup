...
window_num ++; //endlag (it has no whifflag because it's only shoots a projectile and specials don't have whifflag on the base game characters)
...
set_hitbox_value(atk, hitbox_num, HG_MULTIHIT_ANGLE, -1);
set_hitbox_value(atk, hitbox_num, HG_MULTIHIT_FLIPPER, 9);
set_hitbox_value(atk, hitbox_num, HG_PROJECTILE_PARRY_STUN, 1);
set_hitbox_value(atk, hitbox_num, HG_EXTENDED_PARRY_STUN, 1);
set_hitbox_value(atk, hitbox_num, HG_FORCE_FLINCH, 2); // force flinch 2 prevents projectiles from being crouch cancelable
set_hitbox_value(atk, hitbox_num, HG_PROJECTILE_HOMING, has_rune("G"));
