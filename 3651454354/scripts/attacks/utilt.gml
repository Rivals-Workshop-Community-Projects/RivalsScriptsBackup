...
//set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("snd_swing_quick_high"));
...
set_hitbox_value(AT_UTILT, 1, HG_WIDTH, 18);
...
set_hitbox_value(AT_UTILT, 3, HG_HITBOX_Y, -109);
...
set_hitbox_value(AT_UTILT, 3, HG_BASE_KNOCKBACK, 8.5);
