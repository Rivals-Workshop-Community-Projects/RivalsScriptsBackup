...
set_hitbox_value(AT_DSPECIAL, 2, HG_HEIGHT, 122);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HIT_SFX, sound_get("snd_nothing"));
set_hitbox_value(AT_DSPECIAL, 2, HG_HIT_LOCKOUT, 8);
set_hitbox_value(AT_DSPECIAL, 2, HG_ANGLE_FLIPPER, 3);
set_hitbox_value(AT_DSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("plat"));
...
set_hitbox_value(AT_DSPECIAL, 3, HG_HIT_SFX, sound_get("snd_nothing"));
//set_hitbox_value(AT_DSPECIAL, 2, HG_HIT_LOCKOUT, 5);
set_hitbox_value(AT_DSPECIAL, 3, HG_ANGLE_FLIPPER, 3);
set_hitbox_value(AT_DSPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("plat"));
set_hitbox_value(AT_DSPECIAL, 3, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_DSPECIAL, 3, HG_PROJECTILE_ANIM_SPEED, 1.0);
set_hitbox_value(AT_DSPECIAL, 3, HG_PROJECTILE_AIR_FRICTION, 0.03);
