...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, asset_get("sfx_clairen_hit_weak"));
...
set_hitbox_value(AT_BAIR, 3, HG_HIT_SFX, asset_get("sfx_clairen_hit_weak"));
...
set_hitbox_value(AT_BAIR, 4, HG_ANGLE, 105);
