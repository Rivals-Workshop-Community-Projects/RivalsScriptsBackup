...
set_window_value(AT_NAIR, 4, AG_WINDOW_ANIM_FRAMES, 7);
set_window_value(AT_NAIR, 4, AG_WINDOW_ANIM_FRAME_START, 16);
set_window_value(AT_NAIR, 4, AG_WINDOW_HAS_WHIFFLAG, 2);
...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sound_get("snd_damage_weak"));
...
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, sound_get("snd_damage_weak"));
...
set_hitbox_value(AT_NAIR, 3, HG_KNOCKBACK_SCALING, .75);
...
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, sound_get("snd_damage_weak"));
...
set_hitbox_value(AT_NAIR, 4, HG_KNOCKBACK_SCALING, .85);
...
set_hitbox_value(AT_NAIR, 4, HG_HIT_SFX, sound_get("snd_damage_weak"));