...
set_window_value(AT_DAIR, 2, AG_WINDOW_SFX, sound_get("snd_swing"));
...
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, sound_get("snd_damage_weak"));
...
set_hitbox_value(AT_DAIR, 2, HG_HITBOX_Y, 43);
...
set_hitbox_value(AT_DAIR, 2, HG_BASE_KNOCKBACK, 7.5);
...
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, sound_get("snd_damage_strong"));
set_hitbox_value(AT_DAIR, 2, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT, slash);