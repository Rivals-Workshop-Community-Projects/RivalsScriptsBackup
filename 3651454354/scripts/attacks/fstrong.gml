...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_HAS_WHIFFLAG, 6);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sound_get("snd_damage_strong"));
...
set_hitbox_value(AT_FSTRONG, 2, HG_ANGLE, 135);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, sound_get("snd_damage_strong"));
