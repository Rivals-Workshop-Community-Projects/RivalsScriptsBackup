...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("snd_jump"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_LIFETIME, 999);
...
set_hitbox_value(AT_DSTRONG, 1, HG_PROJECTILE_SPRITE, sprite_get("caroseal_plc"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_PROJECTILE_SPRITE, sprite_get("caroseal_plc"));
set_hitbox_value(AT_DSTRONG, 2, HG_PROJECTILE_ANIM_SPEED, 0.25);
...
set_hitbox_value(AT_DSTRONG, 3, HG_LIFETIME, 999);
...
set_hitbox_value(AT_DSTRONG, 3, HG_ANGLE, 48);
...
set_hitbox_value(AT_DSTRONG, 3, HG_PROJECTILE_SPRITE, sprite_get("caroseal_plc"));
set_hitbox_value(AT_DSTRONG, 3, HG_PROJECTILE_ANIM_SPEED, 0.25);
