...
set_attack_value(attack, AG_SPRITE, sprite_get("uthrow"));
set_attack_value(attack, AG_AIR_SPRITE, 0);
set_attack_value(attack, AG_HURTBOX_SPRITE, sprite_get("uthrow_hurt"));
...
"- Non-enhanced version of Uspecial
- Can cancel endlag with attack / airdodge / jump");//AG_MUNO_ATTACK_MISC_ADD 

//Window Values-----------------------------------------------------------------------------
var window_num = 1;

// Window #1 / Frame(s) # 0-3 / Grab Start Up
...
// Window #2 / Frame(s) # 4-7 / Shock Window
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_window_value(attack, window_num, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1);
...
//hitbox_num++;
// Hitbox 6 - Final Hitbox with knockback/ outside of grab window to prevent interacting with grab code
window_for_hitbox = 3; 
    set_hitbox_value(attack, hitbox_num, HG_WINDOW, window_for_hitbox);
    set_hitbox_value(attack, hitbox_num, HG_HITBOX_TYPE, 1);
