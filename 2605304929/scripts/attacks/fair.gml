...
// Window #3 / Frame(s) # 6-8 / Linger Hitbox
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_hitbox_value(attack, hitbox_num, HG_VISUAL_EFFECT, 305); // 305 - basic sweetspot
