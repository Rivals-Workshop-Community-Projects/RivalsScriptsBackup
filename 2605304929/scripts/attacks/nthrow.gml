var attack = AT_NTHROW; // Swap Taunt for attack that this is

//Attack Values-----------------------------------------------------------------------------
set_attack_value(attack, AG_CATEGORY, 1);
set_attack_value(attack, AG_SPRITE, sprite_get("nthrow"));
set_attack_value(attack, AG_AIR_SPRITE, 0);
set_attack_value(attack, AG_HURTBOX_SPRITE, sprite_get("nthrow_hurt"));
...
// Window #3 / Frame(s) # 4-14 / Jump Off
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_hitbox_value(attack, hitbox_num, HG_VISUAL_EFFECT, 9); // 9   - light water directional
set_hitbox_value(attack, hitbox_num, HG_HIT_SFX, asset_get("sfx_waterhit_heavy"));
