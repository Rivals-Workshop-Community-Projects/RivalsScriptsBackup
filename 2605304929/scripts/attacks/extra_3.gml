// A+B Command Input Execution Version
...
// Window #1 / Frame(s) # 0-2 / Grab Start Up / Sliding behind
...
// Window #2 / Frame(s) # 3-6 / Jump On Opponent
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #3 / Frame(s) # 7-10 / Shock Window
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
window_for_hitbox = 3; 
    ...
    //set_hitbox_value(attack, hitbox_num, HG_VISUAL_EFFECT, 1); // 21  - lightning medium //1   - no visual effect
