...
set_attack_value(attack, AG_HURTBOX_SPRITE, sprite_get("nair_hurt"));
...
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_swipe_medium1")); //  or sound_get("")
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, get_window_value(attack, window_num, AG_WINDOW_LENGTH)-1);

window_num++;

// Window #2 / Frame(s) # 4- / 1st kick active hitbox
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #3 / Frame(s) # 5-8 / Inbetween to 2nd kick
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 7);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 4);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAME_START, 5);
set_window_value(attack, window_num, AG_WINDOW_HAS_SFX, 1); 
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_swipe_medium2")); //  or sound_get("")
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, get_window_value(attack, window_num, AG_WINDOW_LENGTH)-1);
window_num++;

// Window #4 / Frame(s) # 9- / 2nd kick active hitbox
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 3);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 1);
...
// Window #5 / Frame(s) # 10-15 / End Lag
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -27);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 100);
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 53);
...
set_hitbox_value(attack, hitbox_num, HG_ANGLE_FLIPPER, 10); // Autolink Flipper
...
set_hitbox_value(attack, hitbox_num, HG_HITBOX_GROUP, -1);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 29);
