//Paired with Uspecial

var attack = AT_USPECIAL_2; // Swap Taunt for attack that this is

//Attack Values-----------------------------------------------------------------------------
set_attack_value(attack, AG_CATEGORY, 2);
set_attack_value(attack, AG_SPRITE, sprite_get("uspecial_2"));
set_attack_value(attack, AG_AIR_SPRITE, 0);
set_attack_value(attack, AG_HURTBOX_SPRITE, sprite_get("uspecial_2_hurt"));
...
"- Enhanced version of Uspecial
- Consumes Mark
- Has anti gannoncide platform code.
- Has anti top gimping code.");//AG_MUNO_ATTACK_MISC_ADD 

//Window Values-----------------------------------------------------------------------------
var window_num = 1;

// Window #1 / Frame(s) # 4-5 / Grab Start Up, used to set opponent location before flip.
...
// Window #2 / Frame(s) # 6-10 / Flipping
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #3 / Frame(s) # 11-12 / Shock Window + falling
set_window_value(attack, window_num, AG_WINDOW_TYPE, 10);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 12);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAME_START, 11);
set_window_value(attack, window_num, AG_WINDOW_HSPEED, 0);
set_window_value(attack, window_num, AG_WINDOW_VSPEED, 20);
set_window_value(attack, window_num, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(attack, window_num, AG_WINDOW_VSPEED_TYPE, 1);

window_num++;

// Window #4 / Frame(s) # 13-14 / Ground Impact
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #5 / Frame(s) # 15-20 / Endlag / Recovery
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
window_for_hitbox = 1; 
    ...
    set_hitbox_value(attack, hitbox_num, HG_WINDOW_CREATION_FRAME, hitbox_num * 5);
    set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 21);
...
window_for_hitbox = 4; 
    ...
    set_hitbox_value(attack, hitbox_num, HG_WIDTH, 165);
