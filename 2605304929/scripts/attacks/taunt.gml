...
set_attack_value(attack, AG_SPRITE, sprite_get("taunt"));
set_attack_value(attack, AG_AIR_SPRITE, 0);
set_attack_value(attack, AG_HURTBOX_SPRITE, sprite_get("taunt_hurt"));
...
// Window #1 / Frame(s) # 0-2 / Start Up (Skip frame 3)
...
// Window #2 / Frame(s) # 3 / Howl Start Frame
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_syl_dspecial_howl")); //  or sound_get("")
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, 0);

window_num++;

// Window #3 / Frame(s) # 4-5 / Howl Loop
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #4 / Frame(s) # 6-8 / End of Howl
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 16);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 3);
