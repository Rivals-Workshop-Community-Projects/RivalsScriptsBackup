...
set_attack_value(attack, AG_HURTBOX_SPRITE, sprite_get("uspecial_hurt"));
...
set_attack_value(attack, 87, "Sets into pratfall on whiff.");//AG_MUNO_ATTACK_MISC_ADD 
...
// Window #2 / Frame(s) # 4- / Start Momentum + ground hitbox
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_window_value(attack, window_num, AG_WINDOW_HSPEED, 0);
set_window_value(attack, window_num, AG_WINDOW_VSPEED, -12.5);
set_window_value(attack, window_num, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(attack, window_num, AG_WINDOW_VSPEED_TYPE, 2);
set_window_value(attack, window_num, AG_WINDOW_HAS_SFX, 1);
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_absa_new_whip1")); 

window_num++;

// Window #3 / Frame(s) # 5-6 / In Air asending hitbox active
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window #4 / Frame(s) # 7 - 8 / Overhead hitbox
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 8);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAME_START, 7);
set_window_value(attack, window_num, AG_WINDOW_HAS_SFX, 1);
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_absa_new_whip2")); 

window_num++;

// Window #5 / Frame(s) # 9 - 10 / Endlag Section
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 8);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 2);
...
// Window #6 / Frame(s) # 11 - 13 / Whiff into Pratfall
set_window_value(attack, window_num, AG_WINDOW_TYPE, 7); //7 = Goes into pratfall
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 12);
...
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 41);
...
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 2);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 18);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -56);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 28);
...
hitbox_num++;
/*
//Back Hitbox Not active for now
