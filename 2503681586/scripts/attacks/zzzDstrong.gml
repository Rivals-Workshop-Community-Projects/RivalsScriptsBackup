set_attack_value( AT_DSTRONG_2, AG_SPRITE, sprite_get("f_dstrong"));
...
set_attack_value( AT_DSTRONG_2, AG_HURTBOX_SPRITE, sprite_get("f_dstrong_hurt"));
...
set_window_value( AT_DSTRONG_2, 2, AG_WINDOW_SFX, asset_get("sfx_swish_weak"));
...
set_hitbox_value( AT_DSTRONG_2, 1, HG_WINDOW_CREATION_FRAME, 6);
