...
set_window_value(AT_NAIR, 1, AG_WINDOW_TYPE, 8);
...
set_window_value(AT_NAIR, 3, AG_WINDOW_TYPE, 8);
...
set_window_value(AT_NAIR, 4, AG_WINDOW_TYPE, 8);
...
set_hitbox_value(AT_NAIR, 1, HG_HEIGHT, 140);
...
set_hitbox_value(AT_NAIR, 1, HG_EXTRA_HITPAUSE, 5);
