...
set_window_value(AT_UAIR, 4, AG_WINDOW_TYPE, 8);
...
set_hitbox_value(AT_UAIR, 1, HG_WIDTH, 150);
...
set_hitbox_value(AT_UAIR, 2, HG_HITBOX_Y, -110); //-100
set_hitbox_value(AT_UAIR, 2, HG_WIDTH, 20); //50
set_hitbox_value(AT_UAIR, 2, HG_HEIGHT, 20); //50
...
set_hitbox_value(AT_UAIR, 2, HG_EXTRA_HITPAUSE, 5);
...
set_hitbox_value(AT_UAIR, 3, HG_BASE_HITPAUSE, 20);
