...
set_window_value(AT_DAIR, 7, AG_WINDOW_VSPEED, -5);

//ALT throw
set_window_value(AT_DAIR, 8, AG_WINDOW_TYPE, 7);
...
set_window_value(AT_DAIR, 8, AG_WINDOW_VSPEED, -4);
set_window_value(AT_DAIR, 8, AG_WINDOW_HAS_WHIFFLAG, 1);
set_window_value(AT_DAIR, 8, AG_WINDOW_CANCEL_FRAME, 10);
