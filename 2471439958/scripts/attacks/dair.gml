...
set_attack_value(AT_DAIR, AG_HURTBOX_SPRITE, sprite_get("hurtbox"));
...
//ALT throw
set_window_value(AT_DAIR, 7, AG_WINDOW_TYPE, 7);
...
set_window_value(AT_DAIR, 7, AG_WINDOW_SFX, asset_get("sfx_swipe_medium2"));
set_window_value(AT_DAIR, 7, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_DAIR, 7, AG_WINDOW_VSPEED, -4);
set_window_value(AT_DAIR, 7, AG_WINDOW_HAS_WHIFFLAG, 1);
set_window_value(AT_DAIR, 7, AG_WINDOW_CANCEL_FRAME, 10);

//GENERIC END
set_window_value(AT_DAIR, 8, AG_WINDOW_TYPE, 0);
set_window_value(AT_DAIR, 8, AG_WINDOW_LENGTH, 1);
