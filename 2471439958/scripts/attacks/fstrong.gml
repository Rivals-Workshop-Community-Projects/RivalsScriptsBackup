...
set_attack_value(AT_FSTRONG, AG_HAS_LANDING_LAG, 10);
...
set_window_value(AT_FSTRONG, 6, AG_WINDOW_LENGTH, 19);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_X, 140);
...
set_hitbox_value(AT_FSTRONG, 3, HG_VISUAL_EFFECT, 204);
set_hitbox_value(AT_FSTRONG, 3, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_FSTRONG, 3, HG_HIT_SFX, asset_get("sfx_burnconsume"));
...
set_hitbox_value(AT_FSTRONG, 4, HG_HITBOX_X, 140);
...
set_hitbox_value(AT_FSTRONG, 4, HG_BASE_HITPAUSE, 40);
set_hitbox_value(AT_FSTRONG, 4, HG_HITPAUSE_SCALING, .6);
set_hitbox_value(AT_FSTRONG, 4, HG_VISUAL_EFFECT, 19);
