...
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_X, 90);
...
set_hitbox_value(AT_FSTRONG, 3, HG_HITBOX_X, 90);
set_hitbox_value(AT_FSTRONG, 3, HG_HITBOX_Y, -20);
set_hitbox_value(AT_FSTRONG, 3, HG_WIDTH, 140);
set_hitbox_value(AT_FSTRONG, 3, HG_HEIGHT, 14);
...
set_hitbox_value(AT_FSTRONG, 4, HG_HITBOX_X, 160);
...
set_hitbox_value(AT_FSTRONG, 4, HG_BASE_HITPAUSE, 25);
