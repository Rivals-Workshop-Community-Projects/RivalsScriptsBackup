set_attack_value(AT_EXTRA_2, AG_SPRITE, sprite_get("fstrong_rock"));
set_attack_value(AT_EXTRA_2, AG_HAS_LANDING_LAG, 10);
set_attack_value(AT_EXTRA_2, AG_STRONG_CHARGE_WINDOW, 1);
set_attack_value(AT_EXTRA_2, AG_HURTBOX_SPRITE, sprite_get("fstrong_hurt"));
...
set_window_value(AT_EXTRA_2, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, .4);
...
set_window_value(AT_EXTRA_2, 2, AG_WINDOW_SFX_FRAME, 6);
...
set_window_value(AT_EXTRA_2, 4, AG_WINDOW_LENGTH, 1);
set_window_value(AT_EXTRA_2, 4, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_EXTRA_2, 4, AG_WINDOW_ANIM_FRAME_START, 8);
...
set_window_value(AT_EXTRA_2, 6, AG_WINDOW_LENGTH, 19);
set_window_value(AT_EXTRA_2, 6, AG_WINDOW_ANIM_FRAMES, 4);
set_window_value(AT_EXTRA_2, 6, AG_WINDOW_ANIM_FRAME_START, 11);
...
set_hitbox_value(AT_EXTRA_2, 1, HG_HEIGHT, 14);
set_hitbox_value(AT_EXTRA_2, 1, HG_PRIORITY, 5);
set_hitbox_value(AT_EXTRA_2, 1, HG_SHAPE, 1);
set_hitbox_value(AT_EXTRA_2, 1, HG_HITPAUSE_SCALING, .6);
set_hitbox_value(AT_EXTRA_2, 1, HG_VISUAL_EFFECT_Y_OFFSET, 20);
	...
	set_hitbox_value(AT_EXTRA_2, 1, HG_VISUAL_EFFECT, 162);
	...
	set_hitbox_value(AT_EXTRA_2, 1, HG_DAMAGE, 18);
	set_hitbox_value(AT_EXTRA_2, 1, HG_EFFECT, 0);
	set_hitbox_value(AT_EXTRA_2, 1, HG_ANGLE, 42);
...
set_hitbox_value(AT_EXTRA_2, 2, HG_HITBOX_X, 146);
set_hitbox_value(AT_EXTRA_2, 2, HG_HITBOX_Y, -22);
set_hitbox_value(AT_EXTRA_2, 2, HG_HEIGHT, 16);
set_hitbox_value(AT_EXTRA_2, 2, HG_PRIORITY, 4);
set_hitbox_value(AT_EXTRA_2, 2, HG_SHAPE, 1);
set_hitbox_value(AT_EXTRA_2, 2, HG_HITPAUSE_SCALING, .6);
set_hitbox_value(AT_EXTRA_2, 2, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_EXTRA_2, 2, HG_EXTRA_CAMERA_SHAKE, 1);
	set_hitbox_value(AT_EXTRA_2, 2, HG_HIT_SFX, asset_get("sfx_absa_kickhit"));
	set_hitbox_value(AT_EXTRA_2, 2, HG_VISUAL_EFFECT, 133);
	set_hitbox_value(AT_EXTRA_2, 2, HG_BASE_HITPAUSE, 30);
	set_hitbox_value(AT_EXTRA_2, 2, HG_BASE_KNOCKBACK, 7);
	set_hitbox_value(AT_EXTRA_2, 2, HG_KNOCKBACK_SCALING, 1.2);
	set_hitbox_value(AT_EXTRA_2, 2, HG_DAMAGE, 20);
	set_hitbox_value(AT_EXTRA_2, 2, HG_EFFECT, 0);
	set_hitbox_value(AT_EXTRA_2, 2, HG_ANGLE, 35);
