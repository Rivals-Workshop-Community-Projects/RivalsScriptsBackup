...
set_hitbox_value(AT_FAIR, 2, HG_WIDTH, 120);
...
set_hitbox_value(AT_FAIR, 3, HG_BASE_HITPAUSE, 20);
set_hitbox_value(AT_FAIR, 3, HG_HITPAUSE_SCALING, .25);
set_hitbox_value(AT_FAIR, 3, HG_VISUAL_EFFECT, 204);
set_hitbox_value(AT_FAIR, 3, HG_EFFECT, 2);
set_hitbox_value(AT_FAIR, 3, HG_HIT_SFX, asset_get("sfx_burnconsume"));
set_hitbox_value(AT_FAIR, 3, HG_HITSTUN_MULTIPLIER, 1.1);

//SOURSPOT CONSUME (currently unused because I was forced to.... I sorry.... I wamted to keep it)
...
set_hitbox_value(AT_FAIR, 4, HG_WIDTH, 120);
...
set_hitbox_value(AT_FAIR, 4, HG_BASE_HITPAUSE, 15);
