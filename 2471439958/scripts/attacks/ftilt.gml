set_attack_value(AT_FTILT, AG_SPRITE, sprite_get("sickles"));
set_attack_value(AT_FTILT, AG_HURTBOX_SPRITE, sprite_get("sickles_hurt"));
...
set_window_value(AT_FTILT, 7, AG_WINDOW_LENGTH, 1);
...
set_window_value(AT_FTILT, 8, AG_WINDOW_LENGTH, 8);
set_window_value(AT_FTILT, 8, AG_WINDOW_ANIM_FRAMES, 5);
set_window_value(AT_FTILT, 8, AG_WINDOW_ANIM_FRAME_START, 13);
set_window_value(AT_FTILT, 8, AG_WINDOW_HSPEED, 3);
set_window_value(AT_FTILT, 8, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FTILT, 8, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy2"));
set_window_value(AT_FTILT, 8, AG_WINDOW_HAS_WHIFFLAG, 1);

set_window_value(AT_FTILT, 9, AG_WINDOW_TYPE, 1);
set_window_value(AT_FTILT, 9, AG_WINDOW_LENGTH, 6);
...
set_window_value(AT_FTILT, 10, AG_WINDOW_LENGTH, 6);
set_window_value(AT_FTILT, 10, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_FTILT, 10, AG_WINDOW_ANIM_FRAME_START, 2);

set_window_value(AT_FTILT, 11, AG_WINDOW_TYPE, 1);
set_window_value(AT_FTILT, 11, AG_WINDOW_LENGTH, 13);
set_window_value(AT_FTILT, 11, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_FTILT, 11, AG_WINDOW_ANIM_FRAME_START, 1);

//Generic end

set_window_value(AT_FTILT, 10, AG_WINDOW_TYPE, 1);
set_window_value(AT_FTILT, 10, AG_WINDOW_LENGTH, 1);
set_window_value(AT_FTILT, 10, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_FTILT, 10, AG_WINDOW_ANIM_FRAME_START, 12);

set_window_value(AT_FTILT, 11, AG_WINDOW_TYPE, 1);
set_window_value(AT_FTILT, 11, AG_WINDOW_LENGTH, 8);
set_window_value(AT_FTILT, 11, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_FTILT, 11, AG_WINDOW_ANIM_FRAME_START, 12);
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, sound_get("axe_hit2"));
set_hitbox_value(AT_FTILT, 1, HG_HIT_LOCKOUT, 1);
set_hitbox_value(AT_FTILT, 1, HG_TECHABLE, 1);
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT, blood_effect);
...
set_hitbox_value(AT_FTILT, 2, HG_ANGLE, 115);
...
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, sound_get("axe_hit2"));
set_hitbox_value(AT_FTILT, 2, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_FTILT, 2, HG_HIT_LOCKOUT, 1);
set_hitbox_value(AT_FTILT, 2, HG_TECHABLE, 1);
set_hitbox_value(AT_FTILT, 2, HG_SHAPE, 2);
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT, blood_effect);
...
set_hitbox_value(AT_FTILT, 3, HG_ANGLE_FLIPPER, 10);
set_hitbox_value(AT_FTILT, 3, HG_BASE_KNOCKBACK, 4);
set_hitbox_value(AT_FTILT, 3, HG_BASE_HITPAUSE, 12);
set_hitbox_value(AT_FTILT, 3, HG_HIT_SFX, sound_get("axe_hit"));
...
set_hitbox_value(AT_FTILT, 3, HG_EXTRA_CAMERA_SHAKE, 50);
set_hitbox_value(AT_FTILT, 3, HG_VISUAL_EFFECT, blood_effect);
...
set_hitbox_value(AT_FTILT, 4, HG_WINDOW_CREATION_FRAME, 5);
...
set_hitbox_value(AT_FTILT, 4, HG_BASE_KNOCKBACK, 10);
...
set_hitbox_value(AT_FTILT, 4, HG_HIT_SFX, sound_get("axe_hit3"));
set_hitbox_value(AT_FTILT, 4, HG_HITBOX_GROUP, 3);
set_hitbox_value(AT_FTILT, 4, HG_EXTRA_CAMERA_SHAKE, 50);
set_hitbox_value(AT_FTILT, 4, HG_HIT_LOCKOUT, 1);
set_hitbox_value(AT_FTILT, 4, HG_VISUAL_EFFECT, blood_effect);
...
set_hitbox_value(AT_FTILT, 5, HG_HITBOX_Y, -20);
set_hitbox_value(AT_FTILT, 5, HG_WIDTH, 100);
set_hitbox_value(AT_FTILT, 5, HG_HEIGHT, 60);
set_hitbox_value(AT_FTILT, 5, HG_PRIORITY, 5);
set_hitbox_value(AT_FTILT, 5, HG_DAMAGE, 3);
set_hitbox_value(AT_FTILT, 5, HG_ANGLE, 70);
set_hitbox_value(AT_FTILT, 5, HG_ANGLE_FLIPPER, 10);
set_hitbox_value(AT_FTILT, 5, HG_BASE_KNOCKBACK, 4);
set_hitbox_value(AT_FTILT, 5, HG_BASE_HITPAUSE, 2);
set_hitbox_value(AT_FTILT, 5, HG_HIT_LOCKOUT, 1);
set_hitbox_value(AT_FTILT, 5, HG_TECHABLE, 1);
set_hitbox_value(AT_FTILT, 5, HG_HIT_SFX, sound_get("axe_hit2"));
set_hitbox_value(AT_FTILT, 5, HG_VISUAL_EFFECT, blood_effect);