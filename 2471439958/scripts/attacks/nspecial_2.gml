...
set_attack_value(AT_NSPECIAL_2, AG_HURTBOX_SPRITE, sprite_get("hurtbox"));
...
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HITSTUN_MULTIPLIER, .5);
...
set_hitbox_value(AT_NSPECIAL_2, 2, HG_LIFETIME, 18);
...
set_hitbox_value(AT_NSPECIAL_2, 2, HG_HITSTUN_MULTIPLIER, .5);
...
set_hitbox_value(AT_NSPECIAL_2, 2, HG_PROJECTILE_HSPEED, 15);
