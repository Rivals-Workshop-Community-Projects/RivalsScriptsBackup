...
set_window_value(AT_EXTRA_3, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, .3);
set_window_value(AT_EXTRA_3, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_EXTRA_3, 1, AG_WINDOW_SFX, sound_get("SGL2"));
...
set_window_value(AT_EXTRA_3, 2, AG_WINDOW_SFX, sound_get("SGL"));
...
set_window_value(AT_EXTRA_3, 3, AG_WINDOW_SFX, sound_get("QSGF"));
...
set_window_value(AT_EXTRA_3, 4, AG_WINDOW_HSPEED, -4);
...
set_hitbox_value(AT_EXTRA_3, 1, HG_HITBOX_X, 110);
...
set_hitbox_value(AT_EXTRA_3, 1, HG_HIT_SFX, asset_get("sfx_burnapplied"));
...
set_hitbox_value(AT_EXTRA_3, 2, HG_HITBOX_X, 70);
...
set_hitbox_value(AT_EXTRA_3, 2, HG_PRIORITY, 8);
...
set_hitbox_value(AT_EXTRA_3, 2, HG_HIT_SFX, asset_get("sfx_burnapplied"));
