set_attack_value(AT_UTILT, AG_SPRITE, sprite_get("shredder"));
set_attack_value(AT_UTILT, AG_NUM_WINDOWS, 5);
set_attack_value(AT_UTILT, AG_CATEGORY, 2);
set_attack_value(AT_UTILT, AG_HURTBOX_SPRITE, sprite_get("shredder_hurt"));
...
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sound_get("axe_hit3"));
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, blood_effect);
...
set_hitbox_value(AT_UTILT, 2, HG_KNOCKBACK_SCALING, .12);
set_hitbox_value(AT_UTILT, 2, HG_BASE_HITPAUSE, 1);
set_hitbox_value(AT_UTILT, 2, HG_EXTRA_CAMERA_SHAKE, 1);
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, sound_get("axe_hit3"));
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, blood_effect);
...
set_hitbox_value(AT_UTILT, 3, HG_WIDTH, 100);
...
set_hitbox_value(AT_UTILT, 3, HG_BASE_HITPAUSE, 12);
set_hitbox_value(AT_UTILT, 3, HG_HITPAUSE_SCALING, .4);
set_hitbox_value(AT_UTILT, 3, HG_EXTRA_CAMERA_SHAKE, 1);
set_hitbox_value(AT_UTILT, 3, HG_HIT_SFX, sound_get("axe_hit3"));
set_hitbox_value(AT_UTILT, 3, HG_HITSTUN_MULTIPLIER, 1.0);
set_hitbox_value(AT_UTILT, 3, HG_VISUAL_EFFECT, blood_effect);