...
set_hitbox_value(AT_FSPECIAL, 3, HG_HIT_SFX, asset_get("sfx_swipe_heavy1"));
...
set_hitbox_value(AT_FSPECIAL, 4, HG_HITBOX_X, 158);
set_hitbox_value(AT_FSPECIAL, 4, HG_HITBOX_Y, -25);
set_hitbox_value(AT_FSPECIAL, 4, HG_WIDTH, 58);
set_hitbox_value(AT_FSPECIAL, 4, HG_HEIGHT, 50);
set_hitbox_value(AT_FSPECIAL, 4, HG_PRIORITY, 10);
set_hitbox_value(AT_FSPECIAL, 4, HG_DAMAGE, 3);
set_hitbox_value(AT_FSPECIAL, 4, HG_ANGLE, 110);
set_hitbox_value(AT_FSPECIAL, 4, HG_BASE_KNOCKBACK, 12);
set_hitbox_value(AT_FSPECIAL, 4, HG_KNOCKBACK_SCALING, .10);
set_hitbox_value(AT_FSPECIAL, 4, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_FSPECIAL, 4, HG_VISUAL_EFFECT_X_OFFSET, 26);
set_hitbox_value(AT_FSPECIAL, 4, HG_VISUAL_EFFECT_Y_OFFSET, 18);
set_hitbox_value(AT_FSPECIAL, 4, HG_HIT_SFX, asset_get("sfx_bite"));
