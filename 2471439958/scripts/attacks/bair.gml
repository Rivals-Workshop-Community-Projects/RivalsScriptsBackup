...
set_hitbox_value(AT_BAIR, 6, HG_HEIGHT, 56);
...
set_hitbox_value(AT_BAIR, 6, HG_ANGLE, 110);
set_hitbox_value(AT_BAIR, 6, HG_ANGLE_FLIPPER, 2);
set_hitbox_value(AT_BAIR, 6, HG_BASE_KNOCKBACK, 4);
set_hitbox_value(AT_BAIR, 6, HG_KNOCKBACK_SCALING, .0);
set_hitbox_value(AT_BAIR, 6, HG_BASE_HITPAUSE, 2);
set_hitbox_value(AT_BAIR, 6, HG_HITSTUN_MULTIPLIER, 1.2);
