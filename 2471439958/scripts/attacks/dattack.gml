...
set_window_value(AT_DATTACK, 1, AG_WINDOW_ANIM_FRAME_START, 5);
...
set_window_value(AT_DATTACK, 2, AG_WINDOW_ANIM_FRAME_START, 9);
...
set_window_value(AT_DATTACK, 12, AG_WINDOW_HSPEED, 4);
set_window_value(AT_DATTACK, 12, AG_WINDOW_HSPEED_TYPE, 2);
...
set_window_value(AT_DATTACK, 13, AG_WINDOW_HSPEED, 7);
...
set_hitbox_value(AT_DATTACK, 3, HG_HITBOX_X, 37);
...
set_hitbox_value(AT_DATTACK, 3, HG_FORCE_FLINCH, 2);
...
set_hitbox_value(AT_DATTACK, 4, HG_FORCE_FLINCH, 2);
...
set_hitbox_value(AT_DATTACK, 5, HG_HITBOX_X, 37);
...
set_hitbox_value(AT_DATTACK, 5, HG_FORCE_FLINCH, 2);
...
set_hitbox_value(AT_DATTACK, 6, HG_HITBOX_X, 35);
