...
set_window_value(AT_TAUNT_2, 1, AG_WINDOW_SFX, sound_get("taunt1"));
set_window_value(AT_TAUNT_2, 1, AG_WINDOW_VSPEED, -6.9);
...
set_window_value(AT_TAUNT_2, 3, AG_WINDOW_SFX, sound_get("taunt"));
...
set_window_value(AT_TAUNT_2, 5, AG_WINDOW_LENGTH, 11);
set_window_value(AT_TAUNT_2, 5, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_TAUNT_2, 5, AG_WINDOW_ANIM_FRAME_START, 13);
set_window_value(AT_TAUNT_2, 5, AG_WINDOW_HAS_WHIFFLAG, 1);
...
set_hitbox_value(AT_TAUNT_2, 1, HG_WIDTH, 76);
...
set_hitbox_value(AT_TAUNT_2, 1, HG_HITBOX_Y, -36);
set_hitbox_value(AT_TAUNT_2, 1, HG_DAMAGE, 5);
set_hitbox_value(AT_TAUNT_2, 1, HG_BASE_KNOCKBACK, 3);
set_hitbox_value(AT_TAUNT_2, 1, HG_KNOCKBACK_SCALING, 1.3);
set_hitbox_value(AT_TAUNT_2, 1, HG_BASE_HITPAUSE, 30);
