set_attack_value(AT_EXTRA_1, AG_SPRITE, sprite_get("sickles"));
set_attack_value(AT_EXTRA_1, AG_HURTBOX_SPRITE, sprite_get("sickles_hurt"));
set_attack_value(AT_EXTRA_1, AG_CATEGORY, 0);

set_attack_value(AT_EXTRA_1, AG_NUM_WINDOWS, 11);
...
set_window_value(AT_EXTRA_1, 2, AG_WINDOW_SFX, asset_get("sfx_swipe_medium2"));
...
set_window_value(AT_EXTRA_1, 3, AG_WINDOW_CANCEL_FRAME, 4);

set_window_value(AT_EXTRA_1, 4, AG_WINDOW_TYPE, 1);
set_window_value(AT_EXTRA_1, 4, AG_WINDOW_LENGTH, 1);
...
set_window_value(AT_EXTRA_1, 5, AG_WINDOW_HSPEED, 3);
...
set_window_value(AT_EXTRA_1, 6, AG_WINDOW_LENGTH, 9);
set_window_value(AT_EXTRA_1, 6, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_EXTRA_1, 6, AG_WINDOW_ANIM_FRAME_START, 11);
...
set_window_value(AT_EXTRA_1, 7, AG_WINDOW_LENGTH, 1);
...
set_window_value(AT_EXTRA_1, 8, AG_WINDOW_LENGTH, 8);
set_window_value(AT_EXTRA_1, 8, AG_WINDOW_ANIM_FRAMES, 5);
set_window_value(AT_EXTRA_1, 8, AG_WINDOW_ANIM_FRAME_START, 13);
set_window_value(AT_EXTRA_1, 8, AG_WINDOW_HSPEED, 3);
set_window_value(AT_EXTRA_1, 8, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_EXTRA_1, 8, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy2"));
set_window_value(AT_EXTRA_1, 8, AG_WINDOW_HAS_WHIFFLAG, 1);

set_window_value(AT_EXTRA_1, 9, AG_WINDOW_TYPE, 1);
set_window_value(AT_EXTRA_1, 9, AG_WINDOW_LENGTH, 6);
set_window_value(AT_EXTRA_1, 9, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_EXTRA_1, 9, AG_WINDOW_ANIM_FRAME_START, 18);
set_window_value(AT_EXTRA_1, 9, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);

set_window_value(AT_EXTRA_1, 10, AG_WINDOW_TYPE, 1);
set_window_value(AT_EXTRA_1, 10, AG_WINDOW_LENGTH, 6);
set_window_value(AT_EXTRA_1, 10, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_EXTRA_1, 10, AG_WINDOW_ANIM_FRAME_START, 2);

set_window_value(AT_EXTRA_1, 11, AG_WINDOW_TYPE, 1);
set_window_value(AT_EXTRA_1, 11, AG_WINDOW_LENGTH, 13);
set_window_value(AT_EXTRA_1, 11, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_EXTRA_1, 11, AG_WINDOW_ANIM_FRAME_START, 1);

//Generic end

set_window_value(AT_EXTRA_1, 10, AG_WINDOW_TYPE, 1);
set_window_value(AT_EXTRA_1, 10, AG_WINDOW_LENGTH, 1);
set_window_value(AT_EXTRA_1, 10, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_EXTRA_1, 10, AG_WINDOW_ANIM_FRAME_START, 12);

set_window_value(AT_EXTRA_1, 11, AG_WINDOW_TYPE, 1);
set_window_value(AT_EXTRA_1, 11, AG_WINDOW_LENGTH, 8);
set_window_value(AT_EXTRA_1, 11, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_EXTRA_1, 11, AG_WINDOW_ANIM_FRAME_START, 12);

set_num_hitboxes(AT_EXTRA_1, 5);
...
set_hitbox_value(AT_EXTRA_1, 1, HG_HIT_SFX, sound_get("axe_hit2"));
...
set_hitbox_value(AT_EXTRA_1, 2, HG_HITBOX_X, 38);
set_hitbox_value(AT_EXTRA_1, 2, HG_HITBOX_Y, -26);
set_hitbox_value(AT_EXTRA_1, 2, HG_WIDTH, 86);
...
set_hitbox_value(AT_EXTRA_1, 2, HG_HIT_SFX, sound_get("axe_hit2"));
...
set_hitbox_value(AT_EXTRA_1, 3, HG_WINDOW, 8);
...
set_hitbox_value(AT_EXTRA_1, 3, HG_HITBOX_Y, -18);
...
set_hitbox_value(AT_EXTRA_1, 3, HG_HIT_SFX, sound_get("axe_hit"));
...
set_hitbox_value(AT_EXTRA_1, 3, HG_EXTRA_CAMERA_SHAKE, 50);
...
set_hitbox_value(AT_EXTRA_1, 4, HG_WINDOW, 8);
...
set_hitbox_value(AT_EXTRA_1, 4, HG_HITBOX_Y, -25);
set_hitbox_value(AT_EXTRA_1, 4, HG_WIDTH, 110);
