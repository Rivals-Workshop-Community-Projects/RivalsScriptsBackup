...
set_hitbox_value(AT_FSTRONG, 10, HG_WINDOW_CREATION_FRAME, 9);
set_hitbox_value(AT_FSTRONG, 10, HG_LIFETIME, 3);
set_hitbox_value(AT_FSTRONG, 10, HG_HITBOX_X, 135);
set_hitbox_value(AT_FSTRONG, 10, HG_HITBOX_Y, -43);
set_hitbox_value(AT_FSTRONG, 10, HG_WIDTH, 30);
set_hitbox_value(AT_FSTRONG, 10, HG_HEIGHT, 20);
set_hitbox_value(AT_FSTRONG, 10, HG_PRIORITY, 2 );
set_hitbox_value(AT_FSTRONG, 10, HG_DAMAGE, 6);
set_hitbox_value(AT_FSTRONG, 10, HG_ANGLE, 140);
set_hitbox_value(AT_FSTRONG, 10, HG_BASE_KNOCKBACK, 9);
set_hitbox_value(AT_FSTRONG, 10, HG_KNOCKBACK_SCALING, 0);
set_hitbox_value(AT_FSTRONG, 10, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_FSTRONG, 10, HG_HITPAUSE_SCALING, 1.0);
set_hitbox_value(AT_FSTRONG, 10, HG_EXTRA_HITPAUSE, 20);
set_hitbox_value(AT_FSTRONG, 10, HG_VISUAL_EFFECT, 20);
set_hitbox_value(AT_FSTRONG, 10, HG_VISUAL_EFFECT_X_OFFSET, 15);
set_hitbox_value(AT_FSTRONG, 10, HG_TECHABLE, 1);
set_hitbox_value(AT_FSTRONG, 10, HG_HIT_SFX, asset_get("sfx_absa_uair"));
...
set_hitbox_value(AT_FSTRONG, 3, HG_HIT_SFX, asset_get("sfx_absa_uair"));
...
set_hitbox_value(AT_FSTRONG, 5, HG_VISUAL_EFFECT, 20);
set_hitbox_value(AT_FSTRONG, 5, HG_VISUAL_EFFECT_X_OFFSET, 15);
set_hitbox_value(AT_FSTRONG, 5, HG_TECHABLE, 1);
set_hitbox_value(AT_FSTRONG, 5, HG_HIT_SFX, asset_get("sfx_absa_uair"));
set_hitbox_value(AT_FSTRONG, 5, HG_HITBOX_GROUP, 1);

set_hitbox_value(AT_FSTRONG, 11, HG_PARENT_HITBOX, 11);
set_hitbox_value(AT_FSTRONG, 11, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_FSTRONG, 11, HG_WINDOW, 5);
set_hitbox_value(AT_FSTRONG, 11, HG_WINDOW_CREATION_FRAME, 0);
set_hitbox_value(AT_FSTRONG, 11, HG_LIFETIME, 3);
set_hitbox_value(AT_FSTRONG, 11, HG_HITBOX_X, 158);
set_hitbox_value(AT_FSTRONG, 11, HG_HITBOX_Y, -43);
set_hitbox_value(AT_FSTRONG, 11, HG_WIDTH, 20);
set_hitbox_value(AT_FSTRONG, 11, HG_HEIGHT, 20);
set_hitbox_value(AT_FSTRONG, 11, HG_PRIORITY, 7 );
set_hitbox_value(AT_FSTRONG, 11, HG_DAMAGE, 6);
set_hitbox_value(AT_FSTRONG, 11, HG_ANGLE, 135);
set_hitbox_value(AT_FSTRONG, 11, HG_BASE_KNOCKBACK, 9);
set_hitbox_value(AT_FSTRONG, 11, HG_KNOCKBACK_SCALING, 0);
set_hitbox_value(AT_FSTRONG, 11, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_FSTRONG, 11, HG_HITPAUSE_SCALING, 1.0);
set_hitbox_value(AT_FSTRONG, 11, HG_EXTRA_HITPAUSE, 20);
set_hitbox_value(AT_FSTRONG, 11, HG_VISUAL_EFFECT, 20);
set_hitbox_value(AT_FSTRONG, 11, HG_VISUAL_EFFECT_X_OFFSET, 15);
set_hitbox_value(AT_FSTRONG, 11, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_FSTRONG, 11, HG_HIT_SFX, asset_get("sfx_absa_uair"));
set_hitbox_value(AT_FSTRONG, 11, HG_TECHABLE, 1);
...
set_hitbox_value(AT_FSTRONG, 6, HG_WIDTH, 50);
set_hitbox_value(AT_FSTRONG, 6, HG_HEIGHT, 30);
set_hitbox_value(AT_FSTRONG, 6, HG_PRIORITY, 9);
...
set_hitbox_value(AT_FSTRONG, 6, HG_HIT_SFX, asset_get("sfx_absa_uair"));
...
set_hitbox_value(AT_FSTRONG, 7, HG_VISUAL_EFFECT, 20);
set_hitbox_value(AT_FSTRONG, 7, HG_VISUAL_EFFECT_X_OFFSET, 15);
set_hitbox_value(AT_FSTRONG, 7, HG_TECHABLE, 1);
set_hitbox_value(AT_FSTRONG, 7, HG_HIT_SFX, asset_get("sfx_absa_uair"));
...
set_hitbox_value(AT_FSTRONG, 8, HG_VISUAL_EFFECT, 20);
set_hitbox_value(AT_FSTRONG, 8, HG_VISUAL_EFFECT_X_OFFSET, 15);
set_hitbox_value(AT_FSTRONG, 8, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_FSTRONG, 8, HG_HIT_SFX, asset_get("sfx_absa_uair"));
...
set_hitbox_value(AT_FSTRONG, 9, HG_HITBOX_X, 152);
...
set_hitbox_value(AT_FSTRONG, 9, HG_VISUAL_EFFECT, 20);
set_hitbox_value(AT_FSTRONG, 9, HG_VISUAL_EFFECT_X_OFFSET, 15);
set_hitbox_value(AT_FSTRONG, 9, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_FSTRONG, 9, HG_HIT_SFX, asset_get("sfx_absa_uair"));
set_hitbox_value(AT_FSTRONG, 9, HG_TECHABLE, 1);

set_hitbox_value(AT_FSTRONG, 12, HG_PARENT_HITBOX, 12);
set_hitbox_value(AT_FSTRONG, 12, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_FSTRONG, 12, HG_WINDOW, 6);
set_hitbox_value(AT_FSTRONG, 12, HG_WINDOW_CREATION_FRAME, 0);
set_hitbox_value(AT_FSTRONG, 12, HG_LIFETIME, 3);
set_hitbox_value(AT_FSTRONG, 12, HG_HITBOX_X, 182);
set_hitbox_value(AT_FSTRONG, 12, HG_HITBOX_Y, -43);
set_hitbox_value(AT_FSTRONG, 12, HG_WIDTH, 25);
set_hitbox_value(AT_FSTRONG, 12, HG_HEIGHT, 20);
set_hitbox_value(AT_FSTRONG, 12, HG_PRIORITY, 8 );
set_hitbox_value(AT_FSTRONG, 12, HG_DAMAGE, 6);
set_hitbox_value(AT_FSTRONG, 12, HG_ANGLE, 135);
set_hitbox_value(AT_FSTRONG, 12, HG_BASE_KNOCKBACK, 11);
set_hitbox_value(AT_FSTRONG, 12, HG_KNOCKBACK_SCALING, 0);
set_hitbox_value(AT_FSTRONG, 12, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_FSTRONG, 12, HG_HITPAUSE_SCALING, 1.0);
set_hitbox_value(AT_FSTRONG, 12, HG_EXTRA_HITPAUSE, 20);
set_hitbox_value(AT_FSTRONG, 12, HG_VISUAL_EFFECT, 20);
set_hitbox_value(AT_FSTRONG, 12, HG_VISUAL_EFFECT_X_OFFSET, 15);
set_hitbox_value(AT_FSTRONG, 12, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_FSTRONG, 12, HG_TECHABLE, 1);
set_hitbox_value(AT_FSTRONG, 12, HG_HIT_SFX, asset_get("sfx_absa_uair"));