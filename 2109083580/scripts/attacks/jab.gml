...
set_window_value(AT_JAB, 7, AG_WINDOW_SFX, sound_get("sfx_jab_bite"))
...
set_window_value(AT_JAB, 10,AG_WINDOW_ANIM_FRAME_START, 0);
...
set_hitbox_value(AT_JAB, 2, HG_FORCE_FLINCH, 1); //i added this to make tilts link more reliably
...
set_hitbox_value(AT_JAB, 3, HG_ANGLE, 361); //i had to remove the spike angle to make the jab2->jab3 confirm techable
...
set_hitbox_value(AT_JAB, 4, HG_HITBOX_X, 67);
...
set_hitbox_value(AT_JAB, 4, HG_KNOCKBACK_SCALING, .5); //increased slightly because the jab finisher right now is kind of very weak. i feel it could even be stronger
...
set_hitbox_value(AT_JAB, 4, HG_HIT_SFX, sound_get("Jab_3_p2"));
