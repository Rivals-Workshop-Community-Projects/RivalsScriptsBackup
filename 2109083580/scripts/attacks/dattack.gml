...
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 3.1);
...
set_window_value(AT_DATTACK, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.95);
...
set_hitbox_value(AT_DATTACK, 1, HG_BASE_HITPAUSE, 18);
