...
set_window_value(AT_FTILT, 1, AG_WINDOW_HAS_SFX, true);
...
set_hitbox_value(AT_FTILT, 1, HG_SDI_MULTIPLIER, 1.4);
set_hitbox_value(AT_FTILT, 1, HG_DRIFT_MULTIPLIER, 1.4);
