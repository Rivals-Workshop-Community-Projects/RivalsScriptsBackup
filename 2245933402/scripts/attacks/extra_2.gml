...
set_window_value(AT_EXTRA_2, 1, AG_WINDOW_LENGTH, 50);
...
set_window_value(AT_EXTRA_2, 2, AG_WINDOW_SFX, asset_get( "sfx_diamond_collect" ));
...
set_window_value(AT_EXTRA_2, 4, AG_WINDOW_LENGTH, 25);
