...
set_window_value(AT_JAB, 1, AG_WINDOW_LENGTH, 2); //6
set_window_value(AT_JAB, 1, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_JAB, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, sound_get("smooch"));

set_window_value(AT_JAB, 2, AG_WINDOW_TYPE, 1);
set_window_value(AT_JAB, 2, AG_WINDOW_LENGTH, 9);
set_window_value(AT_JAB, 2, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_JAB, 2, AG_WINDOW_ANIM_FRAME_START, 1);
// set_window_value(AT_JAB, 2, AG_WINDOW_HSPEED, 30);
...
// set_window_value(AT_JAB, 3, AG_WINDOW_HSPEED, -20);
...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, asset_get("sfx_absa_cloud_place"));
