...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_LENGTH, 4); // 4
...
set_hitbox_value(AT_DSTRONG, 1, HG_LIFETIME, 300);
set_hitbox_value(AT_DSTRONG, 1, HG_PROJECTILE_ANIM_SPEED, 0.2);
set_hitbox_value(AT_DSTRONG, 1, HG_PROJECTILE_IS_TRANSCENDENT, 1);
// set_hitbox_value(AT_DSTRONG, 1, HG_PROJECTILE_GRAVITY, 0.2);
set_hitbox_value(AT_DSTRONG, 1, HG_PROJECTILE_GROUND_BEHAVIOR, 0);
set_hitbox_value(AT_DSTRONG, 1, HG_PROJECTILE_VSPEED, 2);
set_hitbox_value(AT_DSTRONG, 1, HG_PROJECTILE_MASK, -1);
// set_hitbox_value(AT_DSTRONG, 1, HG_PROJECTILE_VSPEED, -3);
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_X, 112);
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_Y, -400);
