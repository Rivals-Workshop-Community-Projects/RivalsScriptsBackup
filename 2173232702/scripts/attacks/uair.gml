...
set_hitbox_value(AT_UAIR, 1, HG_ANGLE, 115);
...
set_hitbox_value(AT_UAIR, 1, HG_HITSTUN_MULTIPLIER, 1.5);
// set_hitbox_value(AT_UAIR, 1, HG_HITPAUSE_SCALING, .35);
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, asset_get("sfx_ori_energyhit_weak"));
...
set_hitbox_value(AT_UAIR, 2, HG_HITBOX_Y, -89);
...
set_hitbox_value(AT_UAIR, 2, HG_ANGLE, 130);
...
set_hitbox_value(AT_UAIR, 2, HG_HITSTUN_MULTIPLIER, 2);
// set_hitbox_value(AT_UAIR, 2, HG_HITPAUSE_SCALING, .35);
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, -16);
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, asset_get("sfx_ori_spirit_flame_1"));
...
set_hitbox_value(AT_UAIR, 3, HG_HEIGHT, 32);
...
set_hitbox_value(AT_UAIR, 3, HG_HIT_SFX, asset_get("sfx_ori_spirit_flame_2"));