...
set_window_value(AT_DATTACK, 1, AG_WINDOW_HSPEED, 0.1);
set_window_value(AT_DATTACK, 1, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_DATTACK, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, asset_get("sfx_land_light"));

set_window_value(AT_DATTACK, 2, AG_WINDOW_TYPE, 1);
set_window_value(AT_DATTACK, 2, AG_WINDOW_LENGTH, 32);
...
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX, asset_get("sfx_land_heavy"));
