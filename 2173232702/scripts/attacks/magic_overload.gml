set_attack_value(AT_TAUNT_2, AG_SPRITE, sprite_get("overflow"));
...
// set_window_value(AT_TAUNT_2, 1, AG_WINDOW_SFX, sound_get("happy"));
// set_window_value(AT_TAUNT_2, 1, AG_WINDOW_SFX_FRAME, 19);
// set_window_value(AT_TAUNT_2, 1, AG_STRONG_CHARGE_WINDOW, 1);
