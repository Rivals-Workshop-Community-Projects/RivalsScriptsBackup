...
set_window_value(AT_UTILT, 1, AG_WINDOW_LENGTH, 3);	// he NEEDS it
...
set_hitbox_value(AT_UTILT, 1, HG_MUNO_HITBOX_NAME, "Scoop Hit");
...
set_hitbox_value(AT_UTILT, 2, HG_MUNO_HITBOX_NAME, "Clean Hit");
