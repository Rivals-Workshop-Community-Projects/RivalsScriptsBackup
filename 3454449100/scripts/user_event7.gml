...
add_skin("racer",true);
add_skin("racer_shell",true);

add_skin("kooper",true);
add_skin("kooper_shell",true);

add_skin("koops",true);
add_skin("koops_shell",true);
...
if (carryingShell){
	if (curr_alt_costume != 0){
		if (curr_alt_costume == 1){
			set_skin("racer_shell");
		} else if (curr_alt_costume == 2){
			set_skin("kooper_shell");
		} else if (curr_alt_costume == 3){
			set_skin("koops_shell");
		}
	} else {
		set_skin("shell");
	}
