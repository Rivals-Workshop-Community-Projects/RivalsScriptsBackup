...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, asset_get("sfx_blow_weak1"));
...
set_hitbox_value(AT_FTILT, 1, HG_HEIGHT, 37);
...
set_hitbox_value(AT_FTILT, 2, HG_HITBOX_X, 21);
set_hitbox_value(AT_FTILT, 2, HG_HITBOX_Y, -1);
...
set_hitbox_value(AT_FTILT, 2, HG_ANGLE, 290);
...
set_hitbox_value(AT_FTILT, 2, HG_HITPAUSE_SCALING, .95);
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT_Y_OFFSET, 15);
...
set_hitbox_value(AT_FTILT, 2, HG_GROUNDEDNESS, 2);