...
set_hitbox_value(AT_NSPECIAL, 2, HG_HITBOX_X, 12);
set_hitbox_value(AT_NSPECIAL, 2, HG_HITBOX_Y, -6);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_HITBOX_Y, -6);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_PROJECTILE_MASK, sprite_get("box_hitbox_mask"));
