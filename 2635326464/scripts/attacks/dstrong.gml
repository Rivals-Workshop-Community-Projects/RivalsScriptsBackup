...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("SuperHorn"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_MUNO_HITBOX_NAME, "Box shockwave");

set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_DSTRONG, 1, HG_WINDOW, 3);
set_hitbox_value(AT_DSTRONG, 1, HG_LIFETIME, 14);
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_Y, -61);
...
set_hitbox_value(AT_DSTRONG, 2, HG_MUNO_HITBOX_NAME, "Ground shockwave");
...
set_hitbox_value(AT_DSTRONG, 2, HG_WIDTH, 174);
...
set_attack_value(AT_DSTRONG, AG_MUNO_ATTACK_ENDLAG, string(get_window_value(AT_USPECIAL, 4, AG_WINDOW_LENGTH)));