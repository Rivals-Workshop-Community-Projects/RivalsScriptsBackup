...
set_hitbox_value(AT_FTILT, 1, HG_HITBOX_X, 82);
...
set_attack_value(AT_FTILT, AG_MUNO_ATTACK_MISC_ADD, "Reduces the opponent's speed by half for 3 seconds. Has 45 frames of cooldown.");
