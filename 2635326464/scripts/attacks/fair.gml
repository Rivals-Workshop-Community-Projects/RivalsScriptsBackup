...
set_hitbox_value(AT_FAIR, 8, HG_KNOCKBACK_SCALING, 1);
...
set_attack_value(AT_FAIR, AG_MUNO_ATTACK_MISC_ADD, "There's 22 frames of landing lag, but this gets reduced to 8 on hit. Has 5 frames of cooldown.");