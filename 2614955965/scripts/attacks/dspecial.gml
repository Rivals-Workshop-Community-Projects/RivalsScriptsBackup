...
set_hitbox_value(AT_DSPECIAL, 1, HG_HITSTUN_MULTIPLIER, 4.5);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_ANGLE, 41);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HIT_SFX, sound_get("slash1"));
