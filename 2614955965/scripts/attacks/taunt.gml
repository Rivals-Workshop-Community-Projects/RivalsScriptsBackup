...
set_window_value(AT_TAUNT, 2, AG_WINDOW_SFX, sound_get("shuffle"));
...
set_window_value(AT_TAUNT, 4, AG_WINDOW_LENGTH, 11);
...
set_window_value(AT_TAUNT, 4, AG_WINDOW_SFX, sound_get("shuffle"));
