...
set_window_value(AT_UTILT, 5, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy2"));

set_window_value(AT_UTILT, 6, AG_WINDOW_TYPE, 1);
set_window_value(AT_UTILT, 6, AG_WINDOW_LENGTH, 11);
...
set_hitbox_value(AT_UTILT, 2, HG_KNOCKBACK_SCALING, 0.1);
...
//set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, sound_get("SMASH"));