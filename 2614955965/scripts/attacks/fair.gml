...
set_window_value(AT_FAIR, 4, AG_WINDOW_HAS_WHIFFLAG, 3);
...
set_hitbox_value(AT_FAIR, 1, HG_HITBOX_Y, -43);
...
set_hitbox_value(AT_FAIR, 1, HG_ANGLE, 46);
...
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, sound_get("slash2"));
