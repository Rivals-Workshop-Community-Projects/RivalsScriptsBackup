...
set_window_value(AT_FSPECIAL, 6, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy2"));
...
set_window_value(AT_FSPECIAL, 8, AG_WINDOW_ANIM_FRAME_START, 16);
...
set_window_value(AT_FSPECIAL, 10, AG_WINDOW_ANIM_FRAME_START, 19);
set_window_value(AT_FSPECIAL, 10, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FSPECIAL, 10, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy2"));
set_window_value(AT_FSPECIAL, 10, AG_WINDOW_SFX_FRAME, 2);
...
set_window_value(AT_FSPECIAL, 12, AG_WINDOW_LENGTH, 5);
set_window_value(AT_FSPECIAL, 12, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_FSPECIAL, 12, AG_WINDOW_ANIM_FRAME_START, 23);
...
set_window_value(AT_FSPECIAL, 13, AG_WINDOW_ANIM_FRAME_START, 25);

set_window_value(AT_FSPECIAL, 14, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL, 14, AG_WINDOW_LENGTH, 12);
set_window_value(AT_FSPECIAL, 14, AG_WINDOW_ANIM_FRAMES, 6);
set_window_value(AT_FSPECIAL, 14, AG_WINDOW_ANIM_FRAME_START, 26);
set_window_value(AT_FSPECIAL, 14, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_FSPECIAL, 14, AG_WINDOW_HSPEED, 1);
set_window_value(AT_FSPECIAL, 14, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_FSPECIAL, 14, AG_WINDOW_CUSTOM_GROUND_FRICTION, 6);
set_window_value(AT_FSPECIAL, 14, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FSPECIAL, 14, AG_WINDOW_SFX, asset_get("sfx_swipe_medium2"));
set_window_value(AT_FSPECIAL, 14, AG_WINDOW_SFX_FRAME, 0);
//set_window_value(AT_FSPECIAL, 11, AG_WINDOW_VSPEED_TYPE, 0);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_X, 69);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_ANGLE, 41);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, sound_get("slash2"));
...
set_hitbox_value(AT_FSPECIAL, 2, HG_ANGLE, 59);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, sound_get("slash2"));
...
set_hitbox_value(AT_FSPECIAL, 3, HG_HITBOX_X, 79);
set_hitbox_value(AT_FSPECIAL, 3, HG_HITBOX_Y, -70);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_ANGLE, 59);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_HIT_SFX, sound_get("slash2"));
...
set_hitbox_value(AT_FSPECIAL, 4, HG_HITBOX_X, 39);
...
set_hitbox_value(AT_FSPECIAL, 4, HG_ANGLE, 86);
...
set_hitbox_value(AT_FSPECIAL, 4, HG_HIT_SFX, sound_get("slash2"));
...
set_hitbox_value(AT_FSPECIAL, 5, HG_HITBOX_X, 79);
set_hitbox_value(AT_FSPECIAL, 5, HG_HITBOX_Y, -3);
...
set_hitbox_value(AT_FSPECIAL, 5, HG_ANGLE, 86);
set_hitbox_value(AT_FSPECIAL, 5, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_FSPECIAL, 5, HG_KNOCKBACK_SCALING, .1);
set_hitbox_value(AT_FSPECIAL, 5, HG_EFFECT, 6);
set_hitbox_value(AT_FSPECIAL, 5, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_FSPECIAL, 5, HG_HIT_SFX, sound_get("slash2"));
