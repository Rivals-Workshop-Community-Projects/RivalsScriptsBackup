...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sfx_spellcast);
...
set_window_value(AT_FSTRONG, 5, AG_WINDOW_SFX, sfx_fstrong_end);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_X, 115);
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_Y, -41);
set_hitbox_value(AT_FSTRONG, 1, HG_WIDTH, 67);
...
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, 26);
...
set_hitbox_value(AT_FSTRONG, 3, HG_HITBOX_Y, -41);
...
set_hitbox_value(AT_FSTRONG, 4, HG_HITBOX_X, 115);
...
set_hitbox_value(AT_FSTRONG, 5, HG_HITBOX_X, 115);
set_hitbox_value(AT_FSTRONG, 5, HG_HITBOX_Y, -41);
...
set_hitbox_value(AT_FSTRONG, 5, HG_VISUAL_EFFECT, 158);
...
set_hitbox_value(AT_FSTRONG, 5, HG_IGNORES_PROJECTILES, 0);
