...
set_hitbox_value(AT_FSTRONG, 3, HG_ANGLE, 361);//55
set_hitbox_value(AT_FSTRONG, 3, HG_BASE_KNOCKBACK, 7);//6
set_hitbox_value(AT_FSTRONG, 3, HG_KNOCKBACK_SCALING, 1.05);//.95
set_hitbox_value(AT_FSTRONG, 3, HG_BASE_HITPAUSE, 12);//5
set_hitbox_value(AT_FSTRONG, 3, HG_HITPAUSE_SCALING, 1.0);
set_hitbox_value(AT_FSTRONG, 3, HG_HIT_SFX, sound_get("sfx_kris_hit_strong"));
