...
set_hitbox_value(AT_JAB, 2, HG_HITBOX_X, 51);
set_hitbox_value(AT_JAB, 2, HG_HITBOX_Y, -48);
set_hitbox_value(AT_JAB, 2, HG_WIDTH, 60);
set_hitbox_value(AT_JAB, 2, HG_HEIGHT, 71);
set_hitbox_value(AT_JAB, 2, HG_PRIORITY, 2);
set_hitbox_value(AT_JAB, 2, HG_DAMAGE, 5);
set_hitbox_value(AT_JAB, 2, HG_ANGLE, 55);
set_hitbox_value(AT_JAB, 2, HG_BASE_KNOCKBACK, 7);//4
set_hitbox_value(AT_JAB, 2, HG_KNOCKBACK_SCALING, .45);//.85
