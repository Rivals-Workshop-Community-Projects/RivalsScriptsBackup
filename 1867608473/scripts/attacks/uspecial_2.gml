...
set_attack_value(AT_USPECIAL_2, AG_SPRITE, sprite_get("uspecial2_ground"));
set_attack_value(AT_USPECIAL_2, AG_NUM_WINDOWS, 3);
set_attack_value(AT_USPECIAL_2, AG_HAS_LANDING_LAG, 9);
set_attack_value(AT_USPECIAL_2, AG_OFF_LEDGE, 1);
set_attack_value(AT_USPECIAL_2, AG_AIR_SPRITE, sprite_get("uspecial2"));
set_attack_value(AT_USPECIAL_2, AG_HURTBOX_SPRITE, sprite_get("uspecial2_ground_hurt"));
...
set_window_value(AT_USPECIAL_2, 1, AG_WINDOW_SFX, sound_get("sfx_kris_ping"));
...
set_window_value(AT_USPECIAL_2, 2, AG_WINDOW_INVINCIBILITY, 2);
