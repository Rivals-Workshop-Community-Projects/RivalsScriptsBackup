...
make_window(AT_USPECIAL, 3,
    ...
    AG_WINDOW_ANIM_FRAME_START, 3,
    AG_WINDOW_HAS_SFX, 1,
    AG_WINDOW_SFX, sound_get("sfx_rudebuster")
    //AG_WINDOW_HSPEED_TYPE, 1,
    //AG_WINDOW_VSPEED_TYPE, 1
)
...
make_hitbox(AT_USPECIAL, 1,
    ...
    HG_HIT_SFX, sound_get("hmed"),
    HG_ANGLE_FLIPPER, 10,
    HG_SDI_MULTIPLIER, .02,
    HG_HITBOX_GROUP, 1
)
// Spawned manually, Sweet
