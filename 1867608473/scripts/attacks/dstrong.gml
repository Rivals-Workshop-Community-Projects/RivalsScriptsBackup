...
set_window_value(AT_DSTRONG, 8, AG_WINDOW_LENGTH, 16);//22, makes this animation look really janky theres probably a better way to do this
...
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_X, -23);
...
set_hitbox_value(AT_DSTRONG, 3, HG_WIDTH, 49);
set_hitbox_value(AT_DSTRONG, 3, HG_HEIGHT, 69); //nice
...
set_hitbox_value(AT_DSTRONG, 3, HG_ANGLE, 45);//60
set_hitbox_value(AT_DSTRONG, 3, HG_BASE_KNOCKBACK, 7);//5
set_hitbox_value(AT_DSTRONG, 3, HG_KNOCKBACK_SCALING, .9);//1.2
set_hitbox_value(AT_DSTRONG, 3, HG_BASE_HITPAUSE, 10);//6
set_hitbox_value(AT_DSTRONG, 3, HG_HITPAUSE_SCALING, 1);//.95
