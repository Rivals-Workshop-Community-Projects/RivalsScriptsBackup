...
//hitbox 2 (overhead & in front), new hitbox added and you can rename this to whatever
...
set_hitbox_value(AT_UTILT, 3, HG_ANGLE, 80); //90
set_hitbox_value(AT_UTILT, 3, HG_BASE_KNOCKBACK, 8);//6
set_hitbox_value(AT_UTILT, 3, HG_KNOCKBACK_SCALING, .5);//.92
...
set_hitbox_value(AT_UTILT, 3, HG_HIT_SFX, asset_get("sfx_blow_medium3"));//sfx_blow_weak2
set_hitbox_value(AT_UTILT, 3, HG_ANGLE_FLIPPER, 0);//4
...
set_hitbox_value(AT_UTILT, 4, HG_HITBOX_X, -38);
set_hitbox_value(AT_UTILT, 4, HG_HITBOX_Y, -65);
set_hitbox_value(AT_UTILT, 4, HG_WIDTH, 60);
set_hitbox_value(AT_UTILT, 4, HG_HEIGHT, 96);
set_hitbox_value(AT_UTILT, 4, HG_PRIORITY, 2);
set_hitbox_value(AT_UTILT, 4, HG_DAMAGE, 5);//7
set_hitbox_value(AT_UTILT, 4, HG_ANGLE, 95);
set_hitbox_value(AT_UTILT, 4, HG_BASE_KNOCKBACK, 6);//5
set_hitbox_value(AT_UTILT, 4, HG_KNOCKBACK_SCALING, .4);//.88
set_hitbox_value(AT_UTILT, 4, HG_BASE_HITPAUSE, 7);//8
