...
set_window_value(AT_TAUNT, 1, AG_WINDOW_LENGTH, 49);
set_window_value(AT_TAUNT, 1, AG_WINDOW_ANIM_FRAMES, 8);
set_window_value(AT_TAUNT, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX, sound_get("sfx_lancerlaugh"));
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX_FRAME, 18);

set_window_value(AT_TAUNT, 2, AG_WINDOW_TYPE, 2);
set_window_value(AT_TAUNT, 2, AG_WINDOW_LENGTH, 46);
...
set_window_value(AT_TAUNT, 3, AG_WINDOW_ANIM_FRAME_START, 25);
...
set_hitbox_value(AT_TAUNT, 1, HG_WINDOW_CREATION_FRAME, 13);
set_hitbox_value(AT_TAUNT, 1, HG_LIFETIME, 3);
set_hitbox_value(AT_TAUNT, 1, HG_HITBOX_X, 38);
set_hitbox_value(AT_TAUNT, 1, HG_HITBOX_Y, -8);
set_hitbox_value(AT_TAUNT, 1, HG_WIDTH, 71);
set_hitbox_value(AT_TAUNT, 1, HG_HEIGHT, 29);
...
set_hitbox_value(AT_TAUNT, 1, HG_KNOCKBACK_SCALING, .6);
set_hitbox_value(AT_TAUNT, 1, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_TAUNT, 1, HG_HITPAUSE_SCALING, .55);
set_hitbox_value(AT_TAUNT, 1, HG_VISUAL_EFFECT_X_OFFSET, 30);
