set_attack_value(AT_PHONE, AG_SPRITE, sprite_get("taunt2"));
...
set_window_value(AT_PHONE, 2, AG_WINDOW_ANIM_FRAMES, 7);
...
set_window_value(AT_PHONE, 3, AG_WINDOW_ANIM_FRAME_START, 11);