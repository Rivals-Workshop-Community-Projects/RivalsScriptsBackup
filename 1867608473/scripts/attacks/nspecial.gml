...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("sfx_jevil_he"));
...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, sound_get("sfx_jevil_ha"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_LIFETIME, 9999); // Don't bother tweaking
