...
set_hitbox_value(AT_DTILT, 1, HG_BASE_KNOCKBACK, 7);//6.25
set_hitbox_value(AT_DTILT, 1, HG_KNOCKBACK_SCALING, .35);//.5
...
/*set_hitbox_value(AT_DTILT, 2, HG_PARENT_HITBOX, 2); disabled for consistency
...
set_hitbox_value(AT_DTILT, 2, HG_WIDTH, 37);
...
set_hitbox_value(AT_DTILT, 2, HG_ANGLE, 84);
