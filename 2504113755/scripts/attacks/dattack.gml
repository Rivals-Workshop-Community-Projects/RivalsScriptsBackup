...
set_hitbox_value(AT_DATTACK, 2, HG_HITBOX_X, 65);
...
set_hitbox_value(AT_DATTACK, 3, HG_HITBOX_X, 65);
...
set_hitbox_value(AT_DATTACK, 5, HG_HITBOX_X, 65);
...
set_hitbox_value(AT_DATTACK, 6, HG_HITBOX_X, 60);
set_hitbox_value(AT_DATTACK, 6, HG_HITBOX_Y, -35);
set_hitbox_value(AT_DATTACK, 6, HG_WIDTH, 110);
