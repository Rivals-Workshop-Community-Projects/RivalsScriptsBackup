...
set_hitbox_value(AT_DATTACK, 5, HG_HIT_SFX, asset_get("sfx_clairen_hit_med"));
set_hitbox_value(AT_DATTACK, 5, HG_HIT_LOCKOUT, 5);
set_hitbox_value(AT_DATTACK, 5, HG_HITBOX_GROUP, 5);
set_hitbox_value(AT_DATTACK, 5, HG_HIT_PARTICLE_NUM, 1)
set_hitbox_value(AT_DATTACK, 5, HG_VISUAL_EFFECT, plasma_x_circle_small );
