...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_clairen_uspecial_swing"));
...
set_hitbox_value(AT_USPECIAL, 2, HG_VISUAL_EFFECT, plasma_x_big);