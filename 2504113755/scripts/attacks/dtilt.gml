...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, asset_get("sfx_clairen_poke_weak"));
...
set_hitbox_value(AT_DTILT, 1, HG_HITBOX_X, 73);
...
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, asset_get("sfx_clairen_hit_weak"));
set_hitbox_value(AT_DTILT, 1, HG_HIT_PARTICLE_NUM, 1)
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT, plasma_t_small );