...
//endlag
set_window_value(AT_FSPECIAL, 13, AG_WINDOW_LENGTH, 30);
...
set_window_value(AT_FSPECIAL, 13, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.2);
...
set_window_value(AT_FSPECIAL, 15, AG_WINDOW_CUSTOM_GRAVITY, 0.4);
