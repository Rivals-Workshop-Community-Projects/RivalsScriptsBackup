...
set_window_value(AT_NSPECIAL, 1, AG_MUNO_WINDOW_EXCLUDE, 1);





set_attack_value(AT_NSPECIAL, AG_MUNO_ATTACK_MISC_ADD, (string(blink_start_frame) +" frames startup, 7 frames teleporting. No invulnerability."));