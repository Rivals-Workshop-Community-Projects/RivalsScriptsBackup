...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, asset_get("sfx_clairen_poke_weak"));
...
set_window_value(AT_UTILT, 3, AG_WINDOW_SFX, asset_get("sfx_clairen_poke_med"));
set_window_value(AT_UTILT, 3, AG_WINDOW_SFX_FRAME, 7);
...
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, plasma_x_circle_small );
...
set_hitbox_value(AT_UTILT, 2, HG_HEIGHT, 85);
...
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, plasma_x_circle_big );
