...
//spike fall
set_window_value(AT_NAIR, 6, AG_WINDOW_LENGTH, 30);
...
//land lag
set_window_value(AT_NAIR, 8, AG_WINDOW_LENGTH, 14);
...
set_hitbox_value(AT_NAIR, 4, HG_HITBOX_X, 27);
...
set_hitbox_value(AT_NAIR, 5, HG_HITBOX_Y, -5);
...
set_hitbox_value(AT_NAIR, 6, HG_HITBOX_X, 45);
...
set_hitbox_value(AT_NAIR, 7, HG_LIFETIME, 30);
set_hitbox_value(AT_NAIR, 7, HG_HITBOX_X, 45);
...
set_hitbox_value(AT_NAIR, 7, HG_KNOCKBACK_SCALING, .6);
...
set_hitbox_value(AT_NAIR, 8, HG_HITBOX_X, 55);
