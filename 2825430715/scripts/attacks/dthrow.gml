set_attack_value(AT_NSPECIAL_2, AG_SPRITE, sprite_get("uair"));
set_attack_value(AT_NSPECIAL_2, AG_NUM_WINDOWS, 3);
set_attack_value(AT_NSPECIAL_2, AG_CATEGORY, 2);
set_attack_value(AT_NSPECIAL_2, AG_OFF_LEDGE, 0);
set_attack_value(AT_NSPECIAL_2, AG_HURTBOX_SPRITE, sprite_get("uair_hurt"));
...
set_window_value(AT_NSPECIAL_2, 1, AG_WINDOW_ANIM_FRAME_START, 12);
...
set_hitbox_value(AT_NSPECIAL_2, 1, HG_WIDTH, 104);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HEIGHT, 104);
...
set_hitbox_value(AT_NSPECIAL_2, 2, HG_WIDTH, 104);
set_hitbox_value(AT_NSPECIAL_2, 2, HG_HEIGHT, 104);
...
set_hitbox_value(AT_NSPECIAL_2, 3, HG_WIDTH, 104);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_HEIGHT, 104);
...
set_hitbox_value(AT_NSPECIAL_2, 3, HG_ANGLE, 130);
...
set_hitbox_value(AT_NSPECIAL_2, 3, HG_EXTRA_HITPAUSE, 0);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_HITPAUSE_SCALING, 0);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_VISUAL_EFFECT_Y_OFFSET, 0);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_HITSTUN_MULTIPLIER, 1);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_VISUAL_EFFECT, 1);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_EXTRA_CAMERA_SHAKE, -1);