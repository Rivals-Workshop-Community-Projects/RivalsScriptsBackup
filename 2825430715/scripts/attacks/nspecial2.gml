...
set_attack_value(AT_FSPECIAL_2, AG_SPRITE, sprite_get("potbuster"));
...
set_attack_value(AT_FSPECIAL_2, AG_HURTBOX_SPRITE, sprite_get("empty"));

set_window_value(AT_FSPECIAL_2, 1, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL_2, 1, AG_WINDOW_LENGTH, 13*5);
set_window_value(AT_FSPECIAL_2, 1, AG_WINDOW_ANIM_FRAMES, 13);
...
set_window_value(AT_FSPECIAL_2, 3, AG_WINDOW_LENGTH, 7*5);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_WIDTH, 114);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_DAMAGE, 14);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HITPAUSE_SCALING, 1.15);
...
set_hitbox_value(AT_FSPECIAL_2, 3, HG_WIDTH, 200);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HEIGHT, 200);
...
set_hitbox_value(AT_FSPECIAL_2, 3, HG_EXTRA_HITPAUSE, 60);
