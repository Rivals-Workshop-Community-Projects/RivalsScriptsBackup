...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("ska_attack"));
...
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sound_get("ska_hit"));
...
set_hitbox_value(AT_UTILT, 2, HG_HITBOX_X, 54);
