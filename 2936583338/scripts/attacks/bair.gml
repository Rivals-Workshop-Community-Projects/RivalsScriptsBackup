...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("ska_attack"));
...
set_hitbox_value(AT_BAIR, 1, HG_LIFETIME, 18);
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_X, 72);
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("ska_hit"));
