...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, sound_get("ska_attack"));
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, sound_get("ska_bighit"));
...
set_hitbox_value(AT_FTILT, 2, HG_HITBOX_Y, -68);
...
set_hitbox_value(AT_FTILT, 2, HG_ANGLE, 110);
...
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, sound_get("ska_hit"));
