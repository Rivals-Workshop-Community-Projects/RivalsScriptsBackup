...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, sound_get("ska_attack"));
...
set_window_value(AT_DTILT, 3, AG_WINDOW_ANIM_FRAMES, 17);
...
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, sound_get("ska_hit"));
