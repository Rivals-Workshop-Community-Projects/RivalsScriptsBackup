...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX, sound_get("clover_dspecial"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HITBOX_Y, 82);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_KNOCKBACK_SCALING, 1.00);
