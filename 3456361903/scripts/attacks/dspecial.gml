...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, sound_get("wonder_jump"));
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HEIGHT, 56);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HEIGHT, 88);
