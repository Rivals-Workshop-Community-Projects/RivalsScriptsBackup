...
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_X, 109);
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_Y, -32);
set_hitbox_value(AT_FSPECIAL, 1, HG_WIDTH, 91);
set_hitbox_value(AT_FSPECIAL, 1, HG_HEIGHT, 83);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_KNOCKBACK_SCALING, .125);
set_hitbox_value(AT_FSPECIAL, 1, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_FSPECIAL, 1, HG_HITPAUSE_SCALING, .4);
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT_X_OFFSET, 8);
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT_Y_OFFSET, 8);
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT, fx_smallhit2 );
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, sound_get("eggcrack"));