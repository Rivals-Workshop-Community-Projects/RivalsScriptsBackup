...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_syl_ustrong_part3"));
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_bite"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, fx_smallhit2);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("bhit_medium_3"));
