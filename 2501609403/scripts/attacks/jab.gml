...
set_window_value(AT_JAB, 2, AG_WINDOW_SFX, asset_get("sfx_bite"));
...
set_hitbox_value(AT_JAB, 1, HG_WIDTH, 43);
...
set_hitbox_value(AT_JAB, 1, HG_VISUAL_EFFECT, fx_smallhit2 );
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, asset_get("sfx_blow_medium3"));
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("bhit_medium_1"));
