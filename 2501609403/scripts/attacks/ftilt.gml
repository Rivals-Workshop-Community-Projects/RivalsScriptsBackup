...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, asset_get("sfx_may_whip2"));
...
set_hitbox_value(AT_FTILT, 1, HG_HITBOX_X, 61);
...
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT, fx_smallhit2 );
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, asset_get("sfx_blow_medium3"));
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, sound_get("bhit_medium_2"));
