...
set_attack_value(AT_TAUNT_2, AG_HURTBOX_SPRITE, sprite_get("taunt2"));
...
set_window_value(AT_TAUNT_2, 2, AG_WINDOW_LENGTH, 37);
...
set_window_value(AT_TAUNT_2, 3, AG_WINDOW_LENGTH, 37);
