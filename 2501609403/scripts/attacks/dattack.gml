...
set_window_value(AT_DATTACK, 3, AG_WINDOW_SFX, asset_get("sfx_syl_ustrong_part3"));
...
set_hitbox_value(AT_DATTACK, 1, HG_HITBOX_X, 88);
...
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT, fx_smallhit2);
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, asset_get("sfx_blow_medium3"));
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, sound_get("bhit_medium_2"));

//Sourspot
set_hitbox_value(AT_DATTACK, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_DATTACK, 2, HG_WINDOW, 2);
set_hitbox_value(AT_DATTACK, 2, HG_LIFETIME, 4);
set_hitbox_value(AT_DATTACK, 2, HG_HITBOX_X, 48);
set_hitbox_value(AT_DATTACK, 2, HG_HITBOX_Y, -33);
set_hitbox_value(AT_DATTACK, 2, HG_WIDTH, 102);
set_hitbox_value(AT_DATTACK, 2, HG_HEIGHT, 76);
...
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT, fx_smallhit1);
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, asset_get("sfx_blow_medium1"));
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, sound_get("bhit_medium_1"));