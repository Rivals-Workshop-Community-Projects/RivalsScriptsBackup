...
set_window_value(AT_UTILT, 2, AG_WINDOW_LENGTH, 11);
...
set_hitbox_value(AT_UTILT, 1, HG_HITBOX_X, 53);
...
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, fx_smallhit2 );
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, asset_get("sfx_blow_medium3"));
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sound_get("bhit_medium_2"));
...
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, fx_smallhit1 );
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, asset_get("sfx_blow_medium1"));
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, sound_get("bhit_medium_1"));
