...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, asset_get("sfx_syl_ustrong_part3"));
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX_FRAME, 0);
...
set_window_value(AT_DTILT, 4, AG_WINDOW_ANIM_FRAME_START, 11);
...
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT, fx_smallhit1);
...
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, sound_get("bhit_medium_1"));
...
set_hitbox_value(AT_DTILT, 2, HG_WIDTH, 43);
...
set_hitbox_value(AT_DTILT, 2, HG_VISUAL_EFFECT, fx_smallhit2);
...
set_hitbox_value(AT_DTILT, 2, HG_HIT_SFX, sound_get("bhit_medium_2"));