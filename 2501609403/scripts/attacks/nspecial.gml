...
set_hitbox_value(AT_NSPECIAL, 9, HG_WIDTH, 127);
set_hitbox_value(AT_NSPECIAL, 9, HG_HEIGHT, 87);
set_hitbox_value(AT_NSPECIAL, 9, HG_PRIORITY, 6);
set_hitbox_value(AT_NSPECIAL, 9, HG_DAMAGE, 10);
set_hitbox_value(AT_NSPECIAL, 9, HG_ANGLE, 361);
set_hitbox_value(AT_NSPECIAL, 9, HG_ANGLE_FLIPPER, 4);
