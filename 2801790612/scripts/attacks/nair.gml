...
set_window_value(AT_NAIR, 2, AG_WINDOW_LENGTH, 27);
...
set_hitbox_value(AT_NAIR, 1, HG_MUNO_HITBOX_NAME, "Sex Kick");

set_hitbox_value(AT_NAIR, 1, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_NAIR, 1, HG_WINDOW, 2);
set_hitbox_value(AT_NAIR, 1, HG_LIFETIME, 27);
...
set_hitbox_value(AT_NAIR, 2, HG_LIFETIME, 27);
