...
set_window_value(AT_BAIR, 1, AG_WINDOW_HSPEED, -5);
...
set_hitbox_value(AT_BAIR, 1, HG_ANGLE, 180); // maybe 135?
set_hitbox_value(AT_BAIR, 1, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_BAIR, 1, HG_KNOCKBACK_SCALING, .12);
...
set_hitbox_value(AT_BAIR, 2, HG_ANGLE, 230);
