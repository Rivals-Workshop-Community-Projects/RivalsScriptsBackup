...
set_hitbox_value(AT_USTRONG, 2, HG_PROJECTILE_SPRITE, spr_garbage1);
set_hitbox_value(AT_USTRONG, 2, HG_PROJECTILE_MASK, spr_garbage1);
set_hitbox_value(AT_USTRONG, 2, HG_PROJECTILE_ANIM_SPEED, 0.25);
set_hitbox_value(AT_USTRONG, 2, HG_PROJECTILE_HSPEED, 4);
set_hitbox_value(AT_USTRONG, 2, HG_PROJECTILE_VSPEED, -16);
set_hitbox_value(AT_USTRONG, 2, HG_PROJECTILE_GRAVITY, 0.5);
set_hitbox_value(AT_USTRONG, 2, HG_PROJECTILE_AIR_FRICTION, 0.05);
set_hitbox_value(AT_USTRONG, 2, HG_PROJECTILE_WALL_BEHAVIOR, 2);
set_hitbox_value(AT_USTRONG, 2, HG_PROJECTILE_GROUND_BEHAVIOR, 1);
set_hitbox_value(AT_USTRONG, 2, HG_PROJECTILE_ENEMY_BEHAVIOR, 0);
set_hitbox_value(AT_USTRONG, 2, HG_PROJECTILE_IS_TRANSCENDENT, false);
set_hitbox_value(AT_USTRONG, 2, HG_PROJECTILE_DESTROY_EFFECT, 145);
set_hitbox_value(AT_USTRONG, 2, HG_IGNORES_PROJECTILES, 0);
set_hitbox_value(AT_USTRONG, 2, HG_EFFECT, 69);