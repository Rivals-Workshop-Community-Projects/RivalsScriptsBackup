...
if (!variable_instance_exists(id,"ae") || ye == true){
    ...
    col_max = 13; // number of alternate color palettes. 0 is the default color, count it accordingly.
    ...
    ce[0,1] = "Pepsi Man" // the name of the alternate color.
