...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_waterwarp_start"));
...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX, sound_get("uspec_1"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, vfx_water_small);