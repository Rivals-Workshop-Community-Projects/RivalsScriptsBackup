...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, sound_get("Double_Edge1"));
...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .04);
set_window_value(AT_DSTRONG, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("Take_Down1"));
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, 1);
set_window_value(AT_DSTRONG, 3, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, sound_get("Take_Down2"));
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_CUSTOM_GRAVITY, 0.2);
