...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("Tailwind1"));
...
set_window_value(AT_BAIR, 2, AG_WINDOW_SFX, sound_get("Tailwind2"));
...
set_window_value(AT_BAIR, 4, AG_WINDOW_SFX, asset_get("sfx_gus_propeller_dagger_wall"));
...
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, hfx_poison_sweetspot);
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, -32);
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("poison_sweetspot"));
...
set_hitbox_value(AT_BAIR, 2, HG_HITPAUSE_SCALING, .05);
