...
set_hitbox_value(AT_DAIR, 1, HG_HEIGHT, 125);
...
set_hitbox_value(AT_DAIR, 2, HG_WIDTH, 4);
...
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT, hfx_dair_sweetspot);
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, sound_get("poison_sweetspot"));