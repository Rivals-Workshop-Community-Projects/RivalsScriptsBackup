...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, sound_get("Double_Edge1"));
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX, sound_get("Double_Edge2"));
...
set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT, hfx_poison_sweetspot);
set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, sound_get("poison_sweetspot"));
...
set_hitbox_value(AT_FSTRONG, 3, HG_ANGLE, 145);
