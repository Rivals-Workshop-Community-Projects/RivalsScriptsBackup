...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, asset_get("sfx_ell_drill_stab"));
...
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT, hfx_drill_run);
...
set_hitbox_value(AT_DATTACK, 1, HG_THROWS_ROCK, 2);