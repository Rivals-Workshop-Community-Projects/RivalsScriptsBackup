...
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT, hfx_poison_sweetspot);
...
set_hitbox_value(AT_FTILT, 2, HG_EFFECT, 10);
...
set_hitbox_value(AT_FTILT, 2, HG_HITPAUSE_SCALING, .6);
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT, 118);
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, asset_get("sfx_poison_hit_med"));