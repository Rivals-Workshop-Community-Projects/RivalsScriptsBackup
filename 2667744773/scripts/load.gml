...
sprite_change_offset("hover", 64, 94);
sprite_change_offset("intro", 128, 158);
sprite_change_offset("intro1", 96, 158);
...
sprite_change_offset("parry", 64, 106);
sprite_change_offset("roll_forward", 64, 114);
sprite_change_offset("roll_backward", 64, 114);
...
sprite_change_offset("dair", 64, 106);
sprite_change_offset("fstrong", 94, 158);
sprite_change_offset("ustrong", 94, 158);
sprite_change_offset("dstrong", 94, 158);
sprite_change_offset("dstrong_air", 94, 158);
sprite_change_offset("nspecial", 96, 158);
sprite_change_offset("nspecial_air", 94, 158);
...
sprite_change_offset("taunt1", 96, 158);
sprite_change_offset("final_smah", 128, 158);


sprite_change_offset("nspecial_proj", 64, 94);
sprite_change_offset("nspecial_proj1", 64, 94);
sprite_change_offset("nspecial_air_proj", 64, 94);
sprite_change_offset("nspecial_air_proj1", 64, 94);
sprite_change_offset("Final_smash_blade", 128, 124);
sprite_change_offset("final_smah_drill1", 128, 158);
sprite_change_offset("final_smah_drill2", 64, 94);
sprite_change_offset("final_smah_drill3", 64, 94);
sprite_change_offset("final_smah_Beam", 900, 124);

sprite_change_offset("resort_painting", 27, 39);
set_victory_theme(sound_get("victory_theme"));
set_victory_bg(sprite_get("victory_screen"));
sprite_change_offset("beedrillganronpa", 34, 0);
sprite_change_offset("miiverse_post", 60, 30);
sprite_change_offset("feri_costume_beedrill", 84, 114);

sprite_change_offset("hfx_dair_sweetpot", 128, 128);
sprite_change_offset("poison_hit_sweet", 128, 128);
sprite_change_offset("hfx_x_scissor", 128, 128);
sprite_change_offset("hfx_drill_run", 128, 128);
sprite_change_offset("hfx_giga_impact", 128, 128);
