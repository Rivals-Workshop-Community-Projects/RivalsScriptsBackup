...
add_sprites("bair","dair","dattack","dspecial","dstrong","dtilt","fair","fspecial","fstrong",
            "ftilt","jab","nair","nspecial","taunt","uair","uspecial","ustrong","utilt","nspecial_air",
            "fspecial_air","uspecial_air","dspecial_air");

//=================OTHER=================
//  hurt sprites
add_sprites("hurt","bighurt","hurtground","downhurt");
