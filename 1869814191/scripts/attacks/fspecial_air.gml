...
set_attack_value(AT_FSPECIAL_AIR, AG_NUM_WINDOWS, 14);
...
set_window_value(AT_FSPECIAL_AIR, 5, AG_WINDOW_ANIM_FRAME_START, 4);

//Grabbed

set_window_value(AT_FSPECIAL_AIR, 6, AG_WINDOW_TYPE, 9);
set_window_value(AT_FSPECIAL_AIR, 6, AG_WINDOW_LENGTH, 6);
set_window_value(AT_FSPECIAL_AIR, 6, AG_WINDOW_ANIM_FRAMES, 2);
...
set_window_value(AT_FSPECIAL_AIR, 7, AG_WINDOW_ANIM_FRAMES, 5);
set_window_value(AT_FSPECIAL_AIR, 7, AG_WINDOW_ANIM_FRAME_START, 19);
...
set_window_value(AT_FSPECIAL_AIR, 8, AG_WINDOW_ANIM_FRAME_START, 14);

//Back Throw

set_window_value(AT_FSPECIAL_AIR, 9, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL_AIR, 9, AG_WINDOW_LENGTH, 20);
set_window_value(AT_FSPECIAL_AIR, 9, AG_WINDOW_ANIM_FRAMES, 5);
set_window_value(AT_FSPECIAL_AIR, 9, AG_WINDOW_ANIM_FRAME_START, 30);

//Forward Throw

set_window_value(AT_FSPECIAL_AIR, 10, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL_AIR, 10, AG_WINDOW_LENGTH, 20);
set_window_value(AT_FSPECIAL_AIR, 10, AG_WINDOW_ANIM_FRAMES, 5);
set_window_value(AT_FSPECIAL_AIR, 10, AG_WINDOW_ANIM_FRAME_START, 24);

//Endlag

set_window_value(AT_FSPECIAL_AIR, 11, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL_AIR, 11, AG_WINDOW_LENGTH, 8);
set_window_value(AT_FSPECIAL_AIR, 11, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_FSPECIAL_AIR, 11, AG_WINDOW_ANIM_FRAME_START, 6);

set_window_value(AT_FSPECIAL_AIR, 12, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL_AIR, 12, AG_WINDOW_LENGTH, 12);
set_window_value(AT_FSPECIAL_AIR, 12, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_FSPECIAL_AIR, 12, AG_WINDOW_ANIM_FRAME_START, 8);

set_window_value(AT_FSPECIAL_AIR, 13, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL_AIR, 13, AG_WINDOW_LENGTH, 6);
set_window_value(AT_FSPECIAL_AIR, 13, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_FSPECIAL_AIR, 13, AG_WINDOW_ANIM_FRAME_START, 7);

set_window_value(AT_FSPECIAL_AIR, 14, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL_AIR, 14, AG_WINDOW_LENGTH, 5);
set_window_value(AT_FSPECIAL_AIR, 14, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_FSPECIAL_AIR, 14, AG_WINDOW_ANIM_FRAME_START, 24);
...
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_WINDOW_CREATION_FRAME, 6);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_LIFETIME, 9);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_HITBOX_X, 80);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_HITBOX_Y, -32);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_WIDTH, 111);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_HEIGHT, 66);
...
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_EXTRA_HITPAUSE, 70);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_KNOCKBACK_SCALING, 0.3);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_HIT_SFX, sound_get("sfx_soul_hit"));
...
set_hitbox_value(AT_FSPECIAL_AIR, 2, HG_WINDOW, 10);
set_hitbox_value(AT_FSPECIAL_AIR, 2, HG_WINDOW_CREATION_FRAME, 4);
set_hitbox_value(AT_FSPECIAL_AIR, 2, HG_LIFETIME, 5);
set_hitbox_value(AT_FSPECIAL_AIR, 2, HG_HITBOX_X, 80);
set_hitbox_value(AT_FSPECIAL_AIR, 2, HG_HITBOX_Y, -30);
set_hitbox_value(AT_FSPECIAL_AIR, 2, HG_WIDTH, 120);
set_hitbox_value(AT_FSPECIAL_AIR, 2, HG_HEIGHT, 74);
...
set_hitbox_value(AT_FSPECIAL_AIR, 2, HG_ANGLE, 30);
set_hitbox_value(AT_FSPECIAL_AIR, 2, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_FSPECIAL_AIR, 2, HG_KNOCKBACK_SCALING, 0.5);
set_hitbox_value(AT_FSPECIAL_AIR, 2, HG_BASE_HITPAUSE, 4);
set_hitbox_value(AT_FSPECIAL_AIR, 2, HG_HIT_SFX, sound_get("sfx_soul_break"));
...
set_hitbox_value(AT_FSPECIAL_AIR, 3, HG_WINDOW, 9);
set_hitbox_value(AT_FSPECIAL_AIR, 3, HG_WINDOW_CREATION_FRAME, 4);
set_hitbox_value(AT_FSPECIAL_AIR, 3, HG_LIFETIME, 5);
set_hitbox_value(AT_FSPECIAL_AIR, 3, HG_HITBOX_X, 80);
set_hitbox_value(AT_FSPECIAL_AIR, 3, HG_HITBOX_Y, -30);
set_hitbox_value(AT_FSPECIAL_AIR, 3, HG_WIDTH, 120);
set_hitbox_value(AT_FSPECIAL_AIR, 3, HG_HEIGHT, 74);
...
set_hitbox_value(AT_FSPECIAL_AIR, 3, HG_ANGLE, 150);
set_hitbox_value(AT_FSPECIAL_AIR, 3, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_FSPECIAL_AIR, 3, HG_KNOCKBACK_SCALING, 0.5);
set_hitbox_value(AT_FSPECIAL_AIR, 3, HG_BASE_HITPAUSE, 4);
set_hitbox_value(AT_FSPECIAL_AIR, 3, HG_HIT_SFX, sound_get("sfx_soul_break"));
...
set_hitbox_value(AT_FSPECIAL_AIR, 4, HG_WINDOW, 7);
set_hitbox_value(AT_FSPECIAL_AIR, 4, HG_WINDOW_CREATION_FRAME, 4);
set_hitbox_value(AT_FSPECIAL_AIR, 4, HG_LIFETIME, 5);
set_hitbox_value(AT_FSPECIAL_AIR, 4, HG_HITBOX_X, 80);
set_hitbox_value(AT_FSPECIAL_AIR, 4, HG_HITBOX_Y, -30);
set_hitbox_value(AT_FSPECIAL_AIR, 4, HG_WIDTH, 120);
set_hitbox_value(AT_FSPECIAL_AIR, 4, HG_HEIGHT, 74);
...
set_hitbox_value(AT_FSPECIAL_AIR, 4, HG_KNOCKBACK_SCALING, 0.5);
set_hitbox_value(AT_FSPECIAL_AIR, 4, HG_BASE_HITPAUSE, 4);
set_hitbox_value(AT_FSPECIAL_AIR, 4, HG_HIT_SFX, sound_get("sfx_soul_break"));
set_hitbox_value(AT_FSPECIAL_AIR, 4, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_FSPECIAL_AIR, 4, HG_IGNORES_PROJECTILES, 1);

set_hitbox_value(AT_FSPECIAL_AIR, 5, HG_PARENT_HITBOX, 5);
set_hitbox_value(AT_FSPECIAL_AIR, 5, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_FSPECIAL_AIR, 5, HG_WINDOW, 8);
set_hitbox_value(AT_FSPECIAL_AIR, 5, HG_WINDOW_CREATION_FRAME, 4);
set_hitbox_value(AT_FSPECIAL_AIR, 5, HG_LIFETIME, 5);
set_hitbox_value(AT_FSPECIAL_AIR, 5, HG_HITBOX_X, 80);
set_hitbox_value(AT_FSPECIAL_AIR, 5, HG_HITBOX_Y, -30);
set_hitbox_value(AT_FSPECIAL_AIR, 5, HG_WIDTH, 120);
set_hitbox_value(AT_FSPECIAL_AIR, 5, HG_HEIGHT, 74);
set_hitbox_value(AT_FSPECIAL_AIR, 5, HG_SHAPE, 1);
set_hitbox_value(AT_FSPECIAL_AIR, 5, HG_PRIORITY, 3);
set_hitbox_value(AT_FSPECIAL_AIR, 5, HG_DAMAGE, 5);
set_hitbox_value(AT_FSPECIAL_AIR, 5, HG_ANGLE, 270);
set_hitbox_value(AT_FSPECIAL_AIR, 5, HG_BASE_KNOCKBACK, 4);
set_hitbox_value(AT_FSPECIAL_AIR, 5, HG_KNOCKBACK_SCALING, 0.2);
set_hitbox_value(AT_FSPECIAL_AIR, 5, HG_BASE_HITPAUSE, 4);
set_hitbox_value(AT_FSPECIAL_AIR, 5, HG_HIT_SFX, sound_get("sfx_soul_break"));
