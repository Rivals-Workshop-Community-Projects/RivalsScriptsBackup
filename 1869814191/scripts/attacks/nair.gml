...
set_window_value(AT_NAIR, 1, AG_WINDOW_LENGTH, 18);
...
set_window_value(AT_NAIR, 2, AG_WINDOW_SFX, sound_get("sfx_sans_whoopee"));
...
set_hitbox_value(AT_NAIR, 2, HG_HITPAUSE_SCALING, .85);
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT, 254);
