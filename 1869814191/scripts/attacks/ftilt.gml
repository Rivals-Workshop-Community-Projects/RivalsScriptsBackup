...
set_attack_value(AT_FTILT, AG_LANDING_LAG, 6);
...
set_hitbox_value(AT_FTILT, 1, HG_ANGLE, 315);
...
set_hitbox_value(AT_FTILT, 2, HG_HITPAUSE_SCALING, .85);
...
set_hitbox_value(AT_FTILT, 3, HG_KNOCKBACK_SCALING, .9);
set_hitbox_value(AT_FTILT, 3, HG_BASE_HITPAUSE, 4);
set_hitbox_value(AT_FTILT, 3, HG_HITPAUSE_SCALING, .9);
...
set_hitbox_value(AT_FTILT, 4, HG_HEIGHT, 44);
...
set_hitbox_value(AT_FTILT, 4, HG_HITPAUSE_SCALING, .85);
