...
set_window_value(AT_UAIR, 2, AG_WINDOW_SFX, sound_get("sfx_sans_trombone"));
...
set_hitbox_value(AT_NAIR, 1, HG_HITPAUSE_SCALING, .95);
set_hitbox_value(AT_UAIR, 1, HG_DRIFT_MULTIPLIER, 1);
set_hitbox_value(AT_UAIR, 1, HG_SDI_MULTIPLIER, 1);
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT, 254);
