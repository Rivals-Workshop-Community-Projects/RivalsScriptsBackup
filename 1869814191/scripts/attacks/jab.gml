...
set_hitbox_value(AT_JAB, 2, HG_ANGLE, 135);
...
set_hitbox_value(AT_JAB, 2, HG_VISUAL_EFFECT_Y_OFFSET, -24);
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, asset_get("sfx_absa_jab1"));
...
set_hitbox_value(AT_JAB, 3, HG_ANGLE, 135);
...
set_hitbox_value(AT_JAB, 3, HG_VISUAL_EFFECT, 197);
set_hitbox_value(AT_JAB, 3, HG_VISUAL_EFFECT_X_OFFSET, 24);
set_hitbox_value(AT_JAB, 3, HG_VISUAL_EFFECT_Y_OFFSET, -24);
