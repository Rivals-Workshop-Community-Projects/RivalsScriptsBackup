...
thetoken = noone;
uspecnum = 0;
uspec_speed = 1;uspectarget = noone;uspectime = 0;uspec_mask = false;
property = noone;
dspec_charge = 0;
jaildice1 = 0;jaildice2 = 0;
jaildicetimer = 0;jaildiceattempts = 0;jailcost = 0;jailcard = false;jailpropertymoney = 0;
diceluck = 0;
dattackhitbox = noone;dattacknum = 0;dattacktimer = 0;
...
BAir_cooldown = 0;
VerySkillful = true;mrmonopolydidskillfulvictoryskillstuff = false;
current_money = 15000;current_money2 = 15000;income_boost = 1;
prev_money = 15000;prev_money_diff = 0;money_diff = 0.0;money_frameignore = 0;epic_riches = 60;epic_riches2 = 60;
discount = 1;discount_stocks = 0;
tauntmoney = 0;
notmuchtimeleft = 0;
