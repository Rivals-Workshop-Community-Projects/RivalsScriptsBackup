...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_absa_cloud_crackle"));
...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_absa_cloud_crackle"));
...
set_window_value(AT_NSPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_absa_cloud_crackle"));
...
set_window_value(AT_NSPECIAL, 8, AG_WINDOW_SFX, sound_get("molotov end"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_LIFETIME, 55);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_ANGLE, 41);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_VISUAL_EFFECT, 157);
set_hitbox_value(AT_NSPECIAL, 3, HG_HIT_SFX, asset_get("sfx_ori_charged_flame_hit"));
