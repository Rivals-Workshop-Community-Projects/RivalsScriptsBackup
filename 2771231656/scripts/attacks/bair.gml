...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("miss1"));
...
set_window_value(AT_BAIR, 4, AG_WINDOW_SFX, sound_get("Sswing1"));
set_window_value(AT_BAIR, 4, AG_WINDOW_SFX_FRAME, 10);
...
set_window_value(AT_BAIR, 6, AG_WINDOW_LENGTH, 15);
...
set_hitbox_value(AT_BAIR, 1, HG_BASE_KNOCKBACK, 8.2);
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("punch_heavy"));
...
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, sound_get("swordmid"));