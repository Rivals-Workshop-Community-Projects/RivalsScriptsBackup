...
set_window_value(AT_DAIR, 2, AG_WINDOW_SFX, sound_get("bigmiss"));
...
set_window_value(AT_DAIR, 4, AG_WINDOW_SFX, sound_get("dair"));
...
set_window_value(AT_DAIR, 5, AG_WINDOW_SFX, sound_get("Sswing1"));
...
set_hitbox_value(AT_DAIR, 1, HG_KNOCKBACK_SCALING, .85);
...
set_hitbox_value(AT_DAIR, 3, HG_HITBOX_Y, -56);
...
set_hitbox_value(AT_DAIR, 3, HG_BASE_KNOCKBACK, 7.5);
...
set_hitbox_value(AT_DAIR, 3, HG_HIT_SFX, sound_get("kick_weak"))