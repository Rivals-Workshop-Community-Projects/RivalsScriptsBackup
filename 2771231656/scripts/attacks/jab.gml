...
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, sound_get("jab"));
...
set_window_value(AT_JAB, 4, AG_WINDOW_SFX, sound_get("Sswing1"));
...
set_window_value(AT_JAB, 6, AG_WINDOW_CUSTOM_GROUND_FRICTION, 4);
...
set_hitbox_value(AT_JAB, 1, HG_BASE_KNOCKBACK, 6.4);
...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("punch_weak"));
...
set_hitbox_value(AT_JAB, 2, HG_WIDTH, 130);
...
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, sound_get("swordweak"));