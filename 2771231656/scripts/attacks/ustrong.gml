...
set_hitbox_value(AT_USTRONG, 3, HG_KNOCKBACK_SCALING, 1.3);
...
set_hitbox_value(AT_USTRONG, 4, HG_KNOCKBACK_SCALING, 1.3);
...
set_hitbox_value(AT_USTRONG, 5, HG_EXTRA_HITPAUSE, 4);
