...
set_hitbox_value(AT_NAIR, 2, HG_EXTRA_HITPAUSE, 7);
...
set_hitbox_value(AT_NAIR, 3, HG_EXTRA_HITPAUSE, 7);
...
set_hitbox_value(AT_NAIR, 4, HG_ANGLE, 88);
...
set_hitbox_value(AT_NAIR, 5, HG_HITBOX_X, -65);
set_hitbox_value(AT_NAIR, 5, HG_HITBOX_Y, -45);
set_hitbox_value(AT_NAIR, 5, HG_WIDTH, 75);
set_hitbox_value(AT_NAIR, 5, HG_HEIGHT, 105);
...
set_hitbox_value(AT_NAIR, 5, HG_BASE_HITPAUSE, 12);
...
set_hitbox_value(AT_NAIR, 6, HG_BASE_HITPAUSE, 12);
...
set_hitbox_value(AT_NAIR, 7, HG_HEIGHT, 105);
set_hitbox_value(AT_NAIR, 7, HG_PRIORITY, 1);
set_hitbox_value(AT_NAIR, 7, HG_DAMAGE, 10);
set_hitbox_value(AT_NAIR, 7, HG_ANGLE, 80);
set_hitbox_value(AT_NAIR, 7, HG_BASE_KNOCKBACK, 10);
set_hitbox_value(AT_NAIR, 7, HG_KNOCKBACK_SCALING, .8);
set_hitbox_value(AT_NAIR, 7, HG_BASE_HITPAUSE, 12);
