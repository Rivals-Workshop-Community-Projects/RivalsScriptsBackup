...
set_attack_value(AT_USPECIAL_2, AG_SPRITE, sprite_get("uspecial_geese"));
...
set_window_value(AT_USPECIAL_2, 1, AG_WINDOW_SFX, asset_get("sfx_spin"));
...
set_window_value(AT_USPECIAL_2, 2, AG_WINDOW_SFX_FRAME, 7);
...
set_window_value(AT_USPECIAL_2, 5, AG_WINDOW_HAS_WHIFFLAG, 1);
...
set_hitbox_value(AT_USPECIAL_2, 1, HG_WIDTH, 58);
...
set_hitbox_value(AT_USPECIAL_2, 1, HG_TECHABLE, 0);
...
set_hitbox_value(AT_USPECIAL_2, 5, HG_HITBOX_Y, -35);
set_hitbox_value(AT_USPECIAL_2, 5, HG_WIDTH, 98);
set_hitbox_value(AT_USPECIAL_2, 5, HG_HEIGHT, 65);
set_hitbox_value(AT_USPECIAL_2, 5, HG_SHAPE, 0);
set_hitbox_value(AT_USPECIAL_2, 5, HG_PRIORITY, 3);
...
set_hitbox_value(AT_USPECIAL_2, 5, HG_HITPAUSE_SCALING, 0.6);
