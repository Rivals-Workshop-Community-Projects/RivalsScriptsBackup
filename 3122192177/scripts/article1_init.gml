...
sprite_index = sprite_get("nspecial_ward_intro");           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
...
tempest_dir = 1;
tempest_owner = noone;
tempest_got_parried = false;

tempest_cur_hitbox = 0;
