...
alt_name[0]  = "Default";
alt_name[1]  = "Pride";
alt_name[2]  = "Mojiblake";
alt_name[3]  = "Grake";
alt_name[4]  = "R-00";
alt_name[5]  = "InnerOtaku" ;
alt_name[6]  = "Abyss";
alt_name[7]  = "Early Access";
alt_name[8]  = "Servbot";
alt_name[9]  = "Freddy";
alt_name[10]  = "Ice";
alt_name[11]  = "Microtonal Banana";
alt_name[12]  = "Donyoku";
alt_name[13]  = "Lode";
alt_name[14]  = "Rosa";
alt_name[15]  = "Karkat";
...
//include alt. name
textDraw(temp_x + 6, temp_y + 128, "fName", c_white, 0, 1000, 1, true, 1, alt_name[alt_cur]); //"Alt. " + (alt_cur < 9 ? "0" : "") + string(alt_cur + 1) + ": " +
