...
set_window_value(AT_FAIR, 3, AG_WINDOW_SFX, asset_get("sfx_ell_drill_loop"));
...
set_window_value(AT_FAIR, 5, AG_WINDOW_ANIM_FRAME_START, 17);
...
set_window_value(AT_FAIR, 6, AG_WINDOW_ANIM_FRAME_START, 17);
...
set_hitbox_value(AT_FAIR, 2, HG_HIT_SFX, asset_get("sfx_ell_drill_stab"));
...
set_hitbox_value(AT_FAIR, 4, HG_PARENT_HITBOX, 2);
...
set_hitbox_value(AT_FAIR, 5, HG_HITBOX_Y, -29);
set_hitbox_value(AT_FAIR, 5, HG_WIDTH, 53);
set_hitbox_value(AT_FAIR, 5, HG_HEIGHT, 31);
...
set_hitbox_value(AT_FAIR, 6, HG_PARENT_HITBOX, 0);
set_hitbox_value(AT_FAIR, 6, HG_WINDOW, 5);
set_hitbox_value(AT_FAIR, 6, HG_WINDOW_CREATION_FRAME, 1);
set_hitbox_value(AT_FAIR, 6, HG_LIFETIME, 3);
set_hitbox_value(AT_FAIR, 6, HG_HITBOX_X, 22);
set_hitbox_value(AT_FAIR, 6, HG_HITBOX_Y, -19);
set_hitbox_value(AT_FAIR, 6, HG_WIDTH, 53);
set_hitbox_value(AT_FAIR, 6, HG_HEIGHT, 31);
...
set_hitbox_value(AT_FAIR, 6, HG_HITPAUSE_SCALING, 0.6);
set_hitbox_value(AT_FAIR, 6, HG_HIT_SFX, asset_get("sfx_blow_medium3"));
set_hitbox_value(AT_FAIR, 6, HG_HITBOX_GROUP, 4);
