...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, asset_get("mfx_coin"));
...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("bwoink"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_Y, -62);
...
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT, 154);
...
set_hitbox_value(AT_DSTRONG, 4, HG_HITBOX_Y, -61);
...
set_hitbox_value(AT_DSTRONG, 5, HG_WIDTH, 101);
set_hitbox_value(AT_DSTRONG, 5, HG_HEIGHT, 58);
