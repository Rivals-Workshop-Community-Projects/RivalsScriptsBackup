...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_mobile_gear_jump"));
...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_ell_drill_loop"));
...
set_hitbox_value(AT_USPECIAL, 5, HG_HIT_SFX, asset_get("sfx_shovel_hit_heavy1"));
set_hitbox_value(AT_USPECIAL, 1, HG_HITBOX_GROUP, -1);
