...
//Sprites
spr_starempty = sprite_get("starempty"); // sprites/example_stripX.png
spr_fspecial_star = sprite_get("fspecial_star")

// SFX
sfx_example = sound_get("example"); // sounds/example.ogg

// VFX
star_get = hit_fx_create(sprite_get("star_get"), 14);
star_hit = hit_fx_create(sprite_get("star_hit"), 24);
