...
set_hitbox_value(AT_JAB, 1, HG_MUNO_HITBOX_NAME, "First Hit");
...
set_hitbox_value(AT_JAB, 1, HG_BASE_HITPAUSE, 4.5);
...
set_hitbox_value(AT_JAB, 2, HG_MUNO_HITBOX_NAME, "Second Hit");
...
set_hitbox_value(AT_JAB, 2, HG_BASE_HITPAUSE, 4.5);
...
set_hitbox_value(AT_JAB, 3, HG_MUNO_HITBOX_NAME, "Third Hit");
...
set_hitbox_value(AT_JAB, 3, HG_HITPAUSE_SCALING, .55);
