...
set_hitbox_value(AT_NSPECIAL_2, 1, HG_ANGLE, 30);
...
set_hitbox_value(AT_NSPECIAL_2, 3, HG_KNOCKBACK_SCALING, .9);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_BASE_HITPAUSE, 10);
...
set_hitbox_value(AT_NSPECIAL_2, 4, HG_KNOCKBACK_SCALING, .9);
