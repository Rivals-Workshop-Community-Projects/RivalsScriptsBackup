...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sound_get("fspecial_leap"));
...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_SFX, sound_get("fspecial_swing"));
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_SFX_FRAME, 16);
