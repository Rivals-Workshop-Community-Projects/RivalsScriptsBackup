...
set_attack_value(AT_NAIR, AG_HURTBOX_SPRITE, sprite_get("AT_NAIR_AIR_hurt"));
set_attack_value(AT_NAIR, AG_HURTBOX_SPRITE, sprite_get("AT_NAIR_GROUND_hurt"));
...
set_hitbox_value(AT_NAIR, 3, HG_HITPAUSE_SCALING, .23);
