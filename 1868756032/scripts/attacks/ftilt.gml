set_attack_value(AT_FTILT, AG_SPRITE, sprite_get("AT_FTILT"));
set_attack_value(AT_FTILT, AG_NUM_WINDOWS, 3);
set_attack_value(AT_FTILT, AG_HURTBOX_SPRITE, sprite_get("AT_FTILT_hurt"));
set_window_value(AT_FTILT, 2, AG_WINDOW_SFX, sound_get("ftilt_star_rod"));
