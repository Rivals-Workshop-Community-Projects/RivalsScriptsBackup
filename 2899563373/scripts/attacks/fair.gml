...
set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, sound_get("sfx_magicpoke"));
...
set_hitbox_value(AT_FAIR, 1, HG_ANGLE, 40); //went back and forth on this one. 45 is way too good on di in but 40 is awful on di out
...
set_hitbox_value(AT_FAIR, 1, HG_VISUAL_EFFECT, vfx_holyhit_m);
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, asset_get("sfx_blow_medium3"));
set_hitbox_value(AT_FAIR, 1, HG_HIT_PARTICLE_NUM, particle_num);