...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, vfx_holyhit_l);
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, asset_get("sfx_blow_medium3"));
set_hitbox_value(AT_DAIR, 1, HG_HIT_PARTICLE_NUM, particle_num);
//ground only sends backwards
...
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT, vfx_holyhit_m);
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, asset_get("sfx_blow_medium3"));
set_hitbox_value(AT_DAIR, 2, HG_HIT_PARTICLE_NUM, particle_num);