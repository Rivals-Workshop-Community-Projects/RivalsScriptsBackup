...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_fspec_scan"));
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX_FRAME, 1);//*/
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.045);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_ANGLE, 0); //trolling
set_hitbox_value(AT_FSPECIAL, 1, HG_ANGLE_FLIPPER, 4); //trolling
set_hitbox_value(AT_FSPECIAL, 1, HG_BASE_KNOCKBACK, 10); //trolling
...
set_hitbox_value(AT_FSPECIAL, 2, HG_FORCE_FLINCH, 3);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_HIT_SFX, asset_get("sfx_burnapplied"));
