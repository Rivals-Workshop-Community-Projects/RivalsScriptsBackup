...
//set all sprites as variables do you dont have to sprite_get them

spr_idle = sprite_get("barrier_idle");
spr_spawn = sprite_get("barrier_spawn");
spr_hit = sprite_get("barrier_hit");
spr_pulse = sprite_get("barrier_pulse");
spr_shatter = sprite_get("barrier_shatter");

vfx_barrier_beam = player_id.vfx_barrier_beam;

mask_index = sprite_get("barrier_mask");

//----------------------------------------------------------

//Sprite and direction
sprite_index = spr_spawn;           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
...
idle_anim_rate = 6;                                 //Example animation speed value 1. The animation in question will increment every 6 frames in this case
anim_rate = 4;                                      //USED BY ME!! WOW
die_anim_rate = 4;                                  //Example animation speed value 2.
die_time = 12;                                      //Example variable used in this case to determine how long the article should take to die (state 2). 
...
maxarticles = 3; //just for fun                     //The maximum number of this article that should exist at once.
