...
if (!variable_instance_exists(id,"ae") || ye == true){
    ...
    //--- ---
    altsel = sound_get("blip1"); // change the alt select sound here. if you don't want to change the sound, put 0 here.
    ...
    ce[0,1] = "Goddess of Light" // the name of the alternate color.
    ...
    ce[1,0] = make_color_rgb(199, 111, 115)
    ce[1,1] = "Red"
    ce[1,2] = "Standard recolor."
    ce[2,0] = make_color_rgb(51, 61, 110)
    ce[2,1] = "Blue"
    ce[2,2] = "Standard recolor."
    ce[3,0] = make_color_rgb(77, 186, 73)
    ce[3,1] = "Green"
    ce[3,2] = "Standard recolor."
    ce[4,0] = make_color_rgb(52, 133, 173)
    ce[4,1] = "Turquoise"
    ce[4,2] = "Flashier recolor."
    ce[5,0] = make_color_rgb(184, 51, 138)
    ce[5,1] = "Pink"
    ce[5,2] = "Flashier recolor."
    ce[6,0] = make_color_rgb(146, 37, 156)
    ce[6,1] = "Black"
    ce[6,2] = "Alternate recolor. This is my alt so I'm biased."
    ce[7,0] = make_color_rgb(130, 114, 114)
    ce[7,1] = "Rainbow"
    ce[7,2] = "Color-changing rainbow alt."
    ce[8,0] = make_color_rgb(59, 35, 37)
    ce[8,1] = "Medusa"
    ce[8,2] = "References Medusa from Kid Icarus."
    ce[9,0] = make_color_rgb(150, 190, 254)
    ce[9,1] = "Phosphora"
    ce[9,2] = "References Phosphora from Kid Icarus.."
