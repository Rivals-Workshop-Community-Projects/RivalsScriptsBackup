...
if !found && state != PS_SPAWN && state != PS_RESPAWN && visible instance_create(x, 0, "obj_article1")
...
if state != PS_ATTACK_AIR && state != PS_ATTACK_GROUND && !bike{
	bike = 1
