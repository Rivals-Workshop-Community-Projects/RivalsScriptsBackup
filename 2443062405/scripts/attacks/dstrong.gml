...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_LENGTH, 8); // 12; also anim stuff was different
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_SFX, asset_get("sfx_spin"));
set_window_value(AT_DSTRONG, 4, AG_WINDOW_SFX_FRAME, 14);
...
set_hitbox_value(AT_DSTRONG, 1, HG_EXTRA_HITPAUSE, 4); //to true combo
set_hitbox_value(AT_DSTRONG, 1, HG_MUNO_OBJECT_LAUNCH_ANGLE, 270);

set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_DSTRONG, 2, HG_WINDOW, 5);
set_hitbox_value(AT_DSTRONG, 2, HG_LIFETIME, 3);
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_X, 26);
