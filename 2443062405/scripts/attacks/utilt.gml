...
set_hitbox_value(AT_UTILT, 1, HG_ANGLE, 30);
...
// set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, vfx_hit_small);
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, asset_get("sfx_blow_weak1"));
set_hitbox_value(AT_UTILT, 1, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_UTILT, 1, HG_MUNO_OBJECT_LAUNCH_ANGLE, 90);
...
set_hitbox_value(AT_UTILT, 2, HG_MUNO_OBJECT_LAUNCH_ANGLE, 90);
...
set_hitbox_value(AT_UTILT, 3, HG_MUNO_OBJECT_LAUNCH_ANGLE, 90);
...
// set_hitbox_value(AT_UTILT, 4, HG_VISUAL_EFFECT, vfx_hit_med);
set_hitbox_value(AT_UTILT, 4, HG_HIT_SFX, asset_get("sfx_blow_medium1"));
set_hitbox_value(AT_UTILT, 4, HG_HITBOX_GROUP, 3);
set_hitbox_value(AT_UTILT, 4, HG_MUNO_OBJECT_LAUNCH_ANGLE, 90);
