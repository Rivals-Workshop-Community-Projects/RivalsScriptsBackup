...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, bigpow);
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, bigpow);
...
set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_X, 24);
...
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT, pow);
