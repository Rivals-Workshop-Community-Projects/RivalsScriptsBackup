...
set_hitbox_value(AT_DSPECIAL, 1, HG_VISUAL_EFFECT, pow);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_VISUAL_EFFECT, pow);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_VISUAL_EFFECT, bigpow);
...
set_hitbox_value(AT_DSPECIAL, 4, HG_VISUAL_EFFECT, pow);
...
set_hitbox_value(AT_DSPECIAL, 5, HG_VISUAL_EFFECT, pow);
...
set_hitbox_value(AT_DSPECIAL, 6, HG_VISUAL_EFFECT, pow);
...
set_hitbox_value(AT_DSPECIAL, 7, HG_KNOCKBACK_SCALING, 1.25);
...
set_hitbox_value(AT_DSPECIAL, 7, HG_VISUAL_EFFECT, bigpow);
