...
set_window_value(AT_FTILT, 4, AG_WINDOW_SFX, sound_get("cannon"));
...
set_window_value(AT_FTILT, 5, AG_WINDOW_ANIM_FRAME_START, 16);
...
set_hitbox_value(AT_FTILT, 2, HG_ANGLE, 32);
set_hitbox_value(AT_FTILT, 2, HG_BASE_KNOCKBACK, 4);
set_hitbox_value(AT_FTILT, 2, HG_KNOCKBACK_SCALING, .20);
