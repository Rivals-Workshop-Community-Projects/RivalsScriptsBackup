...
set_window_value(AT_PHONE, 1, AG_WINDOW_TYPE, 1);
set_window_value(AT_PHONE, 1, AG_WINDOW_LENGTH, 34);
set_window_value(AT_PHONE, 1, AG_WINDOW_ANIM_FRAMES, 17);
...
set_window_value(AT_PHONE, 2, AG_WINDOW_ANIM_FRAME_START, 17);

//Closing window

set_window_value(AT_PHONE, 3, AG_WINDOW_LENGTH, 20);
set_window_value(AT_PHONE, 3, AG_WINDOW_ANIM_FRAMES, 6);
set_window_value(AT_PHONE, 3, AG_WINDOW_ANIM_FRAME_START, 18);