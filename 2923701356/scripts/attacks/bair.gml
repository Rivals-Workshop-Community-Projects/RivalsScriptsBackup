...
set_attack_value(attack, AG_LANDING_LAG, 5);
...
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, 7); //get_window_value(attack,window_num,AG_WINDOW_LENGTH)-1);
...
// Window 5 / Frame(s) 4 / Endlag 2/Startup 3
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 2);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 1);
