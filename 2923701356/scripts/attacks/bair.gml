...
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, 4); //get_window_value(attack,window_num,AG_WINDOW_LENGTH)-1);

window_num++;

// Window 2 / Frame(s) 1 / Active 1
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window 3 / Frame(s) 2 / Endlag 1/Startup 2
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 78);
set_hitbox_value(attack, hitbox_num, HG_PRIORITY, 6);
set_hitbox_value(attack, hitbox_num, HG_DAMAGE, 5);
set_hitbox_value(attack, hitbox_num, HG_ANGLE, 120);
