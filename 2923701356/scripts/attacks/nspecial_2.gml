var attack = AT_NSPECIAL_2; // Swap Taunt for attack that this is

//Attack Values-----------------------------------------------------------------------------
set_attack_value(attack, AG_CATEGORY, 2);
set_attack_value(attack, AG_SPRITE, sprite_get("nspecial_2")); //sprite_get("")
set_attack_value(attack, AG_AIR_SPRITE, 0);
set_attack_value(attack, AG_HURTBOX_SPRITE, sprite_get("nspecial_2_hurt")); //sprite_get("_hurt")
...
set_window_value(attack, window_num, AG_WINDOW_SFX, sound_get("nspecial_startup"));

window_num++;

// Window 2 / Frame(s) 3 - 6 / Idle
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 172);
