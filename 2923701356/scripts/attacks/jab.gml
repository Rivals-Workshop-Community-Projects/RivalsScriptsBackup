...
// Window 1 / Frame(s) 0 - 1 / Startup 1
...
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_swipe_weak1"));
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, 4);
window_num++;

// Window 2 / Frame(s) 2 - 3 / Active 1
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_window_value(attack, window_num, AG_WINDOW_HSPEED, 1);
 ...
 // asset_get("") or sound_get("")

window_num++;

// Window 3 / Frame(s) 4 / Endlag
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_window_value(attack, window_num, AG_WINDOW_HAS_SFX, 1);
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_swipe_weak2"));
...
set_window_value(attack, window_num, AG_WINDOW_CANCEL_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_CANCEL_FRAME, 1);
...
set_window_value(attack, window_num, AG_WINDOW_HSPEED, 13);
set_window_value(attack, window_num, AG_WINDOW_VSPEED, -4);
set_window_value(attack, window_num, AG_WINDOW_CUSTOM_AIR_FRICTION, 1.3);
...
set_window_value(attack, window_num, AG_WINDOW_CUSTOM_AIR_FRICTION, 1.1);
...
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 0);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, get_window_value(attack, window_for_hitbox, AG_WINDOW_LENGTH)); // Swap 1 for what ever window this attack is
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 8);
...
set_hitbox_value(attack, hitbox_num, HG_HITPAUSE_SCALING, 0.4);
set_hitbox_value(attack, hitbox_num, HG_VISUAL_EFFECT, 0);
