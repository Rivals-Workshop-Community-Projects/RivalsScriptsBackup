...
set_window_value(attack, window_num, AG_WINDOW_HAS_SFX, 1);
set_window_value(attack, window_num, AG_WINDOW_SFX, sound_get("nspecial_fail"));
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, 10);

window_num++;

// Window 3 / Frame(s) 7 - 12 / Failure
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window 4 / Frame(s) 13 - 14 / Return to Idle
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
