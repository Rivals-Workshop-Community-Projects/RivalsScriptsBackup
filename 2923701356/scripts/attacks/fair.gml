...
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, 9); //get_window_value(attack,window_num,AG_WINDOW_LENGTH)-1);
...
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 36);
