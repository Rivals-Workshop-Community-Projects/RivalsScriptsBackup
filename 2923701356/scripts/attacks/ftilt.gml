...
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_bite")); // asset_get("") or sound_get("")
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, 6);
...
// Window 4 / Frame(s) 5 - 6 / Startup 2
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 4);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAME_START, 5);
set_window_value(attack, window_num, AG_WINDOW_SFX, asset_get("sfx_bite"));
set_window_value(attack, window_num, AG_WINDOW_HAS_SFX, 1); // asset_get("") or sound_get("")
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, 2);

window_num++;

// Window 5 / Frame(s) 7 - 8 / Active 2
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 4);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 1);
...
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 70);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -24);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 96);
...
set_hitbox_value(attack, hitbox_num, HG_HITPAUSE_SCALING, .45);
