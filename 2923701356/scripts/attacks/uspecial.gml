...
set_window_value(attack, window_num, AG_WINDOW_SFX, sound_get("uspecial_jump")); // asset_get("") or sound_get("")
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, 5); //get_window_value(attack,window_num,AG_WINDOW_LENGTH)-1);

window_num++;

// Window 2 / Frame(s) 3 - 9 / Endlag
...
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, 60); // Swap 1 for what ever window this attack is
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 5);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -13);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 68);
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 26);
...
set_hitbox_value(attack, hitbox_num, HG_HITSTUN_MULTIPLIER, 0.6);

set_hitbox_value(attack, hitbox_num, HG_PROJECTILE_SPRITE, sprite_get("uspecialproj"));
set_hitbox_value(attack, hitbox_num, HG_PROJECTILE_MASK, sprite_get("uspecialproj"));
set_hitbox_value(attack, hitbox_num, HG_PROJECTILE_ANIM_SPEED, 0.2);
set_hitbox_value(attack, hitbox_num, HG_PROJECTILE_HSPEED, 0);
set_hitbox_value(attack, hitbox_num, HG_PROJECTILE_VSPEED, 4);
set_hitbox_value(attack, hitbox_num, HG_PROJECTILE_GRAVITY, 0.5);
...
set_hitbox_value(attack, hitbox_num, HG_PROJECTILE_LIFESPAN, 60);
...
set_hitbox_value(attack, hitbox_num, HG_PROJECTILE_DESTROY_EFFECT, uspecial_projectile);

set_hitbox_value(attack, hitbox_num, HG_PROJECTILE_COLLISION_SPRITE, sprite_get("uspecial_mask"));
