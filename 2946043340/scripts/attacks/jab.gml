...
set_hitbox_value(AT_JAB, 1, HG_VISUAL_EFFECT, hfx_wind_small);
...
set_hitbox_value(AT_JAB, 2, HG_VISUAL_EFFECT, hfx_wind_small);
...
set_hitbox_value(AT_JAB, 3, HG_VISUAL_EFFECT, hfx_wind_small);
