...
var edit_attack = AT_NTHROW;
var e_window = 3;

set_attack_value(edit_attack, AG_CATEGORY, 2);
set_attack_value(edit_attack, AG_SPRITE, sprite_get("nthrow"));
...
set_attack_value(edit_attack, AG_HURTBOX_SPRITE, sprite_get("nthrow_hurt"));
