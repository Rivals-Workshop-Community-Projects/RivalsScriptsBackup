...
set_hitbox_value(AT_FSTRONG, e_hitbox, HG_HITBOX_X, 64);
set_hitbox_value(AT_FSTRONG, e_hitbox, HG_HITBOX_Y, -38);
set_hitbox_value(AT_FSTRONG, e_hitbox, HG_WIDTH, 106);
...
set_hitbox_value(AT_FSTRONG, e_hitbox, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_FSTRONG, e_hitbox, HG_KNOCKBACK_SCALING, 1.3);
