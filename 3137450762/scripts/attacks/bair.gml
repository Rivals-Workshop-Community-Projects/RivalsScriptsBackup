...
set_hitbox_value(edit_attack, 1, HG_BASE_KNOCKBACK, 8);
...
set_hitbox_value(edit_attack, 2, HG_BASE_KNOCKBACK, 4);
...
set_hitbox_value(edit_attack, 3, HG_KNOCKBACK_SCALING, 0.85);
