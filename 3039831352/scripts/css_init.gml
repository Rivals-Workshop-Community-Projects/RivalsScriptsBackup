...
season_name[2] = current_month != 6 ? "Seaside Laze" : "Sonic Origins";
season_name[3] = "ILLEGAL INSTRUCTION 000E0XE0"; //lord X
...
alt_name[7] = "Psychic Hegdehog";       //silver (super silver)
alt_name[8] = "Her Highness";           //blaze (burning blaze)
...
alt_name[19] = "Scarlet Speedster"; //the flash
alt_name[20] = "False Chaos and Rage";
alt_name[21] = (current_day == 31 && current_month == 10) ? "It's him...?" : "It's him"; //snick
alt_name[22] = "Sylvan Watcher"; //maypul
alt_name[23] = "Elemental Guardian"; //bar
alt_name[24] = "Driving Thunder"; //keqing
alt_name[25] = "Youkai of Dusk"; //rumia
alt_name[26] = "Radical Team Player"; //player color
