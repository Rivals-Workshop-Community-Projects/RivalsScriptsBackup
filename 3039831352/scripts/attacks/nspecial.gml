...
set_window_value(atk, window_num, AG_WINDOW_LENGTH, 16); //30
...
set_hitbox_value(atk, hitbox_num, HG_BASE_KNOCKBACK, 6.5); //7
set_hitbox_value(atk, hitbox_num, HG_KNOCKBACK_SCALING, 0.5); //0.8
