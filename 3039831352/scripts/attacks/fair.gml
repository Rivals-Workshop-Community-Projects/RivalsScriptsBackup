...
set_attack_value(atk, AG_LANDING_LAG, 8); //12
...
set_hitbox_value(atk, hitbox_num, HG_ANGLE, 50); // 20
set_hitbox_value(atk, hitbox_num, HG_BASE_KNOCKBACK, 4); // 8
set_hitbox_value(atk, hitbox_num, HG_HITSTUN_MULTIPLIER, 1); // .3
...
// Alternative Version, Potentially revisit later
...
set_attack_value(atk, AG_HURTBOX_SPRITE, sprite_get("fair_hurt"));
set_attack_value(atk, AG_HAS_LANDING_LAG, 1);
set_attack_value(atk, AG_LANDING_LAG, 7); //8
...
set_hitbox_value(atk, hitbox_num, HG_HITBOX_TYPE, 1);
set_hitbox_value(atk, hitbox_num, HG_HITBOX_GROUP, hitbox_num);
set_hitbox_value(atk, hitbox_num, HG_WINDOW, 2); // 4
set_hitbox_value(atk, hitbox_num, HG_LIFETIME, 2);
