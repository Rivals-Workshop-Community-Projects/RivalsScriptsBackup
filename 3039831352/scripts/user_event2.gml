...
//
add_sprites("idle","crouch","walkturn","walk",
            "dashstart","dash","dash_max","dashstop","dashturn",
            "jumpstart","jump","doublejump","walljump","land","landinglag","pratfall",
            "parry","roll","airdodge","waveland","tech",
            "walk_push","tails_hang","knux_dunk");

//================Attacks================
//  Base Attacks
add_sprites("jab","utilt","ftilt","dtilt","dattack",
            "ustrong","fstrong","dstrong",
            "nair","uair","fair","dair","bair",
            "nspecial","uspecial","uspecial_air","uspecial2","fspecial","dspecial",
            "taunt","trick","transform",
            "finalsmash","runeC","runeH");

//=================OTHER=================
//  hurt sprites
add_sprites("hurt","hurt_tumble","hurt_kbspin");

//  UI and other stuff
add_sprites("hud_sonic_norm","hud_sonic_hurt","hud_sonic_offscreen","charselect",
            "portrait","portrait_ex1","portrait_ex2","portrait_ex4",
            "result_small","result_small_ex1","result_small_ex2","result_small_ex4",
            "proj_runeF"
);
...
if (debug_display) print(`[SKIN SYSTEM] precache took ${current_time-ctime}ms.`)