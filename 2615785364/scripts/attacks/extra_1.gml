set_attack_value(AT_EXTRA_1, AG_SPRITE, sprite_get("dstrong"));
...
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_SFX, sound_get("crash"));
...
set_window_value(AT_EXTRA_1, 4, AG_WINDOW_ANIM_FRAME_START, 0);
...
set_hitbox_value(AT_EXTRA_1, 1, HG_WIDTH, 56);
...
set_hitbox_value(AT_EXTRA_1, 1, HG_VISUAL_EFFECT_Y_OFFSET, 12);
set_hitbox_value(AT_EXTRA_1, 1, HG_HIT_SFX, sound_get("slam1"));
set_hitbox_value(AT_EXTRA_1, 1, HG_VISUAL_EFFECT, hfx_small);