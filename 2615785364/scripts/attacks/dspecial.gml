...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_SFX, sound_get("Dspecial"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_LIFETIME, 52);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("dead"));
set_hitbox_value(AT_DSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("dead"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_PROJECTILE_VSPEED, -25);
