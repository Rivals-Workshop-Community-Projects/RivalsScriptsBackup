...
// hair + glaze
set_color_profile_slot( 0, 0, 17, 255, 41 );
set_color_profile_slot_range( 0, 1, 7, 46 );

// skin
set_color_profile_slot( 0, 1, 255, 231, 201 );
set_color_profile_slot_range( 1, 22, 25, 21 );

// leggings
set_color_profile_slot( 0, 2, 18, 247, 255 );
set_color_profile_slot_range( 2, 1, 7, 46 );

// clothes
set_color_profile_slot( 0, 3, 188, 0, 0 );
set_color_profile_slot_range( 3, 1, 1, 26 );

// headgear
set_color_profile_slot( 0, 4, 168, 179, 255 );
set_color_profile_slot_range( 4, 19, 20, 25 );

// zipper + sleeves
set_color_profile_slot( 0, 5, 237, 184, 94 );
set_color_profile_slot_range( 5, 10, 26, 10 );

// eye
set_color_profile_slot( 0, 6, 255, 18, 255 );
set_color_profile_slot_range( 6, 1, 7, 46 );

// moontech logo
set_color_profile_slot( 0, 7, 186, 186, 188 );
