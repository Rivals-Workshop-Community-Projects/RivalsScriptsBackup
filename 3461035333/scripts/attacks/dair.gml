...
set_window_value(AT_DAIR, 3, AG_WINDOW_LENGTH, 6);//4
...
set_hitbox_value(AT_DAIR, 2, HG_BASE_KNOCKBACK, 6.5);//6
set_hitbox_value(AT_DAIR, 2, HG_KNOCKBACK_SCALING, .15);//.1
...
set_hitbox_value(AT_DAIR, 2, HG_HITSTUN_MULTIPLIER, 0.7); //1
