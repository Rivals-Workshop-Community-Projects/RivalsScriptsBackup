...
set_window_value(AT_USTRONG, 2, AG_WINDOW_LENGTH, 6);//5
...
set_window_value(AT_USTRONG, 4, AG_WINDOW_LENGTH, 19);//18
...
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_X, 13);//15
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_Y, -72);//-60
set_hitbox_value(AT_USTRONG, 1, HG_WIDTH, 44);//50
set_hitbox_value(AT_USTRONG, 1, HG_HEIGHT, 90);//120
set_hitbox_value(AT_USTRONG, 1, HG_SHAPE, 2);
set_hitbox_value(AT_USTRONG, 1, HG_PRIORITY, 2);
set_hitbox_value(AT_USTRONG, 1, HG_DAMAGE, 10);//11
set_hitbox_value(AT_USTRONG, 1, HG_ANGLE, 90);//105
set_hitbox_value(AT_USTRONG, 1, HG_BASE_KNOCKBACK, 10);
set_hitbox_value(AT_USTRONG, 1, HG_KNOCKBACK_SCALING, 0.95);//0.9
