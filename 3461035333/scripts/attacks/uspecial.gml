...
set_hitbox_value(AT_USPECIAL, 1, HG_WIDTH, 40);//50
set_hitbox_value(AT_USPECIAL, 1, HG_HEIGHT, 40);//50
...
set_hitbox_value(AT_USPECIAL, 1, HG_KNOCKBACK_SCALING, 0.3);//0.4
