...
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_Y, -83);
set_hitbox_value(AT_BAIR, 2, HG_WIDTH, 57);//50
...
set_hitbox_value(AT_BAIR, 4, HG_LIFETIME, 2);//3
set_hitbox_value(AT_BAIR, 4, HG_HITBOX_X, 34);
set_hitbox_value(AT_BAIR, 4, HG_HITBOX_Y, -55);
set_hitbox_value(AT_BAIR, 4, HG_WIDTH, 25);//25
set_hitbox_value(AT_BAIR, 4, HG_HEIGHT, 50); //40
...
set_hitbox_value(AT_BAIR, 4, HG_KNOCKBACK_SCALING, .1); //.2
set_hitbox_value(AT_BAIR, 4, HG_BASE_HITPAUSE, 6); //4
set_hitbox_value(AT_BAIR, 4, HG_HITPAUSE_SCALING, .1); //.2
set_hitbox_value(AT_BAIR, 4, HG_WINDOW_CREATION_FRAME, 0);
//set_hitbox_value(AT_BAIR, 4, HG_HITSTUN_MULTIPLIER, 1.0); //1.2
