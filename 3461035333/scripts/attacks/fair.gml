...
//Startup 
set_window_value(AT_FAIR, 1, AG_WINDOW_LENGTH, 6);//7
...
//Pre-kick 3
set_window_value(AT_FAIR, 4, AG_WINDOW_LENGTH, 7);//6
...
set_hitbox_value(AT_FAIR, 1, HG_WIDTH, 70);//80
set_hitbox_value(AT_FAIR, 1, HG_HEIGHT, 45);//40
...
set_hitbox_value(AT_FAIR, 1, HG_HITSTUN_MULTIPLIER, 0.8);//1
set_hitbox_value(AT_FAIR, 1, HG_SDI_MULTIPLIER, 1.2);// 1.3
...
set_hitbox_value(AT_FAIR, 3, HG_HEIGHT, 50);//40
...
set_hitbox_value(AT_FAIR, 3, HG_BASE_HITPAUSE, 9);//8
