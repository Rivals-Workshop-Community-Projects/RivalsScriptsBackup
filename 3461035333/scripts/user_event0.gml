...
//================Attacks================
//  Base Attacks
add_sprites("bair","dair","dattack","dspecial","dstrong","dstrong_air","dtilt","fair","fspecial","fstrong", "fstrong_air",
            "ftilt","jab","nair","nspecial", "nspecial_air", "nspecial_throw", "nspecial_throw_air", "taunt","uair","uspecial",
            "ustrong", "ustrong_air", "utilt", "fes");

//=================OTHER=================
//  hurt sprites
add_sprites("hurt", "bighurt", "bouncehurt","hurtground","spinhurt","uphurt","downhurt");
