...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_kragg_spike"));
...
set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_swipe_medium3"));
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, dirt_hfx_weak);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, dirt_hfx_weak);
...
set_hitbox_value(AT_USTRONG, 3, HG_VISUAL_EFFECT, blood_hfx_vertical);
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, asset_get("sfx_blow_heavy2"));
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_GROUP, 0);
set_hitbox_value(AT_USTRONG, 3, HG_HIT_PARTICLE_NUM, 3);