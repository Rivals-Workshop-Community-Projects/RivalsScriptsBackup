...
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT, dirt_hfx_weak);
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT_X_OFFSET, 8);
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT_Y_OFFSET, 8);
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, sound_get("sfx_deracine_hit1"));
...
set_hitbox_value(AT_DATTACK, 2, HG_WIDTH, 110);
...
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT, dirt_hfx_weak);
