...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_kragg_roll_end"));
...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_syl_fspecial_bite"));
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_bigplant_clamp"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_Y, -37);
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, dirt_hfx_weak);
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, dirt_hfx_weak);
...
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT, dirt_hfx_strong);
...
set_hitbox_value(AT_DSTRONG, 4, HG_VISUAL_EFFECT, dirt_hfx_weak);
...
set_hitbox_value(AT_DSTRONG, 4, HG_HIT_PARTICLE_NUM, 2);