...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sound_get("sfx_deracine_hit1"));
...
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, sound_get("sfx_deracine_hit1"));
set_hitbox_value(AT_NAIR, 2, HG_HITSTUN_MULTIPLIER, 0.8);
