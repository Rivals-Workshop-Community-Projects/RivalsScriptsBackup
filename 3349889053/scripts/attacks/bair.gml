...
set_window_value(AT_BAIR, 2, AG_WINDOW_SFX, sound_get("sfx_deracine_swing1"));
...
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, dirt_hfx_strong);
...
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT, dirt_hfx_weak);
