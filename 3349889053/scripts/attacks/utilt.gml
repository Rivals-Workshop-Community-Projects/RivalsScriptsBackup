...
set_window_value(AT_UTILT, 2, AG_WINDOW_SFX, asset_get("sfx_kragg_spike"));
...
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sound_get("sfx_deracine_hit1"));
...
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, dirt_hfx_weak);
