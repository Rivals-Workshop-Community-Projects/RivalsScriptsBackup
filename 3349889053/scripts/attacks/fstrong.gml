...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_kragg_roll_start"));
...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("sfx_deracine_gore3"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, blood_hfx_horizontal);
