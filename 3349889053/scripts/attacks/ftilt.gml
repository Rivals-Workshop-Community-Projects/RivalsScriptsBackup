...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, asset_get("sfx_burnapplied"));
...
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT, ghost_hfx_weak);
...
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT, ghost_hfx_weak);
