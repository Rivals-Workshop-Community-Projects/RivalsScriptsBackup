...
set_window_value(AT_FAIR, 4, AG_WINDOW_TYPE, 4);
set_window_value(AT_FAIR, 4, AG_WINDOW_LENGTH, 24);
...
set_window_value(AT_FAIR, 4, AG_WINDOW_SFX, sound_get("Glich3.1"));
...
set_window_value(AT_FAIR, 5, AG_WINDOW_HSPEED, -5);
set_window_value(AT_FAIR, 5, AG_WINDOW_VSPEED_TYPE, 1);
set_window_value(AT_FAIR, 5, AG_WINDOW_VSPEED, -1);
...
set_hitbox_value(AT_FAIR, 2, HG_BASE_HITPAUSE, 13);
