...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, sound_get("Glich6"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_Y, -100);
...
set_hitbox_value(AT_DSTRONG, 2, HG_ANGLE, 250);
...
set_hitbox_value(AT_DSTRONG, 6, HG_HITBOX_X, -12);
...
set_hitbox_value(AT_DSTRONG, 6, HG_ANGLE, 290);
...
set_hitbox_value(AT_DSTRONG, 6, HG_HITSTUN_MULTIPLIER, 0.5);
...
set_hitbox_value(AT_DSTRONG, 7, HG_KNOCKBACK_SCALING, 0.6);
...
set_hitbox_value(AT_DSTRONG, 7, HG_HITSTUN_MULTIPLIER, 0.5);
set_hitbox_value(AT_DSTRONG, 7, HG_HITBOX_GROUP, 3);

set_hitbox_value(AT_DSTRONG, 8, HG_PARENT_HITBOX, 8);
...
set_hitbox_value(AT_DSTRONG, 8, HG_HITBOX_X, 65);
set_hitbox_value(AT_DSTRONG, 8, HG_HITBOX_Y, -15);
...
set_hitbox_value(AT_DSTRONG, 8, HG_KNOCKBACK_SCALING, 0.6);
set_hitbox_value(AT_DSTRONG, 8, HG_BASE_HITPAUSE, 2);
set_hitbox_value(AT_DSTRONG, 8, HG_HITPAUSE_SCALING, .9);
set_hitbox_value(AT_DSTRONG, 8, HG_VISUAL_EFFECT, 13);
...
set_hitbox_value(AT_DSTRONG, 8, HG_HITSTUN_MULTIPLIER, 0.5);
