...
set_window_value(AT_DAIR, 1, AG_WINDOW_VSPEED, -0.1);
set_window_value(AT_DAIR, 1, AG_WINDOW_HSPEED, -0.1);
set_window_value(AT_DAIR, 1, AG_WINDOW_CUSTOM_GRAVITY, 1.0);
set_window_value(AT_DAIR, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sound_get("Glich10"));
...
set_window_value(AT_DAIR, 2, AG_WINDOW_SFX, sound_get("owl6"));
