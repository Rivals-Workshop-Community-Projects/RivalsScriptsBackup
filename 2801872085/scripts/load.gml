...
//______________________________________________________________________________Jab/Tilt
sprite_change_offset("jab", 40, 98);
sprite_change_offset("dattack", 60, 78);
sprite_change_offset("ftilt", 60, 98);
sprite_change_offset("dtilt", 80, 98);
sprite_change_offset("utilt", 40, 98);
//______________________________________________________________________________Air
sprite_change_offset("nair", 80, 98);
sprite_change_offset("fair", 80, 98);
sprite_change_offset("bair", 80, 98);
sprite_change_offset("uair", 64, 94);
sprite_change_offset("dair", 80, 94);
//______________________________________________________________________________Strong
sprite_change_offset("fstrong", 82, 98);
sprite_change_offset("ustrong", 100, 96);
...
sprite_change_offset("nspecial", 120, 98);
...
sprite_change_offset("ZZ1", 40, 98);
sprite_change_offset("ZZ2", 40, 80);
sprite_change_offset("ZZ3", 40, 98);
sprite_change_offset("ZZ4", 30, 80);
sprite_change_offset("ZZ5", 220, 80);
...
sprite_change_offset("ZZZ1", 160, 160);

//---------------------------------------------------------------------------------------------------------#
set_victory_theme( sound_get("TWRNormal10"));
