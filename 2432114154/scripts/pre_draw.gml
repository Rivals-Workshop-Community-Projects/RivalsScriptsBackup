...
if move_cooldown[AT_FSPECIAL_2] > 0 {
    if get_player_color(player) != 14 {
         ...
         draw_sprite_ext(sprite_get("galaxy1"), 0,  (room_width/2 + galax)/2 + 16,  room_height/2 - 30  + 100,7 - move_cooldown[AT_FSPECIAL_2]/30 ,7 - move_cooldown[AT_FSPECIAL_2]/30 ,0,-1,min(0.3,(move_cooldown[AT_FSPECIAL_2] - 90 )/120) );     
    	  gpu_set_blendmode(bm_add);   
          draw_sprite_ext(sprite_get("galaxy1"), 0,  (room_width/2 + galax)/2 + 16 ,  room_height/2 - 60 + move_cooldown[AT_FSPECIAL_2],3.5 - move_cooldown[AT_FSPECIAL_2]/240 ,3.5 - move_cooldown[AT_FSPECIAL_2]/240 ,0,-1,min(0.5,(move_cooldown[AT_FSPECIAL_2] - 60 )/120) );     
           gpu_set_blendmode(bm_normal);
  shader_start();  
    	 gpu_set_blendmode(bm_add);   
        draw_sprite_ext(sprite_get("galaxy1"), 2,  (room_width/2 + galax)/2 + 16 ,  room_height/2 - 60  + move_cooldown[AT_FSPECIAL_2],3.5 - move_cooldown[AT_FSPECIAL_2]/240 ,3.5 - move_cooldown[AT_FSPECIAL_2]/240 ,0,-1,min(0.5,(move_cooldown[AT_FSPECIAL_2] - 60 )/120) );     
         gpu_set_blendmode(bm_normal); 
shader_end(); 
    } else {
           draw_sprite_ext(sprite_get("galaxy1"), 1,  (room_width/2 + galax)/2 ,  room_height/2 + 100,7 - move_cooldown[AT_FSPECIAL_2]/30 ,7 - move_cooldown[AT_FSPECIAL_2]/30 ,0,-1,min(0.3,(move_cooldown[AT_FSPECIAL_2] - 90 )/120) );     
         	  gpu_set_blendmode(bm_add);
           draw_sprite_ext(sprite_get("galaxy1"), 1,  (room_width/2 + galax)/2 ,  room_height/2 + move_cooldown[AT_FSPECIAL_2],3.5 - move_cooldown[AT_FSPECIAL_2]/240 ,3.5 - move_cooldown[AT_FSPECIAL_2]/240 ,0,-1,min(0.6,(move_cooldown[AT_FSPECIAL_2] - 60 )/120) );     
         gpu_set_blendmode(bm_normal);    
     }
