...
set_hitbox_value(AT_EXTRA_3, 2, HG_HIT_SFX, asset_get("sfx_waterhit_heavy"));
set_hitbox_value(AT_EXTRA_3, 2, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_EXTRA_3, 2, HG_HITSTUN_MULTIPLIER, 1.4);
...
set_hitbox_value(AT_EXTRA_3, 1, HG_EXTRA_HITPAUSE, 25);
set_hitbox_value(AT_EXTRA_3, 1, HG_VISUAL_EFFECT_Y_OFFSET, -16);
set_hitbox_value(AT_EXTRA_3, 1, HG_HIT_SFX, asset_get("sfx_waterhit_heavy"));
set_hitbox_value(AT_EXTRA_3, 1, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_EXTRA_3, 1, HG_HITSTUN_MULTIPLIER, 1.4);
...
set_hitbox_value(AT_EXTRA_3, 5, HG_HITPAUSE_SCALING, .6);
set_hitbox_value(AT_EXTRA_3, 5, HG_EXTRA_HITPAUSE, 25);
set_hitbox_value(AT_EXTRA_3, 5, HG_VISUAL_EFFECT_Y_OFFSET, -16);
set_hitbox_value(AT_EXTRA_3, 5, HG_HIT_SFX, asset_get("sfx_waterhit_heavy"));
set_hitbox_value(AT_EXTRA_3, 5, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_EXTRA_3, 5, HG_HITSTUN_MULTIPLIER, 1.4);
