...
set_hitbox_value(AT_EXTRA_3, 2, HG_LIFETIME, 8);
...
set_hitbox_value(AT_EXTRA_3, 2, HG_HITSTUN_MULTIPLIER, 1.15);
set_hitbox_value(AT_EXTRA_3, 2, HG_HIT_LOCKOUT, 8);
...
set_hitbox_value(AT_EXTRA_3, 1, HG_WIDTH, 81);
set_hitbox_value(AT_EXTRA_3, 1, HG_HEIGHT, 81);
...
set_hitbox_value(AT_EXTRA_3, 1, HG_HIT_LOCKOUT, 8);
