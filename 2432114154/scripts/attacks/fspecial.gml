...
set_hitbox_value(AT_FSPECIAL, 4, HG_LIFETIME, 300);
...
set_hitbox_value(AT_FSPECIAL, 4, HG_PROJECTILE_DESTROY_EFFECT, 304);
...
set_hitbox_value(AT_FSPECIAL, 4, HG_HIT_SFX, sound_get("counterhit"));
set_hitbox_value(AT_FSPECIAL, 4, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_FSPECIAL, 4, HG_VISUAL_EFFECT, SC);
...
set_hitbox_value(AT_FSPECIAL, 5, HG_HIT_SFX, sound_get("counterhit"));
set_hitbox_value(AT_FSPECIAL, 5, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_FSPECIAL, 5, HG_PROJECTILE_PARRY_STUN, 1);
set_hitbox_value(AT_FSPECIAL, 5, HG_VISUAL_EFFECT, SC);
...
set_hitbox_value(AT_FSPECIAL, 6, HG_PROJECTILE_DESTROY_EFFECT, 304);
...
set_hitbox_value(AT_FSPECIAL, 6, HG_HIT_SFX, sound_get("counterhit"));
set_hitbox_value(AT_FSPECIAL, 6, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_FSPECIAL, 6, HG_PROJECTILE_PARRY_STUN, 1);
set_hitbox_value(AT_FSPECIAL, 6, HG_VISUAL_EFFECT, SC);
set_hitbox_value(AT_FSPECIAL, 6, HG_HITSTUN_MULTIPLIER, 0.7);
