...
set_window_value(AT_NAIR, 7, AG_WINDOW_ANIM_FRAME_START, 9);
...
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, asset_get("sfx_poison_hit_weak"));
...
set_hitbox_value(AT_NAIR, 3, HG_VISUAL_EFFECT_X_OFFSET, 15);
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, asset_get("sfx_poison_hit_weak"));
...
set_hitbox_value(AT_NAIR, 4, HG_HIT_SFX, asset_get("sfx_poison_hit_weak"));
