...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("hit_metal_weak1"));
...
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, sound_get("hit_metal_weak1"));
...
set_hitbox_value(AT_BAIR, 3, HG_HIT_SFX, sound_get("hit_metal_weak1"));
...
set_hitbox_value(AT_BAIR, 4, HG_HITBOX_X, -45);
...
set_hitbox_value(AT_BAIR, 4, HG_ANGLE, 280);
...
set_hitbox_value(AT_BAIR, 4, HG_BASE_HITPAUSE, 25);
set_hitbox_value(AT_BAIR, 4, HG_HITPAUSE_SCALING, .9);
set_hitbox_value(AT_BAIR, 4, HG_HIT_SFX, sound_get("cut"));
