...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("smog_shot"));
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX, sound_get("smogspew"));
...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_SFX, sound_get("smogspew"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_BASE_KNOCKBACK, 4.20);
set_hitbox_value(AT_FSTRONG, 1, HG_KNOCKBACK_SCALING, 1.8);
...
set_hitbox_value(AT_FSTRONG, 1, HG_PROJECTILE_SPRITE, sprite_get("smog"));
set_hitbox_value(AT_FSTRONG, 1, HG_PROJECTILE_DESTROY_EFFECT, 1);
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, smog);
...
set_hitbox_value(AT_FSTRONG, 1, HG_PROJECTILE_AIR_FRICTION, 0.24);
...
set_hitbox_value(AT_FSTRONG, 2, HG_PROJECTILE_SPRITE, sprite_get("smogdestroy"));
set_hitbox_value(AT_FSTRONG, 2, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_FSTRONG, 2, HG_PROJECTILE_ANIM_SPEED, 0.15);
