...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("darkwhatever"));
...
set_hitbox_value(AT_UTILT, 1, HG_WIDTH, 98);
set_hitbox_value(AT_UTILT, 1, HG_HEIGHT, 98);
...
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sound_get("hit_darkpulse"));
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, pulse);
...
set_hitbox_value(AT_UTILT, 2, HG_HITBOX_Y, -101);
...
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, sound_get("hit_punch"));
set_hitbox_value(AT_UTILT, 2, HG_ANGLE_FLIPPER, 4);
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, pulse);