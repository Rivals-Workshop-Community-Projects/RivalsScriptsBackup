...
set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, sound_get("huf"));

set_window_value(AT_FAIR, 2, AG_WINDOW_LENGTH, 4);
set_window_value(AT_FAIR, 2, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_FAIR, 2, AG_WINDOW_ANIM_FRAME_START, 1);
set_window_value(AT_FAIR, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FAIR, 2, AG_WINDOW_SFX, sound_get("firespit"));
...
set_window_value(AT_FAIR, 6, AG_WINDOW_ANIM_FRAMES, 5);
...
set_hitbox_value(AT_FAIR, 1, HG_KNOCKBACK_SCALING, .15);
set_hitbox_value(AT_FAIR, 1, HG_BASE_HITPAUSE, 3);
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, sound_get("hit_fire_weak"));
...
set_hitbox_value(AT_FAIR, 2, HG_HITBOX_Y, 2);
set_hitbox_value(AT_FAIR, 2, HG_WIDTH, 82);
...
set_hitbox_value(AT_FAIR, 2, HG_HIT_SFX, sound_get("hit_fire_weak"));
...
set_hitbox_value(AT_FAIR, 3, HG_HIT_SFX, sound_get("hit_fire_med"));
set_hitbox_value(AT_FAIR, 3, HG_HITBOX_GROUP, 3);
set_hitbox_value(AT_FAIR, 3, HG_VISUAL_EFFECT, 148);