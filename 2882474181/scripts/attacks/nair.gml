...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sound_get("hit_punch"));
...
set_hitbox_value(AT_NAIR, 3, HG_WIDTH, 125);
set_hitbox_value(AT_NAIR, 3, HG_HEIGHT, 125);
...
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, sound_get("hit_punch2"));
