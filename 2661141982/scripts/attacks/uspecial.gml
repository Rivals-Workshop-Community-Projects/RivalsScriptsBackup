...
set_hitbox_value(AT_USPECIAL, 1, HG_HITBOX_X, 15);//19
set_hitbox_value(AT_USPECIAL, 1, HG_HITBOX_Y, -40);//65
...
set_hitbox_value(AT_USPECIAL, 2, HG_HITBOX_X, 16);//19
set_hitbox_value(AT_USPECIAL, 2, HG_HITBOX_Y, -54);
set_hitbox_value(AT_USPECIAL, 2, HG_WIDTH, 41);//50
