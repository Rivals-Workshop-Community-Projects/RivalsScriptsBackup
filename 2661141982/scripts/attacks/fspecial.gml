...
set_window_value(AT_FSPECIAL, 6, AG_WINDOW_ANIM_FRAME_START, 20);
...
set_window_value(AT_FSPECIAL, 6, AG_WINDOW_SFX, asset_get("sfx_swish_medium"));
...
set_window_value(AT_FSPECIAL, 7, AG_WINDOW_ANIM_FRAME_START, 23);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_ANGLE_FLIPPER, 10);// lol flippers
set_hitbox_value(AT_FSPECIAL, 2, HG_ANGLE_FLIPPER, 10);// lol flippers
set_hitbox_value(AT_FSPECIAL, 3, HG_ANGLE_FLIPPER, 10);// lol flippers
// set_hitbox_value(AT_FSPECIAL, 1, HG_EXTRA_HITPAUSE, 2);// lol flippers
// set_hitbox_value(AT_FSPECIAL, 2, HG_EXTRA_HITPAUSE, 2);// lol flippers
// set_hitbox_value(AT_FSPECIAL, 3, HG_EXTRA_HITPAUSE, 2);// lol flippers
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HITBOX_Y, -21);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_HITBOX_Y, -21);
...
set_hitbox_value(AT_FSPECIAL, 4, HG_HITBOX_TYPE, 1);//default last hit
...
set_hitbox_value(AT_FSPECIAL, 4, HG_KNOCKBACK_SCALING, .8);
set_hitbox_value(AT_FSPECIAL, 4, HG_HIT_SFX, asset_get("sfx_poison_hit_strong"));
...
set_hitbox_value(AT_FSPECIAL, 4, HG_VISUAL_EFFECT, uspec_large);

set_hitbox_value(AT_FSPECIAL, 5, HG_HITBOX_TYPE, 1);//rekka
set_hitbox_value(AT_FSPECIAL, 5, HG_WINDOW, 7);
//set_hitbox_value(AT_FSPECIAL, 5, HG_WINDOW_CREATION_FRAME, 15);
set_hitbox_value(AT_FSPECIAL, 5, HG_LIFETIME, 4);
set_hitbox_value(AT_FSPECIAL, 5, HG_HITBOX_X, 24);
...
set_hitbox_value(AT_FSPECIAL, 5, HG_PRIORITY, 7);
set_hitbox_value(AT_FSPECIAL, 5, HG_BASE_KNOCKBACK, 8);
//set_hitbox_value(AT_FSPECIAL, 5, HG_EXTRA_HITPAUSE, 2);
