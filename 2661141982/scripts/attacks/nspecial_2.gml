...
set_window_value(AT_NSPECIAL_2, 1, AG_WINDOW_SFX, asset_get("sfx_clairen_hit_strong"));
...
set_window_value(AT_NSPECIAL_2, 2, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy2"));
...
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HIT_SFX, asset_get("sfx_abyss_explosion"));
...
set_hitbox_value(AT_NSPECIAL_2, 2, HG_BASE_KNOCKBACK, 6);//7
set_hitbox_value(AT_NSPECIAL_2, 2, HG_KNOCKBACK_SCALING, .6);//.8
set_hitbox_value(AT_NSPECIAL_2, 2, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_NSPECIAL_2, 2, HG_HITPAUSE_SCALING, .4);
set_hitbox_value(AT_NSPECIAL_2, 2, HG_HIT_SFX, asset_get("sfx_absa_whip3"));
