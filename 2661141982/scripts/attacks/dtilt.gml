...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, asset_get("sfx_swish_medium"));
set_window_value(AT_DTILT, 2, AG_WINDOW_HITPAUSE_FRAME, 2);

set_window_value(AT_DTILT, 3, AG_WINDOW_LENGTH, 8);//12
...
set_hitbox_value(AT_DTILT, 1, HG_HEIGHT, 31);
...
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT, small);
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, asset_get("sfx_blow_medium2"));
set_hitbox_value(AT_DTILT, 1, HG_IGNORES_PROJECTILES, 1);
