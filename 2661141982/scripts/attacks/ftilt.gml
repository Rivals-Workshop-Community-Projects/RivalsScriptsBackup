...
//set_window_value(AT_FTILT, 1, AG_WINDOW_VSPEED, -2);
...
set_window_value(AT_FTILT, 3, AG_WINDOW_SFX_FRAME, 11);
//hit
...
set_hitbox_value(AT_FTILT, 2, HG_HEIGHT, 62);
...
set_hitbox_value(AT_FTILT, 2, HG_KNOCKBACK_SCALING, .6);//.2
