...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_VISUAL_EFFECT, ewgf_fx);
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_KNOCKBACK_SCALING, 1.0);
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_VISUAL_EFFECT, ewgf_fx);
