...
set_window_value(AT_DAIR, 7, AG_WINDOW_HAS_SFX, 0);
set_window_value(AT_DAIR, 7, AG_WINDOW_SFX, asset_get("sfx_clairen_swing_strong"));
set_window_value(AT_DAIR, 7, AG_WINDOW_SFX_FRAME, 0);
...
set_window_value(AT_DAIR, 8, AG_WINDOW_SFX, asset_get("sfx_clairen_swing_weak"));
...
set_window_value(AT_DAIR, 9, AG_WINDOW_ANIM_FRAME_START, 21);
...
set_hitbox_value(AT_DAIR, 2, HG_HITSTUN_MULTIPLIER, 0.3);
...
set_hitbox_value(AT_DAIR, 5, HG_DAMAGE, 10);
set_hitbox_value(AT_DAIR, 5, HG_SHAPE, 0);
set_hitbox_value(AT_DAIR, 5, HG_ANGLE, 272);
...
set_hitbox_value(AT_DAIR, 5, HG_VISUAL_EFFECT, 306);
set_hitbox_value(AT_DAIR, 5, HG_EXTRA_CAMERA_SHAKE, 1);
set_hitbox_value(AT_DAIR, 5, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_DAIR, 5, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_DAIR, 5, HG_HIT_SFX, asset_get("sfx_clairen_swing_mega_instant"));
...
set_hitbox_value(AT_DAIR, 6, HG_VISUAL_EFFECT, 306);
set_hitbox_value(AT_DAIR, 6, HG_EXTRA_CAMERA_SHAKE, 1);
set_hitbox_value(AT_DAIR, 6, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_DAIR, 6, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_DAIR, 6, HG_HIT_SFX, asset_get("sfx_clairen_swing_mega_instant"));
...
set_hitbox_value(AT_DAIR, 7, HG_VISUAL_EFFECT, 306);
set_hitbox_value(AT_DAIR, 7, HG_EXTRA_CAMERA_SHAKE, 1);
set_hitbox_value(AT_DAIR, 7, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_DAIR, 7, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_DAIR, 7, HG_HIT_SFX, asset_get("sfx_clairen_swing_mega_instant"));
