...
set_hitbox_value(AT_FTILT, 1, HG_ANGLE, 46);
...
set_hitbox_value(AT_FTILT, 2, HG_PROJECTILE_SPRITE, sprite_get("empty"));
...
set_hitbox_value(AT_FTILT, 2, HG_ANGLE, 46);
...
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, asset_get("sfx_ori_energyhit_medium"));
...
set_hitbox_value(AT_FTILT, 2, HG_PROJECTILE_UNBASHABLE, true);
set_hitbox_value(AT_FTILT, 2, HG_PROJECTILE_DOES_NOT_REFLECT, true);