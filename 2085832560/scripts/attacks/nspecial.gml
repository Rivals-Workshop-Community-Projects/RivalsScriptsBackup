...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_ANIM_FRAME_START, 14);
...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_ell_eject"));
...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_ell_cooldown"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_shovel_hit_heavy1"));
