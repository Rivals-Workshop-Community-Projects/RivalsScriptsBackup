...
set_hitbox_value(AT_UTILT, 1, HG_HITPAUSE_SCALING, .9);
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, -11);
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, asset_get("sfx_clairen_tip_strong"));
...
set_hitbox_value(AT_UTILT, 2, HG_HITBOX_X, 06);
...
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, asset_get("sfx_clairen_tip_strong"));
