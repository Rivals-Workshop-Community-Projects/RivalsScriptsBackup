...
set_hitbox_value(AT_DAIR, 1, HG_WIDTH, 128);
...
set_hitbox_value(AT_DAIR, 1, HG_MUNO_HITBOX_NAME, "Normal");
...
set_hitbox_value(AT_DAIR, 2, HG_LIGHT_GIMMICK, 1);
set_hitbox_value(AT_DAIR, 2, HG_MUNO_HITBOX_MISC_ADD, light_gimmick_desc);
