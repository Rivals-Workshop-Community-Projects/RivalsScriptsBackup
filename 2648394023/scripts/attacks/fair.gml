...
set_hitbox_value(AT_FAIR, 1, HG_HITBOX_X, 32); // 48
set_hitbox_value(AT_FAIR, 1, HG_HITBOX_Y, -36); // -24
set_hitbox_value(AT_FAIR, 1, HG_WIDTH, 96); // 72
set_hitbox_value(AT_FAIR, 1, HG_HEIGHT, 76); // 56
