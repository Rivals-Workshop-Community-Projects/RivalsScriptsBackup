...
sfx_ssbu_bouncing_fish = sound_get("ssbu_bouncing_fish");
...
vfx_wavelengths = [
    hit_fx_create(sprite_get("vfx_wavelength_uv"), 24),
    hit_fx_create(sprite_get("vfx_wavelength_ir"), 24),
    ];
vfx_hit_small = hit_fx_create(sprite_get("vfx_hit_small"), 24);
vfx_hit_med = hit_fx_create(sprite_get("vfx_hit_med"), 24);
vfx_hit_big = hit_fx_create(sprite_get("vfx_hit_big"), 24);
vfx_stasis_arrow = hit_fx_create(sprite_get("vfx_stasis_arrow"), 20);
vfx_prism_reticle = hit_fx_create(sprite_get("vfx_prism_reticle"), 30);

set_hit_particle_sprite(1, sprite_get("vfx_sparkle_particle"));

// Variables
orig_gravity = gravity_speed;
gravity_mult = 0.35;
fall_mult = 0.6;
nspecial_charge = 0;
nspecial_charge_max = 3;
...
ir = 0; // 0 UV, 1 IR
ir_change_timer = 0;
ir_change_timer_max = 4;

var alt_cur = get_player_color(player);
wing_colors = [[
    make_color_rgb(
        get_color_profile_slot_r(alt_cur, 2),
        get_color_profile_slot_g(alt_cur, 2),
        get_color_profile_slot_b(alt_cur, 2)
        ),
    make_color_rgb(
        get_color_profile_slot_r(alt_cur, 3),
        get_color_profile_slot_g(alt_cur, 3),
        get_color_profile_slot_b(alt_cur, 3)
        ),
        ],[
    make_color_rgb(
...
HG_LIGHT_GIMMICK = 150; // 2 = no special sfx
light_gimmick_desc = "Photon Hit";
...
// Jumps
double_jump_time    = 13;		// 24   -  40
walljump_time       = 10;		// 18   -  32
...
set_victory_theme(sound_get("glare_wins")); // victory_theme.ogg
