...
draw_sprite_part_ext(sprite_get("idle"), anim_timer/6, 0, 0, 100, 200, x + 8, y - 12 + 82, 2, 2, c_white, alpha_alt);
shader_end();

draw_set_halign(fa_left);
textDraw(x + 14, y + 44, "fName", make_color_rgb(get_color_profile_slot_r(alt_cur, 2), get_color_profile_slot_g(alt_cur, 2), get_color_profile_slot_b(alt_cur, 2)), 14, 400, 1, 1, alpha_alt, alt_name[alt_cur], c_black);
draw_set_halign(fa_left);
