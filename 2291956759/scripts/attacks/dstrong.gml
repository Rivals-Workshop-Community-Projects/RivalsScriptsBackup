...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_ice_on_player"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("SpaceCut"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_WIDTH, 170);
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, SC);
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT_Y_OFFSET, 0);
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("SpaceCut"));
