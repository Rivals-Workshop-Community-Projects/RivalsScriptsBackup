...
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX, asset_get("sfx_orca_absorb"));
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_SFX, asset_get("sfx_forsburn_disappear"));
...
set_window_value(AT_DATTACK, 4, AG_WINDOW_SFX, asset_get("sfx_forsburn_reappear"));
...
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, asset_get("sfx_waterhit_heavy2"));
...
set_hitbox_value(AT_DATTACK, 2, HG_ANGLE, 54);
set_hitbox_value(AT_DATTACK, 2, HG_SHAPE, 0);
set_hitbox_value(AT_DATTACK, 2, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_DATTACK, 2, HG_KNOCKBACK_SCALING, 0.55);
