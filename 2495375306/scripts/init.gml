...
walljump_vsp        = 7;		// 7    -  10
land_time           = 4;		// 4    -  6
prat_land_time      = 6;		// 3    -  24       zetterburn's is 3, but that's ONLY because his uspecial is so slow. safer up b (or other move) = longer pratland time to compensate
...
//Sprites
spr_nspecial_proj = sprite_get("nspecial_icons");
spr_example = sprite_get("diamond_air"); // sprites/example_stripX.png
...
has_fail = true;
fail_text = "TIME PARADOX";
fail_timer = 600;
fail_alpha = 0;
other_has_fail = false;
...
// Hurtbox sprites
hurtbox_spr         = sprite_get("henry_hurt");
crouchbox_spr       = sprite_get("henry_hurt_crouch");
air_hurtbox_spr     = -1; // -1 = use hurtbox_spr
hitstun_hurtbox_spr = -1; // -1 = use hurtbox_spr

// Victory
set_victory_bg(sprite_get("victory_bg")); // victory_background.png
set_victory_theme(sound_get("mus_henry_wins")); // victory_theme.ogg
