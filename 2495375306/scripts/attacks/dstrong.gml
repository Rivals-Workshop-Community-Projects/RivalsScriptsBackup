...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_swipe_weak2"));
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_SFX, asset_get("sfx_blow_medium1"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_ANGLE, 64);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITPAUSE_SCALING, 0.25);
