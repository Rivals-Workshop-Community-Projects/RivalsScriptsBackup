...
set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX, sound_get("sfx_chainsaw2"));
...
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, asset_get("sfx_metal_hit_weak"));
...
set_hitbox_value(AT_USTRONG, 4, HG_HIT_SFX, asset_get("sfx_metal_hit_weak"));
...
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_X, 10);
set_hitbox_value(AT_USTRONG, 5, HG_WIDTH, 20);
...
set_hitbox_value(AT_USTRONG, 5, HG_HIT_SFX, asset_get("sfx_metal_hit_weak"));