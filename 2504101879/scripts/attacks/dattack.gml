...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, asset_get("sfx_ori_bash_launch"));
...
set_window_value(AT_DATTACK, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.3);
//end
...
set_hitbox_value(AT_DATTACK, 1, HG_ANGLE, 49);
