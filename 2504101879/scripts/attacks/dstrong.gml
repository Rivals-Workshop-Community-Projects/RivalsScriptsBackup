...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, sfx_babythrow);
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_SFX, sfx_babythrow);
...
set_window_value(AT_DSTRONG, 5, AG_WINDOW_SFX, sfx_babythrow);
//end
...
set_hitbox_value(AT_DSTRONG, 1, HG_ANGLE, 131);
...
set_hitbox_value(AT_DSTRONG, 2, HG_ANGLE, 46);
