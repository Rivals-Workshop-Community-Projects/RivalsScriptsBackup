...
//end
set_window_value(AT_USTRONG, 8, AG_WINDOW_LENGTH, 24);
...
set_hitbox_value(AT_USTRONG, 1, HG_LIFETIME, get_window_value(AT_USTRONG, 5, AG_WINDOW_LENGTH));
...
set_hitbox_value(AT_USTRONG, 3, HG_LIFETIME, get_window_value(AT_USTRONG, 6, AG_WINDOW_LENGTH));
...
set_hitbox_value(AT_USTRONG, 3, HG_ANGLE, 36);
