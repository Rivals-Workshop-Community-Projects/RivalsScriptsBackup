...
sprite_index = sprite_get("hook");           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
...
hookspeed = 3;
hookrange = 230;
hookdespawnrange = 290;
ispulled = false;
//hook placement on enemy
latchedid = player_id;
hxoffset = 0;
hyoffset = 0;
htemp_x = 0;
...
new_sprite = sprite_get("hook");             //This is another part of the animation handling. It tells the game "this is the sprite this article should be using; if it's not already, switch it over please"
