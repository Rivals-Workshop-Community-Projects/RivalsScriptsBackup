...
if (!variable_instance_exists(id,"ae") || ye == true){
    ...
    //--- ---
    altsel = sound_get("_pho_move"); // change the alt select sound here. if you don't want to change the sound, put 0 here.
    ...
    ce[0,0] = make_color_rgb(255, 255, 255) // "color preview square" color. can be any color!
    ...
    ce[1,0] = make_color_rgb(79, 79, 79)
    ce[1,1] = "Player 2"
    ce[1,2] = ""
    ce[2,0] = make_color_rgb(255, 239, 87)
    ce[2,1] = "Player 3"
    ce[2,2] = ""
    ce[3,0] = make_color_rgb(189, 94, 26)
    ce[3,1] = "Player 4"
    ce[3,2] = ""
    ce[4,0] = make_color_rgb(0, 133, 74)
    ce[4,1] = "Player 5"
    ce[4,2] = ""
    ce[5,0] = make_color_rgb(255, 105, 117)
    ce[5,1] = "Player 6"
    ce[5,2] = ""
    ce[6,0] = make_color_rgb(49, 162, 242)
    ce[6,1] = "Player 7"
    ce[6,2] = ""
    ce[7,0] = make_color_rgb(175, 85, 221)
    ce[7,1] = "Player 8"
    ce[7,2] = ""
    ce[8,0] = make_color_rgb(86, 84, 146)
    ce[8,1] = "Abyss"
    ce[8,2] = ""
    ce[9,0] = make_color_rgb(167, 186, 74)
    ce[9,1] = "Game Boy"
    ce[9,2] = ""
    ce[10,0] = make_color_rgb(232, 147, 186)
    ce[10,1] = "Pink"
    ce[10,2] = ""
    ce[11,0] = make_color_rgb(99, 207, 186)
    ce[11,1] = "Aqua"
    ce[11,2] = ""    
    ce[12,0] = make_color_rgb(91, 44, 140)
    ce[12,1] = "Purple"
    ce[12,2] = ""
    ce[13,0] = make_color_rgb(169, 86, 144)
    ce[13,1] = "Wrastor"
    ce[13,2] = ""
    ce[14,0] = make_color_rgb(44, 72, 116)
    ce[14,1] = "Bradshaw"
    ce[14,2] = ""
    ce[15,0] = make_color_rgb(103, 108, 173)
    ce[15,1] = "Bird Guy"
    ce[15,2] = ""    
