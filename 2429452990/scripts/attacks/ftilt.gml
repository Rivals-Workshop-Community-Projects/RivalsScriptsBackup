...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, sound_get("duck_duelingpistol"));
...
set_hitbox_value(AT_FTILT, 1, HG_ANGLE, 25);
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, asset_get("sfx_obstacle_hit"));
