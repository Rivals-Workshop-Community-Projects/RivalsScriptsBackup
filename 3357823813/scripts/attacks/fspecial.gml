...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.05);
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.05);
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_SFX, sound_get("sfx_claw_swipe_weak1"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT, fx_smash_grab);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HITBOX_Y, -110);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_VISUAL_EFFECT, fx_blood_hit1);
set_hitbox_value(AT_FSPECIAL, 2, HG_VISUAL_EFFECT_Y_OFFSET, 12);
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, sound_get("sfx_claw_impact_weak1"));
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_PARTICLE_NUM, 6);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_HEIGHT, 72);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_VISUAL_EFFECT, fx_blood_hit1);
set_hitbox_value(AT_FSPECIAL, 3, HG_VISUAL_EFFECT_Y_OFFSET, 12);
set_hitbox_value(AT_FSPECIAL, 3, HG_HIT_SFX, sound_get("sfx_claw_impact_weak1"));
set_hitbox_value(AT_FSPECIAL, 3, HG_HIT_PARTICLE_NUM, 6);
...
set_hitbox_value(AT_FSPECIAL, 4, HG_VISUAL_EFFECT, fx_blood_hit2);
set_hitbox_value(AT_FSPECIAL, 4, HG_VISUAL_EFFECT_Y_OFFSET, 12);
set_hitbox_value(AT_FSPECIAL, 4, HG_HIT_SFX, sound_get("sfx_claw_impact_medium1"));
set_hitbox_value(AT_FSPECIAL, 4, HG_HIT_PARTICLE_NUM, 6);
