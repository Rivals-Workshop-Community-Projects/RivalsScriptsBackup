...
//Can Transition to Dark Inferno
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_LENGTH, 10);
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("sfx_cape_swipe_soft1"));
...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_SFX, sound_get("sfx_cape_swipe_hard2"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, fx_nspecial_swirl);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HITBOX_X, 49);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HIT_SFX, asset_get("blow1_sfx"));
set_hitbox_value(AT_NSPECIAL, 2, HG_VISUAL_EFFECT, 1);
set_hitbox_value(AT_NSPECIAL, 2, HG_HIT_PARTICLE_NUM, 2);
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_DESTROY_EFFECT, fx_nspecial_swirl);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_HIT_SFX, asset_get("blow1_sfx"));
set_hitbox_value(AT_NSPECIAL, 3, HG_VISUAL_EFFECT, 1);
set_hitbox_value(AT_NSPECIAL, 3, HG_HIT_PARTICLE_NUM, 2);
set_hitbox_value(AT_NSPECIAL, 3, HG_PROJECTILE_DESTROY_EFFECT, fx_nspecial_swirl);
