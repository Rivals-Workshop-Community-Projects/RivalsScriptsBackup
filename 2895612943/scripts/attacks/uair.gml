...
set_attack_value(AT_UAIR, AG_SPRITE_BITE, sprite_get("bite_uair"));
...
set_window_value(AT_UAIR, 1, AG_STARTUP, 1)

set_window_value(AT_UAIR, 2, AG_WINDOW_TYPE, 1);
set_window_value(AT_UAIR, 2, AG_WINDOW_LENGTH, 3);
set_window_value(AT_UAIR, 2, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_UAIR, 2, AG_WINDOW_ANIM_FRAME_START, 3);
set_window_value(AT_UAIR, 2, AG_ACTIVE, 1)
...
set_hitbox_value(AT_UAIR, 1, HG_KNOCKBACK_SCALING, 0.95);
