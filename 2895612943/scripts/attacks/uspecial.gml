...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_buzzsaw_hit"));
set_window_value(AT_USPECIAL, 4, AG_WINDOW_SFX_FRAME, 8);

set_window_value(AT_USPECIAL, 5, AG_WINDOW_LENGTH, 123);
...
set_window_value(AT_USPECIAL, 6, AG_WINDOW_SFX, asset_get("sfx_buzzsaw_throw"));
set_window_value(AT_USPECIAL, 6, AG_WINDOW_SFX_FRAME, 1);

set_num_hitboxes(AT_USPECIAL, 2);

/* dsgafbkjbnfdkjnadsfkjnsdfkjlnasdjkfnaskldjmnvcklmsdvclkamsdvlkmasdklvmlkaefmlkaewsfiojerwoijdfklsdmvlkmdsflkmsdlkfmaselkrfjnapliewujfnaksjldvnlakjdnvkjdfnvkljdnfgjnaerdsgfiuhjaerifujhn Idk
...
set_hitbox_value(AT_USPECIAL, 2, HG_LIFETIME, 90);
...
set_hitbox_value(AT_USPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("bamboo_proj"));
set_hitbox_value(AT_USPECIAL, 2, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_USPECIAL, 2, HG_PROJECTILE_GRAVITY, .25);
set_hitbox_value(AT_USPECIAL, 2, HG_PROJECTILE_WALL_BEHAVIOR, 2);
set_hitbox_value(AT_USPECIAL, 2, HG_PROJECTILE_GROUND_BEHAVIOR, 0);
