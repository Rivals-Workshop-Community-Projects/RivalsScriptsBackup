...
set_hitbox_value(AT_NAIR, 1, HG_HEIGHT, 61);
set_hitbox_value(AT_NAIR, 1, HG_PRIORITY, 1);
set_hitbox_value(AT_NAIR, 1, HG_DAMAGE, 5);
set_hitbox_value(AT_NAIR, 1, HG_ANGLE, 50);
//set_hitbox_value(AT_NAIR, 1, HG_ANGLE_FLIPPER, 3); //horizontally away from center
set_hitbox_value(AT_NAIR, 1, HG_BASE_KNOCKBACK, 6.3);
...
set_hitbox_value(AT_NAIR, 2, HG_BASE_KNOCKBACK, 6.3);
