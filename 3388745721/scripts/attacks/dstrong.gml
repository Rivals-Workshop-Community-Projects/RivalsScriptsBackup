...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, fx_gus_flame_small);
...
set_hitbox_value(AT_DSTRONG, 2, HG_ANGLE, 160);
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, fx_gus_flame_small);
...
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT, fx_gus_flame_small);
...
set_hitbox_value(AT_DSTRONG, 4, HG_VISUAL_EFFECT, fx_gus_flame_large);
