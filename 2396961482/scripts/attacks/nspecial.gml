...
set_hitbox_value(AT_NSPECIAL, 1, HG_KNOCKBACK_SCALING, .10);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_KNOCKBACK_SCALING, 1);//.25
...
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_HSPEED, 1.5);
