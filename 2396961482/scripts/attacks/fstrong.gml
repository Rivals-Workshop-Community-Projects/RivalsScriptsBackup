...
set_hitbox_value(AT_FSTRONG, 2, HG_DAMAGE, 13);//8
set_hitbox_value(AT_FSTRONG, 2, HG_KNOCKBACK_SCALING, .9);
set_hitbox_value(AT_FSTRONG, 2, HG_BASE_HITPAUSE, 10);//20
set_hitbox_value(AT_FSTRONG, 2, HG_HITPAUSE_SCALING, 1);
set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT, 9);
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, asset_get("sfx_bubblepop"));
