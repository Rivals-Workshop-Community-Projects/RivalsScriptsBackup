...
set_hitbox_value(AT_USPECIAL_2, 1, HG_KNOCKBACK_SCALING, 1.2);
...
set_hitbox_value(AT_USPECIAL_2, 1, HG_HIT_SFX, asset_get("sfx_infinidagger"));
...
set_hitbox_value(AT_USPECIAL_2, 2, HG_HIT_SFX, asset_get("sfx_infinidagger"));
