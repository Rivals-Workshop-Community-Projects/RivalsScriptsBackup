...
//set_window_value(AT_USPECIAL, 2, AG_WINDOW_HAS_WHIFFLAG, 1);
...
set_hitbox_value(AT_USPECIAL, 2, HG_HIT_SFX, asset_get("sfx_infinidagger"));
...
set_hitbox_value(AT_USPECIAL, 3, HG_HIT_SFX, asset_get("sfx_infinidagger"));
