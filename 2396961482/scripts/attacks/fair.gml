...
set_hitbox_value(AT_FAIR, 1, HG_WIDTH, 65);//50
...
set_hitbox_value(AT_FAIR, 2, HG_HEIGHT, 20);//20
...
set_hitbox_value(AT_FAIR, 2, HG_HIT_SFX, asset_get("sfx_shovel_hit_heavy2"));
