...
sprite_change_offset("jumpstart", 50, 78);
sprite_change_offset("jump", 40, 98);
sprite_change_offset("doublejump", 40, 68);
sprite_change_offset("walljump", 50, 98);
sprite_change_offset("pratfall", 40, 98);
sprite_change_offset("land", 50, 78);
sprite_change_offset("landinglag", 50, 78);

sprite_change_offset("parry", 50, 78);
sprite_change_offset("roll_forward", 50, 78);
sprite_change_offset("roll_backward", 50, 78);
sprite_change_offset("airdodge", 40, 98);
sprite_change_offset("waveland", 40, 78);
sprite_change_offset("tech", 50, 78);

sprite_change_offset("jab", 50, 78);
sprite_change_offset("dattack", 50, 78);
sprite_change_offset("ftilt", 50, 78);
...
sprite_change_offset("ustrong", 50, 118);
