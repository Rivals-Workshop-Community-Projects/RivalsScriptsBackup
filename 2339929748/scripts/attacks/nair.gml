...
set_hitbox_value(AT_NAIR, 1, HG_WIDTH, 161);
set_hitbox_value(AT_NAIR, 1, HG_HEIGHT, 156);
...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sound_get("destroy_sound_effect"));
...
set_hitbox_value(AT_NAIR, 3, HG_WIDTH, 161);
set_hitbox_value(AT_NAIR, 3, HG_HEIGHT, 156);
...
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, sound_get("destroy_final_hit"));
