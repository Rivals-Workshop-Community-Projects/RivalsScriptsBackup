...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX, sound_get("blocksound"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HIT_SFX, sound_get("end"));

//bl_select = 5, low damage, massive hitstun.
...
set_hitbox_value(AT_DSPECIAL, 2, HG_EFFECT, 5);
set_hitbox_value(AT_DSPECIAL, 2, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_DSPECIAL, 2, HG_EXTRA_HITPAUSE, 50);
