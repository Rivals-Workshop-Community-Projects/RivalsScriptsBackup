...
set_hitbox_value(AT_UAIR, 1, HG_BASE_KNOCKBACK, 2); //4
...
set_hitbox_value(AT_UAIR, 1, HG_HITSTUN_MULTIPLIER, 1.6); //.8
...
set_hitbox_value(AT_UAIR, 6, HG_KNOCKBACK_SCALING, 0.75);
...
set_hitbox_value(AT_UAIR, 7, HG_KNOCKBACK_SCALING, 0.75);
...
set_hitbox_value(AT_UAIR, 8, HG_KNOCKBACK_SCALING, 0.75);
...
set_hitbox_value(AT_UAIR, 9, HG_KNOCKBACK_SCALING, 0.75);
