...
set_window_value(AT_UAIR, 4, AG_WINDOW_VSPEED, -5);
...
set_hitbox_value(AT_UAIR, 1, HG_BASE_KNOCKBACK, 3); //4
...
set_hitbox_value(AT_UAIR, 1, HG_HITSTUN_MULTIPLIER, 1.2); //.8

set_hitbox_value(AT_UAIR, 2, HG_PARENT_HITBOX, 0);
set_hitbox_value(AT_UAIR, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_UAIR, 2, HG_WINDOW, 2);
set_hitbox_value(AT_UAIR, 2, HG_LIFETIME, 2);
set_hitbox_value(AT_UAIR, 2, HG_HITBOX_Y, -69);
...
set_hitbox_value(AT_UAIR, 4, HG_HITBOX_Y, -74);
...
set_hitbox_value(AT_UAIR, 5, HG_HITSTUN_MULTIPLIER, 1.2);
...
set_hitbox_value(AT_UAIR, 6, HG_KNOCKBACK_SCALING, 0.9);
set_hitbox_value(AT_UAIR, 6, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_UAIR, 6, HG_HITPAUSE_SCALING, .75);
...
set_hitbox_value(AT_UAIR, 7, HG_HITBOX_Y, -69);
...
set_hitbox_value(AT_UAIR, 7, HG_KNOCKBACK_SCALING, 0.9);
set_hitbox_value(AT_UAIR, 7, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_UAIR, 7, HG_HITPAUSE_SCALING, .85);
set_hitbox_value(AT_UAIR, 7, HG_VISUAL_EFFECT, 304);
...
set_hitbox_value(AT_UAIR, 8, HG_VISUAL_EFFECT, 304);
...
set_hitbox_value(AT_UAIR, 9, HG_KNOCKBACK_SCALING, 0.9);
set_hitbox_value(AT_UAIR, 9, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_UAIR, 9, HG_HITPAUSE_SCALING, .8);
set_hitbox_value(AT_UAIR, 9, HG_VISUAL_EFFECT, 304);
