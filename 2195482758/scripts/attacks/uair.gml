...
set_hitbox_value(AT_UAIR, 6, HG_KNOCKBACK_SCALING, 0.77);
...
set_hitbox_value(AT_UAIR, 7, HG_KNOCKBACK_SCALING, 0.77);
...
set_hitbox_value(AT_UAIR, 8, HG_KNOCKBACK_SCALING, 0.77);
...
set_hitbox_value(AT_UAIR, 9, HG_KNOCKBACK_SCALING, 0.77);
