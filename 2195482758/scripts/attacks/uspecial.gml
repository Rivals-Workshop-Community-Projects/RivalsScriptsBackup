...
set_hitbox_value(AT_USPECIAL, 3, HG_HITBOX_Y, -142);
...
set_hitbox_value(AT_USPECIAL, 4, HG_HITBOX_Y, -170);
...
set_hitbox_value(AT_USPECIAL, 6, HG_HITBOX_X, -30);
...
set_hitbox_value(AT_USPECIAL, 7, HG_HITBOX_X, -8);
set_hitbox_value(AT_USPECIAL, 7, HG_WIDTH, 50);
set_hitbox_value(AT_USPECIAL, 7, HG_HEIGHT, 25);
...
set_hitbox_value(AT_USPECIAL, 7, HG_BASE_KNOCKBACK, 9);
set_hitbox_value(AT_USPECIAL, 7, HG_KNOCKBACK_SCALING, .35);
set_hitbox_value(AT_USPECIAL, 7, HG_BASE_HITPAUSE, 2);
set_hitbox_value(AT_USPECIAL, 7, HG_HITPAUSE_SCALING, .35);
set_hitbox_value(AT_USPECIAL, 7, HG_HIT_SFX, asset_get("sfx_blow_medium1"));
