...
set_hitbox_value(AT_UTILT, 6, HG_VISUAL_EFFECT, 302);
...
set_hitbox_value(AT_UTILT, 7, HG_ANGLE_FLIPPER, 9);
...
set_hitbox_value(AT_UTILT, 9, HG_VISUAL_EFFECT, 302);
set_hitbox_value(AT_UTILT, 9, HG_ANGLE_FLIPPER, 9);
