...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_CUSTOM_GRAVITY, .2);
...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_CUSTOM_GRAVITY, .2);
...
set_window_value(AT_FSTRONG, 6, AG_WINDOW_CUSTOM_GRAVITY, .8);
