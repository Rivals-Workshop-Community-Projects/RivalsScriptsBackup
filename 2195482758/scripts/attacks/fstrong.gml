...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, .7);
set_window_value(AT_FSTRONG, 3, AG_WINDOW_CUSTOM_GRAVITY, .3);
...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_CUSTOM_GRAVITY, .3);
...
set_window_value(AT_FSTRONG, 5, AG_WINDOW_CUSTOM_GRAVITY, .3);
...
set_window_value(AT_FSTRONG, 6, AG_WINDOW_CUSTOM_GRAVITY, .7);
