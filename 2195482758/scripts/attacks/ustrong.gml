...
set_hitbox_value(AT_USTRONG, 1, HG_KNOCKBACK_SCALING, 1.13);
...
set_hitbox_value(AT_USTRONG, 2, HG_KNOCKBACK_SCALING, 1.13);
...
set_hitbox_value(AT_USTRONG, 4, HG_KNOCKBACK_SCALING, 1.13);
