...
set_window_value(AT_AIR_DSPECIAL, 2, AG_WINDOW_VSPEED, 16);
...
set_hitbox_value(AT_AIR_DSPECIAL, 1, HG_HITBOX_Y, -25);
set_hitbox_value(AT_AIR_DSPECIAL, 1, HG_HITBOX_X, -10);
set_hitbox_value(AT_AIR_DSPECIAL, 1, HG_WIDTH, 50);
set_hitbox_value(AT_AIR_DSPECIAL, 1, HG_HEIGHT, 60);
