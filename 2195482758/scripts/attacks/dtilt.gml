...
set_window_value(AT_DTILT, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, .00001);
set_window_value(AT_DTILT, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, asset_get("sfx_land_light"));
...
// set_hitbox_value(AT_DTILT, 1, HG_DRIFT_MULTIPLIER,0.00001);
// set_hitbox_value(AT_DTILT, 1, HG_SDI_MULTIPLIER,0.00001);
