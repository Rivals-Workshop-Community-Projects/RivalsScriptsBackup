...
phone_online = 0;
if get_player_hud_color(1) == $64e542 phone_online = 1;
...
spr_dspecial_air = sprite_get("air_dspecial");
spr_taunt = sprite_get("taunt");
spr_taunt2 = sprite_get("taunt2");
...
with phone{
	...
	initSetting("FPS Warning", "setting_fps_warn", [0, 1], ["On", "Off"], "Display a warning onscreen when the FPS drops below 60.");
...
with phone{
	...
	initAbout("About Tenru", "Spritework, animation, sfx, moveset, balancing by Selrate
	Discord: Selrate#4428
	Tenru Discord: discord.com/invite/WXSVZX8
	
	This is a rushdown character focused on fluid combos and grabs. Check out the steam page or the character tips on this phone for all the cool stuff you can do!
	
	Also check out Brandon Jacobson on youtube for some absolutely sick Tenru gameplay (link at the bottom of the steam page).
	

	Lastly, check out Tenru's super cool trailer if you havn't already, link in steam page. It's all animated and stuff.");
}
