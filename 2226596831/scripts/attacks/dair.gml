...
set_hitbox_value(AT_DAIR, 4, HG_LIFETIME, 15);

set_hitbox_value(AT_DAIR, 4, HG_PROJECTILE_SPRITE, sprite_get("wiimote"));
set_hitbox_value(AT_DAIR, 4, HG_PROJECTILE_ANIM_SPEED, 0.3);
...
set_hitbox_value(AT_DAIR, 4, HG_KNOCKBACK_SCALING, 0.63);
...
set_hitbox_value(AT_DAIR, 4, HG_PROJECTILE_DESTROY_EFFECT, 136);
set_hitbox_value(AT_DAIR, 4, HG_HIT_SFX, sound_get("hit_medium_5"));

set_hitbox_value(AT_DAIR, 4, HG_PROJECTILE_PLASMA_SAFE, 1);
set_hitbox_value(AT_DAIR, 4, HG_PROJECTILE_PARRY_STUN, 1);
set_hitbox_value(AT_DAIR, 4, HG_EXTENDED_PARRY_STUN, 1);
