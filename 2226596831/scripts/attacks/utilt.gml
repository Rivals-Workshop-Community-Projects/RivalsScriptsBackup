...
set_window_value(AT_UTILT, 1, AG_WINDOW_LENGTH, 8);//7
...
set_hitbox_value(AT_UTILT, 4, HG_LIFETIME, 12);

set_hitbox_value(AT_UTILT, 4, HG_PROJECTILE_SPRITE, sprite_get("wiimote"));
...
set_hitbox_value(AT_UTILT, 4, HG_WIDTH, 36);
...
set_hitbox_value(AT_UTILT, 4, HG_BASE_KNOCKBACK, 7.5);
...
set_hitbox_value(AT_UTILT, 4, HG_HIT_SFX, sound_get("hit_medium_2"));

set_hitbox_value(AT_UTILT, 4, HG_PROJECTILE_PLASMA_SAFE, 0);
