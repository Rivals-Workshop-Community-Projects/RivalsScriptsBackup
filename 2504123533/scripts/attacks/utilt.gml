...
set_attack_value(AT_UTILT, AG_HAS_LANDING_LAG, 4);
...
set_hitbox_value(AT_UTILT, 2, HG_WIDTH, 142);
...
set_hitbox_value(AT_UTILT, 3, HG_WIDTH, 142);
set_hitbox_value(AT_UTILT, 3, HG_HEIGHT, 32);
...
set_hitbox_value(AT_UTILT, 4, HG_WINDOW_CREATION_FRAME, 15);
set_hitbox_value(AT_UTILT, 4, HG_LIFETIME, 2);
set_hitbox_value(AT_UTILT, 4, HG_HITBOX_X, -8);
set_hitbox_value(AT_UTILT, 4, HG_HITBOX_Y, -70);
set_hitbox_value(AT_UTILT, 4, HG_WIDTH, 142);
set_hitbox_value(AT_UTILT, 4, HG_HEIGHT, 32);
