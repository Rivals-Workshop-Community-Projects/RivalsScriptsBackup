...
set_hitbox_value(AT_FAIR, 2, HG_HIT_SFX, asset_get("sfx_poison_hit_med"));
...
set_hitbox_value(AT_FAIR, 3, HG_HITBOX_Y, -45);
...
set_hitbox_value(AT_FAIR, 3, HG_VISUAL_EFFECT, sting);
...
set_hitbox_value(AT_FAIR, 3, HG_EXTRA_HITPAUSE, 10);
...
set_hitbox_value(AT_FAIR, 4, HG_HITBOX_Y, -83);
...
set_hitbox_value(AT_FAIR, 4, HG_VISUAL_EFFECT, sting);
set_hitbox_value(AT_FAIR, 4, HG_VISUAL_EFFECT_Y_OFFSET, 0);
set_hitbox_value(AT_FAIR, 4, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_FAIR, 4, HG_EXTRA_HITPAUSE, 10);
set_hitbox_value(AT_FAIR, 4, HG_HIT_SFX, asset_get("sfx_poison_hit_med"));
