...
set_attack_value(AT_DSTRONG, AG_NUM_WINDOWS, 3);// <-- make sure this accounts for ALL frames!
...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_orca_soak"));
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX_FRAME, 15);
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_ANIM_FRAME_START, 19);
...
set_hitbox_value(AT_DSTRONG, 2, HG_WINDOW_CREATION_FRAME, 24);
