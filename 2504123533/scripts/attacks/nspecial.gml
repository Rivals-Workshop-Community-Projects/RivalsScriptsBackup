...
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_swish_weak"));
...
set_hitbox_value(AT_NSPECIAL, 6, HG_HIT_SFX, asset_get("sfx_swish_weak"));
...
set_hitbox_value(AT_NSPECIAL, 4, HG_ANGLE, 130);
