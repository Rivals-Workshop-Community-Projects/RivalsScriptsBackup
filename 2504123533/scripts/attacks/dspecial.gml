...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_land_heavy"));
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX_FRAME, 8);

//Looping Window
//We select on this window
...
//Potion Selected
//this also determines how long the selected potion will appear above the head
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_SFX, asset_get("mfx_confirm"));
