...
set_attack_value(AT_NSPECIAL, AG_AIR_SPRITE, sprite_get("fspeciala"));
...
set_window_value(AT_NSPECIAL, 4, AG_WINDOW_LENGTH, 35);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("seed1"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("seed2"));
...
set_hitbox_value(AT_NSPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("seed2"));
...
set_hitbox_value(AT_NSPECIAL, 4, HG_PROJECTILE_GRAVITY, 0.1);
...
set_hitbox_value(AT_NSPECIAL, 5, HG_PROJECTILE_SPRITE, sprite_get("seed1"));
...
set_hitbox_value(AT_NSPECIAL, 5, HG_PROJECTILE_VSPEED, -3);
set_hitbox_value(AT_NSPECIAL, 5, HG_PROJECTILE_GRAVITY, .35);
...
set_hitbox_value(AT_NSPECIAL, 6, HG_WIDTH, 50);
...
set_hitbox_value(AT_NSPECIAL, 5, HG_HIT_SFX, asset_get("sfx_ori_energyhit_heavy"));
set_hitbox_value(AT_NSPECIAL, 6, HG_PROJECTILE_SPRITE, sprite_get("seed1"));
...
set_hitbox_value(AT_NSPECIAL, 6, HG_PROJECTILE_VSPEED, -3);
set_hitbox_value(AT_NSPECIAL, 6, HG_PROJECTILE_GRAVITY, .35);
...
set_hitbox_value(AT_NSPECIAL, 7, HG_HEIGHT, 140);
...
set_hitbox_value(AT_NSPECIAL, 7, HG_KNOCKBACK_SCALING, 0.8);
set_hitbox_value(AT_NSPECIAL, 7, HG_BASE_HITPAUSE, 20);
...
set_hitbox_value(AT_NSPECIAL, 8, HG_WIDTH, 140);
set_hitbox_value(AT_NSPECIAL, 8, HG_HEIGHT, 140);
set_hitbox_value(AT_NSPECIAL, 8, HG_PRIORITY, 3);
set_hitbox_value(AT_NSPECIAL, 8, HG_DAMAGE, 10);
set_hitbox_value(AT_NSPECIAL, 8, HG_ANGLE, 40);
set_hitbox_value(AT_NSPECIAL, 8, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_NSPECIAL, 8, HG_KNOCKBACK_SCALING, 1.1);
set_hitbox_value(AT_NSPECIAL, 8, HG_BASE_HITPAUSE, 30);
