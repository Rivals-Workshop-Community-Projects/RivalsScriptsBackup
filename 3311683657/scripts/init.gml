...
hfx_abyss_proj_hit = hit_fx_create(sprite_get("hfx_abyss_proj_hit"), 20)
hfx_ori_orange_big = hit_fx_create(sprite_get("hfx_ori_orange_big"), 14)
hfx_ori_orange_small = hit_fx_create(sprite_get("hfx_ori_orange_small"), 14)
hfx_ori_blue_small = hit_fx_create(sprite_get("hfx_ori_blue_small"), 18)
hfx_ori_blue_big = hit_fx_create(sprite_get("hfx_ori_blue_big"), 22)
hfx_ori_fspec_boom = hit_fx_create(sprite_get("hfx_ori_fspec_boom"), 26)
hfx_wra_wind_big = hit_fx_create(sprite_get("hfx_wra_wind_big"), 20)
hfx_wra_wind_huge = hit_fx_create(sprite_get("hfx_wra_wind_huge"), 28)
hfx_ell_boom_big = hit_fx_create(sprite_get("hfx_ell_boom_big"), 21)
...
sfx_nspec1 = asset_get("sfx_ori_bash_use")
sfx_nspec2 = asset_get("sfx_ori_dsmash_skitter_alone")
sfx_nspec3 = asset_get("sfx_ori_bash_hit")
sfx_nspec4 = asset_get("sfx_forsburn_combust")
sfx_nspec_charge = asset_get("sfx_ori_charged_flame_charge")
