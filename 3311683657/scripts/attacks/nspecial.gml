...
set_window_value(AT_NSPECIAL, 6, AG_WINDOW_ANIM_FRAME_START, 30);
set_window_value(AT_NSPECIAL, 6, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_NSPECIAL, 6, AG_WINDOW_SFX, sound_get("sfx_ori_bash_launch"));
...
set_window_value(AT_NSPECIAL, 7, AG_WINDOW_ANIM_FRAME_START, 35);
...
set_window_value(AT_NSPECIAL, 8, AG_WINDOW_SFX, sfx_nspec4);
set_window_value(AT_NSPECIAL, 8, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_NSPECIAL, 8, AG_WINDOW_CUSTOM_GRAVITY, 0.5);
...
set_window_value(AT_NSPECIAL, 8, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.6);
set_window_value(AT_NSPECIAL, 8, AG_WINDOW_GOTO, 5);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HIT_SFX, asset_get("sfx_abyss_hazard_burst"));
...
set_hitbox_value(AT_NSPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("nspec_proj_large"));
...
set_hitbox_value(AT_NSPECIAL, 3, HG_PROJECTILE_DESTROY_EFFECT, hfx_abyss_proj_hit);
...
set_hitbox_value(AT_NSPECIAL, 4, HG_HIT_SFX, asset_get("sfx_ell_dspecial_explosion_1"));
set_hitbox_value(AT_NSPECIAL, 4, HG_VISUAL_EFFECT, hfx_abyss_proj_hit);
