...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("bar_swing_heavy"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, hfx_ori_blue_big);
//set_hitbox_value(AT_FSTRONG, 1, HG_HIT_PARTICLE_NUM, 1);
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_FSTRONG, 1, HG_EFFECT, 23);