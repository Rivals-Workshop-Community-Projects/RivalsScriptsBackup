...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_forsburn_reappear_hit"));
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_clairen_fspecial_dash"));
...
set_window_value(AT_FSPECIAL, 5, AG_WINDOW_ANIM_FRAME_START, 19);
set_window_value(AT_FSPECIAL, 5, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FSPECIAL, 5, AG_WINDOW_SFX, asset_get("sfx_clairen_fspecial_dash"));
...
set_window_value(AT_FSPECIAL, 6, AG_WINDOW_ANIM_FRAME_START, 21);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT, hfx_ori_blue_big);
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_FSPECIAL, 1, HG_EFFECT, 23);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, asset_get("sfx_shovel_hit_med2"));
set_hitbox_value(AT_FSPECIAL, 2, HG_VISUAL_EFFECT, hfx_ori_blue_small);
set_hitbox_value(AT_FSPECIAL, 2, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_FSPECIAL, 2, HG_EFFECT, 23);