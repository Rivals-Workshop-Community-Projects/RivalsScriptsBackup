...
set_window_value(AT_UTHROW, 1, AG_WINDOW_SFX, asset_get("sfx_clairen_fspecial_dash"));
...
//endlag
set_window_value(AT_UTHROW, 3, AG_WINDOW_TYPE, 7);
...
set_hitbox_value(AT_UTHROW, 1, HG_VISUAL_EFFECT, hfx_ori_orange_big);
set_hitbox_value(AT_UTHROW, 1, HG_EFFECT, 23);