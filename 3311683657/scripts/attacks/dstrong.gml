...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("bar_swing_med2"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, hfx_ori_orange_big);
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_GROUP, 1);
//set_hitbox_value(AT_DSTRONG, 1, HG_HIT_PARTICLE_NUM, 1);
set_hitbox_value(AT_DSTRONG, 1, HG_EFFECT, 23);
