...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_mobile_gear_deploy"));
...
set_window_value(AT_FSPECIAL, 6, AG_WINDOW_SFX, sound_get("skid"));
set_window_value(AT_FSPECIAL, 6, AG_WINDOW_SFX_FRAME, 0);

//End
set_window_value(AT_FSPECIAL, 7, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL, 7, AG_WINDOW_LENGTH, 21);
...
set_window_value(AT_FSPECIAL, 7, AG_WINDOW_CUSTOM_GROUND_FRICTION, .45);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HITPAUSE_SCALING, .05);
