...
set_window_value(AT_FSPECIAL_2, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .7);
...
set_window_value(AT_FSPECIAL_2, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .7);

//Dash
set_window_value(AT_FSPECIAL_2, 4, AG_WINDOW_LENGTH, 1);
set_window_value(AT_FSPECIAL_2, 4, AG_WINDOW_HSPEED, 12);
...
set_window_value(AT_FSPECIAL_2, 5, AG_WINDOW_LENGTH, 5);
...
set_window_value(AT_FSPECIAL_2, 6, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1);
set_window_value(AT_FSPECIAL_2, 6, AG_WINDOW_CUSTOM_AIR_FRICTION, .4);
set_window_value(AT_FSPECIAL_2, 6, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FSPECIAL_2, 6, AG_WINDOW_SFX, sound_get("skid"));
set_window_value(AT_FSPECIAL_2, 6, AG_WINDOW_SFX_FRAME, 0);

//End
set_window_value(AT_FSPECIAL_2, 7, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL_2, 7, AG_WINDOW_LENGTH, 21);
set_window_value(AT_FSPECIAL_2, 7, AG_WINDOW_ANIM_FRAMES, 6);
set_window_value(AT_FSPECIAL_2, 7, AG_WINDOW_ANIM_FRAME_START, 11);
set_window_value(AT_FSPECIAL_2, 7, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_FSPECIAL_2, 7, AG_WINDOW_CUSTOM_GROUND_FRICTION, .45);
set_window_value(AT_FSPECIAL_2, 7, AG_WINDOW_CUSTOM_AIR_FRICTION, .1);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_KNOCKBACK_SCALING, .2);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HITPAUSE_SCALING, .05);
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HIT_LOCKOUT, 12);
...
set_hitbox_value(AT_FSPECIAL_2, 2, HG_KNOCKBACK_SCALING, .35);
...
set_hitbox_value(AT_FSPECIAL_2, 3, HG_WIDTH, 42);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HEIGHT, 42);
...
set_hitbox_value(AT_FSPECIAL_2, 3, HG_KNOCKBACK_SCALING, .15);
