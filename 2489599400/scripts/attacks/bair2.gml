...
set_window_value(AT_UTHROW, 1, AG_WINDOW_HSPEED, -1);
...
set_hitbox_value(AT_UTHROW, 1, HG_KNOCKBACK_SCALING, .55);
set_hitbox_value(AT_UTHROW, 1, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_UTHROW, 1, HG_HITPAUSE_SCALING, .45);
