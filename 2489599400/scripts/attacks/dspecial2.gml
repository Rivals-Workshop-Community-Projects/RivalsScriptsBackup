...
set_window_value(AT_DSPECIAL_2, 3, AG_WINDOW_HSPEED, 6);
set_window_value(AT_DSPECIAL_2, 3, AG_WINDOW_VSPEED, -13);
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HEIGHT, 54);
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_FORCE_FLINCH, 2);
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_HEIGHT, 62);
...
set_hitbox_value(AT_DSPECIAL_2, 6, HG_WIDTH, 74);
