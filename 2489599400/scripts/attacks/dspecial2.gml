...
set_window_value(AT_DSPECIAL_2, 1, AG_WINDOW_ANIM_FRAME_START, 3);

set_window_value(AT_DSPECIAL_2, 2, AG_WINDOW_TYPE, 1);
set_window_value(AT_DSPECIAL_2, 2, AG_WINDOW_LENGTH, 1);
...
set_window_value(AT_DSPECIAL_2, 4, AG_WINDOW_SFX, asset_get("sfx_ori_stomp_spin"));
set_window_value(AT_DSPECIAL_2, 4, AG_WINDOW_SFX_FRAME, 2);
...
set_window_value(AT_DSPECIAL_2, 5, AG_WINDOW_VSPEED, 17);
...
set_window_value(AT_DSPECIAL_2, 6, AG_WINDOW_SFX, asset_get("sfx_ori_stomp_hit"));
set_window_value(AT_DSPECIAL_2, 6, AG_WINDOW_SFX_FRAME, 0);

set_window_value(AT_DSPECIAL_2, 7, AG_WINDOW_TYPE, 1);
set_window_value(AT_DSPECIAL_2, 7, AG_WINDOW_LENGTH, 5);
set_window_value(AT_DSPECIAL_2, 7, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_DSPECIAL_2, 7, AG_WINDOW_ANIM_FRAME_START, 17);
set_window_value(AT_DSPECIAL_2, 7, AG_WINDOW_HAS_WHIFFLAG, 1);

set_window_value(AT_DSPECIAL_2, 8, AG_WINDOW_TYPE, 1);
set_window_value(AT_DSPECIAL_2, 8, AG_WINDOW_LENGTH, 14);
set_window_value(AT_DSPECIAL_2, 8, AG_WINDOW_ANIM_FRAMES, 4);
set_window_value(AT_DSPECIAL_2, 8, AG_WINDOW_ANIM_FRAME_START, 18);
set_window_value(AT_DSPECIAL_2, 8, AG_WINDOW_HAS_WHIFFLAG, 1);
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_WINDOW_CREATION_FRAME, 69);
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HEIGHT, 46);
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_WIDTH, 44);
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_ANGLE, -95);
...
set_hitbox_value(AT_DSPECIAL_2, 3, HG_PARENT_HITBOX, 2);
...
set_hitbox_value(AT_DSPECIAL_2, 5, HG_HITBOX_Y, -26);
...
set_hitbox_value(AT_DSPECIAL_2, 6, HG_WINDOW, 6);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_WINDOW_CREATION_FRAME, 0);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_LIFETIME, 3);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_HITBOX_X, -2);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_HITBOX_Y, -16);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_WIDTH, 69);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_HEIGHT, 44);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_PRIORITY, 10);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_DAMAGE, 7);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_SHAPE, 1);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_ANGLE, 50);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_KNOCKBACK_SCALING, .9);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_HIT_SFX, asset_get("sfx_blow_heavy1"));
set_hitbox_value(AT_DSPECIAL_2, 6, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_HITPAUSE_SCALING, .6);
