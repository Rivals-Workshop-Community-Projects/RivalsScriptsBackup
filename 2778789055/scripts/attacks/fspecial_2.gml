...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_WIDTH, 25);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HITSTUN_MULTIPLIER, 0.4);
...
set_hitbox_value(AT_FSPECIAL_2, 2, HG_WIDTH, 25);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_HEIGHT, 25);
...
set_hitbox_value(AT_FSPECIAL_2, 2, HG_HITSTUN_MULTIPLIER, 0.4);
...
set_hitbox_value(AT_FSPECIAL_2, 3, HG_WIDTH, 25);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HEIGHT, 25);
...
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HITSTUN_MULTIPLIER, 0.4);
