...
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_ANIM_FRAME_START, 14);
...
set_window_value(AT_EXTRA_1, 3, AG_WINDOW_ANIM_FRAME_START, 19);
...
set_window_value(AT_EXTRA_1, 4, AG_WINDOW_ANIM_FRAME_START, 26);
