...
set_hitbox_value(AT_USTRONG_2, 1, HG_HITBOX_X, 45);
...
set_hitbox_value(AT_USTRONG_2, 1, HG_KNOCKBACK_SCALING, 0.9);
set_hitbox_value(AT_USTRONG_2, 1, HG_BASE_HITPAUSE, 12);
...
set_hitbox_value(AT_USTRONG_2, 2, HG_HITBOX_Y, -100);
