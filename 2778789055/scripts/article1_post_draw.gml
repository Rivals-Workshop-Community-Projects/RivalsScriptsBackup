...
draw_sprite_ext(sprite_get("cook_bar"), 0, x + 36, y + 3, 1, (-explode_timer/180), 0, c_white, 1);
if(!can_be_hit){
...
if(!can_opponent_hit){
    draw_sprite_ext(sprite_index, image_index, x, y, 1, 1, image_angle, c_black, 0.5);
}
