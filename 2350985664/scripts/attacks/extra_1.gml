...
set_attack_value(AT_EXTRA_1, AG_SPRITE, sprite_get("animalcage"));
set_attack_value(AT_EXTRA_1, AG_HURTBOX_SPRITE, sprite_get("animalcage_hurt"));
...
set_window_value(AT_EXTRA_1, 3, AG_WINDOW_SFX, asset_get("sfx_swipe_weak1"));
...
set_window_value(AT_EXTRA_1, 5, AG_WINDOW_SFX_FRAME, 0);
...
set_window_value(AT_EXTRA_1, 6, AG_WINDOW_ANIM_FRAME_START, 10);
set_window_value(AT_EXTRA_1, 6, AG_WINDOW_HAS_SFX, 1);
//set_window_value(AT_EXTRA_1, 5, AG_WINDOW_SFX, sound_get("bounce"));
set_window_value(AT_EXTRA_1, 6, AG_WINDOW_SFX_FRAME, 1);
set_window_value(AT_EXTRA_1, 6, AG_WINDOW_VSPEED_TYPE, 2);
set_window_value(AT_EXTRA_1, 6, AG_WINDOW_VSPEED, -4);
