...
//================Attacks================
//  Base Attacks
add_sprites("bair","dair","dattack","dspecial","dspecial_2","dstrong","dtilt","fair","fspecial","fspecial_air","fstrong",
            "ftilt","jab","nair","nspecial","nspecial_air","taunt","uair","uspecial","ustrong","utilt");
            

//=================OTHER=================
//  hurt sprites
add_sprites("hurt","bouncehurt","hurtground","spinhurt","uphurt","downhurt");
add_sprites("wsc_sonictrick");
add_sprites("sparking_exit");
