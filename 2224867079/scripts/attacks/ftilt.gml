...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, sound_get("BlueSwish1"));
...
set_hitbox_value(AT_FTILT, 1, HG_WIDTH, 78);
set_hitbox_value(AT_FTILT, 1, HG_HEIGHT, 16);
...
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT, blue_stab_1 );
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT, blue_new_stab_1 );
