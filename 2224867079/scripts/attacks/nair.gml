...
set_window_value(AT_NAIR, 4, AG_WINDOW_SFX, sound_get("BlueSwish1"));
...
set_hitbox_value(AT_NAIR, 3, HG_VISUAL_EFFECT, blue_new_stab_1 );
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, asset_get("sfx_blow_medium2"));
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, sound_get("Hit4"));