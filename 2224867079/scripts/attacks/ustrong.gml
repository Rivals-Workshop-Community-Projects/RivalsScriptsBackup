...
set_window_value(AT_USTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_clairen_tip_loop"));

set_window_value(AT_USTRONG, 2, AG_WINDOW_TYPE, 1);
set_window_value(AT_USTRONG, 2, AG_WINDOW_LENGTH, 1);
set_window_value(AT_USTRONG, 2, AG_WINDOW_ANIM_FRAME_START, 2);
set_window_value(AT_USTRONG, 2, AG_WINDOW_ANIM_FRAMES, 0);
set_window_value(AT_USTRONG, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, sound_get("BlueSwish4"));
...
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_X, 80);
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_Y, -63);
set_hitbox_value(AT_USTRONG, 1, HG_WIDTH, 22);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, blue_new_stab_1 );
...
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_Y, -124);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, blue_new_stab_1 );
set_hitbox_value(AT_USTRONG, 2, HG_HIT_PARTICLE_NUM, 1);
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("Hit4"));