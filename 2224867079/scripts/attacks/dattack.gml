...
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX, sound_get("BlueSwish4"));
...
set_window_value(AT_DATTACK, 4, AG_WINDOW_LENGTH, 22);
...
set_window_value(AT_DATTACK, 6, AG_WINDOW_ANIM_FRAME_START, 2);
set_window_value(AT_DATTACK, 6, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DATTACK, 6, AG_WINDOW_SFX_FRAME, 5);
set_window_value(AT_DATTACK, 6, AG_WINDOW_SFX, sound_get("RedSwish4"));
...
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT, blue_new_stab_1);
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, asset_get("sfx_blow_medium2"));
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, sound_get("Hit4"));
...
set_hitbox_value(AT_DATTACK, 2, HG_HEIGHT, 69);
...
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT, red_new_stab_1);
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, asset_get("sfx_blow_medium2"));
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, sound_get("RedHit4"));