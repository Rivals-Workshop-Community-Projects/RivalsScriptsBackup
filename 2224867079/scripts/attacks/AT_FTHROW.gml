...
set_window_value(AT_FTHROW, 3, AG_WINDOW_LENGTH, 22);
...
set_window_value(AT_FTHROW, 4, AG_WINDOW_LENGTH, 5);
...
set_window_value(AT_FTHROW, 5, AG_WINDOW_SFX, asset_get("sfx_swipe_weak1"));
...
set_hitbox_value(AT_FTHROW, 1, HG_LIFETIME, 40);
...
set_hitbox_value(AT_FTHROW, 1, HG_PROJECTILE_SPRITE, sprite_get("nspecial_proj"));
...
set_hitbox_value(AT_FTHROW, 2, HG_PROJECTILE_ENEMY_BEHAVIOR, 0);
set_hitbox_value(AT_FTHROW, 2, HG_LIFETIME, 40);
set_hitbox_value(AT_FTHROW, 2, HG_HITBOX_X, 35);
...
set_hitbox_value(AT_FTHROW, 2, HG_BASE_HITPAUSE, 2);
set_hitbox_value(AT_FTHROW, 2, HG_HITPAUSE_SCALING, 0.2);
set_hitbox_value(AT_FTHROW, 2, HG_VISUAL_EFFECT, 301);
set_hitbox_value(AT_FTHROW, 2, HG_HIT_SFX, asset_get("sfx_absa_orb_hit"));
set_hitbox_value(AT_FTHROW, 2, HG_PROJECTILE_SPRITE, sprite_get("nspecial_proj"));
set_hitbox_value(AT_FTHROW, 2, HG_PROJECTILE_MASK, sprite_get("nspecial_proj"));
set_hitbox_value(AT_FTHROW, 2, HG_PROJECTILE_HSPEED, 13);
set_hitbox_value(AT_FTHROW, 2, HG_PROJECTILE_VSPEED, -1.5);
set_hitbox_value(AT_FTHROW, 2, HG_PROJECTILE_ANIM_SPEED, 0);
set_hitbox_value(AT_FTHROW, 2, HG_PROJECTILE_DESTROY_EFFECT, 302);
set_hitbox_value(AT_FTHROW, 2, HG_PROJECTILE_IS_TRANSCENDENT, false);
