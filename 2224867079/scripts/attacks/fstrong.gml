...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_ell_drill_loop"));
...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_SFX, asset_get("sfx_ell_drill_stab"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_ANGLE, 180);
...
set_hitbox_value(AT_FSTRONG, 3, HG_ANGLE, 180);
...
set_hitbox_value(AT_FSTRONG, 5, HG_ANGLE, 180);
...
set_hitbox_value(AT_FSTRONG, 8, HG_DAMAGE, 4);
set_hitbox_value(AT_FSTRONG, 8, HG_ANGLE, 35);
set_hitbox_value(AT_FSTRONG, 8, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_FSTRONG, 8, HG_KNOCKBACK_SCALING, 0.8);
set_hitbox_value(AT_FSTRONG, 8, HG_BASE_HITPAUSE, 4);
