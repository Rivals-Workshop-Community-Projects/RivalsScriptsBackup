...
set_attack_value(AT_USPECIAL_2, AG_AIR_SPRITE, sprite_get("red_uspecial"));
...
set_window_value(AT_USPECIAL_2, 2, AG_WINDOW_LENGTH, 1);
...
set_window_value(AT_USPECIAL_2, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, .1);
set_window_value(AT_USPECIAL_2, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0);
...
set_window_value(AT_USPECIAL_2, 3, AG_WINDOW_SFX, sound_get("RedSwish6"));
...
set_window_value(AT_USPECIAL_2, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, .1);
set_window_value(AT_USPECIAL_2, 3, AG_WINDOW_VSPEED_TYPE, 2);
set_window_value(AT_USPECIAL_2, 3, AG_WINDOW_VSPEED, -19);
set_window_value(AT_USPECIAL_2, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0);
...
set_hitbox_value(AT_USPECIAL_2, 1, HG_HITBOX_X, 25);
set_hitbox_value(AT_USPECIAL_2, 1, HG_HITBOX_Y, -24);
set_hitbox_value(AT_USPECIAL_2, 1, HG_WIDTH, 18);
set_hitbox_value(AT_USPECIAL_2, 1, HG_HEIGHT, 19);
...
set_hitbox_value(AT_USPECIAL_2, 2, HG_LIFETIME, 15);
set_hitbox_value(AT_USPECIAL_2, 2, HG_HITBOX_X, 7);
set_hitbox_value(AT_USPECIAL_2, 2, HG_HITBOX_Y, -49);
set_hitbox_value(AT_USPECIAL_2, 2, HG_WIDTH, 60);
set_hitbox_value(AT_USPECIAL_2, 2, HG_HEIGHT, 97);
...
set_hitbox_value(AT_USPECIAL_2, 2, HG_KNOCKBACK_SCALING, 0.1);
set_hitbox_value(AT_USPECIAL_2, 2, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_USPECIAL_2, 2, HG_HITPAUSE_SCALING, 0.1);
