...
var summon_time = 1; //how long it takes for the plant to be ready
if (state == 0){ //growing
    image_index = 0 + state_timer * 1 / summon_time;
	//that's:
...
// // // // STATE 3 - CHARGING
var charge_time = 1; //how long it takes to charge //14
if (state == 3){ //charging
	if (use_left == 2){ //if it has 2 uses left
		image_index = 19 + state_timer * 2 / charge_time;
	} else if (use_left == 1){ //if it has 1 use left
		image_index = 0 + state_timer * 1 / charge_time;	
	}
	//that's:
	//starting animation frame +
	//current time *
...
// // // // STATE 4 - EXPLODE
var boom_time = 18; //how long it takes for explosion to end
if (state == 4){ //explosion
	if (use_left == 2){ //if it has 2 uses left
		image_index = 21 + state_timer * 3 / (boom_time+1);
	} else if (use_left == 1){ //if it has 1 use left
		image_index = 0 + state_timer * 3 / (boom_time+1);
	}
	//that's:
	//starting animation frame +
	//current time *
