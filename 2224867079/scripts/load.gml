...
sprite_change_offset("BlueNewStab1", 31, 33);
sprite_change_offset("BlueStab_2", 90, 140);
sprite_change_offset("BlueNewStab2", 31, 33);
sprite_change_offset("BlueStab3", 50, 102);
sprite_change_offset("BlueStab_4", 67, 43);
sprite_change_offset("RedStab1", 25, 102);
sprite_change_offset("RedNewStab1", 31, 33);
sprite_change_offset("RedStab_2", 90, 140);
sprite_change_offset("RedNewStab2", 31, 33);
...
sprite_change_offset("RBmark2", 50, 50);
//Phone
sprite_change_offset("phone_open", 40, 90);


//Blue
sprite_change_offset("idle", 32, 70);
...
sprite_change_offset("spinhurt", 32, 70);
sprite_change_offset("hurtground", 32, 70);
sprite_change_offset("crouch", 42, 70);
sprite_change_offset("walk", 32, 70);
sprite_change_offset("walkturn", 32, 70);
sprite_change_offset("dash", 40, 70);
...
sprite_change_offset("parry", 32, 70);
sprite_change_offset("roll_forward", 32, 70);
sprite_change_offset("roll_backward", 32, 70);
sprite_change_offset("waveland", 32, 70);
sprite_change_offset("tech", 32, 70);

sprite_change_offset("jab", 38, 88);
sprite_change_offset("dattack", 32, 70);
sprite_change_offset("ftilt", 24, 70);
sprite_change_offset("dtilt", 42, 95);
sprite_change_offset("utilt", 26, 82);
...
sprite_change_offset("nspecial", 32, 70);
...
//Red
sprite_change_offset("red_idle", 32, 70);
sprite_change_offset("red_hurt", 32, 70);
sprite_change_offset("red_bighurt", 32, 70);
sprite_change_offset("red_uphurt", 32, 70);
sprite_change_offset("red_downhurt", 32, 70);
sprite_change_offset("red_spinhurt", 32, 70);
sprite_change_offset("red_crouch", 42, 70);
sprite_change_offset("red_walk", 32, 70);
sprite_change_offset("red_walkturn", 32, 70);
sprite_change_offset("red_dash", 40, 70);
sprite_change_offset("red_dashstart", 40, 70);
sprite_change_offset("red_dashstop", 40, 70);
sprite_change_offset("red_dashturn", 40, 70);

sprite_change_offset("red_jumpstart", 32, 91);
sprite_change_offset("red_jump", 32, 91);
sprite_change_offset("red_airdodge", 32, 91);
sprite_change_offset("red_doublejump", 32, 91);
sprite_change_offset("red_walljump", 24, 85);
sprite_change_offset("red_pratfall", 32, 70);
sprite_change_offset("red_land", 32, 91);
sprite_change_offset("red_landinglag", 32, 91);
sprite_change_offset("red_waveland", 32, 70);
sprite_change_offset("red_tech", 32, 70);

sprite_change_offset("red_parry", 32, 70);
sprite_change_offset("red_roll_forward", 32, 70);
...
sprite_change_offset("red_nair", 60, 80);
...
sprite_change_offset("red_dstrong", 60, 96);
sprite_change_offset("red_nspecial", 32, 70);
sprite_change_offset("red_nspecial2", 38, 78);
