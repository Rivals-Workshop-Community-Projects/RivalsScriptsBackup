...
set_window_value(AT_FSPECIAL, 13, AG_WINDOW_ANIM_FRAME_START, 4);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_KNOCKBACK_SCALING, 0.35);
set_hitbox_value(AT_FSPECIAL, 3, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_FSPECIAL, 3, HG_HITPAUSE_SCALING, 0.35);
