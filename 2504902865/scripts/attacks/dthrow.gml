...
set_attack_value(AT_DTHROW, AG_SPRITE, sprite_get("dthrow_lv1"));
...
set_window_value(AT_DTHROW, 2, AG_WINDOW_VSPEED, -8);
...
set_hitbox_value(AT_DTHROW, 1, HG_WINDOW, 69);
set_hitbox_value(AT_DTHROW, 1, HG_LIFETIME, 99999);
...
set_hitbox_value(AT_DTHROW, 1, HG_HITPAUSE_SCALING, 0.4);
set_hitbox_value(AT_DTHROW, 1, HG_HITSTUN_MULTIPLIER, 0.8);
set_hitbox_value(AT_DTHROW, 1, HG_VISUAL_EFFECT_X_OFFSET, -32);
set_hitbox_value(AT_DTHROW, 1, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_DTHROW, 1, HG_HIT_SFX, asset_get("sfx_waterhit_heavy"));
...
set_hitbox_value(AT_DTHROW, 1, HG_PROJECTILE_PARRY_STUN, true);
set_hitbox_value(AT_DTHROW, 1, HG_EXTENDED_PARRY_STUN, true);
set_hitbox_value(AT_DTHROW, 1, HG_ANGLE_FLIPPER, 3);
set_hitbox_value(AT_DTHROW, 1, HG_FORCE_FLINCH, 2);