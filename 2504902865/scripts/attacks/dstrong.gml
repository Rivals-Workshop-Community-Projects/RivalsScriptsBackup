...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, fx_waterhit_big);
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, fx_waterhit_big);
...
set_hitbox_value(AT_DSTRONG, 3, HG_LIFETIME, get_window_value(AT_DSTRONG,3,AG_WINDOW_LENGTH));
...
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT, fx_waterhit_big);
