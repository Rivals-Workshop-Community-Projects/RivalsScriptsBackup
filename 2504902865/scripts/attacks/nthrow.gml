...
set_attack_value(AT_NTHROW, AG_SPRITE, sprite_get("nthrow_lv1"));
...
set_hitbox_value(AT_NTHROW, 1, HG_WINDOW, 69);
set_hitbox_value(AT_NTHROW, 1, HG_LIFETIME, 99999);
set_hitbox_value(AT_NTHROW, 1, HG_HITBOX_X, 0);
set_hitbox_value(AT_NTHROW, 1, HG_HITBOX_Y, 5);
...
set_hitbox_value(AT_NTHROW, 1, HG_PROJECTILE_ANIM_SPEED, 0);
...
set_hitbox_value(AT_NTHROW, 1, HG_HITSTUN_MULTIPLIER, 0.8);
set_hitbox_value(AT_NTHROW, 1, HG_VISUAL_EFFECT_X_OFFSET, -32);
set_hitbox_value(AT_NTHROW, 1, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_NTHROW, 1, HG_HIT_SFX, asset_get("sfx_waterhit_heavy"));
...
set_hitbox_value(AT_NTHROW, 1, HG_PROJECTILE_UNBASHABLE, true);
