...
// creates the masking//================================================================================
{
    ...
    draw_set_alpha(1);
    var incrament = 40 - time%50;
    var chunk = 50;
    var segment = incrament * (sprite_height/60);
    var part = sprite_height - segment - chunk;
    draw_sprite_part_ext(sprite_index, image_index, 0, part, abs(sprite_width), chunk, x - sprite_width/2, y - segment + chunk, 1, 1, c_white, .3);
    maskMidder();
