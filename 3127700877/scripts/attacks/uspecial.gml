...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_VSPEED, -14.5);
...
set_hitbox_value(AT_USPECIAL, 2, HG_BASE_KNOCKBACK, 12.5);
...
set_hitbox_value(AT_USPECIAL, 3, HG_BASE_KNOCKBACK, 11.5);
...
set_hitbox_value(AT_USPECIAL, 4, HG_BASE_KNOCKBACK, 7.5);
...
set_hitbox_value(AT_USPECIAL, 7, HG_PROJECTILE_COLLISION_SPRITE, sprite_get("uspecial_proj_mask"));
...
set_hitbox_value(AT_USPECIAL, 8, HG_PROJECTILE_COLLISION_SPRITE, sprite_get("uspecial_proj_mask"));
