...
set_hitbox_value(AT_NSPECIAL_AIR, 4, HG_PROJECTILE_COLLISION_SPRITE, sprite_get("uair_proj_mask"));
...
set_hitbox_value(AT_NSPECIAL_AIR, 7, HG_PROJECTILE_COLLISION_SPRITE, sprite_get("fair_proj_old_mask"));
