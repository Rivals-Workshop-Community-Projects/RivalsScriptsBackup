...
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT, hfx_feather_small);
...
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT, hfx_curse_large);
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, asset_get("sfx_blow_heavy2"));
set_hitbox_value(AT_FTILT, 2, HG_EXTRA_CAMERA_SHAKE, 15);
