...
set_window_value(AT_UAIR, 3, AG_WINDOW_GOTO, 9);
...
set_window_value(AT_UAIR, 4, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy1"));
set_window_value(AT_UAIR, 4, AG_WINDOW_SFX_FRAME, 8);
...
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT, hfx_feather_small);
...
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT, hfx_feather_small);
...
set_hitbox_value(AT_UAIR, 2, HG_HITSTUN_MULTIPLIER, 1.0);
...
set_hitbox_value(AT_UAIR, 3, HG_VISUAL_EFFECT, hfx_feather_small);
...
set_hitbox_value(AT_UAIR, 3, HG_EXTRA_HITPAUSE, 16);
...
set_hitbox_value(AT_UAIR, 4, HG_VISUAL_EFFECT, hfx_feather_large);
