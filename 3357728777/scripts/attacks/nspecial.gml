...
set_window_value(AT_NSPECIAL, 5, AG_WINDOW_SFX, asset_get("sfx_bigplant_clamp"));
...
set_window_value(AT_NSPECIAL, 7, AG_WINDOW_SFX, asset_get("sfx_bigplant_eat"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, hfx_feather_small);
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, hfx_feather_small);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_VISUAL_EFFECT, hfx_curse_small);
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_DESTROY_EFFECT, hfx_curse_small);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_EXTRA_HITPAUSE, 13);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_VISUAL_EFFECT, hfx_curse_large);
set_hitbox_value(AT_NSPECIAL, 3, HG_PROJECTILE_DESTROY_EFFECT, hfx_curse_large);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_EXTRA_HITPAUSE, 18);
...
set_hitbox_value(AT_NSPECIAL, 4, HG_VISUAL_EFFECT, hfx_curse_large);
set_hitbox_value(AT_NSPECIAL, 4, HG_PROJECTILE_DESTROY_EFFECT, hfx_curse_large);
...
set_hitbox_value(AT_NSPECIAL, 4, HG_PROJECTILE_HSPEED, 18);
set_hitbox_value(AT_NSPECIAL, 4, HG_EXTRA_HITPAUSE, 24);
...
set_hitbox_value(AT_NSPECIAL, 5, HG_HITBOX_X, 48);
...
set_hitbox_value(AT_NSPECIAL, 5, HG_KNOCKBACK_SCALING, .85);
set_hitbox_value(AT_NSPECIAL, 5, HG_BASE_HITPAUSE, 9);
set_hitbox_value(AT_NSPECIAL, 5, HG_HITPAUSE_SCALING, 0.75);
set_hitbox_value(AT_NSPECIAL, 5, HG_VISUAL_EFFECT, hfx_blood_small);
...
set_hitbox_value(AT_NSPECIAL, 5, HG_HIT_PARTICLE_NUM, 2);
...
set_hitbox_value(AT_NSPECIAL, 6, HG_HITBOX_X, 68);
...
set_hitbox_value(AT_NSPECIAL, 6, HG_KNOCKBACK_SCALING, 1.1);
set_hitbox_value(AT_NSPECIAL, 6, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_NSPECIAL, 6, HG_HITPAUSE_SCALING, 1.1);
set_hitbox_value(AT_NSPECIAL, 6, HG_VISUAL_EFFECT, hfx_blood_large);
set_hitbox_value(AT_NSPECIAL, 6, HG_HIT_SFX, asset_get("sfx_blow_heavy2"));
set_hitbox_value(AT_NSPECIAL, 6, HG_HIT_LOCKOUT, 10);
set_hitbox_value(AT_NSPECIAL, 6, HG_IGNORES_PROJECTILES, 1);
set_hitbox_value(AT_NSPECIAL, 6, HG_HIT_PARTICLE_NUM, 2);