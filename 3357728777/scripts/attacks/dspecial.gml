...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, sound_get("Hisako_CrawlTeleport_End_04"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_VISUAL_EFFECT, hfx_curse_small);
set_hitbox_value(AT_DSPECIAL, 1, HG_HIT_SFX, sound_get("qoedil_hit_bite"));
...
set_hitbox_value(AT_DSPECIAL, 2, HG_VISUAL_EFFECT, hfx_curse_small);
set_hitbox_value(AT_DSPECIAL, 2, HG_HIT_SFX, sound_get("qoedil_hit_bite"));
...
set_hitbox_value(AT_DSPECIAL, 3, HG_VISUAL_EFFECT, hfx_curse_small);
set_hitbox_value(AT_DSPECIAL, 3, HG_PROJECTILE_DESTROY_EFFECT, hfx_curse_large);
set_hitbox_value(AT_DSPECIAL, 3, HG_HIT_SFX, sound_get("qoedil_hit_bite"));
