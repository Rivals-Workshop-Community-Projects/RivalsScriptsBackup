...
set_window_value(AT_UTILT, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.8);
...
set_window_value(AT_UTILT, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.85);
...
set_window_value(AT_UTILT, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.9);
...
set_hitbox_value(AT_UTILT, 1, HG_HITBOX_X, 54);
...
set_hitbox_value(AT_UTILT, 1, HG_ANGLE, 130);
...
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, asset_get("sfx_mol_norm_explode"));
set_hitbox_value(AT_UTILT, 1, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, vfx_explosion_smol)
...
set_hitbox_value(AT_UTILT, 4, HG_HITBOX_X, 11);
...
set_hitbox_value(AT_UTILT, 4, HG_HITSTUN_MULTIPLIER, 0.8);
...
set_hitbox_value(AT_UTILT, 2, HG_ANGLE, 140);
...
set_hitbox_value(AT_UTILT, 2, HG_EXTRA_HITPAUSE, 2);
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT_Y_OFFSET, -16);
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, asset_get("sfx_mol_norm_explode"));
set_hitbox_value(AT_UTILT, 2, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, vfx_explosion_smol)
...
set_hitbox_value(AT_UTILT, 3, HG_HIT_SFX, asset_get("sfx_mol_flare_explode"));
set_hitbox_value(AT_UTILT, 3, HG_HITBOX_GROUP, 3);
set_hitbox_value(AT_UTILT, 3, HG_VISUAL_EFFECT, vfx_explosion)