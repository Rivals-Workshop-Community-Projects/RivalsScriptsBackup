...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_syl_ustrong_part2"));
...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_syl_dspecial_plantaway"));
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_syl_dstrong"));
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_bigplant_clamp"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HITBOX_Y, -75);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_BASE_HITPAUSE, has_rune("M")?0:12);
set_hitbox_value(AT_DSPECIAL, 1, HG_EXTRA_HITPAUSE, has_rune("M")?12:0);
set_hitbox_value(AT_DSPECIAL, 1, HG_HIT_SFX, asset_get("hfx_wood_largest"));
...
set_hitbox_value(AT_DSPECIAL, 2, HG_BASE_HITPAUSE, has_rune("M")?0:12);
set_hitbox_value(AT_DSPECIAL, 2, HG_EXTRA_HITPAUSE, has_rune("M")?12:0);
set_hitbox_value(AT_DSPECIAL, 2, HG_HIT_SFX, asset_get("hfx_wood_largest"));
...
set_hitbox_value(AT_DSPECIAL, 3, HG_HITBOX_X, 14);
set_hitbox_value(AT_DSPECIAL, 3, HG_HITBOX_Y, -80);
set_hitbox_value(AT_DSPECIAL, 3, HG_SHAPE, 1);
set_hitbox_value(AT_DSPECIAL, 3, HG_WIDTH, 65);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_BASE_KNOCKBACK, has_rune("M")?0:10);
set_hitbox_value(AT_DSPECIAL, 3, HG_EXTRA_HITPAUSE, has_rune("M")?12:0);
set_hitbox_value(AT_DSPECIAL, 3, HG_KNOCKBACK_SCALING, 1);
set_hitbox_value(AT_DSPECIAL, 3, HG_BASE_HITPAUSE, 12);
set_hitbox_value(AT_DSPECIAL, 3, HG_HIT_SFX, asset_get("hfx_wood_largest"));
...
set_hitbox_value(AT_DSPECIAL, 4, HG_HIT_SFX, asset_get("hfx_wood_largest"));
set_hitbox_value(AT_DSPECIAL, 4, HG_PROJECTILE_SPRITE, sprite_get("dspecial_rune"));
set_hitbox_value(AT_DSPECIAL, 4, HG_PROJECTILE_MASK, sprite_get("dspecial_rune"));
set_hitbox_value(AT_DSPECIAL, 4, HG_PROJECTILE_COLLISION_SPRITE, sprite_get("dspecial_rune"));
