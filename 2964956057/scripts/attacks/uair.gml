...
set_hitbox_value(AT_UAIR, 1, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_UAIR, 1, HG_WINDOW, 2);
set_hitbox_value(AT_UAIR, 1, HG_LIFETIME, has_rune("L")?2:3);
...
set_hitbox_value(AT_UAIR, 2, HG_WINDOW_CREATION_FRAME, has_rune("L")?2:3);
...
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT, vfx_star);
