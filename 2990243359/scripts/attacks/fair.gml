...
set_hitbox_value(AT_FAIR, 4, HG_HITBOX_X, 72);
...
set_hitbox_value(AT_FAIR, 5, HG_HITBOX_Y, -74);
...
set_hitbox_value(AT_FAIR, 6, HG_HITBOX_Y, -9);
set_hitbox_value(AT_FAIR, 6, HG_WIDTH, 70);
set_hitbox_value(AT_FAIR, 6, HG_HEIGHT, 48);
