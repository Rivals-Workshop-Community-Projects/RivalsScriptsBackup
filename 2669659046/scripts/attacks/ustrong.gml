...
set_window_value(AT_USTRONG, 2, AG_WINDOW_LENGTH, 12); // 3
...
set_hitbox_value(AT_USTRONG, 2, HG_KNOCKBACK_SCALING, .85); // 1.2
set_hitbox_value(AT_USTRONG, 2, HG_BASE_HITPAUSE, 8); // 8
