...
set_hitbox_value(AT_DAIR, 1, HG_WINDOW_CREATION_FRAME, 5);
...
set_hitbox_value(AT_DAIR, 1, HG_HEIGHT, 37);
set_hitbox_value(AT_DAIR, 1, HG_SHAPE, 0);
set_hitbox_value(AT_DAIR, 1, HG_PRIORITY, 2);
set_hitbox_value(AT_DAIR, 1, HG_DAMAGE, 8); // 18
set_hitbox_value(AT_DAIR, 1, HG_ANGLE, 270);
set_hitbox_value(AT_DAIR, 1, HG_BASE_KNOCKBACK, 7); // 10
...
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, asset_get("sfx_blow_heavy"));
...
set_hitbox_value(AT_DAIR, 2, HG_WIDTH, 68);
set_hitbox_value(AT_DAIR, 2, HG_HEIGHT, 129);
set_hitbox_value(AT_DAIR, 2, HG_SHAPE, 0);
set_hitbox_value(AT_DAIR, 2, HG_PRIORITY, 2);
set_hitbox_value(AT_DAIR, 2, HG_DAMAGE, 4); // 18
set_hitbox_value(AT_DAIR, 2, HG_ANGLE, 45);
set_hitbox_value(AT_DAIR, 2, HG_BASE_KNOCKBACK, 3); // 10
set_hitbox_value(AT_DAIR, 2, HG_KNOCKBACK_SCALING, 0.8); // 1.0
