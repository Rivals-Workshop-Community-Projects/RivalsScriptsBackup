...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("wooper"));
...
set_hitbox_value(AT_UTILT, 1, HG_WIDTH, 60); // 20
...
set_hitbox_value(AT_UTILT, 2, HG_WIDTH, 96); // 20
set_hitbox_value(AT_UTILT, 2, HG_HEIGHT, 49);
set_hitbox_value(AT_UTILT, 2, HG_PRIORITY, 2);
set_hitbox_value(AT_UTILT, 2, HG_DAMAGE, 1); // 3
