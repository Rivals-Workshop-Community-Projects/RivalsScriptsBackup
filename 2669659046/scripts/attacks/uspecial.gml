...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_watergun_splash"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_HITBOX_Y, 2);
set_hitbox_value(AT_USPECIAL, 1, HG_WIDTH, 62);
...
set_hitbox_value(AT_USPECIAL, 2, HG_VISUAL_EFFECT, 5);
...
set_hitbox_value(AT_USPECIAL, 3, HG_HITBOX_Y, 2);
set_hitbox_value(AT_USPECIAL, 3, HG_WIDTH, 62);
...
set_hitbox_value(AT_USPECIAL, 3, HG_VISUAL_EFFECT, 5);
...
set_hitbox_value(AT_USPECIAL, 4, HG_HITBOX_Y, 2);
set_hitbox_value(AT_USPECIAL, 4, HG_WIDTH, 62);
set_hitbox_value(AT_USPECIAL, 4, HG_HEIGHT, 25);
set_hitbox_value(AT_USPECIAL, 4, HG_SHAPE, 0);
set_hitbox_value(AT_USPECIAL, 4, HG_PRIORITY, 1);
set_hitbox_value(AT_USPECIAL, 4, HG_DAMAGE, 2); // 2
...
set_hitbox_value(AT_USPECIAL, 4, HG_VISUAL_EFFECT, 5);
set_hitbox_value(AT_USPECIAL, 4, HG_HIT_SFX, asset_get("sfx_waterhit_weak"));
set_hitbox_value(AT_USPECIAL, 4, HG_ANGLE_FLIPPER, 8);
...
set_hitbox_value(AT_USPECIAL, 5, HG_WIDTH, 62);
set_hitbox_value(AT_USPECIAL, 5, HG_HEIGHT, 25);
set_hitbox_value(AT_USPECIAL, 5, HG_SHAPE, 0);
set_hitbox_value(AT_USPECIAL, 5, HG_PRIORITY, 1);
set_hitbox_value(AT_USPECIAL, 5, HG_DAMAGE, 3); // 2
...
set_hitbox_value(AT_USPECIAL, 5, HG_VISUAL_EFFECT, 5);
set_hitbox_value(AT_USPECIAL, 5, HG_HIT_SFX, asset_get("sfx_waterhit_weak"));
set_hitbox_value(AT_USPECIAL, 5, HG_ANGLE_FLIPPER, 8);
...
set_hitbox_value(AT_USPECIAL, 6, HG_HITBOX_Y, 2);
set_hitbox_value(AT_USPECIAL, 6, HG_WIDTH, 62);
set_hitbox_value(AT_USPECIAL, 6, HG_HEIGHT, 25);
set_hitbox_value(AT_USPECIAL, 6, HG_SHAPE, 0);
set_hitbox_value(AT_USPECIAL, 6, HG_PRIORITY, 1);
set_hitbox_value(AT_USPECIAL, 6, HG_DAMAGE, 3); // 2
...
set_hitbox_value(AT_USPECIAL, 6, HG_VISUAL_EFFECT, 5);
set_hitbox_value(AT_USPECIAL, 6, HG_HIT_SFX, asset_get("sfx_waterhit_weak"));
