...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, codename_emerl_active ? sound_get("emerl_dash") : asset_get("sfx_ell_eject"));
...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_HSPEED, 28);
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_VSPEED_TYPE, 1);
