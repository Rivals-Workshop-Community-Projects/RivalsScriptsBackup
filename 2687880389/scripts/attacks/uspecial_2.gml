...
set_window_value(AT_USPECIAL_2, 1, AG_WINDOW_SFX, sound_get("last_gasp_charge"));
set_window_value(AT_USPECIAL_2, 1, AG_WINDOW_SFX_FRAME, 1);
//set_window_value(AT_USPECIAL_2, 1, AG_WINDOW_CUSTOM_GRAVITY, gravity_speed); // 0.3
...
set_window_value(AT_USPECIAL_2, 2, AG_WINDOW_SFX, sound_get("last_gasp_blast"));
set_window_value(AT_USPECIAL_2, 2, AG_WINDOW_SFX_FRAME, 1);
//set_window_value(AT_USPECIAL_2, 2, AG_WINDOW_CUSTOM_GRAVITY, gravity_speed * 0.9);
...
set_window_value(AT_USPECIAL_2, 1, AG_WINDOW_VSPEED, 0);
set_window_value(AT_USPECIAL_2, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USPECIAL_2, 1, AG_WINDOW_SFX, sound_get("last_gasp"));
set_window_value(AT_USPECIAL_2, 1, AG_WINDOW_SFX_FRAME, 1);
...
// Penalty Zone
set_window_value(AT_USPECIAL_2, penalty_window, AG_WINDOW_LENGTH, max_penalty_frames);
...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_may_arc_cointoss"));
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_VSPEED, -28);
...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 5);
