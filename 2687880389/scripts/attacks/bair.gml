...
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_X, -74); // -80
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_Y, -51); // -51
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 36); // 60
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 48); // 48
...
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, blast_hit_effect);
...
set_hitbox_value(AT_BAIR, 2, HG_WIDTH, 78);
...
set_hitbox_value(AT_BAIR, 1, HG_WINDOW, 3);
set_hitbox_value(AT_BAIR, 1, HG_LIFETIME, 3);
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_X, -1);
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_Y, 33);
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 25);
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 21);
...
set_hitbox_value(AT_BAIR, 2, HG_WIDTH, 78);
set_hitbox_value(AT_BAIR, 2, HG_HEIGHT, 78);
...
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, blast_hit_effect);
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, asset_get("sfx_clairen_hit_med"));
...
set_hitbox_value(AT_BAIR, 3, HG_HITBOX_X, -2);
set_hitbox_value(AT_BAIR, 3, HG_HITBOX_Y, -10);
set_hitbox_value(AT_BAIR, 3, HG_WIDTH, 56);
set_hitbox_value(AT_BAIR, 3, HG_HEIGHT, 73);
...
set_hitbox_value(AT_BAIR, 1, HG_WINDOW, 3);
set_hitbox_value(AT_BAIR, 1, HG_LIFETIME, 3);
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_X, -2);
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_Y, 25);
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 25);
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 13);
set_hitbox_value(AT_BAIR, 1, HG_SHAPE, 0);
set_hitbox_value(AT_BAIR, 1, HG_PRIORITY, 2);
set_hitbox_value(AT_BAIR, 1, HG_DAMAGE, 5);
set_hitbox_value(AT_BAIR, 1, HG_ANGLE, 270);
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, asset_get("sfx_burnconsume"));
set_hitbox_value(AT_BAIR, 1, HG_ANGLE_FLIPPER, 0);
...
set_hitbox_value(AT_BAIR, 2, HG_WINDOW, 3);
set_hitbox_value(AT_BAIR, 2, HG_LIFETIME, 3);
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_X, -2);
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_Y, 28);
set_hitbox_value(AT_BAIR, 2, HG_WIDTH, 71);
set_hitbox_value(AT_BAIR, 2, HG_HEIGHT, 59);
set_hitbox_value(AT_BAIR, 2, HG_SHAPE, 0);
set_hitbox_value(AT_BAIR, 2, HG_PRIORITY, 1);
set_hitbox_value(AT_BAIR, 2, HG_DAMAGE, 5);
set_hitbox_value(AT_BAIR, 2, HG_ANGLE, 70);
...
set_hitbox_value(AT_BAIR, 1, HG_WINDOW, 3);
set_hitbox_value(AT_BAIR, 1, HG_LIFETIME, 3);
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_X, -5);
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_Y, -76);
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 76);
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 77);
set_hitbox_value(AT_BAIR, 1, HG_SHAPE, 0);
...
set_hitbox_value(AT_BAIR, 1, HG_PRIORITY, 2);
set_hitbox_value(AT_BAIR, 1, HG_DAMAGE, 18);
set_hitbox_value(AT_BAIR, 1, HG_ANGLE, 270);
