...
// Windup
set_window_value(AT_USTRONG, 1, AG_WINDOW_LENGTH, 5); // 4 5
...
// Hold
set_window_value(AT_USTRONG, 2, AG_WINDOW_LENGTH, 5); // 4 5
...
// Pre-kick
set_window_value(AT_USTRONG, 3, AG_WINDOW_LENGTH, 12); // 14 15 9
