...
set_window_value(AT_DAIR, 2, AG_WINDOW_SFX, laser_blast_sound);
...
set_window_value(AT_DAIR, 6, AG_WINDOW_ANIM_FRAMES, 0);
...
set_hitbox_value(AT_DAIR, 1, HG_HITBOX_X, -2); // -2
set_hitbox_value(AT_DAIR, 1, HG_HITBOX_Y, 34); // 43
set_hitbox_value(AT_DAIR, 1, HG_WIDTH, 52); // 52
set_hitbox_value(AT_DAIR, 1, HG_HEIGHT, 36); // 54
...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, -12);
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, blast_hit_effect);
...
set_hitbox_value(AT_DAIR, 2, HG_HEIGHT, 73);
...
set_hitbox_value(AT_DAIR, 1, HG_HITBOX_Y, 33);
set_hitbox_value(AT_DAIR, 1, HG_WIDTH, 25);
set_hitbox_value(AT_DAIR, 1, HG_HEIGHT, 21);
...
set_hitbox_value(AT_DAIR, 3, HG_HEIGHT, 73);
...
set_hitbox_value(AT_DAIR, 1, HG_WIDTH, 25);
set_hitbox_value(AT_DAIR, 1, HG_HEIGHT, 13);
set_hitbox_value(AT_DAIR, 1, HG_SHAPE, 0);
set_hitbox_value(AT_DAIR, 1, HG_PRIORITY, 2);
set_hitbox_value(AT_DAIR, 1, HG_DAMAGE, 5);
set_hitbox_value(AT_DAIR, 1, HG_ANGLE, 270);
...
set_hitbox_value(AT_DAIR, 2, HG_WIDTH, 71);
...
set_hitbox_value(AT_DAIR, 1, HG_HITBOX_Y, -76);
