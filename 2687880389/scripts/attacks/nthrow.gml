...
// windup/turn
set_window_value(AT_NTHROW, 1, AG_WINDOW_LENGTH, 21); // 12 15
...
// YEET
set_window_value(AT_NTHROW, 2, AG_WINDOW_LENGTH, 3); // 6
...
// recovery
set_window_value(AT_NTHROW, 3, AG_WINDOW_LENGTH, 10); // 10
...
// recovery
set_window_value(AT_NTHROW, 4, AG_WINDOW_LENGTH, 4); // 0
...
set_window_value(AT_NTHROW, 4, AG_WINDOW_VSPEED, 0);
set_window_value(AT_NTHROW, 4, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_NTHROW, 4, AG_WINDOW_HSPEED, 0);
...
set_hitbox_value(AT_NTHROW, 1, HG_ANGLE, 45); //  48 40
set_hitbox_value(AT_NTHROW, 1, HG_BASE_KNOCKBACK, 6.0); // 6.1 6.8
set_hitbox_value(AT_NTHROW, 1, HG_KNOCKBACK_SCALING, 1.05); // 1.15
set_hitbox_value(AT_NTHROW, 1, HG_BASE_HITPAUSE, 7); // 6.1 6.8
set_hitbox_value(AT_NTHROW, 1, HG_HITPAUSE_SCALING, 1.2); // 1.05 1.15
