...
// Hop
set_window_value(AT_DATTACK, 1, AG_WINDOW_LENGTH, 4); // 5
...
set_window_value(AT_DATTACK, 1, AG_WINDOW_HSPEED, 9); // 11
set_window_value(AT_DATTACK, 1, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_DATTACK, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0);
set_window_value(AT_DATTACK, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, asset_get("sfx_jumpair"));
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX_FRAME, 0);

// Angle
set_window_value(AT_DATTACK, 2, AG_WINDOW_LENGTH, 4); // 0
...
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX, tire_screech_sound);
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.4); // 0.3

// Hold
set_window_value(AT_DATTACK, 4, AG_WINDOW_LENGTH, 10); // 7 5
