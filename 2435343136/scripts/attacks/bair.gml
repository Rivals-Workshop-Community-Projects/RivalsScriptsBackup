...
//set_attack_value(AT_BAIR, AG_SPRITE, asset_get("sword_bair_spr"));
...
//set_attack_value(AT_BAIR, AG_HURTBOX_SPRITE, asset_get("sword_bair_hurt"));
...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, asset_get("sfx_clairen_swing_weak"));
...
set_hitbox_value(temp_attack, temp_num, HG_HEIGHT, 120);
...
set_hitbox_value(temp_attack, temp_num, HG_VISUAL_EFFECT_Y_OFFSET, -12);
