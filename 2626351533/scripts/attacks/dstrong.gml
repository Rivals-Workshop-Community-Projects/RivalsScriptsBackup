...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_ell_dspecial_explosion_3"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 81);
set_hitbox_value(AT_DSTRONG, 1, HG_HEIGHT, 71);
