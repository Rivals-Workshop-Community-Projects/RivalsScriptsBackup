...
set_window_value(AT_FSPECIAL, 5, AG_WINDOW_LENGTH, 33);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_LIFETIME, 21); //600
...
set_hitbox_value(AT_FSPECIAL, 2, HG_LIFETIME, 21); //600
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, asset_get("sfx_ell_utilt_hit"));
