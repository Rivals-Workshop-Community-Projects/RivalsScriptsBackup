...
set_window_value(AT_USTRONG, 1, AG_WINDOW_SFX, sound_get("bnewupstrongcharge"));
...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, sound_get("bnewupstrongrelease"));
...
set_hitbox_value(AT_USTRONG, 2, HG_HEIGHT, 105);
