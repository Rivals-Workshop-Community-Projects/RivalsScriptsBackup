...
set_window_value(AT_FSPECIAL_2, 1, AG_WINDOW_SFX, sound_get("bonby_frog_fspecial_grab"));
...
set_window_value(AT_FSPECIAL_2, 2, AG_WINDOW_SFX, sound_get("bonby_frog_fspecial_throw"));
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_PROJECTILE_SPRITE, sprite_get("frog_projectile"));
set_hitbox_value(AT_FSPECIAL_2, 1, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_FSPECIAL_2, 1, HG_PROJECTILE_ANIM_SPEED, 0.4);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_PROJECTILE_GRAVITY, 0.85);
set_hitbox_value(AT_FSPECIAL_2, 1, HG_WINDOW, 2);
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_FSPECIAL_2, 1, HG_PRIORITY, 8);
set_hitbox_value(AT_FSPECIAL_2, 1, HG_LIFETIME, 999);
