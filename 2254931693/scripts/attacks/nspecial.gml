...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("nspecialdraw"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HITPAUSE_SCALING, .75);
set_hitbox_value(AT_NSPECIAL, 1, HG_BASE_KNOCKBACK, 7.5);
set_hitbox_value(AT_NSPECIAL, 1, HG_KNOCKBACK_SCALING, 0.75);
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, sound_get("nspecialspikeballhit"));
