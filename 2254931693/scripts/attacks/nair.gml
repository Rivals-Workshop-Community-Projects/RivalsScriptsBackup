...
set_window_value(AT_NAIR, 2, AG_WINDOW_ANIM_FRAMES, 26);
...
set_window_value(AT_NAIR, 3, AG_WINDOW_ANIM_FRAME_START, 29);
set_window_value(AT_NAIR, 3, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_NAIR, 3, AG_WINDOW_SFX, asset_get("sfx_may_whip2"));
...
set_hitbox_value(AT_NAIR, 1, HG_BASE_HITPAUSE, 1.75);
...
set_hitbox_value(AT_NAIR, 6, HG_HITSTUN_MULTIPLIER, 0.65);
set_hitbox_value(AT_NAIR, 6, HG_BASE_KNOCKBACK, 8.25);
set_hitbox_value(AT_NAIR, 6, HG_KNOCKBACK_SCALING, 0.75);
