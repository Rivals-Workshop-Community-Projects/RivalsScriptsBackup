...
set_hitbox_value(AT_USPECIAL_GROUND, 3, HG_LIFETIME, 2);
...
set_hitbox_value(AT_USPECIAL_GROUND, 4, HG_LIFETIME, 2);
...
set_hitbox_value(AT_USPECIAL_GROUND, 5, HG_LIFETIME, 2);
