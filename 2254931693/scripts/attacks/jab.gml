...
set_window_value(AT_JAB, 2, AG_WINDOW_SFX, asset_get("sfx_dust_knuckle"));
...
set_window_value(AT_JAB, 4, AG_WINDOW_SFX, asset_get("sfx_dust_knuckle"));
...
set_hitbox_value(AT_JAB, 2, HG_KNOCKBACK_SCALING, 0.125);
