sprite_change_offset("idle", 92, 128);
...
sprite_change_offset("walk", 48, 88);
sprite_change_offset("walkturn", 48, 88);
sprite_change_offset("dash", 90, 132);
sprite_change_offset("dashstart", 90, 132);
sprite_change_offset("dashstop", 90, 132);
sprite_change_offset("dashturn", 90, 132);

sprite_change_offset("jumpstart", 92, 128);
sprite_change_offset("jump", 92, 128);
sprite_change_offset("doublejump", 92, 128);
sprite_change_offset("walljump", 92, 128);
sprite_change_offset("pratfall", 92, 128);
sprite_change_offset("land", 44, 88);
sprite_change_offset("landinglag", 48, 88);

sprite_change_offset("parry", 92, 128);
sprite_change_offset("roll_forward", 48, 88);
sprite_change_offset("roll_backward", 48, 88);
sprite_change_offset("airdodge", 48, 88);
sprite_change_offset("waveland", 92, 128);
sprite_change_offset("tech", 48, 88);
...
sprite_change_offset("cyclone_rune_back", 92, 128);
sprite_change_offset("uspecial_air", 92, 128);
sprite_change_offset("cyclone_rune_front", 92, 128);
sprite_change_offset("dspecial", 60, 96);
sprite_change_offset("dspecialair", 60, 96);
sprite_change_offset("dspecial_2", 92, 128);
sprite_change_offset("dspecial_3", 92, 128);
...
sprite_change_offset("frog_tongue_startup", 148, 328);
...
sprite_change_offset("frog_spit", 148, 328);
...
sprite_change_offset("uspecial_hiteffect", 125, 125);

sprite_change_offset("feri_costume_bon", 84, 114);
