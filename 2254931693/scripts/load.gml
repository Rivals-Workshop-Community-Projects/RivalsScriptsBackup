...
sprite_change_offset("dash", 48, 88);
sprite_change_offset("dashstart", 48, 88);
sprite_change_offset("dashstop", 48, 88);
sprite_change_offset("dashturn", 48, 88);

sprite_change_offset("jumpstart", 48, 88);
sprite_change_offset("jump", 48, 88);
...
sprite_change_offset("waveland", 48, 88);
sprite_change_offset("tech", 48, 88);

sprite_change_offset("jab", 48, 88);
...
sprite_change_offset("fair", 52, 110);
sprite_change_offset("bair", 68, 88);
sprite_change_offset("uair", 48, 88);
sprite_change_offset("dair", 48, 88);
...
sprite_change_offset("uspecialair", 48, 88);
sprite_change_offset("dspecial", 44, 96);
sprite_change_offset("dspecialair", 44, 96);
sprite_change_offset("taunt", 48, 88);

sprite_change_offset("plat", 64, 94);

sprite_change_offset("nspecialspikeballhitthing", 33, 67);
