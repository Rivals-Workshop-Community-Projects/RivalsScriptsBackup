...
set_window_value(AT_EXTRA_2, 3, AG_WINDOW_SFX, sound_get("magicshoot2"));
...
set_window_value(AT_EXTRA_2, 4, AG_WINDOW_SFX, sound_get("magicshoot2"));
...
set_window_value(AT_EXTRA_2, 5, AG_WINDOW_SFX, sound_get("magicshoot3"));
...
set_hitbox_value(AT_EXTRA_2, 2, HG_ANGLE_FLIPPER, 10);
...
set_hitbox_value(AT_EXTRA_2, 2, HG_KNOCKBACK_SCALING, .1);
...
set_hitbox_value(AT_EXTRA_2, 3, HG_HEIGHT, 65);
...
set_hitbox_value(AT_EXTRA_2, 3, HG_KNOCKBACK_SCALING, 1);
set_hitbox_value(AT_EXTRA_2, 3, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_EXTRA_2, 3, HG_HITPAUSE_SCALING, .9);
set_hitbox_value(AT_EXTRA_2, 3, HG_EXTRA_CAMERA_SHAKE, 1);
