...
set_attack_value(AT_TAUNT_2, AG_HURTBOX_SPRITE, sprite_get("hurtb"));
...
set_window_value(AT_TAUNT_2, 3, AG_WINDOW_SFX_FRAME, 8);
set_window_value(AT_TAUNT_2, 3, AG_WINDOW_SFX, sound_get("bluey_taunt"));
