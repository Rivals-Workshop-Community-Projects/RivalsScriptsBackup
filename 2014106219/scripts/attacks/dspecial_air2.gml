...
set_window_value(AT_DTHROW, 3, AG_WINDOW_HSPEED, 12);
set_window_value(AT_DTHROW, 3, AG_WINDOW_VSPEED, 28);
...
set_window_value(AT_DTHROW, 5, AG_WINDOW_LENGTH, 24);
...
set_hitbox_value(AT_DTHROW, 1, HG_KNOCKBACK_SCALING, .75);
...
set_hitbox_value(AT_DTHROW, 2, HG_DAMAGE, 12);
set_hitbox_value(AT_DTHROW, 2, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_DTHROW, 2, HG_ANGLE, 270);
set_hitbox_value(AT_DTHROW, 2, HG_HIT_LOCKOUT, 3);
set_hitbox_value(AT_DTHROW, 2, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_DTHROW, 2, HG_KNOCKBACK_SCALING, .75);
set_hitbox_value(AT_DTHROW, 2, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_DTHROW, 2, HG_EXTRA_HITPAUSE, 3);
...
set_hitbox_value(AT_DTHROW, 3, HG_LIFETIME, 10);
...
set_hitbox_value(AT_DTHROW, 3, HG_DAMAGE, 8);
set_hitbox_value(AT_DTHROW, 3, HG_ANGLE, 60);
set_hitbox_value(AT_DTHROW, 3, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_DTHROW, 3, HG_KNOCKBACK_SCALING, .85);
...
set_hitbox_value(AT_DTHROW, 4, HG_LIFETIME, 10);
...
set_hitbox_value(AT_DTHROW, 4, HG_DAMAGE, 8);
set_hitbox_value(AT_DTHROW, 4, HG_ANGLE, 60);
set_hitbox_value(AT_DTHROW, 4, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_DTHROW, 4, HG_KNOCKBACK_SCALING, .85);
...
set_hitbox_value(AT_DTHROW, 9, HG_HITBOX_X, -36);
set_hitbox_value(AT_DTHROW, 9, HG_HITBOX_Y, -54);
set_hitbox_value(AT_DTHROW, 9, HG_WIDTH, 64);
set_hitbox_value(AT_DTHROW, 9, HG_HEIGHT, 64);
...
set_hitbox_value(AT_DTHROW, 9, HG_ANGLE, 60);
set_hitbox_value(AT_DTHROW, 9, HG_ANGLE_FLIPPER, 5);
set_hitbox_value(AT_DTHROW, 9, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_DTHROW, 9, HG_KNOCKBACK_SCALING, .85);
set_hitbox_value(AT_DTHROW, 9, HG_VISUAL_EFFECT, 0);
...
set_hitbox_value(AT_DTHROW, 9, HG_EXTRA_HITPAUSE, 5);
