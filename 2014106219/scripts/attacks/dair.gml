...
set_hitbox_value(AT_DAIR, 1, HG_HITPAUSE_SCALING, .55);
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, sound_get("sword-hit1"));
...
set_hitbox_value(AT_DAIR, 2, HG_LIFETIME, 19);
...
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, sound_get("sword-hit3"));
...
set_hitbox_value(AT_DAIR, 3, HG_HITPAUSE_SCALING, .55);
set_hitbox_value(AT_DAIR, 3, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_DAIR, 3, HG_HIT_SFX, sound_get("sword-hit1"));
set_hitbox_value(AT_DAIR, 3, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_DAIR, 3, HG_HIT_LOCKOUT, 15);
