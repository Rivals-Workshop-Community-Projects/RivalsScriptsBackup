...
set_window_value(AT_DSPECIAL_AIR, 3, AG_WINDOW_HSPEED, 8);
set_window_value(AT_DSPECIAL_AIR, 3, AG_WINDOW_VSPEED, 23);
...
set_window_value(AT_DSPECIAL_AIR, 5, AG_WINDOW_LENGTH, 24);
...
set_hitbox_value(AT_DSPECIAL_AIR, 3, HG_LIFETIME, 10);
...
set_hitbox_value(AT_DSPECIAL_AIR, 3, HG_KNOCKBACK_SCALING, .65);
set_hitbox_value(AT_DSPECIAL_AIR, 3, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_DSPECIAL_AIR, 3, HG_HITPAUSE_SCALING, .65);
...
set_hitbox_value(AT_DSPECIAL_AIR, 4, HG_LIFETIME, 10);
...
set_hitbox_value(AT_DSPECIAL_AIR, 4, HG_KNOCKBACK_SCALING, .65);
set_hitbox_value(AT_DSPECIAL_AIR, 4, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_DSPECIAL_AIR, 4, HG_HITPAUSE_SCALING, .65);
