...
set_hitbox_value(AT_NSPECIAL, 1, HG_LIFETIME, 36);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_AIR_FRICTION, -.15);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_HITBOX_X, 68);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_FINAL_BASE_KNOCKBACK, 3);
