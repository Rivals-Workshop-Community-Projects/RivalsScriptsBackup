...
set_window_value(AT_FSPECIAL_2, 3, AG_WINDOW_SFX_FRAME, 5);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_VISUAL_EFFECT, 110);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_PROJECTILE_VSPEED, -9);
set_hitbox_value(AT_FSPECIAL_2, 1, HG_PROJECTILE_AIR_FRICTION, .01);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_PROJECTILE_DESTROY_EFFECT, 110);
