...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_HSPEED, 21);
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_VSPEED_TYPE, 1);
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .001);
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, .001);
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, .001);
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, .001);
...
set_window_value(AT_DSPECIAL, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, .75);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HITPAUSE_SCALING, .75);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_HITBOX_X, 64);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_FINAL_BASE_KNOCKBACK, 3);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_HIT_SFX, sound_get("sword-hit2"));