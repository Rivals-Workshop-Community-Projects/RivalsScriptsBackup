...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_ori_glide_featherout"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_KNOCKBACK_SCALING, .55);
set_hitbox_value(AT_DSPECIAL, 1, HG_BASE_HITPAUSE, 9);
set_hitbox_value(AT_DSPECIAL, 1, HG_HITPAUSE_SCALING, .55);
set_hitbox_value(AT_DSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_ori_glide_hit"));
set_hitbox_value(AT_DSPECIAL, 1, HG_HIT_LOCKOUT, 7);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_KNOCKBACK_SCALING, .01);
set_hitbox_value(AT_DSPECIAL, 2, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_DSPECIAL, 2, HG_HIT_LOCKOUT, 4);
set_hitbox_value(AT_DSPECIAL, 2, HG_HITPAUSE_SCALING, .05);
