...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, sound_get("sword-brandish"));
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_HSPEED, 22);
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, 2);
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, 3);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HIT_SFX, sound_get("sword-hit2"));