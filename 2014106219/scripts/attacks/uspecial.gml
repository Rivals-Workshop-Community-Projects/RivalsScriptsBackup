...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, .3);
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .3);
...
set_hitbox_value(AT_USPECIAL, 1, HG_LIFETIME, 56);
set_hitbox_value(AT_USPECIAL, 1, HG_HITBOX_Y, -82);
