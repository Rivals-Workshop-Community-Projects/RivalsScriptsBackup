...
set_window_value(AT_DSPECIAL_2, 2, AG_WINDOW_SFX, sound_get("magicshoot3"));
...
set_window_value(AT_DSPECIAL_2, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, .005);
set_window_value(AT_DSPECIAL_2, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, .005);
...
set_window_value(AT_DSPECIAL_2, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.25);
set_window_value(AT_DSPECIAL_2, 5, AG_WINDOW_CUSTOM_AIR_FRICTION, .55);
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_KNOCKBACK_SCALING, .75);
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_HITBOX_X, -50);
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_KNOCKBACK_SCALING, .85);
