...
set_window_value(AT_DSPECIAL_2, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .55);
set_window_value(AT_DSPECIAL_2, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, .55);
...
set_window_value(AT_DSPECIAL_2, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.25);
set_window_value(AT_DSPECIAL_2, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, .45);
...
set_window_value(AT_DSPECIAL_2, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1);
set_window_value(AT_DSPECIAL_2, 5, AG_WINDOW_CUSTOM_AIR_FRICTION, 1);
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HITBOX_X, 74);
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_HITBOX_X, 76);
...
set_hitbox_value(AT_DSPECIAL_2, 3, HG_LIFETIME, 16);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_HITBOX_X, 76);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_HITBOX_Y, -20);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_WIDTH, 78);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_HEIGHT, 22);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_PRIORITY, 2);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_DAMAGE, 5);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_VISUAL_EFFECT, 0);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_ANGLE, 60);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_BASE_KNOCKBACK, 4);
