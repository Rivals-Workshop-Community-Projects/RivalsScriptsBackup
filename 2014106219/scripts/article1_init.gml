...
sprite_index = sprite_get("fspecial_proj");         //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
...
hsp = 3;                                            //The horizontal speed of the article. Multiply by spr_dir to correctly handle forward (+) or backward (-) movement
vsp = -6;                                           //The vertical speed of the article.
...
die_time = 110;                                      //Example variable used in this case to determine how long the article should take to die (state 2). 
animation_type = .5;                                 //This variable is part of the animation handling found in article1_update. It determines when, or how frequently, the image_index should increment
...
maxarticles = 2;                                    //The maximum number of this article that should exist at once.
