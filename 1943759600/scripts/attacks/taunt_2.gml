set_attack_value(AT_TAUNT_2, AG_SPRITE, sprite_get("tauntG7"));
...
set_window_value(AT_TAUNT_2, 1, AG_WINDOW_SFX, sound_get("g7glitch_1"));
...
set_window_value(AT_TAUNT_2, 3, AG_WINDOW_ANIM_FRAMES, 11);
set_window_value(AT_TAUNT_2, 3, AG_WINDOW_ANIM_FRAME_START,8);
set_window_value(AT_TAUNT_2, 3, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_TAUNT_2, 3, AG_WINDOW_SFX, sound_get("g7glitch_2"));
set_window_value(AT_TAUNT_2, 3, AG_WINDOW_SFX_FRAME, 5);
