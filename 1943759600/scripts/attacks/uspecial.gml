...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_SFX, sound_get("olym_finisher"));
...
set_hitbox_value(AT_USPECIAL, 4, HG_HITBOX_Y, -29);
...
set_hitbox_value(AT_USPECIAL, 5, HG_HITBOX_Y, -29);
...
set_hitbox_value(AT_USPECIAL, 6, HG_HITBOX_Y, -29);
