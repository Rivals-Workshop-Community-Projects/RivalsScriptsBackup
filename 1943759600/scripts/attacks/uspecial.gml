...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_TYPE, 1); //active
...
set_hitbox_value(AT_USPECIAL, 2, HG_HITBOX_Y, -49);
...
set_hitbox_value(AT_USPECIAL, 3, HG_HITBOX_Y, -49);
...
set_hitbox_value(AT_USPECIAL, 4, HG_HITBOX_Y, -49);
...
set_hitbox_value(AT_USPECIAL, 5, HG_HITBOX_Y, -49);
...
set_hitbox_value(AT_USPECIAL, 6, HG_HITBOX_Y, -49);
...
set_hitbox_value(AT_USPECIAL, 7, HG_HITBOX_Y, -53);
set_hitbox_value(AT_USPECIAL, 7, HG_HITBOX_X, 18);
...
set_hitbox_value(AT_USPECIAL, 8, HG_HITBOX_Y, -74);
set_hitbox_value(AT_USPECIAL, 8, HG_HITBOX_X, 46);
set_hitbox_value(AT_USPECIAL, 8, HG_WIDTH, 48);
...
set_hitbox_value(AT_USPECIAL, 8, HG_KNOCKBACK_SCALING, .85);
set_hitbox_value(AT_USPECIAL, 8, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_USPECIAL, 8, HG_HITPAUSE_SCALING, .3);
