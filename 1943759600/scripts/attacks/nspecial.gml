...
set_attack_value(AT_NSPECIAL, AG_HURTBOX_AIR_SPRITE, sprite_get("nspecial2_hurt"));
...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("olym_twinkle"));
...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_TYPE, 420); //This makes it cancel inside the gem field
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_LENGTH, 16);
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_ANIM_FRAME_START, 5);

set_window_value(AT_NSPECIAL, 4, AG_WINDOW_TYPE, 1); //This makes it cancel inside the gem field
...
set_hitbox_value(AT_NSPECIAL, 1, HG_LIFETIME, 26);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_metal_hit_strong"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HIT_SFX, sound_get("clonk"));
