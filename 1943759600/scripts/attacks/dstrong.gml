...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_TYPE, 420); //This makes it cancel inside the gem field
...
set_hitbox_value(AT_DSTRONG, 3, HG_WIDTH, 82);
set_hitbox_value(AT_DSTRONG, 3, HG_HEIGHT, 38);
