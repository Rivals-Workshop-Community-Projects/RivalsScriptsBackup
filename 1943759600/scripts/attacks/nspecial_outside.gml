...
set_attack_value(AT_NSPECIAL_2, AG_AIR_SPRITE, sprite_get("nspecial2_2"));
set_attack_value(AT_NSPECIAL_2, AG_HURTBOX_SPRITE, sprite_get("nspecial_2_hurt"));
set_attack_value(AT_NSPECIAL_2, AG_HURTBOX_AIR_SPRITE, sprite_get("nspecial2_2_hurt"));
...
set_window_value(AT_NSPECIAL_2, 1, AG_WINDOW_SFX, asset_get("sfx_blink_dash"));
...
set_window_value(AT_NSPECIAL_2, 3, AG_WINDOW_TYPE, 69); //This will make the gem flash
...
//The hitbox below is the stun hitbox
...
set_hitbox_value(AT_NSPECIAL_2, 1, HG_EFFECT, 990);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HITPAUSE_SCALING, 0.2);
...
set_hitbox_value(AT_NSPECIAL_2, 2, HG_WIDTH, 220);
set_hitbox_value(AT_NSPECIAL_2, 2, HG_HEIGHT, 220);
...
set_hitbox_value(AT_NSPECIAL_2, 2, HG_EFFECT, 990);
set_hitbox_value(AT_NSPECIAL_2, 2, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_NSPECIAL_2, 2, HG_HITPAUSE_SCALING, 0.2);
