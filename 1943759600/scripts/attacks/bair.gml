...
set_window_value(AT_BAIR, 3, AG_WINDOW_TYPE, 420); //This makes it cancel inside the gem field
...
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_Y, -21);
...
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_X, -21);
