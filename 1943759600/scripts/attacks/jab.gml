...
set_window_value(AT_JAB, 4, AG_WINDOW_ANIM_FRAMES, 0);
...
set_window_value(AT_JAB, 8, AG_WINDOW_SFX_FRAME, 15);
...
set_hitbox_value(AT_JAB, 3, HG_BASE_KNOCKBACK, 7.5);
...
set_hitbox_value(AT_JAB, 5, HG_HITBOX_X, 22);
set_hitbox_value(AT_JAB, 5, HG_HITBOX_Y, -22);
set_hitbox_value(AT_JAB, 5, HG_WIDTH, 79);
