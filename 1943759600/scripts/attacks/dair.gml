...
set_window_value(AT_DAIR, 3, AG_WINDOW_TYPE, 419); //This makes it cancel inside the gem field
...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, olym_hit);
...
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, sound_get("olym_sweetspot2"));
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT, olym_hit);
