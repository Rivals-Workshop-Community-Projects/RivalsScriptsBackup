...
set_window_value(AT_NAIR, 3, AG_WINDOW_TYPE, 420); //This makes it cancel inside the gem field
...
set_window_value(AT_NAIR, 5, AG_WINDOW_TYPE, 420); //This makes it cancel inside the gem field
