...
var i = 1;
set_window_value(AT_USPECIAL, i, AG_WINDOW_TYPE, 1);
set_window_value(AT_USPECIAL, i, AG_WINDOW_LENGTH, 9);
set_window_value(AT_USPECIAL, i, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_USPECIAL, i, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USPECIAL, i, AG_WINDOW_SFX, asset_get("sfx_bubblepop"));

i = 2;
set_window_value(AT_USPECIAL, i, AG_WINDOW_TYPE, 1);
set_window_value(AT_USPECIAL, i, AG_WINDOW_LENGTH, 60);
set_window_value(AT_USPECIAL, i, AG_WINDOW_ANIM_FRAMES, 7);
set_window_value(AT_USPECIAL, i, AG_WINDOW_ANIM_FRAME_START, 3);

i = 3;
set_window_value(AT_USPECIAL, i, AG_WINDOW_TYPE, 69);
set_window_value(AT_USPECIAL, i, AG_WINDOW_LENGTH, 6);
set_window_value(AT_USPECIAL, i, AG_WINDOW_ANIM_FRAMES, 0);
set_window_value(AT_USPECIAL, i, AG_WINDOW_ANIM_FRAME_START, 10);
set_window_value(AT_USPECIAL, i, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USPECIAL, i, AG_WINDOW_SFX, asset_get("sfx_bubblespray"));


i = 4;
set_window_value(AT_USPECIAL, i, AG_WINDOW_TYPE, 7);
set_window_value(AT_USPECIAL, i, AG_WINDOW_LENGTH, 4);
set_window_value(AT_USPECIAL, i, AG_WINDOW_ANIM_FRAMES, 0);
set_window_value(AT_USPECIAL, i, AG_WINDOW_ANIM_FRAME_START, 15);

i = 5;
set_window_value(AT_USPECIAL, i, AG_WINDOW_TYPE, 1);
set_window_value(AT_USPECIAL, i, AG_WINDOW_LENGTH, 23);
set_window_value(AT_USPECIAL, i, AG_WINDOW_ANIM_FRAMES, 4);
set_window_value(AT_USPECIAL, i, AG_WINDOW_ANIM_FRAME_START, 11);
set_window_value(AT_USPECIAL, i, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_USPECIAL, i, AG_WINDOW_HSPEED, -9);
set_window_value(AT_USPECIAL, i, AG_WINDOW_VSPEED, -6);
set_window_value(AT_USPECIAL, i, AG_WINDOW_HSPEED_TYPE, 2);
set_window_value(AT_USPECIAL, i, AG_WINDOW_VSPEED_TYPE, 2);
...
set_hitbox_value(AT_USPECIAL, 1, HG_EFFECT, 69420);
...
set_attack_value(AT_USPECIAL, AG_HURTBOX_SPRITE, sprite_get("uspecial_hurt"));
set_attack_value(AT_USPECIAL, AG_STRONG_CHARGE_WINDOW, 5);
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_gus_jump"));
...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_gus_jump"));
...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_gus_jump"));

set_window_value(AT_USPECIAL, 5, AG_WINDOW_TYPE, 69);
...
set_window_value(AT_USPECIAL, 6, AG_WINDOW_LENGTH, 40);
...
set_window_value(AT_USPECIAL, 6, AG_WINDOW_VSPEED, -11);
set_window_value(AT_USPECIAL, 6, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USPECIAL, 6, AG_WINDOW_SFX, asset_get("sfx_frog_gong_hit"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_EFFECT, 420);
...
set_hitbox_value(AT_USPECIAL, 2, HG_EFFECT, 420);
