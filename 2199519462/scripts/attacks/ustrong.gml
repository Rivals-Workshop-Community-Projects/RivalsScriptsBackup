...
set_window_value(AT_USTRONG, 2, AG_WINDOW_HSPEED, 8);
...
set_window_value(AT_USTRONG, 4, AG_WINDOW_TYPE, 101);
...
set_window_value(AT_USTRONG, 4, AG_WINDOW_SFX, asset_get("sfx_blow_heavy1"));
set_window_value(AT_USTRONG, 4, AG_WINDOW_SFX_FRAME, 14);
...
set_window_value(AT_USTRONG, 5, AG_WINDOW_HSPEED, -4);
...
set_hitbox_value(AT_USTRONG, 1, HG_EFFECT, 420);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, hfx[4]);
...
set_hitbox_value(AT_USTRONG, 2, HG_EFFECT, 420);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, hfx[4]);
...
set_hitbox_value(AT_USTRONG, 3, HG_EFFECT, 420);
set_hitbox_value(AT_USTRONG, 3, HG_PRIORITY, 2);
set_hitbox_value(AT_USTRONG, 3, HG_DAMAGE, 9);
set_hitbox_value(AT_USTRONG, 3, HG_ANGLE, 235);
set_hitbox_value(AT_USTRONG, 3, HG_EFFECT, 420);
...
set_hitbox_value(AT_USTRONG, 3, HG_VISUAL_EFFECT, hfx[4]);
