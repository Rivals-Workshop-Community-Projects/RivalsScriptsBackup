...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_shovel_swing_light2"));
...
set_window_value(AT_FSTRONG, 5, AG_WINDOW_TYPE, 99);
...
set_window_value(AT_FSTRONG, 5, AG_WINDOW_SFX, asset_get("sfx_land_med"));

set_window_value(AT_FSTRONG, 6, AG_WINDOW_TYPE, 99);
...
set_window_value(AT_FSTRONG, 7, AG_WINDOW_TYPE, 99);
...
set_window_value(AT_FSTRONG, 8, AG_WINDOW_TYPE, 98);
...
set_window_value(AT_FSTRONG, 8, AG_WINDOW_SFX, asset_get("sfx_land_light"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_X, 62);
...
set_hitbox_value(AT_FSTRONG, 1, HG_SDI_MULTIPLIER, 2);
set_hitbox_value(AT_FSTRONG, 1, HG_BASE_HITPAUSE, 16);
set_hitbox_value(AT_FSTRONG, 1, HG_HITPAUSE_SCALING, 1);
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, hfx[3]);
...
set_hitbox_value(AT_FSTRONG, 1, HG_EFFECT, 420);
