...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_TYPE, 69);
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_zetter_fireball_fire"));
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_SFX, asset_get("sfx_abyss_explosion"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_X, 98);
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, 4);
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, asset_get("sfx_waveland_zet"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_X, 98);
...
set_hitbox_value(AT_DSTRONG, 2, HG_SDI_MULTIPLIER, 0.2);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, asset_get("plop_sfx"));
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_GROUP, -1);

set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_DSTRONG, 3, HG_WINDOW, 4);
set_hitbox_value(AT_DSTRONG, 3, HG_LIFETIME, 2);
set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_X, 98);
...
set_hitbox_value(AT_DSTRONG, 3, HG_SDI_MULTIPLIER, 0.3);
...
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT, 148);
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_DSTRONG, 3, HG_HIT_SFX, asset_get("sfx_waveland_zet"));
set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_GROUP, 8);