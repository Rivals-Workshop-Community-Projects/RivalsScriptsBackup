set_attack_value(AT_USPECIAL, AG_SPRITE, sprite_get("ustrong_2"));
...
set_attack_value(AT_USPECIAL, AG_HURTBOX_SPRITE, sprite_get("ustrong_2_hurt"));
...
set_hitbox_value(AT_USPECIAL, 3, HG_BASE_KNOCKBACK, 17);
...
set_hitbox_value(AT_USPECIAL, 4, HG_HITBOX_X, 45);
...
set_hitbox_value(AT_USPECIAL, 4, HG_BASE_KNOCKBACK, 17);
...
set_hitbox_value(AT_USPECIAL, 5, HG_HITBOX_X, 45);
...
set_hitbox_value(AT_USPECIAL, 5, HG_BASE_KNOCKBACK, 17);
...
set_hitbox_value(AT_USPECIAL, 6, HG_WINDOW_CREATION_FRAME, 5);
set_hitbox_value(AT_USPECIAL, 6, HG_LIFETIME, 1);
set_hitbox_value(AT_USPECIAL, 6, HG_HITBOX_X, 45);
set_hitbox_value(AT_USPECIAL, 6, HG_HITBOX_Y, -55);
...
set_hitbox_value(AT_USPECIAL, 6, HG_VISUAL_EFFECT_Y_OFFSET, -10);
