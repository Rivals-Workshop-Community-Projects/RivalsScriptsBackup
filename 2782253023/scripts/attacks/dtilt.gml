...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, asset_get("sfx_clairen_swing_med"));
...
set_hitbox_value(AT_DTILT, 1, HG_DRIFT_MULTIPLIER, -0.9);
set_hitbox_value(AT_DTILT, 1, HG_SDI_MULTIPLIER, -0.9);
