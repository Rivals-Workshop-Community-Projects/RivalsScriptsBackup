...
set_hitbox_value(AT_FSTRONG, 1, HG_ANGLE, 47);
set_hitbox_value(AT_FSTRONG, 1, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_FSTRONG, 1, HG_KNOCKBACK_SCALING, 1.1);
set_hitbox_value(AT_FSTRONG, 1, HG_BASE_HITPAUSE, 12);
set_hitbox_value(AT_FSTRONG, 1, HG_HITPAUSE_SCALING, 1.0);set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sound_get("dthrowsfx"));
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, hit_diagonal1);
