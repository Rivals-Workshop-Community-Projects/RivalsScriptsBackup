...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, sound_get("Bow03"));
...
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT, hit_small_heart);
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, 10);
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_Y_OFFSET, 10);
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, sound_get("BTL_RAPIER1"));
