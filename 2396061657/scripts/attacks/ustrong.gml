...
set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX, sound_get("SE_battle#120"));
...
set_hitbox_value(AT_USTRONG, 1, HG_EXTRA_HITPAUSE, 10);
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, hit_ustrong);
...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_PARTICLE_NUM, 4);
...
set_hitbox_value(AT_USTRONG, 2, HG_HEIGHT, 49);
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("uspecial2"));
...
set_hitbox_value(AT_USTRONG, 3, HG_WIDTH, 43);
set_hitbox_value(AT_USTRONG, 3, HG_HEIGHT, 49);
...
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, sound_get("uspecial2"));
...
set_hitbox_value(AT_USTRONG, 4, HG_EXTRA_HITPAUSE, 10);
set_hitbox_value(AT_USTRONG, 4, HG_VISUAL_EFFECT, hit_ustrong);
set_hitbox_value(AT_USTRONG, 4, HG_VISUAL_EFFECT_X_OFFSET, 10);
set_hitbox_value(AT_USTRONG, 4, HG_VISUAL_EFFECT_Y_OFFSET, -40);
set_hitbox_value(AT_USTRONG, 4, HG_HIT_SFX, sound_get("ustrongtwinklehit"));
set_hitbox_value(AT_USTRONG, 4, HG_HIT_PARTICLE_NUM, 4);

set_hitbox_value(AT_USTRONG, 5, HG_PARENT_HITBOX, 4);
...
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_Y, -95);

set_hitbox_value(AT_USTRONG, 6, HG_PARENT_HITBOX, 4);
...
set_hitbox_value(AT_USTRONG, 6, HG_HITBOX_Y, -95);