...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, hit_bat_shatter);
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, hit_bat_shatter);
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT_Y_OFFSET, -30);
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("dthrowsfx"));
