...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("CMN_SWISH_2"));
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.05);
set_window_value(AT_DSTRONG, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.05);
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, -30);
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("dthrowsfx"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("uspecial1"));
