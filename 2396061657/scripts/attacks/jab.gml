...
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, sound_get("Swing01"));
...
set_window_value(AT_JAB, 4, AG_WINDOW_SFX, sound_get("CMN_JUMP02"));
...
set_window_value(AT_JAB, 7, AG_WINDOW_SFX, sound_get("CMN_JUMP02"));
set_window_value(AT_JAB, 7, AG_WINDOW_SFX_FRAME, 10);
...
set_hitbox_value(AT_JAB, 1, HG_VISUAL_EFFECT, hit_surprise);
set_hitbox_value(AT_JAB, 1, HG_VISUAL_EFFECT_X_OFFSET, 15);
set_hitbox_value(AT_JAB, 1, HG_VISUAL_EFFECT_Y_OFFSET, -5);
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("fthrowsfx"));
...
set_hitbox_value(AT_JAB, 2, HG_VISUAL_EFFECT, hit_small_heart);
set_hitbox_value(AT_JAB, 2, HG_VISUAL_EFFECT_X_OFFSET, 20);
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, sound_get("BTL_RAPIER_CRITICAL"));
...
set_hitbox_value(AT_JAB, 3, HG_VISUAL_EFFECT, hit_big_heart);
set_hitbox_value(AT_JAB, 3, HG_VISUAL_EFFECT_X_OFFSET, 30);
set_hitbox_value(AT_JAB, 3, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, sound_get("dthrowsfx"));
