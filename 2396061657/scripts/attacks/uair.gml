...
//set_window_value(AT_UAIR, 1, AG_WINDOW_CUSTOM_GRAVITY,  3.3);
...
//set_window_value(AT_UAIR, 2, AG_WINDOW_CUSTOM_GRAVITY,  3.3);
...
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT, hit_up);
