...
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT, hit_up);
...
set_hitbox_value(AT_UAIR, 3, HG_VISUAL_EFFECT, hit_up);
set_hitbox_value(AT_UAIR, 3, HG_VISUAL_EFFECT_X_OFFSET, 20);
set_hitbox_value(AT_UAIR, 3, HG_VISUAL_EFFECT_Y_OFFSET, -30);
set_hitbox_value(AT_UAIR, 3, HG_HIT_SFX, sound_get("BTL_HAND_CRITICAL"));
