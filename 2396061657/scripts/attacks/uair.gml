...
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, sound_get("SE_battle#120"));
...
set_hitbox_value(AT_UAIR, 1, HG_WIDTH, 130);
...
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT, hit_bat_shatter);
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, 20);
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, -30);
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, sound_get("BTL_HAND_CRITICAL"));
...
set_hitbox_value(AT_UAIR, 2, HG_HITBOX_X, 60);
...
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT, hit_bat_shatter);
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, -20);
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, sound_get("BTL_HAND_CRITICAL"));
...
set_hitbox_value(AT_UAIR, 1, HG_HIT_PARTICLE_NUM, 3);
