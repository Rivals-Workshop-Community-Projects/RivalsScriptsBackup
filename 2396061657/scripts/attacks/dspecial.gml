...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX, sound_get("CMN_SWISH01"));
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .4);
...
set_window_value(AT_DSPECIAL, 6, AG_WINDOW_LENGTH, dash_cancel_endlag); // Normally 15
...
set_window_value(AT_DSPECIAL, 6, AG_WINDOW_CUSTOM_GROUND_FRICTION, .2);
set_window_value(AT_DSPECIAL, 6, AG_WINDOW_CUSTOM_AIR_FRICTION, .2);
