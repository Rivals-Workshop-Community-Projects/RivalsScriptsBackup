...
set_hitbox_value(AT_NTHROW, 2, HG_DAMAGE, 7);
set_hitbox_value(AT_NTHROW, 2, HG_ANGLE, 90);
set_hitbox_value(AT_NTHROW, 2, HG_BASE_KNOCKBACK, RibbonKB); // Every 50 increased by .5 starting at 8.5
set_hitbox_value(AT_NTHROW, 2, HG_KNOCKBACK_SCALING, .85);
