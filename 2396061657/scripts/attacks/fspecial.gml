...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_SFX, sound_get("CMN_SWISH_2"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT, hit_surprise);
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT_Y_OFFSET, -5);
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, sound_get("fspecialsfx"));
