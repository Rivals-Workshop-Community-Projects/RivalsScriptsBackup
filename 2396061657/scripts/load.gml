...
sprite_change_offset("nair", 70, 100);
sprite_change_offset("fair", 38, 94);
...
sprite_change_offset("dstrong", 50, 98);
...
sprite_change_offset("up_fx", 32, 63);
sprite_change_offset("forward_fx", 64, 36);
sprite_change_offset("back_fx", 64, 36);
sprite_change_offset("hit_diagonal1", 174, 166);
sprite_change_offset("hit_slap", 174, 166);
sprite_change_offset("hit_heart", 174, 166);
sprite_change_offset("dair_fx", 65, 50);
sprite_change_offset("uthrow_fx", 79, 70);
sprite_change_offset("dthrow_fx", 73, 69);
sprite_change_offset("fthrow_fx", 75, 64);
