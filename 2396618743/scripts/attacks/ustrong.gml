...
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_X, 18);
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_Y, -60);
set_hitbox_value(AT_USTRONG, 5, HG_WIDTH, 32);
set_hitbox_value(AT_USTRONG, 5, HG_HEIGHT, 55);
...
set_hitbox_value(AT_USTRONG, 6, HG_HITPAUSE_SCALING, .9);
set_hitbox_value(AT_USTRONG, 6, HG_VISUAL_EFFECT, flood1);
set_hitbox_value(AT_USTRONG, 6, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_USTRONG, 6, HG_HIT_SFX, asset_get("sfx_waterhit_heavy"));
set_hitbox_value(AT_USTRONG, 6, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_USTRONG, 6, HG_HIT_LOCKOUT, 5);