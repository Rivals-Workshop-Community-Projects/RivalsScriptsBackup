...
set_window_value(AT_TAUNT, 2, AG_WINDOW_SFX, asset_get("sfx_coin_collect"));
set_window_value(AT_TAUNT, 2, AG_WINDOW_SFX_FRAME, 9);

set_window_value(AT_TAUNT, 3, AG_WINDOW_TYPE, 3);
set_window_value(AT_TAUNT, 3, AG_WINDOW_LENGTH, 52);
set_window_value(AT_TAUNT, 3, AG_WINDOW_ANIM_FRAMES, 13);
set_window_value(AT_TAUNT, 3, AG_WINDOW_ANIM_FRAME_START, 6);
set_window_value(AT_TAUNT, 3, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_TAUNT, 3, AG_WINDOW_SFX, asset_get("sfx_owl1"));
set_window_value(AT_TAUNT, 3, AG_WINDOW_SFX_FRAME, 9);
...
set_hitbox_value(AT_TAUNT, 1, HG_HITBOX_Y, -67);
...
set_hitbox_value(AT_TAUNT, 1, HG_KNOCKBACK_SCALING, .4);
