...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, sound_get("terra_slash1"));
...
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, sound_get("terra_swordhit1"));
...
set_hitbox_value(AT_DTILT, 2, HG_HIT_SFX, sound_get("terra_swordhit1"));