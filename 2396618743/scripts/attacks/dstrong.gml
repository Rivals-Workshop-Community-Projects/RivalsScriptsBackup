...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_kragg_rock_shatter"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 163);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITPAUSE_SCALING, .85);
