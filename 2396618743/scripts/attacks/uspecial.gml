...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_bird_nspecial"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_WIDTH, 147);
...
set_hitbox_value(AT_USPECIAL, 2, HG_WIDTH, 147);
set_hitbox_value(AT_USPECIAL, 2, HG_HEIGHT, 126);
...
set_hitbox_value(AT_USPECIAL, 3, HG_HEIGHT, 102);
...
set_hitbox_value(AT_USPECIAL, 4, HG_HEIGHT, 102);
