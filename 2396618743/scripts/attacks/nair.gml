...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, sound_get("terra_slash1"));
...
set_window_value(AT_NAIR, 3, AG_WINDOW_SFX, sound_get("terra_slash3"));
...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sound_get("terra_swordhit1"));
...
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, sound_get("terra_swordhit1"));
...
set_hitbox_value(AT_NAIR, 3, HG_HITPAUSE_SCALING, .35);
set_hitbox_value(AT_NAIR, 3, HG_VISUAL_EFFECT_X_OFFSET, 20);
set_hitbox_value(AT_NAIR, 3, HG_VISUAL_EFFECT_Y_OFFSET, -20);
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, sound_get("terra_swordhit2"));
