...
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, asset_get("sfx_ell_arc_taunt_end"));
set_hitbox_value(AT_DAIR, 1, HG_HITSTUN_MULTIPLIER, .5);
...
set_hitbox_value(AT_DAIR, 2, HG_PROJECTILE_SPRITE, sprite_get("nothing"));
...
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT, 67);
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, 0);
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, asset_get("sfx_ell_arc_taunt_end"));
set_hitbox_value(AT_DAIR, 2, HG_HITSTUN_MULTIPLIER, .5);
...
set_hitbox_value(AT_DAIR, 3, HG_WIDTH, 180);
set_hitbox_value(AT_DAIR, 3, HG_HEIGHT, 180);
...
set_hitbox_value(AT_DAIR, 3, HG_BASE_KNOCKBACK, 0);
