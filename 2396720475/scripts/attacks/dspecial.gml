...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, sound_get("box2_sfx"));
...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_CUSTOM_GRAVITY, 1.3);
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_CUSTOM_GRAVITY, 1.3);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_LIFETIME, 19);
