...
set_hitbox_value(AT_DSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("tomotomotomo"));
...
set_hitbox_value(AT_DSPECIAL, 2, HG_LIFETIME, 19);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HIT_SFX, sound_get("basic2_hit_sfx"));
set_hitbox_value(AT_DSPECIAL, 2, HG_IGNORES_PROJECTILES, 1);
set_hitbox_value(AT_DSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("tomotomotomo"));
