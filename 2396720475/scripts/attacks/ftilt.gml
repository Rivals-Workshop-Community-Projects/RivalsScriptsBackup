...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, sound_get("bair2_sfx"));
...
set_hitbox_value(AT_FTILT, 1, HG_HITBOX_X, 23);
...
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT, hit_small3);
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT_X_OFFSET,40);
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT_Y_OFFSET, 10);
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, sound_get("sharp_hit_sfx"));

// Same as above stat wise
...
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT, hit_small3);
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT_X_OFFSET, 52);
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT_Y_OFFSET, 10);
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, sound_get("sharp_hit_sfx"));