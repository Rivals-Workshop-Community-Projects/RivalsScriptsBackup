...
set_hitbox_value(AT_USTRONG, 1, HG_WIDTH, 15);
...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("strong_hit_sfx"));
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, hit_spiky);
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("strong_hit_sfx"));
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, hit_small4);
