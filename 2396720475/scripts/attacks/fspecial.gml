...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sound_get("fspecial_startup"));
...
set_window_value(AT_FSPECIAL, 6, AG_WINDOW_CUSTOM_AIR_FRICTION, .40);
set_window_value(AT_FSPECIAL, 6, AG_WINDOW_CUSTOM_GROUND_FRICTION, .60);

// Bounce Lag
set_window_value(AT_FSPECIAL, 7, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL, 7, AG_WINDOW_LENGTH, 10);
set_window_value(AT_FSPECIAL, 7, AG_WINDOW_HSPEED, -1.5);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, sound_get("basic1_hit_sfx"));
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT, hit_small3);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, sound_get("basic2_hit_sfx"));
...
set_hitbox_value(AT_FSPECIAL, 3, HG_HITBOX_X, 17);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_EXTRA_HITPAUSE, 12);
set_hitbox_value(AT_FSPECIAL, 3, HG_HIT_SFX, sound_get("fspecial_hit_sfx"));
