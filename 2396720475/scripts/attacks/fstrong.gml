...
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sound_get("strong_hit_sfx"));
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, hit_small4);
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, -20);
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_LOCKOUT, 16);