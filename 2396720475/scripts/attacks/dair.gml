...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sound_get("dstrong1_sfx"));
...
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, sound_get("basic1_hit_sfx"));
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, hit_small2);
...
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, sound_get("sharp_hit_sfx"));
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT, hit_small4);
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, -40);
