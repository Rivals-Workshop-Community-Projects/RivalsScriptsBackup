...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, sound_get("dtilt_sfx"));
...
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, sound_get("basic2_hit_sfx"));
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT, hit_small3);
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, 46);
