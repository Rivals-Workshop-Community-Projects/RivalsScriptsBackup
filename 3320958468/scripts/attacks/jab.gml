...
set_hitbox_value(AT_JAB, 1, HG_HITBOX_X, 69);
...
set_hitbox_value(AT_JAB, 2, HG_HITBOX_X, 69);
...
set_hitbox_value(AT_JAB, 3, HG_HITBOX_X, 84);
set_hitbox_value(AT_JAB, 3, HG_HITBOX_Y, -29);
set_hitbox_value(AT_JAB, 3, HG_WIDTH, 82);
...
set_hitbox_value(AT_JAB, 3, HG_VISUAL_EFFECT_X_OFFSET, 18);
