...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_absa_singlezap2"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_KNOCKBACK_SCALING, 0.10);
set_hitbox_value(AT_NSPECIAL, 1, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_NSPECIAL, 1, HG_HITPAUSE_SCALING, 0.10);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_MUNO_HITBOX_NAME, "Blaster Projectile");
set_hitbox_value(AT_NSPECIAL, 2, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_NSPECIAL, 2, HG_WINDOW, 2);
set_hitbox_value(AT_NSPECIAL, 2, HG_WINDOW_CREATION_FRAME, 0);
set_hitbox_value(AT_NSPECIAL, 2, HG_LIFETIME, 74);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HITPAUSE_SCALING, 0.60);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_ANIM_SPEED, 0.40);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_DESTROY_EFFECT, 310);
set_hitbox_value(AT_NSPECIAL, 2, HG_IGNORES_PROJECTILES, 0);
set_hitbox_value(AT_NSPECIAL, 2, HG_HITSTUN_MULTIPLIER, 0.70);
