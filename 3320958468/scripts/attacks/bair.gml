...
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 47);
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 59);
set_hitbox_value(AT_BAIR, 1, HG_PRIORITY, 2);
set_hitbox_value(AT_BAIR, 1, HG_DAMAGE, 7);
set_hitbox_value(AT_BAIR, 1, HG_ANGLE, 140);
set_hitbox_value(AT_BAIR, 1, HG_BASE_KNOCKBACK, bk_power);
set_hitbox_value(AT_BAIR, 1, HG_FINAL_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_BAIR, 1, HG_KNOCKBACK_SCALING, kb_power);
set_hitbox_value(AT_BAIR, 1, HG_BASE_HITPAUSE, bhit_pause);
set_hitbox_value(AT_BAIR, 1, HG_HITPAUSE_SCALING, hp_power);
...
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_Y, -21);
set_hitbox_value(AT_BAIR, 2, HG_WIDTH, 39);
...
set_hitbox_value(AT_BAIR, 2, HG_BASE_KNOCKBACK, bk_power);
set_hitbox_value(AT_BAIR, 2, HG_KNOCKBACK_SCALING, kb_power);
set_hitbox_value(AT_BAIR, 2, HG_BASE_HITPAUSE, bhit_pause);
set_hitbox_value(AT_BAIR, 2, HG_HITPAUSE_SCALING, hp_power);
