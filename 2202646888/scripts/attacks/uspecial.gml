...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_VSPEED, 1.2);
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_land_heavy"));
...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_ell_utilt_cannon"));
...
set_hitbox_value(AT_USPECIAL, 3, HG_LIFETIME, 48);
...
set_hitbox_value(AT_USPECIAL, 3, HG_PROJECTILE_GRAVITY, 14.5);
...
set_hitbox_value(AT_USPECIAL, 3, HG_PROJECTILE_ENEMY_BEHAVIOR, 2);