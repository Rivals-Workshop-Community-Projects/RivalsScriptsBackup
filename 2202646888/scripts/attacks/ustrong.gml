...
set_window_value(AT_USTRONG, 5, AG_WINDOW_SFX, asset_get("sfx_swipe_weak2"));
...
set_window_value(AT_USTRONG, 6, AG_WINDOW_SFX, asset_get("sfx_icehit_weak2"));
...
set_hitbox_value(AT_USTRONG, 1, HG_ANGLE, 89);
...
set_hitbox_value(AT_USTRONG, 2, HG_WIDTH, 18);
set_hitbox_value(AT_USTRONG, 2, HG_HEIGHT, 24);
set_hitbox_value(AT_USTRONG, 2, HG_PRIORITY, 2);
set_hitbox_value(AT_USTRONG, 2, HG_DAMAGE, 10);
set_hitbox_value(AT_USTRONG, 2, HG_ANGLE, 89);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, 19);
