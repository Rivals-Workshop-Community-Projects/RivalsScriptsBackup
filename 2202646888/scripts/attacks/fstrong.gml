...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_HSPEED, 10.5);
...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, .8);
...
set_window_value(AT_FSTRONG, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, .8);
...
set_hitbox_value(AT_FSTRONG, 1, HG_WIDTH, 59);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HEIGHT, 27);
...
set_hitbox_value(AT_FSTRONG, 3, HG_WIDTH, 44);
set_hitbox_value(AT_FSTRONG, 3, HG_HEIGHT, 31);
