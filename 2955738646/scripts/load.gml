...
sprite_change_offset("mecha_crouch", 24, 68);
...
sprite_change_offset("roll_forward", 64, 108); sprite_change_offset("roll_forward_ai", 64, 108);
...
sprite_change_offset("fstrong_burst_trail", 10, 60);
