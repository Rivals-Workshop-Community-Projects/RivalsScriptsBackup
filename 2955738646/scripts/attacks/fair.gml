...
set_hitbox_value(AT_FAIR, 1, HG_HITBOX_Y, -65);
...
set_hitbox_value(AT_FAIR, 4, HG_HITBOX_Y, -45);
...
set_hitbox_value(AT_FAIR, 5, HG_HITBOX_X, 33);
set_hitbox_value(AT_FAIR, 5, HG_HITBOX_Y, -40);
set_hitbox_value(AT_FAIR, 5, HG_WIDTH, 55);
set_hitbox_value(AT_FAIR, 5, HG_HEIGHT, 85);
