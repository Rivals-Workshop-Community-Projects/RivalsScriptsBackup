...
set_window_value(AT_FTILT, 5, AG_WINDOW_LENGTH, 40);
...
set_window_value(AT_FTILT, 5, AG_WINDOW_SFX_FRAME, 5);
...
set_hitbox_value(AT_FTILT, 2, HG_WINDOW_CREATION_FRAME, 15);
set_hitbox_value(AT_FTILT, 2, HG_LIFETIME, 3);
set_hitbox_value(AT_FTILT, 2, HG_HITBOX_X, 5);
