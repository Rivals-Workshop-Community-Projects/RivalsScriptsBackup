...
set_hitbox_value(AT_USPECIAL_2, 3, HG_PROJECTILE_HSPEED, 10);
...
set_hitbox_value(AT_USPECIAL_2, 4, HG_BASE_HITPAUSE, 6);
...
set_hitbox_value(AT_USPECIAL_2, 4, HG_PROJECTILE_HSPEED, -15);
...
set_hitbox_value(AT_USPECIAL_2, 5, HG_HITBOX_X, 25);
set_hitbox_value(AT_USPECIAL_2, 5, HG_HITBOX_Y, -50);
...
set_hitbox_value(AT_USPECIAL_2, 5, HG_BASE_HITPAUSE, 6);
...
set_hitbox_value(AT_USPECIAL_2, 5, HG_PROJECTILE_VSPEED, -19);
...
set_hitbox_value(AT_USPECIAL_2, 6, HG_BASE_HITPAUSE, 1);
...
set_hitbox_value(AT_USPECIAL_2, 6, HG_PROJECTILE_HSPEED, 19);
set_hitbox_value(AT_USPECIAL_2, 6, HG_PROJECTILE_VSPEED, -3);
...
//set_hitbox_value(AT_USPECIAL_2, 7, HG_WINDOW_CREATION_FRAME, 30);
...
set_hitbox_value(AT_USPECIAL_2, 7, HG_BASE_HITPAUSE, 5);
...
set_hitbox_value(AT_USPECIAL_2, 7, HG_PROJECTILE_VSPEED, -19);
...
set_hitbox_value(AT_USPECIAL_2, 8, HG_BASE_HITPAUSE, 5);
...
set_hitbox_value(AT_USPECIAL_2, 8, HG_PROJECTILE_HSPEED, 16);
set_hitbox_value(AT_USPECIAL_2, 8, HG_PROJECTILE_VSPEED, -21);
...
/*
set_hitbox_value(AT_USPECIAL_2, 7, HG_HITBOX_TYPE, 1); //Teleport downward punch
set_hitbox_value(AT_USPECIAL_2, 7, HG_WINDOW, 5);
set_hitbox_value(AT_USPECIAL_2, 7, HG_WINDOW_CREATION_FRAME, 18);
set_hitbox_value(AT_USPECIAL_2, 7, HG_LIFETIME, 3);
set_hitbox_value(AT_USPECIAL_2, 7, HG_HITBOX_X, 3);
set_hitbox_value(AT_USPECIAL_2, 7, HG_HITBOX_Y, -30);
set_hitbox_value(AT_USPECIAL_2, 7, HG_WIDTH, 30);
set_hitbox_value(AT_USPECIAL_2, 7, HG_HEIGHT, 130);
set_hitbox_value(AT_USPECIAL_2, 7, HG_SHAPE, 0);
set_hitbox_value(AT_USPECIAL_2, 7, HG_PRIORITY, 10);
set_hitbox_value(AT_USPECIAL_2, 7, HG_DAMAGE, 5);
set_hitbox_value(AT_USPECIAL_2, 7, HG_ANGLE, 270);
set_hitbox_value(AT_USPECIAL_2, 7, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_USPECIAL_2, 7, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_USPECIAL_2, 7, HG_KNOCKBACK_SCALING, 0.1);
set_hitbox_value(AT_USPECIAL_2, 7, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_USPECIAL_2, 7, HG_HITPAUSE_SCALING, 1);
set_hitbox_value(AT_USPECIAL_2, 7, HG_TECHABLE, 1);
set_hitbox_value(AT_USPECIAL_2, 7, HG_HITSTUN_MULTIPLIER, 2);
set_hitbox_value(AT_USPECIAL_2, 7, HG_VISUAL_EFFECT, 306);
set_hitbox_value(AT_USPECIAL_2, 7, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_USPECIAL_2, 7, HG_HIT_SFX, sound_get("Dair_sweetspot"));
set_hitbox_value(AT_USPECIAL_2, 7, HG_ANGLE_FLIPPER, 6);
