...
set_window_value(AT_USPECIAL_2, 4, AG_WINDOW_SFX, sound_get("scouter_found"));
...
set_window_value(AT_USPECIAL_2, 8, AG_WINDOW_LENGTH, 5);
set_window_value(AT_USPECIAL_2, 8, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_USPECIAL_2, 8, AG_WINDOW_ANIM_FRAME_START, 17);
...
set_hitbox_value(AT_USPECIAL_2, 1, HG_HIT_SFX, sound_get("scouter_found"));
...
set_hitbox_value(AT_USPECIAL_2, 2, HG_HIT_SFX, sound_get("scouter_found"));
...
set_hitbox_value(AT_USPECIAL_2, 3, HG_WINDOW_CREATION_FRAME, 14);
...
set_hitbox_value(AT_USPECIAL_2, 3, HG_KNOCKBACK_SCALING, 0.9);
...
set_hitbox_value(AT_USPECIAL_2, 3, HG_PROJECTILE_ANIM_SPEED, 0);
if (attack_button == false){ //Targeting Missiles
...
set_hitbox_value(AT_USPECIAL_2, 3, HG_PROJECTILE_HSPEED, -5);
set_hitbox_value(AT_USPECIAL_2, 3, HG_PROJECTILE_VSPEED, 10);
...
set_hitbox_value(AT_USPECIAL_2, 4, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_USPECIAL_2, 4, HG_KNOCKBACK_SCALING, 0.9);
...
set_hitbox_value(AT_USPECIAL_2, 4, HG_PROJECTILE_ANIM_SPEED, 0);
if (attack_button == false){
set_hitbox_value(AT_USPECIAL_2, 4, HG_PROJECTILE_HSPEED, 4);
set_hitbox_value(AT_USPECIAL_2, 4, HG_PROJECTILE_VSPEED, -19);
set_hitbox_value(AT_USPECIAL_2, 4, HG_HITBOX_X, 40);
...
set_hitbox_value(AT_USPECIAL_2, 4, HG_ANGLE_FLIPPER, 0);
} else {
set_hitbox_value(AT_USPECIAL_2, 4, HG_PROJECTILE_HSPEED, 2);
set_hitbox_value(AT_USPECIAL_2, 4, HG_PROJECTILE_VSPEED, 5);
set_hitbox_value(AT_USPECIAL_2, 4, HG_HITBOX_X, 30);
set_hitbox_value(AT_USPECIAL_2, 4, HG_HITBOX_Y, -70);
set_hitbox_value(AT_USPECIAL_2, 4, HG_PRIORITY, 10);
set_hitbox_value(AT_USPECIAL_2, 4, HG_ANGLE, 90);
...
set_hitbox_value(AT_USPECIAL_2, 5, HG_WINDOW_CREATION_FRAME, 22);
...
set_hitbox_value(AT_USPECIAL_2, 5, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_USPECIAL_2, 5, HG_KNOCKBACK_SCALING, 0.9);
...
set_hitbox_value(AT_USPECIAL_2, 5, HG_PROJECTILE_ANIM_SPEED, 0);
if (attack_button == false){
...
set_hitbox_value(AT_USPECIAL_2, 5, HG_PROJECTILE_HSPEED, 1);
set_hitbox_value(AT_USPECIAL_2, 5, HG_PROJECTILE_VSPEED, -10);
set_hitbox_value(AT_USPECIAL_2, 5, HG_HITBOX_X, 10);
set_hitbox_value(AT_USPECIAL_2, 5, HG_HITBOX_Y, -70);
...
set_hitbox_value(AT_USPECIAL_2, 6, HG_WINDOW_CREATION_FRAME, 23);
...
set_hitbox_value(AT_USPECIAL_2, 6, HG_PROJECTILE_ANIM_SPEED, 0);
if (attack_button == false){
set_hitbox_value(AT_USPECIAL_2, 6, HG_PROJECTILE_HSPEED, 8);
set_hitbox_value(AT_USPECIAL_2, 6, HG_PROJECTILE_VSPEED, -15);
...
set_hitbox_value(AT_USPECIAL_2, 6, HG_PROJECTILE_HSPEED, 10);
set_hitbox_value(AT_USPECIAL_2, 6, HG_PROJECTILE_VSPEED, -13);
set_hitbox_value(AT_USPECIAL_2, 6, HG_HITBOX_X, 30);
set_hitbox_value(AT_USPECIAL_2, 6, HG_HITBOX_Y, -70);
set_hitbox_value(AT_USPECIAL_2, 6, HG_PRIORITY, 10);
