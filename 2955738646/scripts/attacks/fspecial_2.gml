...
set_window_value(AT_FSPECIAL_2, 1, AG_WINDOW_SFX, sound_get("fspecial_startup"));

set_window_value(AT_FSPECIAL_2, 2, AG_WINDOW_TYPE, 1); //Flying forward
...
set_window_value(AT_FSPECIAL_2, 2, AG_WINDOW_HSPEED, 45);
...
set_window_value(AT_FSPECIAL_2, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, 3);
set_window_value(AT_FSPECIAL_2, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, 2);
...
set_window_value(AT_FSPECIAL_2, 4, AG_WINDOW_TYPE, 1); //Punches
set_window_value(AT_FSPECIAL_2, 4, AG_WINDOW_LENGTH, 26);
set_window_value(AT_FSPECIAL_2, 4, AG_WINDOW_ANIM_FRAMES, 9);
...
set_window_value(AT_FSPECIAL_2, 4, AG_WINDOW_SFX, sound_get("fspecial_rapidswipes"));
//set_window_value(AT_FSPECIAL_2, 4, AG_WINDOW_HAS_WHIFFLAG, 2);

set_window_value(AT_FSPECIAL_2, 5, AG_WINDOW_TYPE, 1); //Demon Raged
...
set_window_value(AT_FSPECIAL_2, 5, AG_WINDOW_SFX, sound_get("final_hit"));

set_num_hitboxes(AT_FSPECIAL_2, 8);

set_hitbox_value(AT_FSPECIAL_2, 1, HG_HITBOX_TYPE, 1); //Grabbed into Raging Demon
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_VISUAL_EFFECT, 259);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HIT_SFX, sound_get("ARC_BTL_CMN_Sousai_Kidan"));
...
set_hitbox_value(AT_FSPECIAL_2, 2, HG_HITBOX_TYPE, 1); //Punch 1
...
set_hitbox_value(AT_FSPECIAL_2, 2, HG_HEIGHT, 90);
...
set_hitbox_value(AT_FSPECIAL_2, 2, HG_HITSTUN_MULTIPLIER, 2);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_VISUAL_EFFECT_X_OFFSET, 15);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_VISUAL_EFFECT_Y_OFFSET, 15);
...
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HITBOX_TYPE, 1); //Punch 2
...
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HITBOX_X, 25);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HITBOX_Y, -50);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_WIDTH, 90);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HEIGHT, 90);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_PRIORITY, 9);
...
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HITSTUN_MULTIPLIER, 2);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_VISUAL_EFFECT_X_OFFSET, 15);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_VISUAL_EFFECT_Y_OFFSET, 15);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HIT_SFX, asset_get("sfx_blow_medium1"));
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HIT_LOCKOUT, 1);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_TECHABLE, 3);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HITBOX_GROUP, -1);

set_hitbox_value(AT_FSPECIAL_2, 4, HG_HITBOX_TYPE, 1); //Punch 3
...
set_hitbox_value(AT_FSPECIAL_2, 4, HG_HITBOX_X, 25);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_HITBOX_Y, -50);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_WIDTH, 90);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_HEIGHT, 90);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_PRIORITY, 9);
...
set_hitbox_value(AT_FSPECIAL_2, 4, HG_BASE_KNOCKBACK, 3);
...
set_hitbox_value(AT_FSPECIAL_2, 4, HG_HITSTUN_MULTIPLIER, 2);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_VISUAL_EFFECT_X_OFFSET, 15);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_VISUAL_EFFECT_Y_OFFSET, 15);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_HIT_SFX, asset_get("sfx_blow_medium2"));
set_hitbox_value(AT_FSPECIAL_2, 4, HG_HIT_LOCKOUT, 1);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_TECHABLE, 3);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_HITBOX_GROUP, -1);

set_hitbox_value(AT_FSPECIAL_2, 5, HG_HITBOX_TYPE, 1); //Punch 4
set_hitbox_value(AT_FSPECIAL_2, 5, HG_WINDOW, 4);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_WINDOW_CREATION_FRAME, 15);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_LIFETIME, 1);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_HITBOX_X, 25);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_HITBOX_Y, -50);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_WIDTH, 90);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_HEIGHT, 90);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_PRIORITY, 9);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_DAMAGE, 1);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_ANGLE, 361);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_ANGLE_FLIPPER, 9);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_BASE_KNOCKBACK, 3);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_KNOCKBACK_SCALING, 0);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_BASE_HITPAUSE, 1);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_HITPAUSE_SCALING, 0);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_HITSTUN_MULTIPLIER, 2);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_VISUAL_EFFECT_X_OFFSET, 15);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_VISUAL_EFFECT_Y_OFFSET, 15);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_HIT_SFX, asset_get("sfx_blow_medium2"));
set_hitbox_value(AT_FSPECIAL_2, 5, HG_HIT_LOCKOUT, 1);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_TECHABLE, 3);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_HITBOX_GROUP, -1);

set_hitbox_value(AT_FSPECIAL_2, 6, HG_HITBOX_TYPE, 1); //Punch 5
set_hitbox_value(AT_FSPECIAL_2, 6, HG_WINDOW, 4);
set_hitbox_value(AT_FSPECIAL_2, 6, HG_WINDOW_CREATION_FRAME, 18);
set_hitbox_value(AT_FSPECIAL_2, 6, HG_LIFETIME, 1);
set_hitbox_value(AT_FSPECIAL_2, 6, HG_HITBOX_X, 25);
set_hitbox_value(AT_FSPECIAL_2, 6, HG_HITBOX_Y, -50);
set_hitbox_value(AT_FSPECIAL_2, 6, HG_WIDTH, 90);
set_hitbox_value(AT_FSPECIAL_2, 6, HG_HEIGHT, 90);
set_hitbox_value(AT_FSPECIAL_2, 6, HG_PRIORITY, 9);
set_hitbox_value(AT_FSPECIAL_2, 6, HG_DAMAGE, 1);
set_hitbox_value(AT_FSPECIAL_2, 6, HG_ANGLE, 361);
set_hitbox_value(AT_FSPECIAL_2, 6, HG_ANGLE_FLIPPER, 9);
set_hitbox_value(AT_FSPECIAL_2, 6, HG_BASE_KNOCKBACK, 3);
set_hitbox_value(AT_FSPECIAL_2, 6, HG_KNOCKBACK_SCALING, 0);
set_hitbox_value(AT_FSPECIAL_2, 6, HG_BASE_HITPAUSE, 1);
set_hitbox_value(AT_FSPECIAL_2, 6, HG_HITPAUSE_SCALING, 0);
set_hitbox_value(AT_FSPECIAL_2, 6, HG_HITSTUN_MULTIPLIER, 2);
set_hitbox_value(AT_FSPECIAL_2, 6, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_FSPECIAL_2, 6, HG_VISUAL_EFFECT_X_OFFSET, 15);
set_hitbox_value(AT_FSPECIAL_2, 6, HG_VISUAL_EFFECT_Y_OFFSET, 15);
set_hitbox_value(AT_FSPECIAL_2, 6, HG_HIT_SFX, asset_get("sfx_blow_medium3"));
set_hitbox_value(AT_FSPECIAL_2, 6, HG_HIT_LOCKOUT, 1);
set_hitbox_value(AT_FSPECIAL_2, 6, HG_TECHABLE, 3);
set_hitbox_value(AT_FSPECIAL_2, 6, HG_HITBOX_GROUP, -1);

set_hitbox_value(AT_FSPECIAL_2, 7, HG_HITBOX_TYPE, 1); //Punch 6
set_hitbox_value(AT_FSPECIAL_2, 7, HG_WINDOW, 4);
set_hitbox_value(AT_FSPECIAL_2, 7, HG_WINDOW_CREATION_FRAME, 21);
set_hitbox_value(AT_FSPECIAL_2, 7, HG_LIFETIME, 1);
set_hitbox_value(AT_FSPECIAL_2, 7, HG_HITBOX_X, 25);
set_hitbox_value(AT_FSPECIAL_2, 7, HG_HITBOX_Y, -50);
set_hitbox_value(AT_FSPECIAL_2, 7, HG_WIDTH, 90);
set_hitbox_value(AT_FSPECIAL_2, 7, HG_HEIGHT, 90);
set_hitbox_value(AT_FSPECIAL_2, 7, HG_PRIORITY, 9);
set_hitbox_value(AT_FSPECIAL_2, 7, HG_DAMAGE, 1);
set_hitbox_value(AT_FSPECIAL_2, 7, HG_ANGLE, 361);
...
set_hitbox_value(AT_FSPECIAL_2, 7, HG_BASE_HITPAUSE, 1);
set_hitbox_value(AT_FSPECIAL_2, 7, HG_HITPAUSE_SCALING, 0);
set_hitbox_value(AT_FSPECIAL_2, 7, HG_HITSTUN_MULTIPLIER, 2);
set_hitbox_value(AT_FSPECIAL_2, 7, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_FSPECIAL_2, 7, HG_VISUAL_EFFECT_X_OFFSET, 15);
set_hitbox_value(AT_FSPECIAL_2, 7, HG_VISUAL_EFFECT_Y_OFFSET, 15);
set_hitbox_value(AT_FSPECIAL_2, 7, HG_HIT_SFX, asset_get("sfx_blow_medium3"));
set_hitbox_value(AT_FSPECIAL_2, 7, HG_HIT_LOCKOUT, 1);
set_hitbox_value(AT_FSPECIAL_2, 7, HG_TECHABLE, 3);
set_hitbox_value(AT_FSPECIAL_2, 7, HG_HITBOX_GROUP, -1);

set_hitbox_value(AT_FSPECIAL_2, 8, HG_HITBOX_TYPE, 1); //Punch Final 7
set_hitbox_value(AT_FSPECIAL_2, 8, HG_WINDOW, 4);
set_hitbox_value(AT_FSPECIAL_2, 8, HG_WINDOW_CREATION_FRAME, 24);
set_hitbox_value(AT_FSPECIAL_2, 8, HG_LIFETIME, 1);
set_hitbox_value(AT_FSPECIAL_2, 8, HG_HITBOX_X, 20);
set_hitbox_value(AT_FSPECIAL_2, 8, HG_HITBOX_Y, -48);
set_hitbox_value(AT_FSPECIAL_2, 8, HG_WIDTH, 110);
set_hitbox_value(AT_FSPECIAL_2, 8, HG_HEIGHT, 90);
set_hitbox_value(AT_FSPECIAL_2, 8, HG_PRIORITY, 9);
set_hitbox_value(AT_FSPECIAL_2, 8, HG_DAMAGE, 4);
set_hitbox_value(AT_FSPECIAL_2, 8, HG_ANGLE, 50);
set_hitbox_value(AT_FSPECIAL_2, 8, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_FSPECIAL_2, 8, HG_KNOCKBACK_SCALING, 2);
set_hitbox_value(AT_FSPECIAL_2, 8, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_FSPECIAL_2, 8, HG_HITPAUSE_SCALING, 2);
set_hitbox_value(AT_FSPECIAL_2, 8, HG_EXTRA_HITPAUSE, 5);
set_hitbox_value(AT_FSPECIAL_2, 8, HG_HITSTUN_MULTIPLIER, 0.4);
set_hitbox_value(AT_FSPECIAL_2, 8, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_FSPECIAL_2, 8, HG_VISUAL_EFFECT_X_OFFSET, 15);
set_hitbox_value(AT_FSPECIAL_2, 8, HG_VISUAL_EFFECT_Y_OFFSET, 15);
set_hitbox_value(AT_FSPECIAL_2, 8, HG_HIT_SFX, sound_get("ARC_BTL_CMN_Hit_Large-A"));
set_hitbox_value(AT_FSPECIAL_2, 8, HG_HIT_LOCKOUT, 1);
set_hitbox_value(AT_FSPECIAL_2, 8, HG_HITBOX_GROUP, -1);

/*
set_hitbox_value(AT_FSPECIAL_2, 2, HG_HITBOX_TYPE, 1); //Teleport hit
set_hitbox_value(AT_FSPECIAL_2, 2, HG_WINDOW, 4);
...
set_hitbox_value(AT_FSPECIAL_2, 2, HG_KNOCKBACK_SCALING, .2);
...
set_hitbox_value(AT_FSPECIAL_2, 2, HG_VISUAL_EFFECT, 138);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_VISUAL_EFFECT_X_OFFSET, 10);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_VISUAL_EFFECT_Y_OFFSET, -1);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_HIT_SFX, asset_get("sfx_abyss_explosion"));
set_hitbox_value(AT_FSPECIAL_2, 2, HG_HITBOX_GROUP, 2);

set_hitbox_value(AT_FSPECIAL_2, 3, HG_HITBOX_TYPE, 1); //Follow up knee
set_hitbox_value(AT_FSPECIAL_2, 3, HG_WINDOW, 4);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_WINDOW_CREATION_FRAME, 18);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_LIFETIME, 2);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HITBOX_X, 35);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HITBOX_Y, -50);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_WIDTH, 90);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HEIGHT, 120);
...
set_hitbox_value(AT_FSPECIAL_2, 3, HG_EXTRA_HITPAUSE, 1);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_VISUAL_EFFECT_X_OFFSET, 5);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_VISUAL_EFFECT_Y_OFFSET, 5);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HIT_SFX, asset_get("sfx_blow_heavy1"));
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HITBOX_GROUP,-1);

set_hitbox_value(AT_FSPECIAL_2, 4, HG_HITBOX_TYPE, 1); //Follow up down overhead
set_hitbox_value(AT_FSPECIAL_2, 4, HG_WINDOW, 4);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_WINDOW_CREATION_FRAME, 48);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_LIFETIME, 2);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_HITBOX_X, 35);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_HITBOX_Y, -50);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_WIDTH, 90);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_HEIGHT, 120);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_PRIORITY, 1);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_DAMAGE, 5);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_ANGLE, 270);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_BASE_KNOCKBACK, 20);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_KNOCKBACK_SCALING, .1);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_BASE_HITPAUSE, 25);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_EXTRA_HITPAUSE, 0);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_VISUAL_EFFECT_X_OFFSET, 5);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_VISUAL_EFFECT_Y_OFFSET, -1);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_HIT_SFX, asset_get("sfx_blow_heavy2"));
set_hitbox_value(AT_FSPECIAL_2, 4, HG_HITBOX_GROUP, -1);

set_hitbox_value(AT_FSPECIAL_2, 5, HG_HITBOX_TYPE, 2); //Follow up timer
set_hitbox_value(AT_FSPECIAL_2, 5, HG_WINDOW, 10);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_WINDOW_CREATION_FRAME, 0);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_LIFETIME, 30);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_HITBOX_X, 1);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_HITBOX_Y, -90);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_WIDTH, 0);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_HEIGHT, 0);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_PRIORITY, 0);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_DAMAGE, 0);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_ANGLE, 0);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_BASE_KNOCKBACK, 0);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_BASE_HITPAUSE, 0);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_VISUAL_EFFECT, 1);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_VISUAL_EFFECT_X_OFFSET, 1);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_VISUAL_EFFECT_Y_OFFSET, -1);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_PROJECTILE_SPRITE, sprite_get("bar"));
set_hitbox_value(AT_FSPECIAL_2, 5, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_PROJECTILE_ANIM_SPEED, 1.3);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_HITBOX_GROUP, 1);