...
set_window_value(AT_TAUNT_2, 1, AG_WINDOW_SFX, sound_get("IVE_LET_YOU_LIVE_LONG_ENOUGH"));
...
set_window_value(AT_TAUNT_2, 3, AG_WINDOW_SFX, sound_get("ARC_BTL_CMN_ChargeGod_Start"));
