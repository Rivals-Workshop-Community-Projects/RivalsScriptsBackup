...
set_window_value(AT_EXTRA_3, 1, AG_WINDOW_LENGTH, 90);
...
set_hitbox_value(AT_EXTRA_3, 3, HG_VISUAL_EFFECT, 302);
set_hitbox_value(AT_EXTRA_3, 3, HG_HIT_SFX, sound_get("se_common_sword_hit_s"));
