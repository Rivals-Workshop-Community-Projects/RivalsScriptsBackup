...
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, sound_get("ARC_BTL_CMN_Furi_YokoKeri"));
...
set_window_value(AT_UAIR, 3, AG_WINDOW_TYPE, 1); //Flipping back around in aerial idle
...
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, sound_get("ARC_BTL_CMN_Guard_Large"));
