...
set_window_value(AT_DATTACK, 5, AG_WINDOW_HSPEED, 10);
set_window_value(AT_DATTACK, 5, AG_WINDOW_HAS_SFX, 1);
//set_window_value(AT_DATTACK, 5, AG_WINDOW_SFX, sound_get("Warpout"));
...
set_hitbox_value(AT_DATTACK, 1, HG_EXTRA_HITPAUSE, 15);
...
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT, 200);
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT_X_OFFSET, 5);
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT_Y_OFFSET, 5);
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, asset_get("sfx_ori_ustrong_launch"));
