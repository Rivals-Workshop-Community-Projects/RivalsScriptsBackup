...
set_window_value(AT_DATTACK, 6, AG_WINDOW_CUSTOM_AIR_FRICTION, .5);
set_window_value(AT_DATTACK, 6, AG_WINDOW_CUSTOM_GROUND_FRICTION, .5);
...
set_window_value(AT_DATTACK, 9, AG_WINDOW_TYPE, 1); //Jumping up Attack B
set_window_value(AT_DATTACK, 9, AG_WINDOW_LENGTH, 20);
set_window_value(AT_DATTACK, 9, AG_WINDOW_ANIM_FRAMES, 10);
set_window_value(AT_DATTACK, 9, AG_WINDOW_VSPEED_TYPE, 2);
set_window_value(AT_DATTACK, 9, AG_WINDOW_HSPEED_TYPE, 2);
set_window_value(AT_DATTACK, 9, AG_WINDOW_HSPEED, 0);
set_window_value(AT_DATTACK, 9, AG_WINDOW_VSPEED, 0);
set_window_value(AT_DATTACK, 9, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DATTACK, 9, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_DATTACK, 9, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.1);
set_window_value(AT_DATTACK, 9, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1);
...
set_hitbox_value(AT_DATTACK, 1, HG_DRIFT_MULTIPLIER, 0.1);
set_hitbox_value(AT_DATTACK, 1, HG_SDI_MULTIPLIER, 0.1);
...
set_hitbox_value(AT_DATTACK, 2, HG_WIDTH, 94);
...
set_hitbox_value(AT_DATTACK, 3, HG_WIDTH, 94);
...
set_hitbox_value(AT_DATTACK, 5, HG_WIDTH, 94);
...
set_hitbox_value(AT_DATTACK, 6, HG_WINDOW_CREATION_FRAME, 2);
...
set_hitbox_value(AT_DATTACK, 7, HG_WINDOW, 6);
set_hitbox_value(AT_DATTACK, 7, HG_WINDOW_CREATION_FRAME, 3);
...
set_hitbox_value(AT_DATTACK, 8, HG_WINDOW_CREATION_FRAME, 4);
...
set_hitbox_value(AT_DATTACK, 8, HG_WIDTH, 100);
...
set_hitbox_value(AT_DATTACK, 9, HG_WIDTH, 99);
...
set_hitbox_value(AT_DATTACK, 9, HG_HITPAUSE_SCALING, .7);
...
set_hitbox_value(AT_DATTACK, 9, HG_HITSTUN_MULTIPLIER, 0.9);
