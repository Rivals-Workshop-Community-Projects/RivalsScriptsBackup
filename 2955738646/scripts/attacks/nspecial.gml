...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_SFX, sound_get("ARC_BTL_SGN_Rengeki_Finish_BC"));
...
set_window_value(AT_NSPECIAL, 4, AG_WINDOW_SFX, sound_get("ARC_BTL_CMN_GK_AirTurn"));
...
set_window_value(AT_NSPECIAL, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, 4);
...
set_window_value(AT_NSPECIAL, 5, AG_WINDOW_CUSTOM_AIR_FRICTION, 4);
...
set_window_value(AT_NSPECIAL, 9, AG_WINDOW_TYPE, 1); //Landing back down
...
set_window_value(AT_NSPECIAL, 9, AG_WINDOW_SFX, sound_get("ARC_BTL_SGN_Rengeki_Finish_BC"));
...
set_hitbox_value(AT_NSPECIAL, 3, HG_HIT_SFX, sound_get("ARC_BTL_GBR_Sword_Hit"));
