...
set_window_value(AT_JAB, 3, AG_WINDOW_CANCEL_FRAME, 14);
...
set_window_value(AT_JAB, 5, AG_WINDOW_LENGTH, 25);
...
//set_window_value(AT_JAB, 5, AG_WINDOW_CANCEL_FRAME, 16);
...
set_hitbox_value(AT_JAB, 3, HG_WINDOW_CREATION_FRAME, 19);
...
set_hitbox_value(AT_JAB, 5, HG_HITBOX_TYPE, 2); //Teleport hitbox grabber
...
//set_hitbox_value(AT_JAB, 5, HG_PROJECTILE_SPRITE, sprite_get("teleport_mask"));
set_hitbox_value(AT_JAB, 5, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_JAB, 5, HG_PROJECTILE_COLLISION_SPRITE, sprite_get("teleport_mask"));
set_hitbox_value(AT_JAB, 5, HG_LIFETIME, 40);
set_hitbox_value(AT_JAB, 5, HG_HITBOX_X, 0);
set_hitbox_value(AT_JAB, 5, HG_HITBOX_Y, -95);
set_hitbox_value(AT_JAB, 5, HG_WIDTH, 1);
set_hitbox_value(AT_JAB, 5, HG_HEIGHT, 1);
set_hitbox_value(AT_JAB, 5, HG_PRIORITY, 0);
set_hitbox_value(AT_JAB, 5, HG_DAMAGE, 0);
set_hitbox_value(AT_JAB, 5, HG_ANGLE, 90);
set_hitbox_value(AT_JAB, 5, HG_BASE_KNOCKBACK, 0);
set_hitbox_value(AT_JAB, 5, HG_BASE_HITPAUSE, 0);
set_hitbox_value(AT_JAB, 5, HG_VISUAL_EFFECT, 148);
set_hitbox_value(AT_JAB, 5, HG_VISUAL_EFFECT_X_OFFSET, 42);
set_hitbox_value(AT_JAB, 5, HG_VISUAL_EFFECT_Y_OFFSET, -1);
set_hitbox_value(AT_JAB, 5, HG_HIT_SFX, asset_get("sfx_ori_ustrong_launch"));
set_hitbox_value(AT_JAB, 5, HG_FORCE_FLINCH, 0);
set_hitbox_value(AT_JAB, 5, HG_TECHABLE, 3);
set_hitbox_value(AT_JAB, 5, HG_PROJECTILE_VSPEED, 30);
set_hitbox_value(AT_JAB, 5, HG_PROJECTILE_GROUND_BEHAVIOR, 0);
set_hitbox_value(AT_JAB, 5, HG_PROJECTILE_WALL_BEHAVIOR, 0);
set_hitbox_value(AT_JAB, 5, HG_PROJECTILE_UNBASHABLE, true);
set_hitbox_value(AT_JAB, 5, HG_PROJECTILE_IS_TRANSCENDENT, true);
set_hitbox_value(AT_JAB, 5, HG_PROJECTILE_PLASMA_SAFE, true);
