...
set_window_value(AT_JAB, 4, AG_WINDOW_SFX, sound_get("ARC_BTL_CMN_Keriage"));
...
set_window_value(AT_JAB, 5, AG_WINDOW_SFX, sound_get("ARC_BTL_CMN_ChargeGod_Bishi"));
...
set_window_value(AT_JAB, 6, AG_WINDOW_SFX, sound_get("ARC_BTL_CMN_DrgnRush_Start"));
