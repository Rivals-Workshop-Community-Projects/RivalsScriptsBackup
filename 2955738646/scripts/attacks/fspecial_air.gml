...
set_window_value(AT_FSPECIAL_AIR, 2, AG_WINDOW_HSPEED, 50);
...
set_window_value(AT_FSPECIAL_AIR, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, 4);
...
set_window_value(AT_FSPECIAL_AIR, 3, AG_WINDOW_VSPEED, -0.2);
...
set_window_value(AT_FSPECIAL_AIR, 7, AG_WINDOW_TYPE, 1); //Flying forward dash
...
set_window_value(AT_FSPECIAL_AIR, 7, AG_WINDOW_HSPEED, 25);
...
set_window_value(AT_FSPECIAL_AIR, 7, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1);
...
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_HIT_SFX, sound_get("fspecial2_knee"));
...
set_hitbox_value(AT_FSPECIAL_AIR, 8, HG_HITSTUN_MULTIPLIER, 0.9);
...
set_hitbox_value(AT_FSPECIAL_AIR, 8, HG_HIT_SFX, sound_get("SuperMecha_largehit"));
