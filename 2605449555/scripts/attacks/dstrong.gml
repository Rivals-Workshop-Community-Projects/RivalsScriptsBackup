...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_ell_utilt_retract"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_WINDOW_CREATION_FRAME, 16);
...
set_hitbox_value(AT_DSTRONG, 3, HG_WINDOW_CREATION_FRAME, 30);
...
set_hitbox_value(AT_DSTRONG, 3, HG_DAMAGE, 17);
