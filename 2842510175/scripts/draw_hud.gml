...
music_files = ["music_loop3", "music_loop2", "music_loop", "music_loop4"]

//music name title
music_titles = ["Sacred Square - Kirby Star Allies", "Moonlight Canyon - Kirby and the Forgotten Land", "Sky Tower - Kirby's Return to Dream Land", "Sky Tower Reprisal - Kirby and the Rainbow Curse"]
