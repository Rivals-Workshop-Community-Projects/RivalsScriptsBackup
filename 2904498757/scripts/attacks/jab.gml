...
set_window_value(AT_JAB, 6, AG_WINDOW_HAS_WHIFFLAG, 8);
...
set_hitbox_value(AT_JAB, 1, HG_SDI_MULTIPLIER, 1.25);
...
set_hitbox_value(AT_JAB, 2, HG_HEIGHT, 86);
...
set_hitbox_value(AT_JAB, 2, HG_HITPAUSE_SCALING, 0.35);
