...
set_window_value(AT_DSPECIAL_AIR, 1, AG_WINDOW_SFX, asset_get("mfx_timertick"));
...
set_hitbox_value(AT_DSPECIAL_AIR, 1, HG_HEIGHT, 24);
...
set_hitbox_value(AT_DSPECIAL_AIR, 1, HG_KNOCKBACK_SCALING, .25);
