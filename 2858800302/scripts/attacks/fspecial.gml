...
set_hitbox_value(AT_FSPECIAL, 2, HG_HITPAUSE_SCALING, .95);
set_hitbox_value(AT_FSPECIAL, 2, HG_VISUAL_EFFECT, 156);
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, asset_get("sfx_abyss_hazard_hit"));