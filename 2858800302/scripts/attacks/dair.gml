...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, petal_big);
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, asset_get("sfx_may_whip2"));
set_hitbox_value(AT_DAIR, 1, HG_ANGLE_FLIPPER, 6);

set_hitbox_value(AT_DAIR, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_DAIR, 2, HG_WINDOW, 3);
set_hitbox_value(AT_DAIR, 2, HG_LIFETIME, 11);
set_hitbox_value(AT_DAIR, 2, HG_HITBOX_X, 4);
set_hitbox_value(AT_DAIR, 2, HG_HITBOX_Y, 5);
set_hitbox_value(AT_DAIR, 2, HG_WIDTH, 42);
set_hitbox_value(AT_DAIR, 2, HG_HEIGHT, 34);
...
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT, petal_small);
