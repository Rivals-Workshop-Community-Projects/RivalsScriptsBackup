...
set_hitbox_value(AT_TAUNT, 1, HG_WINDOW_CREATION_FRAME, 9);
...
set_hitbox_value(AT_TAUNT, 1, HG_HEIGHT, 2);
...
set_hitbox_value(AT_TAUNT, 1, HG_KNOCKBACK_SCALING, 0.45);
set_hitbox_value(AT_TAUNT, 1, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_TAUNT, 1, HG_HITPAUSE_SCALING, 0.5);
set_hitbox_value(AT_TAUNT, 1, HG_VISUAL_EFFECT, petal_tipper);
