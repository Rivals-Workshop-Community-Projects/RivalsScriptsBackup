...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("flower_crown"));
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("flower_crown"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, petal_small);
