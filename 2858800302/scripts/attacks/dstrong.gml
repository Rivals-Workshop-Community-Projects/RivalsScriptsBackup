...
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 109);
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, petal_big);
...
set_hitbox_value(AT_DSTRONG, 2, HG_WIDTH, 86);
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, petal_small);
...
set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_Y, -14);
set_hitbox_value(AT_DSTRONG, 3, HG_WIDTH, 83);
...
set_hitbox_value(AT_DSTRONG, 3, HG_HITPAUSE_SCALING, .65);
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT, petal_big);
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_DSTRONG, 3, HG_HIT_SFX, asset_get("sfx_may_whip1"));
set_hitbox_value(AT_DSTRONG, 3, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_GROUP, 4);