...
set_window_value(AT_JAB, 4, AG_WINDOW_SFX, sound_get("camera"));
...
set_hitbox_value(AT_JAB, 2, HG_VISUAL_EFFECT_X_OFFSET, 26);
set_hitbox_value(AT_JAB, 2, HG_VISUAL_EFFECT, 197);
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, asset_get("sfx_absa_uair"));
