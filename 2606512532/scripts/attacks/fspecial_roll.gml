...
set_window_value(AT_FTHROW, 3, AG_WINDOW_HSPEED, -13);
...
set_window_value(AT_FTHROW, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.2);
set_window_value(AT_FTHROW, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.15);
...
set_window_value(AT_FTHROW, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.2);
set_window_value(AT_FTHROW, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.3);
...
set_window_value(AT_FTHROW, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.2);
set_window_value(AT_FTHROW, 5, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.3);
...
set_hitbox_value(AT_FTHROW, 1, HG_LIFETIME, 30);
...
set_hitbox_value(AT_FTHROW, 1, HG_PROJECTILE_HSPEED, 32);
...
set_hitbox_value(AT_FTHROW, 2, HG_WIDTH, 45);
...
set_hitbox_value(AT_FTHROW, 3, HG_HITBOX_X, 50);
...
set_hitbox_value(AT_FTHROW, 3, HG_KNOCKBACK_SCALING, 0.8);
set_hitbox_value(AT_FTHROW, 3, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_FTHROW, 3, HG_EXTRA_HITPAUSE, 4);
