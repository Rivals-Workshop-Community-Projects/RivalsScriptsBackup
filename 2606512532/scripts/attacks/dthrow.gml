...
set_window_value(AT_DTHROW, 1, AG_WINDOW_SFX, asset_get("sfx_charge_blade_ready"));
...
set_hitbox_value(AT_DTHROW, 1, HG_ANGLE, 60);
...
set_hitbox_value(AT_DTHROW, 4, HG_LIFETIME, 18);
...
set_hitbox_value(AT_DTHROW, 4, HG_PROJECTILE_PARRY_STUN, 0);
