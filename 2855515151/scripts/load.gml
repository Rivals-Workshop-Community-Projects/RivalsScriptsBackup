...
sprite_change_offset("crouch", 38, 110);
sprite_change_offset("walk", 34, 88);
sprite_change_offset("walkturn", 23, 74);
...
sprite_change_offset("parry_2", 32, 78);
sprite_change_offset("roll_forward", 34, 76);
sprite_change_offset("roll_backward", 34, 76);
sprite_change_offset("roll_forward_2", 34, 70);
sprite_change_offset("roll_backward_2", 34, 70);
sprite_change_offset("airdodge", 30, 78);
sprite_change_offset("tech", 32, 76);
...
sprite_change_offset("ftilt", 64, 88);
sprite_change_offset("dtilt", 30, 62);
...
sprite_change_offset("uair", 72, 94);
sprite_change_offset("uair2", 72, 94);
sprite_change_offset("uairbig", 70, 176);
sprite_change_offset("dair", 44, 84);
sprite_change_offset("fstrong", 56, 106);
sprite_change_offset("ustrong", 84, 148);
sprite_change_offset("dstrong", 94, 92);
sprite_change_offset("dstrong_2", 94, 92);
sprite_change_offset("nspecial", 42, 80);
sprite_change_offset("nspecial_up", 42, 98);
sprite_change_offset("fspecial", 42,80);
sprite_change_offset("uspecial", 64, 94);
sprite_change_offset("dspecial", 58, 168);
...
sprite_change_offset("doublejump_hatless", 80, 90);
...
sprite_change_offset("tech_hatless", 32, 70); //needs both sprites
...
sprite_change_offset("dattack_hatless", 72, 94);
sprite_change_offset("ftilt_hatless", 64, 88);
...
sprite_change_offset("fstrong_2", 56, 106);
sprite_change_offset("ustrong_hatless", 84, 148);
...
sprite_change_offset("dspecial_2", 100, 126); //needs sprite
sprite_change_offset("taunt_hatless", 72, 80); //needs sprite

sprite_change_offset("dspecial_grab", 266, 366); //needs sprite
...
//article_sprites:
sprite_change_offset("budbe", 22, 24);
sprite_change_offset("budbeexplode", 102, 92);
sprite_change_offset("budbepetal", 102, 92);
sprite_change_offset("roger", 96, 115);
sprite_change_offset("roger_hurt", 96, 115);
sprite_change_offset("hat_hit", 68, 188);
sprite_change_offset("hat_idle", 68, 188);
sprite_change_offset("hat_hurt", 68, 188);
sprite_change_offset("hat_return", 68, 188);
sprite_change_offset("surrender", 24, 109);
