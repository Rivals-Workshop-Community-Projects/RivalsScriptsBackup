...
hfx_spark = hit_fx_create(sprite_get("parry_effect"), 24);
hfx_ustrong = hit_fx_create(sprite_get("ustrongeffect"), 40)
set_hit_particle_sprite(1, sprite_get("hitpart"));
...
budbeexplode = hit_fx_create(sprite_get("budbeexplode"), 40);
active = 0;
