...
set_attack_value(AT_NSPECIAL_2, AG_NUM_WINDOWS, 7); //9
set_attack_value(AT_NSPECIAL_2, AG_HAS_LANDING_LAG, 4);
set_attack_value(AT_NSPECIAL_2, AG_AIR_SPRITE, sprite_get("nspecial_up"));
...
set_window_value(AT_NSPECIAL_2, 4, AG_WINDOW_SFX_FRAME, 5);
...
set_window_value(AT_NSPECIAL_2, 5, AG_WINDOW_TYPE, 0);
set_window_value(AT_NSPECIAL_2, 5, AG_WINDOW_LENGTH, 20);
set_window_value(AT_NSPECIAL_2, 5, AG_WINDOW_ANIM_FRAMES, 4);
set_window_value(AT_NSPECIAL_2, 5, AG_WINDOW_ANIM_FRAME_START, 11);
set_window_value(AT_NSPECIAL_2, 5, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_NSPECIAL_2, 5, AG_WINDOW_SFX, asset_get("sfx_burnconsume"));
...
//Launch
set_window_value(AT_NSPECIAL_2, 6, AG_WINDOW_TYPE, 0);
...
set_window_value(AT_NSPECIAL_2, 6, AG_WINDOW_CUSTOM_AIR_FRICTION, 1.2);
set_window_value(AT_NSPECIAL_2, 6, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.8);
set_window_value(AT_NSPECIAL_2, 6, AG_WINDOW_CUSTOM_GRAVITY, 0.2);

//Post-launch endlag
set_window_value(AT_NSPECIAL_2, 7, AG_WINDOW_TYPE, 0);
set_window_value(AT_NSPECIAL_2, 7, AG_WINDOW_LENGTH, 32);
set_window_value(AT_NSPECIAL_2, 7, AG_WINDOW_ANIM_FRAMES, 8);
set_window_value(AT_NSPECIAL_2, 7, AG_WINDOW_ANIM_FRAME_START, 16);
set_window_value(AT_NSPECIAL_2, 7, AG_WINDOW_CUSTOM_GRAVITY, 1);

//Normal endlag (Has NOT hit player)
set_window_value(AT_NSPECIAL_2, 8, AG_WINDOW_TYPE, 0);
set_window_value(AT_NSPECIAL_2, 8, AG_WINDOW_LENGTH, 15);
set_window_value(AT_NSPECIAL_2, 8, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_NSPECIAL_2, 8, AG_WINDOW_ANIM_FRAME_START, 19);
set_window_value(AT_NSPECIAL_2, 8, AG_WINDOW_CUSTOM_GRAVITY, 1);


set_window_value(AT_NSPECIAL_2, 9, AG_WINDOW_TYPE, 0);
set_window_value(AT_NSPECIAL_2, 9, AG_WINDOW_LENGTH, 8);
set_window_value(AT_NSPECIAL_2, 9, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_NSPECIAL_2, 9, AG_WINDOW_ANIM_FRAME_START, 22);
set_window_value(AT_NSPECIAL_2, 9, AG_WINDOW_CUSTOM_GRAVITY, 1);
...
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HITBOX_X, 42);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HITBOX_Y, -57);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_WIDTH, 40);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HEIGHT, 38);
...
set_hitbox_value(AT_NSPECIAL_2, 1, HG_EXTRA_HITPAUSE, 30);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HITPAUSE_SCALING, 0);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HIT_SFX, asset_get("sfx_bite"));
...
set_hitbox_value(AT_NSPECIAL_2, 3, HG_WINDOW_CREATION_FRAME, 3);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_HITBOX_X, 52);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_HITBOX_Y, -28);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_WIDTH, 65);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_HEIGHT, 69);
...
set_hitbox_value(AT_NSPECIAL_2, 3, HG_BASE_HITPAUSE, 1);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_EXTRA_HITPAUSE, 30);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_HITPAUSE_SCALING, 0);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_HIT_SFX, asset_get("sfx_bite"));
...
set_hitbox_value(AT_NSPECIAL_2, 2, HG_VISUAL_EFFECT, 148);
set_hitbox_value(AT_NSPECIAL_2, 2, HG_HIT_PARTICLE_NUM, 1);
set_hitbox_value(AT_NSPECIAL_2, 2, HG_HIT_LOCKOUT, 10);
set_hitbox_value(AT_NSPECIAL_2, 2, HG_HIT_SFX, asset_get("sfx_forsburn_combust"));
set_hitbox_value(AT_NSPECIAL_2, 2, HG_HITBOX_GROUP, 2);
