...
set_window_value(AT_FTILT, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.7);
...
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT, 265);
...
set_hitbox_value(AT_FTILT, 2, HG_HITBOX_Y, -67);
...
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT, 265);
...
set_hitbox_value(AT_FTILT, 3, HG_HITBOX_X, 110);
...
set_hitbox_value(AT_FTILT, 3, HG_VISUAL_EFFECT, 265);
...
set_hitbox_value(AT_FTILT, 4, HG_HITBOX_X, 136);
set_hitbox_value(AT_FTILT, 4, HG_HITBOX_Y, -31);
set_hitbox_value(AT_FTILT, 4, HG_WIDTH, 41);
set_hitbox_value(AT_FTILT, 4, HG_HEIGHT, 42);
...
set_hitbox_value(AT_FTILT, 4, HG_VISUAL_EFFECT, 261);
set_hitbox_value(AT_FTILT, 4, HG_HIT_PARTICLE_NUM, 1);
set_hitbox_value(AT_FTILT, 4, HG_HIT_SFX, asset_get("sfx_ori_energyhit_heavy"));