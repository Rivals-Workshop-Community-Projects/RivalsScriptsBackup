...
set_window_value(AT_USTRONG, 3, AG_WINDOW_ANIM_FRAMES, 15);
...
set_window_value(AT_USTRONG, 4, AG_WINDOW_ANIM_FRAME_START, 22);
...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, asset_get("sfx_mol_norm_explode"));
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, 251);
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, asset_get("sfx_mol_norm_explode"));
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, 251);
...
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, asset_get("sfx_mol_norm_explode"));
...
set_hitbox_value(AT_USTRONG, 3, HG_VISUAL_EFFECT, 251);
...
set_hitbox_value(AT_USTRONG, 4, HG_HIT_SFX, asset_get("sfx_mol_norm_explode"));
...
set_hitbox_value(AT_USTRONG, 4, HG_VISUAL_EFFECT, 251);
...
set_hitbox_value(AT_USTRONG, 5, HG_WINDOW_CREATION_FRAME, 22);
...
set_hitbox_value(AT_USTRONG, 5, HG_HIT_SFX, asset_get("sfx_mol_norm_explode"));
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_X, -8);
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_Y, -84);
set_hitbox_value(AT_USTRONG, 5, HG_WIDTH, 50);
set_hitbox_value(AT_USTRONG, 5, HG_VISUAL_EFFECT, 251);
...
set_hitbox_value(AT_USTRONG, 6, HG_HIT_SFX, asset_get("sfx_mol_norm_explode"));
set_hitbox_value(AT_USTRONG, 6, HG_HITBOX_X, 20);
set_hitbox_value(AT_USTRONG, 6, HG_HITBOX_Y, -80);
set_hitbox_value(AT_USTRONG, 6, HG_WIDTH, 50);
set_hitbox_value(AT_USTRONG, 6, HG_VISUAL_EFFECT, 251);
set_hitbox_value(AT_USTRONG, 6, HG_HEIGHT, 70);
...
set_hitbox_value(AT_USTRONG, 7, HG_WINDOW_CREATION_FRAME, 26);
...
set_hitbox_value(AT_USTRONG, 7, HG_HIT_SFX, asset_get("sfx_mol_huge_explode"));
set_hitbox_value(AT_USTRONG, 7, HG_HITBOX_X, 6);
set_hitbox_value(AT_USTRONG, 7, HG_HITBOX_Y, -94);
set_hitbox_value(AT_USTRONG, 7, HG_WIDTH, 80);
set_hitbox_value(AT_USTRONG, 7, HG_VISUAL_EFFECT, 262);
