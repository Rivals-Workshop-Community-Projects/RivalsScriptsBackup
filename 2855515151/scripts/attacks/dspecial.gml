...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_LENGTH, 57);
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_ANIM_FRAMES, 19);
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_syl_uspecial_travel_start"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_WINDOW_CREATION_FRAME, 13);
