...
// Physical size
char_height         = 72;       //                  not zetterburn's. this is just cosmetic anyway
...
spr_ftilt_knifeless = sprite_get("ftilt_knifeless");
spr_dummy = sprite_get("dummy");
spr_robodummy = sprite_get("robodummy");
...
// Hurtbox sprites
hurtbox_spr         = sprite_get("dummyhurt");
crouchbox_spr       = sprite_get("dummycrouchhurt");
