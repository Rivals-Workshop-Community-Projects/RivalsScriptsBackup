...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_ell_small_missile_fire"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_MUNO_HITBOX_NAME, "Cotton Ball");
set_hitbox_value(AT_NSPECIAL, 2, HG_MUNO_HITBOX_NAME, "Missile (Robot Dummy Only)");
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, sound_get("sfx_monsterhit"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HIT_SFX, sound_get("sfx_monsterhit"));
