...
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 124);
...
//set_hitbox_value(AT_DSTRONG, 1, HG_ANGLE, 310); //save this for rune lol
set_hitbox_value(AT_DSTRONG, 1, HG_ANGLE, 52);
set_hitbox_value(AT_DSTRONG, 1, HG_BASE_KNOCKBACK, 10);
set_hitbox_value(AT_DSTRONG, 1, HG_FINAL_BASE_KNOCKBACK, 8);
...
//set_hitbox_value(AT_DSTRONG, 1, HG_ANGLE, 310); //save this for rune lol
set_hitbox_value(AT_DSTRONG, 2, HG_ANGLE, 310);
set_hitbox_value(AT_DSTRONG, 2, HG_BASE_KNOCKBACK, 9);
set_hitbox_value(AT_DSTRONG, 2, HG_FINAL_BASE_KNOCKBACK, 8);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("sfx_funny_spike"));
