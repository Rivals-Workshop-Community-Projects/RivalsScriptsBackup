...
set_attack_value(AT_FSPECIAL, AG_MUNO_ATTACK_MISC_ADD, "Second window can be canceled with an airdodge or parry, and will eventually put Dummy into free fall to prevent him from stalling.");