...
set_hitbox_value(AT_UTILT, 1, HG_MUNO_HITBOX_NAME, "Knife");
...
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, asset_get("sfx_syl_nspecial_flowerhit"));

set_hitbox_value(AT_UTILT, 2, HG_MUNO_HITBOX_NAME, "Knifeless");

set_hitbox_value(AT_UTILT, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_UTILT, 2, HG_WINDOW, 0);
...
set_hitbox_value(AT_UTILT, 2, HG_EXTRA_CAMERA_SHAKE, 2);