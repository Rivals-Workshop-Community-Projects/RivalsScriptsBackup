//
sprite_index = sprite_get("knife");           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
image_index = 0;   
mask_index = sprite_get("knife");
