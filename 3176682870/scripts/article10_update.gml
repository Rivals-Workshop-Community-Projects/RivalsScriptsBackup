...
if "alubal_timer" not in obj_stage_main exit;
...
if (obj_stage_main.alubal_timer < 221) {
    obj_stage_main.alubal_timer += 1
}

if (obj_stage_main.alubal_timer = 200) {
    image_index = 1
}

if (obj_stage_main.alubal_timer = 207) {
    image_index = 2
}

if (obj_stage_main.alubal_timer = 214) {
    image_index = 3
}
