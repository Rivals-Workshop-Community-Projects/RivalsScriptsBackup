...
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_Y, -33);//-40
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 70);
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 45);//30
...
set_hitbox_value(AT_BAIR, 1, HG_KNOCKBACK_SCALING, 0.6);//0.5
...
set_hitbox_value(AT_BAIR, 2, HG_KNOCKBACK_SCALING, 0.8);//0.7
