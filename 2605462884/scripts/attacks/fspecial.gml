...
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_X, 44);//40
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_Y, -37);
set_hitbox_value(AT_FSPECIAL, 1, HG_WIDTH, 74);//66
...
set_hitbox_value(AT_FSPECIAL, 1, HG_KNOCKBACK_SCALING, 0.3);//0
