...
var tstststs = get_player_color(player)

draw_sprite_ext( sprite_get("cssbg"), 0, x+8, y+8, 2, 2, 0, -1, 1 );
draw_sprite_ext( sprite_get("css"), tstststs, x+8, y+8, 2, 2, 0, -1, 1 );
draw_sprite_ext( sprite_get("aaa_vernum"), 1, x+180, y+32, 2, 2, 0, -1, 1 );
...
if (!variable_instance_exists(id,"ae") || ye == true){
	...
	//--- ---
	altsel = sound_get("click"); // change the alt select sound here. if you don't want to change the sound, put 0 here.
	...
	ce[0,0] = make_color_rgb(140, 71, 62)
	ce[0,1] = "EXPLORER"
	ce[0,2] = "..."
	ce[1,0] = make_color_rgb(4, 2, 60)
	ce[1,1] = "BASE BODY 25"
	ce[1,2] = ""
	ce[2,0] = make_color_rgb(188, 42, 44)
	ce[2,1] = "BASE BODY 6"
	ce[2,2] = ""
	ce[3,0] = make_color_rgb(132, 162, 20)
	ce[3,1] = "BASE BODY 2"
	ce[3,2] = ""
	ce[4,0] = make_color_rgb(108, 10, 84)
	ce[4,1] = "BASE BODY 5"
	ce[4,2] = ""
	ce[5,0] = make_color_rgb(123, 54, 130)
	ce[5,1] = "BASE BODY 11"
	ce[5,2] = ""
	ce[6,0] = make_color_rgb(60, 2, 4)
	ce[6,1] = "BASE BODY 9"
	ce[6,2] = ""
	ce[7,0] = make_color_rgb(132, 2, 20)
	ce[7,1] = "BASE BODY 16"
	ce[7,2] = ""
	ce[8,0] = make_color_rgb(0, 0, 0)
	ce[8,1] = "MINFINITY EXPLORER"
	ce[8,2] = ""
	ce[9,0] = make_color_rgb(70, 70, 0)
	ce[9,1] = "PHILIPP"
	ce[9,2] = ""
