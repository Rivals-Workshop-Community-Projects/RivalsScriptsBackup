...
set_attack_value(AT_DSPECIAL, AG_HURTBOX_SPRITE, sprite_get("dspecial_hurt")); //no air hurtbox because idc
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HITBOX_X, 45);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_VISUAL_EFFECT, vfx_hit_big);
