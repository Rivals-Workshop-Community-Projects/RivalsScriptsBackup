...
set_window_value(AT_DATTACK, 3, AG_WINDOW_LENGTH, 27);
...
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT, 198);
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, asset_get("sfx_leafy_hit3"));
...
set_hitbox_value(AT_DATTACK, 2, HG_WIDTH, 72);
...
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT, 17);
