...
set_hitbox_value(AT_USTRONG, 4, HG_HITBOX_X, 13);
set_hitbox_value(AT_USTRONG, 4, HG_HITBOX_Y, -81);
set_hitbox_value(AT_USTRONG, 4, HG_WIDTH, 288);
...
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_X, 13);
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_Y, -110);
set_hitbox_value(AT_USTRONG, 5, HG_WIDTH, 288);
...
set_hitbox_value(AT_USTRONG, 6, HG_HITBOX_X, 13);
set_hitbox_value(AT_USTRONG, 6, HG_HITBOX_Y, -144);
set_hitbox_value(AT_USTRONG, 6, HG_WIDTH, 208);
set_hitbox_value(AT_USTRONG, 6, HG_HEIGHT, 104);
