...
set_hitbox_value(AT_FSTRONG, 3, HG_VISUAL_EFFECT, fx_slashlight);
set_hitbox_value(AT_FSTRONG, 3, HG_HIT_SFX, sound_get("sfx_anthem_hit2"));
...
set_hitbox_value(AT_FSTRONG, 4, HG_VISUAL_EFFECT, fx_slashheavy);
set_hitbox_value(AT_FSTRONG, 4, HG_HIT_SFX, sound_get("sfx_anthem_hit3"));
set_hitbox_value(AT_FSTRONG, 4, HG_HITSTUN_MULTIPLIER, 1.1);