...
set_window_value(AT_JAB, 2, AG_WINDOW_HSPEED, 3.5);
...
set_window_value(AT_JAB, 5, AG_WINDOW_HSPEED, 3.5);
...
set_hitbox_value(AT_JAB, 3, HG_HITBOX_Y, -66);
...
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, sound_get("melonimpact"));
set_hitbox_value(AT_JAB, 3, HG_VISUAL_EFFECT, splat_effect);
set_hitbox_value(AT_JAB, 3, HG_PROJECTILE_DESTROY_EFFECT, splat_effect2);
set_hitbox_value(AT_JAB, 3, HG_PROJECTILE_SPRITE, sprite_get("melon"));
set_hitbox_value(AT_JAB, 3, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_JAB, 3, HG_PROJECTILE_COLLISION_SPRITE, sprite_get("melon_collision"));
...
set_hitbox_value(AT_JAB, 3, HG_PROJECTILE_HSPEED, 10);
set_hitbox_value(AT_JAB, 3, HG_PROJECTILE_VSPEED, 2);
set_hitbox_value(AT_JAB, 3, HG_PROJECTILE_GRAVITY, 0.6);
set_hitbox_value(AT_JAB, 3, HG_PROJECTILE_PARRY_STUN, 1);
...
set_hitbox_value(AT_JAB, 4, HG_EFFECT, 19);
...
set_hitbox_value(AT_JAB, 5, HG_KNOCKBACK_SCALING, .3);
set_hitbox_value(AT_JAB, 5, HG_BASE_HITPAUSE, 4);
set_hitbox_value(AT_JAB, 5, HG_HITPAUSE_SCALING, .4);
set_hitbox_value(AT_JAB, 5, HG_EFFECT, 19);
set_hitbox_value(AT_JAB, 5, HG_EXTENDED_PARRY_STUN, 1);
...
set_hitbox_value(AT_JAB, 5, HG_PROJECTILE_PARRY_STUN, 1);
set_hitbox_value(AT_JAB, 5, HG_HITSTUN_MULTIPLIER, 0.5);