...
set_hitbox_value(AT_NAIR, 3, HG_HITBOX_X, 46);
...
set_hitbox_value(AT_NAIR, 6, HG_ANGLE, 120);
...
set_hitbox_value(AT_NAIR, 7, HG_HITBOX_X, -46);
set_hitbox_value(AT_NAIR, 7, HG_HITBOX_Y, -8);
