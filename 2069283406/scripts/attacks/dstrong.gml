...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, .6);
...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("RI2"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, asset_get("sfx_forsburn_combust"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, asset_get("sfx_forsburn_combust"));
