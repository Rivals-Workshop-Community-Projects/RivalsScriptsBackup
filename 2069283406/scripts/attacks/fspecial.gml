...
set_hitbox_value(AT_FSPECIAL, 9, HG_ANGLE_FLIPPER, 3);
set_hitbox_value(AT_FSPECIAL, 9, HG_BASE_KNOCKBACK, 3);
...
set_hitbox_value(AT_FSPECIAL, 9, HG_HITSTUN_MULTIPLIER, 0.6);
