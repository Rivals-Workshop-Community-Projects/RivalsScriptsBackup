...
set_hitbox_value(AT_DSPECIAL, 1, HG_HEIGHT, 166);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_VISUAL_EFFECT, 1);
set_hitbox_value(AT_DSPECIAL, 1, HG_HITSTUN_MULTIPLIER, 1.15);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_TECHABLE, 2);
...
set_hitbox_value(AT_DSPECIAL, 4, HG_KNOCKBACK_SCALING, 0.1);
...
set_hitbox_value(AT_DSPECIAL, 4, HG_TECHABLE, 2);
...
set_hitbox_value(AT_DSPECIAL, 5, HG_TECHABLE, 2);


set_hitbox_value(AT_DSPECIAL, 7, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_DSPECIAL, 7, HG_WINDOW, 4);
set_hitbox_value(AT_DSPECIAL, 7, HG_WINDOW_CREATION_FRAME, 7);
set_hitbox_value(AT_DSPECIAL, 7, HG_LIFETIME, 300);
...
set_hitbox_value(AT_DSPECIAL, 7, HG_PROJECTILE_AIR_FRICTION, 0.4);
...
set_hitbox_value(AT_DSPECIAL, 7, HG_PROJECTILE_SPRITE, sprite_get("ffires2"));
...
set_hitbox_value(AT_DSPECIAL, 7, HG_WIDTH, 45);
...
set_hitbox_value(AT_DSPECIAL, 7, HG_KNOCKBACK_SCALING, 0.4);
...
set_hitbox_value(AT_DSPECIAL, 7, HG_VISUAL_EFFECT, ffire);
