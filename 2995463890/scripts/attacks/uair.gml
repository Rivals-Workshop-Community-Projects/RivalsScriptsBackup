...
set_attack_value(AT_UAIR, AG_STRONG_CHARGE_WINDOW, 1);
...
set_hitbox_value(AT_UAIR, 1, HG_HITPAUSE_SCALING, 0.95);
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT, bighit_hfx);
