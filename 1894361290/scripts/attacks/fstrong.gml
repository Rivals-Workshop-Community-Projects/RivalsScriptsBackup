...
set_hitbox_value(AT_FSTRONG, 5, HG_HITBOX_X, 60);
set_hitbox_value(AT_FSTRONG, 5, HG_HITBOX_Y, -20);
set_hitbox_value(AT_FSTRONG, 5, HG_WIDTH, 45);
...
set_hitbox_value(AT_FSTRONG, 6, HG_HITBOX_X, 38);
set_hitbox_value(AT_FSTRONG, 6, HG_HITBOX_Y, -40);
set_hitbox_value(AT_FSTRONG, 6, HG_WIDTH, 55);
...
set_hitbox_value(AT_FSTRONG, 6, HG_DAMAGE, 9);
...
set_hitbox_value(AT_FSTRONG, 6, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_FSTRONG, 6, HG_HITPAUSE_SCALING, 0.8);
