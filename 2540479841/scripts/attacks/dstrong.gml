...
set_hitbox_value(AT_DSTRONG, 1, HG_BASE_KNOCKBACK, 8.3);
set_hitbox_value(AT_DSTRONG, 1, HG_KNOCKBACK_SCALING, 1.3);
set_hitbox_value(AT_DSTRONG, 1, HG_BASE_HITPAUSE, 7.5);
...
set_hitbox_value(AT_DSTRONG, 2, HG_WIDTH, 135);
...
set_hitbox_value(AT_DSTRONG, 2, HG_BASE_HITPAUSE, 7.5);
