...
set_attack_value(AT_DSPECIAL, AG_SPRITE, sprite_get("dspecialv4"));
set_attack_value(AT_DSPECIAL, AG_NUM_WINDOWS, 3);
set_attack_value(AT_DSPECIAL, AG_HAS_LANDING_LAG, 0);
set_attack_value(AT_DSPECIAL, AG_OFF_LEDGE, 0);
set_attack_value(AT_DSPECIAL, AG_AIR_SPRITE, sprite_get("dspecialv4"));
set_attack_value(AT_DSPECIAL, AG_HURTBOX_SPRITE, sprite_get("dspecialv4_hurt"));
...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX, sound_get("waft4"));
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_HSPEED, 0);
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_VSPEED, -17.5);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_KNOCKBACK_SCALING, 1.15);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_ANGLE, 88);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_PROJECTILE_HSPEED, .75);
...
set_hitbox_value(AT_DSPECIAL, 5, HG_PROJECTILE_SPRITE, sprite_get("gascloud"));
set_hitbox_value(AT_DSPECIAL, 5, HG_PROJECTILE_MASK, sprite_get("gascloud"));
set_hitbox_value(AT_DSPECIAL, 5, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_DSPECIAL, 5, HG_PROJECTILE_VSPEED, -0.1);
...
set_hitbox_value(AT_DSPECIAL, 6, HG_PROJECTILE_SPRITE, sprite_get("gascloud"));
set_hitbox_value(AT_DSPECIAL, 6, HG_PROJECTILE_MASK, sprite_get("gascloud"));
set_hitbox_value(AT_DSPECIAL, 6, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_DSPECIAL, 6, HG_PROJECTILE_VSPEED, -0.1);
...
set_hitbox_value(AT_DSPECIAL, 7, HG_HITBOX_Y, 16);
...
set_hitbox_value(AT_DSPECIAL, 7, HG_ANGLE, 0);
set_hitbox_value(AT_DSPECIAL, 7, HG_VISUAL_EFFECT_Y_OFFSET, -16);
set_hitbox_value(AT_DSPECIAL, 7, HG_HITSTUN_MULTIPLIER, -1);
set_hitbox_value(AT_DSPECIAL, 7, HG_PROJECTILE_SPRITE, sprite_get("gascloud4"));
...
set_hitbox_value(AT_DSPECIAL, 7, HG_PROJECTILE_HSPEED, -.75);
