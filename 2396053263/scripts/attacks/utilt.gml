...
set_hitbox_value(AT_UTILT, 1, HG_KNOCKBACK_SCALING, 0.75);
...
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, hit_utiltsweet);
...
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, hit_weak_1);
