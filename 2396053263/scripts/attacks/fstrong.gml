...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 2.2);
...
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, hit_fstrong_sour);
...
set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT, hit_fstrong_sour);
...
set_hitbox_value(AT_FSTRONG, 3, HG_DAMAGE, 18);
...
set_hitbox_value(AT_FSTRONG, 3, HG_VISUAL_EFFECT, hit_fstrong_sour);
