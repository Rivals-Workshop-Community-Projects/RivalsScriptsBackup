...
set_hitbox_value(AT_JAB, 2, HG_VISUAL_EFFECT, hit_weak_1);
...
set_hitbox_value(AT_JAB, 3, HG_ANGLE, 320);
...
set_hitbox_value(AT_JAB, 3, HG_VISUAL_EFFECT, hit_weak_1);
...
set_hitbox_value(AT_JAB, 4, HG_ANGLE, 320);
...
set_hitbox_value(AT_JAB, 4, HG_VISUAL_EFFECT, hit_weak_1);
...
set_hitbox_value(AT_JAB, 5, HG_HITBOX_X, -15);
set_hitbox_value(AT_JAB, 5, HG_HITBOX_Y, -27);
...
set_hitbox_value(AT_JAB, 5, HG_HITPAUSE_SCALING, 0.4);
set_hitbox_value(AT_JAB, 5, HG_HIT_SFX, asset_get("sfx_blow_medium1"));
set_hitbox_value(AT_JAB, 5, HG_VISUAL_EFFECT, hit_weak_1);