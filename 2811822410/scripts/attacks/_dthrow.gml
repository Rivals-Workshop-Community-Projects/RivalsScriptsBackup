var curr_attack = AT_DTHROW_2;

set_attack_value(curr_attack, AG_CATEGORY, 2);
set_attack_value(curr_attack, AG_SPRITE, sprite_get("dthrow"));
set_attack_value(curr_attack, AG_NUM_WINDOWS, 3);
set_attack_value(curr_attack, AG_HURTBOX_SPRITE, sprite_get("dthrow_hurt"));
...
set_hitbox_value(curr_attack, 1, HG_BASE_KNOCKBACK, 9);
