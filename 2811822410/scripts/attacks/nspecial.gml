...
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("nspecial_leak"));
...
set_hitbox_value(AT_NSPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("nspecial_leak"));
...
set_hitbox_value(AT_NSPECIAL, 3, HG_VISUAL_EFFECT, HFX_MAY_LEAF_HUGE);
