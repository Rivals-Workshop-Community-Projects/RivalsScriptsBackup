...
set_window_value(curr_attack, 2, AG_WINDOW_LENGTH, 32);
set_window_value(curr_attack, 2, AG_WINDOW_ANIM_FRAMES, 8);
...
set_hitbox_value(curr_attack, 1, HG_WIDTH, 0);
set_hitbox_value(curr_attack, 1, HG_HEIGHT, 1028);
...
set_hitbox_value(curr_attack, 1, HG_EXTRA_HITPAUSE, 20); 
...
set_hitbox_value(curr_attack, 2, HG_DAMAGE, 8);
set_hitbox_value(curr_attack, 2, HG_PROJECTILE_SPRITE, sprite_get("empty"));
set_hitbox_value(curr_attack, 2, HG_PROJECTILE_MASK, -1);
set_hitbox_value(curr_attack, 2, HG_SHAPE, 1);
set_hitbox_value(curr_attack, 2, HG_WIDTH, 120);
set_hitbox_value(curr_attack, 2, HG_HEIGHT, 1028);
...
set_hitbox_value(curr_attack, 2, HG_HIT_SFX, asset_get("sfx_absa_singlezap2"));
set_hitbox_value(curr_attack, 2, HG_BASE_HITPAUSE, 10); 
set_hitbox_value(curr_attack, 2, HG_EXTRA_HITPAUSE, 20); 
...
set_hitbox_value(curr_attack, 2, HG_HIT_PARTICLE_NUM, 6);

set_hitbox_value(curr_attack, 3, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(curr_attack, 3, HG_HITBOX_TYPE, 2);
set_hitbox_value(curr_attack, 3, HG_PROJECTILE_ANIM_SPEED, .5);
set_hitbox_value(curr_attack, 3, HG_WINDOW, 3);
set_hitbox_value(curr_attack, 3, HG_WINDOW_CREATION_FRAME, 0);
set_hitbox_value(curr_attack, 3, HG_LIFETIME, 20);
set_hitbox_value(curr_attack, 3, HG_PRIORITY, 8);
set_hitbox_value(curr_attack, 3, HG_DAMAGE, 2);
set_hitbox_value(curr_attack, 3, HG_PROJECTILE_SPRITE, sprite_get("empty"));
set_hitbox_value(curr_attack, 3, HG_PROJECTILE_MASK, -1);
set_hitbox_value(curr_attack, 3, HG_SHAPE, 1);
set_hitbox_value(curr_attack, 3, HG_WIDTH, 120);
set_hitbox_value(curr_attack, 3, HG_HEIGHT, 2048);
set_hitbox_value(curr_attack, 3, HG_HITBOX_Y, 0);
set_hitbox_value(curr_attack, 3, HG_HITBOX_X, 0);
set_hitbox_value(curr_attack, 3, HG_PROJECTILE_DESTROY_EFFECT, 1);
set_hitbox_value(curr_attack, 3, HG_PROJECTILE_HSPEED, 0);
set_hitbox_value(curr_attack, 3, HG_PROJECTILE_VSPEED, 0);
set_hitbox_value(curr_attack, 3, HG_PROJECTILE_GRAVITY, 0);
set_hitbox_value(curr_attack, 3, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(curr_attack, 3, HG_KNOCKBACK_SCALING, 0); 
set_hitbox_value(curr_attack, 3, HG_ANGLE, 90);
set_hitbox_value(curr_attack, 3, HG_PROJECTILE_WALL_BEHAVIOR, 1);
set_hitbox_value(curr_attack, 3, HG_PROJECTILE_GROUND_BEHAVIOR, 1);
set_hitbox_value(curr_attack, 3, HG_PROJECTILE_ENEMY_BEHAVIOR, 1);
set_hitbox_value(curr_attack, 3, HG_HIT_SFX, asset_get("sfx_absa_singlezap2"));
set_hitbox_value(curr_attack, 3, HG_BASE_HITPAUSE, 10); 
set_hitbox_value(curr_attack, 3, HG_EXTRA_HITPAUSE, 20); 
set_hitbox_value(curr_attack, 3, HG_HITBOX_GROUP, 1); 
set_hitbox_value(curr_attack, 3, HG_PROJECTILE_IS_TRANSCENDENT, true); 
set_hitbox_value(curr_attack, 3, HG_PROJECTILE_DOES_NOT_REFLECT, true); 
set_hitbox_value(curr_attack, 3, HG_PROJECTILE_UNBASHABLE, true); 
set_hitbox_value(curr_attack, 3, HG_HITPAUSE_SCALING, 0); 
set_hitbox_value(curr_attack, 3, HG_HITSTUN_MULTIPLIER, .5); 
set_hitbox_value(curr_attack, 3, HG_HIT_LOCKOUT, 0);
set_hitbox_value(curr_attack, 3, HG_PROJECTILE_PARRY_STUN, true);
set_hitbox_value(curr_attack, 3, HG_EXTENDED_PARRY_STUN, true);
set_hitbox_value(curr_attack, 3, HG_VISUAL_EFFECT, 301);
set_hitbox_value(curr_attack, 3, HG_HIT_PARTICLE_NUM, 6);
