for (i = 0; i <= 1; i++) {
	...
	set_window_value(curr_attack, 1, AG_WINDOW_SFX_FRAME, 11);
	set_window_value(curr_attack, 1, AG_WINDOW_HSPEED, 12);
	...
	set_window_value(curr_attack, 2, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
	set_window_value(curr_attack, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .5);
