...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, .8);
...
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT, HFX_MAY_LEAF_HUGE);
...
set_hitbox_value(AT_USPECIAL, 2, HG_VISUAL_EFFECT, HFX_MAY_LEAF_BIG);
