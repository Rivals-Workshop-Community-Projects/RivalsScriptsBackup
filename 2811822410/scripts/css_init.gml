...
[
	...
	["USPECIAL Info", "USPECIAL is strong kill move that has poor vertical and horizontal reach. Hitting the early hit will deal a lot of knockback."],
	...
	["DSPECIAL Weakness", "Opponents hitting the clone destroys it and puts it on a cooldown."]
]
used_pages = [];
