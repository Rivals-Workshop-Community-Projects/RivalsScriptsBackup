		...
		*/
		...
		if (browser_type == "text") {
			if (array_length(used_pages)) {
				textDraw(temp_x + 4, temp_y + 33 + 0 * 14, "fName", c_white, 14, 200, 1, true, 1, used_pages[search_page, 0]);
				textDraw(temp_x + 4, temp_y + 33 + 1 * 14, "fName", c_white, 14, 200, 1, true, 1, used_pages[search_page, 1]);
				draw_set_halign(fa_right);
				textDraw(temp_x + 196, temp_y + 33 + 0 * 14, "fName", c_white, 14, 200, 1, true, 1, string(search_page + 1) + "/" + string(array_length(used_pages)));
				draw_set_halign(fa_left);
			} else if (search_term == "") {
				//array_push(used_pages, [pages[0, 0], pages[0, 1]]); //Default
				textDraw(temp_x + 4, temp_y + 33 + 0 * 14, "fName", c_white, 14, 200, 1, true, 1, pages[search_page, 0]);
				textDraw(temp_x + 4, temp_y + 33 + 1 * 14, "fName", c_white, 14, 200, 1, true, 1, pages[search_page, 1]);
				draw_set_halign(fa_right);
				textDraw(temp_x + 196, temp_y + 33 + 0 * 14, "fName", c_white, 14, 200, 1, true, 1, string(search_page + 1) + "/" + string(array_length(pages)));
				draw_set_halign(fa_left);
			}
		} else if (browser_type == "framedata") {
			...
			//Attack Sprite
			draw_sprite_ext(hitbox_list[0, 1], 2, temp_x + 100, temp_y + 100, .5 + (small_sprites * .5), .5 + (small_sprites * .5), 0, c_white, 1);
			//Hurtbox
			draw_sprite_ext(hitbox_list[0, 2], 2, temp_x + 100, temp_y + 100, .5 + (small_sprites * .5), .5 + (small_sprites * .5), 0, c_white, .8);
			//Hitbox
			draw_sprite_ext(
		...
		textDraw(temp_x + 4, temp_y + 33 + (search_max) * 14, "fName", c_white, 0, 200, 1, true, 1, ">" + string(search_term));
		/*
