...
set_window_value(AT_DATTACK, 2, AG_WINDOW_HSPEED, 6.75);
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.05);
...
set_window_value(AT_DATTACK, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.20);
...
set_window_value(AT_DATTACK, 6, AG_WINDOW_HITPAUSE_FRAME, 4);
set_window_value(AT_DATTACK, 6, AG_WINDOW_HSPEED, 2.5);
set_window_value(AT_DATTACK, 6, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_DATTACK, 6, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_DATTACK, 6, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.25);

set_num_hitboxes(AT_DATTACK, 2);

set_hitbox_value(AT_DATTACK, 1, HG_MUNO_HITBOX_NAME, "Early Strike");
...
set_hitbox_value(AT_DATTACK, 2, HG_MUNO_HITBOX_NAME, "Weak Alternative");
...
set_hitbox_value(AT_DATTACK, 2, HG_KNOCKBACK_SCALING, 0.40);
