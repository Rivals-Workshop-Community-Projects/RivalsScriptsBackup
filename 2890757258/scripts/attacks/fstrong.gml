...
set_hitbox_value(AT_FSTRONG, 2, HG_WIDTH, 107);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HITPAUSE_SCALING, 0.70);
...
set_hitbox_value(AT_FSTRONG, 3, HG_WIDTH, 130);
...
set_hitbox_value(AT_FSTRONG, 3, HG_KNOCKBACK_SCALING, 1.10);
set_hitbox_value(AT_FSTRONG, 3, HG_BASE_HITPAUSE, 9);
set_hitbox_value(AT_FSTRONG, 3, HG_HITPAUSE_SCALING, 0.70);
