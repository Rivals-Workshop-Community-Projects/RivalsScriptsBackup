...
set_hitbox_value(AT_BAIR, 1, HG_MUNO_HITBOX_NAME, "Early Strike");
...
set_hitbox_value(AT_BAIR, 2, HG_MUNO_HITBOX_NAME, "Late Strike");
...
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_X, -9);
...
set_hitbox_value(AT_BAIR, 2, HG_HITPAUSE_SCALING, 0.45);
