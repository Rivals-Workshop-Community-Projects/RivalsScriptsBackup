...
set_hitbox_value(AT_DAIR, 1, HG_MUNO_HITBOX_NAME, "Spike Spot");
...
set_hitbox_value(AT_DAIR, 1, HG_ANGLE, 270);		// man... 285
...
set_hitbox_value(AT_DAIR, 2, HG_MUNO_HITBOX_NAME, "Regular Spot");
