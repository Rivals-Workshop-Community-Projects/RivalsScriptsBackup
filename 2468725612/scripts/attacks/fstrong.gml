...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("fstrong_swing"));
...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_SFX, sound_get("shotgun_shoot"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sound_get("shotgun1"));
...
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, sound_get("shotgun1"));
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_LOCKOUT, 3);
...
set_hitbox_value(AT_FSTRONG, 3, HG_HITBOX_Y, -99);
...
set_hitbox_value(AT_FSTRONG, 3, HG_HIT_SFX, sound_get("shotgun1"));
...
set_hitbox_value(AT_FSTRONG, 4, HG_WIDTH, 82);
...
set_hitbox_value(AT_FSTRONG, 4, HG_VISUAL_EFFECT, 110);
...
set_hitbox_value(AT_FSTRONG, 5, HG_HITBOX_X, 130);
set_hitbox_value(AT_FSTRONG, 5, HG_HITBOX_Y, -37);
set_hitbox_value(AT_FSTRONG, 5, HG_WIDTH, 130);
...
set_hitbox_value(AT_FSTRONG, 5, HG_KNOCKBACK_SCALING, .8);
set_hitbox_value(AT_FSTRONG, 5, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_FSTRONG, 5, HG_HITPAUSE_SCALING, .8);
set_hitbox_value(AT_FSTRONG, 5, HG_VISUAL_EFFECT, 109);
set_hitbox_value(AT_FSTRONG, 5, HG_HIT_SFX, asset_get("sfx_abyss_hazard_hit"));
set_hitbox_value(AT_FSTRONG, 5, HG_PROJECTILE_SPRITE, asset_get("empty_sprite"));
set_hitbox_value(AT_FSTRONG, 5, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_FSTRONG, 5, HG_PROJECTILE_IS_TRANSCENDENT, true);
set_hitbox_value(AT_FSTRONG, 5, HG_PROJECTILE_PARRY_STUN, true);
set_hitbox_value(AT_FSTRONG, 5, HG_PROJECTILE_PLASMA_SAFE, 1);
...
set_hitbox_value(AT_FSTRONG, 6, HG_HITBOX_Y, -47);
set_hitbox_value(AT_FSTRONG, 6, HG_WIDTH, 92);
set_hitbox_value(AT_FSTRONG, 6, HG_HEIGHT, 60);
set_hitbox_value(AT_FSTRONG, 6, HG_PRIORITY, 4);
set_hitbox_value(AT_FSTRONG, 6, HG_DAMAGE, 0);
set_hitbox_value(AT_FSTRONG, 6, HG_ANGLE, 45);
set_hitbox_value(AT_FSTRONG, 6, HG_BASE_KNOCKBACK, 14);
...
set_hitbox_value(AT_FSTRONG, 6, HG_VISUAL_EFFECT, 123);
set_hitbox_value(AT_FSTRONG, 6, HG_HIT_LOCKOUT, 4);
set_hitbox_value(AT_FSTRONG, 6, HG_HIT_SFX, asset_get("sfx_clairen_hit_strong"));
set_hitbox_value(AT_FSTRONG, 6, HG_PROJECTILE_SPRITE, asset_get("empty_sprite"));
set_hitbox_value(AT_FSTRONG, 6, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_FSTRONG, 6, HG_PROJECTILE_IS_TRANSCENDENT, true);
set_hitbox_value(AT_FSTRONG, 6, HG_PROJECTILE_PARRY_STUN, true);
set_hitbox_value(AT_FSTRONG, 6, HG_PROJECTILE_PLASMA_SAFE, 1);

set_hitbox_value(AT_FSTRONG, 7, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_FSTRONG, 7, HG_WINDOW, 2);
set_hitbox_value(AT_FSTRONG, 7, HG_WINDOW_CREATION_FRAME, 6);
set_hitbox_value(AT_FSTRONG, 7, HG_LIFETIME, 4);
set_hitbox_value(AT_FSTRONG, 7, HG_HITBOX_X, 48);
set_hitbox_value(AT_FSTRONG, 7, HG_HITBOX_Y, -78);
set_hitbox_value(AT_FSTRONG, 7, HG_WIDTH, 68);
set_hitbox_value(AT_FSTRONG, 7, HG_HEIGHT, 39);
set_hitbox_value(AT_FSTRONG, 7, HG_PRIORITY, 4);
set_hitbox_value(AT_FSTRONG, 7, HG_DAMAGE, 0);
set_hitbox_value(AT_FSTRONG, 7, HG_ANGLE, 45);
set_hitbox_value(AT_FSTRONG, 7, HG_BASE_KNOCKBACK, 14);
set_hitbox_value(AT_FSTRONG, 7, HG_KNOCKBACK_SCALING, 1.1);
set_hitbox_value(AT_FSTRONG, 7, HG_BASE_HITPAUSE, 15);
//set_hitbox_value(AT_FSTRONG, 7, HG_HITPAUSE_SCALING, 1.0);
set_hitbox_value(AT_FSTRONG, 7, HG_VISUAL_EFFECT, 123);
set_hitbox_value(AT_FSTRONG, 7, HG_HIT_LOCKOUT, 4);
set_hitbox_value(AT_FSTRONG, 7, HG_HIT_SFX, asset_get("sfx_clairen_hit_strong"));
set_hitbox_value(AT_FSTRONG, 7, HG_PROJECTILE_SPRITE, asset_get("empty_sprite"));
set_hitbox_value(AT_FSTRONG, 7, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_FSTRONG, 7, HG_PROJECTILE_IS_TRANSCENDENT, true);
set_hitbox_value(AT_FSTRONG, 7, HG_PROJECTILE_PARRY_STUN, true);
set_hitbox_value(AT_FSTRONG, 7, HG_PROJECTILE_PLASMA_SAFE, 1);
...
set_hitbox_value(AT_FSTRONG, 8, HG_HITBOX_X, 14);
set_hitbox_value(AT_FSTRONG, 8, HG_HITBOX_Y, -99);
set_hitbox_value(AT_FSTRONG, 8, HG_WIDTH, 60);
set_hitbox_value(AT_FSTRONG, 8, HG_HEIGHT, 31);
set_hitbox_value(AT_FSTRONG, 8, HG_PRIORITY, 4);
set_hitbox_value(AT_FSTRONG, 8, HG_DAMAGE, 0);
set_hitbox_value(AT_FSTRONG, 8, HG_ANGLE, 45);
set_hitbox_value(AT_FSTRONG, 8, HG_BASE_KNOCKBACK, 14);
set_hitbox_value(AT_FSTRONG, 8, HG_KNOCKBACK_SCALING, 1.1);
set_hitbox_value(AT_FSTRONG, 8, HG_BASE_HITPAUSE, 15);
//set_hitbox_value(AT_FSTRONG, 8, HG_HITPAUSE_SCALING, 1.0);
set_hitbox_value(AT_FSTRONG, 8, HG_VISUAL_EFFECT, 123);
set_hitbox_value(AT_FSTRONG, 8, HG_HIT_LOCKOUT, 4);
set_hitbox_value(AT_FSTRONG, 8, HG_HIT_SFX, asset_get("sfx_clairen_hit_strong"));
set_hitbox_value(AT_FSTRONG, 8, HG_PROJECTILE_SPRITE, asset_get("empty_sprite"));
set_hitbox_value(AT_FSTRONG, 8, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_FSTRONG, 8, HG_PROJECTILE_IS_TRANSCENDENT, true);
set_hitbox_value(AT_FSTRONG, 8, HG_PROJECTILE_PARRY_STUN, true);
set_hitbox_value(AT_FSTRONG, 8, HG_PROJECTILE_PLASMA_SAFE, 1);
...
set_hitbox_value(AT_FSTRONG, 4, HG_EFFECT, has_rune("A"));
set_hitbox_value(AT_FSTRONG, 5, HG_EFFECT, has_rune("A"));