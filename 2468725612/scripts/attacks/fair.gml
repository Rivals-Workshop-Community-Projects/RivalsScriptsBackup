...
set_hitbox_value(AT_FAIR, 1, HG_HITBOX_Y, -59);
set_hitbox_value(AT_FAIR, 1, HG_WIDTH, 93);
set_hitbox_value(AT_FAIR, 1, HG_HEIGHT, 83);
...
set_hitbox_value(AT_FAIR, 2, HG_WIDTH, 93);
set_hitbox_value(AT_FAIR, 2, HG_HEIGHT, 83);
