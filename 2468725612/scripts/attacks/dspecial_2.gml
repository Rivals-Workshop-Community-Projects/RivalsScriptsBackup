...
set_attack_value(AT_DSPECIAL_2, AG_SPRITE, sprite_get("dspecial_hologram"));
...
set_window_value(AT_DSPECIAL_2, 1, AG_WINDOW_SFX, sound_get("dspecial_start"));
...
set_window_value(AT_DSPECIAL_2, 4, AG_WINDOW_HSPEED, -4);
...
set_window_value(AT_DSPECIAL_2, 4, AG_WINDOW_SFX, sound_get("shotgun_shoot"));
set_window_value(AT_DSPECIAL_2, 4, AG_WINDOW_SFX_FRAME, 7);
...
set_window_value(AT_DSPECIAL_2, 5, AG_WINDOW_HSPEED, -2);
...
set_window_value(AT_DSPECIAL_2, 5, AG_WINDOW_SFX, sound_get("dspecial_end"));
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_LIFETIME, 19);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HITBOX_X, 76);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HITBOX_Y, -40);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_WIDTH, 133);
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_VISUAL_EFFECT, 123);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HIT_SFX, asset_get("sfx_clairen_hit_strong"));
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_HITBOX_X, 165);
set_hitbox_value(AT_DSPECIAL_2, 2, HG_HITBOX_Y, -37);
set_hitbox_value(AT_DSPECIAL_2, 2, HG_WIDTH, 82);
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_KNOCKBACK_SCALING, .9);
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_PROJECTILE_PLASMA_SAFE, 1);
...
set_hitbox_value(AT_DSPECIAL_2, 3, HG_WINDOW_CREATION_FRAME, 3);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_LIFETIME, 8);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_HITBOX_X, 190);
...
set_hitbox_value(AT_DSPECIAL_2, 3, HG_KNOCKBACK_SCALING, .9);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_HITPAUSE_SCALING, .8);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_VISUAL_EFFECT, 109);
...
set_hitbox_value(AT_DSPECIAL_2, 3, HG_PROJECTILE_PLASMA_SAFE, 1);

set_hitbox_value(AT_DSPECIAL_2, 1, HG_EFFECT, 0);
set_hitbox_value(AT_DSPECIAL_2, 2, HG_EFFECT, has_rune("A"));
set_hitbox_value(AT_DSPECIAL_2, 3, HG_EFFECT, has_rune("A"));