...
set_hitbox_value(AT_UAIR, 2, HG_HITBOX_X, 52);
...
set_hitbox_value(AT_UAIR, 3, HG_WIDTH, 138);
set_hitbox_value(AT_UAIR, 3, HG_HEIGHT, 67);
...
set_hitbox_value(AT_UAIR, 3, HG_HIT_SFX, sound_get("kick_medium"));
...
set_hitbox_value(AT_UAIR, 4, HG_HITBOX_X, -62);
set_hitbox_value(AT_UAIR, 4, HG_HITBOX_Y, -56);
set_hitbox_value(AT_UAIR, 4, HG_WIDTH, 41);
...
set_hitbox_value(AT_UAIR, 4, HG_HIT_SFX, sound_get("kick_weak"));
...
set_hitbox_value(AT_UAIR, 5, HG_HITBOX_X, 37);
set_hitbox_value(AT_UAIR, 5, HG_HITBOX_Y, -71);
set_hitbox_value(AT_UAIR, 5, HG_WIDTH, 52);
set_hitbox_value(AT_UAIR, 5, HG_HEIGHT, 81);
...
set_hitbox_value(AT_UAIR, 5, HG_HIT_LOCKOUT, 16);
set_hitbox_value(AT_UAIR, 5, HG_PROJECTILE_SPRITE, asset_get("empty_sprite"));
set_hitbox_value(AT_UAIR, 5, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_UAIR, 5, HG_PROJECTILE_IS_TRANSCENDENT, true);
set_hitbox_value(AT_UAIR, 5, HG_PROJECTILE_PARRY_STUN, true);
set_hitbox_value(AT_UAIR, 5, HG_PROJECTILE_PLASMA_SAFE, 1);
set_hitbox_value(AT_UAIR, 5, HG_PROJECTILE_DESTROY_EFFECT, 1);
...
set_hitbox_value(AT_UAIR, 6, HG_HITBOX_X, 52);
set_hitbox_value(AT_UAIR, 6, HG_HITBOX_Y, -55);
set_hitbox_value(AT_UAIR, 6, HG_WIDTH, 46);
set_hitbox_value(AT_UAIR, 6, HG_HEIGHT, 87);
set_hitbox_value(AT_UAIR, 6, HG_PRIORITY, 5);
set_hitbox_value(AT_UAIR, 6, HG_DAMAGE, 0);
set_hitbox_value(AT_UAIR, 6, HG_ANGLE, 90);
set_hitbox_value(AT_UAIR, 6, HG_BASE_KNOCKBACK, 12);
set_hitbox_value(AT_UAIR, 6, HG_KNOCKBACK_SCALING, .8);
set_hitbox_value(AT_UAIR, 6, HG_BASE_HITPAUSE, 9);
set_hitbox_value(AT_UAIR, 6, HG_VISUAL_EFFECT, 128);
set_hitbox_value(AT_UAIR, 6, HG_HIT_SFX, asset_get("sfx_clairen_hit_med"));
set_hitbox_value(AT_UAIR, 6, HG_HIT_LOCKOUT, 16);
set_hitbox_value(AT_UAIR, 6, HG_PROJECTILE_SPRITE, asset_get("empty_sprite"));
set_hitbox_value(AT_UAIR, 6, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_UAIR, 6, HG_PROJECTILE_IS_TRANSCENDENT, true);
set_hitbox_value(AT_UAIR, 6, HG_PROJECTILE_PARRY_STUN, true);
set_hitbox_value(AT_UAIR, 6, HG_PROJECTILE_PLASMA_SAFE, 1);
set_hitbox_value(AT_UAIR, 6, HG_PROJECTILE_DESTROY_EFFECT, 1);
...
set_hitbox_value(AT_UAIR, 7, HG_HITBOX_Y, -79);
set_hitbox_value(AT_UAIR, 7, HG_WIDTH, 138);
set_hitbox_value(AT_UAIR, 7, HG_HEIGHT, 67);
set_hitbox_value(AT_UAIR, 7, HG_PRIORITY, 5);
set_hitbox_value(AT_UAIR, 7, HG_DAMAGE, 0);
set_hitbox_value(AT_UAIR, 7, HG_ANGLE, 90);
set_hitbox_value(AT_UAIR, 7, HG_BASE_KNOCKBACK, 12);
set_hitbox_value(AT_UAIR, 7, HG_KNOCKBACK_SCALING, .8);
set_hitbox_value(AT_UAIR, 7, HG_BASE_HITPAUSE, 9);
set_hitbox_value(AT_UAIR, 7, HG_VISUAL_EFFECT, 128);
set_hitbox_value(AT_UAIR, 7, HG_HIT_SFX, asset_get("sfx_clairen_hit_med"));
set_hitbox_value(AT_UAIR, 7, HG_HIT_LOCKOUT, 16);
set_hitbox_value(AT_UAIR, 7, HG_PROJECTILE_SPRITE, asset_get("empty_sprite"));
set_hitbox_value(AT_UAIR, 7, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_UAIR, 7, HG_PROJECTILE_IS_TRANSCENDENT, true);
set_hitbox_value(AT_UAIR, 7, HG_PROJECTILE_PARRY_STUN, true);
...
set_hitbox_value(AT_UAIR, 8, HG_HITBOX_X, -62);
set_hitbox_value(AT_UAIR, 8, HG_HITBOX_Y, -56);
set_hitbox_value(AT_UAIR, 8, HG_WIDTH, 41);
