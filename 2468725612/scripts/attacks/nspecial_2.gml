...
set_attack_value(AT_NSPECIAL_2, AG_HURTBOX_AIR_SPRITE, sprite_get("nspecial2_hurt"));
...
set_window_value(AT_NSPECIAL_2, 1, AG_WINDOW_SFX, sound_get("throw_hat"));
set_window_value(AT_NSPECIAL_2, 1, AG_WINDOW_SFX_FRAME, 10);
set_window_value(AT_NSPECIAL_2, 1, AG_WINDOW_CUSTOM_GRAVITY, .60);
...
set_window_value(AT_NSPECIAL_2, 2, AG_WINDOW_SFX, sound_get("nspecial_act"));
set_window_value(AT_NSPECIAL_2, 2, AG_WINDOW_SFX_FRAME, 12);
set_window_value(AT_NSPECIAL_2, 2, AG_WINDOW_CUSTOM_GRAVITY, .60);
...
set_window_value(AT_NSPECIAL_2, 6, AG_WINDOW_CUSTOM_GRAVITY, .60);

set_hitbox_value(AT_NSPECIAL_2, 1, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_WINDOW, 9);
...
set_hitbox_value(AT_NSPECIAL_2, 1, HG_WIDTH, 2);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HEIGHT, 2);
