...
set_attack_value(AT_FSTRONG, AG_CATEGORY, 2);//allows it to be in air
set_attack_value(AT_FSTRONG, AG_STRONG_CHARGE_WINDOW, 1);
set_attack_value(AT_FSTRONG, AG_HURTBOX_SPRITE, sprite_get("fstrong_hurt"));
set_attack_value(AT_FSTRONG, AG_OFF_LEDGE, 1); //so it can go off of ledges
...
//lag after attack return to idle
...
set_window_value(AT_FSTRONG, 5, AG_USES_CUSTOM_GRAVITY, 1);
