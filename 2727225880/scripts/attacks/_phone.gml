...
set_window_value(AT_PHONE, 3, AG_WINDOW_ANIM_FRAME_START, 1);


/*
set_window_value(AT_PHONE, 4, AG_WINDOW_LENGTH, 12);
set_window_value(AT_PHONE, 4, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_PHONE, 4, AG_WINDOW_ANIM_FRAME_START, 4);