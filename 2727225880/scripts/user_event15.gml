...
initTip("Mechanic: Zoom");
initWords("Landing a strong, fspecial, or dspecial puts you into the Zoom state

In this state, any aerial attack (excluding uair) and utilt will send you flying

You can have a maximum of 2 Zoom Stacks, achieved by landing any of the previously
mentioned moves while in zoom state already or by hitting a fully charged dspecial

If you land after hitting a move in the zoom state your stack is not depleted (one time only per zooming)

You lose one stack on being hit
You lose the state upon being parried, killed, and after a few seconds of not hitting anyone



tldr; hit opponent go fast
");


initTip("NSpecial: Chakram");
initWords("Throw a chakram which flies forward before returning to you!
You must catch the chakram before you can throw it again");
initWords("If it hits an opponent or is hit by the opponent it will bounce off and land on stage
If it is on stage for too long it will despawn, but will later respawn above your position");
initImage_ext(sprite_get("nspec_ground"), -6, fa_center, 1, 1, true, c_white, 1, true, 200, 400, 100, 200);
initImage_ext(sprite_get("disc_zoom"), -5, fa_center, 1, 1, true, c_white, 1, true, 250, 100, 70, 100);


initTip("FSpecial: Ryusenkyaku");
initWords("Fly forward and slam down with a leg!
Spikes aerial opponents");
initWords("Can be cancelled after falling for some time.");
initImage_ext(sprite_get("fspecial"), -5, fa_center, 1, 1, true, c_white, 1, false, noone, noone, noone, noone);

initTip("USpecial: Helicopter Kick");
initWords("Use a flurry of kicks before sending your opponent away.");
initWords("Doesn't go far, but you have great control of your movement during the attack.");
initImage_ext(sprite_get("uspecial"), -5, fa_center, 1, 1, true, c_white, 1, false, noone, noone, noone, noone);

initTip("DSpecial: Focus Attack");
initWords("Charge up before releasing an armored punch in either direction.");
initWords("Can be cancelled with parry to dash forwards or backwards.");
initImage_ext(sprite_get("dspecial_ground"), -4, fa_center, 1, 1, true, c_white, 1, false, noone, noone, noone, noone);

initTip("Random Stuff");
initWords("Hold attack during nair to keep on spinning!

You can hitfall the grab of uair for better dragdowns

Charging fstrong or ustrong makes them go farther and last longer
");
initImage_ext(sprite_get("nair"), -5, fa_center, 1, 1, true, c_white, 1, true, 200, 350, 100, 200);
initImage_ext(sprite_get("uair"), -5, fa_center, 1, 1, true, c_white, 1, true, 350, 200, 100, 200);

initTip("Lore?");
initWords("
A lone wanderer, he serves nobody but himself
...
iroh took his tail off in a fight (canon)
");
...
~fair first hit base hitpause 6-5
-prat land time 5-8
-fspecial lag after landing 17-22
-dspecial has 10 more frames of endlag on whiff (15-25)
-fstrong endlag 12-18
-dstrong endlag 12-15
-ustrong endlag 12-16");


initPatch("1.1", "21 January, 2022");
initHeader("Random fixes");
initSection("Taunt no longer uses sandbert sfx (amazing)
Changed waveland sfx to zetter
Some moves have different vfx now

-uair is now techable");


initPatch("1.0", "21 January, 2022");
initHeader("Release!");
initSection("My first character! Wait what? Nova who?");
...
// Steve death message.
steve_death_message = "Steve got spun around";
