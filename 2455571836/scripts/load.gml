sprite_change_offset("glace_hurt_box", 40, 71);
sprite_change_offset("glace_crouch_box", 30, 71);

sprite_change_offset("idle", 37, 72);
sprite_change_offset("hurt", 48, 73);
sprite_change_offset("bighurt", 45, 56);
sprite_change_offset("uphurt", 45, 56);
sprite_change_offset("downhurt", 35, 45);
sprite_change_offset("spinhurt", 37, 71);
sprite_change_offset("bouncehurt", 36, 56);
sprite_change_offset("crouch", 30, 65);
...
sprite_change_offset("jab", 64, 92);
sprite_change_offset("dattack", 44, 72);
sprite_change_offset("ftilt", 39, 72);
sprite_change_offset("dtilt", 30, 65);
sprite_change_offset("dtilt_proj", 0, 32);
sprite_change_offset("utilt", 37, 75);
sprite_change_offset("nair", 71, 99);
sprite_change_offset("fair", 44, 70);
sprite_change_offset("bair", 72, 70);
sprite_change_offset("uair", 90, 132);
sprite_change_offset("dair", 43, 74);
sprite_change_offset("fstrong", 52, 70);
sprite_change_offset("ustrong", 38, 160);
sprite_change_offset("dstrong", 93, 94);
sprite_change_offset("nspecial", 39, 70);
sprite_change_offset("nspecial_air", 39, 70);
sprite_change_offset("nspecial_proj", 8, 15);
sprite_change_offset("fspecial", 42, 64);
...
sprite_change_offset("glacedr", 31, 0); //Danganronpa
sprite_change_offset("glacemv", 60, 30); //Miiverse
sprite_change_offset("sandstar_hurt", 48, 73); //Savannah Area
sprite_change_offset("glace_sliced", 48, 73); //Abyss Hime

sprite_change_offset("glace_amber_doll", 0, 5);
