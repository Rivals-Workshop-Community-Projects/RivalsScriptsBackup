...
with phone{
	...
	initApp(0, 0, "HOME Menu", $91ceee, 0); // uses BGR instead of RGB for... some reason????? wtf gamemaker
...
with phone{
	...
	initAbout("About MunoPhone", "MunoPhone firmware v" + string(firmware) + " Dimpsuu build
	
	by Muno @munomario777
	
	Optimisation Help: Archytas | Beta Testing: Tdude
	
	[More Mods] tinyurl.com/muno-collection
	[Community] discord.gg/yhchvBB
	
	SFX:
	Melty Blood, UNDER NIGHT IN-BIRTH, SEGA Dreamcast"); //SFX: Super Paper Mario  //if you remove the credits i will come to your house and kick down your door
