...
set_hitbox_value(AT_UAIR, 1, HG_WIDTH, 127);
...
set_hitbox_value(AT_UAIR, 1, HG_HITPAUSE_SCALING, 0.65);
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, asset_get("sfx_ori_sein_fstrong_hit"));
