...
set_hitbox_value(AT_DTILT, 1, HG_BASE_HITPAUSE, 20);
...
set_hitbox_value(AT_DTILT, 1, HG_PROJECTILE_MASK, sprite_get("dtilt_proj"));
...
set_hitbox_value(AT_DTILT, 1, HG_PROJECTILE_DESTROY_EFFECT, 0);