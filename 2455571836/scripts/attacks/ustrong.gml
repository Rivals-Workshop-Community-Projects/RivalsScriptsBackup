...
set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_may_whip1"));
...
set_hitbox_value(AT_USTRONG, 1, HG_KNOCKBACK_SCALING, 1.5);
set_hitbox_value(AT_USTRONG, 1, HG_BASE_HITPAUSE, 22);
set_hitbox_value(AT_USTRONG, 1, HG_HITPAUSE_SCALING, 1.1);
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, asset_get("sfx_ori_sein_fstrong_hit"));
