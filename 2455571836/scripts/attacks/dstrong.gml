...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, sound_get("glace_ice_shot"));
...
set_window_value(AT_DSTRONG, 7, AG_WINDOW_ANIM_FRAMES, 9);
...
set_hitbox_value(AT_DSTRONG, 1, HG_BASE_KNOCKBACK, 0.3);
set_hitbox_value(AT_DSTRONG, 1, HG_KNOCKBACK_SCALING, .3);
set_hitbox_value(AT_DSTRONG, 1, HG_FINAL_BASE_KNOCKBACK, 0.4);
...
set_hitbox_value(AT_DSTRONG, 2, HG_BASE_KNOCKBACK, 0.3);
set_hitbox_value(AT_DSTRONG, 2, HG_KNOCKBACK_SCALING, .3);
set_hitbox_value(AT_DSTRONG, 2, HG_FINAL_BASE_KNOCKBACK, 0.4);
set_hitbox_value(AT_DSTRONG, 2, HG_BASE_HITPAUSE, 3);
set_hitbox_value(AT_DSTRONG, 2, HG_HITPAUSE_SCALING, .45);
...
set_hitbox_value(AT_DSTRONG, 3, HG_BASE_KNOCKBACK, 0.3);
set_hitbox_value(AT_DSTRONG, 3, HG_KNOCKBACK_SCALING, .3);
set_hitbox_value(AT_DSTRONG, 3, HG_FINAL_BASE_KNOCKBACK, 0.4);
set_hitbox_value(AT_DSTRONG, 3, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_DSTRONG, 3, HG_HITPAUSE_SCALING, .45);
set_hitbox_value(AT_DSTRONG, 3, HG_EXTRA_HITPAUSE, 5);
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT, 27);
...
set_hitbox_value(AT_DSTRONG, 4, HG_WIDTH, 170);
...
set_hitbox_value(AT_DSTRONG, 4, HG_KNOCKBACK_SCALING, 1.5);
set_hitbox_value(AT_DSTRONG, 4, HG_BASE_HITPAUSE, 20);
set_hitbox_value(AT_DSTRONG, 4, HG_HITPAUSE_SCALING, .75);
set_hitbox_value(AT_DSTRONG, 4, HG_VISUAL_EFFECT, 199);
set_hitbox_value(AT_DSTRONG, 4, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_DSTRONG, 4, HG_HIT_SFX, asset_get("sfx_icehit_heavy2"));
