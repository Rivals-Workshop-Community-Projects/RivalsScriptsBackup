...
set_hitbox_value(AT_USTRONG, 1, HG_WIDTH, 79);
...
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_Y, -127);
...
set_hitbox_value(AT_USTRONG, 4, HG_HITBOX_Y, -165);
...
set_hitbox_value(AT_USTRONG, 5, HG_WINDOW_CREATION_FRAME, 5);
set_hitbox_value(AT_USTRONG, 5, HG_LIFETIME, 6);
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_X, 0);
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_Y, -201);