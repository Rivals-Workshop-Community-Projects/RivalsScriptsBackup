set_attack_value(AT_TAUNT_2, AG_SPRITE, sprite_get("taunt_ballin"));
...
set_window_value(AT_TAUNT_2, 1, AG_WINDOW_SFX, sound_get("bball_sfx"));
set_window_value(AT_TAUNT_2, 1, AG_WINDOW_SFX_FRAME, 24);
...
set_window_value(AT_TAUNT_2, 2, AG_WINDOW_SFX, sound_get("bball_sfx"));
...
set_window_value(AT_TAUNT_2, 3, AG_WINDOW_SFX, sound_get("bball_sfx"));
