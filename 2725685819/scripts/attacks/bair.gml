...
set_window_value(AT_BAIR, 4, AG_WINDOW_SFX, sound_get("saya"));
set_window_value(AT_BAIR, 4, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_BAIR, 4, AG_WINDOW_IASA, -1);
...
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, vfx_slash);
