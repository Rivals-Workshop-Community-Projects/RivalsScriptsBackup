...
set_hitbox_value(AT_FAIR, 1, HG_VISUAL_EFFECT, vfx_stab_strong);
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, sound_get("slicef"));
...
set_hitbox_value(AT_FAIR, 2, HG_VISUAL_EFFECT, vfx_slash_weak);
