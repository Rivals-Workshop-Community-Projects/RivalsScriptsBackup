...
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT, vfx_slash_weak);
...
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT, vfx_slash_weak);
...
set_hitbox_value(AT_DATTACK, 3, HG_VISUAL_EFFECT, vfx_slash_weak);
...
set_hitbox_value(AT_DATTACK, 4, HG_VISUAL_EFFECT, vfx_slash_weak);
set_hitbox_value(AT_DATTACK, 4, HG_ANGLE_FLIPPER, 0);
set_hitbox_value(AT_DATTACK, 4, HG_CHAOS_LEVEL, -1);
set_hitbox_value(AT_DATTACK, 4, HG_HITSTUN_MULTIPLIER, 0.8);
...
set_hitbox_value(AT_DATTACK, 5, HG_VISUAL_EFFECT, vfx_slash_weak);
...
set_hitbox_value(AT_DATTACK, 6, HG_VISUAL_EFFECT, vfx_slash_weak);
...
set_hitbox_value(AT_DATTACK, 7, HG_VISUAL_EFFECT, vfx_slash);
