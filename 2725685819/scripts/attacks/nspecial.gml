...
set_hitbox_value(AT_NSPECIAL, 4, HG_PROJECTILE_DESTROY_EFFECT, jc_destroyed);
...
set_hitbox_value(AT_NSPECIAL, 4, HG_VISUAL_EFFECT, vfx_slash);
set_hitbox_value(AT_NSPECIAL, 4, HG_HIT_SFX, sound_get("slicen"));
set_hitbox_value(AT_NSPECIAL, 4, HG_CHAOS_EXCLUDE, 0);
