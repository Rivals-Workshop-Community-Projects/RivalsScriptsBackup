...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, vfx_slash_med);
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("slicef2"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, vfx_slash_med);
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("slicef2"));
