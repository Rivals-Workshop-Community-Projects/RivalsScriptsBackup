...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, asset_get("sfx_spin_longer"));
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX_FRAME, 5);

set_window_value(AT_DATTACK, 2, AG_WINDOW_TYPE, 1);
set_window_value(AT_DATTACK, 2, AG_WINDOW_LENGTH, 30);
set_window_value(AT_DATTACK, 2, AG_WINDOW_ANIM_FRAMES, 15);
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_ANIM_FRAME_START, 16);
...
set_hitbox_value(AT_DATTACK, 3, HG_WINDOW_CREATION_FRAME, 14);
...
set_hitbox_value(AT_DATTACK, 4, HG_WINDOW_CREATION_FRAME, 20);
set_hitbox_value(AT_DATTACK, 4, HG_WINDOW, 2);
set_hitbox_value(AT_DATTACK, 4, HG_LIFETIME, 2);
set_hitbox_value(AT_DATTACK, 4, HG_HITBOX_X, 12);
set_hitbox_value(AT_DATTACK, 4, HG_HITBOX_Y, -44);
...
set_hitbox_value(AT_DATTACK, 5, HG_WINDOW_CREATION_FRAME, 28);
set_hitbox_value(AT_DATTACK, 5, HG_LIFETIME, 2);
set_hitbox_value(AT_DATTACK, 5, HG_HITBOX_X, 12);
set_hitbox_value(AT_DATTACK, 5, HG_HITBOX_Y, -44);
set_hitbox_value(AT_DATTACK, 5, HG_WIDTH, 55);
...
set_hitbox_value(AT_DATTACK, 5, HG_HIT_SFX, asset_get("sfx_blow_medium2"));
