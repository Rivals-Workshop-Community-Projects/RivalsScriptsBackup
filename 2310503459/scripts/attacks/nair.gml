...
set_window_value(AT_NAIR, 2, AG_WINDOW_LENGTH, 21);
...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, asset_get("sfx_forsburn_reappear_hit"));
...
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, asset_get("sfx_forsburn_reappear_hit"));
...
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, asset_get("sfx_forsburn_reappear_hit"));
...
set_hitbox_value(AT_NAIR, 5, HG_HITBOX_Y, -34);
...
set_hitbox_value(AT_NAIR, 6, HG_WINDOW_CREATION_FRAME, 15);
set_hitbox_value(AT_NAIR, 6, HG_LIFETIME, 4);
set_hitbox_value(AT_NAIR, 6, HG_HITBOX_X, 18);
set_hitbox_value(AT_NAIR, 6, HG_HITBOX_Y, -24);
set_hitbox_value(AT_NAIR, 6, HG_WIDTH, 64);
...
set_hitbox_value(AT_NAIR, 7, HG_HITBOX_Y, -6);
