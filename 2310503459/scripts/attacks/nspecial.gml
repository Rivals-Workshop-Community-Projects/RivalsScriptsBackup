...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_ori_glide_featherout"));
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX_FRAME, 8);
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_VSPEED, -3);
...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_VSPEED, -9);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_ell_dspecial_explosion_2"));
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, bullet_fx_large);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HIT_SFX, asset_get("sfx_ell_dspecial_explosion_2"));
