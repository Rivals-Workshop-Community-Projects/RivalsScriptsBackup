...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_LENGTH, 36);
...
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT, bullet_fx_large);
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT_Y_OFFSET, -40);
set_hitbox_value(AT_USPECIAL, 1, HG_HIT_SFX, asset_get("sfx_ell_dspecial_explosion_1"));
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("explosion"));
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("explosion"));
