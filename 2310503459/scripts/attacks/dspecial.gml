...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, sound_get("laser"));
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_HAS_WHIFFLAG, 16);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HITBOX_X, 330);
set_hitbox_value(AT_DSPECIAL, 1, HG_HITBOX_Y, -13);
set_hitbox_value(AT_DSPECIAL, 1, HG_WIDTH, 584);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_VISUAL_EFFECT, bullet_fx_large);
