...
set_window_value(AT_UAIR, 2, AG_WINDOW_SFX, asset_get("sfx_hod_fspecial"));
...
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, asset_get("sfx_waterhit_medium"));
...
set_hitbox_value(AT_UAIR, 3, HG_HIT_SFX, asset_get("sfx_waterhit_medium"));
...
set_hitbox_value(AT_UAIR, 4, HG_HEIGHT, 110);
...
set_hitbox_value(AT_UAIR, 4, HG_VISUAL_EFFECT, 195);
set_hitbox_value(AT_UAIR, 4, HG_HIT_SFX, asset_get("sfx_waterhit_heavy2"));