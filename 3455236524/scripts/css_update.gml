...
if (cursor_x > voice_button_pos[0] && cursor_x < voice_button_pos[2] && cursor_y > voice_button_pos[1] && cursor_y < voice_button_pos[3] && !instance_exists(oTestPlayer))
{
   ...
   //print(get_synced_var(player))
       ...
       switch(voice_button){
       	case 0:
       	sound_stop(sound_get("funky_yell3"));
       	sound_play(sound_get("funky_okay"));
       	sound_stop(sound_get("uspecial_bongo_left"));
       	sound_play(sound_get("uspecial_bongo_right"));
           voice_button = 1;
           break;
      	case 1:
       	sound_stop(sound_get("funky_okay"));
       	sound_play(sound_get("funky_yell3"));
       	sound_stop(sound_get("uspecial_bongo_right"));
       	sound_play(sound_get("uspecial_bongo_left"));
           voice_button = 0;
           break;           
       }
   }
