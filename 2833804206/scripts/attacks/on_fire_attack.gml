...
set_hitbox_value(AT_EXTRA_1, 1, HG_VISUAL_EFFECT, 148);
set_hitbox_value(AT_EXTRA_1, 1, HG_HIT_SFX, asset_get("sfx_forsburn_combust"));
set_hitbox_value(AT_EXTRA_1, 1, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_EXTRA_1, 1, HG_HITSTUN_MULTIPLIER, 0.75);
