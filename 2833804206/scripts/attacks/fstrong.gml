...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_ell_utilt_retract"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_PRIORITY, 0);
...
set_hitbox_value(AT_FSTRONG, 1, HG_PROJECTILE_SPRITE, sprite_get("fstrong_bb8"));
set_hitbox_value(AT_FSTRONG, 1, HG_PROJECTILE_MASK, sprite_get("fstrong_bb8_hurt"));
set_hitbox_value(AT_FSTRONG, 1, HG_PROJECTILE_ANIM_SPEED, 0.2);
set_hitbox_value(AT_FSTRONG, 1, HG_PROJECTILE_HSPEED, 7);
...
set_hitbox_value(AT_FSTRONG, 2, HG_PROJECTILE_DESTROY_EFFECT, 0);
...
set_hitbox_value(AT_FSTRONG, 3, HG_VISUAL_EFFECT, 148);
...
set_hitbox_value(AT_FSTRONG, 3, HG_PROJECTILE_DESTROY_EFFECT, 0);
