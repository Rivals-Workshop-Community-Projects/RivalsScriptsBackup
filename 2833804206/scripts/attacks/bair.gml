...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, asset_get("sfx_absa_dattack"));
...
set_hitbox_value(AT_BAIR, 1, HG_ANGLE, 180 - 50);
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, asset_get("sfx_absa_orb_hit"));
...
set_hitbox_value(AT_BAIR, 3, HG_ANGLE, 180 - 50);
