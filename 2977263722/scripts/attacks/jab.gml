...
set_attack_value(AT_JAB, AG_MUNO_ATTACK_MISC_ADD, "Ignores parry stun. Attack cancelleable on hit starting frame 16.");
...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("ssb_sword_med"));
set_hitbox_value(AT_JAB, 1, HG_HIT_PARTICLE_NUM, 2);

set_hitbox_value(AT_JAB, 1, HG_MUNO_HITBOX_MISC_ADD, "10 Extra Hitpause (conditional)");