...
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, -60);
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, sound_get("ssb_sword_heavy"));
set_hitbox_value(AT_UAIR, 1, HG_HIT_PARTICLE_NUM, 2);

set_hitbox_value(AT_UAIR, 2, HG_MUNO_HITBOX_NAME, "Sourspot");
...
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, sound_get("ssb_sword_light"));
