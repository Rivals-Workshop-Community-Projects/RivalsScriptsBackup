...
set_hitbox_value(AT_UTILT, 1, HG_HITPAUSE_SCALING, 0.9);
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sound_get("ssb_sword_med2"));
...
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, sound_get("ssb_sword_light"));
