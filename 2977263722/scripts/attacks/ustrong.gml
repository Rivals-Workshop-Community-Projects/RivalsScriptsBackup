...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, funnyhit);
set_hitbox_value(AT_USTRONG, 1, HG_HIT_PARTICLE_NUM, 3);
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("FUNNY CHUCKYA MOVE"));
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("ssb_sword_heavy"));