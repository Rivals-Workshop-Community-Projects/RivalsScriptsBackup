...
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, sound_get("jump2"));
...
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, sound_get("coins_mus"));
set_hitbox_value(AT_UAIR, 1, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT, coin_effect);