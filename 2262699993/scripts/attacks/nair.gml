...
set_attack_value(AT_NAIR, AG_SPRITE, sprite_get("nspecial"));
...
set_attack_value(AT_NAIR, AG_AIR_SPRITE, sprite_get("nspecial_air"));
set_attack_value(AT_NAIR, AG_HURTBOX_SPRITE, sprite_get("nspecial_hurt"));

set_window_value(AT_NAIR, 1, AG_WINDOW_TYPE, 1);
set_window_value(AT_NAIR, 1, AG_WINDOW_LENGTH, 16);
set_window_value(AT_NAIR, 1, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_NAIR, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, sound_get("fireball"));
...
set_hitbox_value(AT_NAIR, 1, HG_LIFETIME, 120);
...
set_hitbox_value(AT_NAIR, 1, HG_PROJECTILE_SPRITE, sprite_get("nspecial_proj"));
set_hitbox_value(AT_NAIR, 1, HG_PROJECTILE_MASK, sprite_get("nspecial_proj"));
set_hitbox_value(AT_NAIR, 1, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_NAIR, 1, HG_PROJECTILE_HSPEED, 6);
set_hitbox_value(AT_NAIR, 1, HG_PROJECTILE_VSPEED, -5);
set_hitbox_value(AT_NAIR, 1, HG_PROJECTILE_GRAVITY, .4);
set_hitbox_value(AT_NAIR, 1, HG_PROJECTILE_GROUND_BEHAVIOR, 2);
set_hitbox_value(AT_NAIR, 1, HG_PROJECTILE_WALL_BEHAVIOR, 2)
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sound_get("fireballhit"));