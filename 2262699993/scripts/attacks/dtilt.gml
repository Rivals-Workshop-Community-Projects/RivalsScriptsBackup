...
set_hitbox_value(AT_DTILT, 2, HG_HITBOX_X, -19);
...
set_hitbox_value(AT_DTILT, 3, HG_HITBOX_X, 19);
...
set_hitbox_value(AT_DTILT, 3, HG_HIT_SFX, sound_get("hit2"));
...
set_hitbox_value(AT_DTILT, 4, HG_WINDOW_CREATION_FRAME, 8);
set_hitbox_value(AT_DTILT, 4, HG_LIFETIME, 3);
set_hitbox_value(AT_DTILT, 4, HG_HITBOX_X, -19);
set_hitbox_value(AT_DTILT, 4, HG_HITBOX_Y, -10);
set_hitbox_value(AT_DTILT, 4, HG_WIDTH, 60);
...
set_hitbox_value(AT_DTILT, 4, HG_HIT_SFX, sound_get("hit2"));