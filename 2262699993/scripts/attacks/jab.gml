...
set_attack_value(AT_JAB, AG_AIR_SPRITE, sprite_get("nspecial_air"));
set_attack_value(AT_JAB, AG_HURTBOX_SPRITE, sprite_get("nspecial_hurt"));

set_window_value(AT_JAB, 1, AG_WINDOW_TYPE, 1);
set_window_value(AT_JAB, 1, AG_WINDOW_LENGTH, 6);
set_window_value(AT_JAB, 1, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_JAB, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, sound_get("fireball"));
...
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_SPRITE, sprite_get("nspecial_proj"));
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_MASK, sprite_get("nspecial_proj"));
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_HSPEED, 6);
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_VSPEED, -5);
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_GRAVITY, .5);
...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("fireballhit"));