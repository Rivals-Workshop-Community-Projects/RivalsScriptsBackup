...
set_window_value(AT_DSTRONG, 5, AG_WINDOW_HAS_WHIFFLAG, 1); // vineboom
...
set_hitbox_value(AT_DSTRONG, 1, HG_ANGLE, 361); // rainbow wanted this
...
set_hitbox_value(AT_DSTRONG, 2, HG_ANGLE, 361); // rainbow wanted this
