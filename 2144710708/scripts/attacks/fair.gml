...
set_window_value(AT_FAIR, 2, AG_WINDOW_VSPEED_TYPE, 0); // base cast moment
...
set_hitbox_value(AT_FAIR, 1, HG_WIDTH, 68); // used to be 65
set_hitbox_value(AT_FAIR, 1, HG_HEIGHT, 84);
set_hitbox_value(AT_FAIR, 1, HG_PRIORITY, 3);
set_hitbox_value(AT_FAIR, 1, HG_DAMAGE, 9);
set_hitbox_value(AT_FAIR, 1, HG_ANGLE, 45); // snolid wanted angle 40, angle 45 was my doing
