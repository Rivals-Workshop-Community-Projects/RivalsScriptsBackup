...
initCodecPage(SPK_PIT,	6,	9,	"Wow, that cat's holding a crowbar.");
initCodecPage(SPK_PIT,	1,	7,	"And standing on two legs...");
initCodecPage(SPK_VIR,	1,	3,	"Come on Pit, that's normal around here!");
initCodecPage(SPK_PALU,	1,	1,	"I couldn't find much data about this fighter.");
initCodecPage(SPK_PALU,	0,	-1,	"There is something about a shoe, though.");
initCodecPage(SPK_PIT,	4,	8,	"Shoes? But she isn't wearing any!");
initCodecPage(SPK_PALU,	2,	5,	"Looks like you'll have to wait and see.");
