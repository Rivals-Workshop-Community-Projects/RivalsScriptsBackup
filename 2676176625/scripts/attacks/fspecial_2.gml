...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HEIGHT, 15);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HIT_SFX, sound_get("hit_frisbee"));
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_PARENT_HITBOX, 1);
set_hitbox_value(AT_FSPECIAL_2, 1, HG_PROJECTILE_SPRITE, sprite_get("disk"));
set_hitbox_value(AT_FSPECIAL_2, 1, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_FSPECIAL_2, 1, HG_PROJECTILE_ANIM_SPEED, 0.1);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_PROJECTILE_GROUND_FRICTION, 0.6);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_PROJECTILE_ENEMY_BEHAVIOR, 2);
...
set_hitbox_value(AT_FSPECIAL_2, 2, HG_WIDTH, 120);
...
set_hitbox_value(AT_FSPECIAL_2, 2, HG_PROJECTILE_ENEMY_BEHAVIOR, 2);
...
set_hitbox_value(AT_FSPECIAL_2, 2, HG_PROJECTILE_SPRITE, sprite_get("poggers"));
set_hitbox_value(AT_FSPECIAL_2, 2, HG_PROJECTILE_MASK, sprite_get("poggers"));
set_hitbox_value(AT_FSPECIAL_2, 2, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_PROJECTILE_DESTROY_EFFECT, 143);
...
set_hitbox_value(AT_FSPECIAL_2, 3, HG_WINDOW, 0);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_LIFETIME, 5);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_WIDTH, 260);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HEIGHT, 260);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_PRIORITY, 1);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_DAMAGE, 2);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_PROJECTILE_ENEMY_BEHAVIOR, 2);
...
set_hitbox_value(AT_FSPECIAL_2, 3, HG_PROJECTILE_SPRITE, sprite_get("poggers"));
set_hitbox_value(AT_FSPECIAL_2, 3, HG_PROJECTILE_MASK, sprite_get("poggers"));
...
set_hitbox_value(AT_FSPECIAL_2, 3, HG_ANGLE_FLIPPER, 8);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_FSPECIAL_2, 3, HG_HIT_LOCKOUT, 20);
