...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, sound_get("slurpy1"));
...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("slurpy2"));
...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_LENGTH, 11);
...
set_hitbox_value(AT_FSTRONG, 1, HG_WIDTH, 43);
set_hitbox_value(AT_FSTRONG, 1, HG_HEIGHT, 81);
set_hitbox_value(AT_FSTRONG, 1, HG_PRIORITY, 3);
set_hitbox_value(AT_FSTRONG, 1, HG_SHAPE, 2);
set_hitbox_value(AT_FSTRONG, 1, HG_DAMAGE, 9);
set_hitbox_value(AT_FSTRONG, 1, HG_ANGLE, 78);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sound_get("hit_smacked"));

set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_FSTRONG, 2, HG_WINDOW, 3);
set_hitbox_value(AT_FSTRONG, 2, HG_LIFETIME, 5);
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_X, 27);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, sound_get("hit_smacked"));
