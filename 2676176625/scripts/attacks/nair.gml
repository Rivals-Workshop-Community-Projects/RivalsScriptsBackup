...
set_hitbox_value(AT_NAIR, 1, HG_LIFETIME, 300);
...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sound_get("hit_smacked"));
...
set_hitbox_value(AT_NAIR, 2, HG_ANGLE, 335);
...
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, sound_get("hit_smacked"));