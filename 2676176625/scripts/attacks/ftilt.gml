...
set_window_value(AT_FTILT, 2, AG_WINDOW_SFX, sound_get("catattack_5"));
...
set_window_value(AT_FTILT, 3, AG_WINDOW_HAS_WHIFFLAG, 6);
...
set_hitbox_value(AT_FTILT, 1, HG_ANGLE, 24);
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, sound_get("hit_smacked"));