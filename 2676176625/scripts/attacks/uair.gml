...
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, sound_get("hit_smacked"));
...
set_hitbox_value(AT_UAIR, 2, HG_WIDTH, 103);
...
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, sound_get("clunk_1"));
