...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, sound_get("spikes"));
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_SFX, sound_get("pain3"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HEIGHT, 59);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_X, 68);
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_Y, -27);
set_hitbox_value(AT_DSTRONG, 2, HG_WIDTH, 52);
set_hitbox_value(AT_DSTRONG, 2, HG_HEIGHT, 59);