set_attack_value(AT_TAUNT_2, AG_SPRITE, sprite_get("taunt_smile"));
...
set_window_value(AT_TAUNT_2, 2, AG_WINDOW_SFX, asset_get("sfx_boss_shine"));
...
//set_window_value(AT_TAUNT_2, 3, AG_WINDOW_SFX, asset_get("sfx_land"));
