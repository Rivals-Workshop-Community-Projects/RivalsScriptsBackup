...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_LENGTH, 10); //Pulling back
...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_LENGTH, 3); //Head going down
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_LENGTH, 8); //Vines
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_LENGTH, 12); //Pulling head back up
...
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_TYPE, 1); //Head slam
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_TYPE, 1); //Front Vine
...
set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_TYPE, 1); //Back Vine
...
set_hitbox_value(AT_DSTRONG, 3, HG_ANGLE, 100);
