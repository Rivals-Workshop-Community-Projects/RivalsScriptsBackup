...
set_window_value(AT_DSTRONG, 5, AG_WINDOW_SFX, asset_get("sfx_ell_strong_attack_explosion"));
...
set_window_value(AT_DSTRONG, 7, AG_WINDOW_CUSTOM_GRAVITY, 1);
...
set_window_value(AT_DSTRONG, 8, AG_WINDOW_ANIM_FRAME_START, 16);
...
set_window_value(AT_DSTRONG, 8, AG_WINDOW_CUSTOM_GRAVITY, 1);
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, 140);
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, asset_get("sfx_ell_uspecial_explode"));
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_LOCKOUT, 10);

set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_DSTRONG, 3, HG_WINDOW, -1);
set_hitbox_value(AT_DSTRONG, 3, HG_LIFETIME, 16);
