...
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, asset_get("sfx_ori_uptilt_single"));
...
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT, hit_sprites[3]);
...
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT, hit_sprites[3]);
