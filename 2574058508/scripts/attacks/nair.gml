...
set_hitbox_value(AT_NAIR, 1, HG_HITSTUN_MULTIPLIER, .55);
set_hitbox_value(AT_NAIR, 1, HG_DRIFT_MULTIPLIER, .5);
...
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_X, -38);
...
set_hitbox_value(AT_NAIR, 2, HG_ANGLE, 55);//70
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT, butterfly_effect);
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, 128);
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, 1);
