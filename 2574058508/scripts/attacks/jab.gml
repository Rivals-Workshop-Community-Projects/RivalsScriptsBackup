...
set_window_value(AT_JAB, 4, AG_WINDOW_SFX_FRAME, 0);
...
set_window_value(AT_JAB, 7, AG_WINDOW_SFX, asset_get("sfx_clairen_swing_weak"));
...
set_window_value(AT_JAB, 9, AG_WINDOW_HAS_WHIFFLAG, 0); //NOTE: if you make it a multi-hit jab, remove whifflag, since Rivals multi-step jabs do not have whifflag. single-hits like sandbert, elli, etc DO have whifflag
...
set_hitbox_value(AT_JAB, 1, HG_HITSTUN_MULTIPLIER, .95);
...
set_hitbox_value(AT_JAB, 2, HG_HITSTUN_MULTIPLIER, .95);
...
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, asset_get("sfx_holy_lightning"));
