...
set_hitbox_value(AT_FTILT, 2, HG_HITBOX_X, 66);
...
set_hitbox_value(AT_FTILT, 2, HG_ANGLE, 180);
...
set_hitbox_value(AT_FTILT, 2, HG_HITSTUN_MULTIPLIER, .45);
...
set_hitbox_value(AT_FTILT, 3, HG_KNOCKBACK_SCALING, .45);
...
set_hitbox_value(AT_FTILT, 4, HG_HITBOX_Y, -24);
set_hitbox_value(AT_FTILT, 4, HG_HITBOX_X, 66);
set_hitbox_value(AT_FTILT, 4, HG_WIDTH, 130);
set_hitbox_value(AT_FTILT, 4, HG_HEIGHT, 46);
set_hitbox_value(AT_FTILT, 4, HG_SHAPE, 2);
set_hitbox_value(AT_FTILT, 4, HG_PRIORITY, 1);
set_hitbox_value(AT_FTILT, 4, HG_DAMAGE, 6);
set_hitbox_value(AT_FTILT, 4, HG_ANGLE, 170);
...
set_hitbox_value(AT_FTILT, 4, HG_DRIFT_MULTIPLIER, .5);
