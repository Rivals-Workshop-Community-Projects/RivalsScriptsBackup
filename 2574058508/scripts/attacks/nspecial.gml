...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_ANIM_FRAMES, 3); //Startup
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, asset_get("mfx_timertick_holy2"));
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX_FRAME, 4);

set_window_value(AT_NSPECIAL, 2, AG_WINDOW_LENGTH, 3);      //Jumping and spawing block
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_ANIM_FRAME_START, 3);
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, asset_get("mfx_timertick_holy"));
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_VSPEED, -1);
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_VSPEED_TYPE, 2);
    
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_LENGTH, 16);     //Back to idle
...
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, block_effect);
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT_X_OFFSET, 128);
