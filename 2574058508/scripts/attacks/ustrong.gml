...
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_Y, -19);
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_X, -44);
...
set_hitbox_value(AT_USTRONG, 4, HG_WIDTH, 87);
set_hitbox_value(AT_USTRONG, 4, HG_HEIGHT, 78);
...
set_hitbox_value(AT_USTRONG, 4, HG_VISUAL_EFFECT, butterfly_effect);
set_hitbox_value(AT_USTRONG, 4, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_USTRONG, 4, HG_KNOCKBACK_SCALING, 1.15);//1.2
