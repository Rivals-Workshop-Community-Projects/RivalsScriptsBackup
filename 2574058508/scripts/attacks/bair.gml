...
set_window_value(AT_BAIR, 1, AG_WINDOW_CUSTOM_GRAVITY, .9);

set_window_value(AT_BAIR, 2, AG_WINDOW_LENGTH, 2);
set_window_value(AT_BAIR, 2, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_BAIR, 2, AG_WINDOW_ANIM_FRAME_START, 3);
set_window_value(AT_BAIR, 2, AG_WINDOW_CUSTOM_GRAVITY, .9);
...
set_window_value(AT_BAIR, 3, AG_WINDOW_CUSTOM_GRAVITY, .9);
...
set_window_value(AT_BAIR, 4, AG_WINDOW_CUSTOM_GRAVITY, .9);
...
set_window_value(AT_BAIR, 5, AG_WINDOW_SFX, asset_get("sfx_may_arc_five"));
set_window_value(AT_BAIR, 5, AG_WINDOW_SFX_FRAME, 3);
set_window_value(AT_BAIR, 5, AG_WINDOW_CUSTOM_GRAVITY, .9);
...
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_Y, -29);
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 92);
...
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, butterfly_effect);
...
set_hitbox_value(AT_BAIR, 1, HG_FORCE_FLINCH, 1);
...
set_hitbox_value(AT_BAIR, 2, HG_WIDTH, 92);
...
set_hitbox_value(AT_BAIR, 3, HG_WIDTH, 41);
