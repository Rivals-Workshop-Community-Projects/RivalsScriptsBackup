...
set_attack_value(AT_FSTRONG, AG_CATEGORY, 0);//2
set_attack_value(AT_FSTRONG, AG_OFF_LEDGE, 0);//1
...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("fstrong_leap"));
...
set_window_value(AT_FSTRONG, 6, AG_WINDOW_ANIM_FRAME_START, 17);
...
set_hitbox_value(AT_FSTRONG, 1, HG_WIDTH, 84);//84
set_hitbox_value(AT_FSTRONG, 1, HG_HEIGHT, 60);//70
...
set_hitbox_value(AT_FSTRONG, 2, HG_ANGLE, 0);
...
set_hitbox_value(AT_FSTRONG, 4, HG_LIFETIME, 99);
set_hitbox_value(AT_FSTRONG, 4, HG_HITBOX_X, 12);
...
set_hitbox_value(AT_FSTRONG, 4, HG_ANGLE, 280);
