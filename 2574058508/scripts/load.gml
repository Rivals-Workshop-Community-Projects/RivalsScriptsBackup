...
sprite_change_offset("utilt", 130, 190);
...
sprite_change_offset("uspecial_teleport", 128, 190);
sprite_change_offset("dspecial", 128, 190);
sprite_change_offset("dspecial_hit", 128, 870);
sprite_change_offset("taunt", 128, 190);
sprite_change_offset("phone_open", 128, 190);
...
sprite_change_offset("butterfly_transition", 104, 142);
sprite_change_offset("butterfly_idle", 123, 142);
sprite_change_offset("butterfly_teleport", 123, 142);
sprite_change_offset("butterfly_active", 123, 142);
sprite_change_offset("butterfly_destroy", 123, 142);

//effects
sprite_change_offset("block_fx", 175, 136);
sprite_change_offset("butterfly_fx", 110, 136);