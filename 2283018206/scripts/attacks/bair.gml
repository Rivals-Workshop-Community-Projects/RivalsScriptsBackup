...
set_window_value(AT_BAIR, 1, AG_WINDOW_LENGTH, 12); // 15
...
set_window_value(AT_BAIR, 3, AG_WINDOW_LENGTH, 12); // 16
...
set_hitbox_value(AT_BAIR, 1, HG_DAMAGE, 8); // 9
set_hitbox_value(AT_BAIR, 1, HG_ANGLE, 135);
set_hitbox_value(AT_BAIR, 1, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_BAIR, 1, HG_FINAL_BASE_KNOCKBACK, 6); // 5
...
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, vfx_hit_med);
...
set_window_value(AT_BAIR, 1, AG_WINDOW_TYPE, 1);
set_window_value(AT_BAIR, 1, AG_WINDOW_LENGTH, 6); // 7
set_window_value(AT_BAIR, 1, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_BAIR, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, asset_get("sfx_shovel_swing_light1"));
...
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_X, -20); // -24
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_Y, -48);
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 72); // 64
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 64);
set_hitbox_value(AT_BAIR, 1, HG_PRIORITY, 2);
set_hitbox_value(AT_BAIR, 1, HG_DAMAGE, 5);
set_hitbox_value(AT_BAIR, 1, HG_ANGLE, 80);
set_hitbox_value(AT_BAIR, 1, HG_ANGLE_FLIPPER, 3); // 0
set_hitbox_value(AT_BAIR, 1, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_BAIR, 1, HG_KNOCKBACK_SCALING, .4); // 5
set_hitbox_value(AT_BAIR, 1, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_BAIR, 1, HG_HITPAUSE_SCALING, .4);
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, asset_get("sfx_blow_medium2"));
set_hitbox_value(AT_BAIR, 1, HG_MUNO_OBJECT_LAUNCH_ANGLE, 135);