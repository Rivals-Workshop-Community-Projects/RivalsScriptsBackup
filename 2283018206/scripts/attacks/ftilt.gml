...
set_window_value(AT_FTILT, 1, AG_WINDOW_LENGTH, 9); // 12
...
// set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT, vfx_hit_med);
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, asset_get("sfx_blow_medium1"));
set_hitbox_value(AT_FTILT, 1, HG_MUNO_OBJECT_LAUNCH_ANGLE, 360);