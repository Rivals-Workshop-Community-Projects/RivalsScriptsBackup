...
set_window_value(AT_DATTACK, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, fric);
set_window_value(AT_DATTACK, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, fric);
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, fric);
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, fric);
...
set_window_value(AT_DATTACK, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, fric);
set_window_value(AT_DATTACK, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, fric * 0.5);
...
set_hitbox_value(AT_DATTACK, 2, HG_MUNO_OBJECT_LAUNCH_ANGLE, 360);
...
Canceling explained:
- Hold jump to cancel into a super-high jump
- Hold attack to redirect its speed sideways
- No airdodge immediately after jumping