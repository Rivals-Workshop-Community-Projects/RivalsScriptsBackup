...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sound_get("flip"));
...
set_window_value(AT_DAIR, 4, AG_WINDOW_LENGTH, 53);
...
set_window_value(AT_DAIR, 4, AG_WINDOW_VSPEED, 14);
...
set_window_value(AT_DAIR, 5, AG_WINDOW_SFX, sound_get("groundpound"));
