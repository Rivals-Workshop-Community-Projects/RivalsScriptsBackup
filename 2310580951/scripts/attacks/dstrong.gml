...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_blink_dash"));
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_HSPEED, 26);
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, .25);
...
set_window_value(AT_DSTRONG, 5, AG_WINDOW_HSPEED, -36);
...
set_window_value(AT_DSTRONG, 6, AG_WINDOW_CUSTOM_GROUND_FRICTION, .25);
...
set_window_value(AT_DSTRONG, 7, AG_WINDOW_HSPEED, 10);
...
set_hitbox_value(AT_DSTRONG, 2, HG_WIDTH, 76);
