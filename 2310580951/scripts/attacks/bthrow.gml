...
set_window_value(AT_NTHROW, 4, AG_WINDOW_LENGTH, 6);
...
set_window_value(AT_NTHROW, 6, AG_WINDOW_LENGTH, 6);
...
set_window_value(AT_NTHROW, 7, AG_WINDOW_LENGTH, 6);
...
//recovery
set_window_value(AT_NTHROW, 9, AG_WINDOW_LENGTH, 11);
...
set_window_value(AT_NTHROW, 9, AG_WINDOW_HAS_WHIFFLAG, 1);

set_window_value(AT_NTHROW, 10, AG_WINDOW_LENGTH, 12);
set_window_value(AT_NTHROW, 10, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_NTHROW, 10, AG_WINDOW_ANIM_FRAME_START, 19);
set_window_value(AT_NTHROW, 10, AG_WINDOW_HAS_WHIFFLAG, 1);
...
set_hitbox_value(AT_NTHROW, 1, HG_HITSTUN_MULTIPLIER, .9);
