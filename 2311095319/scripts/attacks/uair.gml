...
set_hitbox_value(AT_UAIR, 1, HG_BASE_KNOCKBACK, uairBKB);
set_hitbox_value(AT_UAIR, 1, HG_KNOCKBACK_SCALING, uairKBS);
set_hitbox_value(AT_UAIR, 1, HG_BASE_HITPAUSE, uairBHP);
set_hitbox_value(AT_UAIR, 1, HG_HITPAUSE_SCALING, uairHPS);
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, 10);
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, -6);
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, asset_get("sfx_blow_medium1"));
set_hitbox_value(AT_UAIR, 1, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_UAIR, 1, HG_HITSTUN_MULTIPLIER, uairHitstunMult);
...
set_hitbox_value(AT_UAIR, 2, HG_BASE_KNOCKBACK, uairBKB);
set_hitbox_value(AT_UAIR, 2, HG_KNOCKBACK_SCALING, uairKBS);
set_hitbox_value(AT_UAIR, 2, HG_BASE_HITPAUSE, uairBHP);
set_hitbox_value(AT_UAIR, 2, HG_HITPAUSE_SCALING, uairHPS);
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, 10);
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, -6);
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, asset_get("sfx_blow_medium1"));
set_hitbox_value(AT_UAIR, 2, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_UAIR, 2, HG_HITSTUN_MULTIPLIER, uairHitstunMult);
...
set_hitbox_value(AT_UAIR, 3, HG_BASE_KNOCKBACK, uairBKB);
set_hitbox_value(AT_UAIR, 3, HG_KNOCKBACK_SCALING, uairKBS);
set_hitbox_value(AT_UAIR, 3, HG_BASE_HITPAUSE, uairBHP);
set_hitbox_value(AT_UAIR, 3, HG_HITPAUSE_SCALING, uairHPS);
set_hitbox_value(AT_UAIR, 3, HG_VISUAL_EFFECT_X_OFFSET, 10);
set_hitbox_value(AT_UAIR, 3, HG_VISUAL_EFFECT_Y_OFFSET, -6);
set_hitbox_value(AT_UAIR, 3, HG_HIT_SFX, asset_get("sfx_blow_medium1"));
set_hitbox_value(AT_UAIR, 3, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_UAIR, 3, HG_HITSTUN_MULTIPLIER, uairHitstunMult);