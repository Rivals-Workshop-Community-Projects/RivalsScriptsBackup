...
set_hitbox_value(AT_NSPECIAL, 7, HG_PROJECTILE_DESTROY_EFFECT, fireball_normal_explode);
set_hitbox_value(AT_NSPECIAL, 7, HG_VISUAL_EFFECT, fireball_normal_explode);
...
set_hitbox_value(AT_NSPECIAL, 9, HG_HITSTUN_MULTIPLIER, 0.7);
...
set_hitbox_value(AT_NSPECIAL, 9, HG_PROJECTILE_DESTROY_EFFECT, fireball_normal_explode);
set_hitbox_value(AT_NSPECIAL, 9, HG_VISUAL_EFFECT, fireball_normal_explode);
