...
set_attack_value(AT_FSPECIAL, AG_SPRITE, sprite_get("dive"));
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_SFX, sfx_landing_lag);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HITBOX_Y, -19);
