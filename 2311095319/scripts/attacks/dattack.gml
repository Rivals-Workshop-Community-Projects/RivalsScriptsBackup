...
set_attack_value(AT_DATTACK, AG_MUNO_ATTACK_NAME, "DAttack: Slide");
set_attack_value(AT_DATTACK, AG_MUNO_ATTACK_MISC_ADD, "Can go off ledges.");
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .12);
...
set_hitbox_value(AT_DATTACK, 1, HG_HEIGHT, 22);
