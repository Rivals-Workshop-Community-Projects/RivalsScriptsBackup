set_attack_value(AT_PHONE, AG_SPRITE, sprite_get("munophone_open"));
...
set_attack_value(AT_PHONE, AG_HURTBOX_SPRITE, sprite_get("munophone_open"));
...
set_window_value(AT_PHONE, 1, AG_WINDOW_LENGTH, 8);
