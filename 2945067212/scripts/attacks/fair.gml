...
set_window_value(AT_FAIR, 3, AG_WINDOW_LENGTH, 10);//6
...
set_hitbox_value(AT_FAIR, 1, HG_HITBOX_X, 39);//30
...
set_hitbox_value(AT_FAIR, 1, HG_BASE_KNOCKBACK, 5);//6
set_hitbox_value(AT_FAIR, 1, HG_KNOCKBACK_SCALING, .8);//.6
...
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, asset_get("sfx_birdclap"));//sfx_infinidagger
