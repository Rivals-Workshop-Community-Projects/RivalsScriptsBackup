...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, asset_get("sfx_absa_new_whip2"));
...
set_hitbox_value(AT_DAIR, 3, HG_VISUAL_EFFECT, 150);
*/
...
set_hitbox_value(AT_DAIR, 1, HG_HEIGHT, 29);
