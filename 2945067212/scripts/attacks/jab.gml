...
set_window_value(AT_JAB, 7, AG_WINDOW_LENGTH, 8);			//CHANGE STARTUP HERE
set_window_value(AT_JAB, 7, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_JAB, 7, AG_WINDOW_ANIM_FRAME_START, 9);
set_window_value(AT_JAB, 7, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_JAB, 7, AG_WINDOW_SFX, asset_get("sfx_ori_sein_fstrong"));
set_window_value(AT_JAB, 7, AG_WINDOW_SFX_FRAME, 5);
//set_window_value(AT_JAB, 7, AG_WINDOW_HSPEED, 4);	
set_window_value(AT_JAB, 7, AG_WINDOW_HSPEED_TYPE, 2);//CHANGE HORIZONTAL BOOST HERE

//ACTIVE FRAMES FOR JAB 3
set_window_value(AT_JAB, 8, AG_WINDOW_TYPE, 1);
set_window_value(AT_JAB, 8, AG_WINDOW_LENGTH, 5);			//CHANGE ACTIVE FRAMES HERE, THEY ALSO NEED TO BE CHANGED BELOW
...
set_window_value(AT_JAB, 8, AG_WINDOW_HSPEED_TYPE, 2);//CHANGE HORIZONTAL BOOST HERE

//ENDLAG FOR JAB 3
set_window_value(AT_JAB, 9, AG_WINDOW_TYPE, 1);
set_window_value(AT_JAB, 9, AG_WINDOW_LENGTH, 12);			//CHANGE ENDLAG HERE
