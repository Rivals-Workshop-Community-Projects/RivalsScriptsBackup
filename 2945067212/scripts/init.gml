...
mario_cap_top_compat = sprite_get("cappytaunt")
//intro
introTimer = -4;
introTimer2 = 0;
...
ghost1 = hit_fx_create( sprite_get( "ghost1" ), 20 );
ghost2 = hit_fx_create( sprite_get( "ghost2" ), 20 );
ghost3 = hit_fx_create( sprite_get( "ghost3" ), 20 );
