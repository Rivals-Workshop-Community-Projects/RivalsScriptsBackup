...
// set_window_value(AT_EXTRA_2, 1, AG_WINDOW_LENGTH, 364);
// set_window_value(AT_EXTRA_2, 1, AG_WINDOW_ANIM_FRAMES, 52);
// set_window_value(AT_EXTRA_2, 1, AG_WINDOW_HAS_SFX, 0);//1
...
set_window_value(AT_EXTRA_2, 2, AG_WINDOW_ANIM_FRAME_START, 20);

set_window_value(AT_EXTRA_2, 3, AG_WINDOW_TYPE, 1);
set_window_value(AT_EXTRA_2, 3, AG_WINDOW_LENGTH, 224);
set_window_value(AT_EXTRA_2, 3, AG_WINDOW_ANIM_FRAMES, 32);
...
set_hitbox_value(AT_EXTRA_2, 1, HG_WINDOW_CREATION_FRAME, 28);
set_hitbox_value(AT_EXTRA_2, 1, HG_LIFETIME, 4);
set_hitbox_value(AT_EXTRA_2, 1, HG_HITBOX_X, 15);
set_hitbox_value(AT_EXTRA_2, 1, HG_HITBOX_Y, -48);
...
set_hitbox_value(AT_EXTRA_2, 1, HG_EXTRA_HITPAUSE, 133);
set_hitbox_value(AT_EXTRA_2, 1, HG_VISUAL_EFFECT, 20);
set_hitbox_value(AT_EXTRA_2, 1, HG_HIT_SFX, asset_get("sfx_absa_kickhit"));
...
set_hitbox_value(AT_EXTRA_2, 2, HG_WINDOW_CREATION_FRAME, 133);
set_hitbox_value(AT_EXTRA_2, 2, HG_LIFETIME, 4);
set_hitbox_value(AT_EXTRA_2, 2, HG_HITBOX_X, 15);
set_hitbox_value(AT_EXTRA_2, 2, HG_HITBOX_Y, -48);
...
set_hitbox_value(AT_EXTRA_2, 2, HG_VISUAL_EFFECT, 197);
set_hitbox_value(AT_EXTRA_2, 2, HG_HIT_SFX, asset_get("sfx_absa_kickhit"));
set_hitbox_value(AT_EXTRA_2, 2, HG_HITBOX_GROUP, -1);

if(has_rune("G")){
    set_hitbox_value(AT_EXTRA_2, 1, HG_WIDTH, 399);
    set_hitbox_value(AT_EXTRA_2, 1, HG_HEIGHT, 399);
}

if(has_rune("G")){
    set_hitbox_value(AT_EXTRA_2, 2, HG_WIDTH, 9999);
    set_hitbox_value(AT_EXTRA_2, 2, HG_HEIGHT, 9999);
}