...
set_attack_value(AT_EXTRA_1, AG_SPRITE, sprite_get("dthrow"));
set_attack_value(AT_EXTRA_1, AG_NUM_WINDOWS, 5);
set_attack_value(AT_EXTRA_1, AG_AIR_SPRITE, sprite_get("dthrow"));
set_attack_value(AT_EXTRA_1, AG_HURTBOX_SPRITE, sprite_get("dthrow_hurt"));
...
set_window_value(AT_EXTRA_1, 3, AG_WINDOW_SFX_FRAME, 11);
set_window_value(AT_EXTRA_1, 3, AG_WINDOW_SFX, asset_get("sfx_zetter_downb"));
...
set_window_value(AT_EXTRA_1, 4, AG_WINDOW_ANIM_FRAME_START, 7);
...
set_window_value(AT_EXTRA_1, 5, AG_WINDOW_VSPEED_TYPE, 2);
set_window_value(AT_EXTRA_1, 5, AG_WINDOW_VSPEED, -10);
...
set_hitbox_value(AT_EXTRA_1, 1, HG_HITBOX_Y, -36);
set_hitbox_value(AT_EXTRA_1, 1, HG_WIDTH, 30);
set_hitbox_value(AT_EXTRA_1, 1, HG_HEIGHT, 66);
set_hitbox_value(AT_EXTRA_1, 1, HG_PRIORITY, 2);
set_hitbox_value(AT_EXTRA_1, 1, HG_DAMAGE, 2);
set_hitbox_value(AT_EXTRA_1, 1, HG_ANGLE, 105);
...
set_hitbox_value(AT_EXTRA_1, 1, HG_DRIFT_MULTIPLIER, .01);
set_hitbox_value(AT_EXTRA_1, 1, HG_SDI_MULTIPLIER, .01);
...
set_hitbox_value(AT_EXTRA_1, 2, HG_ANGLE, 270);
...
if(has_rune("N")){
    ...
    set_hitbox_value(AT_EXTRA_1, 2, HG_TECHABLE, 3);
    set_hitbox_value(AT_EXTRA_1, 2, HG_EFFECT, 15);
    set_hitbox_value(AT_EXTRA_1, 2, HG_DAMAGE, 18);
}