...
set_hitbox_value(AT_NAIR, 2, HG_HEIGHT, 108);
...
set_hitbox_value(AT_NAIR, 3, HG_HITBOX_Y, 3);
...
set_hitbox_value(AT_NAIR, 4, HG_HITBOX_X, -36);
set_hitbox_value(AT_NAIR, 4, HG_HITBOX_Y, -50);
set_hitbox_value(AT_NAIR, 4, HG_WIDTH, 90);
set_hitbox_value(AT_NAIR, 4, HG_HEIGHT, 126);
