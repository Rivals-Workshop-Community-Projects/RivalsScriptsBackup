...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("sfx_swing_m"));
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_SFX, sound_get("sfx_swing_m"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_X, 63);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("sfx_attack_m"));
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_DSTRONG, 1, HG_EFFECT, 100);
...
set_hitbox_value(AT_DSTRONG, 2, HG_ANGLE, 125);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("sfx_attack_m"));
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_DSTRONG, 2, HG_EFFECT, 100);