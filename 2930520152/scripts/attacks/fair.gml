...
set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, sound_get("sfx_swing_l"));
...
set_hitbox_value(AT_FAIR, 1, HG_HITBOX_Y, -94);
...
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, sound_get("sfx_attack_m"));
set_hitbox_value(AT_FAIR, 1, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_FAIR, 1, HG_EFFECT, 100);
...
set_hitbox_value(AT_FAIR, 2, HG_HEIGHT, 102);
...
set_hitbox_value(AT_FAIR, 2, HG_HIT_SFX, sound_get("sfx_attack_m"));
set_hitbox_value(AT_FAIR, 2, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_FAIR, 2, HG_EFFECT, 100);
...
set_hitbox_value(AT_FAIR, 3, HG_HIT_SFX, sound_get("sfx_attack_m"));
set_hitbox_value(AT_FAIR, 3, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_FAIR, 3, HG_EFFECT, 100);