...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("nspecial"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_ori_charged_flame_hit"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HITBOX_Y, -64);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("food1"));
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_GRAVITY, .3);
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_DESTROY_EFFECT, food_kill);