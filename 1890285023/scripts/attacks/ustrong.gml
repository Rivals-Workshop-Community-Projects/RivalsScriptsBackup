...
set_window_value(AT_USTRONG, 1, AG_WINDOW_SFX, sound_get("smash"));
...
set_window_value(AT_USTRONG, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .25);
...
set_hitbox_value(AT_USTRONG, 1, HG_HITPAUSE_SCALING, 1.6);
