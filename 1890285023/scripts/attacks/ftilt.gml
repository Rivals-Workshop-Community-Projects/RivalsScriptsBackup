...
set_hitbox_value(AT_FTILT, 4, HG_LIFETIME, 9);
set_hitbox_value(AT_FTILT, 4, HG_HITBOX_X, 58);
set_hitbox_value(AT_FTILT, 4, HG_HITBOX_Y, -30);
set_hitbox_value(AT_FTILT, 4, HG_WIDTH, 38);
...
set_hitbox_value(AT_FTILT, 4, HG_HITPAUSE_SCALING, .4);
