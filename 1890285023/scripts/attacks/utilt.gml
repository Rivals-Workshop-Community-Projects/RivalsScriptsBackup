...
set_hitbox_value(AT_UTILT, 1, HG_ANGLE, 170);
...
set_hitbox_value(AT_UTILT, 3, HG_ANGLE, 140);
...
set_hitbox_value(AT_UTILT, 5, HG_HITBOX_X, -56);
...
set_hitbox_value(AT_UTILT, 5, HG_KNOCKBACK_SCALING, .6);
