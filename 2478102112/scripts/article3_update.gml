...
if pick_timer >= 10{
	print_debug("lizard");
	with (pHitBox){
	    if (place_meeting(x,y,other.id) and id != other.hbox and type != 2){
...
if (state == 0){
	...
	if state_timer == 0 and obj_article1.stability == 0{
		itemnum = random_func( 0, 8, true );
	}
	if state_timer == 0 and obj_article1.stability == 1{
		itemnum = random_func( 0, 12, true );
	}
