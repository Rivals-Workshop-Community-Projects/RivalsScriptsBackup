...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX, sound_get("DanceTime"));
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, .25);
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, .25);
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, .5);
...
set_window_value(AT_DSPECIAL, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, .5);
...
set_window_value(AT_DSPECIAL, 7, AG_WINDOW_CUSTOM_AIR_FRICTION, .25);
set_window_value(AT_DSPECIAL, 7, AG_WINDOW_CUSTOM_GROUND_FRICTION, .5);

set_window_value(AT_DSPECIAL, 8, AG_WINDOW_TYPE, 1);
set_window_value(AT_DSPECIAL, 8, AG_WINDOW_LENGTH, 24);
...
set_window_value(AT_DSPECIAL, 8, AG_WINDOW_CUSTOM_AIR_FRICTION, .25);
...
set_window_value(AT_DSPECIAL, 9, AG_WINDOW_ANIM_FRAME_START, 8);
set_window_value(AT_DSPECIAL, 9, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_DSPECIAL, 9, AG_WINDOW_CUSTOM_AIR_FRICTION, .25);
set_window_value(AT_DSPECIAL, 9, AG_WINDOW_CUSTOM_GROUND_FRICTION, .5);
...
set_window_value(AT_DSPECIAL, 10, AG_WINDOW_CUSTOM_AIR_FRICTION, .25);
set_window_value(AT_DSPECIAL, 10, AG_WINDOW_CUSTOM_GROUND_FRICTION, .5);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_ice_sleep"));
...
set_hitbox_value(AT_DSPECIAL, 3, HG_PARENT_HITBOX, 3);//crystal
...
set_hitbox_value(AT_DSPECIAL, 3, HG_VISUAL_EFFECT, asset_get("eHfx.oly_crystalize_end"));
...
set_hitbox_value(AT_DSPECIAL, 3, HG_PROJECTILE_LIFESPAN, 2);
...
set_hitbox_value(AT_DSPECIAL, 4, HG_WIDTH, 96);
set_hitbox_value(AT_DSPECIAL, 4, HG_HEIGHT, 96);
...
set_hitbox_value(AT_DSPECIAL, 5, HG_LIFETIME, 20);
set_hitbox_value(AT_DSPECIAL, 5, HG_HITBOX_Y, -32);
set_hitbox_value(AT_DSPECIAL, 5, HG_WIDTH, 128);
set_hitbox_value(AT_DSPECIAL, 5, HG_HEIGHT, 128);
...
set_hitbox_value(AT_DSPECIAL, 6, HG_PARENT_HITBOX, 1);//3 actually
set_hitbox_value(AT_DSPECIAL, 6, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_DSPECIAL, 6, HG_WINDOW, 5);
set_hitbox_value(AT_DSPECIAL, 6, HG_LIFETIME, 20);
set_hitbox_value(AT_DSPECIAL, 6, HG_HITBOX_Y, -32);
set_hitbox_value(AT_DSPECIAL, 6, HG_WIDTH, 64);
set_hitbox_value(AT_DSPECIAL, 6, HG_HEIGHT, 64);
set_hitbox_value(AT_DSPECIAL, 6, HG_PRIORITY, 2);
set_hitbox_value(AT_DSPECIAL, 6, HG_DAMAGE, 0);
