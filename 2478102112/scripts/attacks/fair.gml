...
set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, asset_get("sfx_ell_steam_hit"));
...
set_window_value(AT_FAIR, 2, AG_WINDOW_SFX, asset_get("sfx_ell_steam_hit"));
...
set_hitbox_value(AT_FAIR, 4, HG_HITBOX_Y, -84);
