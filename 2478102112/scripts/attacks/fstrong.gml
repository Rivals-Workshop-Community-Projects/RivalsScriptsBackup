...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_leafy_hit3"));
...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_may_whip1"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_HITPAUSE_SCALING, .25);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HITPAUSE_SCALING, .25);
set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT, 143);
