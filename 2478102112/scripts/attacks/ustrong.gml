...
set_attack_value(AT_USTRONG, AG_HAS_LANDING_LAG, 10);
...
set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX, sound_get("UstrongRelease"));
...
set_window_value(AT_USTRONG, 4, AG_WINDOW_CUSTOM_GRAVITY, 0);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, confetti);
