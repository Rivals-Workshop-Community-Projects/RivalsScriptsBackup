...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("UtiltHorn"));
...
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, 9);
set_hitbox_value(AT_UTILT, 2, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, sound_get("PinatCrunch"));
...
set_hitbox_value(AT_UTILT, 3, HG_VISUAL_EFFECT, 9);
set_hitbox_value(AT_UTILT, 3, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_UTILT, 3, HG_HIT_SFX, sound_get("PinatCrunch"));
...
set_hitbox_value(AT_UTILT, 4, HG_HITBOX_Y, -100);
...
set_hitbox_value(AT_UTILT, 4, HG_VISUAL_EFFECT, 9);
set_hitbox_value(AT_UTILT, 4, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_UTILT, 4, HG_HIT_SFX, sound_get("PinatCrunch"));
...
set_hitbox_value(AT_UTILT, 5, HG_VISUAL_EFFECT, 6);
set_hitbox_value(AT_UTILT, 5, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_UTILT, 5, HG_HIT_SFX, asset_get("sfx_ell_steam_hit"));
