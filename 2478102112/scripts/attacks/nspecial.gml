...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, .8);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_WIDTH, 4);
set_hitbox_value(AT_NSPECIAL, 1, HG_HEIGHT, 4);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, confetti);
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_321"));
