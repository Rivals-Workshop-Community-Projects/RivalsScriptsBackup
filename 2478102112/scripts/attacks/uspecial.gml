...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_springgo"));
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_VSPEED, -15.6);
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_frog_dspecial_cast"));
...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, .10);
...
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT, confetti);
...
set_hitbox_value(AT_USPECIAL, 2, HG_VISUAL_EFFECT, confetti);
