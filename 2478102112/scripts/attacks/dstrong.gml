...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, .95);
set_window_value(AT_DSTRONG, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_waveland_may"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 168);
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, confetti_diag);
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, confetti_diag);
