...
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX, asset_get("sfx_ori_dtilt_perform"));
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX_FRAME, 10);
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_SFX, asset_get("sfx_land"));
