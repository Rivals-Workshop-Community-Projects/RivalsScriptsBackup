...
set_attack_value(AT_UTHROW, AG_SPRITE, sprite_get("dspecial"));
set_attack_value(AT_UTHROW, AG_NUM_WINDOWS, 3);
set_attack_value(AT_UTHROW, AG_HAS_LANDING_LAG, 5);
set_attack_value(AT_UTHROW, AG_AIR_SPRITE, sprite_get("dspecial"));
set_attack_value(AT_UTHROW, AG_HURTBOX_SPRITE, sprite_get("dspecial_hurt"));
...
set_window_value(AT_UTHROW, 1, AG_WINDOW_SFX, asset_get("sfx_forsburn_cape_swipe"));
set_window_value(AT_UTHROW, 1, AG_WINDOW_ANIM_FRAME_START, 22);
...
set_window_value(AT_UTHROW, 2, AG_WINDOW_ANIM_FRAME_START, 25);
...
set_hitbox_value(AT_UTHROW, 1, HG_BASE_KNOCKBACK, 3);
...
set_hitbox_value(AT_UTHROW, 1, HG_PROJECTILE_SPRITE, sprite_get("smokebomb_proj"));
set_hitbox_value(AT_UTHROW, 1, HG_PROJECTILE_MASK, sprite_get("blank_sheet"));
...
set_hitbox_value(AT_UTHROW, 1, HG_PROJECTILE_DESTROY_EFFECT, 13);
...
set_hitbox_value(AT_UTHROW, 1, HG_FORCE_FLINCH, 1);
set_hitbox_value(AT_UTHROW, 1, HG_PROJECTILE_VSPEED, -13);
set_hitbox_value(AT_UTHROW, 1, HG_PROJECTILE_GRAVITY, 0.4);