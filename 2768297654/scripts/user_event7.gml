...
///////////////////////////////////////////
initCodecPagePit(0,	6,	7,	"Hm.. I don't recognize this guy.");
initCodecPagePit(1,	0,	2,	"Do you remember Lucas from Super Smash Bros? Duster is a friend of his.");
initCodecPagePit(2,	3,	1,	"Let's hope Lucas didn't go crying to this guy after you won against him!");
initCodecPagePit(0,	9,	8,	"Uh oh, I hope this guy isn't here for revenge.");
initCodecPagePit(2,	0,	3,	"Well, it certainly wouldn't be unfounded.");
initCodecPagePit(1,	5,	1,	"Keep on your feet, Pit. Duster moves quickly and can easily overwhelm you.");
initCodecPagePit(1,	0,	3,	"The residents of Tazmily fight by sound battle. If you get hit 16 times, you'll take critical damage.");
initCodecPagePit(0,	0,	7,	"Wow, maybe I could take some lessons from Duster. Sound battles.. sound fun!");
initCodecPagePit(2,	1,	7,	"Hm... Duster wouldn't be a good mentor. He's a thief. Stealing is a bad thing you know.");
initCodecPagePit(1,	1,	2,	"That's right, he has a variety of 'Thieves Tools' at his disposal. Don't get caught in one of his traps.");
initCodecPagePit(2,	5,	6,	"Well it's not like Pit has anything that valuable on him. The most Duster could steal is a victory!");
initCodecPagePit(0,	8,	3,	"Yeah! I just have to worry abo- Hey! I'm not poor!");
///////////////////////////////////////////
