...
set_window_value(AT_DATTACK, 5, AG_WINDOW_SFX, asset_get("sfx_blow_heavy1"));
...
set_hitbox_value(AT_DATTACK, 1, HG_DAMAGE, 22);
...
set_hitbox_value(AT_DATTACK, 1, HG_BASE_HITPAUSE, 28);
set_hitbox_value(AT_DATTACK, 1, HG_HITPAUSE_SCALING, 1.4);
...
set_hitbox_value(AT_DATTACK, 2, HG_EXTRA_HITPAUSE, 2);
