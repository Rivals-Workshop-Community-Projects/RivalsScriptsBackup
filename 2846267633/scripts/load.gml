...
sprite_change_offset("hurtground", 32, 62);
...
sprite_change_offset("crawl_forward", 32, 62);
sprite_change_offset("crawl_back", 32, 62);
...
sprite_change_offset("e_hurtbox", 32, 62);
sprite_change_offset("e_air_hurtbox", 32, 62);
sprite_change_offset("e_crouchbox", 32, 62);
...
sprite_change_offset("super", 64, 94);
...
sprite_change_offset("head_mine", 32, 62);
sprite_change_offset("orbital_laser", 32, 1022);