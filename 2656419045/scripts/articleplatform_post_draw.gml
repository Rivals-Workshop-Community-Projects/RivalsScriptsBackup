//Make the actual hitbox render the ice
if(variant == "ice block projectile platform" || variant == "ice block projectile renderer") with(attach_to) {
	//draw ice block
	...
	var ice_x = x + rumble_xoffset, ice_y = y + rumble_yoffset, ice_w = abs(image_xscale * 100), ice_h = abs(image_yscale * 100) + 1;
	var ice = spr_ice_block;
