...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_orca_soak"));
...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_bird_sidespecial_start"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HITSTUN_MULTIPLIER, 1.3);
