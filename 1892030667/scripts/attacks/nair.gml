...
set_window_value(AT_NAIR, 2, AG_WINDOW_CUSTOM_GRAVITY, .7);
...
set_window_value(AT_NAIR, 4, AG_WINDOW_CUSTOM_GRAVITY, .7);
...
set_hitbox_value(AT_NAIR, 1, HG_BASE_KNOCKBACK, 7); //was 6
