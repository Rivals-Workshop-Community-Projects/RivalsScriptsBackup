...
set_window_value(AT_NAIR, 1, AG_WINDOW_LENGTH, has_rune("D")?1:4);
set_window_value(AT_NAIR, 1, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_NAIR, 1, AG_WINDOW_HAS_SFX, 1);

set_window_value(AT_NAIR, 2, AG_WINDOW_TYPE, 1);
set_window_value(AT_NAIR, 2, AG_WINDOW_LENGTH, has_rune("D")?1:4);
set_window_value(AT_NAIR, 2, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_NAIR, 2, AG_WINDOW_ANIM_FRAME_START, 5);
set_window_value(AT_NAIR, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_NAIR, 2, AG_WINDOW_SFX, asset_get("sfx_abyss_hex_hit"));
...
set_window_value(AT_NAIR, 4, AG_WINDOW_LENGTH, has_rune("D")?6:12);
...
set_hitbox_value(AT_NAIR, 1, HG_WIDTH, has_rune("D")?100:85);
set_hitbox_value(AT_NAIR, 1, HG_HEIGHT, has_rune("D")?100:85);
...
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT, hexfx);
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, asset_get("sfx_icehit_medium1"));
set_hitbox_value(AT_NAIR, 1, HG_ANGLE_FLIPPER, has_rune("D")?8:3);