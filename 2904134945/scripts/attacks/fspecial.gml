...
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_dust_knuckle"));
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("snowball"));
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_HSPEED, 6);
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, 29);
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT, hexfx);
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_LOCKOUT, 2);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_SDI_MULTIPLIER, 1.1);