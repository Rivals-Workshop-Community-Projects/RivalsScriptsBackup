if ("other_player_id" in self)
{
	if (instance_exists(noelleFrostbiteID) && noelleFrostbiteID.player == other_player_id.player)
	{
		...
		{
			var alpha = 1;
			if (frostgraveTime == other.noelleFrostgrave || ((hitpause || (other.state == PS_HITSTUN && other.state_timer == 1)) && other.noelleFrostgrave <= other.hitstun_full/3))
			{
			...
			shader_end();
			var frostHeight = (1-(other.noelleFrostgrave/frostgraveTime));
