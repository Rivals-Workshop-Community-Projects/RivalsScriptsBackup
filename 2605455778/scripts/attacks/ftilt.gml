...
set_window_value(AT_FTILT, 4, AG_WINDOW_TYPE, 1); //yoshi parry
...
set_hitbox_value(AT_FTILT, 2, HG_HITBOX_X, 68);
set_hitbox_value(AT_FTILT, 2, HG_HITBOX_Y, -63);
...
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, asset_get("sfx_kragg_rock_shatter"));