...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_LENGTH, 17); //start up
set_window_value(AT_USPECIAL, 1, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_USPECIAL, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_kragg_throw"));

set_window_value(AT_USPECIAL, 2, AG_WINDOW_LENGTH, 37); //throw and recovery
set_window_value(AT_USPECIAL, 2, AG_WINDOW_ANIM_FRAMES, 5);
set_window_value(AT_USPECIAL, 2, AG_WINDOW_ANIM_FRAME_START, 2);
set_window_value(AT_USPECIAL, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_abyss_hazard_burst"));

set_window_value(AT_USPECIAL, 3, AG_WINDOW_LENGTH, 15); //cancel hop
set_window_value(AT_USPECIAL, 3, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_USPECIAL, 3, AG_WINDOW_ANIM_FRAME_START, 7);
set_window_value(AT_USPECIAL, 3, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_abyss_hazard_burst"));

set_num_hitboxes(AT_USPECIAL, 0);

set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("upspecial_proj")); //projectile
...
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_GRAVITY, 0.4);
...
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, rockeggpowfx);

set_hitbox_value(AT_USPECIAL, 2, HG_HITBOX_TYPE, 2); //regular pow
...
set_hitbox_value(AT_USPECIAL, 2, HG_HIT_SFX, asset_get("sfx_kragg_rock_shatter"));
set_hitbox_value(AT_USPECIAL, 2, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_USPECIAL, 2, HG_VISUAL_EFFECT, 1);

set_hitbox_value(AT_USPECIAL, 3, HG_HITBOX_TYPE, 2); //totem pow
...
set_hitbox_value(AT_USPECIAL, 3, HG_WIDTH, 180);
set_hitbox_value(AT_USPECIAL, 3, HG_HEIGHT, 150);
...
set_hitbox_value(AT_USPECIAL, 4, HG_HITBOX_TYPE, 2); //swallow pow
...
set_hitbox_value(AT_USPECIAL, 4, HG_HIT_SFX, asset_get("sfx_kragg_rock_shatter"));
