...
set_hitbox_value(AT_USTRONG, 1, HG_KNOCKBACK_SCALING, 1.08);
...
set_hitbox_value(AT_USTRONG, 2, HG_KNOCKBACK_SCALING, 1.08);
...
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_Y, -27);
...
set_hitbox_value(AT_USTRONG, 3, HG_KNOCKBACK_SCALING, 1.08);
