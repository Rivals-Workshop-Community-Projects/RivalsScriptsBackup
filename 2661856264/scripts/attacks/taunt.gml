set_attack_value(AT_TAUNT, AG_MUNO_ATTACK_NAME, "Golem, King of the Jungle");
...
set_window_value(AT_TAUNT, 2, AG_WINDOW_SFX, sound_get("hit_s"));
...
set_window_value(AT_TAUNT, 3, AG_WINDOW_SFX, sound_get("hit_s"));
...
set_attack_value(AT_TAUNT, AG_MUNO_ATTACK_MISC, "look at it go
