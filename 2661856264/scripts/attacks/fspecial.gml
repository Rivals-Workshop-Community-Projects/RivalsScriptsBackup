...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_kragg_rock_pull"));
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_SFX, sound_get("item_throw"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT, rock_s);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_GRAVITY, .35);
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_WALL_BEHAVIOR, 2);
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, rock_s);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_LOCKOUT, 9);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_VISUAL_EFFECT, rock_m);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("fspec_proj_alt"));
set_hitbox_value(AT_FSPECIAL, 3, HG_PROJECTILE_MASK, sprite_get("fspec_proj_alt"));
set_hitbox_value(AT_FSPECIAL, 3, HG_PROJECTILE_HSPEED, 3);
set_hitbox_value(AT_FSPECIAL, 3, HG_PROJECTILE_VSPEED, -6);
set_hitbox_value(AT_FSPECIAL, 3, HG_PROJECTILE_GRAVITY, .35);
set_hitbox_value(AT_FSPECIAL, 3, HG_PROJECTILE_AIR_FRICTION, .02);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_PROJECTILE_DESTROY_EFFECT, rock_m);