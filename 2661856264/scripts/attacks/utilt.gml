...
set_window_value(AT_UTILT, 4, AG_WINDOW_LENGTH, 13);
...
set_window_value(AT_UTILT, 4, AG_WINDOW_SFX, sound_get("step_xl_run"));
...
set_hitbox_value(AT_UTILT, 1, HG_HITPAUSE_SCALING, 1.15);
