...
//music name title
music_titles = ["in Lurid, the Sensational Dream", "Funky Solution", "Professional Problem", "Fried Banana"]
 
 
//confirmation sound to play when music has been changed
//sound_get and asset_get both works here.
var confirm_sound = sound_get("lsd_select");
...
var music_line_color = make_color_rgb(247,247,156);
