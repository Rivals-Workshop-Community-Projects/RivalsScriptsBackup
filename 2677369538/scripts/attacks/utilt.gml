...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, asset_get("sfx_waveland_gus"));
...
set_hitbox_value(AT_UTILT, 1, HG_HITBOX_Y, -20*2);
set_hitbox_value(AT_UTILT, 1, HG_WIDTH, 15*2);
set_hitbox_value(AT_UTILT, 1, HG_HEIGHT, 40*2);
...
set_hitbox_value(AT_UTILT, 2, HG_HITBOX_X, 4*2);
set_hitbox_value(AT_UTILT, 2, HG_HITBOX_Y, -42*2);
set_hitbox_value(AT_UTILT, 2, HG_WIDTH, 56*2);
set_hitbox_value(AT_UTILT, 2, HG_HEIGHT, 23*2);
...
set_hitbox_value(AT_UTILT, 3, HG_HITBOX_X, 20*2);
set_hitbox_value(AT_UTILT, 3, HG_HITBOX_Y, -27*2);
set_hitbox_value(AT_UTILT, 3, HG_WIDTH, 30*2);
set_hitbox_value(AT_UTILT, 3, HG_HEIGHT, 53*2);
...
set_hitbox_value(AT_UTILT, 3, HG_HIT_SFX, asset_get("sfx_icehit_weak1"));