...
set_hitbox_value(AT_DSPECIAL_AIR, 1, HG_PRIORITY, 0);
...
set_hitbox_value(AT_DSPECIAL_AIR, 5, HG_HITBOX_TYPE, 1); //When you hit someone, spawn this
set_hitbox_value(AT_DSPECIAL_AIR, 5, HG_WINDOW, 100);
set_hitbox_value(AT_DSPECIAL_AIR, 5, HG_WINDOW_CREATION_FRAME, 1);
set_hitbox_value(AT_DSPECIAL_AIR, 5, HG_LIFETIME, 100);
