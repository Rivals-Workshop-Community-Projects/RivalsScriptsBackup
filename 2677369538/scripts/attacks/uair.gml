...
set_hitbox_value(AT_UAIR, 1, HG_HITBOX_X, 2*2);
set_hitbox_value(AT_UAIR, 1, HG_HITBOX_Y, -30*2);
set_hitbox_value(AT_UAIR, 1, HG_WIDTH, 32*2);
set_hitbox_value(AT_UAIR, 1, HG_HEIGHT, 50*2);
