...
set_attack_value(AT_NAIR, AG_NUM_WINDOWS, 10);
...
set_window_value(AT_NAIR, 7, AG_WINDOW_LENGTH, 2);
...
set_window_value(AT_NAIR, 8, AG_WINDOW_SFX, asset_get("sfx_swipe_medium1"));

set_window_value(AT_NAIR, 9, AG_WINDOW_TYPE, 1);
set_window_value(AT_NAIR, 9, AG_WINDOW_LENGTH, 3);
...
set_window_value(AT_NAIR, 10, AG_WINDOW_LENGTH, 12);
set_window_value(AT_NAIR, 10, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_NAIR, 10, AG_WINDOW_ANIM_FRAME_START, 12);
set_window_value(AT_NAIR, 10, AG_WINDOW_HAS_WHIFFLAG, 1);
...
set_hitbox_value(AT_NAIR, 1, HG_HITBOX_X, 4*2);
set_hitbox_value(AT_NAIR, 1, HG_HITBOX_Y, -18*2);
set_hitbox_value(AT_NAIR, 1, HG_WIDTH, 35*2);
set_hitbox_value(AT_NAIR, 1, HG_HEIGHT, 35*2);
...
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_X, 4*2);
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_Y, -18*2);
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_NAIR, 2, HG_WIDTH, 35*2);
set_hitbox_value(AT_NAIR, 2, HG_HEIGHT, 35*2);
...
set_hitbox_value(AT_NAIR, 3, HG_HITBOX_X, 4*2);
set_hitbox_value(AT_NAIR, 3, HG_HITBOX_Y, -18*2);
set_hitbox_value(AT_NAIR, 3, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_NAIR, 3, HG_WIDTH, 35*2);
set_hitbox_value(AT_NAIR, 3, HG_HEIGHT, 35*2);

set_hitbox_value(AT_NAIR, 4, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_NAIR, 4, HG_WINDOW, 9);
set_hitbox_value(AT_NAIR, 4, HG_LIFETIME, 3);
set_hitbox_value(AT_NAIR, 4, HG_HITBOX_X, 4*2);
set_hitbox_value(AT_NAIR, 4, HG_HITBOX_Y, -14*2);
set_hitbox_value(AT_NAIR, 4, HG_WIDTH, 40*2);
set_hitbox_value(AT_NAIR, 4, HG_HEIGHT, 40*2);
