...
set_hitbox_value(AT_DSPECIAL, 5, HG_HITBOX_TYPE, 1); //When you hit someone, spawn this
set_hitbox_value(AT_DSPECIAL, 5, HG_WINDOW, 100);
set_hitbox_value(AT_DSPECIAL, 5, HG_WINDOW_CREATION_FRAME, 1);
set_hitbox_value(AT_DSPECIAL, 5, HG_LIFETIME, 100);
...
set_hitbox_value(AT_DSPECIAL, 5, HG_HIT_LOCKOUT, 50);
