...
set_hitbox_value(AT_DSPECIAL, 1, HG_PROJECTILE_ENEMY_BEHAVIOR, 3);
...
set_hitbox_value(AT_DSPECIAL, 4, HG_HITBOX_TYPE, 1); //When you hit someone, spawn this
...
set_hitbox_value(AT_DSPECIAL, 4, HG_HITBOX_X, 9000);
set_hitbox_value(AT_DSPECIAL, 4, HG_HITBOX_Y, -9000);
...
set_hitbox_value(AT_DSPECIAL, 4, HG_ANGLE_FLIPPER, 2);
...
set_hitbox_value(AT_DSPECIAL, 4, HG_VISUAL_EFFECT, nothing);
set_hitbox_value(AT_DSPECIAL, 4, HG_HIT_SFX, asset_get("sfx_obstacle_hit"));
set_hitbox_value(AT_DSPECIAL, 4, HG_HIT_LOCKOUT, 1);
set_hitbox_value(AT_DSPECIAL, 4, HG_HITBOX_GROUP, -1);

set_hitbox_value(AT_DSPECIAL, 5, HG_HITBOX_TYPE, 1); //Rat moving forward
...
set_hitbox_value(AT_DSPECIAL, 5, HG_HITBOX_X, 9000);
set_hitbox_value(AT_DSPECIAL, 5, HG_HITBOX_Y, -9000);
set_hitbox_value(AT_DSPECIAL, 5, HG_WIDTH, 45);
...
//set_hitbox_value(AT_DSPECIAL, 5, HG_ANGLE_FLIPPER, 1);
...
set_hitbox_value(AT_DSPECIAL, 5, HG_VISUAL_EFFECT, nothing);
set_hitbox_value(AT_DSPECIAL, 5, HG_HIT_SFX, asset_get("sfx_obstacle_hit"));
set_hitbox_value(AT_DSPECIAL, 5, HG_TECHABLE, 1);
set_hitbox_value(AT_DSPECIAL, 5, HG_EXTENDED_PARRY_STUN, false);
set_hitbox_value(AT_DSPECIAL, 5, HG_HIT_LOCKOUT, 90);