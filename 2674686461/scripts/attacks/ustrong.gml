...
set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX_FRAME, get_window_value(AT_USTRONG,3,AG_WINDOW_LENGTH)-1);
...
set_hitbox_value(AT_USTRONG, 1, HG_LIFETIME, get_window_value(AT_USTRONG,4,AG_WINDOW_LENGTH));
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, -25);
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, asset_get("sfx_blow_heavy1"));
set_hitbox_value(AT_USTRONG, 1, HG_HIT_LOCKOUT, 7);
