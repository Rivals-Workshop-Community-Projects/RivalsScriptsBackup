...
set_window_value(AT_DAIR, 3, AG_WINDOW_SFX_FRAME, get_window_value(AT_DAIR,3,AG_WINDOW_LENGTH)-1);
...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, 3);
...
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, 3);
...
set_hitbox_value(AT_DAIR, 3, HG_HEIGHT, 85);
...
set_hitbox_value(AT_DAIR, 3, HG_VISUAL_EFFECT_X_OFFSET, 3);
...
set_hitbox_value(AT_DAIR, 4, HG_VISUAL_EFFECT_X_OFFSET, 3);
set_hitbox_value(AT_DAIR, 4, HG_VISUAL_EFFECT_Y_OFFSET, 5);
...
set_hitbox_value(AT_DAIR, 5, HG_LIFETIME, get_window_value(AT_DAIR,4,AG_WINDOW_LENGTH));
...
set_hitbox_value(AT_DAIR, 5, HG_HITPAUSE_SCALING, 0.35);
set_hitbox_value(AT_DAIR, 5, HG_VISUAL_EFFECT, 1);
set_hitbox_value(AT_DAIR, 5, HG_VISUAL_EFFECT_X_OFFSET, 3);
