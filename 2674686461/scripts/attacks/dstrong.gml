...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX_FRAME, get_window_value(AT_DSTRONG,3,AG_WINDOW_LENGTH)-1);
...
set_hitbox_value(AT_DSTRONG, 1, HG_LIFETIME, get_window_value(AT_DSTRONG,4,AG_WINDOW_LENGTH)-1);
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, -15);
