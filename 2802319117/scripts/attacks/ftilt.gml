...
set_window_value(AT_FTILT, 2, AG_WINDOW_SFX, asset_get("sfx_swish_medium"));
...
//set_window_value(AT_FTILT, 3, AG_WINDOW_HITPAUSE_FRAME, 2);
set_window_value(AT_FTILT, 3, AG_WINDOW_LENGTH, 3);//12
set_window_value(AT_FTILT, 3, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_FTILT, 3, AG_WINDOW_ANIM_FRAME_START, 2);
set_window_value(AT_FTILT, 3, AG_WINDOW_HAS_WHIFFLAG, 1);

set_window_value(AT_FTILT, 4, AG_WINDOW_LENGTH, 10);//12
...
//set_hitbox_value(AT_FTILT, 1, HG_WINDOW_CREATION_FRAME, 7);
...
set_hitbox_value(AT_FTILT, 1, HG_WIDTH, 127);
