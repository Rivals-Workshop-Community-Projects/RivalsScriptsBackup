...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy1"));
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_SFX_FRAME, 19);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_WIDTH, 89);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_HITBOX_TYPE, 2); //phanto values most are ok to change
...
set_hitbox_value(AT_DSPECIAL, 3, HG_WIDTH, 89);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("phanto"));// do not change
set_hitbox_value(AT_DSPECIAL, 3, HG_PROJECTILE_MASK, sprite_get("phanto"));// do not change unless you want a different hitbox
