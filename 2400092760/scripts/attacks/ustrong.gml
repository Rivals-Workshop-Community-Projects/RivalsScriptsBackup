...
set_window_value(AT_USTRONG, 4, AG_WINDOW_SFX, asset_get("sfx_ori_spirit_flame_1"));
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, hit_sprites[1]);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, hit_sprites[0]);
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, asset_get("sfx_buzzsaw_hit"));
...
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_Y, -107);
set_hitbox_value(AT_USTRONG, 3, HG_WIDTH, 109);
...
set_hitbox_value(AT_USTRONG, 3, HG_VISUAL_EFFECT, hit_sprites[3]);
