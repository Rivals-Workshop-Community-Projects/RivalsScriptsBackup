...
set_hitbox_value(AT_UAIR, 1, HG_SDI_MULTIPLIER, 0.2);
...
set_hitbox_value(AT_UAIR, 2, HG_SDI_MULTIPLIER, 0.2);
...
set_hitbox_value(AT_UAIR, 3, HG_SDI_MULTIPLIER, 0.2);
...
set_hitbox_value(AT_UAIR, 4, HG_BASE_HITPAUSE, 0);
...
set_hitbox_value(AT_UAIR, 4, HG_SDI_MULTIPLIER, 0.2);
