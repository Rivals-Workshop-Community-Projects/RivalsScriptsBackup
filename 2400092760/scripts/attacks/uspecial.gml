...
set_hitbox_value(AT_USPECIAL, 1, HG_KNOCKBACK_SCALING, 0.82);
...
set_hitbox_value(AT_USPECIAL, 3, HG_WIDTH, 8);
...
set_hitbox_value(AT_USPECIAL, 3, HG_KNOCKBACK_SCALING, 0.82);
