...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, asset_get("sfx_ori_bash_use"));
...
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT, hit_sprites[1]);
...
set_hitbox_value(AT_BAIR, 3, HG_HITBOX_X, -38);
set_hitbox_value(AT_BAIR, 3, HG_HITBOX_Y, -58);
set_hitbox_value(AT_BAIR, 3, HG_WIDTH, 57);
...
set_hitbox_value(AT_BAIR, 3, HG_VISUAL_EFFECT, hit_sprites[1]);
