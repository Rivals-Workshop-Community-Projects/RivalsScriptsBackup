...
set_window_value(AT_DATTACK, 3, AG_WINDOW_SFX, asset_get("sfx_shovel_swing_med1"));
...
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT, hit_sprites[1]);
...
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT, hit_sprites[2]);
...
set_hitbox_value(AT_DATTACK, 1, HG_HITPAUSE_SCALING, 0.5);
set_hitbox_value(AT_DATTACK, 3, HG_VISUAL_EFFECT, hit_sprites[2]);
