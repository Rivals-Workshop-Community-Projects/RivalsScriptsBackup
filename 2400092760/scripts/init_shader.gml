...
if ("ColorLocked" in self && ColorLocked){
	switch (Default){ // Color Alt 0 Secret Colors
		...
		set_article_color_slot( 1, 46, 36, 37 ); //HAIR
		set_article_color_slot( 2, 107, 106, 102 ); //SHIRT
		set_article_color_slot( 3, 54, 53, 49 ); //COAT
		set_article_color_slot( 4, 154, 155, 157 ); //FUR
		set_article_color_slot( 5, 54, 53, 49 ); //BANDAGES
		set_article_color_slot( 6, 139, 211, 225 ); //HIGHLIGHTS
		set_article_color_slot( 7, 255, 132, 0 ); //BLOOD
			break;
			case 3:
		// Sketchy Origins
	...
	set_character_color_slot( 5, 74, 44, 198 ); //BANDAGES
	...
	set_article_color_slot( 5, 74, 44, 198 ); //BANDAGES
	...
	set_article_color_slot( 7, 221, 10, 244 ); //BLOOD
		...
		case 6:
	//Null
	set_character_color_slot( 0, 71, 49, 87 ); //SKIN
	set_character_color_slot( 1, 119, 43, 197 ); //HAIR
	set_character_color_slot( 2, 71, 49, 87 ); //SHIRT
	set_character_color_slot( 3, 49, 33, 64 ); //COAT
	set_character_color_slot( 4, 88, 22, 183 ); //FUR
	set_character_color_slot( 5, 140, 145, 183 ); //BANDAGES
	set_character_color_slot( 6, 255, 180, 0 ); //HIGHLIGHTS
	set_character_color_slot( 7, 88, 22, 183 ); //BLOOD
	
	set_article_color_slot( 0, 71, 49, 87 ); //SKIN
	set_article_color_slot( 1, 119, 43, 197 ); //HAIR
	set_article_color_slot( 2, 71, 49, 87 ); //SHIRT
	set_article_color_slot( 3, 49, 33, 64 ); //COAT
	set_article_color_slot( 4, 88, 22, 183 ); //FUR
	set_article_color_slot( 5, 140, 145, 183 ); //BANDAGES
	set_article_color_slot( 6, 255, 180, 0 ); //HIGHLIGHTS
	set_article_color_slot( 7, 88, 22, 183 ); //BLOOD
		break;
	}
}