...
set_hitbox_value(AT_NAIR, 1, HG_WIDTH, 49);
set_hitbox_value(AT_NAIR, 1, HG_HEIGHT, 63);
...
set_hitbox_value(AT_NAIR, 3, HG_HITBOX_Y, -31);
...
set_hitbox_value(AT_NAIR, 4, HG_WIDTH, 81);
set_hitbox_value(AT_NAIR, 4, HG_HEIGHT, 59);
...
set_hitbox_value(AT_NAIR, 4, HG_HIT_SFX, asset_get("sfx_may_whip1"));
