...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, sound_get("zoom"));
...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_SFX, sound_get("ohno"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_KNOCKBACK_SCALING, .95);
set_hitbox_value(AT_USPECIAL, 1, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_USPECIAL, 1, HG_HITPAUSE_SCALING, .75);
...
set_hitbox_value(AT_USPECIAL, 2, HG_WIDTH, 47);
