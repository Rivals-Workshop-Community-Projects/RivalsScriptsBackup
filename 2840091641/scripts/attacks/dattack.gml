...
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX, sound_get("discipline_device_woosh_02"));
...
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, sound_get("discipline_device_impact_01"));
