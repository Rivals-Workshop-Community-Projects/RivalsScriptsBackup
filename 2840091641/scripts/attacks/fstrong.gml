...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, sound_get("shotgun_load"));
...
set_hitbox_value(AT_FSTRONG, 3, HG_HITBOX_X, 150);
set_hitbox_value(AT_FSTRONG, 3, HG_HITBOX_Y, -30);
set_hitbox_value(AT_FSTRONG, 3, HG_WIDTH, 150);
set_hitbox_value(AT_FSTRONG, 3, HG_HEIGHT, 150);
...
set_hitbox_value(AT_FSTRONG, 3, HG_HIT_LOCKOUT, 1);