...
set_attack_value(AT_NSPECIAL, AG_LANDING_LAG, 13);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HITBOX_Y, -66);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("rocket"));
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("rocket_hurt"));
