...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_ori_grenade_launch"));
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_ell_strong_attack_explosion"));
...
set_hitbox_value(AT_USPECIAL, 3, HG_VISUAL_EFFECT, 253);
set_hitbox_value(AT_USPECIAL, 3, HG_HIT_SFX, asset_get("sfx_ell_uspecial_explode"));
