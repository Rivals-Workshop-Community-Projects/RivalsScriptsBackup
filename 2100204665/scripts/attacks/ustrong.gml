...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, sound_get("sfx_rise"));
...
set_hitbox_value(AT_USTRONG, 1, HG_HEIGHT, 146);
...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("sfx_ut_souldamage"));
