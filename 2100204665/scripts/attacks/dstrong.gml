...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("sfx_rise"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 240);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("sfx_monsterhit"));
