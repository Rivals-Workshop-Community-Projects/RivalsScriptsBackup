...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_ice_dspecial_form"));
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX_FRAME, 15);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HEIGHT, 88);
...
set_hitbox_value(AT_FSTRONG, 2, HG_KNOCKBACK_SCALING, .77);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, asset_get("sfx_icehit_heavy2"));
