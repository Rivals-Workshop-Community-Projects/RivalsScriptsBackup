...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, sound_get("sfx_rise"));


set_num_hitboxes(AT_USPECIAL, 1);

set_hitbox_value(AT_USPECIAL, 1, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("empty_proj"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_EFFECT, 95);
