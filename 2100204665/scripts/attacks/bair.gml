...
set_window_value(AT_BAIR, 2, AG_WINDOW_SFX, sound_get("sfx_ping"));
...
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 83);
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 2);
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_X, -96);
...
set_hitbox_value(AT_BAIR, 1, HG_ANGLE, 225);
...
set_hitbox_value(AT_BAIR, 1, HG_PROJECTILE_VSPEED, 5);
