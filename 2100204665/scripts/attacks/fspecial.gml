...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_SFX, sound_get("sfx_ping"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HEIGHT, 92);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, sound_get("sfx_ut_souldamage"));