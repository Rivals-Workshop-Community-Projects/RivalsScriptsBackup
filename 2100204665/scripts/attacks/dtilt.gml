...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, sound_get("sfx_dogrise"));
...
set_hitbox_value(AT_DTILT, 1, HG_HITBOX_X, 82);
...
set_hitbox_value(AT_DTILT, 2, HG_ANGLE, 24);
...
set_hitbox_value(AT_DTILT, 2, HG_PROJECTILE_HSPEED, -8);
set_hitbox_value(AT_DTILT, 2, HG_PROJECTILE_GROUND_BEHAVIOR, 0);
set_hitbox_value(AT_DTILT, 2, HG_PROJECTILE_ENEMY_BEHAVIOR, 1);
set_hitbox_value(AT_DTILT, 2, HG_HIT_SFX, sound_get("sfx_ut_souldamage"));
set_hitbox_value(AT_DTILT, 2, HG_PROJECTILE_GRAVITY, .5);
