//
if (state != 3 && state > 0 && enemy_hitboxID.effect != 95 || state != 3 && state > 0 && enemy_hitboxID.effect == 95 && enemy_hitboxID.player_id != player_id){
hitpause_time = enemy_hitboxID.hitpause*1.5;
if (enemy_hitboxID.player_id.blue == true){
    hits += 0.5;
}
if (enemy_hitboxID.player_id.blue == false){
    hits += 1;
}
if (hits >= 1){
