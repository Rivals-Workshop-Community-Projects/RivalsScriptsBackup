...
music_files = ["music_loop", "music_loop3", "music_loop8", "music_loop5", "music_loop7", "music_loop2", "music_loop4", "music_loop6"]
 
//music name title
music_titles = ["Homecoming Hijinks", "Forest Folly", "Funky Stadium (Paulygon Remix)", "Harvest Hazards", "Funky's Medley (DJ the S)", "Seashore War", "Scorch 'N' Torch", "Blurry Flurry"]
 
 
//confirmation sound to play when music has been changed
//sound_get and asset_get both works here.
var confirm_sound = sound_get("banana_coin");
...
var music_line_color = make_color_rgb(255,214,64);
...
if (get_gameplay_time() <= 110 && mus_phase == 0 && get_gameplay_time() >= 5)
{
    with (asset_get("oPlayer"))
    {
        if(temp_level == 0){
            var conditions;
            conditions = [ joy_dir > 45-43 && joy_dir < 45+43 || up_stick_down && !(special_down or attack_down or shield_down or strong_down or taunt_down), //Homecoming Hijinks - up/up-right
                        joy_dir > 315-43 && joy_dir < 315+43 || down_stick_down && !(special_down or attack_down or shield_down or strong_down or taunt_down),//TF 3 - down/down-right
                        joy_dir > 135-43 && joy_dir < 135+43 || left_stick_down && (special_down or attack_down or shield_down or strong_down or taunt_down), //Funky Stadium - s-left/up-left
                        joy_dir > 225-43 && joy_dir < 225+43 || right_stick_down && (special_down or attack_down or shield_down or strong_down or taunt_down), //TF 5 - s-right/down_left
                        joy_dir > 90-5 && joy_dir < 90+5 || left_stick_down && !(special_down or attack_down or shield_down or strong_down or taunt_down),      //Funky Medley - left/up
                        joy_dir > 360-5 || joy_dir < 5 && !joy_pad_idle || joy_dir=0 and right_down || right_stick_down && !(special_down or attack_down or shield_down or strong_down or taunt_down),//TF 2 - right/right
                        joy_dir > 270-5 && joy_dir < 270+5 || up_stick_down && (special_down or attack_down or shield_down or strong_down or taunt_down), //TF 4 - s-up/down
                        joy_dir > 180-5 && joy_dir < 180+5 || down_stick_down && (special_down or attack_down or shield_down or strong_down or taunt_down)]//Blurry Flurry - s_down/left
