...
initTip("FSpecial");
initWords("Fires a spinning wheel that slows down over time.");
initWords("The animation will retain your horizontal speed so you can 'schmoove' with it.");
initWords("Releases an Interial Bubble upon expiring.");
initWords("Bubbles will interact with the other specials.");
initImage_ext(sprite_get("fspecial"), -4, fa_left, 1, 1, true, c_white, 1, true, noone, noone, noone, noone);
initImage_ext(sprite_get("wheel"), -4, fa_center, 1, 1, true, c_white, 1, true, noone, noone, noone, noone);
...
initWords("Hitting an Interial Bubble will bounce you and refund double jump.");
initWords("Try to position yourself beforehand so you can actually touch the Bubble and not completely miss it.");
initImage_ext(sprite_get("uspecial"), -4, fa_center, 1, 1, true, c_white, 1, false, noone, noone, noone, noone);

initTip("DSpecial");
initWords("Creates a slash perpendicular to you and the Interial Bubble.");
initWords("If there's no Bubble it just makes a vertial slash on top of you.");
initWords("Has higher damage and kill power if you hit opponents closer to the center.");
initImage_ext(sprite_get("dspecial"), -4, fa_center, 1, 1, true, c_white, 1, false, noone, noone, noone, noone);

initTip("Dutch's Lore");
initWords_ext("Chapter 1", fa_center, c_gray, 0, false);
initWords("An angel taking the form of a dragon. Carries out divine authority. Contrary to popular belief, is not a 'Dutch Angel Dragon' but it's easy to make that mistake.");
initWords("Were you expecting deep lore for a shitpost???");
...
(it's balanced because it doesnt work)");
