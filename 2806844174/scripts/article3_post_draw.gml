...
if draw_circle2 > 0 {
	var circle_radius2 = ease_sineOut(0, 80, 25 - draw_circle2, 25);
	draw_sprite_ext(sprite_get("circle2"), 0, circle_x2 + 2, circle_y2, circle_radius2/250, circle_radius2/250, 0, c_white, (draw_circle2/25));
}