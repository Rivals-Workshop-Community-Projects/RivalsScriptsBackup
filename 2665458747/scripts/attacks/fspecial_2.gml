...
set_hitbox_value(AT_FSPECIAL_2, 4, HG_VISUAL_EFFECT, 0);
...
set_hitbox_value(AT_FSPECIAL_2, 5, HG_VISUAL_EFFECT, 0);
...
set_hitbox_value(AT_FSPECIAL_2, 6, HG_VISUAL_EFFECT, 4);
