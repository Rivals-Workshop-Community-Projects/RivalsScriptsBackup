...
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT, fighthit);
...
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, sound_get("dp-hit2"));
...
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT, fighthit);
...
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, sound_get("dp-hit2"));
...
set_hitbox_value(AT_UAIR, 3, HG_VISUAL_EFFECT, poisonjabhit);
...
set_hitbox_value(AT_UAIR, 3, HG_HIT_SFX, sound_get("sm-tipper"));
...
set_hitbox_value(AT_UAIR, 4, HG_VISUAL_EFFECT, poisonjabhit);
...
set_hitbox_value(AT_UAIR, 4, HG_HIT_SFX, sound_get("sm-tipper"));
