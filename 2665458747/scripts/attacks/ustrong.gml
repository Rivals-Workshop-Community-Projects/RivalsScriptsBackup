...
set_window_value(AT_USTRONG, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.33);

set_window_value(AT_USTRONG, 2, AG_WINDOW_LENGTH, 7);
set_window_value(AT_USTRONG, 2, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_USTRONG, 2, AG_WINDOW_ANIM_FRAME_START, 2);
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_swipe_weak2"));
set_window_value(AT_USTRONG, 2, AG_WINDOW_HAS_SFX, 3);
...
set_window_value(AT_USTRONG, 5, AG_WINDOW_SFX, sound_get("sm-movementstrike"));
set_window_value(AT_USTRONG, 5, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USTRONG, 5, AG_WINDOW_SFX_FRAME, 5);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, fightinghit);
...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("dp-hit2"));
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, fightinghit);
...
set_hitbox_value(AT_USTRONG, 2, HG_EXTRA_HITPAUSE, 40);
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("dp-hit2"));
...
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_Y, -61);
...
set_hitbox_value(AT_USTRONG, 3, HG_VISUAL_EFFECT, bighit);
...
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, sound_get("sm-fightinghit2"));
...
set_hitbox_value(AT_USTRONG, 4, HG_HITBOX_Y, -61);
...
set_hitbox_value(AT_USTRONG, 4, HG_VISUAL_EFFECT, bigsting);
...
set_hitbox_value(AT_USTRONG, 4, HG_HIT_SFX, sound_get("sm-tipper"));
