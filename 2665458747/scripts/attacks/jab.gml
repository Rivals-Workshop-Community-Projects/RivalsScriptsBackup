...
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, sound_get("sm-quickmovement"));
...
set_window_value(AT_JAB, 4, AG_WINDOW_SFX, sound_get("sm-quickmovement"));
...
set_hitbox_value(AT_JAB, 2, HG_VISUAL_EFFECT, stinghit);
...
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, sound_get("sm-jabhit"));
