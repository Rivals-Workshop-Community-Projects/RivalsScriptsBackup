...
set_window_value(AT_DAIR, 6, AG_WINDOW_LENGTH, 11);
...
set_hitbox_value(AT_DAIR, 1, HG_WIDTH, 72);
...
set_hitbox_value(AT_DAIR, 2, HG_HEIGHT, 94);
...
set_hitbox_value(AT_DAIR, 3, HG_WIDTH, 94);
set_hitbox_value(AT_DAIR, 3, HG_HEIGHT, 92);
