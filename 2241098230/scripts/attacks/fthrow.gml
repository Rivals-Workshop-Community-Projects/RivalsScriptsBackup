...
set_hitbox_value(AT_FTHROW, 2, HG_KNOCKBACK_SCALING, 1);
set_hitbox_value(AT_FTHROW, 2, HG_BASE_HITPAUSE, 18);
...
set_hitbox_value(AT_FTHROW, 2, HG_HITSTUN_MULTIPLIER, 1.2);
