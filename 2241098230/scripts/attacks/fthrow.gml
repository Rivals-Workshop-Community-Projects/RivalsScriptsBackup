...
set_attack_value(AT_FTHROW, AG_MUNO_ATTACK_USES_ROLES, 1);

set_attack_value(AT_FTHROW, AG_NUM_WINDOWS, 5);
set_window_value(AT_FTHROW, 1, AG_MUNO_WINDOW_ROLE, 1);
...
//Throw 1
set_window_value(AT_FTHROW, 2, AG_MUNO_WINDOW_ROLE, 2);
...
set_window_value(AT_FTHROW, 3, AG_MUNO_WINDOW_ROLE, 3);
...
//Normal
set_hitbox_value(AT_FTHROW, 1, HG_MUNO_HITBOX_NAME, "Throw");
...
//Smoked
set_hitbox_value(AT_FTHROW, 2, HG_MUNO_HITBOX_NAME, "Throw (Consumed)");
