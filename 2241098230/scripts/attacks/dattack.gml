...
set_window_value(AT_DATTACK, 2, AG_WINDOW_HSPEED, 7.5 + (has_rune("A") * 5));
...
set_hitbox_value(AT_DATTACK, 1, HG_HITBOX_X, 31.5);
...
set_hitbox_value(AT_DATTACK, 2, HG_HITBOX_X, 34.5);
