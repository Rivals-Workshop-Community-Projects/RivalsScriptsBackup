...
set_hitbox_value(AT_FSPECIAL, 1, HG_WIDTH, 42 + (has_rune("O") * 24));
...
set_hitbox_value(AT_FSPECIAL, 2, HG_WIDTH, 32 + (has_rune("O") * 112));
set_hitbox_value(AT_FSPECIAL, 2, HG_HEIGHT, 32 + (has_rune("O") * 112));
...
set_hitbox_value(AT_FSPECIAL, 6, HG_BASE_KNOCKBACK, 7 + (has_rune("J") * 3));
