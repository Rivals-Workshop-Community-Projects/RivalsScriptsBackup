...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_VSPEED, -6.5);
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_VSPEED, -6.5);
...
set_window_value(AT_DSTRONG, 5, AG_WINDOW_CUSTOM_GRAVITY, 0.35);
