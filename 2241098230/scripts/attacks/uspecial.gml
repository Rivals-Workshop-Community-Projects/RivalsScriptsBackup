...
set_window_value(AT_USPECIAL, 7, AG_WINDOW_HSPEED, -.5);
set_window_value(AT_USPECIAL, 7, AG_WINDOW_VSPEED, -6);
...
set_window_value(AT_USPECIAL, 8, AG_WINDOW_CUSTOM_GRAVITY, 0.3);
...
set_window_value(AT_USPECIAL, 10, AG_WINDOW_HSPEED, -.5);
...
set_hitbox_value(AT_USPECIAL, 1, HG_WIDTH, 32 + (has_rune("O") * 48));
set_hitbox_value(AT_USPECIAL, 1, HG_HEIGHT, 54 + (has_rune("O") * 48));
...
set_hitbox_value(AT_USPECIAL, 2, HG_HITBOX_X, 42);
set_hitbox_value(AT_USPECIAL, 2, HG_HITBOX_Y, -56);
set_hitbox_value(AT_USPECIAL, 2, HG_WIDTH, 32 + (has_rune("O") * 48));
set_hitbox_value(AT_USPECIAL, 2, HG_HEIGHT, 40 + (has_rune("O") * 48));
...
set_hitbox_value(AT_USPECIAL, 3, HG_HEIGHT, 36);
...
set_hitbox_value(AT_USPECIAL, 6, HG_DAMAGE, 4 + (has_rune("I") * 4));
...
set_hitbox_value(AT_USPECIAL, 6, HG_BASE_HITPAUSE, 14);
...
set_hitbox_value(AT_USPECIAL, 7, HG_DAMAGE, 6 + (has_rune("I") * 4));
...
set_hitbox_value(AT_USPECIAL, 7, HG_BASE_HITPAUSE, 18);
set_hitbox_value(AT_USPECIAL, 7, HG_HITPAUSE_SCALING, 1.1);
set_hitbox_value(AT_USPECIAL, 7, HG_VISUAL_EFFECT, smokeconsume_fx_bot);
set_hitbox_value(AT_USPECIAL, 7, HG_VISUAL_EFFECT_Y_OFFSET, 44);
