...
set_hitbox_value(AT_USPECIAL, 1, HG_WIDTH, 68 + (has_rune("O") * 48));
set_hitbox_value(AT_USPECIAL, 1, HG_HEIGHT, 48 + (has_rune("O") * 48));
...
set_hitbox_value(AT_USPECIAL, 2, HG_WIDTH, 44 + (has_rune("O") * 112));
set_hitbox_value(AT_USPECIAL, 2, HG_HEIGHT, 48 + (has_rune("O") * 112));
...
set_hitbox_value(AT_USPECIAL, 3, HG_WIDTH, 44 + (has_rune("O") * 112));
set_hitbox_value(AT_USPECIAL, 3, HG_HEIGHT, 48 + (has_rune("O") * 112));
