...
set_window_value(AT_USPECIAL, 3, AG_MUNO_WINDOW_ROLE, 2);
...
set_window_value(AT_USPECIAL, 4, AG_MUNO_WINDOW_ROLE, 3);
...
set_hitbox_value(AT_USPECIAL, 1, HG_MUNO_HITBOX_NAME, "Early Grab");
...
set_hitbox_value(AT_USPECIAL, 2, HG_MUNO_HITBOX_NAME, "Grab Clean");
...
set_hitbox_value(AT_USPECIAL, 3, HG_MUNO_HITBOX_NAME, "Grab Late");
...
set_hitbox_value(AT_USPECIAL, 4, HG_HITBOX_X, 42);
...
set_hitbox_value(AT_USPECIAL, 4, HG_EXTRA_CAMERA_SHAKE, -1);

set_hitbox_value(AT_USPECIAL, 5, HG_MUNO_HITBOX_NAME, "Throw");
...
set_hitbox_value(AT_USPECIAL, 5, HG_HITBOX_Y, -42);
set_hitbox_value(AT_USPECIAL, 5, HG_WIDTH, 76);
set_hitbox_value(AT_USPECIAL, 5, HG_HEIGHT, 76);
set_hitbox_value(AT_USPECIAL, 5, HG_PRIORITY, 2);
set_hitbox_value(AT_USPECIAL, 5, HG_DAMAGE, 4 + (has_rune("I") * 4));
...
set_hitbox_value(AT_USPECIAL, 5, HG_HIT_SFX,  asset_get("sfx_zetter_downb"));
set_hitbox_value(AT_USPECIAL, 5, HG_IGNORES_PROJECTILES, 1);
set_hitbox_value(AT_USPECIAL, 5, HG_HITBOX_GROUP, 1);

set_hitbox_value(AT_USPECIAL, 6, HG_MUNO_HITBOX_NAME, "Throw (Consumed)");
...
set_hitbox_value(AT_USPECIAL, 6, HG_DAMAGE, 6 + (has_rune("I") * 4));
...
set_hitbox_value(AT_USPECIAL, 6, HG_VISUAL_EFFECT, smokeconsume_fx_bot);
set_hitbox_value(AT_USPECIAL, 6, HG_VISUAL_EFFECT_Y_OFFSET, 44);
set_hitbox_value(AT_USPECIAL, 6, HG_HIT_SFX,  asset_get("sfx_burnconsume"));
