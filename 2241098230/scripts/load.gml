...
sprite_change_offset("parry", 80, 126);
sprite_change_offset("roll_forward", 80, 126);
sprite_change_offset("roll_backward", 80, 126);
...
sprite_change_offset("dattack", 48, 126);
sprite_change_offset("ftilt", 48, 126);
sprite_change_offset("dtilt", 48, 126);
sprite_change_offset("utilt", 48, 126);
sprite_change_offset("nair", 48, 126);
sprite_change_offset("fair", 80, 126);
sprite_change_offset("bair", 80, 126);
sprite_change_offset("uair", 80, 126)
sprite_change_offset("dair", 48, 126);
sprite_change_offset("fstrong", 80, 158);
sprite_change_offset("ustrong", 80, 126);
sprite_change_offset("dstrong", 48, 126);
sprite_change_offset("nspecial", 48, 158);
sprite_change_offset("nspecial_air", 80, 158);
sprite_change_offset("fthrow", 80, 126);
sprite_change_offset("fthrow_air", 80, 126);
...
sprite_change_offset("ryk_crouchbox", 48, 126);
