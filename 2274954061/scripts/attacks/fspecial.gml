...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_buzzsaw_throw"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_X, 19);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, asset_get("sfx_buzzsaw_hit"));
