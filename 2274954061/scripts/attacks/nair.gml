...
set_window_value(AT_NAIR, 4, AG_WINDOW_HAS_WHIFFLAG, 10);
...
set_hitbox_value(AT_NAIR, 5, HG_KNOCKBACK_SCALING, .45);
...
set_hitbox_value(AT_NAIR, 5, HG_HITSTUN_MULTIPLIER, .8);