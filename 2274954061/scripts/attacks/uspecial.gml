...
set_window_value(AT_USPECIAL, 5, AG_WINDOW_LENGTH, 100);
...
set_window_value(AT_USPECIAL, 5, AG_WINDOW_SFX, asset_get("sfx_swipe_weak1"));
...
set_hitbox_value(AT_USPECIAL, 2, HG_HIT_SFX, asset_get("sfx_shovel_hit_light2"));
set_hitbox_value(AT_USPECIAL, 2, HG_HITBOX_GROUP, 1);

set_hitbox_value(AT_USPECIAL, 3, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_USPECIAL, 3, HG_WINDOW, 5);
set_hitbox_value(AT_USPECIAL, 3, HG_LIFETIME, 100);
set_hitbox_value(AT_USPECIAL, 3, HG_HITBOX_Y, -17);
set_hitbox_value(AT_USPECIAL, 3, HG_WIDTH, 73);
set_hitbox_value(AT_USPECIAL, 3, HG_HEIGHT, 41);
...
set_hitbox_value(AT_USPECIAL, 3, HG_KNOCKBACK_SCALING, .65);
