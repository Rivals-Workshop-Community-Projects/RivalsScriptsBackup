...
//(grnds) nspst nspan nspac nsph  nsprc  nspspin nsprcvr
//(0-3:4) 4-5:2 6-6:1 7-7:1 8-8:1 9-10:2 11-14:4 15-16:2
...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_VSPEED, -4.5);//-5.5
...
set_hitbox_value(AT_NSPECIAL, 1, HG_WIDTH, 106);
set_hitbox_value(AT_NSPECIAL, 1, HG_HEIGHT, 60);
set_hitbox_value(AT_NSPECIAL, 1, HG_PRIORITY, 1);
set_hitbox_value(AT_NSPECIAL, 1, HG_DAMAGE, 2);
set_hitbox_value(AT_NSPECIAL, 1, HG_ANGLE, 88);
