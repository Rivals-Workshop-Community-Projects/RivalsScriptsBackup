...
set_window_value(AT_FAIR, 1, AG_WINDOW_LENGTH, 10);//9
...
set_hitbox_value(AT_FAIR, 1, HG_KNOCKBACK_SCALING, 1.0);//1.1
...
set_hitbox_value(AT_FAIR, 2, HG_KNOCKBACK_SCALING, 1.0);//1.1
