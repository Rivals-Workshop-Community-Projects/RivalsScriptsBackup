...
set_window_value(AT_BAIR, 2, AG_WINDOW_SFX, sound_get("swing5"));
...
set_window_value(AT_BAIR, 4, AG_WINDOW_LENGTH, 9);//11
...
set_window_value(AT_BAIR, 5, AG_WINDOW_LENGTH, 9);//11
...
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 104);
...
set_hitbox_value(AT_BAIR, 1, HG_BASE_KNOCKBACK, 8.5);//8
set_hitbox_value(AT_BAIR, 1, HG_KNOCKBACK_SCALING, 0.75);//0.6
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("hit1"));
...
set_hitbox_value(AT_BAIR, 2, HG_HEIGHT, 9);
set_hitbox_value(AT_BAIR, 2, HG_PRIORITY, 2);
set_hitbox_value(AT_BAIR, 2, HG_DAMAGE, 10);//9
set_hitbox_value(AT_BAIR, 2, HG_ANGLE, 272);
...
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, sound_get("hit3"));
