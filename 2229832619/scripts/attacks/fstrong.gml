...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_LENGTH, 9);//14//10//9
...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX_FRAME, 8-5);

set_window_value(AT_FSTRONG, 2, AG_WINDOW_LENGTH, 4);
set_window_value(AT_FSTRONG, 2, AG_WINDOW_ANIM_FRAME_START, 3);
set_window_value(AT_FSTRONG, 2, AG_WINDOW_ANIM_FRAMES, 1);

set_window_value(AT_FSTRONG, 3, AG_WINDOW_LENGTH, 8);//8
set_window_value(AT_FSTRONG, 3, AG_WINDOW_ANIM_FRAME_START, 4);
set_window_value(AT_FSTRONG, 3, AG_WINDOW_ANIM_FRAMES, 2);

set_window_value(AT_FSTRONG, 4, AG_WINDOW_LENGTH, 4);//5//6
set_window_value(AT_FSTRONG, 4, AG_WINDOW_ANIM_FRAME_START, 6);
set_window_value(AT_FSTRONG, 4, AG_WINDOW_ANIM_FRAMES, 1);

set_window_value(AT_FSTRONG, 5, AG_WINDOW_LENGTH, 2);//3
...
set_hitbox_value(AT_FSTRONG, 1, HG_BASE_KNOCKBACK, 8);//10//8//10
set_hitbox_value(AT_FSTRONG, 1, HG_KNOCKBACK_SCALING, 1.25);//1.05//0.9//0.95//1.15
...
set_hitbox_value(AT_FSTRONG, 2, HG_EXTRA_HITPAUSE, -6);
