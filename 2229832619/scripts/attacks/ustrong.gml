...
set_window_value(AT_USTRONG, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.45);
...
set_window_value(AT_USTRONG, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.45);
...
set_window_value(AT_USTRONG, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.3);
...
set_window_value(AT_USTRONG, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.3);
...
set_window_value(AT_USTRONG, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.3);
...
set_hitbox_value(AT_USTRONG, 3, HG_BASE_KNOCKBACK, 5);//3
...
set_hitbox_value(AT_USTRONG, 4, HG_HITBOX_Y, -86);//-74
set_hitbox_value(AT_USTRONG, 4, HG_WIDTH, 158);
set_hitbox_value(AT_USTRONG, 4, HG_HEIGHT, 54);//75
set_hitbox_value(AT_USTRONG, 4, HG_SHAPE, 2);
set_hitbox_value(AT_USTRONG, 4, HG_DAMAGE, 4);//3
set_hitbox_value(AT_USTRONG, 4, HG_ANGLE, 79);
...
set_hitbox_value(AT_USTRONG, 4, HG_KNOCKBACK_SCALING, 1.1);//0.94//0.98
