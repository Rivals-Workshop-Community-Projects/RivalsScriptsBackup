...
if (my_hitboxID.attack == AT_USPECIAL){//as per request
	if (my_hitboxID.hbox_num==5){
		if (na_dsp_charge < dspmax){
			//print(string(ceil((4-my_hitboxID.hbox_num)*1.5)))
			na_dsp_charge += ceil((1)*1.5);
			white_flash_timer = 6;
			sound_play(sound_get("tic"));
			clock_timer = clock_dur;
			if (na_dsp_charge >= dspmax){
...
if (my_hitboxID.attack == AT_NSPECIAL_AIR){
	...
	//print(string(my_hitboxID))
	//print(string(my_hitboxID.leaderhb))
	//print(string(my_hitboxID.leaderhb.idbox[4]))
	//my_hitboxID.leaderhb.idbox[0].can_hit[hit_player] = false;
	//my_hitboxID.leaderhb.idbox[1].can_hit[hit_player] = false;
	//my_hitboxID.leaderhb.idbox[2].can_hit[hit_player] = false;
	//my_hitboxID.leaderhb.idbox[3].can_hit[hit_player] = false;
	//my_hitboxID.leaderhb.idbox[4].can_hit[hit_player] = false;
	/*with(my_hitboxID){
		leaderhb.idbox[0].can_hit[hit_player] = false;
		leaderhb.idbox[1].can_hit[hit_player] = false;
		leaderhb.idbox[2].can_hit[hit_player] = false;
		leaderhb.idbox[3].can_hit[hit_player] = false;
		leaderhb.idbox[4].can_hit[hit_player] = false;
	}*/
	//print(string(my_hitboxID.leaderhb.idbox[4].can_hit))
