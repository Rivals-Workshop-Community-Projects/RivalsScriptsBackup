...
set_color_profile_slot_range( 3, 15, 23, 34 );
...
set_color_profile_slot( 1, 1, 44, 53, 113 ); //main.2
set_color_profile_slot( 1, 2, 29, 33, 91 ); //main.3
set_color_profile_slot( 1, 3, 58, 154, 228 ); //purple
...
set_color_profile_slot( 1, 7, 168, 230, 230 ); //blade.2

// fire
set_color_profile_slot( 2, 0, 122, 112, 78 ); //main
set_color_profile_slot( 2, 1, 102, 90, 57 ); //main.2
set_color_profile_slot( 2, 2, 69, 54, 43 ); //main.3
...
set_color_profile_slot( 2, 7, 255, 115, 0 ); //blade.2

// earth
set_color_profile_slot( 3, 0, 50, 54, 40 ); //main
set_color_profile_slot( 3, 1, 32, 35, 25 ); //main.2
set_color_profile_slot( 3, 2, 19, 20, 14 ); //main.3
...
set_color_profile_slot( 3, 7, 127, 166, 92 ); //blade.2

// Axanthic
set_color_profile_slot( 4, 0, 75, 78, 82 ); //main
set_color_profile_slot( 4, 1, 50, 56, 56 ); //main.2
set_color_profile_slot( 4, 2, 31, 36, 41 ); //main.3
set_color_profile_slot( 4, 3, 130, 97, 125 ); //purple
...
set_color_profile_slot( 5, 2, 54, 55, 71 ); //main.3
...
// doomsday
set_color_profile_slot( 11, 0, 43, 71, 52 ); //main
set_color_profile_slot( 11, 1, 21, 43, 31 ); //main.2
set_color_profile_slot( 11, 2, 11, 23, 19 ); //main.3
