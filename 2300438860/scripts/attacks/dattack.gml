...
set_hitbox_value(AT_DATTACK, 2, HG_ANGLE, 44);
...
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, sound_get("hstrong"));
...
set_hitbox_value(AT_DATTACK, 1, HG_HITBOX_Y, -82);
...
set_hitbox_value(AT_DATTACK, 1, HG_ANGLE, 44);
...
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, sound_get("hstrong"));
