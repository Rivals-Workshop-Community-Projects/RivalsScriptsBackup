...
sprite_index = sprite_get("super_vac_idle");           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
mask_index = sprite_get("super_vac_hurt");
...
nspecial_shot = false;
nspecial_proj1 = noone;
nspecial_proj2 = noone;
nspecial_proj3 = noone;

vacuum_myself = false;

grabbed_opponent = noone;
