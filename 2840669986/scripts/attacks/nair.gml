...
set_hitbox_value(AT_NAIR, 1, HG_BASE_KNOCKBACK, multihit_base_kb);
set_hitbox_value(AT_NAIR, 1, HG_BASE_HITPAUSE, multihit_hitpause);
...
set_hitbox_value(AT_NAIR, 2, HG_BASE_KNOCKBACK, multihit_base_kb);
set_hitbox_value(AT_NAIR, 2, HG_BASE_HITPAUSE, multihit_hitpause);
...
set_hitbox_value(AT_NAIR, 3, HG_BASE_KNOCKBACK, multihit_base_kb);
set_hitbox_value(AT_NAIR, 3, HG_BASE_HITPAUSE, multihit_hitpause);
...
set_hitbox_value(AT_NAIR, 4, HG_BASE_KNOCKBACK, multihit_base_kb);
set_hitbox_value(AT_NAIR, 4, HG_BASE_HITPAUSE, multihit_hitpause);
