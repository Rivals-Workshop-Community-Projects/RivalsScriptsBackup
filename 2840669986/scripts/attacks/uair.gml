...
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, sfx_star_allies_cleaning_swipe_1);
...
set_hitbox_value(AT_UAIR, 1, HG_HITBOX_Y, -31);
set_hitbox_value(AT_UAIR, 1, HG_WIDTH, 57);
...
set_hitbox_value(AT_UAIR, 2, HG_HEIGHT, 61);
...
set_hitbox_value(AT_UAIR, 4, HG_HEIGHT, 58);
