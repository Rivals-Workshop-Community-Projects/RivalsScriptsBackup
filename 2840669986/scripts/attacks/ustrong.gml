...
set_window_value(AT_USTRONG, 3, AG_WINDOW_LENGTH, 6 + (ustrongJumpRune*3));
...
set_hitbox_value(AT_USTRONG, 1, HG_LIFETIME, 2 + ustrongJumpRune);
...
set_hitbox_value(AT_USTRONG, 2, HG_WINDOW_CREATION_FRAME, 2 + ustrongJumpRune);
set_hitbox_value(AT_USTRONG, 2, HG_LIFETIME, 2 + ustrongJumpRune);
...
set_hitbox_value(AT_USTRONG, 3, HG_WINDOW_CREATION_FRAME, 4 + (ustrongJumpRune * 2));
set_hitbox_value(AT_USTRONG, 3, HG_LIFETIME, 2 + ustrongJumpRune);
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_X, -31);
