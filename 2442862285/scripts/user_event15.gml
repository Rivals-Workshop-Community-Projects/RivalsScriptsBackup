...
with self{
	...
	initCheat("Say woag", "cheat_funny_snail", [0, 1], ["no", "yes"], "in loving memory");
...
with phone{
	...
	initAbout("About Alto", "Character made by Muno!
