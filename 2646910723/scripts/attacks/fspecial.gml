...
set_window_value(AT_EXTRA_1, 2, AG_WINDOW_LENGTH, 36);
...
set_window_value(AT_EXTRA_1, 3, AG_WINDOW_ANIM_FRAME_START, 22);
...
set_window_value(AT_EXTRA_1, 4, AG_WINDOW_ANIM_FRAME_START, 24);
...
set_hitbox_value(AT_EXTRA_1, 1, HG_HEIGHT, 200);
