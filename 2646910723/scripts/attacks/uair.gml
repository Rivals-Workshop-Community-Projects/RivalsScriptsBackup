...
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, sound_get("swingw1"));
...
set_window_value(AT_UAIR, 6, AG_WINDOW_TYPE, 7);
...
set_hitbox_value(AT_UAIR, 1, HG_IGNORES_PROJECTILES, true);

set_hitbox_value(AT_UAIR, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_UAIR, 2, HG_WINDOW, 99);
...
set_hitbox_value(AT_UAIR, 2, HG_WIDTH, 140);
...
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, sound_get("punch"));
set_hitbox_value(AT_UAIR, 2, HG_HITSTUN_MULTIPLIER, 1);
set_hitbox_value(AT_UAIR, 2, HG_SDI_MULTIPLIER, .001);
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT, 303);
set_hitbox_value(AT_UAIR, 2, HG_IGNORES_PROJECTILES, true);
