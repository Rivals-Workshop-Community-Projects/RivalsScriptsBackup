...
set_window_value(AT_JAB, 4, AG_WINDOW_SFX, asset_get("sfx_clairen_poke_weak"));
...
set_window_value(AT_JAB, 7, AG_WINDOW_LENGTH, 1);
set_window_value(AT_JAB, 7, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_JAB, 7, AG_WINDOW_ANIM_FRAME_START, 1);
set_window_value(AT_JAB, 7, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_JAB, 7, AG_WINDOW_SFX, asset_get("sfx_clairen_poke_med"));
...
set_window_value(AT_JAB, 8, AG_WINDOW_SFX, asset_get("sfx_clairen_poke_med"));
...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, asset_get("sfx_ori_energyhit_weak"));
...
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, asset_get("sfx_ori_energyhit_weak"));
...
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, asset_get("sfx_ori_energyhit_weak"));
...
set_hitbox_value(AT_JAB, 4, HG_HIT_SFX, asset_get("sfx_ori_energyhit_weak"));
...
set_hitbox_value(AT_JAB, 5, HG_HEIGHT, 36);
...
set_hitbox_value(AT_JAB, 5, HG_HIT_SFX, asset_get("sfx_ori_energyhit_weak"));
set_hitbox_value(AT_JAB, 5, HG_SHAPE, 2);
set_hitbox_value(AT_JAB, 5, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_JAB, 5, HG_HITSTUN_MULTIPLIER, 1.2);