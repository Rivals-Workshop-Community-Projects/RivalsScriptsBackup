...
set_window_value(AT_FAIR, 2, AG_WINDOW_SFX, asset_get("sfx_clairen_swing_med"));
...
set_hitbox_value(AT_FAIR, 2, HG_HIT_SFX, asset_get("sfx_clairen_tip_weak"));
...
set_hitbox_value(AT_FAIR, 3, HG_WIDTH, 46);
...
set_hitbox_value(AT_FAIR, 3, HG_VISUAL_EFFECT_X_OFFSET, 2);
set_hitbox_value(AT_FAIR, 3, HG_HIT_SFX, asset_get("sfx_ori_energyhit_heavy"));
set_hitbox_value(AT_FAIR, 3, HG_HITSTUN_MULTIPLIER, 0.9);