...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, asset_get("sfx_clairen_swing_med"));
...
set_window_value(AT_NAIR, 2, AG_WINDOW_SFX, asset_get("sfx_clairen_swing_weak"));
...
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, asset_get("sfx_ori_energyhit_weak"));
