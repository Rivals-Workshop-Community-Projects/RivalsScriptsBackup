...
set_window_value(AT_USTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_ori_charged_flame_release"));
...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_ori_energyhit_medium"));
...
set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_ori_energyhit_heavy"));
...
set_window_value(AT_USTRONG, 4, AG_WINDOW_SFX, asset_get("sfx_ori_energyhit_weak"));
...
set_hitbox_value(AT_USTRONG, 1, HG_HITPAUSE_SCALING, .21);
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, asset_get("sfx_clairen_tip_weak"));
...
set_hitbox_value(AT_USTRONG, 2, HG_HITPAUSE_SCALING, .21);
...
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_Y, -66);
...
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, asset_get("sfx_clairen_tip_strong"));
