...
set_hitbox_value(AT_FTILT, 1, HG_WIDTH, 126);
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, sound_get("sliceh2"));
set_hitbox_value(AT_FTILT, 1, HG_HITSTUN_MULTIPLIER, 1.0);
...
set_hitbox_value(AT_FTILT, 2, HG_WIDTH, 146);
