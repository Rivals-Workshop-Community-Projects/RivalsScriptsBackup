...
set_window_value(AT_USTRONG, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.5);
...
set_window_value(AT_USTRONG, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, 1);
...
set_hitbox_value(AT_USTRONG, 4, HG_VISUAL_EFFECT, 111);
