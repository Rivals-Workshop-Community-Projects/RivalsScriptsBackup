...
set_window_value(AT_DSTRONG, 13, AG_WINDOW_LENGTH, 20);
//set_window_value(AT_DSTRONG, 10, AG_WINDOW_HSPEED_TYPE, 1);
//set_window_value(AT_DSTRONG, 10, AG_WINDOW_HSPEED, -5);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HEIGHT, 21);
...
set_hitbox_value(AT_DSTRONG, 9, HG_KNOCKBACK_SCALING, 0.7);
set_hitbox_value(AT_DSTRONG, 9, HG_BASE_HITPAUSE, 30);
set_hitbox_value(AT_DSTRONG, 9, HG_EXTRA_HITPAUSE, 20);
