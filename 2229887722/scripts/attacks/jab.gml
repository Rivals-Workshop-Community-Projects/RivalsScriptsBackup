...
//set_window_value(AT_JAB, 4, AG_WINDOW_HSPEED, 8);
...
set_window_value(AT_JAB, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.75);
...
set_window_value(AT_JAB, 6, AG_WINDOW_ANIM_FRAME_START, 23);
set_window_value(AT_JAB, 6, AG_WINDOW_HSPEED, 6);
...
set_window_value(AT_JAB, 7, AG_WINDOW_ANIM_FRAME_START, 23);
...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, asset_get("sfx_ori_spirit_flame_hit_1"));
...
set_hitbox_value(AT_JAB, 6, HG_HITBOX_X, 14);
set_hitbox_value(AT_JAB, 6, HG_HITBOX_Y, -26);
set_hitbox_value(AT_JAB, 6, HG_WIDTH, 56);
...
set_hitbox_value(AT_JAB, 7, HG_HIT_SFX, asset_get("sfx_ori_spirit_flame_hit_1"));
