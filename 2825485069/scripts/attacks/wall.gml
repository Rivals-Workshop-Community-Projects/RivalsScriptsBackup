...
set_hitbox_value(AT_JAB, 1, HG_HITPAUSE_SCALING, .85);
...
set_hitbox_value(AT_JAB, 1, HG_WIDTH, 8 * 32);
set_hitbox_value(AT_JAB, 1, HG_HEIGHT, 3 * 32);
...
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_SPRITE, /*sprite_get("skullon")); ///**/asset_get("empty_sprite"));
