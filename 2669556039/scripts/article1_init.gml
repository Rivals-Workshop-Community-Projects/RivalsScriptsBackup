...
sprite_index = asset_get("empty_sprite");//sprite_get("dspecialHead");           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
mask_index = sprite_get("dspecialHeadMask");//stil not accurate?
