...
set_window_value(AT_FTILT, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.75); //more means less far on dash
...
set_window_value(AT_FTILT, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.25);
set_window_value(AT_FTILT, 2, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(AT_FTILT, 2, AG_WINDOW_HSPEED, 2);
//set_window_value(AT_FTILT, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.5);
...
set_window_value(AT_FTILT, 3, AG_WINDOW_VSPEED, -3);
...
set_window_value(AT_FTILT, 4, AG_WINDOW_SFX, asset_get("sfx_land"));
...
set_hitbox_value(AT_FTILT, 1, HG_HITBOX_Y, -64);
