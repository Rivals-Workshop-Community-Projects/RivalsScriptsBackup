...
sprite_index = sprite_get("toxicCloud");//sprite_get("dspecialHead");           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
mask_index = sprite_get("toxicCloud");//stil not accurate?
