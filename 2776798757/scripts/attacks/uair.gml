...
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, asset_get("sfx_coin_collect"));
...
set_hitbox_value(AT_UAIR, 3, HG_LIFETIME, 10);
...
set_hitbox_value(AT_UAIR, 3, HG_PROJECTILE_VSPEED, -10);
...
set_hitbox_value(AT_UAIR, 5, HG_LIFETIME, 7);
...
set_hitbox_value(AT_UAIR, 5, HG_PROJECTILE_VSPEED, 10);
set_hitbox_value(AT_UAIR, 5, HG_PROJECTILE_HSPEED, 10);
...
set_hitbox_value(AT_UAIR, 6, HG_LIFETIME, 7);
set_hitbox_value(AT_UAIR, 6, HG_HITBOX_X, 50);
set_hitbox_value(AT_UAIR, 6, HG_HITBOX_Y, -100);
set_hitbox_value(AT_UAIR, 6, HG_PROJECTILE_SPRITE, sprite_get("uair_proj"));
set_hitbox_value(AT_UAIR, 6, HG_PROJECTILE_MASK, sprite_get("uair_proj"));
set_hitbox_value(AT_UAIR, 6, HG_PROJECTILE_ANIM_SPEED, 0.5);
set_hitbox_value(AT_UAIR, 6, HG_PROJECTILE_VSPEED, 10);
set_hitbox_value(AT_UAIR, 6, HG_PROJECTILE_HSPEED, -10);
...
set_hitbox_value(AT_UAIR, 7, HG_LIFETIME, 7);
set_hitbox_value(AT_UAIR, 7, HG_HITBOX_X, 30);
set_hitbox_value(AT_UAIR, 7, HG_HITBOX_Y, -80);
set_hitbox_value(AT_UAIR, 7, HG_PROJECTILE_SPRITE, sprite_get("uair_proj"));
set_hitbox_value(AT_UAIR, 7, HG_PROJECTILE_MASK, sprite_get("uair_proj"));
set_hitbox_value(AT_UAIR, 7, HG_PROJECTILE_ANIM_SPEED, 0.5);
set_hitbox_value(AT_UAIR, 7, HG_PROJECTILE_VSPEED, -10);
set_hitbox_value(AT_UAIR, 7, HG_PROJECTILE_HSPEED, 10);
...
set_hitbox_value(AT_UAIR, 8, HG_LIFETIME, 7);
set_hitbox_value(AT_UAIR, 8, HG_HITBOX_X, 50);
set_hitbox_value(AT_UAIR, 8, HG_HITBOX_Y, -80);
set_hitbox_value(AT_UAIR, 8, HG_PROJECTILE_SPRITE, sprite_get("uair_proj"));
set_hitbox_value(AT_UAIR, 8, HG_PROJECTILE_MASK, sprite_get("uair_proj"));
set_hitbox_value(AT_UAIR, 8, HG_PROJECTILE_ANIM_SPEED, 0.5);
set_hitbox_value(AT_UAIR, 8, HG_PROJECTILE_VSPEED, -10);
set_hitbox_value(AT_UAIR, 8, HG_PROJECTILE_HSPEED, -10);
set_hitbox_value(AT_UAIR, 8, HG_PROJECTILE_GROUND_BEHAVIOR, 1);
...
set_hitbox_value(AT_UAIR, 9, HG_WINDOW_CREATION_FRAME, 1);
set_hitbox_value(AT_UAIR, 9, HG_LIFETIME, 2);
set_hitbox_value(AT_UAIR, 9, HG_HITBOX_X, 0);
set_hitbox_value(AT_UAIR, 9, HG_HITBOX_Y, -80);
set_hitbox_value(AT_UAIR, 9, HG_WIDTH, 100);
set_hitbox_value(AT_UAIR, 9, HG_HEIGHT, 100);
set_hitbox_value(AT_UAIR, 9, HG_PRIORITY, 9);
...
set_hitbox_value(AT_UAIR, 9, HG_HIT_SFX, asset_get("sfx_blow_medium3"));
