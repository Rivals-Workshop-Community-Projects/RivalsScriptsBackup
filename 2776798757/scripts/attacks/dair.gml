...
set_window_value(AT_DAIR, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.9);
...
set_window_value(AT_DAIR, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 3);
...
set_window_value(AT_DAIR, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, -33);
