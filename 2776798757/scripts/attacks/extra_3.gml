...
set_window_value(AT_EXTRA_3, 4, AG_WINDOW_VSPEED, -1);
...
set_hitbox_value(AT_EXTRA_3, 2, HG_HITBOX_Y, -75);
...
set_hitbox_value(AT_EXTRA_3, 2, HG_HITPAUSE_SCALING, .85);
...
set_hitbox_value(AT_EXTRA_3, 2, HG_HITBOX_X, 10);
set_hitbox_value(AT_EXTRA_3, 2, HG_HITBOX_Y, -70);
...
set_hitbox_value(AT_EXTRA_3, 2, HG_DAMAGE, 17);
...
set_hitbox_value(AT_EXTRA_3, 2, HG_BASE_HITPAUSE, 30);
