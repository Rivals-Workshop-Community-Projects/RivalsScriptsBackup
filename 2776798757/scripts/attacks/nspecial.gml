...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_SFX, sound_get("lv1shot"));
...
set_window_value(AT_NSPECIAL, 4, AG_WINDOW_SFX, sound_get("chargeshotlv1"));
...
set_window_value(AT_NSPECIAL, 5, AG_WINDOW_SFX, sound_get("chargeshotlv2"));
...
set_hitbox_value(AT_NSPECIAL, 5, HG_HITBOX_X, 18);
...
set_hitbox_value(AT_NSPECIAL, 5, HG_DAMAGE, 16);
...
set_hitbox_value(AT_NSPECIAL, 5, HG_KNOCKBACK_SCALING, 1.2);
...
set_hitbox_value(AT_NSPECIAL, 5, HG_DAMAGE, 24);
