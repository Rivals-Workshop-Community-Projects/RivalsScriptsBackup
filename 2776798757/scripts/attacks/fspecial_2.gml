...
set_window_value(AT_FSPECIAL_2, 3, AG_WINDOW_LENGTH, 19);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_PROJECTILE_MASK, sprite_get("fspecial_2_proj_hurt"));
...
set_hitbox_value(AT_FSPECIAL_2, 2, HG_PROJECTILE_MASK, sprite_get("fspecial_2_proj_hurt"));
