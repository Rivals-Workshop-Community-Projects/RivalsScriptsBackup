...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_ANIM_FRAME_START, 39);
...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_SFX, sound_get("boomerangcutter"));
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_ANIM_FRAME_START, 42);

set_window_value(AT_FSPECIAL, 3, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_LENGTH, 11);
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_ANIM_FRAME_START, 46);
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_CANCEL_FRAME, 1);
