...
alt_name[4] = "iX";
alt_name[5] = "PSX";
alt_name[6] = "PSX Cheat code";
alt_name[7] = "X6 Ultimate Armor";
alt_name[8] = "X-kai";
alt_name[9] = "Storm Tornado";
alt_name[10] = "Sonic Slicer";
alt_name[11] = "Triad Thunder";
alt_name[12] = "Rising Fire";
alt_name[13] = "Ground Hunter";
alt_name[14] = "Goo Shaver";
