...
#define draw_colored_hitboxes
{
    if (hbox_view)
    {
        ...
        draw_sprite_ext(hurtboxID.sprite_index, hurtboxID.image_index, hurtboxID.x, hurtboxID.y, hurtboxID.image_xscale, hurtboxID.image_yscale, hurtboxID.image_angle, -1, 0.5)
