set_attack_value(AT_USTRONG, AG_SPRITE, spr_ustrong);
set_attack_value(AT_USTRONG, AG_NUM_WINDOWS, 5);
set_attack_value(AT_USTRONG, AG_STRONG_CHARGE_WINDOW, 1);
set_attack_value(AT_USTRONG, AG_HURTBOX_SPRITE, sprite_get("ustrong_hurt"));
set_attack_value(AT_USTRONG, AG_HURTBOX_AIR_SPRITE, sprite_get("ustrong_air_hurt"));
set_attack_value(AT_USTRONG, AG_OFF_LEDGE, 1);
set_attack_value(AT_USTRONG, AG_CATEGORY, 2);
set_attack_value(AT_USTRONG, AG_USES_CUSTOM_GRAVITY, 1);

set_window_value(AT_USTRONG, 1, AG_WINDOW_CUSTOM_GRAVITY, 0.25);
set_window_value(AT_USTRONG, 2, AG_WINDOW_CUSTOM_GRAVITY, 0.25);
set_window_value(AT_USTRONG, 3, AG_WINDOW_CUSTOM_GRAVITY, 0.25);
set_window_value(AT_USTRONG, 4, AG_WINDOW_CUSTOM_GRAVITY, 0.25);
set_window_value(AT_USTRONG, 5, AG_WINDOW_CUSTOM_GRAVITY, 0.25);

set_window_value(AT_USTRONG, 1, AG_WINDOW_LENGTH, strongstartup);
set_window_value(AT_USTRONG, 1, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_USTRONG, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_ice_uspecial_jump"));
...
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_Y, -106);
...
set_hitbox_value(AT_USTRONG, 1, HG_PRIORITY, 9);
...
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_Y, -156);
...
set_hitbox_value(AT_USTRONG, 3, HG_KNOCKBACK_SCALING, 0.3);
