...
else
{
    ...
    set_hitbox_value(AT_SKILL1, 1, HG_HIT_PARTICLE_NUM, 2);
    set_hitbox_value(AT_SKILL1, 2, HG_HIT_PARTICLE_NUM, 2);
    set_hitbox_value(AT_SKILL1, 3, HG_HIT_PARTICLE_NUM, 2);
    //air
    set_attack_value(AT_SKILL1_AIR, AG_SPRITE, sprite_get("burningfury_air"));
    set_hitbox_value(AT_SKILL1_AIR, 1, HG_HIT_PARTICLE_NUM, 2);
    set_hitbox_value(AT_SKILL1_AIR, 2, HG_HIT_PARTICLE_NUM, 2);
    ...
    set_hitbox_value(AT_SKILL5, 2, HG_HIT_PARTICLE_NUM, 2);
    set_hitbox_value(AT_SKILL5, 3, HG_HIT_PARTICLE_NUM, 2);
    set_hitbox_value(AT_SKILL5, 4, HG_HIT_PARTICLE_NUM, 2);
    ...
    for (var i = 0; i < 7; i++) set_hitbox_value(AT_SKILL10, i, HG_HIT_PARTICLE_NUM, 2);
    ...
    set_hitbox_value(AT_DSTRONG_2, 1, HG_PROJECTILE_SPRITE, sprite_get("fx_dstrong_fireball"));
