...
var window_num = 1; //windup and leg woosh
set_window_value(atk, window_num, AG_WINDOW_TYPE, 1);
set_window_value(atk, window_num, AG_WINDOW_LENGTH, 5); //controls speed
...
set_window_value(atk, window_num, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.1); //0.2
...
set_window_value(atk, window_num, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(atk, window_num, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.2); //0.3
...
set_hitbox_value(atk, hitbox_num, HG_WIDTH, 80); //66
set_hitbox_value(atk, hitbox_num, HG_HEIGHT, 40); //36
...
set_hitbox_value(atk, hitbox_num, HG_ANGLE, 75); //85
set_hitbox_value(atk, hitbox_num, HG_BASE_KNOCKBACK, 7); //8
set_hitbox_value(atk, hitbox_num, HG_KNOCKBACK_SCALING, 0.3);
set_hitbox_value(atk, hitbox_num, HG_BASE_HITPAUSE, 6); //5
set_hitbox_value(atk, hitbox_num, HG_HITPAUSE_SCALING, 0.2); //0.4
