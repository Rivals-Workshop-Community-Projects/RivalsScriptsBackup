...
set_attack_value(atk, AG_SPRITE, sprite_get("lightdagger"));
set_attack_value(atk, AG_HURTBOX_SPRITE, sprite_get("lightdagger_hurt"));
...
set_hitbox_value(atk, hitboxNum, HG_LIFETIME, 20); //excluded from HG_PARENT_HITBOX
...
set_hitbox_value(atk, hitboxNum, HG_PROJECTILE_HSPEED, 18);
...
set_hitbox_value(atk, hitboxNum, HG_LIFETIME, 20);
...
set_hitbox_value(atk, hitboxNum, HG_HITBOX_GROUP, -1);
set_hitbox_value(atk, hitboxNum, HG_HITBOX_TYPE, 2);
set_hitbox_value(atk, hitboxNum, HG_LIFETIME, 35); //burning fury stat
set_hitbox_value(atk, hitboxNum, HG_PRIORITY, 2);
...
set_hitbox_value(atk, hitboxNum, HG_PROJECTILE_ANIM_SPEED, 0.2);
set_hitbox_value(atk, hitboxNum, HG_PROJECTILE_HSPEED, 15); //burning fury stat
set_hitbox_value(atk, hitboxNum, HG_PROJECTILE_PARRY_STUN, 0);
set_hitbox_value(atk, hitboxNum, HG_PROJECTILE_WALL_BEHAVIOR, 0);
set_hitbox_value(atk, hitboxNum, HG_PROJECTILE_GROUND_BEHAVIOR, 0);
