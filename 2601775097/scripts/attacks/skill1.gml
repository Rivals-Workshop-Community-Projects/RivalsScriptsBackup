...
window_num ++; //multi hitting dash final hit
set_window_value(atk, window_num, AG_WINDOW_TYPE, 0);
set_window_value(atk, window_num, AG_WINDOW_LENGTH, 4);
set_window_value(atk, window_num, AG_WINDOW_ANIM_FRAMES, 4);
set_window_value(atk, window_num, AG_WINDOW_ANIM_FRAME_START, 13);
...
//PHASE 3 - ATTACK 2 (windows 13-15)
...
//set_hitbox_value(atk, hitbox_num, HG_ANGLE, 10); //doesn't matter cuz it's a command grab
set_hitbox_value(atk, hitbox_num, HG_BASE_KNOCKBACK, 2); //needs to be over 1
