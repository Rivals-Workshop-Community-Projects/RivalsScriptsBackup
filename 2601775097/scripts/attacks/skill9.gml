...
set_window_value(atk, window_num, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.6); //2
set_window_value(atk, window_num, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.3); //2
...
window_num ++; //charge
set_window_value(atk, window_num, AG_WINDOW_LENGTH, 8); //6
...
set_window_value(atk, window_num, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.6); //2
set_window_value(atk, window_num, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.3); //2
set_window_value(atk, window_num, AG_WINDOW_CUSTOM_GRAVITY, gravity_speed/10);
...
set_window_value(atk, window_num, AG_WINDOW_LENGTH, 26); //12
set_window_value(atk, window_num, AG_WINDOW_ANIM_FRAMES, 4); //3
set_window_value(atk, window_num, AG_WINDOW_ANIM_FRAME_START, 7); //8
...
set_hitbox_value(atk, hitbox_num, HG_LIFETIME, 30); //excluded from HG_PARENT_HITBOX
