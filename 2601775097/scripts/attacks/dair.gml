...
set_hitbox_value(atk, hitbox_num, HG_PRIORITY, 1); //4
...
set_hitbox_value(atk, hitbox_num, HG_BASE_HITPAUSE, 6); //4
set_hitbox_value(atk, hitbox_num, HG_HITPAUSE_SCALING, 0.2); //0.9
