...
set_window_value(atk, window_num, AG_WINDOW_VSPEED, -12); //-9.75
...
set_hitbox_value(atk, hitbox_num, HG_DAMAGE, 1); //2
...
set_hitbox_value(atk, hitbox_num, HG_BASE_KNOCKBACK, 5); //1
set_hitbox_value(atk, hitbox_num, HG_BASE_HITPAUSE, 3);
set_hitbox_value(atk, hitbox_num, HG_HITPAUSE_SCALING, 0.3);
set_hitbox_value(atk, hitbox_num, HG_SDI_MULTIPLIER, 0.5);
...
set_hitbox_value(atk, hitbox_num, HG_DAMAGE, 4); //6
...
set_hitbox_value(atk, hitbox_num, HG_KNOCKBACK_SCALING, 0.6); //0.8
...
set_hitbox_value(atk, hitbox_num, HG_LIFETIME, 4);
set_hitbox_value(atk, hitbox_num, HG_PRIORITY, 4);
set_hitbox_value(atk, hitbox_num, HG_DAMAGE, 2); //4
set_hitbox_value(atk, hitbox_num, HG_HITBOX_Y, -32);
