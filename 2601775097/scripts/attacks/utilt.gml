...
set_hitbox_value(atk, hitbox_num, HG_PRIORITY, 4); //1 = low priority over other moves || 10 = highest
...
set_hitbox_value(atk, hitbox_num, HG_BASE_HITPAUSE, 12); //hitstun
...
hitbox_num ++; //air poke
set_hitbox_value(atk, hitbox_num, HG_HITBOX_TYPE, 1); // 1 = physical attack || 2 = projectile
set_hitbox_value(atk, hitbox_num, HG_WINDOW, 3); //at which window from the above the attack is created
set_hitbox_value(atk, hitbox_num, HG_LIFETIME, 7); //hitbox duration in frames
set_hitbox_value(atk, hitbox_num, HG_WINDOW_CREATION_FRAME, 1); //the reason this is here is so it won't mess with the dust effects
...
set_hitbox_value(atk, hitbox_num, HG_ANGLE, 90); //was 100
set_hitbox_value(atk, hitbox_num, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(atk, hitbox_num, HG_KNOCKBACK_SCALING, 0.7);
set_hitbox_value(atk, hitbox_num, HG_BASE_HITPAUSE, 8); //hitstun
set_hitbox_value(atk, hitbox_num, HG_HITPAUSE_SCALING, 0.8); //hitstun
...
set_hitbox_value(atk, hitbox_num, HG_ANGLE_FLIPPER, 0); //was causing issues
