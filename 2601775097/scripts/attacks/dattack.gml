...
var window_num = 1; //attack 1 windup 
...
set_window_value(atk, window_num, AG_WINDOW_ANIM_FRAME_START, 1); //starting frame. starts from 0
set_window_value(atk, window_num, AG_WINDOW_HSPEED_TYPE, 2);
set_window_value(atk, window_num, AG_WINDOW_HSPEED, 10);
set_window_value(atk, window_num, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(atk, window_num, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.05);
...
set_window_value(atk, window_num, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(atk, window_num, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.2);

window_num ++; //attack 2 windup 
set_window_value(atk, window_num, AG_WINDOW_TYPE, 1);
set_window_value(atk, window_num, AG_WINDOW_LENGTH, 6); //controls speed
set_window_value(atk, window_num, AG_WINDOW_ANIM_FRAMES, 2); //frames amount on strip
...
var hitbox_num = 1; //attack 1
set_hitbox_value(atk, hitbox_num, HG_HITBOX_TYPE, 1); // 1 = physical attack || 2 = projectile
set_hitbox_value(atk, hitbox_num, HG_WINDOW, 2); //at which window from the above the attack is created
set_hitbox_value(atk, hitbox_num, HG_LIFETIME, 4); //hitbox duration in frames
...
set_hitbox_value(atk, hitbox_num, HG_ANGLE, 40); //35 allows it to be teched if they DI down
set_hitbox_value(atk, hitbox_num, HG_BASE_KNOCKBACK, 7); //8.5
set_hitbox_value(atk, hitbox_num, HG_BASE_HITPAUSE, 5); //hitstun
...
set_hitbox_value(atk, hitbox_num, HG_HITBOX_GROUP, hitbox_num); //it needs to be a different value for every different move in the file

hitbox_num ++; //attack 2
set_hitbox_value(atk, hitbox_num, HG_HITBOX_TYPE, 1); // 1 = physical attack || 2 = projectile
set_hitbox_value(atk, hitbox_num, HG_WINDOW, 5); //at which window from the above the attack is created
set_hitbox_value(atk, hitbox_num, HG_LIFETIME, 4); //hitbox duration in frames
...
set_hitbox_value(atk, hitbox_num, HG_BASE_HITPAUSE, 7); //hitstun
