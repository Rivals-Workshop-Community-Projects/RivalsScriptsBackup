...
set_attack_value(atk, AG_LANDING_LAG, 6); //4
...
set_hitbox_value(atk, hitbox_num, HG_KNOCKBACK_SCALING, 0.7); //0.8
set_hitbox_value(atk, hitbox_num, HG_BASE_HITPAUSE, 7); //6
set_hitbox_value(atk, hitbox_num, HG_HITPAUSE_SCALING, 0.4); //0.2
