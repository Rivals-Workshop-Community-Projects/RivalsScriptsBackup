...
var atk = AT_NSPECIAL_AIR;

set_attack_value(atk, AG_CATEGORY, 2);
set_attack_value(atk, AG_SPRITE, sprite_get("skill0_air"));
set_attack_value(atk, AG_HURTBOX_SPRITE, sprite_get("skill0_air_hurt"));
...
set_hitbox_value(atk, hitbox_num, HG_LIFETIME, 17);
...
set_hitbox_value(atk, hitbox_num, HG_HITBOX_GROUP, -1);
set_hitbox_value(atk, hitbox_num, HG_HITBOX_TYPE, 2);
set_hitbox_value(atk, hitbox_num, HG_LIFETIME, 32); //burning fury stat
set_hitbox_value(atk, hitbox_num, HG_PRIORITY, 2);
...
set_hitbox_value(atk, hitbox_num, HG_PROJECTILE_ANIM_SPEED, 0.1);
set_hitbox_value(atk, hitbox_num, HG_PROJECTILE_HSPEED, 12); //burning fury stat
set_hitbox_value(atk, hitbox_num, HG_PROJECTILE_VSPEED, 12); //burning fury stat
set_hitbox_value(atk, hitbox_num, HG_PROJECTILE_PARRY_STUN, 0);
set_hitbox_value(atk, hitbox_num, HG_PROJECTILE_WALL_BEHAVIOR, 1);
set_hitbox_value(atk, hitbox_num, HG_PROJECTILE_GROUND_BEHAVIOR, 1);
