...
set_hitbox_value(atk, hitboxNum, HG_LIFETIME, 24); //hitbox duration in frames
set_hitbox_value(atk, hitboxNum, HG_HITBOX_X, 18); //24
set_hitbox_value(atk, hitboxNum, HG_HITBOX_Y, -28);
set_hitbox_value(atk, hitboxNum, HG_WIDTH, 76); //60
set_hitbox_value(atk, hitboxNum, HG_HEIGHT, 38); //32
