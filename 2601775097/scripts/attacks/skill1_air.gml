...
set_attack_value(atk, AG_SPRITE, sprite_get("burningfury_air"));
set_attack_value(atk, AG_HURTBOX_SPRITE, sprite_get("burningfury_hurt"));
set_attack_value(atk, AG_HURTBOX_AIR_SPRITE, sprite_get("burningfury_air_hurt"));
...
set_window_value(atk, windowNum, AG_WINDOW_VSPEED_TYPE, 1);
set_window_value(atk, windowNum, AG_WINDOW_VSPEED, 7);
...
set_window_value(atk, windowNum, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.01);
...
set_hitbox_value(atk, hitboxNum, HG_BASE_KNOCKBACK, 4); //10
...
set_hitbox_value(atk, hitboxNum, HG_ANGLE, 320);
set_hitbox_value(atk, hitboxNum, HG_BASE_KNOCKBACK, 6); //10
set_hitbox_value(atk, hitboxNum, HG_KNOCKBACK_SCALING, 0.4); //0.6
...
set_hitbox_value(atk, hitboxNum, HG_DAMAGE, 5);
set_hitbox_value(atk, hitboxNum, HG_ANGLE, 335);
