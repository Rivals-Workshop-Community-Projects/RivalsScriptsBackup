...
sprite_change_offset("fx_burn", 16, 48);
...
sprite_change_offset("fx_skill5", 40, 16);
...
sprite_change_offset("fx_skill9_proj", 48, 16);
sprite_change_offset("fx_skill9_proj_burn", 64, 32);
sprite_change_offset("fx_skill9_chain", 7, 3);
sprite_change_offset("fx_skill10", 24, 60);
sprite_change_offset("fx_skill11_burst", 32, 126);
sprite_change_offset("fx_skill11_chasm", 64, 126);

sprite_change_offset("fx_rune_i", 16, 16);
...
sprite_change_offset("fx_ustrong2", 48, 0);
sprite_change_offset("fx_fstrong2", 28, 64);
sprite_change_offset("fx_dstrong2_smear", 48, 128);
sprite_change_offset("fx_dstrong2_proj", 16, 48);
...
sprite_change_offset("hitbox_skill5", 40, 16);
sprite_change_offset("hitbox_skill6", 16, 32);
