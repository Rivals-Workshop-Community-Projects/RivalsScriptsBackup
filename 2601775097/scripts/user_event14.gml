...
phone.attack_names = [
	...
	"UAir",
	"NAir",
	"FSpecial", //doesn't exist
	"DSpecial", //doesn't exist
	"USpecial", //doesn't exist
	"NSpecial", //doesn't exist
	"Theïkós FStrong",
	"Theïkós DStrong",
	"Theïkós UStrong",
...
draw_sprite_ext(sprite_get("_pho_icon"), 0, x + 180, y + 42, 2, 2, 0, c_white, 1);
