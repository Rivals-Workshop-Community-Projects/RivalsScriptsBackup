...
set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, sound_get("swing_sword2"));
...
set_hitbox_value(AT_FAIR, 1, HG_HITBOX_X, 71);
...
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, sound_get("hitSFX2"));
...
set_hitbox_value(AT_FAIR, 2, HG_HIT_SFX, sound_get("hitSFX2"));
