...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("swing_sword_large"));
...
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 77);
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 95);
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("enemy_damage2"));
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_GROUP, 1);

set_hitbox_value(AT_BAIR, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_BAIR, 2, HG_WINDOW, 2);
set_hitbox_value(AT_BAIR, 2, HG_LIFETIME, 4);
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_X, -17);
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_Y, -75);
set_hitbox_value(AT_BAIR, 2, HG_WIDTH, 91);
...
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, sound_get("enemy_damage2"));
