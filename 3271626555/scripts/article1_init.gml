...
sprite_index = sprite_get("soulmass");           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
...
orb_number = 0;
detection_hitbox = noone;
homing_soulmass = noone;
target_x = 0;
target_y = 0;
homing_dir = 0;
homing_hsp = 0;
...
player_id.nspecial_casted = true;
