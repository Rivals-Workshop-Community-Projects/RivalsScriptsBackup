...
set_hitbox_value(AT_UAIR, 4, HG_WIDTH, 64);
set_hitbox_value(AT_UAIR, 4, HG_HEIGHT, 64);
set_hitbox_value(AT_UAIR, 4, HG_PRIORITY, 1);
set_hitbox_value(AT_UAIR, 4, HG_DAMAGE, 6);
set_hitbox_value(AT_UAIR, 4, HG_ANGLE, 100);
set_hitbox_value(AT_UAIR, 4, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_UAIR, 4, HG_KNOCKBACK_SCALING, .45);
set_hitbox_value(AT_UAIR, 4, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_UAIR, 4, HG_HITPAUSE_SCALING, .3);
