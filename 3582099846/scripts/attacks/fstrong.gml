...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("sfx_heavy_swing"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_WIDTH, 93);
...
set_hitbox_value(AT_FSTRONG, 1, HG_EFFECT, 304);
