...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, asset_get("sfx_kragg_throw"));
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_HAS_WHIFFLAG, 3);
...
set_hitbox_value(AT_DATTACK, 1, HG_BASE_KNOCKBACK, 6.9);
