...
set_window_value(AT_FTILT, 4, AG_WINDOW_SFX, asset_get("sfx_shovel_swing_med1"));
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, sound_get("slicel"));
...
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, sound_get("slicel"));
...
set_hitbox_value(AT_FTILT, 3, HG_WIDTH, 124);
...
set_hitbox_value(AT_FTILT, 3, HG_HIT_SFX, sound_get("slice"));
set_hitbox_value(AT_FTILT, 3, HG_VISUAL_EFFECT, 306);
