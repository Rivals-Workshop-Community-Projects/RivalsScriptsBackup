...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_ori_glide_end"));
...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_ori_spirit_flame_1"));
...
set_hitbox_value(AT_DSTRONG, 5, HG_WIDTH, 185);
...
set_hitbox_value(AT_DSTRONG, 6, HG_WIDTH, 190);
set_hitbox_value(AT_DSTRONG, 6, HG_HEIGHT, 140);
...
set_hitbox_value(AT_DSTRONG, 6, HG_KNOCKBACK_SCALING, 0.95);
