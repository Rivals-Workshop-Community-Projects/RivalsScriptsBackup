...
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, sound_get("RI2"));
...
set_hitbox_value(AT_NSPECIAL, 7, HG_PRIORITY, 9);
...
set_hitbox_value(AT_NSPECIAL, 7, HG_KNOCKBACK_SCALING, 1.2);
set_hitbox_value(AT_NSPECIAL, 7, HG_BASE_HITPAUSE, 2);
...
set_hitbox_value(AT_NSPECIAL, 6, HG_WINDOW_CREATION_FRAME, 9);
