...
set_hitbox_value(AT_EXTRA_1, 6, HG_WIDTH, 60);
set_hitbox_value(AT_EXTRA_1, 6, HG_HEIGHT, 88);
...
set_hitbox_value(AT_EXTRA_1, 7, HG_WIDTH, 60);
set_hitbox_value(AT_EXTRA_1, 7, HG_HEIGHT, 88);
...
set_hitbox_value(AT_EXTRA_1, 7, HG_ANGLE_FLIPPER, 0);
...
set_hitbox_value(AT_EXTRA_1, 8, HG_WIDTH, 60);
set_hitbox_value(AT_EXTRA_1, 8, HG_HEIGHT, 88);
...
set_hitbox_value(AT_EXTRA_1, 8, HG_KNOCKBACK_SCALING, 0.8);
set_hitbox_value(AT_EXTRA_1, 8, HG_BASE_HITPAUSE, 12);
set_hitbox_value(AT_EXTRA_1, 8, HG_HITPAUSE_SCALING, .45);
set_hitbox_value(AT_EXTRA_1, 8, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_EXTRA_1, 8, HG_HIT_SFX, sound_get("SpaceCut"));
