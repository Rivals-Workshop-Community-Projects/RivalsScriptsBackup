...
set_hitbox_value(AT_DAIR, 1, HG_WIDTH, 98);
...
set_hitbox_value(AT_DAIR, 3, HG_HITBOX_Y, -38);
set_hitbox_value(AT_DAIR, 3, HG_WIDTH, 108);
...
set_hitbox_value(AT_DAIR, 3, HG_ANGLE_FLIPPER, 7);
...
set_hitbox_value(AT_DAIR, 4, HG_ANGLE_FLIPPER, 7);
...
set_hitbox_value(AT_DAIR, 5, HG_HITBOX_Y, -38);
set_hitbox_value(AT_DAIR, 5, HG_WIDTH, 98);
...
set_hitbox_value(AT_DAIR, 5, HG_ANGLE_FLIPPER, 7);
...
set_hitbox_value(AT_DAIR, 6, HG_HEIGHT, 28);
...
set_hitbox_value(AT_DAIR, 7, HG_HITBOX_Y, -7);
set_hitbox_value(AT_DAIR, 7, HG_WIDTH, 40);
set_hitbox_value(AT_DAIR, 7, HG_HEIGHT, 32);
set_hitbox_value(AT_DAIR, 7, HG_SHAPE, 2);
set_hitbox_value(AT_DAIR, 7, HG_PRIORITY, 5);
...
set_hitbox_value(AT_DAIR, 7, HG_KNOCKBACK_SCALING, 1.1);
set_hitbox_value(AT_DAIR, 7, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_DAIR, 7, HG_HITPAUSE_SCALING, 1.3);
