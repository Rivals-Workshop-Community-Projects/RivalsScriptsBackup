...
set_window_value(AT_UTHROW, 2, AG_WINDOW_SFX, asset_get("sfx_clairen_tip_med"));
set_window_value(AT_UTHROW, 2, AG_WINDOW_SFX_FRAME, 2);
...
set_window_value(AT_UTHROW, 4, AG_WINDOW_LENGTH, 6);
...
set_hitbox_value(AT_UTHROW, 1, HG_HITBOX_X, 57);
set_hitbox_value(AT_UTHROW, 1, HG_HITBOX_Y, -84);
set_hitbox_value(AT_UTHROW, 1, HG_WIDTH, 77);
...
set_hitbox_value(AT_UTHROW, 1, HG_HIT_SFX, asset_get("sfx_clairen_hit_med"));
...
set_hitbox_value(AT_UTHROW, 2, HG_HITBOX_X, 100);
set_hitbox_value(AT_UTHROW, 2, HG_HITBOX_Y, -115);
set_hitbox_value(AT_UTHROW, 2, HG_WIDTH, 25);
set_hitbox_value(AT_UTHROW, 2, HG_HEIGHT, 25);
...
set_hitbox_value(AT_UTHROW, 2, HG_PRIORITY, 4);
set_hitbox_value(AT_UTHROW, 2, HG_BASE_HITPAUSE, 9);
set_hitbox_value(AT_UTHROW, 2, HG_HITPAUSE_SCALING, .9);
set_hitbox_value(AT_UTHROW, 2, HG_VISUAL_EFFECT, 301);
set_hitbox_value(AT_UTHROW, 2, HG_HIT_SFX, asset_get("sfx_clairen_hit_med"));