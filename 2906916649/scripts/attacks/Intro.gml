...
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_LENGTH, 54);
...
set_window_value(AT_EXTRA_1, 3, AG_WINDOW_LENGTH, 50);
set_window_value(AT_EXTRA_1, 3, AG_WINDOW_ANIM_FRAMES, 9);
...
set_hitbox_value(AT_EXTRA_1, 3, HG_KNOCKBACK_SCALING, .4);
set_hitbox_value(AT_EXTRA_1, 3, HG_VISUAL_EFFECT, 3);
...
set_hitbox_value(AT_EXTRA_1, 3, HG_VISUAL_EFFECT_X_OFFSET, 30);
