...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sound_get("oops"));
...
set_window_value(AT_DATTACK, 4, AG_WINDOW_SFX, asset_get("sfx_blow_medium2"));
...
set_hitbox_value(AT_DATTACK, 1, HG_ANGLE, 300);
