...
switch(state) {
    case 1:
        ...
        switch(window) {
            ...
            case 2: //shot
                ...
                if window_timer == 12 { 
                	...
                	sound_play(sound_get("BombardmentPronounce10"));
                    InkstrikeBomb = create_hitbox(AT_DSPECIAL,4,x - 0 * spr_dir, y - 40);
                    InkstrikeBomb.spr_dir = spr_dir; //projectile spr_dir is currently broke apparently so we gotta do this
                    InkstrikeBomb.draw_xscale = spr_dir;
                    InkstrikeBomb.vsp = -15;
                    InkstrikeBomb.hsp = 4 * spr_dir;
                }
                break;
            case 3: //endlag
                window_length = 20;
        ...
        break;
    case 2:
        sprite_index = sprite_get("bobble_squib_soul");
        last_window = 1;
        ignores_walls = true;
        ...
        switch(window) {
            case 1: //thrown
                ...
                if window_timer == 1 {
                    vsp = -5;
                    sound_stop(sound_get("VoiceMComeOn02"));
                    sound_play(sound_get("BobbleDead"));
        ...
        break;
    case 3:
        sprite_index = sprite_get("taunt_bobble_gritty");
        last_window = 3;
        switch(window) {
            case 1: //startup
                window_length = 30;
        ...
        break;
    case 4:
        sprite_index = sprite_get("taunt_bobble");
        last_window = 3;
        switch(window) {
            case 1: //startup
                window_length = 25;
