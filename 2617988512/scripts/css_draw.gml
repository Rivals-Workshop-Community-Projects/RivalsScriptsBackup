...
alt_name[0]		= "Business Casual";
alt_name[1]		= "Green";
alt_name[2]		= "Purple";
alt_name[3]		= "Gold";
alt_name[4]		= "Transcendance";
alt_name[5]		= "Komato Assassin";
alt_name[6]		= "Angry Fox";
alt_name[7]		= "Muscular Platypus";
alt_name[8]		= "Cyborg Cat";
alt_name[9]		= "Goofy Sea Sponge";
alt_name[10]	= "Chubby Starfish";
alt_name[11]	= "Greedy Crab";
alt_name[12]	= "Big Shot";
alt_name[13]	= "Super Saiyan Warrior";
alt_name[14]	= "Amog";
