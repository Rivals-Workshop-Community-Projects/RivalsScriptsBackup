...
set_hitbox_value(AT_UTILT, 1, HG_BASE_KNOCKBACK, 9); //8
set_hitbox_value(AT_UTILT, 1, HG_KNOCKBACK_SCALING, .5); //0.62
...
set_hitbox_value(AT_UTILT, 2, HG_BASE_KNOCKBACK, 9); //8
set_hitbox_value(AT_UTILT, 2, HG_KNOCKBACK_SCALING, .5); //0.62
