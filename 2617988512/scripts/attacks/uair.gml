...
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, sound_get("bcm_uair"));
...
set_hitbox_value(AT_UAIR, 1, HG_TECHABLE, 3);
...
set_hitbox_value(AT_UAIR, 2, HG_BASE_HITPAUSE, 1.5);
