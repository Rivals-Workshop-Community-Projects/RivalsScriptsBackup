...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, sound_get("bcm_uspecial_pull"));
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, sound_get("bcm_uspecial_shoot"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_HIT_SFX, sound_get("bcm_uspecial_hit"));