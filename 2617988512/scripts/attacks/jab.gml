...
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, sound_get("bcm_jab"));
...
set_window_value(AT_JAB, 3, AG_WINDOW_HAS_WHIFFLAG, 4);

set_window_value(AT_JAB, 4, AG_WINDOW_TYPE, 1);
set_window_value(AT_JAB, 4, AG_WINDOW_LENGTH, 6);
set_window_value(AT_JAB, 4, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_JAB, 4, AG_WINDOW_ANIM_FRAME_START, 4);
set_window_value(AT_JAB, 4, AG_WINDOW_HAS_WHIFFLAG, 6);
...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("bcm_blow_weak"));
