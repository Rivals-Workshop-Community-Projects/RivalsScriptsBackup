...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_HSPEED, 3.2);
...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sound_get("bcm_fspecial"));
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_orca_bite"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_orca_crunch"));