...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("bcm_nspecial"));
...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.8);
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.8);
...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_HAS_WHIFFLAG, 4);
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_VSPEED, 2.4);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HEIGHT, 74);
