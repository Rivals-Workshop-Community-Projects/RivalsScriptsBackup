...
//hitboxes 1-6 all have the same stats, but arent made parent hitboxes because the hitpause decreases with each hit
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("bcm_blow_weak"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("bcm_blow_weak"));
...
set_hitbox_value(AT_DSTRONG, 3, HG_ANGLE, 15);
...
set_hitbox_value(AT_DSTRONG, 3, HG_HIT_SFX, sound_get("bcm_blow_weak"));
...
set_hitbox_value(AT_DSTRONG, 4, HG_HITBOX_Y, -27);
...
set_hitbox_value(AT_DSTRONG, 4, HG_ANGLE, 15);
...
set_hitbox_value(AT_DSTRONG, 4, HG_HIT_SFX, sound_get("bcm_blow_weak"));
...
set_hitbox_value(AT_DSTRONG, 5, HG_HITBOX_X, 14);
...
set_hitbox_value(AT_DSTRONG, 5, HG_ANGLE, 15);
...
set_hitbox_value(AT_DSTRONG, 5, HG_HIT_SFX, sound_get("bcm_blow_weak"));
...
set_hitbox_value(AT_DSTRONG, 6, HG_LIFETIME, 1);
set_hitbox_value(AT_DSTRONG, 6, HG_HITBOX_X, 26);
set_hitbox_value(AT_DSTRONG, 6, HG_HITBOX_Y, -29);
...
set_hitbox_value(AT_DSTRONG, 6, HG_ANGLE, 15);
...
set_hitbox_value(AT_DSTRONG, 6, HG_HIT_SFX, sound_get("bcm_blow_weak"));
...
set_hitbox_value(AT_DSTRONG, 7, HG_HITBOX_X, 40);
