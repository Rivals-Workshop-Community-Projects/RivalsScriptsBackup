...
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX, sound_get("bcm_buy"));
...
set_window_value(AT_TAUNT, 5, AG_WINDOW_LENGTH, 14);
...
set_window_value(AT_TAUNT, 7, AG_WINDOW_LENGTH, 14);
set_window_value(AT_TAUNT, 7, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_TAUNT, 7, AG_WINDOW_ANIM_FRAME_START, 5);
