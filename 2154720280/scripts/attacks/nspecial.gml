...
set_hitbox_value(AT_NSPECIAL, 9, HG_HITBOX_X, 600);
set_hitbox_value(AT_NSPECIAL, 9, HG_HITBOX_Y, -44);
...
set_hitbox_value(AT_NSPECIAL, 9, HG_WIDTH, 1200);
set_hitbox_value(AT_NSPECIAL, 9, HG_HEIGHT, 35);
set_hitbox_value(AT_NSPECIAL, 9, HG_SHAPE, 1);
set_hitbox_value(AT_NSPECIAL, 9, HG_PRIORITY, 3);
set_hitbox_value(AT_NSPECIAL, 9, HG_DAMAGE, 20);
set_hitbox_value(AT_NSPECIAL, 9, HG_ANGLE, 40);
set_hitbox_value(AT_NSPECIAL, 9, HG_BASE_KNOCKBACK, 12);
set_hitbox_value(AT_NSPECIAL, 9, HG_KNOCKBACK_SCALING,1);
set_hitbox_value(AT_NSPECIAL, 9, HG_BASE_HITPAUSE, 12);
set_hitbox_value(AT_NSPECIAL, 9, HG_HITPAUSE_SCALING, 1.3);
set_hitbox_value(AT_NSPECIAL, 9, HG_EXTRA_HITPAUSE, 30);
