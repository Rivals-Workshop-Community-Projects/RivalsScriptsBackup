...
set_attack_value(AT_EXTRA_2, AG_SPRITE, sprite_get("taunt"));
set_attack_value(AT_EXTRA_2, AG_NUM_WINDOWS, 6);
set_attack_value(AT_EXTRA_2, AG_HAS_LANDING_LAG, 0);
set_attack_value(AT_EXTRA_2, AG_AIR_SPRITE, sprite_get("taunt"));
...
set_window_value(AT_EXTRA_2, 2, AG_WINDOW_LENGTH, 40);
...
set_window_value(AT_EXTRA_2, 2, AG_WINDOW_SFX, sound_get("supercombo"));
...
set_window_value(AT_EXTRA_2, 3, AG_WINDOW_SFX, sound_get("lazercharge"));
...
set_window_value(AT_EXTRA_2, 4, AG_WINDOW_HSPEED, -12);
...
set_hitbox_value(AT_EXTRA_2, 3, HG_LIFETIME, 15);
set_hitbox_value(AT_EXTRA_2, 3, HG_HITBOX_X, 880);
set_hitbox_value(AT_EXTRA_2, 3, HG_HITBOX_Y, -46);
...
set_hitbox_value(AT_EXTRA_2, 3, HG_HITSTUN_MULTIPLIER, 0.8);
...
set_hitbox_value(AT_EXTRA_2, 1, HG_HITBOX_X, 850);
set_hitbox_value(AT_EXTRA_2, 1, HG_HITBOX_Y, -46);
set_hitbox_value(AT_EXTRA_2, 1, HG_WIDTH, 1700);
...
set_hitbox_value(AT_EXTRA_2, 1, HG_KNOCKBACK_SCALING, 0.4);
...
set_hitbox_value(AT_EXTRA_2, 2, HG_KNOCKBACK_SCALING, 0.4);
set_hitbox_value(AT_EXTRA_2, 2, HG_BASE_HITPAUSE, 1);
