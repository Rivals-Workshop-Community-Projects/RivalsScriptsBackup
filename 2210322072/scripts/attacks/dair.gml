...
set_hitbox_value(AT_DAIR, 1, HG_ANGLE, 96);
...
set_hitbox_value(AT_DAIR, 3, HG_ANGLE, 56);
...
set_hitbox_value(AT_DAIR, 4, HG_BASE_HITPAUSE, 12);
...
set_hitbox_value(AT_DAIR, 5, HG_ANGLE, 110);
...
set_hitbox_value(AT_DAIR, 5, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_DAIR, 4, HG_HITSTUN_MULTIPLIER, 0.95);
