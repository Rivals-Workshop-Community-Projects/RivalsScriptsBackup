set_attack_value(AT_BAIR, AG_SPRITE, sprite_get("fair"));
set_attack_value(AT_BAIR, AG_NUM_WINDOWS, 8);
set_attack_value(AT_BAIR, AG_HURTBOX_SPRITE, sprite_get("fair_hurt"));
...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, asset_get("sfx_ice_on_player"));
...
set_window_value(AT_BAIR, 5, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy2"))
...
set_window_value(AT_BAIR, 6, AG_WINDOW_SFX, asset_get("sfx_ice_on_player"));

set_window_value(AT_BAIR, 7, AG_WINDOW_TYPE, 1);
set_window_value(AT_BAIR, 7, AG_WINDOW_LENGTH, 8);
set_window_value(AT_BAIR, 7, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_BAIR, 7, AG_WINDOW_ANIM_FRAME_START, 11);
...
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 74);
...
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_Y, -74);
...
set_hitbox_value(AT_BAIR, 2, HG_HITSTUN_MULTIPLIER, .85);
...
set_hitbox_value(AT_BAIR, 3, HG_WIDTH, 98);
...
set_hitbox_value(AT_BAIR, 3, HG_KNOCKBACK_SCALING, 0.2);
...
set_hitbox_value(AT_BAIR, 3, HG_HIT_SFX, sound_get("strong1"));
set_hitbox_value(AT_BAIR, 3, HG_HITSTUN_MULTIPLIER, 0.9);
...
set_hitbox_value(AT_BAIR,4, HG_LIFETIME, 7);
set_hitbox_value(AT_BAIR,4, HG_HITBOX_X, 22);
set_hitbox_value(AT_BAIR,4, HG_HITBOX_Y, -62);
...
set_hitbox_value(AT_BAIR,4, HG_HIT_SFX, sound_get("strong1"));
set_hitbox_value(AT_BAIR,4, HG_HITSTUN_MULTIPLIER, 0.9);
