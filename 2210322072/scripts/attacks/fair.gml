...
set_window_value(AT_FAIR, 5, AG_WINDOW_SFX_FRAME, 7);
set_window_value(AT_FAIR, 5, AG_WINDOW_SFX, asset_get("sfx_ice_on_player"));
...
set_hitbox_value(AT_FAIR, 3, HG_SDI_MULTIPLIER, 0.7);
