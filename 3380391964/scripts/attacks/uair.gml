...
set_window_value(AT_UAIR, 2, AG_WINDOW_SFX, asset_get("sfx_forsburn_cape_swipe"));
...
set_window_value(AT_UAIR, 3, AG_WINDOW_SFX, asset_get("sfx_frog_jab"));
...
set_hitbox_value(AT_UAIR, 3, HG_HITBOX_Y, -69);
