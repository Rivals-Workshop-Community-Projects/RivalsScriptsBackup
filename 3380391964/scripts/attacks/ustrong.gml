...
set_window_value(AT_USTRONG, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, .005);
set_window_value(AT_USTRONG, 1, AG_WINDOW_CUSTOM_GRAVITY, .25);
...
set_window_value(AT_USTRONG, 2, AG_WINDOW_CUSTOM_GRAVITY, .25);
set_window_value(AT_USTRONG, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, .25);
...
set_window_value(AT_USTRONG, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, .005);
set_window_value(AT_USTRONG, 3, AG_WINDOW_CUSTOM_GRAVITY, .25);
...
set_window_value(AT_USTRONG, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, .005);
set_window_value(AT_USTRONG, 4, AG_WINDOW_CUSTOM_GRAVITY, 3.5);
...
set_window_value(AT_USTRONG, 5, AG_WINDOW_CUSTOM_GRAVITY, .45);
...
set_window_value(AT_USTRONG, 6, AG_WINDOW_CUSTOM_GRAVITY, gravity_speed);
