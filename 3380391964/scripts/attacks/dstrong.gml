...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, .01);
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_forsburn_cape_swipe"));
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, 10);
