...
set_hitbox_value(atk, hitbox_num, HG_HITBOX_X, -37); //these offsets reflect the effect's offsets
set_hitbox_value(atk, hitbox_num, HG_HITBOX_Y, -44); //the (-5, +2) offsets correspond to hsp and vsp, since tester moves at this point
...
set_hitbox_value(atk, hitbox_num, HG_VISUAL_EFFECT, HFX_GEN_BIG);
