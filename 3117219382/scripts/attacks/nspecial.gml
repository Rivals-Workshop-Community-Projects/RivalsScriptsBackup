...
set_window_value(atk, window_num, AG_WINDOW_SFX, sound_get("desp_cointoss"));
...
set_hitbox_value(atk, hitbox_num, HG_LIFETIME, 74);
...
set_hitbox_value(atk, hitbox_num, HG_HIT_SFX, asset_get("sfx_may_arc_hit"));
