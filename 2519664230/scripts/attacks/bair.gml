...
set_hitbox_value(AT_BAIR, 1, HG_SDI_MULTIPLIER, 0.5);
...
set_hitbox_value(AT_BAIR, 4, HG_HITBOX_X, -55);
...
set_hitbox_value(AT_BAIR, 5, HG_WINDOW_CREATION_FRAME, 8);
set_hitbox_value(AT_BAIR, 5, HG_HITBOX_X, -60);
set_hitbox_value(AT_BAIR, 5, HG_HITBOX_Y, -25);
set_hitbox_value(AT_BAIR, 5, HG_WIDTH, 58);
set_hitbox_value(AT_BAIR, 5, HG_HEIGHT, 37);
...
set_hitbox_value(AT_BAIR, 5, HG_KNOCKBACK_SCALING, .55);
set_hitbox_value(AT_BAIR, 5, HG_BASE_HITPAUSE, 9);
