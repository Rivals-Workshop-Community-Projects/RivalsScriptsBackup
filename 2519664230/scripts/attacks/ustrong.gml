...
set_hitbox_value(AT_USTRONG, 1, HG_WIDTH, 27);
...
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_X, 39);
...
set_hitbox_value(AT_USTRONG, 3, HG_WIDTH, 27);
...
set_hitbox_value(AT_USTRONG, 3, HG_VISUAL_EFFECT, 150);
set_hitbox_value(AT_USTRONG, 3, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, asset_get("sfx_waterhit_medium"));
...
set_hitbox_value(AT_USTRONG, 4, HG_HITBOX_X, 39);
...
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_X, -43);
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_Y, -40);
set_hitbox_value(AT_USTRONG, 5, HG_WIDTH, 27);
set_hitbox_value(AT_USTRONG, 5, HG_HEIGHT, 92);
...
set_hitbox_value(AT_USTRONG, 6, HG_HITBOX_X, 37);
