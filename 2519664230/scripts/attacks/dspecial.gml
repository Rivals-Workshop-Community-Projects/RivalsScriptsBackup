...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_bubblespray"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("bubbles"));
set_hitbox_value(AT_DSPECIAL, 1, HG_WINDOW, 10);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("bubbles"));
...
set_hitbox_value(AT_DSPECIAL, 2, HG_KNOCKBACK_SCALING, .15);
set_hitbox_value(AT_DSPECIAL, 2, HG_BASE_HITPAUSE, 3);
set_hitbox_value(AT_DSPECIAL, 2, HG_VISUAL_EFFECT, 9);
set_hitbox_value(AT_DSPECIAL, 2, HG_HIT_SFX, asset_get("sfx_bubblepop"));