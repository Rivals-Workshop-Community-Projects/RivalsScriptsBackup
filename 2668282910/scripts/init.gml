...
fire_effect_big = hit_fx_create( sprite_get( "fire_hit_effect" ), 30 );
fire_effect_small = hit_fx_create( sprite_get( "fire_hit_effect_small" ), 30 );
zetter_hit1 = hit_fx_create( sprite_get( "zetter_hit1" ), 25 );
zetter_hit2 = hit_fx_create( sprite_get( "zetter_hit2" ), 25 );
zetter_hit3 = hit_fx_create( sprite_get( "zetter_hit3" ), 25 );
zetter_hit_ex = hit_fx_create( sprite_get( "zetter_hit2" ), 15 );
...
pkmn_stadium_front_img = sprite_get("stadium_f");
pkmn_stadium_back_img = sprite_get("stadium_b");

boxing_title = "The Blaze 
Pokémon";
