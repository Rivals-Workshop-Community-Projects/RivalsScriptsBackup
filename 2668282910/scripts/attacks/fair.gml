...
set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, sound_get("swing"));
...
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, sound_get("pokken_kick"));
...
set_hitbox_value(AT_FAIR, 2, HG_HIT_SFX, sound_get("pokken_kick"));
...
set_hitbox_value(AT_FAIR, 3, HG_HIT_SFX, sound_get("pokken_kick5"));
...
set_hitbox_value(AT_FAIR, 4, HG_HITBOX_Y, -41);
set_hitbox_value(AT_FAIR, 4, HG_WIDTH, 56);
...
set_hitbox_value(AT_FAIR, 4, HG_HIT_SFX, sound_get("pokken_kick5"));
...
set_hitbox_value(AT_FAIR, 5, HG_HITBOX_X, 67);
set_hitbox_value(AT_FAIR, 5, HG_HITBOX_Y, -38);
set_hitbox_value(AT_FAIR, 5, HG_WIDTH, 38);
set_hitbox_value(AT_FAIR, 5, HG_HEIGHT, 89);
...
set_hitbox_value(AT_FAIR, 5, HG_VISUAL_EFFECT, zetter_hit1);
set_hitbox_value(AT_FAIR, 5, HG_HIT_SFX, sound_get("hit_fire"));
...
set_hitbox_value(AT_FAIR, 6, HG_HITBOX_Y, -56);
set_hitbox_value(AT_FAIR, 6, HG_WIDTH, 70);
set_hitbox_value(AT_FAIR, 6, HG_HEIGHT, 90);
...
set_hitbox_value(AT_FAIR, 6, HG_VISUAL_EFFECT, zetter_hit1);
set_hitbox_value(AT_FAIR, 6, HG_HIT_SFX, sound_get("hit_fire"));