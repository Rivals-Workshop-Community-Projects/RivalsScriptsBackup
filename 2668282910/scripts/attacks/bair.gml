...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("blaze_kick_swing"));
...
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 8);
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 8);
set_hitbox_value(AT_BAIR, 1, HG_PRIORITY, 8);
set_hitbox_value(AT_BAIR, 1, HG_DAMAGE, 12);
set_hitbox_value(AT_BAIR, 1, HG_ANGLE, 149);
...
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, zetter_hit3);
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("blaze_kick_hit"));
...
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, sound_get("hit_weak"));

set_hitbox_value(AT_BAIR, 3, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_BAIR, 3, HG_WINDOW, 3);
set_hitbox_value(AT_BAIR, 3, HG_LIFETIME, 4);
set_hitbox_value(AT_BAIR, 3, HG_HITBOX_X, -27);
set_hitbox_value(AT_BAIR, 3, HG_HITBOX_Y, -33);
set_hitbox_value(AT_BAIR, 3, HG_WIDTH, 95);
set_hitbox_value(AT_BAIR, 3, HG_HEIGHT, 39);
set_hitbox_value(AT_BAIR, 3, HG_PRIORITY, 8);
set_hitbox_value(AT_BAIR, 3, HG_DAMAGE, 12);
set_hitbox_value(AT_BAIR, 3, HG_ANGLE, 149);
...
set_hitbox_value(AT_BAIR, 3, HG_VISUAL_EFFECT, zetter_hit3);
set_hitbox_value(AT_BAIR, 3, HG_HIT_SFX, sound_get("blaze_kick_hit"));