...
set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX, sound_get("blaze_kick_swing"));
...
set_hitbox_value(AT_USTRONG, 1, HG_ANGLE, 79);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, zetter_hit3);
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("hit_fire_strong"));
...
set_hitbox_value(AT_USTRONG, 2, HG_ANGLE, 79);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, zetter_hit3);
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("hit_fire_strong"));

set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_USTRONG, 3, HG_WINDOW, 3);
set_hitbox_value(AT_USTRONG, 3, HG_LIFETIME, 8);
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_X, 45);
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_Y, -28);
...
set_hitbox_value(AT_USTRONG, 3, HG_ANGLE, 79);
...
set_hitbox_value(AT_USTRONG, 3, HG_VISUAL_EFFECT, zetter_hit3);
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, sound_get("hit_fire_strong"));
...
set_hitbox_value(AT_USTRONG, 4, HG_HITBOX_Y, -73);
set_hitbox_value(AT_USTRONG, 4, HG_WIDTH, 51);
...
set_hitbox_value(AT_USTRONG, 4, HG_VISUAL_EFFECT, zetter_hit3);
set_hitbox_value(AT_USTRONG, 4, HG_HIT_SFX, sound_get("hit_fire_strong"));
...
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_X, 63);
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_Y, -82);
set_hitbox_value(AT_USTRONG, 5, HG_WIDTH, 71);
...
set_hitbox_value(AT_USTRONG, 5, HG_ANGLE, 79);
...
set_hitbox_value(AT_USTRONG, 5, HG_VISUAL_EFFECT, zetter_hit3);
set_hitbox_value(AT_USTRONG, 5, HG_HIT_SFX, sound_get("hit_fire_strong"));