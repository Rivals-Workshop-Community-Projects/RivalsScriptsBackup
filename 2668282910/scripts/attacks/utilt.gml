...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("pokken_swing3"));
...
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sound_get("hit_normal2"));
...
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, sound_get("hit_normal3"));