...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, sound_get("pokken_swing2"));
...
set_hitbox_value(AT_DTILT, 1, HG_HEIGHT, 41);
...
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, sound_get("kick_hit"));
...
set_hitbox_value(AT_DTILT, 2, HG_HEIGHT, 41);
...
set_hitbox_value(AT_DTILT, 2, HG_HIT_SFX, sound_get("kick_hit2"));
...
set_hitbox_value(AT_DTILT, 3, HG_HITBOX_X, 74);
...
set_hitbox_value(AT_DTILT, 3, HG_VISUAL_EFFECT, zetter_hit1);
set_hitbox_value(AT_DTILT, 3, HG_HIT_SFX, sound_get("hit_fire"));