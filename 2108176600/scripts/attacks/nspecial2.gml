...
set_attack_value(AT_NSPECIAL_2, AG_SPRITE, sprite_get("ou_nair"));
...
set_window_value(AT_NSPECIAL_2, 2, AG_WINDOW_SFX, asset_get("sfx_spin_longer"));
...
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HITBOX_X, 4);
...
set_hitbox_value(AT_NSPECIAL_2, 2, HG_WINDOW_CREATION_FRAME, 10);
set_hitbox_value(AT_NSPECIAL_2, 2, HG_LIFETIME, 4);
set_hitbox_value(AT_NSPECIAL_2, 2, HG_SHAPE, 0);
set_hitbox_value(AT_NSPECIAL_2, 2, HG_HITBOX_X, 4);
...
set_hitbox_value(AT_NSPECIAL_2, 3, HG_WINDOW_CREATION_FRAME, 15);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_LIFETIME, 4);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_SHAPE, 0);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_HITBOX_X, 4);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_HITBOX_Y, -20);
...
set_hitbox_value(AT_NSPECIAL_2, 3, HG_HIT_LOCKOUT, 4);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_VISUAL_EFFECT, 0);
...
set_hitbox_value(AT_NSPECIAL_2, 3, HG_PROJECTILE_PARRY_STUN, false);
