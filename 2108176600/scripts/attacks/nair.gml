...
set_window_value(AT_NAIR, 5, AG_WINDOW_SFX, asset_get("sfx_spin"));
...
set_hitbox_value(AT_NAIR, 2, HG_HEIGHT, 92);
...
//set_hitbox_value(AT_NAIR, 2, HG_HITSTUN_MULTIPLIER, 2);
...
//set_hitbox_value(AT_NAIR, 3, HG_HITSTUN_MULTIPLIER, 2);
...
set_hitbox_value(AT_NAIR, 4, HG_HEIGHT, 98);
...
//set_hitbox_value(AT_NAIR, 4, HG_HITSTUN_MULTIPLIER, 2);
