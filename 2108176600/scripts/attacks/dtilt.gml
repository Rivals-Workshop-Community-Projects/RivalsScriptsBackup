...
set_hitbox_value(AT_DTILT, 3, HG_HIT_LOCKOUT, 0);
...
set_hitbox_value(AT_DTILT, 4, HG_HITBOX_Y, -131);
set_hitbox_value(AT_DTILT, 4, HG_WIDTH, 67);
set_hitbox_value(AT_DTILT, 4, HG_HEIGHT, 63);
set_hitbox_value(AT_DTILT, 4, HG_PRIORITY, 7);
set_hitbox_value(AT_DTILT, 4, HG_DAMAGE, 4);
set_hitbox_value(AT_DTILT, 4, HG_ANGLE, 110);
set_hitbox_value(AT_DTILT, 4, HG_BASE_KNOCKBACK, 4);
set_hitbox_value(AT_DTILT, 4, HG_KNOCKBACK_SCALING, .2);
set_hitbox_value(AT_DTILT, 4, HG_BASE_HITPAUSE, 4);
set_hitbox_value(AT_DTILT, 4, HG_HITPAUSE_SCALING, .2);
set_hitbox_value(AT_DTILT, 4, HG_HIT_LOCKOUT, 0);
