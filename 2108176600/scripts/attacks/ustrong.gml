...
set_window_value(AT_USTRONG, 1, AG_WINDOW_SFX_FRAME, 14);
...
set_hitbox_value(AT_USTRONG, 3, HG_FINAL_BASE_KNOCKBACK, 11);
...
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_X, -49);
...
set_hitbox_value(AT_USTRONG, 2, HG_KNOCKBACK_SCALING, .3);
