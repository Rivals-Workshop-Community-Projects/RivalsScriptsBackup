...
add_sprites("bair","dair","dattack","dspecial","dstrong","dtilt","fair","fspecial","fstrong",
            "ftilt","jab","nair","nspecial","taunt","taunt_noncopyright","taunt_based","uair","uspecial","ustrong","utilt","hatch","phone_open");

//=================OTHER=================
//  hurt sprites
add_sprites("hurt","bouncehurt","hurtground","spinhurt","uphurt","downhurt","orb_idle","orb_proj");
...
//As an example:
 if (get_player_color(player) == 14 || get_player_color(player)== 15 || get_player_color(player)== 16 || get_player_color(player)== 17 || get_player_color(player)== 18 || get_player_color(player)== 23 || get_player_color(player)== 26) set_skin("eggdog");
