...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("chest_open"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("blank_sheet"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("orb_die"));
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_MASK, sprite_get("orb_die"));
