...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_SFX, sound_get("fspecial_miss"));
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_CUSTOM_GRAVITY, 0.35);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, sound_get("kss_grab_activate"));