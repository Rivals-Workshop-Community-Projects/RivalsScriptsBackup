...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_SFX_FRAME, 14);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("orb_proj"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HITSTUN_MULTIPLIER, 0.65);