...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_ori_dtilt_perform"));
...
set_window_value(AT_USTRONG, 7, AG_WINDOW_SFX, asset_get("sfx_ori_sein_fstrong"));
set_window_value(AT_USTRONG, 7, AG_WINDOW_SFX_FRAME, 1);
...
set_window_value(AT_USTRONG, 9, AG_WINDOW_LENGTH, 6);
set_window_value(AT_USTRONG, 9, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_USTRONG, 9, AG_WINDOW_ANIM_FRAME_START, 6);

set_window_value(AT_USTRONG, 10, AG_WINDOW_TYPE, 1);
set_window_value(AT_USTRONG, 10, AG_WINDOW_LENGTH, 4);
...
set_window_value(AT_USTRONG, 11, AG_WINDOW_LENGTH, 17);
set_window_value(AT_USTRONG, 11, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_USTRONG, 11, AG_WINDOW_ANIM_FRAME_START, 9);
...
set_hitbox_value(AT_USTRONG, 1, HG_SDI_MULTIPLIER, 0.2);
...
set_hitbox_value(AT_USTRONG, 2, HG_WIDTH, 57);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, 67);
...
set_hitbox_value(AT_USTRONG, 2, HG_SDI_MULTIPLIER, 0.2);
...
set_hitbox_value(AT_USTRONG, 4, HG_HEIGHT, 132);
...
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_Y, -70);
