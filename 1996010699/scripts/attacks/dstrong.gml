...
set_hitbox_value(AT_DSTRONG, 2, HG_WIDTH, 15);
...
set_hitbox_value(AT_DSTRONG, 3, HG_HEIGHT, 84);
set_hitbox_value(AT_DSTRONG, 3, HG_SHAPE, 2);
set_hitbox_value(AT_DSTRONG, 3, HG_PRIORITY, 2);
set_hitbox_value(AT_DSTRONG, 3, HG_DAMAGE, 18);
...
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT, exp1KT);
