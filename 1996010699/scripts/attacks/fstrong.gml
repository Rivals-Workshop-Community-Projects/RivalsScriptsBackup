...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.3);
...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.35);
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.35);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HEIGHT, 22);
...
set_hitbox_value(AT_FSTRONG, 3, HG_HITPAUSE_SCALING, 0.65);
set_hitbox_value(AT_FSTRONG, 3, HG_VISUAL_EFFECT, snap );
set_hitbox_value(AT_FSTRONG, 3, HG_VISUAL_EFFECT_Y_OFFSET, 36);
