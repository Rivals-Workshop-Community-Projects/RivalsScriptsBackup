...
set_hitbox_value(AT_UAIR, 3, HG_HITBOX_Y, -128);
set_hitbox_value(AT_UAIR, 3, HG_WIDTH, 16);
set_hitbox_value(AT_UAIR, 3, HG_HEIGHT, 16);
...
set_hitbox_value(AT_UAIR, 3, HG_KNOCKBACK_SCALING, 1.1);
...
set_hitbox_value(AT_UAIR, 4, HG_HEIGHT, 36);
...
set_hitbox_value(AT_UAIR, 5, HG_HITBOX_X, 18);
set_hitbox_value(AT_UAIR, 5, HG_HITBOX_Y, -122);
