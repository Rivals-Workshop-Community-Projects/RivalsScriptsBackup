...
set_attack_value(AT_BAIR, AG_USES_CUSTOM_GRAVITY, 0);
...
set_window_value(AT_BAIR, 2, AG_WINDOW_INVINCIBILITY, 2);
...
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 88); //88
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 46); //46
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, asset_get("sfx_icehit_medium2"));
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, symbiote);
...
set_hitbox_value(AT_BAIR, 2, HG_WIDTH, 4);
set_hitbox_value(AT_BAIR, 2, HG_HEIGHT, 4);
...
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT, symbiote);
