...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, wheelspin);
...
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT, wheelspin);
...
set_hitbox_value(AT_DAIR, 3, HG_WIDTH, 74);
...
set_hitbox_value(AT_DAIR, 3, HG_BASE_KNOCKBACK, 7.0);
...
set_hitbox_value(AT_DAIR, 3, HG_VISUAL_EFFECT, wheelspin);
