...
set_attack_value(AT_FSPECIAL, AG_SPRITE, sprite_get("newmove"));
set_attack_value(AT_FSPECIAL, AG_HURTBOX_SPRITE, sprite_get("newmove_hurt"));
set_attack_value(AT_FSPECIAL, AG_AIR_SPRITE, sprite_get("newmove_air"));
set_attack_value(AT_FSPECIAL, AG_HURTBOX_AIR_SPRITE, sprite_get("newmove_air_hurt"));
...
set_window_value(AT_FSPECIAL, 7, AG_WINDOW_SFX, asset_get("sfx_metal_hit_strong"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_LIFETIME, 0);//180
...
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, zetter_effect);
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_bird_downspecial"));
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("proj_zetter1"));
...
set_hitbox_value(AT_FSPECIAL, 2, HG_LIFETIME, 0);//180
...
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_DESTROY_EFFECT, zetter_effect);
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, asset_get("sfx_bird_downspecial"));
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("proj_zetter1"));
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_ANIM_SPEED, 1);
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_HSPEED, 7);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_LIFETIME, 0);//180
...
set_hitbox_value(AT_FSPECIAL, 3, HG_PROJECTILE_DESTROY_EFFECT, zetter_effect);
set_hitbox_value(AT_FSPECIAL, 3, HG_HIT_SFX, asset_get("sfx_bird_downspecial"));
set_hitbox_value(AT_FSPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("proj_zetter1"));
...
set_hitbox_value(AT_FSPECIAL, 4, HG_LIFETIME, 0);//180
...
set_hitbox_value(AT_FSPECIAL, 4, HG_PRIORITY, 0);
...
set_hitbox_value(AT_FSPECIAL, 4, HG_PROJECTILE_DESTROY_EFFECT, zetter_effect);
set_hitbox_value(AT_FSPECIAL, 4, HG_HIT_SFX, asset_get("sfx_bird_downspecial"));
set_hitbox_value(AT_FSPECIAL, 4, HG_PROJECTILE_SPRITE, sprite_get("proj_zetter1"));
...
set_hitbox_value(AT_FSPECIAL, 5, HG_WINDOW_CREATION_FRAME, 1);
set_hitbox_value(AT_FSPECIAL, 5, HG_LIFETIME, 0);//180
...
set_hitbox_value(AT_FSPECIAL, 5, HG_PROJECTILE_DESTROY_EFFECT, zetter_effect);
set_hitbox_value(AT_FSPECIAL, 5, HG_HIT_SFX, asset_get("sfx_bird_downspecial"));
set_hitbox_value(AT_FSPECIAL, 5, HG_PROJECTILE_SPRITE, sprite_get("proj_zetter1"));
set_hitbox_value(AT_FSPECIAL, 5, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_FSPECIAL, 5, HG_PROJECTILE_ANIM_SPEED, 1);
set_hitbox_value(AT_FSPECIAL, 5, HG_PROJECTILE_HSPEED, 0);
set_hitbox_value(AT_FSPECIAL, 5, HG_PROJECTILE_VSPEED, -10);
