...
set_attack_value(AT_FSPECIAL, AG_SPRITE, sprite_get("FX_teleport"));
set_attack_value(AT_FSPECIAL, AG_OFF_LEDGE, 1);
set_attack_value(AT_FSPECIAL, AG_NUM_WINDOWS, 4);
set_attack_value(AT_FSPECIAL, AG_USES_CUSTOM_GRAVITY, 1);
set_attack_value(AT_FSPECIAL, AG_HURTBOX_SPRITE, sprite_get("FX_teleport_hurt"));
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_HSPEED, 20);
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_SFX, sound_get("teleport"));