...
set_window_value(AT_DTILT, 1, AG_WINDOW_LENGTH, 10);//old 7
...
set_window_value(AT_DTILT, 2, AG_WINDOW_LENGTH, 13);// old 8 
...
set_window_value(AT_DTILT, 3, AG_WINDOW_LENGTH, 5);// old  5
...
set_hitbox_value(AT_DTILT, 1, HG_WIDTH, 107);
