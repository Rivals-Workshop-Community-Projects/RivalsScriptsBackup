...
set_hitbox_value(AT_FSTRONG, 1, HG_WIDTH, 81);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_X, 73);
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_Y, -36);
set_hitbox_value(AT_FSTRONG, 2, HG_WIDTH, 43);
...
set_hitbox_value(AT_FSTRONG, 2, HG_ANGLE, 42);
