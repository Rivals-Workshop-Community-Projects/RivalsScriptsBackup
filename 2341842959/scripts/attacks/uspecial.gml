...
set_attack_value(AT_USPECIAL, AG_SPRITE, sprite_get("FX_teleport"));
set_attack_value(AT_USPECIAL, AG_OFF_LEDGE, 1);
set_attack_value(AT_USPECIAL, AG_NUM_WINDOWS, 4);
set_attack_value(AT_USPECIAL, AG_USES_CUSTOM_GRAVITY, 1);
set_attack_value(AT_USPECIAL, AG_HURTBOX_SPRITE, sprite_get("FX_teleport_hurt"));
...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_SFX, sound_get("teleport"));