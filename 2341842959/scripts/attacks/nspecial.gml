...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_metal_hit_strong"));
...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_LENGTH, 9);//old 6
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HEIGHT, 115);
