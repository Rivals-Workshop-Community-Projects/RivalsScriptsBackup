...
set_window_value(AT_DTILT, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, .02);
...
set_window_value(AT_DTILT, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .02);
...
set_window_value(AT_DTILT, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .05);
...
set_hitbox_value(AT_DTILT, 1, HG_HITBOX_X, 49);
set_hitbox_value(AT_DTILT, 1, HG_HITBOX_Y, -19);
set_hitbox_value(AT_DTILT, 1, HG_WIDTH, 79);
...
// Tipper
set_hitbox_value(AT_DTILT, 2, HG_HIT_LOCKOUT, 8);
...
set_hitbox_value(AT_DTILT, 2, HG_HITPAUSE_SCALING, .45);
...
set_hitbox_value(AT_DTILT, 2, HG_TIPPER, 1);