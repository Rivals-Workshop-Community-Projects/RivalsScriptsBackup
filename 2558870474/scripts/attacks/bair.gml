...
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 66);
...
set_hitbox_value(AT_BAIR, 2, HG_HEIGHT, 88);
...
set_hitbox_value(AT_BAIR, 2, HG_TIPPER, 1);
...
set_hitbox_value(AT_BAIR, 3, HG_HIT_SFX, asset_get("sfx_icehit_heavy2"));
set_hitbox_value(AT_BAIR, 3, HG_TIPPER, 1);
