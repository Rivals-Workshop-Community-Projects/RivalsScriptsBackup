...
set_window_value(AT_UTILT, 4, AG_WINDOW_LENGTH, 17);
...
set_hitbox_value(AT_UTILT, 2, HG_HEIGHT, 124);
...
set_hitbox_value(AT_UTILT, 4, HG_HITBOX_X, 14);
set_hitbox_value(AT_UTILT, 4, HG_HITBOX_Y, -104);
set_hitbox_value(AT_UTILT, 4, HG_WIDTH, 91);
