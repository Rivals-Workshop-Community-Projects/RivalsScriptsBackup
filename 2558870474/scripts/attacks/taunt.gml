...
set_attack_value(AT_TAUNT, AG_HURTBOX_SPRITE, sprite_get("eirlys_hurt_box"));
...
set_window_value(AT_TAUNT, 2, AG_WINDOW_SFX, sfx_laugh);
...
set_window_value(AT_TAUNT, 4, AG_WINDOW_LENGTH, 32);
