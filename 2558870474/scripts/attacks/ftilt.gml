...
set_hitbox_value(AT_FTILT, 1, HG_HEIGHT, 69);   //nice
...
set_hitbox_value(AT_FTILT, 2, HG_HEIGHT, 89);
...
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT, 26);
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, asset_get("sfx_icehit_heavy1"));
set_hitbox_value(AT_FTILT, 2, HG_TIPPER, 1);
