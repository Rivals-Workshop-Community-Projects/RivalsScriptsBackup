...
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_Y, -132);
set_hitbox_value(AT_USTRONG, 1, HG_WIDTH, 42);
set_hitbox_value(AT_USTRONG, 1, HG_HEIGHT, 63);
...
set_hitbox_value(AT_USTRONG, 1, HG_TIPPER, 1);
...
set_hitbox_value(AT_USTRONG, 2, HG_HEIGHT, 89);
...
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_Y, -19);
set_hitbox_value(AT_USTRONG, 3, HG_WIDTH, 68);
