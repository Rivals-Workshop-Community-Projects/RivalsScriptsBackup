...
set_hitbox_value(AT_NAIR, 2, HG_WIDTH, 98);
...
set_hitbox_value(AT_NAIR, 3, HG_HITBOX_X, -11);
...
set_hitbox_value(AT_NAIR, 4, HG_WIDTH, 88);
set_hitbox_value(AT_NAIR, 4, HG_HEIGHT, 41);
set_hitbox_value(AT_NAIR, 4, HG_PRIORITY, 2);
set_hitbox_value(AT_NAIR, 4, HG_DAMAGE, hittwodmg);
set_hitbox_value(AT_NAIR, 4, HG_ANGLE, hittwoangle);
set_hitbox_value(AT_NAIR, 4, HG_BASE_KNOCKBACK, hittwobkb);
set_hitbox_value(AT_NAIR, 4, HG_KNOCKBACK_SCALING, hittwokbs);
set_hitbox_value(AT_NAIR, 4, HG_BASE_HITPAUSE, hittwobhp);
set_hitbox_value(AT_NAIR, 4, HG_HITPAUSE_SCALING, hittwohps);
set_hitbox_value(AT_NAIR, 4, HG_VISUAL_EFFECT, 302);
set_hitbox_value(AT_NAIR, 4, HG_ANGLE_FLIPPER, hittwoanglflp);
...
set_hitbox_value(AT_NAIR, 4, HG_TIPPER, 0);
...
set_hitbox_value(AT_NAIR, 5, HG_HITBOX_X, -36);
set_hitbox_value(AT_NAIR, 5, HG_HITBOX_Y, -52);
set_hitbox_value(AT_NAIR, 5, HG_WIDTH, 43);
...
set_hitbox_value(AT_NAIR, 5, HG_TIPPER, 1);
...
set_hitbox_value(AT_NAIR, 6, HG_HITBOX_Y, -32);
set_hitbox_value(AT_NAIR, 6, HG_WIDTH, 127);
set_hitbox_value(AT_NAIR, 6, HG_HEIGHT, 51);
set_hitbox_value(AT_NAIR, 6, HG_PRIORITY, 1);
set_hitbox_value(AT_NAIR, 6, HG_DAMAGE, hittwodmg_tipper);
set_hitbox_value(AT_NAIR, 6, HG_ANGLE, hittwoangle_tipper);
set_hitbox_value(AT_NAIR, 6, HG_BASE_KNOCKBACK, hittwobkb_tipper);
set_hitbox_value(AT_NAIR, 6, HG_KNOCKBACK_SCALING, hittwokbs_tipper);
set_hitbox_value(AT_NAIR, 6, HG_BASE_HITPAUSE, hittwobhp_tipper);
set_hitbox_value(AT_NAIR, 6, HG_HITPAUSE_SCALING, hittwohps_tipper);
set_hitbox_value(AT_NAIR, 6, HG_ANGLE_FLIPPER, hittwoanglflp_tipper);
set_hitbox_value(AT_NAIR, 6, HG_HIT_SFX, asset_get("sfx_icehit_medium2"));
...
set_hitbox_value(AT_NAIR, 7, HG_HITBOX_X, -11);
set_hitbox_value(AT_NAIR, 7, HG_HITBOX_Y, -65);
set_hitbox_value(AT_NAIR, 7, HG_WIDTH, 74);
set_hitbox_value(AT_NAIR, 7, HG_HEIGHT, 63);
...
set_hitbox_value(AT_NAIR, 8, HG_HITBOX_Y, -71);
set_hitbox_value(AT_NAIR, 8, HG_WIDTH, 89);
set_hitbox_value(AT_NAIR, 8, HG_HEIGHT, 74);
...
set_hitbox_value(AT_NAIR, 8, HG_ANGLE_FLIPPER, 5);
