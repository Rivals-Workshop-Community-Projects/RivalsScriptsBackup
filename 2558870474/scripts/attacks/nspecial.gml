...
set_window_value(AT_NSPECIAL, 7, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_LIFETIME, 60);  // 60
...
set_hitbox_value(AT_NSPECIAL, 2, HG_FINAL_BASE_KNOCKBACK, 8);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_HSPEED, 11); //0
...
set_hitbox_value(AT_NSPECIAL, 5, HG_WINDOW, 8);
