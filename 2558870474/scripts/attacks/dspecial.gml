...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, .8);
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .9);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_WIDTH, 111);
set_hitbox_value(AT_DSPECIAL, 1, HG_HEIGHT, 111);
