...
set_hitbox_value(AT_FAIR, 1, HG_DAMAGE, 6*damagebuff);
set_hitbox_value(AT_FAIR, 1, HG_ANGLE, 40);
set_hitbox_value(AT_FAIR, 1, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_FAIR, 1, HG_KNOCKBACK_SCALING, 0.48*damagebuff);
set_hitbox_value(AT_FAIR, 1, HG_BASE_HITPAUSE, 12*damagebuff);
...
set_hitbox_value(AT_FAIR, 2, HG_DAMAGE, 6*damagebuff);
set_hitbox_value(AT_FAIR, 2, HG_ANGLE, 10);
set_hitbox_value(AT_FAIR, 2, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_FAIR, 2, HG_KNOCKBACK_SCALING, 0.48*damagebuff);
set_hitbox_value(AT_FAIR, 2, HG_BASE_HITPAUSE, 12*damagebuff);
