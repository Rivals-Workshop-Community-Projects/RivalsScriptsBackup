...
set_hitbox_value(AT_DATTACK, 1, HG_DAMAGE, 5*damagebuff);
set_hitbox_value(AT_DATTACK, 1, HG_ANGLE, 55);
set_hitbox_value(AT_DATTACK, 1, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_DATTACK, 1, HG_KNOCKBACK_SCALING, 0.35*damagebuff);
...
set_hitbox_value(AT_DATTACK, 2, HG_DAMAGE, 3*damagebuff);
set_hitbox_value(AT_DATTACK, 2, HG_ANGLE, 75);
set_hitbox_value(AT_DATTACK, 2, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_DATTACK, 2, HG_KNOCKBACK_SCALING, 0.35*damagebuff);
