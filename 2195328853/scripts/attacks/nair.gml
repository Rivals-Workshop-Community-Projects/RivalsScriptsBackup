...
set_hitbox_value(AT_NAIR, 1, HG_DAMAGE, 6*damagebuff);
set_hitbox_value(AT_NAIR, 1, HG_ANGLE, 45);
set_hitbox_value(AT_NAIR, 1, HG_ANGLE_FLIPPER, 3);
set_hitbox_value(AT_NAIR, 1, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_NAIR, 1, HG_KNOCKBACK_SCALING, .45*damagebuff);
set_hitbox_value(AT_NAIR, 1, HG_BASE_HITPAUSE, 8*damagebuff);
...
set_hitbox_value(AT_NAIR, 2, HG_DAMAGE, 4*damagebuff);
...
set_hitbox_value(AT_NAIR, 2, HG_KNOCKBACK_SCALING, .31*damagebuff);
set_hitbox_value(AT_NAIR, 2, HG_BASE_HITPAUSE, 4*damagebuff);
