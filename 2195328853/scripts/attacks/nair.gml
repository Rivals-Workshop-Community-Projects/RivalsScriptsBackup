...
set_window_value(AT_NAIR, 5, AG_WINDOW_ANIM_FRAMES, 8);
...
set_hitbox_value(AT_NAIR, 2, HG_KNOCKBACK_SCALING, .31);
...
set_hitbox_value(AT_NAIR, 3, HG_KNOCKBACK_SCALING, .31);
