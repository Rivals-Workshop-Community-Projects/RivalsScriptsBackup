...
set_hitbox_value(AT_DAIR, 1, HG_DAMAGE, 9*damagebuff);
set_hitbox_value(AT_DAIR, 1, HG_ANGLE, 270);
set_hitbox_value(AT_DAIR, 1, HG_BASE_KNOCKBACK, 4);
set_hitbox_value(AT_DAIR, 1, HG_KNOCKBACK_SCALING, 0.75*damagebuff);
set_hitbox_value(AT_DAIR, 1, HG_BASE_HITPAUSE, 12*damagebuff);
...
set_hitbox_value(AT_DAIR, 2, HG_DAMAGE, 7*damagebuff);
set_hitbox_value(AT_DAIR, 2, HG_ANGLE, 140);
set_hitbox_value(AT_DAIR, 2, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_DAIR, 2, HG_KNOCKBACK_SCALING, 0.7*damagebuff);
set_hitbox_value(AT_DAIR, 2, HG_BASE_HITPAUSE, 10*damagebuff);
