...
set_hitbox_value(AT_FTILT, 1, HG_DAMAGE, 6*damagebuff);
set_hitbox_value(AT_FTILT, 1, HG_ANGLE, 40);
set_hitbox_value(AT_FTILT, 1, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_FTILT, 1, HG_KNOCKBACK_SCALING, 0.85*damagebuff);
...
set_hitbox_value(AT_FTILT, 2, HG_DAMAGE, 4*damagebuff);
set_hitbox_value(AT_FTILT, 2, HG_ANGLE, 40);
set_hitbox_value(AT_FTILT, 2, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_FTILT, 2, HG_KNOCKBACK_SCALING, 0.45*damagebuff);
