...
set_window_value(AT_JAB, 2, AG_WINDOW_HITPAUSE_FRAME, 1);
...
set_window_value(AT_JAB, 5, AG_WINDOW_HITPAUSE_FRAME, 5);
...
set_window_value(AT_JAB, 8, AG_WINDOW_HITPAUSE_FRAME, 8);
...
set_hitbox_value(AT_JAB, 1, HG_HITBOX_Y, -10);
set_hitbox_value(AT_JAB, 1, HG_WIDTH, 80);
set_hitbox_value(AT_JAB, 1, HG_HEIGHT, 45);
set_hitbox_value(AT_JAB, 1, HG_PRIORITY, 2);
set_hitbox_value(AT_JAB, 1, HG_DAMAGE, 3*damagebuff);
...
set_hitbox_value(AT_JAB, 1, HG_DRIFT_MULTIPLIER, 0.25);
...
set_hitbox_value(AT_JAB, 2, HG_HITBOX_Y, -10);
set_hitbox_value(AT_JAB, 2, HG_WIDTH, 80);
set_hitbox_value(AT_JAB, 2, HG_HEIGHT, 45);
set_hitbox_value(AT_JAB, 2, HG_PRIORITY, 2);
set_hitbox_value(AT_JAB, 2, HG_DAMAGE, 3*damagebuff);
...
set_hitbox_value(AT_JAB, 2, HG_DRIFT_MULTIPLIER, 0.25);
...
set_hitbox_value(AT_JAB, 3, HG_DAMAGE, 5*damagebuff);
set_hitbox_value(AT_JAB, 3, HG_ANGLE, 55);
set_hitbox_value(AT_JAB, 3, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_JAB, 3, HG_KNOCKBACK_SCALING, .57*damagebuff);
set_hitbox_value(AT_JAB, 3, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_JAB, 3, HG_HITPAUSE_SCALING, 1.25);
