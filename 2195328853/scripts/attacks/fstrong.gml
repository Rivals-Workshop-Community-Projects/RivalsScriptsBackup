...
set_attack_value(AT_FSTRONG, AG_LANDING_LAG, 6);
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_VSPEED, -2);
...
set_hitbox_value(AT_FSTRONG, 1, HG_KNOCKBACK_SCALING, .92);
set_hitbox_value(AT_FSTRONG, 1, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_FSTRONG, 1, HG_HITPAUSE_SCALING, 1.85);
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, asset_get("sfx_ell_steam_release"));
...
//set_hitbox_value(AT_FSTRONG, 2, HG_HITPAUSE_SCALING, .35);
