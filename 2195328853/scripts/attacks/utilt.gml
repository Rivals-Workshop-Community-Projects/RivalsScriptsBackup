...
set_hitbox_value(AT_UTILT, 1, HG_DAMAGE, 7*damagebuff);
set_hitbox_value(AT_UTILT, 1, HG_ANGLE, 90);
set_hitbox_value(AT_UTILT, 1, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_UTILT, 1, HG_KNOCKBACK_SCALING, 0.9*damagebuff);
...
set_hitbox_value(AT_UTILT, 2, HG_DAMAGE, 4*damagebuff);
set_hitbox_value(AT_UTILT, 2, HG_ANGLE, 90);
set_hitbox_value(AT_UTILT, 2, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_UTILT, 2, HG_KNOCKBACK_SCALING, 0.35*damagebuff);
