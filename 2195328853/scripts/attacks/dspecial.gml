...
set_hitbox_value(AT_DSPECIAL, 2, HG_KNOCKBACK_SCALING, 0.87);
set_hitbox_value(AT_DSPECIAL, 2, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_DSPECIAL, 2, HG_HITPAUSE_SCALING, 1.85);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_HITPAUSE_SCALING, 1.55);
...
set_hitbox_value(AT_DSPECIAL, 4, HG_HITPAUSE_SCALING, 1.55);
...
set_hitbox_value(AT_DSPECIAL, 5, HG_KNOCKBACK_SCALING, 1.24);
set_hitbox_value(AT_DSPECIAL, 5, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_DSPECIAL, 5, HG_HITPAUSE_SCALING, 1.85);
