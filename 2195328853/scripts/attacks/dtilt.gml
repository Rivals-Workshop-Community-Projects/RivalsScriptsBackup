...
set_hitbox_value(AT_DTILT, 1, HG_DAMAGE, 6*damagebuff);
set_hitbox_value(AT_DTILT, 1, HG_ANGLE, 30);
set_hitbox_value(AT_DTILT, 1, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_DTILT, 1, HG_KNOCKBACK_SCALING, 0.45*damagebuff);
...
set_hitbox_value(AT_DTILT, 2, HG_DAMAGE, 4*damagebuff);
set_hitbox_value(AT_DTILT, 2, HG_ANGLE, 30);
set_hitbox_value(AT_DTILT, 2, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_DTILT, 2, HG_KNOCKBACK_SCALING, 0.28*damagebuff);
