...
set_hitbox_value(AT_BAIR, 1, HG_DAMAGE, 9*damagebuff);
set_hitbox_value(AT_BAIR, 1, HG_ANGLE, 140);
set_hitbox_value(AT_BAIR, 1, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_BAIR, 1, HG_KNOCKBACK_SCALING, 1.0*damagebuff);
set_hitbox_value(AT_BAIR, 1, HG_BASE_HITPAUSE, 12*damagebuff);
