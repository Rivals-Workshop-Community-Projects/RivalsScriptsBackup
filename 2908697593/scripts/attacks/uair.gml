...
set_hitbox_value(AT_UAIR, 1, HG_LIFETIME, 25);
...
set_hitbox_value(AT_UAIR, 4, HG_LIFETIME, 25);
...
set_hitbox_value(AT_UAIR, 7, HG_LIFETIME, 25);
...
set_hitbox_value(AT_UAIR, 10, HG_LIFETIME, 25);
