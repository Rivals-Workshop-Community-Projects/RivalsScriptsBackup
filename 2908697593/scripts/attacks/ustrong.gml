...
set_hitbox_value(AT_USTRONG, 2, HG_EXTRA_CAMERA_SHAKE, 20);
...
set_hitbox_value(AT_USTRONG, 2, HG_PROJECTILE_GRAVITY, 0.4);
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, 197);
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT_X_OFFSET, 2);
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, 4);