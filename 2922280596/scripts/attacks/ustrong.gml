...
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_Y, -97);
set_hitbox_value(AT_USTRONG, 2, HG_WIDTH, 63);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, bigfx);
//set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, asset_get("sfx_mol_spark_explode1"));
