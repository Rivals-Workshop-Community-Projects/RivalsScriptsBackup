...
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX, asset_get("sfx_ori_glide_featherout"));
...
set_window_value(AT_TAUNT, 2, AG_WINDOW_SFX, sound_get("revolver_deploy"));
...
set_window_value(AT_TAUNT, 3, AG_WINDOW_SFX, sound_get("revolver_deploy"));

set_window_value(AT_TAUNT, 4, AG_WINDOW_TYPE, 1);
set_window_value(AT_TAUNT, 4, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_TAUNT, 4, AG_WINDOW_SFX, asset_get("mfx_star"));
