...
set_hitbox_value(AT_NAIR, 2, HG_WIDTH, 99);
...
set_hitbox_value(AT_NAIR, 3, HG_WIDTH, 99);
...
set_hitbox_value(AT_NAIR, 4, HG_HEIGHT, 47);
...
set_hitbox_value(AT_NAIR, 5, HG_HITBOX_X, -9);
set_hitbox_value(AT_NAIR, 5, HG_HITBOX_Y, -12);
set_hitbox_value(AT_NAIR, 5, HG_WIDTH, 99);
