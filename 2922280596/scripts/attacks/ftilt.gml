...
set_hitbox_value(AT_FTILT, 1, HG_HITBOX_X, 76);
set_hitbox_value(AT_FTILT, 1, HG_HITBOX_Y, -20);
set_hitbox_value(AT_FTILT, 1, HG_WIDTH, 21);
...
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT, smallfx);
//set_hitbox_value(AT_FTILT, 1, HG_EXTRA_HITPAUSE, 2);
set_hitbox_value(AT_FTILT, 1, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_FTILT, 1, HG_HITPAUSE_SCALING, .9);
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, asset_get("sfx_blow_medium3")); //sfx_may_whip2
//set_hitbox_value(AT_FTILT, 1, HG_HIT_LOCKOUT, 6);
...
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, asset_get("sfx_may_whip1"));
//set_hitbox_value(AT_FTILT, 1, HG_HIT_LOCKOUT, 6);