...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HITSTUN_MULTIPLIER, .7);
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_KNOCKBACK_SCALING, .3);
set_hitbox_value(AT_DSPECIAL_2, 2, HG_HITSTUN_MULTIPLIER, .7);
