...
version = 0;					    //0 = fsmash, 1 = dair, 2 = side b, 3 = up b, 4 = down b middle ray, 6 = down b side ray-- //5 = big dair (rune)
myHSpeed = 0;
myVSpeed = 0;
lifetime = 10;
detonating = 0;
...
hasDetonated = 0;
blastColor = 4;
flashOrigin = 0; 				//1 when flash is spawned from an aerial geno flash
flashAngle = 0;
hitPlayer = 0;
totalLifetime = 0;
...
exp_anim_rate = 3;                                  //Example animation speed value 3.
