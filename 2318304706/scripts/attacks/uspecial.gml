...
set_attack_value(AT_USPECIAL, AG_MUNO_ATTACK_NAME, "USpecial: Geno Flash");
...
set_window_value(AT_USPECIAL, 5, AG_MUNO_WINDOW_EXCLUDE, 1);
...
set_window_value(AT_USPECIAL, 6, AG_MUNO_WINDOW_EXCLUDE, 1);
...
set_window_value(AT_USPECIAL, 12, AG_MUNO_WINDOW_EXCLUDE, 1);
...
set_window_value(AT_USPECIAL, 13, AG_MUNO_WINDOW_EXCLUDE, 1);
...
set_hitbox_value(AT_USPECIAL, 1, HG_MUNO_HITBOX_NAME, "Melee hitbox");
...
set_hitbox_value(AT_USPECIAL, 2, HG_MUNO_HITBOX_NAME, "Projectile Travelling Hitbox");
...
set_hitbox_value(AT_USPECIAL, 3, HG_MUNO_HITBOX_NAME, "Projectile Multihit Hitbox");
set_hitbox_value(AT_USPECIAL, 3, HG_MUNO_HITBOX_MISC, "Hits 3 times.");
...
set_hitbox_value(AT_USPECIAL, 4, HG_HITSTUN_MULTIPLIER, 0.7);
...
set_hitbox_value(AT_USPECIAL, 4, HG_MUNO_HITBOX_NAME, "Launcher (Grounded USpec)");
...
set_hitbox_value(AT_USPECIAL, 5, HG_HITSTUN_MULTIPLIER, 0.7);
...
set_hitbox_value(AT_USPECIAL, 5, HG_MUNO_HITBOX_NAME, "Launcher (Aerial USpec)");