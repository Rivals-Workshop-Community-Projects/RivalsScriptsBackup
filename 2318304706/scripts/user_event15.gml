...
initSection("In addition, there's been some targeted tweaks to moves that I remember hearing complaints about, specifically DAttack, UAir, FAir and NSpecial.");
initHeader("General");
initSection("* Removed blue rim-lighting from char-select and results-small.");
initSection("* Added a little visual effect when a special or DAttack is used.");
initSection("* Added a special hit effect and sound effect when any of Geno's moves trigger a galaxy (even when they galaxy Geno himself, such as if a projectile is reflected).");
initHeader("Jab");
initSection("- Jab 1 hitbox size decreased.");
initSection("- Jab 1 Startup increased (3 -> 4) (First hitbox comes out F5 instead of F4. I will use this same formatting for all moves.)");
initSection("- Jab 2 Non-finisher Pellet Damage reduced (2, 1, 2 -> 1, 1, 1) (Total jab combo damage reduced from 12(14) to 10(12))");
initHeader("UTilt");
initSection("- Damage reduced (3, 4, 4 -> 3, 2, 3) (Total combo damage reduced from 11 to 8)");
initHeader("FTilt");
initSection("- Hitbox width reduced slightly.");
initSection("- Damage reduced (10 -> 9)");
initHeader("DTilt");
initSection("- Sweetspot hitbox width reduced slightly.");
initSection("- Damage reduced (12/10 -> 10/7)");
initSection("* Fixed hurtbox to match the visual.");
initHeader("DAttack");
initSection("- Hitbox size reduced.");
initSection("- Endlag increased (14/21 -> 16/24)");
initSection("* Additional animation frame added to endlag to make the animation more smooth.");
initSection("- Damage (9 -> 7)");
initHeader("UStrong");
initSection("- Hit 1 top hitbox size reduced.");
initSection("- Hit 2 bullet damage reduced (8 [center], 4 [sides] -> 6, 3)");
initHeader("FStrong");
initSection("- Hit 1 (punch) damage reduced (8 -> 6)");
initSection("* Hit 2 (explosion) KB and angle changed (9+1.15 @ 55 -> 8 + 1.1 @ 45)");
initSection("//this is experimental, but as of rn this galaxies zett on ToH at 135 from center stage or 105 at ledge, which feels fair.");
initSection("* Fixed hurtbox to match the visual.");
initHeader("DStrong");
initSection("- Hit 1 and 2 damage reduced (4 -> 3) (Total combo damage reduced from 14(16) to 12(14))");
initSection("- Hit 3 knockback reduced (9.5+1(10+1.1) -> 8 + 1(8 + 1.1))");
initSection("//also experimental. with these changes, zett gets galaxied on ToH at 150(135) at center stage, or 125(105) at ledge. Notice the TH knockback is the same as FStrong's explosion knockback.");
initSection("- Hitbox sizes all reduced slightly.");
initHeader("NAir");
initSection("- Hurtbox size increased, Hitbox sizes decreased slightly");
initHeader("FAir");
initSection("- Startup increased (6 -> 7) (first hitbox comes out F8 instead of F7)");
initSection("- Hitbox sizes reduced slightly.");
initSection("- Damage reduced (5, 6 -> 4, 5) (Total combo damage reduced from 11 to 9)");
initHeader("BAir");
initSection("- Startup increased (11 -> 13)");
initSection("- Damage reduced (10[body], 10[sourspot], 13 [sweetspot] -> 7, 8, 11)");
initHeader("UAir");
initSection("- Knockback reduced (8+.75[sourspot], 9+.85[sweetspot] -> 7+.7, 9+.8)");
initSection("- Hitbox sizes reduced.");
initSection("- Damage reduced (9[body], 9[sourspot], 11 [sweetspot] -> 7, 8, 10)");
initHeader("DAir");
initSection("- Punch damage reduced (6 -> 4)");
initHeader("NSpecial: Geno Beam");
initSection("- Charge now goes away on parry.");
initSection("- Charge cancel vulnerable period increased (9f -> 12f)");
initHeader("FSpecial: Geno Whirl");
initSection("- Weak projectile hit damage reduced (6 -> 3)");
initSection("- Weak projectile hitstun multiplier reduced (1 -> .5)");
initSection("* Strong explosion knockback changed (10.5+1 -> 8+1.1)");
initSection("//Now, it's the exact same knockback as FStrong or DStrong. This feels fair, as all three of these moves are supposed to be the really strong 'blow someone up' moves.");
initSection("//Before, trying to decide which should be stronger and weaker was weird. FStrong has the most startup, FSpecial is the hardest to hit, DStrong has the least range. Having them all the same simplifies the matter.");
initHeader("USpecial: Geno Flash");
initSection("- Projectile launcher hitstun multiplier reduced (1 -> .7)");
initSection("/ Adjusted sprites when launching yourself with an diagonal angle to better match the movement and projectile launch trajectory.");
initSection("- Slightly reduced horizontal movement when launching yourself directly to the side");
initSection("* Can no longer be timed. Fixed distance is slightly less than the previous Timed Hit distance. Move always puts Geno into pratfall.");
initSection("+ Move has a weak hitbox on Geno's body during the flight.");
initSection("+ During the endlag, Geno will turn to face whichever direction is held.");
