...
sprite_index = sprite_get("dspec_article_move");           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
...
vsp = -12 - (8 * player_id.runeActiveJ);                     //The vertical speed of the article.
...
numShots = 4 + (2 * player_id.runeActiveJ);
numShotsDone = 0;
