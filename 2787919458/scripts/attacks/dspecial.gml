...
set_hitbox_value(AT_DSPECIAL, 1, HG_WIDTH, 260);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HITBOX_X, 775);
set_hitbox_value(AT_DSPECIAL, 2, HG_HITBOX_Y, -45);
set_hitbox_value(AT_DSPECIAL, 2, HG_WIDTH, 880);
set_hitbox_value(AT_DSPECIAL, 2, HG_SHAPE, 1);
set_hitbox_value(AT_DSPECIAL, 2, HG_HEIGHT, 8);
...
set_hitbox_value(AT_DSPECIAL, 6, HG_WINDOW_CREATION_FRAME, 14);
...
set_hitbox_value(AT_DSPECIAL, 6, HG_HEIGHT, 60);
