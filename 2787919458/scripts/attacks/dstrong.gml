...
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 1);
set_hitbox_value(AT_DSTRONG, 1, HG_HEIGHT, 1);
...
set_hitbox_value(AT_DSTRONG, 1, HG_PROJECTILE_SPRITE, sprite_get("datboi_idle"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_PROJECTILE_SPRITE, sprite_get("datboi_ride"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_PROJECTILE_GRAVITY, .4);
