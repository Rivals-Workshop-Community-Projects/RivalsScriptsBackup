...
set_hitbox_value(AT_USTRONG, 1, HG_WIDTH, 1);
set_hitbox_value(AT_USTRONG, 1, HG_HEIGHT, 1);
...
set_hitbox_value(AT_USTRONG, 1, HG_PROJECTILE_SPRITE, sprite_get("doge_idle"));
set_hitbox_value(AT_USTRONG, 1, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_USTRONG, 1, HG_PROJECTILE_ANIM_SPEED, .06);
set_hitbox_value(AT_USTRONG, 1, HG_PROJECTILE_DESTROY_EFFECT, 304);
