...
set_window_value(AT_NAIR, 2, AG_WINDOW_VSPEED, -4);
...
set_hitbox_value(AT_NAIR, 2, HG_HITPAUSE_SCALING, .9);
...
set_hitbox_value(AT_NAIR, 2, HG_EXTRA_CAMERA_SHAKE, 11);
...
set_hitbox_value(AT_NAIR, 3, HG_KNOCKBACK_SCALING, .9);
...
set_hitbox_value(AT_NAIR, 3, HG_EXTRA_CAMERA_SHAKE, 11);
