...
// Physical size
char_height             = 64;                   //                  the height of the overhead hud - the arrow with your name and %
...
nspecial_shot = hit_fx_create(sprite_get("vfx_fired"), 18);

nspecial_angled = false;
nspecial_range = 100;
nspecial_interval = 40;
nspecial_angled_interval = 30;
...
dspecial_damage_scaling = 0.1;
dspecial_stun_scaling = 0.25;
