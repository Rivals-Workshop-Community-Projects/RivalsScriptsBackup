...
set_window_value(AT_DSPECIAL_2, 1, AG_WINDOW_LENGTH, 36);
set_window_value(AT_DSPECIAL_2, 1, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_DSPECIAL_2, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DSPECIAL_2, 1, AG_WINDOW_SFX, sound_get("Cast A Spell"));
...
set_window_value(AT_DSPECIAL_2, 3, AG_WINDOW_SFX, sound_get("counterattack"));
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_PROJECTILE_DESTROY_EFFECT, 4);
