...
set_window_value(AT_EXTRA_2, 4, AG_WINDOW_VSPEED, -12 + has_rune ("N") * -4);
...
set_hitbox_value(AT_EXTRA_2, 1, HG_LIFETIME, 10 + has_rune ("N") * 15);
...
set_hitbox_value(AT_EXTRA_2, 1, HG_DAMAGE, 10 + has_rune ("N") * 4);
...
set_hitbox_value(AT_EXTRA_2, 1, HG_BASE_KNOCKBACK, 9 + has_rune ("N") * 2);
...
set_hitbox_value(AT_EXTRA_2, 1, HG_WINDOW_CREATION_FRAME, 4 + has_rune ("N") * -3);
