...
set_window_value(AT_FAIR, 1, AG_WINDOW_LENGTH, 8 + has_rune("A") * 4);
...
set_window_value(AT_FAIR, 3, AG_WINDOW_LENGTH, 8 + has_rune("A") * 4);
...
set_hitbox_value(AT_FAIR, 1, HG_DAMAGE, 5 + has_rune("A") + 2);
set_hitbox_value(AT_FAIR, 1, HG_ANGLE, 70);
set_hitbox_value(AT_FAIR, 1, HG_BASE_KNOCKBACK, 5 + has_rune("A") + 3);
