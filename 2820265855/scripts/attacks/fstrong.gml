...
set_num_hitboxes(AT_FSTRONG,5 + has_rune("J") * 1);
...
set_hitbox_value(AT_FSTRONG, 5, HG_HIT_SFX, sound_get("hstrong"));
...
set_hitbox_value(AT_FSTRONG, 6, HG_WINDOW, 8);
set_hitbox_value(AT_FSTRONG, 6, HG_LIFETIME, 10);
set_hitbox_value(AT_FSTRONG, 6, HG_HITBOX_X, 10);
set_hitbox_value(AT_FSTRONG, 6, HG_HITBOX_Y, -60);
set_hitbox_value(AT_FSTRONG, 6, HG_WIDTH, 70);
...
set_hitbox_value(AT_FSTRONG, 6, HG_BASE_HITPAUSE, 18);
set_hitbox_value(AT_FSTRONG, 6, HG_HITPAUSE_SCALING, 1.0);
set_hitbox_value(AT_FSTRONG, 6, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_FSTRONG, 6, HG_HIT_SFX, asset_get("sfx_clairen_hit_med"));
set_hitbox_value(AT_FSTRONG, 6, HG_HIT_LOCKOUT, 10);
set_hitbox_value(AT_FSTRONG, 6, HG_PROJECTILE_SPRITE, sprite_get("bladebeam"));
set_hitbox_value(AT_FSTRONG, 6, HG_PROJECTILE_HSPEED, 10);
set_hitbox_value(AT_FSTRONG, 6, HG_PROJECTILE_ANIM_SPEED, 0.5);
set_hitbox_value(AT_FSTRONG, 6, HG_LIFETIME, 40);
set_hitbox_value(AT_FSTRONG, 6, HG_VISUAL_EFFECT, 67)
set_hitbox_value(AT_FSTRONG, 6, HG_PROJECTILE_DESTROY_EFFECT, 67);