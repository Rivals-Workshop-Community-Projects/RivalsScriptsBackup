...
set_hitbox_value(AT_USTRONG, 1, HG_DAMAGE, 9 + has_rune("L") * 2);
...
set_hitbox_value(AT_USTRONG, 2, HG_DAMAGE, 14 + has_rune("L") * 2);
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("BladeStrike2"));
