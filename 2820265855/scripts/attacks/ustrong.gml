...
set_hitbox_value(AT_USTRONG, 1, HG_DAMAGE, 12 + has_rune("L") * 2);
...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("BladeStrike1"));
...
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_Y, -103);
...
set_hitbox_value(AT_USTRONG, 2, HG_DAMAGE, 12 + has_rune("L") * 2);
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("BladeStrike1"));
