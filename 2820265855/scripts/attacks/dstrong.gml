...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_SFX, asset_get("sfx_swipe_weak2"));
...
set_hitbox_value(AT_DSTRONG, 5, HG_ANGLE, 180);
...
set_hitbox_value(AT_DSTRONG, 7, HG_HITBOX_Y, -50);
