...
set_window_value(AT_DSTRONG, 5, AG_WINDOW_SFX, asset_get("sfx_swipe_weak2"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_ANGLE, 340);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("BladeStrike1"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_ANGLE, 170);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("BladeStrike1"));
...
set_hitbox_value(AT_DSTRONG, 3, HG_ANGLE, 170);
...
set_hitbox_value(AT_DSTRONG, 3, HG_HIT_SFX, sound_get("BladeStrike1"));
...
set_hitbox_value(AT_DSTRONG, 4, HG_HIT_SFX, sound_get("BladeStrike1"));
...
set_hitbox_value(AT_DSTRONG, 5, HG_HIT_SFX, sound_get("BladeStrike1"));
...
set_hitbox_value(AT_DSTRONG, 6, HG_WIDTH, 140);
...
set_hitbox_value(AT_DSTRONG, 6, HG_ANGLE, 170);
...
set_hitbox_value(AT_DSTRONG, 6, HG_VISUAL_EFFECT, 302);
set_hitbox_value(AT_DSTRONG, 6, HG_VISUAL_EFFECT_X_OFFSET, 10);
set_hitbox_value(AT_DSTRONG, 6, HG_HIT_SFX, sound_get("BladeStrike1"));
...
set_hitbox_value(AT_DSTRONG, 6, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_DSTRONG, 6, HG_WINDOW_CREATION_FRAME, 5);

set_hitbox_value(AT_DSTRONG, 7, HG_PARENT_HITBOX, 0);
set_hitbox_value(AT_DSTRONG, 7, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_DSTRONG, 7, HG_WINDOW, 7);
...
set_hitbox_value(AT_DSTRONG, 7, HG_DAMAGE, 5 + has_rune("L") * 2);
...
set_hitbox_value(AT_DSTRONG, 7, HG_BASE_HITPAUSE, 9);
...
set_hitbox_value(AT_DSTRONG, 7, HG_HIT_SFX, sound_get("BladeStrike2"));
...
set_hitbox_value(AT_DSTRONG, 8, HG_WINDOW, 99);
set_hitbox_value(AT_DSTRONG, 8, HG_LIFETIME, 99999);
set_hitbox_value(AT_DSTRONG, 8, HG_HITBOX_X, 0);
set_hitbox_value(AT_DSTRONG, 8, HG_HITBOX_Y, 0);
set_hitbox_value(AT_DSTRONG, 8, HG_WIDTH, 30);
