...
set_window_value(AT_FTILT, 1, AG_WINDOW_LENGTH, 10);//6
...
set_hitbox_value(AT_FTILT, 1, HG_HITPAUSE_SCALING, 1.3);
...
set_hitbox_value(AT_FTILT, 2, HG_HITPAUSE_SCALING, 1.3);
