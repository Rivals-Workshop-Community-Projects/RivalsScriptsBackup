...
set_window_value(AT_JAB, 4, AG_WINDOW_SFX_FRAME, get_window_value(AT_JAB,4,AG_WINDOW_LENGTH)-1);
...
set_window_value(AT_JAB, 7, AG_WINDOW_SFX_FRAME, get_window_value(AT_JAB,7,AG_WINDOW_LENGTH)-1);
...
set_hitbox_value(AT_JAB, 3, HG_KNOCKBACK_SCALING, 0.45);
...
set_hitbox_value(AT_JAB, 3, HG_HIT_BLEED, 1);
