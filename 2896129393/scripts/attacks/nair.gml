...
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, 15);
...
set_hitbox_value(AT_NAIR, 2, HG_WIDTH, 15);
set_hitbox_value(AT_NAIR, 2, HG_HEIGHT, 15);
