...
set_hitbox_value(AT_DSPECIAL, 2, HG_LIFETIME, get_window_value(AT_DSPECIAL,6,AG_WINDOW_LENGTH));
...
set_hitbox_value(AT_DSPECIAL, 2, HG_KNOCKBACK_SCALING, 0.15);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HIT_BLEED, 1)
