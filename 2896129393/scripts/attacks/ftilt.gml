...
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, 15);
...
set_hitbox_value(AT_FTILT, 2, HG_LIFETIME, get_window_value(AT_FTILT,2,AG_WINDOW_LENGTH));
set_hitbox_value(AT_FTILT, 2, HG_HITBOX_X, 60);
set_hitbox_value(AT_FTILT, 2, HG_HITBOX_Y, -12);
set_hitbox_value(AT_FTILT, 2, HG_WIDTH, 15);
...
set_hitbox_value(AT_FTILT, 2, HG_HIT_BLEED, 1);
