...
if (!variable_instance_exists(id,"ae") || ye == true){
    ...
    ce[0,0] = make_color_rgb(255, 175, 147) // "color preview square" color. can be any color!
    ce[0,1] = "Berry" // the name of the alternate color.
    ...
    ce[1,0] = make_color_rgb(222, 245, 140)
    ce[1,1] = "Fire"
    ce[1,2] = ""
    ce[2,0] = make_color_rgb(64, 178, 255)
    ce[2,1] = "Frost"
    ce[2,2] = ""
    ce[3,0] = make_color_rgb(55, 150, 81)
    ce[3,1] = "Sweet"
    ce[3,2] = ""
    ce[4,0] = make_color_rgb(255, 31, 31)
    ce[4,1] = "Devil"
    ce[4,2] = ""
    ce[5,0] = make_color_rgb(64, 64, 82)
    ce[5,1] = "White"
    ce[5,2] = ""
    ce[6,0] = make_color_rgb(245, 247, 255)
    ce[6,1] = "Black"
    ce[6,2] = ""
    ce[7,0] = make_color_rgb(37, 52, 194)
    ce[7,1] = "Sea"
    ce[7,2] = ""
    ce[8,0] = make_color_rgb(156, 132, 118)
    ce[8,1] = "Student"
    ce[8,2] = ""
    ce[9,0] = make_color_rgb(255, 216, 74)
    ce[9,1] = "Yokai"
    ce[9,2] = ""
    ce[10,0] = make_color_rgb(255, 165, 54)
    ce[10,1] = "Entertainer"
    ce[10,2] = ""
    ce[11,0] = make_color_rgb(106, 242, 183)
    ce[11,1] = "Aquamarine"
    ce[11,2] = ""
    ce[12,0] = make_color_rgb(187, 29, 222)
    ce[12,1] = "Vaporwave"
    ce[12,2] = ""
