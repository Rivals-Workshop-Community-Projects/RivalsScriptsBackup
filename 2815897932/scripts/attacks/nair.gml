...
set_window_value(AT_NAIR, 1, AG_WINDOW_CUSTOM_GRAVITY, 1.1);
set_window_value(AT_NAIR, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, sound_get("sfx_nair_speen"));
...
set_window_value(AT_NAIR, 2, AG_WINDOW_CUSTOM_GRAVITY, 1.1);
...
set_hitbox_value(AT_NAIR, 2, HG_WIDTH, 104);
...
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, sound_get("sfx_blow_heavyish"));
