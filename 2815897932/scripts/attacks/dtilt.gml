...
set_window_value(AT_DTILT, 2, AG_WINDOW_HITPAUSE_FRAME, 0);
...
set_window_value(AT_DTILT, 3, AG_WINDOW_CANCEL_FRAME, 2);
...
set_window_value(AT_DTILT, 4, AG_WINDOW_HAS_CUSTOM_FRICTION, 0);
...
set_window_value(AT_DTILT, 5, AG_WINDOW_HAS_CUSTOM_FRICTION, 0);
set_window_value(AT_DTILT, 5, AG_WINDOW_CUSTOM_AIR_FRICTION, 0);
set_window_value(AT_DTILT, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1);
set_window_value(AT_DTILT, 5, AG_WINDOW_HITPAUSE_FRAME, 0);
...
set_window_value(AT_DTILT, 5, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(AT_DTILT, 5, AG_WINDOW_VSPEED_TYPE, 0);

set_window_value(AT_DTILT, 6, AG_WINDOW_TYPE, 5);
set_window_value(AT_DTILT, 6, AG_WINDOW_LENGTH, 8);
set_window_value(AT_DTILT, 6, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_DTILT, 6, AG_WINDOW_ANIM_FRAME_START, 12);
set_window_value(AT_DTILT, 6, AG_WINDOW_HAS_WHIFFLAG, 1);
set_window_value(AT_DTILT, 6, AG_WINDOW_HAS_CUSTOM_FRICTION, 0);
set_window_value(AT_DTILT, 6, AG_WINDOW_CUSTOM_AIR_FRICTION, 0);
set_window_value(AT_DTILT, 6, AG_WINDOW_CUSTOM_GROUND_FRICTION, 6);
...
set_hitbox_value(AT_DTILT, 2, HG_EXTRA_HITPAUSE, 3);
