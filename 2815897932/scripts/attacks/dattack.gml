...
set_hitbox_value(AT_DATTACK, 1, HG_KNOCKBACK_SCALING, .08);
set_hitbox_value(AT_DATTACK, 1, HG_SDI_MULTIPLIER, .7);
set_hitbox_value(AT_DATTACK, 1, HG_BASE_HITPAUSE, 3);
set_hitbox_value(AT_DATTACK, 1, HG_HITPAUSE_SCALING, .05);
...
set_hitbox_value(AT_DATTACK, 2, HG_HITPAUSE_SCALING, .75);
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT, 302);
set_hitbox_value(AT_DATTACK, 2, HG_HITSTUN_MULTIPLIER, .8);
