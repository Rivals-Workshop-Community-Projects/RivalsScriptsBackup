...
set_window_value(AT_UAIR, 3, AG_WINDOW_HITPAUSE_FRAME, 0);
set_window_value(AT_UAIR, 3, 33, 0);

set_window_value(AT_UAIR, 4, AG_WINDOW_TYPE, 2);
...
set_window_value(AT_UAIR, 4, 33, 0);
...
set_hitbox_value(AT_UAIR, 1, HG_KNOCKBACK_SCALING, .72);
set_hitbox_value(AT_UAIR, 1, HG_BASE_HITPAUSE, 4);
set_hitbox_value(AT_UAIR, 1, HG_HITPAUSE_SCALING, .67);
