...
set_window_value(AT_JAB, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .2);
...
set_window_value(AT_JAB, 5, AG_WINDOW_CUSTOM_AIR_FRICTION, 0);
...
set_window_value(AT_JAB, 6, AG_WINDOW_CUSTOM_AIR_FRICTION, 0);
set_window_value(AT_JAB, 6, AG_WINDOW_CUSTOM_GROUND_FRICTION, .2);
...
set_window_value(AT_JAB, 7, AG_WINDOW_CUSTOM_AIR_FRICTION, 0);
...
set_window_value(AT_JAB, 8, AG_WINDOW_HSPEED, 10);
set_window_value(AT_JAB, 8, AG_WINDOW_HSPEED_TYPE, 2);
set_window_value(AT_JAB, 8, AG_WINDOW_CUSTOM_AIR_FRICTION, 0);
set_window_value(AT_JAB, 8, AG_WINDOW_CUSTOM_GROUND_FRICTION, .7);

set_window_value(AT_JAB, 9, AG_WINDOW_TYPE, 2);
...
set_window_value(AT_JAB, 9, AG_WINDOW_CUSTOM_AIR_FRICTION, 0);
set_window_value(AT_JAB, 9, AG_WINDOW_CUSTOM_GROUND_FRICTION, .25);
set_window_value(AT_JAB, 9, AG_WINDOW_HITPAUSE_FRAME, 0);
...
set_hitbox_value(AT_JAB, 2, HG_HITSTUN_MULTIPLIER, 1.2);
...
set_hitbox_value(AT_JAB, 3, HG_ANGLE, 59);
set_hitbox_value(AT_JAB, 3, HG_BASE_KNOCKBACK, 8.5);
