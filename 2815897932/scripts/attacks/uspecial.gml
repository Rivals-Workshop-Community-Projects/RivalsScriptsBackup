...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX_FRAME, 18);
...
set_hitbox_value(AT_USPECIAL, 1, HG_BASE_KNOCKBACK, 5.75);
set_hitbox_value(AT_USPECIAL, 1, HG_KNOCKBACK_SCALING, 1.05);
