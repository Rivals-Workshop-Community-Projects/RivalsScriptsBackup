...
set_color_profile_slot( 1, 1, 37, 167, 189 ); //body shade
set_color_profile_slot( 1, 2, 149, 201, 220 ); //face
set_color_profile_slot( 1, 3, 76, 111, 166 ); //face shade
...
set_color_profile_slot( 2, 1, 177, 40, 179 ); //body shade
set_color_profile_slot( 2, 2, 149, 201, 220 ); //face
set_color_profile_slot( 2, 3, 76, 111, 166 ); //face shade
...
set_color_profile_slot( 3, 1, 27, 158, 65 ); //body shade
set_color_profile_slot( 3, 2, 149, 201, 220 ); //face
set_color_profile_slot( 3, 3, 76, 111, 166 ); //face shade
...
set_color_profile_slot( 4, 1, 30, 31, 36 ); //body shade
set_color_profile_slot( 4, 2, 149, 201, 220 ); //face
set_color_profile_slot( 4, 3, 76, 111, 166 ); //face shade
...
set_color_profile_slot( 5, 1, 193, 136, 33 ); //body shade
set_color_profile_slot( 5, 2, 149, 201, 220 ); //face
set_color_profile_slot( 5, 3, 76, 111, 166 ); //face shade
...
set_color_profile_slot( 6, 1, 57, 52, 115 ); //body shade
set_color_profile_slot( 6, 2, 133, 110, 150 ); //face
set_color_profile_slot( 6, 3, 89, 72, 115 ); //face shade
...
set_color_profile_slot( 7, 1, 83, 122, 62 ); //body shade
set_color_profile_slot( 7, 2, 167, 186, 74 ); //face
set_color_profile_slot( 7, 3, 167, 186, 74 ); //face shade
...
set_color_profile_slot( 8, 1, 132, 149, 193 ); //body shade
set_color_profile_slot( 8, 2, 149, 201, 220 ); //face
set_color_profile_slot( 8, 3, 76, 111, 166 ); //face shade
...
set_color_profile_slot( 9, 1, 10, 77, 46 ); //body shade
set_color_profile_slot( 9, 2, 149, 201, 220 ); //face
set_color_profile_slot( 9, 3, 76, 111, 166 ); //face shade
...
set_color_profile_slot( 10, 1, 61, 23, 124 ); //body shade
set_color_profile_slot( 10, 2, 149, 201, 220 ); //face
set_color_profile_slot( 10, 3, 76, 111, 166 ); //face shade
...
set_color_profile_slot( 11, 1, 77, 35, 21 ); //body shade
set_color_profile_slot( 11, 2, 149, 201, 220 ); //face
set_color_profile_slot( 11, 3, 76, 111, 166 ); //face shade
...
set_color_profile_slot( 12, 1, 180, 62, 26 ); //body shade
set_color_profile_slot( 12, 2, 149, 201, 220 ); //face
set_color_profile_slot( 12, 3, 76, 111, 166 ); //face shade
...
set_color_profile_slot( 13, 1, 10, 23, 138 ); //body shade
set_color_profile_slot( 13, 2, 149, 201, 220 ); //face
set_color_profile_slot( 13, 3, 76, 111, 166 ); //face shade
...
set_color_profile_slot( 14, 1, 123, 125, 173 ); //body shade
set_color_profile_slot( 14, 2, 190, 209, 222 ); //face
set_color_profile_slot( 14, 3, 123, 125, 173 ); //face shade
...
// riptide
set_color_profile_slot( 21, 0, 253, 183, 0 ); //body
set_color_profile_slot( 21, 1, 201, 121, 0 ); //body shade
set_color_profile_slot( 21, 2, 8, 194, 217 ); //face
set_color_profile_slot( 21, 3, 0, 120, 184 ); //face shade
...
=== BEGIN JSON PALETTE ===
{"formatversion":1,"data":[{"name":"body","colors":[{"r":197,"g":17,"b":17,"main":true}]},{"name":"body shade","colors":[{"r":143,"g":0,"b":29,"main":true}]},{"name":"face","colors":[{"r":149,"g":201,"b":220,"main":true}]},{"name":"face shade","colors":[{"r":76,"g":111,"b":166,"main":true}]},{"name":"face highlight","colors":[{"r":189,"g":238,"b":240,"main":true}]},{"name":"vent","colors":[{"r":189,"g":189,"b":189,"main":true}]},{"name":"vent shade","colors":[{"r":124,"g":124,"b":124,"main":true}]}]}
=== END JSON PALETTE ===
*/
