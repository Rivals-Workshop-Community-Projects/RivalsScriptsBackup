...
sprite_index = sprite_get("laser");           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
image_index = 0;                                    //The frame in the animation the article should start at. 0 = beginning of animation
spr_dir = player_id.spr_dir;                        //The direction the article should face when it spawns. Here I have it set to face the same way as the character
uses_shader = true;                                 //Whether or not the article is recolored according to the character's color.gml and costume.
mask_index = sprite_get("laser_mask");
...
new_sprite = sprite_get("laser");             //This is another part of the animation handling. It tells the game "this is the sprite this article should be using; if it's not already, switch it over please"
...
To summon an article, use the line:
    ...
    instance_create(x, y, asset_get("obj_article3"));
...
Anyway, we can use "myarticle" to refer to the article we just created, WITHOUT referring to other instances of it that may already exist.
    ...
    var myarticle = instance_create(x+50, y-10, asset_get("obj_article3"));
