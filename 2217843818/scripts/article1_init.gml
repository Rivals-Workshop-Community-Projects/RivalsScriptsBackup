...
mask_index = sprite_get("button_mask");
...
new_sprite = asset_get("empty_sprite");             //This is another part of the animation handling. It tells the game "this is the sprite this article should be using; if it's not already, switch it over please"
