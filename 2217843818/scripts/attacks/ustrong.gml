...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_absa_dattack"));
...
set_window_value(AT_USTRONG, 4, AG_WINDOW_SFX, asset_get("sfx_absa_harderhit"));
...
set_hitbox_value(AT_USTRONG, 1, HG_WIDTH, 67);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, 22);
...
set_hitbox_value(AT_USTRONG, 2, HG_WIDTH, 67);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, 22);
...
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_Y, -44);
...
set_hitbox_value(AT_USTRONG, 3, HG_VISUAL_EFFECT, 22);
...
set_hitbox_value(AT_USTRONG, 4, HG_WIDTH, 72);
