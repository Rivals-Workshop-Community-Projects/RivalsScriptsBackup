...
set_window_value(AT_UAIR, 2, AG_WINDOW_SFX, asset_get("sfx_birdclap"));
...
set_window_value(AT_UAIR, 3, AG_WINDOW_VSPEED, -3);
...
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, -32);
...
set_hitbox_value(AT_UAIR, 2, HG_WIDTH, 10);
set_hitbox_value(AT_UAIR, 2, HG_HEIGHT, 10);
