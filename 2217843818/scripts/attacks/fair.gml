...
set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, asset_get("sfx_ori_stomp_spin"));
...
set_hitbox_value(AT_FAIR, 3, HG_WIDTH, 51);
...
set_hitbox_value(AT_FAIR, 4, HG_WIDTH, 51);
...
set_hitbox_value(AT_FAIR, 4, HG_HITSTUN_MULTIPLIER, .8);
...
set_hitbox_value(AT_FAIR, 5, HG_WIDTH, 69);
set_hitbox_value(AT_FAIR, 5, HG_HEIGHT, 56);
...
set_hitbox_value(AT_FAIR, 5, HG_KNOCKBACK_SCALING, .45);
