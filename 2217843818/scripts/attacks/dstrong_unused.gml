set_attack_value(AT_EXTRA_1, AG_SPRITE, sprite_get("dstrong_unused"));
...
set_attack_value(AT_EXTRA_1, AG_HURTBOX_SPRITE, sprite_get("dstrong_hurt"));
...
set_window_value(AT_EXTRA_1, 2, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy1"));
...
set_window_value(AT_EXTRA_1, 4, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy2"));
...
set_window_value(AT_EXTRA_1, 6, AG_WINDOW_HAS_WHIFFLAG, 10);
...
set_window_value(AT_EXTRA_1, 7, AG_WINDOW_HAS_WHIFFLAG, 10);
...
set_hitbox_value(AT_EXTRA_1, 1, HG_WIDTH, 160);
...
set_hitbox_value(AT_EXTRA_1, 1, HG_EXTRA_HITPAUSE, 25);
set_hitbox_value(AT_EXTRA_1, 1, HG_VISUAL_EFFECT, 13);
set_hitbox_value(AT_EXTRA_1, 1, HG_VISUAL_EFFECT_X_OFFSET, 10);
set_hitbox_value(AT_EXTRA_1, 1, HG_HIT_SFX, asset_get("sfx_blow_heavy2"));
set_hitbox_value(AT_EXTRA_1, 1, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_EXTRA_1, 1, HG_HITSTUN_MULTIPLIER, 1.0);
...
set_hitbox_value(AT_EXTRA_1, 2, HG_HITBOX_X, 5);
...
set_hitbox_value(AT_EXTRA_1, 2, HG_KNOCKBACK_SCALING, 1.3);
set_hitbox_value(AT_EXTRA_1, 2, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_EXTRA_1, 2, HG_HITPAUSE_SCALING, .9);
set_hitbox_value(AT_EXTRA_1, 2, HG_VISUAL_EFFECT, 13);
set_hitbox_value(AT_EXTRA_1, 2, HG_VISUAL_EFFECT_X_OFFSET, 10);
