...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_shing"));

set_window_value(AT_DSPECIAL, 2, AG_WINDOW_LENGTH, 14);
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_ANIM_FRAME_START, 2);
// set_window_value(AT_DSPECIAL, 2, AG_WINDOW_HAS_SFX, 1);
// set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_shing"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_abyss_explosion_big"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_VISUAL_EFFECT, HFX_ELL_FSPEC_BIG_HIT);
