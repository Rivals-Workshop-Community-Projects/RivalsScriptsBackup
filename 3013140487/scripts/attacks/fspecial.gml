...
if(has_rune("G")) set_window_value(AT_FSPECIAL, 1, AG_WINDOW_LENGTH, 7);
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_GOTO, 30);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, sound_get("sfx_grapple_hit"));
...
if(has_rune("B")) set_hitbox_value(AT_FSPECIAL, 2, HG_EFFECT, 13);