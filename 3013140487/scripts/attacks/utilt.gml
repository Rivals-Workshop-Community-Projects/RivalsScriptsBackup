...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("sfx_knifeswing_medium1"));
...
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sound_get("sfx_knifeblow_medium2"));
...
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, 3);
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, sound_get("sfx_knifeblow_medium2"));
...
set_hitbox_value(AT_UTILT, 3, HG_VISUAL_EFFECT, 3);
set_hitbox_value(AT_UTILT, 3, HG_HIT_SFX, sound_get("sfx_knifeblow_medium2"));