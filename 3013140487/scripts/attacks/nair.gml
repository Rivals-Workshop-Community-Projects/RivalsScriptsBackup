...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sound_get("sfx_knifeblow_weaker1"));
...
set_hitbox_value(AT_NAIR, 5, HG_HEIGHT, 82);
...
set_hitbox_value(AT_NAIR, 5, HG_VISUAL_EFFECT, 3);
set_hitbox_value(AT_NAIR, 5, HG_HIT_SFX, sound_get("sfx_knifeblow_medium2"));
