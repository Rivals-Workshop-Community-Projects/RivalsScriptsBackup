...
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HITBOX_X, 22);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HITBOX_Y, -31);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_WIDTH, 30);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HEIGHT, 28);
...
set_hitbox_value(AT_NSPECIAL_2, 20, HG_HITBOX_X, 22);
...
set_hitbox_value(AT_NSPECIAL_2, 20, HG_KNOCKBACK_SCALING, 0.65);
