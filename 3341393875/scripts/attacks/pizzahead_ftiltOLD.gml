/*set_attack_value(AT_EXTRA_3, AG_SPRITE, sprite_get("pizzahead_ftilt"));
set_attack_value(AT_EXTRA_3, AG_NUM_WINDOWS, 3);
set_attack_value(AT_EXTRA_3, AG_HURTBOX_SPRITE, sprite_get("pizzahead_ftilt_hurt"));
...
set_window_value(AT_EXTRA_3, 2, AG_WINDOW_SFX, asset_get("sfx_swipe_weak2"));
...
set_hitbox_value(AT_EXTRA_3, 1, HG_HITBOX_Y, -51);
