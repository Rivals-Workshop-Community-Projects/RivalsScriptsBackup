...
set_attack_value(AT_UAIR, AG_SPRITE, sprite_get("pizzaface_uair"));
set_attack_value(AT_UAIR, AG_NUM_WINDOWS, 5);
set_attack_value(AT_UAIR, AG_HAS_LANDING_LAG, 1);
set_attack_value(AT_UAIR, AG_LANDING_LAG, 10);
set_attack_value(AT_UAIR, AG_HURTBOX_SPRITE, sprite_get("pizzaface_uair_hurt"));
...
set_window_value(AT_UAIR, 2, AG_WINDOW_SFX, asset_get("sfx_absa_cloud_crackle"));
...
set_window_value(AT_UAIR, 3, AG_WINDOW_SFX, asset_get("sfx_absa_cloud_crackle"));
...
set_window_value(AT_UAIR, 4, AG_WINDOW_ANIM_FRAME_START, 13);
set_window_value(AT_UAIR, 4, AG_WINDOW_VSPEED, -1);
set_window_value(AT_UAIR, 4, AG_WINDOW_SFX, asset_get("sfx_absa_dashup"));
...
set_hitbox_value(AT_UAIR, 1, HG_HITBOX_Y, -149);
...
set_hitbox_value(AT_UAIR, 2, HG_HITBOX_Y, -149);
...
set_hitbox_value(AT_UAIR, 3, HG_HITBOX_Y, -149);
...
set_hitbox_value(AT_UAIR, 4, HG_HITBOX_Y, -149);
set_hitbox_value(AT_UAIR, 4, HG_WIDTH, 71);
set_hitbox_value(AT_UAIR, 4, HG_HEIGHT, 120);
...
set_hitbox_value(AT_UAIR, 5, HG_HITBOX_X, 10);
set_hitbox_value(AT_UAIR, 5, HG_HITBOX_Y, -149);
set_hitbox_value(AT_UAIR, 5, HG_WIDTH, 95);
set_hitbox_value(AT_UAIR, 5, HG_HEIGHT, 138);
