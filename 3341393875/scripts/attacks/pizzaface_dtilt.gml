set_attack_value(AT_DTILT, AG_SPRITE, sprite_get("pizzaface_dtilt"));
set_attack_value(AT_DTILT, AG_NUM_WINDOWS, 3);
set_attack_value(AT_DTILT, AG_HURTBOX_SPRITE, sprite_get("pizzaface_dtilt_hurt"));
...
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT, HFX_MAY_LEAF_BIG);
...
set_hitbox_value(AT_DTILT, 2, HG_VISUAL_EFFECT_Y_OFFSET, 30);
