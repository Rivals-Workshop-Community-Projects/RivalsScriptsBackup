...
set_attack_value(AT_FAIR, AG_SPRITE, sprite_get("pizzaface_fair"));
set_attack_value(AT_FAIR, AG_NUM_WINDOWS, 4);
set_attack_value(AT_FAIR, AG_HAS_LANDING_LAG, 1);
set_attack_value(AT_FAIR, AG_LANDING_LAG, 6);
set_attack_value(AT_FAIR, AG_HURTBOX_SPRITE, sprite_get("pizzaface_fair_hurt"));
...
set_hitbox_value(AT_FAIR, 2, HG_HITBOX_X, 80);
