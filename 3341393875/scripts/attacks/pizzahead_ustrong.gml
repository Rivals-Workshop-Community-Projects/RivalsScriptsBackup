...
set_attack_value(atk, AG_SPRITE, sprite_get("pizzahead_ustrong"));
set_attack_value(atk, AG_HURTBOX_SPRITE, sprite_get("pizzahead_ustrong_hurt"));
...
set_hitbox_value(atk, hitbox_num, HG_HITBOX_Y, -92);
set_hitbox_value(atk, hitbox_num, HG_WIDTH, 56);
set_hitbox_value(atk, hitbox_num, HG_HEIGHT, 98);
