set_attack_value(AT_DTHROW, AG_SPRITE, sprite_get("pizzahead_dair"));
...
set_attack_value(AT_DTHROW, AG_HURTBOX_SPRITE, sprite_get("pizzahead_dair_hurt"));
...
set_window_value(AT_DTHROW, 1, AG_WINDOW_SFX_FRAME, 10);
...
set_hitbox_value(AT_DTHROW, 1, HG_HITBOX_X, -2);
set_hitbox_value(AT_DTHROW, 1, HG_HITBOX_Y, -38);
set_hitbox_value(AT_DTHROW, 1, HG_WIDTH, 36);
set_hitbox_value(AT_DTHROW, 1, HG_HEIGHT, 55);
...
set_hitbox_value(AT_DTHROW, 2, HG_HITBOX_Y, 6);
set_hitbox_value(AT_DTHROW, 2, HG_HITBOX_X, 2);
set_hitbox_value(AT_DTHROW, 2, HG_WIDTH, 60);
set_hitbox_value(AT_DTHROW, 2, HG_HEIGHT, 36);
...
set_hitbox_value(AT_DTHROW, 2, HG_KNOCKBACK_SCALING, 0.5);
