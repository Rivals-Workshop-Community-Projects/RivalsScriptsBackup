set_attack_value(AT_DATTACK, AG_SPRITE, sprite_get("pizzaface_dattack"));
set_attack_value(AT_DATTACK, AG_NUM_WINDOWS, 3);
set_attack_value(AT_DATTACK, AG_AIR_SPRITE, sprite_get("pizzaface_dattack"));
set_attack_value(AT_DATTACK, AG_HURTBOX_SPRITE, sprite_get("pizzaface_dattack_hurt"));
...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sound_get("EnemyCharge"));
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.75);
...
set_hitbox_value(AT_DATTACK, 1, HG_HITBOX_Y, -59);
set_hitbox_value(AT_DATTACK, 1, HG_HITBOX_X, 58);
...
set_hitbox_value(AT_DATTACK, 2, HG_HITBOX_Y, -59);
