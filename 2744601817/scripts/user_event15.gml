...
switch (get_player_color(player)) {
    case (0):
        ...
        break;
    case (1):
    	draw_sprite(sprite_get("_cssico"),1,x+90,y+16);
        alt_ui_recolor = 0;
        break;
	case (2):
    	draw_sprite(sprite_get("_cssico"),2,x+90,y+16);
    	break;
    case (3):
    	draw_sprite(sprite_get("_cssico"),3,x+90,y+16);
        alt_ui_recolor = 0;
        break;
    case (4):
    	draw_sprite(sprite_get("_cssico"),4,x+90,y+16);
        break;
    case (5):
    	draw_sprite(sprite_get("_cssico"),5,x+90,y+16);
        alt_ui_recolor = 0;
        break;
    case (6):
    	draw_sprite(sprite_get("_cssico"),6,x+90,y+16);
        break;
    case (7):
    	draw_sprite(sprite_get("_cssico"),7,x+90,y+16);
        break;
    case (8):
    	draw_sprite(sprite_get("_cssico"),8,x+90,y+16);
        break;
    case (9):
    	draw_sprite(sprite_get("_cssico"),9,x+90,y+16);
        break;
    case (10):
        alt_ui_recolor = 0;
        break;
