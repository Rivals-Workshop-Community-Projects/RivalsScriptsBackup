...
set_attack_value(AT_EXTRA_1, AG_SPRITE, sprite_get("uair"));
...
set_attack_value(AT_EXTRA_1, AG_HURTBOX_SPRITE, sprite_get("uair_hurt"));

//startup
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_TYPE, 1);
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_LENGTH, 9);//10
...
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_SFX, sound_get("bswish_light1"));
...
set_window_value(AT_EXTRA_1, 2, AG_WINDOW_LENGTH, 4);//10
...
set_window_value(AT_EXTRA_1, 3, AG_WINDOW_LENGTH, 4);//10
...
set_window_value(AT_EXTRA_1, 4, AG_WINDOW_LENGTH, 2);//10
...
set_hitbox_value(AT_EXTRA_1, 1, HG_HITBOX_X, -8*2);
set_hitbox_value(AT_EXTRA_1, 1, HG_HITBOX_Y, -13*2);
set_hitbox_value(AT_EXTRA_1, 1, HG_WIDTH, 36*2);
set_hitbox_value(AT_EXTRA_1, 1, HG_HEIGHT, 17*2);
...
set_hitbox_value(AT_EXTRA_1, 1, HG_VISUAL_EFFECT, fx_bhit);
