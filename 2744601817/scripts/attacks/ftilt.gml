...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, sound_get("bswish_med1"));
...
set_hitbox_value(AT_FTILT, 1, HG_HITBOX_X, 25*2);
set_hitbox_value(AT_FTILT, 1, HG_HITBOX_Y, -17*2);
set_hitbox_value(AT_FTILT, 1, HG_WIDTH, 39*2);
set_hitbox_value(AT_FTILT, 1, HG_HEIGHT, 14*2);
...
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT, fx_bhit);
