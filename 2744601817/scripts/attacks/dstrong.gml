...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("dair"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_X, 15*2);
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_Y, -17*2);
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 13*2);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_PARTICLE_NUM, 1);
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, fx_bhit);
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT_X_OFFSET, 10);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_X, -17*2);
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_Y, -17*2);
set_hitbox_value(AT_DSTRONG, 2, HG_WIDTH, 13*2);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_PARTICLE_NUM, 1);
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, fx_bhit);
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT_X_OFFSET, 10);
...
set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_X, -1*2);
set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_Y, -12*2);
set_hitbox_value(AT_DSTRONG, 3, HG_WIDTH, 24*2);
set_hitbox_value(AT_DSTRONG, 3, HG_HEIGHT, 24*2);
...
set_hitbox_value(AT_DSTRONG, 3, HG_KNOCKBACK_SCALING, .8); 
...
set_hitbox_value(AT_DSTRONG, 3, HG_HIT_PARTICLE_NUM, 1);
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT, fx_bhit);
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT_X_OFFSET, 10);
