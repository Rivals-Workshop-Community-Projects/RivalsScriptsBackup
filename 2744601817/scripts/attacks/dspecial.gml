...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, sound_get("red_mode"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_PARENT_HITBOX, 1);  //use this line to make follow up hitboxes share values with this one, remove it if it should be different
set_hitbox_value(AT_DSPECIAL, 1, HG_HITBOX_TYPE, 1); //setting this to 2 makes it a projectile
...
set_hitbox_value(AT_DSPECIAL, 1, HG_VISUAL_EFFECT, fx_rhit);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_WIDTH, 98);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_VISUAL_EFFECT, fx_rhit_large);
