...
set_window_value(AT_FSPECIAL_2, 1, AG_WINDOW_VSPEED, -1.5);
...
set_window_value(AT_FSPECIAL_2, 2, AG_WINDOW_ANIM_FRAME_START, 15);
...
set_window_value(AT_FSPECIAL_2, 3, AG_WINDOW_ANIM_FRAME_START, 16);
...
set_window_value(AT_FSPECIAL_2, 4, AG_WINDOW_HSPEED, 4);
...
set_window_value(AT_FSPECIAL_2, 5, AG_WINDOW_ANIM_FRAME_START, 13);
...
set_window_value(AT_FSPECIAL_2, 6, AG_WINDOW_LENGTH, 60);
set_window_value(AT_FSPECIAL_2, 6, AG_WINDOW_ANIM_FRAME_START, 15);
set_window_value(AT_FSPECIAL_2, 6, AG_WINDOW_ANIM_FRAMES, 1);

set_window_value(AT_FSPECIAL_2, 7, AG_WINDOW_TYPE, 7);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HITBOX_X, 7*2);
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HITBOX_Y, -15*2);
set_hitbox_value(AT_FSPECIAL_2, 1, HG_WIDTH, 20*2);
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HEIGHT, 20*2);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_VISUAL_EFFECT, fx_rhit );
...
set_hitbox_value(AT_FSPECIAL_2, 2, HG_HITBOX_X, 7*2);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_HITBOX_Y, -15*2);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_WIDTH, 20*2);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_HEIGHT, 20*2);
...
set_hitbox_value(AT_FSPECIAL_2, 2, HG_BASE_HITPAUSE, 11);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_HITPAUSE_SCALING, 0.1);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_VISUAL_EFFECT, fx_rhit );
set_hitbox_value(AT_FSPECIAL_2, 2, HG_HIT_PARTICLE_NUM, 2);
