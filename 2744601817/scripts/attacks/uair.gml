...
set_window_value(AT_UAIR, 1, AG_WINDOW_LENGTH, 9);//10
set_window_value(AT_UAIR, 1, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_UAIR, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX_FRAME, 5);
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, sound_get("bswish_light1"));
...
set_window_value(AT_UAIR, 4, AG_WINDOW_LENGTH, 12);//20
...
set_hitbox_value(AT_UAIR, 1, HG_HITBOX_X, 10*2);
set_hitbox_value(AT_UAIR, 1, HG_HITBOX_Y, -31*2);
set_hitbox_value(AT_UAIR, 1, HG_WIDTH, 24*2);
set_hitbox_value(AT_UAIR, 1, HG_HEIGHT, 25*2);
...
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT, fx_bhit);
