...
textDraw(x + 80, y + 19, "fName", col, 20, 1000, fa_left, 1, false, 1, txt, false);


if use_alt_names{
	if alt_cur < array_length(alt_names) && alt_names[alt_cur] != ""{
		if (alt_cur = 0){
			rectDraw(x + 10, y + 144 - is_online * 12, 76, 10, c_black);
		} else {
			rectDraw(x + 10, y + 144 - is_online * 12, string_width_ext(alt_names[alt_cur], 1000, 200), 10, c_black);
		}
		if (alt_cur = 0){
			textDraw(x + 10, y + 141 - is_online * 12, "fName", $FFFFFF, 1000, 200, fa_left, 1, true, 1, "Red", false);
			textDraw(x + 38, y + 141 - is_online * 12, "fName", $FFFFFF, 1000, 200, fa_left, 1, true, 1, "and", false);
			textDraw(x + 66, y + 141 - is_online * 12, "fName", $FFFFFF, 1000, 200, fa_left, 1, true, 1, "Blue", false);
		} else {
