...
set_window_value(AT_JAB, 5, AG_WINDOW_SFX, sfx_smash_ult_sword_swing_medium_2);
...
set_hitbox_value(AT_JAB, 4, HG_HITBOX_Y, -46);
...
set_hitbox_value(AT_JAB, 4, HG_HIT_SFX, sfx_smash_ult_sword_hit_medium);
