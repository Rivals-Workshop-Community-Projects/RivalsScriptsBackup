...
set_window_value(AT_DTILT, 1, AG_WINDOW_LENGTH, 4 - (brawl_mode * 2));
set_window_value(AT_DTILT, 1, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_DTILT, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, sfx_dtilt);
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX_FRAME, 2 - (brawl_mode * 1));
...
set_window_value(AT_DTILT, 3, AG_WINDOW_LENGTH, 10 - (brawl_mode * 6));
...
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, 22);
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_Y_OFFSET, 10);
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, sfx_smash_ult_sword_hit_weak);