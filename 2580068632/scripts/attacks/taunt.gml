...
set_attack_value(AT_TAUNT, AG_HURTBOX_SPRITE, sprite_get("meta_hurtbox"));
...
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX, sfx_taunt_wings_1);
...
set_window_value(AT_TAUNT, 3, AG_WINDOW_SFX, sfx_taunt_wings_2);
set_window_value(AT_TAUNT, 3, AG_WINDOW_SFX_FRAME, 11);

set_window_value(AT_TAUNT, 4, AG_WINDOW_TYPE, 1);
set_window_value(AT_TAUNT, 4, AG_WINDOW_LENGTH, 28);
set_window_value(AT_TAUNT, 4, AG_WINDOW_ANIM_FRAMES, 7);
