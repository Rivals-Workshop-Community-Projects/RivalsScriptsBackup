...
set_window_value(AT_BAIR, 1, AG_WINDOW_LENGTH, 9 - (brawl_mode * 4));
set_window_value(AT_BAIR, 1, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_BAIR, 1, AG_WINDOW_VSPEED, -1);
set_window_value(AT_BAIR, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sfx_bair_1);
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX_FRAME, 7 - (brawl_mode * 3));
...
set_hitbox_value(AT_BAIR, 1, HG_HITPAUSE_SCALING, .15);
