...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, sfx_crouch);
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX_FRAME, 6);
...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sfx_dimensional_cape_strike);
...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_LENGTH, 18 - (brawl_mode * 9));
...
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sfx_smash_ult_sword_hit_heavy);