...
set_window_value(AT_DATTACK, 1, AG_WINDOW_LENGTH, 7 - (brawl_mode * 3));
set_window_value(AT_DATTACK, 1, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_DATTACK, 1, AG_WINDOW_HSPEED, 3);
set_window_value(AT_DATTACK, 1, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_DATTACK, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sfx_dattack);
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX_FRAME, 3 - (brawl_mode * 1));
