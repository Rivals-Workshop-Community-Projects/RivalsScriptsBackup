...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, sfx_shuttle_loop_2);
...
set_window_value(AT_USPECIAL, 8, AG_WINDOW_HSPEED, 0.5);
...
set_window_value(AT_USPECIAL, 9, AG_WINDOW_ANIM_FRAME_START, 6);
set_window_value(AT_USPECIAL, 9, AG_WINDOW_HSPEED_TYPE, 2);
set_window_value(AT_USPECIAL, 9, AG_WINDOW_HSPEED, 2.5);
...
set_window_value(AT_USPECIAL, 10, AG_WINDOW_ANIM_FRAME_START, 6);
set_window_value(AT_USPECIAL, 10, AG_WINDOW_HSPEED_TYPE, 2);
set_window_value(AT_USPECIAL, 10, AG_WINDOW_HSPEED, 6);
set_window_value(AT_USPECIAL, 10, AG_WINDOW_VSPEED_TYPE, 2);
set_window_value(AT_USPECIAL, 10, AG_WINDOW_VSPEED, 4);
...
set_window_value(AT_USPECIAL, 11, AG_WINDOW_ANIM_FRAME_START, 7);
set_window_value(AT_USPECIAL, 11, AG_WINDOW_HSPEED_TYPE, 2);
set_window_value(AT_USPECIAL, 11, AG_WINDOW_HSPEED, 8);
set_window_value(AT_USPECIAL, 11, AG_WINDOW_VSPEED_TYPE, 2);
set_window_value(AT_USPECIAL, 11, AG_WINDOW_VSPEED, 2);

//Loop 5
set_window_value(AT_USPECIAL, 12, AG_WINDOW_TYPE, 1);
set_window_value(AT_USPECIAL, 12, AG_WINDOW_LENGTH, 2);
set_window_value(AT_USPECIAL, 12, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_USPECIAL, 12, AG_WINDOW_ANIM_FRAME_START, 7);
set_window_value(AT_USPECIAL, 12, AG_WINDOW_HSPEED_TYPE, 2);
set_window_value(AT_USPECIAL, 12, AG_WINDOW_HSPEED, 10);
set_window_value(AT_USPECIAL, 12, AG_WINDOW_VSPEED_TYPE, 2);
set_window_value(AT_USPECIAL, 12, AG_WINDOW_VSPEED, 0);

//Glide
set_window_value(AT_USPECIAL, 13, AG_WINDOW_TYPE, 9);
set_window_value(AT_USPECIAL, 13, AG_WINDOW_LENGTH, 8);
...
set_hitbox_value(AT_USPECIAL, 1, HG_KNOCKBACK_SCALING, 0.75 + (brawl_mode * 0.3));
...
set_hitbox_value(AT_USPECIAL, 1, HG_HIT_SFX, sfx_smash_ult_sword_hit_heavy);
