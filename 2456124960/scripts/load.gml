sprite_change_offset("idle", 108, 154);
...
sprite_change_offset("jump", 108, 154);
sprite_change_offset("doublejump", 108, 154);
sprite_change_offset("walljump", 108, 154);
sprite_change_offset("pratfall", 108, 154);
sprite_change_offset("land", 108, 154);
sprite_change_offset("landinglag", 108, 154);
...
sprite_change_offset("jab", 108, 154);
sprite_change_offset("icicle", 15, 16);
sprite_change_offset("dattack", 122, 154);
sprite_change_offset("ftilt", 108, 154);
sprite_change_offset("dtilt", 108, 194);
sprite_change_offset("utilt", 108, 154);
sprite_change_offset("nair", 108, 154);
sprite_change_offset("fair", 108, 154);
sprite_change_offset("bair", 108, 154);
sprite_change_offset("uair", 108, 154);
sprite_change_offset("dair", 108, 154);
sprite_change_offset("fstrong", 108, 154);
sprite_change_offset("ustrong", 108, 154);
sprite_change_offset("dstrong", 140, 154);
sprite_change_offset("nspecial", 108, 154);
...
sprite_change_offset("fspec_charge_lv3", 32, 32);
sprite_change_offset("fspec_charge_lv4", 32, 32);
sprite_change_offset("fspec_charge_sparkle1", 15, 15);
sprite_change_offset("fspec_charge_sparkle2", 15, 15);
sprite_change_offset("fspec_charge_swirl1", 32, 32);
sprite_change_offset("fspec_charge_swirl2", 32, 32);
sprite_change_offset("fspec_charge_swirl3", 32, 32);
sprite_change_offset("fspec_charge_swirl4", 32, 32);
sprite_change_offset("fspec_charge_ring", 32, 32);
...
sprite_change_offset("dspec_charge_lv2", 32, 32);
sprite_change_offset("dspec_charge_lv3", 32, 32);
sprite_change_offset("dspec_charge_lv4", 32, 32);
sprite_change_offset("dspec_charge_sparkle1", 15, 15);
sprite_change_offset("dspec_charge_sparkle2", 15, 15);
sprite_change_offset("dspec_charge_swirl1", 32, 32);
sprite_change_offset("dspec_charge_swirl2", 32, 32);
sprite_change_offset("dspec_charge_swirl3", 32, 32);
sprite_change_offset("dspec_charge_swirl4", 32, 32);
...
sprite_change_offset("bighurt", 108, 154);
sprite_change_offset("uphurt", 108, 154);
sprite_change_offset("downhurt", 108, 154);
sprite_change_offset("bouncehurt", 108, 154);

sprite_change_offset("plat", 122, 150);
sprite_change_offset("intro", 108, 154);
sprite_change_offset("introstructure", 1600, 400);
...
sprite_change_offset("hud_bg", 80, 20);
...
sprite_change_offset("landinglag_fair_1", 108, 154);
sprite_change_offset("landinglag_fair_2", 108, 154);
sprite_change_offset("landinglag_fair_3", 108, 154);
sprite_change_offset("landinglag_bair_1", 108, 154);
sprite_change_offset("landinglag_bair_2", 108, 154);
sprite_change_offset("landinglag_uair_1", 108, 154);
sprite_change_offset("landinglag_uair_2", 108, 154);
sprite_change_offset("landinglag_uair_3", 108, 154);

sprite_change_offset("effect_dtilt", 108, 194);
sprite_change_offset("effect_utilt", 108, 154);
sprite_change_offset("effect_ustrong", 108, 154);
