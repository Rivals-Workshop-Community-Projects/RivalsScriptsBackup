...
set_hitbox_value(AT_FAIR, 1, HG_KNOCKBACK_SCALING, 1.05);
set_hitbox_value(AT_FAIR, 1, HG_BASE_HITPAUSE, 9);
set_hitbox_value(AT_FAIR, 1, HG_HITPAUSE_SCALING, 1.15);
...
set_hitbox_value(AT_FAIR, 2, HG_HITPAUSE_SCALING, 1.15);
