...
set_hitbox_value(AT_JAB, 3, HG_VISUAL_EFFECT, 27);
...
set_hitbox_value(AT_JAB, 4, HG_HITBOX_Y, -47);
...
set_hitbox_value(AT_JAB, 4, HG_VISUAL_EFFECT, 27);
...
set_hitbox_value(AT_JAB, 6, HG_HITBOX_Y, -47);
...
set_hitbox_value(AT_JAB, 7, HG_ANGLE, 65);
...
set_hitbox_value(AT_JAB, 8, HG_HITBOX_X, 40);
set_hitbox_value(AT_JAB, 8, HG_HITBOX_Y, -47);
set_hitbox_value(AT_JAB, 8, HG_WIDTH, 35);
set_hitbox_value(AT_JAB, 8, HG_HEIGHT, 35);
set_hitbox_value(AT_JAB, 8, HG_PRIORITY, 2);
set_hitbox_value(AT_JAB, 8, HG_DAMAGE, 2); 
set_hitbox_value(AT_JAB, 8, HG_ANGLE, 65);
...
set_hitbox_value(AT_JAB, 8, HG_VISUAL_EFFECT, 27);