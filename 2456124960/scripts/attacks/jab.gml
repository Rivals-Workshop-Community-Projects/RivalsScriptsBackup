...
set_hitbox_value(AT_JAB, 9, HG_WINDOW_CREATION_FRAME, 18);
set_hitbox_value(AT_JAB, 9, HG_LIFETIME, 40);
set_hitbox_value(AT_JAB, 9, HG_HITBOX_X, 32);
set_hitbox_value(AT_JAB, 9, HG_HITBOX_Y, -30);
set_hitbox_value(AT_JAB, 9, HG_WIDTH, 30);
set_hitbox_value(AT_JAB, 9, HG_HEIGHT, 30);
set_hitbox_value(AT_JAB, 9, HG_PRIORITY, 0);
set_hitbox_value(AT_JAB, 9, HG_DAMAGE, 2);
set_hitbox_value(AT_JAB, 9, HG_ANGLE, 90);
set_hitbox_value(AT_JAB, 9, HG_BASE_KNOCKBACK, 6.5);
set_hitbox_value(AT_JAB, 9, HG_KNOCKBACK_SCALING, .3);
set_hitbox_value(AT_JAB, 9, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_JAB, 9, HG_HITPAUSE_SCALING, .3);
set_hitbox_value(AT_JAB, 9, HG_HIT_SFX, asset_get("sfx_icehit_medium1"));
set_hitbox_value(AT_JAB, 9, HG_VISUAL_EFFECT, hitA2);
set_hitbox_value(AT_JAB, 9, HG_PROJECTILE_SPRITE, sprite_get("icicle"));
set_hitbox_value(AT_JAB, 9, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_JAB, 9, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_JAB, 9, HG_PROJECTILE_VSPEED, -24);
set_hitbox_value(AT_JAB, 9, HG_PROJECTILE_HSPEED, 2);
