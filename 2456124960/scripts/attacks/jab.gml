...
set_hitbox_value(AT_JAB, 1, HG_SDI_MULTIPLIER, .0001);
...
set_hitbox_value(AT_JAB, 2, HG_SDI_MULTIPLIER, .0001);
set_hitbox_value(AT_JAB, 2, HG_VISUAL_EFFECT, hitA);
set_hitbox_value(AT_JAB, 2, HG_TECHABLE, 3);

set_hitbox_value(AT_JAB, 9, HG_PARENT_HITBOX, 0);
...
set_hitbox_value(AT_JAB, 9, HG_HITBOX_X, 40);
set_hitbox_value(AT_JAB, 9, HG_HITBOX_Y, -20);
set_hitbox_value(AT_JAB, 9, HG_WIDTH, 45);
set_hitbox_value(AT_JAB, 9, HG_HEIGHT, 30);
set_hitbox_value(AT_JAB, 9, HG_PRIORITY, 2);
set_hitbox_value(AT_JAB, 9, HG_SHAPE, 2);
set_hitbox_value(AT_JAB, 9, HG_DAMAGE, 4); 
set_hitbox_value(AT_JAB, 9, HG_ANGLE, 120);
set_hitbox_value(AT_JAB, 9, HG_BASE_KNOCKBACK, 3.5);
set_hitbox_value(AT_JAB, 9, HG_BASE_HITPAUSE, 4);
set_hitbox_value(AT_JAB, 9, HG_EXTRA_HITPAUSE, 6);
set_hitbox_value(AT_JAB, 9, HG_DRIFT_MULTIPLIER, .4);
set_hitbox_value(AT_JAB, 9, HG_HIT_SFX, asset_get("sfx_icehit_medium1"));
//set_hitbox_value(AT_JAB, 9, HG_ANGLE_FLIPPER, 4);
set_hitbox_value(AT_JAB, 9, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_JAB, 9, HG_SDI_MULTIPLIER, .0001);
set_hitbox_value(AT_JAB, 9, HG_VISUAL_EFFECT, hitA);
set_hitbox_value(AT_JAB, 9, HG_TECHABLE, 3);
...
set_hitbox_value(AT_JAB, 3, HG_SDI_MULTIPLIER, .0001);
...
set_hitbox_value(AT_JAB, 4, HG_ANGLE, 130);
...
set_hitbox_value(AT_JAB, 4, HG_SDI_MULTIPLIER, .0001);
...
set_hitbox_value(AT_JAB, 5, HG_SDI_MULTIPLIER, .0001);
...
set_hitbox_value(AT_JAB, 6, HG_ANGLE, 130);
...
set_hitbox_value(AT_JAB, 7, HG_WINDOW_CREATION_FRAME, 12);
...
set_hitbox_value(AT_JAB, 7, HG_KNOCKBACK_SCALING, 0.3);
...
set_hitbox_value(AT_JAB, 7, HG_DRIFT_MULTIPLIER, 1);
...
set_hitbox_value(AT_JAB, 8, HG_BASE_KNOCKBACK, 7);
...
set_hitbox_value(AT_JAB, 8, HG_DRIFT_MULTIPLIER, 1);
...
set_hitbox_value(AT_JAB, 10, HG_PARENT_HITBOX, 0);
set_hitbox_value(AT_JAB, 10, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_JAB, 10, HG_WINDOW, 8);
set_hitbox_value(AT_JAB, 10, HG_WINDOW_CREATION_FRAME, 18);
set_hitbox_value(AT_JAB, 10, HG_LIFETIME, 40);
set_hitbox_value(AT_JAB, 10, HG_HITBOX_X, 32);
set_hitbox_value(AT_JAB, 10, HG_HITBOX_Y, -30);
set_hitbox_value(AT_JAB, 10, HG_WIDTH, 30);
set_hitbox_value(AT_JAB, 10, HG_HEIGHT, 30);
set_hitbox_value(AT_JAB, 10, HG_PRIORITY, 0);
...
set_hitbox_value(AT_JAB, 10, HG_PROJECTILE_VSPEED, -24);
set_hitbox_value(AT_JAB, 10, HG_PROJECTILE_HSPEED, 2);
