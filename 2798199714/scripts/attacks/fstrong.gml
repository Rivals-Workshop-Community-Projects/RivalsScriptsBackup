...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX_FRAME, 15);
...
set_hitbox_value(AT_FSTRONG, 2, HG_LIFETIME, 60);
...
set_hitbox_value(AT_FSTRONG, 2, HG_PROJECTILE_SPRITE, sprite_get("fstrong_projectile"));
set_hitbox_value(AT_FSTRONG, 2, HG_PROJECTILE_COLLISION_SPRITE, sprite_get("star_big_collision"));
