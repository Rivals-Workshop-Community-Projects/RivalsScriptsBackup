...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, sound_get("slash 3"));
...
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, sound_get("slash_hit"));
...
set_hitbox_value(AT_DTILT, 2, HG_HITPAUSE_SCALING, 1.3);
set_hitbox_value(AT_DTILT, 2, HG_HIT_SFX, sound_get("slash_hit"));
