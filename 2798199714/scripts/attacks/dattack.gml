...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sound_get("stab"));
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_VSPEED, -1);
...
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, sound_get("slash_hit"));