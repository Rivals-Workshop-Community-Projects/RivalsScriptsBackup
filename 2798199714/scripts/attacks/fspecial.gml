...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sound_get("block"));
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .7);
...
set_window_value(AT_FSPECIAL, 8, AG_WINDOW_CUSTOM_GROUND_FRICTION, .2);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("fspecial_projectile"));
set_hitbox_value(AT_FSPECIAL, 3, HG_PROJECTILE_COLLISION_SPRITE, sprite_get("star_big_collision"));
set_hitbox_value(AT_FSPECIAL, 3, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_FSPECIAL, 3, HG_PROJECTILE_DESTROY_EFFECT, 1);
set_hitbox_value(AT_FSPECIAL, 3, HG_PROJECTILE_ANIM_SPEED, .5);
set_hitbox_value(AT_FSPECIAL, 3, HG_PROJECTILE_HSPEED, 18);
