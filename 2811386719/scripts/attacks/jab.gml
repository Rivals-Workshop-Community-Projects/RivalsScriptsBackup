...
set_hitbox_value(AT_JAB, 4, HG_HIT_LOCKOUT, 4);
...
set_hitbox_value(AT_JAB, 5, HG_HITBOX_Y, -55);
...
set_hitbox_value(AT_JAB, 5, HG_HITSTUN_MULTIPLIER, 0.7);
set_hitbox_value(AT_JAB, 5, HG_HIT_SFX, asset_get("sfx_absa_singlezap1"));
