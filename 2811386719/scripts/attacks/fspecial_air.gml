...
set_window_value(AT_FSPECIAL_AIR, 1, AG_WINDOW_LENGTH, 19);
...
set_window_value(AT_FSPECIAL_AIR, 3, AG_WINDOW_LENGTH, 17);
...
set_hitbox_value(AT_FSPECIAL_AIR, 2, HG_HITSTUN_MULTIPLIER, 0.85);
...
set_hitbox_value(AT_FSPECIAL_AIR, 3, HG_KNOCKBACK_SCALING, .7);
...
set_hitbox_value(AT_FSPECIAL_AIR, 3, HG_HITSTUN_MULTIPLIER, 0.8);
...
set_hitbox_value(AT_FSPECIAL_AIR, 4, HG_HITBOX_Y, -15);
...
set_hitbox_value(AT_FSPECIAL_AIR, 4, HG_HITSTUN_MULTIPLIER, 0.85);
