...
set_window_value(AT_USPECIAL_GROUND, 1, AG_WINDOW_LENGTH, 11);
...
set_window_value(AT_USPECIAL_GROUND, 4, AG_WINDOW_LENGTH, 2);
...
set_window_value(AT_USPECIAL_GROUND, 5, AG_WINDOW_TYPE, 0);
set_window_value(AT_USPECIAL_GROUND, 5, AG_WINDOW_LENGTH, 15);
set_window_value(AT_USPECIAL_GROUND, 5, AG_WINDOW_ANIM_FRAMES, 4);
set_window_value(AT_USPECIAL_GROUND, 5, AG_WINDOW_ANIM_FRAME_START, 8);
...
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_ANGLE, 89);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_BASE_HITPAUSE, 2);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_IGNORES_PROJECTILES, 1);
...
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_HITBOX_X, 65);
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_HITBOX_Y, -120);
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_WIDTH, 65);
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_HEIGHT, 65);
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_SHAPE, 0);
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_PRIORITY, 4);
...
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_VISUAL_EFFECT, 304);
...
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_TECHABLE, 2);
...
set_hitbox_value(AT_USPECIAL_GROUND, 3, HG_WINDOW_CREATION_FRAME, 13);
set_hitbox_value(AT_USPECIAL_GROUND, 3, HG_LIFETIME, 3);
set_hitbox_value(AT_USPECIAL_GROUND, 3, HG_HITBOX_X, 20);
set_hitbox_value(AT_USPECIAL_GROUND, 3, HG_HITBOX_Y, -50);
set_hitbox_value(AT_USPECIAL_GROUND, 3, HG_WIDTH, 70);
set_hitbox_value(AT_USPECIAL_GROUND, 3, HG_HEIGHT, 40);
...
set_hitbox_value(AT_USPECIAL_GROUND, 3, HG_HIT_SFX, asset_get("sfx_blow_medium3"));
