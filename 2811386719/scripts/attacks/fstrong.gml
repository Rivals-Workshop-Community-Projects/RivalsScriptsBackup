...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .07);
...
set_hitbox_value(AT_FSTRONG, 2, HG_LIFETIME, 280);
...
set_hitbox_value(AT_FSTRONG, 2, HG_PROJECTILE_HSPEED, 9);
set_hitbox_value(AT_FSTRONG, 2, HG_PROJECTILE_VSPEED, -1);
