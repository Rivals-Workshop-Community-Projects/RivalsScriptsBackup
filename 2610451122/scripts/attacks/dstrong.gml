...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_propeller_dagger_draw"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HEIGHT, 86);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_X, 63);
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT_X_OFFSET, 16);
