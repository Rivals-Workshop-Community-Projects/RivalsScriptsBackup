...
set_hitbox_value(AT_DTILT, 1, HG_HITBOX_X, 115);
...
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT, 197);
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, 30);
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_Y_OFFSET, 10);
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, asset_get("sfx_absa_kickhit"));
