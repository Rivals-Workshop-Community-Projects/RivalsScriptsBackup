...
// Melee Falco - Hopefully you have an IDE that lets you collapse if statements because this is huge. It's necessary for it to be huge so that I have 100%
// control over the balanced mode without messing up Fox or Melee Falco. I could manually go through and get rid of anything that's unchanged, but
...
if (!balanced_falco) {
	...
	if (!easter_egg_set && easter_egg_timer == 91) {
		...
		gravity_speed = 0.60;
		hitstun_grav = 0.55;
		knockback_adj = 100/80; //the multiplier to KB dealt to you. 1 = default, >1 = lighter, <1 = heavier
		moonwalk_accel = 0.75;
		...
		set_hitbox_value(AT_DSTRONG, 5, HG_DAMAGE, 13);
		...
		set_hitbox_value(AT_DSTRONG, 6, HG_DAMAGE, 16);
		...
		set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sound_get("falco_illusion_swoosh"));
		...
		set_hitbox_value(AT_FSTRONG, 9, HG_BASE_KNOCKBACK, 9.6);
		set_hitbox_value(AT_FSTRONG, 9, HG_KNOCKBACK_SCALING, 0.45);
		set_hitbox_value(AT_FSTRONG, 9, HG_BASE_HITPAUSE, 9.6);
		...
		set_window_value(AT_TAUNT, 1, AG_WINDOW_LENGTH, 84);
		...
		set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, sound_get("falco_fiyaa"));
		...
		set_hitbox_value(AT_UTILT, 2, HG_BASE_KNOCKBACK, 7.4);
		set_hitbox_value(AT_UTILT, 2, HG_KNOCKBACK_SCALING, 0.6);
		set_hitbox_value(AT_UTILT, 2, HG_BASE_HITPAUSE, 7.4);
		...
		set_hitbox_value(AT_UTILT, 3, HG_BASE_HITPAUSE, 7.4);
		...
		set_hitbox_value(AT_UTILT, 4, HG_BASE_KNOCKBACK, 7.4);
		set_hitbox_value(AT_UTILT, 4, HG_KNOCKBACK_SCALING, 0.6);
		set_hitbox_value(AT_UTILT, 4, HG_BASE_HITPAUSE, 7.4);
		...
		set_hitbox_value(AT_UTILT, 5, HG_BASE_KNOCKBACK, 7.4);
		set_hitbox_value(AT_UTILT, 5, HG_KNOCKBACK_SCALING, 0.6);
		set_hitbox_value(AT_UTILT, 5, HG_BASE_HITPAUSE, 7.4);
		set_hitbox_value(AT_UTILT, 5, HG_HITPAUSE_SCALING, 0.6);
		...
		set_hitbox_value(AT_UTILT, 6, HG_BASE_KNOCKBACK, 7.4);
		set_hitbox_value(AT_UTILT, 6, HG_KNOCKBACK_SCALING, 0.6);
		set_hitbox_value(AT_UTILT, 6, HG_BASE_HITPAUSE, 7.4);
		...
		set_hitbox_value(AT_UTILT, 7, HG_BASE_KNOCKBACK, 7.4);
		set_hitbox_value(AT_UTILT, 7, HG_KNOCKBACK_SCALING, 0.6);
		set_hitbox_value(AT_UTILT, 7, HG_BASE_HITPAUSE, 7.4);
		set_hitbox_value(AT_UTILT, 7, HG_HITPAUSE_SCALING, 0.6);
		set_hitbox_value(AT_UTILT, 7, HG_VISUAL_EFFECT, 304);
		...
		set_hitbox_value(AT_UTILT, 8, HG_BASE_KNOCKBACK, 7.4);
		set_hitbox_value(AT_UTILT, 8, HG_KNOCKBACK_SCALING, 0.6);
		set_hitbox_value(AT_UTILT, 8, HG_BASE_HITPAUSE, 7.4);
		set_hitbox_value(AT_UTILT, 8, HG_HITPAUSE_SCALING, 0.6);
		...
		set_hitbox_value(AT_UTILT, 9, HG_BASE_KNOCKBACK, 7.4);
		set_hitbox_value(AT_UTILT, 9, HG_KNOCKBACK_SCALING, 0.6);
		set_hitbox_value(AT_UTILT, 9, HG_BASE_HITPAUSE, 7.4);
		set_hitbox_value(AT_UTILT, 9, HG_HITPAUSE_SCALING, 0.6);
		set_hitbox_value(AT_UTILT, 9, HG_VISUAL_EFFECT, 304);
		...
		set_hitbox_value(AT_UTILT, 10, HG_BASE_KNOCKBACK, 7.4);
		set_hitbox_value(AT_UTILT, 10, HG_KNOCKBACK_SCALING, 0.6);
		set_hitbox_value(AT_UTILT, 10, HG_BASE_HITPAUSE, 7.4);
		set_hitbox_value(AT_UTILT, 10, HG_HITPAUSE_SCALING, 0.6);
		set_hitbox_value(AT_UTILT, 10, HG_VISUAL_EFFECT, 304);
		set_hitbox_value(AT_UTILT, 10, HG_HIT_SFX, asset_get("sfx_blow_medium2"));
		...
		set_hitbox_value(AT_UTILT, 11, HG_BASE_KNOCKBACK, 7.4);
		set_hitbox_value(AT_UTILT, 11, HG_KNOCKBACK_SCALING, 0.6);
		set_hitbox_value(AT_UTILT, 11, HG_BASE_HITPAUSE, 7.4);
		set_hitbox_value(AT_UTILT, 11, HG_HITPAUSE_SCALING, 0.6);
		...
		set_hitbox_value(AT_UTILT, 12, HG_ANGLE, 90);
		set_hitbox_value(AT_UTILT, 12, HG_BASE_KNOCKBACK, 7.4);
		set_hitbox_value(AT_UTILT, 12, HG_KNOCKBACK_SCALING, 0.6);
		set_hitbox_value(AT_UTILT, 12, HG_BASE_HITPAUSE, 7.4);
		set_hitbox_value(AT_UTILT, 12, HG_HITPAUSE_SCALING, 0.6);
		set_hitbox_value(AT_UTILT, 12, HG_VISUAL_EFFECT, 304);
		set_hitbox_value(AT_UTILT, 12, HG_HIT_SFX, asset_get("sfx_blow_medium2"));
		...
		set_hitbox_value(AT_UTILT, 13, HG_ANGLE, 90);
		set_hitbox_value(AT_UTILT, 13, HG_BASE_KNOCKBACK, 7.4);
		set_hitbox_value(AT_UTILT, 13, HG_KNOCKBACK_SCALING, 0.6);
		set_hitbox_value(AT_UTILT, 13, HG_BASE_HITPAUSE, 7.4);
		set_hitbox_value(AT_UTILT, 13, HG_HITPAUSE_SCALING, 0.6);
		set_hitbox_value(AT_UTILT, 13, HG_VISUAL_EFFECT, 304);
		set_hitbox_value(AT_UTILT, 13, HG_HIT_SFX, asset_get("sfx_blow_medium2"));
		...
		set_hitbox_value(AT_UTILT, 14, HG_ANGLE, 90);
		set_hitbox_value(AT_UTILT, 14, HG_GROUNDEDNESS, 2);
		set_hitbox_value(AT_UTILT, 14, HG_BASE_KNOCKBACK, 7.4);
		set_hitbox_value(AT_UTILT, 14, HG_KNOCKBACK_SCALING, 0.6);
		set_hitbox_value(AT_UTILT, 14, HG_BASE_HITPAUSE, 7.4);
		set_hitbox_value(AT_UTILT, 14, HG_HITPAUSE_SCALING, 0.6);
		...
		set_hitbox_value(AT_UTILT, 15, HG_BASE_KNOCKBACK, 7.4);
		set_hitbox_value(AT_UTILT, 15, HG_KNOCKBACK_SCALING, 0.6);
		set_hitbox_value(AT_UTILT, 15, HG_BASE_HITPAUSE, 7.4);
		set_hitbox_value(AT_UTILT, 15, HG_HITPAUSE_SCALING, 0.6);
		set_hitbox_value(AT_UTILT, 15, HG_VISUAL_EFFECT, 304);
		set_hitbox_value(AT_UTILT, 15, HG_HIT_SFX, asset_get("sfx_blow_medium2"));
		...
		set_hitbox_value(AT_UTILT, 16, HG_ANGLE, 90);
		set_hitbox_value(AT_UTILT, 16, HG_BASE_KNOCKBACK, 7.4);
		set_hitbox_value(AT_UTILT, 16, HG_KNOCKBACK_SCALING, 0.7);
		set_hitbox_value(AT_UTILT, 16, HG_BASE_HITPAUSE, 7.4);
		set_hitbox_value(AT_UTILT, 16, HG_HITPAUSE_SCALING, 0.7);
		set_hitbox_value(AT_UTILT, 16, HG_VISUAL_EFFECT, 304);
		set_hitbox_value(AT_UTILT, 16, HG_HIT_SFX, asset_get("sfx_blow_medium2"));
