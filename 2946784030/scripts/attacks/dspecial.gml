...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_blow_heavy2"));
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HITBOX_Y, -7);
set_hitbox_value(AT_DSPECIAL, 2, HG_SHAPE, 2);
set_hitbox_value(AT_DSPECIAL, 2, HG_WIDTH, 156);
set_hitbox_value(AT_DSPECIAL, 2, HG_HEIGHT, 28);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_LIFETIME, 18);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("dspecial_kablooey"));
set_hitbox_value(AT_DSPECIAL, 3, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_DSPECIAL, 3, HG_PROJECTILE_ANIM_SPEED, .3);
