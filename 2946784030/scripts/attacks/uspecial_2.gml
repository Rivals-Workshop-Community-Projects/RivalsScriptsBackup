...
//Add Another Spin SFX Here (Turn into regular fall6)
...
set_window_value(AT_USPECIAL_2, 4, AG_WINDOW_CUSTOM_GRAVITY, 1.5);
set_window_value(AT_USPECIAL_2, 4, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USPECIAL_2, 4, AG_WINDOW_SFX, asset_get("sfx_spin"));

//Fall
set_window_value(AT_USPECIAL_2, 5, AG_WINDOW_TYPE, 10);
...
set_window_value(AT_USPECIAL_2, 5, AG_WINDOW_CUSTOM_GRAVITY, 1.5);
...
set_window_value(AT_USPECIAL_2, 6, AG_WINDOW_ANIM_FRAME_START, 33);

//Recoil
set_window_value(AT_USPECIAL_2, 7, AG_WINDOW_TYPE, 1);
set_window_value(AT_USPECIAL_2, 7, AG_WINDOW_LENGTH, 24);
set_window_value(AT_USPECIAL_2, 7, AG_WINDOW_ANIM_FRAMES, 7);
set_window_value(AT_USPECIAL_2, 7, AG_WINDOW_ANIM_FRAME_START, 34);
set_window_value(AT_USPECIAL_2, 7, AG_WINDOW_VSPEED_TYPE, 2);
set_window_value(AT_USPECIAL_2, 7, AG_WINDOW_HSPEED_TYPE, 2);
set_window_value(AT_USPECIAL_2, 7, AG_WINDOW_HSPEED, -4);
set_window_value(AT_USPECIAL_2, 7, AG_WINDOW_VSPEED, -9);
set_window_value(AT_USPECIAL_2, 7, AG_WINDOW_CUSTOM_GRAVITY, 1);
