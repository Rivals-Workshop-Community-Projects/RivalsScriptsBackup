set_attack_value(AT_EXTRA_1, AG_SPRITE, sprite_get("extra"));
set_attack_value(AT_EXTRA_1, AG_HURTBOX_SPRITE, sprite_get("extra_hurt"));
...
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_SFX, asset_get("sfx_land_heavy"));
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_SFX_FRAME, 0);

set_window_value(AT_EXTRA_1, 2, AG_WINDOW_TYPE, 1);
set_window_value(AT_EXTRA_1, 2, AG_WINDOW_LENGTH, 19);
...
set_hitbox_value(AT_EXTRA_1, 1, HG_HEIGHT, 36);
...
set_hitbox_value(AT_EXTRA_1, 1, HG_VISUAL_EFFECT_X_OFFSET, 30);
set_hitbox_value(AT_EXTRA_1, 1, HG_VISUAL_EFFECT_Y_OFFSET, 10);
set_hitbox_value(AT_EXTRA_1, 1, HG_HIT_SFX, asset_get("sfx_icehit_weak2"));