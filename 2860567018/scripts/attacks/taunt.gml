...
set_window_value(AT_TAUNT, 2, AG_WINDOW_LENGTH, 41);
...
set_hitbox_value(AT_TAUNT, 1, HG_WIDTH, 2);
...
set_hitbox_value(AT_TAUNT, 2, HG_WIDTH, 2);
set_hitbox_value(AT_TAUNT, 2, HG_HEIGHT, 2);
