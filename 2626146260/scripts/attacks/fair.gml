...
set_window_value(AT_FAIR, 2, AG_WINDOW_SFX, asset_get("sfx_clairen_poke_strong"));
...
set_hitbox_value(AT_FAIR, 1, HG_WIDTH, 142);
...
set_hitbox_value(AT_FAIR, 1, HG_KNOCKBACK_SCALING, .76);
