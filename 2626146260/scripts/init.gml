...
birdb1 = hit_fx_create( sprite_get( "birdb1" ), 15*2 );
sprite_change_offset("birdb1", 120, 60);


bird2 = hit_fx_create( sprite_get( "bird2" ), 37*2 );
sprite_change_offset("bird2", 120, 60);

bird1 = hit_fx_create( sprite_get( "bird1" ), 37*2 );
sprite_change_offset("bird1", 120, 60);
