...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_tow_anchor_start"));
...
set_hitbox_value(AT_USPECIAL, 2, HG_HITBOX_X, 58);
...
set_hitbox_value(AT_USPECIAL, 4, HG_HITBOX_X, 58);
...
set_hitbox_value(AT_USPECIAL, 6, HG_HITBOX_X, 58);
...
set_hitbox_value(AT_USPECIAL, 8, HG_HITBOX_X, 58);
...
set_hitbox_value(AT_USPECIAL, 9, HG_KNOCKBACK_SCALING, .75);
...
set_hitbox_value(AT_USPECIAL, 10, HG_KNOCKBACK_SCALING, .75);
