...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, sound_get("hero_charge_init"));
...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("hero_greatslash"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_HEIGHT, 96);
...
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT_X_OFFSET, 18);
