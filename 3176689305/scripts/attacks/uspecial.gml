...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, sound_get("hero_dash"));
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, 100);
...
set_hitbox_value(AT_USPECIAL, 1, HG_HITPAUSE_SCALING, 1.1);
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT_X_OFFSET, 18);
