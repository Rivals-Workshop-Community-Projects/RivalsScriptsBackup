...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sound_get("sw_dair"));
...
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, asset_get("sfx_icehit_weak2"));
...
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, asset_get("sfx_icehit_weak2"));
