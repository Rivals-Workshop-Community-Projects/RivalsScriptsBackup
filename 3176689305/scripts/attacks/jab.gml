...
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, sound_get("sw_uair"));
...
set_window_value(AT_JAB, 4, AG_WINDOW_SFX, sound_get("sw_misc"));
...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, asset_get("sfx_icehit_weak2"));
...
set_hitbox_value(AT_JAB, 2, HG_WIDTH, 81);
