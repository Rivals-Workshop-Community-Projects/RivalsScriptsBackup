...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("hero_fireball_cut"));
...
set_window_value(AT_NSPECIAL, 4, AG_WINDOW_SFX, sound_get("hero_fireball_cut"));
set_window_value(AT_NSPECIAL, 4, AG_WINDOW_SFX_FRAME, 14);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, fx_soulb_small);
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_abyss_hazard_hit"));
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, fx_soulb_small);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("nspecial_proj_shade"));
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_MASK, sprite_get("nspecial_proj_shade"));
set_hitbox_value(AT_NSPECIAL, 2, HG_VISUAL_EFFECT, fx_shadeb_big);
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_HSPEED, 10);
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_DESTROY_EFFECT, fx_shadeb_small);
