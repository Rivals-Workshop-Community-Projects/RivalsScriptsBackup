...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("mantis_lord_whoosh_to_above"));
...
set_hitbox_value(AT_UTILT, 2, HG_BASE_HITPAUSE, 7.5);
set_hitbox_value(AT_UTILT, 2, HG_HITPAUSE_SCALING, .6);
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, asset_get("sfx_icehit_weak2"));