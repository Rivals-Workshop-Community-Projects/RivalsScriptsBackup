...
set_hitbox_value(AT_DAIR, 1, HG_PROJECTILE_SPRITE, sprite_get("powergo"));
set_hitbox_value(AT_DAIR, 1, HG_PROJECTILE_COLLISION_SPRITE, sprite_get("down_arrow"));
set_hitbox_value(AT_DAIR, 1, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, asset_get("sfx_blow_medium2"));
set_hitbox_value(AT_DAIR, 1, HG_PROJECTILE_ANIM_SPEED, .3);
set_hitbox_value(AT_DAIR, 1, HG_PROJECTILE_VSPEED, 18);
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, arrowhitFX);
set_hitbox_value(AT_DAIR, 1, HG_PROJECTILE_DESTROY_EFFECT, arrowhitwallFX);