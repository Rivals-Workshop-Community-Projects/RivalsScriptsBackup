...
set_hitbox_value(curr_attack, 1, HG_HITBOX_Y, -12);
set_hitbox_value(curr_attack, 1, HG_HITBOX_X, 50);
...
set_hitbox_value(curr_attack, 2, HG_HITBOX_Y, -12);
...
set_hitbox_value(curr_attack, 2, HG_ANGLE_FLIPPER, 5);
