...
set_attack_value(curr_attack, AG_OFF_LEDGE, 1);
...
set_window_value(curr_attack, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1);
set_window_value(curr_attack, 1, AG_WINDOW_HSPEED, 0);
set_window_value(curr_attack, 1, AG_WINDOW_HSPEED_TYPE, 2);
...
set_window_value(curr_attack, 2, AG_WINDOW_HSPEED, 7);
set_window_value(curr_attack, 2, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(curr_attack, 2, AG_WINDOW_HAS_CUSTOM_FRICTION, true);
set_window_value(curr_attack, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0);
...
set_window_value(curr_attack, 3, AG_WINDOW_HSPEED, 7);
set_window_value(curr_attack, 3, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(curr_attack, 3, AG_WINDOW_HAS_CUSTOM_FRICTION, true);
set_window_value(curr_attack, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0);
...
set_window_value(curr_attack, 4, AG_WINDOW_HAS_CUSTOM_FRICTION, true);
set_window_value(curr_attack, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1);
...
set_hitbox_value(curr_attack, 1, HG_ANGLE, 65);
