...
wall_frames         = 5;		// may or may not actually work... dan pls
...
jump_sound          = sound_get("jumpsound");
djump_sound         = sound_get("walljumpsound");
wjump_sound         = sound_get("walljumpsound")
