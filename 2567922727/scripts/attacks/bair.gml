...
set_window_value(AT_BAIR, 2, AG_WINDOW_SFX, sound_get("effort1"));
...
set_window_value(AT_BAIR, 4, AG_WINDOW_ANIM_FRAME_START, 0);
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, asset_get("sfx_buzzsaw_hit"));
