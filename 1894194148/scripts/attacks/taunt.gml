...
set_attack_value(AT_TAUNT, AG_HURTBOX_SPRITE, sprite_get("ar_hurtbox"));
...
//set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX, sound_get("scoptool"));
...
set_window_value(AT_TAUNT, 2, AG_WINDOW_SFX, sound_get("scopclap"));
...
set_window_value(AT_TAUNT, 3, AG_WINDOW_SFX, sound_get("scopclap"));
...
set_window_value(AT_TAUNT, 4, AG_WINDOW_SFX, sound_get("scopclap"));
...
set_window_value(AT_TAUNT, 5, AG_WINDOW_SFX, sound_get("scopclap"));

set_window_value(AT_TAUNT, 6, AG_WINDOW_LENGTH, 5);
