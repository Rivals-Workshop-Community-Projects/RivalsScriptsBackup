...
set_hitbox_value(AT_UTILT, 1, HG_WINDOW, 4);//3
set_hitbox_value(AT_UTILT, 1, HG_LIFETIME, 4);//8
set_hitbox_value(AT_UTILT, 1, HG_WIDTH, 48);
set_hitbox_value(AT_UTILT, 1, HG_HEIGHT, 42);
set_hitbox_value(AT_UTILT, 1, HG_PRIORITY, 2);
set_hitbox_value(AT_UTILT, 1, HG_DAMAGE, 6);//5
...
set_hitbox_value(AT_UTILT, 1, HG_BASE_HITPAUSE, 6);//3
set_hitbox_value(AT_UTILT, 1, HG_HITPAUSE_SCALING, 0.35);//.6
