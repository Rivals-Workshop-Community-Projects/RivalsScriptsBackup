...
set_window_value(AT_DATTACK, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.3);
...
set_window_value(AT_DATTACK, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.4);
...
set_window_value(AT_DATTACK, 6, AG_WINDOW_HSPEED_TYPE, 0);
...
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT, crit_effect);
...
set_hitbox_value(AT_DATTACK, 2, HG_BASE_KNOCKBACK, 6.8);
...
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT, crit_effect);
...
set_hitbox_value(AT_DATTACK, 3, HG_BASE_KNOCKBACK, 5.7);
...
set_hitbox_value(AT_DATTACK, 3, HG_VISUAL_EFFECT, snow_effect);
...
set_hitbox_value(AT_DATTACK, 4, HG_HITBOX_X, 22);
...
set_hitbox_value(AT_DATTACK, 4, HG_VISUAL_EFFECT, snow_effect);
...
set_hitbox_value(AT_DATTACK, 5, HG_WIDTH, 98);
set_hitbox_value(AT_DATTACK, 5, HG_HEIGHT, 14);
...
set_hitbox_value(AT_DATTACK, 5, HG_ANGLE, 85);
...
set_hitbox_value(AT_DATTACK, 5, HG_HITPAUSE_SCALING, .2);
set_hitbox_value(AT_DATTACK, 5, HG_VISUAL_EFFECT, snow_effect);
