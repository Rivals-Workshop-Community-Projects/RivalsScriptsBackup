...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, sound_get("spidersay"));
...
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT, crit_effect);
...
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT, snow_effect);
