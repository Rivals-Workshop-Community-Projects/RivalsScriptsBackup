...
set_hitbox_value(AT_UAIR, 1, HG_BASE_HITPAUSE, 2.5);
...
set_hitbox_value(AT_UAIR, 3, HG_ANGLE, 61);
...
set_hitbox_value(AT_UAIR, 5, HG_ANGLE, 62);
...
set_hitbox_value(AT_UAIR, 4, HG_KNOCKBACK_SCALING, 0.2);
