...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, sound_get("shadowpunch"));
...
set_hitbox_value(AT_FTILT, 1, HG_PROJECTILE_SPRITE, sprite_get("shadowpunch"));
set_hitbox_value(AT_FTILT, 1, HG_PROJECTILE_MASK, sprite_get("shadowpunch"));
set_hitbox_value(AT_FTILT, 1, HG_PROJECTILE_ENEMY_BEHAVIOR, 2);
...
set_hitbox_value(AT_FTILT, 1, HG_PROJECTILE_ANIM_SPEED, .4);
set_hitbox_value(AT_FTILT, 1, HG_WINDOW, 99);
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, sound_get("bigpunch"));


set_hitbox_value(AT_FTILT, 2, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_FTILT, 2, HG_PROJECTILE_SPRITE, sprite_get("projectile_invis"));
set_hitbox_value(AT_FTILT, 2, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_FTILT, 2, HG_PROJECTILE_WALL_BEHAVIOR, 2);
set_hitbox_value(AT_FTILT, 2, HG_PROJECTILE_ENEMY_BEHAVIOR, 2);
...
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, sound_get("pokehit_nfe"));