...
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, sound_get("plop"));
set_window_value(AT_JAB, 1, AG_WINDOW_SFX_FRAME, 4);

set_window_value(AT_JAB, 2, AG_WINDOW_TYPE, 9);
set_window_value(AT_JAB, 2, AG_WINDOW_LENGTH, 24);
...
set_hitbox_value(AT_JAB, 1, HG_WINDOW, 99);
set_hitbox_value(AT_JAB, 1, HG_LIFETIME, 14);
...
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_SPRITE, sprite_get("ssl_shadowball_small"));
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_HSPEED, nspec_speed);
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_AIR_FRICTION, 0.3);
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("shadow_hit"));
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_DESTROY_EFFECT, explode);


set_hitbox_value(AT_JAB, 2, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_JAB, 2, HG_WINDOW, 99);
set_hitbox_value(AT_JAB, 2, HG_LIFETIME, 24);
...
set_hitbox_value(AT_JAB, 2, HG_PROJECTILE_SPRITE, sprite_get("ssl_shadowball_med"));
set_hitbox_value(AT_JAB, 2, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_JAB, 2, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_JAB, 2, HG_PROJECTILE_HSPEED, nspec_speed*1.1);
set_hitbox_value(AT_JAB, 2, HG_PROJECTILE_AIR_FRICTION, 0.3);
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, sound_get("shadow_hit"));
set_hitbox_value(AT_JAB, 2, HG_PROJECTILE_DESTROY_EFFECT, explode);

set_hitbox_value(AT_JAB, 3, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_JAB, 3, HG_WINDOW, 99);
set_hitbox_value(AT_JAB, 3, HG_LIFETIME, 34);
...
set_hitbox_value(AT_JAB, 3, HG_PROJECTILE_SPRITE, sprite_get("ssl_shadowball_bg"));
set_hitbox_value(AT_JAB, 3, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_JAB, 3, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_JAB, 3, HG_PROJECTILE_HSPEED, nspec_speed*1.2);
set_hitbox_value(AT_JAB, 3, HG_PROJECTILE_AIR_FRICTION, 0.2);
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, sound_get("shadow_hit"));
set_hitbox_value(AT_JAB, 3, HG_PROJECTILE_DESTROY_EFFECT, explode);


set_hitbox_value(AT_JAB, 4, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_JAB, 4, HG_WINDOW, 99);
set_hitbox_value(AT_JAB, 4, HG_LIFETIME, 44);
set_hitbox_value(AT_JAB, 4, HG_HITBOX_X, 44);
set_hitbox_value(AT_JAB, 4, HG_HITBOX_Y, -44);
set_hitbox_value(AT_JAB, 4, HG_WIDTH, 50);
set_hitbox_value(AT_JAB, 4, HG_HEIGHT, 50);
set_hitbox_value(AT_JAB, 4, HG_PRIORITY, 3);
set_hitbox_value(AT_JAB, 4, HG_DAMAGE, 14);
set_hitbox_value(AT_JAB, 4, HG_ANGLE, 80);
set_hitbox_value(AT_JAB, 4, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_JAB, 4, HG_BASE_HITPAUSE, 16);
set_hitbox_value(AT_JAB, 4, HG_HITPAUSE_SCALING, .3);
set_hitbox_value(AT_JAB, 4, HG_EXTRA_HITPAUSE, 10);
set_hitbox_value(AT_JAB, 4, HG_PROJECTILE_SPRITE, sprite_get("ssl_shadowball_huge"));
set_hitbox_value(AT_JAB, 4, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_JAB, 4, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_JAB, 4, HG_PROJECTILE_HSPEED, nspec_speed*1.3);
set_hitbox_value(AT_JAB, 4, HG_PROJECTILE_AIR_FRICTION, 0.1);
set_hitbox_value(AT_JAB, 4, HG_HIT_SFX, sound_get("shadow_hit"));
set_hitbox_value(AT_JAB, 4, HG_PROJECTILE_DESTROY_EFFECT, explode);