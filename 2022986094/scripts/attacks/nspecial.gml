...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_LENGTH, 50);
...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_bird_screech"));
}
...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_SFX, sound_get("pawnch"));
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_VSPEED_TYPE, 1);
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_HSPEED, 4)
...
set_hitbox_value(AT_NSPECIAL, 1, HG_DAMAGE, 28);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("usa"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_DAMAGE, 28);
