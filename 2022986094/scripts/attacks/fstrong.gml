...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("tuwah"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_HEIGHT, 49);
...
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT_OFFSET_X, 35);
