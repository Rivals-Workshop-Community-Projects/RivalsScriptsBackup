...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("turahh"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_X, 39);
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_Y, -45);
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 73);
...
set_hitbox_value(AT_DSTRONG, 2, HG_ANGLE, 150);
