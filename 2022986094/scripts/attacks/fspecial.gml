...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sound_get("raptorboost"));
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_zetter_upb_hit"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_X, 31);
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_Y, -49);
set_hitbox_value(AT_FSPECIAL, 1, HG_WIDTH, 66);
set_hitbox_value(AT_FSPECIAL, 1, HG_HEIGHT, 95);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HITBOX_X, 31);
set_hitbox_value(AT_FSPECIAL, 2, HG_HITBOX_Y, -49);
