...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sound_get("hah"));
...
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, sound_get("meteor"));
...
set_hitbox_value(AT_DAIR, 2, HG_HITBOX_Y, -61);
set_hitbox_value(AT_DAIR, 2, HG_WIDTH, 33);
