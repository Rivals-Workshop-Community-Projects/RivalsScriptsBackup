...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("chat"));
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, sound_get("wiw"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("hit"));