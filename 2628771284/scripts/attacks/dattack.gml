...
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX, sound_get("nyanyattack"));
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, .40);
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .60);
...
set_hitbox_value(AT_DATTACK, 1, HG_HITBOX_X, 11);
...
set_hitbox_value(AT_DATTACK, 1, HG_KNOCKBACK_SCALING, .23);
...
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, sound_get("hit2"));
