...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("wiw"));
...
set_window_value(AT_BAIR, 2, AG_WINDOW_SFX, sound_get("chat"));
...
set_hitbox_value(AT_BAIR, 1, HG_LIFETIME, 13);
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_X, -13);
...
set_hitbox_value(AT_BAIR, 1, HG_KNOCKBACK_SCALING, .70);
