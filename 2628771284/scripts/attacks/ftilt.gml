...
set_window_value(AT_FTILT, 2, AG_WINDOW_SFX, sound_get("wiw2"));
...
set_hitbox_value(AT_FTILT, 1, HG_WIDTH, 23);
...
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, 50);
set_hitbox_value(AT_FTILT, 1, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_FTILT, 1, HG_BASE_KNOCKBACK, 4);
set_hitbox_value(AT_FTILT, 1, HG_KNOCKBACK_SCALING, 0.34);
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, sound_get("hit5"));