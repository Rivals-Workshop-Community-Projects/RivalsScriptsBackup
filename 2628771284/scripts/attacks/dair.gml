...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sound_get("na"));
...
set_window_value(AT_DAIR, 2, AG_WINDOW_SFX, sound_get("wiw"));
...
set_hitbox_value(AT_DAIR, 1, HG_KNOCKBACK_SCALING, .01);
set_hitbox_value(AT_DAIR, 1, HG_BASE_HITPAUSE, 14);
set_hitbox_value(AT_DAIR, 1, HG_HITPAUSE_SCALING, .2);
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, sound_get("hit"));