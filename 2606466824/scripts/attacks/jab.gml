...
set_window_value(AT_JAB, 2, AG_WINDOW_SFX, asset_get("sfx_land_med2"));
...
set_window_value(AT_JAB, 6, AG_WINDOW_SFX, asset_get("sfx_land_med"));
set_window_value(AT_JAB, 6, AG_WINDOW_SFX_FRAME, 17);
...
set_hitbox_value(AT_JAB, 1, HG_SDI_MULTIPLIER, 2);
//set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, asset_get("sfx_blow_weak1"));
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("punch_light"));
...
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, sound_get("punch_medium"));
...
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, sound_get("punch_heavy"));
set_hitbox_value(AT_JAB, 3, HG_HITBOX_GROUP, 3);
set_hitbox_value(AT_JAB, 3, HG_REVENGE_KB_MULTIPLIER, 1.2);
set_hitbox_value(AT_JAB, 3, HG_MUNO_HITBOX_NAME, "Jab 3");