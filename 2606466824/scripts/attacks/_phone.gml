...
set_window_value(AT_PHONE, 1, AG_WINDOW_LENGTH, 18); //12
set_window_value(AT_PHONE, 1, AG_WINDOW_ANIM_FRAMES, 6);
set_window_value(AT_PHONE, 1, AG_WINDOW_ANIM_FRAME_START, 1);
...
set_window_value(AT_PHONE, 3, AG_WINDOW_LENGTH, 6); //12
