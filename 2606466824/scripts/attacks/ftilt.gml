...
set_window_value(AT_FTILT, 2, AG_WINDOW_SFX, asset_get("sfx_land_med"));
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, sound_get("sword"));
set_hitbox_value(AT_FTILT, 1, HG_REVENGE_KB_MULTIPLIER, 1.25);