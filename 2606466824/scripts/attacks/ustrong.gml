...
set_window_value(AT_USTRONG, 5, AG_WINDOW_ANIM_FRAME_START, 0);
...
set_hitbox_value(AT_USTRONG, 1, HG_WIDTH, 125);
...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("punch_heavy"));
set_hitbox_value(AT_USTRONG, 1, HG_REVENGE_KB_MULTIPLIER, 1.25);
set_hitbox_value(AT_USTRONG, 1, HG_MUNO_HITBOX_NAME, "Upper hit");
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("punch_heavy"));
set_hitbox_value(AT_USTRONG, 2, HG_REVENGE_KB_MULTIPLIER, 1.25);
set_hitbox_value(AT_USTRONG, 2, HG_THROWS_ROCK, 1);
set_hitbox_value(AT_USTRONG, 2, HG_MUNO_HITBOX_NAME, "Lower hit");