...
set_attack_value(AT_USPECIAL, AG_MUNO_ATTACK_MISC, "Above values refer to only doing the first part of the move. Second part only stats: FAF: 51, Endlag: 11, Landing Lag: 30 (or 10 with Soft Landing)");
...
set_hitbox_value(AT_USPECIAL, 4, HG_LIFETIME, 27);
