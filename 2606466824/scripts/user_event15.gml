...
initSection("However, that allowed me to look at Incin with basically fresh eyes, and I'm toning down the things I saw as particularly egregious. Mostly damage numbers and hitbox/hurtbox sizes.");
initSection("Incin's changes aren't as harsh as Geno's IMO. They were already in a pretty good spot.");
initHeader("General");
initSection("* Removed blue rim-lighting from char-select and results-small.");
initHeader("Jab");
initSection("- Damage reduced (3, 3, 6 -> 2, 3, 5) (Total jab combo damage reduced from 12 to 10)");
initHeader("UTilt");
initSection("- Damage reduced (9 -> 8)");
initSection("- Hitbox sizes reduced.");
initHeader("DAttack");
initSection("- Hitbox sizes reduced.");
initSection("- Sweetspot Active Frames reduced (3 -> 2)");
initSection("- Damage reduced (11/8 -> 10/6)");
initHeader("UStrong");
initSection("- Hitbox sizes reduced. (animation adjusted to compensate)");
initSection("- Hurtbox size increased.");
initSection("- Damage reduced (14/12 -> 12/10)");
initHeader("FStrong");
initSection("- Hitbox sizes slightly reduced. (animation adjusted to compensate)");
initSection("- Knockback reduced. (10+1.2/8+1 -> 9.5+1.2/7.5+.95)");
initHeader("NAir");
initSection("- Strong hitbox size reduced.");
initHeader("FAir");
initSection("- Strong hitbox size reduced.");
initSection("- Hurtbox size increased");
initSection("- Weak hitbox damage decreased (9 -> 7)");
initHeader("BAir");
initSection("- Hitbox size reduced.");
initSection("- Knockback reduced (8+1 -> 7+1)");
initHeader("UAir");
initSection("- Hitbox size reduced.");
initHeader("DAir");
initSection("- Damage reduced (13/10 -> 12/8)");
initSection("- Sweetspot hitbox size reduced.");
initHeader("FSpecial: Alolan Grapple");
initSection("- Decreased the range for snapping to the ledge.");
initHeader("BThrow");
initSection("- Knockback changed (9+.95 -> 7+1) (AIR: 8+.8 -> 6+.9)");
initSection("//grounded now galaxies zett on ToH at 135 (center stage) or 100 (ledge) (10% later in each case)");
initSection("- Damage reduced (15 -> 14)");
initHeader("USpecial: Cross Chop");
initSection("- Decreased the vertical height gained from this move.");
initSection("- Decreased the horizontal control over the ascent.");
initSection("* Explosion KB reduced (10+.8 @ 45 -> 9+.6 @ 55)");
initHeader("DSpecial: Revenge");
initSection("- Increased the speed at which Revenge decays (.0012/f -> .0014/f)");
initSection("- Attacking will now make Revenge decay faster.");
initSection("// Turn on the Munophone cheats for Visible Revenge Stack and Self-Sufficient Revenge to see these changes!");
