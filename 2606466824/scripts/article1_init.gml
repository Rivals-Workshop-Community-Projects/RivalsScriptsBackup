...
sprite_index = sprite_get("ropes");           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
mask_index = sprite_get("rope_mask");
image_index = 10;                                    //The frame in the animation the article should start at. 0 = beginning of animation
...
phone_offscr_y_offset = -30; // y offset to draw the arrow at
