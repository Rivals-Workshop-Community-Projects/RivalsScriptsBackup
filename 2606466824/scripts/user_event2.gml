//I can't believe it's not hit_player.gml!
if (my_hitboxID.attack != AT_NSPECIAL) {
	target = noone;
}

if (my_hitboxID.attack == AT_FSPECIAL && hit_player_obj.super_armor == 0) {
...
if (my_hitboxID.attack == AT_USPECIAL && hit_player_obj.super_armor == 0) {
