...
set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_X, 39);
...
set_hitbox_value(AT_DSTRONG, 3, HG_DRIFT_MULTIPLIER, 0.1);
...
set_hitbox_value(AT_DSTRONG, 4, HG_WINDOW_CREATION_FRAME, 269);
...
set_hitbox_value(AT_DSTRONG, 5, HG_WIDTH, 90);
...
set_hitbox_value(AT_DSTRONG, 5, HG_ANGLE, 100);
set_hitbox_value(AT_DSTRONG, 5, HG_BASE_KNOCKBACK, 9);
set_hitbox_value(AT_DSTRONG, 5, HG_KNOCKBACK_SCALING, 0.85);
set_hitbox_value(AT_DSTRONG, 5, HG_BASE_HITPAUSE, 14);
...
set_hitbox_value(AT_DSTRONG, 5, HG_HIT_SFX, asset_get("sfx_may_whip2"));