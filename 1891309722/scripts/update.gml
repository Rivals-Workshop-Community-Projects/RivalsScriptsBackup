...
if (currentCombo < 4) {
	...
	set_hitbox_value(AT_NSPECIAL, 5, HG_HITPAUSE_SCALING, .8);
	...
	set_hitbox_value(AT_FSTRONG, 4, HG_BASE_KNOCKBACK, 9.75);
	...
	set_hitbox_value(AT_BAIR, 1, HG_HITPAUSE_SCALING, .95);
