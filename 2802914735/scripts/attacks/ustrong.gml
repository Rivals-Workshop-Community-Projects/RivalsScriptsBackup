...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("sfx_sharphit_s"));
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("sfx_sharphit_s"));
...
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, sound_get("sfx_sharphit_m"));
