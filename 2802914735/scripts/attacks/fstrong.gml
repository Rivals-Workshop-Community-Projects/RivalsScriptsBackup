...
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sound_get("sfx_sharphit_s"));
...
set_hitbox_value(AT_FSTRONG, 2, HG_HITPAUSE_SCALING, 0.95);
set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT_X_OFFSET, 5);
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, sound_get("sfx_sharphit_m"));
