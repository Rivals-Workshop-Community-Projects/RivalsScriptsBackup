...
set_window_value(AT_UAIR, 1, AG_WINDOW_ANIM_FRAMES, 3); //4
...
set_window_value(AT_UAIR, 2, AG_WINDOW_ANIM_FRAMES, 2); //3
...
set_window_value(AT_UAIR, 3, AG_WINDOW_ANIM_FRAME_START, 7); //7
...
set_hitbox_value(AT_UAIR, 1, HG_WIDTH, 93);
