...
if my_hitboxID.attack == AT_EXTRA_1 {
	...
	if hit_player_obj.object_index == obj_stage_article
        hit_player_obj.percent += 5;
    else
...
if (my_hitboxID.attack == AT_FSPECIAL && my_hitboxID.type == 2 && my_hitboxID.hbox_num==1) && ("clone" not in hit_player_obj || hit_player_obj.clone == false) // bomb arrow system
{
...
if (sharphits>0) {
    ...
    if hit_player_obj.object_index == obj_stage_article
        hit_player_obj.percent += sharpBuff;
    else
