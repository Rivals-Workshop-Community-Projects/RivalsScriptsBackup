...
// green
set_color_profile_slot( 0, 0, 29, 226, 135 );
set_color_profile_slot_range( 0, 1, 1, 43 );

// hair
set_color_profile_slot( 0, 1, 106, 131, 120 );
set_color_profile_slot_range( 1, 2, 6, 19 );

// skin
set_color_profile_slot( 0, 2, 255, 238, 215 );
set_color_profile_slot_range( 2, 15, 28, 10 );

// white
set_color_profile_slot( 0, 3, 226, 255, 247 );
set_color_profile_slot_range( 3, 3, 29, 37 );

// dark
set_color_profile_slot( 0, 4, 37, 69, 59 );
set_color_profile_slot_range( 4, 1, 3, 16 );

// gold
set_color_profile_slot( 0, 5, 255, 184, 15 );
set_color_profile_slot_range( 5, 1, 3, 36 );

// umbrella
set_color_profile_slot( 0, 6, 86, 213, 206 );
set_color_profile_slot_range( 6, 2, 24, 51 );

// eyes
set_color_profile_slot( 0, 7, 0, 98, 56 );
set_color_profile_slot_range( 7, 2, 1, 43 );
...
=== BEGIN JSON PALETTE ===
{"formatversion":1,"data":[{"name":"green","colors":[{"r":29,"g":226,"b":135,"main":true},{"r":22,"g":167,"b":100},{"r":16,"g":121,"b":72}]},{"name":"hair","colors":[{"r":106,"g":131,"b":120,"main":true},{"r":65,"g":85,"b":76}]},{"name":"skin","colors":[{"r":255,"g":238,"b":215,"main":true},{"r":233,"g":168,"b":133}]},{"name":"white","colors":[{"r":226,"g":255,"b":247,"main":true},{"r":156,"g":207,"b":194},{"r":99,"g":162,"b":145}]},{"name":"dark","colors":[{"r":37,"g":69,"b":59,"main":true},{"r":60,"g":107,"b":92}]},{"name":"gold","colors":[{"r":255,"g":184,"b":15,"main":true},{"r":166,"g":119,"b":13}]},{"name":"umbrella","colors":[{"r":86,"g":213,"b":206,"main":true},{"r":26,"g":155,"b":147},{"r":25,"g":86,"b":83}]},{"name":"eyes","colors":[{"r":0,"g":98,"b":56,"main":true},{"r":0,"g":205,"b":121}]}]}
=== END JSON PALETTE ===
*/
