...
set_hitbox_value(AT_DTILT, 1, HG_HITBOX_X, 58);//52
set_hitbox_value(AT_DTILT, 1, HG_HITBOX_Y, -12);
set_hitbox_value(AT_DTILT, 1, HG_WIDTH, 94);//83
set_hitbox_value(AT_DTILT, 1, HG_HEIGHT, 27);
set_hitbox_value(AT_DTILT, 1, HG_SHAPE, 2);
set_hitbox_value(AT_DTILT, 1, HG_DAMAGE, 4);//3
...
set_hitbox_value(AT_DTILT, 2, HG_KNOCKBACK_SCALING, 0.4);//0.3
...
set_hitbox_value(AT_DTILT, 3, HG_HITBOX_Y, -19);
set_hitbox_value(AT_DTILT, 3, HG_WIDTH, 56);
