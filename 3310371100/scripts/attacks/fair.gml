...
set_hitbox_value(AT_FAIR, 6, HG_HITBOX_X, 65);
set_hitbox_value(AT_FAIR, 6, HG_HITBOX_Y, -58);
...
set_hitbox_value(AT_FAIR, 6, HG_ANGLE, hb_angle);
set_hitbox_value(AT_FAIR, 6, HG_PRIORITY, 1);
set_hitbox_value(AT_FAIR, 6, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_FAIR, 6, HG_HIT_LOCKOUT, 15);
set_hitbox_value(AT_FAIR, 6, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_FAIR, 6, HG_KNOCKBACK_SCALING, 0.75);
set_hitbox_value(AT_FAIR, 6, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_FAIR, 6, HG_HITPAUSE_SCALING, 0.4);
...
set_hitbox_value(AT_FAIR, 7, HG_HITBOX_X, 62);
set_hitbox_value(AT_FAIR, 7, HG_HITBOX_Y, -16);
set_hitbox_value(AT_FAIR, 7, HG_WIDTH, 44);
set_hitbox_value(AT_FAIR, 7, HG_HEIGHT, 63);
set_hitbox_value(AT_FAIR, 7, HG_SHAPE, 0);
set_hitbox_value(AT_FAIR, 7, HG_DAMAGE, 4);
set_hitbox_value(AT_FAIR, 7, HG_ANGLE, hb_angle);
set_hitbox_value(AT_FAIR, 7, HG_PRIORITY, 1);
set_hitbox_value(AT_FAIR, 7, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_FAIR, 7, HG_HIT_LOCKOUT, 15);
set_hitbox_value(AT_FAIR, 7, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_FAIR, 7, HG_KNOCKBACK_SCALING, 0.75);
set_hitbox_value(AT_FAIR, 7, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_FAIR, 7, HG_HITPAUSE_SCALING, 0.4);
set_hitbox_value(AT_FAIR, 7, HG_VISUAL_EFFECT, 301);
