...
set_attack_value(AT_NAIR, AG_LANDING_LAG, 5);//dr mario nair-1
set_attack_value(AT_NAIR, AG_NUM_WINDOWS, 4);
set_attack_value(AT_NAIR, AG_MUNO_ATTACK_MISC_ADD, "hello - this move NO LONGER has AUTOCANCEL");
...
set_hitbox_value(AT_NAIR, 1, HG_ANGLE, 45);//361
...
set_hitbox_value(AT_NAIR, 2, HG_LIFETIME, 22);//17
...
set_hitbox_value(AT_NAIR, 2, HG_KNOCKBACK_SCALING, 0.3);//0.35
