...
set_window_value(AT_UTILT, 3, AG_WINDOW_VSPEED, 8);
...
set_hitbox_value(AT_UTILT, 1, HG_HITBOX_Y, -82);
...
set_hitbox_value(AT_UTILT, 1, HG_HITPAUSE_SCALING, 1.5);
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sfx_hit2);
