...
set_window_value(AT_DATTACK, 4, AG_WINDOW_SFX, landing_lag_sound);
...
set_hitbox_value(AT_DATTACK, 1, HG_WIDTH, 13);
...
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, sfx_hit3);
...
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, sfx_hit4);