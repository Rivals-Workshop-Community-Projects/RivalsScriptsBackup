...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("myonnb"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_swipe_medium1"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("projectile_arrow"));
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_MASK, sprite_get("projectile_arrow"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_HSPEED, 0.005);
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_AIR_FRICTION, -0.15);
...
set_hitbox_value(AT_NSPECIAL, 8, HG_HITBOX_Y, -14);
...
set_hitbox_value(AT_NSPECIAL, 8, HG_HITPAUSE_SCALING, 0.7);
set_hitbox_value(AT_NSPECIAL, 8, HG_HITSTUN_MULTIPLIER, 1.2);
set_hitbox_value(AT_NSPECIAL, 8, HG_VISUAL_EFFECT_Y_OFFSET, -16);
//set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_PARRY_STUN, 1);
//set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_DOES_NOT_REFLECT, 1);
set_hitbox_value(AT_NSPECIAL, 8, HG_HITSTUN_MULTIPLIER, 1.3);
set_hitbox_value(AT_NSPECIAL, 8, HG_PROJECTILE_SPRITE, sprite_get("projectile_arrow"));
set_hitbox_value(AT_NSPECIAL, 8, HG_PROJECTILE_MASK, sprite_get("projectile_arrow"));
...
set_hitbox_value(AT_NSPECIAL, 8, HG_PROJECTILE_HSPEED, -0.005);
set_hitbox_value(AT_NSPECIAL, 8, HG_PROJECTILE_AIR_FRICTION, -0.15);
...
set_hitbox_value(AT_NSPECIAL, 4, HG_HITBOX_Y, -58);
set_hitbox_value(AT_NSPECIAL, 4, HG_PARENT_HITBOX, 2);
...
set_hitbox_value(AT_NSPECIAL, 5, HG_LIFETIME, 19);
set_hitbox_value(AT_NSPECIAL, 5, HG_HITBOX_X, 82);
set_hitbox_value(AT_NSPECIAL, 5, HG_HITBOX_Y, -14);
set_hitbox_value(AT_NSPECIAL, 5, HG_WIDTH, 0);
set_hitbox_value(AT_NSPECIAL, 5, HG_HEIGHT, 0);
...
set_hitbox_value(AT_NSPECIAL, 5, HG_PROJECTILE_PARRY_STUN, 1); // Remove if you can make this unparryable somehow
set_hitbox_value(AT_NSPECIAL, 5, HG_PROJECTILE_SPRITE, sprite_get("projectilestart"));
set_hitbox_value(AT_NSPECIAL, 5, HG_PROJECTILE_MASK, sprite_get("null"));
set_hitbox_value(AT_NSPECIAL, 5, HG_PROJECTILE_ANIM_SPEED, 2.5);
...
set_hitbox_value(AT_NSPECIAL, 6, HG_LIFETIME, 18);
set_hitbox_value(AT_NSPECIAL, 6, HG_HITBOX_X, 62);
set_hitbox_value(AT_NSPECIAL, 6, HG_HITBOX_Y, -44);
...
set_hitbox_value(AT_NSPECIAL, 7, HG_LIFETIME, 18);
set_hitbox_value(AT_NSPECIAL, 7, HG_HITBOX_X, 42);
set_hitbox_value(AT_NSPECIAL, 7, HG_HITBOX_Y, -74);
set_hitbox_value(AT_NSPECIAL, 7, HG_PARENT_HITBOX, 5);