...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("lightswingsoku"));
...
set_window_value(AT_UTILT, 5, AG_WINDOW_SFX, sound_get("sheathe"));

set_window_value(AT_UTILT, 6, AG_WINDOW_LENGTH, 8);
set_window_value(AT_UTILT, 6, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_UTILT, 6, AG_WINDOW_ANIM_FRAME_START, 15);
...
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sound_get("sokuswordhitlight"));
...
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, sound_get("sokuswordhitlight"));
...
set_hitbox_value(AT_UTILT, 3, HG_HIT_SFX, sound_get("sokuswordhitlight"));
