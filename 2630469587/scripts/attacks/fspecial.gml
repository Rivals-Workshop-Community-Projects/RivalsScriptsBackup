...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sound_get("rslash2"));
...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_HSPEED, 23);
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_VSPEED_TYPE, 1);
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_SFX, sound_get("fspecial"));
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.1);
...
set_window_value(AT_FSPECIAL, 5, AG_WINDOW_CUSTOM_AIR_FRICTION, 1.5);
set_window_value(AT_FSPECIAL, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.1);
...
set_window_value(AT_FSPECIAL, 6, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.1);
set_window_value(AT_FSPECIAL, 6, AG_WINDOW_CUSTOM_GRAVITY, 0);

set_window_value(AT_FSPECIAL, 7, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL, 7, AG_WINDOW_LENGTH, 13);
set_window_value(AT_FSPECIAL, 7, AG_WINDOW_ANIM_FRAMES, 10);
...
set_window_value(AT_FSPECIAL, 7, AG_WINDOW_CUSTOM_AIR_FRICTION, 1.5);
set_window_value(AT_FSPECIAL, 7, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.2);
...
set_window_value(AT_FSPECIAL, 8, AG_WINDOW_CUSTOM_AIR_FRICTION, 1.5);
set_window_value(AT_FSPECIAL, 8, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.6);
...
set_window_value(AT_FSPECIAL, 9, AG_WINDOW_SFX, sound_get("sheathe"));
set_window_value(AT_FSPECIAL, 9, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_FSPECIAL, 9, AG_WINDOW_CUSTOM_AIR_FRICTION, 1.1);
set_window_value(AT_FSPECIAL, 9, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.6);
...
set_window_value(AT_FSPECIAL, 10, AG_WINDOW_CUSTOM_AIR_FRICTION, 1.1);
set_window_value(AT_FSPECIAL, 10, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.6);

set_window_value(AT_FSPECIAL, 11, AG_WINDOW_CUSTOM_GRAVITY, 0);
...
set_window_value(AT_FSPECIAL, 11, AG_WINDOW_ANIM_FRAME_START, 7);
set_window_value(AT_FSPECIAL, 11, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_FSPECIAL, 11, AG_WINDOW_CUSTOM_AIR_FRICTION, 1.4);
...
set_window_value(AT_FSPECIAL, 11, AG_WINDOW_HSPEED, 1);
set_window_value(AT_FSPECIAL, 11, AG_WINDOW_CUSTOM_GROUND_FRICTION, 2);
set_window_value(AT_FSPECIAL, 11, AG_WINDOW_HAS_WHIFFLAG, 0);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_SDI_MULTIPLIER, 0.3);
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, sound_get("heavyslashsoku"));
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, sound_get("heavierslashsoku"));
