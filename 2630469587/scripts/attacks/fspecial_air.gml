...
set_attack_value(AT_FSPECIAL_AIR, AG_NUM_WINDOWS, 10);
set_attack_value(AT_FSPECIAL_AIR, AG_HAS_LANDING_LAG, 1);
set_attack_value(AT_FSPECIAL_AIR, AG_LANDING_LAG, 12);
...
set_attack_value(AT_FSPECIAL_AIR, AG_HURTBOX_AIR_SPRITE, sprite_get("fspecial_hurt"));
...
set_window_value(AT_FSPECIAL_AIR, 1, AG_WINDOW_SFX, sound_get("rslash2"));
...
set_window_value(AT_FSPECIAL_AIR, 2, AG_WINDOW_HSPEED, 22);
...
set_window_value(AT_FSPECIAL_AIR, 3, AG_WINDOW_LENGTH, 1);
...
set_window_value(AT_FSPECIAL_AIR, 3, AG_WINDOW_HSPEED, 15);
...
set_window_value(AT_FSPECIAL_AIR, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, 1.1);
set_window_value(AT_FSPECIAL_AIR, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.6);
set_window_value(AT_FSPECIAL_AIR, 4, AG_WINDOW_CUSTOM_GRAVITY, 0);

set_window_value(AT_FSPECIAL_AIR, 5, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL_AIR, 5, AG_WINDOW_LENGTH, 13);
...
set_window_value(AT_FSPECIAL_AIR, 5, AG_WINDOW_CUSTOM_AIR_FRICTION, 1.7);
set_window_value(AT_FSPECIAL_AIR, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.6);
set_window_value(AT_FSPECIAL_AIR, 5, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_FSPECIAL_AIR, 5, AG_WINDOW_HSPEED, 1);
set_window_value(AT_FSPECIAL_AIR, 5, AG_WINDOW_CUSTOM_GRAVITY, 0);
set_window_value(AT_FSPECIAL_AIR, 5, AG_WINDOW_HAS_WHIFFLAG, 0);
...
set_window_value(AT_FSPECIAL_AIR, 6, AG_WINDOW_CUSTOM_AIR_FRICTION, 1.5);
set_window_value(AT_FSPECIAL_AIR, 6, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.6);
set_window_value(AT_FSPECIAL_AIR, 6, AG_WINDOW_CUSTOM_GRAVITY, 1);

set_window_value(AT_FSPECIAL_AIR, 7, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL_AIR, 7, AG_WINDOW_LENGTH, 16);
set_window_value(AT_FSPECIAL_AIR, 7, AG_WINDOW_ANIM_FRAMES, 10);
...
set_window_value(AT_FSPECIAL_AIR, 7, AG_WINDOW_CUSTOM_AIR_FRICTION, 1.5);
set_window_value(AT_FSPECIAL_AIR, 7, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.6);

set_window_value(AT_FSPECIAL_AIR, 8, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL_AIR, 8, AG_WINDOW_LENGTH, 12);
set_window_value(AT_FSPECIAL_AIR, 8, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_FSPECIAL_AIR, 8, AG_WINDOW_ANIM_FRAME_START, 20);
set_window_value(AT_FSPECIAL_AIR, 8, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_FSPECIAL_AIR, 8, AG_WINDOW_CUSTOM_AIR_FRICTION, 1.5);
set_window_value(AT_FSPECIAL_AIR, 8, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.6);

set_window_value(AT_FSPECIAL_AIR, 9, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL_AIR, 9, AG_WINDOW_LENGTH, 6);
set_window_value(AT_FSPECIAL_AIR, 9, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_FSPECIAL_AIR, 9, AG_WINDOW_ANIM_FRAME_START, 21);
set_window_value(AT_FSPECIAL_AIR, 9, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FSPECIAL_AIR, 9, AG_WINDOW_SFX, sound_get("sheathe"));
set_window_value(AT_FSPECIAL_AIR, 9, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_FSPECIAL_AIR, 9, AG_WINDOW_CUSTOM_AIR_FRICTION, 1.1);
set_window_value(AT_FSPECIAL_AIR, 9, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.6);

set_window_value(AT_FSPECIAL_AIR, 10, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL_AIR, 10, AG_WINDOW_LENGTH, 12);
set_window_value(AT_FSPECIAL_AIR, 10, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_FSPECIAL_AIR, 10, AG_WINDOW_ANIM_FRAME_START, 24);
set_window_value(AT_FSPECIAL_AIR, 10, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_FSPECIAL_AIR, 10, AG_WINDOW_CUSTOM_AIR_FRICTION, 1.1);
set_window_value(AT_FSPECIAL_AIR, 10, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.6);

set_window_value(AT_FSPECIAL_AIR, 11, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL_AIR, 11, AG_WINDOW_LENGTH, 3);
set_window_value(AT_FSPECIAL_AIR, 11, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_FSPECIAL_AIR, 11, AG_WINDOW_ANIM_FRAME_START, 7);
set_window_value(AT_FSPECIAL_AIR, 11, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_FSPECIAL_AIR, 11, AG_WINDOW_HSPEED, 2);
set_window_value(AT_FSPECIAL_AIR, 11, AG_WINDOW_CUSTOM_GRAVITY, 0);
set_window_value(AT_FSPECIAL_AIR, 11, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_FSPECIAL_AIR, 11, AG_WINDOW_CUSTOM_AIR_FRICTION, 1.1);
set_window_value(AT_FSPECIAL_AIR, 11, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.6);
...
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_KNOCKBACK_SCALING, .4);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_VISUAL_EFFECT, 67);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_BASE_HITPAUSE, 0);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_HITPAUSE_SCALING, 0.2);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_EXTRA_HITPAUSE, 18);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_SDI_MULTIPLIER, 0.3);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_HIT_SFX, sound_get("heavyslashsoku"));
...
set_hitbox_value(AT_FSPECIAL_AIR, 2, HG_KNOCKBACK_SCALING, 0.9);
set_hitbox_value(AT_FSPECIAL_AIR, 2, HG_VISUAL_EFFECT, 67);
set_hitbox_value(AT_FSPECIAL_AIR, 2, HG_BASE_HITPAUSE, 11);
set_hitbox_value(AT_FSPECIAL_AIR, 2, HG_HITPAUSE_SCALING, 0.8);
set_hitbox_value(AT_FSPECIAL_AIR, 2, HG_EXTRA_HITPAUSE, 30);
set_hitbox_value(AT_FSPECIAL_AIR, 2, HG_HIT_SFX, sound_get("heavierslashsoku"));
