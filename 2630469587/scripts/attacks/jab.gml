...
set_window_value(AT_JAB, 5, AG_WINDOW_LENGTH, 0);
...
set_window_value(AT_JAB, 8, AG_WINDOW_ANIM_FRAME_START, 4);
set_window_value(AT_JAB, 8, AG_WINDOW_CANCEL_TYPE, 1);
set_window_value(AT_JAB, 8, AG_WINDOW_CANCEL_FRAME, 1);
...
set_window_value(AT_JAB, 10, AG_WINDOW_SFX, sound_get("lightswingsoku"));
...
set_window_value(AT_JAB, 12, AG_WINDOW_LENGTH, 11);
set_window_value(AT_JAB, 12, AG_WINDOW_ANIM_FRAME_START, 16);
set_window_value(AT_JAB, 12, AG_WINDOW_ANIM_FRAMES, 9);

set_window_value(AT_JAB, 13, AG_WINDOW_LENGTH, 8);
set_window_value(AT_JAB, 13, AG_WINDOW_ANIM_FRAME_START, 25);
set_window_value(AT_JAB, 13, AG_WINDOW_ANIM_FRAMES, 5);
set_window_value(AT_JAB, 13, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_JAB, 13, AG_WINDOW_SFX, sound_get("sheathe"));

set_window_value(AT_JAB, 14, AG_WINDOW_LENGTH, 8);
set_window_value(AT_JAB, 14, AG_WINDOW_ANIM_FRAME_START, 29);
