...
set_window_value(AT_JAB, 2, AG_WINDOW_SFX, sound_get("slash2"));
...
set_window_value(AT_JAB, 5, AG_WINDOW_SFX, sound_get("slash2"));
...
set_window_value(AT_JAB, 7, AG_WINDOW_CANCEL_FRAME, 4);
...
set_window_value(AT_JAB, 9, AG_WINDOW_SFX, sound_get("lightswingsoku"));
...
set_window_value(AT_JAB, 11, AG_WINDOW_LENGTH, 11);
set_window_value(AT_JAB, 11, AG_WINDOW_ANIM_FRAME_START, 19);
set_window_value(AT_JAB, 11, AG_WINDOW_ANIM_FRAMES, 9);

set_window_value(AT_JAB, 12, AG_WINDOW_LENGTH, 8);
set_window_value(AT_JAB, 12, AG_WINDOW_ANIM_FRAME_START, 28);
set_window_value(AT_JAB, 12, AG_WINDOW_ANIM_FRAMES, 5);
set_window_value(AT_JAB, 12, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_JAB, 12, AG_WINDOW_SFX, sound_get("sheathe"));

set_window_value(AT_JAB, 13, AG_WINDOW_LENGTH, 8);
set_window_value(AT_JAB, 13, AG_WINDOW_ANIM_FRAME_START, 31);
...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("lightsoku"));
set_hitbox_value(AT_JAB, 1, HG_DRIFT_MULTIPLIER, 0.1);
set_hitbox_value(AT_JAB, 1, HG_SDI_MULTIPLIER, 0.1);
...
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, sound_get("lightsoku"));
set_hitbox_value(AT_JAB, 2, HG_DRIFT_MULTIPLIER, 0.1);
set_hitbox_value(AT_JAB, 2, HG_SDI_MULTIPLIER, 0.1);
...
set_hitbox_value(AT_JAB, 3, HG_WIDTH, 76);
...
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, sound_get("sokuswordhitlight"));
