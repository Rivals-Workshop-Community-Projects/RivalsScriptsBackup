...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("sfx_peashoot_1"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_DAMAGE, spread_dmg);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_DAMAGE, spread_dmg);
...
set_hitbox_value(AT_NSPECIAL, 4, HG_DAMAGE, spread_dmg);
...
//Not Fully Charged
set_hitbox_value(AT_NSPECIAL, 9, HG_PARENT_HITBOX, 9);
...
set_hitbox_value(AT_NSPECIAL, 10, HG_KNOCKBACK_SCALING, .65);
set_hitbox_value(AT_NSPECIAL, 9, HG_HIT_SFX, asset_get("sfx_blow_weak1"));
set_hitbox_value(AT_NSPECIAL, 9, HG_PROJECTILE_SPRITE, sprite_get("chargeshot_weak"));
set_hitbox_value(AT_NSPECIAL, 9, HG_PROJECTILE_MASK, sprite_get("chargeshot_weak"));
...
set_hitbox_value(AT_NSPECIAL, 9, HG_PROJECTILE_HSPEED, 8);

//Fully Charged
set_hitbox_value(AT_NSPECIAL, 10, HG_PARENT_HITBOX, 10);
...
set_hitbox_value(AT_NSPECIAL, 10, HG_HITBOX_X, 32);
set_hitbox_value(AT_NSPECIAL, 10, HG_HITBOX_Y, -32);
set_hitbox_value(AT_NSPECIAL, 10, HG_WIDTH, 90);
set_hitbox_value(AT_NSPECIAL, 10, HG_HEIGHT, 60);
...
set_hitbox_value(AT_NSPECIAL, 10, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_NSPECIAL, 10, HG_HITPAUSE_SCALING, 1.0);
set_hitbox_value(AT_NSPECIAL, 10, HG_BASE_KNOCKBACK, 4);
set_hitbox_value(AT_NSPECIAL, 10, HG_KNOCKBACK_SCALING, .55);
set_hitbox_value(AT_NSPECIAL, 10, HG_HIT_SFX, asset_get("sfx_blow_heavy1"));
set_hitbox_value(AT_NSPECIAL, 10, HG_PROJECTILE_SPRITE, sprite_get("chargeshot_full"));
set_hitbox_value(AT_NSPECIAL, 10, HG_PROJECTILE_MASK, sprite_get("chargeshot_full"));
set_hitbox_value(AT_NSPECIAL, 10, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_NSPECIAL, 10, HG_PROJECTILE_HSPEED, 14);
set_hitbox_value(AT_NSPECIAL, 10, HG_PROJECTILE_IS_TRANSCENDENT, true);
set_hitbox_value(AT_NSPECIAL, 10, HG_PROJECTILE_PARRY_STUN, true);
