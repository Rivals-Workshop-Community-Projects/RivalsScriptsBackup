...
set_attack_value(AT_EXTRA_2, AG_SPRITE, sprite_get("nspecial_up"));
set_attack_value(AT_EXTRA_2, AG_AIR_SPRITE, sprite_get("nspecial_up_air"));
set_attack_value(AT_EXTRA_2, AG_HURTBOX_SPRITE, sprite_get("cup_hurtbox"));
...
set_hitbox_value(AT_EXTRA_2, 1, HG_PROJECTILE_SPRITE, sprite_get("chargeshot_weak_up"));
set_hitbox_value(AT_EXTRA_2, 1, HG_PROJECTILE_MASK, sprite_get("chargeshot_weak_up"));
...
set_hitbox_value(AT_EXTRA_2, 1, HG_PROJECTILE_VSPEED, -8);
...
set_hitbox_value(AT_EXTRA_2, 2, HG_LIFETIME, 30);
...
set_hitbox_value(AT_EXTRA_2, 2, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_EXTRA_2, 2, HG_HITPAUSE_SCALING, 1.0);
set_hitbox_value(AT_EXTRA_2, 2, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_EXTRA_2, 2, HG_KNOCKBACK_SCALING, .65);
set_hitbox_value(AT_EXTRA_2, 2, HG_HIT_SFX, asset_get("sfx_blow_heavy1"));
set_hitbox_value(AT_EXTRA_2, 2, HG_PROJECTILE_SPRITE, sprite_get("chargeshot_full_up"));
set_hitbox_value(AT_EXTRA_2, 2, HG_PROJECTILE_MASK, sprite_get("chargeshot_full_up"));
set_hitbox_value(AT_EXTRA_2, 2, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_EXTRA_2, 2, HG_PROJECTILE_VSPEED, -14);
set_hitbox_value(AT_EXTRA_2, 2, HG_PROJECTILE_IS_TRANSCENDENT, true);
set_hitbox_value(AT_EXTRA_2, 2, HG_PROJECTILE_PARRY_STUN, true);
set_hitbox_value(AT_EXTRA_2, 2, HG_EXTENDED_PARRY_STUN, true);

/*
set_attack_value(AT_EXTRA_2, AG_CATEGORY, 2);
set_attack_value(AT_EXTRA_2, AG_SPRITE, sprite_get("superart"));
set_attack_value(AT_EXTRA_2, AG_NUM_WINDOWS, 5);
set_attack_value(AT_EXTRA_2, AG_HAS_LANDING_LAG, 4);
set_attack_value(AT_EXTRA_2, AG_OFF_LEDGE, 1);
set_attack_value(AT_EXTRA_2, AG_AIR_SPRITE, sprite_get("superart"));
set_attack_value(AT_EXTRA_2, AG_HURTBOX_SPRITE, sprite_get("superart_hurt"));

//Startup
set_window_value(AT_EXTRA_2, 1, AG_WINDOW_TYPE, 1);
set_window_value(AT_EXTRA_2, 1, AG_WINDOW_LENGTH, 46);
set_window_value(AT_EXTRA_2, 1, AG_WINDOW_ANIM_FRAMES, 6);
set_window_value(AT_EXTRA_2, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_EXTRA_2, 1, AG_WINDOW_SFX, sound_get("superart_invincible"));
...
set_window_value(AT_EXTRA_2, 4, AG_WINDOW_LENGTH, 20);
