...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, asset_get("sfx_ell_dspecial_explosion_1"));
...
set_hitbox_value(AT_BAIR, 4, HG_HITBOX_X, -56);
set_hitbox_value(AT_BAIR, 4, HG_HITBOX_Y, -24);
set_hitbox_value(AT_BAIR, 4, HG_WIDTH, 100);
...
set_hitbox_value(AT_BAIR, 4, HG_HITPAUSE_SCALING, .65);
set_hitbox_value(AT_BAIR, 4, HG_VISUAL_EFFECT, 141);
set_hitbox_value(AT_BAIR, 4, HG_HIT_SFX, asset_get("sfx_ell_dspecial_explosion_1"));