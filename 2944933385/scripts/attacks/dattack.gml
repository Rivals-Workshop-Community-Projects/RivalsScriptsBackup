...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sound_get("sfx_rev_roll"));
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_SFX, sound_get("sfx_roll_stop"));
...
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, sound_get("sfx_kick_heavy"));
...
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, sound_get("sfx_kick_medium"));