...
sfx_pho_page = sound_get("_pho_select2");
sfx_pho_open_app = sound_get("_pho_select1");
sfx_pho_close_app = sound_get("_pho_close2");
sfx_pho_power_off = sound_get("_pho_close1");
sfx_pho_power_on = sound_get("_pho_open2");
