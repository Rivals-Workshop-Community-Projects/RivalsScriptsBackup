...
// Physical size
char_height         = 96;       //                  not zetterburn's. this is just cosmetic anyway
...
// Victory
set_victory_bg(sprite_get("victory_bg")); // ass fuck shit fart (cry about it ExW)
set_victory_theme(sound_get("mus_koko_wins")); // victory_theme.ogg
...
electro_start = false;
terrain = noone;
zmove = hit_fx_create( sprite_get( "zmove" ), 36 );
electro_burst = hit_fx_create( sprite_get( "electroburst" ), 15 );
electric_hit = hit_fx_create( sprite_get( "electric_hit" ), 24 );
natures_madness = hit_fx_create( sprite_get( "natures_madness" ), 36 );
uspecial_cancel = hit_fx_create( sprite_get( "uspecial_cancel" ), 15 );
uh_oh = hit_fx_create( sprite_get( "uh_oh" ), 24 );
//uspecial_trail = hit_fx_create( sprite_get( "uspecial_trail" ), 30 );
uspecial_trail = noone;
counter_id = noone;
countered = false;
counter_dmg = 0;


overclock_multipler_damage = 1.5;
overclock_multipler_knockback = 1.6;
