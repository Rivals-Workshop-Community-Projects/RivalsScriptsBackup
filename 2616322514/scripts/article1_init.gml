...
sprite_index = sprite_get("terrain_spawn");           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
...
sprite[0] = sprite_get("terrain_spawn");             //Example sprites
sprite[1] = sprite_get("terrain_idle");
sprite[2] = sprite_get("terrain_despawn");
