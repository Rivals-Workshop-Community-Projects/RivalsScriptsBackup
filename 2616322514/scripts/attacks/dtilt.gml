...
set_hitbox_value(AT_DTILT, 1, HG_MUNO_HITBOX_MISC, "Hitting when supercharged will make the attack cancellable into a strong or special attack.");
...
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, sound_get("sfx_electro_hit_weak"));

set_hitbox_value(AT_DTILT, 2, HG_MUNO_HITBOX_NAME, "Sweetspot");
set_hitbox_value(AT_DTILT, 2, HG_EXTRA_CAMERA_SHAKE, 2);
...
set_hitbox_value(AT_DTILT, 2, HG_BASE_HITPAUSE, 16);
set_hitbox_value(AT_DTILT, 2, HG_HITPAUSE_SCALING, .8);
set_hitbox_value(AT_DTILT, 2, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_DTILT, 2, HG_VISUAL_EFFECT, electric_hit);
set_hitbox_value(AT_DTILT, 2, HG_HIT_SFX, sound_get("sfx_electro_hit_heavy"));