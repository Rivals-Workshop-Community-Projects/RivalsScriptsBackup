...
set_hitbox_value(AT_UTILT, 1, HG_MUNO_HITBOX_MISC, "Hitting when supercharged will make the attack cancellable into a strong or special attack.");
...
set_hitbox_value(AT_UTILT, 1, HG_HEIGHT, 34);
set_hitbox_value(AT_UTILT, 1, HG_PRIORITY, 3);
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, electric_hit);
...
set_hitbox_value(AT_UTILT, 1, HG_BASE_HITPAUSE, 16);
set_hitbox_value(AT_UTILT, 1, HG_HITPAUSE_SCALING, .5);
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sound_get("sfx_electro_hit_med"));

set_hitbox_value(AT_UTILT, 1, HG_MUNO_HITBOX_NAME, "Sweetspot");
