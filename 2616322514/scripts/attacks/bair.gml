...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("sfx_shield_swing"));
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("sfx_shield_hit_med"));
...
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, sound_get("sfx_shield_hit_med"));
