...
set_hitbox_value(AT_DAIR, 3, HG_MUNO_HITBOX_NAME, "Sweetspot");
set_hitbox_value(AT_DAIR, 3, HG_MUNO_HITBOX_MISC, "Creates electric terrain or stuns on hit.");

set_window_value(AT_DAIR, 1, AG_WINDOW_LENGTH, 16);
set_window_value(AT_DAIR, 1, AG_WINDOW_ANIM_FRAMES, 4);
set_window_value(AT_DAIR, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DAIR, 1, AG_WINDOW_VSPEED, -1);
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sound_get("sfx_claw_swing_med"));
...
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, sound_get("sfx_electro_hit_med"));
...
set_hitbox_value(AT_DAIR, 2, HG_HITBOX_Y, -86);
...
set_hitbox_value(AT_DAIR, 3, HG_BASE_HITPAUSE, 20);
set_hitbox_value(AT_DAIR, 3, HG_HITPAUSE_SCALING, .8);
set_hitbox_value(AT_DAIR, 3, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_DAIR, 3, HG_VISUAL_EFFECT, electric_hit);
set_hitbox_value(AT_DAIR, 3, HG_HIT_SFX, sound_get("sfx_electro_hit_heavy"));