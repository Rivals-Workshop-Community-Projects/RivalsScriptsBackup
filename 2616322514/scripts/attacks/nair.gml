...
set_window_value(AT_NAIR, 1, AG_WINDOW_VSPEED, -.5);
...
set_hitbox_value(AT_NAIR, 4, HG_HITBOX_Y, -60);
set_hitbox_value(AT_NAIR, 4, HG_HITBOX_X, -70);
...
set_hitbox_value(AT_NAIR, 4, HG_HIT_SFX, sound_get("sfx_shield_hit_med"));
set_hitbox_value(AT_NAIR, 4, HG_HITBOX_GROUP, 1);



set_hitbox_value(AT_NAIR, 5, HG_MUNO_HITBOX_NAME, "Hard Hitter 2");
...
set_hitbox_value(AT_NAIR, 5, HG_HITBOX_Y, -60);
