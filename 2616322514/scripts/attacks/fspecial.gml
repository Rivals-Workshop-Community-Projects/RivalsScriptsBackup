...
set_attack_value(AT_FSPECIAL, AG_MUNO_ATTACK_NAME, "FSpecial (Supercharged)");
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_HITPAUSE_FRAME, 5);
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, 1.1);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT, electric_hit);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, sound_get("sfx_electro_hit_heavy"));
set_hitbox_value(AT_FSPECIAL, 1, HG_IGNORES_PROJECTILES, 1);

set_attack_value(AT_FSPECIAL, AG_MUNO_ATTACK_MISC_ADD, "Failing to hit with the attack will end it with pratfall.");