...
set_hitbox_value(AT_UAIR, 2, HG_MUNO_HITBOX_NAME, "Sweetspot");
set_hitbox_value(AT_UAIR, 2, HG_MUNO_HITBOX_MISC, "Creates electric terrain or stuns on hit.");

set_window_value(AT_UAIR, 1, AG_WINDOW_LENGTH, 12);
set_window_value(AT_UAIR, 1, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_UAIR, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX_FRAME, 11);
set_window_value(AT_UAIR, 1, AG_WINDOW_VSPEED, -1.5);
...
set_hitbox_value(AT_UAIR, 1, HG_HITBOX_Y, -146);
...
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, sound_get("sfx_electro_hit_weak"));
set_hitbox_value(AT_UAIR, 1, HG_ANGLE_FLIPPER, 6);

set_hitbox_value(AT_UAIR, 2, HG_EXTRA_CAMERA_SHAKE, 2);
set_hitbox_value(AT_UAIR, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_UAIR, 2, HG_WINDOW, 2);
set_hitbox_value(AT_UAIR, 2, HG_LIFETIME, 4);
set_hitbox_value(AT_UAIR, 2, HG_HITBOX_Y, -146);
...
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, -15);
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT, electric_hit);
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, sound_get("sfx_electro_hit_heavy"));
...
set_hitbox_value(AT_UAIR, 3, HG_VISUAL_EFFECT_Y_OFFSET, -15);
set_hitbox_value(AT_UAIR, 3, HG_HIT_SFX, sound_get("sfx_shield_hit_weak"));
set_hitbox_value(AT_UAIR, 3, HG_ANGLE_FLIPPER, 6);