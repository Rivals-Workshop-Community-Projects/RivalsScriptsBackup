...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, sound_get("sfx_claw_swing_med"));
...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("sfx_sharp_hit_weak"));

set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_USTRONG, 2, HG_WINDOW, 3);
set_hitbox_value(AT_USTRONG, 2, HG_LIFETIME, 4);
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_Y, -168);
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("sfx_sharp_hit_heavy"));