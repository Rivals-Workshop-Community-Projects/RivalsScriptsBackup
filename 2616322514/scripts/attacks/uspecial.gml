...
set_attack_value(AT_USPECIAL, AG_MUNO_ATTACK_MISC_ADD, "The attack can be cancelled with shield or special, and will move faster and can be cancelled into NSpecial if in the electric terrain.");
...
set_hitbox_value(AT_USPECIAL, 1, HG_HEIGHT, 125);
set_hitbox_value(AT_USPECIAL, 1, HG_PRIORITY, 1);
set_hitbox_value(AT_USPECIAL, 1, HG_DAMAGE, 6);
set_hitbox_value(AT_USPECIAL, 1, HG_ANGLE, 90);
set_hitbox_value(AT_USPECIAL, 1, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_USPECIAL, 1, HG_KNOCKBACK_SCALING, .6);
set_hitbox_value(AT_USPECIAL, 1, HG_BASE_HITPAUSE, 16);
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT, 22);
