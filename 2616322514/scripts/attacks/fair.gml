...
set_hitbox_value(AT_FAIR, 2, HG_MUNO_HITBOX_MISC, "Creates electric terrain or stuns on hit.");
...
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, sound_get("sfx_electro_hit_med"));
...
set_hitbox_value(AT_FAIR, 2, HG_BASE_HITPAUSE, 16);
set_hitbox_value(AT_FAIR, 2, HG_HITPAUSE_SCALING, .55);
set_hitbox_value(AT_FAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_FAIR, 2, HG_VISUAL_EFFECT, electric_hit);
set_hitbox_value(AT_FAIR, 2, HG_HIT_SFX, sound_get("sfx_electro_hit_heavy"));
...
set_hitbox_value(AT_FAIR, 3, HG_HEIGHT, 112);
...
set_hitbox_value(AT_FAIR, 3, HG_VISUAL_EFFECT, 22);
set_hitbox_value(AT_FAIR, 3, HG_VISUAL_EFFECT_X_OFFSET, 32);
set_hitbox_value(AT_FAIR, 3, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_FAIR, 3, HG_HIT_SFX, sound_get("sfx_electro_hit_med"));