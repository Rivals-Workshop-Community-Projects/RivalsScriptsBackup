...
set_hitbox_value(AT_JAB, 6, HG_HITBOX_X, 44);
...
set_hitbox_value(AT_JAB, 7, HG_HITPAUSE_SCALING, 0.5);
set_hitbox_value(AT_JAB, 7, HG_HIT_SFX, asset_get("sfx_blow_medium2"));
