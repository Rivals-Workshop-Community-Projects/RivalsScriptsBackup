...
set_window_value(AT_DATTACK, 4, AG_WINDOW_SFX, asset_get("sfx_mol_uspec_ready"));
...
set_window_value(AT_DATTACK, 6, AG_WINDOW_VSPEED, -4.5);
...
set_hitbox_value(AT_DATTACK, 3, HG_HITBOX_Y, -8);
...
set_hitbox_value(AT_DATTACK, 4, HG_HITBOX_Y, -8);
...
set_hitbox_value(AT_DATTACK, 5, HG_HITBOX_X, 28);
set_hitbox_value(AT_DATTACK, 5, HG_HITBOX_Y, -16);
set_hitbox_value(AT_DATTACK, 5, HG_WIDTH, 72);
set_hitbox_value(AT_DATTACK, 5, HG_HEIGHT, 36);
...
set_hitbox_value(AT_DATTACK, 5, HG_HITSTUN_MULTIPLIER, 0.8);
set_hitbox_value(AT_DATTACK, 5, HG_HIT_SFX, asset_get("sfx_burnapplied"));
set_hitbox_value(AT_DATTACK, 5, HG_VISUAL_EFFECT, 4);
set_hitbox_value(AT_DATTACK, 5, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_DATTACK, 5, HG_VISUAL_EFFECT_Y_OFFSET, 16);
...
set_hitbox_value(AT_DATTACK, 6, HG_HITBOX_X, 56);
set_hitbox_value(AT_DATTACK, 6, HG_HITBOX_Y, -20);
set_hitbox_value(AT_DATTACK, 6, HG_WIDTH, 40);
