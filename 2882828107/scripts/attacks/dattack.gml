...
set_hitbox_value(AT_DATTACK, 5, HG_HITBOX_Y, -18);
set_hitbox_value(AT_DATTACK, 5, HG_WIDTH, 56);
...
set_hitbox_value(AT_DATTACK, 5, HG_EFFECT, 9);
...
set_hitbox_value(AT_DATTACK, 6, HG_HITBOX_Y, -16);
set_hitbox_value(AT_DATTACK, 6, HG_WIDTH, 64);
set_hitbox_value(AT_DATTACK, 6, HG_HEIGHT, 36);
...
set_hitbox_value(AT_DATTACK, 7, HG_HITBOX_X, 70);
set_hitbox_value(AT_DATTACK, 7, HG_HITBOX_Y, -28);
set_hitbox_value(AT_DATTACK, 7, HG_WIDTH, 42);
set_hitbox_value(AT_DATTACK, 7, HG_HEIGHT, 36);
