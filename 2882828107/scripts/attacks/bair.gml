...
set_window_value(AT_BAIR, 3, AG_WINDOW_LENGTH, 21);
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, asset_get("sfx_waterhit_heavy"));
...
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT, 4);
