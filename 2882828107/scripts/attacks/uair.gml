...
set_hitbox_value(AT_UAIR, 5, HG_HEIGHT, 32);
...
set_hitbox_value(AT_UAIR, 7, HG_HITBOX_Y, -36);
...
set_hitbox_value(AT_UAIR, 8, HG_HITBOX_Y, -36);
...
set_hitbox_value(AT_UAIR, 9, HG_HITBOX_Y, -36);
