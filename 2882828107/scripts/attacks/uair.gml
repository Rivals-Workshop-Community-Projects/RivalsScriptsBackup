...
set_hitbox_value(AT_UAIR, 7, HG_PARENT_HITBOX, 6);
...
set_hitbox_value(AT_UAIR, 7, HG_HITBOX_Y, -41);
set_hitbox_value(AT_UAIR, 7, HG_HITBOX_GROUP, 2);

set_hitbox_value(AT_UAIR, 8, HG_PARENT_HITBOX, 6);
...
set_hitbox_value(AT_UAIR, 8, HG_HITBOX_Y, -41);
set_hitbox_value(AT_UAIR, 8, HG_HITBOX_GROUP, 3);

set_hitbox_value(AT_UAIR, 9, HG_PARENT_HITBOX, 6);
...
set_hitbox_value(AT_UAIR, 9, HG_HITBOX_Y, -41);
...
set_hitbox_value(AT_UAIR, 5, HG_HITBOX_Y, -62);
set_hitbox_value(AT_UAIR, 5, HG_WIDTH, 76);
...
set_hitbox_value(AT_UAIR, 5, HG_KNOCKBACK_SCALING, 0.4);
set_hitbox_value(AT_UAIR, 5, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_UAIR, 5, HG_HITPAUSE_SCALING, 0.6);
...
set_hitbox_value(AT_UAIR, 10, HG_HITBOX_Y, -41);
...
set_hitbox_value(AT_UAIR, 10, HG_ANGLE_FLIPPER, 0);
set_hitbox_value(AT_UAIR, 10, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_UAIR, 10, HG_KNOCKBACK_SCALING, 0.4);
set_hitbox_value(AT_UAIR, 10, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_UAIR, 10, HG_HITPAUSE_SCALING, 0.6);
set_hitbox_value(AT_UAIR, 10, HG_HITSTUN_MULTIPLIER, 0.8);
set_hitbox_value(AT_UAIR, 10, HG_HIT_SFX, asset_get("sfx_blow_weak2"));
set_hitbox_value(AT_UAIR, 10, HG_VISUAL_EFFECT, 301);
