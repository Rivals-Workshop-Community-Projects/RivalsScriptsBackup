...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, asset_get("sfx_waterwarp_start"));
...
set_window_value(AT_DTILT, 3, AG_WINDOW_SFX, asset_get("sfx_frog_ustrong"));
...
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, asset_get("sfx_ori_glide_hit"));
