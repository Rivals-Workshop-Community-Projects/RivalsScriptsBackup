...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, sound_get("explosion_startup"));
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, sound_get("explosion"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_HIT_SFX, asset_get("sfx_ori_glide_hit"));
