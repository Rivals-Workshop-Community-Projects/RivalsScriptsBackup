...
set_hitbox_value(AT_NSPECIAL, 3, HG_WIDTH, 92);
set_hitbox_value(AT_NSPECIAL, 3, HG_HEIGHT, 92);
...
set_hitbox_value(AT_NSPECIAL, 5, HG_WIDTH, 92);
set_hitbox_value(AT_NSPECIAL, 5, HG_HEIGHT, 92);
...
set_hitbox_value(AT_NSPECIAL, 5, HG_KNOCKBACK_SCALING, 0.25);
set_hitbox_value(AT_NSPECIAL, 5, HG_BASE_HITPAUSE, 3);
set_hitbox_value(AT_NSPECIAL, 5, HG_EXTRA_HITPAUSE, 3);
...
set_hitbox_value(AT_NSPECIAL, 6, HG_HITBOX_Y, -34);
