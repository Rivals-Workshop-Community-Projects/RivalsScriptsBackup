...
sprite_change_offset("dair", 64, 78);
...
sprite_change_offset("jackolantern", 64, 94);
sprite_change_offset("jackolantern_mask", 64, 94);
sprite_change_offset("jackolantern_startup", 64, 94);
sprite_change_offset("jackolantern_attacking", 64, 94);
sprite_change_offset("jackolantern_fire", 64, 94);
sprite_change_offset("jackolantern_fire_collision", 64, 94);
sprite_change_offset("jackolantern_end", 64, 94);
sprite_change_offset("witchhazel", 64, 94);
sprite_change_offset("witchhazel_mask", 64, 94);
sprite_change_offset("witchhazel_ready", 64, 94);
sprite_change_offset("witchhazel_attacking", 64, 94);
