...
/*
if (attack == AT_UAIR){
    if (window == 2 || window == 3) && (jump_down){
		vsp -= gravity_speed;
	}
}
*/
...
if (attack == AT_FSTRONG){
	...
	if (window == 1 && (window_timer == 6 || (strong_charge mod 10 == 0 && strong_charge > 0))){
...
if (has_rune("L")){
	if (attack == AT_USTRONG || attack == AT_DSTRONG) && strong_charge > 3 && window < 4{
		vsp = 0;
		hsp *= 0.9
		can_move = false
	}
