...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, asset_get("sfx_ice_shieldup"))
...
set_hitbox_value(AT_BAIR, 2, HG_HEIGHT, 74);
...
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, asset_get("sfx_ice_back_air"))
