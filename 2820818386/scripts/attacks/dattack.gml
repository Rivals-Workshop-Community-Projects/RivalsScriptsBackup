...
set_window_value(AT_DATTACK, 1, AG_WINDOW_VSPEED, -3);
...
set_hitbox_value(AT_DATTACK, 1, HG_PROJECTILE_SPRITE, sprite_get("starproj"));
set_hitbox_value(AT_DATTACK, 1, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_DATTACK, 1, HG_PROJECTILE_ANIM_SPEED, 0.15);
set_hitbox_value(AT_DATTACK, 1, HG_PROJECTILE_HSPEED, 14);
set_hitbox_value(AT_DATTACK, 1, HG_PROJECTILE_VSPEED, 0);
...
set_hitbox_value(AT_DATTACK, 1, HG_WIDTH, 22);
...
set_hitbox_value(AT_DATTACK, 2, HG_PROJECTILE_SPRITE, sprite_get("starproj"));
set_hitbox_value(AT_DATTACK, 2, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_DATTACK, 2, HG_PROJECTILE_ANIM_SPEED, 0.15);
set_hitbox_value(AT_DATTACK, 2, HG_PROJECTILE_HSPEED, 14);
set_hitbox_value(AT_DATTACK, 2, HG_PROJECTILE_VSPEED, 0);
set_hitbox_value(AT_DATTACK, 2, HG_PROJECTILE_WALL_BEHAVIOR, 0);
set_hitbox_value(AT_DATTACK, 2, HG_PROJECTILE_GROUND_BEHAVIOR, 0);
...
set_hitbox_value(AT_DATTACK, 2, HG_WIDTH, 22);
...
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, asset_get("sfx_shovel_hit_light2"));
