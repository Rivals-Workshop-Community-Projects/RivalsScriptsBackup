...
set_window_value(AT_DATTACK, 2, AG_WINDOW_VSPEED, -7.5);
...
set_hitbox_value(AT_DATTACK, 1, HG_WIDTH, 20);
...
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, asset_get("sfx_shovel_hit_med2"));
