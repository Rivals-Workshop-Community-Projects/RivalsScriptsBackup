...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_CANCEL_FRAME, 4);
...
set_hitbox_value(AT_USPECIAL, 1, HG_HIT_SFX, asset_get("sfx_ice_shieldup"));
...
set_hitbox_value(AT_USPECIAL, 2, HG_HIT_SFX, asset_get("sfx_ice_shieldup"));
...
set_hitbox_value(AT_USPECIAL, 3, HG_HIT_SFX, asset_get("sfx_ice_shieldup"));
...
set_hitbox_value(AT_USPECIAL, 4, HG_HEIGHT, 64);
...
set_hitbox_value(AT_USPECIAL, 4, HG_HIT_SFX, asset_get("sfx_ice_back_air"));
