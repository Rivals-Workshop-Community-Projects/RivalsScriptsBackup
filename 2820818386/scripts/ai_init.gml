...
far_down_attacks[1] = AT_FSPECIAL;
...
close_up_attacks[5] = AT_FSPECIAL;
close_up_attacks[6] = AT_NSPECIAL;

close_down_attacks[0] = AT_DSTRONG;
close_down_attacks[1] = AT_FSPECIAL;
...
close_side_attacks[2] = AT_USTRONG;
close_side_attacks[3] = AT_FAIR;
close_side_attacks[4] = AT_NAIR;
close_side_attacks[5] = AT_BAIR;
close_side_attacks[6] = AT_FTILT;
close_side_attacks[7] = AT_DTILT;
close_side_attacks[8] = AT_UTILT;
close_side_attacks[9] = AT_JAB;
close_side_attacks[10] = AT_DSPECIAL;
...
neutral_attacks[5] = AT_JAB;
neutral_attacks[6] = AT_FTILT;
