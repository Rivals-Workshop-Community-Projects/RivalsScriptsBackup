...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_LENGTH, 28);
set_window_value(AT_DSTRONG, 1, AG_WINDOW_ANIM_FRAMES, 14);
...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("dog_test"));
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_dust_knuckle"));
