...
//Special Modifiers for 7th Color
switch(get_player_color(player))
{
	default: set_attack_value(AT_FSPECIAL, AG_SPRITE, sprite_get("fspecial"));
	case 7: set_attack_value(AT_FSPECIAL, AG_SPRITE, sprite_get("fspecial_monochrome")); break;
	case 8: set_attack_value(AT_FSPECIAL, AG_SPRITE, sprite_get("fspecial_gameboy")); break;
	case 9: set_attack_value(AT_FSPECIAL, AG_SPRITE, sprite_get("fspecial_abyss")); break;
	case 10: set_attack_value(AT_FSPECIAL, AG_SPRITE, sprite_get("fspecial_valentines")); break;
	case 11: set_attack_value(AT_FSPECIAL, AG_SPRITE, sprite_get("fspecial_halloween")); break;
	case 12: set_attack_value(AT_FSPECIAL, AG_SPRITE, sprite_get("fspecial_champion")); break;
	case 13: set_attack_value(AT_FSPECIAL, AG_SPRITE, sprite_get("fspecial_infamous")); break;
}
...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_ANIM_FRAMES, 19);
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_ANIM_FRAME_START, 0);

set_window_value(AT_FSPECIAL, 2, AG_WINDOW_TYPE, 0);
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_LENGTH, 600);
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_ANIM_FRAME_START, 20);
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_HSPEED, 17);
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_VSPEED, -13);
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_VSPEED_TYPE, 2);

//SFX
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_SFX, sound_get("dog_motor"));
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_SFX_FRAME, 0);

set_window_value(AT_FSPECIAL, 3, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_SFX, sound_get("dog_motorstop"));
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_SFX_FRAME, 0);

set_window_value(AT_FSPECIAL, 4, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_SFX, sound_get("dog_bomb"));
...
// set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("proj_carsplosion"));
// set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_MASK, sprite_get("proj_carsplosion_hitbox"));
...
// set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_GRAVITY, -0.1);
