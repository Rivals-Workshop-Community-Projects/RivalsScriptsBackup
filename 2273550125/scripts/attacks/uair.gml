...
set_attack_value(AT_UAIR, AG_SPRITE, sprite_get("nair"));
set_attack_value(AT_UAIR, AG_HURTBOX_SPRITE, sprite_get("nair_hurt"));
...
set_window_value(AT_UAIR, 2, AG_WINDOW_ANIM_FRAMES, 0);
set_window_value(AT_UAIR, 2, AG_WINDOW_ANIM_FRAME_START, 2);
set_window_value(AT_UAIR, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_UAIR, 2, AG_WINDOW_SFX, asset_get("sfx_ghost_glove"));
...
set_hitbox_value(AT_UAIR, 1, HG_PROJECTILE_SPRITE, sprite_get("proj_blast"));
//set_hitbox_value(AT_UAIR, 1, HG_PROJECTILE_MASK, sprite_get("proj_blast_hitbox"));
set_hitbox_value(AT_UAIR, 1, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_UAIR, 1, HG_PROJECTILE_ANIM_SPEED, 0.333);
