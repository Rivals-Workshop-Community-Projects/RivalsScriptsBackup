...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, sound_get("dog_test"));
...
set_window_value(AT_USTRONG, 5, AG_WINDOW_ANIM_FRAMES, 9);
...
set_hitbox_value(AT_USTRONG, 5, HG_HEIGHT, 36);
set_hitbox_value(AT_USTRONG, 5, HG_PRIORITY, 10);
...
set_hitbox_value(AT_USTRONG, 6, HG_HITBOX_Y, -110);
...
set_hitbox_value(AT_USTRONG, 6, HG_PRIORITY, 10);
set_hitbox_value(AT_USTRONG, 6, HG_DAMAGE, 11);
...
set_hitbox_value(AT_USTRONG, 7, HG_WINDOW_CREATION_FRAME, 7);
...
set_hitbox_value(AT_USTRONG, 7, HG_WIDTH, 48);
set_hitbox_value(AT_USTRONG, 7, HG_HEIGHT, 36);
set_hitbox_value(AT_USTRONG, 7, HG_PRIORITY, 10);
set_hitbox_value(AT_USTRONG, 7, HG_DAMAGE, 11);
