...
set_window_value(AT_JAB, 1, AG_OFF_LEDGE, 0);
set_window_value(AT_JAB, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, sound_get("dog_bark"));
...
set_hitbox_value(AT_JAB, 1, HG_HEIGHT, 14);
set_hitbox_value(AT_JAB, 1, HG_PRIORITY, 1);
set_hitbox_value(AT_JAB, 1, HG_DAMAGE, 3);
set_hitbox_value(AT_JAB, 1, HG_ANGLE, 125);
...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, asset_get("sfx_bubblepop"));
...
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_ANIM_SPEED, 1);
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_HSPEED, 7);
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_VSPEED, 0);
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_GRAVITY, 0);
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_GROUND_FRICTION, 0);
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_AIR_FRICTION, 0.09);
...
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_UNBASHABLE, 0);
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_DOES_NOT_REFLECT, 0);
set_hitbox_value(AT_JAB, 1, HG_PROJECTILE_IS_TRANSCENDENT, 0);
