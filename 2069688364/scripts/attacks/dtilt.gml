...
set_window_value(a, wn, AG_WINDOW_LENGTH, 3);
...
set_window_value(a, wn, AG_WINDOW_SFX, asset_get("sfx_swipe_weak2"));
...
set_hitbox_value(a, i, HG_HEIGHT, 40);
set_hitbox_value(a, i, HG_PRIORITY, 5);
set_hitbox_value(a, i, HG_DAMAGE, 3);
set_hitbox_value(a, i, HG_ANGLE, 40);
set_hitbox_value(a, i, HG_BASE_KNOCKBACK, 8);
