...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, asset_get("sfx_ice_back_air"));
...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, asset_get("sfx_swipe_weak1"));
...
set_hitbox_value(AT_NAIR, 2, HG_ANGLE, 140);
