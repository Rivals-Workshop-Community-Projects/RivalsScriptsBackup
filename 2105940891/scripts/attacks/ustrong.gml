...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_tow_anchor_start"));
...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, asset_get("sfx_ori_bash_launch"));
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, asset_get("sfx_ori_bash_launch"));
...
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, asset_get("sfx_ori_bash_launch"));
...
set_hitbox_value(AT_USTRONG, 4, HG_HITBOX_Y, -53);
...
set_hitbox_value(AT_USTRONG, 4, HG_HIT_SFX, asset_get("sfx_ori_bash_launch"));
