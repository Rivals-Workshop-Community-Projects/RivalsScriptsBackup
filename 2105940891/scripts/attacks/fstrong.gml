...
set_hitbox_value(AT_FSTRONG, 1, HG_ANGLE, 39);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, asset_get("sfx_syl_dstrong"));

set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_FSTRONG, 2, HG_WINDOW, 3);
set_hitbox_value(AT_FSTRONG, 2, HG_LIFETIME, 3);
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_X, 10);
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_Y, -100);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, asset_get("sfx_syl_fstrong"));
