...
set_window_value(AT_JAB, 7, AG_WINDOW_SFX, asset_get("sfx_orca_crunch"));
...
set_window_value(AT_JAB, 9, AG_WINDOW_HAS_WHIFFLAG, 2);
...
set_window_value(AT_JAB, 10, AG_WINDOW_HAS_WHIFFLAG, 2);
...
set_hitbox_value(AT_JAB, 3, HG_VISUAL_EFFECT, poison_hit_small);
