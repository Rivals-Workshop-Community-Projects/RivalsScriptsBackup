...
set_hitbox_value(AT_NSPECIAL, 1, HG_WIDTH, 40);//48
...
set_hitbox_value(AT_NSPECIAL, 2, HG_WIDTH, 64);//76
...
set_hitbox_value(AT_NSPECIAL, 3, HG_WIDTH, 88); //104
set_hitbox_value(AT_NSPECIAL, 3, HG_HEIGHT, 88);
