...
set_hitbox_value(AT_FTILT, 1, HG_HEIGHT, 31);
set_hitbox_value(AT_FTILT, 1, HG_SHAPE, 0);
set_hitbox_value(AT_FTILT, 1, HG_PRIORITY, 1);
set_hitbox_value(AT_FTILT, 1, HG_DAMAGE, 6);
set_hitbox_value(AT_FTILT, 1, HG_ANGLE, 37);
...
set_hitbox_value(AT_FTILT, 1, HG_HITSTUN_MULTIPLIER, .825);
...
set_hitbox_value(AT_FTILT, 2, HG_ANGLE, 37);
...
set_hitbox_value(AT_FTILT, 2, HG_HITSTUN_MULTIPLIER, .825);
