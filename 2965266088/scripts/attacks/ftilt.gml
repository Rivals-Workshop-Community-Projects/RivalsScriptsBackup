...
set_window_value(atk, window_num, AG_WINDOW_SFX_FRAME, 6); //4 -> 6

window_num ++; //attack
set_window_value(atk, window_num, AG_WINDOW_LENGTH, 3); //6
set_window_value(atk, window_num, AG_WINDOW_ANIM_FRAMES, 1); //1
...
window_num ++; //endlag 2
set_window_value(atk, window_num, AG_WINDOW_LENGTH, 10); //14
set_window_value(atk, window_num, AG_WINDOW_ANIM_FRAMES, 2);
