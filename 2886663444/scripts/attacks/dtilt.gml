...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, sound_get("dagger_swoosh2"));
...
set_hitbox_value(AT_DTILT, 1, HG_EXTRA_HITPAUSE, 3);
set_hitbox_value(AT_DTILT, 1, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_DTILT, 1, HG_HITPAUSE_SCALING, .4);
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, sound_get("dagger_stab1"));