...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("dagger_swoosh2"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_WIDTH, 115);
...
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, fspecSmallHit);
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sound_get("dagger_stab2"));
