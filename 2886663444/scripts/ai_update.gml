...
//Dspecial
if  80 > xdist and 30 > ydist and can_special {
	if ai_target.x > x {
		right_down = true
		left_down = false
	}
...
//Fspecial
if  40 > xdist and 10 > ydist and can_special {
	if ai_target.x > x {
		right_down = true
		left_down = false
	}
...
if !free and can_attack and 0 > AIwait{
    ...
    else if 10 > xdist and 50 > ydist and facing{ // Ftilt
        clear_button_buffer( PC_ATTACK_PRESSED );
        joy_pad_idle = true;
        if x > ai_target.x{
            left_down = true;
	...
	else if 80 > ydist and 0 > xdist and facing{ // Utilt
        clear_button_buffer( PC_ATTACK_PRESSED );
        joy_pad_idle = true;
        left_down = false;
        right_down = false;
	...
	else if 20 > ydist and 10 > xdist and facing{ // Dtilt
        clear_button_buffer( PC_ATTACK_PRESSED );
        joy_pad_idle = true;
        left_down = false;
        right_down = false;
