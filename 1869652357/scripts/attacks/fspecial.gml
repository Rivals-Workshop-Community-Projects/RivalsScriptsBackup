...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_TYPE, 1); //startup 2 - animation boogaloo
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_TYPE, 7); //endlag (universal)
...
set_window_value(AT_FSPECIAL, 5, AG_WINDOW_TYPE, 1); //on-hit 
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, sound_get("pow_up"));
