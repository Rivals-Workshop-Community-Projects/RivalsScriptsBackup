...
set_hitbox_value(AT_FAIR, 1, HG_PARENT_HITBOX, 1); //sweetspot
...
set_hitbox_value(AT_FAIR, 1, HG_VISUAL_EFFECT, 156);
set_hitbox_value(AT_FAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, 32);
set_hitbox_value(AT_FAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_FAIR, 1, HG_EXTRA_CAMERA_SHAKE, 50);
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, sound_get("bell_ding"));
...
set_hitbox_value(AT_FAIR, 2, HG_VISUAL_EFFECT, 156);
