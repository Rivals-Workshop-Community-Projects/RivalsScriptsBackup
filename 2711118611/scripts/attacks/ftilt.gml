...
set_window_value(AT_FTILT, 2, AG_WINDOW_SFX, asset_get("sfx_swipe_weak1")); //TODO: fix later
...
set_window_value(AT_FTILT, 3, AG_WINDOW_SFX, sfx_throw)
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, sfx_hitsound);
set_hitbox_value(AT_FTILT, 1, HG_SDI_MULTIPLIER, 0.01);
...
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, sfx_hitcool);
set_hitbox_value(AT_FTILT, 2, HG_SDI_MULTIPLIER, 0.01);
...
set_hitbox_value(AT_FTILT, 3, HG_HITBOX_X, 78);
set_hitbox_value(AT_FTILT, 3, HG_SDI_MULTIPLIER, 0.01);
...
set_hitbox_value(AT_FTILT, 4, HG_SDI_MULTIPLIER, 0.01);
...
set_hitbox_value(AT_FTILT, 5, HG_HITBOX_X, 18);
set_hitbox_value(AT_FTILT, 5, HG_WIDTH, 78);
set_hitbox_value(AT_FTILT, 5, HG_HEIGHT, 30);
set_hitbox_value(AT_FTILT, 5, HG_PRIORITY, 1);
set_hitbox_value(AT_FTILT, 5, HG_DAMAGE, 7);
set_hitbox_value(AT_FTILT, 5, HG_ANGLE, 150);
set_hitbox_value(AT_FTILT, 5, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_FTILT, 5, HG_KNOCKBACK_SCALING, .4);
set_hitbox_value(AT_FTILT, 5, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_FTILT, 5, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_FTILT, 5, HG_HIT_SFX, sfx_hit4);
