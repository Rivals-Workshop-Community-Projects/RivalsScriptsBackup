...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, sound_get("sfx_spear_swing_1"));
...
set_hitbox_value(AT_FTILT, 1, HG_MUNO_HITBOX_NAME, "Sourspot");
...
set_hitbox_value(AT_FTILT, 2, HG_HITBOX_X, 99);
...
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, sound_get("sfx_smash_ult_sword_hit_medium"));
