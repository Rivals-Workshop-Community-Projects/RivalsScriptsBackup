...
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX, sound_get("sfx_jump"));
...
set_window_value(AT_TAUNT, 3, AG_WINDOW_SFX, sound_get("sfx_landinglag"));
...
set_attack_value(AT_TAUNT_2, AG_HURTBOX_SPRITE, sprite_get("taunt_apple_hurt"));
...
set_window_value(AT_TAUNT_2, 1, AG_WINDOW_SFX, sound_get("sfx_landinglag"));
