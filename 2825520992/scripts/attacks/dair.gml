...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sound_get("sfx_spear_swing_1"));
...
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, sound_get("sfx_smash_ult_sword_hit_medium"));
set_hitbox_value(AT_DAIR, 2, HG_EXTRA_CAMERA_SHAKE, 3);