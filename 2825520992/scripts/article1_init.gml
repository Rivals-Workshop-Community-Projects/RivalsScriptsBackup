...
sprite_index = sprite_get("spear_proj");           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
mask_index = sprite_get("spear_proj_mask");
