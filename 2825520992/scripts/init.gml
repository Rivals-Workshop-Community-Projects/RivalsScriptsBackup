...
// SFX
// VFX
fx_ground_spear_break = hit_fx_create(sprite_get("spear_pin_death_ground"), 24);
fx_wall_spear_break = hit_fx_create(sprite_get("spear_pin_death_wall"), 24);
...
// Hurtbox sprites
hurtbox_spr         = sprite_get("bd_hurtbox");
crouchbox_spr       = sprite_get("bd_crouch_hurtbox");
air_hurtbox_spr     = -1; // -1 = use hurtbox_spr
hitstun_hurtbox_spr = -1; // -1 = use hurtbox_spr

// Victory
set_victory_bg(sprite_get("bwd_victory_bg")); // victory_background.png
...
spear3 = noone;
spear_count = 0;
nspecial_charge = hit_fx_create(sprite_get("vfx_charge"), 20);
...
bwd_mega_is_perfect = false;
bwd_pendelum_current = 0;
fx_pillarR = hit_fx_create(sprite_get("pillar_right"), 24);
fx_pillarL = hit_fx_create(sprite_get("pillar_left"), 24);
times_through = 0;

//Compatibility
Hikaru_Title = "Trusty Spear";
arena_title = "Spear of Dee";
battle_text = "The Waddle Dee Confidently tightens his Bandana"
kf_custom_icon = sprite_get("ability_bwd");
