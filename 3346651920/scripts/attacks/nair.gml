...
set_hitbox_value(AT_NAIR, 1, HG_WIDTH, 114);
...
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT, 66);
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, asset_get("sfx_holy_lightning"));
...
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_Y, -63);
...
set_hitbox_value(AT_NAIR, 2, HG_HITPAUSE_SCALING, 0.25);
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT, 66);
