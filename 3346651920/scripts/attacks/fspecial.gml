...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_HSPEED, 3.5);
...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_INVINCIBILITY, 2);//wow!!

//end
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_LENGTH, 16);//22
