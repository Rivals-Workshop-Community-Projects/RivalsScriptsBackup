...
//set_window_value(AT_BAIR, 2, AG_WINDOW_SFX, asset_get("sfx_abyss_explosion"));
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("sword1"));
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, bigsmoke);