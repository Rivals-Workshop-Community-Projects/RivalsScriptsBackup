...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sound_get("swing_weak2"));
...
set_hitbox_value(AT_DATTACK, 1, HG_ANGLE, 150);
...
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, asset_get("sfx_swipe_weak2"));
