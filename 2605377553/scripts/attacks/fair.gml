...
set_hitbox_value(AT_FAIR, 1, HG_VISUAL_EFFECT, midsmoke);
...
set_hitbox_value(AT_FAIR, 2, HG_VISUAL_EFFECT, midsmoke);
set_hitbox_value(AT_FAIR, 2, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_FAIR, 2, HG_HIT_SFX, sound_get("slash3"));