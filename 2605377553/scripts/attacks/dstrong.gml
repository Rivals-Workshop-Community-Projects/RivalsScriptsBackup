...
set_hitbox_value(AT_DSTRONG, 7, HG_HITBOX_X, 60);
set_hitbox_value(AT_DSTRONG, 7, HG_HITBOX_Y, -35);
set_hitbox_value(AT_DSTRONG, 7, HG_WIDTH, 85);
set_hitbox_value(AT_DSTRONG, 7, HG_HEIGHT, 125);
...
set_hitbox_value(AT_DSTRONG, 8, HG_HITBOX_X, -50);
set_hitbox_value(AT_DSTRONG, 8, HG_HITBOX_Y, -35);
set_hitbox_value(AT_DSTRONG, 8, HG_WIDTH, 85);
set_hitbox_value(AT_DSTRONG, 8, HG_HEIGHT, 125);
