set_attack_value(AT_EXTRA_1, AG_SPRITE, sprite_get("taunt_jay"));
...
set_window_value(AT_EXTRA_1, 2, AG_WINDOW_SFX, sound_get("funkybeat"));
...
set_window_value(AT_EXTRA_1, 4, AG_WINDOW_LENGTH, 80);
set_window_value(AT_EXTRA_1, 4, AG_WINDOW_ANIM_FRAMES, 17);
...
set_window_value(AT_EXTRA_1, 5, AG_WINDOW_ANIM_FRAME_START, 19);
