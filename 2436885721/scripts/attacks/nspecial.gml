...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_ori_uptilt_single"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_LIFETIME, 48);
set_hitbox_value(AT_NSPECIAL, 1, HG_HITBOX_X, 200);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, swirl);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, sound_get("bom0"));
