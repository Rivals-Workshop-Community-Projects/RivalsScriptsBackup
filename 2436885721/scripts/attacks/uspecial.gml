...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_LENGTH, 80);
...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_VSPEED, -18);
...
set_hitbox_value(AT_USPECIAL, 1, HG_HITBOX_Y, -130);
...
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT, swirl);
