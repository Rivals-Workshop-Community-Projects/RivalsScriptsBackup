...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, sound_get("tent1"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_BASE_KNOCKBACK, 8.4);
set_hitbox_value(AT_FSTRONG, 1, HG_KNOCKBACK_SCALING, 1.12);
...
set_hitbox_value(AT_FSTRONG, 2, HG_BASE_KNOCKBACK, 8.4);
