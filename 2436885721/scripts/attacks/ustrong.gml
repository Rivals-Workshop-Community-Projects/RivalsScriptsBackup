...
set_window_value(AT_USTRONG, 1, AG_WINDOW_SFX, sound_get("tent2"));
...
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_X, 94);
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_Y, -72);
set_hitbox_value(AT_USTRONG, 1, HG_WIDTH, 61);
set_hitbox_value(AT_USTRONG, 1, HG_HEIGHT, 158);
set_hitbox_value(AT_USTRONG, 1, HG_SHAPE, 0);
set_hitbox_value(AT_USTRONG, 1, HG_PRIORITY, 2);
set_hitbox_value(AT_USTRONG, 1, HG_DAMAGE, 14);
set_hitbox_value(AT_USTRONG, 1, HG_ANGLE, 280);
set_hitbox_value(AT_USTRONG, 1, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_USTRONG, 1, HG_KNOCKBACK_SCALING, .85);
