...
set_window_value(AT_NAIR, 1, AG_WINDOW_LENGTH, 6);//6
set_window_value(AT_NAIR, 1, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_NAIR, 1, AG_WINDOW_HSPEED, 8);
...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, sound_get("whoosh"));
...
set_window_value(AT_NAIR, 4, AG_WINDOW_HSPEED, 15);
set_window_value(AT_NAIR, 4, AG_WINDOW_VSPEED, -6);
set_window_value(AT_NAIR, 4, AG_WINDOW_HSPEED_TYPE, 2);
...
set_window_value(AT_NAIR, 4, AG_WINDOW_SFX, sound_get("whoosh"));
...
set_hitbox_value(AT_NAIR, 1, HG_PROJECTILE_SPRITE, sprite_get("jab_proj"));
set_hitbox_value(AT_NAIR, 1, HG_PROJECTILE_MASK, sprite_get("jab_proj"));
