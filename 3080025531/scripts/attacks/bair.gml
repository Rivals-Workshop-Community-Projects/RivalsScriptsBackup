...
//set_hitbox_value(AT_BAIR, 1, HG_HITBOX_Y, -70);
...
//set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sfx_fe_hit1);
...
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, -32);
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sfx_fe_hit2);
...
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_Y, 5);
...
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, sfx_aa_stab);
...
set_hitbox_value(AT_BAIR, 3, HG_HIT_SFX, sfx_fe_hit1);