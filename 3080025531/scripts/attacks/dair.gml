...
set_hitbox_value(AT_DAIR, 1, HG_HEIGHT, 8);
...
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, sfx_aa_stab);
...
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, sfx_fe_hit1);
...
set_hitbox_value(AT_DAIR, 3, HG_ANGLE, 115);
set_hitbox_value(AT_DAIR, 3, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_DAIR, 3, HG_KNOCKBACK_SCALING, 0.45);
...
set_hitbox_value(AT_DAIR, 3, HG_HIT_SFX, sfx_fe_hit1);
...
set_hitbox_value(AT_DAIR, 4, HG_WIDTH, 110);
...
set_hitbox_value(AT_DAIR, 4, HG_HIT_SFX, sfx_fe_hit3);
