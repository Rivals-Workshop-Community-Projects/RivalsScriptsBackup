...
if (attack == AT_USPECIAL){
    ...
    if (window == 2){
        if (window_timer == 1){
        if (state == PS_ATTACK_AIR){ create_hitbox(AT_USPECIAL, 3, x-36 * spr_dir, y-10); }
        }
    }
    if (window == 3){
        if (window_timer >= 2 && tilt == 0){ window = 4; window_timer = 0; vsp = -14; }
        if (window_timer >= 1 && tilt != 0){ window = 5; window_timer = 0; vsp = -14; hsp = 10 * spr_dir; }
...
if (attack == AT_USTRONG){
    ...
    if (window == 2){
        ...
        if (window_timer == 6){ create_hitbox(AT_USTRONG, 2, x + rock_pos, y-40); }
        if (window_timer == 10){ create_hitbox(AT_USTRONG, 3, x - rock_pos, y-40); }
        if (window_timer == 14){ create_hitbox(AT_USTRONG, 4, x + rock_pos, y-40); }
        if (window_timer == 18){ create_hitbox(AT_USTRONG, 5, x + rock_pos, y-40); }
