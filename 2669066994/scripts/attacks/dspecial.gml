...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_boss_laser_hit"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_VISUAL_EFFECT, poison_hit2);
set_hitbox_value(AT_DSPECIAL, 1, HG_VISUAL_EFFECT_Y_OFFSET, -16);
set_hitbox_value(AT_DSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_poison_hit_weak"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, poison_hit2);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_BASE_KNOCKBACK, 0.001);
set_hitbox_value(AT_DSPECIAL, 2, HG_BASE_HITPAUSE, 0);
set_hitbox_value(AT_DSPECIAL, 2, HG_HITSTUN_MULTIPLIER, -1);
set_hitbox_value(AT_DSPECIAL, 2, HG_VISUAL_EFFECT, poison_hit2);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_PROJECTILE_DESTROY_EFFECT, poison_hit2);
