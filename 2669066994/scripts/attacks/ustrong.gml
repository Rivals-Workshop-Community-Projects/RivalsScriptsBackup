...
set_hitbox_value(AT_USTRONG, 5, HG_WIDTH, 5);
...
set_hitbox_value(AT_USTRONG, 5, HG_KNOCKBACK_SCALING, .6);
...
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_SPRITE, sprite_get("ustrong_proj"));
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_ANIM_SPEED, .3);
