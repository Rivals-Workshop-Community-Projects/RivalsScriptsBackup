...
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, sound_get("sliceh2"));
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT, hkr_stab_strong);
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT_X_OFFSET, 20);
set_hitbox_value(AT_DATTACK, 1, HG_HIT_LOCKOUT, 5);
set_hitbox_value(AT_DATTACK, 1, HG_HKR_CLAW, 4);
...
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT, hkr_slash);
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, sound_get("slicew2"));
set_hitbox_value(AT_DATTACK, 2, HG_HIT_LOCKOUT, 5);
set_hitbox_value(AT_DATTACK, 2, HG_HKR_CLAW, 3);