...
set_window_value(AT_USTRONG_2, 1, AG_WINDOW_LENGTH, 2);
...
set_window_value(AT_USTRONG_2, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, .5);
...
set_window_value(AT_USTRONG_2, 2, AG_WINDOW_SFX, hkr_gunshot_sfx);
set_window_value(AT_USTRONG_2, 2, AG_WINDOW_SFX_FRAME, 5);
set_window_value(AT_USTRONG_2, 2, AG_WINDOW_VSPEED, 0);
...
set_window_value(AT_USTRONG_2, 2, AG_WINDOW_CUSTOM_GRAVITY, 1);
...
//set_window_value(AT_USTRONG_2, 3, AG_WINDOW_HSPEED, -10);
set_window_value(AT_USTRONG_2, 3, AG_WINDOW_HSPEED_TYPE, 2);
//set_window_value(AT_USTRONG_2, 3, AG_WINDOW_VSPEED, 4);
set_window_value(AT_USTRONG_2, 3, AG_WINDOW_VSPEED_TYPE, 2);
set_window_value(AT_USTRONG_2, 3, AG_WINDOW_CUSTOM_GRAVITY, 1);
set_window_value(AT_USTRONG_2, 3, AG_HKR_EXCITE, 20);
set_window_value(AT_USTRONG_2, 3, AG_HKR_EXCITE_DAMAGE, 2);
...
set_window_value(AT_USTRONG_2, 4, AG_WINDOW_CUSTOM_GRAVITY, 1);
...
set_window_value(AT_USTRONG_2, 5, AG_WINDOW_CUSTOM_GRAVITY, 1);
...
set_hitbox_value(AT_USTRONG_2, 1, HG_HITBOX_X, 34);
set_hitbox_value(AT_USTRONG_2, 1, HG_HITBOX_Y, -82);
...
set_hitbox_value(AT_USTRONG_2, 2, HG_PROJECTILE_ANIM_SPEED, 0.6);
set_hitbox_value(AT_USTRONG_2, 2, HG_WINDOW, 4);
set_hitbox_value(AT_USTRONG_2, 2, HG_LIFETIME, 4);
set_hitbox_value(AT_USTRONG_2, 2, HG_HITBOX_X, 42);
set_hitbox_value(AT_USTRONG_2, 2, HG_HITBOX_Y, -88);
set_hitbox_value(AT_USTRONG_2, 2, HG_WIDTH, 40);
set_hitbox_value(AT_USTRONG_2, 2, HG_HEIGHT, 40);
set_hitbox_value(AT_USTRONG_2, 2, HG_PROJECTILE_HSPEED, 0);
...
set_hitbox_value(AT_USTRONG_2, 2, HG_BASE_KNOCKBACK, 5);
...
set_hitbox_value(AT_USTRONG_2, 2, HG_HIT_SFX, hkr_gunhit_sfx);
set_hitbox_value(AT_USTRONG_2, 2, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_USTRONG_2, 1, HG_VISUAL_EFFECT, 141);

set_hitbox_value(AT_USTRONG_2, 3, HG_PARENT_HITBOX, 2);
...
set_hitbox_value(AT_USTRONG_2, 3, HG_HITBOX_X, 60);
set_hitbox_value(AT_USTRONG_2, 3, HG_HITBOX_Y, -115);
