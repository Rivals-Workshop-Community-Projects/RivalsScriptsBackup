...
set_window_value(AT_FTILT, 4, AG_WINDOW_IASA, 1);
...
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT, hkr_slash);
set_hitbox_value(AT_FTILT, 1, HG_HKR_CLAW, 3);
...
set_hitbox_value(AT_FTILT, 2, HG_HKR_CLAW, 3);
...
set_hitbox_value(AT_FTILT, 3, HG_WIDTH, 30);
...
set_hitbox_value(AT_FTILT, 3, HG_VISUAL_EFFECT, hkr_slash);
set_hitbox_value(AT_FTILT, 3, HG_HIT_SFX, sound_get("slicew2"));
set_hitbox_value(AT_FTILT, 3, HG_HKR_CLAW, 3);