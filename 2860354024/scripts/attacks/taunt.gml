...
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX, asset_get("sfx_jumpair"));
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX_FRAME, 4);
set_window_value(AT_TAUNT, 1, AG_HKR_EXCITE, 5);
...
set_window_value(AT_TAUNT, 2, AG_WINDOW_SFX, asset_get("sfx_jumpair"));
...
// set_window_value(AT_TAUNT, 3, AG_WINDOW_SFX, asset_get("sfx_forsburn_cape_swipe"));
...
// set_window_value(AT_TAUNT, 4, AG_WINDOW_SFX, asset_get("sfx_jumpair"));
