set_attack_value(AT_EXTRA_1, AG_SPRITE, sprite_get("excite"));
...
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_LENGTH, 90);
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_ANIM_FRAMES, 15);
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_SFX, asset_get("sfx_sand_yell"));
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_SFX_FRAME, 19);
