...
set_attack_value(AT_DSTRONG_2, AG_LANDING_LAG, 0);
...
set_window_value(AT_DSTRONG_2, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, .5);
set_window_value(AT_DSTRONG_2, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, .5);
...
set_window_value(AT_DSTRONG_2, 2, AG_WINDOW_SFX, hkr_gunshot_sfx);
...
set_window_value(AT_DSTRONG_2, 2, AG_WINDOW_CUSTOM_GRAVITY, 1);
...
set_window_value(AT_DSTRONG_2, 3, AG_WINDOW_CUSTOM_GRAVITY, 1);
set_window_value(AT_DSTRONG_2, 3, AG_HKR_EXCITE, 20);
set_window_value(AT_DSTRONG_2, 3, AG_HKR_EXCITE_DAMAGE, 2);
...
set_window_value(AT_DSTRONG_2, 4, AG_WINDOW_CUSTOM_GRAVITY, 1);

set_window_value(AT_DSTRONG_2, 5, AG_WINDOW_TYPE, 1);
set_window_value(AT_DSTRONG_2, 5, AG_WINDOW_LENGTH, 14);
set_window_value(AT_DSTRONG_2, 5, AG_WINDOW_ANIM_FRAMES, 5);
set_window_value(AT_DSTRONG_2, 5, AG_WINDOW_ANIM_FRAME_START, 6);
set_window_value(AT_DSTRONG_2, 5, AG_WINDOW_CUSTOM_GRAVITY, 1);
...
set_hitbox_value(AT_DSTRONG_2, 1, HG_HITBOX_Y, 42);
...
set_hitbox_value(AT_DSTRONG_2, 1, HG_ANGLE, 0 - 90);
...
set_hitbox_value(AT_DSTRONG_2, 1, HG_HITPAUSE_SCALING, 1.2);
set_hitbox_value(AT_DSTRONG_2, 1, HG_VISUAL_EFFECT, 141);
set_hitbox_value(AT_DSTRONG_2, 1, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_DSTRONG_2, 1, HG_HIT_SFX, hkr_gunhit_sfx);
...
set_hitbox_value(AT_DSTRONG_2, 2, HG_PROJECTILE_ANIM_SPEED, 0.6);
set_hitbox_value(AT_DSTRONG_2, 2, HG_WINDOW, 4);
set_hitbox_value(AT_DSTRONG_2, 2, HG_LIFETIME, 4);
set_hitbox_value(AT_DSTRONG_2, 2, HG_HITBOX_X, -5);
set_hitbox_value(AT_DSTRONG_2, 2, HG_HITBOX_Y, 62);
...
set_hitbox_value(AT_DSTRONG_2, 2, HG_ANGLE, 0 - 45);
...
set_hitbox_value(AT_DSTRONG_2, 2, HG_HIT_SFX, hkr_gunhit_sfx);
set_hitbox_value(AT_DSTRONG_2, 2, HG_VISUAL_EFFECT, 141);
set_hitbox_value(AT_DSTRONG_2, 2, HG_VISUAL_EFFECT_Y_OFFSET, 20);
