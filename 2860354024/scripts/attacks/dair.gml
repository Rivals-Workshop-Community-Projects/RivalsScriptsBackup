...
set_hitbox_value(AT_DAIR, 1, HG_ANGLE, 180 - 45);
set_hitbox_value(AT_DAIR, 1, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_DAIR, 1, HG_KNOCKBACK_SCALING, .35);
set_hitbox_value(AT_DAIR, 1, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_DAIR, 1, HG_HITPAUSE_SCALING, .5);
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, hkr_slash);
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, sound_get("slicew2"));
set_hitbox_value(AT_DAIR, 1, HG_HKR_CLAW, 4);
...
set_hitbox_value(AT_DAIR, 3, HG_WIDTH, 90);
set_hitbox_value(AT_DAIR, 3, HG_HEIGHT, 50);
set_hitbox_value(AT_DAIR, 3, HG_PRIORITY, 1);
set_hitbox_value(AT_DAIR, 3, HG_DAMAGE, 4);
set_hitbox_value(AT_DAIR, 3, HG_ANGLE, 180 - 45);
set_hitbox_value(AT_DAIR, 3, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_DAIR, 3, HG_KNOCKBACK_SCALING, .35);
set_hitbox_value(AT_DAIR, 3, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_DAIR, 3, HG_HITPAUSE_SCALING, .5);
set_hitbox_value(AT_DAIR, 3, HG_VISUAL_EFFECT, hkr_slash);
set_hitbox_value(AT_DAIR, 3, HG_HIT_SFX, sound_get("slicew2"));
set_hitbox_value(AT_DAIR, 3, HG_HKR_CLAW, 4);
