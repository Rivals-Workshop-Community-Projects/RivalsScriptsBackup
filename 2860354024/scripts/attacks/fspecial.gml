...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sound_get("tele"));
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, 2.5);
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 2.5);
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, 2.5);
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, 2.5);
...
set_window_value(AT_FSPECIAL, 6, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.5);
set_window_value(AT_FSPECIAL, 6, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.5);
...
set_window_value(AT_FSPECIAL, 7, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.5);
set_window_value(AT_FSPECIAL, 7, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.5);
set_window_value(AT_FSPECIAL, 7, AG_WINDOW_CUSTOM_GRAVITY, 0);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HITBOX_Y, -70);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_VISUAL_EFFECT, hkr_slash);
set_hitbox_value(AT_FSPECIAL, 2, HG_HKR_CLAW, 20);
set_hitbox_value(AT_FSPECIAL, 2, HG_HKR_HEAL, 8);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_ANGLE, 180 - 45);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_VISUAL_EFFECT, hkr_slash_weak);
set_hitbox_value(AT_FSPECIAL, 3, HG_HKR_CLAW, 2);