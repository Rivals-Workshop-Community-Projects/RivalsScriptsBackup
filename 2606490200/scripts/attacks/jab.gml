...
set_hitbox_value(AT_JAB, 4, HG_HITBOX_X, -5);
set_hitbox_value(AT_JAB, 4, HG_HITBOX_Y, -52);
set_hitbox_value(AT_JAB, 4, HG_WIDTH, 202);
set_hitbox_value(AT_JAB, 4, HG_HEIGHT, 202);
set_hitbox_value(AT_JAB, 4, HG_PRIORITY, 2);
set_hitbox_value(AT_JAB, 4, HG_SHAPE, 0);
set_hitbox_value(AT_JAB, 4, HG_DAMAGE, 15);
...
set_hitbox_value(AT_JAB, 4, HG_EXTRA_HITPAUSE, 30);
