...
set_hitbox_value(AT_EXTRA_1, 6, HG_HITPAUSE_SCALING, .5);
...
set_hitbox_value(AT_EXTRA_1, 9, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_EXTRA_1, 9, HG_KNOCKBACK_SCALING, .7);
...
set_hitbox_value(AT_EXTRA_1, 10, HG_BASE_HITPAUSE, 9);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_LIFETIME, 63*4);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_HEIGHT, 36);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_PROJECTILE_DESTROY_EFFECT, 14);
set_hitbox_value(AT_FSPECIAL_2, 1, HG_PROJECTILE_SPRITE, sprite_get("regi"));
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_PROJECTILE_VSPEED, -3);
set_hitbox_value(AT_FSPECIAL_2, 1, HG_PROJECTILE_GRAVITY, .3);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_PROJECTILE_IS_TRANSCENDENT, false);
...
set_hitbox_value(AT_FSPECIAL_2, 2, HG_WIDTH, 126);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_HEIGHT, 126);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_PRIORITY, 0);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_DAMAGE, 17);
...
set_hitbox_value(AT_FSPECIAL_2, 2, HG_PROJECTILE_DESTROY_EFFECT, 14);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_HIT_SFX, asset_get("sfx_blow_heavy1"));
set_hitbox_value(AT_FSPECIAL_2, 2, HG_PROJECTILE_SPRITE, sprite_get("empty"));
set_hitbox_value(AT_FSPECIAL_2, 2, HG_PROJECTILE_ANIM_SPEED, 0.5);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_PROJECTILE_HSPEED, 8);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_PROJECTILE_VSPEED, -3);
...
set_hitbox_value(AT_FSPECIAL_2, 2, HG_PROJECTILE_UNBASHABLE, true);
