...
facing = 1; //-1, behind marisa, 1, in front
going_back = false;
offstage_timer = 0;
original_url = player_id.url;
baOwner = player_id.player
candyman_url = 2386395909;
...
ball_hitfx = hit_fx_create(sprite_get("p"+string(baOwner)+"plasma_hitfx"),32);
...
hitball_fx = hit_fx_create(sprite_get("ball_explode"+"p"+string(baOwner)),32);
...
playerurl = noone;
donotdraw = false;
life = 5;//how many times the opponent has to hit the ball to break it
