...
set_color_profile_slot( 1, 1, 166, 0, 74 ); //Pants
set_color_profile_slot( 1, 2, 111, 57, 9 ); //Hair / Shoes
set_color_profile_slot( 1, 3, 255, 61, 177 ); //Gloves
set_color_profile_slot( 1, 4, 233, 183, 152 ); //Skin
set_color_profile_slot( 1, 5, 25, 62, 182 ); //Tie / Eyes
set_color_profile_slot( 1, 6, 161, 0, 101 ); //HeadBand

// Red
set_color_profile_slot( 2, 0, 196, 45, 45 ); //Lab Coat
set_color_profile_slot( 2, 1, 115, 0, 0 ); //Pants
set_color_profile_slot( 2, 2, 111, 57, 9 ); //Hair / Shoes
set_color_profile_slot( 2, 3, 191, 80, 80 ); //Gloves
set_color_profile_slot( 2, 4, 233, 183, 152 ); //Skin
set_color_profile_slot( 2, 5, 25, 62, 182 ); //Tie / Eyes
...
set_color_profile_slot( 5, 5, 25, 62, 182 ); //Tie / Eyes
set_color_profile_slot( 5, 6, 94, 58, 58 ); //HeadBand

// Yellow
set_color_profile_slot( 6, 0, 207, 181, 39 ); //Lab Coat
set_color_profile_slot( 6, 1, 89, 89, 89 ); //Pants
set_color_profile_slot( 6, 2, 111, 57, 9 ); //Hair / Shoes
set_color_profile_slot( 6, 3, 158, 134, 0 ); //Gloves
...
// Purple
set_color_profile_slot( 7, 0, 173, 39, 207 ); //Lab Coat
set_color_profile_slot( 7, 1, 89, 89, 89 ); //Pants
set_color_profile_slot( 7, 2, 111, 57, 9 ); //Hair / Shoes
set_color_profile_slot( 7, 3, 136, 8, 161 ); //Gloves
set_color_profile_slot( 7, 4, 233, 183, 152 ); //Skin
set_color_profile_slot( 7, 5, 25, 62, 182 ); //Tie / Eyes
set_color_profile_slot( 7, 6, 130, 80, 118 ); //HeadBand

// Dr Bluey
set_color_profile_slot( 8, 0, 0, 71, 237 ); //Lab Coat
set_color_profile_slot( 8, 1, 25, 19, 138 ); //Pants
set_color_profile_slot( 8, 2, 111, 57, 9 ); //Hair / Shoes
set_color_profile_slot( 8, 3, 44, 45, 48 ); //Gloves
set_color_profile_slot( 8, 4, 255, 197, 97 ); //Skin
set_color_profile_slot( 8, 5, 25, 62, 182 ); //Tie / Eyes
set_color_profile_slot( 8, 6, 104, 104, 171 ); //HeadBand

// Dr Yuuto
set_color_profile_slot( 9, 0, 20, 187, 255 ); //Lab Coat
set_color_profile_slot( 9, 1, 11, 109, 148 ); //Pants
set_color_profile_slot( 9, 2, 111, 57, 9 ); //Hair / Shoes
set_color_profile_slot( 9, 3, 116, 184, 229 ); //Gloves
set_color_profile_slot( 9, 4, 255, 218, 173 ); //Skin
set_color_profile_slot( 9, 5, 25, 62, 182 ); //Tie / Eyes
...
// unnamed alt palette
set_color_profile_slot( 24, 0, 156, 204, 67 ); //Lab Coat
set_color_profile_slot( 24, 1, 61, 122, 0 ); //Pants
set_color_profile_slot( 24, 2, 89, 158, 0 ); //Hair / Shoes
set_color_profile_slot( 24, 3, 254, 205, 28 ); //Gloves
