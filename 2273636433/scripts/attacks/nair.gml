...
set_hitbox_value(AT_NAIR, 2, HG_FINAL_BASE_KNOCKBACK, 8);
...
set_hitbox_value(AT_NAIR, 4, HG_HITBOX_X, 28);
...
set_hitbox_value(AT_NAIR, 5, HG_FINAL_BASE_KNOCKBACK, 9);
...
set_hitbox_value(AT_NAIR, 6, HG_HITBOX_X, 28);
