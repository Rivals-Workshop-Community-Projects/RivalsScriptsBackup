...
set_hitbox_value(AT_FAIR, 2, HG_BASE_HITPAUSE, 8.5);
...
set_hitbox_value(AT_FAIR, 3, HG_HITBOX_Y, -62);
...
set_hitbox_value(AT_FAIR, 3, HG_BASE_KNOCKBACK, 8.5);
set_hitbox_value(AT_FAIR, 3, HG_KNOCKBACK_SCALING, .8);
set_hitbox_value(AT_FAIR, 3, HG_BASE_HITPAUSE, 8.5);
...
set_hitbox_value(AT_FAIR, 4, HG_HITBOX_X, 38);
...
set_hitbox_value(AT_FAIR, 4, HG_BASE_KNOCKBACK, 8.5);
set_hitbox_value(AT_FAIR, 4, HG_KNOCKBACK_SCALING, .8);
set_hitbox_value(AT_FAIR, 4, HG_BASE_HITPAUSE, 8.5);
