...
set_hitbox_value(AT_UTILT, 1, HG_ANGLE, 96);
set_hitbox_value(AT_UTILT, 1, HG_BASE_KNOCKBACK, 5.5);
...
set_hitbox_value(AT_UTILT, 2, HG_ANGLE, 93);
set_hitbox_value(AT_UTILT, 2, HG_BASE_KNOCKBACK, 5.5);
set_hitbox_value(AT_UTILT, 2, HG_KNOCKBACK_SCALING, .65);
set_hitbox_value(AT_UTILT, 2, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_UTILT, 2, HG_HITPAUSE_SCALING, .65);
...
set_hitbox_value(AT_UTILT, 3, HG_BASE_KNOCKBACK, 5.5);
set_hitbox_value(AT_UTILT, 3, HG_KNOCKBACK_SCALING, .65);
set_hitbox_value(AT_UTILT, 3, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_UTILT, 3, HG_HITPAUSE_SCALING, .65);
