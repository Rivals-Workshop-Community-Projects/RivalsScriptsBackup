...
set_hitbox_value(AT_USTRONG, 1, HG_HITPAUSE_SCALING, .95);
...
set_hitbox_value(AT_USTRONG, 3, HG_WIDTH, 48);
...
set_hitbox_value(AT_USTRONG, 3, HG_HITPAUSE_SCALING, .95);
...
set_hitbox_value(AT_USTRONG, 4, HG_HITBOX_Y, -66);
...
set_hitbox_value(AT_USTRONG, 4, HG_HITPAUSE_SCALING, .95);
...
set_hitbox_value(AT_USTRONG, 4, HG_HIT_LOCKOUT, 8);
