...
set_hitbox_value(AT_UAIR, 1, HG_HITSTUN_MULTIPLIER, 1.6);
...
set_hitbox_value(AT_UAIR, 2, HG_WIDTH, 105);
set_hitbox_value(AT_UAIR, 2, HG_HEIGHT, 103);
...
set_hitbox_value(AT_UAIR, 2, HG_HITSTUN_MULTIPLIER, .95);
