...
set_hitbox_value(AT_DAIR, 1, HG_THROWS_ROCK, 1);

set_attack_value(AT_DAIR, AG_MUNO_ATTACK_MISC_ADD, "You can pull yourself towards the ground if you hit a platform or the ground, and haven't hit a player during the active frames.")