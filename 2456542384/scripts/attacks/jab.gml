...
set_hitbox_value(AT_JAB, 1, HG_MUNO_HITBOX_NAME, "Jab Hit 1");
...
set_hitbox_value(AT_JAB, 2, HG_MUNO_HITBOX_NAME, "Jab Hit 2");
...
set_attack_value(AT_JAB, AG_MUNO_ATTACK_MISC_ADD, "Ignores Parry Stun on the first hit");