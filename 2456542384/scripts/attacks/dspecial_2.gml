...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HITBOX_Y, -45);
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_VISUAL_EFFECT_Y_OFFSET, -20);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HIT_SFX, asset_get("sfx_blow_weak2"));



set_attack_value(AT_DSPECIAL_2, AG_MUNO_ATTACK_MISC_ADD, "Used while a Dspecial flower is on the stage to activate it.");