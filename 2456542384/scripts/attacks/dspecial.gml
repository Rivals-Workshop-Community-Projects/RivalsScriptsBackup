...
set_hitbox_value(AT_DSPECIAL, 1, HG_HEIGHT, 175);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_plant_eat"));
set_hitbox_value(AT_DSPECIAL, 1, HG_TECHABLE, 1);
//obligatory projectile stuff
...
set_attack_value(AT_DSPECIAL, AG_MUNO_ATTACK_MISC_ADD, "The attack itself does not have a hitbox, it instead is spawned on the flower upon activation");
