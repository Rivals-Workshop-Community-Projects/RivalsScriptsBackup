...
set_hitbox_value(AT_DATTACK, 1, HG_MUNO_HITBOX_NAME, "Lingering Hitbox");
...
set_hitbox_value(AT_DATTACK, 2, HG_MUNO_HITBOX_NAME, "Bite Hitbox");
...
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, asset_get("sfx_crunch"));
