...
set_window_value(AT_NAIR, 2, AG_WINDOW_TYPE, 1); //Kick 1
set_window_value(AT_NAIR, 2, AG_WINDOW_LENGTH, 3);
set_window_value(AT_NAIR, 2, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_NAIR, 2, AG_WINDOW_ANIM_FRAME_START, 2);

set_window_value(AT_NAIR, 3, AG_WINDOW_TYPE, 1); //Inbetween
...
set_window_value(AT_NAIR, 4, AG_WINDOW_TYPE, 1); //Kick 2
