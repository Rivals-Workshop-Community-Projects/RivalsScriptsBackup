...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .4);
...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, .4);
...
set_hitbox_value(AT_FSTRONG, 1, HG_KNOCKBACK_SCALING, 1);//.95
