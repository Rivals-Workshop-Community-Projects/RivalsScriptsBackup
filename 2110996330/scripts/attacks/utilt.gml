...
set_hitbox_value(AT_UTILT, 1, HG_DAMAGE, 8);//6
set_hitbox_value(AT_UTILT, 1, HG_ANGLE, 90);
set_hitbox_value(AT_UTILT, 1, HG_EFFECT, 2110996334);
set_hitbox_value(AT_UTILT, 1, HG_BASE_KNOCKBACK, 8);//10
set_hitbox_value(AT_UTILT, 1, HG_KNOCKBACK_SCALING, .7);//.3
...
set_hitbox_value(AT_UTILT, 2, HG_DAMAGE, 10);//8
set_hitbox_value(AT_UTILT, 2, HG_EFFECT, 2110996334);
set_hitbox_value(AT_UTILT, 2, HG_ANGLE, 90);
set_hitbox_value(AT_UTILT, 2, HG_BASE_KNOCKBACK, 8);//12
set_hitbox_value(AT_UTILT, 2, HG_KNOCKBACK_SCALING, .95);//.6
...
set_hitbox_value(AT_UTILT, 3, HG_BASE_KNOCKBACK, 6);//8
set_hitbox_value(AT_UTILT, 3, HG_KNOCKBACK_SCALING, .5);//.3
