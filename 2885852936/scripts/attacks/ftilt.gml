...
set_window_value(AT_FTILT, 2, AG_WINDOW_SFX, asset_get("sfx_ell_utilt_fire"));
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, asset_get("sfx_ori_stomp_hit"));
set_hitbox_value(AT_FTILT, 1, HG_PROJECTILE_SPRITE, sprite_get("shot"));
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT, shothit );
set_hitbox_value(AT_FTILT, 1, HG_PROJECTILE_DESTROY_EFFECT, shotmiss);
set_hitbox_value(AT_FTILT, 1, HG_PROJECTILE_MASK, sprite_get("shot"));
set_hitbox_value(AT_FTILT, 1, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_FTILT, 1, HG_PROJECTILE_HSPEED, 13);
