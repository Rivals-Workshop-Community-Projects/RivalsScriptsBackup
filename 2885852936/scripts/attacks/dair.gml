...
set_window_value(AT_DAIR, 2, AG_WINDOW_SFX, asset_get("sfx_ell_uspecial_explode"));
...
set_hitbox_value(AT_DAIR, 3, HG_EFFECT, 1);
...
//set_hitbox_value(AT_DAIR, 1, HG_ANGLE_FLIPPER, 8);
...
set_hitbox_value(AT_DAIR, 4, HG_EFFECT, 1);
set_hitbox_value(AT_DAIR, 4, HG_BASE_KNOCKBACK, 12);
