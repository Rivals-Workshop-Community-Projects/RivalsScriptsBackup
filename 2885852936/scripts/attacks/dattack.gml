...
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX, asset_get("sfx_ell_dspecial_explosion_1"));
...
set_hitbox_value(AT_DATTACK, 2, HG_ANGLE, 300);
...
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, asset_get("sfx_ori_charged_flame_hit"));
