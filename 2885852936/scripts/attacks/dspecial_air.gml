...
set_window_value(AT_DSPECIAL_AIR, 1, AG_WINDOW_HSPEED, 10);
//set_window_value(AT_DSPECIAL_AIR, 1, AG_WINDOW_VSPEED_TYPE, .3);
set_window_value(AT_DSPECIAL_AIR, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DSPECIAL_AIR, 1, AG_WINDOW_SFX, sound_get("MmTalk"));
set_window_value(AT_DSPECIAL_AIR, 1, AG_WINDOW_INVINCIBILITY, 2);
