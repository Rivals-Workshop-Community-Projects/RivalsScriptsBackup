...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, asset_get("sfx_absa_harderhit"));
...
set_window_value(AT_NAIR, 2, AG_WINDOW_SFX, asset_get("sfx_absa_uair"));
...
set_hitbox_value(AT_NAIR, 1, HG_BASE_KNOCKBACK, 6.25);
set_hitbox_value(AT_NAIR, 1, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT, 21);
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, asset_get("sfx_absa_harderhit"));
...
set_hitbox_value(AT_NAIR, 2, HG_BASE_KNOCKBACK, 6.25);
set_hitbox_value(AT_NAIR, 2, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT, 21);
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, asset_get("sfx_absa_harderhit"));
...
set_hitbox_value(AT_NAIR, 3, HG_BASE_KNOCKBACK, 6.25);
set_hitbox_value(AT_NAIR, 3, HG_KNOCKBACK_SCALING, .5);
set_hitbox_value(AT_NAIR, 3, HG_BASE_HITPAUSE, 8.5);
set_hitbox_value(AT_NAIR, 3, HG_HITPAUSE_SCALING, .4);
set_hitbox_value(AT_NAIR, 3, HG_VISUAL_EFFECT, 197);
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, asset_get("sfx_absa_uair"));
