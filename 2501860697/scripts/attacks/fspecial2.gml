...
set_hitbox_value(AT_FSPECIAL_2, 2, HG_WIDTH, 32);
set_hitbox_value(AT_FSPECIAL_2, 2, HG_HEIGHT, 32);
...
set_hitbox_value(AT_FSPECIAL_2, 4, HG_WIDTH, 32);
set_hitbox_value(AT_FSPECIAL_2, 4, HG_HEIGHT, 32);
...
set_hitbox_value(AT_FSPECIAL_2, 5, HG_WIDTH, 32);
set_hitbox_value(AT_FSPECIAL_2, 5, HG_HEIGHT, 32);
...
set_hitbox_value(AT_FSPECIAL_2, 5, HG_EXTENDED_PARRY_STUN, 1);
...
set_hitbox_value(AT_FSPECIAL_2, 5, HG_BASE_HITPAUSE, 15);
...
set_hitbox_value(AT_FSPECIAL_2, 5, HG_PROJECTILE_SPRITE, asset_get("empty_sprite"));
