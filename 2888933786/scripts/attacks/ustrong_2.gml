...
set_window_value(AT_USTRONG_2, 2, AG_WINDOW_LENGTH, 60);
...
set_window_value(AT_USTRONG_2, 3, AG_WINDOW_LENGTH, 1);
...
set_window_value(AT_USTRONG_2, 5, AG_WINDOW_LENGTH, 25);
set_window_value(AT_USTRONG_2, 5, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_USTRONG_2, 5, AG_WINDOW_ANIM_FRAME_START, 0);
...
set_hitbox_value(AT_USTRONG_2, 1, HG_WINDOW, 5);
set_hitbox_value(AT_USTRONG_2, 1, HG_LIFETIME, 11);
set_hitbox_value(AT_USTRONG_2, 1, HG_HITBOX_X, 0);
set_hitbox_value(AT_USTRONG_2, 1, HG_HITBOX_Y, -26);
...
set_hitbox_value(AT_USTRONG_2, 1, HG_KNOCKBACK_SCALING, .7);
set_hitbox_value(AT_USTRONG_2, 1, HG_EFFECT, 12);
set_hitbox_value(AT_USTRONG_2, 1, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_USTRONG_2, 1, HG_HIT_SFX, asset_get("sfx_swipe_medium1"));
set_hitbox_value(AT_USTRONG_2, 1, HG_IGNORES_PROJECTILES, 1);
