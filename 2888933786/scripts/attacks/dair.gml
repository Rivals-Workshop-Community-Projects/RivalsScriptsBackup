...
set_hitbox_value(AT_DAIR, 3, HG_LIFETIME, 22);
set_hitbox_value(AT_DAIR, 3, HG_HITBOX_X, -100);
set_hitbox_value(AT_DAIR, 3, HG_HITBOX_Y, -130);
...
set_hitbox_value(AT_DAIR, 3, HG_PROJECTILE_SPRITE, sprite_get("spark"));
set_hitbox_value(AT_DAIR, 3, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_DAIR, 3, HG_PROJECTILE_ANIM_SPEED, 0.6);
set_hitbox_value(AT_DAIR, 3, HG_PROJECTILE_HSPEED, 0.4);

set_hitbox_value(AT_DAIR, 4, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_DAIR, 4, HG_WINDOW, 2);
set_hitbox_value(AT_DAIR, 4, HG_LIFETIME, 22);
set_hitbox_value(AT_DAIR, 4, HG_HITBOX_X, -70);
set_hitbox_value(AT_DAIR, 4, HG_HITBOX_Y, -100);
...
set_hitbox_value(AT_DAIR, 4, HG_PROJECTILE_SPRITE, sprite_get("spark"));
set_hitbox_value(AT_DAIR, 4, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_DAIR, 4, HG_PROJECTILE_ANIM_SPEED, 0.6);
set_hitbox_value(AT_DAIR, 4, HG_PROJECTILE_HSPEED, 0.4);