...
set_window_value(AT_NAIR, 1, AG_WINDOW_LENGTH, 4); //12 -> 20
...
set_window_value(AT_NAIR, 2, AG_WINDOW_SFX, sound_get("evil_laugh"));
...
set_window_value(AT_NAIR, 9, AG_WINDOW_ANIM_FRAME_START, 4);
...
set_window_value(AT_NAIR, 10, AG_WINDOW_ANIM_FRAME_START, 5);

set_window_value(AT_NAIR, 11, AG_WINDOW_TYPE, 1);
set_window_value(AT_NAIR, 11, AG_WINDOW_LENGTH, 5);
set_window_value(AT_NAIR, 11, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_NAIR, 11, AG_WINDOW_ANIM_FRAME_START, 1);

set_window_value(AT_NAIR, 12, AG_WINDOW_TYPE, 1);
set_window_value(AT_NAIR, 12, AG_WINDOW_LENGTH, 4);
set_window_value(AT_NAIR, 12, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_NAIR, 12, AG_WINDOW_ANIM_FRAME_START, 0);
...
set_hitbox_value(AT_NAIR, 1, HG_WIDTH, 160);
set_hitbox_value(AT_NAIR, 1, HG_HEIGHT, 160);
...
set_hitbox_value(AT_NAIR, 1, HG_IGNORES_PROJECTILES, true);
...
set_hitbox_value(AT_NAIR, 2, HG_WIDTH, 160);
set_hitbox_value(AT_NAIR, 2, HG_HEIGHT, 160);
...
set_hitbox_value(AT_NAIR, 3, HG_WINDOW, 9);
...
set_hitbox_value(AT_NAIR, 3, HG_HEIGHT, 160);
...
set_hitbox_value(AT_NAIR, 3, HG_IGNORES_PROJECTILES, true);