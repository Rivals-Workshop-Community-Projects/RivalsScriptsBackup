...
set_attack_value(AT_DATTACK, AG_HURTBOX_SPRITE, sprite_get("idle_hurt"));
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_SFX, sound_get("scrape"));
...
set_window_value(AT_DATTACK, 8, AG_WINDOW_SFX_FRAME, 2);
set_window_value(AT_DATTACK, 8, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_DATTACK, 8, AG_WINDOW_HSPEED, 9);
set_window_value(AT_DATTACK, 8, AG_WINDOW_ANIM_FRAMES, 7);
set_window_value(AT_DATTACK, 8, AG_WINDOW_ANIM_FRAME_START, 3);

set_window_value(AT_DATTACK, 9, AG_WINDOW_LENGTH, 4);
set_window_value(AT_DATTACK, 9, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_DATTACK, 9, AG_WINDOW_ANIM_FRAME_START, 2);
set_window_value(AT_DATTACK, 9, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_DATTACK, 9, AG_WINDOW_HSPEED, 0);

set_window_value(AT_DATTACK, 10, AG_WINDOW_LENGTH, 4);
set_window_value(AT_DATTACK, 10, AG_WINDOW_HSPEED_TYPE, 2);
set_window_value(AT_DATTACK, 10, AG_WINDOW_HSPEED, 4);
set_window_value(AT_DATTACK, 10, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_DATTACK, 10, AG_WINDOW_ANIM_FRAME_START, 1);

set_window_value(AT_DATTACK, 11, AG_WINDOW_LENGTH, 4);
set_window_value(AT_DATTACK, 11, AG_WINDOW_HSPEED_TYPE, 2);
set_window_value(AT_DATTACK, 11, AG_WINDOW_HSPEED, 2);
set_window_value(AT_DATTACK, 11, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_DATTACK, 11, AG_WINDOW_ANIM_FRAME_START, 0);
...
set_hitbox_value(AT_DATTACK, 1, HG_WIDTH, 130);
...
set_hitbox_value(AT_DATTACK, 1, HG_DAMAGE, 15);
...
set_hitbox_value(AT_DATTACK, 2, HG_PRIORITY, 9);
set_hitbox_value(AT_DATTACK, 2, HG_DAMAGE, 4);
set_hitbox_value(AT_DATTACK, 2, HG_ANGLE, 200);
