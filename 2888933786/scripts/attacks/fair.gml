...
set_hitbox_value(AT_FAIR, 2, HG_DAMAGE, 17);
set_hitbox_value(AT_FAIR, 2, HG_ANGLE, 37);
...
set_hitbox_value(AT_FAIR, 3, HG_DAMAGE, 17);
set_hitbox_value(AT_FAIR, 3, HG_ANGLE, 25);
...
set_hitbox_value(AT_FAIR, 4, HG_WIDTH, 140);
set_hitbox_value(AT_FAIR, 4, HG_HEIGHT, 60);
set_hitbox_value(AT_FAIR, 4, HG_PRIORITY, 9);
set_hitbox_value(AT_FAIR, 4, HG_DAMAGE, 23);
set_hitbox_value(AT_FAIR, 4, HG_ANGLE, 300);
set_hitbox_value(AT_FAIR, 4, HG_HIT_SFX, asset_get("sfx_blow_heavy2"));
set_hitbox_value(AT_FAIR, 4, HG_VISUAL_EFFECT, cartoon_punch);
