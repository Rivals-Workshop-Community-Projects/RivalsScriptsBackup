...
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX, sound_get("screech"));
...
set_hitbox_value(AT_DATTACK, 1, HG_MUNO_HITBOX_NAME, "Early Strong Hitbox");
...
set_hitbox_value(AT_DATTACK, 2, HG_MUNO_HITBOX_NAME, "Late Weak Hitbox");
