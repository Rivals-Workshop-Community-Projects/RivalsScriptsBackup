...
set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT, vfx_waterhit_light_huge);
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_LOCKOUT, 14);
...
set_hitbox_value(AT_FSTRONG, 3, HG_VISUAL_EFFECT, vfx_waterhit_light_huge);
set_hitbox_value(AT_FSTRONG, 3, HG_ANGLE_FLIPPER, 3);
set_hitbox_value(AT_FSTRONG, 3, HG_HIT_LOCKOUT, 14);
/*
