...
set_window_value(AT_DTILT, 6, AG_WINDOW_LENGTH, 22);
...
set_hitbox_value(AT_DTILT, 2, HG_ANGLE, 145);
...
set_hitbox_value(AT_DTILT, 3, HG_BASE_KNOCKBACK, 5.5);
set_hitbox_value(AT_DTILT, 3, HG_KNOCKBACK_SCALING, .6);
set_hitbox_value(AT_DTILT, 3, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_DTILT, 3, HG_HITPAUSE_SCALING, .65);
set_hitbox_value(AT_DTILT, 3, HG_EXTRA_HITPAUSE, 2);
