...
set_hitbox_value(AT_FTILT, 1, HG_KNOCKBACK_SCALING, .78);
...
set_hitbox_value(AT_FTILT, 2, HG_KNOCKBACK_SCALING, .72);
set_hitbox_value(AT_FTILT, 2, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_FTILT, 2, HG_HITPAUSE_SCALING, .8);
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, asset_get("sfx_waterhit_heavy"));
set_hitbox_value(AT_FTILT, 2, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_FTILT, 2, HG_SHAPE, 1);
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT, 5);
