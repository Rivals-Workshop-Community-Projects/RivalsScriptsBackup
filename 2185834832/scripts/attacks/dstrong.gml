...
set_hitbox_value(AT_DSTRONG, 7, HG_BASE_KNOCKBACK, 9.4);
set_hitbox_value(AT_DSTRONG, 7, HG_KNOCKBACK_SCALING, 0.95);
set_hitbox_value(AT_DSTRONG, 7, HG_BASE_HITPAUSE, 9.8);
