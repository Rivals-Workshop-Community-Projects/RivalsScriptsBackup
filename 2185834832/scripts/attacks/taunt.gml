...
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX, asset_get("sfx_waterhit_heavy"));
...
set_hitbox_value(AT_TAUNT, 1, HG_HITBOX_GROUP, 2);
...
set_hitbox_value(AT_TAUNT, 1, HG_BASE_HITPAUSE, 11);
set_hitbox_value(AT_TAUNT, 1, HG_HITPAUSE_SCALING, 0.9);
set_hitbox_value(AT_TAUNT, 1, HG_SHAPE, 0);
set_hitbox_value(AT_TAUNT, 1, HG_VISUAL_EFFECT, vfx_waterhit_light_huge);
...
set_hitbox_value(AT_TAUNT, 2, HG_HITBOX_Y, -50);
set_hitbox_value(AT_TAUNT, 2, HG_WIDTH, 80);
set_hitbox_value(AT_TAUNT, 2, HG_HEIGHT, 100);
set_hitbox_value(AT_TAUNT, 2, HG_PRIORITY, 2);
set_hitbox_value(AT_TAUNT, 2, HG_DAMAGE, 6);
set_hitbox_value(AT_TAUNT, 2, HG_ANGLE, 90);
set_hitbox_value(AT_TAUNT, 2, HG_BASE_KNOCKBACK, 5.5);
set_hitbox_value(AT_TAUNT, 2, HG_KNOCKBACK_SCALING, 0.65);
set_hitbox_value(AT_TAUNT, 2, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_TAUNT, 2, HG_SHAPE, 2);
set_hitbox_value(AT_TAUNT, 2, HG_VISUAL_EFFECT, vfx_waterhit_light_big);
set_hitbox_value(AT_TAUNT, 2, HG_HIT_SFX, asset_get("sfx_waterhit_medium"));