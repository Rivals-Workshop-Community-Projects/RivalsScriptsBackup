...
set_hitbox_value(AT_DSPECIAL, 6, HG_PROJECTILE_GRAVITY, 0);
...
set_hitbox_value(AT_DSPECIAL, 6, HG_HITBOX_X, -55);
set_hitbox_value(AT_DSPECIAL, 6, HG_HITBOX_Y, 20);
set_hitbox_value(AT_DSPECIAL, 6, HG_WIDTH, 65);
set_hitbox_value(AT_DSPECIAL, 6, HG_HEIGHT, 35);
...
set_hitbox_value(AT_DSPECIAL, 6, HG_HIT_SFX, asset_get("sfx_waterhit_weak"));
set_hitbox_value(AT_DSPECIAL, 6, HG_BASE_HITPAUSE, 2.5);
...
set_hitbox_value(AT_DSPECIAL, 6, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_DSPECIAL, 6, HG_VISUAL_EFFECT, vfx_waterhit_small);
