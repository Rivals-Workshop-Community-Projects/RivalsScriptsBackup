...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, 149);
...
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT, 5);
...
set_hitbox_value(AT_DAIR, 3, HG_ANGLE, 305);
set_hitbox_value(AT_DAIR, 3, HG_BASE_KNOCKBACK, 8.7);
set_hitbox_value(AT_DAIR, 3, HG_KNOCKBACK_SCALING, 0.43);
set_hitbox_value(AT_DAIR, 3, HG_BASE_HITPAUSE, 8.2);
