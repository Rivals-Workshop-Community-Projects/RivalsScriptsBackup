...
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("bubbleBombEmpty"));
...
set_hitbox_value(AT_USPECIAL, 2, HG_PROJECTILE_MASK, sprite_get("bubbleBombHugeEmpty"));
