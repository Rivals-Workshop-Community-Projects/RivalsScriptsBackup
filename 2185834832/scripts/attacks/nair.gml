...
set_window_value(AT_NAIR, 3, AG_WINDOW_LENGTH, 30);
...
set_hitbox_value(AT_NAIR, 3, HG_LIFETIME, 30);
...
set_hitbox_value(AT_NAIR, 4, HG_LIFETIME, 30);
set_hitbox_value(AT_NAIR, 4, HG_HITBOX_X, 43);
