...
set_hitbox_value(AT_USTRONG, 7, HG_HITBOX_Y, -10);
...
set_hitbox_value(AT_USTRONG, 7, HG_BASE_KNOCKBACK, 7.5);
set_hitbox_value(AT_USTRONG, 7, HG_KNOCKBACK_SCALING, 1.15);
...
set_hitbox_value(AT_USTRONG, 7, HG_HIT_LOCKOUT, 14);
