...
set_hitbox_value(AT_FAIR, 3, HG_HITBOX_X, 58);
...
set_hitbox_value(AT_FAIR, 4, HG_HITBOX_X, 58);
...
set_hitbox_value(AT_FAIR, 5, HG_HITBOX_X, 58);
set_hitbox_value(AT_FAIR, 5, HG_HITBOX_Y, -35);
set_hitbox_value(AT_FAIR, 5, HG_WIDTH, 48);
