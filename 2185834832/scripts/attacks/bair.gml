...
set_hitbox_value(AT_BAIR, 1, HG_HIT_LOCKOUT, 14);
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, vfx_waterhit_light_huge);

set_hitbox_value(AT_BAIR, 2, HG_PARENT_HITBOX, 0);
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_BAIR, 2, HG_WINDOW, 2);
set_hitbox_value(AT_BAIR, 2, HG_WINDOW_CREATION_FRAME, 2);
set_hitbox_value(AT_BAIR, 2, HG_LIFETIME, 18);
...
set_hitbox_value(AT_BAIR, 2, HG_KNOCKBACK_SCALING, 0.23);
set_hitbox_value(AT_BAIR, 2, HG_BASE_HITPAUSE, 3);
set_hitbox_value(AT_BAIR, 2, HG_HITPAUSE_SCALING, .29);
