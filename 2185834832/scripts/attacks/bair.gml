...
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, vfx_waterhit_light_big);
...
set_hitbox_value(AT_BAIR, 2, HG_HIT_LOCKOUT, 14);
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT, vfx_waterhit_light_huge);
