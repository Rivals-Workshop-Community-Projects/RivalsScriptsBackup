...
set_hitbox_value(AT_FSTRONG, 1, HG_PROJECTILE_SPRITE, sprite_get("fstrongproj_loop"));
set_hitbox_value(AT_FSTRONG, 1, HG_PROJECTILE_MASK, sprite_get("fstrongproj_loop"));
set_hitbox_value(AT_FSTRONG, 1, HG_PROJECTILE_ENEMY_BEHAVIOR, 1);
set_hitbox_value(AT_FSTRONG, 1, HG_IGNORES_PROJECTILES, true);
...
set_hitbox_value(AT_FSTRONG, 1, HG_PROJECTILE_ANIM_SPEED, .3);
set_hitbox_value(AT_FSTRONG, 1, HG_PROJECTILE_DESTROY_EFFECT, 1);
set_hitbox_value(AT_FSTRONG, 1, HG_WINDOW, 99);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sound_get("bigpunch"));


set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_FSTRONG, 2, HG_PROJECTILE_SPRITE, sprite_get("fstrongproj_active"));
set_hitbox_value(AT_FSTRONG, 2, HG_PROJECTILE_MASK, sprite_get("fstrongproj_active"));
...
set_hitbox_value(AT_FSTRONG, 2, HG_PROJECTILE_ENEMY_BEHAVIOR, 2);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, sound_get("pokehit_nfe"));
...
set_hitbox_value(AT_FSTRONG, 3, HG_HIT_SFX, sound_get("fstrong"));

set_hitbox_value(AT_FSTRONG, 4, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_FSTRONG, 4, HG_PROJECTILE_SPRITE, sprite_get("fstrongproj_startup"));
set_hitbox_value(AT_FSTRONG, 4, HG_PROJECTILE_MASK, sprite_get("fstrongproj_loop"));
set_hitbox_value(AT_FSTRONG, 4, HG_PROJECTILE_ENEMY_BEHAVIOR, 1);
set_hitbox_value(AT_FSTRONG, 4, HG_IGNORES_PROJECTILES, true);
...
set_hitbox_value(AT_FSTRONG, 4, HG_PROJECTILE_ANIM_SPEED, .4);
set_hitbox_value(AT_FSTRONG, 4, HG_WINDOW, 99);
set_hitbox_value(AT_FSTRONG, 4, HG_LIFETIME, 90);
...
set_hitbox_value(AT_FSTRONG, 4, HG_HIT_SFX, sound_get("bigpunch"));


set_hitbox_value(AT_FSTRONG, 5, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_FSTRONG, 5, HG_PROJECTILE_SPRITE, sprite_get("projectile_invis"));
...
set_hitbox_value(AT_FSTRONG, 5, HG_PROJECTILE_ENEMY_BEHAVIOR, 2);
set_hitbox_value(AT_FSTRONG, 5, HG_IGNORES_PROJECTILES, true);
...
set_hitbox_value(AT_FSTRONG, 5, HG_PROJECTILE_DOES_NOT_REFLECT, 1);
set_hitbox_value(AT_FSTRONG, 5, HG_PROJECTILE_PARRY_STUN, 1);
...
set_hitbox_value(AT_FSTRONG, 5, HG_VISUAL_EFFECT, curse);
set_hitbox_value(AT_FSTRONG, 5, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_FSTRONG, 5, HG_HIT_SFX, sound_get("fstrong"));