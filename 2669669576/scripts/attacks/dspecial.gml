...
set_window_value(attack, window_num, AG_WINDOW_SFX_FRAME, 17);

window_num++;

// Window 2 / Frame(s) # - / Attack Start
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
// Window 3 / Frame(s) # - / Falling Attack
...
set_window_value(attack, window_num, AG_WINDOW_GOTO, 5);



window_num++;

// Window 4 / Frame(s) # - / Falling Endlag
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
...
set_window_value(attack, window_num, AG_WINDOW_GOTO, 8);

window_num++;

// Window 5 / Frame(s) # - / Landing
set_window_value(attack, window_num, AG_WINDOW_TYPE, 1);
set_window_value(attack, window_num, AG_WINDOW_LENGTH, 20);
set_window_value(attack, window_num, AG_WINDOW_ANIM_FRAMES, 4);
...
set_num_hitboxes(attack, 20); // Swap 1 for number of hitboxes
...
set_hitbox_value(attack, hitbox_num, HG_ANGLE_FLIPPER, 2);
...
set_hitbox_value(attack, hitbox_num, HG_FINAL_BASE_KNOCKBACK, 4);
