...
// Physical size
char_height         = 57;       //                  not zetterburn's. this is just cosmetic anyway
...
spr_dest_idle = sprite_get("dest_idle");
spr_dest_grab = sprite_get("dest_grab");
spr_dest_car = sprite_get("dest_car");

// SFX
sfx_example = sound_get("example"); // sounds/example.ogg

// VFX
vfx_example = hit_fx_create(spr_nspecial_proj, 54);

// Variables
dest_1 = noone;                 // dest 1's id
dest_2 = noone;                 // dest 2's id
nspecial_timer = 0;             // current nspecial place time
nspecial_timer_max = 180;       // ^ max
...
set_victory_theme(sound_get("arrival")); // victory_theme.ogg
