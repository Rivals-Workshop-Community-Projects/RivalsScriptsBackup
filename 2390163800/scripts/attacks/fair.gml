...
//set_window_value(AT_FAIR, 2, AG_WINDOW_SFX, asset_get("sfx_bird_nspecial"));
...
//set_hitbox_value(AT_FAIR, 1, HG_HITSTUN_MULTIPLIER, 2);
...
//set_hitbox_value(AT_FAIR, 2, HG_HITSTUN_MULTIPLIER, 2);
