...
//ranno stats; no late hit on the bottom just halfway between sweet and sour
...
set_hitbox_value(AT_DSTRONG, 1, HG_HITPAUSE_SCALING, 1.25);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_Y, -53);
