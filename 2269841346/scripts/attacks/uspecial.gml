...
set_window_value(AT_USPECIAL, 5, AG_WINDOW_SFX, asset_get("sfx_bird_downspecial"));
...
set_hitbox_value(AT_USPECIAL, 5, HG_HITBOX_X, 25);
set_hitbox_value(AT_USPECIAL, 5, HG_HITBOX_Y, -30);
set_hitbox_value(AT_USPECIAL, 5, HG_WIDTH, 76);
...
set_hitbox_value(AT_USPECIAL, 5, HG_HIT_SFX, asset_get("sfx_ori_energyhit_heavy"));
