...
if (!variable_instance_exists(id,"ae") || ye == true){
    ...
    ce[col,1] = "Overgrown Reaper" // the name of the alternate color.
    ...
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 1), get_color_profile_slot_g(col, 1), get_color_profile_slot_b(col, 1));
    ce[col,1] = "Blue Violet" // the name of the alternate color.
    ce[col,2] = "" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 1), get_color_profile_slot_g(col, 1), get_color_profile_slot_b(col, 1));
    ce[col,1] = "Phantom Rose" // the name of the alternate color.
    ce[col,2] = "" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 1), get_color_profile_slot_g(col, 1), get_color_profile_slot_b(col, 1));
    ce[col,1] = "Vine Shroom" // the name of the alternate color.
    ce[col,2] = "BINYOT" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 1), get_color_profile_slot_g(col, 1), get_color_profile_slot_b(col, 1));
    ce[col,1] = "Paper Ghost" // the name of the alternate color.
    ce[col,2] = "Vivian" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 1), get_color_profile_slot_g(col, 1), get_color_profile_slot_b(col, 1));
    ce[col,1] = "Scythe Maiden" // the name of the alternate color.
    ce[col,2] = "not a vtuber i swear :clown:" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 1), get_color_profile_slot_g(col, 1), get_color_profile_slot_b(col, 1));
    ce[col,1] = "Psycho Hood" // the name of the alternate color.
    ce[col,2] = "B.B. Hood" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 1), get_color_profile_slot_g(col, 1), get_color_profile_slot_b(col, 1));
    ce[col,1] = "Ghostly" // the name of the alternate color.
    ce[col,2] = "IT IS A MYSTERY" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 1), get_color_profile_slot_g(col, 1), get_color_profile_slot_b(col, 1));
    ce[col,1] = "Huy's Smackdown" // the name of the alternate color.
    ce[col,2] = "Septet" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 1), get_color_profile_slot_g(col, 1), get_color_profile_slot_b(col, 1));
    ce[col,1] = "RR" // the name of the alternate color.
    ce[col,2] = "Ruby Rose" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 1), get_color_profile_slot_g(col, 1), get_color_profile_slot_b(col, 1));
    ce[col,1] = "Reforged" // the name of the alternate color.
    ce[col,2] = "Regina's favorite" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 1), get_color_profile_slot_g(col, 1), get_color_profile_slot_b(col, 1));
    ce[col,1] = "Limit Break" // the name of the alternate color.
    ce[col,2] = "Cloud" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 1), get_color_profile_slot_g(col, 1), get_color_profile_slot_b(col, 1));
    ce[col,1] = "Hell's Edge" // the name of the alternate color.
    ce[col,2] = "Sephiroth I guess" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 1), get_color_profile_slot_g(col, 1), get_color_profile_slot_b(col, 1));
    ce[col,1] = "Abyss" // the name of the alternate color.
    ce[col,2] = "Abyss" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 1), get_color_profile_slot_g(col, 1), get_color_profile_slot_b(col, 1));
    ce[col,1] = "EA" // the name of the alternate color.
    ce[col,2] = "EA" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 1), get_color_profile_slot_g(col, 1), get_color_profile_slot_b(col, 1));
    ce[col,1] = "PowerVale" // the name of the alternate color.
    ce[col,2] = "Nate" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 1), get_color_profile_slot_g(col, 1), get_color_profile_slot_b(col, 1));
    ce[col,1] = "Brisket" // the name of the alternate color.
    ce[col,2] = "Brisket" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 1), get_color_profile_slot_g(col, 1), get_color_profile_slot_b(col, 1));
    ce[col,1] = "Charlotte" // the name of the alternate color.
    ce[col,2] = "Reaper's Warning" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 1), get_color_profile_slot_g(col, 1), get_color_profile_slot_b(col, 1));
    ...
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 1), get_color_profile_slot_g(col, 1), get_color_profile_slot_b(col, 1));
    ce[col,1] = "Kumaki" // the name of the alternate color.
    ce[col,2] = "Reaper's Warning" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 1), get_color_profile_slot_g(col, 1), get_color_profile_slot_b(col, 1));
    ce[col,1] = "Linne" // the name of the alternate color.
    ce[col,2] = "Reaper's Warning" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 3), get_color_profile_slot_g(col, 3), get_color_profile_slot_b(col, 3));
    ce[col,1] = "Lumi" // the name of the alternate color.
    ce[col,2] = "Supersonic says hi." // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 3), get_color_profile_slot_g(col, 3), get_color_profile_slot_b(col, 3));
    ce[col,1] = "very bright" // the name of the alternate color.
    ce[col,2] = "please rename me." // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 2), get_color_profile_slot_g(col, 2), get_color_profile_slot_b(col, 2));
    ce[col,1] = "Flow" // the name of the alternate color.
    ce[col,2] = "shoutouts to water" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 2), get_color_profile_slot_g(col, 2), get_color_profile_slot_b(col, 2));
    ce[col,1] = "Zero" // the name of the alternate color.
    ce[col,2] = "Megaman Zero" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 3), get_color_profile_slot_g(col, 3), get_color_profile_slot_b(col, 3));
    ce[col,1] = "Mint" // the name of the alternate color.
    ce[col,2] = "fresh :)" // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
    col++;
    ce[col,0] = make_color_rgb(get_color_profile_slot_r(col, 2), get_color_profile_slot_g(col, 2), get_color_profile_slot_b(col, 2));
