...
sprite_change_offset("land", 16, 47);
sprite_change_offset("landinglag", 16, 47);
...
sprite_change_offset("nspecial_proj1", 48, 48);
sprite_change_offset("nspecial_proj1e", 144, 144);
...
sprite_change_offset("dspecial_portal_at1", 48, 48);
sprite_change_offset("dspecial_portal_at2", 48, 112);
...
sprite_change_offset("hud_install_de", 24, 24);

sprite_change_offset("fx_install_part", 16, 48);
sprite_change_offset("fx_install_glow", 128, 128);
sprite_change_offset("fx_install_act_fg", 80, 128);
sprite_change_offset("fx_install_act_bg", 80, 128);
sprite_change_offset("fx_install_de_fg", 64, 128);
sprite_change_offset("fx_install_de_bg", 64, 128);

sprite_change_offset("hfx_small", 48, 48);
sprite_change_offset("hfx_small_down", 48, 32);
sprite_change_offset("hfx_small_up", 48, 64);
sprite_change_offset("hfx_large_down", 64, 96);
sprite_change_offset("hfx_small_up", 48, 64);
sprite_change_offset("hfx_large_up", 64, 96);
sprite_change_offset("hfx_sweetspot", 128, 128);
sprite_change_offset("hfx_dstrong_bg", 48, 190);
sprite_change_offset("hfx_dstrong_fg", 48, 190);