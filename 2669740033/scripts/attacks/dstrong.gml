...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_HAS_WHIFFLAG, 8);
...
set_hitbox_value(AT_DSTRONG, 2, HG_WIDTH, 143);
set_hitbox_value(AT_DSTRONG, 2, HG_HEIGHT, 29);
...
set_hitbox_value(AT_DSTRONG, 3, HG_WIDTH, 154);
set_hitbox_value(AT_DSTRONG, 3, HG_HEIGHT, 28);
...
set_hitbox_value(AT_DSTRONG, 4, HG_WIDTH, 172);
set_hitbox_value(AT_DSTRONG, 4, HG_HEIGHT, 31);
...
set_hitbox_value(AT_DSTRONG, 4, HG_ANGLE, 290);
...
set_hitbox_value(AT_DSTRONG, 4, HG_HIT_SFX, asset_get("sfx_absa_harderhit"));
