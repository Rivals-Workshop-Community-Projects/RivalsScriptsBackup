...
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, asset_get("sfx_spin"));
...
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, asset_get("sfx_spin"));
...
set_hitbox_value(AT_DAIR, 3, HG_HEIGHT, 34);
...
set_hitbox_value(AT_DAIR, 3, HG_HIT_SFX, asset_get("sfx_spin"));
