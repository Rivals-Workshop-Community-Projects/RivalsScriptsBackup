...
set_hitbox_value(AT_NSPECIAL, 1, HG_LIFETIME, 135);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, sound_get("Voltorb_short"));
set_hitbox_value(AT_NSPECIAL, 1, HG_HITSTUN_MULTIPLIER, 1);
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("voltorb_loop"));
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("voltorb_loop"));
