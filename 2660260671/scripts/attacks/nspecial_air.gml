...
set_attack_value(AT_NSPECIAL_AIR, AG_SPRITE, sprite_get("dspecial"));
set_attack_value(AT_NSPECIAL_AIR, AG_NUM_WINDOWS, 4);
set_attack_value(AT_NSPECIAL_AIR, AG_HAS_LANDING_LAG, 4);
set_attack_value(AT_NSPECIAL_AIR, AG_AIR_SPRITE, sprite_get("dspecial"));
set_attack_value(AT_NSPECIAL_AIR, AG_HURTBOX_SPRITE, sprite_get("dspecial_hurt"));
...
set_window_value(AT_NSPECIAL_AIR, 1, AG_WINDOW_SFX, sound_get("confuseray"));

set_window_value(AT_NSPECIAL_AIR, 2, AG_WINDOW_TYPE, 1);
set_window_value(AT_NSPECIAL_AIR, 2, AG_WINDOW_LENGTH, 5);
...
set_window_value(AT_NSPECIAL_AIR, 2, AG_WINDOW_SFX, sound_get("ember_shot"));

set_window_value(AT_NSPECIAL_AIR, 3, AG_WINDOW_TYPE, 1);
set_window_value(AT_NSPECIAL_AIR, 3, AG_WINDOW_LENGTH, 14);
...
set_window_value(AT_NSPECIAL_AIR, 4, AG_WINDOW_LENGTH, 21);
...
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_HITBOX_X, 29);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_HITBOX_Y, -12);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_WIDTH, 45);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_HEIGHT, 45);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_SPRITE, sprite_get("confuseray"));
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_ANIM_SPEED, .17);
...
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_UNBASHABLE, 1);
...
set_hitbox_value(AT_NSPECIAL_AIR, 2, HG_WINDOW_CREATION_FRAME, 0);
set_hitbox_value(AT_NSPECIAL_AIR, 2, HG_LIFETIME, 1);
set_hitbox_value(AT_NSPECIAL_AIR, 2, HG_HITBOX_X, 29);
set_hitbox_value(AT_NSPECIAL_AIR, 2, HG_HITBOX_Y, -12);
...
set_hitbox_value(AT_NSPECIAL_AIR, 2, HG_BASE_KNOCKBACK, 12);
...
set_hitbox_value(AT_NSPECIAL_AIR, 2, HG_HIT_SFX, sound_get("hit_punch2"));