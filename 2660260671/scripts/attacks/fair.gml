...
set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, sound_get("hex"));
set_window_value(AT_FAIR, 1, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_FAIR, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.4);
...
set_window_value(AT_FAIR, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.3);
...
set_window_value(AT_FAIR, 3, AG_WINDOW_HAS_WHIFFLAG, 3);
set_window_value(AT_FAIR, 3, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_FAIR, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.1);
...
set_hitbox_value(AT_FAIR, 1, HG_HEIGHT, 47);
...
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, sound_get("hit_punch"));
...
set_hitbox_value(AT_FAIR, 4, HG_KNOCKBACK_SCALING, .51);
...
set_hitbox_value(AT_FAIR, 4, HG_HIT_SFX, sound_get("hit_punch2"));
