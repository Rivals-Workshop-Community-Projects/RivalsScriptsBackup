...
set_window_value(AT_DSPECIAL_AIR, 1, AG_WINDOW_SFX, sound_get("confuseray"));
...
set_window_value(AT_DSPECIAL_AIR, 2, AG_WINDOW_SFX, sound_get("ember_shot"));
...
set_window_value(AT_DSPECIAL_AIR, 4, AG_WINDOW_LENGTH, 21);
...
set_hitbox_value(AT_DSPECIAL_AIR, 1, HG_LIFETIME, 40);
set_hitbox_value(AT_DSPECIAL_AIR, 1, HG_HITBOX_X, 29);
...
set_hitbox_value(AT_DSPECIAL_AIR, 1, HG_PROJECTILE_SPRITE, sprite_get("confuseray"));
set_hitbox_value(AT_DSPECIAL_AIR, 1, HG_PROJECTILE_ANIM_SPEED, .17);
...
set_hitbox_value(AT_DSPECIAL_AIR, 2, HG_HITBOX_X, 29);
set_hitbox_value(AT_DSPECIAL_AIR, 2, HG_HITBOX_Y, -12);
...
set_hitbox_value(AT_DSPECIAL_AIR, 2, HG_BASE_KNOCKBACK, 12);
...
set_hitbox_value(AT_DSPECIAL_AIR, 2, HG_HIT_SFX, sound_get("hit_punch2"));