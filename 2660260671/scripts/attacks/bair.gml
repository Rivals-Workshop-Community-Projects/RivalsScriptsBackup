...
set_window_value(AT_BAIR, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.2);
...
set_window_value(AT_BAIR, 2, AG_WINDOW_SFX, sound_get("fire_hit_smaller"));
...
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 43);
set_hitbox_value(AT_BAIR, 1, HG_PRIORITY, 2);
set_hitbox_value(AT_BAIR, 1, HG_DAMAGE, 8);
set_hitbox_value(AT_BAIR, 1, HG_ANGLE, 35);
...
set_hitbox_value(AT_BAIR, 1, HG_HITPAUSE_SCALING, .40);
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, -32);
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("fire_hit_large"));
