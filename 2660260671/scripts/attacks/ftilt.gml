...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, sound_get("fire_whip"));
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, sound_get("fire_hit_small"));
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT, smallhit);
...
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, sound_get("fire_hit_small"));
set_hitbox_value(AT_FTILT, 2, HG_WINDOW_CREATION_FRAME, 2);
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT, smallhit);