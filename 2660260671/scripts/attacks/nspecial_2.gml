...
set_window_value(AT_NSPECIAL_2, 1, AG_WINDOW_SFX, sound_get("confuseray"));
...
set_window_value(AT_NSPECIAL_2, 2, AG_WINDOW_SFX, sound_get("ember_shot"));
...
set_window_value(AT_NSPECIAL_2, 4, AG_WINDOW_LENGTH, 21);
...
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HITBOX_X, 29);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HITBOX_Y, -12);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_WIDTH, 45);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HEIGHT, 45);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_PROJECTILE_SPRITE, sprite_get("confuseray"));
set_hitbox_value(AT_NSPECIAL_2, 1, HG_PROJECTILE_ANIM_SPEED, .17);
...
set_hitbox_value(AT_NSPECIAL_2, 4, HG_LIFETIME, 1);
set_hitbox_value(AT_NSPECIAL_2, 4, HG_HITBOX_X, 29);
set_hitbox_value(AT_NSPECIAL_2, 4, HG_HITBOX_Y, -12);
set_hitbox_value(AT_NSPECIAL_2, 4, HG_SHAPE, 0);
set_hitbox_value(AT_NSPECIAL_2, 4, HG_WIDTH, 45);
set_hitbox_value(AT_NSPECIAL_2, 4, HG_HEIGHT, 45);
set_hitbox_value(AT_NSPECIAL_2, 4, HG_PRIORITY, 3);
set_hitbox_value(AT_NSPECIAL_2, 4, HG_DAMAGE, 1);
set_hitbox_value(AT_NSPECIAL_2, 4, HG_ANGLE, 315);
set_hitbox_value(AT_NSPECIAL_2, 4, HG_BASE_KNOCKBACK, 12);
set_hitbox_value(AT_NSPECIAL_2, 4, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_NSPECIAL_2, 4, HG_KNOCKBACK_SCALING, 0.8);
set_hitbox_value(AT_NSPECIAL_2, 4, HG_HITPAUSE_SCALING, 0.8);
set_hitbox_value(AT_NSPECIAL_2, 4, HG_HIT_SFX, sound_get("hit_punch2"));