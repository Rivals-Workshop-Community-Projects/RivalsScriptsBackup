...
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, sound_get("fire_hit_large"));
...
set_hitbox_value(AT_DAIR, 2, HG_HEIGHT, 39);
...
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, sound_get("fire_hit_medium"));
set_hitbox_value(AT_DAIR, 2, HG_ANGLE_FLIPPER, 1);