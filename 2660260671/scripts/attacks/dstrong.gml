...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("ember_shot"));
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, sound_get("wisp"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_LIFETIME, 27);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("fire_hit_medium"));
set_hitbox_value(AT_DSTRONG, 1, HG_ANGLE_FLIPPER, 1);
set_hitbox_value(AT_DSTRONG, 1, HG_WINDOW_CREATION_FRAME, 3);
set_hitbox_value(AT_DSTRONG, 1, HG_PROJECTILE_DESTROY_EFFECT, smallhit );
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, smallhit);

set_hitbox_value(AT_DSTRONG, 1, HG_PARENT_HITBOX, 1);
set_hitbox_value(AT_DSTRONG, 1, HG_PROJECTILE_SPRITE, sprite_get("wisp"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_PROJECTILE_GRAVITY, 0.01);
set_hitbox_value(AT_DSTRONG, 1, HG_PROJECTILE_AIR_FRICTION, 0.06);
...
set_hitbox_value(AT_DSTRONG, 2, HG_LIFETIME, 27);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("fire_hit_medium"));
set_hitbox_value(AT_DSTRONG, 2, HG_ANGLE_FLIPPER, 1);
set_hitbox_value(AT_DSTRONG, 2, HG_PROJECTILE_DESTROY_EFFECT, smallhit );
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, smallhit);

set_hitbox_value(AT_DSTRONG, 2, HG_PARENT_HITBOX, 2);
set_hitbox_value(AT_DSTRONG, 2, HG_PROJECTILE_SPRITE, sprite_get("wisp"));
set_hitbox_value(AT_DSTRONG, 2, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_DSTRONG, 2, HG_PROJECTILE_ANIM_SPEED, 0.35);
set_hitbox_value(AT_DSTRONG, 2, HG_PROJECTILE_HSPEED, 0);
set_hitbox_value(AT_DSTRONG, 2, HG_PROJECTILE_VSPEED, 0);
set_hitbox_value(AT_DSTRONG, 2, HG_PROJECTILE_GRAVITY, 0.01);
set_hitbox_value(AT_DSTRONG, 2, HG_PROJECTILE_AIR_FRICTION, 0.06);
...
set_hitbox_value(AT_DSTRONG, 2, HG_PROJECTILE_PARRY_STUN, 0);
