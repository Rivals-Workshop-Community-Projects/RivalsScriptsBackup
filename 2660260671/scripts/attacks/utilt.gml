...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("throw"));
...
set_window_value(AT_UTILT, 3, AG_WINDOW_SFX, sound_get("fire_hit_smaller"));
...
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sound_get("hit_punch"));
...
set_hitbox_value(AT_UTILT, 3, HG_HIT_SFX, sound_get("fire_hit_small"));
...
set_hitbox_value(AT_UTILT, 4, HG_HIT_SFX, sound_get("fire_hit_medium"));
