...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sound_get("ember_shot"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_WIDTH, 27);
set_hitbox_value(AT_FSPECIAL, 1, HG_HEIGHT, 27);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, sound_get("fire_hit_smaller"));
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, smallhit );
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT, smallhit);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HITBOX_X, 11);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("ember"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_AIR_FRICTION, 0.01);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_GRAVITY, 0.05);
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_AIR_FRICTION, 0.01);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, sound_get("fire_hit_medium"));