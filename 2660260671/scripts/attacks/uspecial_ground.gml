...
set_attack_value(AT_USPECIAL_GROUND, AG_SPRITE, sprite_get("dspecial"));
set_attack_value(AT_USPECIAL_GROUND, AG_NUM_WINDOWS, 4);
set_attack_value(AT_USPECIAL_GROUND, AG_HAS_LANDING_LAG, 4);
set_attack_value(AT_USPECIAL_GROUND, AG_AIR_SPRITE, sprite_get("dspecial"));
set_attack_value(AT_USPECIAL_GROUND, AG_HURTBOX_SPRITE, sprite_get("dspecial_hurt"));
...
set_window_value(AT_USPECIAL_GROUND, 1, AG_WINDOW_SFX, sound_get("confuseray"));
...
set_window_value(AT_USPECIAL_GROUND, 2, AG_WINDOW_SFX, sound_get("ember_shot"));
...
set_window_value(AT_USPECIAL_GROUND, 4, AG_WINDOW_LENGTH, 21);
...
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_LIFETIME, 40);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_HITBOX_X, 29);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_HITBOX_Y, -12);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_WIDTH, 45);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_HEIGHT, 45);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_PROJECTILE_SPRITE, sprite_get("confuseray"));
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_PROJECTILE_ANIM_SPEED, .17);
...
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_WINDOW_CREATION_FRAME, 0);
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_LIFETIME, 1);
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_HITBOX_X, 29);
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_HITBOX_Y, -12);
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_SHAPE, 0);
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_WIDTH, 45);
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_HEIGHT, 45);
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_PRIORITY, 3);
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_DAMAGE, 1);
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_ANGLE, 135);
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_BASE_KNOCKBACK, 12);
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_KNOCKBACK_SCALING, 0.8);
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_HITPAUSE_SCALING, 0.8);
set_hitbox_value(AT_USPECIAL_GROUND, 2, HG_HIT_SFX, sound_get("hit_punch2"));