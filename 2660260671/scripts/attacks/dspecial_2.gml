...
set_window_value(AT_DSPECIAL_2, 1, AG_WINDOW_SFX, sound_get("confuseray"));
...
set_window_value(AT_DSPECIAL_2, 2, AG_WINDOW_SFX, sound_get("ember_shot"));
...
set_window_value(AT_DSPECIAL_2, 4, AG_WINDOW_LENGTH, 21);
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HITBOX_X, 29);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HITBOX_Y, -12);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_WIDTH, 45);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HEIGHT, 45);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_PROJECTILE_SPRITE, sprite_get("confuseray"));
set_hitbox_value(AT_DSPECIAL_2, 1, HG_PROJECTILE_ANIM_SPEED, .17);
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_HITBOX_X, 29);
set_hitbox_value(AT_DSPECIAL_2, 2, HG_HITBOX_Y, -12);
set_hitbox_value(AT_DSPECIAL_2, 2, HG_SHAPE, 0);
set_hitbox_value(AT_DSPECIAL_2, 2, HG_WIDTH, 45);
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_HIT_SFX, sound_get("hit_punch2"));