...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, sound_get("teehee"));
...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("astonish2"));
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX, sound_get("astonish"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_HEIGHT, 59);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sound_get("hit_punch3"));
