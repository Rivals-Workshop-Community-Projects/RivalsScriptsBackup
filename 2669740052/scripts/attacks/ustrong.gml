...
set_window_value(AT_USTRONG, 1, AG_WINDOW_INVINCIBILITY, 1);
...
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_X, 77);
...
set_hitbox_value(AT_USTRONG, 1, HG_ANGLE, 128);
set_hitbox_value(AT_USTRONG, 1, HG_BASE_KNOCKBACK, 8);//8
...
set_hitbox_value(AT_USTRONG, 1, HG_HITSTUN_MULTIPLIER, 5);
...
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_Y, -83);
set_hitbox_value(AT_USTRONG, 2, HG_WIDTH, 213);
