...
set_hitbox_value(AT_DTILT, 1, HG_LIFETIME, 28);//14
...
set_hitbox_value(AT_DTILT, 1, HG_PROJECTILE_SPRITE, sprite_get("rock11_proj"));
set_hitbox_value(AT_DTILT, 1, HG_PROJECTILE_MASK, sprite_get("rock11_proj"));
set_hitbox_value(AT_DTILT, 1, HG_PROJECTILE_COLLISION_SPRITE, sprite_get("rock11_proj"));
set_hitbox_value(AT_DTILT, 1, HG_PROJECTILE_ANIM_SPEED, 0.5);
