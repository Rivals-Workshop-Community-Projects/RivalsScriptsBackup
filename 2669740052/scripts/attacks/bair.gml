...
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_Y, -72);
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 153);
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 78);
set_hitbox_value(AT_BAIR, 1, HG_PRIORITY, 2);
set_hitbox_value(AT_BAIR, 1, HG_DAMAGE, 5);
set_hitbox_value(AT_BAIR, 1, HG_ANGLE, 135);//45);
...
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_X, -89);
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_Y, -58);
set_hitbox_value(AT_BAIR, 2, HG_WIDTH, 73);
set_hitbox_value(AT_BAIR, 2, HG_HEIGHT, 61);
set_hitbox_value(AT_BAIR, 2, HG_PRIORITY, 5);
set_hitbox_value(AT_BAIR, 2, HG_DAMAGE, 7);
set_hitbox_value(AT_BAIR, 2, HG_ANGLE, 255);
...
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, asset_get("sfx_blow_hard1"));
