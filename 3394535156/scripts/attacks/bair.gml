...
set_attack_value(AT_BAIR, AG_MUNO_ATTACK_MISC_ADD, "Pushes Plague Knight backwards when used. Land with perfect timing before active frames to slide across the ground.");
...
set_window_value(AT_BAIR, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.75);
...
set_window_value(AT_BAIR, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.3);
set_window_value(AT_BAIR, 3, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_BAIR, 3, AG_WINDOW_CUSTOM_GRAVITY, 1.25);

set_num_hitboxes(AT_BAIR, 1);

set_hitbox_value(AT_BAIR, 1, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_BAIR, 1, HG_MUNO_HITBOX_NAME, "Main Hit");
