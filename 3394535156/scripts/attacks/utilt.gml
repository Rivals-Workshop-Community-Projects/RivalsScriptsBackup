...
set_hitbox_value(AT_UTILT, 1, HG_MUNO_HITBOX_NAME, "First Hit");
...
set_hitbox_value(AT_UTILT, 1, HG_HITSTUN_MULTIPLIER, 0.6);
set_hitbox_value(AT_UTILT, 1, HG_BASE_HITPAUSE, 4);
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, asset_get("sfx_blow_weak2"));
set_hitbox_value(AT_UTILT, 1, HG_HITBOX_GROUP, 1);

set_hitbox_value(AT_UTILT, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_UTILT, 2, HG_MUNO_HITBOX_NAME, "Second Hit");
...
set_hitbox_value(AT_UTILT, 3, HG_MUNO_HITBOX_NAME, "Second Hit (Late)");
