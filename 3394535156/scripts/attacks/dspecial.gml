...
set_attack_value(AT_DSPECIAL, AG_MUNO_ATTACK_NAME, "DSpecial: Powder Management");
set_attack_value(AT_DSPECIAL, AG_MUNO_ATTACK_MISC_ADD, "Selects 1 of 4 powders to apply to bombs thrown with NSpecial and FSpecial. You can select them by flicking the corresponding direction with either the control stick or the right stick for easy access.
