...
set_window_value(AT_USTRONG, 5, AG_WINDOW_HAS_WHIFFLAG, 8);
...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("hit_H1"));
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("hit_M1"));
...
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, sound_get("hit_H1"));
...
set_hitbox_value(AT_USTRONG, 4, HG_HIT_SFX, sound_get("hit_M1"));