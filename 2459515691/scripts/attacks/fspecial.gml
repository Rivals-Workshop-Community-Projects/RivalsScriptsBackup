...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_VSPEED, -0.4);
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_VSPEED, -0.1);
...
set_window_value(AT_FSPECIAL, 5, AG_WINDOW_VSPEED, 0.1);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, sound_get("hit_M1"));
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, sound_get("hit_M1"));
...
set_hitbox_value(AT_FSPECIAL, 3, HG_HIT_SFX, sound_get("hit_M1"));