...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_SFX, asset_get("sfx_shovel_swing_heavy1"));
...
set_window_value(AT_FSTRONG, 6, AG_WINDOW_HAS_WHIFFLAG, 12);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_Y, -64);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_Y, -68);
...
set_hitbox_value(AT_FSTRONG, 3, HG_HEIGHT, 72);
...
set_hitbox_value(AT_FSTRONG, 4, HG_HITBOX_X, 74);
set_hitbox_value(AT_FSTRONG, 4, HG_HITBOX_Y, 3);
set_hitbox_value(AT_FSTRONG, 4, HG_SHAPE, 1);
set_hitbox_value(AT_FSTRONG, 4, HG_WIDTH, 14);
set_hitbox_value(AT_FSTRONG, 4, HG_HEIGHT, 4);
set_hitbox_value(AT_FSTRONG, 4, HG_PRIORITY, 4);
set_hitbox_value(AT_FSTRONG, 4, HG_DAMAGE, 16);
set_hitbox_value(AT_FSTRONG, 4, HG_ANGLE, 300);
