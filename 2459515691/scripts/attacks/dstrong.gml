...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_ell_eject"));
...
set_hitbox_value(AT_DSTRONG, 4, HG_WINDOW_CREATION_FRAME, 15);
set_hitbox_value(AT_DSTRONG, 4, HG_LIFETIME, 3);
set_hitbox_value(AT_DSTRONG, 4, HG_HITBOX_X, -40);
set_hitbox_value(AT_DSTRONG, 4, HG_HITBOX_Y, -6);
set_hitbox_value(AT_DSTRONG, 4, HG_WIDTH, 78);
