...
set_window_value(AT_USPECIAL, 5, AG_WINDOW_VSPEED, -0.6);
...
set_hitbox_value(AT_USPECIAL, 1, HG_HIT_SFX, sound_get("hit_M2"));
...
set_hitbox_value(AT_USPECIAL, 2, HG_HIT_SFX, sound_get("hit_H2"));
...
set_hitbox_value(AT_USPECIAL, 3, HG_HEIGHT, 16);
...
set_hitbox_value(AT_USPECIAL, 3, HG_VISUAL_EFFECT, fire_hit_fx);
...
set_hitbox_value(AT_USPECIAL, 4, HG_HIT_SFX, sound_get("hit_W2"));
