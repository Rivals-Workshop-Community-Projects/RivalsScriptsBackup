...
set_hitbox_value(AT_UAIR, 2, HG_HEIGHT, 18);
...
set_hitbox_value(AT_UAIR, 3, HG_HITBOX_Y, -49);
...
set_hitbox_value(AT_UAIR, 4, HG_WIDTH, 12);
set_hitbox_value(AT_UAIR, 4, HG_HEIGHT, 12);
