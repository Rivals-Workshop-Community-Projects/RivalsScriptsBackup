...
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, asset_get("sfx_ori_seinhit_medium"));
...
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, asset_get("sfx_ori_seinhit_medium"));
...
set_hitbox_value(AT_UAIR, 3, HG_HIT_SFX, asset_get("sfx_ori_seinhit_medium"));
...
set_hitbox_value(AT_UAIR, 4, HG_WIDTH, 10);
set_hitbox_value(AT_UAIR, 4, HG_HEIGHT, 10);
set_hitbox_value(AT_UAIR, 4, HG_PRIORITY, 1);
set_hitbox_value(AT_UAIR, 4, HG_DAMAGE, 8);
set_hitbox_value(AT_UAIR, 4, HG_ANGLE, 230);
