...
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, asset_get("sfx_shovel_hit_light2"));
...
set_hitbox_value(AT_NAIR, 4, HG_HITBOX_X, 3);
set_hitbox_value(AT_NAIR, 4, HG_HITBOX_Y, -21);
...
set_hitbox_value(AT_NAIR, 5, HG_WIDTH, 56);
