...
set_hitbox_value(AT_DATTACK, 4, HG_WINDOW_CREATION_FRAME, 16);
...
set_hitbox_value(AT_DATTACK, 5, HG_WINDOW_CREATION_FRAME, 20);
set_hitbox_value(AT_DATTACK, 5, HG_LIFETIME, 2);
set_hitbox_value(AT_DATTACK, 5, HG_HITBOX_X, 24);
set_hitbox_value(AT_DATTACK, 5, HG_HITBOX_Y, -26);
...
set_hitbox_value(AT_DATTACK, 5, HG_HIT_SFX, asset_get("sfx_shovel_hit_med2"));