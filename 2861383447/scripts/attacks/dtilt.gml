...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, asset_get("sfx_absa_jab2"));
...
set_window_value(AT_DTILT, 3, AG_WINDOW_LENGTH, 8); // 10
...
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, asset_get("sfx_clairen_tip_weak"));