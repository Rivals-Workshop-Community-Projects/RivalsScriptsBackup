...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_absa_kickhit"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, asset_get("sfx_clairen_tip_med"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, asset_get("sfx_clairen_tip_med"));
