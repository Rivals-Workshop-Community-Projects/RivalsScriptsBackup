...
set_hitbox_value(AT_USPECIAL, 2, HG_HITSTUN_MULTIPLIER, 0.7);
...
set_hitbox_value(AT_USPECIAL, 4, HG_KNOCKBACK_SCALING, .35);
...
set_hitbox_value(AT_USPECIAL, 5, HG_DAMAGE, 6); // 8
...
set_hitbox_value(AT_USPECIAL, 5, HG_FORCE_FLINCH, 2);
