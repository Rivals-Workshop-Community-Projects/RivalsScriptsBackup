...
if (state == PS_ATTACK_GROUND || state == PS_ATTACK_AIR){
	...
	case 46:
		if (window == 1)
		draw_sprite_ext(sprite_get("evidence"), evidence[evidence_slot][0], x + 14 * spr_dir, y - 20, 1, 1, 0, c_white, 1);
	break;
	}
}
shader_end();
...
// }
// if (object_index != oTestPlayer) && (!is_nana){
...
// draw_sprite_ext(sprite_get("elec_meterfull"), animtimer_2, x, y - (char_height + 28), 1, 1, 0, c_white, 1);
// }
