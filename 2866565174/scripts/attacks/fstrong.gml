...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_spin"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_ANGLE_FLIPPER, 1);
...
set_hitbox_value(AT_FSTRONG, 2, HG_LIFETIME, 15);
...
set_hitbox_value(AT_FSTRONG, 2, HG_ANGLE, 125);
...
set_hitbox_value(AT_FSTRONG, 3, HG_ANGLE_FLIPPER, 1);
