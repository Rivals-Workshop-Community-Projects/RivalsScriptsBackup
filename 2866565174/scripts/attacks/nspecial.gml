...
set_hitbox_value(AT_NSPECIAL, 1, HG_HITBOX_Y, -500);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("nspecial_voltage1"));
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("nspecial_voltage1"));
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_COLLISION_SPRITE, sprite_get("nspecial_voltage1"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_VSPEED, 20);
