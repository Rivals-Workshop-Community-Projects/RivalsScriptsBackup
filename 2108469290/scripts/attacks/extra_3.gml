set_attack_value(AT_EXTRA_3, AG_SPRITE, sprite_get("fspecial2"));
...
set_window_value(AT_EXTRA_3, 1, AG_WINDOW_SFX_FRAME, 15);
...
set_window_value(AT_EXTRA_3, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, .6);
set_window_value(AT_EXTRA_3, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .8);
...
set_window_value(AT_EXTRA_3, 2, AG_WINDOW_HSPEED, 30);
...
set_window_value(AT_EXTRA_3, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, .4);
set_window_value(AT_EXTRA_3, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .5);


set_window_value(AT_EXTRA_3, 4, AG_WINDOW_TYPE, 7);
...
set_window_value(AT_EXTRA_3, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, .4);
set_window_value(AT_EXTRA_3, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, .5);
...
set_hitbox_value(AT_EXTRA_3, 1, HG_LIFETIME, 18);
set_hitbox_value(AT_EXTRA_3, 1, HG_HITBOX_X, 3);
...
set_hitbox_value(AT_EXTRA_3, 1, HG_HITSTUN_MULTIPLIER, .4);
set_hitbox_value(AT_EXTRA_3, 1, HG_VISUAL_EFFECT, 303);
set_hitbox_value(AT_EXTRA_3, 1, HG_SDI_MULTIPLIER, 0.1);
