...
set_window_value(AT_FTILT, 3, AG_WINDOW_HAS_WHIFFLAG, 8);
...
set_hitbox_value(AT_FTILT, 3, HG_WIDTH, 98);
...
set_hitbox_value(AT_FTILT, 3, HG_BASE_KNOCKBACK, 7.5);
...
set_hitbox_value(AT_FTILT, 4, HG_HITBOX_X, 25);
...
set_hitbox_value(AT_FTILT, 4, HG_BASE_KNOCKBACK, 8.5);
...
set_hitbox_value(AT_FTILT, 4, HG_EXTRA_CAMERA_SHAKE, 2);
