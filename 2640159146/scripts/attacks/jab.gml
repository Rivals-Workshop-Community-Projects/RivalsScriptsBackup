...
set_hitbox_value(AT_JAB, 1, HG_LIFETIME, 7);
...
set_hitbox_value(AT_JAB, 6, HG_WINDOW_CREATION_FRAME, 4);
set_hitbox_value(AT_JAB, 6, HG_LIFETIME, 4);
set_hitbox_value(AT_JAB, 6, HG_HITBOX_X, -24);
set_hitbox_value(AT_JAB, 6, HG_HITBOX_Y, -44);
set_hitbox_value(AT_JAB, 6, HG_WIDTH, 44);
