...
// skin
set_color_profile_slot( 0, 0, 40, 80, 82 );
set_color_profile_slot_range( 0, 1, 1, 1 );

// claws
set_color_profile_slot( 0, 1, 0, 255, 117 );
set_color_profile_slot_range( 1, 149, 101, 36 );

// crystal
set_color_profile_slot( 0, 2, 80, 255, 190 );
set_color_profile_slot_range( 2, 2, 57, 64 );
