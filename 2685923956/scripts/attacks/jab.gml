...
//j1_hold
set_window_value(AT_JAB, 3, AG_WINDOW_LENGTH, 2);//4
...
//j3_rec
set_window_value(AT_JAB, 14, AG_WINDOW_LENGTH, 10);//16
...
set_hitbox_value(AT_JAB, 3, HG_WIDTH, 78);//60
set_hitbox_value(AT_JAB, 3, HG_HEIGHT, 85);
set_hitbox_value(AT_JAB, 3, HG_DAMAGE, 1);
set_hitbox_value(AT_JAB, 3, HG_ANGLE, 95);
