...
set_attack_value(AT_FSTRONG, AG_LANDING_LAG, 20);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_X, 51);//38
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_Y, -38);
set_hitbox_value(AT_FSTRONG, 1, HG_WIDTH, 70);//70
set_hitbox_value(AT_FSTRONG, 1, HG_HEIGHT, 62);//68
...
set_hitbox_value(AT_FSTRONG, 1, HG_KNOCKBACK_SCALING, 1);//0.8
set_hitbox_value(AT_FSTRONG, 1, HG_BASE_HITPAUSE, 9);//8
set_hitbox_value(AT_FSTRONG, 1, HG_HITPAUSE_SCALING, 0.9);//0.8
