...
set_hitbox_value(AT_DTILT, 5, HG_HITBOX_Y, -26);
set_hitbox_value(AT_DTILT, 5, HG_WIDTH, 93);
...
set_hitbox_value(AT_DTILT, 5, HG_KNOCKBACK_SCALING, 0.7);//0.4
set_hitbox_value(AT_DTILT, 5, HG_BASE_HITPAUSE, 8);//6
set_hitbox_value(AT_DTILT, 5, HG_HITPAUSE_SCALING, 0.6);//0.5
