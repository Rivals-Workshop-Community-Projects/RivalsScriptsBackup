...
set_window_value(AT_USTRONG, 4, AG_WINDOW_SFX, asset_get("sfx_waveland_wra"));
...
set_hitbox_value(AT_USTRONG, 1, HG_ANGLE, 90);//80s
set_hitbox_value(AT_USTRONG, 1, HG_BASE_KNOCKBACK, 8);//7
set_hitbox_value(AT_USTRONG, 1, HG_KNOCKBACK_SCALING, 1.0);//1.1
set_hitbox_value(AT_USTRONG, 1, HG_BASE_HITPAUSE, 9);//8
...
set_hitbox_value(AT_USTRONG, 2, HG_LIFETIME, 9);
...
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_Y, -29);
set_hitbox_value(AT_USTRONG, 3, HG_WINDOW, 5);
set_hitbox_value(AT_USTRONG, 3, HG_LIFETIME, 3);
set_hitbox_value(AT_USTRONG, 3, HG_WIDTH, 73);
...
set_hitbox_value(AT_USTRONG, 3, HG_HITPAUSE_SCALING, 0.85);
set_hitbox_value(AT_USTRONG, 3, HG_VISUAL_EFFECT, 110);
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, sound_get("hit_big_1")); //yes for both of these
