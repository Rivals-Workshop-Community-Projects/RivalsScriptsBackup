...
set_attack_value(AT_FAIR, AG_LANDING_LAG, 9);//12
...
set_hitbox_value(AT_FAIR, 3, HG_HITBOX_X, 53);//63
...
set_hitbox_value(AT_FAIR, 3, HG_ANGLE, 50);//60
...
set_hitbox_value(AT_FAIR, 3, HG_KNOCKBACK_SCALING, 0.6);//0.5//0.8
