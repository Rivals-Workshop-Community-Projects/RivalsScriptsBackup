...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, sound_get("SW_Sword01"));
...
set_window_value(AT_FTILT, 3, AG_WINDOW_SFX, sound_get("SW_Livart01"));
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, asset_get("sfx_clairen_tip_weak"));
...
set_hitbox_value(AT_FTILT, 4, HG_HITBOX_X, 50);
set_hitbox_value(AT_FTILT, 4, HG_HITBOX_Y, -30);
set_hitbox_value(AT_FTILT, 4, HG_WIDTH, 90);
...
set_hitbox_value(AT_FTILT, 4, HG_HIT_SFX, asset_get("sfx_clairen_tip_med"));
...
set_hitbox_value(AT_FTILT, 3, HG_BASE_KNOCKBACK, 7);//6
set_hitbox_value(AT_FTILT, 3, HG_KNOCKBACK_SCALING, 0.75);//0.65
set_hitbox_value(AT_FTILT, 3, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_FTILT, 3, HG_HITPAUSE_SCALING, .35);
set_hitbox_value(AT_FTILT, 3, HG_HIT_SFX, asset_get("sfx_ice_shatter"));
