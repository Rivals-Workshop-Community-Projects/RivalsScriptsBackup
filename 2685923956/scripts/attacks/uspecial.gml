...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, sound_get("wish_1"));
...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX, sound_get("wish_2"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_LIFETIME, 4);//6
...
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT, 113);
