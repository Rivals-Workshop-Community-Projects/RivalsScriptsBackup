...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_ice_chain"));
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_LENGTH, 34);
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_flare_razer"));
