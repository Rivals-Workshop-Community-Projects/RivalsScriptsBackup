...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_LENGTH, 100);
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, .04);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_FINAL_BASE_KNOCKBACK, 5);