...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("aerial"));
...
set_hitbox_value(AT_BAIR, 1, HG_TECHABLE, 2);
...
set_hitbox_value(AT_BAIR, 3, HG_WINDOW_CREATION_FRAME, 10);
set_hitbox_value(AT_BAIR, 3, HG_LIFETIME, 3);
set_hitbox_value(AT_BAIR, 3, HG_TECHABLE, 2);
...
set_hitbox_value(AT_BAIR, 4, HG_WIDTH, 75);
...
set_hitbox_value(AT_BAIR, 4, HG_HIT_SFX, asset_get("sfx_bite"));
...
set_hitbox_value(AT_BAIR, 5, HG_HITBOX_X, -55);
set_hitbox_value(AT_BAIR, 5, HG_HITBOX_Y, -20);
set_hitbox_value(AT_BAIR, 5, HG_WIDTH, 75);
...
set_hitbox_value(AT_BAIR, 5, HG_VISUAL_EFFECT_Y_OFFSET, -20);
set_hitbox_value(AT_BAIR, 5, HG_HIT_SFX, asset_get("sfx_bite"));
