...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, sound_get("dtilt2"));
...
set_window_value(AT_FTILT, 2, AG_WINDOW_SFX, sound_get("utilt"));
...
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT, 135);
...
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT, 135);
