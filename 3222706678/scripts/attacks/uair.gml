...
set_window_value(AT_UAIR, 3, AG_WINDOW_SFX, sound_get("uair"));
...
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT, 14);
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, -16);
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, asset_get("sfx_swipe_medium1"));
...
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT, 14);
...
set_hitbox_value(AT_UAIR, 3, HG_HITBOX_Y, -110);
set_hitbox_value(AT_UAIR, 3, HG_WIDTH, 100);
set_hitbox_value(AT_UAIR, 3, HG_HEIGHT, 120);
set_hitbox_value(AT_UAIR, 3, HG_SHAPE, 2);
set_hitbox_value(AT_UAIR, 3, HG_PRIORITY, 1);
set_hitbox_value(AT_UAIR, 3, HG_GROUNDEDNESS, 2);
set_hitbox_value(AT_UAIR, 3, HG_FORCE_FLINCH, 0);
set_hitbox_value(AT_UAIR, 3, HG_THROWS_ROCK, 2);
set_hitbox_value(AT_UAIR, 3, HG_IGNORES_PROJECTILES, 1);
set_hitbox_value(AT_UAIR, 3, HG_HITSTUN_MULTIPLIER, -2);
...
set_hitbox_value(AT_UAIR, 3, HG_HIT_SFX, 0);
...
set_hitbox_value(AT_UAIR, 4, HG_HITBOX_Y, -115);
set_hitbox_value(AT_UAIR, 4, HG_WIDTH, 110);
set_hitbox_value(AT_UAIR, 4, HG_HEIGHT, 155);
...
set_hitbox_value(AT_UAIR, 4, HG_FORCE_FLINCH, 0);
set_hitbox_value(AT_UAIR, 4, HG_THROWS_ROCK, 2);
set_hitbox_value(AT_UAIR, 4, HG_IGNORES_PROJECTILES, 1);
set_hitbox_value(AT_UAIR, 4, HG_HITSTUN_MULTIPLIER, -2);
set_hitbox_value(AT_UAIR, 4, HG_DAMAGE, 0);
set_hitbox_value(AT_UAIR, 4, HG_ANGLE, 80);
set_hitbox_value(AT_UAIR, 4, HG_BASE_KNOCKBACK, 11);
...
set_hitbox_value(AT_UAIR, 4, HG_HIT_SFX, 0);