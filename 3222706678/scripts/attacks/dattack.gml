...
set_window_value(AT_DATTACK, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, 99);
set_window_value(AT_DATTACK, 2, AG_WINDOW_HSPEED, 40);
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 99);
set_window_value(AT_DATTACK, 3, AG_WINDOW_HSPEED, 45);
