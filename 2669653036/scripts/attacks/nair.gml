...
set_attack_value(AT_NAIR, AG_MUNO_ATTACK_COOLDOWN, 10);

set_window_value(AT_NAIR, 1, AG_WINDOW_LENGTH, 6); // 4
set_window_value(AT_NAIR, 1, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_NAIR, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, sound_get("Fire-Spin-turn-damage"));
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX_FRAME, 1); // 2
...
set_hitbox_value(AT_NAIR, 3, HG_KNOCKBACK_SCALING, .35); // 2
