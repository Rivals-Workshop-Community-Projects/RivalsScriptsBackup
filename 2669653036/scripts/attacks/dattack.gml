...
set_window_value(AT_DATTACK, 2, AG_WINDOW_ANIM_FRAMES, 4); // 6
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, .7);
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .4);
set_window_value(AT_DATTACK, 3, AG_WINDOW_HAS_WHIFFLAG, 1);

set_window_value(AT_DATTACK, 4, AG_WINDOW_LENGTH, 8); // 7, then 10
set_window_value(AT_DATTACK, 4, AG_WINDOW_ANIM_FRAMES, 2); // 2
set_window_value(AT_DATTACK, 4, AG_WINDOW_ANIM_FRAME_START, 8); // 7
...
set_hitbox_value(AT_DATTACK, 1, HG_WIDTH, 64); // 64
...
set_hitbox_value(AT_DATTACK, 2, HG_WIDTH, 80); // 64
set_hitbox_value(AT_DATTACK, 2, HG_HEIGHT, 48); // 64
set_hitbox_value(AT_DATTACK, 2, HG_PRIORITY, 2);
set_hitbox_value(AT_DATTACK, 2, HG_DAMAGE, 4); // 6
