...
//=================OTHER=================
//  hurt sprites
add_sprites("hurt","hurtground","bighurt","hurt_crystalized");
...
// f_sprite
//where f is the name of the skin, and sprite is the name of the sprite (as supplied above)
add_skin("f");
...
//As an example:
// if (get_player_color(player) == 15) set_skin("f");
//This will set the skin to the skin "f" when the player is using the 16th color palette.
