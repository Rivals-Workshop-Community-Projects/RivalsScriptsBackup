...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, sound_get("swipe_Er02"));
...
set_window_value(AT_DTILT, 3, AG_WINDOW_LENGTH, 7); // Recomendation, would match olympia dtilt frame data (end lag of 10)
...
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT, fx_gouge);
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_Y_OFFSET, 19);
