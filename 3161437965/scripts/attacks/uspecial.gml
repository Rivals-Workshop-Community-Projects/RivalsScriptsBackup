...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_ice_back_air"));
...
//Strong Hit
set_hitbox_value(AT_USPECIAL, 1, HG_WINDOW_CREATION_FRAME, 7);
...
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT, fx_gouge);
