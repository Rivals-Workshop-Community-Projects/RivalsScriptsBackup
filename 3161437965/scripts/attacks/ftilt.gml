...
set_window_value(AT_FTILT, 2, AG_WINDOW_SFX, sound_get("swipe_Er02"));
...
set_hitbox_value(AT_FTILT, 1, HG_ANGLE, 75); //90
set_hitbox_value(AT_FTILT, 1, HG_BASE_KNOCKBACK, 4); //7
...
set_hitbox_value(AT_FTILT, 2, HG_KNOCKBACK_SCALING, .50);
