...
set_attack_value(AT_EXTRA_2, AG_SPRITE, sprite_get("fair_2"));
...
set_attack_value(AT_EXTRA_2, AG_HURTBOX_SPRITE, sprite_get("fair_2_hurt"));
...
set_window_value(AT_EXTRA_2, 1, AG_WINDOW_SFX_FRAME, 7);
...
set_hitbox_value(AT_EXTRA_2, 1, HG_HEIGHT, 68);
...
set_hitbox_value(AT_EXTRA_2, 1, HG_HITPAUSE_SCALING, 0.35);
