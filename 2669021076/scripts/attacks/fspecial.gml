...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_ice_chain"));
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, air_friction - 0.015);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_HITBOX_Y, -58);
set_hitbox_value(AT_FSPECIAL, 3, HG_WIDTH, 58);
