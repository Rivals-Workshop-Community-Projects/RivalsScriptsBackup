...
set_window_value(AT_NSPECIAL_2, 1, AG_WINDOW_SFX, asset_get("sfx_absa_cloud_place"));
...
set_window_value(AT_NSPECIAL_2, 2, AG_WINDOW_SFX, asset_get("sfx_bubblepop"));
set_window_value(AT_NSPECIAL_2, 2, AG_WINDOW_SFX_FRAME, 24);
...
set_hitbox_value(AT_NSPECIAL_2, 1, HG_VISUAL_EFFECT, 10); // light + dark water directional
