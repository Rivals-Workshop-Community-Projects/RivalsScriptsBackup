...
set_attack_value(AT_EXTRA_1, AG_SPRITE, sprite_get("uair_2"));
...
set_attack_value(AT_EXTRA_1, AG_HURTBOX_SPRITE, sprite_get("uair_2_hurt"));
...
set_hitbox_value(AT_EXTRA_1, 1, HG_HITBOX_Y, -60);
set_hitbox_value(AT_EXTRA_1, 1, HG_WIDTH, 74);
set_hitbox_value(AT_EXTRA_1, 1, HG_HEIGHT, 34);
