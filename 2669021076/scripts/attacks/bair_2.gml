...
set_attack_value(AT_EXTRA_3, AG_SPRITE, sprite_get("bair_2"));
set_attack_value(AT_EXTRA_3, AG_NUM_WINDOWS, 3);
set_attack_value(AT_EXTRA_3, AG_HAS_LANDING_LAG, 1);
set_attack_value(AT_EXTRA_3, AG_LANDING_LAG, 4);
set_attack_value(AT_EXTRA_3, AG_HURTBOX_SPRITE, sprite_get("bair_2_hurt"));
...
set_hitbox_value(AT_EXTRA_3, 1, HG_HEIGHT, 42);
set_hitbox_value(AT_EXTRA_3, 1, HG_PRIORITY, 2);
set_hitbox_value(AT_EXTRA_3, 1, HG_DAMAGE, 7);
set_hitbox_value(AT_EXTRA_3, 1, HG_ANGLE, 130);
