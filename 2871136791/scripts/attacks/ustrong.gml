...
set_window_value(AT_USTRONG, 4, AG_WINDOW_SFX, asset_get("mfx_logo_shing"));
...
set_window_value(AT_USTRONG, 6, AG_WINDOW_LENGTH, 35);
...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("gunshow"));
...
set_hitbox_value(AT_USTRONG, 2, HG_HEIGHT, 116);
set_hitbox_value(AT_USTRONG, 2, HG_SHAPE, 0);
set_hitbox_value(AT_USTRONG, 2, HG_PRIORITY, 8);
set_hitbox_value(AT_USTRONG, 2, HG_DAMAGE, 20);
