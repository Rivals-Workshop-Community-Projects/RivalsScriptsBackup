...
set_window_value(AT_USTRONG, 5, AG_WINDOW_LENGTH, 26);
set_window_value(AT_USTRONG, 5, AG_WINDOW_ANIM_FRAMES, 13);
...
set_hitbox_value(AT_USTRONG, 1, HG_MUNO_HITBOX_NAME, "Scoop Hitbox");
...
set_hitbox_value(AT_USTRONG, 2, HG_MUNO_HITBOX_NAME, "Scoop Hitbox");
set_hitbox_value(AT_USTRONG, 2, HG_WINDOW, 3);
set_hitbox_value(AT_USTRONG, 2, HG_LIFETIME, 3);
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_X, 20);
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_Y, -38);
...
set_hitbox_value(AT_USTRONG, 3, HG_MUNO_HITBOX_NAME, "Main Hitbox");
...
set_hitbox_value(AT_USTRONG, 3, HG_HIT_LOCKOUT, 14);