...
set_attack_value(AT_DSPECIAL, AG_MUNO_ATTACK_NAME, "DSpecial: Operator Onslaught");
set_attack_value(AT_DSPECIAL, AG_MUNO_ATTACK_MISC, "Creates an Operator underneath you. Grants some vertical height when used.");
