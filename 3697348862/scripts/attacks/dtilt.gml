...
set_hitbox_value(AT_DTILT, 2, HG_MUNO_HITBOX_NAME, "Upper Hitbox");
...
set_hitbox_value(AT_DTILT, 2, HG_HITPAUSE_SCALING, .7);	// i didnt do this intentionally I SWEAR ON YOUR SOUL
