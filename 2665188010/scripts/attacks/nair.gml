...
for(i = 1; i <= 3; i++){
    ...
    set_hitbox_value(AT_NAIR, i, HG_HITBOX_Y, -28);
    set_hitbox_value(AT_NAIR, i, HG_WIDTH, 66);
    set_hitbox_value(AT_NAIR, i, HG_HEIGHT, 66);
    set_hitbox_value(AT_NAIR, i, HG_PRIORITY, 1);
    set_hitbox_value(AT_NAIR, i, HG_DAMAGE, 2);
    set_hitbox_value(AT_NAIR, i, HG_ANGLE, 45);
    set_hitbox_value(AT_NAIR, i, HG_ANGLE_FLIPPER, 9);
    set_hitbox_value(AT_NAIR, i, HG_BASE_KNOCKBACK, 5);
    set_hitbox_value(AT_NAIR, i, HG_BASE_HITPAUSE, 2);
