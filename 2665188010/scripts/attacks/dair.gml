...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, asset_get("sfx_clairen_nspecial_grab_miss"));
...
set_hitbox_value(AT_DAIR, 1, HG_HITBOX_Y, 21);
...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, 20); //Lightning Small
...
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT, 21); //Lightning Small
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, asset_get("sfx_absa_singlezap1"));
...
set_hitbox_value(AT_DAIR, 3, HG_VISUAL_EFFECT, 197); //Lightning Medium
set_hitbox_value(AT_DAIR, 3, HG_HIT_SFX, asset_get("sfx_absa_singlezap2"));
