...
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT_Y_OFFSET, 5);
...
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT, HFX_ORI_BLUE_SMALL);
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT_X_OFFSET, 9);
