...
for(i = 2; i <= 3; i++){
    ...
    set_hitbox_value(AT_NSPECIAL, i, HG_BASE_HITPAUSE, 5);
    set_hitbox_value(AT_NSPECIAL, i, HG_HITPAUSE_SCALING, 0.7);
    set_hitbox_value(AT_NSPECIAL, i, HG_VISUAL_EFFECT, 67);
    set_hitbox_value(AT_NSPECIAL, i, HG_VISUAL_EFFECT_X_OFFSET, 48);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_VISUAL_EFFECT_X_OFFSET, -48);