...
set_hitbox_value(this_atk, 1, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(this_atk, 1, HG_BASE_HITPAUSE, 6);
set_hitbox_value(this_atk, 1, HG_EXTRA_HITPAUSE, 2);
...
set_hitbox_value(this_atk, 1, HG_TECHABLE, 1); //can't ground tech
...
set_hitbox_value(this_atk, 2, HG_HITBOX_X, 20);
set_hitbox_value(this_atk, 2, HG_HITBOX_Y, -34);
set_hitbox_value(this_atk, 2, HG_WIDTH, 56);
set_hitbox_value(this_atk, 2, HG_HEIGHT, 68);
set_hitbox_value(this_atk, 2, HG_SHAPE, 2);
set_hitbox_value(this_atk, 2, HG_PRIORITY, 1);
set_hitbox_value(this_atk, 2, HG_ANGLE, 85);
set_hitbox_value(this_atk, 2, HG_BASE_KNOCKBACK, 9);
set_hitbox_value(this_atk, 2, HG_KNOCKBACK_SCALING, 0.5);
set_hitbox_value(this_atk, 2, HG_BASE_HITPAUSE, 7);
set_hitbox_value(this_atk, 2, HG_HITPAUSE_SCALING, 0.5);
set_hitbox_value(this_atk, 2, HG_HIT_SFX, asset_get("sfx_blow_medium1"));
set_hitbox_value(this_atk, 2, HG_HITBOX_GROUP, 2);
set_hitbox_value(this_atk, 2, HG_DRIFT_MULTIPLIER, 1);
set_hitbox_value(this_atk, 2, HG_SDI_MULTIPLIER, 1);

/*

set_num_hitboxes(this_atk, 7);
set_hitbox_value(this_atk, 1, HG_HITBOX_TYPE, 1);
set_hitbox_value(this_atk, 1, HG_WINDOW, 2);
set_hitbox_value(this_atk, 1, HG_WINDOW_CREATION_FRAME, 0);
...
set_hitbox_value(this_atk, 1, HG_DAMAGE, 4);
set_hitbox_value(this_atk, 1, HG_ANGLE, 45);
set_hitbox_value(this_atk, 1, HG_BASE_KNOCKBACK, 10);
...
set_hitbox_value(this_atk, 2, HG_WINDOW_CREATION_FRAME, 1);
set_hitbox_value(this_atk, 2, HG_LIFETIME, 1);
set_hitbox_value(this_atk, 2, HG_HITBOX_X, 20);
set_hitbox_value(this_atk, 2, HG_HITBOX_Y, -10);
set_hitbox_value(this_atk, 2, HG_WIDTH, 61);
...
set_hitbox_value(this_atk, 3, HG_WINDOW_CREATION_FRAME, 2);
...
set_hitbox_value(this_atk, 3, HG_BASE_KNOCKBACK, 8);
...
set_hitbox_value(this_atk, 4, HG_WINDOW_CREATION_FRAME, 3);
...
set_hitbox_value(this_atk, 4, HG_BASE_KNOCKBACK, 7);
...
set_hitbox_value(this_atk, 5, HG_WINDOW_CREATION_FRAME, 4);
...
set_hitbox_value(this_atk, 5, HG_BASE_KNOCKBACK, 6);
...
set_hitbox_value(this_atk, 6, HG_WINDOW_CREATION_FRAME, 5);
...
set_hitbox_value(this_atk, 6, HG_BASE_KNOCKBACK, 5);
...
set_hitbox_value(this_atk, 7, HG_WINDOW, 3);
set_hitbox_value(this_atk, 7, HG_WINDOW_CREATION_FRAME, 0);
set_hitbox_value(this_atk, 7, HG_LIFETIME, 2);
set_hitbox_value(this_atk, 7, HG_HITBOX_X, 20);
set_hitbox_value(this_atk, 7, HG_HITBOX_Y, -30);
set_hitbox_value(this_atk, 7, HG_WIDTH, 30);
set_hitbox_value(this_atk, 7, HG_HEIGHT, 78);
set_hitbox_value(this_atk, 7, HG_SHAPE, 2);
set_hitbox_value(this_atk, 7, HG_PRIORITY, 1);
set_hitbox_value(this_atk, 7, HG_ANGLE, 80);
set_hitbox_value(this_atk, 7, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(this_atk, 7, HG_KNOCKBACK_SCALING, 0.5);
set_hitbox_value(this_atk, 7, HG_BASE_HITPAUSE, 7);
set_hitbox_value(this_atk, 7, HG_HITPAUSE_SCALING, 0.5);
set_hitbox_value(this_atk, 7, HG_HIT_SFX, asset_get("sfx_blow_medium1"));
set_hitbox_value(this_atk, 7, HG_HITBOX_GROUP, 2);
set_hitbox_value(this_atk, 7, HG_DRIFT_MULTIPLIER, 1);
set_hitbox_value(this_atk, 7, HG_SDI_MULTIPLIER, 1);