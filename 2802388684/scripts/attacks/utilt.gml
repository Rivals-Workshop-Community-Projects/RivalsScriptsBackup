...
set_hitbox_value(this_atk, 1, HG_KNOCKBACK_SCALING, 1.125);
set_hitbox_value(this_atk, 1, HG_BASE_HITPAUSE, 5);
set_hitbox_value(this_atk, 1, HG_HITPAUSE_SCALING, 1.1);
set_hitbox_value(this_atk, 1, HG_DRIFT_MULTIPLIER, 0);
set_hitbox_value(this_atk, 1, HG_SDI_MULTIPLIER, 0);
