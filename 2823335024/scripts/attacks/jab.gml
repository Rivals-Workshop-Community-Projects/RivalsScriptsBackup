...
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, sound_get("swing_1"));
...
set_window_value(AT_JAB, 4, AG_WINDOW_SFX, sound_get("swing_3"));
...
set_hitbox_value(AT_JAB, 1, HG_WIDTH, 91);
...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("hit_medium_1"));

set_hitbox_value(AT_JAB, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_JAB, 2, HG_HITBOX_X, -4);
set_hitbox_value(AT_JAB, 2, HG_HITBOX_Y, -35);
set_hitbox_value(AT_JAB, 2, HG_WINDOW, 5);
set_hitbox_value(AT_JAB, 2, HG_LIFETIME, 3);
set_hitbox_value(AT_JAB, 2, HG_WIDTH, 132);
set_hitbox_value(AT_JAB, 2, HG_HEIGHT, 51);
...
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, sound_get("hit_medium_2"));
