...
set_hitbox_value(AT_USTRONG, 1, HG_PROJECTILE_VSPEED, -7);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, HFX_MOL_EXPLODE_HIT);
set_hitbox_value(AT_USTRONG, 1, HG_PROJECTILE_DESTROY_EFFECT, HFX_MOL_EXPLODE_HIT);
...
set_hitbox_value(AT_USTRONG, 2, HG_KNOCKBACK_SCALING, 0.95);
