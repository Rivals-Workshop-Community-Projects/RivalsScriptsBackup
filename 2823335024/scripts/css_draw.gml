...
if (!variable_instance_exists(id,"ae") || ye == true){
    ...
    ce[9,1] = "Splatoon"
    ce[10,0] = make_color_rgb(255, 179, 5)
    ce[10,3] = make_color_rgb(169, 45, 179)
    ce[10,1] = "Halloween"
    ce[11,0] = make_color_rgb(100, 218, 228)
    ce[11,3] = make_color_rgb(117, 229, 161)
    ce[11,1] = "New Horizons"  
    ce[12,0] = make_color_rgb(55, 57, 180)
    ce[12,3] = make_color_rgb(20, 93, 221)
    ce[12,1] = "Skyward Sword" 
    ce[13,0] = make_color_rgb(245, 215, 73)
    ce[13,3] = make_color_rgb(202, 158, 75)
    ce[13,1] = "Let's Go" 
    ce[14,0] = make_color_rgb(0, 114, 195)
    ce[14,3] = make_color_rgb(253, 209, 50)
    ce[14,1] = "Fortnite (yea.)" 
    ce[15,0] = make_color_rgb(222, 29, 40)
    ce[15,3] = make_color_rgb(222, 29, 40)
    ce[15,1] = "Mario" 
    ce[16,0] = make_color_rgb(26, 171, 60)
    ce[16,3] = make_color_rgb(26, 171, 60)
    ce[16,1] = "Luigi" 
    ce[17,0] = make_color_rgb(70, 70, 72)
    ce[17,3] = make_color_rgb(104, 194, 220)
    ce[17,1] = "Wii Fit Trainer" 
    ce[18,0] = make_color_rgb(253, 186, 0)
    ce[18,3] = make_color_rgb(255, 225, 101)
    ce[18,1] = "My Nintendo Gold" 
    ce[19,0] = make_color_rgb(189, 164, 122)
    ce[19,3] = make_color_rgb(189, 117, 83)
    ce[19,1] = "Ring Fit" 
    ce[20,0] = make_color_rgb(251, 105, 38)
    ce[20,3] = make_color_rgb(251, 105, 38)
    ce[20,1] = "Tipp" 
    ce[21,0] = make_color_rgb(0, 56, 168)
    ce[21,3] = make_color_rgb(214, 2, 112)
    ce[21,1] = "Bichromatic" 
    ce[22,0] = make_color_rgb(255, 125, 202)
    ce[22,3] = make_color_rgb(115, 255, 220)
    ce[22,1] = "Transistor" 
    ce[23,0] = make_color_rgb(158, 16, 32)
    ce[23,3] = make_color_rgb(45, 46, 51)
    ce[23,1] = "Virtual Girl" 
    ce[24,0] = make_color_rgb(214, 240, 245)
    ce[24,3] = make_color_rgb(214, 240, 245)
    ce[24,1] = "Reckless" 
