...
set_hitbox_value(AT_USPECIAL, 1, HG_KNOCKBACK_SCALING, .01);
...
set_hitbox_value(AT_USPECIAL, 2, HG_KNOCKBACK_SCALING, .01);
...
set_hitbox_value(AT_USPECIAL, 4, HG_KNOCKBACK_SCALING, .01);
