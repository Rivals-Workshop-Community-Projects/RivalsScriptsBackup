...
set_hitbox_value(AT_USPECIAL, 1, HG_DRIFT_MULTIPLIER, .05);
set_hitbox_value(AT_USPECIAL, 1, HG_SDI_MULTIPLIER, .05);
...
set_hitbox_value(AT_USPECIAL, 2, HG_WIDTH, 61);
set_hitbox_value(AT_USPECIAL, 2, HG_HEIGHT, 77);
set_hitbox_value(AT_USPECIAL, 2, HG_SHAPE, 0);
set_hitbox_value(AT_USPECIAL, 2, HG_PRIORITY, 1);
set_hitbox_value(AT_USPECIAL, 2, HG_DAMAGE, 1);
set_hitbox_value(AT_USPECIAL, 2, HG_ANGLE, 75);
set_hitbox_value(AT_USPECIAL, 2, HG_DRIFT_MULTIPLIER, .05);
set_hitbox_value(AT_USPECIAL, 2, HG_SDI_MULTIPLIER, .05);
...
set_hitbox_value(AT_USPECIAL, 4, HG_HEIGHT, 77);
...
set_hitbox_value(AT_USPECIAL, 5, HG_KNOCKBACK_SCALING, .55);
