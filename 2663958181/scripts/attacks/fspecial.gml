...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sound_get("sfx_fspecial_start"));
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX_FRAME, 8);
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_CUSTOM_GRAVITY, .25);
...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_CUSTOM_GRAVITY, .25);
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_SFX, sound_get("sfx_fspecial_end"));
