...
set_hitbox_value(AT_DSTRONG, 1, HG_KNOCKBACK_SCALING, .05);
...
set_hitbox_value(AT_DSTRONG, 2, HG_KNOCKBACK_SCALING, .05);
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, 9);
...
set_hitbox_value(AT_DSTRONG, 3, HG_WIDTH, 148);
...
set_hitbox_value(AT_DSTRONG, 3, HG_HIT_SFX, asset_get("sfx_waterhit_heavy2"));
