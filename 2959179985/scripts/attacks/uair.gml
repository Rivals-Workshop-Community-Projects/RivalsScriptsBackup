...
set_window_value(AT_UAIR, 3, AG_WINDOW_GOTO, 10);
...
set_window_value(AT_UAIR, 4, AG_WINDOW_SFX_FRAME, 4);
...
set_window_value(AT_UAIR, 6, AG_WINDOW_ANIM_FRAME_START, 11);
...
set_window_value(AT_UAIR, 7, AG_WINDOW_HAS_WHIFFLAG, 4);
...
set_hitbox_value(AT_UAIR, 3, HG_HITBOX_Y, -15);
