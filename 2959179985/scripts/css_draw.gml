...
if (!variable_instance_exists(id,"ae") || ye == true){
    ...
    ce[0,0] = make_color_rgb(get_color_profile_slot_r(0, 2), get_color_profile_slot_g(0, 2), get_color_profile_slot_b(0, 2)) // "color preview square" color. can be any color!
    ce[0,1] = "" // the name of the alternate color.
    ...
    ce[1,1] = ""
    ce[1,2] = "Artoria Pendragon A.K.A Saber"
