...
set_window_value(AT_USTRONG, 1, AG_WINDOW_CUSTOM_GRAVITY, 0.5);
...
set_window_value(AT_USTRONG, 4, AG_WINDOW_CUSTOM_GRAVITY, 1.0);
...
set_hitbox_value(AT_USTRONG, 1, HG_FINAL_BASE_KNOCKBACK, 3);
