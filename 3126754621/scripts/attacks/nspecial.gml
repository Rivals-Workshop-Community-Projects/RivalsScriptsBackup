...
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, HFX_ELL_BOOM_RED);
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("ruby_proj"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_VISUAL_EFFECT, HFX_ELL_BOOM_RED);
