...
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, asset_get("sfx_shovel_hit_med2"));
...
set_hitbox_value(AT_BAIR, 4, HG_WINDOW, 0);
...
set_hitbox_value(AT_BAIR, 4, HG_VISUAL_EFFECT, HFX_MOL_BOOM_FLARE);
...
set_hitbox_value(AT_BAIR, 5, HG_KNOCKBACK_SCALING, 0.8);
...
set_hitbox_value(AT_BAIR, 5, HG_VISUAL_EFFECT, HFX_ELL_BOOM_BIG);
