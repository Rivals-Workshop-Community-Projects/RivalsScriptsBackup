...
//hold
set_window_value(AT_NAIR, 4, AG_WINDOW_LENGTH, 600);
...
set_hitbox_value(AT_NAIR, 2, HG_LIFETIME, 1000);
...
set_hitbox_value(AT_NAIR, 3, HG_WINDOW, 0);
...
set_hitbox_value(AT_NAIR, 4, HG_WINDOW, 0);
set_hitbox_value(AT_NAIR, 4, HG_WINDOW_CREATION_FRAME, 0);
set_hitbox_value(AT_NAIR, 4, HG_LIFETIME, 1000);
...
set_hitbox_value(AT_NAIR, 5, HG_WINDOW, 0);
...
set_hitbox_value(AT_NAIR, 5, HG_HITPAUSE_SCALING, 0.8);
set_hitbox_value(AT_NAIR, 5, HG_HIT_SFX, asset_get("sfx_blow_medium3"));
set_hitbox_value(AT_NAIR, 5, HG_VISUAL_EFFECT, HFX_MOL_BOOM_FLARE);
...
set_hitbox_value(AT_NAIR, 6, HG_WINDOW, 0);
set_hitbox_value(AT_NAIR, 6, HG_WINDOW_CREATION_FRAME, 0);
set_hitbox_value(AT_NAIR, 6, HG_LIFETIME, 1000);
...
set_hitbox_value(AT_NAIR, 6, HG_VISUAL_EFFECT, HFX_MOL_BOOM_FLARE);
set_hitbox_value(AT_NAIR, 6, HG_HITSTUN_MULTIPLIER, 0);
set_hitbox_value(AT_NAIR, 6, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_NAIR, 6, HG_EFFECT, 1);

//initial bomb
set_hitbox_value(AT_NAIR, 7, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_NAIR, 7, HG_WINDOW, 0);
...
set_hitbox_value(AT_NAIR, 7, HG_KNOCKBACK_SCALING, 0.4);
set_hitbox_value(AT_NAIR, 7, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_NAIR, 7, HG_HITPAUSE_SCALING, 0.8);
set_hitbox_value(AT_NAIR, 7, HG_HIT_SFX, asset_get("sfx_blow_heavy2"));
set_hitbox_value(AT_NAIR, 7, HG_VISUAL_EFFECT, HFX_ELL_BOOM_BIG);
...
set_hitbox_value(AT_NAIR, 8, HG_VISUAL_EFFECT, HFX_ELL_BOOM_BIG);
