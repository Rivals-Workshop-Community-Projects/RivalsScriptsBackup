...
set_window_value(AT_FAIR, 3, AG_WINDOW_ANIM_FRAMES, 9);
...
set_hitbox_value(AT_FAIR, 1, HG_HITBOX_X, 35);//33
set_hitbox_value(AT_FAIR, 1, HG_HITBOX_Y, -35);//-36
set_hitbox_value(AT_FAIR, 1, HG_WIDTH, 78);//87
set_hitbox_value(AT_FAIR, 1, HG_HEIGHT, 44);//51
...
set_hitbox_value(AT_FAIR, 1, HG_HITSTUN_MULTIPLIER, .75);
...
set_hitbox_value(AT_FAIR, 2, HG_HITBOX_X, 67);//33
set_hitbox_value(AT_FAIR, 2, HG_HITBOX_Y, -38);//-36
set_hitbox_value(AT_FAIR, 2, HG_WIDTH, 11);//87
set_hitbox_value(AT_FAIR, 2, HG_HEIGHT, 28);//51
...
set_hitbox_value(AT_FAIR, 2, HG_HITSTUN_MULTIPLIER, .75);
/*
