...
set_hitbox_value(AT_FTILT, 1, HG_WIDTH, 121);
...
set_hitbox_value(AT_FTILT, 3, HG_HITBOX_TYPE, 0);
...
set_hitbox_value(AT_FTILT, 3, HG_HITBOX_Y, -29);
set_hitbox_value(AT_FTILT, 3, HG_WIDTH, 62);
...
set_hitbox_value(AT_FTILT, 4, HG_HITBOX_TYPE, 0);
...
set_hitbox_value(AT_FTILT, 4, HG_HITBOX_Y, -37);
set_hitbox_value(AT_FTILT, 4, HG_WIDTH, 56);
set_hitbox_value(AT_FTILT, 4, HG_HEIGHT, 38);
set_hitbox_value(AT_FTILT, 4, HG_SHAPE, 0);
set_hitbox_value(AT_FTILT, 4, HG_PRIORITY, 1);
set_hitbox_value(AT_FTILT, 4, HG_DAMAGE, 5);
set_hitbox_value(AT_FTILT, 4, HG_ANGLE, 135);
set_hitbox_value(AT_FTILT, 4, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_FTILT, 4, HG_KNOCKBACK_SCALING, .65);
set_hitbox_value(AT_FTILT, 4, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_FTILT, 4, HG_HITPAUSE_SCALING, .65);
