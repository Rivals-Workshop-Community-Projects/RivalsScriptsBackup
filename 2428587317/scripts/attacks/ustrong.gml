...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_shovel_hit_heavy1"));
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX_FRAME, 1);

set_window_value(AT_USTRONG, 3, AG_WINDOW_LENGTH, 28);
set_window_value(AT_USTRONG, 3, AG_WINDOW_ANIM_FRAMES, 13);
...
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_Y, -39);
set_hitbox_value(AT_USTRONG, 1, HG_WIDTH, 92);
...
//set_hitbox_value(AT_USTRONG, 1, HG_KNOCKBACK_SCALING, .87);
...
set_hitbox_value(AT_USTRONG, 1, HG_LIFETIME, 5);//13 total
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_X, 0);
...
set_hitbox_value(AT_USTRONG, 2, HG_HEIGHT, 95);
