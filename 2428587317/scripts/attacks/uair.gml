...
set_hitbox_value(AT_UAIR, 4, HG_DAMAGE, 13);
...
set_hitbox_value(AT_UAIR, 5, HG_HITBOX_X, 22);
set_hitbox_value(AT_UAIR, 5, HG_HITBOX_Y, -55);
set_hitbox_value(AT_UAIR, 5, HG_WIDTH, 20);
set_hitbox_value(AT_UAIR, 5, HG_HEIGHT, 24);
set_hitbox_value(AT_UAIR, 5, HG_SHAPE, 0);
set_hitbox_value(AT_UAIR, 5, HG_PRIORITY, 2);
set_hitbox_value(AT_UAIR, 5, HG_DAMAGE, 2);
set_hitbox_value(AT_UAIR, 5, HG_ANGLE, 280);
