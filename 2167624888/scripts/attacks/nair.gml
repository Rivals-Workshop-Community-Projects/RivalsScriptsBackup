...
set_window_value(AT_NAIR, 2, AG_WINDOW_ANIM_FRAMES, 12);
...
set_hitbox_value(AT_NAIR, 1, HG_SDI_MULTIPLIER, 0.8);
...
set_hitbox_value(AT_NAIR, 4, HG_WIDTH, 76);
set_hitbox_value(AT_NAIR, 4, HG_HEIGHT, 76);
...
set_hitbox_value(AT_NAIR, 5, HG_HITBOX_X, 7);
set_hitbox_value(AT_NAIR, 5, HG_HITBOX_Y, -17);
set_hitbox_value(AT_NAIR, 5, HG_WIDTH, 76);
set_hitbox_value(AT_NAIR, 5, HG_HEIGHT, 76);

set_hitbox_value(AT_NAIR, 6, HG_HITBOX_X, 7);
