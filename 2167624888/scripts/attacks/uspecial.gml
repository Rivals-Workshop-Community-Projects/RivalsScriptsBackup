...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_TYPE, 1); // boost
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_VSPEED, -9.5);
set_window_value(AT_USPECIAL, 2, AG_WINDOW_CUSTOM_GRAVITY, 0.9);
set_window_value(AT_USPECIAL, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, sound_get("uspecial_jump"));

set_window_value(AT_USPECIAL, 3, AG_WINDOW_TYPE, 1); // land
set_window_value(AT_USPECIAL, 3, AG_WINDOW_LENGTH, 6);
set_window_value(AT_USPECIAL, 3, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_USPECIAL, 3, AG_WINDOW_ANIM_FRAME_START, 24);


set_num_hitboxes(AT_USPECIAL, 1);

set_hitbox_value(AT_USPECIAL, 1, HG_PARENT_HITBOX, 1); // this is literally the nspec arrow
...
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT, nspec_effect);
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, nspec_effect);
set_hitbox_value(AT_USPECIAL, 1, HG_HIT_SFX, asset_get("sfx_blow_medium2"));
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("bigfireball"));
