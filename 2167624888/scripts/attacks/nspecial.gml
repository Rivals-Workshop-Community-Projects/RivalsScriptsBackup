...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_SFX, sound_get("arrow_shoot"));
...
set_hitbox_value(AT_NSPECIAL, 5, HG_PARENT_HITBOX, 5); // red big explosion
...
set_hitbox_value(AT_NSPECIAL, 5, HG_WIDTH, 180);
set_hitbox_value(AT_NSPECIAL, 5, HG_HEIGHT, 180);
...
set_hitbox_value(AT_NSPECIAL, 5, HG_KNOCKBACK_SCALING, 1.15);
...
set_hitbox_value(AT_NSPECIAL, 6, HG_PARENT_HITBOX, 6); // red/blue big explosion
...
set_hitbox_value(AT_NSPECIAL, 6, HG_WIDTH, 129);
set_hitbox_value(AT_NSPECIAL, 6, HG_HEIGHT, 129);
...
set_hitbox_value(AT_NSPECIAL, 6, HG_KNOCKBACK_SCALING, .85);
...
set_hitbox_value(AT_NSPECIAL, 7, HG_PARENT_HITBOX, 1); // blue arrow (red in set_attack)
...
set_hitbox_value(AT_NSPECIAL, 7, HG_HITBOX_X, 44);
set_hitbox_value(AT_NSPECIAL, 7, HG_HITBOX_Y, -34);
...
set_hitbox_value(AT_NSPECIAL, 7, HG_PROJECTILE_SPRITE, sprite_get("article"));
set_hitbox_value(AT_NSPECIAL, 7, HG_PROJECTILE_MASK, blue_arrow_sprite);
set_hitbox_value(AT_NSPECIAL, 7, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_NSPECIAL, 7, HG_PROJECTILE_HSPEED, 18);
set_hitbox_value(AT_NSPECIAL, 7, HG_PROJECTILE_VSPEED, -3);
set_hitbox_value(AT_NSPECIAL, 7, HG_PROJECTILE_AIR_FRICTION, 0.2);
set_hitbox_value(AT_NSPECIAL, 7, HG_PROJECTILE_GROUND_FRICTION, 0.2);
...
set_hitbox_value(AT_NSPECIAL, 7, HG_VISUAL_EFFECT, nspec_hitenemy_red);