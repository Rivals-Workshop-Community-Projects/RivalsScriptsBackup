...
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT, hfx_yoyo_smalt);
...
set_hitbox_value(AT_NAIR, 5, HG_WIDTH, 107);
...
set_hitbox_value(AT_NAIR, 5, HG_VISUAL_EFFECT, hfx_yoyo_small);
