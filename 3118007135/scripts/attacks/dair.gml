...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, hfx_yoyo_small);
...
set_hitbox_value(AT_DAIR, 2, HG_WIDTH, 73);
...
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT, hfx_yoyo_small);
