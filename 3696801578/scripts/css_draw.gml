...
else if (alt_new != currAlt)
{
	...
	currAlt = alt_new;
	sound_stop(voice)
	var choices = ["yeah", "attack", "attack2", "attack3", "laugh", "laugh2", "kerblam"]
	
	var rand = random_func(12, array_length(choices), true)
	
	voice = sound_play(sound_get("va_finn_"+choices[rand]), false, noone, 0.6, 1)
}

alt_name[0]  = "Warriors of Ooo";
alt_name[1]  = "Pajamas and Shapeshifter";
alt_name[2]  = "Fiona and Cake";
alt_name[3]  = "Shoko and Tiger";
alt_name[4]  = "Shermy and Beth";
alt_name[5]  = "Fern";
alt_name[6]  = "PB and Marceline";
alt_name[7]  = "Ice King and Gunter";
alt_name[8]  = "Susan and Bmo";
alt_name[9]  = "Mabel and Waddles";
alt_name[10]  = "Steven and Amethyst";
alt_name[11] = "Star and Marco";
alt_name[12] = "Luz and King";
alt_name[13] = "Shaggy and Scooby";
alt_name[14] = "Annie of the Stars";
alt_name[15] = "Agent 3";
alt_name[16] = "Banjo and Kazooie";
alt_name[17] = "Zagreus and Cerberus";
alt_name[18] = "Madeline";
alt_name[19] = "Kris and Susie";
alt_name[20] = "Miku and Teto";
alt_name[21] = "Mario and Luigi";
alt_name[22] = "Forsburn";
alt_name[23] = "Clairen and Mollo";
alt_name[24] = "Scratch and Bite";
alt_name[25] = "Cocua and Yingo";
alt_name[26] = "Pastelle";
alt_name[27] = "Valley and Death";
alt_name[28] = "Kallola";
alt_name[29] = "Delta and Dony";
alt_name[30] = "Sunset";
alt_name[31] = "Better off Together";
