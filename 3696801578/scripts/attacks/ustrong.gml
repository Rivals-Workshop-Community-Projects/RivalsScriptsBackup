...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, sound_get("sfx_fj_sword_swipe_heavy2"));
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, HFX_GEN_OMNI)
...
set_hitbox_value(AT_USTRONG, 2, HG_WIDTH, 115);
...
set_hitbox_value(AT_USTRONG, 3, HG_VISUAL_EFFECT, HFX_GEN_BIG)
