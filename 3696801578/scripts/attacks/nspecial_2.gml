...
set_window_value(AT_NSPECIAL_2, 2, AG_WINDOW_HSPEED, 1);
...
set_window_value(AT_NSPECIAL_2, 4, AG_WINDOW_ANIM_FRAMES, 7);
set_window_value(AT_NSPECIAL_2, 4, AG_WINDOW_ANIM_FRAME_START, 8);
set_window_value(AT_NSPECIAL_2, 4, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_NSPECIAL_2, 4, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy2"));
set_window_value(AT_NSPECIAL_2, 4, AG_WINDOW_SFX_FRAME, 12);

set_window_value(AT_NSPECIAL_2, 5, AG_WINDOW_TYPE, 1);
set_window_value(AT_NSPECIAL_2, 5, AG_WINDOW_LENGTH, 3);
...
set_hitbox_value(AT_NSPECIAL_2, 2, HG_HITBOX_X, 22);
