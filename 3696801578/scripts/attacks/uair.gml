...
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT, vfx_hand_spin_small)
...
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT, vfx_hand_spin_small)
...
set_hitbox_value(AT_UAIR, 3, HG_WIDTH, 55);
...
set_hitbox_value(AT_UAIR, 3, HG_HITSTUN_MULTIPLIER, 0.9);
set_hitbox_value(AT_UAIR, 3, HG_VISUAL_EFFECT, vfx_hand_spin_small)
...
set_hitbox_value(AT_UAIR, 4, HG_VISUAL_EFFECT, vfx_hand_spin)
...
set_hitbox_value(AT_UAIR, 5, HG_VISUAL_EFFECT, vfx_hand_spin)
