...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("sfx_fj_sword_swipe_medium1"));
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, sound_get("sfx_fj_sword_swipe_heavy"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, HFX_GEN_BIG);
...
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT, HFX_GEN_BIG);
...
set_hitbox_value(AT_DSTRONG, 4, HG_VISUAL_EFFECT, HFX_GEN_BIG);
