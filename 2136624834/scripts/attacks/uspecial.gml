...
set_hitbox_value(AT_USPECIAL, 1, HG_EXTRA_HITPAUSE, 6);
...
set_hitbox_value(AT_USPECIAL, 17, HG_WINDOW, 2);
set_hitbox_value(AT_USPECIAL, 17, HG_WINDOW_CREATION_FRAME, 0);
set_hitbox_value(AT_USPECIAL, 17, HG_LIFETIME, 2); 
set_hitbox_value(AT_USPECIAL, 17, HG_HITBOX_X, -6);
set_hitbox_value(AT_USPECIAL, 17, HG_HITBOX_Y, -40);
set_hitbox_value(AT_USPECIAL, 17, HG_WIDTH, 120);
set_hitbox_value(AT_USPECIAL, 17, HG_HEIGHT, 120);
set_hitbox_value(AT_USPECIAL, 17, HG_PRIORITY, 1);
set_hitbox_value(AT_USPECIAL, 17, HG_DAMAGE, 4);
set_hitbox_value(AT_USPECIAL, 17, HG_ANGLE, 90);
set_hitbox_value(AT_USPECIAL, 17, HG_BASE_KNOCKBACK, 9);
set_hitbox_value(AT_USPECIAL, 17, HG_KNOCKBACK_SCALING, 0.9);
set_hitbox_value(AT_USPECIAL, 17, HG_VISUAL_EFFECT, 1);
set_hitbox_value(AT_USPECIAL, 17, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_USPECIAL, 17, HG_HITPAUSE_SCALING, .5);
set_hitbox_value(AT_USPECIAL, 17, HG_EXTRA_HITPAUSE, 6);
set_hitbox_value(AT_USPECIAL, 17, HG_VISUAL_EFFECT_Y_OFFSET, 0);
set_hitbox_value(AT_USPECIAL, 17, HG_HIT_SFX, sound_get("slice"));
set_hitbox_value(AT_USPECIAL, 17, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_USPECIAL, 17, HG_HITSTUN_MULTIPLIER, 1);
...
set_hitbox_value(AT_USPECIAL, 5, HG_WIDTH, 380);
set_hitbox_value(AT_USPECIAL, 5, HG_HEIGHT, 380);
...
set_hitbox_value(AT_USPECIAL, 6, HG_BASE_KNOCKBACK, 0.1);
