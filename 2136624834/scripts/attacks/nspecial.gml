...
set_hitbox_value(AT_NSPECIAL, 2, HG_HIT_SFX, asset_get("sfx_abyss_explosion"));
...
set_hitbox_value(AT_NSPECIAL, 4, HG_HIT_SFX, asset_get("sfx_abyss_explosion"));
...
set_hitbox_value(AT_NSPECIAL, 6, HG_HIT_SFX, asset_get("sfx_abyss_explosion"));
...
set_hitbox_value(AT_NSPECIAL, 8, HG_HITSTUN_MULTIPLIER, 0.5);
...
set_hitbox_value(AT_NSPECIAL, 9, HG_KNOCKBACK_SCALING, 0.7);
