...
set_hitbox_value(AT_FTHROW, 18, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_FTHROW, 18, HG_WINDOW, 4);
set_hitbox_value(AT_FTHROW, 18, HG_WINDOW_CREATION_FRAME, 15);
set_hitbox_value(AT_FTHROW, 18, HG_LIFETIME, 20);
set_hitbox_value(AT_FTHROW, 18, HG_HITBOX_X, -40);
set_hitbox_value(AT_FTHROW, 18, HG_HITBOX_Y, -36);
set_hitbox_value(AT_FTHROW, 18, HG_PRIORITY, 3);
set_hitbox_value(AT_FTHROW, 18, HG_PROJECTILE_WALL_BEHAVIOR, 1);
set_hitbox_value(AT_FTHROW, 18, HG_PROJECTILE_GROUND_BEHAVIOR, 1);
set_hitbox_value(AT_FTHROW, 18, HG_PROJECTILE_SPRITE, sprite_get("icicle1"));
set_hitbox_value(AT_FTHROW, 18, HG_PROJECTILE_AIR_FRICTION, 0.4);
set_hitbox_value(AT_FTHROW, 18, HG_PROJECTILE_HSPEED, 14);
set_hitbox_value(AT_FTHROW, 18, HG_PROJECTILE_VSPEED, 0);
set_hitbox_value(AT_FTHROW, 18, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_FTHROW, 18, HG_PROJECTILE_ANIM_SPEED, 0);
set_hitbox_value(AT_FTHROW, 18, HG_PROJECTILE_DESTROY_EFFECT, 302);
set_hitbox_value(AT_FTHROW, 18, HG_WIDTH, 20);
set_hitbox_value(AT_FTHROW, 18, HG_HEIGHT, 60);
set_hitbox_value(AT_FTHROW, 18, HG_SHAPE, 0);
set_hitbox_value(AT_FTHROW, 18, HG_PRIORITY, 3);
set_hitbox_value(AT_FTHROW, 18, HG_DAMAGE, 6);
set_hitbox_value(AT_FTHROW, 18, HG_ANGLE, 40);
set_hitbox_value(AT_FTHROW, 18, HG_BASE_KNOCKBACK, 9);
set_hitbox_value(AT_FTHROW, 18, HG_KNOCKBACK_SCALING, 0.9);
set_hitbox_value(AT_FTHROW, 18, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_FTHROW, 18, HG_HITPAUSE_SCALING, .9);
set_hitbox_value(AT_FTHROW, 18, HG_HIT_SFX, asset_get("sfx_absa_kickhit"));
set_hitbox_value(AT_FTHROW, 18, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_FTHROW, 18, HG_PROJECTILE_PARRY_STUN, 1);
set_hitbox_value(AT_FTHROW, 18, HG_VISUAL_EFFECT, 305);
set_hitbox_value(AT_FTHROW, 18, HG_HITSTUN_MULTIPLIER, 1);
set_hitbox_value(AT_FTHROW, 18, HG_PROJECTILE_ENEMY_BEHAVIOR, 1);
set_hitbox_value(AT_FTHROW, 18, HG_PROJECTILE_IS_TRANSCENDENT, false);
set_hitbox_value(AT_FTHROW, 18, HG_PROJECTILE_DOES_NOT_REFLECT, true);
set_hitbox_value(AT_FTHROW, 18, HG_PROJECTILE_UNBASHABLE, true);
