...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_coin_collect"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_X, 00);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("icicle2"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, tauntpar1);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_KNOCKBACK_SCALING, 0.0);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HITBOX_X, 00);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_HSPEED, -2);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_DESTROY_EFFECT, 305);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_BASE_KNOCKBACK, 13);
set_hitbox_value(AT_FSPECIAL, 2, HG_KNOCKBACK_SCALING, 0.1);
set_hitbox_value(AT_FSPECIAL, 2, HG_BASE_HITPAUSE, 60);
