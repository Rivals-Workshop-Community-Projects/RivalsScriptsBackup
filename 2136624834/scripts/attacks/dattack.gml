...
set_window_value(AT_DATTACK, 3, AG_WINDOW_SFX, asset_get("sfx_ice_shatter_big"));
...
set_hitbox_value(AT_DATTACK, 2, HG_ANGLE, 46);
set_hitbox_value(AT_DATTACK, 2, HG_BASE_KNOCKBACK, 9);
set_hitbox_value(AT_DATTACK, 2, HG_KNOCKBACK_SCALING, .96);
