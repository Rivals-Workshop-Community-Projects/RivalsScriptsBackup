...
set_window_value(AT_UTILT, 3, AG_WINDOW_SFX, asset_get("sfx_shovel_swing_light1")); 
...
//set_hitbox_value(AT_UTILT, 1, HG_HITSTUN_MULTIPLIER, 0.5);
...
set_hitbox_value(AT_UTILT, 4, HG_HITBOX_Y, -15);
...
set_hitbox_value(AT_UTILT, 4, HG_GROUNDEDNESS, 0);
//set_hitbox_value(AT_UTILT, 1, HG_HIT_LOCKOUT, 1);
set_hitbox_value(AT_UTILT, 4, HG_VISUAL_EFFECT, 305);
