...
set_window_value(AT_USTRONG, 3, AG_WINDOW_HSPEED, -7);
...
set_hitbox_value(AT_USTRONG, 4, HG_HITPAUSE_SCALING, 3);
set_hitbox_value(AT_USTRONG, 4, HG_GROUNDEDNESS, 0);
set_hitbox_value(AT_USTRONG, 4, HG_HIT_LOCKOUT, 10);
set_hitbox_value(AT_USTRONG, 4, HG_VISUAL_EFFECT, 306);
set_hitbox_value(AT_USTRONG, 4, HG_HIT_SFX, asset_get("sfx_shovel_hit_heavy2"));
...
set_hitbox_value(AT_USTRONG, 5, HG_WIDTH, 32);
...
set_hitbox_value(AT_USTRONG, 5, HG_KNOCKBACK_SCALING, 0.3);
...
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_SPRITE, sprite_get("nothing"));
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_IS_TRANSCENDENT, true);
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_DESTROY_EFFECT, effect_nothing);
