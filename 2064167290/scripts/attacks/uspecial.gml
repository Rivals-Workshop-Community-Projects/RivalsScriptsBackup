...
set_hitbox_value(AT_USPECIAL, 1, HG_HIT_SFX, asset_get("sfx_blink_dash"));
...
set_hitbox_value(AT_USPECIAL, 2, HG_HIT_SFX, asset_get("sfx_blink_dash"));
...
set_hitbox_value(AT_USPECIAL, 3, HG_HIT_SFX, asset_get("sfx_blink_dash"));