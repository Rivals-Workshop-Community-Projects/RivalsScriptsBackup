...
set_hitbox_value(AT_NSPECIAL_2, 3, HG_ANGLE, 98);
...
set_hitbox_value(AT_NSPECIAL_2, 4, HG_HEIGHT, 40);
...
set_hitbox_value(AT_NSPECIAL_2, 4, HG_ANGLE, 12);
...
set_hitbox_value(AT_NSPECIAL_2, 5, HG_ANGLE, 300);
set_hitbox_value(AT_NSPECIAL_2, 5, HG_BASE_KNOCKBACK, 4);
set_hitbox_value(AT_NSPECIAL_2, 5, HG_KNOCKBACK_SCALING, 1);
set_hitbox_value(AT_NSPECIAL_2, 5, HG_BASE_HITPAUSE, 6.5);
set_hitbox_value(AT_NSPECIAL_2, 5, HG_HITPAUSE_SCALING, 1.2);
...
set_hitbox_value(AT_NSPECIAL_2, 6, HG_HEIGHT, 40);
...
set_hitbox_value(AT_NSPECIAL_2, 6, HG_BASE_KNOCKBACK, 6.3);
set_hitbox_value(AT_NSPECIAL_2, 6, HG_KNOCKBACK_SCALING, 1.2);
set_hitbox_value(AT_NSPECIAL_2, 6, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_NSPECIAL_2, 6, HG_HITPAUSE_SCALING, 0.9);
...
set_hitbox_value(AT_NSPECIAL_2, 7, HG_HEIGHT, 40);
