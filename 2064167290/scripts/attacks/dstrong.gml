...
set_hitbox_value(AT_DSTRONG, 4, HG_HITPAUSE_SCALING, 1.2);
...
set_hitbox_value(AT_DSTRONG, 5, HG_BASE_KNOCKBACK, 2);
...
set_hitbox_value(AT_DSTRONG, 6, HG_BASE_KNOCKBACK, 2);
set_hitbox_value(AT_DSTRONG, 6, HG_KNOCKBACK_SCALING, 0.7);
