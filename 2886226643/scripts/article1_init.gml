...
sprite_index = sprite_get("sword_idle");           //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
mask_index = sprite_get("sword_idle_mask");  
...
portal_startup_timer = 0;
portal_size = 1.5;
portal_hitbox = noone;
field_nspecial = -1;
portal_hitbox_nspec = noone;
