...
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_ANGLE, 95);
//stun
...
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_PROJECTILE_HSPEED, 0);
set_hitbox_value(AT_USPECIAL_GROUND, 1, HG_PROJECTILE_VSPEED, -15);
