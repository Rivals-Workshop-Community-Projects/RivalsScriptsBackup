...
set_hitbox_value(curr_attack, 1, HG_HITBOX_Y, -50);
set_hitbox_value(curr_attack, 1, HG_HITBOX_X, -2);
set_hitbox_value(curr_attack, 1, HG_WIDTH, 95);
set_hitbox_value(curr_attack, 1, HG_HEIGHT, 55);
