...
set_hitbox_value(curr_attack, 1, HG_HITBOX_Y, -51);
set_hitbox_value(curr_attack, 1, HG_HITBOX_X, -4);
set_hitbox_value(curr_attack, 1, HG_WIDTH, 104);
set_hitbox_value(curr_attack, 1, HG_HEIGHT, 100);
