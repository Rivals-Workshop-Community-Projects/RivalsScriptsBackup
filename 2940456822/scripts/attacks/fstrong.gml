...
set_hitbox_value(curr_attack, 1, HG_HITBOX_X, 42);
set_hitbox_value(curr_attack, 1, HG_WIDTH, 75);
...
set_hitbox_value(curr_attack, 2, HG_HITBOX_X, 52);
...
set_hitbox_value(curr_attack, 2, HG_GROUNDEDNESS, 2);
...
set_hitbox_value(curr_attack, 2, HG_HITPAUSE_SCALING, .9);
