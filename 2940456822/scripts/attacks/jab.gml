...
set_hitbox_value(curr_attack, 3, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(curr_attack, 3, HG_KNOCKBACK_SCALING, 1.05);
set_hitbox_value(curr_attack, 3, HG_HITBOX_GROUP, 3);
set_hitbox_value(curr_attack, 3, HG_BASE_HITPAUSE, 10);
set_hitbox_value(curr_attack, 3, HG_HITPAUSE_SCALING, .9);
