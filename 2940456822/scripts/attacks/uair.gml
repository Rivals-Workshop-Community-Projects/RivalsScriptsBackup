...
set_window_value(curr_attack, 4, AG_WINDOW_LENGTH, 16);
...
set_hitbox_value(curr_attack, 2, HG_HITBOX_Y, -60);
...
set_hitbox_value(curr_attack, 3, HG_WIDTH, 20);
set_hitbox_value(curr_attack, 3, HG_HEIGHT, 20);
set_hitbox_value(curr_attack, 3, HG_PRIORITY, 2);
set_hitbox_value(curr_attack, 3, HG_DAMAGE, 4);
set_hitbox_value(curr_attack, 3, HG_ANGLE, 250);
set_hitbox_value(curr_attack, 3, HG_BASE_KNOCKBACK, 4);
set_hitbox_value(curr_attack, 3, HG_KNOCKBACK_SCALING, .4);
set_hitbox_value(curr_attack, 3, HG_BASE_HITPAUSE, 6);
