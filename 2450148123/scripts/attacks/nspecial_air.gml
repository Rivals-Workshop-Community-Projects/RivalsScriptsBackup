...
set_window_value(AT_NSPECIAL_AIR, 1, AG_WINDOW_SFX, sound_get("crescentlight"));
...
set_window_value(AT_NSPECIAL_AIR, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.9);
set_window_value(AT_NSPECIAL_AIR, 1, AG_WINDOW_VSPEED_TYPE, 2);
set_window_value(AT_NSPECIAL_AIR, 1, AG_WINDOW_VSPEED, -4);
set_window_value(AT_NSPECIAL_AIR, 1, AG_WINDOW_CUSTOM_GRAVITY, 0.3);
...
set_window_value(AT_NSPECIAL_AIR, 2, AG_WINDOW_CUSTOM_GRAVITY, 0.65);
...
set_window_value(AT_NSPECIAL_AIR, 3, AG_WINDOW_CUSTOM_GRAVITY, 0.65);
...
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_SPRITE, sprite_get("nspecial_lightprojair"));
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_MASK, sprite_get("nspecial_lightprojair"));
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_HSPEED, 4);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_AIR_FRICTION, -0.1);
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_PROJECTILE_GROUND_FRICTION, -0.125);
