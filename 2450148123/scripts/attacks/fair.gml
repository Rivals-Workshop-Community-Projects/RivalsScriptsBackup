...
set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, asset_get("sfx_frog_uspecial_spin"));
...
set_hitbox_value(AT_FAIR, 3, HG_MUNO_HITBOX_NAME, "Star");
...
set_hitbox_value(AT_FAIR, 3, HG_DAMAGE, star_damage);
...
set_hitbox_value(AT_FAIR, 3, HG_PROJECTILE_SPRITE, sprite_get("star_proj"));
set_hitbox_value(AT_FAIR, 3, HG_PROJECTILE_MASK, sprite_get("star_proj"));
set_hitbox_value(AT_FAIR, 3, HG_VISUAL_EFFECT, stardestroyfx);
set_hitbox_value(AT_FAIR, 3, HG_PROJECTILE_ANIM_SPEED, .5);
set_hitbox_value(AT_FAIR, 3, HG_PROJECTILE_HSPEED, 8);
set_hitbox_value(AT_FAIR, 3, HG_PROJECTILE_VSPEED, 5);
set_hitbox_value(AT_FAIR, 3, HG_PROJECTILE_AIR_FRICTION, -0.05);
set_hitbox_value(AT_FAIR, 3, HG_PROJECTILE_GROUND_FRICTION, 0);
set_hitbox_value(AT_FAIR, 3, HG_PROJECTILE_GROUND_BEHAVIOR, 2);
set_hitbox_value(AT_FAIR, 3, HG_PROJECTILE_WALL_BEHAVIOR, 2);
