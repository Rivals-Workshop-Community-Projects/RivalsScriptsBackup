...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("crescentlight"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("nspecial_lightproj"));
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("nspecial_lightproj"));
