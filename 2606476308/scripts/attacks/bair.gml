...
set_window_value(AT_BAIR, 4, AG_WINDOW_HSPEED_TYPE, 2);
...
set_window_value(AT_BAIR, 5, AG_WINDOW_HSPEED_TYPE, 2);
set_window_value(AT_BAIR, 5, AG_WINDOW_VSPEED_TYPE, 2);
set_window_value(AT_BAIR, 5, AG_WINDOW_HSPEED, -6);
set_window_value(AT_BAIR, 5, AG_WINDOW_VSPEED, 6);
...
set_hitbox_value(AT_BAIR, 1, HG_KNOCKBACK_SCALING, 0.38);
set_hitbox_value(AT_BAIR, 1, HG_BASE_HITPAUSE, 12);
set_hitbox_value(AT_BAIR, 1, HG_HITPAUSE_SCALING, .12);
...
set_hitbox_value(AT_BAIR, 2, HG_KNOCKBACK_SCALING, 0.42);
