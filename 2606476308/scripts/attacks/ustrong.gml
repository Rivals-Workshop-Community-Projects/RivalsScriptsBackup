...
set_hitbox_value(AT_USTRONG, 2, HG_KNOCKBACK_SCALING, 0.05);
set_hitbox_value(AT_USTRONG, 2, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_USTRONG, 2, HG_HITPAUSE_SCALING, .04);
...
set_hitbox_value(AT_USTRONG, 3, HG_WIDTH, 115);
...
set_hitbox_value(AT_USTRONG, 3, HG_KNOCKBACK_SCALING, 0.98);
...
set_hitbox_value(AT_USTRONG, 4, HG_HITPAUSE_SCALING, .03);
...
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_Y, -5);
