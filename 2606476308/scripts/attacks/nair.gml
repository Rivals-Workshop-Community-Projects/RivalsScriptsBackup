...
set_window_value(AT_NAIR, 2, AG_WINDOW_VSPEED, 0.5);
...
set_hitbox_value(AT_NAIR, 1, HG_ANGLE, 280);
...
set_hitbox_value(AT_NAIR, 4, HG_ANGLE_FLIPPER, 10);
set_hitbox_value(AT_NAIR, 4, HG_BASE_KNOCKBACK, 4.5);
