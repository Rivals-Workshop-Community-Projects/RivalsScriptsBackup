...
set_window_value(AT_FAIR, 2, AG_WINDOW_VSPEED, -1.5);
...
set_hitbox_value(AT_FAIR, 1, HG_HITBOX_Y, -8);
...
set_hitbox_value(AT_FAIR, 1, HG_KNOCKBACK_SCALING, 0.28);
set_hitbox_value(AT_FAIR, 1, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_FAIR, 1, HG_HITPAUSE_SCALING, 0.2);
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, sound_get("swish"));
