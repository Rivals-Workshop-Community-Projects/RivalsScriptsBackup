...
set_window_value(AT_TAUNT, 2, AG_WINDOW_SFX, asset_get("sfx_land_heavy"));
set_window_value(AT_TAUNT, 2, AG_WINDOW_SFX_FRAME, 20);
set_window_value(AT_TAUNT, 2, AG_WINDOW_ANIM_FRAME_START, 1);

set_window_value(AT_TAUNT, 3, AG_WINDOW_TYPE, 1);
set_window_value(AT_TAUNT, 3, AG_WINDOW_LENGTH, 44);
set_window_value(AT_TAUNT, 3, AG_WINDOW_ANIM_FRAMES, 11);
set_window_value(AT_TAUNT, 3, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_TAUNT, 3, AG_WINDOW_SFX, asset_get("sfx_land_heavy"));
set_window_value(AT_TAUNT, 3, AG_WINDOW_SFX_FRAME, 28);
