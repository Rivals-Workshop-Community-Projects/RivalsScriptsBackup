...
sprite_change_offset("jump", 125, 154);
sprite_change_offset("doublejump", 125, 154);
...
sprite_change_offset("nair", 125, 154);
sprite_change_offset("fair", 125, 164);
sprite_change_offset("bair", 125, 154);
sprite_change_offset("uair", 125, 154);
sprite_change_offset("dair", 125, 154);
...
sprite_change_offset("nspecial_air", 125, 164);
...
sprite_change_offset("fstrongair", 125, 164);
sprite_change_offset("dstrongair", 125, 164);
sprite_change_offset("ustrongair", 125, 164);
sprite_change_offset("bstrongair", 125, 164);

sprite_change_offset("sweetspot", 125, 164);
sprite_change_offset("Boombox", 125, 164);
sprite_change_offset("explosion", 125, 122);
sprite_change_offset("Mine", 125, 164);
sprite_change_offset("intro", 125, 164);
