...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, asset_get("sfx_bird_sidespecial"));
...
set_window_value(AT_NAIR, 3, AG_WINDOW_HAS_WHIFFLAG, 13);
...
set_hitbox_value(AT_NAIR, 1, HG_BASE_HITPAUSE, 2.5);
set_hitbox_value(AT_NAIR, 1, HG_EXTRA_HITPAUSE, 2);
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT, 302);
set_hitbox_value(AT_NAIR, 1, HG_HITBOX_GROUP, 1);
//set_hitbox_value(AT_NAIR, 1, HG_ANGLE_FLIPPER, 4);
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, asset_get("sfx_bird_upspecial"));
...
set_hitbox_value(AT_NAIR, 4, HG_KNOCKBACK_SCALING, .66);
set_hitbox_value(AT_NAIR, 4, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_NAIR, 4, HG_HITPAUSE_SCALING, .75);
set_hitbox_value(AT_NAIR, 4, HG_VISUAL_EFFECT_X_OFFSET, 20);
set_hitbox_value(AT_NAIR, 4, HG_VISUAL_EFFECT_Y_OFFSET, -20);
set_hitbox_value(AT_NAIR, 4, HG_HIT_SFX, asset_get("sfx_bird_upspecial"));
