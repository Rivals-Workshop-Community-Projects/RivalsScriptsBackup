...
set_hitbox_value(AT_FTILT, 1, HG_EXTRA_HITPAUSE, 13);
set_hitbox_value(AT_FTILT, 1, HG_HITPAUSE_SCALING, .6);
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, asset_get("sfx_absa_jab1"));
...
set_hitbox_value(AT_FTILT, 2, HG_WIDTH, 22);
...
set_hitbox_value(AT_FTILT, 2, HG_EXTRA_HITPAUSE, 7);
set_hitbox_value(AT_FTILT, 2, HG_HITPAUSE_SCALING, .6);
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, asset_get("sfx_absa_jab2"));
...
set_hitbox_value(AT_FTILT, 3, HG_HITBOX_X, 98);
set_hitbox_value(AT_FTILT, 3, HG_HITBOX_Y, -30);
set_hitbox_value(AT_FTILT, 3, HG_WIDTH, 22);
set_hitbox_value(AT_FTILT, 3, HG_HEIGHT, 22);
...
set_hitbox_value(AT_FTILT, 3, HG_HIT_SFX, asset_get("sfx_absa_jab2"));
