...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, asset_get("sfx_ell_dtilt1"));
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX_FRAME, 2);

set_window_value(AT_UTILT, 2, AG_WINDOW_TYPE, 1);
set_window_value(AT_UTILT, 2, AG_WINDOW_LENGTH, 7);
set_window_value(AT_UTILT, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_UTILT, 2, AG_WINDOW_SFX, sound_get("chirp3"));
...
set_window_value(AT_UTILT, 3, AG_WINDOW_ANIM_FRAMES, 10);
...
set_hitbox_value(AT_UTILT, 1, HG_KNOCKBACK_SCALING, .05);
...
set_hitbox_value(AT_UTILT, 2, HG_WIDTH, 31);
...
set_hitbox_value(AT_UTILT, 2, HG_EXTRA_HITPAUSE, 7);
set_hitbox_value(AT_UTILT, 2, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_UTILT, 2, HG_KNOCKBACK_SCALING, .15);
set_hitbox_value(AT_UTILT, 2, HG_BASE_HITPAUSE, 4);
set_hitbox_value(AT_UTILT, 2, HG_HITPAUSE_SCALING, .35);
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, sound_get("crack"));