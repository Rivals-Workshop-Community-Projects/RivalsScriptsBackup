...
set_window_value(AT_UAIR, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, .5);
...
set_window_value(AT_UAIR, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, .25);
...
set_hitbox_value(AT_UAIR, 1, HG_HITBOX_Y, -20);
...
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT, beakss );
