...
set_attack_value(AT_FSPECIAL, AG_HAS_LANDING_LAG, 24);
...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_HAS_CUSTOM_FRICTION, .5);
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_CANCEL_FRAME, 22);
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, 1.33);
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_VSPEED, -7.5)
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_blow_weak2"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX,  sound_get("hoo3"));
