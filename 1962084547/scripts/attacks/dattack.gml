...
set_window_value(AT_DATTACK, 1, AG_WINDOW_HAS_CUSTOM_FRICTION, 1.5);
...
set_window_value(AT_DATTACK, 2, AG_WINDOW_HSPEED, 7.25);
set_window_value(AT_DATTACK, 2, AG_WINDOW_HSPEED_TYPE, 1);
set_window_value(AT_DATTACK, 2, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_DATTACK, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .8);
...
set_window_value(AT_DATTACK, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, .90);*/
...
set_hitbox_value(AT_DATTACK, 2, HG_WIDTH, 11);
set_hitbox_value(AT_DATTACK, 2, HG_HEIGHT, 11);
...
set_hitbox_value(AT_DATTACK, 2, HG_BASE_KNOCKBACK, 7.25);
set_hitbox_value(AT_DATTACK, 2, HG_KNOCKBACK_SCALING, 1);
set_hitbox_value(AT_DATTACK, 2, HG_BASE_HITPAUSE, 13);
set_hitbox_value(AT_DATTACK, 2, HG_HITPAUSE_SCALING, 1);
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT_X_OFFSET, 25);
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT_Y_OFFSET, 15);
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT, beakss2);
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, asset_get("sfx_shovel_hit_heavy2"));
