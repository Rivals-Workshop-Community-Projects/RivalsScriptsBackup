...
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 81);
set_hitbox_value(AT_BAIR, 1, HG_ANGLE, 17);
...
set_hitbox_value(AT_BAIR, 2, HG_WIDTH, 83);
...
set_hitbox_value(AT_BAIR, 2, HG_BASE_KNOCKBACK, 4.33);
