...
set_window_value(AT_FSPECIAL_2, 1, AG_WINDOW_HSPEED, 5.6);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_WIDTH, 102);
...
set_hitbox_value(AT_FSPECIAL_2, 1, HG_BASE_KNOCKBACK, 7.25);
