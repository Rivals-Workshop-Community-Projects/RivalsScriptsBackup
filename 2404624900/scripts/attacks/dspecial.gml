...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_LENGTH, 23);
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_ANIM_FRAMES, 7);
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_ANIM_FRAME_START, 3);
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX, sound_get("counter_active"));
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_SFX, sound_get("counter_success"));
