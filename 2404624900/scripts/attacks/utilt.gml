...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("fair"));
...
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sound_get("blade_hit6"));
...
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, sound_get("clone_sword_hit"));
set_hitbox_value(AT_UTILT, 2, HG_PROJECTILE_SPRITE, sprite_get("nothing"));
set_hitbox_value(AT_UTILT, 2, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_UTILT, 2, HG_PROJECTILE_IS_TRANSCENDENT, true);
set_hitbox_value(AT_UTILT, 2, HG_EFFECT, 0);
set_hitbox_value(AT_UTILT, 2, HG_PROJECTILE_PARRY_STUN, true);
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, clone_hit);
...
set_hitbox_value(AT_UTILT, 2,  HG_EXTENDED_PARRY_STUN, 1);