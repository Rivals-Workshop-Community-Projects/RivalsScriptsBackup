...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, sound_get("jab2"));
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, sound_get("blade_hit4"));
...
set_hitbox_value(AT_FTILT, 2, HG_WIDTH, 67);
...
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, sound_get("blade_hit4"));
...
set_hitbox_value(AT_FTILT, 3, HG_HITBOX_X, 59);
set_hitbox_value(AT_FTILT, 3, HG_HITBOX_Y, -41);
set_hitbox_value(AT_FTILT, 3, HG_WIDTH, 56);
set_hitbox_value(AT_FTILT, 3, HG_HEIGHT, 46);
...
set_hitbox_value(AT_FTILT, 3, HG_HIT_SFX, sound_get("clone_sword_hit"));
set_hitbox_value(AT_FTILT, 3, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_FTILT, 3, HG_PROJECTILE_SPRITE, sprite_get("nothing"));
...
set_hitbox_value(AT_FTILT, 3, HG_VISUAL_EFFECT, clone_hit);
...
set_hitbox_value(AT_FTILT, 4, HG_HITBOX_X, 22);
set_hitbox_value(AT_FTILT, 4, HG_HITBOX_Y, -25);
set_hitbox_value(AT_FTILT, 4, HG_WIDTH, 67);
set_hitbox_value(AT_FTILT, 4, HG_HEIGHT, 23);
...
set_hitbox_value(AT_FTILT, 4, HG_KNOCKBACK_SCALING, .45);
set_hitbox_value(AT_FTILT, 4, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_FTILT, 4, HG_HITPAUSE_SCALING, .5);
set_hitbox_value(AT_FTILT, 4, HG_HIT_SFX, sound_get("clone_sword_hit"));
set_hitbox_value(AT_FTILT, 4, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_FTILT, 4, HG_PROJECTILE_SPRITE, sprite_get("nothing"));
...
set_hitbox_value(AT_FTILT, 4, HG_VISUAL_EFFECT, clone_hit);
...
set_hitbox_value(AT_FTILT, 3, HG_EXTENDED_PARRY_STUN, 1);
set_hitbox_value(AT_FTILT, 4, HG_EXTENDED_PARRY_STUN, 1);