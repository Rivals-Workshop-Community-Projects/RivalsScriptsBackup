...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_SFX, sound_get("shadow_clone"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HITBOX_TYPE, 2); //Izuna Drop
...
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, 145);
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT_X_OFFSET, 10);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_abyss_explosion_big"));

set_hitbox_value(AT_NSPECIAL, 2, HG_HITBOX_TYPE, 2);    //Clone Counter
...
set_hitbox_value(AT_NSPECIAL, 2, HG_ANGLE, 52);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_HITBOX_TYPE, 2);    //Izuna Clone
