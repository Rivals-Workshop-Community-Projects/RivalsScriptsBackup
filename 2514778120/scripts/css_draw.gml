...
if (!variable_instance_exists(id,"ae") || ye == true){
    ...
    ce[1,0] = make_color_rgb(get_color_profile_slot_r(1, 2), get_color_profile_slot_g(1, 2), get_color_profile_slot_b(1, 2));
    ce[1,1] = "Blue"
    ce[1,2] = ""
    ce[2,0] = make_color_rgb(get_color_profile_slot_r(2, 2), get_color_profile_slot_g(2, 2), get_color_profile_slot_b(2, 2));
    ce[2,1] = "Red"
    ce[2,2] = ""
    ce[3,0] = make_color_rgb(get_color_profile_slot_r(3, 2), get_color_profile_slot_g(3, 2), get_color_profile_slot_b(3, 2));
    ce[3,1] = "Green"
    ce[3,2] = ""
    ce[4,0] = make_color_rgb(get_color_profile_slot_r(4, 2), get_color_profile_slot_g(4, 2), get_color_profile_slot_b(4, 2));
    ce[4,1] = "Black"
    ce[4,2] = ""
    ce[5,0] = make_color_rgb(get_color_profile_slot_r(5, 2), get_color_profile_slot_g(5, 2), get_color_profile_slot_b(5, 2));
    ce[5,1] = "Pink"
    ce[5,2] = ""
    ce[6,0] = make_color_rgb(get_color_profile_slot_r(6, 2), get_color_profile_slot_g(6, 2), get_color_profile_slot_b(6, 2));
    ce[6,1] = "Abyss"
    ce[6,2] = ""
    ce[7,0] = make_color_rgb(get_color_profile_slot_r(7, 2), get_color_profile_slot_g(7, 2), get_color_profile_slot_b(7, 2));
    ce[7,1] = "Early Access"
    ce[7,2] = ""
    ce[8,0] = make_color_rgb(get_color_profile_slot_r(8, 2), get_color_profile_slot_g(8, 2), get_color_profile_slot_b(8, 2));
    ce[8,1] = "Elphelt"
    ce[8,2] = ""
    ce[9,0] = make_color_rgb(get_color_profile_slot_r(9, 2), get_color_profile_slot_g(9, 2), get_color_profile_slot_b(9, 2));
    ce[9,1] = "Valentine"
    ce[9,2] = ""
    ce[10,0] = make_color_rgb(get_color_profile_slot_r(10, 2), get_color_profile_slot_g(10, 2), get_color_profile_slot_b(10, 2));
    ce[10,1] = "Strive Black"
    ce[10,2] = ""
    ce[11,0] = make_color_rgb(get_color_profile_slot_r(11, 2), get_color_profile_slot_g(11, 2), get_color_profile_slot_b(11, 2));
    ce[11,1] = "Strive Red"
    ce[11,2] = ""
    ce[12,0] = make_color_rgb(get_color_profile_slot_r(12, 2), get_color_profile_slot_g(12, 2), get_color_profile_slot_b(12, 2));
    ce[12,1] = "Strive Yellow"
    ce[12,2] = ""
    ce[13,0] = make_color_rgb(get_color_profile_slot_r(13, 2), get_color_profile_slot_g(13, 2), get_color_profile_slot_b(13, 2));
    ce[13,1] = "Strive Green"
    ce[13,2] = ""
    ce[14,0] = make_color_rgb(get_color_profile_slot_r(14, 2), get_color_profile_slot_g(14, 2), get_color_profile_slot_b(14, 2));
    ce[14,1] = "Strive Blue"
    ce[14,2] = ""
    ce[15,0] = make_color_rgb(get_color_profile_slot_r(15, 2), get_color_profile_slot_g(15, 2), get_color_profile_slot_b(15, 2));
    ce[15,1] = "Strive Silver"
    ce[15,2] = ""
    ce[16,0] = make_color_rgb(get_color_profile_slot_r(16, 2), get_color_profile_slot_g(16, 2), get_color_profile_slot_b(16, 2));
    ce[16,1] = "Strive Purple"
    ce[16,2] = ""
    ce[17,0] = make_color_rgb(get_color_profile_slot_r(17, 2), get_color_profile_slot_g(17, 2), get_color_profile_slot_b(17, 2));
    ce[17,1] = "Strive Pink"
    ce[17,2] = ""
    ce[18] = make_color_rgb(get_color_profile_slot_r(18, 2), get_color_profile_slot_g(18, 2), get_color_profile_slot_b(18, 2));
    ce[18,1] = "Gold"
    ce[18,2] = "(purely visual)"
    ce[19,0] = make_color_rgb(get_color_profile_slot_r(19, 2), get_color_profile_slot_g(19, 2), get_color_profile_slot_b(19, 2));
    ce[19,1] = "Strive Orange"
    ce[19,2] = ""
    ce[20,0] = make_color_rgb(get_color_profile_slot_r(20, 2), get_color_profile_slot_g(20, 2), get_color_profile_slot_b(20, 2));
    ce[20,1] = "Black Hole"
    ce[20,2] = ""
    ...
    ce[22,1] = "Transistor"
    ce[22,2] = ""
    ce[23,0] = make_color_rgb(get_color_profile_slot_r(23, 2), get_color_profile_slot_g(23, 2), get_color_profile_slot_b(23, 2));
    ce[23,1] = "Rat's Nest"
    ce[23,2] = ""
    ce[24,0] = make_color_rgb(get_color_profile_slot_r(24, 2), get_color_profile_slot_g(24, 2), get_color_profile_slot_b(24, 2));
    ce[24,1] = "Delta"
    ce[24,2] = ""
...
if argument[7]{
    for (i = -1; i < 2; i++){
        for (j = -1; j < 2; j++){
            draw_text_ext_transformed_color(argument[0] + i * 2, argument[1] + j * 2, argument[9], argument[4], argument[5], argument[6], argument[6], 0, c_black, c_black, c_black, c_black, 2);
        }
    }
}
