...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_blow_heavy2"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_ANGLE, -240);
...
set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_Y, -48);
set_hitbox_value(AT_DSTRONG, 3, HG_WIDTH, 28);
