...
set_hitbox_value(AT_DSTRONG, 1, HG_DAMAGE, 0.5);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_Y, -72);
...
set_hitbox_value(AT_DSTRONG, 2, HG_DAMAGE, 0.5);
...
set_hitbox_value(AT_DSTRONG, 3, HG_HEIGHT, 17);
...
set_hitbox_value(AT_DSTRONG, 3, HG_HIT_SFX, asset_get("sfx_bite"));
...
set_hitbox_value(AT_DSTRONG, 4, HG_ANGLE, 248);
