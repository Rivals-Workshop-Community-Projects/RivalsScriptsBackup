...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_ell_big_missile_fire"));
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.12);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT, hit_sprites[2]);
