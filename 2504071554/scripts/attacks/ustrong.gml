...
set_attack_value(AT_USTRONG, AG_NUM_WINDOWS, 5);//4
set_attack_value(AT_USTRONG, AG_CATEGORY, 2);
set_attack_value(AT_USTRONG, AG_HAS_LANDING_LAG, 1);
set_attack_value(AT_USTRONG, AG_LANDING_LAG, 3);
...
set_window_value(AT_USTRONG, 3, AG_WINDOW_LENGTH, 7);//8, reduced because buffer
...
set_window_value(AT_USTRONG, 3, AG_WINDOW_CUSTOM_GRAVITY, .5);
set_window_value(AT_USTRONG, 3, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_USTRONG, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, .1);
...
set_window_value(AT_USTRONG, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, .1);
...
set_window_value(AT_USTRONG, 5, AG_WINDOW_CUSTOM_GRAVITY, .5);
set_window_value(AT_USTRONG, 5, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_USTRONG, 5, AG_WINDOW_CUSTOM_AIR_FRICTION, .05);
...
set_hitbox_value(AT_USTRONG, 1, HG_WINDOW, 4);//3
set_hitbox_value(AT_USTRONG, 1, HG_LIFETIME, 4);
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_X, 1);
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_Y, 3);
...
set_hitbox_value(AT_USTRONG, 2, HG_WINDOW, 4);//3
...
set_hitbox_value(AT_USTRONG, 3, HG_WINDOW, 4);//3
