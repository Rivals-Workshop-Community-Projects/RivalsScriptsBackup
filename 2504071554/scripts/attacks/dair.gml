...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, asset_get("sfx_clairen_fspecial_dash"));
...
set_window_value(AT_DAIR, 4, AG_WINDOW_HSPEED, 6);
set_window_value(AT_DAIR, 4, AG_WINDOW_VSPEED_TYPE, 1);
set_window_value(AT_DAIR, 4, AG_WINDOW_VSPEED, 8);
...
set_hitbox_value(AT_DAIR, 2, HG_HEIGHT, 67);
