...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_CUSTOM_GRAVITY, .4);
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, .09);
set_window_value(AT_DSTRONG, 4, AG_WINDOW_CUSTOM_GRAVITY, .7);
...
set_window_value(AT_DSTRONG, 5, AG_WINDOW_CUSTOM_AIR_FRICTION, .09);
...
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 143);
...
set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_X, -31);
...
set_hitbox_value(AT_DSTRONG, 4, HG_HEIGHT, 16);
...
set_hitbox_value(AT_DSTRONG, 4, HG_HIT_SFX, asset_get("sfx_blow_heavy3"));