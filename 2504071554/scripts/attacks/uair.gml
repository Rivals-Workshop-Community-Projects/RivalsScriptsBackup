...
set_window_value(AT_UAIR, 3, AG_WINDOW_HAS_WHIFFLAG, 9);
...
set_hitbox_value(AT_UAIR, 2, HG_HITBOX_Y, -12);
...
set_hitbox_value(AT_UAIR, 5, HG_HITBOX_X, -33);
set_hitbox_value(AT_UAIR, 5, HG_HITBOX_Y, -68);
set_hitbox_value(AT_UAIR, 5, HG_WIDTH, 30);
set_hitbox_value(AT_UAIR, 5, HG_HEIGHT, 90);
set_hitbox_value(AT_UAIR, 5, HG_PRIORITY, 3);
set_hitbox_value(AT_UAIR, 5, HG_DAMAGE, 5);
set_hitbox_value(AT_UAIR, 5, HG_ANGLE, 90);
set_hitbox_value(AT_UAIR, 5, HG_BASE_KNOCKBACK, 7.7);
...
set_hitbox_value(AT_UAIR, 6, HG_LIFETIME, 12);
set_hitbox_value(AT_UAIR, 6, HG_HITBOX_X, -6);
set_hitbox_value(AT_UAIR, 6, HG_HITBOX_Y, -39);
...
set_hitbox_value(AT_UAIR, 6, HG_BASE_KNOCKBACK, 6.5);
