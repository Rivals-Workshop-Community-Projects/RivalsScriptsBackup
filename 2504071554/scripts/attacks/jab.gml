...
set_window_value(AT_JAB, 2, AG_WINDOW_LENGTH, 6);//8
set_window_value(AT_JAB, 2, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_JAB, 2, AG_WINDOW_ANIM_FRAME_START, 2);

set_window_value(AT_JAB, 3, AG_WINDOW_TYPE, 1);
set_window_value(AT_JAB, 3, AG_WINDOW_LENGTH, 10);//5
...
set_window_value(AT_JAB, 5, AG_WINDOW_LENGTH, 6);//8
set_window_value(AT_JAB, 5, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_JAB, 5, AG_WINDOW_ANIM_FRAME_START, 5);

set_window_value(AT_JAB, 6, AG_WINDOW_TYPE, 1);
set_window_value(AT_JAB, 6, AG_WINDOW_LENGTH, 12);//9
...
set_window_value(AT_JAB, 7, AG_WINDOW_LENGTH, 4);//4
...
set_window_value(AT_JAB, 8, AG_WINDOW_LENGTH, 3);//10
...
set_window_value(AT_JAB, 9, AG_WINDOW_HAS_WHIFFLAG, 5);
...
set_window_value(AT_JAB, 10, AG_WINDOW_HAS_WHIFFLAG, 5);
...
set_hitbox_value(AT_JAB, 1, HG_BASE_HITPAUSE, 4);//6//4
...
set_hitbox_value(AT_JAB, 2, HG_HEIGHT, 73);
set_hitbox_value(AT_JAB, 2, HG_PRIORITY, 2);
set_hitbox_value(AT_JAB, 2, HG_DAMAGE, 4);
set_hitbox_value(AT_JAB, 2, HG_ANGLE, 60);
set_hitbox_value(AT_JAB, 2, HG_BASE_KNOCKBACK, 4);
set_hitbox_value(AT_JAB, 2, HG_BASE_HITPAUSE, 4);//6//4
...
set_hitbox_value(AT_JAB, 4, HG_HITBOX_X, 89);
set_hitbox_value(AT_JAB, 4, HG_HITBOX_Y, -40);
set_hitbox_value(AT_JAB, 4, HG_WIDTH, 73);
...
set_hitbox_value(AT_JAB, 4, HG_BASE_HITPAUSE, 8);//8
