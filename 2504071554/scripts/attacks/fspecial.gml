...
set_window_value(AT_FSPECIAL, 11, AG_WINDOW_LENGTH, 10);
set_window_value(AT_FSPECIAL, 11, AG_WINDOW_ANIM_FRAME_START, 17);
set_window_value(AT_FSPECIAL, 11, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_FSPECIAL, 11, AG_WINDOW_HAS_WHIFFLAG, 1);



//teleport (parry cancel)
set_window_value(AT_FSPECIAL, 12, AG_WINDOW_LENGTH, 6);
set_window_value(AT_FSPECIAL, 12, AG_WINDOW_ANIM_FRAME_START, 20);
set_window_value(AT_FSPECIAL, 12, AG_WINDOW_ANIM_FRAMES, 2);

set_window_value(AT_FSPECIAL, 13, AG_WINDOW_LENGTH, 5);
set_window_value(AT_FSPECIAL, 13, AG_WINDOW_ANIM_FRAME_START, 22);
set_window_value(AT_FSPECIAL, 13, AG_WINDOW_ANIM_FRAMES, 1);

//tele (parry)
set_window_value(AT_FSPECIAL, 14, AG_WINDOW_LENGTH, 4);
set_window_value(AT_FSPECIAL, 14, AG_WINDOW_ANIM_FRAME_START, 23);
...
set_window_value(AT_FSPECIAL, 16, AG_WINDOW_LENGTH, 20);
set_window_value(AT_FSPECIAL, 16, AG_WINDOW_ANIM_FRAME_START, 24);
set_window_value(AT_FSPECIAL, 16, AG_WINDOW_ANIM_FRAMES, 2);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_LIFETIME, 600);
