...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_ice_on_player"));
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX_FRAME, 0);

set_window_value(AT_DSPECIAL, 2, AG_WINDOW_ANIM_FRAME_START, 21);
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_LENGTH, 16);
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_bird_nspecial"));
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_bird_nspecial"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HIT_SFX, sound_get("slice2"));
...
set_hitbox_value(AT_DSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("esp1"));
...
set_hitbox_value(AT_DSPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("esp2"));
