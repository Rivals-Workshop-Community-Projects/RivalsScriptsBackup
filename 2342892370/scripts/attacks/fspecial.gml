...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sound_get("uspecialdash"));
...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_HSPEED, 200);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_WINDOW_CREATION_FRAME, 23);
set_hitbox_value(AT_FSPECIAL, 2, HG_LIFETIME, 1);
set_hitbox_value(AT_FSPECIAL, 2, HG_HITBOX_X, 100);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, sound_get("slice3"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, sound_get("slicef"));
