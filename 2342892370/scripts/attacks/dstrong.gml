...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_abyss_explosion"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HITSTUN_MULTIPLIER, .7);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITSTUN_MULTIPLIER, .7);
