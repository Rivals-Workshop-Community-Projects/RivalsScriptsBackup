...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("coconut_gun"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, 14);
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, -5);
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_LOCKOUT, 10);
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, asset_get("sfx_ell_strong_attack_explosion"));
...
set_hitbox_value(AT_FSTRONG, 2, HG_PROJECTILE_SPRITE, sprite_get("coconut"));
set_hitbox_value(AT_FSTRONG, 2, HG_PROJECTILE_MASK, sprite_get("coconut"));
...
set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT, 135);
set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT_Y_OFFSET, -5);
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, asset_get("sfx_abyss_seed_explode"));