...
shader_start();
    ...
    if (move_cooldown[AT_USPECIAL] <= 1){
        draw_sprite_ext(sprite_get("barrel_icon"), 1, temp_x+185, temp_y-15, 2, 2, 0, c_white, 1);
    }
    if (move_cooldown[AT_USPECIAL] > 1){
        draw_sprite_ext(sprite_get("barrel_icon"), 0, temp_x+185, temp_y-15, 2, 2, 0, c_white, 1);
    }
