...
set_attack_value(AT_TAUNT, AG_HURTBOX_SPRITE, sprite_get("fit_hurt_box"));

set_window_value(AT_TAUNT, 1, AG_WINDOW_TYPE, 1);
set_window_value(AT_TAUNT, 1, AG_WINDOW_LENGTH, 13);
...
set_window_value(AT_TAUNT, 3, AG_WINDOW_LENGTH, 22);
...
set_window_value(AT_TAUNT, 4, AG_WINDOW_LENGTH, 22);
...
set_window_value(AT_TAUNT, 5, AG_WINDOW_LENGTH, 22);
