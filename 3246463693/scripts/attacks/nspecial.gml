...
set_attack_value(AT_NSPECIAL, AG_HURTBOX_SPRITE, sprite_get("fit_hurt_box"));
...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("wft_nspecial"));
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX_FRAME, 7);
set_window_value(AT_NSPECIAL, 1, AG_USES_CUSTOM_GRAVITY, 1);
...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.3);
...
set_window_value(AT_NSPECIAL, 2, AG_USES_CUSTOM_GRAVITY, 1);
...
set_window_value(AT_NSPECIAL, 3, AG_USES_CUSTOM_GRAVITY, 1);
...
set_window_value(AT_NSPECIAL, 4, AG_USES_CUSTOM_GRAVITY, 1);
set_window_value(AT_NSPECIAL, 4, AG_WINDOW_CUSTOM_GRAVITY, 0.75);
...
set_window_value(AT_NSPECIAL, 5, AG_USES_CUSTOM_GRAVITY, 1);
set_window_value(AT_NSPECIAL, 5, AG_WINDOW_CUSTOM_GRAVITY, 0.75);
...
set_window_value(AT_NSPECIAL, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.2);
...
set_window_value(AT_NSPECIAL, 6, AG_USES_CUSTOM_GRAVITY, 1);
set_window_value(AT_NSPECIAL, 6, AG_WINDOW_CUSTOM_GRAVITY, 0.75);
