...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sound_get("wft_swing_heavy"));
...
set_hitbox_value(AT_DAIR, 1, HG_HITPAUSE_SCALING, .75);
...
set_hitbox_value(AT_DAIR, 2, HG_KNOCKBACK_SCALING, .32);
set_hitbox_value(AT_DAIR, 2, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_DAIR, 2, HG_HITPAUSE_SCALING, .12);
