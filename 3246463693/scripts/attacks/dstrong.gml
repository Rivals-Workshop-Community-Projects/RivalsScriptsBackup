...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, sound_get("wft_whistle"));
...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("wft_dsmash"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT_X_OFFSET, 14);
