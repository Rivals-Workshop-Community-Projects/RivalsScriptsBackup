...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, sound_get("wft_whistle"));
...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("wft_fsmash"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_KNOCKBACK_SCALING, .75);
...
set_hitbox_value(AT_FSTRONG, 2, HG_ANGLE, 140);
set_hitbox_value(AT_FSTRONG, 2, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_FSTRONG, 2, HG_KNOCKBACK_SCALING, .45);
