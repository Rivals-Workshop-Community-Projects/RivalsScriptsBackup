...
set_hitbox_value(AT_FSPECIAL, 1, HG_DAMAGE, round(5 * damage_adj));
set_hitbox_value(AT_FSPECIAL, 1, HG_ANGLE, 75);
set_hitbox_value(AT_FSPECIAL, 1, HG_BASE_KNOCKBACK, 8 * damage_adj);
set_hitbox_value(AT_FSPECIAL, 1, HG_KNOCKBACK_SCALING, 0.2 * damage_adj);
