...
set_hitbox_value(AT_DATTACK, 6, HG_HITBOX_Y, -85);
set_hitbox_value(AT_DATTACK, 6, HG_WIDTH, 80);
set_hitbox_value(AT_DATTACK, 6, HG_HEIGHT, 130);
set_hitbox_value(AT_DATTACK, 6, HG_PRIORITY, 1);
set_hitbox_value(AT_DATTACK, 6, HG_ANGLE, 90);
set_hitbox_value(AT_DATTACK, 6, HG_DRIFT_MULTIPLIER, 1.1);
...
set_hitbox_value(AT_DATTACK, 6, HG_BASE_HITPAUSE, 2);
set_hitbox_value(AT_DATTACK, 6, HG_HITPAUSE_SCALING, 0.1);
set_hitbox_value(AT_DATTACK, 6, HG_HIT_SFX, asset_get("sfx_ell_steam_hit"));
