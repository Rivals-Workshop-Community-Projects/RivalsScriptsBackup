...
set_hitbox_value(AT_NAIR, 2, HG_KNOCKBACK_SCALING, 0.15);
...
set_hitbox_value(AT_NAIR, 3, HG_KNOCKBACK_SCALING, 0.15);
...
set_hitbox_value(AT_NAIR, 6, HG_HITBOX_X, -66);
set_hitbox_value(AT_NAIR, 6, HG_HITBOX_Y, -33);
set_hitbox_value(AT_NAIR, 6, HG_WIDTH, 15);
set_hitbox_value(AT_NAIR, 6, HG_HEIGHT, 15);
...
set_hitbox_value(AT_NAIR, 6, HG_KNOCKBACK_SCALING, 0.7);
set_hitbox_value(AT_NAIR, 6, HG_BASE_HITPAUSE, 14);
set_hitbox_value(AT_NAIR, 6, HG_HITPAUSE_SCALING, 0.3);
