...
set_hitbox_value(AT_DSPECIAL, 7, HG_LIFETIME, 1000);
set_hitbox_value(AT_DSPECIAL, 7, HG_HITBOX_X, -55);
set_hitbox_value(AT_DSPECIAL, 7, HG_HITBOX_Y, 20);
...
set_hitbox_value(AT_DSPECIAL, 7, HG_HIT_SFX, asset_get("sfx_waterhit_heavy"));
set_hitbox_value(AT_DSPECIAL, 7, HG_KNOCKBACK_SCALING, 0.8);
set_hitbox_value(AT_DSPECIAL, 7, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_DSPECIAL, 7, HG_EXTRA_HITPAUSE, 25);
set_hitbox_value(AT_DSPECIAL, 7, HG_ANGLE, 90);
set_hitbox_value(AT_DSPECIAL, 7, HG_VISUAL_EFFECT_Y_OFFSET, -16);
set_hitbox_value(AT_DSPECIAL, 7, HG_PROJECTILE_SPRITE, sprite_get("steam_mortar"));
set_hitbox_value(AT_DSPECIAL, 7, HG_PROJECTILE_DESTROY_EFFECT, vfx_steam_hit_small);
...
set_hitbox_value(AT_DSPECIAL, 7, HG_VISUAL_EFFECT, vfx_steam_hit_large);
set_hitbox_value(AT_DSPECIAL, 7, HG_VISUAL_EFFECT_Y_OFFSET, 10);
set_hitbox_value(AT_DSPECIAL, 7, HG_PROJECTILE_GRAVITY, 0.4);