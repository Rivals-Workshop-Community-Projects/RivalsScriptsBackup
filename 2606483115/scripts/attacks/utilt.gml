...
set_hitbox_value(AT_UTILT, 2, HG_BASE_KNOCKBACK, 9.5);
...
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, vfx_steam_hit_small);
...
set_hitbox_value(AT_UTILT, 3, HG_KNOCKBACK_SCALING, 0.15);
