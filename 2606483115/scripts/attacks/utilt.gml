...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, asset_get("sfx_blow_heavy1"));
...
set_hitbox_value(AT_UTILT, 1, HG_HEIGHT, 126);
...
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, vfx_steam_hit_small);
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, asset_get("sfx_ell_steam_hit"));
...
set_hitbox_value(AT_UTILT, 2, HG_KNOCKBACK_SCALING, 0.15);
