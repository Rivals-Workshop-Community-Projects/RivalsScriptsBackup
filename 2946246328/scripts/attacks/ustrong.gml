...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_may_wrap2"));
...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, asset_get("sfx_leafy_hit3"));
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, 133);
