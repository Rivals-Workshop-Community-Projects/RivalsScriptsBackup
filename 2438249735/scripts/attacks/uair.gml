...
set_window_value(AT_UAIR, 2, AG_WINDOW_SFX, sound_get("swingw2"));
...
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, sound_get("slicew2"));
...
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, sound_get("slicew2"));
