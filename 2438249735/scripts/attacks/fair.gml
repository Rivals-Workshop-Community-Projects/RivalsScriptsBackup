...
set_window_value(AT_FAIR, 2, AG_WINDOW_SFX, sound_get("swingw1"));
...
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, sound_get("slicew1"));
...
set_hitbox_value(AT_FAIR, 2, HG_HIT_SFX, sound_get("slicew1"));
