...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, sound_get("swingh"));
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX_FRAME, 0);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, lpar5);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, sound_get("slicew1"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("grass"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HIT_SFX, sound_get("slicew1"));
...
set_hitbox_value(AT_NSPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("seed"));
...
set_hitbox_value(AT_NSPECIAL, 3, HG_HIT_SFX, sound_get("slicew1"));
...
set_hitbox_value(AT_NSPECIAL, 4, HG_PROJECTILE_SPRITE, sprite_get("grasscv"));
...
set_hitbox_value(AT_NSPECIAL, 4, HG_HIT_SFX, asset_get("sfx_syl_nspecial_flowerhit"));
