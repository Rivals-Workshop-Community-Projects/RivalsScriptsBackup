...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, sound_get("swingw2"));
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX_FRAME, 6);
set_window_value(AT_FTILT, 1, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_FTILT, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, .1);
...
set_hitbox_value(AT_FTILT, 1, HG_HITBOX_Y, -12);
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, sound_get("slicew2"));
...
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, sound_get("slicew2"));
