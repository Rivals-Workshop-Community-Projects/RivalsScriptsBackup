...
set_window_value(AT_USTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_bird_downspecial"));
...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, sound_get("swingh"));
...
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("sliceh1"));
...
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("sliceh1"));
