...
set_window_value(AT_DAIR, 4, AG_WINDOW_SFX, asset_get("sfx_jumpground"));
...
set_window_value(AT_DAIR, 5, AG_WINDOW_SFX, asset_get("sfx_jumpground"));
...
set_hitbox_value(AT_DAIR, 1, HG_HITBOX_Y, 08);
set_hitbox_value(AT_DAIR, 1, HG_WIDTH, 39);
...
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, sound_get("sliceh1"));
...
set_hitbox_value(AT_DAIR, 2, HG_HITBOX_Y, 08);
set_hitbox_value(AT_DAIR, 2, HG_WIDTH, 39);
...
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, sound_get("slicew2"));