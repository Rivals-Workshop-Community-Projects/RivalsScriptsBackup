...
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX,  asset_get("sfx_ell_dspecial_drop"));
...
set_window_value(AT_TAUNT, 2, AG_WINDOW_SFX,  asset_get("sfx_ell_eject"));
...
set_window_value(AT_TAUNT, 4, AG_WINDOW_SFX, asset_get("sfx_ell_dspecial_drop"));
...
set_hitbox_value(AT_TAUNT, 1, HG_HITBOX_X, 02);
set_hitbox_value(AT_TAUNT, 1, HG_HITBOX_Y, -18);
set_hitbox_value(AT_TAUNT, 1, HG_WIDTH, 58);
set_hitbox_value(AT_TAUNT, 1, HG_HEIGHT, 46);
set_hitbox_value(AT_TAUNT, 1, HG_PRIORITY, 1);
set_hitbox_value(AT_TAUNT, 1, HG_DAMAGE, 1);
set_hitbox_value(AT_TAUNT, 1, HG_ANGLE, 340);
...
set_hitbox_value(AT_TAUNT, 1, HG_VISUAL_EFFECT_X_OFFSET, 24);
