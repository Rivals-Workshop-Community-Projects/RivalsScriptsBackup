...
set_window_value(AT_BAIR, 2, AG_WINDOW_SFX, sound_get("swingh"));
...
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 102);
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("sliceh2"));
