...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sound_get("swingw2"));
...
set_window_value(AT_DATTACK, 2, AG_WINDOW_LENGTH, 7*2);
...
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, sound_get("slicew1"));
...
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, sound_get("slicew1"));
set_hitbox_value(AT_DATTACK, 2, HG_HITSTUN_MULTIPLIER, 0.5);
...
set_hitbox_value(AT_DATTACK, 3, HG_HIT_SFX, sound_get("slicew2"));
