...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("tinyslam"));
...
set_hitbox_value(AT_UTILT, 1, HG_HITBOX_Y, -16);
...
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, hfx_medium);
