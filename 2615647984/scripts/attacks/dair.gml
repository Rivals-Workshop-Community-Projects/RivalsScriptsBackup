...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, sound_get("spin"));
...
set_window_value(AT_DAIR, 2, AG_WINDOW_LENGTH, 150);
...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, hfx_bigger);
