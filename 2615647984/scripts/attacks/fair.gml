...
set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, sound_get("whoash"));
...
set_hitbox_value(AT_FAIR, 3, HG_HEIGHT, 72);
...
set_hitbox_value(AT_FAIR, 3, HG_HIT_SFX, sound_get("hit2"));
set_hitbox_value(AT_FAIR, 3, HG_HIT_LOCKOUT, 9);

set_hitbox_value(AT_FAIR, 4, HG_PARENT_HITBOX, 4);
set_hitbox_value(AT_FAIR, 4, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_FAIR, 4, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_FAIR, 4, HG_WINDOW_CREATION_FRAME, 18);
...
set_hitbox_value(AT_FAIR, 4, HG_ANGLE, 315);
set_hitbox_value(AT_FAIR, 4, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_FAIR, 4, HG_KNOCKBACK_SCALING, .45);
set_hitbox_value(AT_FAIR, 4, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_FAIR, 4, HG_HITPAUSE_SCALING, .25);
set_hitbox_value(AT_FAIR, 4, HG_VISUAL_EFFECT, hfx_medium);
set_hitbox_value(AT_FAIR, 4, HG_VISUAL_EFFECT_X_OFFSET, 12);
set_hitbox_value(AT_FAIR, 4, HG_VISUAL_EFFECT_Y_OFFSET, -8);
set_hitbox_value(AT_FAIR, 4, HG_HIT_SFX, sound_get("slam2"));