...
set_window_value(AT_FAIR, 2, AG_WINDOW_LENGTH, 32);
...
set_hitbox_value(AT_FAIR, 3, HG_WINDOW_CREATION_FRAME, 16);
...
set_hitbox_value(AT_FAIR, 3, HG_ANGLE, -20);
...
set_hitbox_value(AT_FAIR, 4, HG_WINDOW_CREATION_FRAME, 24);
...
set_hitbox_value(AT_FAIR, 4, HG_HIT_SFX, sound_get("hit2"));