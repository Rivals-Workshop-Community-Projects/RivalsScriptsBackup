...
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, sound_get("nothing"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_HIT_SFX, sound_get("nothing"));
...
set_hitbox_value(AT_NSPECIAL, 3, HG_HIT_SFX, sound_get("nothing"));