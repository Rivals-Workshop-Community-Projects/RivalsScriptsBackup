...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_SFX, sound_get("slam1"));
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_SFX_FRAME, 16);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HIT_SFX, sound_get("plop"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_VISUAL_EFFECT_Y_OFFSET, 24);
set_hitbox_value(AT_NSPECIAL, 2, HG_HITBOX_GROUP, 1);
set_hitbox_value(AT_NSPECIAL, 2, HG_THROWS_ROCK, 2);
set_hitbox_value(AT_NSPECIAL, 2, HG_HIT_SFX, sound_get("spit"));
...
set_hitbox_value(AT_NSPECIAL, 3, HG_HIT_SFX, sound_get("spit"));