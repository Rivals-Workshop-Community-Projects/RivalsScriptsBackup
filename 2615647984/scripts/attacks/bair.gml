...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("whoosh"));
...
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, hfx_big);
...
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT, hfx_medium);
