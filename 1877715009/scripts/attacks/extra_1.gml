...
set_attack_value(AT_EXTRA_1, AG_SPRITE, 0);
set_attack_value(AT_EXTRA_1, AG_AIR_SPRITE, 0);
set_attack_value(AT_EXTRA_1, AG_HURTBOX_SPRITE, 0);
set_attack_value(AT_EXTRA_1, AG_HURTBOX_AIR_SPRITE, 0);
...
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_LENGTH, 0);
...
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_HAS_CUSTOM_FRICTION, 0);
...
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_INVINCIBILITY, 0);
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_HITPAUSE_FRAME, 0);
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_CANCEL_TYPE, 0);
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_CANCEL_FRAME, 0);
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_HAS_SFX, 0);
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_SFX, 0);
...
set_hitbox_value(AT_EXTRA_1, 1, HG_HIT_SFX, 0);
...
set_hitbox_value(AT_EXTRA_1, 1, HG_PROJECTILE_SPRITE, 0);
set_hitbox_value(AT_EXTRA_1, 1, HG_PROJECTILE_MASK, 0);
