...
set_window_value(AT_DATTACK, 1, AG_WINDOW_TYPE, 1); // frame 1 - 4
...
set_window_value(AT_DATTACK, 2, AG_WINDOW_TYPE, 1); // frame 5 - 6
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_TYPE, 1); // frame 7
...
set_window_value(AT_DATTACK, 4, AG_WINDOW_TYPE, 1); // frame 8 - 10
...
set_hitbox_value(AT_DATTACK, 2, HG_WIDTH, 38);
...
set_hitbox_value(AT_DATTACK, 2, HG_EXTRA_HITPAUSE, 4);
