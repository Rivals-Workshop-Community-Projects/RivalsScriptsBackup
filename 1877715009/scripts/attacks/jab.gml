...
set_attack_value(AT_JAB, AG_STRONG_CHARGE_WINDOW, 7);
...
set_window_value(AT_JAB, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, 8);
...
//set_window_value(AT_JAB, 9, AG_WINDOW_HSPEED, 23);
...
set_hitbox_value(AT_JAB, 3, HG_HITSTUN_MULTIPLIER, 0.8);
set_hitbox_value(AT_JAB, 3, HG_KNOCKBACK_SCALING, 0.5);
set_hitbox_value(AT_JAB, 3, HG_VISUAL_EFFECT, paw_effect);
