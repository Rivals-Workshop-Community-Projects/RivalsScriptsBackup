...
sprite_index = sprite_get("fakie");					//The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
...
b_whip = false;
previous = noone;
part_length = 4;	// the distance between 2 points
friction = 0.45;		// not sure about this
ropeindex = 0;
...
new_sprite = sprite_get("fakie");					//This is another part of the animation handling. It tells the game "this is the sprite this article should be using; if it's not already, switch it over please"
