...
set_hitbox_value(curr_attack, _num, HG_DAMAGE, 9); //Damage is based on base damage
set_hitbox_value(curr_attack, _num, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(curr_attack, _num, HG_KNOCKBACK_SCALING, .2);
...
set_hitbox_value(curr_attack, _num, HG_ANGLE, 70);
