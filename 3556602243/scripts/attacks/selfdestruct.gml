...
set_hitbox_value(curr_attack, _num, HG_BASE_KNOCKBACK, 3);
set_hitbox_value(curr_attack, _num, HG_KNOCKBACK_SCALING, 1.5);
set_hitbox_value(curr_attack, _num, HG_BASE_HITPAUSE, 4);
set_hitbox_value(curr_attack, _num, HG_HITPAUSE_SCALING, 2);
...
set_hitbox_value(curr_attack, _num, HG_HIT_LOCKOUT, 3);
