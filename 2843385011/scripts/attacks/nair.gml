...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, asset_get("sfx_ori_ustrong_launch"));
...
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT, dark_smull);
...
set_hitbox_value(AT_NAIR, 3, HG_VISUAL_EFFECT, dark_med);
