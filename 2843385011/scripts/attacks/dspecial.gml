...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_frog_dspecial_swallow"));
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_frog_dspecial_swallow"));
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_frog_dspecial_swallow"));
...
set_window_value(AT_DSPECIAL, 5, AG_WINDOW_SFX, asset_get("sfx_frog_dspecial_swallow"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, blob_tiny);
