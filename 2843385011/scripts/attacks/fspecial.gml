...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_abyss_hazard_start"));

//Projectile Travelling
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_LENGTH, 60);
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_ANIM_FRAMES, 12);
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_boss_shine"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT, dark_smull);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, dark_smull);
