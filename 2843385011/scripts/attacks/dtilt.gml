...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, sound_get("sfx_sword_swipe1"));
...
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, sound_get("sfx_smash_ult_sword_hit_medium"));
...
set_hitbox_value(AT_DTILT, 2, HG_HIT_SFX, sound_get("sfx_smash_ult_sword_hit_weak"));