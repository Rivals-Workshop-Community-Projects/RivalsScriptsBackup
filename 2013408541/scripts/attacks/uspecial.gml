...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.75);
set_window_value(AT_USPECIAL, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USPECIAL, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.01);
...
set_window_value(AT_USPECIAL, 6, AG_WINDOW_ANIM_FRAMES, 7);
set_window_value(AT_USPECIAL, 6, AG_WINDOW_ANIM_FRAME_START, 8);
set_window_value(AT_USPECIAL, 6, AG_WINDOW_VSPEED, -.05);
...
set_window_value(AT_USPECIAL, 6, AG_WINDOW_CUSTOM_AIR_FRICTION, .6);
...
set_hitbox_value(AT_USPECIAL, 1, HG_WIDTH, 135);
...
set_hitbox_value(AT_USPECIAL, 1, HG_HIT_SFX, asset_get("sfx_ice_on_player"));
...
set_hitbox_value(AT_USPECIAL, 3, HG_HIT_SFX, asset_get("sfx_ice_on_player"));
...
set_hitbox_value(AT_USPECIAL, 4, HG_WIDTH, 140);
...
set_hitbox_value(AT_USPECIAL, 4, HG_VISUAL_EFFECT, 194);
set_hitbox_value(AT_USPECIAL, 4, HG_HIT_SFX, asset_get("sfx_ice_on_player"));
...
set_hitbox_value(AT_USPECIAL, 5, HG_VISUAL_EFFECT, 194);
set_hitbox_value(AT_USPECIAL, 5, HG_HIT_SFX, asset_get("sfx_ice_on_player"));
...
set_hitbox_value(AT_USPECIAL, 6, HG_WIDTH, 135);
...
set_hitbox_value(AT_USPECIAL, 6, HG_HIT_SFX, sound_get("Rocket Hit"));
