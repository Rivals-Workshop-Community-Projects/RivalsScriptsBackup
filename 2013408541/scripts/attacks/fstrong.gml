...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_LENGTH, 18); //22
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_LENGTH, 28); //30
...
set_hitbox_value(AT_FSTRONG, 1, HG_BASE_KNOCKBACK, 12);//8
set_hitbox_value(AT_FSTRONG, 1, HG_KNOCKBACK_SCALING, 1.5);//
set_hitbox_value(AT_FSTRONG, 1, HG_BASE_HITPAUSE, 12);//16
...
set_hitbox_value(AT_FSTRONG, 10, HG_BASE_KNOCKBACK, 8.5);
...
set_hitbox_value(AT_FSTRONG, 11, HG_BASE_HITPAUSE, 12);
...
set_hitbox_value(AT_FSTRONG, 12, HG_BASE_KNOCKBACK, 9);//7
set_hitbox_value(AT_FSTRONG, 12, HG_KNOCKBACK_SCALING, .8);
set_hitbox_value(AT_FSTRONG, 12, HG_BASE_HITPAUSE, 12);
