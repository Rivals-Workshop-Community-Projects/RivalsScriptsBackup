...
set_attack_value(AT_DAIR, AG_LANDING_LAG, 6);//10
set_attack_value(AT_DAIR, AG_HURTBOX_SPRITE, sprite_get("dair_hurt"));

set_window_value(AT_DAIR, 1, AG_WINDOW_TYPE, 1);
set_window_value(AT_DAIR, 1, AG_WINDOW_LENGTH, 12);//15
...
set_hitbox_value(AT_DAIR, 1, HG_BASE_KNOCKBACK, 2);//1
set_hitbox_value(AT_DAIR, 1, HG_KNOCKBACK_SCALING, 1);//.9
...
set_hitbox_value(AT_DAIR, 10, HG_WIDTH, 50);
...
set_hitbox_value(AT_DAIR, 10, HG_BASE_KNOCKBACK, 1.5);
set_hitbox_value(AT_DAIR, 10, HG_KNOCKBACK_SCALING, .9);//5
...
set_hitbox_value(AT_DAIR, 11, HG_WIDTH, 50);
...
set_hitbox_value(AT_DAIR, 11, HG_KNOCKBACK_SCALING, .9);//3
