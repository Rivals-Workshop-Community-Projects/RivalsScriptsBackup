...
set_hitbox_value(AT_DSPECIAL, 3, HG_ANGLE, 280);
...
set_hitbox_value(AT_DSPECIAL, 5, HG_VISUAL_EFFECT, 29);
set_hitbox_value(AT_DSPECIAL, 5, HG_VISUAL_EFFECT_X_OFFSET, 24);
set_hitbox_value(AT_DSPECIAL, 5, HG_HIT_SFX, asset_get("sfx_metal_hit_strong"));
