...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_shovel_swing_heavy1"));
...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_forsburn_reappear"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_ice_on_player"));
...
set_hitbox_value(AT_FSPECIAL, 2, HG_VISUAL_EFFECT, 151);
set_hitbox_value(AT_FSPECIAL, 2, HG_VISUAL_EFFECT_X_OFFSET, 24);
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, asset_get("sfx_shovel_dig"));
