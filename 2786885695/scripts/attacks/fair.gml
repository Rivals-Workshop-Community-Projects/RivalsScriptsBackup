...
set_attack_value(atk, AG_LANDING_LAG, 10); //6
...
set_hitbox_value(atk, hitbox_num, HG_HITBOX_X, 92);
...
set_hitbox_value(atk, hitbox_num, HG_ANGLE, 40); //20
...
set_hitbox_value(atk, hitbox_num, HG_WINDOW, 3);
set_hitbox_value(atk, hitbox_num, HG_LIFETIME, 2);
set_hitbox_value(atk, hitbox_num, HG_HITBOX_X, 54); //64
set_hitbox_value(atk, hitbox_num, HG_HITBOX_Y, -26); //-20
