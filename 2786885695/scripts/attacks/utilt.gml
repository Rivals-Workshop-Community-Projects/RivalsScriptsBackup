...
set_hitbox_value(atk, hitbox_num, HG_WIDTH, 36); //50
set_hitbox_value(atk, hitbox_num, HG_HEIGHT, 90); //110
...
set_hitbox_value(atk, hitbox_num, HG_WINDOW, 2);
set_hitbox_value(atk, hitbox_num, HG_LIFETIME, 2);
set_hitbox_value(atk, hitbox_num, HG_HITBOX_X, 4); //6
set_hitbox_value(atk, hitbox_num, HG_HITBOX_Y, -96); //-104
set_hitbox_value(atk, hitbox_num, HG_WIDTH, 72); //80
...
set_hitbox_value(atk, hitbox_num, HG_WINDOW, 2);
set_hitbox_value(atk, hitbox_num, HG_LIFETIME, 2);
set_hitbox_value(atk, hitbox_num, HG_HITBOX_X, -32); //-36
set_hitbox_value(atk, hitbox_num, HG_HITBOX_Y, -50); //-54
set_hitbox_value(atk, hitbox_num, HG_WIDTH, 32);
set_hitbox_value(atk, hitbox_num, HG_HEIGHT, 90); //100
set_hitbox_value(atk, hitbox_num, HG_PRIORITY, 1);
set_hitbox_value(atk, hitbox_num, HG_DAMAGE, 6);
