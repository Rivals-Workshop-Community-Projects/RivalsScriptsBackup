...
window_num = 1; //windup
set_window_value(atk, window_num, AG_WINDOW_LENGTH, 4); //7
...
set_hitbox_value(atk, hitbox_num, HG_WINDOW_CREATION_FRAME, 3); //4
...
set_hitbox_value(atk, hitbox_num, HG_ANGLE_FLIPPER, 0); //7 / 4
set_hitbox_value(atk, hitbox_num, HG_MUNO_HITBOX_MISC_ADD, "Horizontal KB sends along the user's movement direction.");
