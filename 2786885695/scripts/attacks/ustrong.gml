...
//set_hitbox_value(atk, hitbox_num, HG_BASE_KNOCKBACK, 8); //done in set_attack
//set_hitbox_value(atk, hitbox_num, HG_KNOCKBACK_SCALING, 0.9); //done in set_attack
set_hitbox_value(atk, hitbox_num, HG_MUNO_HITBOX_BKB, "8/7.5");
set_hitbox_value(atk, hitbox_num, HG_MUNO_HITBOX_KBG, "1.1/0.9");
