...
set_hitbox_value(AT_BAIR, 2, HG_PROJECTILE_GRAVITY, 0.5);
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_Y, -13);
...
set_hitbox_value(AT_BAIR, 2, HG_PROJECTILE_SPRITE, sprite_get("1,2,oatmeal"));
set_hitbox_value(AT_BAIR, 2, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_BAIR, 2, HG_PROJECTILE_ANIM_SPEED, .2);
set_hitbox_value(AT_BAIR, 2, HG_PROJECTILE_HSPEED, -10);