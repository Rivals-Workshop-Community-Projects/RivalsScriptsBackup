...
set_window_value(AT_DSPECIAL_2, 2, AG_WINDOW_LENGTH, 90);
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_LIFETIME, 34);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HITBOX_X, 52);
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_PROJECTILE_SPRITE, sprite_get("fire"));
set_hitbox_value(AT_DSPECIAL_2, 1, HG_PROJECTILE_MASK, sprite_get("fire"));
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_WINDOW_CREATION_FRAME, 35);
set_hitbox_value(AT_DSPECIAL_2, 2, HG_LIFETIME, 34);
set_hitbox_value(AT_DSPECIAL_2, 2, HG_HITBOX_X, 52);
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_HITBOX_Y, 18);
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_BASE_KNOCKBACK, 13);
set_hitbox_value(AT_DSPECIAL_2, 2, HG_PROJECTILE_SPRITE, sprite_get("fire"));
set_hitbox_value(AT_DSPECIAL_2, 2, HG_PROJECTILE_MASK, sprite_get("fire"));
