...
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, asset_get("sfx_frog_ustrong"));
...
set_window_value(AT_UAIR, 2, AG_WINDOW_SFX, asset_get("sfx_clairen_swing_strong"));
...
set_hitbox_value(AT_UAIR, 3, HG_HITBOX_Y, -105);
