...
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX, asset_get("sfx_ell_strong_attack_explosion"));
...
//set_window_value(AT_DATTACK, 3, AG_WINDOW_HSPEED, 12);
set_window_value(AT_DATTACK, 3, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .3);
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, .25);
set_window_value(AT_DATTACK, 3, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DATTACK, 3, AG_WINDOW_SFX, asset_get("sfx_forsburn_spew_end"));
set_window_value(AT_DATTACK, 3, AG_WINDOW_SFX_FRAME, 10);
...
set_window_value(AT_DATTACK, 5, AG_WINDOW_CUSTOM_AIR_FRICTION, .3);
set_window_value(AT_DATTACK, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, .7);
...
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT, 251);
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT_X_OFFSET, 8);
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT_Y_OFFSET, 8);
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, asset_get("sfx_ori_charged_flame_hit"));
...
set_hitbox_value(AT_DATTACK, 2, HG_BASE_HITPAUSE, 11);
set_hitbox_value(AT_DATTACK, 2, HG_HITPAUSE_SCALING, 0.7);
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT, 253);
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT_X_OFFSET, 8);
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT_Y_OFFSET, 8);
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, asset_get("sfx_ell_uspecial_explode"));
