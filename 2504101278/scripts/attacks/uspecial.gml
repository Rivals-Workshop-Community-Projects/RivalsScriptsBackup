...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_frog_nspecial_cast"));
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, sound_get("magolor_tele_in"));
...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_clairen_swing_mega_instant"));
...
set_window_value(AT_USPECIAL, 5, AG_WINDOW_SFX, asset_get("sfx_frog_nspecial_shove"));
...
set_hitbox_value(AT_USPECIAL, 2, HG_WINDOW_CREATION_FRAME, 11);
...
set_hitbox_value(AT_USPECIAL, 3, HG_VISUAL_EFFECT, 126);
