...
set_window_value(AT_FTILT, 9, AG_WINDOW_LENGTH, 9);
...
//set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, sound_get("hit5"));
...
set_hitbox_value(AT_FTILT, 2, HG_HITBOX_X, 94);
...
set_hitbox_value(AT_FTILT, 3, HG_HITBOX_X, 96);
...
//set_hitbox_value(AT_FTILT, 3, HG_HIT_SFX, sound_get("hit5"));
...
set_hitbox_value(AT_FTILT, 4, HG_HITBOX_X, 94);
set_hitbox_value(AT_FTILT, 4, HG_HITBOX_Y, -27);
...
set_hitbox_value(AT_FTILT, 4, HG_HIT_SFX, asset_get("sfx_absa_harderhit"));
//set_hitbox_value(AT_FTILT, 4, HG_HIT_SFX, sound_get("hit4"));
