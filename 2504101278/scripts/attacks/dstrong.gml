...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_frog_nspecial_cast"));
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_SFX, asset_get("sfx_frog_dstrong"));
...
set_window_value(AT_DSTRONG, 5, AG_WINDOW_SFX, asset_get("sfx_ori_stomp_hit"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_X, -59);
