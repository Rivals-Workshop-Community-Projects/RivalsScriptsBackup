...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, asset_get("sfx_frog_dstrong"));
...
set_window_value(AT_DTILT, 2, AG_WINDOW_SFX, sound_get("SWE2"));
...
set_window_value(AT_DTILT, 3, AG_WINDOW_SFX, asset_get("sfx_frog_dspecial_swallow"));
...
set_hitbox_value(AT_DTILT, 1, HG_HITBOX_Y, -36);
set_hitbox_value(AT_DTILT, 1, HG_WIDTH, 90);
set_hitbox_value(AT_DTILT, 1, HG_HEIGHT, 75);
...
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT, hit_sprites[1]);
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, 30);
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_Y_OFFSET, 10);
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, sound_get("hit4"));
...
set_hitbox_value(AT_DTILT, 2, HG_VISUAL_EFFECT, hit_sprites[2]);
