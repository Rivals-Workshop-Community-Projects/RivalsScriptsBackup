...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_absa_uair"));
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, vfx_ustrong_hit);
...
set_hitbox_value(AT_USTRONG, 2, HG_WIDTH, 106);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, vfx_ustrong_hit);
