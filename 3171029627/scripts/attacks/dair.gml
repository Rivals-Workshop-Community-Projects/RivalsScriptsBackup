...
set_window_value(AT_DAIR, 1, AG_WINDOW_CANCEL_FRAME, -99);

set_window_value(AT_DAIR, 2, AG_WINDOW_LENGTH, 3);
set_window_value(AT_DAIR, 2, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_DAIR, 2, AG_WINDOW_ANIM_FRAME_START, 4);
set_window_value(AT_DAIR, 2, AG_WINDOW_CANCEL_FRAME, -99);
set_window_value(AT_DAIR, 2, AG_ACTIVE_WINDOW, 1);
...
set_hitbox_value(AT_DAIR, 1, HG_HITBOX_Y, 55);
...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, hfx_sword_medium);
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, sound_get("dbd_weapon_hit3"));

set_hitbox_value(AT_DAIR, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_DAIR, 2, HG_WINDOW, 2);
set_hitbox_value(AT_DAIR, 2, HG_LIFETIME, 3);
set_hitbox_value(AT_DAIR, 2, HG_HITBOX_X, 55);
set_hitbox_value(AT_DAIR, 2, HG_HITBOX_Y, -20);
set_hitbox_value(AT_DAIR, 2, HG_WIDTH, 45);
set_hitbox_value(AT_DAIR, 2, HG_HEIGHT, 105);
...
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT, hfx_sword_small);
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, sound_get("dbd_weapon_hit2"));