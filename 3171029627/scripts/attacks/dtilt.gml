...
set_window_value(AT_DTILT, 1, AG_WINDOW_CANCEL_FRAME, -99);

set_window_value(AT_DTILT, 2, AG_WINDOW_LENGTH, 4);
set_window_value(AT_DTILT, 2, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_DTILT, 2, AG_WINDOW_ANIM_FRAME_START, 2);
set_window_value(AT_DTILT, 2, AG_WINDOW_CANCEL_FRAME, -99);
set_window_value(AT_DTILT, 2, AG_ACTIVE_WINDOW, 1);
...
set_hitbox_value(AT_DTILT, 1, HG_ANGLE, 130);
...
set_hitbox_value(AT_DTILT, 3, HG_HITPAUSE_SCALING, .45);
