...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_CUSTOM_GRAVITY, 0.015);
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_absa_cloud_send"));
...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_mobile_gear_move"));
...
set_hitbox_value(AT_USPECIAL, 3, HG_WIDTH, 15);
...
set_hitbox_value(AT_USPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("lock_chain"));
...
set_hitbox_value(AT_USPECIAL, 3, HG_HIT_SFX, asset_get("sfx_ell_steam_hit"));