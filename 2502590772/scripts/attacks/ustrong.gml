...
set_hitbox_value(this_attack, 1, HG_HITBOX_Y, -75);
set_hitbox_value(this_attack, 1, HG_HITBOX_X, -2);
set_hitbox_value(this_attack, 1, HG_WIDTH, 100);
...
set_hitbox_value(this_attack, 2, HG_WIDTH, 44);
set_hitbox_value(this_attack, 2, HG_HEIGHT, 15);
