...
set_window_value(this_attack, 2, AG_WINDOW_LENGTH, 3);
...
set_hitbox_value(this_attack, 1, HG_KNOCKBACK_SCALING, .55);
set_hitbox_value(this_attack, 1, HG_BASE_HITPAUSE, 3);
