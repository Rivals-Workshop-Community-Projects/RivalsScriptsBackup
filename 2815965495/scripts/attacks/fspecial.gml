...
set_hitbox_value(AT_FSPECIAL, 1, HG_DAMAGE, 1); // 6
...
set_hitbox_value(AT_FSPECIAL, 1, HG_SDI_MULTIPLIER, 1.15);
set_hitbox_value(AT_FSPECIAL, 1, HG_DRIFT_MULTIPLIER, 1.15);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_DAMAGE, 2); // 6
...
set_hitbox_value(AT_FSPECIAL, 2, HG_SDI_MULTIPLIER, 1.15);
set_hitbox_value(AT_FSPECIAL, 2, HG_DRIFT_MULTIPLIER, 1.15);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_HITBOX_X, 46);
