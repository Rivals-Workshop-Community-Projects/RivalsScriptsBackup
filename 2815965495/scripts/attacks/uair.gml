...
set_window_value(AT_UAIR, 1, AG_WINDOW_LENGTH, 6); // 4
set_window_value(AT_UAIR, 1, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_UAIR, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, asset_get("sfx_swipe_weak2"));
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX_FRAME, 5); // 2
...
set_hitbox_value(AT_UAIR, 1, HG_LIFETIME, 4); // 3
set_hitbox_value(AT_UAIR, 1, HG_HITBOX_X, 2); // -40
set_hitbox_value(AT_UAIR, 1, HG_HITBOX_Y, -50); // -40
set_hitbox_value(AT_UAIR, 1, HG_WIDTH, 64); // 70
set_hitbox_value(AT_UAIR, 1, HG_HEIGHT, 44); // 70
