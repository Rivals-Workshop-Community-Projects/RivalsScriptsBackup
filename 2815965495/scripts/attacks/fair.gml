...
set_hitbox_value(AT_FAIR, 1, HG_BASE_KNOCKBACK, 7.75);
set_hitbox_value(AT_FAIR, 1, HG_KNOCKBACK_SCALING, .7);
set_hitbox_value(AT_FAIR, 1, HG_BASE_HITPAUSE, 8); // 6
set_hitbox_value(AT_FAIR, 1, HG_HITPAUSE_SCALING, .7); // .25
...
set_hitbox_value(AT_FAIR, 2, HG_BASE_HITPAUSE, 8); // 6
set_hitbox_value(AT_FAIR, 2, HG_HITPAUSE_SCALING, .7); // .25
