...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, .5);
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, .5);
set_window_value(AT_DSTRONG, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, .5);
...
set_hitbox_value(AT_DSTRONG, 1, HG_BASE_KNOCKBACK, 8.8);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, asset_get("sfx_zetter_downb"));
