...
set_window_value(AT_DTILT, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .75);
...
set_hitbox_value(AT_DTILT, 1, HG_BASE_KNOCKBACK, 7.25);
...
set_hitbox_value(AT_DTILT, 2, HG_BASE_KNOCKBACK, 7.25);
