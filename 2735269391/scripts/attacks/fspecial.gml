set_attack_value(AT_FSPECIAL, AG_SPRITE, sprite_get("fair2"));
set_attack_value(AT_FSPECIAL, AG_NUM_WINDOWS, 3);
set_attack_value(AT_FSPECIAL, AG_CATEGORY, 2);
set_attack_value(AT_FSPECIAL, AG_OFF_LEDGE, 1);
set_attack_value(AT_FSPECIAL, AG_HURTBOX_SPRITE, sprite_get("fair2_hurt"));
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_LENGTH, 7*4);
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_LENGTH, 4*3);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT_X_OFFSET, 4);
set_hitbox_value(AT_FSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_ori_stomp_hit"));
...
set_hitbox_value(AT_FSPECIAL, 2, HG_LIFETIME, 160);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("proj_goatskull"));
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_HSPEED, 10);
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_VSPEED, 0);
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_ANIM_SPEED, .8);
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_DESTROY_EFFECT, 303);
