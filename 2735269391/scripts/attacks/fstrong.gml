...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_ori_bash_hit"));
...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_ori_bash_launch"));
...
set_hitbox_value(AT_FSTRONG, 2, HG_WIDTH, 82);
