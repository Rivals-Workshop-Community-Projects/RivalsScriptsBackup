...
set_hitbox_value(AT_NAIR, 1, HG_WIDTH, 96);
...
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, 4);
...
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, 4);
...
set_hitbox_value(AT_NAIR, 3, HG_HEIGHT, 96);
...
set_hitbox_value(AT_NAIR, 3, HG_VISUAL_EFFECT_X_OFFSET, 4);
