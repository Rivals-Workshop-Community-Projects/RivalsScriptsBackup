...
set_hitbox_value(AT_DATTACK, 3, HG_WIDTH, 62);
set_hitbox_value(AT_DATTACK, 3, HG_HEIGHT, 86);
...
set_hitbox_value(AT_DATTACK, 3, HG_VISUAL_EFFECT_X_OFFSET, 6);
set_hitbox_value(AT_DATTACK, 3, HG_VISUAL_EFFECT_Y_OFFSET, 6);
