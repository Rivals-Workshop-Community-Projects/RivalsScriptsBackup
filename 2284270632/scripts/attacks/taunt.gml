...
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX, asset_get("sfx_ell_dspecial_stick"));
...
set_window_value(AT_TAUNT, 2, AG_WINDOW_SFX, sound_get("growl"));
set_window_value(AT_TAUNT, 2, AG_WINDOW_SFX_FRAME, 10);
...
set_window_value(AT_TAUNT, 6, AG_WINDOW_LENGTH, 25);
...
set_window_value(AT_TAUNT, 6, AG_WINDOW_SFX, asset_get("sfx_ell_dspecial_stick"));
set_window_value(AT_TAUNT, 6, AG_WINDOW_SFX_FRAME, 6);