...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("xil_swing_heavy"));
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_SFX, sound_get("xil_swing_heavy"));
...
set_window_value(AT_DSTRONG, 6, AG_WINDOW_HAS_WHIFFLAG, 2);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("xil_hit_med2"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("xil_hit_med2"));
...
set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_Y, -43);
...
set_hitbox_value(AT_DSTRONG, 3, HG_HIT_SFX, sound_get("xil_hit_med2"));
...
set_hitbox_value(AT_DSTRONG, 4, HG_HEIGHT, 42);
...
set_hitbox_value(AT_DSTRONG, 4, HG_HIT_SFX, sound_get("xil_hit_heavy"));
...
set_hitbox_value(AT_DSTRONG, 5, HG_WIDTH, 92);
...
set_hitbox_value(AT_DSTRONG, 5, HG_HIT_SFX, sound_get("xil_hit_heavy"));
