...
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, sound_get("xil_swing_med1"));
...
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, sound_get("xil_hit_weak"));
...
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, sound_get("xil_hit_med2"));
...
set_hitbox_value(AT_UAIR, 3, HG_HITBOX_X, -62);
set_hitbox_value(AT_UAIR, 3, HG_HITBOX_Y, -67);
set_hitbox_value(AT_UAIR, 3, HG_WIDTH, 60);
set_hitbox_value(AT_UAIR, 3, HG_HEIGHT, 73);
...
set_hitbox_value(AT_UAIR, 3, HG_HIT_SFX, sound_get("xil_hit_med1"));
...
set_hitbox_value(AT_UAIR, 4, HG_WIDTH, 84);
set_hitbox_value(AT_UAIR, 4, HG_HEIGHT, 43);
...
set_hitbox_value(AT_UAIR, 4, HG_HIT_SFX, sound_get("xil_hit_med2"));
