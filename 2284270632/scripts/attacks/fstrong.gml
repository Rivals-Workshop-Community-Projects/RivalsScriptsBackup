...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("xil_swing_heavy"));
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX, sound_get("xil_hit_med1"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_X, 98);
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_Y, -31);
set_hitbox_value(AT_FSTRONG, 1, HG_WIDTH, 134);
...
set_hitbox_value(AT_FSTRONG, 1, HG_BASE_HITPAUSE, 23);
set_hitbox_value(AT_FSTRONG, 1, HG_HITPAUSE_SCALING, 1.2);
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, 304);
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sound_get("xil_hit_heavy"));
...
set_hitbox_value(AT_FSTRONG, 2, HG_BASE_HITPAUSE, 23);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, sound_get("xil_hit_heavy"));
...
set_hitbox_value(AT_FSTRONG, 3, HG_HITBOX_X, 78);
set_hitbox_value(AT_FSTRONG, 3, HG_HITBOX_Y, -51);
