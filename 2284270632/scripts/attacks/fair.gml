...
set_window_value(AT_FAIR, 2, AG_WINDOW_SFX, sound_get("xil_swing_med2"));
...
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, sound_get("xil_hit_med2"));
...
set_hitbox_value(AT_FAIR, 2, HG_HITBOX_Y, -77);
...
set_hitbox_value(AT_FAIR, 2, HG_HIT_SFX, sound_get("xil_hit_med1"));
...
set_hitbox_value(AT_FAIR, 3, HG_WIDTH, 86);
...
set_hitbox_value(AT_FAIR, 3, HG_HIT_SFX, sound_get("xil_hit_med2"));
...
set_hitbox_value(AT_FAIR, 4, HG_HITBOX_X, 78);
set_hitbox_value(AT_FAIR, 4, HG_HITBOX_Y, 2);
...
set_hitbox_value(AT_FAIR, 4, HG_HIT_SFX, sound_get("xil_hit_med1"));