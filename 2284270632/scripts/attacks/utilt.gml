...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("xil_swing_weak"));
...
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sound_get("xil_hit_weak"));
...
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, sound_get("xil_hit_weak"));
...
set_hitbox_value(AT_UTILT, 3, HG_HITBOX_Y, -71);
...
set_hitbox_value(AT_UTILT, 3, HG_HIT_SFX, sound_get("xil_hit_weak"));