...
set_window_value(AT_NAIR, 2, AG_WINDOW_SFX, sound_get("xil_swing_weak"));
...
set_window_value(AT_NAIR, 4, AG_WINDOW_SFX, sound_get("xil_swing_med1"));
...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sound_get("xil_hit_weak"));
...
set_hitbox_value(AT_NAIR, 2, HG_WIDTH, 115);
...
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, sound_get("xil_hit_med1"));
...
set_hitbox_value(AT_NAIR, 3, HG_WIDTH, 202);
...
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, sound_get("xil_hit_med1"));
...
set_hitbox_value(AT_NAIR, 4, HG_WIDTH, 167);
...
set_hitbox_value(AT_NAIR, 4, HG_HIT_SFX, sound_get("xil_hit_med1"));
...
set_hitbox_value(AT_NAIR, 5, HG_HITBOX_Y, -19);
set_hitbox_value(AT_NAIR, 5, HG_WIDTH, 167);
set_hitbox_value(AT_NAIR, 5, HG_HEIGHT, 39);
...
set_hitbox_value(AT_NAIR, 5, HG_HIT_SFX, sound_get("xil_hit_med1"));
