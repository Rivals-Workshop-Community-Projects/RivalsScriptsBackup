...
set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX, sound_get("xil_swing_heavy"));
...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("xil_hit_heavy"));
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("xil_hit_heavy"));
...
set_hitbox_value(AT_USTRONG, 3, HG_HEIGHT, 78);
...
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, sound_get("xil_hit_med2"));
...
set_hitbox_value(AT_USTRONG, 4, HG_WIDTH, 94);
...
set_hitbox_value(AT_USTRONG, 4, HG_HIT_SFX, sound_get("xil_hit_med2"));