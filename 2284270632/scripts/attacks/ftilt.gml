...
set_window_value(AT_FTILT, 2, AG_WINDOW_SFX, sound_get("xil_swing_med2"));
...
set_hitbox_value(AT_FTILT, 1, HG_HITBOX_X, 85);
...
set_hitbox_value(AT_FTILT, 1, HG_ANGLE, 42);
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, sound_get("xil_hit_med2"));
...
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, sound_get("xil_hit_weak"));