...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("xil_swing_heavy"));
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("xil_hit_heavy"));
...
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, sound_get("xil_hit_med1"));