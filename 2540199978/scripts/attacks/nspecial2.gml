...
set_hitbox_value(AT_NSPECIAL_2, 2, HG_LIFETIME, 1);
...
set_hitbox_value(AT_NSPECIAL_2, 2, HG_EXTRA_HITPAUSE, 8);
...
set_hitbox_value(AT_NSPECIAL_2, 2, HG_HIT_SFX, asset_get("sfx_icehit_medium2"));
