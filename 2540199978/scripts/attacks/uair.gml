...
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, asset_get("sfx_ice_back_air"));
...
set_window_value(AT_UAIR, 3, AG_WINDOW_SFX, asset_get("sfx_ice_fspecial_hit_ground"));
...
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, asset_get("sfx_icehit_heavy1"));
