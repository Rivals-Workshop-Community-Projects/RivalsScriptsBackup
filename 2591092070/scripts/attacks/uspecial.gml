...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.5);
...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.75);
set_window_value(AT_USPECIAL, 3, AG_WINDOW_VSPEED, 7);
set_window_value(AT_USPECIAL, 3, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_abyss_explosion"));
...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_CUSTOM_GRAVITY, -0.3);
set_window_value(AT_USPECIAL, 4, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_USPECIAL, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, 1);
...
set_hitbox_value(AT_USPECIAL, 6, HG_WIDTH, 115);
set_hitbox_value(AT_USPECIAL, 6, HG_HEIGHT, 110);
...
set_hitbox_value(AT_USPECIAL, 6, HG_HITPAUSE_SCALING, .5);
