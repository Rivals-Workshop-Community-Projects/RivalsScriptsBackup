...
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_ANIM_SPEED, 0.7);
...
set_hitbox_value(AT_FSPECIAL, 2, HG_PROJECTILE_ANIM_SPEED, 0.4);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_WIDTH, 43);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_HITPAUSE_SCALING, .55);
set_hitbox_value(AT_FSPECIAL, 3, HG_VISUAL_EFFECT, 301);
set_hitbox_value(AT_FSPECIAL, 3, HG_VISUAL_EFFECT_Y_OFFSET, -5);
set_hitbox_value(AT_FSPECIAL, 3, HG_HIT_SFX, sound_get("Hit_M"));
set_hitbox_value(AT_FSPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("fspec_proj"));
