...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_LENGTH, 22); //was 18
...
set_hitbox_value(AT_DSPECIAL, 1, HG_ANGLE, 20);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HITBOX_Y, -53);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_BASE_KNOCKBACK, 11.5);
set_hitbox_value(AT_DSPECIAL, 2, HG_BASE_HITPAUSE, 0);
set_hitbox_value(AT_DSPECIAL, 2, HG_HITSTUN_MULTIPLIER, 0.96);
