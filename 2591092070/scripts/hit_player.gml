...
if(my_hitboxID.attack == AT_USTRONG && my_hitboxID.hbox_num != 5)
{
    hit_player_obj.x = lerp(hit_player_obj.x, x, 0.5)
    hit_player_obj.y = lerp(hit_player_obj.y, y - 50, 0.5)
}
if(my_hitboxID.attack == AT_USPECIAL && my_hitboxID.hbox_num != 6)
{
    hit_player_obj.x = lerp(hit_player_obj.x, x, 0.2)
    hit_player_obj.y = lerp(hit_player_obj.y, y - 30, 0.2)
}