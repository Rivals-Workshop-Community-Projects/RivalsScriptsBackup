...
set_attack_value(AT_NSPECIAL_2, AG_SPRITE, sprite_get("fspecial_hilt"));
...
set_window_value(AT_NSPECIAL_2, 1, AG_WINDOW_SFX, asset_get("sfx_ell_utilt_retract"));
...
set_window_value(AT_NSPECIAL_2, 2, AG_WINDOW_SFX, asset_get("sfx_ell_cooldown"));
set_window_value(AT_NSPECIAL_2, 2, AG_WINDOW_SFX_FRAME, 11);
...
set_window_value(AT_NSPECIAL_2, 3, AG_WINDOW_HSPEED, -5);
...
set_hitbox_value(AT_NSPECIAL_2, 1, HG_EXTRA_HITPAUSE, 14);
set_hitbox_value(AT_NSPECIAL_2, 1, HG_HIT_SFX, asset_get("sfx_ell_steam_hit"));
set_hitbox_value(AT_NSPECIAL_2, 1, HG_VISUAL_EFFECT, 0);
