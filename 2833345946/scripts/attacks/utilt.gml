...
set_attack_value(AT_UTILT, AG_STANCE_SPRITE, sprite_get("utilt_hilt"));
...
set_window_value(AT_UTILT, 3, AG_WINDOW_VSPEED, -4);
set_window_value(AT_UTILT, 3, AG_WINDOW_VSPEED_TYPE, 2);
set_window_value(AT_UTILT, 3, AG_WINDOW_CUSTOM_GRAVITY, 0.8);
...
set_window_value(AT_UTILT, 4, AG_WINDOW_CUSTOM_GRAVITY, 1.2);
