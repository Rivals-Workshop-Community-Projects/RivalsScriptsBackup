...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX_FRAME, 14);
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_VSPEED, 14);
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.2);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_VISUAL_EFFECT, vfx_medium_sword);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_HITBOX_Y, -15);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_VISUAL_EFFECT, vfx_large_sword);
