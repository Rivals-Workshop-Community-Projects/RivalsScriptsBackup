...
set_attack_value(AT_DSPECIAL_2, AG_SPRITE, sprite_get("dspecial_hilt"));
...
set_window_value(AT_DSPECIAL_2, 2, AG_WINDOW_SFX_FRAME, 14);
...
set_window_value(AT_DSPECIAL_2, 2, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.5);

//dunk
set_window_value(AT_DSPECIAL_2, 3, AG_WINDOW_LENGTH, 15);
set_window_value(AT_DSPECIAL_2, 3, AG_WINDOW_TYPE, 9);
...
set_window_value(AT_DSPECIAL_2, 3, AG_WINDOW_VSPEED, 12);
set_window_value(AT_DSPECIAL_2, 3, AG_WINDOW_VSPEED_TYPE, 1);
set_window_value(AT_DSPECIAL_2, 3, AG_WINDOW_CUSTOM_GRAVITY, 0);


//land
set_window_value(AT_DSPECIAL_2, 4, AG_WINDOW_LENGTH, 32);
...
set_window_value(AT_DSPECIAL_2, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.2);
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_KNOCKBACK_SCALING, 0.2);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HITPAUSE_SCALING, 0);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HIT_SFX, asset_get("sfx_shovel_hit_med2"));
set_hitbox_value(AT_DSPECIAL_2, 1, HG_VISUAL_EFFECT, vfx_medium_sword);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HITBOX_GROUP, 0);
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_LIFETIME, 15);
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_HIT_SFX, asset_get("sfx_shovel_hit_med1"));
...
set_hitbox_value(AT_DSPECIAL_2, 3, HG_HITBOX_Y, -15);
...
set_hitbox_value(AT_DSPECIAL_2, 3, HG_VISUAL_EFFECT, vfx_large_sword);
