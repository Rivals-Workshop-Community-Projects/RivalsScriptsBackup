...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_ell_strong_attack_explosion"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT, vfx_small_sword);
...
set_hitbox_value(AT_USPECIAL, 3, HG_LIFETIME, 60);
...
set_hitbox_value(AT_USPECIAL, 3, HG_HIT_SFX, asset_get("sfx_shovel_hit_med1"));
...
set_hitbox_value(AT_USPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("uspec_sword_proj"));
set_hitbox_value(AT_USPECIAL, 3, HG_PROJECTILE_ANIM_SPEED, 0.2);
set_hitbox_value(AT_USPECIAL, 3, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_USPECIAL, 3, HG_PROJECTILE_HSPEED, 16);
set_hitbox_value(AT_USPECIAL, 3, HG_PROJECTILE_VSPEED, 16);
set_hitbox_value(AT_USPECIAL, 3, HG_PROJECTILE_LIFESPAN, 0);
...
set_hitbox_value(AT_USPECIAL, 3, HG_VISUAL_EFFECT, 306);