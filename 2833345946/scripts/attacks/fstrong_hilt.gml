set_attack_value(AT_FSTRONG_2, AG_SPRITE, sprite_get("fstrong_hilt"));
...
set_window_value(AT_FSTRONG_2, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.2);
...
set_window_value(AT_FSTRONG_2, 2, AG_WINDOW_SFX, asset_get("sfx_charge_blade_swing"));
...
set_window_value(AT_FSTRONG_2, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.5);
...
set_hitbox_value(AT_FSTRONG_2, 1, HG_HITBOX_Y, -35);
set_hitbox_value(AT_FSTRONG_2, 1, HG_WIDTH, 80);
set_hitbox_value(AT_FSTRONG_2, 1, HG_HEIGHT, 70);
set_hitbox_value(AT_FSTRONG_2, 1, HG_PRIORITY, 7);
...
set_hitbox_value(AT_FSTRONG_2, 1, HG_KNOCKBACK_SCALING, 0.9);
...
set_hitbox_value(AT_FSTRONG_2, 1, HG_VISUAL_EFFECT, vfx_medium_sword);
