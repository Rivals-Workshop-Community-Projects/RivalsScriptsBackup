...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, sound_get("flash start"));
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_VSPEED, 1);
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_SFX, sound_get("flash"));
...
set_window_value(AT_DSPECIAL, 5, AG_WINDOW_SFX, sound_get("flash end"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HIT_SFX, sound_get("hit_smash"));
...
set_hitbox_value(AT_DSPECIAL, 2, HG_WIDTH, 147);
set_hitbox_value(AT_DSPECIAL, 2, HG_HEIGHT, 143);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HIT_SFX, sound_get("hit_smash"));
