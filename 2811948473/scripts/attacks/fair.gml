...
set_window_value(AT_FAIR, 3, AG_WINDOW_HAS_WHIFFLAG, 25);
...
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, sound_get("hit_med"));
...
set_hitbox_value(AT_FAIR, 2, HG_WIDTH, 41);
...
set_hitbox_value(AT_FAIR, 2, HG_HIT_SFX, sound_get("hit_med"));