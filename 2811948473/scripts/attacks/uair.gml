...
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, sound_get("swipe"));
...
set_hitbox_value(AT_UAIR, 1, HG_HITBOX_X, 31);
...
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, sound_get("hit_med"));
...
set_hitbox_value(AT_UAIR, 3, HG_HIT_SFX, sound_get("hit_med"));