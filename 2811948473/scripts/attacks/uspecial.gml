...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, sound_get("psi_thunder"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT, thunderhitlarge);
set_hitbox_value(AT_USPECIAL, 1, HG_HIT_SFX, sound_get("hit_thunder"));
...
set_hitbox_value(AT_USPECIAL, 2, HG_BASE_HITPAUSE, 25);
set_hitbox_value(AT_USPECIAL, 2, HG_HITPAUSE_SCALING, .4);
set_hitbox_value(AT_USPECIAL, 2, HG_VISUAL_EFFECT, thunderhitmed);
set_hitbox_value(AT_USPECIAL, 2, HG_HIT_SFX, sound_get("hit_thunder_med"));

set_hitbox_value(AT_USPECIAL, 3, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_USPECIAL, 3, HG_WINDOW, 2);
set_hitbox_value(AT_USPECIAL, 3, HG_LIFETIME, 12);
set_hitbox_value(AT_USPECIAL, 3, HG_HITBOX_X, 3);
set_hitbox_value(AT_USPECIAL, 3, HG_HITBOX_Y, -1);
set_hitbox_value(AT_USPECIAL, 3, HG_WIDTH, 17);
set_hitbox_value(AT_USPECIAL, 3, HG_HEIGHT, 82);
...
set_hitbox_value(AT_USPECIAL, 3, HG_HIT_SFX, sound_get("hit_thunder_weak"));
