...
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT, 157);
...
set_hitbox_value(AT_USPECIAL, 2, HG_HIT_SFX, sound_get("hit_thunder"));
...
set_hitbox_value(AT_USPECIAL, 3, HG_VISUAL_EFFECT, 22);
