...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, sound_get("shock"));
...
set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX, sound_get("swipe4"));
...
set_hitbox_value(AT_USTRONG, 1, HG_ANGLE, 92);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, thunderhitmed);
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("hit_thunder_med"));
...
set_hitbox_value(AT_USTRONG, 2, HG_ANGLE, 92);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, thunderhitmed);
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("hit_thunder_med"));
...
set_hitbox_value(AT_USTRONG, 3, HG_ANGLE, 92);
...
set_hitbox_value(AT_USTRONG, 3, HG_VISUAL_EFFECT, thunderhitmed);
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, sound_get("hit_thunder_weak"));
