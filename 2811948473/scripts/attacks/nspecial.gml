...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_SFX, sound_get("psifire1"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, fire);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_HSPEED, 9.5);
