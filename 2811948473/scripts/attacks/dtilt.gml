...
set_window_value(AT_DTILT, 9, AG_WINDOW_LENGTH, 1);
set_window_value(AT_DTILT, 9, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_DTILT, 9, AG_WINDOW_ANIM_FRAME_START, 4);
...
set_hitbox_value(AT_DTILT, 3, HG_KNOCKBACK_SCALING, .25);
