...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, sound_get("swipe"));
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, sound_get("hit_smash"));
set_hitbox_value(AT_FTILT, 1, HG_EXTRA_CAMERA_SHAKE, 2000);