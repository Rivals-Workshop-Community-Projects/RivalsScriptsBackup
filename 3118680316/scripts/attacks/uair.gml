...
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, sound_get("soap_tail_whoosh_med"));
...
set_hitbox_value(AT_UAIR, 1, HG_BUBBLE_KNOCKBACK, 18);
set_hitbox_value(AT_UAIR, 1, HG_BUBBLE_ANGLE, 80)
set_hitbox_value(AT_UAIR, 1, HG_HITPAUSE_SCALING, .65);
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, -16);
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT, medium_hit1);
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, sound_get("soap_tail_hit_med"));
...
set_hitbox_value(AT_UAIR, 2, HG_BUBBLE_KNOCKBACK, 18);
set_hitbox_value(AT_UAIR, 2, HG_BUBBLE_ANGLE, 100)
...
set_hitbox_value(AT_UAIR, 2, HG_HITPAUSE_SCALING, .65);
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, -16);
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT, medium_hit1);
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, sound_get("soap_tail_hit_med"));
