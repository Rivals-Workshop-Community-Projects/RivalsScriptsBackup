...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, sound_get("soap_claw_swipe"));
...
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT, claw_hit);
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, 30);
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_Y_OFFSET, 30);
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, sound_get("soap_claw_hit"));