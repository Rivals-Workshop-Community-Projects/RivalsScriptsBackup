...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sound_get("soap_tail_whoosh_sml"));
...
set_window_value(AT_DATTACK, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .06);
set_window_value(AT_DATTACK, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DATTACK, 2, AG_WINDOW_SFX, sound_get("soap_chomp"));
...
set_hitbox_value(AT_DATTACK, 1, HG_BUBBLE_KNOCKBACK, 20);
set_hitbox_value(AT_DATTACK, 1, HG_BUBBLE_ANGLE, -5)
...
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT, chomp_hit1);
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, sound_get("soap_chomp_hit"));