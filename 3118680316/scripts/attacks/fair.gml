...
set_hitbox_value(AT_FAIR, 1, HG_BUBBLE_ANGLE, -10);
set_hitbox_value(AT_FAIR, 1, HG_BASE_HITPAUSE, 9);
set_hitbox_value(AT_FAIR, 1, HG_HITPAUSE_SCALING, .5);
set_hitbox_value(AT_FAIR, 1, HG_VISUAL_EFFECT, sweetspot_hit);
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, sound_get("soap_sweetspot"));

set_hitbox_value(AT_FAIR, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_FAIR, 2, HG_WINDOW, 2);
set_hitbox_value(AT_FAIR, 2, HG_LIFETIME, 4);
set_hitbox_value(AT_FAIR, 2, HG_HITBOX_X, 48);
set_hitbox_value(AT_FAIR, 2, HG_HITBOX_Y, -53);
...
set_hitbox_value(AT_FAIR, 2, HG_BUBBLE_KNOCKBACK, 20);
set_hitbox_value(AT_FAIR, 2, HG_BUBBLE_ANGLE, -10);
set_hitbox_value(AT_FAIR, 2, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_FAIR, 2, HG_HITPAUSE_SCALING, .4);
set_hitbox_value(AT_FAIR, 2, HG_VISUAL_EFFECT, medium_hit1);
set_hitbox_value(AT_FAIR, 2, HG_HIT_SFX, sound_get("soap_tail_hit_med"));
