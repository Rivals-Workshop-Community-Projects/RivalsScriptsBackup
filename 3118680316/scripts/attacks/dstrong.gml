...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("soap_tail_whoosh_lrg"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_BUBBLE_KNOCKBACK, 20);
set_hitbox_value(AT_DSTRONG, 1, HG_BUBBLE_ANGLE, 5)
set_hitbox_value(AT_DSTRONG, 1, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_DSTRONG, 1, HG_HITPAUSE_SCALING, .9);
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, splash_hit);
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT_X_OFFSET, 30);
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, 0);
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("soap_tail_hit_lrg"));
