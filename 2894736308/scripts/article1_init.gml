...
spr_spawn = [sprite_get("ringspawn0"), sprite_get("ringspawn1"), sprite_get("ringspawn2")]
spr_idle = [sprite_get("ringidle0"), sprite_get("ringidle1"), sprite_get("ringidle2")];
spr_burst = [sprite_get("ringburst0"), sprite_get("ringburst1"), sprite_get("ringburst2")];
spr_spent = sprite_get("ring_spent");

type = player_id.add_on;
sprite_index = spr_spawn[type];                     //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
...
nspec_hit = 0;                                  //Has been hit by nspecial already.

//anim timing variables for the remote fspecial pops
a_burstframes = [5, 3, 3, 4, 4];
o_burstframes = [4, 3, 3, 3, 3, 3, 4, 4];
e_burstframes = [5, 5, 5, 4, 3, 3, 3];

burst_frames = [a_burstframes, o_burstframes, e_burstframes];
window_timer = -1;
