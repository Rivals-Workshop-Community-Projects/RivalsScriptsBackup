...
if (!variable_instance_exists(id,"ae") || ye == true){
    ...
    //--- ---
    altsel = sound_get("switch"); // change the alt select sound here. if you don't want to change the sound, put 0 here.
    ...
    ce[0,0] = make_color_rgb(83, 83, 83) // "color preview square" color. can be any color!
    ce[0,1] = "Purified" // the name of the alternate color.
    ce[1,0] = make_color_rgb(83, 83, 83)
    ce[1,1] = "The Judge"
    ce[2,0] = make_color_rgb(83, 83, 83)
    ce[2,1] = "Zacherie"
    ce[3,0] = make_color_rgb(83, 83, 83)
    ce[3,1] = "Dedan"
    ce[4,0] = make_color_rgb(83, 83, 83)
    ce[4,1] = "Japhet"
    ce[5,0] = make_color_rgb(83, 83, 83)
    ce[5,1] = "Enoch"
    ce[6,0] = make_color_rgb(255, 255, 255)
    ce[6,1] = "Vader Eloha"
    ce[7,0] = make_color_rgb(241, 255, 47)
    ce[7,1] = "Joas"
    ce[8,0] = make_color_rgb(187, 254, 69)
    ce[8,1] = "Damien"
    ce[9,0] = make_color_rgb(233, 123, 215)
    ce[9,1] = "Bismark"
    ce[10,0] = make_color_rgb(255, 211, 57)
    ce[10,1] = "Vesper"
    ce[11,0] = make_color_rgb(77, 77, 212)
    ce[11,1] = "Le Batteur"
