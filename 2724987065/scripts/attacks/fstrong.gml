...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, sound_get("cast_fast"));
...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("roar_fast"));
...
//set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, hitfx1);
