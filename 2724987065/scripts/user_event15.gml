...
initTip("NSpecial: Elusive Jump");
initWords("You just jump really far backwards. Can normally use once per air time.");
initWords("However, you can cancel any special on hit into this. Will move in the direction opposite of your control stick (hold left = jump to the right).");
initWords("The final/strongest hit of aerials (except uair) can also cancel into this move.");
initWords("You can cancel into nspecial even if you don't have any uses left (aka you can chain aerial -> nspecial -> aerial -> nspecial forever). Fun > Balance");
...
initTip("Cancellable moves:");
initWords("Fspecial: any hit");
initWords("Uspecial: the 2nd attack (the dive)");
initWords("Dspecial: the hit that happens when you reach the ground");
initWords("Nair: the last hit");
initWords("Fair: any tipper from the upwards swipe");
initWords("Dair: the early hitbox");
initWords("Bair: the sweetspot (it's kinda obvious if you hit it)");

initTip("FSpecial: Mirage Rush");
initWords("After a needlessly long animation, dash forward really far.");
initWords("It does a ton of damage/knockback to anyone you collide with.");
initImage_ext(sprite_get("fspecial"), -4, fa_center, 1, 1, true, c_white, 1, false, noone, noone, noone, noone);

initTip("USpecial: Fang and Claw");
initWords("Swing upward and do a weak hit.");
initWords("Hold down the special button to do a strong dive attack afterwards. You will probably die if you miss the 2nd hit off ledge.");
initImage_ext(sprite_get("uspecial"), -4, fa_center, 1, 1, true, c_white, 1, false, noone, noone, noone, noone);

initTip("DSpecial: High Jump");
initWords("Jump really high then fall down, pulling anyone you come into contact with downwards.");
initWords("Does a powerful hit when you reach the ground.");
initWords("If you hit someone on the way down off ledge, a platform will spawn for you to land on (daora moment)
If you miss, you won't get a platform and you just die.");
initImage_ext(sprite_get("dspecial"), -4, fa_center, 1, 1, true, c_white, 1, false, noone, noone, noone, noone);

initTip("Passive: Reis's Blessing");
initWords("Hit enemies from above or with specials to charge the dragon gauge.");
initWords("If you hit a sourspot or hit aerials from below, the gauge goes down.");
initWords("If you fill the gauge, dspecial will upgrade to stardiver. It's slightly stronger, but much faster.");

initTip("Gauge Bonuses:");
initWords("Fspecial: any hit");
initWords("Uspecial: the 2nd attack (the dive)");
initWords("Dspecial: the hit that happens when you reach the ground");
initWords("Nair: any hit (above opponent)");
initWords("Fair: any tipper (above opponent)");
initWords("Dair: the early hitbox");
initWords("Bair: the sweetspot (above opponent)");
initWords("For aerials, any sourspots or hits from below will cause you to lose some gauge.");
	
initTip("Freya's Lore (From what i remember)");
initWords_ext("Chapter 1", fa_center, c_gray, 0, false);
initWords("Freya is a Dragon Knight from Burmecia (furry people kingdom). She left for a while for some reason (not explained), but when she came back, Burmecia was in ruins.");
initWords("The kingdom was attacked by Queen Brahne/Kuja or whatever.");
initWords("Where the hell were the other Dragon Knights during this time?");
initWords_ext("Chapter 2", fa_center, c_gray, 0, false);
initWords("Also she's in love with some hot rat guy named Fratley who's like, the only other Dragon Knight in existence i guess?");
initWords("Too bad he conveniently has amnesia and doesn't know who she is anymore.");
initWords_ext("Chapter 3", fa_center, c_gray, 0, false);
initWords("Ironically, the writers also forgot about her because her arc is completely unfinished and she doesn't do anything past the first 1/3 of the game.");
initWords("That's the entirety of her story.");
initWords("Bruh moment");
...
initPatch("About Freya", "");
initHeader("Originally developed by");
initSection("Scruff0");
initHeader("Additional SFX from");
initSection("Final Fantasy IX, Final Fantasy XIV, Guilty Gear XX, Dungeon Fighter Online");
...
CHEAT_GAUGE		= initCheat("Infinite Gauge", [0, 1], ["Off", "On"], "You get infinite Stardivers.

(Estinien would like to know your location.)");

CHEAT_JUMP		= initCheat("Infinite Nspecial", [0, 1], ["Off", "On"], "You get infinite Nspecials per airtime.

(Estinien would like to know your location. Again.)");

CHEAT_CANCEL	= initCheat("Unrestricted Cancels", [0, 1], ["Off", "On"], "You can cancel literally any attack into Nspecial.

(This bugs out the phone and you cant press b to go back anymore lmao. Just die and mash special to get back to the previous menu.)");
