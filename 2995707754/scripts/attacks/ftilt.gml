...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, asset_get("sfx_ice_uspecial_jump"));
...
set_hitbox_value(AT_FTILT, 1, HG_HITBOX_Y, -20*2);
...
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT, hfx_petshop_ice_large);
