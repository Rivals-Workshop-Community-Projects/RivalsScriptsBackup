...
set_hitbox_value(AT_NAIR, 1, HG_HITBOX_X, 20*2);
set_hitbox_value(AT_NAIR, 1, HG_HITBOX_Y, -8*2);
set_hitbox_value(AT_NAIR, 1, HG_WIDTH, 25*2);
set_hitbox_value(AT_NAIR, 1, HG_HEIGHT, 12*2);
...
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT, hfx_petshop_ice_small);
...
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_X, 8*2);
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_Y, -16*2);
...
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT, hfx_petshop_ice_small);
...
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, asset_get("sfx_icehit_weak1"));