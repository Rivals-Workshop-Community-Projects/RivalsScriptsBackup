...
set_attack_value(AT_UAIR, AG_HURTBOX_SPRITE, sprite_get("utilt_hurt"));
...
set_hitbox_value(AT_UAIR, 1, HG_HITBOX_X, 20*2);
set_hitbox_value(AT_UAIR, 1, HG_HITBOX_Y, -45*2);
set_hitbox_value(AT_UAIR, 1, HG_WIDTH, 24*2);
set_hitbox_value(AT_UAIR, 1, HG_HEIGHT, 22*2);
...
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT, hfx_petshop_ice_small);
...
set_hitbox_value(AT_UAIR, 2, HG_HITBOX_X, 34*2);
set_hitbox_value(AT_UAIR, 2, HG_HITBOX_Y, -59*2);
set_hitbox_value(AT_UAIR, 2, HG_WIDTH, 22*2);
set_hitbox_value(AT_UAIR, 2, HG_HEIGHT, 16*2);
...
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT, hfx_petshop_ice_small);
