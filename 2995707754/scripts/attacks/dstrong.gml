...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_VSPEED, .5);
...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, .4);
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_VSPEED, -3);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_Y, -2*2);
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 64*2);
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT_X_OFFSET, 24*2);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_Y, 14*2);
set_hitbox_value(AT_DSTRONG, 2, HG_WIDTH, 8*2);
set_hitbox_value(AT_DSTRONG, 2, HG_HEIGHT, 8*2);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITPAUSE_SCALING, 1.5);
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, 305);
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT_Y_OFFSET, 24);
