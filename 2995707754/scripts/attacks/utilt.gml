...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, asset_get("sfx_ice_back_air"));
...
set_hitbox_value(AT_UTILT, 1, HG_HITBOX_X, 20*2);
set_hitbox_value(AT_UTILT, 1, HG_HITBOX_Y, -24*2);
set_hitbox_value(AT_UTILT, 1, HG_WIDTH, 24*2);
set_hitbox_value(AT_UTILT, 1, HG_HEIGHT, 22*2);
...
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, hfx_petshop_ice_small);
set_hitbox_value(AT_UTILT, 1, HG_HIT_PARTICLE_NUM, 1);
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, asset_get("sfx_icehit_medium2"));

set_hitbox_value(AT_UTILT, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_UTILT, 2, HG_WINDOW, 2);
set_hitbox_value(AT_UTILT, 2, HG_LIFETIME, 2);
set_hitbox_value(AT_UTILT, 2, HG_HITBOX_X, 34*2);
set_hitbox_value(AT_UTILT, 2, HG_HITBOX_Y, -38*2);
set_hitbox_value(AT_UTILT, 2, HG_WIDTH, 22*2);
set_hitbox_value(AT_UTILT, 2, HG_HEIGHT, 16*2);
...
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, hfx_petshop_ice_small);
