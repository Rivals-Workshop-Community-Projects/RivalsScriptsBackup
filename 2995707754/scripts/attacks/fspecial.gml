...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_VSPEED, 0.4);
...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_bird_sidespecial_start"));
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_bird_sidespecial"));
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_VSPEED, -12);
...
set_window_value(AT_FSPECIAL, 5, AG_WINDOW_CUSTOM_AIR_FRICTION, .4);
set_window_value(AT_FSPECIAL, 5, AG_WINDOW_CUSTOM_GROUND_FRICTION, .4);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_X, 12*2);
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_Y, -23*2);
set_hitbox_value(AT_FSPECIAL, 1, HG_WIDTH, 24*2);
set_hitbox_value(AT_FSPECIAL, 1, HG_HEIGHT, 18*2);
