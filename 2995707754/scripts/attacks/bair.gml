...
set_window_value(AT_BAIR, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .5);
set_window_value(AT_BAIR, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, .5);
...
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_X, -10*2);
set_hitbox_value(AT_BAIR, 1, HG_HITBOX_Y, -20*2);
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 8*2);
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 8*2);
...
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_X, 6*2);
set_hitbox_value(AT_BAIR, 2, HG_HITBOX_Y, -32*2);
...
set_hitbox_value(AT_BAIR, 3, HG_HITBOX_Y, -6*2);