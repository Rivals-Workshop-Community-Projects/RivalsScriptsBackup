...
set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, asset_get("sfx_ice_uspecial_jump"));
...
set_hitbox_value(AT_FAIR, 1, HG_HITBOX_X, 30*2);
set_hitbox_value(AT_FAIR, 1, HG_HITBOX_Y, -20*2);
...
set_hitbox_value(AT_FAIR, 1, HG_VISUAL_EFFECT, hfx_petshop_ice_large);
set_hitbox_value(AT_FAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_FAIR, 1, HG_HIT_PARTICLE_NUM, 1);
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, asset_get("sfx_icehit_medium2"));
