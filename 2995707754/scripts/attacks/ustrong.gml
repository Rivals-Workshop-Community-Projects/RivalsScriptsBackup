...
set_window_value(AT_USTRONG, 1, AG_WINDOW_VSPEED, 0.2);
...
set_window_value(AT_USTRONG, 1, AG_WINDOW_CUSTOM_AIR_FRICTION, .4);
...
set_window_value(AT_USTRONG, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .5);
set_window_value(AT_USTRONG, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, .5);
...
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_X, 2*2);
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_Y, -24*2);
set_hitbox_value(AT_USTRONG, 1, HG_WIDTH, 30*2);
set_hitbox_value(AT_USTRONG, 1, HG_HEIGHT, 30*2);
...
set_hitbox_value(AT_USTRONG, 2, HG_LIFETIME, 17);
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_X, 2*2);
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_Y, -22*2);
set_hitbox_value(AT_USTRONG, 2, HG_WIDTH, 20*2);
set_hitbox_value(AT_USTRONG, 2, HG_HEIGHT, 20*2);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, hfx_petshop_wing);
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT_Y_OFFSET, 24*2);
