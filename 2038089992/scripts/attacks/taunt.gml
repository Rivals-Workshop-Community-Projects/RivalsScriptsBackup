...
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX, asset_get("sfx_orca_absorb"));
...
set_window_value(AT_TAUNT, 2, AG_WINDOW_SFX, sound_get("fish_slap_sfx1"));
...
set_window_value(AT_TAUNT, 3, AG_WINDOW_SFX, asset_get("sfx_waterwarp"));
