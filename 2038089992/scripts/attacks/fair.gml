...
//water blast
set_window_value(AT_FAIR, 4, AG_WINDOW_LENGTH, 20);
...
set_window_value(AT_FAIR, 4, AG_WINDOW_SFX, asset_get("sfx_swish_weak"));
...
set_hitbox_value(AT_FAIR, 1, HG_HITBOX_Y, 0);
...
set_hitbox_value(AT_FAIR, 3, HG_HIT_SFX, asset_get("sfx_waterhit_medium"));
set_hitbox_value(AT_FAIR, 3, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_FAIR, 3, HG_VISUAL_EFFECT, 150);
