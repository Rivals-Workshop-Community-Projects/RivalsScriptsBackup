...
set_hitbox_value(AT_USTRONG, 3, HG_HITSTUN_MULTIPLIER, 0.3);
set_hitbox_value(AT_USTRONG, 3, HG_VISUAL_EFFECT, 144);
...
set_hitbox_value(AT_USTRONG, 5, HG_LIFETIME, 40);
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_X, 15);
set_hitbox_value(AT_USTRONG, 5, HG_HITBOX_Y, -32);
set_hitbox_value(AT_USTRONG, 5, HG_SHAPE, 0);
set_hitbox_value(AT_USTRONG, 5, HG_WIDTH, 15);
set_hitbox_value(AT_USTRONG, 5, HG_HEIGHT, 15);
...
set_hitbox_value(AT_USTRONG, 5, HG_VISUAL_EFFECT, 144);
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_SPRITE, sprite_get("steam_particle1"));
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_ANIM_SPEED, 0);
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_HSPEED, -1);
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_VSPEED, 1);
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_GRAVITY, 0.1);
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_GROUND_FRICTION, 0);
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_AIR_FRICTION, 0.1);
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_WALL_BEHAVIOR, 0);
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_GROUND_BEHAVIOR, 2);
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_ENEMY_BEHAVIOR, 1);
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_PARRY_STUN, 0);
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_DOES_NOT_REFLECT, 0);
set_hitbox_value(AT_USTRONG, 5, HG_PROJECTILE_IS_TRANSCENDENT, 0);
