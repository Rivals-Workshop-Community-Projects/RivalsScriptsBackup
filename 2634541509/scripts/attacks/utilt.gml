...
set_window_value(AT_UTILT, 1, AG_WINDOW_GOTO, 4);
...
set_window_value(AT_UTILT, 2, AG_WINDOW_GOTO, 5);
...
set_window_value(AT_UTILT, 3, AG_WINDOW_GOTO, 6);
...
set_window_value(AT_UTILT, 4, AG_WINDOW_HAS_WHIFFLAG, 20);
set_window_value(AT_UTILT, 4, AG_WINDOW_GOTO, 7);
...
set_window_value(AT_UTILT, 5, AG_WINDOW_HAS_WHIFFLAG, 20);
set_window_value(AT_UTILT, 5, AG_WINDOW_GOTO, 7);
...
set_window_value(AT_UTILT, 6, AG_WINDOW_HAS_WHIFFLAG, 20);
set_window_value(AT_UTILT, 6, AG_WINDOW_GOTO, 7);

set_window_value(AT_UTILT, 7, AG_WINDOW_TYPE, 1);
set_window_value(AT_UTILT, 7, AG_WINDOW_LENGTH, 1);
set_window_value(AT_UTILT, 7, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_UTILT, 7, AG_WINDOW_ANIM_FRAME_START, 4);
set_window_value(AT_UTILT, 7, AG_WINDOW_HAS_WHIFFLAG, 0);
...
set_hitbox_value(AT_UTILT, 3, HG_PRIORITY, 7);
