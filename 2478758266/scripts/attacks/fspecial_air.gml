...
set_attack_value(AT_FSPECIAL_AIR, AG_SPRITE, sprite_get("pklifeup"));
...
set_attack_value(AT_FSPECIAL_AIR, AG_AIR_SPRITE, sprite_get("pklifeup"));
set_attack_value(AT_FSPECIAL_AIR, AG_HURTBOX_SPRITE, sprite_get("pklifeup_hurt"));
...
set_window_value(AT_FSPECIAL_AIR, 2, AG_WINDOW_LENGTH, 35);
set_window_value(AT_FSPECIAL_AIR, 2, AG_WINDOW_ANIM_FRAMES, 9);
set_window_value(AT_FSPECIAL_AIR, 2, AG_WINDOW_ANIM_FRAME_START, 3);

set_window_value(AT_FSPECIAL_AIR, 3, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSPECIAL_AIR, 3, AG_WINDOW_LENGTH, 60);
set_window_value(AT_FSPECIAL_AIR, 3, AG_WINDOW_ANIM_FRAMES, 12);
set_window_value(AT_FSPECIAL_AIR, 3, AG_WINDOW_ANIM_FRAME_START, 23);
set_window_value(AT_FSPECIAL_AIR, 3, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FSPECIAL_AIR, 3, AG_WINDOW_SFX, sound_get("offenseup"));
...
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_HITBOX_Y, -140);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_HITBOX_X, -60);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_WIDTH, 90);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_HEIGHT, 60);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_PROJECTILE_SPRITE, sprite_get("offenseup"));
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_PROJECTILE_MASK, sprite_get("offenseup"));
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_PROJECTILE_ANIM_SPEED, .7);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_PROJECTILE_GROUND_FRICTION, 1);
