...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("bash"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("bash"));
...
set_hitbox_value(AT_DSTRONG, 3, HG_HIT_SFX, sound_get("bash"));
