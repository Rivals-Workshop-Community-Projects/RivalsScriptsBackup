...
set_window_value(AT_JAB, 1, AG_WINDOW_SFX, sound_get("swinga"));
...
set_window_value(AT_JAB, 4, AG_WINDOW_SFX, sound_get("swingb"));
...
set_window_value(AT_JAB, 7, AG_WINDOW_SFX, sound_get("swingc"));
...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("jaba"));
...
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, sound_get("jabb"));
...
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, sound_get("jabc"));
