...
set_hitbox_value(AT_NSPECIAL_AIR, 5, HG_ANGLE, 270);
...
set_hitbox_value(AT_NSPECIAL_AIR, 6, HG_ANGLE, 270);
...
set_hitbox_value(AT_NSPECIAL_AIR, 10, HG_BASE_KNOCKBACK, 15);
...
set_hitbox_value(AT_NSPECIAL_AIR, 11, HG_BASE_KNOCKBACK, 15);
