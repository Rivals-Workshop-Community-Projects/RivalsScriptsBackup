...
set_window_value(AT_UTILT, 4, AG_WINDOW_TYPE, 1); //Kick 2
...
set_window_value(AT_UTILT, 5, AG_WINDOW_TYPE, 1); //Endlag
set_window_value(AT_UTILT, 5, AG_WINDOW_LENGTH, 12);
set_window_value(AT_UTILT, 5, AG_WINDOW_ANIM_FRAMES, 7);
...
set_hitbox_value(AT_UTILT, 1, HG_ANGLE, 81);
