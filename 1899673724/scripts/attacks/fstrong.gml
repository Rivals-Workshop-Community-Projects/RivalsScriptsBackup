...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("sfx_sonic_fstrong_spin"));
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX, sound_get("sfx_sonic_fstrong_swipe"));
