...
set_window_value(AT_UAIR, 3, AG_WINDOW_SFX, sound_get("sfx_sonic_upair_clap"));
...
set_hitbox_value(AT_UAIR, 2, HG_MUNO_HITBOX_NAME, "Second Hitbox");
...
set_hitbox_value(AT_UAIR, 2, HG_WIDTH, 102);
