...
set_hitbox_value(AT_FSPECIAL, 2, HG_KNOCKBACK_SCALING, 0.85);
set_hitbox_value(AT_FSPECIAL, 2, HG_BASE_HITPAUSE, 14);
set_hitbox_value(AT_FSPECIAL, 2, HG_HITPAUSE_SCALING, .75);
set_hitbox_value(AT_FSPECIAL, 2, HG_VISUAL_EFFECT, 125);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_HEIGHT, 62);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_HITSTUN_MULTIPLIER, 0.85);
set_hitbox_value(AT_FSPECIAL, 3, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_FSPECIAL, 3, HG_HITPAUSE_SCALING, .4);
set_hitbox_value(AT_FSPECIAL, 3, HG_VISUAL_EFFECT, 256);
set_hitbox_value(AT_FSPECIAL, 3, HG_VISUAL_EFFECT_X_OFFSET, 21);
set_hitbox_value(AT_FSPECIAL, 3, HG_VISUAL_EFFECT_Y_OFFSET, 10);
set_hitbox_value(AT_FSPECIAL, 3, HG_HIT_SFX, asset_get("sfx_clairen_hit_weak"));
set_hitbox_value(AT_FSPECIAL, 3, HG_HITBOX_GROUP, 2);
set_hitbox_value(AT_FSPECIAL, 3, HG_EFFECT, 0);
set_hitbox_value(AT_FSPECIAL, 3, HG_EXTENDED_PARRY_STUN, 1.5);