...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_LENGTH, 15);    //Startup
...
set_hitbox_value(AT_USPECIAL, 1, HG_HITBOX_TYPE, 1);   //Detection hitbox
...
set_hitbox_value(AT_USPECIAL, 1, HG_WIDTH, 140);
...
set_hitbox_value(AT_USPECIAL, 2, HG_HITBOX_TYPE, 1);  //Launching grounded opponents
...
set_hitbox_value(AT_USPECIAL, 3, HG_HITBOX_TYPE, 1);  //owie hit
...
set_hitbox_value(AT_USPECIAL, 3, HG_WIDTH, 123);
set_hitbox_value(AT_USPECIAL, 3, HG_HEIGHT, 129);
set_hitbox_value(AT_USPECIAL, 3, HG_SHAPE, 0);

set_hitbox_value(AT_USPECIAL, 3, HG_PRIORITY, 1);
set_hitbox_value(AT_USPECIAL, 3, HG_DAMAGE, 14);
