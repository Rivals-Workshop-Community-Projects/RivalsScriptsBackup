...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_LENGTH, 28);
set_window_value(AT_FSTRONG, 2, AG_WINDOW_ANIM_FRAMES, 12);
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX_FRAME, 12);
