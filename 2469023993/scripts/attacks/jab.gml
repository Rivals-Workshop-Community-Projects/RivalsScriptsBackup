...
set_window_value(AT_JAB, 2, AG_WINDOW_HITPAUSE_FRAME, 0);
...
set_window_value(AT_JAB, 5, AG_WINDOW_HITPAUSE_FRAME, 0);
...
set_window_value(AT_JAB, 8, AG_WINDOW_HITPAUSE_FRAME, 0);
...
set_hitbox_value(AT_JAB, 2, HG_ANGLE, 87);
