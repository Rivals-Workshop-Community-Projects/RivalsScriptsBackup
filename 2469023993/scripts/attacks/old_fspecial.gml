...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_SFX, sound_get("shadowfling"));
...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.25);
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_SFX, sound_get("shadowrefresh"));
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_SFX_FRAME, 17);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_X, 85);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_EXTENDED_PARRY_STUN, 30);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_AIR_FRICTION, .55);
