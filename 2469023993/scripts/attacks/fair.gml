...
set_hitbox_value(AT_FAIR, 1, HG_DRIFT_MULTIPLIER, 0.5);
...
set_hitbox_value(AT_FAIR, 2, HG_HITBOX_X, 21);
...
set_hitbox_value(AT_FAIR, 4, HG_HITBOX_X, 23);
...
set_hitbox_value(AT_FAIR, 6, HG_HITBOX_X, 32);
