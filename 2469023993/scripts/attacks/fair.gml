...
set_hitbox_value(AT_FAIR, 3, HG_HITBOX_X, 29);
...
set_hitbox_value(AT_FAIR, 5, HG_HITBOX_X, 31);
...
set_hitbox_value(AT_FAIR, 6, HG_HITBOX_X, 31);
set_hitbox_value(AT_FAIR, 6, HG_HITBOX_Y, -27);
set_hitbox_value(AT_FAIR, 6, HG_WIDTH, 52);
set_hitbox_value(AT_FAIR, 6, HG_HEIGHT, 52);
