...
sprite_change_offset("dash_icon", 25, 22);
sprite_change_offset("creep_icon", 25, 22);
sprite_change_offset("bowser_icon", 25, 22);
sprite_change_offset("tom_icon", 25, 22);
sprite_change_offset("jerry_icon", 25, 22);
sprite_change_offset("meat_icon", 25, 22);
sprite_change_offset("strike_icon", 25, 22);
