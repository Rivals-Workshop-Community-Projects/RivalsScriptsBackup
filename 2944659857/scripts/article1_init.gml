...
mask_index = sprite_get("goomba_mask");

smb_is_mob = true;

spr_spawn = sprite_get("goomba_land");
subimg_spawn = 1;
sound_play(sound_get("spawn_goomba"));
...
spr_walk = sprite_get("goomba_walk");
spr_fall = sprite_get("goomba_fall");
spr_squishwalk = sprite_get("goomba_squishwalk");
