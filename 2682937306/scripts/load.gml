...
sprite_change_offset("uspecial_blastup", 52, 106);
sprite_change_offset("uspecial_blastfront", 52, 106);
...
sprite_change_offset("uspecial_floor", 40, 10);
...
drain_destroy = hit_fx_create( sprite_get( "drain_break"), 15); //Drain breaking

set_victory_bg( sprite_get("victorybg"));
set_victory_theme( sound_get("victorythemex"));