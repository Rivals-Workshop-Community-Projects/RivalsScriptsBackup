...
set_hitbox_value(AT_UAIR, 1, HG_LIFETIME, 70);
...
set_hitbox_value(AT_UAIR, 1, HG_PROJECTILE_AIR_FRICTION, 0);
set_hitbox_value(AT_UAIR, 1, HG_PROJECTILE_DESTROY_EFFECT, rock_break);
