...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_TYPE, 1); //Pulling back, getting ready
...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_bird_sidespecial_start"));
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX_FRAME, 8);

set_window_value(AT_NSPECIAL, 2, AG_WINDOW_TYPE, 1); //Shooting wind
...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_HAS_WHIFFLAG, 5);

set_num_hitboxes(AT_NSPECIAL, 1);

set_hitbox_value(AT_NSPECIAL, 1, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_NSPECIAL, 1, HG_WINDOW, 10);
set_hitbox_value(AT_NSPECIAL, 1, HG_LIFETIME, 990);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("nspecial_sandstorm_twister_startup"));
