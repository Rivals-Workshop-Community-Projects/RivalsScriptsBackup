...
set_hitbox_value(AT_DTILT,1,HG_ANGLE,340);
set_hitbox_value(AT_DTILT,1,HG_HEIGHT,68);
...
set_hitbox_value(AT_DTILT,2,HG_HITBOX_X,2);
set_hitbox_value(AT_DTILT,2,HG_HITBOX_Y,-42);
set_hitbox_value(AT_DTILT,2,HG_SHAPE,0);
set_hitbox_value(AT_DTILT,2,HG_WIDTH,60);
set_hitbox_value(AT_DTILT,2,HG_ANGLE,340);
...
set_hitbox_value(AT_DTILT,3,HG_WINDOW_CREATION_FRAME,9);
set_hitbox_value(AT_DTILT,3,HG_LIFETIME,2);
set_hitbox_value(AT_DTILT,3,HG_DAMAGE,4);
set_hitbox_value(AT_DTILT,3,HG_HITBOX_X,18);
...
set_hitbox_value(AT_DTILT,3,HG_ANGLE,310);
set_hitbox_value(AT_DTILT,3,HG_HEIGHT,68);
set_hitbox_value(AT_DTILT,3,HG_BASE_KNOCKBACK,6.4);
