...
set_attack_value(AT_DSPECIAL_2, AG_AIR_SPRITE, sprite_get("dthrow_air"));
set_attack_value(AT_DSPECIAL_2, AG_SPRITE, sprite_get("dthrow"));
...
set_attack_value(AT_DSPECIAL_2, AG_STRONG_CHARGE_WINDOW, 4);
...
set_window_value(AT_DSPECIAL_2,2,AG_WINDOW_SFX,sound_get("triple_shot"));
...
set_hitbox_value(AT_DSPECIAL_2,1,HG_PARENT_HITBOX,2);
...
set_hitbox_value(AT_DSPECIAL_2,2,HG_LIFETIME,200);
set_hitbox_value(AT_DSPECIAL_2,2,HG_DAMAGE,2);
set_hitbox_value(AT_DSPECIAL_2,2,HG_HITBOX_X,15);
...
set_hitbox_value(AT_DSPECIAL_2,2,HG_BASE_KNOCKBACK,0.1);
set_hitbox_value(AT_DSPECIAL_2,2,HG_KNOCKBACK_SCALING,0.01);
set_hitbox_value(AT_DSPECIAL_2,2,HG_HITSTUN_MULTIPLIER,0.01);
...
set_hitbox_value(AT_DSPECIAL_2,2,HG_PROJECTILE_VSPEED,15);  
set_hitbox_value(AT_DSPECIAL_2,2,HG_PROJECTILE_SPRITE,sprite_get("superscope_bullet_small"));  
set_hitbox_value(AT_DSPECIAL_2,2,HG_PROJECTILE_DESTROY_EFFECT,shadow_hit_fx);  
...
set_hitbox_value(AT_DSPECIAL_2,3,HG_LIFETIME,200);
...
set_hitbox_value(AT_DSPECIAL_2,4,HG_LIFETIME,200);
set_hitbox_value(AT_DSPECIAL_2,4,HG_DAMAGE,7);
set_hitbox_value(AT_DSPECIAL_2,4,HG_HITBOX_X,15);
...
set_hitbox_value(AT_DSPECIAL_2,4,HG_HEIGHT,16);
set_hitbox_value(AT_DSPECIAL_2,4,HG_BASE_KNOCKBACK,7);
set_hitbox_value(AT_DSPECIAL_2,4,HG_KNOCKBACK_SCALING,0.4);
set_hitbox_value(AT_DSPECIAL_2,4,HG_BASE_HITPAUSE,4);
set_hitbox_value(AT_DSPECIAL_2,4,HG_HITPAUSE_SCALING,0.1);
set_hitbox_value(AT_DSPECIAL_2,4,HG_HIT_SFX,asset_get("sfx_burnconsume"));
set_hitbox_value(AT_DSPECIAL_2,4,HG_PROJECTILE_VSPEED,15);  
set_hitbox_value(AT_DSPECIAL_2,4,HG_PROJECTILE_SPRITE,sprite_get("superscope_bullet_large"));   
set_hitbox_value(AT_DSPECIAL_2,4,HG_PROJECTILE_DESTROY_EFFECT,shadow_hit_fx);  
