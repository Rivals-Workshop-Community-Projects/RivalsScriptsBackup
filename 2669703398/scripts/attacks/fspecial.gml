...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sound_get("Infernape Cry"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_WIDTH, 93);
set_hitbox_value(AT_FSPECIAL, 1, HG_HEIGHT, 97);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_PROJECTILE_ANIM_SPEED, 2.5);
