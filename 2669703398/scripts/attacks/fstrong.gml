...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("Lucario Cry"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_X, 143);
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_Y, -44);
set_hitbox_value(AT_FSTRONG, 1, HG_WIDTH, 137);
