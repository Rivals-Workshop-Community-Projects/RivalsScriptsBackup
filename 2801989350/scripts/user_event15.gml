...
initTip("NSpecial");
initWords("NSpecial lets Nik activate his Fairy PouwerUp, summoning Plux to help him in battle.");
initImage_ext(sprite_get("nspecial"), -4, fa_center, 2, 2, true, c_white, 1, false, noone, noone, noone, noone);
initWords("When you have Plux by your side, you can use NSpecial to throw her out onto the battlefield. There, you can press NSpecial again to make her spawn a Bubble!");
initImage_ext(sprite_get("nspecial"), -4, fa_center, 2, 2, true, c_white, 1, false, noone, noone, noone, noone);

initTip("FSpecial");
initWords("Nik dashes forward with his hammer in hand, ready to swing his opponent into the air. The aerial version also gives you a little boost when you hit something, but also puts you into pratfall on whiff.");
initImage_ext(sprite_get("fspecial"), -4, fa_center, 2, 2, true, c_white, 1, false, noone, noone, noone, noone);
initImage_ext(sprite_get("fspecial_air"), -4, fa_center, 2, 2, true, c_white, 1, false, noone, noone, noone, noone);
initWords("You can also get this boost when you hit a Bubble with the aerial version!");

initTip("USpecial");
initWords("USpecial is a simply uppercut-style move. It has a sweetspot right at the beginning.");
initImage_ext(sprite_get("uspecial"), -4, fa_center, 2, 2, true, c_white, 1, false, noone, noone, noone, noone);
initWords("While Plux is at your side, you perform the 'Plux Helicopter', which goes a little further than the normal USpecial and also let's you glide afterwards.");
initImage_ext(sprite_get("uspecial_2"), -4, fa_center, 2, 2, true, c_white, 1, false, noone, noone, noone, noone);

initTip("DSpecial");
initWords("Nik's DSpecial is a simply shine you can jump-cancel on hit.");
initImage_ext(sprite_get("dspecial"), -4, fa_center, 2, 2, true, c_white, 1, false, noone, noone, noone, noone);
initWords("You can use it on Bubbles to make them a Plasma Bubble. These have higher knockback than normal Bubbles, but a smaller hitbox.");
initImage_ext(sprite_get("bubbleidle"), -6, fa_left, 1, 1, true, c_white, 1, true, noone, noone, noone, noone);
initImage_ext(sprite_get("plasma"), -4, fa_right, 1, 1, true, c_white, 1, true, 49, 100, 90, 0);
	
initTip("Dash Attack Cancel");
initWords("Nik can cancel his dash attack into ustrong. You can also do a gatling combo if you connect the first hit.");

initTip("DTilt Jump Cancel");
initWords("Nik can jump cancel his DTilt in the startup frames. It's a small window so be sure to time it right.");

initTip("Falling USpecial");
initWords("Holding down while hitting someone with USpecial will make you go fastball really fast.");

initTip("Plux Recall");
initWords("You can always recall plux by holding taunt.");

initTip("USpecial and Plux");
initWords("Using USpecial near Plux or falling into her during pratfall makes her do 'Plux Helicopter' for an extra recovery.");

initTip("NSpecial Jump Cancel");
initWords("The first few frames of NSpecial can be jumped out of.");

initTip("NSpecial2 Cancel");
initWords("You can cancel NSpecial2 by pressing parry.");
...
initPatch("0.1", "12 December, 2021");
initHeader("Munophone - Adjustments, Additions");
initSection("Upgraded to Munophone Touch.");
initHeader("Fairy Cycle - Adjustments, Fixes");
initSection("Fixed a bug where parrying during NSpecial2 disables NSpecial2 and USpecial2.
Fixed a bug where dying during NSpecial2 would let you stay in NSpecial2.
Removed hammer interactions with Plux.
When Plux hits an enemy after NSpecial2, she now throws the enemy back towards Nik instead of bouncing off of them.
You can now parry Plux after a throw. This causes Plux to enter a stun state for 180 frames.");
initHeader("Bubbles - Adjustments");
initSection("No longer have a lingering hitbox.");
initHeader("NSpecial2 - Adjustments, Fixes");
initSection("Fixed offset hurtboxes.");
initHeader("Fspecial - Adjustments");
initSection("Can now collide with a bubble.");
initHeader("Fspecial Air - Adjustments");
initSection("Can now collide with a bubble, which boosts him higher into the air.");
initHeader("Cooldown Cycle - Adjustments, Fixes");
initSection("Fixed a bug where DSpecial was disabled during the Cooldown Cycle.");
initHeader("DSpecial - Adjustments");
initSection("DSpecial2 removed.");

initPatch("About Nik", "");
initHeader("Character by");
initSection("JRetrioX (Animations, Character Concept)
Splatracer (Coding)
Lognes (Sounds)");
...
CHEAT_CYCLE		= initCheat("Cycle Freeze", [0, 1, 2], ["Nothing", "Default", "Fairy"], "Frezes to a specific cycle")
