...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, sound_get("woosh"));
...
set_window_value(AT_FSPECIAL, 3, AG_WINDOW_SFX, sound_get("fspecial_miss"));
...
set_hitbox_value(AT_FSPECIAL, 2, HG_VISUAL_EFFECT, med_effect);
set_hitbox_value(AT_FSPECIAL, 2, HG_HIT_SFX, sound_get("hammer_med"));