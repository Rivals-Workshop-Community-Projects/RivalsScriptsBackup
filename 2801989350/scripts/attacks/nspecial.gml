...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("cycle_appear"));
...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, sound_get("cycle_collect"));
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX_FRAME, 19);
