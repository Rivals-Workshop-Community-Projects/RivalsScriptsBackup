...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, sound_get("hammer_swing2"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, med_effect);
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("dstrong"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_WIDTH, 186);
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, med_effect);
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("dstrong2"));
