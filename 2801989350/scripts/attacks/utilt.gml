...
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, light_effect);
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, sound_get("punch2"));
...
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, light_effect);
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, sound_get("punch1"));