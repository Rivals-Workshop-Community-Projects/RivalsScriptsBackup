...
set_hitbox_value(AT_NSPECIAL_2, 2, HG_HIT_LOCKOUT, 2);
...
set_hitbox_value(AT_NSPECIAL_2, 3, HG_KNOCKBACK_SCALING, .3);
...
set_hitbox_value(AT_NSPECIAL_2, 4, HG_PRIORITY, 9);
