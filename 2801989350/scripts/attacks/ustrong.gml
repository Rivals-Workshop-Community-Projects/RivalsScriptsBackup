...
set_hitbox_value(AT_USTRONG, 1, HG_HEIGHT, 101);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, heavy_effect);
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("ustrong2"));
...
set_hitbox_value(AT_USTRONG, 2, HG_WIDTH, 69);
set_hitbox_value(AT_USTRONG, 2, HG_HEIGHT, 43);
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, heavy_effect);
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("ustrong"));