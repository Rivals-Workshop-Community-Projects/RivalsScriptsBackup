...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, sound_get("jump_super"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_HITBOX_Y, -67);
...
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT, light_effect);
set_hitbox_value(AT_USPECIAL, 1, HG_HIT_SFX, sound_get("punch3"));
...
set_hitbox_value(AT_USPECIAL, 2, HG_HITBOX_Y, -59);
...
set_hitbox_value(AT_USPECIAL, 2, HG_VISUAL_EFFECT, light_effect);
set_hitbox_value(AT_USPECIAL, 2, HG_HIT_SFX, sound_get("punch2"));