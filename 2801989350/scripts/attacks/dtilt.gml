...
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT, light_effect);
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, sound_get("slidekick"));
...
set_hitbox_value(AT_DTILT, 2, HG_HITBOX_Y, -22);
...
set_hitbox_value(AT_DTILT, 2, HG_VISUAL_EFFECT, light_effect);
set_hitbox_value(AT_DTILT, 2, HG_HIT_SFX, sound_get("slidekick"));