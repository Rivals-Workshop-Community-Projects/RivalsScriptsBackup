...
set_hitbox_value(AT_DAIR, 1, HG_HEIGHT, 87);
...
set_hitbox_value(AT_DAIR, 3, HG_WIDTH, 75);
...
set_hitbox_value(AT_DAIR, 3, HG_VISUAL_EFFECT, light_effect);
set_hitbox_value(AT_DAIR, 3, HG_HIT_SFX, sound_get("dair"));