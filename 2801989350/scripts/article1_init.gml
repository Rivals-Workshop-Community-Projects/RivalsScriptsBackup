...
sprite_index = sprite_get("pluxidle");              //The sprite that the article will (initially) use. Replace text in quotes with your sprite's name
image_index = 0;                                    //The frame in the animation the article should start at. 0 = beginning of animation
spr_dir = player_id.spr_dir;                        //The direction the article should face when it spawns. Here I have it set to face the same way as the character
uses_shader = true;                                 //Whether or not the article is recolored according to the character's color.gml and costume.

//State
state = 13;                                          //The behavior state the article should start in.
state_timer = 0;                                    //The point in time during that state the article should start in. (0 = beginning)
hitstop = 0;                                        //The frames remaining in hitpause. Hitpause automatically prevents movement
hsp = 1 * spr_dir;                                  //The horizontal speed of the article. Multiply by spr_dir to correctly handle forward (+) or backward (-) movement
vsp = -4;                                           //The vertical speed of the article.
grav = true;                                        //If gravity is avtive or not
fairyenergy = player_id.fairyenergy;                //Energy meter of Plux
enemyspr_dir = 0;                                   //Spr-dir of enemy that hit Plux
anglething = point_direction(x,y,player_id.x,player_id.y);
fly_dist = point_distance(x,y,player_id.x,player_id.y);
max_speed = 10;
maxx_speed = 3;
max_speedT = 20;
plux_hitID = noone;
...
idle_anim_rate = 4;                                 //Example animation speed value 1. The animation in question will increment every 4 frames in this case
idle2_anim_rate = 2;
idle3_anim_rate = 20;
taunt2_anim_rate = 50;    
die_anim_rate = 8;                                  //Example animation speed value 2.
taunt_anim_rate = 7;
die_time = 88;                                      //Example variable used in this case to determine how long the article should take to die (state 2). 
...
new_sprite = sprite_get("pluxlaunch");              //This is another part of the animation handling. It tells the game "this is the sprite this article should be using; if it's not already, switch it over please"
