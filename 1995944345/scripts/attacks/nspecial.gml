...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_syl_nspecial_plantgrowth"));
...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_may_wrap1"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_LIFETIME, 11);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_BASE_KNOCKBACK, 9.5);
set_hitbox_value(AT_NSPECIAL, 1, HG_BASE_HITPAUSE, 13);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, hit_sprites[7]);