...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, asset_get("sfx_syl_nspecial"));
...
set_window_value(AT_BAIR, 4, AG_WINDOW_HAS_WHIFFLAG, 20);
set_window_value(AT_BAIR, 4, AG_WINDOW_HITPAUSE_FRAME, 3);
set_window_value(AT_BAIR, 4, AG_WINDOW_VSPEED, -3);
set_window_value(AT_BAIR, 4, AG_WINDOW_HSPEED, -6);
...
set_window_value(AT_BAIR, 5, AG_WINDOW_HSPEED, -7);
...
set_hitbox_value(AT_BAIR, 2, HG_ANGLE, 10);
...
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT, hit_sprites[6]);
