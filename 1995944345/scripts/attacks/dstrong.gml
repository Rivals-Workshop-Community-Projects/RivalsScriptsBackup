...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_syl_ustrong_part3"));
...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_syl_ustrong_part2"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, hit_sprites[1]);
...
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, hit_sprites[1]);
...
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT, hit_sprites[3]);
