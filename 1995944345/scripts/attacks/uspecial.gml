...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_absa_cloud_place"));
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_absa_cloud_place"));
...
set_window_value(AT_USPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_forsburn_breath"));
set_window_value(AT_USPECIAL, 3, AG_WINDOW_VSPEED, -4);
set_window_value(AT_USPECIAL, 3, AG_WINDOW_VSPEED_TYPE, 2);
set_window_value(AT_USPECIAL, 3, AG_WINDOW_HSPEED_TYPE, 2);
set_window_value(AT_USPECIAL, 3, AG_WINDOW_GOTO, 9);
...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_forsburn_breath"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT, hit_sprites[3]);
...
set_hitbox_value(AT_USPECIAL, 2, HG_VISUAL_EFFECT, hit_sprites[3]);