...
set_hitbox_value(AT_JAB, 2, HG_LIFETIME, get_window_value(AT_JAB,5,AG_WINDOW_LENGTH));
...
set_hitbox_value(AT_JAB, 2, HG_KNOCKBACK_SCALING, 0.15);
set_hitbox_value(AT_JAB, 2, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_JAB, 2, HG_HITPAUSE_SCALING, 0.15);
