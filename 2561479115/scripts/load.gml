...
sprite_change_offset("downhurt", 68, 94);
sprite_change_offset("uphurt", 68, 94);
sprite_change_offset("spinhurt", 68, 94);
sprite_change_offset("crouch", 68, 94);
sprite_change_offset("walk", 30, 62);
sprite_change_offset("walkturn", 68, 94);
sprite_change_offset("dash", 70, 94);
sprite_change_offset("dashstart", 70, 94);
sprite_change_offset("dashstop", 70, 94);
sprite_change_offset("dashturn", 74, 94);

sprite_change_offset("jumpstart", 68, 94);
sprite_change_offset("jump", 68, 94);
sprite_change_offset("jump_fx", 68, 105);
sprite_change_offset("jump_fx2", 68, 105);
sprite_change_offset("doublejump", 68, 94);
sprite_change_offset("walljump", 56, 94);
sprite_change_offset("pratfall", 68, 94);
sprite_change_offset("land", 68, 94);
sprite_change_offset("landinglag", 68, 94);

sprite_change_offset("parry", 68, 94);
sprite_change_offset("shield", 68, 94);
sprite_change_offset("roll_forward", 68, 94);
sprite_change_offset("roll_backward", 68, 94);
sprite_change_offset("airdodge", 66, 94);
sprite_change_offset("airdodge_trail", 66, 94);
sprite_change_offset("waveland", 68, 94);
sprite_change_offset("tech", 68, 94);

sprite_change_offset("jab", 68, 94);
sprite_change_offset("jab_hurt", 68, 94);
sprite_change_offset("dattack", 64, 94);
sprite_change_offset("ftilt", 66, 94);
sprite_change_offset("ftilt2", 66, 94);
...
sprite_change_offset("uspecial_aa", 64, 94);
sprite_change_offset("dspecial", 64, 94);
sprite_change_offset("dspecial_air", 64, 94);
sprite_change_offset("taunt", 36, 72);

sprite_change_offset("burst", 28, 52);

sprite_change_offset("article1", 68, 94);
sprite_change_offset("article1_2", 68, 94);
sprite_change_collision_mask( "article1", false, 2, 51, 24, 85, 92, 1 );
sprite_change_collision_mask( "article1_2", false, 2, 51, 24, 85, 92, 1 );

sprite_change_offset("article2", 64, 94);
sprite_change_offset("article2half", 64, 94);
...
sprite_change_offset("article2_blink", 64, 94);
sprite_change_offset("article2_mask", 64, 94);
sprite_change_offset("article2_death", 64, 94);

sprite_change_offset("blindfire_placeholder", 74, 64);
