...
set_attack_value(AT_FAIR, AG_BULLET_LANDING_LAG, 10);
...
set_window_value(AT_FAIR, 4, AG_WINDOW_SFX, sound_get("gunshot_small"));
...
set_hitbox_value(AT_FAIR, 1, HG_HIT_SFX, sound_get("gun_hit"));
...
set_hitbox_value(atk, hboxnum, HG_ANGLE, 270);
