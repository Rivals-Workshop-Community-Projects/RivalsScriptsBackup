...
//set_window_value(AT_FSTRONG, 1, AG_WINDOW_HSPEED, -8);
...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, sound_get("clothes_rub"));
...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, sound_get("swipe_big"));

set_window_value(AT_FSTRONG, 3, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSTRONG, 3, AG_WINDOW_LENGTH, 6);//18
set_window_value(AT_FSTRONG, 3, AG_WINDOW_ANIM_FRAMES, 2);//6
set_window_value(AT_FSTRONG, 3, AG_WINDOW_ANIM_FRAME_START, 6);

set_window_value(AT_FSTRONG, 4, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSTRONG, 4, AG_WINDOW_LENGTH, 26);//10
set_window_value(AT_FSTRONG, 4, AG_WINDOW_ANIM_FRAMES, 6);//3
set_window_value(AT_FSTRONG, 4, AG_WINDOW_ANIM_FRAME_START, 8);//12
...
set_hitbox_value(AT_FSTRONG, 1, HG_LIFETIME, 3);//5
...
set_hitbox_value(AT_FSTRONG, 1, HG_ANGLE, 361);//45
...
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, plasma_hitfx);
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, 24);
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT_X_OFFSET, 10);
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, sound_get("hit_big_new"));
...
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_X, 47);
...
//set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT, plasma_hitfx);
set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT_Y_OFFSET, 24);
