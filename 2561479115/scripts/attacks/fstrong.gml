...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_LENGTH, 10);//18
set_window_value(AT_FSTRONG, 3, AG_WINDOW_ANIM_FRAMES, 4);//6
set_window_value(AT_FSTRONG, 3, AG_WINDOW_ANIM_FRAME_START, 6);

set_window_value(AT_FSTRONG, 4, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSTRONG, 4, AG_WINDOW_LENGTH, 22);//10
set_window_value(AT_FSTRONG, 4, AG_WINDOW_ANIM_FRAMES, 5);//3
set_window_value(AT_FSTRONG, 4, AG_WINDOW_ANIM_FRAME_START, 10);//12
