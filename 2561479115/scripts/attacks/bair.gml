...
set_attack_value(AT_FAIR, AG_BULLET_LANDING_LAG, 7);
...
set_window_value(AT_BAIR, 5, AG_WINDOW_VSPEED, -4);
...
set_window_value(AT_BAIR, 6, AG_WINDOW_LENGTH, 14);
...
set_hitbox_value(atk, hboxnum, HG_KNOCKBACK_SCALING, 0.8);
