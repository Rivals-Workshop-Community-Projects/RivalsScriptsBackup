...
set_attack_value(AT_FAIR, AG_BULLET_LANDING_LAG, 8);
...
set_window_value(AT_BAIR, 4, AG_WINDOW_SFX, asset_get("sfx_clairen_hit_med"));
...
set_hitbox_value(atk, hboxnum, HG_HITBOX_Y, -35);
...
set_hitbox_value(atk, hboxnum, HG_PROJECTILE_ANIM_SPEED, 0.8);
