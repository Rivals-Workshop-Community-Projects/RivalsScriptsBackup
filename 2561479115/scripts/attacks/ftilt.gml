...
set_window_value(AT_FTILT, 4, AG_WINDOW_SFX, asset_get("sfx_clairen_hit_med"));
...
set_window_value(AT_FTILT, 6, AG_WINDOW_LENGTH, 24);
...
set_hitbox_value(atk, hboxnum, HG_HITPAUSE_SCALING, 0.7);
