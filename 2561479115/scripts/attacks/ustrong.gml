...
set_hitbox_value(AT_USTRONG, 3, HG_FINAL_BASE_KNOCKBACK, 5);
...
set_hitbox_value(AT_USTRONG, 3, HG_VISUAL_EFFECT, hfx_plasma_small);
...
set_hitbox_value(AT_USTRONG, 3, HG_HITSTUN_MULTIPLIER, 0.6);
...
set_hitbox_value(AT_USTRONG, 4, HG_VISUAL_EFFECT, hfx_plasma_small);
