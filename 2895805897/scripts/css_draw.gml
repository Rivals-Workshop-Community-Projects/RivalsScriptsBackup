...
switch (alt_cur)
{
    case 1: set_outline(53, 84, 27); break;
    case 3: set_outline(138, 40, 173); break;
    case 4: set_outline(209, 209, 209); break;
    case 12: set_outline(90, 0, 0); break;
    case 17: set_outline(43, 7, 7); break; //early access / gameboy
...
//alt icons
if (alt_cur >= 13 && alt_cur <= 28) draw_sprite(sprite_get("css_icons"), alt_cur + 3, icon_x_pos, icon_y_pos);

//if (alt_cur == 30) draw_sprite(sprite_get("css_icons"), 9, icon_x_pos, icon_y_pos);
//if (alt_cur == 31) draw_sprite(sprite_get("css_icons"), 10, icon_x_pos, icon_y_pos);
