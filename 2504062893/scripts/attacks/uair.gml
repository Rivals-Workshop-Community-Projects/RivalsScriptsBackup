...
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, snd_Uair_hit);
...
set_hitbox_value(AT_UAIR, 3, HG_WINDOW_CREATION_FRAME, 16);
...
set_hitbox_value(AT_UAIR, 3, HG_HIT_SFX, snd_Uair_hit);