...
set_window_value(AT_FTILT, 2, AG_WINDOW_SFX, snd_Dattack);
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, snd_Fair_hit);
// set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, snd_Ftilt_hit);
