...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, asset_get("sfx_bird_nspecial2"));
...
set_window_value(AT_NAIR, 2, AG_WINDOW_SFX, asset_get("sfx_bird_nspecial2"));
...
set_hitbox_value(AT_NAIR, 1, HG_ANGLE_FLIPPER, 10); //9
...
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_NAIR, 2, HG_WINDOW, 2);
set_hitbox_value(AT_NAIR, 2, HG_WINDOW_CREATION_FRAME, 8); // 8 (test)
