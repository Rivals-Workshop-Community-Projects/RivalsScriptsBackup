...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, snd_Dtilt);
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX_FRAME, 2);

set_window_value(AT_DTILT, 2, AG_WINDOW_TYPE, 1);
set_window_value(AT_DTILT, 2, AG_WINDOW_LENGTH, 7); //11
set_window_value(AT_DTILT, 2, AG_WINDOW_HSPEED, 9); //7
...
set_hitbox_value(AT_DTILT, 1, HG_HITBOX_X, 12);
