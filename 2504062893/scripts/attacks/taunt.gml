...
set_window_value(AT_TAUNT, 1, AG_WINDOW_LENGTH, 108);
set_window_value(AT_TAUNT, 1, AG_WINDOW_ANIM_FRAMES, 27);
set_window_value(AT_TAUNT, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_TAUNT, 1, AG_WINDOW_SFX, snd_Taunt);
