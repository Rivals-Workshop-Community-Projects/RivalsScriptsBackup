...
temp_has_airdodge = false;
yet_another_uspec_timer = -1; // another  attempt at teleport invincibilty bug...
yet_another_uspec_timer_length = 20;
...
air_friction = .03; // 0.02, which was extremely low
max_djumps = 1;
...
gravity_speed = .5;
hitstun_grav = .48; //0.5 = base value
knockback_adj = 1.1; //old: 1.15 //the multiplier to KB dealt to you. 1 = default, >1 = lighter, <1 = heavier

land_time = 4; //normal landing frames
prat_land_time = 20; // not sure how much this should be
wave_land_time = 8;
