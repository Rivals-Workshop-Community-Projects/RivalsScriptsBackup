...
set_attack_value(AT_USPECIAL_2, AG_AIR_SPRITE, sprite_get("uspecial_2_prat"));
set_attack_value(AT_USPECIAL_2, AG_HURTBOX_SPRITE, sprite_get("uspecial_2_hurt"));
set_attack_value(AT_USPECIAL_2, AG_HURTBOX_AIR_SPRITE, sprite_get("uspecial_2_prat_hurt"));
//set_attack_value(AT_USPECIAL_2, AG_USES_CUSTOM_GRAVITY, 1);

set_window_value(AT_USPECIAL_2, 1, AG_WINDOW_TYPE, 69);
...
set_window_value(AT_USPECIAL_2, 2, AG_WINDOW_TYPE, 420);
...
//set_window_value(AT_USPECIAL_2, 2, AG_WINDOW_GOTO, 6);

set_window_value(AT_USPECIAL_2, 3, AG_WINDOW_TYPE, 666);
set_window_value(AT_USPECIAL_2, 3, AG_WINDOW_LENGTH, 120);
...
set_hitbox_value(AT_USPECIAL_2, 1, HG_HIT_SFX, asset_get("sfx_absa_singlezap2"));
