...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_TYPE, 420);
...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_TYPE, 69);
...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_GOTO, 3);
set_window_value(AT_USPECIAL, 4, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_absa_kickhit"));
...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_TYPE, 88);
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_TYPE, 111);
...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_ori_spirit_flame_hit_2"));
set_window_value(AT_USPECIAL, 4, AG_WINDOW_SFX_FRAME, 9);

set_window_value(AT_USPECIAL, 5, AG_WINDOW_TYPE, 420);
...
set_window_value(AT_USPECIAL, 6, AG_WINDOW_SFX, asset_get("sfx_ori_spirit_flame_hit_1"));
