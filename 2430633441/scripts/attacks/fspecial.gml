...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_TYPE, 420);
...
set_window_value(AT_FSPECIAL, 5, AG_WINDOW_TYPE, 420);
...
set_window_value(AT_FSPECIAL, 5, AG_WINDOW_SFX, asset_get("sfx_ori_taunt2"));
