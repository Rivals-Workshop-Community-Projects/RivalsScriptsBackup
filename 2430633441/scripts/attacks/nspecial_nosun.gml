...
set_attack_value(AT_NSPECIAL_2, AG_HAS_LANDING_LAG, 3);
...
set_window_value(AT_NSPECIAL_2, 1, AG_WINDOW_SFX, asset_get("sfx_ell_drill_stab"));
...
set_window_value(AT_NSPECIAL_2, 2, AG_WINDOW_SFX, asset_get("sfx_shovel_swing_med1"));
...
set_hitbox_value(AT_NSPECIAL_2, 1, HG_VISUAL_EFFECT, hitfx[9]);
