...
set_attack_value(AT_DSPECIAL, 99, sprite_get("dspecial_remote"));
...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_absa_whip_charge"));
...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_ori_dash_attack_perform"));

set_window_value(AT_DSPECIAL, 3, AG_WINDOW_TYPE, 69);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_ori_seinhit_weak"));
