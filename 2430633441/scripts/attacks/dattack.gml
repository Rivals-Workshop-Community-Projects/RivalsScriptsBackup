...
set_window_value(AT_DATTACK, 1, AG_WINDOW_TYPE, 69);
...
set_window_value(AT_DATTACK, 2, AG_WINDOW_TYPE, 420);
...
set_hitbox_value(AT_DATTACK, 1, HG_BASE_KNOCKBACK, 13.9);
set_hitbox_value(AT_DATTACK, 1, HG_FINAL_BASE_KNOCKBACK, 12);
...
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, asset_get("sfx_ori_spirit_flame_hit_2"));
