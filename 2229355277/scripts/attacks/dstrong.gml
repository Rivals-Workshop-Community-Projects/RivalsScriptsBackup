...
set_hitbox_value(AT_DSTRONG, 1, HG_HEIGHT, 47);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("hit_heavy1"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("hit_heavy1"));
