...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, sound_get("omoriattack"));
...
//choose what you want do next/endlag into pratfall
...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_SFX, sound_get("omoriattack2"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_WIDTH, 37);
...
set_hitbox_value(AT_USPECIAL, 2, HG_WIDTH, 59);
