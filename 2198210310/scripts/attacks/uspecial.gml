...
set_hitbox_value(AT_USPECIAL, 5, HG_HIT_SFX, asset_get("sfx_ell_steam_hit"));
set_hitbox_value(AT_USPECIAL, 5, HG_VISUAL_EFFECT, 144);
...
set_hitbox_value(AT_USPECIAL, 6, HG_PROJECTILE_SPRITE, sprite_get("extinguisher_vfx"));
