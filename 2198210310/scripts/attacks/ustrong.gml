...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_bird_upspecial"));
...
set_hitbox_value(AT_USTRONG, 1, HG_WIDTH, 135);
...
set_hitbox_value(AT_USTRONG, 2, HG_GROUNDEDNESS, 1);
...
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_Y, -37);
