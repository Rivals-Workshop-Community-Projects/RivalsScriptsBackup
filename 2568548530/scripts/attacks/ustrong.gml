...
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_Y, -82);
...
set_hitbox_value(AT_USTRONG, 3, HG_ANGLE, 70);//45 //90
...
set_hitbox_value(AT_USTRONG, 4, HG_HITBOX_Y, -82);
...
set_hitbox_value(AT_USTRONG, 4, HG_ANGLE, 110);//135 //90
