...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, sound_get("sfx_utilt"));
...
set_hitbox_value(AT_UTILT, 1, HG_BASE_KNOCKBACK, 8); //was 9
...
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, 164);
...
set_hitbox_value(AT_UTILT, 2, HG_BASE_KNOCKBACK, 8); //was 9
set_hitbox_value(AT_UTILT, 2, HG_KNOCKBACK_SCALING, .8);
set_hitbox_value(AT_UTILT, 2, HG_BASE_HITPAUSE, 9.5);
set_hitbox_value(AT_UTILT, 2, HG_HITPAUSE_SCALING, .9);
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT_Y_OFFSET, -16);
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, asset_get("sfx_ell_strong_attack_explosion"));
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, 164);