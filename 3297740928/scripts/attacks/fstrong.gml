...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX, sound_get("sfx_fstrongfinal"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_WIDTH, 126);
...
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT_X_OFFSET, 5);
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, -5);
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, asset_get("sfx_ell_dspecial_explosion_2"));
...
set_hitbox_value(AT_FSTRONG, 2, HG_HITBOX_X, 84);
...
set_hitbox_value(AT_FSTRONG, 4, HG_HITBOX_X, 84);
...
set_hitbox_value(AT_FSTRONG, 5, HG_WINDOW_CREATION_FRAME, 10);
set_hitbox_value(AT_FSTRONG, 5, HG_LIFETIME, 2);
set_hitbox_value(AT_FSTRONG, 5, HG_HITBOX_X, 84);
...
set_hitbox_value(AT_FSTRONG, 6, HG_WINDOW_CREATION_FRAME, 12);
set_hitbox_value(AT_FSTRONG, 6, HG_LIFETIME, 3);
set_hitbox_value(AT_FSTRONG, 6, HG_HITBOX_X, 84);
set_hitbox_value(AT_FSTRONG, 6, HG_HITBOX_Y, -35);
set_hitbox_value(AT_FSTRONG, 6, HG_WIDTH, 126);
set_hitbox_value(AT_FSTRONG, 6, HG_HEIGHT, 35);
...
set_hitbox_value(AT_FSTRONG, 6, HG_BASE_KNOCKBACK, 9); //was 10
set_hitbox_value(AT_FSTRONG, 6, HG_KNOCKBACK_SCALING, 1.05); //was 1.1
set_hitbox_value(AT_FSTRONG, 6, HG_BASE_HITPAUSE, 11);
set_hitbox_value(AT_FSTRONG, 6, HG_HITPAUSE_SCALING, 1.1);
set_hitbox_value(AT_FSTRONG, 6, HG_VISUAL_EFFECT, 143);
set_hitbox_value(AT_FSTRONG, 6, HG_VISUAL_EFFECT_X_OFFSET, 5);
set_hitbox_value(AT_FSTRONG, 6, HG_VISUAL_EFFECT_Y_OFFSET, -5);
set_hitbox_value(AT_FSTRONG, 6, HG_HIT_SFX, asset_get("sfx_ell_strong_attack_explosion"));
