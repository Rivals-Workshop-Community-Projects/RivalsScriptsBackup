...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("sfx_dstrong1"));
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, sound_get("sfx_dstrong2"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, asset_get("sfx_ell_strong_attack_explosion"));
