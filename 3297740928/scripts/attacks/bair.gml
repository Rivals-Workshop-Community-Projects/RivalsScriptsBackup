...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("sfx_bair"));
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, asset_get("sfx_ell_fist_explode"));
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, 164);