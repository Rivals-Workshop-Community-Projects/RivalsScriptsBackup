...
set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_blow_heavy1")); // sfx_shovel_hit_med2
...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, sound_get("alt_axe_strong1"));
...
set_hitbox_value(AT_USTRONG, 2, HG_BASE_KNOCKBACK, 7.5);
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, sound_get("alt_axe_strong1"));
...
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, sound_get("alt_axe_strong1"));
...
if(has_rune("G")){
    ...
    set_hitbox_value(AT_USTRONG, 4, HG_DAMAGE, 21);
    set_hitbox_value(AT_USTRONG, 4, HG_ANGLE, 90);
    set_hitbox_value(AT_USTRONG, 4, HG_BASE_KNOCKBACK, 8);
    set_hitbox_value(AT_USTRONG, 4, HG_KNOCKBACK_SCALING, 1.35);
    set_hitbox_value(AT_USTRONG, 4, HG_BASE_HITPAUSE, 18);
    set_hitbox_value(AT_USTRONG, 4, HG_HITPAUSE_SCALING, .5);
    set_hitbox_value(AT_USTRONG, 4, HG_HIT_SFX, sound_get("alt_axe_strong1"));
    set_hitbox_value(AT_USTRONG, 4, HG_VISUAL_EFFECT, 1);
    set_hitbox_value(AT_USTRONG, 4, HG_EFFECT, 2);
    ...
    set_hitbox_value(AT_USTRONG, 6, HG_HITBOX_X, -45);
    ...
    set_hitbox_value(AT_USTRONG, 6, HG_DAMAGE, 21);
    set_hitbox_value(AT_USTRONG, 6, HG_ANGLE, 90);
    set_hitbox_value(AT_USTRONG, 6, HG_BASE_KNOCKBACK, 8);
    set_hitbox_value(AT_USTRONG, 6, HG_KNOCKBACK_SCALING, 1.35);
    set_hitbox_value(AT_USTRONG, 6, HG_BASE_HITPAUSE, 18);
    set_hitbox_value(AT_USTRONG, 6, HG_HITPAUSE_SCALING, .5);
    set_hitbox_value(AT_USTRONG, 6, HG_HIT_SFX, sound_get("alt_axe_strong1"));
    set_hitbox_value(AT_USTRONG, 6, HG_VISUAL_EFFECT, 1);
    set_hitbox_value(AT_USTRONG, 6, HG_EFFECT, 2);
}
