...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_ANIM_FRAME_START, 3); // 2
...
set_hitbox_value(AT_DSTRONG, 1, HG_ANGLE, 145);
...
set_hitbox_value(AT_DSTRONG, 5, HG_HITBOX_X, -48);
...
set_hitbox_value(AT_DSTRONG, 6, HG_HITBOX_Y, -27);
...
set_hitbox_value(AT_DSTRONG, 7, HG_HITBOX_X, -26);
...
set_hitbox_value(AT_DSTRONG, 9, HG_HITBOX_Y, -28);
set_hitbox_value(AT_DSTRONG, 9, HG_WIDTH, 60);
...
set_hitbox_value(AT_DSTRONG, 9, HG_ANGLE, 130);
...
set_hitbox_value(AT_DSTRONG, 9, HG_HITSTUN_MULTIPLIER, 1);
...
set_hitbox_value(AT_DSTRONG, 10, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_DSTRONG, 10, HG_BASE_HITPAUSE, 3);
set_hitbox_value(AT_DSTRONG, 10, HG_HITSTUN_MULTIPLIER, 1);
...
set_hitbox_value(AT_DSTRONG, 10, HG_TECHABLE, 3);
...
set_hitbox_value(AT_DSTRONG, 11, HG_HITBOX_Y, -27);
set_hitbox_value(AT_DSTRONG, 11, HG_WIDTH, 60);
set_hitbox_value(AT_DSTRONG, 11, HG_HEIGHT, 45);
...
set_hitbox_value(AT_DSTRONG, 11, HG_TECHABLE, 3);

for(var i = 1; i <= 11; i++){
    set_hitbox_value(AT_DSTRONG, i, HG_DRIFT_MULTIPLIER, .01);
    set_hitbox_value(AT_DSTRONG, i, HG_SDI_MULTIPLIER, .01);
}
...
set_hitbox_value(AT_DSTRONG, 12, HG_DAMAGE, 7);
