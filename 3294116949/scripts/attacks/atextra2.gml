...
set_attack_value(attack, AG_SPRITE, sprite_get("lotusdance"));
...
set_hitbox_value(attack, hitbox_num, HG_KNOCKBACK_SCALING, 0.4);
set_hitbox_value(attack, hitbox_num, HG_BASE_HITPAUSE, 9);
set_hitbox_value(attack, hitbox_num, HG_HITPAUSE_SCALING, 0.8);
set_hitbox_value(attack, hitbox_num, HG_VISUAL_EFFECT, 204);
set_hitbox_value(attack, hitbox_num, HG_EXTENDED_PARRY_STUN, 1);
set_hitbox_value(attack, hitbox_num, HG_HIT_SFX, asset_get("sfx_rag_whip"));
...
set_hitbox_value(attack, hitbox_num, HG_PROJECTILE_IS_TRANSCENDENT, true);
set_hitbox_value(attack, hitbox_num, HG_PROJECTILE_DESTROY_EFFECT, 302);
...
set_hitbox_value(attack, hitbox_num, HG_PROJECTILE_MASK,-1);
set_hitbox_value(attack, hitbox_num, HG_SHAPE, 0);
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, 150); // Swap 1 for what ever window this attack is
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 0);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -0);
...
set_hitbox_value(attack, hitbox_num, HG_KNOCKBACK_SCALING, 0.3);
