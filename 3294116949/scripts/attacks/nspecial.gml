...
set_hitbox_value(AT_NSPECIAL, 4, HG_WIDTH, 84);
set_hitbox_value(AT_NSPECIAL, 4, HG_HEIGHT, 84);
...
set_hitbox_value(AT_NSPECIAL, 6, HG_WIDTH, 84);
set_hitbox_value(AT_NSPECIAL, 6, HG_HEIGHT, 84);
