...
set_hitbox_value(AT_NSPECIAL, 2, HG_DAMAGE, 4); // 6
...
set_hitbox_value(AT_NSPECIAL, 3, HG_KNOCKBACK_SCALING, 0.25);
...
set_hitbox_value(AT_NSPECIAL, 3, HG_FORCE_FLINCH, 3);
...
set_hitbox_value(AT_NSPECIAL, 5, HG_DAMAGE, 6); // 6
set_hitbox_value(AT_NSPECIAL, 5, HG_ANGLE, 80);//55
set_hitbox_value(AT_NSPECIAL, 5, HG_ANGLE_FLIPPER, 0);//6
