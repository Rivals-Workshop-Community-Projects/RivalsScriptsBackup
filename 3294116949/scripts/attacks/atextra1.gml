...
set_hitbox_value(attack, hitbox_num, HG_LIFETIME, 120); // Swap 1 for what ever window this attack is
...
set_hitbox_value(attack, hitbox_num, HG_HEIGHT, 84);
...
set_hitbox_value(attack, hitbox_num, HG_HITSTUN_MULTIPLIER, 0.5);
...
set_hitbox_value(attack, hitbox_num, HG_EFFECT, 12);
set_hitbox_value(attack, hitbox_num, HG_ANGLE_FLIPPER, 0);
...
set_hitbox_value(attack, hitbox_num, HG_EXTENDED_PARRY_STUN, 1);
set_hitbox_value(attack, hitbox_num, HG_HIT_SFX, asset_get("sfx_blow_heavy1"));
set_hitbox_value(attack, hitbox_num, HG_HITSTUN_MULTIPLIER, 0.75);
