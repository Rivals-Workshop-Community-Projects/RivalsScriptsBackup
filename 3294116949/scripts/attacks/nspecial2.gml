...
set_num_hitboxes(attack, 0); // Swap 1 for number of hitboxes
...
set_hitbox_value(attack, hitbox_num, HG_KNOCKBACK_SCALING, 0.5);
...
set_hitbox_value(attack, hitbox_num, HG_HITBOX_X, 0);
set_hitbox_value(attack, hitbox_num, HG_HITBOX_Y, -15);
set_hitbox_value(attack, hitbox_num, HG_WIDTH, 99);
