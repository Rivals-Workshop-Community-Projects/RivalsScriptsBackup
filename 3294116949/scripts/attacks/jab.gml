...
set_window_value(AT_JAB, 7, AG_WINDOW_ANIM_FRAME_START, 22);
...
set_window_value(AT_JAB, 9, AG_WINDOW_ANIM_FRAME_START, 29);
...
set_window_value(AT_JAB, 10, AG_WINDOW_ANIM_FRAME_START, 31);
...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("alt_axe1"));
...
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, sound_get("alt_axe2"));
...
set_hitbox_value(AT_JAB, 3, HG_ANGLE, 65);
set_hitbox_value(AT_JAB, 3, HG_PRIORITY, 5);
set_hitbox_value(AT_JAB, 3, HG_HITBOX_GROUP, 3);
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, sound_get("alt_axe1"));
