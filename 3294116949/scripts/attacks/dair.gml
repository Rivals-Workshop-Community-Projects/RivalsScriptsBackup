...
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, sound_get("alt_axe_strong2"));
...
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, sound_get("alt_axe_strong2"));
...
set_hitbox_value(AT_DAIR, 4, HG_WIDTH, 54);
...
set_hitbox_value(AT_DAIR, 4, HG_HIT_SFX, sound_get("alt_axe1"));
...
//set_hitbox_value(AT_DAIR, 4, HG_HIT_LOCKOUT, 1);
