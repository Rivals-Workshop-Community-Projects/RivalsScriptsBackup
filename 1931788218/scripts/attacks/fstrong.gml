...
set_attack_value(AT_FSTRONG, AG_HURTBOX_SPRITE, sprite_get("fstrong"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, 160);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HEIGHT, 31);
set_hitbox_value(AT_FSTRONG, 1, HG_SHAPE, 2);
...
set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT, 116);
set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT_Y_OFFSET, 0);
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, asset_get("sfx_blow_light1"));
