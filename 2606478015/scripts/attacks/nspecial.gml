...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_clairen_dspecial_counter_success"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, laser_gyrobounce_fx);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_BASE_HITPAUSE, 8.5);
set_hitbox_value(AT_NSPECIAL, 2, HG_HITPAUSE_SCALING, 0.45);
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("laser_uncharged"));
...
set_hitbox_value(AT_NSPECIAL, 2, HG_PROJECTILE_DESTROY_EFFECT, laser_gyrobounce_fx);