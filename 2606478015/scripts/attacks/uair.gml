...
set_hitbox_value(AT_UAIR, 1, HG_ANGLE, 255);
...
set_hitbox_value(AT_UAIR, 3, HG_ANGLE, 255);
...
set_hitbox_value(AT_UAIR, 4, HG_HEIGHT, 55);
...
set_hitbox_value(AT_UAIR, 4, HG_VISUAL_EFFECT_Y_OFFSET, -15);
...
set_hitbox_value(AT_UAIR, 5, HG_ANGLE, 255);
...
set_hitbox_value(AT_UAIR, 6, HG_HITBOX_Y, -30);
set_hitbox_value(AT_UAIR, 6, HG_WIDTH, 55);
set_hitbox_value(AT_UAIR, 6, HG_HEIGHT, 55);
set_hitbox_value(AT_UAIR, 6, HG_PRIORITY, 1);
set_hitbox_value(AT_UAIR, 6, HG_DAMAGE, 1);
set_hitbox_value(AT_UAIR, 6, HG_ANGLE, 75);
set_hitbox_value(AT_UAIR, 6, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_UAIR, 6, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_UAIR, 6, HG_VISUAL_EFFECT_Y_OFFSET, -15);
set_hitbox_value(AT_UAIR, 6, HG_HIT_SFX, asset_get("sfx_blow_weak2"));
set_hitbox_value(AT_UAIR, 6, HG_ANGLE_FLIPPER, 4);

set_hitbox_value(AT_UAIR, 7, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_UAIR, 7, HG_HITBOX_GROUP, 4);
set_hitbox_value(AT_UAIR, 7, HG_WINDOW, 2);
set_hitbox_value(AT_UAIR, 7, HG_WINDOW_CREATION_FRAME, 9);
set_hitbox_value(AT_UAIR, 7, HG_LIFETIME, 3);
set_hitbox_value(AT_UAIR, 7, HG_HITBOX_Y, -60);
set_hitbox_value(AT_UAIR, 7, HG_WIDTH, 55);
set_hitbox_value(AT_UAIR, 7, HG_HEIGHT, 55);
set_hitbox_value(AT_UAIR, 7, HG_PRIORITY, 1);
set_hitbox_value(AT_UAIR, 7, HG_DAMAGE, 1);
set_hitbox_value(AT_UAIR, 7, HG_ANGLE, 255);
set_hitbox_value(AT_UAIR, 7, HG_BASE_KNOCKBACK, 3);
set_hitbox_value(AT_UAIR, 7, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_UAIR, 7, HG_VISUAL_EFFECT_Y_OFFSET, 15);
set_hitbox_value(AT_UAIR, 7, HG_HIT_SFX, asset_get("sfx_blow_weak2"));
...
set_hitbox_value(AT_UAIR, 8, HG_WINDOW_CREATION_FRAME, 9);
set_hitbox_value(AT_UAIR, 8, HG_LIFETIME, 3);
set_hitbox_value(AT_UAIR, 8, HG_HITBOX_Y, -30);
set_hitbox_value(AT_UAIR, 8, HG_WIDTH, 55);
set_hitbox_value(AT_UAIR, 8, HG_HEIGHT, 55);
set_hitbox_value(AT_UAIR, 8, HG_PRIORITY, 1);
set_hitbox_value(AT_UAIR, 8, HG_DAMAGE, 1);
set_hitbox_value(AT_UAIR, 8, HG_ANGLE, 75);
set_hitbox_value(AT_UAIR, 8, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_UAIR, 8, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_UAIR, 8, HG_VISUAL_EFFECT_Y_OFFSET, -15);
set_hitbox_value(AT_UAIR, 8, HG_HIT_SFX, asset_get("sfx_blow_weak2"));
set_hitbox_value(AT_UAIR, 8, HG_ANGLE_FLIPPER, 4);
...
set_hitbox_value(AT_UAIR, 9, HG_WINDOW_CREATION_FRAME, 15);
set_hitbox_value(AT_UAIR, 9, HG_LIFETIME, 3);
set_hitbox_value(AT_UAIR, 9, HG_HITBOX_Y, -60);
set_hitbox_value(AT_UAIR, 9, HG_WIDTH, 60);
set_hitbox_value(AT_UAIR, 9, HG_HEIGHT, 60);
set_hitbox_value(AT_UAIR, 9, HG_PRIORITY, 1);
set_hitbox_value(AT_UAIR, 9, HG_DAMAGE, 5);
set_hitbox_value(AT_UAIR, 9, HG_ANGLE, 75);
set_hitbox_value(AT_UAIR, 9, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_UAIR, 9, HG_KNOCKBACK_SCALING, 0.8);
set_hitbox_value(AT_UAIR, 9, HG_BASE_HITPAUSE, 9);
set_hitbox_value(AT_UAIR, 9, HG_HITPAUSE_SCALING, 0.75);
set_hitbox_value(AT_UAIR, 9, HG_VISUAL_EFFECT_Y_OFFSET, 0);
set_hitbox_value(AT_UAIR, 9, HG_HIT_SFX, asset_get("sfx_blow_heavy2"));
set_hitbox_value(AT_UAIR, 9, HG_ANGLE_FLIPPER, 3);
...
set_hitbox_value(AT_UAIR, 10, HG_WINDOW_CREATION_FRAME, 15);
set_hitbox_value(AT_UAIR, 10, HG_LIFETIME, 3);
set_hitbox_value(AT_UAIR, 10, HG_HITBOX_Y, -30);
set_hitbox_value(AT_UAIR, 10, HG_WIDTH, 60);
set_hitbox_value(AT_UAIR, 10, HG_HEIGHT, 60);
...
set_hitbox_value(AT_UAIR, 10, HG_HITPAUSE_SCALING, 0.75);
set_hitbox_value(AT_UAIR, 10, HG_VISUAL_EFFECT_Y_OFFSET, -30);
set_hitbox_value(AT_UAIR, 10, HG_HIT_SFX, asset_get("sfx_blow_heavy2"));
set_hitbox_value(AT_UAIR, 10, HG_ANGLE_FLIPPER, 3);
set_hitbox_value(AT_UAIR, 10, HG_VISUAL_EFFECT, 304);