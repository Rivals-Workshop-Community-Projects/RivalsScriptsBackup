...
//if (!hitstop){
	if (!broken){
		...
		if (should_break){
			...
			//play sfx
			sound_stop(sound_get("brickbreak"));
			sound_play(sound_get("brickbreak"));
			
			//spawn particles
			var particle1 = instance_create(x, y, "obj_stage_article", 3);
			var particle2 = instance_create(x, y, "obj_stage_article", 3);
			...
			if (obj_stage_main.player_num < 4){ //disables spawning the other 2 brick particles in 4-player mode to help reduce lag
				var particle3 = instance_create(x, y, "obj_stage_article", 3);
				var particle4 = instance_create(x, y, "obj_stage_article", 3);
