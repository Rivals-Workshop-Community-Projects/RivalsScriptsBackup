...
crouching = false;
Pocket_Hitbox = noone;
Pocketed_Projectile = noone;
pocket_projectile = false;
pocket_article = false;
pocket_projectile_sprite = asset_get("empty_sprite");
pocket_projectile_sprite_imageindex = 0;
pocket_projectile_hud_sprite_original = sprite_get("nspecial_pocket_hud_icons");
pocket_projectile_hud_sprite = sprite_get("nspecial_pocket_hud_icons");
pocket_projectile_hud_sprite_imageindex = 0;
pocket_projectile_hud_sprite_basic = sprite_get("nspecial_pocket_hud_icons_basic");
pocket_projectile_hud_sprite_basic_imageindex = 0;
pocket_hsp = 0;
pocket_vsp = 0;
pocket_transcendent = 0;
pocket_grounds = 0;
pocket_walls = 0;
pocket_buff = false;
pocket_release = 0;
...
tree_chopsfx = sound_get("dspecial_tree_land");
tree_fallsfx = sound_get("dspecial_tree_land");
tree_landsfx = sound_get("dspecial_tree_land");
balloon1 = noone;
balloon2 = noone;
uspec_fuel = 300;
uspec_landed = true;
