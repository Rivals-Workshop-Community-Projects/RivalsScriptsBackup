...
voice = noone;sfx = noone;
fspecial_proj_sprite = sprite_get("fspecial_lloid");uspecial_proj_sprite = sprite_get("uspecial_balloon");
fstrong_sprite = sprite_get("fstrong");fstrong_proj_sprite = sprite_get("bowlingball");
slingshot_proj_sprite = sprite_get("slingshot_projectile");
lookuptime = 0;
upb = false;
tauntcancel = false;
loaded = false;
