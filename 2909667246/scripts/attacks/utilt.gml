...
set_window_value(AT_UTILT, 2, AG_WINDOW_SFX_FRAME, 15);
...
set_window_value(AT_UTILT, 4, AG_WINDOW_ANIM_FRAME_START, 14);
...
set_hitbox_value(AT_UTILT, 3, HG_KNOCKBACK_SCALING, .95);
