...
set_hitbox_value(AT_DSPECIAL, 2, HG_BASE_KNOCKBACK, 0); //6
set_hitbox_value(AT_DSPECIAL, 2, HG_KNOCKBACK_SCALING, 0); //0.6
...
set_hitbox_value(AT_DSPECIAL, 3, HG_PROJECTILE_GRAVITY, 0.2);
