...
set_hitbox_value(AT_DTILT, 1, HG_KNOCKBACK_SCALING, 1.05);
...
set_hitbox_value(AT_DTILT, 3, HG_KNOCKBACK_SCALING, .7);
...
set_hitbox_value(AT_DTILT, 4, HG_HITPAUSE_SCALING, 1.0);
