...
set_hitbox_value(AT_GRAB, 2, HG_DAMAGE, 6);
set_hitbox_value(AT_GRAB, 2, HG_ANGLE, 40);
set_hitbox_value(AT_GRAB, 2, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_GRAB, 2, HG_KNOCKBACK_SCALING, 0.7);
...
set_hitbox_value(AT_GRAB, 3, HG_DAMAGE, 6);
set_hitbox_value(AT_GRAB, 3, HG_ANGLE, 50);
set_hitbox_value(AT_GRAB, 3, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_GRAB, 3, HG_KNOCKBACK_SCALING, 0.7);
...
set_hitbox_value(AT_GRAB, 4, HG_DAMAGE, 6);
set_hitbox_value(AT_GRAB, 4, HG_ANGLE, 90);
set_hitbox_value(AT_GRAB, 4, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_GRAB, 4, HG_KNOCKBACK_SCALING, 0.9);
...
set_hitbox_value(AT_GRAB, 5, HG_DAMAGE, 6);
...
set_hitbox_value(AT_GRAB, 6, HG_DAMAGE, 7);
...
set_hitbox_value(AT_GRAB, 7, HG_DAMAGE, 5);
set_hitbox_value(AT_GRAB, 7, HG_ANGLE, 270);
set_hitbox_value(AT_GRAB, 7, HG_BASE_KNOCKBACK, 4);
set_hitbox_value(AT_GRAB, 7, HG_KNOCKBACK_SCALING, 0.4);
