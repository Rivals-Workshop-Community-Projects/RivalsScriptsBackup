...
set_window_value(AT_DATTACK, 3, AG_WINDOW_ANIM_FRAMES, 10);
...
set_hitbox_value(AT_DATTACK, 1, HG_WIDTH, 25);
...
set_hitbox_value(AT_DATTACK, 1, HG_PROJECTILE_DESTROY_EFFECT, 302);
set_hitbox_value(AT_DATTACK, 1, HG_ANGLE, 70);
set_hitbox_value(AT_DATTACK, 1, HG_PROJECTILE_SPRITE, sprite_get("dattack_pot"));
set_hitbox_value(AT_DATTACK, 1, HG_PROJECTILE_COLLISION_SPRITE, sprite_get("dattack_pot_collision"));
set_hitbox_value(AT_DATTACK, 1, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, asset_get("sfx_blow_medium3"));
set_hitbox_value(AT_DATTACK, 1, HG_PROJECTILE_VSPEED, -2);
set_hitbox_value(AT_DATTACK, 1, HG_PROJECTILE_HSPEED, 8.5);
set_hitbox_value(AT_DATTACK, 1, HG_PROJECTILE_GRAVITY, .4);
set_hitbox_value(AT_DATTACK, 1, HG_PROJECTILE_ENEMY_BEHAVIOR, 1);
set_hitbox_value(AT_DATTACK, 1, HG_PROJECTILE_WALL_BEHAVIOR, 2);
