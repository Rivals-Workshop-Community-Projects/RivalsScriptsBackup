...
with phone{
	...
	initAbout("About Bloppi", "Character made by Robot, based on the Sandbert with a Phone template provided by Muno");
...
if pho_has_steve_dmsg{
	...
	steve_death_message = "Steve laughed too hard";
...
if pho_has_drac_codec{
	...
	dracula_text[page] = "And what are you supposed to be?";
	page++;
	...
	// Page 3
	dracula_speaker[page] = 1;
	dracula_text[page] = "...'Funny.'";
	page++;
	
	// Page 4
	dracula_speaker[page] = 0;
	dracula_text[page] = "Get out.";
	page++;
}
