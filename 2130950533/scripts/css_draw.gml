// Start of Bloppi-specific code

var selected_color = get_player_color(player);

// 0th alt has weird eye-recoloring issues
if (selected_color == 0) {
    set_character_color_slot(2, 255, 255, 255, 1); //Eyes
}

if (get_player_color(player) == 9) {
	draw_sprite_ext(sprite_get("charselect_thanos"), 0, x + 8, y + 8, 2, 2, 0, c_white, 1);
...
if (!variable_instance_exists(id,"ae") || ye == true){
	...
	ce[0,2] = "In his Funday best." // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
	ce[1,0] = make_color_rgb(182, 117, 79)
	ce[1,1] = "Classic"
	ce[1,2] = "The original 'hehe i hav teh funni'"
	ce[2,0] = make_color_rgb(33, 76, 176)
	ce[2,1] = "Blue Blur"
	ce[2,2] = "faster faster faster faster faster"
	ce[3,0] = make_color_rgb(255, 187, 28)
	ce[3,1] = "Tails or S. Sonic"
	ce[3,2] = "I couldn't be bothered to make a distinction."
	ce[4,0] = make_color_rgb(209, 8, 8)
	ce[4,1] = "oh no"
	ce[4,2] = "oh no"
	ce[5,0] = make_color_rgb(230, 101, 222)
	ce[5,1] = "Rose"
	ce[5,2] = "Just wait a minute!~"
	ce[6,0] = make_color_rgb(54, 54, 54)
	ce[6,1] = "Alter Ego"
	ce[6,2] = "Where's that DARN fourth chaos emerald?!"
	ce[7,0] = make_color_rgb(156, 156, 156)
	ce[7,1] = "Shiny Gray"
	ce[7,2] = "It's no use!"
	ce[8,0] = make_color_rgb(30, 68, 158)
	ce[8,1] = "Hide & Seek"
	ce[8,2] = "Hello. Do you want to play with me?"
	ce[9,0] = make_color_rgb(163, 0, 184)
	ce[9,1] = "Perfect Balance"
	ce[9,2] = "As all things should be."
	ce[10,0] = make_color_rgb(0, 102, 0)
	ce[10,1] = "Yo, check it out. He turned himself into a pickle. Funniest thing I've ever seen."
	ce[10,2] = ""
