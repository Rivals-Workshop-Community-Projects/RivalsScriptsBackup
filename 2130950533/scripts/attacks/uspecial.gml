...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_ANIM_FRAMES, 0);
...
set_window_value(AT_USPECIAL, 2, AG_WINDOW_LENGTH, flight_duration);
...
set_hitbox_value(AT_USPECIAL, 1, HG_LIFETIME, flight_duration);
