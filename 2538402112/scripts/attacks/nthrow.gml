...
// set_window_value(AT_NTHROW, 1, AG_WINDOW_CUSTOM_GRAVITY, 1);
...
set_window_value(AT_NTHROW, 2, AG_WINDOW_SFX_FRAME, 0);
...
set_hitbox_value(AT_NTHROW, 1, HG_VISUAL_EFFECT, 141);
...
set_hitbox_value(AT_NTHROW, 1, HG_PROJECTILE_PLASMA_SAFE, true);