...
for(i = 1; i <= 5; i++){
    ...
    set_hitbox_value(AT_FTILT, i, HG_WIDTH, 18);
    set_hitbox_value(AT_FTILT, i, HG_HEIGHT, 14);
...
set_hitbox_value(AT_FTILT, 5, HG_KNOCKBACK_SCALING, 0.3);
set_hitbox_value(AT_FTILT, 5, HG_BASE_HITPAUSE, 7);
set_hitbox_value(AT_FTILT, 5, HG_HITPAUSE_SCALING, 0.6);
set_hitbox_value(AT_FTILT, 5, HG_VISUAL_EFFECT, HFX_MAY_LEAF_BIG);
