...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, sound_get("Move_Start"));
...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_absa_uair"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, HFX_ABS_SWEET_BIG);
