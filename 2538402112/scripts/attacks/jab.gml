...
set_hitbox_value(AT_JAB, 1, HG_VISUAL_EFFECT, HFX_MAY_LEAF_BIG);
...
set_hitbox_value(AT_JAB, 2, HG_VISUAL_EFFECT, HFX_MAY_LEAF_BIG);
...
set_hitbox_value(AT_JAB, 3, HG_HITPAUSE_SCALING, .85);
