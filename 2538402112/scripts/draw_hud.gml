...
// if !has_rune("H"){ //If FSpecial cooldown rune isn't on
draw_sprite_ext(sprite_get("wand_cooldown"), 0, temp_x+186, temp_y-12, 2, 2, 0, temp_color, 1);
if (move_cooldown[AT_FSPECIAL] > 0) draw_sprite_ext(sprite_get("wand_disabled"), 0, temp_x+186, temp_y-12, 2, 2, 0, c_white, 1);
// }

if !has_rune("M"){ //If FTilt Thorn rune isn't on
    temp_color = c_white;
