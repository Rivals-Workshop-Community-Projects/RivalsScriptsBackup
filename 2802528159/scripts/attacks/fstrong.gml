...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_ell_eject"));
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_HAS_WHIFFLAG, 4);
...
set_hitbox_value(AT_FSTRONG, 1, HG_DAMAGE, 8 + (plate_state * 2));
...
set_hitbox_value(AT_FSTRONG, 2, HG_DAMAGE, 10 + (plate_state * 2));
...
set_hitbox_value(AT_FSTRONG, 3, HG_WIDTH, 13);
set_hitbox_value(AT_FSTRONG, 3, HG_HEIGHT, 13);
set_hitbox_value(AT_FSTRONG, 3, HG_PRIORITY, 5);
set_hitbox_value(AT_FSTRONG, 3, HG_DAMAGE, 12 + (plate_state * 2));
