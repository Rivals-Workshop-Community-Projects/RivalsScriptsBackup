set_attack_value(AT_DSTRONG, AG_SPRITE, sprite_get("_dstrong"));
...
set_hitbox_value(AT_DSTRONG, 4, HG_HITSTUN_MULTIPLIER, 0.7);
...
set_hitbox_value(AT_DSTRONG, 5, HG_HITSTUN_MULTIPLIER, 0.6);