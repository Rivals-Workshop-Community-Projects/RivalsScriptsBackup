...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_ori_energyhit_heavy"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_X, 246);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_HITBOX_Y, -54);
