...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_waveland_abs"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_VISUAL_EFFECT, orb1);
set_hitbox_value(AT_DSPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, orb1);
