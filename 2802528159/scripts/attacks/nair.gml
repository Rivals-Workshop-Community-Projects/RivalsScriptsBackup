...
set_attack_value(AT_NAIR, AG_SPRITE, sprite_get(string(plate) + "NAIR"));
...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, asset_get("sfx_absa_whip3"));
...
set_window_value(AT_NAIR, 2, AG_WINDOW_SFX, asset_get("sfx_absa_boltcloud"));
...
set_hitbox_value(AT_NAIR, 3, HG_VISUAL_EFFECT, 20);
...
set_hitbox_value(AT_NAIR, 4, HG_HIT_SFX, asset_get("sfx_absa_harderhit"));