...
set_attack_value(AT_USPECIAL, AG_SPRITE, sprite_get("018"));
set_attack_value(AT_USPECIAL, AG_HURTBOX_SPRITE, sprite_get("usp_hurt"));
set_attack_value(AT_USPECIAL, AG_AIR_SPRITE, sprite_get("018a"));
set_attack_value(AT_USPECIAL, AG_HURTBOX_AIR_SPRITE, sprite_get("uspa_hurt"));
...
set_window_value(AT_USPECIAL, 6, AG_WINDOW_SFX, asset_get("sfx_clairen_dspecial_counter_success"));
...
set_hitbox_value(AT_USPECIAL, 3, HG_HITBOX_Y, -72);
