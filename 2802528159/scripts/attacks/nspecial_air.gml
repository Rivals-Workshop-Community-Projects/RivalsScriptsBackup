...
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_WIDTH, (has_rune("E")? 120: 90));
set_hitbox_value(AT_NSPECIAL_AIR, 1, HG_HEIGHT, (has_rune("E")? 100: 80));
...
set_hitbox_value(AT_NSPECIAL_AIR, 2, HG_EXTRA_HITPAUSE, 8);
