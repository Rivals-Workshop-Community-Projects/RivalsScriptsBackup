...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_LENGTH, 209);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_KNOCKBACK_SCALING, 2.2);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_DAMAGE, 30);
set_hitbox_value(AT_DSPECIAL, 2, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_DSPECIAL, 2, HG_KNOCKBACK_SCALING, 4.5);
