...
set_window_value(AT_BAIR, 2, AG_WINDOW_LENGTH, 3.5);
...
set_hitbox_value(AT_BAIR, 1, HG_LIFETIME, 3.5);
...
set_hitbox_value(AT_BAIR, 2, HG_LIFETIME, 3.5);
...
set_hitbox_value(AT_BAIR, 2, HG_EFFECT, 3);
...
set_hitbox_value(AT_BAIR, 3, HG_LIFETIME, 3.5);
...
set_hitbox_value(AT_BAIR, 3, HG_EFFECT, 3);
set_hitbox_value(AT_BAIR, 3, HG_BASE_KNOCKBACK, 3);
set_hitbox_value(AT_BAIR, 3, HG_KNOCKBACK_SCALING, 1.25);
