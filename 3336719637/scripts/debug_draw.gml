...
//for (var i = 0; i < array_length(change_strings); i++)
//{
//    if (i >= 40) draw_debug_text(floor(view_get_xview()) + 200 * 2, floor(view_get_yview()) + 128 + (i - 40) * 16, string(change_strings[i]));
//    else if (i >= 20) draw_debug_text(floor(view_get_xview()) + 200, floor(view_get_yview()) + 128 + (i - 20) * 16, string(change_strings[i]));
//    else draw_debug_text(floor(view_get_xview()), floor(view_get_yview()) + 128 + i * 16, string(change_strings[i]));
//}
