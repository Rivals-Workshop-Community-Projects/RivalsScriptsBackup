...
if (state = PS_ATTACK_GROUND || state = PS_ATTACK_AIR) && attack = AT_DSPECIAL && window = 2 && shotgun_charge%(has_rune("H")? 30:45) >= (has_rune("H")? 30:45) -5{
    var col = (!alt_cur? make_color_rgb(120, 148, 110): make_color_rgb(get_color_profile_slot_r(alt_cur, 7), get_color_profile_slot_g(alt_cur, 7), get_color_profile_slot_b(alt_cur, 7)));
    gpu_set_fog(1, col, 0, 0);
