...
// Victory
set_victory_bg(sprite_get("hitthatsickdabmonroeohyeahthatsit")); // sprites\winscreen.png - name doesn't matter, the size has to be 480 x 270 pixels big, usually has this puple filter on it
set_victory_theme(sound_get("music_win_hook")); // sounds\mus_victory.ogg - leave some silence in the file after the victory theme finishes
...
fspec_hit = hit_fx_create(sprite_get("fspecialbomb_hit"), 24);
fspec_die = hit_fx_create(sprite_get("fspecialbomb_die"), 9);
fspec_fire = hit_fx_create(sprite_get("fspecialfireeffect"), 9);

dspec1_die = hit_fx_create(sprite_get("Gascloudlevel1die"), 9);
dspec2_die = hit_fx_create(sprite_get("Gascloudlevel2die"), 9);
