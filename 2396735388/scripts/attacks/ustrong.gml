...
//set_window_value(AT_USTRONG, 4, AG_WINDOW_CUSTOM_GRAVITY, .35);
set_window_value(AT_USTRONG, 4, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_USTRONG, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, .4);
...
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_X, 02);
...
set_hitbox_value(AT_USTRONG, 1, HG_FINAL_BASE_KNOCKBACK, 5);
...
set_attack_value(AT_USTRONG_2, AG_SPRITE, sprite_get("ustrong_emp"));
set_attack_value(AT_USTRONG_2, AG_HURTBOX_SPRITE, sprite_get("ustrong_emp_hurt"));
...
set_attack_value(AT_USTRONG_2, AG_LANDING_LAG, 14);
set_attack_value(AT_USTRONG_2, AG_STRONG_CHARGE_WINDOW, 1);

set_window_value(AT_USTRONG_2, 1, AG_WINDOW_LENGTH, 13);
set_window_value(AT_USTRONG_2, 1, AG_WINDOW_ANIM_FRAMES, 5);
set_window_value(AT_USTRONG_2, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USTRONG_2, 1, AG_WINDOW_SFX, asset_get("sfx_ori_ustrong_charge"));
...
set_window_value(AT_USTRONG_2, 2, AG_WINDOW_SFX, asset_get("sfx_bird_downspecial"));
...
set_window_value(AT_USTRONG_2, 4, AG_WINDOW_LENGTH, 22);
...
set_window_value(AT_USTRONG_2, 4, AG_WINDOW_CUSTOM_GRAVITY, .35);
set_window_value(AT_USTRONG_2, 4, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_USTRONG_2, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, .4);
...
set_hitbox_value(AT_USTRONG_2, 1, HG_HITBOX_X, 2);
set_hitbox_value(AT_USTRONG_2, 1, HG_HITBOX_Y, -40);
set_hitbox_value(AT_USTRONG_2, 1, HG_WIDTH, 75);
...
set_hitbox_value(AT_USTRONG_2, 1, HG_BASE_HITPAUSE, 4);
set_hitbox_value(AT_USTRONG_2, 1, HG_EXTRA_HITPAUSE, 1);
set_hitbox_value(AT_USTRONG_2, 1, HG_VISUAL_EFFECT, 302);
set_hitbox_value(AT_USTRONG_2, 1, HG_EFFECT, 230);
...
set_hitbox_value(AT_USTRONG_2, 2, HG_WINDOW_CREATION_FRAME, 2);
set_hitbox_value(AT_USTRONG_2, 2, HG_LIFETIME, 2);
set_hitbox_value(AT_USTRONG_2, 2, HG_HITBOX_X, 2);
...
set_hitbox_value(AT_USTRONG_2, 3, HG_WINDOW_CREATION_FRAME, 4);
set_hitbox_value(AT_USTRONG_2, 3, HG_LIFETIME, 2);
set_hitbox_value(AT_USTRONG_2, 3, HG_HITBOX_X, 2);
...
set_hitbox_value(AT_USTRONG_2, 4, HG_WINDOW_CREATION_FRAME, 6);
...
set_hitbox_value(AT_USTRONG_2, 4, HG_WIDTH, 90);
set_hitbox_value(AT_USTRONG_2, 4, HG_HEIGHT, 90);
set_hitbox_value(AT_USTRONG_2, 4, HG_PRIORITY, 2);
set_hitbox_value(AT_USTRONG_2, 4, HG_DAMAGE, 6);
set_hitbox_value(AT_USTRONG_2, 4, HG_ANGLE, 90);
set_hitbox_value(AT_USTRONG_2, 4, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_USTRONG_2, 4, HG_KNOCKBACK_SCALING, .9);
set_hitbox_value(AT_USTRONG_2, 4, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_USTRONG_2, 4, HG_HITPAUSE_SCALING, .7);
set_hitbox_value(AT_USTRONG_2, 4, HG_HIT_SFX, asset_get("sfx_blow_medium3"));
set_hitbox_value(AT_USTRONG_2, 4, HG_ANGLE_FLIPPER, 0);
set_hitbox_value(AT_USTRONG_2, 4, HG_EFFECT, 229);
