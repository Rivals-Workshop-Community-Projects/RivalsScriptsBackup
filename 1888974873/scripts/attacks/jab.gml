...
set_window_value(AT_JAB, 2, AG_WINDOW_SFX, sound_get("figureFighter"));
...
set_window_value(AT_JAB, 5, AG_WINDOW_SFX, sound_get("figureFighter"));
...
set_window_value(AT_JAB, 8, AG_WINDOW_HAS_WHIFFLAG, 4);
