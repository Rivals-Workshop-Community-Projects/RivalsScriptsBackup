...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("djSchool"));
...
set_hitbox_value(AT_BAIR, 2, HG_KNOCKBACK_SCALING, .15);
...
set_hitbox_value(AT_BAIR, 3, HG_VISUAL_EFFECT, 20);
...
set_hitbox_value(AT_BAIR, 4, HG_KNOCKBACK_SCALING, .15);
...
set_hitbox_value(AT_BAIR, 4, HG_HIT_SFX, asset_get("sfx_blow_weak1"));
