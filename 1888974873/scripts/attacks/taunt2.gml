...
set_window_value(AT_TAUNT_2, 2, AG_WINDOW_SFX, sound_get("quizShow"));
...
set_window_value(AT_TAUNT_2, 3, AG_WINDOW_SFX, sound_get("quizShow2"));
...
set_window_value(AT_TAUNT_2, 5, AG_WINDOW_ANIM_FRAME_START, 2);
...
set_window_value(AT_TAUNT_2, 6, AG_WINDOW_ANIM_FRAME_START, 2);
...
set_window_value(AT_TAUNT_2, 7, AG_WINDOW_ANIM_FRAME_START, 2);
