...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX, sound_get( "freezeFrame" ));
...
set_window_value(AT_FSTRONG, 5, AG_WINDOW_HAS_WHIFFLAG, 12);
...
set_hitbox_value(AT_FSTRONG, 2, HG_ANGLE, -210);
...
set_hitbox_value(AT_FSTRONG, 3, HG_VISUAL_EFFECT, 197);
