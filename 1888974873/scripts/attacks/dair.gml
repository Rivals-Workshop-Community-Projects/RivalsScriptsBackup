...
set_window_value(AT_DAIR, 2, AG_WINDOW_ANIM_FRAMES, 12);
...
set_window_value(AT_DAIR, 3, AG_WINDOW_ANIM_FRAME_START, 15);

set_window_value(AT_DAIR, 4, AG_WINDOW_TYPE, 1);
set_window_value(AT_DAIR, 4, AG_WINDOW_LENGTH, 9);
set_window_value(AT_DAIR, 4, AG_WINDOW_ANIM_FRAMES, 1);
set_window_value(AT_DAIR, 4, AG_WINDOW_ANIM_FRAME_START, 16);
set_window_value(AT_DAIR, 4, AG_WINDOW_HAS_WHIFFLAG, 3);
