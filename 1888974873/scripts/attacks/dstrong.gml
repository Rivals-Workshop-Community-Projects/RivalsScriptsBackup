...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, sound_get("sneakySpirits"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_GROUP, 4);
...
set_hitbox_value(AT_DSTRONG, 3, HG_HITSTUN_MULTIPLIER, 1.4);
...
set_hitbox_value(AT_DSTRONG, 4, HG_WIDTH, 66);
set_hitbox_value(AT_DSTRONG, 4, HG_HEIGHT, 57);
