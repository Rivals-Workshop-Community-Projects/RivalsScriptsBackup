...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, sound_get("dazzlesHold"));
...
set_window_value(AT_DTILT, 2, AG_WINDOW_SFX, sound_get("dazzlesPose"));
...
set_hitbox_value(AT_DTILT, 1, HG_HITBOX_Y, -34);
set_hitbox_value(AT_DTILT, 1, HG_WIDTH, 80);
set_hitbox_value(AT_DTILT, 1, HG_HEIGHT, 87);
...
set_hitbox_value(AT_DTILT, 1, HG_EXTRA_HITPAUSE, 15);
...
set_hitbox_value(AT_DTILT, 2, HG_HITBOX_X, -3);
set_hitbox_value(AT_DTILT, 2, HG_HITBOX_Y, -34);
set_hitbox_value(AT_DTILT, 2, HG_WIDTH, 80);
set_hitbox_value(AT_DTILT, 2, HG_HEIGHT, 87);
...
set_hitbox_value(AT_DTILT, 2, HG_EXTRA_HITPAUSE, 7);
