...
set_window_value(AT_UAIR, 2, AG_WINDOW_SFX, sound_get("chorusKid"));
...
set_window_value(AT_UAIR, 3, AG_WINDOW_SFX, sound_get("chorusKidScream"));
...
set_window_value(AT_UAIR, 5, AG_WINDOW_HAS_WHIFFLAG, 3);
