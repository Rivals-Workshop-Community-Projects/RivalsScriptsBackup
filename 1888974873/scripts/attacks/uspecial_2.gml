...
set_window_value(AT_USPECIAL_2, 1, AG_WINDOW_SFX, sound_get("launchPartyStart2"));

set_window_value(AT_USPECIAL_2, 2, AG_WINDOW_TYPE, 1);
set_window_value(AT_USPECIAL_2, 2, AG_WINDOW_LENGTH, 7.5);
...
set_window_value(AT_USPECIAL_2, 2, AG_WINDOW_SFX, sound_get("launchPartyStart3"));

set_window_value(AT_USPECIAL_2, 3, AG_WINDOW_TYPE, 1);
set_window_value(AT_USPECIAL_2, 3, AG_WINDOW_LENGTH, 7.5);
...
set_window_value(AT_USPECIAL_2, 3, AG_WINDOW_SFX, sound_get("launchPartyStart4"));

set_window_value(AT_USPECIAL_2, 4, AG_WINDOW_TYPE, 1);
set_window_value(AT_USPECIAL_2, 4, AG_WINDOW_LENGTH, 8.5);
...
set_window_value(AT_USPECIAL_2, 4, AG_WINDOW_SFX, sound_get("launchPartyStart5"));

set_window_value(AT_USPECIAL_2, 5, AG_WINDOW_TYPE, 1);
set_window_value(AT_USPECIAL_2, 5, AG_WINDOW_LENGTH, 7.5);
...
set_window_value(AT_USPECIAL_2, 5, AG_WINDOW_SFX, sound_get("launchPartyStart6"));

set_window_value(AT_USPECIAL_2, 6, AG_WINDOW_TYPE, 1);
set_window_value(AT_USPECIAL_2, 6, AG_WINDOW_LENGTH, 2);
set_window_value(AT_USPECIAL_2, 6, AG_WINDOW_ANIM_FRAME_START, 5);
set_window_value(AT_USPECIAL_2, 6, AG_WINDOW_VSPEED, -21);
set_window_value(AT_USPECIAL_2, 6, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USPECIAL_2, 6, AG_WINDOW_SFX, sound_get("skillStar"));
...
set_hitbox_value(AT_USPECIAL_2, 1, HG_WINDOW, 6);
set_hitbox_value(AT_USPECIAL_2, 1, HG_LIFETIME, 20);
...
set_hitbox_value(AT_USPECIAL_2, 2, HG_HITBOX_Y, 24);
...
set_hitbox_value(AT_USPECIAL_2, 2, HG_KNOCKBACK_SCALING, .5);
set_hitbox_value(AT_USPECIAL_2, 2, HG_BASE_HITPAUSE, 3);
set_hitbox_value(AT_USPECIAL_2, 2, HG_VISUAL_EFFECT, 305);
set_hitbox_value(AT_USPECIAL_2, 2, HG_HIT_SFX, sound_get("fireworks"));
