...
set_hitbox_value(AT_EXTRA_1, 1, HG_PROJECTILE_MASK, sprite_get("pea"));
...
set_hitbox_value(AT_EXTRA_1, 2, HG_WIDTH, 24);
set_hitbox_value(AT_EXTRA_1, 2, HG_HEIGHT, 24);
set_hitbox_value(AT_EXTRA_1, 2, HG_PRIORITY, 1);
set_hitbox_value(AT_EXTRA_1, 2, HG_DAMAGE, 2);
set_hitbox_value(AT_EXTRA_1, 2, HG_ANGLE, 120);
...
set_hitbox_value(AT_EXTRA_1, 2, HG_PROJECTILE_MASK, sprite_get("pea"));
