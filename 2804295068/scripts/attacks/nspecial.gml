...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_LENGTH, 96);
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_ANIM_FRAMES, 24);
...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_ANIM_FRAME_START, 27);
...
set_window_value(AT_NSPECIAL, 7, AG_WINDOW_ANIM_FRAME_START, 33);
...
set_window_value(AT_NSPECIAL, 9, AG_WINDOW_ANIM_FRAME_START, 36);
...
set_window_value(AT_NSPECIAL, 11, AG_WINDOW_LENGTH, 6);
set_window_value(AT_NSPECIAL, 11, AG_WINDOW_ANIM_FRAMES, 2);
set_window_value(AT_NSPECIAL, 11, AG_WINDOW_ANIM_FRAME_START, 39);
...
set_window_value(AT_NSPECIAL, 14, AG_WINDOW_ANIM_FRAME_START, 42);
set_window_value(AT_NSPECIAL, 14, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_NSPECIAL, 14, AG_WINDOW_SFX, asset_get("sfx_rag_plant_ready"));
set_window_value(AT_NSPECIAL, 14, AG_WINDOW_SFX_FRAME, 0);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("pea"));
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_MASK, sprite_get("pea"));
