...
set_window_value(49, 2, AG_WINDOW_SFX, sound_get ("plant_food"));
...
set_hitbox_value(49, 1, HG_LIFETIME, 31);
set_hitbox_value(49, 1, HG_WIDTH, 28);
set_hitbox_value(49, 1, HG_HEIGHT, 28);
...
set_hitbox_value(49, 2, HG_LIFETIME, 31);
set_hitbox_value(49, 2, HG_WIDTH, 28);
set_hitbox_value(49, 2, HG_HEIGHT, 28);
...
set_hitbox_value(49, 3, HG_LIFETIME, 46);
