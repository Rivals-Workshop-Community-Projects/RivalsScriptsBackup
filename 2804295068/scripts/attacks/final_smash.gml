...
set_hitbox_value(49, 1, HG_PROJECTILE_MASK, sprite_get("pea"));
...
set_hitbox_value(49, 2, HG_WINDOW_CREATION_FRAME, 3);
set_hitbox_value(49, 2, HG_LIFETIME, 60);
set_hitbox_value(49, 2, HG_HITBOX_X, -4);
set_hitbox_value(49, 2, HG_HITBOX_Y, -27);
...
set_hitbox_value(49, 2, HG_HITPAUSE_SCALING, 0.6);
set_hitbox_value(49, 2, HG_HIT_SFX, sound_get("splat"));
set_hitbox_value(49, 2, HG_VISUAL_EFFECT, 303);
set_hitbox_value(49, 2, HG_PROJECTILE_SPRITE, sprite_get("pea_big"));
set_hitbox_value(49, 2, HG_PROJECTILE_MASK, sprite_get("pea_big"));
