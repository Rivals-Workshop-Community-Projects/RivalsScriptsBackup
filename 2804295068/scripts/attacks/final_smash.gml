...
set_hitbox_value(49, 2, HG_PROJECTILE_MASK, sprite_get("pea"));
...
set_hitbox_value(49, 3, HG_HIT_SFX, sound_get("splat"));
set_hitbox_value(49, 3, HG_VISUAL_EFFECT, 303);
set_hitbox_value(49, 3, HG_PROJECTILE_SPRITE, sprite_get("pea_big"));
set_hitbox_value(49, 3, HG_PROJECTILE_MASK, sprite_get("pea_big"));
