...
set_window_value(49, 1, AG_WINDOW_SFX, sound_get ("fs_powerup"));
...
set_hitbox_value(49, 1, HG_LIFETIME, 32);
...
set_hitbox_value(49, 3, HG_LIFETIME, 16);
...
set_hitbox_value(49, 3, HG_PROJECTILE_HSPEED, 32);
