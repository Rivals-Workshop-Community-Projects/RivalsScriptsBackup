...
set_hitbox_value(AT_FAIR, 2, HG_PROJECTILE_HSPEED, 16);
set_hitbox_value(AT_FAIR, 2, HG_PROJECTILE_VSPEED, -8.5);
...
set_hitbox_value(AT_FAIR, 3, HG_PROJECTILE_HSPEED, 16);
set_hitbox_value(AT_FAIR, 3, HG_PROJECTILE_VSPEED, 8.5);
