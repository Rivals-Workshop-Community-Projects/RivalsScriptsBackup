...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, sound_get("throw"));
...
set_window_value(AT_FTILT, 3, AG_WINDOW_CANCEL_FRAME, 0);
...
set_window_value(AT_FTILT, 4, AG_WINDOW_SFX, sound_get("throw"));
...
set_hitbox_value(AT_FTILT, 2, HG_HITSTUN_MULTIPLIER, 0.6);