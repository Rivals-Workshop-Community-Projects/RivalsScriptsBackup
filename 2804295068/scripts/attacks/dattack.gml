...
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.75);
...
set_hitbox_value(AT_DATTACK, 1, HG_HITBOX_Y, -19);
...
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, asset_get("sfx_leafy_hit2"));
...
set_hitbox_value(AT_DATTACK, 2, HG_HITBOX_X, 41);
set_hitbox_value(AT_DATTACK, 2, HG_HITBOX_Y, -35);
set_hitbox_value(AT_DATTACK, 2, HG_WIDTH, 69);
...
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, asset_get("sfx_leafy_hit2"));
