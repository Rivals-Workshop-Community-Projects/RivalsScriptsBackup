...
set_hitbox_value(AT_DTILT, 1, HG_HITBOX_X, 117);
set_hitbox_value(AT_DTILT, 1, HG_HITBOX_Y, 6);
set_hitbox_value(AT_DTILT, 1, HG_WIDTH, 20);
set_hitbox_value(AT_DTILT, 1, HG_HEIGHT, 10);
...
set_hitbox_value(AT_DTILT, 2, HG_HITBOX_X, 117);
...
set_hitbox_value(AT_DTILT, 3, HG_HIT_SFX, sound_get("splat"));
...
set_hitbox_value(AT_DTILT, 4, HG_HIT_SFX, sound_get("splat"));
