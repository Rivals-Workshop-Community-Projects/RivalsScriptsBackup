...
set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_X, -53);
...
set_hitbox_value(AT_DSTRONG, 4, HG_HITBOX_X, -59);
...
set_hitbox_value(AT_DSTRONG, 5, HG_HITBOX_X, -53);
...
set_hitbox_value(AT_DSTRONG, 6, HG_HITBOX_X, -59);
