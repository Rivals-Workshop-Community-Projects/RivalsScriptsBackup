...
set_window_value(AT_DSTRONG, 5, AG_WINDOW_SFX, sound_get("throw"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("splat"));
...
set_hitbox_value(AT_DSTRONG, 3, HG_HIT_SFX, sound_get("splat"));
...
set_hitbox_value(AT_DSTRONG, 7, HG_HITBOX_X, -67);
...
set_hitbox_value(AT_DSTRONG, 7, HG_HIT_SFX, sound_get("splat2"));
...
set_hitbox_value(AT_DSTRONG, 9, HG_HIT_SFX, sound_get("splat"));
