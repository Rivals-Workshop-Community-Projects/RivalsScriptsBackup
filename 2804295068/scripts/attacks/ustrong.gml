...
set_hitbox_value(AT_USTRONG, 1, HG_HIT_SFX, asset_get("sfx_leafy_hit1"));
...
set_hitbox_value(AT_USTRONG, 2, HG_HEIGHT, 63);
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, asset_get("sfx_leafy_hit1"));
...
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_Y, -62);
...
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, asset_get("sfx_leafy_hit2"));
