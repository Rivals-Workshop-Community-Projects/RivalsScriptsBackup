...
set_window_value(AT_DAIR, 3, AG_WINDOW_LENGTH, 72);
...
set_hitbox_value(AT_DAIR, 3, HG_WINDOW_CREATION_FRAME, 12);
...
set_hitbox_value(AT_DAIR, 4, HG_WINDOW_CREATION_FRAME, 18);
...
set_hitbox_value(AT_DAIR, 8, HG_WINDOW_CREATION_FRAME, 18);
set_hitbox_value(AT_DAIR, 8, HG_HITBOX_X, -2);
set_hitbox_value(AT_DAIR, 8, HG_HITBOX_Y, -2);
...
set_hitbox_value(AT_DAIR, 9, HG_HITBOX_Y, -2);
...
set_hitbox_value(AT_DAIR, 10, HG_WINDOW_CREATION_FRAME, 30);
set_hitbox_value(AT_DAIR, 10, HG_HITBOX_X, -2);
set_hitbox_value(AT_DAIR, 10, HG_HITBOX_Y, -2);
...
set_hitbox_value(AT_DAIR, 11, HG_WINDOW_CREATION_FRAME, 36);
set_hitbox_value(AT_DAIR, 11, HG_HITBOX_X, -2);
set_hitbox_value(AT_DAIR, 11, HG_HITBOX_Y, -2);
...
set_hitbox_value(AT_DAIR, 12, HG_WINDOW_CREATION_FRAME, 42);
set_hitbox_value(AT_DAIR, 12, HG_HITBOX_X, -2);
set_hitbox_value(AT_DAIR, 12, HG_HITBOX_Y, -2);
...
set_hitbox_value(AT_DAIR, 13, HG_WINDOW_CREATION_FRAME, 48);
set_hitbox_value(AT_DAIR, 13, HG_HITBOX_X, -2);
set_hitbox_value(AT_DAIR, 13, HG_HITBOX_Y, -2);
...
set_hitbox_value(AT_DAIR, 14, HG_WINDOW_CREATION_FRAME, 54);
set_hitbox_value(AT_DAIR, 14, HG_HITBOX_X, -2);
set_hitbox_value(AT_DAIR, 14, HG_HITBOX_Y, -2);
...
set_hitbox_value(AT_DAIR, 15, HG_WINDOW_CREATION_FRAME, 60);
set_hitbox_value(AT_DAIR, 15, HG_HITBOX_X, -2);
set_hitbox_value(AT_DAIR, 15, HG_HITBOX_Y, -2);
...
set_hitbox_value(AT_DAIR, 16, HG_WINDOW_CREATION_FRAME, 66);
set_hitbox_value(AT_DAIR, 16, HG_HITBOX_X, -2);
set_hitbox_value(AT_DAIR, 16, HG_HITBOX_Y, -2);
set_hitbox_value(AT_DAIR, 16, HG_HITBOX_GROUP, -1);

/*
set_hitbox_value(AT_DAIR, 17, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_DAIR, 17, HG_WINDOW, 4);
set_hitbox_value(AT_DAIR, 17, HG_WINDOW_CREATION_FRAME, 2);
set_hitbox_value(AT_DAIR, 17, HG_LIFETIME, 2);
set_hitbox_value(AT_DAIR, 17, HG_HITBOX_X, -2);
set_hitbox_value(AT_DAIR, 17, HG_HITBOX_Y, 2);
set_hitbox_value(AT_DAIR, 17, HG_SHAPE, 0);
set_hitbox_value(AT_DAIR, 17, HG_WIDTH, 56);
set_hitbox_value(AT_DAIR, 17, HG_HEIGHT, 24);
set_hitbox_value(AT_DAIR, 17, HG_PRIORITY, 3);
set_hitbox_value(AT_DAIR, 17, HG_DAMAGE, 1);
set_hitbox_value(AT_DAIR, 17, HG_ANGLE, 90);
set_hitbox_value(AT_DAIR, 17, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_DAIR, 17, HG_KNOCKBACK_SCALING, .4);
set_hitbox_value(AT_DAIR, 17, HG_BASE_HITPAUSE, 4);
set_hitbox_value(AT_DAIR, 17, HG_HITPAUSE_SCALING, 0.4);
set_hitbox_value(AT_DAIR, 17, HG_HIT_SFX, asset_get("sfx_blow_weak2"));
set_hitbox_value(AT_DAIR, 17, HG_VISUAL_EFFECT, 303);
set_hitbox_value(AT_DAIR, 17, HG_HITBOX_GROUP, -1);
*/