...
set_window_value(AT_FSTRONG, 1, AG_WINDOW_SFX, sound_get("throw2"));
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_ell_utilt_cannon"));
...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_SFX, asset_get("sfx_ell_utilt_cannon"));
...
set_window_value(AT_FSTRONG, 5, AG_WINDOW_SFX, asset_get("sfx_ell_utilt_cannon"));
...
set_window_value(AT_FSTRONG, 6, AG_WINDOW_SFX, asset_get("sfx_ell_utilt_cannon"));
set_window_value(AT_FSTRONG, 6, AG_WINDOW_HSPEED_TYPE, 1);

set_window_value(AT_FSTRONG, 7, AG_WINDOW_TYPE, 1);
set_window_value(AT_FSTRONG, 7, AG_WINDOW_LENGTH, 32);
...
set_hitbox_value(AT_FSTRONG, 1, HG_WIDTH, 24);
...
set_hitbox_value(AT_FSTRONG, 1, HG_PROJECTILE_HSPEED, 21);
...
set_hitbox_value(AT_FSTRONG, 3, HG_HITBOX_X, -4);
set_hitbox_value(AT_FSTRONG, 3, HG_HITBOX_Y, -27);
...
set_hitbox_value(AT_FSTRONG, 4, HG_WIDTH, 24);
set_hitbox_value(AT_FSTRONG, 4, HG_HEIGHT, 24);
...
set_hitbox_value(AT_FSTRONG, 4, HG_PROJECTILE_HSPEED, 21);
