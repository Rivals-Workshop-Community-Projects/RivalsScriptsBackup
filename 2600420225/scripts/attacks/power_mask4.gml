set_hitbox_value( AT_FSPECIAL_2, 1, HG_ANGLE_FLIPPER, 8);
...
set_hitbox_value( AT_FSPECIAL_2, 1, HG_PROJECTILE_DESTROY_EFFECT, empty);
set_hitbox_value( AT_FSPECIAL_2, 1, HG_PRIORITY, 10);

set_hitbox_value( AT_FSPECIAL_2, 1, HG_HITBOX_X, 465);
set_hitbox_value( AT_FSPECIAL_2, 1, HG_HITBOX_Y, 250);
set_hitbox_value( AT_FSPECIAL_2, 1, HG_HEIGHT, 356);
set_hitbox_value( AT_FSPECIAL_2, 1, HG_WIDTH, 700);