set_hitbox_value( AT_NSPECIAL_AIR, 1, HG_ANGLE_FLIPPER, 8);
...
set_hitbox_value( AT_NSPECIAL_AIR, 1, HG_PROJECTILE_SPRITE, sprite_get("empty"));
set_hitbox_value( AT_NSPECIAL_AIR, 1, HG_PROJECTILE_HSPEED, 0);
set_hitbox_value( AT_NSPECIAL_AIR, 1, HG_PROJECTILE_VSPEED, 0);
...
set_hitbox_value( AT_NSPECIAL_AIR, 1, HG_PROJECTILE_DESTROY_EFFECT, empty);
set_hitbox_value( AT_NSPECIAL_AIR, 1, HG_PRIORITY, 10);

set_hitbox_value( AT_NSPECIAL_AIR, 1, HG_HITBOX_X, 452);
set_hitbox_value( AT_NSPECIAL_AIR, 1, HG_HITBOX_Y, 256);
set_hitbox_value( AT_NSPECIAL_AIR, 1, HG_HEIGHT, 270);
set_hitbox_value( AT_NSPECIAL_AIR, 1, HG_WIDTH, 500);