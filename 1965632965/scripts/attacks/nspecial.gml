...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, sound_get("magnum"));
...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_CUSTOM_GRAVITY, 0.3);
...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_CUSTOM_GRAVITY, 0.3);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, 251);
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_DESTROY_EFFECT, 251);
