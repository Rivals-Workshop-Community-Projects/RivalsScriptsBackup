...
set_window_value(AT_UAIR, 1, AG_WINDOW_CUSTOM_GRAVITY, 0.2);
...
set_window_value(AT_UAIR, 2, AG_WINDOW_CUSTOM_GRAVITY, 0.2);
...
set_window_value(AT_UAIR, 2, AG_WINDOW_SFX, asset_get("sfx_clairen_swing_weak"));
...
set_window_value(AT_UAIR, 3, AG_WINDOW_SFX, asset_get("sfx_clairen_swing_weak"));
set_window_value(AT_UAIR, 4, AG_WINDOW_CUSTOM_GRAVITY, 0.2);
...
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, asset_get("sfx_clairen_tip_weak"));
...
set_hitbox_value(AT_UAIR, 3, HG_HEIGHT, 138);
...
set_hitbox_value(AT_UAIR, 3, HG_HIT_SFX, asset_get("sfx_clairen_tip_med"));
