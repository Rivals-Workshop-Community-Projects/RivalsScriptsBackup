...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sound_get("blank"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HEIGHT, 104);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, asset_get("sfx_ori_seinhit_heavy"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_WIDTH, 270);
set_hitbox_value(AT_DSTRONG, 2, HG_HEIGHT, 104);
...
set_hitbox_value(AT_DSTRONG, 3, HG_WIDTH, 270);
set_hitbox_value(AT_DSTRONG, 3, HG_HEIGHT, 104);
