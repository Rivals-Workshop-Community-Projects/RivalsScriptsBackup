    ...
    draw_sprite(sprite_get("guns"), gun, temp_x, temp_y-20);
    
    
if(move_cooldown[AT_FSPECIAL] == 0 and table == noone){
     draw_sprite(sprite_get("tablehud"), 0, temp_x+50, temp_y-20);
}else if(table != noone){
     draw_sprite(sprite_get("tablehud"), 1, temp_x+50, temp_y-20);
}else if(move_cooldown[AT_FSPECIAL] > 0){
    draw_sprite(sprite_get("tablehud"), 2, temp_x+50, temp_y-20);
}    
