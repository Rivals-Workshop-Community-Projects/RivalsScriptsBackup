...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .6);
//set_window_value(AT_FSTRONG, 2, AG_WINDOW_HAS_SFX, 1);
//set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_mol_bat_ready"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, medium_hfx);
...
set_hitbox_value(AT_FSTRONG, 2, HG_VISUAL_EFFECT, big_hfx);
