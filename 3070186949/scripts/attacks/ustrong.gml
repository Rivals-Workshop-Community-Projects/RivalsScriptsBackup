...
set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX, sound_get("sfx_cane_swing"));
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, small_hfx)
...
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, big_hfx);
