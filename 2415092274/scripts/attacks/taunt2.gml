...
set_window_value(AT_TAUNT_2, 2, AG_WINDOW_LENGTH, 45);
...
set_window_value(AT_TAUNT_2, 3, AG_WINDOW_ANIM_FRAME_START, 0);
set_window_value(AT_TAUNT_2, 3, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_TAUNT_2, 3, AG_WINDOW_SFX, asset_get("sfx_birdflap"));
