...
set_window_value(AT_USTRONG, 1, AG_WINDOW_LENGTH, 6); //4
...
set_window_value(AT_USTRONG, 3, AG_WINDOW_HSPEED, 3);//2
set_window_value(AT_USTRONG, 3, AG_WINDOW_VSPEED, -9);//6
set_window_value(AT_USTRONG, 3, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_USTRONG, 3, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.5);

set_window_value(AT_USTRONG, 4, AG_WINDOW_LENGTH, 9); //22//14
...
set_window_value(AT_USTRONG, 4, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.4);//0.4

set_window_value(AT_USTRONG, 5, AG_WINDOW_LENGTH, 7); //22//8
...
set_window_value(AT_USTRONG, 5, AG_WINDOW_CUSTOM_GRAVITY, 0.7);
set_window_value(AT_USTRONG, 5, AG_WINDOW_HAS_CUSTOM_FRICTION, 0);
set_window_value(AT_USTRONG, 5, AG_WINDOW_CUSTOM_AIR_FRICTION, 0.3);//0.4
...
set_hitbox_value(AT_USTRONG, 1, HG_WIDTH, 42);//42
set_hitbox_value(AT_USTRONG, 1, HG_HEIGHT, 52);//42
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, 112);
