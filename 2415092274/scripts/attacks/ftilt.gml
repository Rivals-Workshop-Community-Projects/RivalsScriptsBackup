...
set_window_value(AT_FTILT, 2, AG_WINDOW_HSPEED, 4);//2
...
set_window_value(AT_FTILT, 3, AG_WINDOW_HSPEED, 8);//4
...
set_window_value(AT_FTILT, 5, AG_WINDOW_ANIM_FRAME_START, 4);//7
set_window_value(AT_FTILT, 5, AG_WINDOW_ANIM_FRAMES, 2);//1
...
set_hitbox_value(AT_FTILT, 1, HG_ANGLE, 30);//20
set_hitbox_value(AT_FTILT, 1, HG_BASE_KNOCKBACK, 12);//10
...
set_hitbox_value(AT_FTILT, 2, HG_HITBOX_X, 40);//41
...
set_hitbox_value(AT_FTILT, 2, HG_ANGLE, 60);//70
set_hitbox_value(AT_FTILT, 2, HG_BASE_KNOCKBACK, 9);//5
set_hitbox_value(AT_FTILT, 2, HG_KNOCKBACK_SCALING, 0.6);//.9
