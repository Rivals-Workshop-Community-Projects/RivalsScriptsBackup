...
set_window_value(AT_BAIR, 1, AG_WINDOW_LENGTH, 11);//9//10
...
set_window_value(AT_BAIR, 3, AG_WINDOW_ANIM_FRAME_START, 4);//8
...
set_window_value(AT_BAIR, 4, AG_WINDOW_ANIM_FRAME_START, 5);//8
...
set_window_value(AT_BAIR, 5, AG_WINDOW_ANIM_FRAME_START, 6);//8
set_window_value(AT_BAIR, 5, AG_WINDOW_ANIM_FRAMES, 1);//3
...
set_hitbox_value(AT_BAIR, 1, HG_HEIGHT, 28);//14
set_hitbox_value(AT_BAIR, 1, HG_SHAPE, 0); //0
