...
set_attack_value(AT_FTHROW, AG_SPRITE, sprite_get("whatsthis_throw_f"));
...
set_hitbox_value(AT_FTHROW, 1, HG_HITBOX_X, 52);
...
set_hitbox_value(AT_FTHROW, 1, HG_WIDTH, 53);
set_hitbox_value(AT_FTHROW, 1, HG_HEIGHT, 43);
...
set_hitbox_value(AT_FTHROW, 1, HG_HIT_SFX, asset_get("sfx_blow_weak2"));
