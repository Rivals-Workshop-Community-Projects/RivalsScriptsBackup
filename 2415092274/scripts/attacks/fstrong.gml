...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_HSPEED, 4);//2
...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_ANIM_FRAME_START, 3);//3
set_window_value(AT_FSTRONG, 3, AG_WINDOW_ANIM_FRAMES, 2);//1
