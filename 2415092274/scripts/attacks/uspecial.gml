...
set_window_value(AT_USPECIAL, 8, AG_WINDOW_HSPEED, 7);
...
set_hitbox_value(AT_USPECIAL, 1, HG_LIFETIME, 12);//41
...
set_hitbox_value(AT_USPECIAL, 2, HG_HITBOX_X, 44);//-2
set_hitbox_value(AT_USPECIAL, 2, HG_HITBOX_Y, -18);
set_hitbox_value(AT_USPECIAL, 2, HG_WIDTH, 42);//62
...
set_hitbox_value(AT_USPECIAL, 2, HG_BASE_KNOCKBACK, 15);//4.5
...
set_hitbox_value(AT_USPECIAL, 3, HG_HITBOX_X, 44);//-2
set_hitbox_value(AT_USPECIAL, 3, HG_HITBOX_Y, -64);
set_hitbox_value(AT_USPECIAL, 3, HG_WIDTH, 42);//62
...
set_hitbox_value(AT_USPECIAL, 4, HG_HITBOX_X, 42);//-2
set_hitbox_value(AT_USPECIAL, 4, HG_HITBOX_Y, -6);
set_hitbox_value(AT_USPECIAL, 4, HG_WIDTH, 46);//62
...
set_hitbox_value(AT_USPECIAL, 6, HG_HITBOX_X, 20);//-2
set_hitbox_value(AT_USPECIAL, 6, HG_HITBOX_Y, -20);
set_hitbox_value(AT_USPECIAL, 6, HG_WIDTH, 44);//62
set_hitbox_value(AT_USPECIAL, 6, HG_HEIGHT, 44);
...
set_hitbox_value(AT_USPECIAL, 7, HG_HITBOX_X, 20);//-2
set_hitbox_value(AT_USPECIAL, 7, HG_HITBOX_Y, -20);
set_hitbox_value(AT_USPECIAL, 7, HG_WIDTH, 38);//62
