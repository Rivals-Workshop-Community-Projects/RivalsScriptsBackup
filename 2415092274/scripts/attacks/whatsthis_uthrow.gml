...
set_attack_value(AT_UTHROW, AG_SPRITE, sprite_get("whatsthis_throw_u"));
...
set_window_value(AT_UTHROW, 3, AG_WINDOW_LENGTH, 6);
...
set_window_value(AT_UTHROW, 4, AG_WINDOW_ANIM_FRAME_START, 3);
...
set_hitbox_value(AT_UTHROW, 1, HG_HITBOX_X, 26);
...
set_hitbox_value(AT_UTHROW, 1, HG_WIDTH, 71);
...
set_hitbox_value(AT_UTHROW, 1, HG_HITPAUSE_SCALING, 0.3);
