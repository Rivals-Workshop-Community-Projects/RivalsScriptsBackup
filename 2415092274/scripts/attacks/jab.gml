...
set_window_value(AT_JAB, 11, AG_WINDOW_ANIM_FRAME_START, 12);
...
set_hitbox_value(AT_JAB, 5, HG_HITBOX_Y, -47);
...
set_hitbox_value(AT_JAB, 6, HG_HITBOX_X, 74);
...
set_hitbox_value(AT_JAB, 8, HG_HITBOX_Y, -16);
set_hitbox_value(AT_JAB, 8, HG_WINDOW, 5);
set_hitbox_value(AT_JAB, 8, HG_LIFETIME, 3);
set_hitbox_value(AT_JAB, 8, HG_WIDTH, 48);
