...
set_hitbox_value(AT_UAIR, 1, HG_DAMAGE, 7); // 5
set_hitbox_value(AT_UAIR, 1, HG_ANGLE, 90);
set_hitbox_value(AT_UAIR, 1, HG_BASE_KNOCKBACK, 8); // 9.5
set_hitbox_value(AT_UAIR, 1, HG_KNOCKBACK_SCALING, 0.7); // 0.75
...
set_hitbox_value(AT_UAIR, 2, HG_BASE_KNOCKBACK, 7); // 8.5
set_hitbox_value(AT_UAIR, 2, HG_KNOCKBACK_SCALING, 0.6); // 0.7
