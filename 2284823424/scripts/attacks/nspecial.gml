...
set_attack_value(AT_NSPECIAL, AG_SPRITE, sprite_get("nspecial_cont_craft"));
set_attack_value(AT_NSPECIAL, AG_NUM_WINDOWS, 4);
set_attack_value(AT_NSPECIAL, AG_OFF_LEDGE, 1);
set_attack_value(AT_NSPECIAL, AG_HURTBOX_SPRITE, hurtbox_spr);
set_attack_value(AT_NSPECIAL, AG_MUNO_ATTACK_NAME, "NSpecial: Inventory");
...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_ANIM_FRAMES, 12);
...
set_window_value(AT_NSPECIAL, 5, AG_WINDOW_LENGTH, 36);
