...
set_hitbox_value(AT_DAIR, 1, HG_MUNO_OBJECT_LAUNCH_ANGLE, 270);
...
set_hitbox_value(AT_DAIR, 1, HG_MUNO_HITBOX_NAME, "Late Hit");
set_hitbox_value(AT_DAIR, 1, HG_MUNO_HITBOX_MISC_ADD, "Launch direction can be influenced slightly by hitbox owner");
...
set_hitbox_value(AT_DAIR, 2, HG_HITPAUSE_SCALING, 1.1);
set_hitbox_value(AT_DAIR, 2, HG_SDI_MULTIPLIER, -.25);
set_hitbox_value(AT_DAIR, 2, HG_DRIFT_MULTIPLIER, -.25);
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, asset_get("sfx_blow_heavy2"));
set_hitbox_value(AT_DAIR, 2, HG_MUNO_HITBOX_NAME, "Early Hit");
set_hitbox_value(AT_DAIR, 2, HG_MUNO_HITBOX_MISC_ADD, "Launch direction can be influenced slightly by hitbox owner
Vertical kb is reversed when opponent has taken at least 100%
Vertical kb will not be reversed if UP is held while hitting.");
...
set_hitbox_value(AT_DAIR, 2, HG_PROJECTILE_HSPEED, 0); //These values are how fast they bounce off of enemies if the attack lands.
set_hitbox_value(AT_DAIR, 2, HG_PROJECTILE_VSPEED, -10); 
