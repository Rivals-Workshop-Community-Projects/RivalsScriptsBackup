...
set_hitbox_value(AT_NSPECIAL_2, 3, HG_MUNO_HITBOX_EXCLUDE, 1);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_HITBOX_TYPE, 2);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_WINDOW, 6);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_WINDOW_CREATION_FRAME, 9);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_LIFETIME, 180);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_HITBOX_X, 0);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_HITBOX_Y, 0);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_WIDTH, 20);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_HEIGHT, 20);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_PRIORITY, 10);
...
set_hitbox_value(AT_NSPECIAL_2, 3, HG_HIT_SFX, -1);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_HITSTUN_MULTIPLIER, -1);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_PROJECTILE_SPRITE, sprite_get("die"));
...
set_hitbox_value(AT_NSPECIAL_2, 3, HG_PROJECTILE_VSPEED, -3);
set_hitbox_value(AT_NSPECIAL_2, 3, HG_PROJECTILE_GRAVITY, 0.2);
...
set_hitbox_value(AT_NSPECIAL_2, 3, HG_MUNO_HITBOX_NAME, "die");