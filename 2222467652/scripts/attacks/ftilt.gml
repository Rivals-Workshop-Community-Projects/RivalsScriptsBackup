...
set_window_value(AT_FTILT, 2, AG_WINDOW_SFX, asset_get("sfx_zetter_fireball_fire"));
...
set_hitbox_value(AT_FTILT, 1, HG_WIDTH, 57);
...
set_hitbox_value(AT_FTILT, 1, HG_EXTRA_HITPAUSE, 8);
set_hitbox_value(AT_FTILT, 1, HG_HITPAUSE_SCALING, .6);
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, 16);
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, asset_get("sfx_absa_jab2"));
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT, 1);
set_hitbox_value(AT_FTILT, 1, HG_MUNO_HITBOX_MISC_ADD, "Inflicts Green Fire (4%)");