...
set_hitbox_value(AT_UTILT, 1, HG_LIFETIME, 17);
...
set_hitbox_value(AT_UTILT, 1, HG_HEIGHT, 24);
...
set_hitbox_value(AT_UTILT, 1, HG_PROJECTILE_UNBASHABLE, true);
set_hitbox_value(AT_UTILT, 1, HG_PROJECTILE_IS_TRANSCENDENT, true);
set_hitbox_value(AT_UTILT, 1, HG_PROJECTILE_VSPEED, -10);
set_hitbox_value(AT_UTILT, 1, HG_PROJECTILE_GRAVITY, 1.4);
//set_hitbox_value(AT_UTILT, 1, HG_MUNO_HITBOX_MISC_ADD, "Tehnically a projectile, but acts more like a melee hitbox.");