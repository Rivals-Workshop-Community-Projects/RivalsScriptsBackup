...
set_attack_value(AT_NSPECIAL, AG_MUNO_ATTACK_MISC_ADD, "Can't be used while egg is present
Attempting to use while egg is present will toggle the egg's floating state");
