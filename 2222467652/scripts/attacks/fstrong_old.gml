...
set_attack_value(AT_EXTRA_1, AG_SPRITE, sprite_get("fstrong_old"));
set_attack_value(AT_EXTRA_1, AG_NUM_WINDOWS, 3);
set_attack_value(AT_EXTRA_1, AG_STRONG_CHARGE_WINDOW, 1);
set_attack_value(AT_EXTRA_1, AG_HURTBOX_SPRITE, sprite_get("fstrong_old_hurt"));
set_attack_value(AT_EXTRA_1, AG_MUNO_ATTACK_NAME, "Fstrong (Old)");
...
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_HAS_CUSTOM_FRICTION, 1.5);
set_window_value(AT_EXTRA_1, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, .4);
...
set_window_value(AT_EXTRA_1, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .8);
...
set_window_value(AT_EXTRA_1, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, .80);
set_window_value(AT_EXTRA_1, 3, AG_WINDOW_HAS_WHIFFLAG, 5);
set_window_value(AT_EXTRA_1, 3, AG_WINDOW_HSPEED, 5);
...
set_window_value(AT_EXTRA_1, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, .90);*/
...
set_hitbox_value(AT_EXTRA_1, 1, HG_HITBOX_Y, -24);
set_hitbox_value(AT_EXTRA_1, 1, HG_HITBOX_X, 14);
set_hitbox_value(AT_EXTRA_1, 1, HG_WIDTH, 54);
set_hitbox_value(AT_EXTRA_1, 1, HG_HEIGHT, 54);
