...
set_attack_value(AT_DTILT, AG_MUNO_ATTACK_MISC_ADD, "Cancels into jump or normal attacks on-hit starting on frame " + string(get_window_value(AT_DTILT, 1, AG_WINDOW_LENGTH) + get_window_value(AT_DTILT, 2, AG_WINDOW_LENGTH) + 1) + ".");
