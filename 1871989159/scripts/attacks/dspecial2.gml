...
//set_attack_value(AT_DSPECIAL_2, AG_AIR_SPRITE, sprite_get("nspecial_air"));
...
set_window_value(AT_DSPECIAL_2, 3, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy1"));
...
set_window_value(AT_DSPECIAL_2, 4, AG_WINDOW_VSPEED, -1);
...
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HITBOX_Y, -55);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_WIDTH, 48);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_HEIGHT, 78);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_PRIORITY, 3);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_DAMAGE, 6);
set_hitbox_value(AT_DSPECIAL_2, 1, HG_ANGLE, 120);
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_HITBOX_X, -11);
set_hitbox_value(AT_DSPECIAL_2, 2, HG_HITBOX_Y, -90);
set_hitbox_value(AT_DSPECIAL_2, 2, HG_WIDTH, 53);
set_hitbox_value(AT_DSPECIAL_2, 2, HG_HEIGHT, 24);
set_hitbox_value(AT_DSPECIAL_2, 2, HG_PRIORITY, 3);
set_hitbox_value(AT_DSPECIAL_2, 2, HG_DAMAGE, 6);
set_hitbox_value(AT_DSPECIAL_2, 2, HG_ANGLE, 120);
...
set_hitbox_value(AT_DSPECIAL_2, 2, HG_HIT_LOCKOUT, 2);
...
set_hitbox_value(AT_DSPECIAL_2, 3, HG_HITBOX_X, 29);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_HITBOX_Y, -30);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_WIDTH, 69);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_HEIGHT, 40);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_PRIORITY, 6);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_DAMAGE, 13);
...
set_hitbox_value(AT_DSPECIAL_2, 3, HG_HITPAUSE_SCALING, 0.3);
set_hitbox_value(AT_DSPECIAL_2, 3, HG_HIT_SFX, asset_get("sfx_blow_heavy1"));
set_hitbox_value(AT_DSPECIAL_2, 3, HG_HIT_LOCKOUT, 2);
...
set_hitbox_value(AT_DSPECIAL_2, 4, HG_WIDTH, 41);
set_hitbox_value(AT_DSPECIAL_2, 4, HG_HEIGHT, 39);
set_hitbox_value(AT_DSPECIAL_2, 4, HG_PRIORITY, 5);
set_hitbox_value(AT_DSPECIAL_2, 4, HG_DAMAGE, 15);
set_hitbox_value(AT_DSPECIAL_2, 4, HG_ANGLE, 45);
set_hitbox_value(AT_DSPECIAL_2, 4, HG_BASE_KNOCKBACK, 8.2);
set_hitbox_value(AT_DSPECIAL_2, 4, HG_KNOCKBACK_SCALING, 1.1);
set_hitbox_value(AT_DSPECIAL_2, 4, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_DSPECIAL_2, 4, HG_HITPAUSE_SCALING, 3);
...
set_hitbox_value(AT_DSPECIAL_2, 5, HG_WINDOW, 6);
set_hitbox_value(AT_DSPECIAL_2, 5, HG_LIFETIME, 400);
set_hitbox_value(AT_DSPECIAL_2, 5, HG_HITBOX_X, 26);
set_hitbox_value(AT_DSPECIAL_2, 5, HG_HITBOX_Y, -60);
set_hitbox_value(AT_DSPECIAL_2, 5, HG_WIDTH, 24);
set_hitbox_value(AT_DSPECIAL_2, 5, HG_HEIGHT, 16);
set_hitbox_value(AT_DSPECIAL_2, 5, HG_PRIORITY, 3);
set_hitbox_value(AT_DSPECIAL_2, 5, HG_DAMAGE, 3);
...
set_hitbox_value(AT_DSPECIAL_2, 5, HG_KNOCKBACK_SCALING, 0.1);
set_hitbox_value(AT_DSPECIAL_2, 5, HG_HITPAUSE_SCALING, 0.1);
set_hitbox_value(AT_DSPECIAL_2, 5, HG_HIT_SFX, asset_get("sfx_blow_weak1"));

set_hitbox_value(AT_DSPECIAL_2, 5, HG_PROJECTILE_SPRITE, sprite_get("bat"));
set_hitbox_value(AT_DSPECIAL_2, 5, HG_PROJECTILE_MASK, -1);
set_hitbox_value(AT_DSPECIAL_2, 5, HG_PROJECTILE_ANIM_SPEED, 0.25);
set_hitbox_value(AT_DSPECIAL_2, 5, HG_PROJECTILE_HSPEED, -3);
set_hitbox_value(AT_DSPECIAL_2, 5, HG_PROJECTILE_VSPEED, -2);
set_hitbox_value(AT_DSPECIAL_2, 5, HG_PROJECTILE_GRAVITY, 0.2);
set_hitbox_value(AT_DSPECIAL_2, 5, HG_PROJECTILE_WALL_BEHAVIOR, 2);
set_hitbox_value(AT_DSPECIAL_2, 5, HG_PROJECTILE_GROUND_BEHAVIOR, 0);
set_hitbox_value(AT_DSPECIAL_2, 5, HG_PROJECTILE_GROUND_FRICTION, 1);
set_hitbox_value(AT_DSPECIAL_2, 5, HG_PROJECTILE_ENEMY_BEHAVIOR, 0);
set_hitbox_value(AT_DSPECIAL_2, 5, HG_PROJECTILE_PARRY_STUN, 0);
set_hitbox_value(AT_DSPECIAL_2, 5, HG_PROJECTILE_DESTROY_EFFECT, 135);
set_hitbox_value(AT_DSPECIAL_2, 5, HG_THROWS_ROCK, 2);

///Bomb detection
set_hitbox_value(AT_DSPECIAL_2, 6, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_WINDOW, 4);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_LIFETIME, 30);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_HITBOX_X, 33);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_HITBOX_Y, -36);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_WIDTH, 105);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_HEIGHT, 50);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_PRIORITY, 6);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_DAMAGE, 18);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_ANGLE, 20);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_SHAPE, 2);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_BASE_HITPAUSE, 5);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_KNOCKBACK_SCALING, 0.7);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_HITPAUSE_SCALING, 0.3);
set_hitbox_value(AT_DSPECIAL_2, 6, HG_HIT_SFX, asset_get("sfx_blow_heavy1"));
