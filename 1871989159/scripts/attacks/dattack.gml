...
set_hitbox_value(AT_DATTACK, 1, HG_WIDTH, 47);
...
set_hitbox_value(AT_DATTACK, 1, HG_FINAL_BASE_KNOCKBACK, 10);
set_hitbox_value(AT_DATTACK, 1, HG_BASE_HITPAUSE, 10);
set_hitbox_value(AT_DATTACK, 1, HG_HITPAUSE_SCALING, .6);
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT, hit_fx_create(sprite_get("sparkfx2"), 20));
