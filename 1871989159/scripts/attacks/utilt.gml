...
set_hitbox_value(AT_UTILT, 1, HG_ANGLE, 67);
...
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, hit_fx_create(sprite_get("sparkfx4"), 20));
...
set_hitbox_value(AT_UTILT, 2, HG_WIDTH, 37);
...
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, hit_fx_create(sprite_get("sparkfx4"), 20));
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, asset_get("sfx_blow_heavy1"));

set_hitbox_value(AT_UTILT, 2, HG_HIT_PARTICLE_NUM, 1);

set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT_Y_OFFSET, -40);