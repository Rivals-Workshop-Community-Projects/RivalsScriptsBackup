...
set_hitbox_value(AT_DTILT, 1, HG_HITBOX_X, 7);
...
set_hitbox_value(AT_DTILT, 1, HG_KNOCKBACK_SCALING, 0.20);
...
set_hitbox_value(AT_DTILT, 1, HG_HIT_PARTICLE_NUM, 0);
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, 501);
...
set_hitbox_value(AT_DTILT, 1, HG_FINAL_BASE_KNOCKBACK, 0);
