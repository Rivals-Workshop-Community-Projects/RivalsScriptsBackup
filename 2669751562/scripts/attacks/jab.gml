...
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, 500);
...
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, 501);
...
set_hitbox_value(AT_JAB, 3, HG_WIDTH, 44);
set_hitbox_value(AT_JAB, 3, HG_HEIGHT, 67);
...
set_hitbox_value(AT_JAB, 3, HG_KNOCKBACK_SCALING, 0.60);
set_hitbox_value(AT_JAB, 3, HG_EFFECT, 0);
set_hitbox_value(AT_JAB, 3, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_JAB, 3, HG_HITPAUSE_SCALING, 0.60);
...
set_hitbox_value(AT_JAB, 3, HG_HIT_PARTICLE_NUM, 0);
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, 504);
set_hitbox_value(AT_JAB, 3, HG_ANGLE_FLIPPER, 0);
set_hitbox_value(AT_JAB, 3, HG_EXTRA_HITPAUSE, 0);
set_hitbox_value(AT_JAB, 3, HG_GROUNDEDNESS, 0);
