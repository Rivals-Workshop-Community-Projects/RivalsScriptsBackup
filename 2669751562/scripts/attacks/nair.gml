...
set_hitbox_value(AT_NAIR, 1, HG_KNOCKBACK_SCALING, 0.60);
set_hitbox_value(AT_NAIR, 1, HG_EFFECT, 0);
set_hitbox_value(AT_NAIR, 1, HG_BASE_HITPAUSE, 8);
set_hitbox_value(AT_NAIR, 1, HG_HITPAUSE_SCALING, 0.50);
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT, 193);
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, 0);
set_hitbox_value(AT_NAIR, 1, HG_HIT_PARTICLE_NUM, 0);
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, 505);
...
set_hitbox_value(AT_NAIR, 2, HG_KNOCKBACK_SCALING, 0.50);
set_hitbox_value(AT_NAIR, 2, HG_EFFECT, 0);
set_hitbox_value(AT_NAIR, 2, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_NAIR, 2, HG_HITPAUSE_SCALING, 0.50);
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT, 193);
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, 0);
set_hitbox_value(AT_NAIR, 2, HG_HIT_PARTICLE_NUM, 0);
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, 505);
