...
CHEAT_DEBUG = initCheat("Debug", [0, 1, 2], ["Off", "On", "Performance"], "Enable debug mode.");

CHEAT_NSPECIAL = initCheat("Toggle NSpecial", [0], ["Toggle"], "Toggle the state of Vanda's Neutral Special.");

CHEAT_FSPECIAL = initCheat("Toggle FSpecial", [0], ["Toggle"], "Toggle the state of Vanda's Forward Special.");

CHEAT_USPECIAL = initCheat("Toggle USpecial", [0], ["Toggle"], "Toggle the state of Vanda's Up Special.");

CHEAT_PARRY		= initCheat("Endless Parry", [0, 1], ["Off", "On"], "Causes other players' parry windows to last forever until they successfully parry something.
...
phone.stats_notes = "Vanda's stats change whenever they sacrifice with DSpecial. Make sure to refresh the stats page for the most up to date information.";
