...
set_hitbox_value(AT_JAB, 1, HG_HEIGHT, 87);
...
set_hitbox_value(AT_JAB, 3, HG_WIDTH, 102);
set_hitbox_value(AT_JAB, 3, HG_HEIGHT, 53);
...
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, sound_get("fstrong"));
