...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX, sound_get("swing3"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, asset_get("sfx_orcane_fspecial_pud"));
set_hitbox_value(AT_FSTRONG, 1, HG_HITBOX_COLOR, hb_color[1]);