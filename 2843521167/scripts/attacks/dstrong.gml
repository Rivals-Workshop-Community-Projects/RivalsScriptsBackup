...
set_hitbox_value(AT_DSTRONG, 2, HG_DRIFT_MULTIPLIER, 0.1);
...
set_hitbox_value(AT_DSTRONG, 3, HG_DRIFT_MULTIPLIER, 0.25);
set_hitbox_value(AT_DSTRONG, 3, HG_SDI_MULTIPLIER, 0.33);
...
set_hitbox_value(AT_DSTRONG, 4, HG_LIFETIME, 16);
...
set_hitbox_value(AT_DSTRONG, 4, HG_ANGLE, 65);
...
set_hitbox_value(AT_DSTRONG, 4, HG_DRIFT_MULTIPLIER, 0.25);
set_hitbox_value(AT_DSTRONG, 4, HG_SDI_MULTIPLIER, 0.33);
