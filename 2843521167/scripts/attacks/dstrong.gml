...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_SFX, asset_get("sfx_poison_hit_med"));
...
set_window_value(AT_DSTRONG, 5, AG_WINDOW_SFX, asset_get("sfx_zetter_shine_charged"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, 280);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITBOX_Y, -107);
...
set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_Y, -72);
set_hitbox_value(AT_DSTRONG, 3, HG_WIDTH, 77);
...
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT, 283);
set_hitbox_value(AT_DSTRONG, 3, HG_HIT_SFX, asset_get("sfx_waterhit_heavy1"));
...
set_hitbox_value(AT_DSTRONG, 4, HG_WIDTH, 77);
set_hitbox_value(AT_DSTRONG, 4, HG_HEIGHT, 43);
...
set_hitbox_value(AT_DSTRONG, 4, HG_VISUAL_EFFECT, 283);
set_hitbox_value(AT_DSTRONG, 4, HG_HIT_SFX, asset_get("sfx_waterhit_heavy1"));
