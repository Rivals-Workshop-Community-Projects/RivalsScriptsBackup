...
alt_name[0]  = "The Alpha";
alt_name[1]  = "False Future";
alt_name[2]  = "Samurai Slasher";
alt_name[3]  = "001";
alt_name[4]  = "Sonic Hitman";
alt_name[5]  = "Chef's Kiss";
alt_name[6]  = "Golden Knight";
alt_name[7]  = "Electrical Surge";
alt_name[8]  = "Woven Fury";
alt_name[9]  = "Sapphire Shard";
alt_name[10]  = "Robotic Hacker";
alt_name[11] = "Rose Crystal";
alt_name[12] = "Young Hoverer";
alt_name[13] = "Under the Rain";
alt_name[14] = "Freedom Fighter";
alt_name[15] = "Void Stick";
alt_name[16] = "Fluid of Gender";
...
draw_sprite_ext(sprite_get("charselect"), get_player_color(player), temp_x+204, temp_y, 2, 2, 0, c_white, 1);
