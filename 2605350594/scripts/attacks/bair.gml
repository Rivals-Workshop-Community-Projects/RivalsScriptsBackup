...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, sound_get("dagger_swoosh2"));
...
set_hitbox_value(AT_BAIR, 1, HG_WIDTH, 89);
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("dagger_stab1"));