...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, sound_get("dagger_swoosh2"));
...
set_hitbox_value(AT_FTILT, 1, HG_HITBOX_X, 71);
set_hitbox_value(AT_FTILT, 1, HG_HITBOX_Y, -19);
set_hitbox_value(AT_FTILT, 1, HG_WIDTH, 82);
set_hitbox_value(AT_FTILT, 1, HG_HEIGHT, 39);
...
set_hitbox_value(AT_FTILT, 2, HG_HIT_SFX, sound_get("dagger_stab3"));
