...
set_window_value(AT_UAIR, 1, AG_WINDOW_SFX, sound_get("dagger_swing2"));
...
set_hitbox_value(AT_UAIR, 2, HG_HITBOX_X, -45);
...
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, sound_get("dagger_stab3"));
...
set_hitbox_value(AT_UAIR, 3, HG_HITBOX_Y, -93);
...
set_hitbox_value(AT_UAIR, 3, HG_HIT_SFX, sound_get("dagger_stab3"));