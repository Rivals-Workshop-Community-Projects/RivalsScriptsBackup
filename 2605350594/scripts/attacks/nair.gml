...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, sound_get("dagger_swing3"));
...
set_hitbox_value(AT_NAIR, 1, HG_WIDTH, 132);
...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sound_get("dagger_slash1"));