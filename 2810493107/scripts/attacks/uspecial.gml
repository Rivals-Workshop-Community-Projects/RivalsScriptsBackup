...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_SFX, sound_get("psyswing"));
...
set_window_value(AT_USPECIAL, 4, AG_WINDOW_SFX, sound_get("hammerarmswing"));
...
set_hitbox_value(AT_USPECIAL, 2, HG_HITBOX_Y, -11);
