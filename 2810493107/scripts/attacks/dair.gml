...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, asset_get("sfx_absa_boltcloud"));
...
set_hitbox_value(AT_DAIR, 1, HG_HEIGHT, 110);
...
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, sound_get("thundersour"));
...
set_hitbox_value(AT_DAIR, 2, HG_HIT_SFX, sound_get("thundersweet"));