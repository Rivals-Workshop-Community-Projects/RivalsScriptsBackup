...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, sound_get("nairhits"));
...
set_window_value(AT_NAIR, 3, AG_WINDOW_SFX, sound_get("nairlaunch"));
...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sound_get("psyhit_weak"));
...
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, sound_get("psyhit_weak"));
...
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, sound_get("psyhit_weak"));
...
set_hitbox_value(AT_NAIR, 4, HG_HIT_SFX, sound_get("psyhit_medium"));
