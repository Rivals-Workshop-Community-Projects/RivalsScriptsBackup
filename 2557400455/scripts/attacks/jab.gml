...
set_window_value(AT_JAB, 7, AG_WINDOW_SFX, asset_get("sfx_frog_fspecial_charge_gained_1"));
...
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, asset_get("sfx_ori_energyhit_medium"));
