...
set_window_value(AT_USPECIAL, 1, AG_WINDOW_LENGTH, 7*4);
...
set_hitbox_value(AT_USPECIAL, 1, HG_PROJECTILE_SPRITE, sprite_get("grenade"));
...
set_hitbox_value(AT_USPECIAL, 2, HG_PROJECTILE_SPRITE, sprite_get("grenade"));
...
set_hitbox_value(AT_USPECIAL, 3, HG_HITBOX_X, 36);
...
set_hitbox_value(AT_USPECIAL, 3, HG_PROJECTILE_SPRITE, sprite_get("grenade"));
