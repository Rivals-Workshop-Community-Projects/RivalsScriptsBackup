...
set_hitbox_value(AT_FAIR, 1, HG_HITSTUN_MULTIPLIER, .45);
...
set_hitbox_value(AT_FAIR, 1, HG_SDI_MULTIPLIER, 1.4);
...
set_hitbox_value(AT_FAIR, 2, HG_HITSTUN_MULTIPLIER, .45);
...
set_hitbox_value(AT_FAIR, 2, HG_SDI_MULTIPLIER, 1.4);
