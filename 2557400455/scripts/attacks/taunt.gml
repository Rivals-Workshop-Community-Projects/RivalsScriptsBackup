...
set_hitbox_value(AT_TAUNT, 3, HG_LIFETIME, 1);
set_hitbox_value(AT_TAUNT, 3, HG_HITBOX_X, 22);
set_hitbox_value(AT_TAUNT, 3, HG_HITBOX_Y, -22);
set_hitbox_value(AT_TAUNT, 3, HG_WIDTH, 56);
set_hitbox_value(AT_TAUNT, 3, HG_HEIGHT, 40);
...
set_hitbox_value(AT_TAUNT, 3, HG_BASE_HITPAUSE, 0);
set_hitbox_value(AT_TAUNT, 3, HG_EXTRA_HITPAUSE, 3);
set_hitbox_value(AT_TAUNT, 3, HG_HITPAUSE_SCALING, 0);
set_hitbox_value(AT_TAUNT, 3, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_TAUNT, 3, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_TAUNT, 3, HG_HITSTUN_MULTIPLIER, 1);
set_hitbox_value(AT_TAUNT, 3, HG_VISUAL_EFFECT, 14);
set_hitbox_value(AT_TAUNT, 3, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_TAUNT, 3, HG_HIT_SFX, asset_get("sfx_shovel_hit_med2"));
...
set_hitbox_value(AT_TAUNT, 4, HG_LIFETIME, 1);
set_hitbox_value(AT_TAUNT, 4, HG_HITBOX_X, 42);
set_hitbox_value(AT_TAUNT, 4, HG_HITBOX_Y, -32);
set_hitbox_value(AT_TAUNT, 4, HG_WIDTH, 70);
set_hitbox_value(AT_TAUNT, 4, HG_HEIGHT, 60);
set_hitbox_value(AT_TAUNT, 4, HG_SHAPE, 0);
set_hitbox_value(AT_TAUNT, 4, HG_PRIORITY, 3);
set_hitbox_value(AT_TAUNT, 4, HG_DAMAGE, 1);
set_hitbox_value(AT_TAUNT, 4, HG_ANGLE, 70);
set_hitbox_value(AT_TAUNT, 4, HG_ANGLE_FLIPPER, 6);
set_hitbox_value(AT_TAUNT, 4, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_TAUNT, 4, HG_BASE_KNOCKBACK, 3);
set_hitbox_value(AT_TAUNT, 4, HG_KNOCKBACK_SCALING, 0);
set_hitbox_value(AT_TAUNT, 4, HG_BASE_HITPAUSE, 0);
set_hitbox_value(AT_TAUNT, 4, HG_EXTRA_HITPAUSE, 3);
set_hitbox_value(AT_TAUNT, 4, HG_HITPAUSE_SCALING, 0);
set_hitbox_value(AT_TAUNT, 4, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_TAUNT, 4, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_TAUNT, 4, HG_HITSTUN_MULTIPLIER, 1);
set_hitbox_value(AT_TAUNT, 4, HG_VISUAL_EFFECT, 14);
set_hitbox_value(AT_TAUNT, 4, HG_HITBOX_GROUP, -1);
set_hitbox_value(AT_TAUNT, 4, HG_HIT_SFX, asset_get("sfx_shovel_hit_med2"));
