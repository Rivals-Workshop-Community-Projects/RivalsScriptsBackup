...
//set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_springgo"));
set_window_value(AT_USPECIAL, 2, AG_WINDOW_CUSTOM_GRAVITY, 1);
set_window_value(AT_USPECIAL, 2, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_absa_jump"));
...
set_window_value(AT_USPECIAL, 5, AG_WINDOW_SFX, sound_get("bees_loud"));
...
set_window_value(AT_USPECIAL, 6, AG_WINDOW_ANIM_FRAME_START, 23);
set_window_value(AT_USPECIAL, 6, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USPECIAL, 6, AG_WINDOW_SFX, sound_get("bees_loud"));
...
set_window_value(AT_USPECIAL, 7, AG_WINDOW_CUSTOM_GRAVITY, 1.8);
set_window_value(AT_USPECIAL, 7, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_USPECIAL, 7, AG_WINDOW_SFX, asset_get("sfx_may_arc_cointoss"));
...
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT, honey_small);
set_hitbox_value(AT_USPECIAL, 1, HG_VISUAL_EFFECT_Y_OFFSET, 48);
...
set_hitbox_value(AT_USPECIAL, 2, HG_VISUAL_EFFECT, honey_big);
...
set_hitbox_value(AT_USPECIAL, 3, HG_ANGLE, 180);
set_hitbox_value(AT_USPECIAL, 3, HG_BASE_KNOCKBACK, 5);
set_hitbox_value(AT_USPECIAL, 3, HG_BASE_HITPAUSE, 2);
set_hitbox_value(AT_USPECIAL, 3, HG_EXTRA_HITPAUSE, 10);
set_hitbox_value(AT_USPECIAL, 3, HG_VISUAL_EFFECT, honey_small);
set_hitbox_value(AT_USPECIAL, 3, HG_VISUAL_EFFECT_Y_OFFSET, 64);
...
set_hitbox_value(AT_USPECIAL, 4, HG_PRIORITY, 9);
...
set_hitbox_value(AT_USPECIAL, 4, HG_EXTRA_HITPAUSE, 6);
set_hitbox_value(AT_USPECIAL, 4, HG_VISUAL_EFFECT, honey_big);
