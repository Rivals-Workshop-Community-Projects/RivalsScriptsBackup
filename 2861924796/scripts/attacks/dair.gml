...
set_window_value(AT_DAIR, 1, AG_WINDOW_SFX, asset_get("sfx_syl_dstrong"));
...
//set_window_value(AT_DAIR, 2, AG_WINDOW_HAS_SFX, 1);
//set_window_value(AT_DAIR, 2, AG_WINDOW_SFX, sound_get("uturn2"));
...
set_window_value(AT_DAIR, 4, AG_WINDOW_SFX, asset_get("sfx_springgo"));
...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, honey_small);
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, 30);
