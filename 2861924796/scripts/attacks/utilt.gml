...
set_window_value(AT_UTILT, 5, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy1"));
...
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, asset_get("sfx_poison_hit_weak"));
...
set_hitbox_value(AT_UTILT, 3, HG_HIT_SFX, asset_get("sfx_poison_hit_med"));
...
set_hitbox_value(AT_UTILT, 4, HG_HIT_SFX, asset_get("sfx_poison_hit_med"));
...
set_hitbox_value(AT_UTILT, 6, HG_VISUAL_EFFECT, honey_big);
