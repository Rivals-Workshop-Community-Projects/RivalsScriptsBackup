...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, asset_get("sfx_shovel_brandish"));
...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_ori_charged_flame_release"));
