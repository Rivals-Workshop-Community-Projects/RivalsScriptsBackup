...
set_window_value(AT_JAB, 2, AG_WINDOW_SFX, asset_get("sfx_ori_seinhit_weak"));
...
set_window_value(AT_JAB, 5, AG_WINDOW_SFX, asset_get("sfx_ori_seinhit_weak"));
...
set_window_value(AT_JAB, 8, AG_WINDOW_SFX, asset_get("sfx_ori_seinhit_medium"));
