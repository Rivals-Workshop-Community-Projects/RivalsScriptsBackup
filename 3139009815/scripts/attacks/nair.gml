...
set_hitbox_value(AT_NAIR, 1, HG_VISUAL_EFFECT, vfx_knife_small);
...
set_hitbox_value(AT_NAIR, 4, HG_WIDTH, 110);
set_hitbox_value(AT_NAIR, 4, HG_HEIGHT, 110);
...
set_hitbox_value(AT_NAIR, 4, HG_VISUAL_EFFECT, vfx_knife_med);
set_hitbox_value(AT_NAIR, 4, HG_VISUAL_EFFECT_X_OFFSET, 20);
set_hitbox_value(AT_NAIR, 4, HG_VISUAL_EFFECT_Y_OFFSET, -20);
set_hitbox_value(AT_NAIR, 4, HG_HIT_SFX, asset_get("sfx_shovel_hit_med1"));
