...
set_hitbox_value(AT_DSPECIAL, 1, HG_WIDTH, 119);
set_hitbox_value(AT_DSPECIAL, 1, HG_HEIGHT, 119);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_VISUAL_EFFECT, vfx_lantern_large);
set_hitbox_value(AT_DSPECIAL, 1, HG_VISUAL_EFFECT_X_OFFSET, 40);
set_hitbox_value(AT_DSPECIAL, 1, HG_VISUAL_EFFECT_Y_OFFSET, 40);
set_hitbox_value(AT_DSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_burnconsume"));
