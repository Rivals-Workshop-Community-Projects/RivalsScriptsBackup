...
set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, woosh_1);
...
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_Y, -147);
set_hitbox_value(AT_USTRONG, 1, HG_WIDTH, 26);
...
set_hitbox_value(AT_USTRONG, 2, HG_HIT_SFX, asset_get("sfx_pom_slap2"));
...
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_Y, -230);
...
set_hitbox_value(AT_USTRONG, 3, HG_VISUAL_EFFECT, vfx_knife_med);
...
set_hitbox_value(AT_USTRONG, 4, HG_HITBOX_Y, -262);
set_hitbox_value(AT_USTRONG, 4, HG_WIDTH, 20);
...
set_hitbox_value(AT_USTRONG, 4, HG_VISUAL_EFFECT, vfx_knife_big);
set_hitbox_value(AT_USTRONG, 4, HG_VISUAL_EFFECT_Y_OFFSET, -10);
set_hitbox_value(AT_USTRONG, 4, HG_HIT_SFX, asset_get("sfx_shovel_hit_heavy1"));
set_hitbox_value(AT_USTRONG, 4, HG_HIT_LOCKOUT, 10);

set_attack_value(AT_USTRONG, AG_MUNO_ATTACK_MISC, "Rope, wing, knife, and tipper, in that order.");