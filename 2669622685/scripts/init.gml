...
// SFX
chargeroll = noone;
staticsound_get = noone;

// VFX
vfx_charge_volt1 = hit_fx_create(sprite_get("charge"), 16)
vfx_charge_volt2 = hit_fx_create(sprite_get("charge_static"), 16);
vfx_voltface = hit_fx_create(sprite_get("vfx_voltface"), 16);
...
// Hurtbox sprites
hurtbox_spr         = sprite_get("voltorb_hurt");
crouchbox_spr       = sprite_get("voltorb_hurt_crouch");
air_hurtbox_spr     = -1; // -1 = use hurtbox_spr
hitstun_hurtbox_spr = -1; // -1 = use hurtbox_spr


// Victory
set_victory_bg( sprite_get( "victorybg_volt" )); // victory_background.png
set_victory_theme(sound_get("voltorbvictory")); // victory_theme.ogg
