...
if (!variable_instance_exists(id,"ae") || ye == true){
	...
	//--- ---
	altsel = sound_get("altselect"); // change the alt select sound here. if you don't want to change the sound, put 0 here.
	...
	ce[0,0] = make_color_rgb(240, 0, 12) // "color preview square" color. can be any color!
	ce[0,1] = "Number 100" // the name of the alternate color.
	ce[0,2] = "Voltorb's colors from the core series." // description to display if "alt color description button" is on. keep it blank if none, and you can remove it if you didn't turn it on.
	ce[1,0] = make_color_rgb(0, 64, 255)
	ce[1,1] = "Great-Model"
	ce[1,2] = "The color of the Great Ball, a step up from the Poke Ball."
	ce[2,0] = make_color_rgb(37, 38, 66)
	ce[2,1] = "Ultra-Model"
	ce[2,2] = "The palette of the Ultra Ball, the Pokeball better than Great."
	ce[3,0] = make_color_rgb(128, 31, 255)
	ce[3,1] = "Master-Model"
	ce[3,2] = "The colors belonging to the Master Ball, the ultimate Pokeball."
	ce[4,0] = make_color_rgb(255, 98, 0)
	ce[4,1] = "Repeat-Model"
	ce[4,2] = "This palette references the Repeat Ball, works best on repeats."
	ce[5,0] = make_color_rgb(133, 136, 156)
	ce[5,1] = "Timer-Model"
	ce[5,2] = "The colors of the Timer Ball, gets better as turns pass."
	ce[6,0] = make_color_rgb( 84, 90, 112)
	ce[6,1] = "Luxury-Model"
	ce[6,2] = "The palette of the Luxury Ball, costs quite a bit."
	ce[7,0] = make_color_rgb(0, 174, 255)
	ce[7,1] = "Quick-Model"
	ce[7,2] = "The color of the Quick Ball, works best at the start."
	ce[8,0] = make_color_rgb(23, 0, 87)
	ce[8,1] = "Beast-Model"
	ce[8,2] = "References the Beast Ball, best-suited for catching UBs."
	ce[9,0] = make_color_rgb(130, 252, 0)
	ce[9,1] = "Dusk-Model"
	ce[9,2] = "The palette of the Dusk Ball, works best in caves."
	ce[10,0] = make_color_rgb(243, 244, 248)
	ce[10,1] = "Evolvin' Electric"
	ce[10,2] = "The color of the Pokemon Electrode. Shoutouts to Delta"
	ce[11,0] = make_color_rgb(226, 217, 175)
	ce[11,1] = "Disguised"
	ce[11,2] = "The color of Mimikyu, another Pokemon Jam entry."
	ce[12,0] = make_color_rgb(95, 129, 248)
	ce[12,1] = "Poison Slinger"
	ce[12,2] = "The color of Croagunk, another Pokemon Jam entry."
	ce[13,0] = make_color_rgb(0, 166, 255)
	ce[13,1] = "Voltorb <-"
	ce[13,2] = "^ pipis"
	ce[14,0] = make_color_rgb(151, 40, 166)
	ce[14,1] = "Matter Most Dark"
	ce[14,2] = "References Dark Matter, the evil species from Kirby"
	ce[15,0] = make_color_rgb(255, 255, 255)
	ce[15,1] = "Rainball"
	ce[15,2] = "An original color scheme that shifts colors."
	ce[16,0] = make_color_rgb(196, 147, 0)
	ce[16,1] = "Golden Globe"
	ce[16,2] = "A color matching the golden ones of Rivals."
	ce[17,0] = make_color_rgb(192, 181, 255)
	ce[17,1] = "Ice-Cold"
	ce[17,2] = "A chilling alt based off snowballs."
	ce[18,0] = make_color_rgb(255, 248, 33)
	ce[18,1] = "Laugh-Out-Loud"
	ce[18,2] = "References emoji, the orbs that adorn phones."
	ce[19,0] = make_color_rgb(255, 0, 166)
	ce[19,1] = "Spiked Clay"
	ce[19,2] = "The palette of the unnamed ball from Claycia's fight."
	ce[20,0] = make_color_rgb(255, 111, 0)
	ce[20,1] = "Pulsing Laser"
	ce[20,2] = "References the Laser Balls from Kirby."
	ce[21,0] = make_color_rgb(196, 211, 130)
	ce[21,1] = "The Ball"
	ce[21,2] = "The palette of the Game & Watch handhelds."
	ce[22,0] = make_color_rgb(33, 174, 255)
	ce[22,1] = "Trans Roller"
	ce[22,2] = "Trans Rights!"
	ce[23,0] = make_color_rgb(59, 73, 134)
	ce[23,1] = "Rollin' Waves"
	ce[23,2] = "Based on Orcane, from Rivals of Aether."
...
//remember rivals starts with 0
	...
	color_rgb=make_color_rgb(110, 0, 0);
	...
	color_rgb=make_color_rgb(255, 191, 191);
	//make a gamemaker color variable using kirby's default color (feet)
	//hue2=(color_get_hue(color_rgb)+hue) mod 255;
	//kirby's feet keep the same hue as his skin
	color_hsv=make_color_hsv(hue2,color_get_saturation(color_rgb),color_get_value(color_rgb)); 
	...
	color_rgb=make_color_rgb(181, 206, 255);
	//make a gamemaker color variable using kirby's default color (feet)
	//hue2=(color_get_hue(color_rgb)+hue) mod 255;
	//kirby's feet keep the same hue as his skin
	color_hsv=make_color_hsv(hue2,color_get_saturation(color_rgb),color_get_value(color_rgb)); 
	//make a gamemaker color variable using the new hue
	set_color_profile_slot(15, 5,color_get_red(color_hsv),color_get_green(color_hsv),color_get_blue(color_hsv));
	//set the new color using rgb values from the gamemaker color
	}
init_shader();
...
//main
draw_sprite_ext( sprite_get("pokeball_css"), 0, argument[0], argument[1], 1, 1, 0, argument[4], argument[6] )
//draw_rectangle_color(argument[0], argument[1], argument[2], argument[3], argument[5], argument[5], argument[5], argument[5], false);
//outline
//draw_set_alpha(argument[6]*1.5);
draw_sprite_ext( sprite_get("pokeball_css"), 1, argument[0], argument[1], 1, 1, 0, argument[5], argument[6]*1.5 )
