...
set_window_value(AT_FAIR, 1, AG_WINDOW_LENGTH, 8); // 4
set_window_value(AT_FAIR, 1, AG_WINDOW_ANIM_FRAMES, 3);
set_window_value(AT_FAIR, 1, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FAIR, 1, AG_WINDOW_SFX, sound_get("sonicboom1"));
...
set_window_value(AT_FAIR, 2, AG_WINDOW_SFX, sound_get("sonicboom2"));
...
set_window_value(AT_FAIR, 4, AG_WINDOW_LENGTH, 12); // 8
...
set_hitbox_value(AT_FAIR, 1, HG_HITPAUSE_SCALING, .5); // .25
...
set_hitbox_value(AT_FAIR, 2, HG_ANGLE, 60); // 30
