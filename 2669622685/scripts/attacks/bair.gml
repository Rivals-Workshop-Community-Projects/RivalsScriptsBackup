...
set_window_value(AT_BAIR, 2, AG_WINDOW_SFX, sound_get("swift"));

set_window_value(AT_BAIR, 3, AG_WINDOW_LENGTH, 10); // 7
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, sound_get("swift_hit"));
