...
set_window_value(AT_UAIR, 2, AG_WINDOW_SFX, sound_get("screech"));

set_window_value(AT_UAIR, 3, AG_WINDOW_LENGTH, 6); // 6
...
set_hitbox_value(AT_UAIR, 1, HG_WIDTH, 49);
set_hitbox_value(AT_UAIR, 1, HG_HEIGHT, 64);
set_hitbox_value(AT_UAIR, 1, HG_PRIORITY, 1);
set_hitbox_value(AT_UAIR, 1, HG_DAMAGE, 5); // 5
...
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, sound_get("screech_hit"));
