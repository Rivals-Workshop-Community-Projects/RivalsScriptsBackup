...
set_window_value(AT_FTILT, 1, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.05);
...
set_window_value(AT_FTILT, 2, AG_WINDOW_SFX, asset_get("sfx_absa_jab1"));
set_window_value(AT_FTILT, 2, AG_WINDOW_SFX_FRAME, 1);
set_window_value(AT_FTILT, 2, AG_WINDOW_HAS_CUSTOM_FRICTION, 1);
set_window_value(AT_FTILT, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, 0.05);
...
set_hitbox_value(AT_FTILT, 1, HG_HIT_SFX, asset_get("sfx_absa_dattack"));
