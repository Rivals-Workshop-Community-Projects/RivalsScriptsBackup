...
set_window_value(AT_NAIR, 3, AG_WINDOW_LENGTH, 4); // 7
...
set_hitbox_value(AT_NAIR, 1, HG_HITBOX_Y, -22); // -40
...
set_hitbox_value(AT_NAIR, 3, HG_HITBOX_Y, -22); // -40
set_hitbox_value(AT_NAIR, 3, HG_WIDTH, 89); // 70
set_hitbox_value(AT_NAIR, 3, HG_HEIGHT, 86); // 70
set_hitbox_value(AT_NAIR, 3, HG_PRIORITY, 1);
set_hitbox_value(AT_NAIR, 3, HG_DAMAGE, 4); // 5
...
set_hitbox_value(AT_NAIR, 3, HG_HIT_SFX, asset_get("sfx_absa_kickhit"));
