...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, sound_get("thunder1"));
...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_HAS_WHIFFLAG, 2);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_Y, -167);
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 60);
set_hitbox_value(AT_DSTRONG, 1, HG_HEIGHT, 162);
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, 22);
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, sound_get("thunder1"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_DAMAGE, 19);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sound_get("thunder2"));
...
set_hitbox_value(AT_DSTRONG, 3, HG_HITBOX_Y, -167);
set_hitbox_value(AT_DSTRONG, 3, HG_WIDTH, 36);
set_hitbox_value(AT_DSTRONG, 3, HG_HEIGHT, 136);
...
set_hitbox_value(AT_DSTRONG, 3, HG_HIT_SFX, sound_get("thunder2"));
...
set_hitbox_value(AT_DSTRONG, 4, HG_WIDTH, 146);
set_hitbox_value(AT_DSTRONG, 4, HG_HEIGHT, 92);
...
set_hitbox_value(AT_DSTRONG, 4, HG_VISUAL_EFFECT, 21);
set_hitbox_value(AT_DSTRONG, 4, HG_HIT_SFX, sound_get("thunder2"));