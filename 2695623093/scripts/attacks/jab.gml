...
set_window_value(AT_JAB, 2, AG_WINDOW_CANCEL_FRAME, 14);
...
set_window_value(AT_JAB, 4, AG_WINDOW_LENGTH, 19);
...
set_window_value(AT_JAB, 4, AG_WINDOW_CUSTOM_GROUND_FRICTION, 10);
set_window_value(AT_JAB, 4, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_JAB, 4, AG_WINDOW_SFX, asset_get("sfx_swipe_medium1"));

set_window_value(AT_JAB, 5, AG_WINDOW_TYPE, 1);
set_window_value(AT_JAB, 5, AG_WINDOW_LENGTH, 13);
...
set_hitbox_value(AT_JAB, 1, HG_HITPAUSE_SCALING, 0.9);
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, sound_get("attack3"));
...
set_hitbox_value(AT_JAB, 3, HG_HIT_SFX, sound_get("attack5"));
...
set_hitbox_value(AT_JAB, 4, HG_HIT_SFX, sound_get("attack4"));

set_hitbox_value(AT_JAB, 5, HG_PARENT_HITBOX, 5);
set_hitbox_value(AT_JAB, 5, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_JAB, 5, HG_WINDOW_CREATION_FRAME, 13);
set_hitbox_value(AT_JAB, 5, HG_WINDOW, 4);
set_hitbox_value(AT_JAB, 5, HG_LIFETIME, 5);
set_hitbox_value(AT_JAB, 5, HG_HITBOX_X, 10);
set_hitbox_value(AT_JAB, 5, HG_HITBOX_Y, -46);
...
set_hitbox_value(AT_JAB, 5, HG_HITPAUSE_SCALING, 0.9);
set_hitbox_value(AT_JAB, 5, HG_HITBOX_GROUP, 4);
set_hitbox_value(AT_JAB, 5, HG_HIT_SFX, sound_get("die2"));