...
set_hitbox_value(AT_DATTACK, 1, HG_HITBOX_Y, -49);
set_hitbox_value(AT_DATTACK, 1, HG_WIDTH, 90);
set_hitbox_value(AT_DATTACK, 1, HG_HEIGHT, 106);
...
set_hitbox_value(AT_DATTACK, 2, HG_HEIGHT, 106);
...
set_hitbox_value(AT_DATTACK, 3, HG_HITBOX_Y, -49);
set_hitbox_value(AT_DATTACK, 3, HG_WIDTH, 90);
set_hitbox_value(AT_DATTACK, 3, HG_HEIGHT, 106);
...
set_hitbox_value(AT_DATTACK, 4, HG_HITBOX_Y, -49);
set_hitbox_value(AT_DATTACK, 4, HG_WIDTH, 82);
set_hitbox_value(AT_DATTACK, 4, HG_HEIGHT, 93);
set_hitbox_value(AT_DATTACK, 4, HG_PRIORITY, 1);
set_hitbox_value(AT_DATTACK, 4, HG_DAMAGE, 3);
set_hitbox_value(AT_DATTACK, 4, HG_ANGLE, 72);
