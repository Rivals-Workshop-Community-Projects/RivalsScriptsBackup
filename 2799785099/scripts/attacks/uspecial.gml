...
set_hitbox_value(AT_USPECIAL, 4, HG_HEIGHT, 55);
...
set_hitbox_value(AT_USPECIAL, 4, HG_PROJECTILE_GROUND_FRICTION, 1);
set_hitbox_value(AT_USPECIAL, 4, HG_PROJECTILE_AIR_FRICTION, 1);
