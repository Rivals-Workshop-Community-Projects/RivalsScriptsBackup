...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, sound_get("sfx_finalcutter_land"));
...
set_window_value(AT_DATTACK, 2, AG_WINDOW_CUSTOM_GROUND_FRICTION, .65);
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_CUSTOM_GROUND_FRICTION, 1.3);
...
set_hitbox_value(AT_DATTACK, 1, HG_HIT_SFX, sound_get("sfx_hit_sharp"));
