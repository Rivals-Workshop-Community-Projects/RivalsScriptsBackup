...
set_window_value(AT_NAIR, 2, AG_WINDOW_SFX, sound_get("sfx_sword_swipe2"));
...
set_hitbox_value(AT_NAIR, 1, HG_WIDTH, 42);
...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sound_get("sfx_hit_sharp"));
...
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_Y, 1);
...
set_hitbox_value(AT_NAIR, 2, HG_KNOCKBACK_SCALING, .65);
set_hitbox_value(AT_NAIR, 2, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_NAIR, 2, HG_HITPAUSE_SCALING, .25);
set_hitbox_value(AT_NAIR, 2, HG_VISUAL_EFFECT, 0);
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, sound_get("sfx_hit_sharp"));