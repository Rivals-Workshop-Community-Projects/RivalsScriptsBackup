...
{
	set_attack_value(AT_USTRONG, AG_SPRITE, sprite_get("ustrongAcc"));
	set_attack_value(AT_USTRONG, AG_NUM_WINDOWS, 3);
	set_attack_value(AT_USTRONG, AG_STRONG_CHARGE_WINDOW, 1);
	set_attack_value(AT_USTRONG, AG_HURTBOX_SPRITE, sprite_get("ustrongAcc_hurt"));
	...
	set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, sound_get("vc_lucario_attack05"));
...
else
{
	...
	set_window_value(AT_USTRONG, 2, AG_WINDOW_HAS_SFX, 1);
	set_window_value(AT_USTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_ori_charged_flame_release"));
	...
	set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, aura_effect);
	...
	set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, aura_effect);
	...
	set_hitbox_value(AT_USTRONG, 3, HG_VISUAL_EFFECT, aurabig_effect);
