...
initTip("NSpecial: Pin Missile");
initWords("Behaves similar to Sheik/Ranno. Holding it will charge the move. The longer you charge the more needles you throw out.");
initWords("Upon hitting the opponent they wont go anywhere but instead they'll be inflicted with poison.");
initWords("You can cancel the move by pressing parry. This stores your needle count for next use.");
initImage_ext(sprite_get("nspecial"), -4, fa_center, 1, 1, true, c_white, 1, false, noone, noone, noone, noone);

initTip("FSpecial: Drill Run");
initWords("Once initiated you can steer up and down.");
...
initTip("USpecial: Takedown");
initWords("USpecial has Beedrill leap up before diving down. The leap will have a grab box so be careful.");
initWords("However if you mess it up you will probably die as this bee aint stopping anytime soon.");
initImage_ext(sprite_get("uspecial"), -4, fa_center, 1, 1, true, c_white, 1, false, noone, noone, noone, noone);

initTip("DSpecial: Sludge Bomb");
initWords("Using dspecial shoots out a puddle.

If you use dspecial while a puddle is out and you aren't on a puddle you'll shoot the puddle again moving it.

If you use dspecial while on a puddle you'll absorb it and store it's poison on you. If stored whenever you attack it'll inflict poison.

If you attack while on a puddle it'll absorb and cause that attack to gain the poison buff. If you miss it won't stay.");
initImage_ext(sprite_get("dspecial"), -4, fa_center, 1, 1, true, c_white, 1, false, noone, noone, noone, noone);

initTip("FStrong: Fell Stinger");
initWords("During the charge of FStrong, Beedrill has less friction due to hovering. Get a running start to ambush a foe!");
initImage_ext(sprite_get("fstrong"), -6, fa_center, 1, 1, true, c_white, 1, false, noone, noone, noone, noone);
initWords_ext("Gimmick:", fa_center, c_gray, 0, false);	
initWords("Upon killing an enemy using Fell Stinger, Beedrill gains a temporary buff to every attack (.5x damage and hitpause, and 1 extra base kb)");

initTip("Poison");
initWords("When hitting certain moves Beedrill will cause a poison status effect on the foe. This effect stacks with a maximum time of about 8 seconds. When affected the opponent takes 1% every half second.");
...
initSection("Pokémon (bro idfk its from the games)");
...
SPK_BEE = initSpeaker(1, "Beedrill", sprite_get("_pho_example_speaker"));
...
initCodecPage(SPK_BEE, 0, 0, "no"); // this page uses the custom speaker
...
// Steve death message.
steve_death_message = "Steve got stung";
...
initCodecPit();
initCodecPagePit(SPK_PIT,	6,	6,	"Who's that Pokémon?");
initCodecPagePit(SPK_PALU,	2,	3,	"That's Beedril-");
initCodecPagePit(SPK_VIR,   1,  6, "Beedrill is an evolved form of Weedle, following its Kakuna stage. Its sting is highly poisonous.");
initCodecPagePit(SPK_PALU,  1,	0,	"-.....l");
initCodecPagePit(SPK_PIT,	9,	1,	"POISON?!");
initCodecPagePit(SPK_PALU,  2,	5,	"Calm yourself, Pit.");
initCodecPagePit(SPK_VIR,   6,	1,	"Beedrill fly quickly and attack using poison stingers on their forelegs and tail.");
initCodecPagePit(SPK_PALU,  0,	1,	"Not all attacks will inflict poison though.");
initCodecPagePit(SPK_PIT,	0,	10,	"Well that's a relief.");
initCodecPagePit(SPK_PALU,  0,	7,	"That doesn't mean you're safe. Watch out for Beedrill's Fell Stinger attack. It packs quite the punch.");
initCodecPagePit(SPK_PALU,  0,	7,	"To add insult to injury if you get KO'd by it Beedrill gets a buff to their strength for a short while.");
initCodecPagePit(SPK_PIT,	7,	2,	"So be on the look out for that move.... Got it.");
/*
╔═══════════════════════════════════════════════════════════════════════════╗
║																			║
║ Behind-The-Scenes															║
