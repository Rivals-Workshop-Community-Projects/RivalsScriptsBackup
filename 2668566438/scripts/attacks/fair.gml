...
set_hitbox_value(AT_FAIR, 1, HG_ANGLE, 35); // 30
...
set_hitbox_value(AT_FAIR, 2, HG_ANGLE, 270); // 30
...
set_hitbox_value(AT_FAIR, 2, HG_HIT_SFX, asset_get("sfx_absa_uair"));