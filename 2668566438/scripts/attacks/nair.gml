...
set_window_value(AT_NAIR, 1, AG_WINDOW_LENGTH, 12); // 4
...
set_window_value(AT_NAIR, 2, AG_WINDOW_LENGTH, 14); // 15
...
set_window_value(AT_NAIR, 3, AG_WINDOW_LENGTH, 12); // 7
...
set_hitbox_value(AT_NAIR, 1, HG_HITBOX_Y, -40); // -40
set_hitbox_value(AT_NAIR, 1, HG_WIDTH, 74); // 65
set_hitbox_value(AT_NAIR, 1, HG_HEIGHT, 74); // 65
...
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_Y, -40); // -40
...
set_hitbox_value(AT_NAIR, 3, HG_WINDOW_CREATION_FRAME, 5); // 6
set_hitbox_value(AT_NAIR, 3, HG_LIFETIME, 2);
set_hitbox_value(AT_NAIR, 3, HG_HITBOX_Y, -40); // -40
...
set_hitbox_value(AT_NAIR, 4, HG_WINDOW_CREATION_FRAME, 7); // 6
set_hitbox_value(AT_NAIR, 4, HG_LIFETIME, 2);
set_hitbox_value(AT_NAIR, 4, HG_HITBOX_Y, -40); // -40
set_hitbox_value(AT_NAIR, 4, HG_HITBOX_GROUP, -1);

set_hitbox_value(AT_NAIR, 5, HG_MUNO_HITBOX_NAME, "Launcher");

set_hitbox_value(AT_NAIR, 5, HG_HITBOX_TYPE, 1);
set_hitbox_value(AT_NAIR, 5, HG_WINDOW, 2);
set_hitbox_value(AT_NAIR, 5, HG_WINDOW_CREATION_FRAME, 9); // 12
set_hitbox_value(AT_NAIR, 5, HG_LIFETIME, 3); // 3
set_hitbox_value(AT_NAIR, 5, HG_HITBOX_Y, -40); // -40
set_hitbox_value(AT_NAIR, 5, HG_WIDTH, 84); // 70
set_hitbox_value(AT_NAIR, 5, HG_HEIGHT, 84); // 70
set_hitbox_value(AT_NAIR, 5, HG_PRIORITY, 1);
set_hitbox_value(AT_NAIR, 5, HG_DAMAGE, 4); // 5
set_hitbox_value(AT_NAIR, 5, HG_ANGLE, 55);
set_hitbox_value(AT_NAIR, 5, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_NAIR, 5, HG_KNOCKBACK_SCALING, .6); // 2
...
set_hitbox_value(AT_NAIR, 5, HG_EXTRA_CAMERA_SHAKE, 4);
