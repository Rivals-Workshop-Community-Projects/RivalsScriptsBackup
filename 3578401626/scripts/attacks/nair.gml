...
set_window_value(AT_NAIR, 1, AG_WINDOW_SFX, sfx_swipe_small);
...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, sfx_hit3alt);
...
set_hitbox_value(AT_NAIR, 2, HG_WIDTH, 61);
...
set_hitbox_value(AT_NAIR, 2, HG_HIT_SFX, sfx_hit3alt);
