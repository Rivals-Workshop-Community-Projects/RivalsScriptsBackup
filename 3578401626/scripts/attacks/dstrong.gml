...
set_window_value(AT_DSTRONG, 1, AG_WINDOW_SFX, sfx_swipe_small);
...
set_window_value(AT_DSTRONG, 2, AG_WINDOW_SFX, sfx_swipe_big);
...
set_window_value(AT_DSTRONG, 5, AG_WINDOW_LENGTH, 999);
...
set_window_value(AT_DSTRONG, 6, AG_WINDOW_SFX, sound_get("huge_bounce"));
...
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_Y, -60);
set_hitbox_value(AT_DSTRONG, 1, HG_WIDTH, 0);
set_hitbox_value(AT_DSTRONG, 1, HG_HEIGHT, 108);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, sfx_hit5);